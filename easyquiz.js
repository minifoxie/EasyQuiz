...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let v=p.filter(T=>T.type==="checkbox"||T.type==="chk"),x=new Set(p.filter(T=>T.type==="radio").map(T=>T.name).filter(Boolean)),w=v.filter(T=>!T.name||!x.has(T.name)),A=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),C=w.length>=2||A,E=x.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&x.size>=1,M=p.every(T=>T.type==="radio"||T.type==="chk")&&x.size===1&&!C&&!E,y=p.filter(T=>T.type==="text"||T.type==="number"||T.type==="val"||T.tag==="input"||T.tag==="textarea"),P=y.length>=2;return(E?`[GRADE VERDADEIRO/FALSO (${x.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${x.size} afirma\xE7\xF5es \u2014 emita ${x.size} a\xE7\xF5es chk separadas + adv]
`:C?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:M?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:P?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${y.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${y.length} campos abaixo com seu id exato]
`:"")+JSON.stringify(p.map(T=>({id:T.id,t:T.type,n:T.name||void 0,txt:T.label?T.label.length>160?T.label.slice(0,160)+"...":T.label:void 0,v:T.value||void 0,opt:T.options&&T.options.length?T.options.slice(0,20).map(O=>O.label||O.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${g.length>0?g.map(v=>`"${v.label||v.id}"[${v.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${(()=>{if(e.length===0)return/\b(observ[ea]|analis[ea]|figur[a]|gráfic[o]|diagram[a]|image[mn]|mapa|tabela|veja|conforme|de acordo com|pela|ilustra|representa|mostr[a]|exib[ea]|consider[ea]\s+(a|o)\s+(image|figur|gráfic|diagram|tabela|mapa))\b/i.test(o.questionText)?"[AVISO CR\xCDTICO]: O enunciado referencia conte\xFAdo visual (gr\xE1fico/imagem/figura/diagrama) mas NENHUMA imagem foi capturada. Sua confian\xE7a DEVE ser \u22640.15. N\xC3O adivinhe \u2014 use apenas o contexto textual dispon\xEDvel.":"Nenhum anexo visual.";let v=e.filter(E=>E.captureStatus==="failed_relevant"),w=/\b(observ[ea]|analis[ea]|figur[a]|gráfic[o]|diagram[a]|image[mn]|mapa|tabela|veja|conforme|de acordo com|pela|ilustra|representa|mostr[a])\b/i.test(o.questionText),A=e.every(E=>E.captureStatus!=="captured"),C="";return(v.length>0||w&&A)&&(C=`
...
`;function ko(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=fn,document.head.appendChild(o)}}catch{}}function Le(){xe&&(xe.style.removeProperty("outline"),xe.style.removeProperty("outline-offset"),xe.style.removeProperty("position"),xe=null);for(let o of Be)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");Be=[];for(let o of Wt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");Wt=[];for(let o of ot)try{o.remove()}catch{}ot=[],ge&&typeof window<"u"&&(window.removeEventListener("scroll",ge),window.removeEventListener("resize",ge),ge=null);for(let o of Jt)try{o.remove()}catch{}if(Jt=[],ye){try{ye.remove()}catch{}ye=null}try{document.querySelectorAll("[data-easyquiz-image-frame]").forEach(o=>{try{o.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-capture-badge]").forEach(o=>{try{o.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-image-highlight]").forEach(o=>{try{let e=o;e.style.removeProperty("animation"),e.style.removeProperty("outline"),e.style.removeProperty("outline-offset"),e.style.removeProperty("box-shadow"),e.style.removeProperty("filter"),e.removeAttribute("data-easyquiz-image-highlight")}catch{}})}catch{}}function Yt(o){ko();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let n=t;try{let i=t.getBoundingClientRect(),a=i.width||n.offsetWidth||0,r=i.height||n.offsetHeight||0;if(a>=Co&&r>=Co){try{n.style&&(n.style.outline="3px solid #ffd600",n.style.outlineOffset="4px",n.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",n.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",n.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),n.setAttribute("data-easyquiz-image-highlight","true"),Wt.push(n)}catch{}let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
        ...
        `,s.appendChild(d),document.body.appendChild(s),ot.push(s),Jt.push(d),e.push({element:t,frame:s})}}catch{}}e.length>0&&!ge&&typeof window<"u"&&(ge=()=>{for(let t=e.length-1;t>=0;t--){let n=e[t];try{if(!document.contains(n.element)){try{n.frame.remove()}catch{}let a=ot.indexOf(n.frame);a!==-1&&ot.splice(a,1),e.splice(t,1);continue}let i=n.element.getBoundingClientRect();i.width>0&&i.height>0?(n.frame.style.top=`${i.top+window.scrollY-3}px`,n.frame.style.left=`${i.left+window.scrollX-3}px`,n.frame.style.width=`${i.width+6}px`,n.frame.style.height=`${i.height+6}px`):n.frame.style.display="none"}catch{}}e.length===0&&ge&&(window.removeEventListener("scroll",ge),window.removeEventListener("resize",ge),ge=null)},window.addEventListener("scroll",ge,{passive:!0}),window.addEventListener("resize",ge,{passive:!0}))}function nt(o){xe&&xe!==o&&(xe.style.removeProperty("outline"),xe.style.removeProperty("outline-offset")),ko(),xe=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(ye){try{ye.remove()}catch{}ye=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
...
`};var kt=class{element=null;shadow;isMinimized=!1;currentPlan=null;isDragging=!1;dragStartX=0;dragStartY=0;initialLeft=25;initialTop=25;onAdvanceCallback;constructor(e,t){this.shadow=e,this.onAdvanceCallback=t,this.initGlobalListeners()}initGlobalListeners(){window.addEventListener("popstate",()=>this.handlePageNavigated()),window.addEventListener("hashchange",()=>this.handlePageNavigated()),document.addEventListener("click",e=>{if(!this.isOpen())return;let t=e.target;if(!t||this.shadow.contains(t)||t.closest("#easyquiz-shadow-root"))return;let n=t.closest('button, [role="button"], a, input[type="submit"]');if(n){let i=(n.textContent||n.value||"").toLowerCase();/pr[oó]xim|avan[cç]|continu|verific|enviar|submit|confirm|checar|validar|next/i.test(i)&&setTimeout(()=>{this.isOpen()&&this.handlePageNavigated()},800)}},!0)}handlePageNavigated(){this.isOpen()&&(this.hide(),this.onAdvanceCallback?.())}isOpen(){return this.element!==null&&this.element.style.display!=="none"}show(e){this.currentPlan=e,this.element||this.createElement(),this.renderContent(),this.element&&(this.element.style.display="flex")}hide(){this.element&&(this.element.style.display="none")}minimize(){this.isMinimized=!0,this.element&&this.element.classList.add("minimized")}restore(){this.isMinimized=!1,this.element&&this.element.classList.remove("minimized")}createElement(){this.element=document.createElement("div"),this.element.className="eq-floating-hud",this.element.style.left=`${this.initialLeft}px`,this.element.style.top=`${this.initialTop}px`,this.element.innerHTML=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=n=>{if(n.target.closest(".eq-fah-btn"))return;n.preventDefault(),this.isDragging=!0,this.dragStartX=n.clientX,this.dragStartY=n.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let a=s=>{if(!this.isDragging||!this.element)return;let d=s.clientX-this.dragStartX,l=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),h);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),n=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,a=i.actions.filter(m=>m.t==="drag"),r=i.actions.filter(m=>{if(m.t!=="val")return!1;let p=H(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),s=i.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=i.actions.filter(m=>m.t==="sel"),l=a.length||r.length||s.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,u.append(h,c),e.appendChild(u),a.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,n.textContent=String(a.length);let m={};for(let p of a){let g=H(p.to)||"Geral";m[g]||(m[g]=[]),m[g].push(H(p.from))}for(let[p,g]of Object.entries(m)){let f=document.createElement("div"),b=/fato|true|verdadeiro|sim/i.test(p),v=/opini[aã]o|false|falso|n[aã]o/i.test(p);f.className=`eq-fah-group ${b?"group-fato":v?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${p} (${g.length})`,f.appendChild(x);let w=document.createElement("div");w.className="eq-fah-group-items";for(let A of g){let C=document.createElement("div");C.className="eq-fah-item";let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=A,C.appendChild(E);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(A),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),C.appendChild(M),w.appendChild(C)}f.appendChild(w),e.appendChild(f)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,n.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let g=document.createElement("div");g.className="eq-fah-group-items";for(let f=0;f<r.length;f++){let b=r[f],v=document.createElement("div");v.className="eq-fah-item";let x=et(b.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${f+1}`);let w=String(b.v??""),A=document.createElement("div");A.className="eq-fah-field-box";let C=document.createElement("div");C.className="eq-fah-field-label",C.textContent=x,A.appendChild(C);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=w,A.appendChild(E),v.appendChild(A);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(w),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),v.appendChild(M),g.appendChild(v)}m.appendChild(g),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,n.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let g=document.createElement("div");g.className="eq-fah-group-items";for(let f=0;f<s.length;f++){let b=s[f],v=document.createElement("div");v.className="eq-fah-item";let x=et(b.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&b.v&&(x=String(b.v)),x=H(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let w="",A=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);A?(w=A[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=A[2].trim()||x):s.length>1&&(w=String.fromCharCode(65+f));let C=document.createElement("div");if(C.style.display="flex",C.style.alignItems="center",C.style.gap="8px",C.style.flex="1",w){let y=document.createElement("span");y.className="eq-fah-letter-badge",y.textContent=w,C.appendChild(y)}let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=x||(w?`Alternativa ${w}`:"Alternativa Selecionada"),C.appendChild(E),v.appendChild(C);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(x||w),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),v.appendChild(M),g.appendChild(v)}m.appendChild(g),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,n.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let g=document.createElement("div");g.className="eq-fah-group-items";for(let f=0;f<d.length;f++){let b=d[f],v=document.createElement("div");v.className="eq-fah-item";let x=et(b.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${f+1}`);let C=(Array.isArray(b.v)?b.v:[String(b.v??"")]).map(z=>{let T=F(b.id,void 0,!0)||F(H(b.id),void 0,!0),O=T instanceof HTMLSelectElement?T:T?.querySelector("select");if(O){let q=H(z).toLowerCase();for(let L=0;L<O.options.length;L++){let R=O.options[L];if(R.value.toLowerCase()===q||H(R.textContent).toLowerCase()===q){let Q=H(R.textContent);if(Q&&!Q.toLowerCase().includes("selecione"))return Q}}}return z}).join(", "),E=document.createElement("div");E.className="eq-fah-field-box";let M=document.createElement("div");M.className="eq-fah-field-label",M.textContent=x,E.appendChild(M);let y=document.createElement("div");y.className="eq-fah-field-val",y.textContent=C,E.appendChild(y),v.appendChild(E);let P=document.createElement("button");P.className="eq-fah-copy-inline",P.textContent="Copiar",P.addEventListener("click",()=>{navigator.clipboard.writeText(C),P.textContent="\u2713 Copiado",setTimeout(()=>P.textContent="Copiar",1200)}),v.appendChild(P),g.appendChild(v)}m.appendChild(g),e.appendChild(m)}else{t.textContent="Gabarito",n.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(i.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let n=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),a=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),r=e.actions.filter(s=>s.t==="sel");if(n.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let d of n){let l=H(d.to)||"Geral";s[l]||(s[l]=[]),s[l].push(H(d.from))}for(let[d,l]of Object.entries(s)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let d=H(s.id);t.push(`- **${d||"Campo"}:** \`${s.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<a.length;s++){let d=a[s],l=et(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=H(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=a.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of r){let d=H(s.id)||"Lista",l=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let n=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=n},1500)})}};var Io=`
  ...
  :host {
    ...
    --eq-surface-hover:  color-mix(in srgb, var(--eq-text-bright) 6%, transparent);
    --eq-border:         color-mix(in srgb, var(--eq-text-bright) 14%, transparent);
    --eq-text:           #bdbdbd;
  ...
  :host([data-eq-theme="mega-black"]) {
    --eq-bg: rgba(0,0,0,0.85);
    --eq-surface: rgba(10,10,10,0.6);
  ...
  :host([data-eq-theme="dark"]) {
    ...
    --eq-surface-hover: color-mix(in srgb, var(--eq-text-bright) 8%, transparent);
    --eq-border: color-mix(in srgb, var(--eq-text-bright) 10%, transparent);
    --eq-text: #a8b2c8;
  ...
  * {
  ...
  .eq-sidebar {
    ...
    height: 100vh;
    z-index: 2147483647;
    background-color: #0d1117; /* Fallback de seguran\xE7a para garantir opacidade/dimens\xF5es */
  ...
  :host([data-eq-theme="mega-black"]) .eq-sidebar {
    ...
    border-left: 1px solid color-mix(in srgb, var(--eq-text-bright) 10%, transparent);
  }
  ...
  .eq-activity-btn {
    ...
    border-radius: 12px;
    color: color-mix(in srgb, var(--eq-text-bright) 72%, transparent);
    cursor: pointer;
  ...
  .eq-activity-btn:hover {
    color: var(--eq-text-bright);
    background: color-mix(in srgb, var(--eq-text-bright) 4%, transparent);
    border-color: color-mix(in srgb, var(--eq-text-bright) 8%, transparent);
    transform: translateX(2px);
  }

  .eq-activity-btn.active {
    color: #000000;
    background: var(--eq-text-bright);
    border-color: color-mix(in srgb, var(--eq-text-bright) 28%, transparent);
  ...
  .eq-resolve-primary.danger {
    ...
    color: #edf3ff;
    box-shadow: none;
    border: 1px solid color-mix(in srgb, var(--eq-text-bright) 10%, transparent);
  }
  ...
  .eq-cta-progress-line {
    ...
    right: 58px;
    height: 2px;
    background: color-mix(in srgb, var(--eq-text-bright) 6%, transparent);
    overflow: hidden;
    border-radius: 2px;
    pointer-events: none;
  }
  ...
  .eq-status-bar {
    ...
    gap: 8px;
    padding: 6px 10px;
    background: color-mix(in srgb, var(--eq-text-bright) 3%, transparent);
    border: 1px solid color-mix(in srgb, var(--eq-text-bright) 6%, transparent);
    border-radius: 4px;
    margin-bottom: 10px;
    min-height: 32px;
  }
  ...
  .eq-result-toggle {
    ...
    width: 100%;
    background: color-mix(in srgb, var(--eq-text-bright) 4%, transparent);
    border: 1px solid color-mix(in srgb, var(--eq-text-bright) 7%, transparent);
    border-radius: 4px;
    color: #c2ccd8;
    font-size: 11px;
    font-weight: 700;
  ...
  .eq-result-toggle:hover { background: color-mix(in srgb, var(--eq-text-bright) 7%, transparent); }
  ...
  .eq-cfg-row {
    ...
    justify-content: space-between;
    padding: 9px 0;
    border-bottom: 1px solid color-mix(in srgb, var(--eq-text-bright) 5%, transparent);
    gap: 12px;
  }
  ...
  .eq-toggle-track {
    position: absolute;
    inset: 0;
    background: color-mix(in srgb, var(--eq-text-bright) 12%, transparent);
    cursor: pointer;
  ...
  .eq-toggle-knob {
    ...
    width: 14px;
    height: 14px;
    background: color-mix(in srgb, var(--eq-text-bright) 50%, transparent);
  ...
  .eq-theme-card-preview-line {
    height: 4px;
    background: color-mix(in srgb, var(--eq-text-bright) 20%, transparent);
    border-radius: 2px;
  }
  .eq-theme-card-label {
    font-size: 10px;
  ...
  .eq-brain-toolbar {
    ...
    padding:5px 8px; border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 6%, transparent);
  ...
  .eq-brain-canvas {
    ...
    flex-direction: column;
    overflow: hidden;
    border-bottom: 1px solid color-mix(in srgb, var(--eq-text-bright) 7%, transparent);
  ...
  .eq-brain-tabbar {
    ...
    border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 6%, transparent);
    background:rgba(0,0,0,0.12);
    overflow-x:auto; overflow-y:hidden;
    flex-shrink:0; min-height:30px;
    scrollbar-width:thin; scrollbar-color:color-mix(in srgb, var(--eq-text-bright) 10%, transparent) transparent;
  }
  ...
  .eq-brain-tabbar::-webkit-scrollbar-thumb { background:color-mix(in srgb, var(--eq-text-bright) 14%, transparent); border-radius:1px; }
  .eq-brain-tabbar::-webkit-scrollbar-thumb:hover { background:color-mix(in srgb, var(--eq-text-bright) 26%, transparent); }

  .eq-brain-tab {
    display:flex; align-items:center; gap:5px; padding:0 10px;
    border-right:1px solid color-mix(in srgb, var(--eq-text-bright) 5%, transparent); cursor:pointer;
    font-size:11.5px; color:rgba(234,240,248,0.42);
    white-space:nowrap; user-select:none;
    transition:background 0.12s,color 0.12s;
    min-width:90px; max-width:150px; flex-shrink:0;
  }
  .eq-brain-tab:hover { background:color-mix(in srgb, var(--eq-text-bright) 4%, transparent); color:rgba(234,240,248,0.82); }
  .eq-brain-tab.is-active { background:color-mix(in srgb, var(--eq-text-bright) 6%, transparent); color:rgba(234,240,248,0.96); border-bottom:2px solid #4285F4; }
  ...
  .eq-brain-content::-webkit-scrollbar-thumb { background:color-mix(in srgb, var(--eq-text-bright) 13%, transparent); border-radius:2px; }
  ...
  .eq-brain-resize-handle {
    ...
    background:linear-gradient(to bottom,color-mix(in srgb, var(--eq-text-bright) 5%, transparent) 0%,transparent 100%);
  ...
  .eq-brain-resize-handle::after {
    ...
    background:color-mix(in srgb, var(--eq-text-bright) 18%, transparent);
  }
  ...
  .eq-brain-file-header {
    ...
    border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 4%, transparent);
  ...
  .eq-md-h1 { font-size:15px; font-weight:700; color:rgba(234,240,248,0.96); margin:12px 0 6px; padding-bottom:4px; border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 8%, transparent); }
  ...
  .eq-md-inline {
    ...
    background:color-mix(in srgb, var(--eq-text-bright) 8%, transparent); padding:1px 5px; border-radius:3px; color:#93c5fd;
  }
  .eq-md-codeblock { background: transparent; border-radius:5px; margin:6px 0; overflow:hidden; border:1px solid color-mix(in srgb, var(--eq-text-bright) 6%, transparent); }
  .eq-md-codelang {
    font-size:9px; font-weight:700; color:rgba(234,240,248,0.28); text-transform:uppercase;
    letter-spacing:0.06em; padding:3px 10px; border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 5%, transparent);
  ...
  .eq-md-hr { border:none; height:1px; background:color-mix(in srgb, var(--eq-text-bright) 8%, transparent); margin:8px 0; }
  ...
  .eq-folder-view-header {
    ...
    padding-bottom:7px; border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 5%, transparent); margin-bottom:5px;
  }
  .eq-folder-view-row {
  ...
  .eq-folder-view-row:hover { background:color-mix(in srgb, var(--eq-text-bright) 6%, transparent); color:rgba(234,240,248,0.9); }
  ...
  .eq-brain-explorer {
    ...
    scrollbar-color: color-mix(in srgb, var(--eq-text-bright) 8%, transparent) transparent;
  }
  .eq-brain-explorer::-webkit-scrollbar { width:2px; }
  .eq-brain-explorer::-webkit-scrollbar-track { background:transparent; }
  .eq-brain-explorer::-webkit-scrollbar-thumb { background:color-mix(in srgb, var(--eq-text-bright) 12%, transparent); border-radius:1px; }

  .eq-brain-empty-tree { padding:10px; font-size:11.5px; color:rgba(234,240,248,0.26); font-style:italic; }

  /* Global node */
  .eq-tree-global { padding-left:8px!important; color:rgba(156,210,255,0.7)!important; font-weight:600; border-bottom:1px solid color-mix(in srgb, var(--eq-text-bright) 4%, transparent); margin-bottom:1px; }
  ...
  .eq-tree-sep { height:1px; background:color-mix(in srgb, var(--eq-text-bright) 5%, transparent); margin:2px 0; }
  ...
  .eq-tree-folder:hover { background:color-mix(in srgb, var(--eq-text-bright) 4%, transparent); }
  .eq-tree-folder.is-folder-sel { background:color-mix(in srgb, var(--eq-text-bright) 7%, transparent); }
  ...
  .eq-tree-arrow:hover { background:color-mix(in srgb, var(--eq-text-bright) 10%, transparent); color:rgba(234,240,248,0.7); }
  ...
  .eq-tree-file:hover { background:color-mix(in srgb, var(--eq-text-bright) 5%, transparent); color:rgba(234,240,248,0.9); }
  ...
  .eq-operation-state.is-busy { color: #aaa; border-color: color-mix(in srgb, var(--eq-text-bright) 15%, transparent); background: color-mix(in srgb, var(--eq-text-bright) 5%, transparent); }
  ...
  .eq-btn-primary.danger {
    ...
    color: var(--eq-text-bright) !important;
  ...
  .eq-live-stopwatch-box {
    background: transparent;
    border: 1px solid color-mix(in srgb, var(--eq-text-bright) 8%, transparent);
    border-radius: 8px;
    padding: 14px 16px;
    display: flex;
    flex-direction: column;
  ...
  .eq-live-stopwatch-status {
    ...
    color: var(--eq-muted);
    padding: 2px 6px;
    background: color-mix(in srgb, var(--eq-text-bright) 5%, transparent);
    border-radius: 4px;
  }
  .eq-live-stopwatch-status.active {
    color: #ccc;
    background: color-mix(in srgb, var(--eq-text-bright) 8%, transparent);
  ...
  .eq-ctx {
    ...
    border: 1px solid color-mix(in srgb, var(--eq-text-bright) 10%, transparent);
    border-radius: 0;
    box-shadow: 0 18px 56px rgba(0,0,0,0.96), 0 0 0 0.5px color-mix(in srgb, var(--eq-text-bright) 6%, transparent);
  ...
  .eq-ctx-item:hover { background: color-mix(in srgb, var(--eq-text-bright) 9%, transparent); color: #fff; }
  ...
  .eq-ctx-divider { height: 1px; background: color-mix(in srgb, var(--eq-text-bright) 6%, transparent); margin: 3px 6px; }
  .eq-ctx-badge {
    font-size: 9px; font-weight: 700; padding: 2px 6px;
    background: color-mix(in srgb, var(--eq-text-bright) 7%, transparent); color: #555; border-radius: 2px;
  ...
  .eq-resolver-context-menu {
    ...
    border: 1px solid color-mix(in srgb, var(--eq-text-bright) 8%, transparent) !important;
...
`;var Ie="v3.8.3";var Ho=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function En(o,e){try{if(Ho){o.innerHTML=Ho.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var Cn=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],kn=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Tt=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_wallpaperRAF=0;_wlpWhiteLogo=null;_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;_ctxPopup=null;_ctxCloseH=null;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;showTokensCheckbox;soundFeedbackCheckbox;compactModeCheckbox;glowEffectsCheckbox;languageHintSelect;autoScrollLogsCheckbox;analyzeBtn;applyBtn=null;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new Ct({onStatusChange:(l,u,h)=>{this.logToConsole(u,h),l==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):l==="advancing"||l==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):l==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),u.includes("conclus\xE3o")||u.includes("finalizada")||u.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):l==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(l,u)=>{try{return await this.callbacks.onAnalyze(l,u,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.setProperty("position","fixed","important"),this.host.style.setProperty("top","15px","important"),this.host.style.setProperty("right","15px","important"),this.host.style.setProperty("z-index","2147483647","important"),this.host.style.setProperty("display","block","important"),this.host.style.setProperty("pointer-events","none","important"),this.shadow=this.host.attachShadow({mode:"open"}),En(this.shadow,`
    ...
    `).join(""),e.querySelectorAll(".eq-theme-card").forEach(i=>{i.addEventListener("click",a=>{let r=a.currentTarget,s=r.dataset.themeId;s&&(localStorage.setItem("easyquiz_theme",s),this.shadow.host.setAttribute("data-eq-theme",s),e.querySelectorAll(".eq-theme-card").forEach(d=>d.classList.remove("active")),r.classList.add("active"),this.setStatus(`Tema atualizado para ${s}`,"info"))})})}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.setupSettingsTabs();let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let q=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!q))}),this.metricsResetBtn?.addEventListener("click",()=>{We(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let q=this.getFormattedLogs();navigator.clipboard.writeText(q).then(()=>{let L=t.innerHTML;t.innerHTML=k.check,setTimeout(()=>t.innerHTML=L,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let n=this.shadow.querySelector("#eq-dbg-copy-prompt");n?.addEventListener("click",()=>{let q=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(q).then(()=>{let L=n.innerHTML;n.innerHTML=`${k.check} Copiado!`,setTimeout(()=>n.innerHTML=L,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-context");i?.addEventListener("click",()=>{let q=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(q).then(()=>{let L=i.innerHTML;i.innerHTML=`${k.check} Copiado!`,setTimeout(()=>i.innerHTML=L,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-raw-resp");a?.addEventListener("click",()=>{let q=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(q).then(()=>{let L=a.innerHTML;a.innerHTML=`${k.check} Copiado!`,setTimeout(()=>a.innerHTML=L,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-error-btn");r?.addEventListener("click",()=>{let q=this.lastErrorMsg||"";navigator.clipboard.writeText(q).then(()=>{let L=r.innerHTML;r.innerHTML=k.check,setTimeout(()=>r.innerHTML=L,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",q=>{q.altKey&&(q.key==="q"||q.key==="Q"||q.key==="a"||q.key==="A")&&(q.preventDefault(),this.toggle())},!0);let s=q=>{let L=q.composedPath();L.includes(this.shadow)||(L.includes(this.sidebarEl)||L.includes(this.host))&&q.stopImmediatePropagation()};window.addEventListener("keydown",s,!0),window.addEventListener("keyup",s,!0),window.addEventListener("keypress",s,!0);let d=q=>q.stopPropagation();this.shadow.addEventListener("keydown",d),this.shadow.addEventListener("keyup",d),this.shadow.addEventListener("keypress",d),this.shadow.addEventListener("paste",d),this.shadow.addEventListener("copy",d),this.shadow.addEventListener("cut",d),this.apiKeyInput.addEventListener("input",()=>{let q=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:q})});let l=this.shadow.querySelector("#eq-keys-collapsible"),u=this.shadow.querySelector("#eq-keys-chevron"),h=this.shadow.querySelector("#eq-keys-section-header"),c=q=>{l&&(q?(l.style.display="none",u&&(u.style.transform="rotate(0deg)")):(l.style.display="block",l.style.maxHeight="none",l.style.overflow="visible",u&&(u.style.transform="rotate(90deg)")))},m=!1;try{m=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}c(m),h?.addEventListener("click",q=>{if(q.target?.closest("a"))return;let L=l?.style.display==="none";c(!L);try{localStorage.setItem("easyquiz_keys_collapsed",L?"false":"true")}catch{}});let p=this.shadow.querySelector("#eq-auto-menu-btn"),g=this.shadow.querySelector("#eq-auto-menu");g&&(g.hidden=!0),p?.classList.remove("is-open"),p?.addEventListener("click",q=>{if(q.stopPropagation(),!!g){if(this._ctxPopup){this.closeCtxPopup(),p.classList.remove("is-open");return}p.classList.add("is-open"),this.showCtxPopup(p,[{ic:"sparkles",label:"Resolver Autopilot",onClick:()=>{p.classList.remove("is-open"),g.querySelector('[data-auto-action="toggle"]')?.click()}},{ic:"eraser",label:"Limpar mem\xF3ria",onClick:()=>{p.classList.remove("is-open"),g.querySelector('[data-auto-action="memory"]')?.click()}},{ic:"info",label:"Mostrar status",onClick:()=>{p.classList.remove("is-open"),g.querySelector('[data-auto-action="status"]')?.click()}}])}}),g?.querySelectorAll("[data-auto-action]").forEach(q=>{q.addEventListener("click",L=>{L.stopPropagation();let R=q.dataset.autoAction;R==="toggle"?this.analyzeBtn?.click():R==="memory"?(rt(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):R==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),g&&(g.hidden=!0),p?.classList.remove("is-open")})}),this.shadow.addEventListener("click",q=>{q.target.closest(".eq-menu-shell")||(g&&(g.hidden=!0),p?.classList.remove("is-open"))});let f=this.shadow.querySelector("#eq-result-toggle"),b=this.shadow.querySelector("#eq-result-body");f&&b&&(b.classList.add("is-collapsed"),f.classList.remove("is-open"),f.addEventListener("click",()=>{let q=f.classList.toggle("is-open");b.classList.toggle("is-collapsed",!q)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let q=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!q){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let L=X.addKey(q);if(L.ok){let R=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:R[0],apiKeys:R}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${R.length} chaves ativas no pool)`,"success"),c(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),dt(q).then(Q=>{Q.ok?(X.markSuccess(q,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(X.markInvalid(q,Q.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${Q.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(L.message,"warning")}),this.shadow.addEventListener("click",q=>{let L=q.target;!L.closest("#eq-key-context-menu")&&L.closest("#eq-key-more-btn")});let x=()=>{let q=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(q!==null&&q.trim()){let L=q.trim().replace(/^["']|["']$/g,""),R=X.addKey(L);if(R.ok){let Q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:Q[0],apiKeys:Q}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(R.message,"warning")}},w=async()=>{try{let q=await navigator.clipboard.readText();if(q){let L=q.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=L,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let q=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(q!==null&&q.trim()){let L=q.trim().replace(/^["']|["']$/g,"");if(X.addKey(L).ok){let Q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:Q[0],apiKeys:Q}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}},A=()=>{let q=this.apiKeyInput.type==="password";this.apiKeyInput.type=q?"text":"password";let L=this.shadow.querySelector("#eq-menu-vis-icon"),R=this.shadow.querySelector("#eq-menu-vis-text");L&&(L.innerHTML=q?k.eyeOff:k.eye),R&&(R.textContent=q?"Ocultar Campo":"Mostrar Campo")},C=()=>{this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()},E=()=>{this.shadow.querySelector("#eq-bulk-overlay")?.remove();let q=document.createElement("div");q.id="eq-bulk-overlay",q.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let L=document.createElement("div");L.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),L.innerHTML=`
      ...
      `,q.appendChild(L),this.shadow.appendChild(q);let R=L.querySelector("#eq-bulk-ta"),Q=L.querySelector("#eq-bulk-status"),V=L.querySelector("#eq-bulk-import"),$=L.querySelector("#eq-bulk-paste-btn"),J=L.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>R?.focus());let Z=()=>{q.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(G=>{q.addEventListener(G,oe=>{oe.stopPropagation()})}),q.addEventListener("keydown",G=>{G.key==="Escape"&&Z()}),q.addEventListener("click",G=>{G.target===q&&Z()}),L.querySelector("#eq-bulk-x")?.addEventListener("click",Z),L.querySelector("#eq-bulk-cancel")?.addEventListener("click",Z),J.addEventListener("click",()=>{R.value="",Q.textContent="",R.focus()}),$.addEventListener("click",async()=>{try{let G=await navigator.clipboard?.readText();G?(R.value=G,R.focus(),Q.style.color="#38bdf8",Q.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(Q.style.color="#fbbf24",Q.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{Q.style.color="#fbbf24",Q.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",R.focus()}}),L.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let G=R.value.trim();if(!G){Q.style.color="#f87171",Q.textContent="Insira pelo menos uma chave de API antes de importar.";return}let oe=G.match(/AIza[0-9A-Za-z\-_]{35}/g),fe=[];if(oe&&oe.length>0?fe=Array.from(new Set(oe)):fe=Array.from(new Set(G.split(/[\n,;\s]+/).map(ve=>ve.trim().replace(/^["'`]|["'`]$/g,"")).filter(ve=>ve.length>=20))),fe.length===0){Q.style.color="#f87171",Q.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}Q.style.color="#00e5ff",Q.textContent=`Processando ${fe.length} chave(s)...`,V.disabled=!0,V.style.opacity="0.6";let be=0,He=0;for(let ve of fe){let Ne=X.addKey(ve);Ne.ok?be++:Ne.message.includes("j\xE1 est\xE1 cadastrada")&&He++}if(be>0){let ve=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:ve[0],apiKeys:ve}),c(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}Q.textContent=`${be} adicionada(s), ${He} duplicada(s). Validando modelo em paralelo...`;let qe=X.exportRawKeys(),St=this.modelSelect?.value||"gemini-3.5-flash-lite",Re=await Bt(St,qe);Re.ok?(X.markSuccess(Re.key,200),Q.style.color="#4ade80",Q.textContent=` ${be} adicionada(s), ${He} duplicada(s). Modelo '${Re.model}' pronto!`):(Q.style.color="#fbbf24",Q.textContent=`${be} adicionada(s), ${He} duplicada(s). Aviso: ${Re.message}`),this.renderKeysList(),V.disabled=!1,V.style.opacity="1",be>0&&(this.setStatus(` Lote importado: ${be} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(Z,2200))})},M=()=>{this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let q=X.exportRawKeys(),L=document.createElement("div");L.id="eq-text-editor-overlay",L.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let R=document.createElement("div");R.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),R.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Tn(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Sn(){let o=window;if(We(),Tn(),setTimeout(()=>{try{go()}catch{}},500),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=It(),t=null,n=null,i=0,a=new Tt(e,{onAnalyze:(l=1,u,h=!1)=>r(l,u,h),onApply:(l=1)=>void s(l),onDestroy:()=>{if(n){try{n.abort()}catch{}n=null}Le(),delete o.__easyquiz},onCancel:()=>{if(n){try{n.abort()}catch{}n=null}Le(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=eo(l)}});o.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,h=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(n)try{n.abort()}catch{}n=new AbortController;let c=n,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){a.setBusy(!1),a.setProgress(0);return}i=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),Le(),a.hideFloatingAnswers();try{let p=Te(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ke()),nt(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let g=await $t(p.scope,e.useVision);if(console.log("================ [SANITY CHECK] ================"),console.log(`[DOM Scope]: ${p.scope.tagName.toLowerCase()}#${p.scope.id||"N/A"}`),console.log(`[Imagens Capturadas]: ${g.length}`),console.log(`[Texto Extra\xEDdo (In\xEDcio)]: ${p.questionText.slice(0,150).replace(/\n/g," ")}...`),console.log("================================================"),p.questionText.trim().length<10&&g.length===0){a.logToConsole("> [ERRO] Texto extra\xEDdo muito curto e sem imagens. Abortando API.","text-red"),a.setStatus("Falha de escopo: cont\xEAiner inv\xE1lido ou vazio.","error");return}if(g.length>0){let A=g.filter(C=>C.captureStatus==="captured"&&C.base64&&C.base64.length>100&&C.element);if(A.length>0){let C=A.map(E=>E.element).filter(Boolean);Yt(C)}a.updateImages(g)}if(c.signal.aborted)return;let f=e.model;a.setStatus(g.length>0?`Consultando Gemini (${f}) com ${g.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${f}) via DOM nativo (modo r\xE1pido)...`,"info");let b=Je(p,g,e);a.setInspectorPrompt(b,e.model);let v=(A,C)=>{a.setStatus(A,C==="warning"?"info":C);let E=A.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(E){let M=E[1].split(",")[0].trim();a.setProgress(50,`Gemini ${M} respondendo...`)}},{plan:x,usedModel:w}=await ut(p,g,e,v,c.signal);if(c.signal.aborted)return;if(x.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=Te(!0),p||(p=ke()),nt(p.scope),a.updateContext(p),g=await $t(p.scope,e.useVision),g.length>0){let E=g.filter(M=>M.captureStatus==="captured"&&M.base64&&M.base64.length>100&&M.element);if(E.length>0){let M=E.map(y=>y.element).filter(Boolean);Yt(M)}a.updateImages(g)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let A=Je(p,g,e);a.setInspectorPrompt(A,e.model),x=(await ut(p,g,e,v,c.signal)).plan}if(c.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${w||e.model} | Modo: ${x.mode} | Confian\xE7a: ${(x.confidence*100).toFixed(0)}%`,"text-green"),x.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${x.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${x.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),x.memoryToStore&&(to(x.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${x.memoryToStore}"`,"text-yellow")),x.imageDescriptions&&x.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${x.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let A of x.imageDescriptions){let C=A.relevant?"":"\uFE0F";a.logToConsole(`>   ${C} Imagem ${A.index+1} [${A.relevant?"RELEVANTE":"IGNORADA"}]: ${A.description}`,A.relevant?"text-blue":"text-yellow")}}return t=x,a.updateContext(p,x),To(x.actions,x.confidence),a.setPlan(x,!e.dryRun),x.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):x.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):x.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&x.pageType==="question"&&a.showFloatingAnswers(x),c.signal.aborted?void 0:((h||e.autoApply)&&!e.dryRun&&await s(l,c.signal,h),x)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){Le(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}Le(),a.setProgress(0);let g=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(g,"error"),a.setErrorDiagnostic(g,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),n===c&&(n=null),c.signal.aborted||a.setBusy(!1)}}async function s(l=1,u,h=!1){if(u?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(f=>f.t!=="adv"),p=t.pageType==="question"||ft(t.rationale||"");if(p&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let g=(h||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let f=await tt(t,g,l,De(e));if(u?.aborted)return;if(a.setExecutionReport(f),f.failedActions&&f.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${f.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let A of f.failedActions){let C=A.action,E=C.t==="drag"?`drag: "${C.from}" \u2192 "${C.to}"`:C.t==="clk"||C.t==="chk"?`${C.t}: "${C.id}"`:C.t==="val"?`val: "${C.id}" = "${C.v}"`:JSON.stringify(C).slice(0,80);a.logToConsole(`>    [${C.t.toUpperCase()}] ${E} | ${A.evidence.slice(0,80)}`,"text-yellow")}await d(f.failedActions,u)}let b=i>0?Date.now()-i:1200,v=f.verified>0,x=f.applied>0;if(f.success||v&&x){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${f.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${f.verified} verificada(s) no DOM.`,"text-green"),f.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):g&&a.logToConsole(`> [NAV] ${f.navigationEvidence}`,"text-blue"),a.setStatus(f.advanced?`Sucesso: ${f.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${f.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let A=no({id:`q-${Date.now()}`,questionIndex:(Ge().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:b,status:"answered",mode:t.mode,actionsCount:f.applied});a.updateTimingMetrics(A)}else x?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${f.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${f.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${f.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${f.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(f){a.setProgress(0);let b=f instanceof Error?f.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${b}`,"error"),a.logToConsole(`> [ERRO] ${b}`,"text-red")}finally{a.setBusy(!1)}}async function d(l,u){if(!t)return;let h=l.filter(m=>m.action.t==="drag");for(let m of h){if(u?.aborted)return;let p=m.action,g=String(p.from||""),f=String(p.to||""),b=qo(g,f,g,f);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${g}" \u2192 "${f}"`,"text-blue");let v={...t,actions:[{t:"js",v:b}],pageType:"question"},x=await tt(v,!1,1,De(e));a.logToConsole(x.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",x.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,g=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${g}`,"text-blue");let f=String(p.id||p.name||p.selector||""),b=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await yt(m.action),await new Promise(v=>setTimeout(v,250)),he(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${g}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let v=F(f,b)||F(f.replace(/[^\w\s]/g," ").trim(),b);if(v&&(Gt(v),await new Promise(x=>setTimeout(x,300)),he(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${g}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let v=F(f,b)||F(f.replace(/[^\w\s]/g," ").trim(),b);if(v&&(v.focus?.(),await new Promise(x=>setTimeout(x,50)),v.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),v.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80)),v.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),v.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200)),he(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${g}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let v=F(f,b)||F(f.replace(/[^\w\s]/g," ").trim(),b);if(v){let x=v.id,w=!!x;x||(x=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,v.id=x);let A=String(p.v??""),C=p.t==="val",E=document.createElement("script");if(E.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(E),E.remove(),w||setTimeout(()=>{try{v.id===x&&v.removeAttribute("id")}catch{}},0),await new Promise(M=>setTimeout(M,300)),he(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${g}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let v="";try{let T=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(O=>(O.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));T&&(v=T.outerHTML.slice(0,400))}catch{}let x=Te(!1)||ke(),w=`A\xE7\xE3o (${p.t}) alvo="${f}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${v?`
HTML do alvo: ${v}`:""}`,A=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],C=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
A seguinte a\xE7\xE3o falhou ap\xF3s ${A.length} estrat\xE9gias autom\xE1ticas: ${A.join(", ")}.
...
${JSON.stringify((x?.controls||[]).slice(0,6).map(T=>({id:T.id,type:T.type,label:T.label,options:T.options?.slice(0,3)})),null,2)}
