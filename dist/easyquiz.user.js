...
[NAVEGA\xC7\xC3O]:
${h.length>0?h.map(l=>`"${l.label||l.id}"[${l.type}]`).join(","):"Nenhuma"}
...
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var St=new Set(["question","info","start","conclusion"]),Mt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),At=new Set(["val","chk","sel","clk","adv","js","drag"]),kt=150,ce=2e3;function D(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,ce):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,ce):e}function Ht(o,e){if(!o||typeof o!="object")return null;let t=o,n=t.t;if(typeof n!="string"||!At.has(n))return null;if(n==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...D(s)?{id:D(s,"").slice(0,500)}:{}}}if(n==="drag"){let s=D(t.from??t.source),c=D(t.to??t.target??t.destination);return!s||!c?null:{t:"drag",from:s.slice(0,500),to:c.slice(0,500)}}if(n==="js"){let s=D(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&n==="val"&&(i="1");let a=D(i).slice(0,500);if(!a)return null;if(n==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:D(s).slice(0,ce)}}if(n==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,d=(Array.isArray(s)?s:[s]).map(u=>D(u).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:d}}if(n==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",c={t:"chk",id:a,c:!s};return t.v!==void 0&&(c.v=D(t.v).slice(0,ce)),c}let r={t:"clk",id:a};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!s}return t.v!==void 0&&(r.v=D(t.v).slice(0,ce)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(r.co=[t.co[0],t.co[1]]),r}function $e(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,n=e.mode;(typeof t!="string"||!St.has(t))&&(t="question"),(typeof n!="string"||!Mt.has(n))&&(n="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],a=[];for(let d=0;d<Math.min(i.length,kt);d++){let u=Ht(i[d],d);u&&a.push(u)}let r=a.filter(d=>d.t!=="adv"),s=a.some(d=>d.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?s||a.push({t:"adv"}):t==="question"&&!s&&a.push({t:"adv"});let c=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:n,confidence:c,rationale:D(e.rationale,"Plano validado e auto-recuperado."),actions:a,...D(e.memoryToStore)?{memoryToStore:D(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var W=[{id:"gemini-2.0-flash",name:"Gemini 2.0 Flash (Mais R\xE1pido e Est\xE1vel)",description:"Modelo oficial de ultra-baixa lat\xEAncia do Google com suporte multimodal completo.",stable:!0},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Equilibrado e Confi\xE1vel)",description:"Modelo comprovado de alt\xEDssima disponibilidade e estabilidade.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Racioc\xEDnio R\xE1pido)",description:"Modelo multimodal de racioc\xEDnio avan\xE7ado.",stable:!0},{id:"gemini-2.0-flash-lite-preview-02-05",name:"Gemini 2.0 Flash-Lite (Econ\xF4mico)",description:"Modelo leve e \xE1gil para respostas r\xE1pidas.",stable:!0},{id:"gemini-1.5-pro",name:"Gemini 1.5 Pro (Alta Precis\xE3o)",description:"Modelo de m\xE1xima precis\xE3o para problemas complexos.",stable:!0}],It={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function zt(o){return o.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.0-flash"}function Re(o,e){let t="";try{let n=JSON.parse(o);t=n.error?.message||n.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function lt(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let n=e.match(/\{[\s\S]*\}/);if(n)try{return JSON.parse(n[0].trim())}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var be=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;return o?JSON.parse(o):null}catch{return null}})(),Pe=new Set;async function ve(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return W;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let n of t)try{let i=await fetch(n,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let r=await i.text(),s=Re(r,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let a=await i.json();if(Array.isArray(a.models)&&a.models.length>0){let r=a.models.filter(s=>{let c=s.supportedGenerationMethods||[],d=(s.name||"").includes("gemini"),u=c.includes("generateContent"),h=(s.name||"").includes("embedding")||(s.name||"").includes("tts")||(s.name||"").includes("imagen")||(s.name||"").includes("aqa")||(s.name||"").includes("computer-use");return d&&u&&!h}).map(s=>{let c=s.supportedGenerationMethods||[],d=s.name.replace(/^models\//,""),u=s.displayName||d;return{id:d,name:u.includes(d)?u:`${u} (${d})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(d),supportsVision:!/embedding|tts|transcribe|live|image/i.test(d),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(r.length>0){r.sort((s,c)=>{let d=u=>u==="gemini-3.8-flash"?120:u==="gemini-3.5-flash-lite"?115:u==="gemini-2.5-flash"?100:u==="gemini-3.1-pro-preview"?90:u.includes("flash")?50:10;return d(c.id)-d(s.id)}),be=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return W}async function ct(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let n=await ve(e);if(n.length>0&&n!==W){let i=n[0];return{ok:!0,message:`Chave v\xE1lida! ${n.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:n}}}catch(n){return{ok:!1,message:n instanceof Error?n.message:String(n)}}let t=["gemini-3.8-flash","gemini-3.5-flash-lite","gemini-2.5-flash"];for(let n of t)for(let i of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${i}/models/${n}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${n} (${i})!`,models:W}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function $t(o,e,t,n,i){let a=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${o}`);for(let s of a){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let c=`https://generativelanguage.googleapis.com/${s}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{let d=await fetch(c,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:t,signal:i,keepalive:n});if(!d.ok){let l=await d.text(),p=Re(l,d.status);if(d.status===404&&s==="v1beta")continue;throw new Error(p)}let u=await d.json(),h=u.candidates?.[0];if(!h||!h.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");return{rawText:h.content.parts[0].text,data:u,usedModel:o}}catch(d){if(i.aborted)throw d;if(r=d,!r.message.includes("404"))break}}throw r}async function Be(o,e,t,n,i){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let a=t.apiKey.trim().replace(/^["']|["']$/g,"");if(!a)throw new Error("Chave de API n\xE3o configurada.");let r=zt(t.model);if(!be||be.length===0)try{n?.("Verificando modelos autorizados na sua chave de API...","info"),await ve(a)}catch(b){let y=b instanceof Error?b.message:String(b);if(y.includes("inv\xE1lida")||y.includes("n\xE3o autorizada"))throw new Error(y)}if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let s=Date.now(),c=le(o,e,t),d=[{text:c}];for(let b=0;b<e.length;b++){let y=e[b],q=y.associatedLabel||(y.alt?`Imagem: ${y.alt}`:`Imagem ${b+1}`);d.push({text:`[ANEXO VISUAL ${b+1} - V\xCDNCULO: ${q}]:`}),d.push({inline_data:{mime_type:y.mediaType,data:y.base64}})}let u={temperature:0,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:It},h=[r,...be?.map(b=>b.id)||[],"gemini-2.0-flash","gemini-1.5-flash","gemini-2.5-flash","gemini-2.0-flash-lite-preview-02-05","gemini-1.5-pro"],l=Array.from(new Set(h)).filter(b=>!Pe.has(b));l.length===0&&(Pe.clear(),l.push(...W.map(b=>b.id)));let p={system_instruction:{parts:[{text:rt}]},contents:[{role:"user",parts:d}],generationConfig:u},g=JSON.stringify(p),x=g.length<6e4,f=l.slice(0,3);if(f.length>1){n?.(`Velocidade M\xE1xima: consultando APIs em paralelo (${f.join(", ")})...`,"info");let b=f.map(()=>new AbortController),y=E=>{b.forEach((C,M)=>{if(M!==E)try{C.abort(new Error("Cancelado: outro modelo respondeu mais r\xE1pido."))}catch{C.abort()}})},q=()=>{b.forEach(E=>{try{E.abort(new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio."))}catch{E.abort()}})};if(i){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");i.addEventListener("abort",q,{once:!0})}try{let E=f.map(async(M,S)=>{let P=b[S],z=setTimeout(()=>{try{P.abort(new Error(`Timeout de 15s na API Gemini (${M}).`))}catch{P.abort()}},15e3);try{let $=await $t(M,a,g,x,P.signal);clearTimeout(z);let B=$e(lt($.rawText));return B.usedModel=$.usedModel,B.durationMs=Date.now()-s,B.promptSent=c,B.tokensUsed=$.data.usageMetadata?.totalTokenCount,B.promptTokens=$.data.usageMetadata?.promptTokenCount,B.candidatesTokens=$.data.usageMetadata?.candidatesTokenCount,B.rawResponse=$.rawText,y(S),{plan:B,rawUsage:$.data.usageMetadata,usedModel:$.usedModel}}catch($){throw clearTimeout(z),$}}),C=await Promise.any(E);if(i?.removeEventListener("abort",q),C.usedModel!==r){n?.(`\u26A1 Velocidade m\xE1xima alcan\xE7ada com '${C.usedModel}' (${C.plan.durationMs}ms)!`,"info");try{t.model=C.usedModel}catch{}}else n?.(`\u26A1 Resposta mais r\xE1pida recebida em ${C.plan.durationMs}ms via '${C.usedModel}'!`,"info");return C}catch(E){if(i?.removeEventListener("abort",q),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");console.warn("[EasyQuiz Race] Corrida concorrente falhou ou esgotou pool inicial. Alternando para fallback sequencial...",E)}}let m=new Error("Nenhum modelo tentado.");for(let b=0;b<l.length;b++){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let y=l[b],q=l[b+1];n?.(`Consultando Gemini (${y})...`,"info");let E=["v1beta","v1"];for(let S of E){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let P=`https://generativelanguage.googleapis.com/${S}/models/${y}:generateContent?key=${encodeURIComponent(a)}`,z=new AbortController,$=()=>{try{z.abort(new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio."))}catch{z.abort()}};if(i){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");i.addEventListener("abort",$,{once:!0})}let B=setTimeout(()=>{try{z.abort(new Error(`Timeout de 18s excedido na API Gemini (${y}). Servidor demorou a responder.`))}catch{z.abort()}},18e3);try{let R=await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":a},body:g,signal:z.signal,keepalive:x});if(clearTimeout(B),i?.removeEventListener("abort",$),!R.ok){let et=await R.text();if(R.status===400&&u.thinkingConfig&&/thinking/i.test(et)){delete u.thinkingConfig,p.generationConfig=u;continue}let Et=Re(et,R.status);if(R.status===404&&S==="v1beta")continue;throw new Error(Et)}let F=await R.json(),Y=F.candidates?.[0];if(!Y||!Y.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let te=Y.content.parts[0].text,V=$e(lt(te));if(V.usedModel=y,V.durationMs=Date.now()-s,V.promptSent=c,V.tokensUsed=F.usageMetadata?.totalTokenCount,V.promptTokens=F.usageMetadata?.promptTokenCount,V.candidatesTokens=F.usageMetadata?.candidatesTokenCount,V.rawResponse=te,y!==r){n?.(`Resolvido com sucesso pelo fallback '${y}' (${S})!`,"info");try{t.model=y}catch{}}return{plan:V,rawUsage:F.usageMetadata,usedModel:y}}catch(R){if(clearTimeout(B),i?.removeEventListener("abort",$),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");if(R instanceof Error&&(R.name==="AbortError"||R.message.includes("aborted")||R.message.includes("Timeout"))?m=new Error(`Timeout de 18s excedido na API Gemini (${y}). Sem resposta imediata.`):m=R,m.message.includes("inv\xE1lida")||m.message.includes("n\xE3o autorizada"))throw m;if(m.message.includes("Timeout")||m.message.includes("503")||m.message.includes("429"))break}}if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let C=m.message.includes("429")||m.message.includes("cota");if(m.message.includes("404")&&Pe.add(y),q){let S=C?500:150,P=`Modelo '${y}' indispon\xEDvel (${m.message}). Alternando imediatamente para '${q}'...`;console.warn(`[EasyQuiz Fallback] ${P}`),n?.(P,"warning"),S>0&&await new Promise(z=>setTimeout(z,S))}else console.warn(`[EasyQuiz Fallback] Modelo '${y}' falhou: ${m.message}. Todos os modelos esgotados.`)}throw m}var Pt=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function de(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function Ne(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function dt(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(Pt.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var oe=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),ye=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,Rt=0;function Oe(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!ae(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function H(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function L(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||ae(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let n=e.type?.toLowerCase();if(n==="checkbox"||n==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${H(e.id)}"]`);if(a&&Oe(a))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Oe(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return Oe(e)}function Bt(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function A(o,e=500){return Bt(o).replace(/\s+/g," ").trim().slice(0,e)}function Nt(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(Rt+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function ae(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var ue=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function I(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(ae(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let n=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||""),a=String(n.getAttribute?.("aria-label")||""),r=String(n.getAttribute?.("title")||""),s=typeof n.className=="string"?n.className:typeof n.className?.baseVal=="string"?n.className.baseVal:"",c=A(n.textContent,60);return!!(ue.test(i)||ue.test(a)||ue.test(r)||ue.test(s)||c.length>0&&c.length<=25&&ue.test(c))}function G(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||ae(o)||I(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=A(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),n=o.type,i=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),a=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return ye.test(i)||ye.test(t)||n==="submit"||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")||!1}function De(o){let e=o.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),d=c&&c!==o.closest("td")?A(c.textContent,100):"",u=A(o.closest("label, td")?.textContent||"",50);if(d&&u)return`${d}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let c=t.querySelector('.dropdown-label, [class*="label" i]'),d=c&&c!==o?A(c.textContent,150):"";if(d)return d}let n=o.getAttribute("aria-label");if(n)return A(n);let i=o.getAttribute("aria-labelledby");if(i){let c=i.split(/\s+/).map(d=>document.getElementById(d)?.textContent).filter(Boolean).join(" ");if(c.trim())return A(c)}if("labels"in o&&o.labels){let c=Array.from(o.labels??[]).map(d=>d.textContent).join(" ");if(c.trim())return A(c)}let a=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==o){let c=A(a.textContent);if(c)return c}let r=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||r||"";return A(s)}function Ve(o,e){let n=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let a=o.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(a)?a:"other",s=o.getAttribute("role")||"",c=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),d=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(d),h=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(d),p=A((u?"draggable":h?"dropzone":"")||i.type||s||r,40),g="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox")g=i.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(r==="button"||a==="a"||e==="navigation"||G(o))g="";else{let q=typeof o.value=="string"||typeof o.value=="number"?o.value:"";g=A(q||o.getAttribute("data-category")||"",2e3)}let x=[];if(n&&n.options)for(let q of Array.from(n.options).slice(0,80))x.push({value:A(q.value),label:A(q.textContent)});else if(s==="combobox"||s==="listbox"||d.includes("select")||d.includes("dropdown")){let q=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),E=q?document.getElementById(q):o;if(E){let C=E.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let M of Array.from(C).slice(0,80)){let S=A(M.textContent);S&&x.push({value:M.getAttribute("data-value")||M.getAttribute("value")||S,label:S})}}}let f=!!(i.required||o.getAttribute("aria-required")==="true"),m=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),b=Nt(o);return{id:o.id||b,tag:r,type:p,label:De(o),name:A(i.name||o.getAttribute("name")||"",180),value:g,options:x,required:f,disabled:m,role:e}}var ut=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function pt(o){if(!L(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(oe)).filter(L),n=A(o.innerText||o.textContent||"",4e3).length;if(n<10||!t.length&&n<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),r=Math.min(1,a/i),s=e.top+e.height/2,c=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),d=n>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,n/20)+d+u-r*20-c*10}function xe(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,n=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(n))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&n!=="main"&&n!=="body"){e=t;break}let i=A(e.innerText||e.textContent||"",1e4),a=A(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(oe).length,s=t.querySelectorAll(oe).length;if(i.length<150&&a.length>i.length&&s<=r+4&&n!=="main"&&n!=="body"){e=t;continue}break}return e}function ht(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&L(t))return t;let n=0;for(;e.parentElement&&e.parentElement!==document.body&&n<3;)e=e.parentElement,n++;return e||document.body}function N(){let o=document.activeElement;if(o&&o!==document.body){let a=o.closest(ut);if(a&&pt(a)>0)return xe(a)}let t=Array.from(document.querySelectorAll(ut)).map(a=>({element:a,score:pt(a)})).filter(a=>Number.isFinite(a.score)).sort((a,r)=>r.score-a.score),n=t.find(a=>{let r=a.element.tagName.toLowerCase();return r!=="main"&&r!=="body"&&a.score>0});if(n)return xe(n.element);if(t.length>0&&t[0].score>0)return xe(t[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&L(i)?i:document.body}function mt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(n=>n.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(n=>{for(let i of Array.from(n.attributes))t.includes(i.name)||n.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function qe(o){let e=Array.from(o.querySelectorAll(oe)),t=new Set,n=[];for(let i of e){if(!L(i)||G(i)||I(i))continue;let a=i.tagName.toLowerCase();["input","textarea","select"].includes(a)&&(t.add(i),n.push(i))}for(let i of e){if(!L(i)||G(i)||I(i))continue;let a=i.tagName.toLowerCase();if(["input","textarea","select"].includes(a))continue;let r=i.querySelector("input, textarea, select");if(!(r&&t.has(r))){if(i.hasAttribute("for")){let s=i.getAttribute("for"),c=s?i.ownerDocument.getElementById(s):null;if(c&&t.has(c))continue}if(a==="a"){let s=i.getAttribute("role");if(!(s==="button"||s==="radio"||s==="checkbox"||s==="option"||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}n.push(i)}}return n.slice(0,100).map(i=>Ve(i,"answer"))}function _e(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,n=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(oe)))if(!(t.has(a)||!L(a)||!G(a)||I(a))&&(t.add(a),n.push(Ve(a,"navigation")),n.length>=10))return n;return n}function pe(o=!1){let e=N();e=xe(e),o&&(e=ht(e));let t=qe(e),n=_e(e);if(t.length===0){let s=qe(document.body);s.length>0&&(e=ht(e),t=qe(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}n.length===0&&(n=_e(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=A(i,16e3),r=[...t,...n].slice(0,120);return!a||r.length===0&&a.length<30?A(document.body.innerText||document.body.textContent||"",16e3).length>=30?ne():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:mt(e),controls:r,scope:e}}function ne(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=A(o,16e3),t=qe(document.body),n=_e(document.body),i=[...t,...n].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:mt(a).slice(0,15e3),controls:i,scope:a}}function gt(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}:${t.value}:${t.disabled}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,500),e].join("::")}function k(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function v(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function O(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let n=o.getAttribute("for");if(n){let i=o.ownerDocument.getElementById(n);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let n=e.getAttribute("for"),a=(n?e.ownerDocument.getElementById(n):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let n=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(n)return O(n)}return o}function ft(o){let e=o;if(!e||!document.contains(e))try{e=N()}catch{}e=e||document.body;let t=Array.from(e.querySelectorAll("tr")).filter(a=>L(a)&&a.querySelector('input[type="radio"], input[type="checkbox"]'));if(t.length>1)return t;let n=Array.from(e.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(a=>L(a)&&!k(a));return n.length>0?n:Array.from(e.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(a=>L(a)&&!k(a)).filter(a=>!a.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'))}function T(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=H(i),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!k(r)&&L(r))return O(r);try{let l=document.getElementById(i);if(l&&!k(l)&&L(l))return l.hasAttribute("data-category")||l.hasAttribute("data-dropzone")||l.classList.contains("dnd-zone")?l:O(l)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let l=parseInt(s[1],10);if(t){let g=document.body;try{g=N()||document.body}catch{}let x=Array.from(g.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(f=>L(f)&&!k(f));if(l>=1&&l-1<x.length)return x[l-1];if(l===0&&x.length>0)return x[0]}let p=l-1;if(p>=0){let g=ft();if(p<g.length){let m=g[p];if(m.tagName.toLowerCase()==="tr"){if(e){let y=m.querySelector(`input[value="${H(e)}" i], [data-value="${H(e)}" i]`);if(y)return y}let b=m.querySelector("input");if(b)return b}return O(m)}let x=document.body;try{x=N()||document.body}catch{}let f=Array.from(x.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(m=>L(m)&&!k(m));if(p<f.length)return f[p]}}let c=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(c){let l=c[1].toUpperCase().charCodeAt(0)-65;if(l>=0){let p=ft();if(l<p.length){let g=p[l];if(g.tagName.toLowerCase()==="tr"){if(e){let f=g.querySelector(`input[value="${H(e)}" i], [data-value="${H(e)}" i]`);if(f)return f}let x=g.querySelector("input");if(x)return x}return O(g)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let p=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(m=>L(m)&&!k(m));if(p)return p;let x=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(m=>L(m)&&!k(m));if(x)return O(x);let f=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(m=>{if(!L(m)||k(m))return!1;let b=v(m.textContent).toLowerCase();return b===i.toLowerCase()||b===i.toLowerCase()+")"});if(f)return O(f)}try{let p=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`)).find(g=>L(g)&&!k(g));if(p)return p.hasAttribute("data-category")||p.hasAttribute("data-dropzone")||p.classList.contains("dnd-zone")?p:O(p)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let p=Array.from(document.querySelectorAll(i)).find(g=>L(g)&&!k(g));if(p)return O(p)}catch{}try{let l=i.replace(/"/g,""),p=`//button[normalize-space(.)="${l}"] | //a[normalize-space(.)="${l}"] | //*[not(*) and normalize-space(.)="${l}"] | //*[@aria-label="${l}"] | //*[@data-category="${l}"] | //*[@data-testid="${l}"]`,g=document.evaluate(p,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let x=0;x<g.snapshotLength;x++){let f=g.snapshotItem(x);if(f&&L(f)&&!k(f)){if(["body","html"].includes(f.tagName.toLowerCase())){let b=f.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&L(b))return O(b)}return f.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||O(f)}}}catch{}let u=v(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let l of h){if(!L(l)||k(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||I(l)||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=v(l.textContent).toLowerCase(),x=v(l.getAttribute("aria-label")||"").toLowerCase(),f=v(l.getAttribute("placeholder")||"").toLowerCase(),m=v(l.getAttribute("title")||"").toLowerCase(),b=v(l.getAttribute("name")||"").toLowerCase(),y=v(l.getAttribute("data-category")||"").toLowerCase(),q=l instanceof HTMLInputElement||l instanceof HTMLButtonElement?l.value:"",E=v(q).toLowerCase(),C=g.startsWith(u+")")||g.startsWith(u+".")||g.startsWith(u+" -")||g.startsWith(u+":");if(g===u||x===u||f===u||m===u||b===u||y&&y===u||E&&E===u||C)return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||O(l)}if(u.length>=3)for(let l of h){if(!L(l)||k(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||I(l)||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=v(l.textContent).toLowerCase(),x=v(l.getAttribute("aria-label")||"").toLowerCase(),f=v(l.getAttribute("placeholder")||"").toLowerCase(),m=v(l.getAttribute("title")||"").toLowerCase(),b=v(l.getAttribute("name")||"").toLowerCase();if(g.includes(u)||x.includes(u)||f.includes(u)||m.includes(u)||b.includes(u)){if(Array.from(l.children).some(C=>{let M=v(C.textContent).toLowerCase();return M&&M.includes(u)}))continue;return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||O(l)}let y=u.split(/\s+/).filter(Boolean);if(y.length>=3){let q=y.slice(0,Math.min(5,y.length)).join(" ");if(g.includes(q)||x.includes(q)||f.includes(q))return O(l)}}return null}function vt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function _(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){j(t,!0);return}if(t.type==="radio"){j(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement||typeof HTMLAnchorElement<"u"&&o instanceof HTMLAnchorElement||o.tagName?.toLowerCase()==="a"||o.tagName?.toLowerCase()==="button"||typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let i=o.getBoundingClientRect(),a=e?e[0]:Math.round(i.left+Math.max(1,i.width/2)),r=e?e[1]:Math.round(i.top+Math.max(1,i.height/2)),s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerdown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function we(o,e){let t=o;if(t.hasAttribute("for")){let d=t.getAttribute("for"),u=t.ownerDocument.getElementById(d);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Ee(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){Ee(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let d=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(d)t=d;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let l=t.nextElementSibling;for(;l;){if(l instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(l.type)||l instanceof HTMLTextAreaElement||l instanceof HTMLElement&&l.isContentEditable){t=l;break}let p=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){t=p;break}l=l.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let d=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d)t=d;else{let u=document.body;try{u=N()||document.body}catch{}let h=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let d=document.body;try{d=N()||document.body}catch{}let u=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let d=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;j(t,d);return}let r=String(e??""),s=r;if(t instanceof HTMLInputElement&&t.type==="number"){let d=r.replace(",",".").replace(/[^0-9.-]/g,"");d&&!isNaN(Number(d))&&(s=d)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let c=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}c=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}c=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(s===""?" ":"")}catch{}let d=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(d,"value")?.set;u?u.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{u?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function he(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let n=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=v(t),a=T(t)||T(i);if(!a)return n?e:i||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let h=v(r.textContent);if(h&&h.length>0&&h.length<150)return h}if(a.id){let h=document.querySelector(`label[for="${H(a.id)}"]`);if(h){let l=v(h.textContent);if(l&&l.length>0&&l.length<150)return l}}let s=a.getAttribute("aria-label");if(s)return v(s);let c=a.getAttribute("placeholder");if(c)return v(c);let d=v(a.textContent);if(d&&d.length>0&&d.length<120)return d;let u=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return u?v(u):n?e:i||e}function j(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,n=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!n&&t.hasAttribute("for")&&(n=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let i=e?"true":"false";t.setAttribute("aria-checked",i),t.setAttribute("aria-selected",i),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(n){if(n.checked===e)return;try{n.focus?.(),n.click()}catch{}if(n.checked!==e){try{let i=n._valueTracker;i&&i.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(n,e)}catch{}n.checked=e,vt(n,["input","change"])}}else{try{t.focus?.()}catch{}try{t.click()}catch{_(t)}}}function Ee(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let r=e.map(d=>v(d).toLowerCase()),s=!1,c=(d,u)=>{d.selected=!0,t.selectedIndex=u;try{t.value=d.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,d.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(d.value)}catch{}s=!0};for(let d=0;d<t.options.length;d++){let u=t.options[d],h=u.value.toLowerCase(),l=v(u.textContent).toLowerCase();if(r.some(g=>g===h||g===l)){if(c(u,d),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!s)for(let d of r){let u=d.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let h=parseInt(u[1],10),p=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(p>=0&&p<t.options.length&&(c(t.options[p],p),!t.multiple))break}}if(!s){for(let d of r)if(/^[a-z]$/i.test(d)){let u=d.toUpperCase().charCodeAt(0)-65,l=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(l>=0&&l<t.options.length&&(c(t.options[l],l),!t.multiple))break}}if(!s){let d=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let h=t.options[u],l=d(h.value.toLowerCase()),p=d(v(h.textContent).toLowerCase());if(r.some(x=>{let f=d(x);return l.includes(f)||p.includes(f)||f.length>2&&(f.includes(l)||f.includes(p))})&&(c(h,u),!t.multiple))break}}if(s){vt(t,["focus","input","change","blur"]);return}}let n=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');n&&_(n);let i=e.map(r=>v(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>L(r)&&!k(r));for(let r of i){let s=a.find(d=>{let u=v(d.textContent).toLowerCase(),h=v(d.getAttribute("data-value")||d.getAttribute("value")||"").toLowerCase();return u===r||h===r||u.includes(r)||r.length>2&&r.includes(u)});if(s){_(s);let d=s.querySelector('input[type="radio"], input[type="checkbox"]');d&&j(d,!0);return}let c=T(r);if(c){_(c);return}}}function Ot(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function je(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function K(o,e){let t=v(o).toLowerCase();if(!t)return null;let n=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',i=Array.from(document.querySelectorAll(n)),a=e==="destination"?i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t)):null;return a&&L(a)&&!k(a)?a:i.find(r=>{if(!L(r)||k(r))return!1;let s=v(`${r.textContent||""} ${r.getAttribute("data-category")||""} ${r.getAttribute("data-dropzone")||""}`).toLowerCase();return s===t||s.includes(t)})||null}async function Te(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let n=o.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(n.left+Math.max(1,n.width/2)),r=Math.round(n.top+Math.max(1,n.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),c=Math.round(i.top+Math.max(1,i.height/2)),d=v(e.textContent).toLowerCase();if(d){let x=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(f=>{let m=v(f.textContent).toLowerCase(),b=f instanceof HTMLInputElement||f instanceof HTMLOptionElement?v(f.value).toLowerCase():"";return m&&(d.includes(m)||m.includes(d))||b&&(d.includes(b)||b.includes(d))});x&&(_(x),await new Promise(f=>setTimeout(f,120)))}je(o),await new Promise(g=>setTimeout(g,140)),je(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&je(u),await new Promise(g=>setTimeout(g,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",h));let l=4;for(let g=1;g<=l;g++){let x=Math.round(a+(s-a)*(g/l)),f=Math.round(r+(c-r)*(g/l)),m={...h,clientX:x,clientY:f,screenX:x,screenY:f};try{o.dispatchEvent(new PointerEvent("pointermove",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",m))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:c,screenX:s,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let g=Ot(A(o.textContent),o.outerHTML),x={...h},f={...p};g&&(x.dataTransfer=g,f.dataTransfer=g);let m=o.ownerDocument.defaultView?.DragEvent;if(!m)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new m("dragstart",x)),e.dispatchEvent(new m("dragenter",f)),e.dispatchEvent(new m("dragover",f)),e.dispatchEvent(new m("drop",f)),o.dispatchEvent(new m("dragend",x))}catch(g){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",g)}try{let g=new Touch({identifier:1,target:o,clientX:a,clientY:r}),x=new Touch({identifier:1,target:e,clientX:s,clientY:c});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[x]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(g=>setTimeout(g,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var yt={fill:(o,e)=>{let t=T(o);t?we(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=T(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?j(e,!0):_(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=T(o);t?j(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>T(o,e),drag:(o,e)=>{let t=K(o,"source")||T(o),n=K(e,"destination")||T(e);t&&n?Te(t,n):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=K(o,"source")||T(o),n=K(e,"destination")||T(e);if(!t||!n){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Te(t,n)},execute:(o,e=!1,t=1)=>Qe(o,e,t)};typeof window<"u"&&(window.$eq=yt);async function Dt(o,e=1,t=de()){if(Ne(o,t),o.t==="js"){let s=String(o.v||"");dt(s);try{new Function("$eq","document","window",s)(yt,document,window)}catch(c){throw console.warn("[EasyQuiz JS Execution]",c),c}return}if(o.t==="drag"){let s=K(o.from,"source")||T(o.from),c=K(o.to,"destination")||T(o.to);!s&&o.from&&(s=T(v(o.from))),!c&&o.to&&(c=T(v(o.to))),s&&c?await Te(s,c,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let n=o.id!==void 0&&o.id!==null?String(o.id):"";!n&&o.t==="val"&&(n=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,a=i!=null?String(i).trim():"",r=T(n,a,o.t==="val"||o.t==="sel");if(!r&&n&&(r=T(v(n),a,o.t==="val"||o.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(v(r.value).toLowerCase()!==v(a).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${H(r.name)}"][value="${H(a)}" i]`);if(s)r=s;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${H(r.name)}"]`)).find(u=>{let h=u.closest("label, .vf-label, .option-card, tr, td, div");return h&&v(h.textContent).toLowerCase().includes(v(a).toLowerCase())});d&&(r=d)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let s=r.querySelector(`input[value="${H(a)}" i], [data-value="${H(a)}" i]`);if(s)r=s;else{let d=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(u=>{let h=u.closest("label, .vf-label, .option-card, td, div");return h&&v(h.textContent).toLowerCase().includes(v(a).toLowerCase())});d&&(r=d)}}}if(!r&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=N()||document.body}catch{}let c=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(d=>L(d)&&!k(d));if(c.length===1)r=c[0];else if(c.length>1){let d=v(n).toLowerCase(),u=d.match(/^#?_?([0-9]+)$/);if(u){let h=parseInt(u[1],10);h>=1&&h<=c.length?r=c[h-1]:h>=0&&h<c.length&&(r=c[h])}r||(r=c.find(l=>{let p=(l.getAttribute("placeholder")||"").toLowerCase(),g=(l.name||"").toLowerCase(),x=(l.getAttribute("aria-label")||"").toLowerCase(),f=(l.id||"").toLowerCase(),m=v(De(l)).toLowerCase(),b=v(l.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(d)||g.includes(d)||x.includes(d)||f.includes(d)||m&&m.includes(d)||d.length>=2&&b.includes(d)})||(c.length===1?c[0]:null))}}if(!r&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${n}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":if(r){let c=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!c){let l=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');l&&(c=l)}if(!c){let h=r.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){c=h;break}let l=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l){c=l;break}h=h.nextElementSibling}}if(!c){let h=document.body;try{h=N()||document.body}catch{}let l=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>L(p)&&!k(p));l.length>0&&(c=l[0])}let d=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,u=d!=null?String(d):"";we(c||r,u)}break;case"chk":r&&j(r,!!o.c);break;case"sel":if(r){let c=Array.isArray(o.v)?o.v:[String(o.v)];Ee(r,c)}break;case"clk":if(r)if(!!(r.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let d=o.c!==void 0?!!o.c:!0;j(r,d)}else _(r,o.co);break;case"adv":let s=Ge(o.id);if(s){await Fe(s,1200);let c=o.id||s.textContent?.trim()||"";c&&ke(window.location.hostname,{advanceSelector:c}),_(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Vt(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!L(t)||k(t)||t.closest("header, nav, aside"))return!1;let n=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||n||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function Ge(o){if(o){let a=T(o);if(a&&L(a)&&!k(a)&&!I(a))return a}try{let a=re(window.location.hostname);if(a.advanceSelector){let r=T(a.advanceSelector);if(r&&L(r)&&!k(r)&&!I(r))return r}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),n=Array.from(document.querySelectorAll(e)).filter(a=>L(a)&&!k(a)&&!a.closest("header, nav, aside")&&!I(a));for(let a of n)if(G(a)&&!I(a))return a;for(let a of n){let r=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"",s=(a.textContent||r||a.getAttribute("aria-label")||"").trim();if(ye.test(s)&&!I(a))return a}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&L(i)&&!k(i)&&!I(i)?i:null}async function Fe(o,e=1500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,100))}}function xt(){let o=(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim(),e=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"]').length;return`${window.location.href}|${document.title}|${o.slice(0,900)}|${e}`}async function _t(o,e=1800){let t=Date.now();for(;Date.now()-t<e;){if(xt()!==o)return{changed:!0,evidence:"URL, texto, t\xEDtulo ou conjunto de controles mudou ap\xF3s a a\xE7\xE3o."};await new Promise(i=>setTimeout(i,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a observ\xE1vel foi detectada dentro do tempo limite."}}async function bt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let i=T(o.from)||T(v(o.from)),a=T(o.to)||T(v(o.to));i&&a&&await Te(i,a,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",n=T(e,t)||T(v(e),t);if(o.t==="clk"||o.t==="chk"){if(!n&&e){let a=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),r=v(e).toLowerCase();n=a.find(s=>{let c=v(s.textContent).toLowerCase(),d=v(s.value||"").toLowerCase();return c.includes(r)||d===r||c.startsWith(r+")")||c.startsWith("("+r+")")})||null}let i=o.v!==void 0?String(o.v).trim():"";if(n&&i){if(n instanceof HTMLInputElement&&n.type==="radio"&&n.name){if(v(n.value).toLowerCase()!==v(i).toLowerCase()){let a=document.querySelector(`input[type="radio"][name="${H(n.name)}"][value="${H(i)}" i]`);if(a)n=a;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${H(n.name)}"]`)).find(c=>{let d=c.closest("label, .vf-label, .option-card, tr, td, div");return d&&v(d.textContent).toLowerCase().includes(v(i).toLowerCase())});s&&(n=s)}}}else if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLSelectElement)&&!(n instanceof HTMLTextAreaElement)){let a=n.querySelector(`input[value="${H(i)}" i], [data-value="${H(i)}" i]`);if(a)n=a;else{let s=Array.from(n.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(c=>{let d=c.closest("label, .vf-label, .option-card, td, div");return d&&v(d.textContent).toLowerCase().includes(v(i).toLowerCase())});s&&(n=s)}}}if(n){let a=n.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,r=n instanceof HTMLInputElement&&["radio","checkbox"].includes(n.type)?n:a.querySelector('input[type="radio"], input[type="checkbox"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(j(r||a,s),r&&r.checked!==s){try{let c=r._valueTracker;c&&c.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(r,s)}catch{}r.checked=s,r.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),r.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let i=null;if(n&&(i=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let a=document.body;try{a=N()||document.body}catch{}let r=Array.from(a.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=v(e).toLowerCase();i=r.find(c=>{let d=(c.getAttribute("placeholder")||"").toLowerCase(),u=(c.name||"").toLowerCase(),h=(c.id||"").toLowerCase(),l=(c.getAttribute("aria-label")||"").toLowerCase();return d.includes(s)||u.includes(s)||h.includes(s)||l.includes(s)})||(r.length>0?r[0]:null)}if(i){let a=String(o.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,a)}}catch{}we(i,a)}return}if(o.t==="sel"){if(!n&&e){let i=Array.from(document.querySelectorAll("select")),a=v(e).toLowerCase();n=i.find(r=>{let s=(r.name||"").toLowerCase(),c=(r.id||"").toLowerCase(),d=(r.getAttribute("aria-label")||"").toLowerCase();return s.includes(a)||c.includes(a)||d.includes(a)})||null}if(n){let i=Array.isArray(o.v)?o.v:[String(o.v)];Ee(n,i)}return}}function ie(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),n=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let a=T(i,n,!0)||T(v(i),n,!0);if(!a){let h=document.body;try{h=N()||document.body}catch{}let l=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>L(p)&&!k(p));l.length>0&&(a=l[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let h=document.querySelector(`input[type="radio"][name="${H(r.name)}"]:checked`);if(!h)return!1;let l=v(h.value).toLowerCase(),p=v(t).toLowerCase(),g=v(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return l===p||g===p||g.includes(p)}let s=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let l=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');l&&(s=l)}if(!s){let h=a.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){s=h;break}let l=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l){s=l;break}h=h.nextElementSibling}}if(s instanceof HTMLSelectElement){let h=v(t).toLowerCase();return Array.from(s.options).some(l=>{if(!l.selected)return!1;let p=l.value.toLowerCase(),g=v(l.textContent).toLowerCase();return h===p||h===g||p.includes(h)||g.includes(h)})}let c=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??a.textContent??"").trim();if(!c&&!t)return!0;if(!c&&t)return!1;let d=c.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return d===u||d.includes(u)||u.includes(d)||c.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=T(o.id,void 0,!0)||T(v(o.id),void 0,!0);if(!e){let a=document.body;try{a=N()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(d=>L(d)&&!k(d)),s=v(o.id).toLowerCase();e=r.find(d=>{let u=(d.id||"").toLowerCase(),h=(d.getAttribute("name")||"").toLowerCase(),l=(d.getAttribute("aria-label")||"").toLowerCase(),p=v(d.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(s)||h.includes(s)||l.includes(s)||s.length>=2&&p.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(d=>v(d).toLowerCase()),c=v(a.textContent).toLowerCase();return s.some(d=>c.includes(d)||d.includes(c))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(a=>v(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),s=v(a.textContent).toLowerCase();return i.some(c=>c===r||c===s||r.includes(c)||s.includes(c))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=T(o.id,e)||T(v(o.id),e);if(!t)return!1;let n=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,i=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:n.querySelector('input[type="checkbox"], input[type="radio"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),a=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(i&&i.type==="radio"){if(i.checked===a)return!0;if(o.v&&i.name){let u=v(String(o.v)).toLowerCase(),h=document.querySelector(`input[type="radio"][name="${H(i.name)}"]:checked`);if(!h)return!1;if(h===i)return!0;let l=v(h.value).toLowerCase(),p=v(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return l===u||p.includes(u)||u.includes(l)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===a;let r=n.getAttribute("aria-checked")===String(a)||n.getAttribute("aria-selected")===String(a)||n.getAttribute("aria-pressed")===String(a),s=a?n.getAttribute("data-selected")==="true"||n.getAttribute("data-checked")==="true"||n.getAttribute("data-active")==="true"||n.getAttribute("data-state")==="checked"||n.getAttribute("data-state")==="on":n.getAttribute("data-selected")==="false"||n.getAttribute("data-checked")==="false"||n.getAttribute("data-state")==="unchecked",c=a?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(n.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(n.className||"");return!!(r||s||c||(n instanceof HTMLButtonElement||n.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!i)}if(o.t==="drag"){let e=T(o.from)||T(v(o.from)),t=T(o.to)||T(v(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function Qe(o,e,t=1,n=de({engine:"smart",autoAdvance:e})){let i=o.actions.filter(m=>m.t!=="adv"),a=o.actions.filter(m=>m.t==="adv"),r=0,s=[],c=new Map,d=o.pageType==="question",u=i.filter(m=>m.t==="chk"||m.t==="clk"&&m.c!==void 0);if(d&&u.length>0){let m=document.body;try{m=N()||document.body}catch{}let b=Array.from(m.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(y=>L(y)&&!k(y));if(b.length>1){let y=new Set;for(let q of u){let E=q.t==="chk"?!!q.c:!!(q.c??!0),C="id"in q&&typeof q.id=="string"?q.id:"";if(E&&C){let M=T(C,q.v);if(M){let S=M instanceof HTMLInputElement&&M.type==="checkbox"?M:M.querySelector('input[type="checkbox"]');y.add(S||M)}}}if(y.size>0)for(let q of b)y.has(q)||(q instanceof HTMLInputElement&&q.checked||q.getAttribute("aria-checked")==="true"||q.closest(".option-card, label")?.classList.contains("selected"))&&j(q,!1)}}for(let m of i){try{await Dt(m,t,n),r++}catch(b){c.set(m,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",m,b)}await new Promise(b=>setTimeout(b,m.t==="drag"?250:70))}await new Promise(m=>setTimeout(m,i.length>0?300:50));let h=0;for(let m of i){if(ie(m)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${m.t}' no alvo '${m.id||m.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ne(m,n),await bt(m)}catch(b){c.set(m,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",b)}await new Promise(b=>setTimeout(b,180)),ie(m)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++)}if(h<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-h} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(m=>setTimeout(m,200));for(let m of i)if(!ie(m))try{await bt(m)}catch(b){c.set(m,b instanceof Error?b.message:String(b))}await new Promise(m=>setTimeout(m,200)),h=0;for(let m of i)ie(m)&&h++}for(let m of i)ie(m)||s.push(m.t==="drag"?`${m.from} -> ${m.to}`:"id"in m?m.id:m.t);d&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let l=i.map((m,b)=>{let y=m.t==="drag"?`${m.from} -> ${m.to}`:m.t==="js"?"$eq":m.id||m.t,q=m.t==="js"?!0:m.t==="drag"?!!(K(m.from,"source")&&K(m.to,"destination")):!!(T(m.id||"")||T(v(m.id||""))),E=ie(m);return{index:b,action:m,target:y,located:q,applied:!c.has(m),verified:E,strategy:m.t==="drag"?"drag-adaptive":m.t==="js"?"javascript":"declarative-dom",evidence:E?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(m)?{error:c.get(m)}:{}}}),p=d?i.length>0&&s.length===0&&(h===i.length||r===i.length&&h>0):!0,g=!1,x=!1,f="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.";if(e&&(p||!d)){await new Promise(E=>setTimeout(E,i.length>0?400:150));let m=!1;if(o.pageType!=="info"){let E=Vt();E&&L(E)&&(await Fe(E,1200),_(E),m=!0,await new Promise(C=>setTimeout(C,800)))}let b=xt(),y=a.length>0?a[0].id:void 0,q=Ge(y);if(!q&&m&&(await new Promise(E=>setTimeout(E,600)),q=Ge(y)),q){await Fe(q,1500);let E=y||q.textContent?.trim()||"";E&&ke(window.location.hostname,{advanceSelector:E}),_(q);let C=await _t(b,2500);x=C.changed,f=C.evidence,g=C.changed||m,!C.changed&&!m&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else m?(g=!0,x=!0,f="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:r,verified:h,success:p,advanced:g,failed:s,reports:l,navigationVerified:x,navigationEvidence:f}}var me=null,Z=[],Ue=[],jt=`
...
`;function Gt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=jt,document.head.appendChild(o)}}catch{}}function ee(){me&&(me.style.removeProperty("outline"),me.style.removeProperty("outline-offset"),me=null);for(let o of Z)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");Z=[];for(let o of Ue)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");Ue=[]}function Ke(o){Gt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),Ue.push(t)}}function Ye(o){ee(),me=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px"}function qt(o){for(let e of o){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let d=T(e.from),u=T(e.to);d&&(d.style.outline="2px solid #00ff88",Z.push(d)),u&&(u.style.outline="2px dashed #00e5ff",Z.push(u))}catch{}continue}if(!e.id)continue;let t=e.v!==void 0?Array.isArray(e.v)?e.v[0]:String(e.v):"",n=T(e.id,t,e.t==="val"||e.t==="sel")||T(v(e.id),t,e.t==="val"||e.t==="sel");if(!n&&e.t==="sel"){let d=document.body;try{d=N()||document.body}catch{}let u=Array.from(d.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(p=>L(p)&&!ae(p)),h=v(e.id).toLowerCase();n=u.find(p=>{let g=(p.id||"").toLowerCase(),x=(p.getAttribute("name")||"").toLowerCase(),f=(p.getAttribute("aria-label")||"").toLowerCase(),m=v(p.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return g.includes(h)||x.includes(h)||f.includes(h)||h.length>=2&&m.includes(h)})||(u.length===1?u[0]:null)}if(!n)continue;let i=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox",r=n.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||n;r.style.outline="2px solid #00ff88",r.style.outlineOffset="2px",r.style.backgroundColor="rgba(0, 255, 136, 0.12)",r.setAttribute("data-easyquiz-highlight","true"),Z.push(r);let s=i?n:r.querySelector('select, [role="combobox"], [role="listbox"]');s&&(s.style.outline="2px solid #00ff88",s.style.outlineOffset="2px",s.style.boxShadow="0 0 10px rgba(0, 255, 136, 0.8)",s.setAttribute("data-easyquiz-highlight","true"),Z.push(s));let c=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:r.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==r&&(c.style.outline="2px solid #00ff88",c.style.outlineOffset="2px",c.style.boxShadow="0 0 10px rgba(0, 255, 136, 0.8)",c.setAttribute("data-easyquiz-highlight","true"),Z.push(c))}}var Je=10,Ft=1400,Xe=15e5;function se(o){return new Promise((e,t)=>{let n=new FileReader;n.onerror=()=>t(new Error("Falha ao converter blob para base64.")),n.onload=()=>{let i=String(n.result||"");e(i.split(",")[1]||"")},n.readAsDataURL(o)})}async function ge(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let n=Math.min(1,Ft/Math.max(e,t)),i=Math.max(1,Math.round(e*n)),a=Math.max(1,Math.round(t*n)),r=document.createElement("canvas");r.width=i,r.height=a;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,a),s.drawImage(o,0,0,i,a),new Promise((c,d)=>{r.toBlob(u=>u?c(u):d(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Qt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,n=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(n*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(a)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&n>0&&s.setAttribute("viewBox",`0 0 ${t} ${n}`);let d=new XMLSerializer().serializeToString(s),u=new Blob([d],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(u);try{let l=new Image;l.crossOrigin="anonymous",await new Promise((x,f)=>{l.onload=()=>x(),l.onerror=()=>f(new Error("Falha ao renderizar SVG em Image.")),l.src=h});let p=document.createElement("canvas");p.width=a,p.height=r;let g=p.getContext("2d",{alpha:!1});if(!g)throw new Error("Sem suporte a Canvas 2D.");return g.fillStyle="#ffffff",g.fillRect(0,0,a,r),g.drawImage(l,0,0,a,r),new Promise((x,f)=>{p.toBlob(m=>m?x(m):f(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(h)}}async function We(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,n=o.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=n=>{if(n.target.closest(".eq-fah-btn"))return;n.preventDefault(),this.isDragging=!0,this.dragStartX=n.clientX,this.dragStartY=n.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let a=s=>{if(!this.isDragging||!this.element)return;let c=s.clientX-this.dragStartX,d=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),l=Math.min(Math.max(10,this.initialLeft+c),u),p=Math.min(Math.max(10,this.initialTop+d),h);this.element.style.left=`${l}px`,this.element.style.top=`${p}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),n=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,a=i.actions.filter(p=>p.t==="drag"),r=i.actions.filter(p=>{if(p.t!=="val")return!1;let g=v(p.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(g)}),s=i.actions.filter(p=>p.t==="clk"||p.t==="chk"),c=i.actions.filter(p=>p.t==="sel"),d=a.length||r.length||s.length||c.length,u=document.createElement("div");u.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let l=document.createElement("span");if(l.className="eq-fah-meta-badge",l.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,u.append(h,l),e.appendChild(u),a.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,n.textContent=String(a.length);let p={};for(let g of a){let x=v(g.to)||"Geral";p[x]||(p[x]=[]),p[x].push(v(g.from))}for(let[g,x]of Object.entries(p)){let f=document.createElement("div"),m=/fato|true|verdadeiro|sim/i.test(g),b=/opini[aã]o|false|falso|n[aã]o/i.test(g);f.className=`eq-fah-group ${m?"group-fato":b?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${g} (${x.length})`,f.appendChild(y);let q=document.createElement("div");q.className="eq-fah-group-items";for(let E of x){let C=document.createElement("div");C.className="eq-fah-item";let M=document.createElement("span");M.className="eq-fah-item-text",M.textContent=E,C.appendChild(M);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(E),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),C.appendChild(S),q.appendChild(C)}f.appendChild(q),e.appendChild(f)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,n.textContent=String(r.length);let p=document.createElement("div");p.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4DD} Respostas para os Campos de Texto:",p.appendChild(g);let x=document.createElement("div");x.className="eq-fah-group-items";for(let f=0;f<r.length;f++){let m=r[f],b=document.createElement("div");b.className="eq-fah-item";let y=he(m.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${f+1}`);let q=String(m.v??""),E=document.createElement("div");E.className="eq-fah-field-box";let C=document.createElement("div");C.className="eq-fah-field-label",C.textContent=y,E.appendChild(C);let M=document.createElement("div");M.className="eq-fah-field-val",M.textContent=q,E.appendChild(M),b.appendChild(E);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(q),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),b.appendChild(S),x.appendChild(b)}p.appendChild(x),e.appendChild(p)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,n.textContent=String(s.length);let p=document.createElement("div");p.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F3AF} Alternativa(s) Correta(s):",p.appendChild(g);let x=document.createElement("div");x.className="eq-fah-group-items";for(let f=0;f<s.length;f++){let m=s[f],b=document.createElement("div");b.className="eq-fah-item";let y=he(m.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&m.v&&(y=String(m.v)),y=v(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let q="",E=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);E?(q=E[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=E[2].trim()||y):s.length>1&&(q=String.fromCharCode(65+f));let C=document.createElement("div");if(C.style.display="flex",C.style.alignItems="center",C.style.gap="8px",C.style.flex="1",q){let P=document.createElement("span");P.className="eq-fah-letter-badge",P.textContent=q,C.appendChild(P)}let M=document.createElement("span");M.className="eq-fah-item-text",M.textContent=y||(q?`Alternativa ${q}`:"Alternativa Selecionada"),C.appendChild(M),b.appendChild(C);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(y||q),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),b.appendChild(S),x.appendChild(b)}p.appendChild(x),e.appendChild(p)}else if(c.length>0){t.textContent=`Sele\xE7\xE3o (${c.length} listas)`,n.textContent=String(c.length);let p=document.createElement("div");p.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",p.appendChild(g);let x=document.createElement("div");x.className="eq-fah-group-items";for(let f=0;f<c.length;f++){let m=c[f],b=document.createElement("div");b.className="eq-fah-item";let y=he(m.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${f+1}`);let C=(Array.isArray(m.v)?m.v:[String(m.v??"")]).map($=>{let B=T(m.id,void 0,!0)||T(v(m.id),void 0,!0),R=B instanceof HTMLSelectElement?B:B?.querySelector("select");if(R){let F=v($).toLowerCase();for(let Y=0;Y<R.options.length;Y++){let te=R.options[Y];if(te.value.toLowerCase()===F||v(te.textContent).toLowerCase()===F){let V=v(te.textContent);if(V&&!V.toLowerCase().includes("selecione"))return V}}}return $}).join(", "),M=document.createElement("div");M.className="eq-fah-field-box";let S=document.createElement("div");S.className="eq-fah-field-label",S.textContent=y,M.appendChild(S);let P=document.createElement("div");P.className="eq-fah-field-val",P.textContent=C,M.appendChild(P),b.appendChild(M);let z=document.createElement("button");z.className="eq-fah-copy-inline",z.textContent="Copiar",z.addEventListener("click",()=>{navigator.clipboard.writeText(C),z.textContent="\u2713 Copiado",setTimeout(()=>z.textContent="Copiar",1200)}),b.appendChild(z),x.appendChild(b)}p.appendChild(x),e.appendChild(p)}else{t.textContent="Gabarito",n.textContent="0";let p=document.createElement("div");p.style.padding="10px",p.style.color="#888",p.textContent="Nenhuma resposta direta para exibir.",e.appendChild(p)}if(i.rationale){let p=document.createElement("div");p.className="eq-fah-rationale",p.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(p)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let n=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),a=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),r=e.actions.filter(s=>s.t==="sel");if(n.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let c of n){let d=v(c.to)||"Geral";s[d]||(s[d]=[]),s[d].push(v(c.from))}for(let[c,d]of Object.entries(s)){t.push(`### Categoria: ${c}`);for(let u of d)t.push(`- ${u}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let c=v(s.id);t.push(`- **${c||"Campo"}:** \`${s.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<a.length;s++){let c=a[s],d=he(c.id);(!d||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(d))&&c.v&&(d=String(c.v)),d=v(d),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(d)&&(d="");let u=a.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${d||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of r){let c=v(s.id)||"Lista",d=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${c}:** \`${d}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let n=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=n},1500)})}};var wt=`
