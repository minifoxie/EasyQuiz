 ...
 */
"use strict";(()=>{var fe={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0};function se(n){if(!n||typeof n!="string")return!1;let e=n.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of t)if(e.includes(o))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var dt="easyquiz_settings_v2",ke="easyquiz_activity_metrics";function pt(){try{let n=localStorage.getItem(dt);if(!n){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let i=JSON.parse(r);return{...fe,apiKey:i.apiKey||""}}return{...fe}}let e=JSON.parse(n),t=typeof e.model=="string"&&se(e.model)?e.model:fe.model,o=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],s=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(o.length===0&&s&&(o=[s]),o.length===0)try{let r=localStorage.getItem("easyquiz_api_keys");if(r){let i=JSON.parse(r);Array.isArray(i)&&(o=i.filter(c=>typeof c=="string"&&c.trim().length>5))}}catch{}return{apiKey:o[0]||s||fe.apiKey,apiKeys:o,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:fe.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:fe.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:fe.confidenceThreshold}}catch{return{...fe}}}function Dt(){try{localStorage.removeItem(dt),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(ke),sessionStorage.removeItem(ke);let n=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&n.push(t)}n.forEach(e=>localStorage.removeItem(e)),We()}catch(n){console.warn("[EasyQuiz] Erro ao resetar dados:",n)}}function ut(n){try{let e=localStorage.getItem("eq_domain_cache_"+n);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+n)}catch{}}return t}catch{return{}}}function mt(n,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...ut(n),...e};try{localStorage.setItem("eq_domain_cache_"+n,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function Bt(n){let e=pt(),t=Array.isArray(n.apiKeys)?n.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,o;typeof n.apiKey=="string"?o=n.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(n.apiKeys)&&n.apiKeys.length>0?o=t[0]||"":o=e.apiKey,o&&!t.includes(o)&&(t=[o,...t]),t.length>0&&(!o||!t.includes(o))&&(o=t[0]);let s={...e,...n,apiKey:o,apiKeys:t};try{localStorage.setItem(dt,JSON.stringify(s)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return s}var qe=[],Ot=12,pn=1200;function Nt(n){let e=n.trim().replace(/\s+/g," ").slice(0,pn);e&&!qe.includes(e)&&(qe.push(e),qe.length>Ot&&(qe=qe.slice(-Ot)))}function Je(){return qe}function We(){qe=[]}function Rt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Be=Rt();function Ne(){try{localStorage.removeItem(ke)}catch{}return Be}function un(n){Be=n;try{let e=JSON.stringify(n);sessionStorage.setItem(ke,e),localStorage.removeItem(ke)}catch{}}function Qt(n){let e=Be,t=Date.now(),o=e.records[e.records.length-1];if(o&&o.id===n.id&&t-o.timestamp<3e3)return e;let s={...n,timestamp:t},a=[...e.records,s],r=a.filter(p=>p.status==="answered"||p.status==="verified").length,i=a.reduce((p,f)=>p+f.durationMs,0),c=r>0?Math.round(i/r):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),i),completedQuestionsCount:r,averageDurationMs:c,records:a};return un(l),l}function Re(){Be=Rt();try{sessionStorage.removeItem(ke),localStorage.removeItem(ke)}catch{}return Be}var jt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(n)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(n)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(n)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(n)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(n)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Qe(n,e,t){let o=n.htmlSnippet.includes("draggable")||n.htmlSnippet.includes("perseus")||n.htmlSnippet.includes("category")||n.htmlSnippet.includes("dropzone")||n.controls.some(y=>y.type==="draggable"||y.type==="dropzone"),s=/katex|latex|\\frac|\\sqrt/i.test(n.htmlSnippet),a=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(n.sourceUrl)||n.htmlSnippet.includes("Qr7Oae")||n.htmlSnippet.includes("data-item-id")||n.htmlSnippet.includes("freebirdFormviewer"),r=(/wayground|quizizz/i.test(n.sourceUrl)||n.htmlSnippet.includes("data-functional-selector"))&&(n.htmlSnippet.includes("classification")||n.controls.filter(y=>y.role==="answer").length===0),i=n.controls.filter(y=>y.role!=="navigation").length===0,c=i||o||a||r||s&&n.questionText.length<60,l=i?4500:r?6e3:1800,p=c?`
[HTML]:
${n.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",f="";if(i&&typeof document<"u")try{let y=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(A=>{let C=A,x=C.getBoundingClientRect?.()||{width:0,height:0};return x.width>0&&x.height>0&&!C.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(A=>{let C=A,x=C.tagName.toLowerCase(),w=C.id?`#${C.id}`:"",T=C.className&&typeof C.className=="string"?`.${C.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",k=(C.textContent||C.value||C.getAttribute("aria-label")||"").trim().slice(0,60),E=C.getAttribute("type")||C.getAttribute("role")||"";return`${x}${w}${T}[${E}] txt="${k}"`});y.length>0&&(f=`
[DOM-INTERATIVO]:
${y.join(`
`)}`)}catch{}let d=Je(),m=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",u=n.controls.filter(y=>y.role!=="navigation"),h=n.controls.filter(y=>y.role==="navigation"),b=mn(n.sourceUrl,n.htmlSnippet),v=b?`
${b}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(u.length===0)return"Nenhuma";let y=u.filter(q=>q.type==="checkbox"||q.type==="chk"),A=new Set(u.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),C=y.filter(q=>!q.name||!A.has(q.name)),x=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),w=C.length>=2||x,T=A.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&A.size>=1,k=u.every(q=>q.type==="radio"||q.type==="chk")&&A.size===1&&!w&&!T,E=u.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),I=E.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${A.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${A.size} afirma\xE7\xF5es \u2014 emita ${A.size} a\xE7\xF5es chk separadas + adv]
...
`:"")+JSON.stringify(u.map(q=>({id:q.id,t:q.type,n:q.name||void 0,txt:q.label?q.label.length>160?q.label.slice(0,160)+"...":q.label:void 0,v:q.value||void 0,opt:q.options&&q.options.length?q.options.slice(0,20).map(H=>H.label||H.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${h.length>0?h.map(y=>`"${y.label||y.id}"[${y.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length===0?"Nenhum anexo visual.":e.map((y,A)=>{let C=y.associatedLabel||"Gr\xE1fico da Quest\xE3o",x=y.alt?` | alt: "${y.alt}"`:"";if(y.captureStatus==="text_only")return`  - Imagem ${A+1} [CONTEXTO_TEXTUAL]: ${C}${x} | ${y.textContext||"sem contexto adicional"}`;if(y.captureStatus==="captured"||y.base64){let w=y.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${y.textContext}"`:"";return`  - Imagem ${A+1} [VISUAL_INLINE]: ${C}${x}${w}`}return`  - Imagem ${A+1} [FALHOU]: ${C}${x}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var hn=new Set(["question","info","start","conclusion"]),fn=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),gn=new Set(["val","chk","sel","clk","adv","js","drag"]),bn=150,je=2e3;function re(n,e=""){return n==null?e:typeof n=="string"?n.trim().slice(0,je):typeof n=="number"||typeof n=="boolean"?String(n).trim().slice(0,je):e}function vn(n,e){if(!n||typeof n!="object")return null;let t=n,o=t.t;if(typeof o!="string"||!gn.has(o))return null;if(o==="adv"){let i=t.id??t.target??t.name??t.selector;return{t:"adv",...re(i)?{id:re(i,"").slice(0,500)}:{}}}if(o==="drag"){let i=re(t.from??t.source),c=re(t.to??t.target??t.destination);return!i||!c?null:{t:"drag",from:i.slice(0,500),to:c.slice(0,500)}}if(o==="js"){let i=re(t.v??t.code??t.script);return!i||i.length>8e3?null:{t:"js",v:i}}let s=t.id??t.target??t.name??t.selector??t.element;(s==null||s==="")&&o==="val"&&(s="1");let a=re(s).slice(0,500);if(!a)return null;if(o==="val"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:re(i).slice(0,je)}}if(o==="sel"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(i)?i:[i]).map(p=>re(p).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:l}}if(o==="chk"){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",c={t:"chk",id:a,c:!i};return t.v!==void 0&&(c.v=re(t.v).slice(0,je)),c}let r={t:"clk",id:a};if(t.c!==void 0){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!i}return t.v!==void 0&&(r.v=re(t.v).slice(0,je)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(i=>typeof i=="number"&&Number.isFinite(i))&&(r.co=[t.co[0],t.co[1]]),r}function yn(n,e,t){if(t!=="question")return n;let o=n.filter(a=>a.t==="adv"),s=n.filter(a=>a.t!=="adv");if(e==="escolha_unica"){s=s.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=s.filter(r=>r.t==="chk"||r.t==="clk");if(a.length>1){let r=s.filter(c=>c.t!=="chk"&&c.t!=="clk"),i=a[a.length-1];s=[...r,i]}}else if(e==="escolha_multipla"){s=s.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=new Set;s=s.filter(r=>{let i="id"in r&&typeof r.id=="string"?r.id:"";return i?a.has(i)?!1:(a.add(i),!0):!0})}else if(e==="verdadeiro_falso"){let a=new Set,r=[...s].reverse(),i=[];for(let c of r){let l="id"in c&&typeof c.id=="string"?c.id:"";l?a.has(l)||(a.add(l),i.push(c)):i.push(c)}s=i.reverse()}return[...s,...o]}function Ft(n){if(!n||typeof n!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=n,t=e.pageType,o=e.mode;(typeof t!="string"||!hn.has(t))&&(t="question"),(typeof o!="string"||!fn.has(o))&&(o="escolha_unica");let s=Array.isArray(e.actions)?e.actions:[],a=[];for(let c=0;c<Math.min(s.length,bn);c++){let l=vn(s[c],c);l&&a.push(l)}a.some(c=>c.t==="val")&&(o==="escolha_unica"||!e.mode)&&(o="preenchimento"),a.some(c=>c.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(o)&&(o="arrastar_soltar"),a=yn(a,o,t);let r=a.some(c=>c.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?r||a.push({t:"adv"}):t==="question"&&!r&&a.push({t:"adv"});let i=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:o,confidence:i,rationale:re(e.rationale,"Plano validado e auto-recuperado."),actions:a,...re(e.memoryToStore)?{memoryToStore:re(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var ce=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let o=e.flatMap(a=>a.split(/[\n\r]+/));Array.from(new Set(o.map(a=>a.trim().replace(/^["']|["']$/g,"")).filter(a=>a.length>5))).forEach((a,r)=>{let i=this.generateId(a),c=t.get(i)||t.get(a);this.keys.set(i,{id:i,key:a,label:c?.label||`Chave ${r+1}`,addedAt:c?.addedAt||Date.now(),lastUsedAt:c?.lastUsedAt,lastLatencyMs:c?.lastLatencyMs,cooldownUntil:c?.cooldownUntil,errorCount:c?.errorCount||0,lastError:c?.lastError,winCount:c?.winCount||0})})}generateId(e){let t=0;for(let s=0;s<e.length;s++)t=(t<<5)-t+e.charCodeAt(s),t|=0;let o=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${o}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let o=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:o>0,remainingCooldownMs:o}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),o=Array.from(this.keys.values()).filter(a=>(a.errorCount||0)<50);if(o.length===0)return Array.from(this.keys.values()).slice(0,e);let s=o.filter(a=>(a.cooldownUntil||0)<=t);return s.length>0?(s.sort((a,r)=>{let i=a.lastLatencyMs!==void 0?a.lastLatencyMs:99999,c=r.lastLatencyMs!==void 0?r.lastLatencyMs:99999;if(i!==c)return i-c;let l=(a.lastUsedAt||0)-(r.lastUsedAt||0);return l!==0?l:a.addedAt-r.addedAt}),s.slice(0,e)):(o.sort((a,r)=>(a.cooldownUntil||0)-(r.cooldownUntil||0)),o.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let o=this.findKeyObj(e);o&&(o.lastLatencyMs=t,o.lastUsedAt=Date.now(),o.errorCount=0,o.lastError=void 0,o.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let o=this.findKeyObj(e);o&&(o.errorCount=99,o.lastError=t)}addKey(e,t){let o=e.trim().replace(/^["']|["']$/g,"");if(!o)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(o.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let s=this.generateId(o);if(this.keys.has(s)||Array.from(this.keys.values()).some(i=>i.key===o))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let r={id:s,key:o,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(s,r),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:r}}updateKey(e,t,o){let s=this.keys.get(e);if(!s)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=t.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(s.key=a,o!==void 0&&(s.label=o.trim()),s.errorCount=0,s.cooldownUntil=void 0,s.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},j=new ce;var Ie=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Ut=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],An={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function gt(n){return An[n]??n}function xn(n,e){let o={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??wn};return/lite/i.test(n)||(/gemini-3\.[0-9]+-?flash/i.test(n)?o.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(n)&&(o.thinkingConfig={thinkingBudget:0})),o}var wn={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Xt(n){let e=n.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=gt(e);return se(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function ft(n,e){let t="";try{let o=JSON.parse(n);t=o.error?.message||o.message||""}catch{t=n.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function En(n){let e=n.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let o=e.match(/\{[\s\S]*\}/);if(o)try{return JSON.parse(o[0].trim())}catch{}try{let s=e.indexOf("{");if(s!==-1){let a=e.slice(s).trim();a=a.replace(/,\s*\{[^}]*$/,""),a=a.replace(/,\s*$/,"");let r=0,i=0,c=!1,l=!1;for(let f=0;f<a.length;f++){let d=a[f];if(l){l=!1;continue}if(d==="\\"){l=!0;continue}if(d==='"'){c=!c;continue}c||(d==="{"?r++:d==="}"?r=Math.max(0,r-1):d==="["?i++:d==="]"&&(i=Math.max(0,i-1)))}for(c&&(a+='"');i>0;)a+="]",i--;for(;r>0;)a+="}",r--;let p=JSON.parse(a);if(p&&typeof p=="object")return p}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Gt=(()=>{try{let n=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!n)return null;let e=JSON.parse(n);if(Array.isArray(e)){let t=e.filter(o=>o&&typeof o.id=="string"&&se(o.id));return t.length>0?t:null}return null}catch{return null}})(),ht=new Set;async function Ze(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return Ie;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of t)try{let s=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!s.ok){let r=await s.text(),i=ft(r,s.status);if(i.includes("inv\xE1lida")||i.includes("n\xE3o autorizada"))throw new Error(i);continue}let a=await s.json();if(Array.isArray(a.models)&&a.models.length>0){let r=a.models.filter(i=>{let c=i.supportedGenerationMethods||[],l=(i.name||"").replace(/^models\//,""),p=c.includes("generateContent");return se(l)&&p}).map(i=>{let c=i.supportedGenerationMethods||[],l=i.name.replace(/^models\//,""),p=i.displayName||l;return{id:l,name:p.includes(l)?p:`${p} (${l})`,description:i.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(r.length>0){r.sort((i,c)=>{let l=p=>p==="gemini-3.8-flash"?200:p==="gemini-3.7-flash"?190:p==="gemini-3.6-flash"?180:p==="gemini-3.5-flash"?170:p==="gemini-3.5-flash-lite"?160:p==="gemini-2.5-flash"?130:p.includes("flash")?80:p==="gemini-2.5-pro"?60:p.includes("pro")?50:10;return l(c.id)-l(i.id)}),Gt=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(s){if(s.message?.includes("Chave de API"))throw s}return Ie}async function $e(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await Ze(e);if(o.length>0&&o!==Ie){let s=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${s.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let o of t)for(let s of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${s}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${s})!`,models:Ie}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function bt(n,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:n,key:"",message:"Nenhuma chave dispon\xEDvel."};let o=gt(Xt(n)),s=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),a={"Content-Type":"application/json"};async function r(l,p,f){let d=new AbortController,m=setTimeout(()=>d.abort(),f);try{let u=`https://generativelanguage.googleapis.com/v1beta/models/${p}:generateContent?key=${encodeURIComponent(l)}`,h=await fetch(u,{method:"POST",headers:{...a,"x-goog-api-key":l},body:s,signal:d.signal});if(clearTimeout(m),h.ok)return{ok:!0,model:p,key:l,message:`Modelo '${p}' validado com sucesso!`};let b=await h.text().catch(()=>"");throw new Error(`HTTP ${h.status}: ${b.slice(0,80)}`)}catch(u){throw clearTimeout(m),u}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(f=>r(f,o,8e3)))}catch{}}let i=t[0],c=[o,...Ut.filter(l=>l!==o)];for(let l of c)try{let p=await r(i,l,4e3);return l!==o&&(p.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),p}catch{}return{ok:!1,model:o,key:i,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function Cn(n,e,t,o,s){let a=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${n}`),c={...xn(n,s)};for(let l of a){if(o.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let p=`https://generativelanguage.googleapis.com/${l}/models/${n}:generateContent?key=${encodeURIComponent(e)}`,f=Date.now();try{let d=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(!d.ok){let h=await d.text();if(d.status===400){let v=/thinking/i.test(h),y=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(h);if((v||y)&&(c.thinkingConfig||c.responseSchema)){let A={...c};v&&delete A.thinkingConfig,y&&(delete A.responseSchema,delete A.responseMimeType),c=A;let C=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(C.ok){let T=await C.json(),k=T.candidates?.[0];if(k?.content?.parts?.[0]?.text)return j.markSuccess(e,Date.now()-f),{rawText:k.content.parts[0].text,data:T,usedModel:n,usedKey:e}}let x=await C?.text?.().catch(()=>"")??h,w=ft(x,d.status);throw new Error(`[${n}|${ce.maskKey(e)}] ${w}`)}}let b=ft(h,d.status);if(d.status===404&&l==="v1beta")continue;throw d.status===429?(j.markQuotaHit(e,8e3),Kt(e,n,1e4),new Error(`[${n}|${ce.maskKey(e)}] ${b}`)):(d.status===503||/no capacity|overloaded|unavailable/i.test(h)?(j.markOverloaded(e,5e3),ht.add(n)):d.status===403||/API_KEY_INVALID/i.test(h)?j.markInvalid(e,b):d.status===404&&ht.add(n),new Error(`[${n}|${ce.maskKey(e)}] ${b}`))}let m=await d.json(),u=m.candidates?.[0];if(!u||!u.content?.parts?.[0]?.text)throw new Error(`[${n}|${ce.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return j.markSuccess(e,Date.now()-f),{rawText:u.content.parts[0].text,data:m,usedModel:n,usedKey:e}}catch(d){if(o.aborted)throw d;r=d;let m=r.message||"";if(m.includes("404")||/no longer available/i.test(m)){ht.add(n);break}if(m.includes("429")||m.includes("Quota"))break}}throw r}var Ye=new Map;function Vt(n,e){let t=`${n}::${e}`,o=Ye.get(t);return o===void 0?!1:Date.now()>o?(Ye.delete(t),!1):!0}function Kt(n,e,t=1e4){Ye.set(`${n}::${e}`,Date.now()+t)}function vt(){Ye.clear()}async function _e(n,e,t,o,s,a){if(s?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let r=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];j.init(r);let i=t.apiKey.trim().replace(/^["']|["']$/g,""),c=j.getBestKey()||i;if(!c)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=Xt(t.model);if(!Gt&&c&&Ze(c).catch(()=>{}),s?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let p=Date.now(),f=Qe(n,e,t),d=[{text:f}];for(let S=0;S<e.length;S++){let q=e[S],H=q.associatedLabel||(q.alt?`Imagem: ${q.alt}`:`Imagem ${S+1}`);if(q.captureStatus==="text_only"||!q.base64){let Q=q.textContext||q.alt||"";d.push({text:`[CONTEXTO_IMAGEM_${S+1} - V\xCDNCULO: ${H}]: ${Q}`})}else d.push({text:`[ANEXO VISUAL ${S+1} - V\xCDNCULO: ${H}]:`}),d.push({inline_data:{mime_type:q.mediaType,data:q.base64}})}let m={system_instruction:{parts:[{text:a?.systemPromptOverride??jt}]},contents:[{role:"user",parts:d}]},u=gt(l),h=Ut.filter(S=>S!==u),v=j.getAllKeys().length,y=S=>v<=1||S===0?1:2,A=new Set,C=(S,q)=>{let H=/pro/i.test(S),Q=/lite/i.test(S);return H?q===0?18e3:q===1?24e3:3e4:Q?q===0?1e4:q===1?14e3:18e3:q===0?16e3:q===1?2e4:25e3},x=async(S,q)=>{if(q.length===0||s?.aborted)return null;let H=q.map(()=>new AbortController),Q=()=>H.forEach(F=>{try{F.abort()}catch{}});s?.addEventListener("abort",Q,{once:!0});let V=q.map(F=>`${F.model.replace("gemini-","")}/${F.label}`).join(" | ");o?.(`\u26A1 ${S}: ${q.length} slot(s) [${V}]...`,"info");try{let F=q.map(async($,oe)=>{let _=H[oe],ee=setTimeout(()=>{try{_.abort(new Error(`Timeout ${$.timeout/1e3}s (${$.model}|${$.label})`))}catch{_.abort()}},$.timeout);try{let Z=await Cn($.model,$.key,m,_.signal,a?.generationSchemaOverride);clearTimeout(ee);let ne=Ft(En(Z.rawText));return ne.usedModel=Z.usedModel,ne.durationMs=Date.now()-p,ne.promptSent=f,ne.tokensUsed=Z.data.usageMetadata?.totalTokenCount,ne.promptTokens=Z.data.usageMetadata?.promptTokenCount,ne.candidatesTokens=Z.data.usageMetadata?.candidatesTokenCount,ne.rawResponse=Z.rawText,H.forEach((z,B)=>{if(B!==oe)try{z.abort(new Error("Cancelado: vencedor respondeu."))}catch{z.abort()}}),{plan:ne,rawUsage:Z.data.usageMetadata,usedModel:Z.usedModel,usedKey:Z.usedKey,slotLabel:$.label}}catch(Z){clearTimeout(ee);let ne=Z instanceof Error?Z.message:String(Z);throw(ne.includes("429")||ne.includes("Quota")||ne.includes("RESOURCE_EXHAUSTED"))&&(Kt($.key,$.model,1e4),j.markQuotaHit($.key,8e3)),Z}}),K=await Promise.any(F);return s?.removeEventListener("abort",Q),j.markWinner(K.usedKey),K}catch(F){return s?.removeEventListener("abort",Q),F instanceof AggregateError&&F.errors.length>0?E=F.errors.map(K=>K instanceof Error?K.message:String(K)).join(" | "):F instanceof Error&&(E=F.message),console.warn(`[EasyQuiz ${S}] Falha na onda:`,E),null}},T=(v<=1?1:1+Math.ceil((v-1)/2))+4,k=0,E="",I=0;for(;k<T;){if(s?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let S=j.getRoundRobinKeys(v),q=S.filter(_=>!A.has(`${_.key}::${u}`)&&!Vt(_.key,u)),H,Q;if(q.length>0)H=u,Q=q;else{let _=h;H=_[I%_.length]||u,I++;let ee=S.filter(Z=>!A.has(`${Z.key}::${H}`)&&!Vt(Z.key,H));Q=ee.length>0?ee:S.filter(Z=>!A.has(`${Z.key}::${H}`))}if(Q.length===0){if(I<h.length)continue;break}let V=Q.slice(0,y(k));if(V.length===0)break;let F=C(H,k),K=V.map(_=>(A.add(`${_.key}::${H}`),{model:H,key:_.key,label:_.label||"Chave",timeout:F})),$=k===0?"Onda 1":`Onda ${k+1}`,oe=await x($,K);if(oe){let _=oe.plan.durationMs||Date.now()-p,ee=ce.maskKey(oe.usedKey);return o?.(`\u2705 ${_}ms via '${oe.usedModel}' (${oe.slotLabel}: ${ee})`,"info"),oe}k++}throw new Error(E||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var Tn=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Le(n){let e=n?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return n?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!n?.autoAdvance}}function yt(n,e){if(n.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(n.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Jt(n){if(!n.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(n.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(Tn.find(t=>t.test(n)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(n)&&!n.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var He=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),Ve=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,ge=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,qn=0;function At(n){try{let e=n.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!ye(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(n):n.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof n.getBoundingClientRect=="function"){let e=n.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(n.textContent||"").trim().length>0}function W(n){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(n)}catch{}return String(n).replace(/["\\]/g,"\\$&")}function O(n){let e=n;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||ye(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let o=e.type?.toLowerCase();if(o==="checkbox"||o==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${W(e.id)}"]`);if(a&&At(a))return!0}catch{}let s=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(s&&s!==e&&At(s))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return At(e)}function kn(n){if(n==null)return"";if(typeof n=="string")return n;if(typeof n=="number"||typeof n=="boolean")return String(n);if(n instanceof Node)return n.textContent||"";try{if(typeof n?.toString=="function"){let e=n.toString();if(typeof e=="string")return e}}catch{}return""}function G(n,e=500){return kn(n).replace(/\s+/g," ").trim().slice(0,e)}function Ln(n){let e=n.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(qn+=1).toString(36)}`;return n.dataset.easyquizId=t,t}function ye(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Fe=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function Y(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element))return!1;if(ye(n))return!0;let e=n.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((n.type||"").toLowerCase()))return!1;let o=n.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||n,s=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||""),a=String(o.getAttribute?.("aria-label")||""),r=String(o.getAttribute?.("title")||""),i=typeof o.className=="string"?o.className:typeof o.className?.baseVal=="string"?o.className.baseVal:"",c=G(o.textContent,60);return!!(Fe.test(s)||Fe.test(a)||Fe.test(r)||Fe.test(i)||c.length>0&&c.length<=25&&Fe.test(c))}function le(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element)||ye(n)||Y(n)||n.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||n.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&n instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&n instanceof HTMLButtonElement?n.value:"",t=G(n.getAttribute?.("aria-label")||n.textContent||n.getAttribute?.("value")||e),o=n.type,s=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),a=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||n.getAttribute?.("href")||"").toLowerCase();return ge.test(s)||ge.test(t)?!1:Ve.test(s)||Ve.test(t)||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!n.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function xt(n){let e=n.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),l=c&&c!==n.closest("td")?G(c.textContent,100):"",p=G(n.closest("label, td")?.textContent||"",50);if(l&&p)return`${l}: ${p}`}let t=n.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let c=t.querySelector('.dropdown-label, [class*="label" i]'),l=c&&c!==n?G(c.textContent,150):"";if(l)return l}let o=n.getAttribute("aria-label");if(o)return G(o);let s=n.getAttribute("aria-labelledby");if(s){let c=s.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(c.trim())return G(c)}if("labels"in n&&n.labels){let c=Array.from(n.labels??[]).map(l=>l.textContent).join(" ");if(c.trim())return G(c)}let a=n.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==n){let c=G(a.textContent);if(c)return c}let r=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",i=n.getAttribute("placeholder")||n.getAttribute("title")||n.textContent||r||"";return G(i)}function wt(n,e){let o=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName.toLowerCase()==="select"?n:null,s=n;n.dataset.easyquizRole=e;let a=n.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(a)?a:"other",i=n.getAttribute("role")||"",c=(n.getAttribute("data-testid")||n.getAttribute("data-test-id")||"").toLowerCase(),l=(n.className&&typeof n.className=="string"?n.className:"").toLowerCase(),p=n.getAttribute("draggable")==="true"||n.classList.contains("perseus-drag-item")||n.classList.contains("sortable-item")||l.includes("cursor-grab")||!!n.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(l),f=n.getAttribute("data-role")==="dropzone"||n.classList.contains("category-container")||n.hasAttribute("data-category")||!!n.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(l),m=G((p?"draggable":f?"dropzone":"")||s.type||i||r,40),u="";if(s.type==="checkbox"||s.type==="radio"||i==="radio"||i==="checkbox"){let C=s.checked||n.getAttribute("aria-checked")==="true",x=s.value&&s.value!=="on"?s.value:n.getAttribute("data-value")||"";u=C?x?`checked:${x}`:"checked":x||"unchecked"}else if(r==="button"||a==="a"||e==="navigation"||le(n))u="";else{let C=typeof n.value=="string"||typeof n.value=="number"?n.value:"";u=G(C||n.getAttribute("data-category")||"",2e3)}let h=[];if(o&&o.options)for(let C of Array.from(o.options).slice(0,80))h.push({value:G(C.value),label:G(C.textContent)});else if(i==="combobox"||i==="listbox"||l.includes("select")||l.includes("dropdown")){let C=n.getAttribute("aria-controls")||n.getAttribute("aria-owns"),x=C?document.getElementById(C):n;if(x){let w=x.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let T of Array.from(w).slice(0,80)){let k=G(T.textContent);k&&h.push({value:T.getAttribute("data-value")||T.getAttribute("value")||k,label:k})}}}let b=!!(s.required||n.getAttribute("aria-required")==="true"),v=!!(s.disabled||n.getAttribute("aria-disabled")==="true"),y=Ln(n);return{id:n.id||y,tag:r,type:m,label:xt(n),name:G(s.name||n.getAttribute("name")||"",180),value:u,options:h,required:b,disabled:v,role:e}}var Wt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Yt(n){if(!O(n))return-1/0;let e=n.getBoundingClientRect(),t=Array.from(n.querySelectorAll(He)).filter(O),o=G(n.innerText||n.textContent||"",4e3).length;if(o<10||!t.length&&o<60)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),r=Math.min(1,a/s),i=e.top+e.height/2,c=Math.abs(i-window.innerHeight/2)/Math.max(1,window.innerHeight),l=o>40?35:0,p=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,o/20)+l+p-r*20-c*10}function et(n){let e=n;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,o=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&o!=="main"&&o!=="body"){e=t;break}let s=G(e.innerText||e.textContent||"",1e4),a=G(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(He).length,i=t.querySelectorAll(He).length;if(s.length<150&&a.length>s.length&&i<=r+4&&o!=="main"&&o!=="body"){e=t;continue}break}return e}function Zt(n){let e=n,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&O(t))return t;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function ie(){let n=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(n&&O(n))return n;let e=document.activeElement;if(e&&e!==document.body){let r=e.closest(Wt);if(r&&Yt(r)>0)return et(r)}let o=Array.from(document.querySelectorAll(Wt)).map(r=>({element:r,score:Yt(r)})).filter(r=>Number.isFinite(r.score)).sort((r,i)=>i.score-r.score),s=o.find(r=>{let i=r.element.tagName.toLowerCase();return i!=="main"&&i!=="body"&&r.score>0});if(s)return et(s.element);if(o.length>0&&o[0].score>0)return et(o[0].element);let a=document.querySelector('form, main, [role="main"]');return a&&O(a)?a:document.body}function $t(n){let e=n.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))t.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function tt(n){let e=Array.from(n.querySelectorAll(He)),t=new Set,o=[];for(let l of e){if(!O(l)||le(l)||Y(l))continue;let p=(l.value||l.textContent||"").trim();if(ge.test(p))continue;let f=l.tagName.toLowerCase();["input","textarea","select"].includes(f)&&(t.add(l),o.push(l))}for(let l of e){if(!O(l)||le(l)||Y(l))continue;let p=(l.value||l.textContent||"").trim();if(ge.test(p))continue;let f=l.tagName.toLowerCase();if(["input","textarea","select"].includes(f))continue;let d=l.querySelector("input, textarea, select");if(!(d&&t.has(d))){if(l.hasAttribute("for")){let m=l.getAttribute("for"),u=m?l.ownerDocument.getElementById(m):null;if(u&&t.has(u))continue}if(f==="a"){let m=l.getAttribute("role"),u=l.getAttribute("class")||"",h=l.getAttribute("data-testid")||"",b=l.getAttribute("draggable")==="true"||l.classList.contains("perseus-drag-item")||l.classList.contains("sortable-item")||u.includes("cursor-grab")||!!l.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(h)||/drag|card-item|sortable/i.test(u);if(!(m==="button"||m==="radio"||m==="checkbox"||m==="option"||b||l.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}o.push(l)}}let s=o.length>0&&o.every(l=>Y(l)||/read-?aloud|audio/i.test(l.getAttribute("data-testid")||l.getAttribute("aria-label")||"")),a=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||n,r=document.body.querySelector('[class*="classification" i]')!==null||n.querySelector('[class*="classification" i]')!==null||n.querySelector('[data-cy*="quiz" i]')!==null||n.querySelector('[class*="draggable-item" i]')!==null||n.querySelector('[class*="drag-item" i]')!==null||n.querySelector('[class*="sortable-card" i]')!==null||n.matches?.('[class*="classification" i]');if((o.length===0||s)&&r){s&&(o.length=0);let l=Array.from(a.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(l.length>0){for(let p of l)if(!(!O(p)||Y(p))&&(o.push(p),o.length>=50))break}else{let p=Array.from(a.querySelectorAll("button, div[class], span[class], p, li"));for(let f of p){if(!O(f)||le(f)||Y(f)||ge.test((f.textContent||"").trim()))continue;let d=(f.textContent||"").trim();if(d.length<2||d.length>300)continue;if(Array.from(f.children).some(u=>u.className&&u.textContent?.trim())||o.push(f),o.length>=50)break}}}let c=!o.some(l=>["input","select","textarea"].includes(l.tagName.toLowerCase()))&&o.length>0&&o.every(l=>{let p=l.tagName.toLowerCase();if(["input","select","textarea","button"].includes(p))return!1;let f=(l.textContent||"").trim();return!l.id||f.length<10||/^\d+\s*\/\s*\d+$/.test(f)||/^question text/i.test(f)});if(o.length===0||c){c&&(o.length=0);let l=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(l.length>0)for(let p of l){if(!O(p)||ye(p)||le(p)||Y(p)||ge.test((p.textContent||"").trim()))continue;let f=(p.textContent||"").trim();if(!(f.length<10||f.length>500)&&!/^\d+\s*\/\s*\d+$/.test(f)&&(o.push(p),o.length>=20))break}}return o.slice(0,100).map(l=>wt(l,"answer"))}function Et(n){let e=[n,n.parentElement,n.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,o=[];for(let s of e)for(let a of Array.from(s.querySelectorAll(He)))if(!(t.has(a)||!O(a)||!le(a)||Y(a))&&(t.add(a),o.push(wt(a,"navigation")),o.length>=10))return o;return o}function Ae(n=!1){let e=ie();e=et(e),n&&(e=Zt(e));let t=tt(e),o=Et(e);if(t.length===0){let i=tt(document.body);i.length>0&&(e=Zt(e),t=tt(e),t.length===0&&(t=i,e=document.querySelector('main, article, form, [role="main"]')||document.body))}o.length===0&&(o=Et(document.body));let s=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=s.length>4e4?G(s.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+G(s.slice(-2e3),2e3):G(s,16e3),r=[...t,...o].slice(0,120);return!a||r.length===0&&a.length<30?G(document.body.innerText||document.body.textContent||"",16e3).length>=30?be():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:$t(e),controls:r,scope:e}}function be(){let n=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=G(n,16e3),t=tt(document.body),o=Et(document.body),s=[...t,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:$t(a).slice(0,15e3),controls:s,scope:a}}function Ct(n){let e=n.controls.map(t=>{let o=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${o}`}).join("|");return[window.location.href,n.pageTitle,n.questionText.slice(0,400),e].join("::")}function nt(n){if(!n)return!1;let e=n.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(o=>e.includes(o))}function X(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function M(n){return n==null?"":(typeof n=="string"?n:String(n)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function te(n){if(!n||n instanceof HTMLInputElement||n instanceof HTMLSelectElement||n instanceof HTMLTextAreaElement||n.getAttribute("draggable")==="true"||n.classList.contains("dnd-card")||n.hasAttribute("data-category")||n.hasAttribute("data-dropzone"))return n;if(n.hasAttribute("for")){let o=n.getAttribute("for");if(o){let s=n.ownerDocument.getElementById(o);if(s)return s}}let e=n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let o=e.getAttribute("for"),a=(o?e.ownerDocument.getElementById(o):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=n.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(n.tagName.toLowerCase())){let o=n.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(o)return te(o)}return n}function _t(n){let e=n;if(!e||!document.contains(e))try{e=ie()}catch{}e=e||document.body;let t=s=>{let a=Array.from(s.querySelectorAll("tr")).filter(p=>O(p)&&p.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let r=Array.from(s.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(p=>O(p)&&!X(p));if(r.length>0)return r;let c=Array.from(s.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(p=>O(p)&&!X(p)).filter(p=>!p.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return c.length>0?c:Array.from(s.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(p=>{let f=p;return O(f)&&!X(f)&&(f.textContent||"").trim().length>2&&!le(f)&&!Y(f)&&!f.querySelector("[class]")})},o=t(e);return o.length>0?o:e!==document.body?t(document.body):[]}function N(n,e,t=!1){if(n==null)return null;let s=(typeof n=="string"?n:String(n)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!s)return null;let a=W(s),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!X(r))return te(r);try{let d=document.getElementById(s);if(d&&O(d)&&!X(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:te(d)}catch{}try{let d=document.querySelector(`[data-item-id="${a}"]`);if(d&&O(d)&&!X(d))return te(d)}catch{}let i=s.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(i){let d=parseInt(i[1],10);if(t){let u=document.body;try{u=ie()||document.body}catch{}let h=Array.from(u.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>O(b)&&!X(b));if(d>=1&&d-1<h.length)return h[d-1];if(d===0&&h.length>0)return h[0]}let m=d-1;if(m>=0){let u=_t();if(m<u.length){let v=u[m];if(v.tagName.toLowerCase()==="tr"){if(e){let A=v.querySelector(`input[value="${W(e)}" i], [data-value="${W(e)}" i]`);if(A)return A}let y=v.querySelector("input");if(y)return y}return te(v)}let h=document.body;try{h=ie()||document.body}catch{}let b=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>O(v)&&!X(v));if(m<b.length)return b[m]}}let c=s.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(c){let d=c[1].toUpperCase(),m=d.charCodeAt(0)-65,u=Array.from(document.querySelectorAll(`input[type="radio"][value="${d}" i], input[type="checkbox"][value="${d}" i]`)).find(b=>O(b)&&!X(b));if(u)return te(u);let h=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(b=>{if(!O(b)||X(b))return!1;let y=(b.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(y===d||y===`${d})`||y===`(${d})`||y===`${d}.`||y===`${d}:`)return!0;let A=(b.textContent||"").trim().toUpperCase();return A.startsWith(`${d})`)||A.startsWith(`(${d})`)||A.startsWith(`${d}.`)||A.startsWith(`${d}:`)});if(h)return te(h);if(m>=0){let b=_t();if(m<b.length){let v=b[m];if(v.tagName.toLowerCase()==="tr"){if(e){let A=v.querySelector(`input[value="${W(e)}" i], [data-value="${W(e)}" i]`);if(A)return A}let y=v.querySelector("input");if(y)return y}return te(v)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(s)){let m=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(v=>O(v)&&!X(v));if(m)return m;let h=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(v=>O(v)&&!X(v));if(h)return te(h);let b=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(v=>{if(!O(v)||X(v))return!1;let y=M(v.textContent).toLowerCase();return y===s.toLowerCase()||y===s.toLowerCase()+")"});if(b)return te(b)}try{let d=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let u=d.find(h=>{if(!O(h)||X(h))return!1;if(h instanceof HTMLInputElement&&h.value.toLowerCase()===e.toLowerCase())return!0;let b=h.closest("label, .vf-label, td, div");return b&&M(b.textContent).toLowerCase().includes(M(e).toLowerCase())});if(u)return te(u)}let m=d.find(u=>O(u)&&!X(u));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:te(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(s))try{let m=Array.from(document.querySelectorAll(s)).find(u=>O(u)&&!X(u));if(m)return te(m)}catch{}try{let d=s.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,u=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let h=0;h<u.snapshotLength;h++){let b=u.snapshotItem(h);if(b&&O(b)&&!X(b)){if(["body","html"].includes(b.tagName.toLowerCase())){let y=b.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(y&&O(y))return te(y)}return b.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||te(b)}}}catch{}let p=M(s).toLowerCase(),f=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of f){if(!O(d)||X(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=M(d.textContent).toLowerCase(),h=M(d.getAttribute("aria-label")||"").toLowerCase(),b=M(d.getAttribute("placeholder")||"").toLowerCase(),v=M(d.getAttribute("title")||"").toLowerCase(),y=M(d.getAttribute("name")||"").toLowerCase(),A=M(d.getAttribute("data-category")||"").toLowerCase(),C=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",x=M(C).toLowerCase(),w=u.startsWith(p+")")||u.startsWith(p+".")||u.startsWith(p+" -")||u.startsWith(p+":");if(u===p||h===p||b===p||v===p||y===p||A&&A===p||x&&x===p||w)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||te(d)}if(p.length>=3)for(let d of f){if(!O(d)||X(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=M(d.textContent).toLowerCase(),h=M(d.getAttribute("aria-label")||"").toLowerCase(),b=M(d.getAttribute("placeholder")||"").toLowerCase(),v=M(d.getAttribute("title")||"").toLowerCase(),y=M(d.getAttribute("name")||"").toLowerCase();if(u.includes(p)||h.includes(p)||b.includes(p)||v.includes(p)||y.includes(p)){if(Array.from(d.children).some(w=>{let T=M(w.textContent).toLowerCase();return T&&T.includes(p)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||te(d)}let A=p.split(/\s+/).filter(Boolean);if(A.length>=3){let C=A.slice(0,Math.min(5,A.length)).join(" ");if(u.includes(C)||h.includes(C)||b.includes(C))return te(d)}}return null}function en(n,e){for(let t of e)n.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function ue(n,e){if(!n)return;try{n.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{n.focus?.()}catch{}let t=n.getBoundingClientRect(),o=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),s=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:o,clientY:s};try{n.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}if(typeof n.click=="function")try{n.click()}catch{try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let r=Object.keys(n).find(i=>i.startsWith("__reactFiber")||i.startsWith("__reactInternalInstance"));if(r){let i=n[r];for(;i;){let c=i.memoizedProps||i.pendingProps;if(c?.onClick){c.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}i=i.return}}}catch{}try{let r=Object.keys(n).find(i=>i.startsWith("__reactProps"));if(r){let i=n[r];i?.onClick&&i.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let r=n._vei;r?.onClick&&(Array.isArray(r.onClick.value)?r.onClick.value:[r.onClick.value]).forEach(c=>{try{c({type:"click",target:n})}catch{}})}catch{}try{n.$onclick&&n.$onclick({type:"click",target:n,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||n.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let i=n.querySelector('input[type="radio"], input[type="checkbox"]');i&&(i.focus?.(),i.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,!0),i.dispatchEvent(new Event("change",{bubbles:!0})));let c=n.closest("[jsaction]");if(c&&c!==n)try{c.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:o,clientY:s}))}catch{}}}catch{}if(n.getAttribute("role")==="button"||n.getAttribute("tabindex")!==null)try{n.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function kt(n){try{let e=n.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,n.id=e);let o=document.createElement("script");return o.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(o),o.remove(),t||setTimeout(()=>{try{n.id===e&&n.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function ot(n,e){let t=n;if(t.hasAttribute("for")){let l=t.getAttribute("for"),p=t.ownerDocument.getElementById(l);p&&(t=p)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){at(t,[e]);return}let s=t.querySelector('select, [role="combobox"], [role="listbox"]');if(s){at(s,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)t=l;else{let f=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(f)t=f;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let l=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)t=l;else{let p=document.body;try{p=ie()||document.body}catch{}let f=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f)t=f;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=document.body;try{l=ie()||document.body}catch{}let p=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p)t=p;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;xe(t,l);return}let r=String(e??""),i=r;if(t instanceof HTMLInputElement&&t.type==="number"){let l=r.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(i=l)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,p=Object.getOwnPropertyDescriptor(l,"value")?.set;p?p.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let c=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(c=document.execCommand?.("insertText",!1,i)||!1):t.isContentEditable&&(c=document.execCommand?.("insertText",!1,i)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let f=t._valueTracker;f&&f.setValue(i===""?" ":"")}catch{}let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,p=Object.getOwnPropertyDescriptor(l,"value")?.set;p?p.call(t,i):t.value=i;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==i&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(i))){t.value=i;try{p?.call(t,i)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==i.trim()){t.textContent=i;try{t.innerText=i}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=i),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Ue(n,e=""){if(n==null)return e;let t=typeof n=="string"?n:String(n);if(!t)return e;let o=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),s=M(t),a=N(t)||N(s);if(!a)return o?e:s||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let f=M(r.textContent);if(f&&f.length>0&&f.length<150)return f}if(a.id){let f=document.querySelector(`label[for="${W(a.id)}"]`);if(f){let d=M(f.textContent);if(d&&d.length>0&&d.length<150)return d}}let i=a.getAttribute("aria-label");if(i)return M(i);let c=a.getAttribute("placeholder");if(c)return M(c);let l=M(a.textContent);if(l&&l.length>0&&l.length<120)return l;let p=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return p?M(p):o?e:s||e}function xe(n,e){if(!n)return;let t=n.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||n,o=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:t.querySelector('input[type="checkbox"], input[type="radio"]');!o&&t.hasAttribute("for")&&(o=t.ownerDocument.getElementById(t.getAttribute("for")));let s=n instanceof HTMLInputElement?n.closest("label")||(n.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||n:t&&O(t)?t:n;if(o){let a=o.type==="radio",r=o.type==="checkbox",i=!!o._valueTracker;if(o.checked===e){if(a&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(r){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(s&&s!==o&&ue(s),o.checked!==e)try{o.focus?.(),o.click()}catch{}if(o.checked!==e){try{let l=o._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,en(o,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;ue(s),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function at(n,e){let t=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"?n:n.querySelector("select");if(t){let r=e.map(l=>M(l).toLowerCase()),i=!1,c=(l,p)=>{l.selected=!0,t.selectedIndex=p;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let f=t._valueTracker;f&&f.setValue(l.value)}catch{}i=!0};for(let l=0;l<t.options.length;l++){let p=t.options[l],f=p.value.toLowerCase(),d=M(p.textContent).toLowerCase();if(r.some(u=>u===f||u===d)){if(c(p,l),!t.multiple)break}else t.multiple||(p.selected=!1)}if(!i)for(let l of r){let p=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(p){let f=parseInt(p[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?f:f>=1?f-1:0;if(m>=0&&m<t.options.length&&(c(t.options[m],m),!t.multiple))break}}if(!i){for(let l of r)if(/^[a-z]$/i.test(l)){let p=l.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?p+1:p;if(d>=0&&d<t.options.length&&(c(t.options[d],d),!t.multiple))break}}if(!i){let l=p=>p.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let p=0;p<t.options.length;p++){let f=t.options[p],d=l(f.value.toLowerCase()),m=l(M(f.textContent).toLowerCase());if(r.some(h=>{let b=l(h);return d.includes(b)||m.includes(b)||b.length>2&&(b.includes(d)||b.includes(m))})&&(c(f,p),!t.multiple))break}}if(i){en(t,["focus","input","change","blur"]);return}}let o=n.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?n:n.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');o&&ue(o);let s=e.map(r=>M(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>O(r)&&!X(r));for(let r of s){let i=a.find(l=>{let p=M(l.textContent).toLowerCase(),f=M(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return p===r||f===r||p.includes(r)||r.length>2&&r.includes(p)});if(i){ue(i);let l=i.querySelector('input[type="radio"], input[type="checkbox"]');l&&xe(l,!0);return}let c=N(r);if(c){ue(c);return}}}function Sn(n,e){try{let t=new DataTransfer;try{t.setData("text/plain",n)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Tt(n){try{n.click()}catch{let e=n.ownerDocument.defaultView||window;n.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function Mn(n,e,t){try{if(e.contains(n))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(n))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let o=e.children.length;if(t!==void 0&&o>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${o}`};if([n.getAttribute("data-placed")==="true",n.getAttribute("data-assigned")==="true",n.getAttribute("data-matched")==="true",n.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(n.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(n.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(c=>c!==e&&(c.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:n.getAttribute("aria-hidden")==="true"||n.style.display==="none"||n.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function pe(n,e){let t=M(n).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(n.trim())){let i=document.getElementById(n.trim());if(i&&O(i)&&!X(i))return i}let r=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let i of r){let l=Array.from(document.querySelectorAll(i)).find(p=>{if(!O(p)||X(p))return!1;let f=M(`${p.id} ${p.textContent||""} ${p.getAttribute("data-id")||""}`).toLowerCase();return f===t||f.includes(t)||p.id===n.trim()});if(l)return l}return null}let o=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),s=Array.from(document.querySelectorAll(o)),a=s.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(i=>i?.trim().toLowerCase()===t));return a&&O(a)&&!X(a)?a:s.find(r=>{if(!O(r)||X(r)||/unclassified/i.test(r.className))return!1;let i=r.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),c=M(i?.textContent||r.textContent||"").toLowerCase();return c.includes("op")&&(c.includes("es")||c.includes("\xF5es"))?!1:c===t||c.startsWith(t)||c.includes(t)})||null}async function it(n,e,t=1){try{n.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=n.getBoundingClientRect(),s=e.getBoundingClientRect(),a=Math.round(o.left+Math.max(1,o.width/2)),r=Math.round(o.top+Math.max(1,o.height/2)),i=Math.round(s.left+Math.max(1,s.width/2)),c=Math.round(s.top+Math.max(1,s.height/2)),l=M(e.textContent).toLowerCase();if(l){let h=Array.from(n.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let v=M(b.textContent).toLowerCase(),y=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?M(b.value).toLowerCase():"";return v&&(l.includes(v)||v.includes(l))||y&&(l.includes(y)||y.includes(l))});h&&(ue(h),await new Promise(b=>setTimeout(b,120)))}Tt(n),await new Promise(u=>setTimeout(u,140)),Tt(e);let p=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(p&&p!==e&&Tt(p),await new Promise(u=>setTimeout(u,100)),!e.contains(n)&&n.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(n),e.contains(n)&&n.matches('.dnd-card, [draggable="true"]'))return;let f={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{n.dispatchEvent(new PointerEvent("pointerdown",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}n.dispatchEvent(new MouseEvent("mousedown",f));let d=4;for(let u=1;u<=d;u++){let h=Math.round(a+(i-a)*(u/d)),b=Math.round(r+(c-r)*(u/d)),v={...f,clientX:h,clientY:b,screenX:h,screenY:b};try{n.dispatchEvent(new PointerEvent("pointermove",{...v,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",v))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:c,screenX:i,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let u=Sn(G(n.textContent),n.outerHTML),h={...f},b={...m};u&&(h.dataTransfer=u,b.dataTransfer=u);let v=n.ownerDocument.defaultView?.DragEvent;if(!v)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");n.dispatchEvent(new v("dragstart",h)),e.dispatchEvent(new v("dragenter",b)),e.dispatchEvent(new v("dragover",b)),e.dispatchEvent(new v("drop",b)),n.dispatchEvent(new v("dragend",h))}catch(u){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",u)}try{let u=new Touch({identifier:1,target:n,clientX:a,clientY:r}),h=new Touch({identifier:1,target:e,clientX:i,clientY:c});n.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[u]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[h]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(n))try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(u=>setTimeout(u,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(n))try{let u=v=>{let y=Object.keys(v).find(C=>C.startsWith("__reactFiber")||C.startsWith("__reactInternalInstance"));if(!y)return null;let A=v[y];for(let C=0;C<10&&A;C++){if(A.memoizedProps)return A.memoizedProps;A=A.return}return null},h=u(n),b=u(e);if(h){let v=h.onMouseDown||h.onPointerDown||h.onDragStart;if(typeof v=="function")try{v({type:"mousedown",button:0,buttons:1,clientX:a,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:n,target:n}),await new Promise(y=>setTimeout(y,100))}catch{}}if(b){let v=b.onMouseUp||b.onPointerUp||b.onDrop;if(typeof v=="function")try{v({type:"mouseup",button:0,buttons:0,clientX:i,clientY:c,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200));let v=c>r?"ArrowDown":"ArrowUp";for(let y=0;y<3;y++)document.dispatchEvent(new KeyboardEvent("keydown",{key:v,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(n.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:n.id||n.getAttribute("data-id")}})),await new Promise(y=>setTimeout(y,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(u){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",u)}}function tn(n,e,t,o){let s=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),a=s(n.toLowerCase()),r=s(e.toLowerCase()),i=s(t),c=s(o);return`var src=$eq.find('${i}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${a}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${r}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${a} -> ${r}');}`}var nn={fill:(n,e)=>{let t=N(n);t?ot(t,e):console.warn(`$eq.fill: Elemento '${n}' n\xE3o encontrado`)},click:n=>{let e=N(n);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?xe(e,!0):ue(e):console.warn(`$eq.click: Elemento '${n}' n\xE3o encontrado`)},check:(n,e)=>{let t=N(n);t?xe(t,e):console.warn(`$eq.check: Elemento '${n}' n\xE3o encontrado`)},find:(n,e)=>N(n,e),drag:(n,e)=>{let t=pe(n,"source")||N(n),o=pe(e,"destination")||N(e);t&&o?it(t,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${n}' -> '${e}')`)},categorize:async(n,e)=>{let t=pe(n,"source")||N(n),o=pe(e,"destination")||N(e);if(!t||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${n}' -> '${e}')`);return}await it(t,o)},execute:(n,e=!1,t=1)=>Xe(n,e,t)};typeof window<"u"&&(window.$eq=nn);async function In(n,e=1,t=Le()){if(yt(n,t),n.t==="js"){let c=String(n.v||"");Jt(c);try{new Function("$eq","document","window",c)(nn,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(n.t==="drag"){let c=pe(n.from,"source")||N(n.from),l=pe(n.to,"destination")||N(n.to);!c&&n.from&&(c=N(M(n.from))),!l&&n.to&&(l=N(M(n.to))),c&&l?await it(c,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${n.from}' -> '${n.to}')`);return}let o=n.id!==void 0&&n.id!==null?String(n.id):"";!o&&n.t==="val"&&(o=n.target??n.name??n.selector??"1");let s=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,a=s!=null?String(s).trim():"",r=null,i=String(n.name??n.n??"").trim();if(!i&&o&&document.querySelector(`input[type="radio"][name="${W(o)}"]`)&&(i=o),(n.t==="chk"||n.t==="clk")&&i){let c=Array.from(document.querySelectorAll(`input[name="${W(i)}"]`));if(a&&(r=c.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!r&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),p=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||p){let f=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=c.find(d=>{let m=d.value?.toLowerCase()??"";if(f.includes(m))return!0;let h=(d.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return f.some(b=>h===b||h.startsWith(b+" ")||h.startsWith("("+b+")"))})??null}}!r&&c.length>0&&(r=c[0])}if(r||(r=N(o,a,n.t==="val"||n.t==="sel")),!r&&o&&(r=N(M(o),a,n.t==="val"||n.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(M(r.value).toLowerCase()!==M(a).toLowerCase()){let c=document.querySelector(`input[type="radio"][name="${W(r.name)}"][value="${W(a)}" i]`);if(c)r=c;else{let p=Array.from(document.querySelectorAll(`input[type="radio"][name="${W(r.name)}"]`)).find(f=>{let d=f.closest("label, .vf-label, .option-card, tr, td, div");return d&&M(d.textContent).toLowerCase().includes(M(a).toLowerCase())});p&&(r=p)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let c=r.querySelector(`input[value="${W(a)}" i], [data-value="${W(a)}" i]`);if(c)r=c;else{let p=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(f=>{let d=f.closest("label, .vf-label, .option-card, td, div");return d&&M(d.textContent).toLowerCase().includes(M(a).toLowerCase())});p&&(r=p)}}}if(!r&&(n.t==="val"||n.t==="sel")){let c=document.body;try{c=ie()||document.body}catch{}let l=Array.from(c.querySelectorAll(n.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(p=>O(p)&&!X(p));if(l.length===1)r=l[0];else if(l.length>1){let p=M(o).toLowerCase(),f=p.match(/^#?_?([0-9]+)$/);if(f){let d=parseInt(f[1],10);d>=1&&d<=l.length?r=l[d-1]:d>=0&&d<l.length&&(r=l[d])}r||(r=l.find(m=>{let u=(m.getAttribute("placeholder")||"").toLowerCase(),h=(m.name||"").toLowerCase(),b=(m.getAttribute("aria-label")||"").toLowerCase(),v=(m.id||"").toLowerCase(),y=M(xt(m)).toLowerCase(),A=M(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return u.includes(p)||h.includes(p)||b.includes(p)||v.includes(p)||y&&y.includes(p)||p.length>=2&&A.includes(p)})||(l.length===1?l[0]:null))}}if(!r&&n.t!=="adv")throw new Error(`Alvo '${o}' n\xE3o encontrado no DOM para a\xE7\xE3o '${n.t}'.`);switch(n.t){case"val":if(r){let p=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!p){let u=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(p=u)}if(!p){let m=r.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){p=m;break}let u=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){p=u;break}m=m.nextElementSibling}}if(!p){let m=document.body;try{m=ie()||document.body}catch{}let u=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>O(h)&&!X(h));u.length>0&&(p=u[0])}let f=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,d=f!=null?String(f):"";ot(p||r,d)}break;case"chk":let c=n.c!==void 0?!!n.c:!0;r&&xe(r,c);break;case"sel":if(r){let p=Array.isArray(n.v)?n.v:[String(n.v)];at(r,p)}break;case"clk":if(r)if(!!(r.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let f=n.c!==void 0?!!n.c:!0;xe(r,f)}else ue(r,n.co);break;case"adv":let l=on(n.id);if(l){await qt(l,1200);let p=n.id||l.textContent?.trim()||"";p&&mt(window.location.hostname,{advanceSelector:p}),ue(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Hn(){let n=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(n)).find(t=>{if(!O(t)||X(t)||t.closest("header, nav, aside"))return!1;let o=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",s=(t.textContent||o||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(s)})||null}function on(n){let e=d=>{let m=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return ge.test(m)};if(n){let d=N(n);if(d&&O(d)&&!X(d)&&!Y(d)&&!e(d))return d}try{let d=ut(window.location.hostname);if(d.advanceSelector){let m=N(d.advanceSelector);if(m&&O(m)&&!X(m)&&!Y(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(t)),s=d=>{let m=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||m||"").trim()},a=d=>{let m=s(d).trim();return/^\d{1,3}$/.test(m)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},r=o.filter(d=>O(d)&&!X(d)&&!d.closest("header, aside")&&!Y(d)&&!e(d));for(let d of r){let m=s(d),u=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Ve.test(m)||Ve.test(u))&&!a(d)&&!Y(d))return d}for(let d of r)if(le(d)&&!Y(d)&&!a(d))return d;let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(i&&O(i)&&!X(i)&&!Y(i)&&!e(i))return i;let c=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of c)if(O(d)&&!X(d)&&!e(d)&&!Y(d)&&!a(d))return d;let l=Array.from(document.querySelectorAll('button, [role="button"]')),p=window.innerHeight,f=l.filter(d=>{if(!O(d)||X(d)||e(d)||Y(d)||d.closest("header, nav, aside, .eq-sidebar")||a(d))return!1;let m=d.getBoundingClientRect();return m.top>p*.45&&m.height>=24&&m.width>=24});if(f.length>0)return f.sort((d,m)=>{let u=d.getBoundingClientRect(),h=m.getBoundingClientRect(),b=u.left+u.top;return h.left+h.top-b}),f[0];for(let d of r)if(le(d)&&!Y(d))return d;return null}async function qt(n,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(n.disabled===!0||n.getAttribute("aria-disabled")==="true"||n.classList.contains("disabled")||n.getAttribute("disabled")!==null))return;await new Promise(s=>setTimeout(s,80))}}function zn(){let n=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,o=(document.body?.innerText||document.body?.textContent||"").length;return`${n}|${e}|${t}|${o}`}async function Pn(n,e=3500){let[t,o,s,a]=n.split("|"),r=parseInt(a||"0",10),i=Date.now();for(;Date.now()-i<e;){let c=window.location.href,l=document.title,p=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),f=(document.body?.innerText||document.body?.textContent||"").length;if(c!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${c}`};if(l!==o)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${o}" \u2192 "${l}"`};if(Math.abs(parseInt(p)-parseInt(s||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${s} \u2192 ${p}`};if(Math.abs(f-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(f-r)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function st(n){if(n.t==="js"||n.t==="adv")return;if(n.t==="drag"){let a=N(n.from)||N(M(n.from)),r=N(n.to)||N(M(n.to));a&&r&&await it(a,r,2);return}let e=n.id||"",t=n.v!==void 0?String(n.v).trim():"",o=N(e,t)||N(M(e),t),s=String(n.name??n.n??"").trim();if(!s&&e&&document.querySelector(`input[type="radio"][name="${W(e)}"]`)&&(s=e),!o&&s){let a=Array.from(document.querySelectorAll(`input[name="${W(s)}"]`));if(t&&(o=a.find(r=>r.value?.toLowerCase()===t.toLowerCase())??null),!o&&t){let r=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),i=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(r||i){let c=r?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];o=a.find(l=>{let p=l.value?.toLowerCase()??"";if(c.includes(p))return!0;let d=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return c.some(m=>d===m||d.startsWith(m+" ")||d.startsWith("("+m+")"))})??null}}!o&&a.length>0&&(o=a[0])}if(n.t==="clk"||n.t==="chk"){if(!o&&e){let r=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),i=M(e).toLowerCase();o=r.find(c=>{let l=M(c.textContent).toLowerCase();return!!(M(c.value||"").toLowerCase()===i||l===i||l.startsWith(i+")")||l.startsWith("("+i+")")||l.startsWith(i+".")||l.startsWith(i+" - ")||l.startsWith(i+":")||i.length>=3&&l.includes(i))})||null}let a=n.v!==void 0?String(n.v).trim():"";if(o&&a){if(o instanceof HTMLInputElement&&o.type==="radio"&&o.name){if(M(o.value).toLowerCase()!==M(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${W(o.name)}"][value="${W(a)}" i]`);if(r)o=r;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${W(o.name)}"]`)).find(l=>{let p=l.closest("label, .vf-label, .option-card, tr, td, div");return p&&M(p.textContent).toLowerCase().includes(M(a).toLowerCase())});c&&(o=c)}}}else if(!(o instanceof HTMLInputElement)&&!(o instanceof HTMLSelectElement)&&!(o instanceof HTMLTextAreaElement)){let r=o.querySelector(`input[value="${W(a)}" i], [data-value="${W(a)}" i]`);if(r)o=r;else{let c=Array.from(o.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let p=l.closest("label, .vf-label, .option-card, td, div");return p&&M(p.textContent).toLowerCase().includes(M(a).toLowerCase())});c&&(o=c)}}}if(o){let r=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,i=o instanceof HTMLInputElement&&["radio","checkbox"].includes(o.type)?o:r.querySelector('input[type="radio"], input[type="checkbox"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),c=n.c!==void 0?!!n.c:!0;if(xe(i||r,c),i&&i.checked!==c){try{let l=i._valueTracker;l&&l.setValue(!c)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,c)}catch{}i.checked=c,i.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),i.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(n.t==="val"){let a=null;if(o&&(a=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o.isContentEditable?o:o.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let r=document.body;try{r=ie()||document.body}catch{}let i=Array.from(r.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),c=M(e).toLowerCase();a=i.find(l=>{let p=(l.getAttribute("placeholder")||"").toLowerCase(),f=(l.name||"").toLowerCase(),d=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return p.includes(c)||f.includes(c)||d.includes(c)||m.includes(c)})||(i.length>0?i[0]:null)}if(a){let r=String(n.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,r)}}catch{}ot(a,r)}return}if(n.t==="sel"){if(!o&&e){let a=Array.from(document.querySelectorAll("select")),r=M(e).toLowerCase();o=a.find(i=>{let c=(i.name||"").toLowerCase(),l=(i.id||"").toLowerCase(),p=(i.getAttribute("aria-label")||"").toLowerCase();return c.includes(r)||l.includes(r)||p.includes(r)})||null}if(o){let a=Array.isArray(n.v)?n.v:[String(n.v)];at(o,a)}return}}function de(n){try{if(n.t==="val"){let e=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,t=String(e??"").trim(),o=t,s=n.id!==void 0&&n.id!==null?String(n.id):"";s||(s=n.target??n.name??n.selector??"1");let a=N(s,o,!0)||N(M(s),o,!0);if(!a){let m=document.body;try{m=ie()||document.body}catch{}let u=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>O(h)&&!X(h));u.length>0&&(a=u[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let m=document.querySelector(`input[type="radio"][name="${W(r.name)}"]:checked`);if(!m)return!1;let u=M(m.value).toLowerCase(),h=M(t).toLowerCase(),b=M(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===h||b===h||b.includes(h)}let i=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!i){let u=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(i=u)}if(!i){let m=a.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){i=m;break}let u=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){i=u;break}m=m.nextElementSibling}}if(i instanceof HTMLSelectElement){let m=M(t).toLowerCase();return Array.from(i.options).some(u=>{if(!u.selected)return!1;let h=u.value.toLowerCase(),b=M(u.textContent).toLowerCase();return m===h||m===b||h.includes(m)||b.includes(m)})}let c=(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i?.textContent??a.textContent??"").trim();if(!c&&!t)return!0;if(!c&&t)return!1;let l=c.replace(",",".").replace(/\s+/g,"").toLowerCase(),p=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),f=parseFloat(l),d=parseFloat(p);return!isNaN(f)&&!isNaN(d)&&l.match(/^-?[\d.,]+$/)&&p.match(/^-?[\d.,]+$/)?Math.abs(f-d)<1e-4:l===p||c.toLowerCase()===t.toLowerCase()||p.length>=3&&l===p}if(n.t==="sel"){let e=N(n.id,void 0,!0)||N(M(n.id),void 0,!0);if(!e){let a=document.body;try{a=ie()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>O(l)&&!X(l)),i=M(n.id).toLowerCase();e=r.find(l=>{let p=(l.id||"").toLowerCase(),f=(l.getAttribute("name")||"").toLowerCase(),d=(l.getAttribute("aria-label")||"").toLowerCase(),m=M(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return p.includes(i)||f.includes(i)||d.includes(i)||i.length>=2&&m.includes(i)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let i=(Array.isArray(n.v)?n.v:[String(n.v)]).map(l=>M(l).toLowerCase()),c=M(a.textContent).toLowerCase();return i.some(l=>c.includes(l)||l.includes(c))}return!1}let s=(Array.isArray(n.v)?n.v:[String(n.v)]).map(a=>M(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),i=M(a.textContent).toLowerCase();return s.some(c=>c===r||c===i||r.includes(c)||i.includes(c))})}if(n.t==="chk"||n.t==="clk"){let e=n.v!==void 0?String(n.v).trim():"",t=String(n.name??n.n??"").trim();if(t&&!n.id){let d=Array.from(document.querySelectorAll(`input[name="${W(t)}"]`));if(d.length>0){let m=d.find(y=>y.checked);if(!m)return!1;if(!e)return!0;let u=m.value?.toLowerCase()??"",h=e.toLowerCase();if(u===h)return!0;let b=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),v=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return b?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(u):v?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(u):!1}}let o=N(n.id,e)||N(M(n.id),e);if(!o&&t){let d=document.querySelector(`input[name="${W(t)}"]`);d&&(o=d)}if(!o)return!1;let s=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:s.querySelector('input[type="checkbox"], input[type="radio"]')||(s.getAttribute("for")?s.ownerDocument.getElementById(s.getAttribute("for")):null),r=n.t==="chk"||n.c!==void 0?!!n.c:!0;if(a&&a.type==="radio"){if(a.checked===r)return!0;if(n.v&&a.name){let d=M(String(n.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${W(a.name)}"]:checked`);if(!m)return!1;if(m===a)return!0;let u=M(m.value).toLowerCase(),h=M(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===d||h.includes(d)||d.includes(u)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===r;let i=s.getAttribute("aria-checked")===String(r)||s.getAttribute("aria-selected")===String(r)||s.getAttribute("aria-pressed")===String(r),c=r?s.getAttribute("data-selected")==="true"||s.getAttribute("data-checked")==="true"||s.getAttribute("data-active")==="true"||s.getAttribute("data-state")==="checked"||s.getAttribute("data-state")==="on":s.getAttribute("data-selected")==="false"||s.getAttribute("data-checked")==="false"||s.getAttribute("data-state")==="unchecked",l=s.className||"",p=r?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(i||c||p)return!0;let f=!!s.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return n.t==="clk"&&!a&&!f||s.getAttribute("aria-expanded")!==null||s.getAttribute("aria-pressed")!==null}if(n.t==="drag"){let e=pe(n.from,"source")||N(n.from)||N(M(n.from)),t=pe(n.to,"destination")||N(n.to)||N(M(n.to));return!e||!t?!1:Mn(e,t).success}}catch{}return!1}async function Xe(n,e,t=1,o=Le({engine:"smart",autoAdvance:e})){let s=n.actions.filter(E=>E.t!=="adv"),a=n.actions.filter(E=>E.t==="adv"),r=0,i=[],c=new Map,l=new Map,p=new Map,f=new Set,d=n.pageType==="question"||s.length>0,m=s.filter(E=>E.t==="chk"||E.t==="clk"&&E.c!==void 0),u=new Map;for(let E of s){let I=[];l.set(E,I);try{if(E.t==="drag"){I.push("declarative-A-F");try{let S=pe(E.from,"source")||N(E.from),q=pe(E.to,"destination")||N(E.to);S&&p.set(E,S.parentElement?.outerHTML?.slice(0,500)||""),q&&u.set(E,q.children.length)}catch{}}else I.push("declarative-primary");await In(E,t,o),r++,f.add(E)}catch(S){c.set(E,S instanceof Error?S.message:String(S)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",E,S)}await new Promise(S=>setTimeout(S,E.t==="drag"?180:35))}if(d&&n.mode==="escolha_multipla"&&m.length>0){let E=document.body;try{E=ie()||document.body}catch{}let I=Array.from(E.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(S=>O(S)&&!X(S));if(I.length>1){let q=function(H,Q){if(H===Q||H.contains(Q)||Q.contains(H))return!0;let V=H.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),F=Q.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(V&&F&&V===F)return!0;let K=H.getAttribute("for")||H.id,$=Q.getAttribute("for")||Q.id;return!!(K&&$&&K===$)};var k=q;let S=new Set;for(let H of m){let Q=H.t==="chk"?!!H.c:!!(H.c??!0),V="id"in H&&typeof H.id=="string"?H.id:"";if(Q&&V){let F=N(V,H.v);if(F){S.add(F);let K=F.querySelector('input[type="checkbox"]');K&&S.add(K);let $=F.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');$&&(S.add($),$.querySelectorAll('input[type="checkbox"]').forEach(oe=>S.add(oe)))}}}if(S.size>=m.length&&S.size>0){let H=Array.from(S);for(let Q of I)H.some(F=>q(F,Q))||(Q instanceof HTMLInputElement&&Q.checked||Q.getAttribute("aria-checked")==="true"||Q.closest(".option-card, label")?.classList.contains("selected"))&&xe(Q,!1)}}}await new Promise(E=>setTimeout(E,s.length>0?100:25));let h=0;for(let E of s){if(de(E)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${E.t}' no alvo '${E.id||E.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{yt(E,o),l.get(E)?.push("alternative-path"),await st(E)}catch(I){c.set(E,I instanceof Error?I.message:String(I)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",I)}await new Promise(I=>setTimeout(I,250)),de(E)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++,f.has(E)?c.has(E)&&c.delete(E):(c.delete(E),r++,f.add(E)))}if(h<s.length&&s.length>0){console.warn(`[EasyQuiz Auto-Cura] ${s.length-h} de ${s.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(E=>setTimeout(E,200));for(let E of s)if(!de(E))try{if(await st(E),await new Promise(I=>setTimeout(I,80)),!de(E)&&(E.t==="clk"||E.t==="chk"))try{let I="id"in E?String(E.id||""):"",S=E.v!==void 0?String(E.v).trim():"",q=N(I,S)||N(M(I),S);q&&(kt(q),await new Promise(H=>setTimeout(H,120)))}catch{}}catch(I){c.set(E,I instanceof Error?I.message:String(I))}await new Promise(E=>setTimeout(E,200)),h=0;for(let E of s)de(E)&&(h++,f.has(E)?c.has(E)&&c.delete(E):(c.delete(E),r++,f.add(E)))}let b=[];for(let[E,I]of s.entries())if(!de(I)){let S=I.t==="drag"?`${I.from} -> ${I.to}`:"id"in I&&I.id?I.id:I.t;i.push(S),b.push({actionIndex:E,action:I,strategiesAttempted:l.get(I)||[],evidence:c.get(I)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:p.get(I)}),I.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${I.from}" -> "${I.to}"`,`
  Estrat\xE9gias: ${(l.get(I)||[]).join(", ")}`,`
  Snapshot DOM: ${p.get(I)?.slice(0,200)||"n/a"}`)}d&&s.length===0&&i.push("nenhuma a\xE7\xE3o de resposta prescrita");let v=s.map((E,I)=>{let S=E.t==="drag"?`${E.from} -> ${E.to}`:E.t==="js"?"$eq":E.id||E.t,q=E.t==="js"?!0:E.t==="drag"?!!(pe(E.from,"source")&&pe(E.to,"destination")):!!(N(E.id||"")||N(M(E.id||""))),H=de(E);return{index:I,action:E,target:S,located:q,applied:!c.has(E),verified:H,strategy:E.t==="drag"?"drag-adaptive":E.t==="js"?"javascript":"declarative-dom",evidence:H?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(E)?{error:c.get(E)}:{}}}),y=d?s.length>0&&i.length===0&&(h===s.length||r===s.length&&h>0):!0,A=!1,C=!1,x="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",w=d?h>0&&h>=Math.ceil(s.length/2):r>0&&r>=s.length/2,T=d?h>0&&(y||w):y||s.length===0||w;if(e&&T){await new Promise(S=>setTimeout(S,s.length>0?120:40));let E=!1,I=null;if(n.pageType!=="info"){let S=Hn();if(S&&O(S)){await qt(S,1200),ue(S),E=!0,I=S,await new Promise(Q=>setTimeout(Q,350));let q=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');q&&O(q)&&(q.textContent||"").trim().length>0?(A=!1,C=!1,x=`Aviso do formul\xE1rio ap\xF3s checagem: ${q.textContent?.trim().slice(0,100)}`):(A=!0,C=!0,x="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!E){let S=zn(),q=a.length>0&&"id"in a[0]?a[0].id:void 0,H=on(q);if(H){await qt(H,1500);let Q=q||H.textContent?.trim()||"";Q&&mt(window.location.hostname,{advanceSelector:Q}),ue(H);let V=await Pn(S,1800);C=V.changed,x=V.evidence,A=V.changed||!0,V.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:h,success:y,advanced:A,failed:i,reports:v,navigationVerified:C,navigationEvidence:x,failedActions:b}}var me=null,Se=[],Lt=[],St=[],Mt=[],he=null,we=null,On=`
...
`;function an(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=On,document.head.appendChild(n)}}catch{}}function Ee(){me&&(me.style.removeProperty("outline"),me.style.removeProperty("outline-offset"),me.style.removeProperty("position"),me=null);for(let n of Se)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");Se=[];for(let n of Lt)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");Lt=[];for(let n of St)try{n.remove()}catch{}St=[],we&&typeof window<"u"&&(window.removeEventListener("scroll",we),window.removeEventListener("resize",we),we=null);for(let n of Mt)try{n.remove()}catch{}if(Mt=[],he){try{he.remove()}catch{}he=null}}function It(n){an();let e=[];for(let t of n){if(!t||typeof t.setAttribute!="function")continue;let o=t;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),Lt.push(o)}catch{}try{let s=t.getBoundingClientRect(),a=s.width||t.offsetWidth||280,r=s.height||t.offsetHeight||200;if(a>10&&r>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(c),document.body.appendChild(i),St.push(i),Mt.push(c),e.push({element:t,frame:i})}}catch{}}e.length>0&&!we&&typeof window<"u"&&(we=()=>{for(let t of e)try{let o=t.element.getBoundingClientRect();o.width>0&&o.height>0&&(t.frame.style.top=`${o.top+window.scrollY-3}px`,t.frame.style.left=`${o.left+window.scrollX-3}px`,t.frame.style.width=`${o.width+6}px`,t.frame.style.height=`${o.height+6}px`)}catch{}},window.addEventListener("scroll",we,{passive:!0}),window.addEventListener("resize",we,{passive:!0}))}function Ge(n){me&&me!==n&&(me.style.removeProperty("outline"),me.style.removeProperty("outline-offset")),an(),me=n,n.style.outline="2px solid #00e5ff",n.style.outlineOffset="4px";try{if(he){try{he.remove()}catch{}he=null}window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,n.appendChild(t),he=t}catch{}}function Dn(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function sn(n,e){if(he){try{he.remove()}catch{}he=null}let t=Dn(e);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let m=N(o.from),u=N(o.to);m&&(m.style.outline=`2px solid ${t.outline}`,Se.push(m)),u&&(u.style.outline="2px dashed #00e5ff",Se.push(u))}catch{}continue}let s=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${W(a)}"]`));if(s&&(r=m.find(u=>u.value?.toLowerCase()===s.toLowerCase())??null,!r)){let u=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(s),h=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(s);if(u||h){let b=u?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=m.find(v=>{let y=v.value?.toLowerCase()??"";if(b.includes(y))return!0;let C=(v.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(x=>C===x||C.startsWith(x+" ")||C.startsWith("("+x+")"))})??null}}!r&&m.length>0&&(r=m[0])}if(!r&&o.id&&(r=N(o.id,s,o.t==="val"||o.t==="sel")||N(M(o.id),s,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let m=document.body;try{m=ie()||document.body}catch{}let u=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>O(v)&&!ye(v)),h=M(o.id).toLowerCase();r=u.find(v=>{let y=(v.id||"").toLowerCase(),A=(v.getAttribute("name")||"").toLowerCase(),C=(v.getAttribute("aria-label")||"").toLowerCase(),x=M(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return y.includes(h)||A.includes(h)||C.includes(h)||h.length>=2&&x.includes(h)})||(u.length===1?u[0]:null)}if(!r)continue;let i=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",c=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,p=c||l||r;p.style.outline=`2px solid ${t.outline}`,p.style.outlineOffset="2px",p.style.backgroundColor=t.bg,p.setAttribute("data-easyquiz-highlight","true"),Se.push(p);let f=i?r:p.querySelector('select, [role="combobox"], [role="listbox"]');f&&(f.style.outline=`2px solid ${t.outline}`,f.style.outlineOffset="2px",f.style.boxShadow=`0 0 10px ${t.glow}`,f.setAttribute("data-easyquiz-highlight","true"),Se.push(f));let d=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:p.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==p&&(d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${t.glow}`,d.setAttribute("data-easyquiz-highlight","true"),Se.push(d))}}var Ht=10,Bn=1400,Ke=15e5;function ve(n){return new Promise((e,t)=>{let o=new FileReader;o.onerror=()=>t(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");e(s.split(",")[1]||"")},o.readAsDataURL(n)})}async function Me(n){let e=0,t=0;if(n instanceof HTMLImageElement?(e=n.naturalWidth||n.width,t=n.naturalHeight||n.height):(e=n.width,t=n.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Bn/Math.max(e,t)),s=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(t*o)),r=document.createElement("canvas");r.width=s,r.height=a;let i=r.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,s,a),i.drawImage(n,0,0,s,a),new Promise((c,l)=>{r.toBlob(p=>p?c(p):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function ln(n){let e=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=e.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,s=2,a=Math.min(1800,Math.max(120,Math.round(t*s))),r=Math.min(1800,Math.max(100,Math.round(o*s))),i=n.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(a)),i.setAttribute("height",String(r)),!i.getAttribute("viewBox")&&t>0&&o>0&&i.setAttribute("viewBox",`0 0 ${t} ${o}`);try{let d=Array.from(n.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let u=0;u<Math.min(d.length,m.length);u++){let h=d[u],b=m[u];if(!h||!b||!b.style)continue;let v=window.getComputedStyle?window.getComputedStyle(h):null;v&&(v.fill&&v.fill!=="none"&&(b.style.fill=v.fill),v.stroke&&v.stroke!=="none"&&(b.style.stroke=v.stroke),v.strokeWidth&&(b.style.strokeWidth=v.strokeWidth),v.fontFamily&&(b.style.fontFamily=v.fontFamily),v.fontSize&&(b.style.fontSize=v.fontSize),v.fontWeight&&(b.style.fontWeight=v.fontWeight),v.color&&(b.style.color=v.color))}}catch{}let c="#ffffff";try{let d=n.parentElement||n;for(;d&&d!==document.documentElement;){let u=(window.getComputedStyle?window.getComputedStyle(d):null)?.backgroundColor;if(u&&u!=="transparent"&&u!=="rgba(0, 0, 0, 0)"){c=u;break}d=d.parentElement}}catch{}let p=new XMLSerializer().serializeToString(i),f="";try{f=btoa(unescape(encodeURIComponent(p)))}catch{}try{let d=b=>new Promise((v,y)=>{let A=new Image,C=setTimeout(()=>y(new Error("Timeout render SVG")),1200);A.onload=()=>{clearTimeout(C),v(A)},A.onerror=()=>{clearTimeout(C),y(new Error("Falha ao renderizar SVG em Image."))},A.src=b}),m=null;if(f)try{m=await d(`data:image/svg+xml;base64,${f}`)}catch{}if(!m){let b=new Blob([p],{type:"image/svg+xml;charset=utf-8"}),v=URL.createObjectURL(b);try{m=await d(v)}finally{URL.revokeObjectURL(v)}}let u=document.createElement("canvas");u.width=a,u.height=r;let h=u.getContext("2d",{alpha:!1});if(h&&m){h.fillStyle=c,h.fillRect(0,0,a,r),h.drawImage(m,0,0,a,r);let b=await new Promise(v=>{u.toBlob(v,"image/jpeg",.92)});if(b){let v=await ve(b);if(v)return{blob:b,base64:v,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function zt(n){try{let e=n.getBoundingClientRect(),t=Math.round(e.width)||n.offsetWidth||400,o=Math.round(e.height)||n.offsetHeight||300;if(t<30||o<30)return null;let s=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(s&&n.querySelectorAll("input, select, textarea").length===0)try{let h=await ln(s);if(h.base64&&h.base64.length<=Ke)return{mediaType:h.mediaType,base64:h.base64,alt:n.getAttribute("aria-label")||s.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:Ce(s)}}catch{}if(n instanceof HTMLCanvasElement)try{let h=await Me(n),b=await ve(h);if(b)return{mediaType:"image/jpeg",base64:b,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let h=n;for(;h&&h!==document.documentElement;){let v=(window.getComputedStyle?window.getComputedStyle(h):null)?.backgroundColor;if(v&&v!=="transparent"&&v!=="rgba(0, 0, 0, 0)"){a=v;break}h=h.parentElement}}catch{}let r=n.cloneNode(!0),i=Array.from(n.querySelectorAll("*")),c=Array.from(r.querySelectorAll("*"));for(let h=0;h<Math.min(i.length,c.length);h++){let b=i[h],v=c[h];if(!(!b||!v||!v.style))try{let y=window.getComputedStyle(b);v.style.color=y.color,v.style.backgroundColor=y.backgroundColor,v.style.borderColor=y.borderColor,v.style.borderWidth=y.borderWidth,v.style.borderStyle=y.borderStyle,v.style.fontSize=y.fontSize,v.style.fontFamily=y.fontFamily,v.style.fontWeight=y.fontWeight,v.style.lineHeight=y.lineHeight,v.style.letterSpacing=y.letterSpacing,v.style.textAlign=y.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,o))),p=Math.round(t*l),f=Math.round(o*l),d=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let s=this.element.querySelector("#eq-fah-copy-md-btn");s.addEventListener("click",()=>this.copyMarkdownToClipboard(s));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=o=>{if(o.target.closest(".eq-fah-btn"))return;o.preventDefault(),this.isDragging=!0,this.dragStartX=o.clientX,this.dragStartY=o.clientY;let s=this.element.getBoundingClientRect();this.initialLeft=s.left,this.initialTop=s.top;let a=i=>{if(!this.isDragging||!this.element)return;let c=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,p=Math.max(10,window.innerWidth-this.element.offsetWidth-10),f=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+c),p),m=Math.min(Math.max(10,this.initialTop+l),f);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),o=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let s=this.currentPlan,a=s.actions.filter(m=>m.t==="drag"),r=s.actions.filter(m=>{if(m.t!=="val")return!1;let u=M(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(u)}),i=s.actions.filter(m=>m.t==="clk"||m.t==="chk"),c=s.actions.filter(m=>m.t==="sel"),l=a.length||r.length||i.length||c.length,p=document.createElement("div");p.className="eq-fah-meta";let f=document.createElement("span");f.textContent=`Modo: ${s.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(s.confidence*100)}% Confian\xE7a`,p.append(f,d),e.appendChild(p),a.length>0||s.mode==="categorizacao"||s.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,o.textContent=String(a.length);let m={};for(let u of a){let h=M(u.to)||"Geral";m[h]||(m[h]=[]),m[h].push(M(u.from))}for(let[u,h]of Object.entries(m)){let b=document.createElement("div"),v=/fato|true|verdadeiro|sim/i.test(u),y=/opini[aã]o|false|falso|n[aã]o/i.test(u);b.className=`eq-fah-group ${v?"group-fato":y?"group-opiniao":""}`;let A=document.createElement("div");A.className="eq-fah-group-title",A.textContent=`\u{1F4C1} ${u} (${h.length})`,b.appendChild(A);let C=document.createElement("div");C.className="eq-fah-group-items";for(let x of h){let w=document.createElement("div");w.className="eq-fah-item";let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=x,w.appendChild(T);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(x),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),w.appendChild(k),C.appendChild(w)}b.appendChild(C),e.appendChild(b)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,o.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let u=document.createElement("div");u.className="eq-fah-group-title",u.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(u);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<r.length;b++){let v=r[b],y=document.createElement("div");y.className="eq-fah-item";let A=Ue(v.id);(!A||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(A))&&(A=`Campo ${b+1}`);let C=String(v.v??""),x=document.createElement("div");x.className="eq-fah-field-box";let w=document.createElement("div");w.className="eq-fah-field-label",w.textContent=A,x.appendChild(w);let T=document.createElement("div");T.className="eq-fah-field-val",T.textContent=C,x.appendChild(T),y.appendChild(x);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),y.appendChild(k),h.appendChild(y)}m.appendChild(h),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,o.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let u=document.createElement("div");u.className="eq-fah-group-title",u.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(u);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<i.length;b++){let v=i[b],y=document.createElement("div");y.className="eq-fah-item";let A=Ue(v.id);(!A||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(A))&&v.v&&(A=String(v.v)),A=M(A),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(A)&&(A="");let C="",x=A.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);x?(C=x[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),A=x[2].trim()||A):i.length>1&&(C=String.fromCharCode(65+b));let w=document.createElement("div");if(w.style.display="flex",w.style.alignItems="center",w.style.gap="8px",w.style.flex="1",C){let E=document.createElement("span");E.className="eq-fah-letter-badge",E.textContent=C,w.appendChild(E)}let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=A||(C?`Alternativa ${C}`:"Alternativa Selecionada"),w.appendChild(T),y.appendChild(w);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(A||C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),y.appendChild(k),h.appendChild(y)}m.appendChild(h),e.appendChild(m)}else if(c.length>0){t.textContent=`Sele\xE7\xE3o (${c.length} listas)`,o.textContent=String(c.length);let m=document.createElement("div");m.className="eq-fah-group";let u=document.createElement("div");u.className="eq-fah-group-title",u.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(u);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<c.length;b++){let v=c[b],y=document.createElement("div");y.className="eq-fah-item";let A=Ue(v.id);(!A||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(A))&&(A=`Lista ${b+1}`);let w=(Array.isArray(v.v)?v.v:[String(v.v??"")]).map(S=>{let q=N(v.id,void 0,!0)||N(M(v.id),void 0,!0),H=q instanceof HTMLSelectElement?q:q?.querySelector("select");if(H){let Q=M(S).toLowerCase();for(let V=0;V<H.options.length;V++){let F=H.options[V];if(F.value.toLowerCase()===Q||M(F.textContent).toLowerCase()===Q){let K=M(F.textContent);if(K&&!K.toLowerCase().includes("selecione"))return K}}}return S}).join(", "),T=document.createElement("div");T.className="eq-fah-field-box";let k=document.createElement("div");k.className="eq-fah-field-label",k.textContent=A,T.appendChild(k);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=w,T.appendChild(E),y.appendChild(T);let I=document.createElement("button");I.className="eq-fah-copy-inline",I.textContent="Copiar",I.addEventListener("click",()=>{navigator.clipboard.writeText(w),I.textContent="\u2713 Copiado",setTimeout(()=>I.textContent="Copiar",1200)}),y.appendChild(I),h.appendChild(y)}m.appendChild(h),e.appendChild(m)}else{t.textContent="Gabarito",o.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(s.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${s.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let o=e.actions.filter(i=>i.t==="drag"),s=e.actions.filter(i=>i.t==="val"),a=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),r=e.actions.filter(i=>i.t==="sel");if(o.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let c of o){let l=M(c.to)||"Geral";i[l]||(i[l]=[]),i[l].push(M(c.from))}for(let[c,l]of Object.entries(i)){t.push(`### Categoria: ${c}`);for(let p of l)t.push(`- ${p}`);t.push("")}}else if(s.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of s){let c=M(i.id);t.push(`- **${c||"Campo"}:** \`${i.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<a.length;i++){let c=a[i],l=Ue(c.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&c.v&&(l=String(c.v)),l=M(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let p=a.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${p}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of r){let c=M(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${c}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let o=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=o},1500)})}};var cn=`
...
`;var Te="v3.2.1";var dn=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:n=>n})}catch{}return null})();function Vn(n,e){try{if(dn){n.innerHTML=dn.createHTML(e);return}}catch{}try{if(typeof n.setHTMLUnsafe=="function"){n.setHTMLUnsafe(e);return}}catch{}n.innerHTML=e}var Un=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Xn=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],ct=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new rt({onStatusChange:(i,c,l)=>{this.logToConsole(c,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),c.includes("conclus\xE3o")||c.includes("finalizada")||c.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,c)=>{try{return await this.callbacks.onAnalyze(i,c,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Vn(this.shadow,`
          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                ...
                <span class="eq-brand-version">${Te}</span>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-resolver-hero">
                  <div class="eq-resolver-brand">
                    ...
                    <div class="eq-brand-copy">
                      ...
                      <div class="eq-brand-subline">BETA \u2022 ${Te}</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="eq-footer-note" style="margin-top: auto;">${Te} \u2022 H\xEDbrido 4.0 (RAG + AST + Vision)</div>
              </div>
              ...
              <div class="eq-view-pane" id="eq-view-debug" style="display:none;flex-direction:column;">
                ...
                <div id="eq-term-panel-terminal" style="flex:1;display:flex;flex-direction:column;overflow:hidden;min-height:0;position:relative;">
                  ...
                  <div id="eq-term-output" style="flex:1;overflow-y:auto;overflow-x:hidden;padding:10px 14px 6px;font-family:'Cascadia Code','Fira Code','Courier New',monospace;font-size:11.5px;line-height:1.65;background:#0a0a0a;color:#ddd;user-select:text;-webkit-user-select:text;cursor:text;outline:none;caret-color:transparent;">
                    ...
                    <div data-perm="1" style="white-space:pre;font-family:inherit;"><span style="color:#1a1a1a;">\u2551  </span><span style="color:#444;">${Te}                                  </span><span style="color:#1a1a1a;">\u2551</span></div>
                    <div data-perm="1" style="white-space:pre;color:#1a1a1a;font-family:inherit;">\u2551                                      \u2551</div>
                  ...
                  <div class="eq-key-input-container">
                    ...
                    <div class="eq-context-menu" id="eq-key-context-menu" hidden>
                      <button class="eq-context-item" id="eq-menu-prompt" type="button">
                        <span class="eq-item-icon">${L.edit}</span>
                      ...
                      <button class="eq-context-item" id="eq-menu-paste" type="button">
                        <span class="eq-item-icon">${L.paste}</span>
                      ...
                      <button class="eq-context-item" id="eq-menu-toggle-vis" type="button">
                        <span class="eq-item-icon" id="eq-menu-vis-icon">${L.eye}</span>
                      ...
                      <button class="eq-context-item" id="eq-menu-clear" type="button">
                        <span class="eq-item-icon">${L.eraser}</span>
                      ...
                      <button class="eq-context-item" id="eq-menu-bulk" type="button">
                        <span class="eq-item-icon">${L.listPlus}</span>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new lt(this.shadow,()=>{this.callbacks.onAnalyze(1)});let o=this.shadow.querySelector("#eq-open-hud-btn");o&&o.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),Ie.filter(i=>se(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===e.model))),Un.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===e.modeHint))),Xn.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let s=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];j.init(s),this.apiKeyInput.value=j.getBestKey()||e.apiKey||"",this.renderKeysList();let a=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof a?.unref=="function"&&a.unref();let r=j.getBestKey()||e.apiKey;r&&Ze(r).then(i=>{i&&i.length>0&&this.updateModelSelect(i,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];this.shadow.querySelector(".eq-views-wrapper")?.classList.toggle("is-brain-active",e==="brain");for(let s of t){let a=this.shadow.querySelector(`#eq-tab-${s}`),r=this.shadow.querySelector(`#eq-view-${s}`),i=s===e;a?.classList.toggle("active",i),r&&(r.style.display=i?"flex":"none")}switch(this.updateContextBar(e),e){case"brain":this.initBrainControls(),this.renderContextTree(),this.refreshInspectorView();break;case"metrics":try{this.updateTimingMetrics()}catch{}break;case"debug":try{this.refreshDebugView(),this.renderTerminalEntries(),this.initTerminalREPL()}catch{}break;case"settings":break}}updateContextBar(e){let t=this.shadow.querySelector("#eq-ctxbar-icon"),o=this.shadow.querySelector("#eq-ctxbar-name"),s=this.shadow.querySelector("#eq-ctxbar-sub"),a=this.shadow.querySelector("#eq-ctxbar-actions");if(!t||!o||!s||!a)return;a.innerHTML="";let i={resolver:{icon:L.sparkles,label:"Resolver",sub:"Autopilot & opera\xE7\xF5es",color:"#a78bfa",actions:()=>{let c=document.createElement("span");return c.id="eq-ctxbar-status",c.style.cssText="font-size:9px;font-weight:700;padding:2px 7px;border-radius:10px;background:rgba(167,139,250,0.13);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;letter-spacing:0.04em;",c.textContent="PRONTO",[c]}},brain:{icon:L.inspector,label:"C\xE9rebro da IA",sub:"Contexto & inspe\xE7\xE3o",color:"#60a5fa",actions:()=>{let c=this.shadow.querySelector("#eq-brain-canvas-toggle"),l=document.createElement("button");l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",l.innerHTML=this.brainCanvasHidden?L.eyeOff:L.eye,l.title="Mostrar/Ocultar canvas",l.addEventListener("click",()=>{c?.click(),l.innerHTML=this.brainCanvasHidden?L.eyeOff:L.eye});let p=document.createElement("button");return p.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",p.innerHTML=L.copy,p.title="Copiar conte\xFAdo selecionado",p.addEventListener("click",()=>this.smartCopy()),[l,p]}},metrics:{icon:L.clock,label:"M\xE9tricas",sub:"Cron\xF4metro & hist\xF3rico",color:"#4ade80",actions:()=>{let c=document.createElement("button");c.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",c.innerHTML=L.copy,c.title="Copiar relat\xF3rio",c.addEventListener("click",()=>this.copyMetricsReport());let l=document.createElement("button");return l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.08);border:1px solid rgba(255,85,85,0.15);border-radius:4px;cursor:pointer;color:#ff8888;",l.innerHTML=L.trash,l.title="Zerar m\xE9tricas",l.addEventListener("click",()=>{this.shadow.querySelector("#eq-metrics-reset-btn")?.click()}),[c,l]}},debug:{icon:L.code,label:"Terminal",sub:"Comandos & logs",color:"#0098ff",actions:()=>{let c=document.createElement("div");c.style.cssText="display:inline-flex;align-items:center;gap:1px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:2px;";let l=(d,m,u)=>{let h=document.createElement("button");return h.id=d,h.type="button",h.textContent=m,h.style.cssText="font-size:9px;font-weight:600;padding:2px 8px;border-radius:3px;cursor:pointer;transition:all 0.1s;background:"+(u?"#1a1a1a":"transparent")+";border:1px solid "+(u?"#333":"transparent")+";color:"+(u?"#ddd":"#555")+";",h};c.appendChild(l("eq-term-mode-terminal","Terminal",!0)),c.appendChild(l("eq-term-mode-output","Output",!1));let p=document.createElement("button");p.id="eq-term-copy-btn",p.type="button",p.title="Copiar",p.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",p.innerHTML=L.copy;let f=document.createElement("button");return f.id="eq-term-clear-btn",f.type="button",f.title="Limpar",f.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.06);border:1px solid rgba(255,85,85,0.12);border-radius:4px;cursor:pointer;color:#ff5555;",f.innerHTML=L.eraser,[c,p,f]}},settings:{icon:L.settings,label:"Configura\xE7\xF5es",sub:"Ajustes & prefer\xEAncias",color:"#fbbf24"}}[e];if(i&&(t.innerHTML=i.icon,t.style.color=i.color,o.textContent=i.label,o.style.color=i.color==="#a78bfa"?"#ccc":"#ddd",s.textContent=i.sub,i.actions))for(let c of i.actions())a.appendChild(c)}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let x=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!x))}),this.metricsResetBtn?.addEventListener("click",()=>{Re(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let x=this.getFormattedLogs();navigator.clipboard.writeText(x).then(()=>{let w=t.innerHTML;t.innerHTML=L.check,setTimeout(()=>t.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let o=this.shadow.querySelector("#eq-dbg-copy-prompt");o?.addEventListener("click",()=>{let x=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(x).then(()=>{let w=o.innerHTML;o.innerHTML=`${L.check} Copiado!`,setTimeout(()=>o.innerHTML=w,1800)})});let s=this.shadow.querySelector("#eq-dbg-copy-context");s?.addEventListener("click",()=>{let x=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(x).then(()=>{let w=s.innerHTML;s.innerHTML=`${L.check} Copiado!`,setTimeout(()=>s.innerHTML=w,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-raw-resp");a?.addEventListener("click",()=>{let x=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(x).then(()=>{let w=a.innerHTML;a.innerHTML=`${L.check} Copiado!`,setTimeout(()=>a.innerHTML=w,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-error-btn");r?.addEventListener("click",()=>{let x=this.lastErrorMsg||"";navigator.clipboard.writeText(x).then(()=>{let w=r.innerHTML;r.innerHTML=L.check,setTimeout(()=>r.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",x=>{x.altKey&&(x.key==="q"||x.key==="Q"||x.key==="a"||x.key==="A")&&(x.preventDefault(),this.toggle())},!0);let i=x=>{let w=x.composedPath();w.includes(this.shadow)||(w.includes(this.sidebarEl)||w.includes(this.host))&&x.stopImmediatePropagation()};window.addEventListener("keydown",i,!0),window.addEventListener("keyup",i,!0),window.addEventListener("keypress",i,!0),this.apiKeyInput.addEventListener("input",()=>{let x=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:x})});let c=this.shadow.querySelector("#eq-keys-collapsible"),l=this.shadow.querySelector("#eq-keys-chevron"),p=this.shadow.querySelector("#eq-keys-section-header"),f=x=>{c&&(x?(c.style.display="none",l&&(l.style.transform="rotate(0deg)")):(c.style.display="block",c.style.maxHeight="none",c.style.overflow="visible",l&&(l.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}f(d),p?.addEventListener("click",x=>{if(x.target?.closest("a"))return;let w=c?.style.display==="none";f(!w);try{localStorage.setItem("easyquiz_keys_collapsed",w?"false":"true")}catch{}});let m=this.shadow.querySelector("#eq-auto-menu-btn"),u=this.shadow.querySelector("#eq-auto-menu");u&&(u.hidden=!0),m?.classList.remove("is-open"),m?.addEventListener("click",x=>{if(x.stopPropagation(),!u)return;let w=u.hidden;u.hidden=!w,m.classList.toggle("is-open",!u.hidden)}),u?.querySelectorAll("[data-auto-action]").forEach(x=>{x.addEventListener("click",w=>{w.stopPropagation();let T=x.dataset.autoAction;T==="toggle"?this.analyzeBtn?.click():T==="memory"?(We(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):T==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),u&&(u.hidden=!0),m?.classList.remove("is-open")})}),this.shadow.addEventListener("click",x=>{x.target.closest(".eq-menu-shell")||(u&&(u.hidden=!0),m?.classList.remove("is-open"))});let h=this.shadow.querySelector("#eq-result-toggle"),b=this.shadow.querySelector("#eq-result-body");h&&b&&(b.classList.add("is-collapsed"),h.classList.remove("is-open"),h.addEventListener("click",()=>{let x=h.classList.toggle("is-open");b.classList.toggle("is-collapsed",!x)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let x=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!x){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let w=j.addKey(x);if(w.ok){let T=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${T.length} chaves ativas no pool)`,"success"),f(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,$e(x).then(k=>{k.ok?(j.markSuccess(x,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(j.markInvalid(x,k.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${k.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(w.message,"warning")}),this.keyMoreBtn.addEventListener("click",x=>{x.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",x=>{let w=x.target;!w.closest("#eq-key-context-menu")&&!w.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(x!==null&&x.trim()){let w=x.trim().replace(/^["']|["']$/g,""),T=j.addKey(w);if(T.ok){let k=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(T.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let x=await navigator.clipboard.readText();if(x){let w=x.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=w,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let x=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(x!==null&&x.trim()){let w=x.trim().replace(/^["']|["']$/g,"");if(j.addKey(w).ok){let k=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=this.apiKeyInput.type==="password";this.apiKeyInput.type=x?"text":"password";let w=this.shadow.querySelector("#eq-menu-vis-icon"),T=this.shadow.querySelector("#eq-menu-vis-text");w&&(w.innerHTML=x?L.eyeOff:L.eye),T&&(T.textContent=x?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let x=document.createElement("div");x.id="eq-bulk-overlay",x.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let w=document.createElement("div");w.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),w.innerHTML=`
      ...
      `,x.appendChild(w),this.shadow.appendChild(x);let T=w.querySelector("#eq-bulk-ta"),k=w.querySelector("#eq-bulk-status"),E=w.querySelector("#eq-bulk-import"),I=w.querySelector("#eq-bulk-paste-btn"),S=w.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>T?.focus());let q=()=>{x.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(H=>{x.addEventListener(H,Q=>{Q.stopPropagation(),Q.stopImmediatePropagation()},!0)}),x.addEventListener("keydown",H=>{H.key==="Escape"&&q()}),x.addEventListener("click",H=>{H.target===x&&q()}),w.querySelector("#eq-bulk-x")?.addEventListener("click",q),w.querySelector("#eq-bulk-cancel")?.addEventListener("click",q),S.addEventListener("click",()=>{T.value="",k.textContent="",T.focus()}),I.addEventListener("click",async()=>{try{let H=await navigator.clipboard?.readText();H?(T.value=H,T.focus(),k.style.color="#38bdf8",k.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(k.style.color="#fbbf24",k.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{k.style.color="#fbbf24",k.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",T.focus()}}),w.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let H=T.value.trim();if(!H){k.style.color="#f87171",k.textContent="Insira pelo menos uma chave de API antes de importar.";return}let Q=H.match(/AIza[0-9A-Za-z\-_]{35}/g),V=[];if(Q&&Q.length>0?V=Array.from(new Set(Q)):V=Array.from(new Set(H.split(/[\n,;\s]+/).map(ee=>ee.trim().replace(/^["'`]|["'`]$/g,"")).filter(ee=>ee.length>=20))),V.length===0){k.style.color="#f87171",k.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}k.style.color="#00e5ff",k.textContent=`Processando ${V.length} chave(s)...`,E.disabled=!0,E.style.opacity="0.6";let F=0,K=0;for(let ee of V){let Z=j.addKey(ee);Z.ok?F++:Z.message.includes("j\xE1 est\xE1 cadastrada")&&K++}if(F>0){let ee=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:ee[0],apiKeys:ee}),f(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}k.textContent=`${F} adicionada(s), ${K} duplicada(s). Validando modelo em paralelo...`;let $=j.exportRawKeys(),oe=this.modelSelect?.value||"gemini-3.5-flash-lite",_=await bt(oe,$);_.ok?(j.markSuccess(_.key,200),k.style.color="#4ade80",k.textContent=` ${F} adicionada(s), ${K} duplicada(s). Modelo '${_.model}' pronto!`):(k.style.color="#fbbf24",k.textContent=`${F} adicionada(s), ${K} duplicada(s). Aviso: ${_.message}`),this.renderKeysList(),E.disabled=!1,E.style.opacity="1",F>0&&(this.setStatus(` Lote importado: ${F} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(q,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let x=j.exportRawKeys(),w=document.createElement("div");w.id="eq-text-editor-overlay",w.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let T=document.createElement("div");T.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),T.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
      ...
      `,w.appendChild(T),this.shadow.appendChild(w);let k=T.querySelector("#eq-edittext-ta"),E=T.querySelector("#eq-edittext-status");k.value=x.join(`
`),requestAnimationFrame(()=>{k.focus(),k.select()});let I=()=>w.remove();["keydown","keyup","keypress","paste","copy","cut"].forEach(S=>{w.addEventListener(S,q=>{q.stopPropagation(),q.stopImmediatePropagation()},!0)}),w.addEventListener("keydown",S=>{S.key==="Escape"&&I()}),w.addEventListener("click",S=>{S.target===w&&I()}),T.querySelector("#eq-edittext-x")?.addEventListener("click",I),T.querySelector("#eq-edittext-cancel")?.addEventListener("click",I),T.querySelector("#eq-edittext-clear")?.addEventListener("click",()=>{confirm("Apagar todas as chaves? Esta a\xE7\xE3o \xE9 irrevers\xEDvel.")&&(k.value="",E.style.color="#fbbf24",E.textContent="Campo limpo. Clique em Salvar para confirmar a remo\xE7\xE3o de todas as chaves.")}),T.querySelector("#eq-edittext-save")?.addEventListener("click",()=>{let S=k.value.split(/[\n\r]+/).map(Q=>Q.trim().replace(/^["']|["']$/g,"")).filter(Q=>Q.length>5),q=Array.from(new Set(S));j.init(q);let H=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:H[0]||"",apiKeys:H}),this.renderKeysList(),E.style.color="#4ade80",q.length===0?E.textContent=" Todas as chaves removidas.":E.textContent=` ${q.length} chave(s) salva(s) com sucesso!`,this.setStatus(q.length>0?` ${q.length} chave(s) salva(s)!`:"Todas as chaves foram removidas.",q.length>0?"success":"info"),setTimeout(I,1400)})}),this.shadow.querySelector("#eq-menu-delete-all")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=j.getAllKeys();if(x.length===0)return this.setStatus("Nenhuma chave para apagar.","info");confirm(`Apagar todas as ${x.length} chave(s) permanentemente?`)&&(j.init([]),this.callbacks.onSettingsChange({apiKey:"",apiKeys:[]}),this.renderKeysList(),this.setStatus("Todas as chaves foram removidas.","info"))}),this.shadow.querySelector("#eq-menu-test")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;let x=j.getAllKeys();if(x.length===0)return this.setStatus("Nenhuma chave cadastrada para testar.","error");this.setStatus(` Testando ${x.length} chave(s) em paralelo...`,"info");let w=this.modelSelect?.value||"gemini-3.5-flash-lite",T=x.map(E=>E.key),k=await bt(w,T);if(k.ok)j.markSuccess(k.key,150),this.setStatus(` Validado! Modelo '${k.model}' respondeu com sucesso!`,"success");else{let E=await Promise.allSettled(T.map(S=>$e(S))),I=0;E.forEach((S,q)=>{if(S.status==="fulfilled"&&S.value.ok)I++,j.markSuccess(T[q],200);else{let H=S.status==="fulfilled"?S.value.message:String(S.reason);j.markInvalid(T[q],H)}}),this.setStatus(`Teste: ${I}/${x.length} chave(s) v\xE1lidas. ${k.message}`,I>0?"info":"error")}this.renderKeysList()});let y=()=>{this.keyContextMenu.hidden=!0,window.confirm("Deseja realmente resetar todos os dados, chaves e mem\xF3ria de sess\xE3o do EasyQuiz?")&&(this.autopilot.isActive()&&this.autopilot.stop(),this.updateAutopilotUi(!1),this.setBusy(!1),Dt(),Re(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.className="eq-live-stopwatch-status"),this.updateTimingMetrics(),this.apiKeyInput.value="",this.callbacks.onSettingsChange({apiKey:""}),this.setStatus("Todos os dados do EasyQuiz foram limpos.","info"),this.logToConsole("> [SYS] Armazenamento local resetado.","text-yellow"))};this.shadow.querySelector("#eq-menu-reset")?.addEventListener("click",y),this.shadow.querySelector("#eq-reset-all-btn")?.addEventListener("click",y),this.apToggleBtn?.addEventListener("click",()=>{if(this.autopilot.isActive())this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setInterrupted("Autopilot interrompido imediatamente pelo usu\xE1rio.");else{if(!this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"")){this.setStatus("Configure sua chave de API Gemini na aba Configura\xE7\xF5es antes de ligar o Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,vt(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Autopilot ativo. Monitorando exerc\xEDcios...","info")}}),this.shadow.querySelector("#eq-ap-clear-memory")?.addEventListener("click",()=>{We(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")});let C=this.shadow.querySelector("#eq-copy-console-btn");C?.addEventListener("click",()=>{let x=this.apConsole?.innerText||"";navigator.clipboard.writeText(x).then(()=>{let w=C.innerHTML;C.innerHTML=L.check,setTimeout(()=>C.innerHTML=w,1800)})}),this.copyPromptBtn?.addEventListener("click",()=>{let x=this.inspPrompt.textContent||"";navigator.clipboard.writeText(x).then(()=>{if(!this.copyPromptBtn)return;let w=this.copyPromptBtn.innerHTML;this.copyPromptBtn.innerHTML=`${L.check} Copiado!`,setTimeout(()=>this.copyPromptBtn.innerHTML=w,2e3)})}),this.modelSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({model:this.modelSelect.value})),this.modeSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({modeHint:this.modeSelect.value})),this.engineSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({engine:this.engineSelect.value})),this.dryRunCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({dryRun:this.dryRunCheckbox.checked})),this.autoApplyCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoApply:this.autoApplyCheckbox.checked})),this.autoAdvanceCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoAdvance:this.autoAdvanceCheckbox.checked})),this.useVisionCheckbox.addEventListener("change",()=>{let x=this.useVisionCheckbox.checked;this.callbacks.onSettingsChange({useVision:x}),this.setStatus(x?"Vis\xE3o Computacional ativada (capturas habilitadas).":"Modo DOM R\xE1pido ativado (capturas desabilitadas).","info")}),this.hostDarkModeCheckbox.addEventListener("change",()=>{let x=this.hostDarkModeCheckbox.checked;this.callbacks.onSettingsChange({hostDarkMode:x}),this.applyHostDarkMode(x)}),this.analyzeBtn?.addEventListener("click",async()=>{if(this.analyzeBtn.classList.contains("danger")){this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setBusy(!1),this.setInterrupted("Resolver Autopilot interrompido pelo usu\xE1rio.");return}if(!this.apiKeyInput.value.trim().replace(/^['"]|['"]$/g,"")){this.setStatus("Configure sua chave de API Gemini antes de ativar o Resolver Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,vt(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Resolver Autopilot ativo. Monitorando e respondendo...","info")}),this.applyBtn&&this.applyBtn.addEventListener("click",()=>this.callbacks.onApply())}startStopwatch(){this.stopStopwatch(),this.stopwatchStartTime=Date.now();let e=()=>{let t=((Date.now()-this.stopwatchStartTime)/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)};e(),this.stopwatchInterval=setInterval(e,100)}stopStopwatch(e){if(this.stopwatchInterval&&(clearInterval(this.stopwatchInterval),this.stopwatchInterval=null),e!==void 0){let t=(e/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)}}setLogFilter(e){this.activeLogFilter=e;let t=["all","error","ai","dom"];for(let o of t){let s=this.shadow.querySelector(`#eq-dbg-filter-${o}`);o===e?s?.classList.add("active"):s?.classList.remove("active")}this.renderTerminalEntries()}updateLogCounters(){let e=0,t=0,o=0;for(let s of this.logEntries)s.category==="error"?e++:s.category==="ai"?t++:s.category==="dom"&&o++;this.dbgCountAll&&(this.dbgCountAll.textContent=String(this.logEntries.length)),this.dbgCountError&&(this.dbgCountError.textContent=String(e)),this.dbgCountAi&&(this.dbgCountAi.textContent=String(t)),this.dbgCountDom&&(this.dbgCountDom.textContent=String(o))}renderTerminalEntries(){if(!this.liveDebugTerminal)return;this.liveDebugTerminal.replaceChildren();let e=this.activeLogFilter==="all"?[...this.logEntries]:this.logEntries.filter(t=>t.category===this.activeLogFilter);if(this.outputSearchQuery){let t=this.outputSearchQuery.toLowerCase();e=e.filter(o=>o.message.toLowerCase().includes(t))}if(this.outputSortNewest||(e=e.reverse()),e.length===0){let t=document.createElement("div");t.style.cssText="color:#333;font-style:italic;white-space:pre-wrap;",t.textContent=this.outputSearchQuery?'Nenhum resultado para "'+this.outputSearchQuery+'".':'Nenhum log para o filtro "'+this.activeLogFilter.toUpperCase()+'".',this.liveDebugTerminal.appendChild(t);return}for(let t of e){let o=document.createElement("div");o.style.cssText="padding:1px 0;white-space:pre-wrap;overflow-wrap:break-word;word-break:break-word;max-width:100%;",o.textContent=t.message,t.colorClass&&(o.className=t.colorClass),this.liveDebugTerminal.appendChild(o)}this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}appendTerminalLine(e,t){if(!this.liveTerminalOutput)return;let o=this.shadow.querySelector("#eq-term-current-line"),s=document.createElement("div");s.style.cssText="padding:0;white-space:pre-wrap;overflow-wrap:break-word;",s.textContent=e;let a=t==="text-red"?"#ff4444":t==="text-blue"?"#888":t==="text-green"?"#aaa":t==="text-yellow"?"#888":"#ccc";for(s.style.color=a,o?this.liveTerminalOutput.insertBefore(s,o):this.liveTerminalOutput.appendChild(s);this.liveTerminalOutput.children.length>600;){let r=this.liveTerminalOutput.firstChild;if(r&&r!==o)this.liveTerminalOutput.removeChild(r);else break}this.liveTerminalOutput.scrollTop=this.liveTerminalOutput.scrollHeight}initTerminalREPL(){if(this.liveTerminalOutput=this.shadow.querySelector("#eq-term-output"),this._terminalInited){this._reconnectContextbarBtns();return}this._terminalInited=!0;let e=this.shadow.querySelector("#eq-term-capture"),t=this.shadow.querySelector("#eq-term-output"),o=this.shadow.querySelector("#eq-term-typed"),s=this.shadow.querySelector("#eq-term-current-line"),a=this.shadow.querySelector("#eq-term-panel-terminal"),r=this.shadow.querySelector("#eq-term-panel-output"),i=this.shadow.querySelector("#eq-output-toolbar"),c=this.shadow.querySelector("#eq-output-search"),l=this.shadow.querySelector("#eq-output-search-clear"),p=this.shadow.querySelector("#eq-output-filter-btn"),f=this.shadow.querySelector("#eq-output-filter-menu"),d=this.shadow.querySelector("#eq-fchk-apply"),m=(z,B="#888",D=13)=>`<span style="display:inline-flex;vertical-align:middle;width:${D}px;height:${D}px;color:${B};flex-shrink:0;">${L[z]||""}</span>`,u=(z,B="")=>{if(!t||!s)return;let D=document.createElement("div");D.style.cssText="padding:0;white-space:pre-wrap;overflow-wrap:break-word;word-break:break-word;max-width:100%;line-height:1.65;"+B,D.innerHTML=z,t.insertBefore(D,s)},h=(z,B="#cccccc")=>u(`<span style="color:${B};">${z}</span>`),b=()=>h("","#000"),v=(z=52)=>h("  "+"\u2500".repeat(z),"#222"),y=(z,B,D)=>{let U=z.map((R,J)=>R.padEnd(B[J]||0)),P=D?U.map((R,J)=>`<span style="color:${D[J]||"#aaa"}">${R}</span>`):U.map(R=>`<span style="color:#aaa">${R}</span>`);u("  "+P.join("  ")+"  ")},A=z=>{let B=z.trim().split(/s+/),D=B[0].toLowerCase();switch(D){case"help":b(),u("  "+m("terminal","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> COMANDOS DISPON\xCDVEIS</span>'),b(),[["help","lista todos os comandos","list","#666"],["status","estado atual do sistema","sparkles","#666"],["version","vers\xE3o e info do build","info","#666"],["info-api","dados da \xFAltima requisi\xE7\xE3o \xE0 API","chip","#666"],["tokens","tokens consumidos (detalhado)","code","#666"],["context","contexto da quest\xE3o atual","eye","#666"],["controls","controles detectados (tabela)","list","#666"],["errors","erros recentes registrados","info","#666"],["logs [n]","\xFAltimas N entradas do output","file","#666"],["history","hist\xF3rico de quest\xF5es respondidas","clock","#666"],["reset","limpa logs e m\xE9tricas","eraser","#666"],["clear","limpa o terminal","trash","#666"],["copy","copia terminal para clipboard","copy","#666"]].forEach(([P,R,J,ae])=>{u(`    ${m(J,ae,11)} <span style="color:#ccc;font-weight:600;min-width:72px;display:inline-block;">${P.padEnd(10)}</span> <span style="color:#555;">${R}</span>`)}),b();break;case"clear":t&&s&&[...t.children].forEach(R=>{R!==s&&R.remove()});return;case"info-api":{let P=this.latestPlan;b(),u("  "+m("chip","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> INFORMA\xC7\xD5ES DA API</span>'),v(44);let R=(J,ae,ze,Pe,Oe="#aaa")=>u(`  ${m(J,ae,11)}  <span style="color:#444;">${ze.padEnd(16)}</span><span style="color:${Oe};font-weight:600;">${Pe||"--"}</span>`);R("sparkles","#888","Modelo",P?.usedModel||this.initialSettings?.model||"--","#ccc"),R("clock","#888","Lat\xEAncia",P?.durationMs?P.durationMs+"ms":"--","#ccc"),R("code","#888","Prompt tokens",String(P?.promptTokens??"--")),R("code","#888","Resp. tokens",String(P?.candidatesTokens??"--")),R("chip","#aaa","Total tokens",String(P?.tokensUsed??"--"),"#fff"),R("file","#888","Prompt chars",this.latestPromptText?.length?this.latestPromptText.length+" chars":"--"),v(44),b();break}case"version":b(),u("  "+m("sparkles","#888",14)+` <span style="color:#ddd;font-weight:700;"> EasyQuiz ${typeof Te<"u"?Te:"?"}</span>`),h("  Motor: H\xEDbrido 4.0  \xB7  RAG + AST + Vision + Multimodal","#555"),h("  Build: "+new Date().toLocaleDateString("pt-BR"),"#333"),b();break;case"status":{let P=this.latestPlan,R=this.latestContext;b(),u("  "+m("inspector","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> STATUS DO SISTEMA</span>'),v(44);let J=(ae,ze,Pe,Oe,De="#aaa")=>u(`  ${m(ae,ze,11)}  <span style="color:#444;">${Pe.padEnd(14)}</span><span style="color:${De};">${Oe||"--"}</span>`);if(J("sparkles","#888","Modelo",P?.usedModel||this.initialSettings?.model||"--","#ccc"),J("play","#888","Modo",P?.mode||"aguardando"),J("clock","#888","Lat\xEAncia",P?.durationMs?P.durationMs+"ms":"--","#aaa"),J("chip","#888","Tokens",String(P?.tokensUsed??"--")),J("analyze","#888","Confian\xE7a",P?Math.round(P.confidence*100)+"%":"--"),J("eye","#888","Controles",R?String(R.controls.length):"--"),R){let ae='"'+R.questionText.slice(0,50)+(R.questionText.length>50?"...":"")+'"';J("file","#888","Contexto",ae,"#666")}v(44),b();break}case"tokens":{let P=this.latestPlan;if(b(),!P){h("  Nenhuma requisi\xE7\xE3o ainda.","#444"),b();break}u("  "+m("code","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> TOKENS CONSUMIDOS</span>'),v(38),h(`  Prompt tokens    ${String(P.promptTokens??"--").padStart(8)}`,"#888"),h(`  Response tokens  ${String(P.candidatesTokens??"--").padStart(8)}`,"#888"),h("  "+"\u2508".repeat(28),"#222"),h(`  Total            ${String(P.tokensUsed??"--").padStart(8)}`,"#ddd"),h(`  Lat\xEAncia         ${(P.durationMs?P.durationMs+"ms":"--").padStart(8)}`,"#aaa"),v(38),b();break}case"context":{let P=this.latestContext;if(b(),!P){h("  Contexto n\xE3o dispon\xEDvel.","#444"),b();break}u("  "+m("eye","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> CONTEXTO ATUAL</span>'),v(44),h("  Escopo    "+P.scope.tagName.toLowerCase()+(P.scope.id?"#"+P.scope.id:""),"#aaa"),h("  Controles "+P.controls.length,"#aaa"),h("  Texto     "+P.questionText.slice(0,55)+(P.questionText.length>55?"...":""),"#888"),v(44),b();break}case"controls":{let P=this.latestContext;if(b(),!P?.controls.length){h("  Nenhum controle detectado.","#444"),b();break}u("  "+m("list","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> CONTROLES (${P.controls.length})</span>`),v(55),y(["#","Tipo","Label / ID","Valor"],[3,10,27,10],["#555","#777","#aaa","#888"]),h("  "+"\u2508".repeat(53),"#222"),P.controls.forEach((R,J)=>y([String(J+1),(R.type||R.tag||"?").toUpperCase().slice(0,9),(R.label||R.id||R.name||"\u2014").slice(0,26),(R.value||"\u2014").slice(0,9)],[3,10,27,10],["#555","#777","#ccc","#888"])),v(55),b();break}case"errors":{let P=this.logEntries.filter(R=>R.category==="error");if(b(),!P.length){u("  "+m("check","#4ade80",11)+' <span style="color:#555;"> Nenhum erro nesta sess\xE3o.</span>'),b();break}u("  "+m("info","#ff5555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> ERROS (${P.length})</span>`),v(44),P.slice(-15).forEach(R=>h("  "+R.message,"#888")),v(44),b();break}case"logs":{let P=Math.min(parseInt(B[1]||"10",10)||10,50),R=this.logEntries.slice(-P);if(b(),!R.length){h("  Nenhum log.","#444"),b();break}u("  "+m("file","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> \xDALTIMAS ${P} ENTRADAS</span>`),v(44),R.forEach(J=>h("  "+J.message,"#777")),v(44),b();break}case"history":{let P=this.metricsHistory;if(b(),!P?.length){h("  Nenhuma quest\xE3o respondida.","#444"),b();break}u("  "+m("clock","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> HIST\xD3RICO (${P.length})</span>`),v(58),y(["#","Quest\xE3o","Tempo","Modelo"],[3,38,7,10],["#555","#aaa","#888","#777"]),h("  "+"\u2508".repeat(58),"#222"),P.slice(-15).forEach((R,J)=>y([String(J+1),(R.questionTitle||"Quest\xE3o").slice(0,37),R.durationMs?(R.durationMs/1e3).toFixed(1)+"s":"--",(R.model||"--").slice(0,9)],[3,38,7,10],["#555","#ccc","#888","#777"])),v(58),b();break}case"reset":this.clearLogs(),b(),u("  "+m("check","#888",11)+' <span style="color:#666;"> Logs e m\xE9tricas resetados.</span>'),b();break;case"copy":{if(!t)break;let P=Array.from(t.children).filter(R=>R!==s).map(R=>R.textContent||"");navigator.clipboard.writeText(P.join(`
`)).then(()=>{u("  "+m("copy","#888",11)+' <span style="color:#666;"> Conte\xFAdo copiado para a \xE1rea de transfer\xEAncia.</span>'),this.showToast("Terminal copiado","success",2e3)});break}case"":break;default:b(),u(`  <span style="color:#555;">Comando n\xE3o reconhecido: </span><span style="color:#888;">&quot;${D}&quot;</span>`),u('  <span style="color:#333;">Digite </span><span style="color:#666;font-weight:600;">help</span><span style="color:#333;"> para ver os comandos.</span>'),b()}t&&(t.scrollTop=t.scrollHeight)},C=z=>{this.terminalMode=z;let B=z==="terminal";a&&(a.style.display=B?"flex":"none"),r&&(r.style.display=B?"none":"flex"),i&&(i.style.display=B?"none":"flex");let D=this.shadow.querySelector("#eq-term-mode-terminal"),U=this.shadow.querySelector("#eq-term-mode-output");D&&(D.style.background=B?"#181818":"transparent",D.style.borderColor=B?"#2a2a2a":"transparent",D.style.color=B?"#ddd":"#555"),U&&(U.style.background=B?"transparent":"#181818",U.style.borderColor=B?"transparent":"#2a2a2a",U.style.color=B?"#555":"#ddd"),B||this.renderTerminalEntries()};this._reconnectContextbarBtns=()=>{let z=this.shadow.querySelector("#eq-term-mode-terminal"),B=this.shadow.querySelector("#eq-term-mode-output");z?.addEventListener("click",()=>C("terminal")),B?.addEventListener("click",()=>C("output"));let D=this.shadow.querySelector("#eq-term-copy-btn"),U=this.shadow.querySelector("#eq-term-clear-btn");D?.addEventListener("click",()=>{let P=J=>{let ae=J.style.color;J.style.color="#4ade80",setTimeout(()=>J.style.color=ae,400)},R=window.getSelection()?.toString()||"";if(this.terminalMode==="terminal"){if(R)navigator.clipboard.writeText(R).then(()=>{this.showToast("Sele\xE7\xE3o copiada","success",2e3),D&&P(D)});else if(t){let J=Array.from(t.children).filter(ae=>ae!==s).map(ae=>ae.textContent||"");navigator.clipboard.writeText(J.join(`
`)).then(()=>{this.showToast("Terminal copiado","success",2e3),D&&P(D)})}}else R?navigator.clipboard.writeText(R).then(()=>{this.showToast("Sele\xE7\xE3o copiada","success",2e3),D&&P(D)}):navigator.clipboard.writeText(this.getFormattedLogs()).then(()=>{this.showToast("Output copiado","success",2e3),D&&P(D)})}),U?.addEventListener("click",()=>{this.terminalMode==="terminal"?(t&&s&&[...t.children].forEach(P=>{P!==s&&P.dataset?.perm!=="1"&&P.remove()}),o&&(o.textContent="")):this.clearLogs()})},this._reconnectContextbarBtns();let x=()=>{e?.focus(),t?.classList.remove("eq-term-unfocused")},T=(()=>{try{let B=document.createElement("canvas").getContext("2d");return B?(B.font='11.5px "Cascadia Code","Fira Code","Courier New",monospace',B.measureText("X").width):6.9}catch{return 6.9}})(),k=()=>parseFloat(getComputedStyle(t).lineHeight)||19,E=14,I=10,S=this.shadow.querySelector("#eq-click-cursor");t&&(t.style.position="relative"),S&&(t?.appendChild(S),S.style.position="absolute",S.style.width=T+"px",S.style.height="2px",S.style.animation="eq-term-blink 0.9s step-end infinite");let q=(z,B)=>{if(!S||!t)return;let D=k(),U=Math.max(0,Math.floor((z-E)/T)),P=Math.max(0,Math.floor((B-I)/D)),R=U*T+E,J=P*D+I;S.style.left=R+"px",S.style.top=J+D-2+"px",S.style.width=T+"px",S.style.height="2px",S.style.animation="eq-term-blink 0.9s step-end infinite",S.style.display="block"},H=0,Q=0,V=!1;t?.addEventListener("mousedown",z=>{H=z.clientX,Q=z.clientY,V=!1,S&&(S.style.display="none");let B=t.getBoundingClientRect(),D=z.clientX-B.left+t.scrollLeft,U=z.clientY-B.top+t.scrollTop;q(D,U),setTimeout(()=>{V||x()},80)}),t?.addEventListener("mousemove",z=>{if(z.buttons===1){let B=Math.abs(z.clientX-H),D=Math.abs(z.clientY-Q);(B>2||D>2)&&(V=!0,S&&(S.style.display="none"))}}),t?.addEventListener("mouseup",()=>{if(V){V=!1;let z=window.getSelection();z&&z.toString().trim().length>0||x()}}),e?.addEventListener("keydown",()=>{S&&(S.style.display="none")},{passive:!0}),t?.addEventListener("focus",()=>t.classList.remove("eq-term-unfocused")),e?.addEventListener("blur",()=>t?.classList.add("eq-term-unfocused")),e?.addEventListener("focus",()=>t?.classList.remove("eq-term-unfocused")),e?.addEventListener("keydown",z=>{if(!o)return;let B=o.textContent||"";if(z.key==="Enter"){z.preventDefault();let D=B.trim();if(o.textContent="",this.terminalCmdHistoryIdx=-1,D&&(this.terminalCmdHistory.unshift(D),this.terminalCmdHistory.length>50&&this.terminalCmdHistory.pop()),s){let U=document.createElement("div");U.style.cssText="white-space:pre-wrap;overflow-wrap:break-word;",U.innerHTML=`<span style="color:#fff;font-weight:700;">EasyQuiz_Legacy:&nbsp;</span><span style="color:#888;">${D}</span>`,t?.insertBefore(U,s)}D&&A(D),t&&(t.scrollTop=t.scrollHeight)}else if(z.key==="Backspace")z.preventDefault(),o.textContent=B.slice(0,-1);else if(z.key==="ArrowUp")z.preventDefault(),this.terminalCmdHistoryIdx=Math.min(this.terminalCmdHistoryIdx+1,this.terminalCmdHistory.length-1),this.terminalCmdHistoryIdx>=0&&(o.textContent=this.terminalCmdHistory[this.terminalCmdHistoryIdx]);else if(z.key==="ArrowDown")z.preventDefault(),this.terminalCmdHistoryIdx=Math.max(this.terminalCmdHistoryIdx-1,-1),o.textContent=this.terminalCmdHistoryIdx>=0?this.terminalCmdHistory[this.terminalCmdHistoryIdx]:"";else if(z.key==="c"&&z.ctrlKey){let D=window.getSelection()?.toString()||"";D?navigator.clipboard.writeText(D):o?.textContent&&navigator.clipboard.writeText(o.textContent);let U=this.shadow.querySelector("#eq-term-copy-btn");if(U){let P=U.style.color;U.style.color="#4ade80",setTimeout(()=>U.style.color=P,400)}}else z.key==="v"&&z.ctrlKey?(z.preventDefault(),navigator.clipboard.readText().then(D=>{o&&(o.textContent=(o.textContent||"")+D.replace(/\n/g," ")),t&&(t.scrollTop=t.scrollHeight)})):z.key==="l"&&z.ctrlKey?(z.preventDefault(),t&&s&&[...t.children].forEach(D=>{D!==s&&D.dataset?.perm!=="1"&&D.remove()}),o.textContent=""):z.key.length===1&&!z.ctrlKey&&!z.metaKey&&(z.preventDefault(),o.textContent=B+z.key,t&&(t.scrollTop=t.scrollHeight))}),e?.addEventListener("paste",z=>{z.preventDefault();let B=z.clipboardData?.getData("text")||"",D=/\n/g;o&&(o.textContent=(o.textContent||"")+B.replace(D," "))});let F=()=>{let z=this.shadow.querySelector("#eq-fchk-all")?.checked,B=this.shadow.querySelector("#eq-fchk-error")?.checked,D=this.shadow.querySelector("#eq-fchk-ai")?.checked,U=this.shadow.querySelector("#eq-fchk-dom")?.checked;z?this.activeLogFilter="all":B&&!D&&!U?this.activeLogFilter="error":D&&!B&&!U?this.activeLogFilter="ai":U&&!B&&!D?this.activeLogFilter="dom":this.activeLogFilter="all";let P=this.shadow.querySelector("#eq-output-filter-label"),R={all:"Todos",error:"Erros",ai:"IA",dom:"DOM"};if(P){let J={all:"Todos",error:"Erros",ai:"IA",dom:"DOM"},ae=this.shadow.querySelector("#eq-fchk-error")?.checked,ze=this.shadow.querySelector("#eq-fchk-ai")?.checked,Pe=this.shadow.querySelector("#eq-fchk-dom")?.checked,Oe=this.shadow.querySelector("#eq-fchk-all")?.checked,De=[ae,ze,Pe].filter(Boolean).length;Oe||De===0?P.textContent="Todos":De===1?P.textContent=J[this.activeLogFilter]||this.activeLogFilter:P.textContent="\u22EF ("+De+")"}this.renderTerminalEntries()};p?.addEventListener("click",z=>{if(z.stopPropagation(),!f)return;let B=f.style.display!=="none";f.style.display=B?"none":"block"}),f?.addEventListener("mousedown",z=>z.stopPropagation());let K=this.shadow.querySelector("#eq-fchk-all"),$=this.shadow.querySelector("#eq-fchk-error"),oe=this.shadow.querySelector("#eq-fchk-ai"),_=this.shadow.querySelector("#eq-fchk-dom"),ee=[$,oe,_].filter(Boolean);K?.addEventListener("change",()=>{K.checked?ee.forEach(z=>{z.checked=!1}):K.checked=!0,F()}),ee.forEach(z=>{z.addEventListener("change",()=>{z.checked&&K&&(K.checked=!1),!ee.some(D=>D.checked)&&K&&(K.checked=!0),F()})}),document.addEventListener("mousedown",()=>{f&&f.style.display!=="none"&&(f.style.display="none")});let Z=this.shadow.querySelector("#eq-output-sort-btn"),ne=this.shadow.querySelector("#eq-sort-arrow");if(ne&&(ne.style.transform="rotate(270deg)"),Z?.addEventListener("click",()=>{this.outputSortNewest=!this.outputSortNewest,ne&&(ne.style.transform=this.outputSortNewest?"rotate(270deg)":"rotate(90deg)"),Z&&(Z.style.color=this.outputSortNewest?"#aaa":"#60a5fa"),this.renderTerminalEntries()}),c?.addEventListener("input",()=>{this.outputSearchQuery=c.value,l&&(l.style.display=c.value?"inline":"none"),this.renderTerminalEntries()}),l?.addEventListener("click",()=>{c&&(c.value=""),this.outputSearchQuery="",l&&(l.style.display="none"),this.renderTerminalEntries()}),this.liveDebugTerminal){let z=null;this.liveDebugTerminal.addEventListener("scroll",()=>{z&&clearTimeout(z),z=setTimeout(()=>{if(!this.liveDebugTerminal)return;let B=this.liveDebugTerminal,D=B.scrollHeight-B.scrollTop-B.clientHeight,U=this.shadow.querySelector("#eq-dbg-scroll-toggle");D>40?(this.autoScrollLogs=!1,U&&(U.style.color="#333",U.style.borderColor="rgba(255,255,255,0.07)",U.title="Auto-scroll: desativado")):D<10&&(this.autoScrollLogs=!0,U&&(U.style.color="#ddd",U.style.borderColor="rgba(255,255,255,0.18)",U.title="Auto-scroll: ativo"))},150)})}this.shadow.querySelector("#eq-dbg-scroll-toggle")?.addEventListener("click",z=>{this.autoScrollLogs=!this.autoScrollLogs;let B=z.currentTarget;B.style.color=this.autoScrollLogs?"#ddd":"#333",B.style.borderColor=this.autoScrollLogs?"rgba(255,255,255,0.18)":"rgba(255,255,255,0.07)",B.title=this.autoScrollLogs?"Auto-scroll: ativo":"Auto-scroll: desativado"}),C("terminal"),setTimeout(()=>x(),80)}clearLogs(){if(this.logEntries=[],this.updateLogCounters(),this.liveDebugTerminal){this.liveDebugTerminal.replaceChildren();let e=document.createElement("div");e.style.cssText="color:#333;",e.textContent="> [SYS] Output limpo.",this.liveDebugTerminal.appendChild(e)}this.apConsole&&this.apConsole.replaceChildren(),this.executionConsole&&this.executionConsole.replaceChildren()}getFormattedLogs(){return(this.activeLogFilter==="all"?this.logEntries:this.logEntries.filter(t=>t.category===this.activeLogFilter)).map(t=>t.message).join(`
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let o=t?`[${t}] ${e}`:e;this.setLastError(o)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,o=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let s=e?.promptTokens!==void 0?String(e.promptTokens):"--",a=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${s} / ${a}`,this.dbgSplitTokens.title=`Prompt: ${s} tokens | Resposta: ${a} tokens`}if(this.dbgTotalTokens){let s=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=s!==void 0?`${s}`:"--"}if(this.dbgPromptLen){let s=o.length,a=Math.round(s/4);this.dbgPromptLen.textContent=`${s}c (~${a}tok)`}this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let o=new Date,s=`${String(o.getHours()).padStart(2,"0")}:${String(o.getMinutes()).padStart(2,"0")}:${String(o.getSeconds()).padStart(2,"0")}.${String(Math.floor(o.getMilliseconds()/100))}`,a=e;e.startsWith(">")?a=`> [${s}] ${e.slice(1).trim()}`:a=`[${s}] ${e}`;let r="all";t==="text-red"||a.includes("[ERRO]")||a.includes("Falha")||a.includes("Error")?r="error":a.includes("[IA]")||a.includes("[RAG]")||a.includes("Tokens")||a.includes("Gemini")||a.includes("Modelo:")?r="ai":(a.includes("[DOM]")||a.includes("[EXEC]")||a.includes("[VERIF]")||a.includes("[NAV]"))&&(r="dom");let i={id:Date.now()+Math.random(),timestamp:s,message:a,colorClass:t,category:r};for(this.logEntries.push(i);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),r==="error"&&this.setLastError(a),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===r)){let c=document.createElement("div");c.style.cssText="padding:1px 0;",c.textContent=a,t&&(c.className=t),this.liveDebugTerminal.appendChild(c)}if(this.liveTerminalOutput&&(r==="dom"||r==="all"||r==="error")){for(this.appendTerminalLine(a,t);this.liveDebugTerminal.children.length>300;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.apConsole.appendChild(c),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.executionConsole.appendChild(c),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let o=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${o}%`,this.progressVal&&(this.progressVal.textContent=`${o}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),o>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions)),this.activeTab==="brain"?(this.renderContextTree(),this.refreshBrainCanvas(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&(this.renderContextTree(),this.refreshBrainCanvas()),this.activeTab==="brain"&&(this.brainSelectedFolder==="media-images"||(this.brainActiveTab||"").startsWith("img-"))&&this.refreshBrainCanvas()}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=Je(),o=this.latestPlan,s=!!(this.latestPromptText||o?.promptSent),a=!!e,r=!!o;this.contextTreeContainer.innerHTML="";let i=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(i);let c=e?e.controls:[],l=c.map((v,y)=>{let A=v.role==="navigation"||v.type==="button",C=!A&&v.value?` [val: "${v.value}"]`:"";return{label:`[#${y+1}] ${v.type.toUpperCase()}`,value:`${v.label||v.id||v.name||"(Sem r\xF3tulo)"}${C}`.trim(),badge:A?"Navega\xE7\xE3o":v.role||v.type}}),p=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${c.length})`,c.length>0,l);this.contextTreeContainer.appendChild(p);let f=t.map((v,y)=>({label:`Mem\xF3ria #${y+1}`,value:v,badge:"RAG"})),d=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,f);if(this.contextTreeContainer.appendChild(d),o){let v=this.createTreeFolder(` \xDALTIMO PLANO IA (${o.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:o.pageType,badge:`${(o.confidence*100).toFixed(0)}%`},{label:"Modo",value:o.mode},{label:"Racioc\xEDnio",value:o.rationale||"N/A"},...o.actions.map((y,A)=>({label:`A\xE7\xE3o #${A+1} (${y.t})`,value:JSON.stringify(y)}))]);this.contextTreeContainer.appendChild(v)}{let v=document.createElement("div");v.style.cssText="border-bottom:1px solid rgba(255,255,255,0.04);";let y=document.createElement("div");y.style.cssText="display:flex;align-items:center;gap:6px;padding:5px 10px;cursor:pointer;font-size:10px;font-weight:600;color:#fbbf24;letter-spacing:0.04em;user-select:none;",y.innerHTML='<span style="display:inline-flex;width:12px;height:12px;color:#fbbf24;">'+L.inspector+"</span> IA ARTIFACTS";let A=document.createElement("div");A.style.cssText="padding-left:16px;overflow:hidden;";let C=(w,T,k,E)=>{let I=document.createElement("div");return I.style.cssText="display:flex;align-items:center;gap:6px;padding:4px 10px 4px 4px;cursor:pointer;border-radius:4px;transition:background 0.1s;"+(this.brainActiveTab===w?"background:rgba(251,191,36,0.1);":""),I.innerHTML='<span style="font-size:9px;color:'+(E?"#fbbf24":"#444")+';">'+L.code+'</span><span style="font-size:10px;color:'+(E?"#ddd":"#444")+';flex:1;">'+T+'</span><span style="font-size:8px;color:#333;">'+k+"</span>",I.addEventListener("click",()=>{this.brainSelectedFolder=null,this.brainActiveTab=w;let S=this.getBrainFileText(w),q=this.shadow.querySelector("#eq-brain-content");if(q){q.innerHTML="";let H=document.createElement("pre");H.className="eq-brain-code",H.style.cssText='padding:12px;font-size:10.5px;line-height:1.55;white-space:pre-wrap;word-break:break-word;color:#d0d8e8;font-family:"Cascadia Code","Fira Code","Courier New",monospace;',H.textContent=S,q.appendChild(H)}this.renderBrainExplorer(),this.renderBrainTabs()}),I};A.appendChild(C("ai-prompt","prompt.txt",s?"pronto":"aguardando",s)),A.appendChild(C("ai-context","context.json",a?"pronto":"aguardando",a)),A.appendChild(C("ai-response","response.txt",r?"pronto":"aguardando",!!o));let x=!1;y.addEventListener("click",()=>{x=!x,A.style.display=x?"block":"none"}),A.style.display="none",v.appendChild(y),v.appendChild(A),this.contextTreeContainer.appendChild(v)}let m=this.latestImages,u=this.latestImageDescriptions,h=m.map((v,y)=>{let A=u.find(k=>k.index===y),C=(v.captureStatus==="captured"||v.captureStatus==="text_only",""),x=v.captureStatus==="captured"?"Visual":v.captureStatus==="text_only"?"Texto":"Falhou",w=A?A.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",T=A?A.description:v.textContext?v.textContext:"Aguardando an\xE1lise IA...";return{label:`${C} Img ${y+1} [${x}]`,value:`${T}`,badge:w,imgSrc:v.base64?`data:${v.mediaType||"image/jpeg"};base64,${v.base64}`:void 0}}),b=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${m.length})`,!0,h);this.contextTreeContainer.appendChild(b)}createTreeFolder(e,t,o){let s=document.createElement("div");s.className="eq-tree-node";let a=document.createElement("div");a.className="eq-tree-header",a.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let r=document.createElement("div");if(r.className="eq-tree-content",r.style.display=t?"flex":"none",o.length===0)r.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let i of o){let c=document.createElement("div");c.className="eq-tree-leaf";let l="";i.imgSrc&&i.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${i.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),c.innerHTML=`
...
`)}renderBrainExplorer(){let e=this.shadow.querySelector("#eq-brain-explorer");if(!e)return;e.innerHTML="";let t=this.getActiveFolder(),o=document.createElement("div");o.className="eq-tree-file eq-tree-global"+(this.brainActiveTab===this.GLOBAL_ID?" is-selected":""),o.innerHTML=`<span class="eq-tree-ficon" style="color:#60a5fa">${L.folderTree}</span><span class="eq-tree-label">${this.GLOBAL_LABEL}</span>`,o.addEventListener("click",()=>{this.brainSelectedFolder=null,this.openBrainFile(this.GLOBAL_ID,this.GLOBAL_LABEL)}),e.appendChild(o);let s=document.createElement("div");s.className="eq-tree-sep",e.appendChild(s);for(let a of this.getBrainFolders()){let r=this.brainOpenFolders.has(a.id),i=this.brainSelectedFolder===a.id||t===a.id,c=document.createElement("div");c.className="eq-tree-folder"+(i?" is-folder-sel":"");let l=document.createElement("span");l.className="eq-tree-arrow",l.innerHTML=r?L.chevronDown:L.chevronRight,l.addEventListener("click",u=>{u.stopPropagation(),this.brainOpenFolders.has(a.id)?this.brainOpenFolders.delete(a.id):this.brainOpenFolders.add(a.id),this.renderBrainExplorer()}),c.appendChild(l);let p=document.createElement("span");p.className="eq-tree-ficon",p.style.color="#fbbf24",p.innerHTML=L.folder;let f=document.createElement("span");f.className="eq-tree-label",f.textContent=a.label,c.appendChild(p),c.appendChild(f),c.addEventListener("click",()=>{this.brainSelectedFolder=a.id,this.brainActiveTab=null,this.showFolderContent(a),this.renderBrainExplorer(),this.renderBrainTabs()}),e.appendChild(c);let d=document.createElement("div"),m=a.files.length+(a.subfolders?.reduce((u,h)=>u+h.files.length+1,0)??0);d.className="eq-tree-children"+(r?" is-open":""),d.style.setProperty("--child-count",String(m));for(let u of a.files){let h=this.getBrainFileColor(u.icon),b=document.createElement("div");b.className="eq-tree-file"+(this.brainActiveTab===u.id?" is-selected":""),b.innerHTML=`<span class="eq-tree-ficon" style="color:${h}">${L[u.icon]||L.file}</span><span class="eq-tree-label">${u.label}</span>`,b.addEventListener("click",v=>{v.stopPropagation(),this.brainSelectedFolder=null,this.openBrainFile(u.id,u.label)}),d.appendChild(b)}for(let u of a.subfolders||[]){let h=this.brainOpenFolders.has(u.id),b=this.brainSelectedFolder===u.id,v=document.createElement("div");v.className="eq-tree-folder eq-tree-subfolder"+(b?" is-folder-sel":""),v.style.paddingLeft="18px";let y=document.createElement("span");y.className="eq-tree-arrow",y.innerHTML=h?L.chevronDown:L.chevronRight,y.addEventListener("click",T=>{T.stopPropagation(),this.brainOpenFolders.has(u.id)?this.brainOpenFolders.delete(u.id):this.brainOpenFolders.add(u.id),this.renderBrainExplorer()}),v.appendChild(y);let A=document.createElement("span");A.className="eq-tree-ficon",A.style.color="#60a5fa",A.innerHTML=L[u.icon]||L.folder;let C=document.createElement("span");C.className="eq-tree-label",C.textContent=u.label;let x=document.createElement("span");x.style.cssText="font-size:9px;color:#666;margin-left:4px;flex-shrink:0;",x.textContent=String(u.files.length),v.appendChild(A),v.appendChild(C),v.appendChild(x),v.addEventListener("click",()=>{this.brainSelectedFolder=u.id,this.brainActiveTab=null,this.brainOpenFolders.add(u.id),this.showSubfolderContent(u),this.renderBrainExplorer(),this.renderBrainTabs()}),d.appendChild(v);let w=document.createElement("div");w.className="eq-tree-children"+(h?" is-open":""),w.style.setProperty("--child-count",String(u.files.length));for(let T of u.files){let k=this.getBrainFileColor(T.icon),E=document.createElement("div");E.className="eq-tree-file"+(this.brainActiveTab===T.id?" is-selected":""),E.style.paddingLeft="32px",E.innerHTML=`<span class="eq-tree-ficon" style="color:${k}">${L[T.icon]||L.file}</span><span class="eq-tree-label">${T.label}</span>`,E.addEventListener("click",I=>{I.stopPropagation(),this.brainSelectedFolder=null,this.openBrainFile(T.id,T.label)}),w.appendChild(E)}d.appendChild(w)}e.appendChild(d)}}showFolderContent(e){let t=this.shadow.querySelector("#eq-brain-content");if(!t)return;t.innerHTML="";let o=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),s=document.createElement("div");s.className="eq-folder-view";let a=document.createElement("div");a.className="eq-folder-view-header",a.innerHTML=`<span class="eq-tree-ficon" style="color:#fbbf24">${L.folder}</span><span>${o(e.label)}</span>`,s.appendChild(a);let r=document.createElement("div");r.className="eq-folder-view-files";for(let i of e.files){let c=this.getBrainFileColor(i.icon),l=document.createElement("div");l.className="eq-folder-view-row",l.innerHTML=`<span class="eq-tree-ficon" style="color:${c}">${L[i.icon]||L.file}</span><span>${o(i.label)}</span>`,l.addEventListener("click",()=>this.openBrainFile(i.id,i.label)),r.appendChild(l)}for(let i of e.subfolders||[]){let c=document.createElement("div");c.className="eq-folder-view-row",c.style.cssText="display:flex;align-items:center;gap:6px;padding:7px 10px;cursor:pointer;border-radius:5px;";let l=i.id==="media-images"?this.latestImages.length:i.files.length;c.innerHTML=`<span class="eq-tree-ficon" style="color:#60a5fa">${L[i.icon]||L.folder}</span><span style="flex:1">${o(i.label)}</span><span style="font-size:9px;color:#555;">${l} item${l!==1?"s":""}</span>`,c.addEventListener("mouseenter",()=>{c.style.background="rgba(255,255,255,0.04)"}),c.addEventListener("mouseleave",()=>{c.style.background=""}),c.addEventListener("click",()=>{this.brainSelectedFolder=i.id,this.brainActiveTab=null,this.brainOpenFolders.add(i.id),this.showSubfolderContent(i),this.renderBrainExplorer(),this.renderBrainTabs()}),r.appendChild(c)}s.appendChild(r),t.appendChild(s)}openBrainFile(e,t){if(this.brainOpenTabs.find(o=>o.id===e)||this.brainOpenTabs.push({id:e,label:t}),this.brainActiveTab=e,this.brainCanvasHidden){let o=this.shadow.querySelector(".eq-brain-canvas"),s=this.shadow.querySelector("#eq-brain-canvas-toggle");o?.classList.remove("is-hidden"),s&&(s.innerHTML=L.eye,s.title="Ocultar visualizador"),this.brainCanvasHidden=!1}this.renderBrainExplorer(),this.renderBrainTabs(),this.renderBrainFileContent(e)}showSubfolderContent(e){e.id==="media-images"?this.showMediaGrid():this.showFolderContent(e)}showMediaGrid(){let e=this.shadow.querySelector("#eq-brain-content");if(!e)return;e.innerHTML="";let t=this.latestImages,o=this.latestImageDescriptions,s=document.createElement("div");s.style.cssText="display:flex;flex-direction:column;height:100%;overflow:hidden;";let a=document.createElement("div");a.style.cssText="padding:8px 12px;font-size:10px;color:#666;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;flex-shrink:0;",a.innerHTML=`<span style="color:#60a5fa;font-weight:600;">Imagens</span><span>${t.length} captura${t.length!==1?"s":""}</span>`,s.appendChild(a);let r=document.createElement("div");if(r.style.cssText="flex:1;overflow-y:auto;padding:10px;",t.length===0)r.innerHTML='<div style="text-align:center;padding:32px 0;color:#555;font-size:11px;">Nenhuma imagem capturada.<br><span style="opacity:0.6;font-size:10px;">Ative "Vis\xE3o Computacional" nas configura\xE7\xF5es e execute uma an\xE1lise.</span></div>';else{let i=document.createElement("div");i.style.cssText="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;",t.forEach((c,l)=>{let f=o.find(h=>h.index===l)?.relevant??!0,d=c.base64?`data:${c.mediaType||"image/jpeg"};base64,${c.base64}`:"",m=document.createElement("div");if(m.style.cssText=`position:relative;aspect-ratio:1;border-radius:5px;overflow:hidden;cursor:pointer;background:#111;border:2px solid ${f?"rgba(96,165,250,0.3)":"rgba(255,255,255,0.06)"};transition:border-color 0.15s,transform 0.12s;`,d){let h=document.createElement("img");h.src=d,h.style.cssText="width:100%;height:100%;object-fit:cover;display:block;",m.appendChild(h)}else{let h=document.createElement("div");h.style.cssText="width:100%;height:100%;display:flex;align-items:center;justify-content:center;color:#555;font-size:10px;",h.textContent="Texto",m.appendChild(h)}let u=document.createElement("div");u.style.cssText="position:absolute;bottom:3px;right:3px;background:rgba(0,0,0,0.75);border-radius:3px;padding:1px 4px;font-size:9px;color:#aaa;",u.textContent=String(l+1),m.appendChild(u),m.addEventListener("mouseenter",()=>{m.style.transform="scale(1.03)",m.style.borderColor="#60a5fa"}),m.addEventListener("mouseleave",()=>{m.style.transform="",m.style.borderColor=f?"rgba(96,165,250,0.3)":"rgba(255,255,255,0.06)"}),m.addEventListener("click",()=>{this.brainSelectedFolder=null,this.openBrainFile("img-"+l,"img-"+(l+1)+"."+(c.mediaType?.split("/")?.[1]||"jpg"))}),i.appendChild(m)}),r.appendChild(i)}s.appendChild(r),e.appendChild(s)}showImageFile(e){let t=this.shadow.querySelector("#eq-brain-content");if(!t)return;t.innerHTML="";let o=this.latestImages[e];if(!o){t.innerHTML='<div style="padding:16px;color:#666;font-size:11px;">Imagem n\xE3o encontrada.</div>';return}let s=this.latestImageDescriptions.find(m=>m.index===e),a=o.base64?`data:${o.mediaType||"image/jpeg"};base64,${o.base64}`:"",r=s?.relevant??!0,i=o.captureStatus==="captured"?"Visual":o.captureStatus==="text_only"?"Texto":"Falhou",c=o.captureStatus==="captured"?"#4ade80":o.captureStatus==="text_only"?"#fbbf24":"#ef4444",l=document.createElement("div");l.style.cssText="display:flex;flex-direction:column;height:100%;overflow:hidden;";let p=document.createElement("div");if(p.style.cssText="flex:0 0 auto;background:#0a0a0f;display:flex;align-items:center;justify-content:center;padding:10px;min-height:140px;max-height:55%;cursor:zoom-in;border-bottom:1px solid rgba(255,255,255,0.06);position:relative;overflow:hidden;",a){let m=document.createElement("img");m.src=a,m.alt=o.alt||`Imagem ${e+1}`,m.style.cssText="max-width:100%;max-height:100%;object-fit:contain;border-radius:4px;transform-origin:center center;transition:transform 0.12s ease;user-select:none;",p.appendChild(m);let u=1,h=.5,b=4;p.addEventListener("wheel",A=>{A.preventDefault(),A.stopPropagation();let C=A.deltaY>0?-.15:.15;u=Math.min(b,Math.max(h,u+C)),m.style.transform=u===1?"":`scale(${u.toFixed(2)})`,p.style.cursor=u>1?"grab":"zoom-in";let x=p.querySelector(".eq-zoom-hint");x&&(x.textContent=u!==1?`${Math.round(u*100)}% \xB7 scroll para zoom \xB7 clique para ampliar`:"scroll para zoom \xB7 clique para ampliar")},{passive:!1}),p.addEventListener("click",()=>this.openImageLightbox(e));let v=document.createElement("div");v.className="eq-zoom-hint",v.style.cssText="position:absolute;bottom:6px;right:8px;font-size:9px;color:rgba(255,255,255,0.3);pointer-events:none;",v.textContent="scroll para zoom \xB7 clique para ampliar",p.appendChild(v);let y=this.latestImages.length;if(y>1){let A=C=>{let x=document.createElement("button");return x.style.cssText=`position:absolute;${C==="prev"?"left:6px":"right:6px"};top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.55);border:1px solid rgba(255,255,255,0.12);color:#ccc;width:24px;height:24px;border-radius:50%;cursor:pointer;font-size:13px;z-index:5;display:flex;align-items:center;justify-content:center;transition:background 0.12s;`,x.innerHTML=C==="prev"?"\u2039":"\u203A",x.title=C==="prev"?"Imagem anterior":"Pr\xF3xima imagem",x.style.display=C==="prev"&&e===0||C==="next"&&e===y-1?"none":"flex",x.addEventListener("mouseenter",()=>{x.style.background="rgba(96,165,250,0.3)"}),x.addEventListener("mouseleave",()=>{x.style.background="rgba(0,0,0,0.55)"}),x.addEventListener("click",w=>{w.stopPropagation();let T=C==="prev"?e-1:e+1;if(T>=0&&T<y){this.brainActiveTab="img-"+T;let k=this.latestImages[T],E="img-"+(T+1)+"."+(k?.mediaType?.split("/")?.[1]||"jpg");this.brainOpenTabs.find(I=>I.id==="img-"+T)||this.brainOpenTabs.push({id:"img-"+T,label:E}),this.renderBrainExplorer(),this.renderBrainTabs(),this.showImageFile(T)}}),x};p.appendChild(A("prev")),p.appendChild(A("next"))}}else p.style.cssText+="color:#555;font-size:11px;",p.textContent="Sem dados visuais \u2014 captura em modo texto";l.appendChild(p);let f=document.createElement("div");f.style.cssText="flex:1;overflow-y:auto;padding:10px 12px;display:flex;flex-direction:column;gap:7px;";let d=(m,u,h="#aaa")=>{let b=document.createElement("div");return b.style.cssText="display:flex;gap:8px;font-size:10.5px;",b.innerHTML=`<span style="color:#555;min-width:72px;flex-shrink:0;">${m}</span><span style="color:${h};word-break:break-word;">${u}</span>`,b};if(f.appendChild(d("\xCDndice",`Imagem ${e+1} de ${this.latestImages.length}`)),f.appendChild(d("Status",i,c)),f.appendChild(d("Relev\xE2ncia",r?"Relevante":"Ignorada",r?"#60a5fa":"#666")),f.appendChild(d("Tipo",o.mediaType||"--")),o.alt&&f.appendChild(d("Alt text",o.alt)),o.source&&f.appendChild(d("Fonte",o.source)),o.associatedLabel&&f.appendChild(d("R\xF3tulo",o.associatedLabel)),s?.description){let m=document.createElement("div");m.style.cssText="background:rgba(96,165,250,0.06);border:1px solid rgba(96,165,250,0.15);border-radius:5px;padding:8px;",m.innerHTML=`<div style="font-size:9px;color:#60a5fa;font-weight:600;margin-bottom:4px;">AN\xC1LISE DA IA</div><div style="font-size:10.5px;color:#ccc;line-height:1.55;">${s.description}</div>`,f.appendChild(m)}if(o.textContext){let m=document.createElement("div");m.style.cssText="background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.12);border-radius:5px;padding:8px;",m.innerHTML=`<div style="font-size:9px;color:#fbbf24;font-weight:600;margin-bottom:4px;">CONTEXTO TEXTUAL</div><div style="font-size:10.5px;color:#ccc;line-height:1.55;">${o.textContext}</div>`,f.appendChild(m)}l.appendChild(f),t.appendChild(l)}openImageLightbox(e){let t=this.latestImages[e];if(!t)return;let o=this.latestImageDescriptions.find(y=>y.index===e),s=t.base64?`data:${t.mediaType||"image/jpeg"};base64,${t.base64}`:"";this.shadow.querySelector("#eq-img-lightbox")?.remove();let a=document.createElement("div");a.id="eq-img-lightbox",a.style.cssText="position:fixed;inset:0;z-index:2147483647;background:rgba(0,0,0,0.92);display:flex;align-items:center;justify-content:center;padding:20px;box-sizing:border-box;";let r=document.createElement("div");r.style.cssText="display:flex;width:min(90vw,1100px);max-height:90vh;border-radius:10px;background:#0f0f17;border:1px solid rgba(255,255,255,0.1);box-shadow:0 24px 64px rgba(0,0,0,0.8);position:relative;overflow:hidden;";let i=document.createElement("button");i.style.cssText="position:absolute;top:10px;right:10px;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.15);color:#ddd;width:30px;height:30px;border-radius:50%;cursor:pointer;font-size:18px;z-index:10;display:flex;align-items:center;justify-content:center;line-height:1;",i.textContent="\xD7",i.title="Fechar (ESC)";let c=document.createElement("div");if(c.style.cssText="flex:0 0 65%;display:flex;align-items:center;justify-content:center;background:#050508;padding:16px;min-width:0;overflow:hidden;position:relative;",s){let y=document.createElement("img");y.src=s,y.style.cssText="max-width:100%;max-height:82vh;object-fit:contain;border-radius:4px;transform-origin:center center;transition:transform 0.1s ease;user-select:none;display:block;";let A=1,C=.3,x=6;c.addEventListener("wheel",T=>{T.preventDefault(),T.stopPropagation();let k=T.deltaY<0?.18:-.18;A=Math.min(x,Math.max(C,A+k)),y.style.transform=`scale(${A.toFixed(3)})`,y.style.cursor=A>1?"grab":"default",w.textContent=`${Math.round(A*100)}%`,w.style.opacity="1",clearTimeout(c._zt),c._zt=setTimeout(()=>{w.style.opacity="0"},1200)},{passive:!1}),y.addEventListener("dblclick",()=>{A=1,y.style.transform="",y.style.cursor="default",w.textContent="100%",w.style.opacity="1",setTimeout(()=>{w.style.opacity="0"},800)});let w=document.createElement("div");w.style.cssText="position:absolute;bottom:10px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.7);color:#aaa;font-size:10px;padding:2px 8px;border-radius:10px;pointer-events:none;opacity:0;transition:opacity 0.3s;",w.textContent="100%",c.appendChild(y),c.appendChild(w)}else c.innerHTML='<div style="color:#555;font-size:12px;text-align:center;width:100%;">Sem dados visuais</div>';r.appendChild(c);let l=document.createElement("div");l.style.cssText="flex:0 0 35%;overflow-y:auto;padding:20px 16px 20px;border-left:1px solid rgba(255,255,255,0.06);display:flex;flex-direction:column;gap:8px;min-width:0;";let p=document.createElement("div");p.style.cssText="font-size:13px;font-weight:700;color:#e0e0e0;margin-bottom:6px;",p.textContent=`Imagem ${e+1} de ${this.latestImages.length}`,l.appendChild(p);let f=t.captureStatus==="captured"?"#4ade80":t.captureStatus==="text_only"?"#fbbf24":"#ef4444",d=t.captureStatus==="captured"?"Visual":t.captureStatus==="text_only"?"Texto":"Falhou",m=(y,A,C="#aaa")=>{let x=document.createElement("div");return x.style.cssText="display:flex;gap:6px;font-size:10px;",x.innerHTML=`<span style="color:#555;min-width:64px;flex-shrink:0;">${y}</span><span style="color:${C};word-break:break-word;">${A}</span>`,x};l.appendChild(m("Status",d,f)),l.appendChild(m("Relev\xE2ncia",o?.relevant??!0?"Relevante":"Ignorada",o?.relevant??!0?"#60a5fa":"#666")),l.appendChild(m("Tipo",t.mediaType||"--")),t.alt&&l.appendChild(m("Alt",t.alt)),t.source&&l.appendChild(m("Fonte",t.source)),t.associatedLabel&&l.appendChild(m("R\xF3tulo",t.associatedLabel));let u=document.createElement("div");if(u.style.cssText="font-size:9px;color:#444;margin-top:4px;",u.textContent="Scroll na imagem para zoom \xB7 Duplo-clique para resetar",l.appendChild(u),o?.description){let y=document.createElement("div");y.style.cssText="background:rgba(96,165,250,0.07);border:1px solid rgba(96,165,250,0.18);border-radius:5px;padding:8px;margin-top:4px;",y.innerHTML=`<div style="font-size:9px;color:#60a5fa;font-weight:700;margin-bottom:5px;">AN\xC1LISE DA IA</div><div style="font-size:10px;color:#ccc;line-height:1.6;">${o.description}</div>`,l.appendChild(y)}if(t.textContext){let y=document.createElement("div");y.style.cssText="background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.12);border-radius:5px;padding:8px;",y.innerHTML=`<div style="font-size:9px;color:#fbbf24;font-weight:700;margin-bottom:5px;">CONTEXTO TEXTUAL</div><div style="font-size:10px;color:#ccc;line-height:1.6;">${t.textContext}</div>`,l.appendChild(y)}r.appendChild(l),a.appendChild(i),a.appendChild(r),this.shadow.appendChild(a);let h=()=>a.remove();i.addEventListener("click",y=>{y.stopPropagation(),h()}),r.addEventListener("click",y=>y.stopPropagation()),a.addEventListener("click",()=>h());let b=this.latestImages.length;if(b>1){let y=A=>{let C=document.createElement("button");return C.style.cssText=`position:absolute;${A==="prev"?"left:12px":"right:12px"};top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.6);border:1px solid rgba(255,255,255,0.15);color:#ddd;width:36px;height:36px;border-radius:50%;cursor:pointer;font-size:22px;z-index:10;display:${A==="prev"&&e===0||A==="next"&&e===b-1?"none":"flex"};align-items:center;justify-content:center;`,C.innerHTML=A==="prev"?"\u2039":"\u203A",C.title=A==="prev"?"Anterior":"Pr\xF3xima",C.addEventListener("mouseenter",()=>{C.style.background="rgba(96,165,250,0.35)"}),C.addEventListener("mouseleave",()=>{C.style.background="rgba(0,0,0,0.6)"}),C.addEventListener("click",x=>{x.stopPropagation();let w=A==="prev"?e-1:e+1;w>=0&&w<b&&(a.remove(),this.openImageLightbox(w))}),C};a.appendChild(y("prev")),a.appendChild(y("next"))}let v=y=>{y.key==="Escape"&&(h(),window.removeEventListener("keydown",v))};window.addEventListener("keydown",v)}closeBrainTab(e){let t=this.brainOpenTabs.findIndex(o=>o.id===e);t!==-1&&(this.brainOpenTabs.splice(t,1),this.brainActiveTab===e&&(this.brainActiveTab=this.brainOpenTabs[t-1]?.id||this.brainOpenTabs[0]?.id||null),this.renderBrainExplorer(),this.renderBrainTabs(),this.refreshBrainCanvas())}refreshBrainCanvas(){if(this.brainActiveTab)this.renderBrainFileContent(this.brainActiveTab);else if(this.brainSelectedFolder){if(this.brainSelectedFolder==="media-images"){this.showMediaGrid();return}for(let t of this.getBrainFolders()){let o=(t.subfolders||[]).find(s=>s.id===this.brainSelectedFolder);if(o){this.showSubfolderContent(o);return}}let e=this.getBrainFolders().find(t=>t.id===this.brainSelectedFolder);if(e)this.showFolderContent(e);else{let t=this.shadow.querySelector("#eq-brain-content");t&&(t.innerHTML='<div class="eq-brain-empty-canvas"><div style="margin-bottom:4px;opacity:0.5">Nada selecionado</div><div class="eq-brain-empty-sub">Selecione um arquivo no explorador abaixo para visualiz\xE1-lo</div></div>')}}else{let e=this.shadow.querySelector("#eq-brain-content");e&&(e.innerHTML='<div class="eq-brain-empty-canvas"><div style="margin-bottom:4px;opacity:0.5">Nada selecionado</div><div class="eq-brain-empty-sub">Selecione um arquivo no explorador abaixo para visualiz\xE1-lo</div></div>')}}renderBrainTabs(){let e=this.shadow.querySelector("#eq-brain-tabbar");if(e){e.innerHTML="";for(let t of this.brainOpenTabs){let o=document.createElement("div");o.className="eq-brain-tab"+(this.brainActiveTab===t.id?" is-active":""),o.innerHTML=`<span class="eq-brain-tab-icon">${t.id===this.GLOBAL_ID?L.folderTree:L.file}</span><span class="eq-brain-tab-label">${t.label}</span><button class="eq-brain-tab-close" data-tab-id="${t.id}" type="button">${L.close}</button>`,o.addEventListener("click",s=>{let a=s.target.closest(".eq-brain-tab-close");a?this.closeBrainTab(a.dataset.tabId):(this.brainActiveTab=t.id,this.brainSelectedFolder=null,this.renderBrainExplorer(),this.renderBrainTabs(),this.renderBrainFileContent(t.id))}),e.appendChild(o)}}}renderBrainFileContent(e){let t=this.shadow.querySelector("#eq-brain-content");if(!t)return;if(e.startsWith("img-")){this.showImageFile(parseInt(e.slice(4),10));return}let o=this.getBrainFileText(e),s=f=>String(f??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),a=e===this.GLOBAL_ID,r=e==="rationale"||a,c=a||r?"markdown":e==="actions"||e==="exec-result"?"json":"text";t.innerHTML="";let l=document.createElement("div");l.className="eq-brain-file-view";let p=document.createElement("div");if(p.className="eq-brain-file-header",p.innerHTML=`<span class="eq-brain-file-lang">${s(c)}</span>`,l.appendChild(p),r){let f=document.createElement("div");f.className="eq-brain-markdown";try{f.innerHTML=this.renderMarkdown(o||"(sem conte\xFAdo)")}catch{f.textContent=o||"(sem conte\xFAdo)"}l.appendChild(f)}else{let f=document.createElement("pre");f.className="eq-brain-code";let d=document.createElement("code");d.textContent=o||"(sem conte\xFAdo)",f.appendChild(d),l.appendChild(f)}t.appendChild(l)}showFloatingAnswers(e){let t=e||this.latestPlan;t&&this.floatingAnswers.show(t)}hideFloatingAnswers(){this.floatingAnswers.hide()}renderKeysList(){if(!this.keysListEl)return;let e=j.getAllKeys();if(this.keysBadgeEl){let s=e.filter(i=>!i.isCooldown).length,a=e.reduce((i,c)=>i+(c.winCount||0),0),r=s>=3?"  TURBO":"";this.keysBadgeEl.textContent=`${e.length} chave${e.length>1?"s":""} (${s} pronta${s!==1?"s":""})${r}`,this.keysBadgeEl.className=`eq-key-badge ${s>=3?"racing":s>0?"ready":"cooldown"}`}this.keysListEl.replaceChildren();let t=this.shadow?.querySelector("#eq-keys-collapsible");t&&t.style.display!=="none"&&(t.style.maxHeight="none",t.style.overflow="visible"),[...e].sort((s,a)=>{let r=s.winCount||0,i=a.winCount||0;if(r!==i)return i-r;let c=s.lastLatencyMs||99999,l=a.lastLatencyMs||99999;if(c!==l)return c-l;let p=s.isCooldown?1:0,f=a.isCooldown?1:0;return p-f}).forEach((s,a)=>{let r=e.findIndex(y=>y.id===s.id),i=r>=0?r:a,c=document.createElement("div");c.className="eq-key-item";let l=document.createElement("div");l.className="eq-key-info";let p=document.createElement("span");p.className="eq-key-label",p.textContent=s.label||`Chave ${i+1}`;let f=document.createElement("span");f.className="eq-key-masked",f.textContent=ce.maskKey(s.key),f.title="Clique para copiar a chave",f.style.cursor="pointer",f.addEventListener("click",()=>{navigator.clipboard?.writeText(s.key),this.setStatus(`Chave ${i+1} copiada para a \xE1rea de transfer\xEAncia!`,"info")});let d=document.createElement("span");if(s.isCooldown){d.className="eq-key-badge cooldown";let y=Math.ceil(s.remainingCooldownMs/1e3);d.textContent=`\u23F1 Cooldown (${y}s)`}else s.lastError&&s.errorCount&&s.errorCount>3?(d.className="eq-key-badge invalid",d.textContent="Erro",d.title=s.lastError):s.lastLatencyMs?(d.className="eq-key-badge ready",d.textContent=`Pronta (${s.lastLatencyMs}ms)`):(d.className="eq-key-badge ready",d.textContent="Pronta");l.appendChild(p),l.appendChild(f),l.appendChild(d);let m=s.winCount||0;if(m>0){let y=document.createElement("span");y.className="eq-key-badge winner",y.textContent=` ${m} vit\xF3ria${m>1?"s":""}`,y.title=`Esta chave foi a mais r\xE1pida ${m} vez${m>1?"es":""} nas corridas paralelas`,l.appendChild(y)}let u=document.createElement("div");u.className="eq-key-actions";let h=document.createElement("button");h.className="eq-icon-btn",h.type="button",h.title="Testar esta chave",h.innerHTML=L.sparkles,h.addEventListener("click",async()=>{this.setStatus(`Testando chave ${s.label||i+1}...`,"info");let y=await $e(s.key);y.ok?(j.markSuccess(s.key,120),this.setStatus(` ${s.label||`Chave ${i+1}`}: Conex\xE3o com Google Gemini aprovada!`,"success")):(j.markInvalid(s.key,y.message),this.setStatus(`\uFE0F ${s.label||`Chave ${i+1}`}: ${y.message}`,"error")),this.renderKeysList()});let b=document.createElement("button");b.className="eq-icon-btn",b.type="button",b.title="Editar chave",b.innerHTML=L.edit,b.addEventListener("click",()=>{let y=window.prompt(`Editar ${s.label||`Chave ${i+1}`}:`,s.key);if(y!==null&&y.trim()){let A=j.updateKey(s.id,y.trim());if(A.ok){let C=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:C[0],apiKeys:C}),this.setStatus(`Chave ${i+1} atualizada com sucesso!`,"success"),this.renderKeysList()}else this.setStatus(A.message,"warning")}});let v=document.createElement("button");v.className="eq-icon-btn",v.type="button",v.title="Remover chave",v.innerHTML=L.trash,v.addEventListener("click",()=>{if(confirm(`Remover permanentemente a ${s.label||`Chave ${i+1}`}?`)){let y=j.removeKey(s.id);if(y.ok){let A=j.exportRawKeys();this.callbacks.onSettingsChange({apiKey:A[0]||"",apiKeys:A}),this.setStatus("Chave removida com sucesso.","info"),this.renderKeysList()}else this.setStatus(y.message,"warning")}}),u.appendChild(h),u.appendChild(b),u.appendChild(v),c.appendChild(l),c.appendChild(u),this.keysListEl.appendChild(c)})}updateModelSelect(e,t){let o=e.filter(r=>se(r.id)),s=t&&se(t)?t:se(this.initialSettings.model)?this.initialSettings.model:"gemini-2.5-flash";this.modelSelect.innerHTML="";let a=!1;o.forEach(r=>{let i=r.id===s;i&&(a=!0),this.modelSelect.add(new Option(r.name,r.id,!1,i))}),!a&&s&&se(s)&&this.modelSelect.add(new Option(`Gemini (${s})`,s,!1,!0)),this.modelSelect.value=s}updateSelectedModel(e){if(!se(e))return;Array.from(this.modelSelect.options).some(o=>o.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}mountHost(){let e=document.body||document.documentElement;if(!e){let t=()=>{let o=document.body||document.documentElement;o&&!this.host.isConnected&&o.appendChild(this.host)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t,{once:!0}):setTimeout(t,0);return}this.host.isConnected||e.appendChild(this.host)}applyHostDarkMode(e){document.getElementById("eq-host-dark-mode-style")?.remove(),this.host.classList.toggle("eq-dark-mode-active",e)}startQuestionTimer(){this.currentQuestionStartTime=Date.now(),this.questionLiveTimerInterval&&clearInterval(this.questionLiveTimerInterval),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Calculando...",this.metricsLiveStatus.classList.add("active"));let e=()=>{if(!this.metricsLiveTime)return;let t=Date.now()-this.currentQuestionStartTime,o=Math.floor(t/6e4),s=Math.floor(t%6e4/1e3),a=Math.floor(t%1e3/10);this.metricsLiveTime.textContent=`${String(o).padStart(2,"0")}:${String(s).padStart(2,"0")}.${String(a).padStart(2,"0")}`};e(),this.questionLiveTimerInterval=setInterval(e,50)}stopQuestionTimer(e){if(this.questionLiveTimerInterval&&(clearInterval(this.questionLiveTimerInterval),this.questionLiveTimerInterval=null),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Parado",this.metricsLiveStatus.classList.remove("active")),this.metricsLiveTime&&this.currentQuestionStartTime>0){let t=e!==void 0?e:Math.max(0,Date.now()-this.currentQuestionStartTime),o=Math.floor(t/6e4),s=Math.floor(t%6e4/1e3),a=Math.floor(t%1e3/10);this.metricsLiveTime.textContent=`${String(o).padStart(2,"0")}:${String(s).padStart(2,"0")}.${String(a).padStart(2,"0")}`}}updateTimingMetrics(e){let t=e||Ne();if(!this.metricTotalTime)return;let o=Math.floor(t.totalElapsedMs/1e3),s=Math.floor(o/60),a=o%60;this.metricTotalTime.textContent=`${String(s).padStart(2,"0")}:${String(a).padStart(2,"0")}`;let r=(t.averageDurationMs/1e3).toFixed(1);this.metricAvgTime.textContent=`${r}s`,this.metricTotalCount.textContent=String(t.completedQuestionsCount),this.metricsTotalBadge&&(this.metricsTotalBadge.textContent=`${t.completedQuestionsCount} Quest\xE3o(\xF5es)`),this.metricsHistoryCount&&(this.metricsHistoryCount.textContent=`${t.records.length} registros`),this.renderMetricsHistory(t.records)}renderMetricsHistory(e){if(!this.metricsHistoryList)return;if(e.length===0){this.metricsHistoryList.innerHTML='<div style="text-align:center;padding:24px 0;color:#444;font-size:11px;">Nenhuma quest\xE3o respondida ainda.</div>';return}this.metricsHistoryList.innerHTML="";let t=[...e].reverse(),o=Math.max(...e.map(s=>s.durationMs),1);for(let s of t){let a=s.durationMs/1e3,r=Math.round(s.durationMs/o*100),i=s.status==="verified"||s.status==="answered",c=s.status==="manual",l=i?"#4ade80":c?"#fbbf24":"#666",p=i?"Injetado":c?"Gabarito":"Pendente",f=new Date(s.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}),d=s.mode?s.mode.replace(/_/g," "):"auto",m=a<5?"#4ade80":a<15?"#fbbf24":"#ef4444",u=document.createElement("div");u.style.cssText="background:rgba(255,255,255,0.025);border:1px solid rgba(255,255,255,0.055);border-radius:7px;padding:9px 10px;margin-bottom:5px;cursor:default;transition:background 0.1s;",u.addEventListener("mouseenter",()=>{u.style.background="rgba(255,255,255,0.045)"}),u.addEventListener("mouseleave",()=>{u.style.background="rgba(255,255,255,0.025)"});let h=document.createElement("div");h.style.cssText="display:flex;align-items:flex-start;gap:8px;margin-bottom:6px;";let b=document.createElement("div");b.style.cssText="flex-shrink:0;width:22px;height:22px;border-radius:5px;background:rgba(0,152,255,0.15);border:1px solid rgba(0,152,255,0.25);display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:800;color:#0098ff;",b.textContent=String(s.questionIndex);let v=document.createElement("div");v.style.cssText="flex:1;font-size:10.5px;color:#ccc;font-weight:600;line-height:1.4;word-break:break-word;",v.textContent=s.questionTitle||"Quest\xE3o "+s.questionIndex;let y=document.createElement("div");y.style.cssText="flex-shrink:0;font-size:13px;font-weight:800;color:"+m+";font-family:monospace;font-variant-numeric:tabular-nums;",y.textContent=a<60?a.toFixed(1)+"s":Math.floor(a/60)+"m"+String(Math.round(a%60)).padStart(2,"0")+"s",h.appendChild(b),h.appendChild(v),h.appendChild(y);let A=document.createElement("div");A.style.cssText="height:2px;background:rgba(255,255,255,0.05);border-radius:1px;margin-bottom:6px;overflow:hidden;";let C=document.createElement("div");C.style.cssText="height:100%;width:"+r+"%;background:"+m+";border-radius:1px;transition:width 0.4s ease;",A.appendChild(C);let x=document.createElement("div");x.style.cssText="display:flex;align-items:center;gap:6px;flex-wrap:wrap;";let w=(q,H,Q)=>{let V=document.createElement("span");return V.style.cssText="font-size:8.5px;font-weight:700;letter-spacing:0.04em;padding:1px 6px;border-radius:8px;background:rgba("+Q+",0.12);color:"+H+";",V.textContent=q,V};x.appendChild(w(p,l,i?"74,222,128":c?"251,191,36":"102,102,102")),x.appendChild(w(d,"#888","255,255,255")),s.actionsCount&&x.appendChild(w(s.actionsCount+" a\xE7\xE3o"+(s.actionsCount>1?"\xF5es":""),"#888","255,255,255"));let T=document.createElement("span");T.style.cssText="font-size:8.5px;color:#444;margin-left:auto;",T.textContent=f,x.appendChild(T);let k=document.createElement("span");k.style.cssText="flex-shrink:0;display:inline-flex;color:#444;transition:transform 0.2s ease;margin-left:4px;",k.innerHTML='<svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M7 10l5 5 5-5z"/></svg>',h.appendChild(k);let E=document.createElement("div");E.style.cssText="overflow:hidden;max-height:0;transition:max-height 0.22s ease;",E.appendChild(A),E.appendChild(x);let I=!1,S=()=>{I=!I,I?(this.metricsHistoryList?.querySelectorAll(".eq-mhist-body").forEach(q=>{if(q!==E){q.style.maxHeight="0";let H=q.parentElement?.querySelector(".eq-mhist-chevron");H&&(H.style.transform="")}}),E.style.maxHeight=E.scrollHeight+40+"px",k.style.transform="rotate(180deg)"):(E.style.maxHeight="0",k.style.transform="")};E.className="eq-mhist-body",k.className="eq-mhist-chevron",h.style.cursor="pointer",h.addEventListener("click",S),u.appendChild(h),u.appendChild(E),this.metricsHistoryList.appendChild(u)}}copyMetricsReport(){let e=Ne(),t=[];t.push("# Relat\xF3rio de Desempenho e Tempo \u2014 EasyQuiz"),t.push(`- **Quest\xF5es Respondidas:** ${e.completedQuestionsCount}`),t.push(`- **Tempo Total:** ${(e.totalElapsedMs/1e3).toFixed(1)}s`),t.push(`- **Tempo M\xE9dio por Quest\xE3o:** ${(e.averageDurationMs/1e3).toFixed(2)}s`),t.push(""),t.push("### Hist\xF3rico:"),e.records.length===0?t.push("_Nenhum registro ainda._"):e.records.forEach((o,s)=>{t.push(`${s+1}. **${o.questionTitle||`Q${o.questionIndex}`}**: ${(o.durationMs/1e3).toFixed(2)}s (${o.status})`)}),navigator.clipboard.writeText(t.join(`
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Gn(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Kn(){let n=window;if(Re(),Gn(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=pt(),t=null,o=null,s=0,a=new ct(e,{onAnalyze:(l=1,p,f=!1)=>r(l,p,f),onApply:(l=1)=>void i(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}Ee(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}Ee(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=Bt(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,p,f=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,m=()=>{try{d.abort()}catch{}};if(p&&(p.aborted?d.abort():p.addEventListener("abort",m,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}s=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),Ee(),a.hideFloatingAnswers();try{let u=Ae(!1);u||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),u=be()),Ge(u.scope),a.updateContext(u),a.logToConsole(`> [DOM] Escopo: <${u.scope.tagName.toLowerCase()}> com ${u.controls.length} controle(s) e ${u.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${u.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let h=await Pt(u.scope,e.useVision);if(h.length>0){let x=h.map(w=>w.element).filter(Boolean);It(x),a.updateImages(h)}if(d.signal.aborted)return;let b=e.model;a.setStatus(h.length>0?`Consultando Gemini (${b}) com ${h.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let v=Qe(u,h,e);a.setInspectorPrompt(v,e.model);let y=(x,w)=>{a.setStatus(x,w==="warning"?"info":w);let T=x.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(T){let k=T[1].split(",")[0].trim();a.setProgress(50,`Gemini ${k} respondendo...`)}},{plan:A,usedModel:C}=await _e(u,h,e,y,d.signal);if(d.signal.aborted)return;if(A.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),u=Ae(!0),u||(u=be()),Ge(u.scope),a.updateContext(u),h=await Pt(u.scope,e.useVision),h.length>0){let T=h.map(k=>k.element).filter(Boolean);It(T),a.updateImages(h)}a.setStatus(`Reconsultando IA com escopo ampliado (${u.controls.length} controles)...`,"info");let x=Qe(u,h,e);a.setInspectorPrompt(x,e.model),A=(await _e(u,h,e,y,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||e.model} | Modo: ${A.mode} | Confian\xE7a: ${(A.confidence*100).toFixed(0)}%`,"text-green"),A.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${A.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${A.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),A.memoryToStore&&(Nt(A.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${A.memoryToStore}"`,"text-yellow")),A.imageDescriptions&&A.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${A.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let x of A.imageDescriptions){let w=x.relevant?"":"\uFE0F";a.logToConsole(`>   ${w} Imagem ${x.index+1} [${x.relevant?"RELEVANTE":"IGNORADA"}]: ${x.description}`,x.relevant?"text-blue":"text-yellow")}}return t=A,a.updateContext(u,A),sn(A.actions,A.confidence),a.setPlan(A,!e.dryRun),A.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):A.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):A.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&A.pageType==="question"&&a.showFloatingAnswers(A),d.signal.aborted?void 0:((f||e.autoApply)&&!e.dryRun&&await i(l,d.signal,f),A)}catch(u){if(d.signal.aborted||u instanceof Error&&(u.name==="AbortError"||u.message.includes("cancelada"))){Ee(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}Ee(),a.setProgress(0);let h=u instanceof Error?u.message:"Falha desconhecida na an\xE1lise.";a.setStatus(h,"error"),a.setErrorDiagnostic(h,"An\xE1lise da IA");return}finally{p?.removeEventListener("abort",m),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function i(l=1,p,f=!1){if(p?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(b=>b.t!=="adv"),u=t.pageType==="question"||nt(t.rationale||"");if(u&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let h=(f||e.autoAdvance||d)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!u||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Xe(t,h,l,Le(e));if(p?.aborted)return;if(a.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let x of b.failedActions){let w=x.action,T=w.t==="drag"?`drag: "${w.from}" \u2192 "${w.to}"`:w.t==="clk"||w.t==="chk"?`${w.t}: "${w.id}"`:w.t==="val"?`val: "${w.id}" = "${w.v}"`:JSON.stringify(w).slice(0,80);a.logToConsole(`>    [${w.t.toUpperCase()}] ${T} | ${x.evidence.slice(0,80)}`,"text-yellow")}await c(b.failedActions,p)}let v=s>0?Date.now()-s:1200,y=b.verified>0,A=b.applied>0;if(b.success||y&&A){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):h&&a.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),a.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let x=Qt({id:`q-${Date.now()}`,questionIndex:(Ne().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:v,status:"answered",mode:t.mode,actionsCount:b.applied});a.updateTimingMetrics(x)}else A?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(b){a.setProgress(0);let v=b instanceof Error?b.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${v}`,"error"),a.logToConsole(`> [ERRO] ${v}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,p){if(!t)return;let f=l.filter(m=>m.action.t==="drag");for(let m of f){if(p?.aborted)return;let u=m.action,h=String(u.from||""),b=String(u.to||""),v=tn(h,b,h,b);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${h}" \u2192 "${b}"`,"text-blue");let y={...t,actions:[{t:"js",v}],pageType:"question"},A=await Xe(y,!1,1,Le(e));a.logToConsole(A.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",A.applied>0?"text-green":"text-yellow")}let d=l.filter(m=>m.action.t!=="drag");if(d.length!==0&&!p?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of d){if(p?.aborted)return;let u=m.action,h=u.t==="clk"||u.t==="chk"?`${u.t}: "${u.id}"`:u.t==="val"?`val: "${u.id}" = "${u.v}"`:u.t==="sel"?`sel: "${u.id}" = "${Array.isArray(u.v)?u.v[0]:u.v}"`:JSON.stringify(u).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${h}`,"text-blue");let b=String(u.id||u.name||u.selector||""),v=u.v!==void 0?String(u.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await st(m.action),await new Promise(y=>setTimeout(y,250)),de(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${h}`,"text-green");continue}}catch{}if(u.t==="clk"||u.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let y=N(b,v)||N(b.replace(/[^\w\s]/g," ").trim(),v);if(y&&(kt(y),await new Promise(A=>setTimeout(A,300)),de(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${h}`,"text-green");continue}}catch{}}if(u.t==="clk"||u.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let y=N(b,v)||N(b.replace(/[^\w\s]/g," ").trim(),v);if(y&&(y.focus?.(),await new Promise(A=>setTimeout(A,50)),y.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),y.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,80)),y.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),y.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,200)),de(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${h}`,"text-green");continue}}catch{}}if(u.t==="clk"||u.t==="chk"||u.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let y=N(b,v)||N(b.replace(/[^\w\s]/g," ").trim(),v);if(y){let A=y.id,C=!!A;A||(A=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,y.id=A);let x=String(u.v??""),w=u.t==="val",T=document.createElement("script");if(T.textContent=`(function(){
              var el=document.getElementById(${JSON.stringify(A)});
              if(!el)return;
              // Tenta Vue 3 update trigger
              try{if(el.__vueParentComponent){var ins=el.__vueParentComponent;var pr=ins.props||{};if(pr.modelValue!==undefined&&typeof ins.emit==='function'){ins.emit('update:modelValue',${w?JSON.stringify(x):"true"});}}}catch(e){}
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(T),T.remove(),C||setTimeout(()=>{try{y.id===A&&y.removeAttribute("id")}catch{}},0),await new Promise(k=>setTimeout(k,300)),de(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${h}`,"text-green");continue}}}catch{}}if(p?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let y="";try{let q=document.querySelector(`[data-easyquiz-id="${u.id}"]`)||document.getElementById(u.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(H=>(H.textContent||"").toLowerCase().includes(String(u.id||"").toLowerCase().slice(0,20)));q&&(y=q.outerHTML.slice(0,400))}catch{}let A=Ae(!1)||be(),C=`A\xE7\xE3o (${u.t}) alvo="${b}" valor="${u.v||u.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${y?`
HTML do alvo: ${y}`:""}`,x=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],w=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
...
N\xC3O repita as estrat\xE9gias j\xE1 tentadas acima.`,T={...A,questionText:w},k=await _e(T,[],{...e},q=>a.logToConsole(`> [REPLAN-AI] ${q}`,"text-blue"),p);if(p?.aborted||!k?.plan){a.logToConsole("> [REPLAN]  Re-consulta n\xE3o retornou plano.","text-yellow");continue}let E=k.plan.actions.filter(q=>q.t==="js");if(E.length===0){a.logToConsole("> [REPLAN] \u2139\uFE0F IA n\xE3o gerou a\xE7\xF5es JS de fallback.","text-yellow");continue}a.logToConsole(`> [REPLAN]  IA gerou ${E.length} a\xE7\xE3o(\xF5es) JS custom. Executando...`,"text-blue");let I={...t,actions:E,pageType:"question"},S=await Xe(I,!1,1,Le(e));S.applied>0?a.logToConsole(`> [REPLAN]  Estrat\xE9gia 5 OK: ${S.applied} a\xE7\xE3o(\xF5es) JS executada(s)!`,"text-green"):a.logToConsole("> [REPLAN]  Todas as estrat\xE9gias esgotadas para esta a\xE7\xE3o.","text-yellow")}catch(y){a.logToConsole(`> [REPLAN] Erro na re-consulta: ${y instanceof Error?y.message:String(y)}`,"text-yellow")}}}}a.toggle(!0)}Kn().catch(n=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",n),window.alert(`EasyQuiz: falha ao iniciar: ${n instanceof Error?n.message:String(n)}`)});})();
