          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                ...
                <span class="eq-brand-version">${Ce}</span>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                <div class="eq-resolver-hero">
                  <div class="eq-resolver-brand">
                    ...
                    <div class="eq-brand-copy">
                      ...
                      <div class="eq-brand-subline">BETA \u2022 ${Ce}</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="eq-footer-note" style="margin-top: auto;">${Ce} \u2022 H\xEDbrido 4.0 (RAG + AST + Vision)</div>
              </div>
              ...
              <div class="eq-view-pane" id="eq-view-settings" style="display: none;">
                ...
                <div class="eq-footer-note" style="margin-top: auto;">Configura\xE7\xF5es salvas localmente no navegador \u2022 ${Ce}</div>
              </div>
            </div>
          </main>
        </aside>
