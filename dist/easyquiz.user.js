 ...
 */
"use strict";(()=>{var A={apiKey:"",model:"gemini-3.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};var ae="easyquiz_settings_v2";function oe(){try{let t=localStorage.getItem(ae);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let i=JSON.parse(o);return{...A,apiKey:i.apiKey||""}}return{...A}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:A.model;return a==="gemini-2.5-flash"&&(a="gemini-3.5-flash"),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():A.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:A.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:A.confidenceThreshold}}catch{return{...A}}}function ve(){try{localStorage.removeItem(ae),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),ie()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function R(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);if(!e)return{};let a=JSON.parse(e);if(a.advanceSelector&&/inject|injetar/i.test(a.advanceSelector)){a.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+t)}catch{}}return a}catch{return{}}}function ne(t,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...R(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function ye(t){let a={...oe(),...t};try{localStorage.setItem(ae,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}var j=[];function xe(t){let e=t.trim();e&&!j.includes(e)&&j.push(e)}function we(){return j}function ie(){j=[]}var Ee=`Voc\xEA \xE9 o EasyQuiz Engine v4.8 Supreme. Responda estritamente em JSON v\xE1lido.
...
- { "t": "adv" } (aciona bot\xE3o de avan\xE7o/pr\xF3xima)`;function qe(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),s=t.questionText.length<120||o||t.controls.length<3?`
[HTML FRAGMENT (Estrutura DOM/Widgets)]:
${t.htmlSnippet.slice(0,5e3)}`:`
[HTML FRAGMENT]: Omitido (Texto e controles s\xE3o suficientes).`,n=we(),r="";return n.length>0&&(r=`
...
Responda estritamente em JSON.`}var z=[{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Padr\xE3o 2026 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente e Est\xE1vel)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Compatibilidade)",description:"Modelo r\xE1pido para contas com acesso ativo."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Legado Universal)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],Be={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function Ne(t){let e=t.trim().replace(/^google\//,"").replace(/^models\//,"");return e==="gemini-2.5-flash"?"gemini-3.5-flash":e||"gemini-3.5-flash"}function Te(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function De(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let i of o)try{let s=JSON.parse(i);if(s&&typeof s=="object")return s}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var F=null,se=new Set;async function Q(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return z;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let n=await i.text(),r=Te(n,i.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let s=await i.json();if(Array.isArray(s.models)&&s.models.length>0){let n=s.models.filter(r=>{let l=r.supportedGenerationMethods||[],d=(r.name||"").includes("gemini"),c=l.includes("generateContent"),h=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return d&&c&&!h}).map(r=>{let l=r.name.replace(/^models\//,""),d=r.displayName||l;return{id:l,name:d.includes(l)?d:`${d} (${l})`,description:r.description||""}});if(n.length>0)return n.sort((r,l)=>{let d=c=>c==="gemini-2.5-flash"?100:c==="gemini-3.5-flash"?95:c==="gemini-3.1-flash-lite"?90:c==="gemini-2.5-pro"?85:c==="gemini-3.1-pro"?80:c==="gemini-1.5-flash"?60:c.includes("flash")?50:10;return d(l.id)-d(r.id)}),F=n,n}}catch(i){if(i.message?.includes("Chave de API"))throw i}return z}async function Ce(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await Q(e);if(o.length>0&&o!==z){let i=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let i of["v1beta","v1"]){let s=`https://generativelanguage.googleapis.com/${i}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${i})!`,models:z}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function re(t,e,a,o){let i=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!i)throw new Error("Chave de API n\xE3o configurada.");let s=Ne(a.model);if(!F||F.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await Q(i)}catch(m){let u=m instanceof Error?m.message:String(m);if(u.includes("inv\xE1lida")||u.includes("n\xE3o autorizada"))throw new Error(u)}let n=Date.now(),r=qe(t,e,a),l=[{text:r}];for(let m of e)l.push({inline_data:{mime_type:m.mediaType,data:m.base64}});let d={system_instruction:{parts:[{text:Ee}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:Be}},c=[s,...F?.map(m=>m.id)||[],"gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-flash","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],h=Array.from(new Set(c)).filter(m=>!se.has(m));h.length===0&&(se.clear(),h.push(...z.map(m=>m.id)));let p=new Error("Nenhum modelo tentado.");for(let m=0;m<h.length;m++){let u=h[m],x=h[m+1];o?.(`Aguardando resposta da API (${u})...`,"info");let b=["v1beta","v1"];for(let S of b){let T=`https://generativelanguage.googleapis.com/${S}/models/${u}:generateContent?key=${encodeURIComponent(i)}`,G=new AbortController,be=setTimeout(()=>G.abort(),35e3);try{let L=await fetch(T,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":i},body:JSON.stringify(d),signal:G.signal});if(clearTimeout(be),!L.ok){let Oe=await L.text(),$e=Te(Oe,L.status);if(L.status===404&&S==="v1beta")continue;throw new Error($e)}let ee=await L.json(),te=ee.candidates?.[0];if(!te||!te.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let Re=te.content.parts[0].text,C=De(Re);if(Array.isArray(C.actions)||(C.actions=[]),Array.isArray(C.warnings)||(C.warnings=[]),typeof C.confidence!="number"&&(C.confidence=.8),C.usedModel=u,C.durationMs=Date.now()-n,C.promptSent=r,C.tokensUsed=ee.usageMetadata?.totalTokenCount,u!==s){o?.(`Resolvido com sucesso pelo fallback '${u}' (${S})!`,"info");try{a.model=u}catch{}}return{plan:C,rawUsage:ee.usageMetadata,usedModel:u}}catch(L){if(clearTimeout(be),p=L,p.message.includes("inv\xE1lida")||p.message.includes("n\xE3o autorizada"))throw p}}let f=p.message.includes("429")||p.message.includes("cota"),k=p.message.includes("503")||p.message.includes("sobrecarregado");if(p.message.includes("404")&&se.add(u),x){let S=f?3500:k?2500:900,T=`Modelo '${u}' indispon\xEDvel (${p.message}). Aguardando ${S/1e3}s antes de alternar para '${x}'...`;console.warn(`[EasyQuiz Fallback] ${T}`),o?.(T,"warning"),await new Promise(G=>setTimeout(G,S))}else console.warn(`[EasyQuiz Fallback] Modelo '${u}' falhou: ${p.message}. Todos os modelos esgotados.`)}throw p}var H=['input:not([type="hidden"])',"textarea","select","button","a",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),U=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,_e=0;function E(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function Ve(t){if(t==null)return"";if(typeof t=="string")return t;if(typeof t=="number"||typeof t=="boolean")return String(t);if(t instanceof Node)return t.textContent||"";try{if(typeof t?.toString=="function"){let e=t.toString();if(typeof e=="string")return e}}catch{}return""}function w(t,e=500){return Ve(t).replace(/\s+/g," ").trim().slice(0,e)}function Ge(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(_e+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function je(t){return t?!!(t.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||t.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function O(t){if(!t||!(t instanceof Element)||je(t)||t.closest("header, nav, aside"))return!1;let e=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",a=w(t.getAttribute?.("aria-label")||t.textContent||t.getAttribute?.("value")||e),o=t.type,i=a.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),s=String(t.getAttribute?.("data-testid")||t.getAttribute?.("data-test-id")||t.getAttribute?.("id")||t.getAttribute?.("href")||"").toLowerCase();return U.test(i)||U.test(a)||o==="submit"||s.includes("next")||s.includes("check")||s.includes("continue")||s.includes("proximo")||s.includes("forward")||!1}function Fe(t){let e=t.getAttribute("aria-label");if(e)return w(e);let a=t.getAttribute("aria-labelledby");if(a){let n=a.split(/\s+/).map(r=>document.getElementById(r)?.textContent).filter(Boolean).join(" ");if(n.trim())return w(n)}if("labels"in t&&t.labels){let n=Array.from(t.labels??[]).map(r=>r.textContent).join(" ");if(n.trim())return w(n)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let n=w(o.textContent);if(n)return n}let i=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",s=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||i||"";return w(s)}function le(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let i=t.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(i)?i:"other",n=t.getAttribute("role")||"",r=(t.getAttribute("data-testid")||t.getAttribute("data-test-id")||"").toLowerCase(),l=(t.className&&typeof t.className=="string"?t.className:"").toLowerCase(),d=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item")||t.classList.contains("sortable-item")||!!t.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(r)||/drag|card-item|sortable/i.test(l),c=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category")||!!t.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(r)||/dropzone|category-box|bucket|target-zone/i.test(l),p=w((d?"draggable":c?"dropzone":"")||o.type||n||s,40),m="";if(o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox")m=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked";else{let f=t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement?t.value:"";m=w(f||t.getAttribute("data-category")||t.textContent||"",2e3)}let u=[];if(a)for(let f of Array.from(a.options).slice(0,80))u.push({value:w(f.value),label:w(f.textContent)});let x=!!(o.required||t.getAttribute("aria-required")==="true"),b=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Ge(t),tag:s,type:p,label:Fe(t),name:w(o.name||t.getAttribute("name")||"",180),value:m,options:u,required:x,disabled:b,role:e}}var Me=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Se(t){if(!E(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(H)).filter(E),o=w(t.innerText,4e3).length;if(o<10||!a.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),s=Math.max(1,e.width*e.height),n=Math.min(1,s/i),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),d=o>40?35:0,c=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+d+c-n*20-l*10}function ce(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let i=w(e.innerText,1e4),s=w(a.innerText,1e4),n=e.querySelectorAll(H).length,r=a.querySelectorAll(H).length;if(i.length<150&&s.length>i.length&&r<=n+4){e=a;continue}break}return e}function Qe(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&E(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Ue(){let t=document.activeElement;if(t&&t!==document.body){let i=t.closest(Me);if(i&&Se(i)>0)return ce(i)}let a=Array.from(document.querySelectorAll(Me)).map(i=>({element:i,score:Se(i)})).filter(i=>Number.isFinite(i.score)).sort((i,s)=>s.score-i.score);if(a.length>0&&a[0].score>0)return ce(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&E(o)?o:document.body}function ke(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))a.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ye(t){return Array.from(t.querySelectorAll(H)).filter(e=>{if(!E(e)||O(e))return!1;if(e.tagName.toLowerCase()==="a"){let a=e.getAttribute("role");return!!(a==="button"||a==="radio"||a==="checkbox"||a==="option"||e.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]'))}return!0}).slice(0,100).map(e=>le(e,"answer"))}function de(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let i of e)for(let s of Array.from(i.querySelectorAll(H)))if(!(a.has(s)||!E(s)||!O(s))&&(a.add(s),o.push(le(s,"navigation")),o.length>=10))return o;return o}function $(t=!1){let e=Ue();e=ce(e),t&&(e=Qe(e));let a=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",o=w(a,16e3),i=Ye(e),s=de(e);s.length===0&&(s=de(document.body));let n=[...i,...s].slice(0,120);return!o||n.length===0&&o.length<30?w(document.body.innerText||document.body.textContent||"",16e3).length>=30?I():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:o,htmlSnippet:ke(e),controls:n,scope:e}}function I(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=w(t,14e3),a=de(document.body),o=document.querySelector('main, article, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Leitura/Contexto",questionText:e,htmlSnippet:ke(o).slice(0,15e3),controls:a,scope:o}}function M(t){return t?!!(t.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||t.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function y(t){return t?t.replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:\s]+\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim():""}function v(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o&&!M(o))return o;try{if(o=document.querySelector(e),o&&!M(o))return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o&&!M(o))return o}catch{}try{let n=e.replace(/"/g,""),r=`//*[normalize-space(.)="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(r,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let d=l.singleNodeValue;if(!M(d))return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||d}}catch{}let i=y(e).toLowerCase(),s=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of s){if(!E(n)||M(n))continue;let r=y(n.textContent).toLowerCase(),l=y(n.getAttribute("aria-label")||"").toLowerCase(),d=y(n.getAttribute("data-category")||"").toLowerCase(),c=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",h=y(c).toLowerCase(),p=r.startsWith(i+")")||r.startsWith(i+".")||r.startsWith(i+" -")||r.startsWith(i+":");if(r===i||l===i||d&&d===i||h&&h===i||p){let m=n.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]'),u=n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li');return m||u||n}}if(i.length>=3)for(let n of s){if(!E(n)||M(n))continue;let r=y(n.textContent).toLowerCase(),l=y(n.getAttribute("aria-label")||"").toLowerCase();if(r.includes(i)||l.includes(i)||i.length>8&&r&&i.includes(r)){let c=n.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]'),h=n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li');return c||h||n}let d=i.split(" ").filter(c=>c.length>2);if(d.length>=3){let c=d.slice(0,Math.min(4,d.length)).join(" ");if(r.includes(c)||l.includes(c))return n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li')||n}}return null}function B(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function q(t,e){if(!t)return;try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let n=t.getBoundingClientRect();a=Math.round(n.left+Math.max(1,n.width/2)),o=Math.round(n.top+Math.max(1,n.height/2))}try{t.focus?.()}catch{}let i={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};try{t.dispatchEvent(new PointerEvent("pointerdown",{...i,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:1}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",{...i,button:0,buttons:1}));try{t.dispatchEvent(new PointerEvent("pointerup",{...i,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:0}))}catch{}t.dispatchEvent(new MouseEvent("mouseup",{...i,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...i,button:0,buttons:0}));try{let n=new Touch({identifier:Date.now(),target:t,clientX:a,clientY:o,screenX:a,screenY:o,pageX:a+(window.scrollX||0),pageY:o+(window.scrollY||0)});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,composed:!0,touches:[n],targetTouches:[n]})),t.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,composed:!0,touches:[],targetTouches:[]}))}catch{}try{t.click()}catch{}if(!(t instanceof HTMLInputElement||t instanceof HTMLLabelElement)){let n=t.closest('button, a, [role="button"], [role="radio"], [role="checkbox"]');if(n&&n!==t)try{n.click()}catch{}}}function Ae(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let i=t._valueTracker;i&&i.setValue("")}catch{}let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,B(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,B(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function pe(t,e){let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||t,o=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]');if(!o&&a.hasAttribute("for")){let s=a.getAttribute("for");s&&(o=a.ownerDocument.getElementById(s))}if(a&&(a.setAttribute("aria-checked",e?"true":"false"),a.setAttribute("aria-selected",e?"true":"false"),a.classList.toggle("selected",e),a.classList.toggle("active",e),a.classList.toggle("checked",e)),o&&["checkbox","radio"].includes(o.type)){o.checked=e;try{let s=o._valueTracker;s&&s.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,B(o,["input","change"])}let i=a&&a!==o?a:o||t;if(i){try{i.focus?.()}catch{}let s=i.getBoundingClientRect(),n=Math.round(s.left+Math.max(1,s.width/2)),r=Math.round(s.top+Math.max(1,s.height/2)),l={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r};try{i.dispatchEvent(new PointerEvent("pointerdown",{...l,isPrimary:!0,pointerId:1,pointerType:"mouse",button:0,buttons:1}))}catch{}i.dispatchEvent(new MouseEvent("mousedown",{...l,button:0,buttons:1}));try{i.dispatchEvent(new PointerEvent("pointerup",{...l,isPrimary:!0,pointerId:1,pointerType:"mouse",button:0,buttons:0}))}catch{}i.dispatchEvent(new MouseEvent("mouseup",{...l,button:0,buttons:0})),i.dispatchEvent(new MouseEvent("click",{...l,button:0,buttons:0}))}if(o&&["checkbox","radio"].includes(o.type)){if(o.checked!==e){o.checked=e;try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}B(o,["input","change"])}a&&(a.classList.toggle("selected",e),a.classList.toggle("active",e),a.classList.toggle("checked",e))}}function Ke(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);B(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function Xe(t,e){try{let a=new DataTransfer;try{a.setData("text/plain",t)}catch{}try{a.setData("text/html",e)}catch{}return a}catch{return null}}async function ue(t,e,a=1){try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=t.getBoundingClientRect(),i=e.getBoundingClientRect(),s=Math.round(o.left+Math.max(1,o.width/2)),n=Math.round(o.top+Math.max(1,o.height/2)),r=Math.round(i.left+Math.max(1,i.width/2)),l=Math.round(i.top+Math.max(1,i.height/2)),d=y(e.textContent).toLowerCase();if(d){let x=Array.from(t.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let f=y(b.textContent).toLowerCase(),k=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?y(b.value).toLowerCase():"";return f&&(d.includes(f)||f.includes(d))||k&&(d.includes(k)||k.includes(d))});x&&(q(x),await new Promise(b=>setTimeout(b,120)))}q(t,[s,n]),await new Promise(u=>setTimeout(u,140)),q(e,[r,l]);let c=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');c&&c!==e&&q(c),await new Promise(u=>setTimeout(u,100));let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:n,screenX:s,screenY:n,button:0,buttons:1};try{t.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",h));let p=4;for(let u=1;u<=p;u++){let x=Math.round(s+(r-s)*(u/p)),b=Math.round(n+(l-n)*(u/p)),f={...h,clientX:x,clientY:b,screenX:x,screenY:b};try{t.dispatchEvent(new PointerEvent("pointermove",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",f))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:l,screenX:r,screenY:l,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let u=Xe(w(t.textContent),t.outerHTML),x={...h},b={...m};u&&(x.dataTransfer=u,b.dataTransfer=u),t.dispatchEvent(new DragEvent("dragstart",x)),e.dispatchEvent(new DragEvent("dragenter",b)),e.dispatchEvent(new DragEvent("dragover",b)),e.dispatchEvent(new DragEvent("drop",b)),t.dispatchEvent(new DragEvent("dragend",x))}catch(u){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",u)}try{let u=new Touch({identifier:1,target:t,clientX:s,clientY:n}),x=new Touch({identifier:1,target:e,clientX:r,clientY:l});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[u]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[x]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(a>=2&&!e.contains(t))try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(u=>setTimeout(u,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Le={fill:(t,e)=>{let a=v(t);a?Ae(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=v(t);e?q(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=v(t);a?pe(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=v(t),o=v(e);a&&o?ue(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=v(t),o=v(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await ue(a,o)}};window.$eq=Le;async function Je(t,e=1){if(t.t==="js"){let i=String(t.v||"");try{new Function("$eq","document","window",i)(Le,document,window)}catch(s){console.warn("[EasyQuiz JS Execution]",s)}return}if(t.t==="drag"){let i=v(t.from),s=v(t.to);!i&&t.from&&(i=v(y(t.from))),!s&&t.to&&(s=v(y(t.to))),i&&s?await ue(i,s,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let a=t.id||"",o=v(a);if(!o&&a&&(o=v(y(a))),!o&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":o&&Ae(o,String(t.v));break;case"chk":o&&pe(o,!!t.c);break;case"sel":if(o){let s=Array.isArray(t.v)?t.v:[String(t.v)];Ke(o,s)}break;case"clk":o&&(!!(o.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||o.querySelector('input[type="radio"], input[type="checkbox"]')||o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type))?pe(o,!0):q(o,t.co));break;case"adv":let i=Y(t.id);if(i){await he(i,1200);let s=t.id||i.textContent?.trim()||"";s&&ne(window.location.hostname,{advanceSelector:s}),q(i)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function We(){let t=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(t)).find(a=>{if(!E(a)||M(a)||a.closest("header, nav, aside"))return!1;let o=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"",i=(a.textContent||o||a.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function Y(t){if(t){let s=v(t);if(s&&E(s)&&!M(s))return s}try{let s=R(window.location.hostname);if(s.advanceSelector){let n=v(s.advanceSelector);if(n&&E(n)&&!M(n))return n}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(e)).filter(s=>E(s)&&!M(s)&&!s.closest("header, nav, aside"));for(let s of o)if(O(s))return s;for(let s of o){let n=s instanceof HTMLInputElement||s instanceof HTMLButtonElement?s.value:"",r=(s.textContent||n||s.getAttribute("aria-label")||"").trim();if(U.test(r))return s}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&E(i)&&!M(i)?i:null}async function he(t,e=1500){let a=Date.now();for(;Date.now()-a<e;){if(!(t.disabled===!0||t.getAttribute("aria-disabled")==="true"||t.classList.contains("disabled")||t.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,100))}try{t.removeAttribute("disabled"),t.removeAttribute("aria-disabled"),t.classList.remove("disabled"),t.disabled=!1}catch{}}function Ze(t){try{if(t.t==="val"){let e=v(t.id)||v(y(t.id));if(!e)return!1;let a=(e.value??e.textContent??"").trim(),o=String(t.v??"").trim();if(!a&&!o)return!0;if(!a&&o)return!1;let i=a.replace(",",".").toLowerCase(),s=o.replace(",",".").toLowerCase();return i===s||i.includes(s)||a.toLowerCase()===o.toLowerCase()}if(t.t==="sel"){let e=v(t.id)||v(y(t.id));if(!e||!(e instanceof HTMLSelectElement))return!1;let a=Array.isArray(t.v)?t.v:[String(t.v)];return Array.from(e.options).some(o=>o.selected&&a.includes(o.value))}if(t.t==="chk"||t.t==="clk"){let e=v(t.id)||v(y(t.id));if(!e)return!1;let a=e.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||e,o=e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type)?e:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null);if(o&&["checkbox","radio"].includes(o.type)){let n=t.t==="chk"?!!t.c:!0;return o.checked===n}let i=a.getAttribute("aria-checked")==="true"||a.getAttribute("aria-selected")==="true",s=/active|selected|checked|picked/i.test(a.className||"");return i||s||t.t==="clk"}if(t.t==="drag"){let e=v(t.from)||v(y(t.from)),a=v(t.to)||v(y(t.to));return!e||!a?!1:a.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function ze(t,e,a=1){let o=t.actions.filter(c=>c.t!=="adv"),i=t.actions.filter(c=>c.t==="adv"),s=0;for(let c of o){try{await Je(c,a),s++}catch(h){console.warn("[EasyQuiz] A\xE7\xE3o declarativa falhou com seguran\xE7a:",c,h)}c.t==="drag"&&await new Promise(h=>setTimeout(h,250))}await new Promise(c=>setTimeout(c,o.length>0?300:50));let n=0;for(let c of o)Ze(c)&&n++;let r=t.pageType==="question",l=!r||o.length===0?!0:s>0&&n>0&&n>=Math.ceil(o.length*.35),d=!1;if((e||a>=2)&&(l||!r)){if(await new Promise(p=>setTimeout(p,o.length>0?500:200)),t.pageType!=="info"){let p=We();p&&E(p)&&(await he(p,1200),q(p),await new Promise(m=>setTimeout(m,800)))}let c=i.length>0?i[0].id:void 0,h=Y(c);if(h){await he(h,1200);let p=c||h.textContent?.trim()||"";p&&ne(window.location.hostname,{advanceSelector:p}),q(h),d=!0}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:s,verified:n,success:l,advanced:d}}var N=null,D=[];function _(){N&&(N.style.removeProperty("outline"),N.style.removeProperty("outline-offset"),N=null);for(let t of D)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");D=[]}function me(t){_(),N=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function He(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let s=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);s&&(s.style.outline="2px solid #00ff88",D.push(s)),n&&(n.style.outline="2px dashed #00e5ff",D.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let i=o.closest('label, [role="listitem"], .answer, .form-check')||o;i.style.outline="2px solid #00ff88",i.style.outlineOffset="2px",i.style.backgroundColor="rgba(0, 255, 136, 0.08)",D.push(i)}}var V=4,et=1200,ge=12e5;function K(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function X(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,et/Math.max(e,a)),i=Math.max(1,Math.round(e*o)),s=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=i,n.height=s;let r=n.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,s),r.drawImage(t,0,0,i,s),new Promise((l,d)=>{n.toBlob(c=>c?l(c):d(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function Ie(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let s=this.element.querySelector("#eq-fah-copy-all-btn");s.addEventListener("click",()=>this.copyMarkdownToClipboard(s));let n=this.element.querySelector("#eq-fah-header");this.setupDraggable(n)}setupDraggable(e){let a=o=>{if(o.target.closest(".eq-fah-btn"))return;o.preventDefault(),this.isDragging=!0,this.dragStartX=o.clientX,this.dragStartY=o.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let s=r=>{if(!this.isDragging||!this.element)return;let l=r.clientX-this.dragStartX,d=r.clientY-this.dragStartY,c=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),p=Math.min(Math.max(10,this.initialLeft+l),c),m=Math.min(Math.max(10,this.initialTop+d),h);this.element.style.left=`${p}px`,this.element.style.top=`${m}px`},n=()=>{this.isDragging=!1,window.removeEventListener("mousemove",s),window.removeEventListener("mouseup",n)};window.addEventListener("mousemove",s),window.addEventListener("mouseup",n)};e.addEventListener("mousedown",a)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),a=this.element.querySelector("#eq-fah-pill-text"),o=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,s=i.actions.filter(c=>c.t==="drag"),n=i.actions.filter(c=>c.t==="val"),r=i.actions.filter(c=>c.t==="clk"||c.t==="chk"),l=s.length||n.length||r.length,d=document.createElement("div");if(d.className="eq-fah-meta",d.innerHTML=`
    ...
    `,e.appendChild(d),s.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){a.textContent=`Categoriza\xE7\xE3o (${s.length} itens)`,o.textContent=String(s.length);let c={};for(let h of s){let p=y(h.to)||"Geral";c[p]||(c[p]=[]),c[p].push(y(h.from))}for(let[h,p]of Object.entries(c)){let m=document.createElement("div"),u=/fato|true|verdadeiro|sim/i.test(h),x=/opini[aã]o|false|falso|n[aã]o/i.test(h);m.className=`eq-fah-group ${u?"group-fato":x?"group-opiniao":""}`;let b=document.createElement("div");b.className="eq-fah-group-title",b.innerHTML=`<span>\u{1F4C1}</span> <span>${h} (${p.length})</span>`,m.appendChild(b);let f=document.createElement("div");f.className="eq-fah-group-items";for(let k of p){let P=document.createElement("div");P.className="eq-fah-item";let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=k,P.appendChild(S);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(k),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),P.appendChild(T),f.appendChild(P)}m.appendChild(f),e.appendChild(m)}}else if(n.length>0){a.textContent=`Preenchimento (${n.length} campos)`,o.textContent=String(n.length);let c=document.createElement("div");c.className="eq-fah-group";let h=document.createElement("div");h.className="eq-fah-group-title",h.textContent="Respostas para Inserir:",c.appendChild(h);let p=document.createElement("div");p.className="eq-fah-group-items";for(let m of n){let u=document.createElement("div");u.className="eq-fah-item";let x=document.createElement("span");x.className="eq-fah-item-text";let b=y(m.id);x.innerHTML=`${b?`<strong>${b}:</strong> `:""}<code style="color:#00ffcc; background:rgba(0,255,204,0.1); padding:1px 4px; border-radius:3px;">${m.v}</code>`,u.appendChild(x);let f=document.createElement("button");f.className="eq-fah-copy-inline",f.textContent="Copiar",f.addEventListener("click",()=>{navigator.clipboard.writeText(String(m.v)),f.textContent="\u2713 Copiado",setTimeout(()=>f.textContent="Copiar",1200)}),u.appendChild(f),p.appendChild(u)}c.appendChild(p),e.appendChild(c)}else if(r.length>0){a.textContent=`Op\xE7\xF5es (${r.length} marcadas)`,o.textContent=String(r.length);let c=document.createElement("div");c.className="eq-fah-group";let h=document.createElement("div");h.className="eq-fah-group-title",h.textContent="Alternativa(s) Correta(s):",c.appendChild(h);let p=document.createElement("div");p.className="eq-fah-group-items";for(let m of r){let u=document.createElement("div");u.className="eq-fah-item";let x=document.createElement("span");x.className="eq-fah-item-text";let b=y(m.id);x.innerHTML=`<span style="color:#00ffcc; font-weight:bold; margin-right:4px;">\u2611</span> ${b}`,u.appendChild(x);let f=document.createElement("button");f.className="eq-fah-copy-inline",f.textContent="Copiar",f.addEventListener("click",()=>{navigator.clipboard.writeText(b),f.textContent="\u2713 Copiado",setTimeout(()=>f.textContent="Copiar",1200)}),u.appendChild(f),p.appendChild(u)}c.appendChild(p),e.appendChild(c)}else a.textContent="Gabarito",o.textContent="0",e.innerHTML+='<div style="padding:10px; color:#888;">Nenhuma resposta direta para exibir.</div>';if(i.rationale){let c=document.createElement("div");c.className="eq-fah-rationale",c.innerHTML=`<strong>\u{1F4A1} Racioc\xEDnio da IA:</strong> ${i.rationale}`,e.appendChild(c)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,a=[];a.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),a.push(`- **Modo:** ${e.mode}`),a.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),a.push("");let o=e.actions.filter(n=>n.t==="drag"),i=e.actions.filter(n=>n.t==="val"),s=e.actions.filter(n=>n.t==="clk"||n.t==="chk");if(o.length>0){a.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let n={};for(let r of o){let l=y(r.to)||"Geral";n[l]||(n[l]=[]),n[l].push(y(r.from))}for(let[r,l]of Object.entries(n)){a.push(`### Categoria: ${r}`);for(let d of l)a.push(`- ${d}`);a.push("")}}else if(i.length>0){a.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let n of i){let r=y(n.id);a.push(`- **${r||"Campo"}:** \`${n.v}\``)}a.push("")}else if(s.length>0){a.push("## \u2705 Alternativas Corretas:");for(let n of s)a.push(`- [x] ${y(n.id)}`);a.push("")}return e.rationale&&(a.push("---"),a.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),a.join(`
...
`;var at=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],ot=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Z=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="autopilot";stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,a){this.initialSettings=e,this.callbacks=a,this.autopilot=new J({onStatusChange:(i,s,n)=>{this.logToConsole(s,n),i==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(i==="advancing"||i==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async i=>{try{return await this.callbacks.onAnalyze(i)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
    ...
    `;let i=this.shadow.querySelector("#eq-rationale-text");i.textContent=e.rationale;let s=this.shadow.querySelector("#eq-actions-list");s.innerHTML="";for(let n of e.actions){let r=document.createElement("div");r.className="eq-action-item";let l="";n.t==="chk"?l=`chk ${n.id} (${n.c})`:n.t==="val"?l=`val "${n.v}" -> ${n.id}`:n.t==="sel"?l=`sel "${Array.isArray(n.v)?n.v.join(","):n.v}" -> ${n.id}`:n.t==="clk"?l=`clk ${n.id}`:n.t==="adv"?l="adv":n.t==="js"?l=`js: ${String(n.v).slice(0,40)}...`:n.t==="drag"&&(l=`drag "${n.from}" -> "${n.to}"`),r.innerHTML=`<span class="eq-action-badge">${n.t.toUpperCase()}</span> <span>${l}</span>`,s.appendChild(r)}if(this.applyBtn.disabled=!a||!e.actions.length,this.inspModel.textContent=e.usedModel||this.initialSettings.model,this.inspLatency.textContent=e.durationMs?`${e.durationMs}ms`:"--",this.inspTokens.textContent=e.tokensUsed?`${e.tokensUsed}`:"--",this.inspPrompt.textContent=e.promptSent||"Prompt n\xE3o registrado para esta requisi\xE7\xE3o.",this.inspRationale.textContent=e.rationale,this.inspActions.innerHTML="",e.actions.length>0)for(let n of e.actions){let r=document.createElement("div");r.className="eq-action-item",r.textContent=JSON.stringify(n),this.inspActions.appendChild(r)}else this.inspActions.innerHTML='<div class="text-muted" style="padding: 4px;">Nenhuma a\xE7\xE3o prescrita pela IA.</div>'}showFloatingAnswers(e){let a=e||this.latestPlan;a&&this.floatingAnswers.show(a)}hideFloatingAnswers(){this.floatingAnswers.hide()}isFloatingAnswersOpen(){return this.floatingAnswers.isOpen()}updateModelSelect(e,a){let o=a||this.initialSettings.model||this.modelSelect.value;this.modelSelect.innerHTML="";let i=!1;e.forEach(s=>{let n=s.id===o;n&&(i=!0),this.modelSelect.add(new Option(s.name,s.id,!1,n))}),!i&&o&&this.modelSelect.add(new Option(`Gemini (${o})`,o,!1,!0)),this.modelSelect.value=o}updateSelectedModel(e){Array.from(this.modelSelect.options).some(o=>o.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}applyHostDarkMode(e){let a="eq-host-dark-mode-style",o=document.getElementById(a);if(e){let i=window.getComputedStyle(document.body).backgroundColor;(i.includes("rgba(0, 0, 0, 0)")||i==="transparent")&&(i=window.getComputedStyle(document.documentElement).backgroundColor);let s=i.match(/\d+(\.\d+)?/g);if(s&&s.length>=3&&(s[3]!==void 0?parseFloat(s[3]):1)>.1){let r=parseInt(s[0]),l=parseInt(s[1]),d=parseInt(s[2]);if((r*299+l*587+d*114)/1e3<100)return}o||(o=document.createElement("style"),o.id=a,o.innerHTML=`
          html { filter: invert(1) hue-rotate(180deg) !important; background: #fff !important; }
          img, video, canvas, [style*="background-image"] { filter: invert(1) hue-rotate(180deg) !important; }
        `,document.head.appendChild(o)),this.host.classList.add("eq-dark-mode-active")}else this.host.classList.remove("eq-dark-mode-active"),o&&o.remove()}destroy(){this.stopStopwatch(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function nt(){let t=window;if(t.__easyquiz){t.__easyquiz.toggle();return}let e=oe(),a=null,o=new Z(e,{onAnalyze:(n=1)=>i(n),onApply:(n=1)=>void s(n),onDestroy:()=>{_(),delete t.__easyquiz},onSettingsChange:n=>{e=ye(n)}});t.__easyquiz={toggle:()=>o.toggle(),destroy:()=>o.destroy(),analyze:async()=>{await i()}},window.addEventListener("keydown",n=>{if(n.altKey&&(n.key==="q"||n.key==="Q")){if(n.preventDefault(),!o)return;o.toggle(!0),i()}});async function i(n=1){if(!e.apiKey){o.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),o.toggle(!0);return}o.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),_(),o.hideFloatingAnswers();try{let r=$(!1);r||(o.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),r=I()),me(r.scope),o.setStatus(`Quest\xE3o localizada (${r.controls.length} controles). Preparando an\xE1lise...`,"info");let l=await fe(r.scope,e.useVision);o.setStatus(l.length>0?`Consultando Gemini (${e.model}) com ${l.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${e.model}) via DOM nativo (modo r\xE1pido)...`,"info");let{plan:d,usedModel:c}=await re(r,l,e,(h,p)=>{o.setStatus(h,p==="warning"?"info":p)});return d.needsMoreContext&&(o.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),r=$(!0),r||(r=I()),me(r.scope),l=await fe(r.scope,e.useVision),o.setStatus(`Reconsultando IA com escopo ampliado (${r.controls.length} controles)...`,"info"),d=(await re(r,l,e,(p,m)=>{o.setStatus(p,m==="warning"?"info":m)})).plan),d.memoryToStore&&(xe(d.memoryToStore),console.log("[EasyQuiz] Mem\xF3ria de sess\xE3o armazenada:",d.memoryToStore)),a=d,He(d.actions),o.setPlan(d,!e.dryRun),d.pageType==="conclusion"?o.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success"):d.pageType==="info"?o.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success"):d.pageType==="start"?o.setStatus("In\xEDcio de atividade detectado. Iniciando...","info"):o.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success"),e.dryRun&&d.pageType==="question"&&o.showFloatingAnswers(d),e.autoApply&&!e.dryRun&&await s(n),d}catch(r){_();let l=r instanceof Error?r.message:"Falha desconhecida na an\xE1lise.";o.setStatus(l,"error");return}finally{o.setBusy(!1)}}async function s(n=1){if(!a){o.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){o.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let r=a.pageType==="info"||a.pageType==="start",l=(e.autoAdvance||r||n>=2)&&a.confidence>=e.confidenceThreshold&&!a.needsMoreContext;o.setBusy(!0,"Aplicando respostas no formul\xE1rio...");try{let d=await ze(a,l,n);d.success?(o.setStatus(`Sucesso: ${d.applied} resposta(s) preenchida(s)${d.advanced?" e pr\xF3xima quest\xE3o acionada":""}.`,"success"),o.hideFloatingAnswers()):(o.setStatus(`Aviso: O formul\xE1rio requer intera\xE7\xE3o manual direta (${d.verified}/${d.applied} validadas). Gabarito Flutuante exibido na tela.`,"info"),o.showFloatingAnswers(a))}catch(d){let c=d instanceof Error?d.message:"Falha ao aplicar plano.";o.setStatus(c,"error"),o.showFloatingAnswers(a)}finally{o.setBusy(!1)}}o.toggle(!0)}nt().catch(t=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",t),window.alert(`EasyQuiz: falha ao iniciar: ${t instanceof Error?t.message:String(t)}`)});})();
