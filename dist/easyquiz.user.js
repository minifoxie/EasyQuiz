 ...
 */
"use strict";(()=>{var Ae=Object.defineProperty;var L=(t,e)=>()=>(t&&(e=t(t=0)),e);var oe=(t,e)=>{for(var a in e)Ae(t,a,{get:e[a],enumerable:!0})};var y,ae=L(()=>{"use strict";y={apiKey:"",model:"gemini-3.8-flash",uiMode:"advanced",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,confidenceThreshold:.8}});var ie={};oe(ie,{addSessionMemory:()=>Te,clearSessionMemories:()=>V,getSessionMemories:()=>F,loadDomainCache:()=>z,loadSettings:()=>H,saveDomainCache:()=>Q,saveSettings:()=>j});function H(){try{let t=localStorage.getItem(ne);if(!t){let a=localStorage.getItem("easyquiz_settings_v1");if(a){let o=JSON.parse(a);return{...y,apiKey:o.apiKey||""}}return{...y}}let e=JSON.parse(t);return{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():y.apiKey,model:typeof e.model=="string"&&e.model?e.model:y.model,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:y.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:y.confidenceThreshold}}catch{return{...y}}}function z(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function Q(t,e){let o={...z(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function j(t){let a={...H(),...t};try{localStorage.setItem(ne,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}function Te(t){let e=t.trim();e&&!I.includes(e)&&I.push(e)}function F(){return I}function V(){I=[]}var ne,I,x=L(()=>{"use strict";ae();ne="easyquiz_settings_v2";I=[]});function f(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function u(t,e=500){return(t??"").replace(/\s+/g," ").trim().slice(0,e)}function ke(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(Ce+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function Y(t){let e=u(t.getAttribute("aria-label")||t.textContent||t.getAttribute("value")||t.value),a=t.type,o=e.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim();return R.test(o)||R.test(e)||a==="submit"||t.getAttribute("data-testid")?.toLowerCase().includes("next")||t.getAttribute("data-testid")?.toLowerCase().includes("check")||!1}function Le(t){let e=t.getAttribute("aria-label");if(e)return u(e);let a=t.getAttribute("aria-labelledby");if(a){let n=a.split(/\s+/).map(i=>document.getElementById(i)?.textContent).filter(Boolean).join(" ");if(n.trim())return u(n)}if("labels"in t&&t.labels){let n=Array.from(t.labels??[]).map(i=>i.textContent).join(" ");if(n.trim())return u(n)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let n=u(o.textContent);if(n)return n}let s=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||t.value||"";return u(s)}function J(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let s=t.tagName.toLowerCase(),n=["input","textarea","select","button"].includes(s)?s:"other",i=t.getAttribute("role")||"",r=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item"),l=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category"),d=u((r?"draggable":l?"dropzone":"")||o.type||i||n,40),v="";o.type==="checkbox"||o.type==="radio"||i==="radio"||i==="checkbox"?v=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked":v=u(o.value||t.getAttribute("data-category")||t.textContent||"",2e3);let m=[];if(a)for(let p of Array.from(a.options).slice(0,80))m.push({value:u(p.value),label:u(p.textContent)});let k=!!(o.required||t.getAttribute("aria-required")==="true"),S=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:ke(t),tag:n,type:d,label:Le(t),name:u(o.name||t.getAttribute("name")||"",180),value:v,options:m,required:k,disabled:S,role:e}}var B,R,Ce,D=L(()=>{"use strict";B=['input:not([type="hidden"])',"textarea","select","button",'[role="button"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),R=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi)/i,Ce=0});var O={};oe(O,{captureCurrentContext:()=>E,captureFullPageText:()=>Ie,extractAnswerControls:()=>he,extractNavigationControls:()=>P,findActiveScope:()=>pe,sanitizeHtml:()=>X});function ue(t){if(!f(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(B)).filter(f),o=u(t.innerText,4e3).length;if(!a.length||o<10)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),i=Math.min(1,n/s),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),c=Math.min(60,a.length*15e3/n),d=e.top>=0&&e.bottom<=window.innerHeight?30:0;return a.length*20+Math.min(50,o/25)+c+d-i*60-l*15}function pe(){let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(de);if(s&&ue(s)>0)return s}let a=Array.from(document.querySelectorAll(de)).map(s=>({element:s,score:ue(s)})).filter(s=>Number.isFinite(s.score)).sort((s,n)=>n.score-s.score);if(a.length>0&&a[0].score>0)return a[0].element;let o=document.querySelector('form, main, [role="main"]');return o&&f(o)?o:document.body}function X(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))a.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function he(t){return Array.from(t.querySelectorAll(B)).filter(e=>f(e)&&!Y(e)).slice(0,100).map(e=>J(e,"answer"))}function P(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let s of e)for(let n of Array.from(s.querySelectorAll(B)))if(!(a.has(n)||!f(n)||!Y(n))&&(a.add(n),o.push(J(n,"navigation")),o.length>=10))return o;return o}function E(t=!1){let e=pe();t&&e.parentElement&&e.parentElement!==document.body&&(e=e.parentElement);let a=u(e.innerText,16e3),o=he(e),s=P(e);s.length===0&&(s=P(document.body));let n=[...o,...s].slice(0,120);return!a||n.length===0&&a.length<30?null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:X(e),controls:n,scope:e}}function Ie(){let t=document.body.innerText||document.documentElement.innerText,e=u(t,8e3),a=P(document.body),o=document.querySelector('main, article, [role="main"]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina Inteira",questionText:e,htmlSnippet:X(o).slice(0,1e4),controls:a,scope:o}}var de,w=L(()=>{"use strict";D();de=[".Qr7Oae",".geSAlb",'[role="listitem"]',".que",".form-group",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question" i]','[class*="pergunta" i]','[id*="question" i]','[id*="pergunta" i]',"fieldset","form","article","section",'[role="group"]','[role="region"]','[role="dialog"]',"main"].join(",")});x();var se=`Voc\xEA \xE9 o EasyQuiz Engine v4.5. Retorne JSON estrito.
Regras Absolutas:
1. "pageType": 
...
5. Se a quest\xE3o for de categorizar ou associar itens a caixas/categorias:
   ...
   - Sempre inclua { "t": "adv" } ao final para confirmar.`;function re(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),n=t.questionText.length<120||o||t.controls.length<3?`
[HTML FRAGMENT (Estrutura DOM/Widgets)]:
${t.htmlSnippet.slice(0,5e3)}`:`
[HTML FRAGMENT]: Omitido (Texto e controles s\xE3o suficientes).`,i=F(),r="";return i.length>0&&(r=`
...
Responda estritamente em JSON.`}var U=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Recomendado)",description:"Ultrapoderoso, hiper-r\xE1pido modelo 2026 para agents."},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash",description:"Alta velocidade para tarefas simples e fallback."},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",description:"Velocidade e estabilidade."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro",description:"Racioc\xEDnio longo de elite."}],qe={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function Me(t){return t.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-3.8-flash"}function le(t,e){try{let a=JSON.parse(t),o=a.error?.message||a.message||"";if(/API_KEY_INVALID|API key not valid/i.test(o))return"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada. Verifique no Google AI Studio.";if(/RESOURCE_EXHAUSTED|Quota exceeded/i.test(o))return"Limite de cota do Gemini atingido temporariamente. Aguarde alguns segundos.";if(o)return`Erro Gemini (${e}): ${o}`}catch{}return`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}). Verifique sua conex\xE3o e chave.`}async function ce(t){let e=t.trim();if(!e)return{ok:!1,message:"Insira sua chave de API."};let a=`https://generativelanguage.googleapis.com/v1beta/models/gemini-3.8-flash:generateContent?key=${encodeURIComponent(e)}`;try{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})});if(!o.ok){let s=await o.text();return{ok:!1,message:le(s,o.status)}}return{ok:!0,message:"Chave de API validada com sucesso no Gemini 3.8 Flash!"}}catch(o){return{ok:!1,message:o instanceof Error?`Erro de conex\xE3o: ${o.message}`:"Erro desconhecido ao testar chave."}}}async function K(t,e,a){let o=a.apiKey.trim();if(!o)throw new Error("Chave de API n\xE3o configurada.");let s=Me(a.model),i=[{text:re(t,e,a)}];for(let d of e)i.push({inline_data:{mime_type:d.mediaType,data:d.base64}});let r={system_instruction:{parts:[{text:se}]},contents:[{role:"user",parts:i}],generationConfig:{temperature:.05,maxOutputTokens:400,response_mime_type:"application/json",response_schema:qe}},l=a.uiMode==="easy"?U.map(d=>d.id):[s];a.uiMode==="easy"&&!l.includes(s)&&l.unshift(s);let c=new Error("Nenhum modelo tentado.");for(let d of new Set(l)){let v=`https://generativelanguage.googleapis.com/v1beta/models/${d}:generateContent?key=${encodeURIComponent(o)}`;try{let m=await fetch(v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!m.ok){let we=await m.text(),Se=le(we,m.status);throw new Error(Se)}let k=await m.json(),S=k.candidates?.[0];if(!S||!S.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let p;try{p=JSON.parse(S.content.parts[0].text)}catch{throw new Error("Falha ao decodificar o plano JSON da IA.")}return Array.isArray(p.actions)||(p.actions=[]),Array.isArray(p.warnings)||(p.warnings=[]),typeof p.confidence!="number"&&(p.confidence=.8),p.usedModel=d,{plan:p,rawUsage:k.usageMetadata,usedModel:d}}catch(m){if(c=m,a.uiMode!=="easy"||c.message.includes("inv\xE1lida"))throw c;console.warn(`[EasyQuiz] Fallback: Falha no modelo ${d}. Tentando pr\xF3ximo...`,m)}}throw c}x();w();x();D();function h(t){if(!t)return null;let e=t.trim(),a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o)return o;try{if(o=document.querySelector(e),o)return o}catch{}if(o=document.querySelector(`#${a}, [name="${a}"]`),o)return o;try{let i=`//*[text()="${e}"] | //*[contains(text(),"${e}")] | //*[@aria-label="${e}"] | //*[@data-category="${e}"] | //*[@data-testid="${e}"]`,r=document.evaluate(i,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(r.singleNodeValue)return r.singleNodeValue}catch{}let s=e.toLowerCase(),n=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"]'));for(let i of n){let r=(i.textContent||"").trim().toLowerCase(),l=(i.getAttribute("aria-label")||"").trim().toLowerCase(),c=(i.getAttribute("data-category")||"").trim().toLowerCase(),d=(i.getAttribute("data-testid")||"").trim().toLowerCase();if(r===s||l===s||c===s||d===s)return i}return null}function A(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function g(t,e){let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let n=t.getBoundingClientRect();a=n.left+n.width/2,o=n.top+n.height/2}let s={bubbles:!0,cancelable:!0,composed:!0,clientX:a,clientY:o};t.dispatchEvent(new PointerEvent("pointerdown",s)),t.dispatchEvent(new MouseEvent("mousedown",s)),t.dispatchEvent(new PointerEvent("pointerup",s)),t.dispatchEvent(new MouseEvent("mouseup",s)),t.click()}function me(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,A(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,A(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function fe(t,e){if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){t.checked!==e&&t.click(),t.checked!==e&&(Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(t,e),A(t,["input","change"]));return}let a=t.getAttribute("role");if(a==="radio"||a==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(g(t),t.setAttribute("aria-checked",e?"true":"false"),A(t,["input","change"]));return}g(t)}function He(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);A(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function ze(){let t={};return{dropEffect:"move",effectAllowed:"all",files:[],items:[],types:["text/plain"],clearData:e=>{e?delete t[e]:Object.keys(t).forEach(a=>delete t[a])},getData:e=>t[e]||"",setData:(e,a)=>{t[e]=a},setDragImage:()=>{}}}function W(t,e){let a=ze(),o=t.getBoundingClientRect(),s=e.getBoundingClientRect(),n={clientX:o.left+o.width/2,clientY:o.top+o.height/2,bubbles:!0,cancelable:!0},i={clientX:s.left+s.width/2,clientY:s.top+s.height/2,bubbles:!0,cancelable:!0};t.dispatchEvent(new PointerEvent("pointerdown",n)),t.dispatchEvent(new MouseEvent("mousedown",n)),t.dispatchEvent(new DragEvent("dragstart",{...n,dataTransfer:a})),e.dispatchEvent(new DragEvent("dragenter",{...i,dataTransfer:a})),e.dispatchEvent(new DragEvent("dragover",{...i,dataTransfer:a})),e.dispatchEvent(new DragEvent("drop",{...i,dataTransfer:a})),t.dispatchEvent(new DragEvent("dragend",{...n,dataTransfer:a})),e.dispatchEvent(new PointerEvent("pointerup",i)),e.dispatchEvent(new MouseEvent("mouseup",i))}var ye={fill:(t,e)=>{let a=h(t);a?me(a,e):console.warn(`$eq.fill: Elemento ${t} n\xE3o encontrado`)},click:t=>{let e=h(t);e?g(e):console.warn(`$eq.click: Elemento ${t} n\xE3o encontrado`)},check:(t,e)=>{let a=h(t);a?fe(a,e):console.warn(`$eq.check: Elemento ${t} n\xE3o encontrado`)},drag:(t,e)=>{let a=h(t),o=h(e);a&&o?W(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado (${t} -> ${e})`)},categorize:(t,e)=>{let a=h(t),o=h(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados (${t} -> ${e})`);return}W(a,o),g(a),setTimeout(()=>{g(o)},150)}};window.$eq=ye;function ge(t){if(t.t==="js"){let o=String(t.v||"");try{new Function("$eq","document","window",o)(ye,document,window)}catch(s){console.warn("[EasyQuiz JS Execution]",s)}return}if(t.t==="drag"){let o=h(t.from),s=h(t.to);o&&s?(W(o,s),g(o),setTimeout(()=>g(s),150)):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado (${t.from} -> ${t.to})`);return}let e=t.id||"",a=h(e);if(!a&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${e}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":a&&me(a,String(t.v));break;case"chk":a&&fe(a,!!t.c);break;case"sel":if(a){let s=Array.isArray(t.v)?t.v:[String(t.v)];He(a,s)}break;case"clk":a&&g(a,t.co);break;case"adv":let o=a;if(!o){let s=Array.from(document.querySelectorAll('button, a, input[type="submit"]')).filter(n=>R.test(n.textContent||n.value||""));s.length&&(o=s[0])}if(o){let s=t.id||o.textContent?.trim()||o.value?.trim()||"";s&&Q(window.location.hostname,{advanceSelector:s}),g(o)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}async function be(t,e){let a=t.actions.filter(n=>n.t!=="adv"),o=t.actions.filter(n=>n.t==="adv");for(let n of a)ge(n);let s=!1;if(e){let n=Array.from(document.querySelectorAll('button, [role="button"], input[type="submit"]')).find(i=>/(verificar|checar|check|conferir)/i.test(i.textContent||i.value||""));if(n&&isVisible(n)&&(g(n),await new Promise(i=>setTimeout(i,800))),o.length>0)await new Promise(i=>setTimeout(i,600)),ge(o[0]),s=!0;else if(n){await new Promise(r=>setTimeout(r,600));let i=Array.from(document.querySelectorAll('button, [role="button"], a, input[type="submit"]')).find(r=>/(próxim[oa]|next|continuar|avançar|mostrar resumo)/i.test(r.textContent||r.value||""));i&&isVisible(i)&&(g(i),s=!0)}}return{applied:a.length,advanced:s}}var T=null,q=[];function M(){T&&(T.style.removeProperty("outline"),T.style.removeProperty("outline-offset"),T=null);for(let t of q)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");q=[]}function Z(t){M(),T=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function ve(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),i=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);n&&(n.style.outline="2px solid #00ff88",q.push(n)),i&&(i.style.outline="2px dashed #00e5ff",q.push(i))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let s=o.closest('label, [role="listitem"], .answer, .form-check')||o;s.style.outline="2px solid #00ff88",s.style.outlineOffset="2px",s.style.backgroundColor="rgba(0, 255, 136, 0.08)",q.push(s)}}D();var C=4,Re=1200,ee=12e5;function _(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");e(s.split(",")[1]||"")},o.readAsDataURL(t)})}async function $(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Re/Math.max(e,a)),s=Math.max(1,Math.round(e*o)),n=Math.max(1,Math.round(a*o)),i=document.createElement("canvas");i.width=s,i.height=n;let r=i.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,s,n),r.drawImage(t,0,0,s,n),new Promise((l,c)=>{i.toBlob(d=>d?l(d):c(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function xe(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,s=`
...
`;var De=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Pe=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],G=class{host;shadow;callbacks;autopilot;initialSettings;launcherBtn;panelEl;statusBox;resultContainer;apiKeyInput;testKeyBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;analyzeBtn;applyBtn;tabEasyBtn;tabAdvBtn;contentEasy;contentAdv;apToggleBtn;apConsole;constructor(e,a){this.initialSettings=e,this.callbacks=a,this.autopilot=new N({onStatusChange:(o,s,n)=>{if(this.apConsole){let i=document.createElement("div");i.textContent=s,n&&i.classList.add(n),this.apConsole.appendChild(i),this.apConsole.scrollTop=this.apConsole.scrollHeight}o==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(o==="advancing"||o==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async()=>{try{return await this.callbacks.onAnalyze()||null}catch{return null}}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
      <style>${Ee}</style>
    ...
    `;let s=this.shadow.querySelector("#eq-rationale-text");s.textContent=e.rationale;let n=this.shadow.querySelector("#eq-actions-list");n.innerHTML="";for(let i of e.actions){let r=document.createElement("div");r.className="eq-action-item";let l="";i.t==="chk"?l=`[CHK] ${i.id}`:i.t==="val"?l=`[INJ] "${i.v}" em ${i.id}`:i.t==="sel"?l=`[SEL] ${Array.isArray(i.v)?i.v.join(","):i.v} em ${i.id}`:i.t==="clk"?l=`[CLK] ${i.id}`:i.t==="adv"?l="[AVAN\xC7AR]":i.t==="js"&&(l=`[JS] ${String(i.v)}`),r.innerHTML=`<span class="eq-action-bullet">\u25A0</span> <span>${l}</span>`,n.appendChild(r)}this.applyBtn.disabled=!a||!e.actions.length}destroy(){this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function Oe(){let t=window;if(t.__easyquiz){t.__easyquiz.toggle();return}let e=H(),a=null,o=new G(e,{onAnalyze:()=>s(),onApply:()=>void n(),onDestroy:()=>{M(),delete t.__easyquiz},onSettingsChange:i=>{e=j(i)}});t.__easyquiz={toggle:()=>o.toggle(),destroy:()=>o.destroy(),analyze:()=>void s()},window.addEventListener("keydown",i=>{if(i.altKey&&(i.key==="q"||i.key==="Q")){if(i.preventDefault(),!o)return;o.toggle(!0),s()}});async function s(){if(!e.apiKey){o.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),o.toggle(!0);return}o.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),M();try{let i=E(!1);if(!i){o.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info");let{captureFullPageText:c}=await Promise.resolve().then(()=>(w(),O));i=c()}Z(i.scope),o.setStatus(`Quest\xE3o localizada (${i.controls.length} controles). Otimizando imagens...`,"info");let r=await te(i.scope);o.setStatus(`Consultando Gemini (${e.model}) com ${r.length} imagem(ns) anexada(s)...`,"info");let{plan:l}=await K(i,r,e);if(l.needsMoreContext){if(o.setStatus("Expandindo contexto ao redor da quest\xE3o para maior assertividade...","info"),i=E(!0),!i){let{captureFullPageText:d}=await Promise.resolve().then(()=>(w(),O));i=d()}Z(i.scope),r=await te(i.scope),l=(await K(i,r,e)).plan}if(l.memoryToStore){let{addSessionMemory:c}=await Promise.resolve().then(()=>(x(),ie));c(l.memoryToStore),console.log("[EasyQuiz] Mem\xF3ria de sess\xE3o armazenada:",l.memoryToStore)}return a=l,ve(l.actions),o.setPlan(l,!e.dryRun),l.pageType==="conclusion"?o.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success"):o.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success"),e.autoApply&&!e.dryRun&&await n(),l}catch(i){M();let r=i instanceof Error?i.message:"Falha desconhecida na an\xE1lise.";o.setStatus(r,"error");return}finally{o.setBusy(!1)}}async function n(){if(!a){o.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){o.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let i=e.autoAdvance&&a.confidence>=e.confidenceThreshold&&!a.needsMoreContext;o.setBusy(!0,"Aplicando respostas no formul\xE1rio...");try{let r=await be(a,i);o.setStatus(`Sucesso: ${r.applied} resposta(s) preenchida(s)${r.advanced?" e pr\xF3xima quest\xE3o acionada":""}.`,"success")}catch(r){let l=r instanceof Error?r.message:"Falha ao aplicar plano.";o.setStatus(l,"error")}finally{o.setBusy(!1)}}o.toggle(!0)}Oe().catch(t=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",t),window.alert(`EasyQuiz: falha ao iniciar: ${t instanceof Error?t.message:String(t)}`)});})();
