 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8};function Q(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var We="easyquiz_settings_v2",be="easyquiz_activity_metrics";function Je(){try{let o=localStorage.getItem(We);if(!o){let s=localStorage.getItem("easyquiz_settings_v1");if(s){let i=JSON.parse(s);return{...ie,apiKey:i.apiKey||""}}return{...ie}}let e=JSON.parse(o),t=typeof e.model=="string"&&Q(e.model)?e.model:ie.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(s=>typeof s=="string"?s.trim().replace(/^["']|["']$/g,""):"").filter(s=>s.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&r&&(a=[r]),{apiKey:a[0]||r||ie.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:ie.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function Et(){try{localStorage.removeItem(We),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(be),sessionStorage.removeItem(be);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ze()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function Ye(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Xe(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...Ye(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function qt(o){let e=Je(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(We,JSON.stringify(r))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var fe=[],wt=12,Xt=1200;function Ct(o){let e=o.trim().replace(/\s+/g," ").slice(0,Xt);e&&!fe.includes(e)&&(fe.push(e),fe.length>wt&&(fe=fe.slice(-wt)))}function Pe(){return fe}function Ze(){fe=[]}function Tt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var qe=Tt();function Ce(){try{localStorage.removeItem(be)}catch{}return qe}function Zt(o){qe=o;try{let e=JSON.stringify(o);sessionStorage.setItem(be,e),localStorage.removeItem(be)}catch{}}function At(o){let e=qe,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],s=n.filter(u=>u.status==="answered"||u.status==="verified").length,i=n.reduce((u,b)=>u+b.durationMs,0),d=s>0?Math.round(i/s):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),i),completedQuestionsCount:s,averageDurationMs:d,records:n};return Zt(l),l}function Te(){qe=Tt();try{sessionStorage.removeItem(be),localStorage.removeItem(be)}catch{}return qe}var St=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Ae(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(g=>g.type==="draggable"||g.type==="dropzone"),r=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),s=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(g=>g.role==="answer").length===0),i=o.controls.filter(g=>g.role!=="navigation").length===0,d=i||a||n||s||r&&o.questionText.length<60,l=i?4500:s?6e3:1800,u=d?`
[HTML]:
${o.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",b="";if(i&&typeof document<"u")try{let g=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(y=>{let x=y,C=x.getBoundingClientRect?.()||{width:0,height:0};return C.width>0&&C.height>0&&!x.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(y=>{let x=y,C=x.tagName.toLowerCase(),T=x.id?`#${x.id}`:"",M=x.className&&typeof x.className=="string"?`.${x.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",A=(x.textContent||x.value||x.getAttribute("aria-label")||"").trim().slice(0,60),w=x.getAttribute("type")||x.getAttribute("role")||"";return`${C}${T}${M}[${w}] txt="${A}"`});g.length>0&&(b=`
[DOM-INTERATIVO]:
${g.join(`
`)}`)}catch{}let c=Pe(),m=c.length>0?`
[MEM\xD3RIA]:
${c.join(" | ")}
`:"",p=o.controls.filter(g=>g.role!=="navigation"),f=o.controls.filter(g=>g.role==="navigation"),v=eo(o.sourceUrl,o.htmlSnippet),h=v?`
${v}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let g=p.filter(q=>q.type==="checkbox"||q.type==="chk"),y=new Set(p.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),x=g.filter(q=>!q.name||!y.has(q.name)),C=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),T=x.length>=2||C,M=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&y.size>=1,A=p.every(q=>q.type==="radio"||q.type==="chk")&&y.size===1&&!T&&!M,w=p.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),L=w.length>=2;return(M?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
...
`:"")+JSON.stringify(p.map(q=>({id:q.id,t:q.type,n:q.name||void 0,txt:q.label?q.label.length>160?q.label.slice(0,160)+"...":q.label:void 0,v:q.value||void 0,opt:q.options&&q.options.length?q.options.slice(0,20).map(H=>H.label||H.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${f.length>0?f.map(g=>`"${g.label||g.id}"[${g.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length===0?"Nenhum anexo visual.":e.map((g,y)=>{let x=g.associatedLabel||"Gr\xE1fico da Quest\xE3o",C=g.alt?` | alt: "${g.alt}"`:"";if(g.captureStatus==="text_only")return`  - Imagem ${y+1} [CONTEXTO_TEXTUAL]: ${x}${C} | ${g.textContext||"sem contexto adicional"}`;if(g.captureStatus==="captured"||g.base64){let T=g.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${g.textContext}"`:"";return`  - Imagem ${y+1} [VISUAL_INLINE]: ${x}${C}${T}`}return`  - Imagem ${y+1} [FALHOU]: ${x}${C}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var to=new Set(["question","info","start","conclusion"]),oo=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),ao=new Set(["val","chk","sel","clk","adv","js","drag"]),no=150,Se=2e3;function W(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Se):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Se):e}function io(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!ao.has(a))return null;if(a==="adv"){let i=t.id??t.target??t.name??t.selector;return{t:"adv",...W(i)?{id:W(i,"").slice(0,500)}:{}}}if(a==="drag"){let i=W(t.from??t.source),d=W(t.to??t.target??t.destination);return!i||!d?null:{t:"drag",from:i.slice(0,500),to:d.slice(0,500)}}if(a==="js"){let i=W(t.v??t.code??t.script);return!i||i.length>8e3?null:{t:"js",v:i}}let r=t.id??t.target??t.name??t.selector??t.element;(r==null||r==="")&&a==="val"&&(r="1");let n=W(r).slice(0,500);if(!n)return null;if(a==="val"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:W(i).slice(0,Se)}}if(a==="sel"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(i)?i:[i]).map(u=>W(u).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:l}}if(a==="chk"){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",d={t:"chk",id:n,c:!i};return t.v!==void 0&&(d.v=W(t.v).slice(0,Se)),d}let s={t:"clk",id:n};if(t.c!==void 0){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";s.c=!i}return t.v!==void 0&&(s.v=W(t.v).slice(0,Se)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(i=>typeof i=="number"&&Number.isFinite(i))&&(s.co=[t.co[0],t.co[1]]),s}function so(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),r=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){r=r.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let n=r.filter(s=>s.t==="chk"||s.t==="clk");if(n.length>1){let s=r.filter(d=>d.t!=="chk"&&d.t!=="clk"),i=n[n.length-1];r=[...s,i]}}else if(e==="escolha_multipla"){r=r.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let n=new Set;r=r.filter(s=>{let i="id"in s&&typeof s.id=="string"?s.id:"";return i?n.has(i)?!1:(n.add(i),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,s=[...r].reverse(),i=[];for(let d of s){let l="id"in d&&typeof d.id=="string"?d.id:"";l?n.has(l)||(n.add(l),i.push(d)):i.push(d)}r=i.reverse()}return[...r,...a]}function Lt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!to.has(t))&&(t="question"),(typeof a!="string"||!oo.has(a))&&(a="escolha_unica");let r=Array.isArray(e.actions)?e.actions:[],n=[];for(let d=0;d<Math.min(r.length,no);d++){let l=io(r[d],d);l&&n.push(l)}n.some(d=>d.t==="val")&&(a==="escolha_unica"||!e.mode)&&(a="preenchimento"),n.some(d=>d.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(a)&&(a="arrastar_soltar"),n=so(n,a,t);let s=n.some(d=>d.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?s||n.push({t:"adv"}):t==="question"&&!s&&n.push({t:"adv"});let i=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:i,rationale:W(e.rationale,"Plano validado e auto-recuperado."),actions:n,...W(e.memoryToStore)?{memoryToStore:W(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var X=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let a=e.flatMap(n=>n.split(/[\n\r]+/));Array.from(new Set(a.map(n=>n.trim().replace(/^["']|["']$/g,"")).filter(n=>n.length>5))).forEach((n,s)=>{let i=this.generateId(n),d=t.get(i)||t.get(n);this.keys.set(i,{id:i,key:n,label:d?.label||`Chave ${s+1}`,addedAt:d?.addedAt||Date.now(),lastUsedAt:d?.lastUsedAt,lastLatencyMs:d?.lastLatencyMs,cooldownUntil:d?.cooldownUntil,errorCount:d?.errorCount||0,lastError:d?.lastError,winCount:d?.winCount||0})})}generateId(e){let t=0;for(let r=0;r<e.length;r++)t=(t<<5)-t+e.charCodeAt(r),t|=0;let a=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${a}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),a=Array.from(this.keys.values()).filter(n=>(n.errorCount||0)<50);if(a.length===0)return Array.from(this.keys.values()).slice(0,e);let r=a.filter(n=>(n.cooldownUntil||0)<=t);return r.length>0?(r.sort((n,s)=>{let i=n.lastLatencyMs!==void 0?n.lastLatencyMs:99999,d=s.lastLatencyMs!==void 0?s.lastLatencyMs:99999;if(i!==d)return i-d;let l=(n.lastUsedAt||0)-(s.lastUsedAt||0);return l!==0?l:n.addedAt-s.addedAt}),r.slice(0,e)):(a.sort((n,s)=>(n.cooldownUntil||0)-(s.cooldownUntil||0)),a.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let r=this.generateId(a);if(this.keys.has(r)||Array.from(this.keys.values()).some(i=>i.key===a))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let s={id:r,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(r,s),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:s}}updateKey(e,t,a){let r=this.keys.get(e);if(!r)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(r.key=n,a!==void 0&&(r.label=a.trim()),r.errorCount=0,r.cooldownUntil=void 0,r.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},P=new X;var we=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],kt=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],ro={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function ot(o){return ro[o]??o}function lo(o,e){let a={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??co};return/lite/i.test(o)||(/gemini-3\.[0-9]+-?flash/i.test(o)?a.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(o)&&(a.thinkingConfig={thinkingBudget:0})),a}var co={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function It(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=ot(e);return Q(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function tt(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function uo(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}try{let r=e.indexOf("{");if(r!==-1){let n=e.slice(r).trim();n=n.replace(/,\s*\{[^}]*$/,""),n=n.replace(/,\s*$/,"");let s=0,i=0,d=!1,l=!1;for(let b=0;b<n.length;b++){let c=n[b];if(l){l=!1;continue}if(c==="\\"){l=!0;continue}if(c==='"'){d=!d;continue}d||(c==="{"?s++:c==="}"?s=Math.max(0,s-1):c==="["?i++:c==="]"&&(i=Math.max(0,i-1)))}for(d&&(n+='"');i>0;)n+="]",i--;for(;s>0;)n+="}",s--;let u=JSON.parse(n);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Ht=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&Q(a.id));return t.length>0?t:null}return null}catch{return null}})(),et=new Set;async function Re(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return we;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let r=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!r.ok){let s=await r.text(),i=tt(s,r.status);if(i.includes("inv\xE1lida")||i.includes("n\xE3o autorizada"))throw new Error(i);continue}let n=await r.json();if(Array.isArray(n.models)&&n.models.length>0){let s=n.models.filter(i=>{let d=i.supportedGenerationMethods||[],l=(i.name||"").replace(/^models\//,""),u=d.includes("generateContent");return Q(l)&&u}).map(i=>{let d=i.supportedGenerationMethods||[],l=i.name.replace(/^models\//,""),u=i.displayName||l;return{id:l,name:u.includes(l)?u:`${u} (${l})`,description:i.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:d.includes("generateContent"),supportedGenerationMethods:d,discoveredAt:Date.now()}});if(s.length>0){s.sort((i,d)=>{let l=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return l(d.id)-l(i.id)}),Ht=s;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(s))}catch{}return s}}}catch(r){if(r.message?.includes("Chave de API"))throw r}return we}async function Oe(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await Re(e);if(a.length>0&&a!==we){let r=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${r.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let r of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${r}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${r})!`,models:we}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function at(o,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=ot(It(o)),r=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function s(l,u,b){let c=new AbortController,m=setTimeout(()=>c.abort(),b);try{let p=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(l)}`,f=await fetch(p,{method:"POST",headers:{...n,"x-goog-api-key":l},body:r,signal:c.signal});if(clearTimeout(m),f.ok)return{ok:!0,model:u,key:l,message:`Modelo '${u}' validado com sucesso!`};let v=await f.text().catch(()=>"");throw new Error(`HTTP ${f.status}: ${v.slice(0,80)}`)}catch(p){throw clearTimeout(m),p}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(b=>s(b,a,8e3)))}catch{}}let i=t[0],d=[a,...kt.filter(l=>l!==a)];for(let l of d)try{let u=await s(i,l,4e3);return l!==a&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),u}catch{}return{ok:!1,model:a,key:i,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function po(o,e,t,a,r){let n=["v1beta","v1"],s=new Error(`Falha ao consultar modelo ${o}`),d={...lo(o,r)};for(let l of n){if(a.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${l}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,b=Date.now();try{let c=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:d}),signal:a});if(!c.ok){let f=await c.text();if(c.status===400){let h=/thinking/i.test(f),g=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(f);if((h||g)&&(d.thinkingConfig||d.responseSchema)){let y={...d};h&&delete y.thinkingConfig,g&&(delete y.responseSchema,delete y.responseMimeType),d=y;let x=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:d}),signal:a});if(x.ok){let M=await x.json(),A=M.candidates?.[0];if(A?.content?.parts?.[0]?.text)return P.markSuccess(e,Date.now()-b),{rawText:A.content.parts[0].text,data:M,usedModel:o,usedKey:e}}let C=await x?.text?.().catch(()=>"")??f,T=tt(C,c.status);throw new Error(`[${o}|${X.maskKey(e)}] ${T}`)}}let v=tt(f,c.status);if(c.status===404&&l==="v1beta")continue;throw c.status===429?(P.markQuotaHit(e,8e3),$t(e,o,1e4),new Error(`[${o}|${X.maskKey(e)}] ${v}`)):(c.status===503||/no capacity|overloaded|unavailable/i.test(f)?(P.markOverloaded(e,5e3),et.add(o)):c.status===403||/API_KEY_INVALID/i.test(f)?P.markInvalid(e,v):c.status===404&&et.add(o),new Error(`[${o}|${X.maskKey(e)}] ${v}`))}let m=await c.json(),p=m.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error(`[${o}|${X.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return P.markSuccess(e,Date.now()-b),{rawText:p.content.parts[0].text,data:m,usedModel:o,usedKey:e}}catch(c){if(a.aborted)throw c;s=c;let m=s.message||"";if(m.includes("404")||/no longer available/i.test(m)){et.add(o);break}if(m.includes("429")||m.includes("Quota"))break}}throw s}var ze=new Map;function Mt(o,e){let t=`${o}::${e}`,a=ze.get(t);return a===void 0?!1:Date.now()>a?(ze.delete(t),!1):!0}function $t(o,e,t=1e4){ze.set(`${o}::${e}`,Date.now()+t)}function Pt(){ze.clear()}async function Ne(o,e,t,a,r,n){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let s=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];P.init(s);let i=t.apiKey.trim().replace(/^["']|["']$/g,""),d=P.getBestKey()||i;if(!d)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=It(t.model);if(!Ht&&d&&Re(d).catch(()=>{}),r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),b=Ae(o,e,t),c=[{text:b}];for(let S=0;S<e.length;S++){let q=e[S],H=q.associatedLabel||(q.alt?`Imagem: ${q.alt}`:`Imagem ${S+1}`);if(q.captureStatus==="text_only"||!q.base64){let z=q.textContext||q.alt||"";c.push({text:`[CONTEXTO_IMAGEM_${S+1} - V\xCDNCULO: ${H}]: ${z}`})}else c.push({text:`[ANEXO VISUAL ${S+1} - V\xCDNCULO: ${H}]:`}),c.push({inline_data:{mime_type:q.mediaType,data:q.base64}})}let m={system_instruction:{parts:[{text:n?.systemPromptOverride??St}]},contents:[{role:"user",parts:c}]},p=ot(l),f=kt.filter(S=>S!==p),h=P.getAllKeys().length,g=S=>h<=1||S===0?1:2,y=new Set,x=(S,q)=>{let H=/pro/i.test(S),z=/lite/i.test(S);return H?q===0?18e3:q===1?24e3:3e4:z?q===0?1e4:q===1?14e3:18e3:q===0?16e3:q===1?2e4:25e3},C=async(S,q)=>{if(q.length===0||r?.aborted)return null;let H=q.map(()=>new AbortController),z=()=>H.forEach(O=>{try{O.abort()}catch{}});r?.addEventListener("abort",z,{once:!0});let _=q.map(O=>`${O.model.replace("gemini-","")}/${O.label}`).join(" | ");a?.(`\u26A1 ${S}: ${q.length} slot(s) [${_}]...`,"info");try{let O=q.map(async(K,te)=>{let F=H[te],ge=setTimeout(()=>{try{F.abort(new Error(`Timeout ${K.timeout/1e3}s (${K.model}|${K.label})`))}catch{F.abort()}},K.timeout);try{let j=await po(K.model,K.key,m,F.signal,n?.generationSchemaOverride);clearTimeout(ge);let Y=Lt(uo(j.rawText));return Y.usedModel=j.usedModel,Y.durationMs=Date.now()-u,Y.promptSent=b,Y.tokensUsed=j.data.usageMetadata?.totalTokenCount,Y.promptTokens=j.data.usageMetadata?.promptTokenCount,Y.candidatesTokens=j.data.usageMetadata?.candidatesTokenCount,Y.rawResponse=j.rawText,H.forEach((xt,Yt)=>{if(Yt!==te)try{xt.abort(new Error("Cancelado: vencedor respondeu."))}catch{xt.abort()}}),{plan:Y,rawUsage:j.data.usageMetadata,usedModel:j.usedModel,usedKey:j.usedKey,slotLabel:K.label}}catch(j){clearTimeout(ge);let Y=j instanceof Error?j.message:String(j);throw(Y.includes("429")||Y.includes("Quota")||Y.includes("RESOURCE_EXHAUSTED"))&&($t(K.key,K.model,1e4),P.markQuotaHit(K.key,8e3)),j}}),V=await Promise.any(O);return r?.removeEventListener("abort",z),P.markWinner(V.usedKey),V}catch(O){return r?.removeEventListener("abort",z),O instanceof AggregateError&&O.errors.length>0?w=O.errors.map(V=>V instanceof Error?V.message:String(V)).join(" | "):O instanceof Error&&(w=O.message),console.warn(`[EasyQuiz ${S}] Falha na onda:`,w),null}},M=(h<=1?1:1+Math.ceil((h-1)/2))+4,A=0,w="",L=0;for(;A<M;){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let S=P.getRoundRobinKeys(h),q=S.filter(F=>!y.has(`${F.key}::${p}`)&&!Mt(F.key,p)),H,z;if(q.length>0)H=p,z=q;else{let F=f;H=F[L%F.length]||p,L++;let ge=S.filter(j=>!y.has(`${j.key}::${H}`)&&!Mt(j.key,H));z=ge.length>0?ge:S.filter(j=>!y.has(`${j.key}::${H}`))}if(z.length===0){if(L<f.length)continue;break}let _=z.slice(0,g(A));if(_.length===0)break;let O=x(H,A),V=_.map(F=>(y.add(`${F.key}::${H}`),{model:H,key:F.key,label:F.label||"Chave",timeout:O})),K=A===0?"Onda 1":`Onda ${A+1}`,te=await C(K,V);if(te){let F=te.plan.durationMs||Date.now()-u,ge=X.maskKey(te.usedKey);return a?.(`\u2705 ${F}ms via '${te.usedModel}' (${te.slotLabel}: ${ge})`,"info"),te}A++}throw new Error(w||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var mo=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function ve(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function nt(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function zt(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(mo.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var Ee=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),Me=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,se=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,ho=0;function it(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!ce(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function D(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function I(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||ce(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${D(e.id)}"]`);if(n&&it(n))return!0}catch{}let r=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(r&&r!==e&&it(r))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let s=e.getBoundingClientRect();if(s.width>0||s.height>0)return!0}return!0}}}catch{}}return it(e)}function go(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function N(o,e=500){return go(o).replace(/\s+/g," ").trim().slice(0,e)}function fo(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(ho+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function ce(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Le=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function B(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(ce(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,r=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),s=String(a.getAttribute?.("title")||""),i=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",d=N(a.textContent,60);return!!(Le.test(r)||Le.test(n)||Le.test(s)||Le.test(i)||d.length>0&&d.length<=25&&Le.test(d))}function J(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||ce(o)||B(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=N(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,r=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return se.test(r)||se.test(t)?!1:Me.test(r)||Me.test(t)||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!o.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function st(o){let e=o.closest("tr");if(e){let d=e.querySelector("th, td:first-child"),l=d&&d!==o.closest("td")?N(d.textContent,100):"",u=N(o.closest("label, td")?.textContent||"",50);if(l&&u)return`${l}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let d=t.querySelector('.dropdown-label, [class*="label" i]'),l=d&&d!==o?N(d.textContent,150):"";if(l)return l}let a=o.getAttribute("aria-label");if(a)return N(a);let r=o.getAttribute("aria-labelledby");if(r){let d=r.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(d.trim())return N(d)}if("labels"in o&&o.labels){let d=Array.from(o.labels??[]).map(l=>l.textContent).join(" ");if(d.trim())return N(d)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let d=N(n.textContent);if(d)return d}let s=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",i=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||s||"";return N(i)}function rt(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,r=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(n)?n:"other",i=o.getAttribute("role")||"",d=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),l=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||l.includes("cursor-grab")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(d)||/drag|card-item|sortable/i.test(l),b=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(d)||/dropzone|category-box|bucket|target-zone/i.test(l),m=N((u?"draggable":b?"dropzone":"")||r.type||i||s,40),p="";if(r.type==="checkbox"||r.type==="radio"||i==="radio"||i==="checkbox"){let x=r.checked||o.getAttribute("aria-checked")==="true",C=r.value&&r.value!=="on"?r.value:o.getAttribute("data-value")||"";p=x?C?`checked:${C}`:"checked":C||"unchecked"}else if(s==="button"||n==="a"||e==="navigation"||J(o))p="";else{let x=typeof o.value=="string"||typeof o.value=="number"?o.value:"";p=N(x||o.getAttribute("data-category")||"",2e3)}let f=[];if(a&&a.options)for(let x of Array.from(a.options).slice(0,80))f.push({value:N(x.value),label:N(x.textContent)});else if(i==="combobox"||i==="listbox"||l.includes("select")||l.includes("dropdown")){let x=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),C=x?document.getElementById(x):o;if(C){let T=C.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let M of Array.from(T).slice(0,80)){let A=N(M.textContent);A&&f.push({value:M.getAttribute("data-value")||M.getAttribute("value")||A,label:A})}}}let v=!!(r.required||o.getAttribute("aria-required")==="true"),h=!!(r.disabled||o.getAttribute("aria-disabled")==="true"),g=fo(o);return{id:o.id||g,tag:s,type:m,label:st(o),name:N(r.name||o.getAttribute("name")||"",180),value:p,options:f,required:v,disabled:h,role:e}}var Rt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Ot(o){if(!I(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(Ee)).filter(I),a=N(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let r=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),s=Math.min(1,n/r),i=e.top+e.height/2,d=Math.abs(i-window.innerHeight/2)/Math.max(1,window.innerHeight),l=a>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+l+u-s*20-d*10}function De(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let r=N(e.innerText||e.textContent||"",1e4),n=N(t.innerText||t.textContent||"",1e4),s=e.querySelectorAll(Ee).length,i=t.querySelectorAll(Ee).length;if(r.length<150&&n.length>r.length&&i<=s+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Nt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&I(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function G(){let o=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(o&&I(o))return o;let e=document.activeElement;if(e&&e!==document.body){let s=e.closest(Rt);if(s&&Ot(s)>0)return De(s)}let a=Array.from(document.querySelectorAll(Rt)).map(s=>({element:s,score:Ot(s)})).filter(s=>Number.isFinite(s.score)).sort((s,i)=>i.score-s.score),r=a.find(s=>{let i=s.element.tagName.toLowerCase();return i!=="main"&&i!=="body"&&s.score>0});if(r)return De(r.element);if(a.length>0&&a[0].score>0)return De(a[0].element);let n=document.querySelector('form, main, [role="main"]');return n&&I(n)?n:document.body}function Dt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let r of Array.from(a.attributes))t.includes(r.name)||a.removeAttribute(r.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Be(o){let e=Array.from(o.querySelectorAll(Ee)),t=new Set,a=[];for(let l of e){if(!I(l)||J(l)||B(l))continue;let u=(l.value||l.textContent||"").trim();if(se.test(u))continue;let b=l.tagName.toLowerCase();["input","textarea","select"].includes(b)&&(t.add(l),a.push(l))}for(let l of e){if(!I(l)||J(l)||B(l))continue;let u=(l.value||l.textContent||"").trim();if(se.test(u))continue;let b=l.tagName.toLowerCase();if(["input","textarea","select"].includes(b))continue;let c=l.querySelector("input, textarea, select");if(!(c&&t.has(c))){if(l.hasAttribute("for")){let m=l.getAttribute("for"),p=m?l.ownerDocument.getElementById(m):null;if(p&&t.has(p))continue}if(b==="a"){let m=l.getAttribute("role"),p=l.getAttribute("class")||"",f=l.getAttribute("data-testid")||"",v=l.getAttribute("draggable")==="true"||l.classList.contains("perseus-drag-item")||l.classList.contains("sortable-item")||p.includes("cursor-grab")||!!l.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(f)||/drag|card-item|sortable/i.test(p);if(!(m==="button"||m==="radio"||m==="checkbox"||m==="option"||v||l.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(l)}}let r=a.length>0&&a.every(l=>B(l)||/read-?aloud|audio/i.test(l.getAttribute("data-testid")||l.getAttribute("aria-label")||"")),n=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,s=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((a.length===0||r)&&s){r&&(a.length=0);let l=Array.from(n.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(l.length>0){for(let u of l)if(!(!I(u)||B(u))&&(a.push(u),a.length>=50))break}else{let u=Array.from(n.querySelectorAll("button, div[class], span[class], p, li"));for(let b of u){if(!I(b)||J(b)||B(b)||se.test((b.textContent||"").trim()))continue;let c=(b.textContent||"").trim();if(c.length<2||c.length>300)continue;if(Array.from(b.children).some(p=>p.className&&p.textContent?.trim())||a.push(b),a.length>=50)break}}}let d=!a.some(l=>["input","select","textarea"].includes(l.tagName.toLowerCase()))&&a.length>0&&a.every(l=>{let u=l.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let b=(l.textContent||"").trim();return!l.id||b.length<10||/^\d+\s*\/\s*\d+$/.test(b)||/^question text/i.test(b)});if(a.length===0||d){d&&(a.length=0);let l=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(l.length>0)for(let u of l){if(!I(u)||ce(u)||J(u)||B(u)||se.test((u.textContent||"").trim()))continue;let b=(u.textContent||"").trim();if(!(b.length<10||b.length>500)&&!/^\d+\s*\/\s*\d+$/.test(b)&&(a.push(u),a.length>=20))break}}return a.slice(0,100).map(l=>rt(l,"answer"))}function lt(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let r of e)for(let n of Array.from(r.querySelectorAll(Ee)))if(!(t.has(n)||!I(n)||!J(n)||B(n))&&(t.add(n),a.push(rt(n,"navigation")),a.length>=10))return a;return a}function de(o=!1){let e=G();e=De(e),o&&(e=Nt(e));let t=Be(e),a=lt(e);if(t.length===0){let i=Be(document.body);i.length>0&&(e=Nt(e),t=Be(e),t.length===0&&(t=i,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=lt(document.body));let r=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=r.length>4e4?N(r.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+N(r.slice(-2e3),2e3):N(r,16e3),s=[...t,...a].slice(0,120);return!n||s.length===0&&n.length<30?N(document.body.innerText||document.body.textContent||"",16e3).length>=30?re():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:Dt(e),controls:s,scope:e}}function re(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=N(o,16e3),t=Be(document.body),a=lt(document.body),r=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Dt(n).slice(0,15e3),controls:r,scope:n}}function ct(o){let e=o.controls.map(t=>{let a=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${a}`}).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function Ve(o){if(!o)return!1;let e=o.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(a=>e.includes(a))}function R(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function E(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function U(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let r=o.ownerDocument.getElementById(a);if(r)return r}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return U(a)}return o}function Bt(o){let e=o;if(!e||!document.contains(e))try{e=G()}catch{}e=e||document.body;let t=r=>{let n=Array.from(r.querySelectorAll("tr")).filter(u=>I(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(n.length>1)return n;let s=Array.from(r.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>I(u)&&!R(u));if(s.length>0)return s;let d=Array.from(r.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>I(u)&&!R(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return d.length>0?d:Array.from(r.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let b=u;return I(b)&&!R(b)&&(b.textContent||"").trim().length>2&&!J(b)&&!B(b)&&!b.querySelector("[class]")})},a=t(e);return a.length>0?a:e!==document.body?t(document.body):[]}function $(o,e,t=!1){if(o==null)return null;let r=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!r)return null;let n=D(r),s=document.querySelector(`[data-easyquiz-id="${n}"]`);if(s&&!R(s))return U(s);try{let c=document.getElementById(r);if(c&&I(c)&&!R(c))return c.hasAttribute("data-category")||c.hasAttribute("data-dropzone")||c.classList.contains("dnd-zone")?c:U(c)}catch{}try{let c=document.querySelector(`[data-item-id="${n}"]`);if(c&&I(c)&&!R(c))return U(c)}catch{}let i=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(i){let c=parseInt(i[1],10);if(t){let p=document.body;try{p=G()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>I(v)&&!R(v));if(c>=1&&c-1<f.length)return f[c-1];if(c===0&&f.length>0)return f[0]}let m=c-1;if(m>=0){let p=Bt();if(m<p.length){let h=p[m];if(h.tagName.toLowerCase()==="tr"){if(e){let y=h.querySelector(`input[value="${D(e)}" i], [data-value="${D(e)}" i]`);if(y)return y}let g=h.querySelector("input");if(g)return g}return U(h)}let f=document.body;try{f=G()||document.body}catch{}let v=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(h=>I(h)&&!R(h));if(m<v.length)return v[m]}}let d=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(d){let c=d[1].toUpperCase(),m=c.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${c}" i], input[type="checkbox"][value="${c}" i]`)).find(v=>I(v)&&!R(v));if(p)return U(p);let f=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(v=>{if(!I(v)||R(v))return!1;let g=(v.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(g===c||g===`${c})`||g===`(${c})`||g===`${c}.`||g===`${c}:`)return!0;let y=(v.textContent||"").trim().toUpperCase();return y.startsWith(`${c})`)||y.startsWith(`(${c})`)||y.startsWith(`${c}.`)||y.startsWith(`${c}:`)});if(f)return U(f);if(m>=0){let v=Bt();if(m<v.length){let h=v[m];if(h.tagName.toLowerCase()==="tr"){if(e){let y=h.querySelector(`input[value="${D(e)}" i], [data-value="${D(e)}" i]`);if(y)return y}let g=h.querySelector("input");if(g)return g}return U(h)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(r)){let m=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(h=>I(h)&&!R(h));if(m)return m;let f=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(h=>I(h)&&!R(h));if(f)return U(f);let v=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(h=>{if(!I(h)||R(h))return!1;let g=E(h.textContent).toLowerCase();return g===r.toLowerCase()||g===r.toLowerCase()+")"});if(v)return U(v)}try{let c=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`));if(e){let p=c.find(f=>{if(!I(f)||R(f))return!1;if(f instanceof HTMLInputElement&&f.value.toLowerCase()===e.toLowerCase())return!0;let v=f.closest("label, .vf-label, td, div");return v&&E(v.textContent).toLowerCase().includes(E(e).toLowerCase())});if(p)return U(p)}let m=c.find(p=>I(p)&&!R(p));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:U(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(r))try{let m=Array.from(document.querySelectorAll(r)).find(p=>I(p)&&!R(p));if(m)return U(m)}catch{}try{let c=r.replace(/"/g,""),m=`//button[normalize-space(.)="${c}"] | //a[normalize-space(.)="${c}"] | //*[not(*) and normalize-space(.)="${c}"] | //*[@aria-label="${c}"] | //*[@data-category="${c}"] | //*[@data-testid="${c}"]`,p=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let f=0;f<p.snapshotLength;f++){let v=p.snapshotItem(f);if(v&&I(v)&&!R(v)){if(["body","html"].includes(v.tagName.toLowerCase())){let g=v.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(g&&I(g))return U(g)}return v.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||U(v)}}}catch{}let u=E(r).toLowerCase(),b=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let c of b){if(!I(c)||R(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||B(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=E(c.textContent).toLowerCase(),f=E(c.getAttribute("aria-label")||"").toLowerCase(),v=E(c.getAttribute("placeholder")||"").toLowerCase(),h=E(c.getAttribute("title")||"").toLowerCase(),g=E(c.getAttribute("name")||"").toLowerCase(),y=E(c.getAttribute("data-category")||"").toLowerCase(),x=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"",C=E(x).toLowerCase(),T=p.startsWith(u+")")||p.startsWith(u+".")||p.startsWith(u+" -")||p.startsWith(u+":");if(p===u||f===u||v===u||h===u||g===u||y&&y===u||C&&C===u||T)return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||U(c)}if(u.length>=3)for(let c of b){if(!I(c)||R(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||B(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=E(c.textContent).toLowerCase(),f=E(c.getAttribute("aria-label")||"").toLowerCase(),v=E(c.getAttribute("placeholder")||"").toLowerCase(),h=E(c.getAttribute("title")||"").toLowerCase(),g=E(c.getAttribute("name")||"").toLowerCase();if(p.includes(u)||f.includes(u)||v.includes(u)||h.includes(u)||g.includes(u)){if(Array.from(c.children).some(T=>{let M=E(T.textContent).toLowerCase();return M&&M.includes(u)}))continue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||U(c)}let y=u.split(/\s+/).filter(Boolean);if(y.length>=3){let x=y.slice(0,Math.min(5,y.length)).join(" ");if(p.includes(x)||f.includes(x)||v.includes(x))return U(c)}}return null}function Vt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function oe(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),a=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),r=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),n={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerover",{...n}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...n}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...n,button:0,buttons:0}))}catch{}if(typeof o.click=="function")try{o.click()}catch{try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}}else try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}try{let s=Object.keys(o).find(i=>i.startsWith("__reactFiber")||i.startsWith("__reactInternalInstance"));if(s){let i=o[s];for(;i;){let d=i.memoizedProps||i.pendingProps;if(d?.onClick){d.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}i=i.return}}}catch{}try{let s=Object.keys(o).find(i=>i.startsWith("__reactProps"));if(s){let i=o[s];i?.onClick&&i.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let s=o._vei;s?.onClick&&(Array.isArray(s.onClick.value)?s.onClick.value:[s.onClick.value]).forEach(d=>{try{d({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let i=o.querySelector('input[type="radio"], input[type="checkbox"]');i&&(i.focus?.(),i.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,!0),i.dispatchEvent(new Event("change",{bubbles:!0})));let d=o.closest("[jsaction]");if(d&&d!==o)try{d.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:a,clientY:r}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function pt(o){try{let e=o.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,o.id=e);let a=document.createElement("script");return a.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(a),a.remove(),t||setTimeout(()=>{try{o.id===e&&o.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function _e(o,e){let t=o;if(t.hasAttribute("for")){let l=t.getAttribute("for"),u=t.ownerDocument.getElementById(l);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Ke(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){Ke(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)t=l;else{let b=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(b)t=b;else{let c=t.nextElementSibling;for(;c;){if(c instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(c.type)||c instanceof HTMLTextAreaElement||c instanceof HTMLElement&&c.isContentEditable){t=c;break}let m=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}c=c.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let l=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)t=l;else{let u=document.body;try{u=G()||document.body}catch{}let b=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(b)t=b;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=document.body;try{l=G()||document.body}catch{}let u=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;ue(t,l);return}let s=String(e??""),i=s;if(t instanceof HTMLInputElement&&t.type==="number"){let l=s.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(i=l)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let d=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(d=document.execCommand?.("insertText",!1,i)||!1):t.isContentEditable&&(d=document.execCommand?.("insertText",!1,i)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let b=t._valueTracker;b&&b.setValue(i===""?" ":"")}catch{}let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,i):t.value=i;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==i&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(i))){t.value=i;try{u?.call(t,i)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==i.trim()){t.textContent=i;try{t.innerText=i}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=i),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function ke(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),r=E(t),n=$(t)||$(r);if(!n)return a?e:r||e;let s=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(s){let b=E(s.textContent);if(b&&b.length>0&&b.length<150)return b}if(n.id){let b=document.querySelector(`label[for="${D(n.id)}"]`);if(b){let c=E(b.textContent);if(c&&c.length>0&&c.length<150)return c}}let i=n.getAttribute("aria-label");if(i)return E(i);let d=n.getAttribute("placeholder");if(d)return E(d);let l=E(n.textContent);if(l&&l.length>0&&l.length<120)return l;let u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return u?E(u):a?e:r||e}function ue(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for")));let r=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&I(t)?t:o;if(a){let n=a.type==="radio",s=a.type==="checkbox",i=!!a._valueTracker;if(a.checked===e){if(n&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(s){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(r&&r!==a&&oe(r),a.checked!==e)try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let l=a._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,Vt(a,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;oe(r),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Ke(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let s=e.map(l=>E(l).toLowerCase()),i=!1,d=(l,u)=>{l.selected=!0,t.selectedIndex=u;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let b=t._valueTracker;b&&b.setValue(l.value)}catch{}i=!0};for(let l=0;l<t.options.length;l++){let u=t.options[l],b=u.value.toLowerCase(),c=E(u.textContent).toLowerCase();if(s.some(p=>p===b||p===c)){if(d(u,l),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!i)for(let l of s){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let b=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?b:b>=1?b-1:0;if(m>=0&&m<t.options.length&&(d(t.options[m],m),!t.multiple))break}}if(!i){for(let l of s)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,c=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(c>=0&&c<t.options.length&&(d(t.options[c],c),!t.multiple))break}}if(!i){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let b=t.options[u],c=l(b.value.toLowerCase()),m=l(E(b.textContent).toLowerCase());if(s.some(f=>{let v=l(f);return c.includes(v)||m.includes(v)||v.length>2&&(v.includes(c)||v.includes(m))})&&(d(b,u),!t.multiple))break}}if(i){Vt(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&oe(a);let r=e.map(s=>E(s).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(s=>I(s)&&!R(s));for(let s of r){let i=n.find(l=>{let u=E(l.textContent).toLowerCase(),b=E(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===s||b===s||u.includes(s)||s.length>2&&s.includes(u)});if(i){oe(i);let l=i.querySelector('input[type="radio"], input[type="checkbox"]');l&&ue(l,!0);return}let d=$(s);if(d){oe(d);return}}}function bo(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function dt(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function vo(o,e,t){try{if(e.contains(o))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(o))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let a=e.children.length;if(t!==void 0&&a>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${a}`};if([o.getAttribute("data-placed")==="true",o.getAttribute("data-assigned")==="true",o.getAttribute("data-matched")==="true",o.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(o.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let n=(o.textContent||"").trim().toLowerCase();return n.length>2&&Array.from(e.querySelectorAll("*")).some(d=>d!==e&&(d.textContent||"").trim().toLowerCase()===n)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:o.getAttribute("aria-hidden")==="true"||o.style.display==="none"||o.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function ee(o,e){let t=E(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let i=document.getElementById(o.trim());if(i&&I(i)&&!R(i))return i}let s=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let i of s){let l=Array.from(document.querySelectorAll(i)).find(u=>{if(!I(u)||R(u))return!1;let b=E(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return b===t||b.includes(t)||u.id===o.trim()});if(l)return l}return null}let a=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),r=Array.from(document.querySelectorAll(a)),n=r.find(s=>[s.getAttribute("data-category"),s.getAttribute("data-dropzone")].some(i=>i?.trim().toLowerCase()===t));return n&&I(n)&&!R(n)?n:r.find(s=>{if(!I(s)||R(s)||/unclassified/i.test(s.className))return!1;let i=s.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),d=E(i?.textContent||s.textContent||"").toLowerCase();return d.includes("op")&&(d.includes("es")||d.includes("\xF5es"))?!1:d===t||d.startsWith(t)||d.includes(t)})||null}async function je(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),r=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),s=Math.round(a.top+Math.max(1,a.height/2)),i=Math.round(r.left+Math.max(1,r.width/2)),d=Math.round(r.top+Math.max(1,r.height/2)),l=E(e.textContent).toLowerCase();if(l){let f=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(v=>{let h=E(v.textContent).toLowerCase(),g=v instanceof HTMLInputElement||v instanceof HTMLOptionElement?E(v.value).toLowerCase():"";return h&&(l.includes(h)||h.includes(l))||g&&(l.includes(g)||g.includes(l))});f&&(oe(f),await new Promise(v=>setTimeout(v,120)))}dt(o),await new Promise(p=>setTimeout(p,140)),dt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&dt(u),await new Promise(p=>setTimeout(p,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let b={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:s,screenX:n,screenY:s,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...b,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",b));let c=4;for(let p=1;p<=c;p++){let f=Math.round(n+(i-n)*(p/c)),v=Math.round(s+(d-s)*(p/c)),h={...b,clientX:f,clientY:v,screenX:f,screenY:v};try{o.dispatchEvent(new PointerEvent("pointermove",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",h))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:d,screenX:i,screenY:d,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let p=bo(N(o.textContent),o.outerHTML),f={...b},v={...m};p&&(f.dataTransfer=p,v.dataTransfer=p);let h=o.ownerDocument.defaultView?.DragEvent;if(!h)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new h("dragstart",f)),e.dispatchEvent(new h("dragenter",v)),e.dispatchEvent(new h("dragover",v)),e.dispatchEvent(new h("drop",v)),o.dispatchEvent(new h("dragend",f))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:o,clientX:n,clientY:s}),f=new Touch({identifier:1,target:e,clientX:i,clientY:d});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(o))try{let p=h=>{let g=Object.keys(h).find(x=>x.startsWith("__reactFiber")||x.startsWith("__reactInternalInstance"));if(!g)return null;let y=h[g];for(let x=0;x<10&&y;x++){if(y.memoizedProps)return y.memoizedProps;y=y.return}return null},f=p(o),v=p(e);if(f){let h=f.onMouseDown||f.onPointerDown||f.onDragStart;if(typeof h=="function")try{h({type:"mousedown",button:0,buttons:1,clientX:n,clientY:s,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:o,target:o}),await new Promise(g=>setTimeout(g,100))}catch{}}if(v){let h=v.onMouseUp||v.onPointerUp||v.onDrop;if(typeof h=="function")try{h({type:"mouseup",button:0,buttons:0,clientX:i,clientY:d,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(g=>setTimeout(g,200));let h=d>s?"ArrowDown":"ArrowUp";for(let g=0;g<3;g++)document.dispatchEvent(new KeyboardEvent("keydown",{key:h,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(g=>setTimeout(g,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(o.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:o.id||o.getAttribute("data-id")}})),await new Promise(g=>setTimeout(g,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}}function _t(o,e,t,a){let r=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),n=r(o.toLowerCase()),s=r(e.toLowerCase()),i=r(t),d=r(a);return`var src=$eq.find('${i}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${n}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${s}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${n} -> ${s}');}`}var Kt={fill:(o,e)=>{let t=$(o);t?_e(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=$(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?ue(e,!0):oe(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=$(o);t?ue(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>$(o,e),drag:(o,e)=>{let t=ee(o,"source")||$(o),a=ee(e,"destination")||$(e);t&&a?je(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=ee(o,"source")||$(o),a=ee(e,"destination")||$(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await je(t,a)},execute:(o,e=!1,t=1)=>Ie(o,e,t)};typeof window<"u"&&(window.$eq=Kt);async function yo(o,e=1,t=ve()){if(nt(o,t),o.t==="js"){let d=String(o.v||"");zt(d);try{new Function("$eq","document","window",d)(Kt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let d=ee(o.from,"source")||$(o.from),l=ee(o.to,"destination")||$(o.to);!d&&o.from&&(d=$(E(o.from))),!l&&o.to&&(l=$(E(o.to))),d&&l?await je(d,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let r=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=r!=null?String(r).trim():"",s=null,i=String(o.name??o.n??"").trim();if(!i&&a&&document.querySelector(`input[type="radio"][name="${D(a)}"]`)&&(i=a),(o.t==="chk"||o.t==="clk")&&i){let d=Array.from(document.querySelectorAll(`input[name="${D(i)}"]`));if(n&&(s=d.find(l=>l.value?.toLowerCase()===n.toLowerCase())??null),!s&&n){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(n),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(n);if(l||u){let b=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=d.find(c=>{let m=c.value?.toLowerCase()??"";if(b.includes(m))return!0;let f=(c.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(v=>f===v||f.startsWith(v+" ")||f.startsWith("("+v+")"))})??null}}!s&&d.length>0&&(s=d[0])}if(s||(s=$(a,n,o.t==="val"||o.t==="sel")),!s&&a&&(s=$(E(a),n,o.t==="val"||o.t==="sel")),s&&n){if(s instanceof HTMLInputElement&&s.type==="radio"&&s.name){if(E(s.value).toLowerCase()!==E(n).toLowerCase()){let d=document.querySelector(`input[type="radio"][name="${D(s.name)}"][value="${D(n)}" i]`);if(d)s=d;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${D(s.name)}"]`)).find(b=>{let c=b.closest("label, .vf-label, .option-card, tr, td, div");return c&&E(c.textContent).toLowerCase().includes(E(n).toLowerCase())});u&&(s=u)}}}else if(!(s instanceof HTMLInputElement)&&!(s instanceof HTMLSelectElement)&&!(s instanceof HTMLTextAreaElement)){let d=s.querySelector(`input[value="${D(n)}" i], [data-value="${D(n)}" i]`);if(d)s=d;else{let u=Array.from(s.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(b=>{let c=b.closest("label, .vf-label, .option-card, td, div");return c&&E(c.textContent).toLowerCase().includes(E(n).toLowerCase())});u&&(s=u)}}}if(!s&&(o.t==="val"||o.t==="sel")){let d=document.body;try{d=G()||document.body}catch{}let l=Array.from(d.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>I(u)&&!R(u));if(l.length===1)s=l[0];else if(l.length>1){let u=E(a).toLowerCase(),b=u.match(/^#?_?([0-9]+)$/);if(b){let c=parseInt(b[1],10);c>=1&&c<=l.length?s=l[c-1]:c>=0&&c<l.length&&(s=l[c])}s||(s=l.find(m=>{let p=(m.getAttribute("placeholder")||"").toLowerCase(),f=(m.name||"").toLowerCase(),v=(m.getAttribute("aria-label")||"").toLowerCase(),h=(m.id||"").toLowerCase(),g=E(st(m)).toLowerCase(),y=E(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(u)||f.includes(u)||v.includes(u)||h.includes(u)||g&&g.includes(u)||u.length>=2&&y.includes(u)})||(l.length===1?l[0]:null))}}if(!s&&o.t!=="adv")throw new Error(`Alvo '${a}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);switch(o.t){case"val":if(s){let u=s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement||s.isContentEditable?s:s.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let p=s.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(u=p)}if(!u){let m=s.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){u=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){u=p;break}m=m.nextElementSibling}}if(!u){let m=document.body;try{m=G()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>I(f)&&!R(f));p.length>0&&(u=p[0])}let b=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,c=b!=null?String(b):"";_e(u||s,c)}break;case"chk":let d=o.c!==void 0?!!o.c:!0;s&&ue(s,d);break;case"sel":if(s){let u=Array.isArray(o.v)?o.v:[String(o.v)];Ke(s,u)}break;case"clk":if(s)if(!!(s.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||s.querySelector('input[type="radio"], input[type="checkbox"]')||s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type))){let b=o.c!==void 0?!!o.c:!0;ue(s,b)}else oe(s,o.co);break;case"adv":let l=jt(o.id);if(l){await ut(l,1200);let u=o.id||l.textContent?.trim()||"";u&&Xe(window.location.hostname,{advanceSelector:u}),oe(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function xo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!I(t)||R(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(r)})||null}function jt(o){let e=c=>{let m=(c.getAttribute("aria-label")||c.textContent||(c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"")||"").trim();return se.test(m)};if(o){let c=$(o);if(c&&I(c)&&!R(c)&&!B(c)&&!e(c))return c}try{let c=Ye(window.location.hostname);if(c.advanceSelector){let m=$(c.advanceSelector);if(m&&I(m)&&!R(m)&&!B(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(t)),r=c=>{let m=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"";return(c.getAttribute("aria-label")||c.textContent||m||"").trim()},n=c=>{let m=r(c).trim();return/^\d{1,3}$/.test(m)?!!c.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},s=a.filter(c=>I(c)&&!R(c)&&!c.closest("header, aside")&&!B(c)&&!e(c));for(let c of s){let m=r(c),p=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Me.test(m)||Me.test(p))&&!n(c)&&!B(c))return c}for(let c of s)if(J(c)&&!B(c)&&!n(c))return c;let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(i&&I(i)&&!R(i)&&!B(i)&&!e(i))return i;let d=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let c of d)if(I(c)&&!R(c)&&!e(c)&&!B(c)&&!n(c))return c;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,b=l.filter(c=>{if(!I(c)||R(c)||e(c)||B(c)||c.closest("header, nav, aside, .eq-sidebar")||n(c))return!1;let m=c.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(b.length>0)return b.sort((c,m)=>{let p=c.getBoundingClientRect(),f=m.getBoundingClientRect(),v=p.left+p.top;return f.left+f.top-v}),b[0];for(let c of s)if(J(c)&&!B(c))return c;return null}async function ut(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(r=>setTimeout(r,80))}}function wo(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function Eo(o,e=3500){let[t,a,r,n]=o.split("|"),s=parseInt(n||"0",10),i=Date.now();for(;Date.now()-i<e;){let d=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),b=(document.body?.innerText||document.body?.textContent||"").length;if(d!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${d}`};if(l!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(r||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${r} \u2192 ${u}`};if(Math.abs(b-s)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(b-s)} chars)`};await new Promise(c=>setTimeout(c,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Ue(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let n=$(o.from)||$(E(o.from)),s=$(o.to)||$(E(o.to));n&&s&&await je(n,s,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=$(e,t)||$(E(e),t),r=String(o.name??o.n??"").trim();if(!r&&e&&document.querySelector(`input[type="radio"][name="${D(e)}"]`)&&(r=e),!a&&r){let n=Array.from(document.querySelectorAll(`input[name="${D(r)}"]`));if(t&&(a=n.find(s=>s.value?.toLowerCase()===t.toLowerCase())??null),!a&&t){let s=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),i=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(s||i){let d=s?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];a=n.find(l=>{let u=l.value?.toLowerCase()??"";if(d.includes(u))return!0;let c=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return d.some(m=>c===m||c.startsWith(m+" ")||c.startsWith("("+m+")"))})??null}}!a&&n.length>0&&(a=n[0])}if(o.t==="clk"||o.t==="chk"){if(!a&&e){let s=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),i=E(e).toLowerCase();a=s.find(d=>{let l=E(d.textContent).toLowerCase();return!!(E(d.value||"").toLowerCase()===i||l===i||l.startsWith(i+")")||l.startsWith("("+i+")")||l.startsWith(i+".")||l.startsWith(i+" - ")||l.startsWith(i+":")||i.length>=3&&l.includes(i))})||null}let n=o.v!==void 0?String(o.v).trim():"";if(a&&n){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(E(a.value).toLowerCase()!==E(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${D(a.name)}"][value="${D(n)}" i]`);if(s)a=s;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${D(a.name)}"]`)).find(l=>{let u=l.closest("label, .vf-label, .option-card, tr, td, div");return u&&E(u.textContent).toLowerCase().includes(E(n).toLowerCase())});d&&(a=d)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let s=a.querySelector(`input[value="${D(n)}" i], [data-value="${D(n)}" i]`);if(s)a=s;else{let d=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let u=l.closest("label, .vf-label, .option-card, td, div");return u&&E(u.textContent).toLowerCase().includes(E(n).toLowerCase())});d&&(a=d)}}}if(a){let s=a.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,i=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:s.querySelector('input[type="radio"], input[type="checkbox"]')||(s.getAttribute("for")?s.ownerDocument.getElementById(s.getAttribute("for")):null),d=o.c!==void 0?!!o.c:!0;if(ue(i||s,d),i&&i.checked!==d){try{let l=i._valueTracker;l&&l.setValue(!d)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,d)}catch{}i.checked=d,i.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),i.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let n=null;if(a&&(n=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!n){let s=document.body;try{s=G()||document.body}catch{}let i=Array.from(s.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),d=E(e).toLowerCase();n=i.find(l=>{let u=(l.getAttribute("placeholder")||"").toLowerCase(),b=(l.name||"").toLowerCase(),c=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return u.includes(d)||b.includes(d)||c.includes(d)||m.includes(d)})||(i.length>0?i[0]:null)}if(n){let s=String(o.v??"");try{if(n.focus?.(),n.type!=="number"){try{n.select?.()}catch{}document.execCommand?.("insertText",!1,s)}}catch{}_e(n,s)}return}if(o.t==="sel"){if(!a&&e){let n=Array.from(document.querySelectorAll("select")),s=E(e).toLowerCase();a=n.find(i=>{let d=(i.name||"").toLowerCase(),l=(i.id||"").toLowerCase(),u=(i.getAttribute("aria-label")||"").toLowerCase();return d.includes(s)||l.includes(s)||u.includes(s)})||null}if(a){let n=Array.isArray(o.v)?o.v:[String(o.v)];Ke(a,n)}return}}function Z(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,r=o.id!==void 0&&o.id!==null?String(o.id):"";r||(r=o.target??o.name??o.selector??"1");let n=$(r,a,!0)||$(E(r),a,!0);if(!n){let m=document.body;try{m=G()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>I(f)&&!R(f));p.length>0&&(n=p[0])}if(!n)return!1;let s=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(s&&s.name){let m=document.querySelector(`input[type="radio"][name="${D(s.name)}"]:checked`);if(!m)return!1;let p=E(m.value).toLowerCase(),f=E(t).toLowerCase(),v=E(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===f||v===f||v.includes(f)}let i=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!i){let p=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(i=p)}if(!i){let m=n.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){i=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){i=p;break}m=m.nextElementSibling}}if(i instanceof HTMLSelectElement){let m=E(t).toLowerCase();return Array.from(i.options).some(p=>{if(!p.selected)return!1;let f=p.value.toLowerCase(),v=E(p.textContent).toLowerCase();return m===f||m===v||f.includes(m)||v.includes(m)})}let d=(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i?.textContent??n.textContent??"").trim();if(!d&&!t)return!0;if(!d&&t)return!1;let l=d.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),b=parseFloat(l),c=parseFloat(u);return!isNaN(b)&&!isNaN(c)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(b-c)<1e-4:l===u||d.toLowerCase()===t.toLowerCase()||u.length>=3&&l===u}if(o.t==="sel"){let e=$(o.id,void 0,!0)||$(E(o.id),void 0,!0);if(!e){let n=document.body;try{n=G()||document.body}catch{}let s=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>I(l)&&!R(l)),i=E(o.id).toLowerCase();e=s.find(l=>{let u=(l.id||"").toLowerCase(),b=(l.getAttribute("name")||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase(),m=E(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(i)||b.includes(i)||c.includes(i)||i.length>=2&&m.includes(i)})||(s.length===1?s[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(l=>E(l).toLowerCase()),d=E(n.textContent).toLowerCase();return i.some(l=>d.includes(l)||l.includes(d))}return!1}let r=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>E(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let s=n.value.toLowerCase(),i=E(n.textContent).toLowerCase();return r.some(d=>d===s||d===i||s.includes(d)||i.includes(d))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=String(o.name??o.n??"").trim();if(t&&!o.id){let c=Array.from(document.querySelectorAll(`input[name="${D(t)}"]`));if(c.length>0){let m=c.find(g=>g.checked);if(!m)return!1;if(!e)return!0;let p=m.value?.toLowerCase()??"",f=e.toLowerCase();if(p===f)return!0;let v=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),h=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return v?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):h?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let a=$(o.id,e)||$(E(o.id),e);if(!a&&t){let c=document.querySelector(`input[name="${D(t)}"]`);c&&(a=c)}if(!a)return!1;let r=a.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,n=a instanceof HTMLInputElement&&["checkbox","radio"].includes(a.type)?a:r.querySelector('input[type="checkbox"], input[type="radio"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(n&&n.type==="radio"){if(n.checked===s)return!0;if(o.v&&n.name){let c=E(String(o.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${D(n.name)}"]:checked`);if(!m)return!1;if(m===n)return!0;let p=E(m.value).toLowerCase(),f=E(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===c||f.includes(c)||c.includes(p)}}if(n&&["checkbox","radio"].includes(n.type))return n.checked===s;let i=r.getAttribute("aria-checked")===String(s)||r.getAttribute("aria-selected")===String(s)||r.getAttribute("aria-pressed")===String(s),d=s?r.getAttribute("data-selected")==="true"||r.getAttribute("data-checked")==="true"||r.getAttribute("data-active")==="true"||r.getAttribute("data-state")==="checked"||r.getAttribute("data-state")==="on":r.getAttribute("data-selected")==="false"||r.getAttribute("data-checked")==="false"||r.getAttribute("data-state")==="unchecked",l=r.className||"",u=s?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(i||d||u)return!0;let b=!!r.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return o.t==="clk"&&!n&&!b||r.getAttribute("aria-expanded")!==null||r.getAttribute("aria-pressed")!==null}if(o.t==="drag"){let e=ee(o.from,"source")||$(o.from)||$(E(o.from)),t=ee(o.to,"destination")||$(o.to)||$(E(o.to));return!e||!t?!1:vo(e,t).success}}catch{}return!1}async function Ie(o,e,t=1,a=ve({engine:"smart",autoAdvance:e})){let r=o.actions.filter(w=>w.t!=="adv"),n=o.actions.filter(w=>w.t==="adv"),s=0,i=[],d=new Map,l=new Map,u=new Map,b=new Set,c=o.pageType==="question"||r.length>0,m=r.filter(w=>w.t==="chk"||w.t==="clk"&&w.c!==void 0),p=new Map;for(let w of r){let L=[];l.set(w,L);try{if(w.t==="drag"){L.push("declarative-A-F");try{let S=ee(w.from,"source")||$(w.from),q=ee(w.to,"destination")||$(w.to);S&&u.set(w,S.parentElement?.outerHTML?.slice(0,500)||""),q&&p.set(w,q.children.length)}catch{}}else L.push("declarative-primary");await yo(w,t,a),s++,b.add(w)}catch(S){d.set(w,S instanceof Error?S.message:String(S)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",w,S)}await new Promise(S=>setTimeout(S,w.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&m.length>0){let w=document.body;try{w=G()||document.body}catch{}let L=Array.from(w.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(S=>I(S)&&!R(S));if(L.length>1){let q=function(H,z){if(H===z||H.contains(z)||z.contains(H))return!0;let _=H.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),O=z.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(_&&O&&_===O)return!0;let V=H.getAttribute("for")||H.id,K=z.getAttribute("for")||z.id;return!!(V&&K&&V===K)};var A=q;let S=new Set;for(let H of m){let z=H.t==="chk"?!!H.c:!!(H.c??!0),_="id"in H&&typeof H.id=="string"?H.id:"";if(z&&_){let O=$(_,H.v);if(O){S.add(O);let V=O.querySelector('input[type="checkbox"]');V&&S.add(V);let K=O.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');K&&(S.add(K),K.querySelectorAll('input[type="checkbox"]').forEach(te=>S.add(te)))}}}if(S.size>=m.length&&S.size>0){let H=Array.from(S);for(let z of L)H.some(O=>q(O,z))||(z instanceof HTMLInputElement&&z.checked||z.getAttribute("aria-checked")==="true"||z.closest(".option-card, label")?.classList.contains("selected"))&&ue(z,!1)}}}await new Promise(w=>setTimeout(w,r.length>0?100:25));let f=0;for(let w of r){if(Z(w)){f++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${w.t}' no alvo '${w.id||w.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{nt(w,a),l.get(w)?.push("alternative-path"),await Ue(w)}catch(L){d.set(w,L instanceof Error?L.message:String(L)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",L)}await new Promise(L=>setTimeout(L,250)),Z(w)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),f++,b.has(w)?d.has(w)&&d.delete(w):(d.delete(w),s++,b.add(w)))}if(f<r.length&&r.length>0){console.warn(`[EasyQuiz Auto-Cura] ${r.length-f} de ${r.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(w=>setTimeout(w,200));for(let w of r)if(!Z(w))try{if(await Ue(w),await new Promise(L=>setTimeout(L,80)),!Z(w)&&(w.t==="clk"||w.t==="chk"))try{let L="id"in w?String(w.id||""):"",S=w.v!==void 0?String(w.v).trim():"",q=$(L,S)||$(E(L),S);q&&(pt(q),await new Promise(H=>setTimeout(H,120)))}catch{}}catch(L){d.set(w,L instanceof Error?L.message:String(L))}await new Promise(w=>setTimeout(w,200)),f=0;for(let w of r)Z(w)&&(f++,b.has(w)?d.has(w)&&d.delete(w):(d.delete(w),s++,b.add(w)))}let v=[];for(let[w,L]of r.entries())if(!Z(L)){let S=L.t==="drag"?`${L.from} -> ${L.to}`:"id"in L&&L.id?L.id:L.t;i.push(S),v.push({actionIndex:w,action:L,strategiesAttempted:l.get(L)||[],evidence:d.get(L)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(L)}),L.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${L.from}" -> "${L.to}"`,`
  Estrat\xE9gias: ${(l.get(L)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(L)?.slice(0,200)||"n/a"}`)}c&&r.length===0&&i.push("nenhuma a\xE7\xE3o de resposta prescrita");let h=r.map((w,L)=>{let S=w.t==="drag"?`${w.from} -> ${w.to}`:w.t==="js"?"$eq":w.id||w.t,q=w.t==="js"?!0:w.t==="drag"?!!(ee(w.from,"source")&&ee(w.to,"destination")):!!($(w.id||"")||$(E(w.id||""))),H=Z(w);return{index:L,action:w,target:S,located:q,applied:!d.has(w),verified:H,strategy:w.t==="drag"?"drag-adaptive":w.t==="js"?"javascript":"declarative-dom",evidence:H?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...d.has(w)?{error:d.get(w)}:{}}}),g=c?r.length>0&&i.length===0&&(f===r.length||s===r.length&&f>0):!0,y=!1,x=!1,C="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",T=c?f>0&&f>=Math.ceil(r.length/2):s>0&&s>=r.length/2,M=c?f>0&&(g||T):g||r.length===0||T;if(e&&M){await new Promise(S=>setTimeout(S,r.length>0?120:40));let w=!1,L=null;if(o.pageType!=="info"){let S=xo();if(S&&I(S)){await ut(S,1200),oe(S),w=!0,L=S,await new Promise(z=>setTimeout(z,350));let q=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');q&&I(q)&&(q.textContent||"").trim().length>0?(y=!1,x=!1,C=`Aviso do formul\xE1rio ap\xF3s checagem: ${q.textContent?.trim().slice(0,100)}`):(y=!0,x=!0,C="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!w){let S=wo(),q=n.length>0&&"id"in n[0]?n[0].id:void 0,H=jt(q);if(H){await ut(H,1500);let z=q||H.textContent?.trim()||"";z&&Xe(window.location.hostname,{advanceSelector:z}),oe(H);let _=await Eo(S,1800);x=_.changed,C=_.evidence,y=_.changed||!0,_.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:s,verified:f,success:g,advanced:y,failed:i,reports:h,navigationVerified:x,navigationEvidence:C,failedActions:v}}var ae=null,ye=[],mt=[],ht=[],gt=[],ne=null,pe=null,qo=`
...
`;function Ut(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=qo,document.head.appendChild(o)}}catch{}}function me(){ae&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset"),ae.style.removeProperty("position"),ae=null);for(let o of ye)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ye=[];for(let o of mt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");mt=[];for(let o of ht)try{o.remove()}catch{}ht=[],pe&&typeof window<"u"&&(window.removeEventListener("scroll",pe),window.removeEventListener("resize",pe),pe=null);for(let o of gt)try{o.remove()}catch{}if(gt=[],ne){try{ne.remove()}catch{}ne=null}}function ft(o){Ut();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),mt.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,s=r.height||t.offsetHeight||200;if(n>10&&s>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(d),document.body.appendChild(i),ht.push(i),gt.push(d),e.push({element:t,frame:i})}}catch{}}e.length>0&&!pe&&typeof window<"u"&&(pe=()=>{for(let t of e)try{let a=t.element.getBoundingClientRect();a.width>0&&a.height>0&&(t.frame.style.top=`${a.top+window.scrollY-3}px`,t.frame.style.left=`${a.left+window.scrollX-3}px`,t.frame.style.width=`${a.width+6}px`,t.frame.style.height=`${a.height+6}px`)}catch{}},window.addEventListener("scroll",pe,{passive:!0}),window.addEventListener("resize",pe,{passive:!0}))}function He(o){ae&&ae!==o&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset")),Ut(),ae=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(ne){try{ne.remove()}catch{}ne=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),ne=t}catch{}}function Co(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Ft(o,e){if(ne){try{ne.remove()}catch{}ne=null}let t=Co(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let m=$(a.from),p=$(a.to);m&&(m.style.outline=`2px solid ${t.outline}`,ye.push(m)),p&&(p.style.outline="2px dashed #00e5ff",ye.push(p))}catch{}continue}let r=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=String(a.name??a.n??"").trim(),s=null;if(n){let m=Array.from(document.querySelectorAll(`input[name="${D(n)}"]`));if(r&&(s=m.find(p=>p.value?.toLowerCase()===r.toLowerCase())??null,!s)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(r),f=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(r);if(p||f){let v=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=m.find(h=>{let g=h.value?.toLowerCase()??"";if(v.includes(g))return!0;let x=(h.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return v.some(C=>x===C||x.startsWith(C+" ")||x.startsWith("("+C+")"))})??null}}!s&&m.length>0&&(s=m[0])}if(!s&&a.id&&(s=$(a.id,r,a.t==="val"||a.t==="sel")||$(E(a.id),r,a.t==="val"||a.t==="sel")),!s&&a.t==="sel"){let m=document.body;try{m=G()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(h=>I(h)&&!ce(h)),f=E(a.id).toLowerCase();s=p.find(h=>{let g=(h.id||"").toLowerCase(),y=(h.getAttribute("name")||"").toLowerCase(),x=(h.getAttribute("aria-label")||"").toLowerCase(),C=E(h.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return g.includes(f)||y.includes(f)||x.includes(f)||f.length>=2&&C.includes(f)})||(p.length===1?p[0]:null)}if(!s)continue;let i=typeof HTMLSelectElement<"u"&&s instanceof HTMLSelectElement||s.tagName?.toLowerCase()==="select"||s.getAttribute("role")==="combobox"||s.getAttribute("role")==="listbox",d=s.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?s.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=d||l||s;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),ye.push(u);let b=i?s:u.querySelector('select, [role="combobox"], [role="listbox"]');b&&(b.style.outline=`2px solid ${t.outline}`,b.style.outlineOffset="2px",b.style.boxShadow=`0 0 10px ${t.glow}`,b.setAttribute("data-easyquiz-highlight","true"),ye.push(b));let c=s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type)?s:u.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==u&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ye.push(c))}}var bt=10,To=1400,$e=15e5;function le(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let r=String(a.result||"");e(r.split(",")[1]||"")},a.readAsDataURL(o)})}async function xe(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,To/Math.max(e,t)),r=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),s=document.createElement("canvas");s.width=r,s.height=n;let i=s.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,r,n),i.drawImage(o,0,0,r,n),new Promise((d,l)=>{s.toBlob(u=>u?d(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Qt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,r=2,n=Math.min(1800,Math.max(120,Math.round(t*r))),s=Math.min(1800,Math.max(100,Math.round(a*r))),i=o.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(n)),i.setAttribute("height",String(s)),!i.getAttribute("viewBox")&&t>0&&a>0&&i.setAttribute("viewBox",`0 0 ${t} ${a}`);try{let c=Array.from(o.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,m.length);p++){let f=c[p],v=m[p];if(!f||!v||!v.style)continue;let h=window.getComputedStyle?window.getComputedStyle(f):null;h&&(h.fill&&h.fill!=="none"&&(v.style.fill=h.fill),h.stroke&&h.stroke!=="none"&&(v.style.stroke=h.stroke),h.strokeWidth&&(v.style.strokeWidth=h.strokeWidth),h.fontFamily&&(v.style.fontFamily=h.fontFamily),h.fontSize&&(v.style.fontSize=h.fontSize),h.fontWeight&&(v.style.fontWeight=h.fontWeight),h.color&&(v.style.color=h.color))}}catch{}let d="#ffffff";try{let c=o.parentElement||o;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){d=p;break}c=c.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),b="";try{b=btoa(unescape(encodeURIComponent(u)))}catch{}try{let c=v=>new Promise((h,g)=>{let y=new Image,x=setTimeout(()=>g(new Error("Timeout render SVG")),1200);y.onload=()=>{clearTimeout(x),h(y)},y.onerror=()=>{clearTimeout(x),g(new Error("Falha ao renderizar SVG em Image."))},y.src=v}),m=null;if(b)try{m=await c(`data:image/svg+xml;base64,${b}`)}catch{}if(!m){let v=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(v);try{m=await c(h)}finally{URL.revokeObjectURL(h)}}let p=document.createElement("canvas");p.width=n,p.height=s;let f=p.getContext("2d",{alpha:!1});if(f&&m){f.fillStyle=d,f.fillRect(0,0,n,s),f.drawImage(m,0,0,n,s);let v=await new Promise(h=>{p.toBlob(h,"image/jpeg",.92)});if(v){let h=await le(v);if(h)return{blob:v,base64:h,mediaType:"image/jpeg"}}}}catch{}return{base64:b,mediaType:"image/svg+xml"}}async function vt(o){try{let e=o.getBoundingClientRect(),t=Math.round(e.width)||o.offsetWidth||400,a=Math.round(e.height)||o.offsetHeight||300;if(t<30||a<30)return null;let r=o.tagName.toLowerCase()==="svg"?o:o.querySelector("svg");if(r&&o.querySelectorAll("input, select, textarea").length===0)try{let f=await Qt(r);if(f.base64&&f.base64.length<=$e)return{mediaType:f.mediaType,base64:f.base64,alt:o.getAttribute("aria-label")||r.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:he(r)}}catch{}if(o instanceof HTMLCanvasElement)try{let f=await xe(o),v=await le(f);if(v)return{mediaType:"image/jpeg",base64:v,alt:o.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let n="#ffffff";try{let f=o;for(;f&&f!==document.documentElement;){let h=(window.getComputedStyle?window.getComputedStyle(f):null)?.backgroundColor;if(h&&h!=="transparent"&&h!=="rgba(0, 0, 0, 0)"){n=h;break}f=f.parentElement}}catch{}let s=o.cloneNode(!0),i=Array.from(o.querySelectorAll("*")),d=Array.from(s.querySelectorAll("*"));for(let f=0;f<Math.min(i.length,d.length);f++){let v=i[f],h=d[f];if(!(!v||!h||!h.style))try{let g=window.getComputedStyle(v);h.style.color=g.color,h.style.backgroundColor=g.backgroundColor,h.style.borderColor=g.borderColor,h.style.borderWidth=g.borderWidth,h.style.borderStyle=g.borderStyle,h.style.fontSize=g.fontSize,h.style.fontFamily=g.fontFamily,h.style.fontWeight=g.fontWeight,h.style.lineHeight=g.lineHeight,h.style.letterSpacing=g.letterSpacing,h.style.textAlign=g.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,a))),u=Math.round(t*l),b=Math.round(a*l),c=`
      <svg xmlns="http://www.w3.org/2000/svg" width="${u}" height="${b}" viewBox="0 0 ${t} ${a}">
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let s=this.element.querySelector("#eq-fah-header");this.setupDraggable(s)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=i=>{if(!this.isDragging||!this.element)return;let d=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),b=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),b);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},s=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",s)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",s)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),s=r.actions.filter(m=>{if(m.t!=="val")return!1;let p=E(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=r.actions.filter(m=>m.t==="sel"),l=n.length||s.length||i.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let b=document.createElement("span");b.textContent=`Modo: ${r.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(b,c),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let p of n){let f=E(p.to)||"Geral";m[f]||(m[f]=[]),m[f].push(E(p.from))}for(let[p,f]of Object.entries(m)){let v=document.createElement("div"),h=/fato|true|verdadeiro|sim/i.test(p),g=/opini[aã]o|false|falso|n[aã]o/i.test(p);v.className=`eq-fah-group ${h?"group-fato":g?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${p} (${f.length})`,v.appendChild(y);let x=document.createElement("div");x.className="eq-fah-group-items";for(let C of f){let T=document.createElement("div");T.className="eq-fah-item";let M=document.createElement("span");M.className="eq-fah-item-text",M.textContent=C,T.appendChild(M);let A=document.createElement("button");A.className="eq-fah-copy-inline",A.textContent="Copiar",A.addEventListener("click",()=>{navigator.clipboard.writeText(C),A.textContent="\u2713 Copiado",setTimeout(()=>A.textContent="Copiar",1200)}),T.appendChild(A),x.appendChild(T)}v.appendChild(x),e.appendChild(v)}}else if(s.length>0){t.textContent=`Preenchimento (${s.length} campos)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let v=0;v<s.length;v++){let h=s[v],g=document.createElement("div");g.className="eq-fah-item";let y=ke(h.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${v+1}`);let x=String(h.v??""),C=document.createElement("div");C.className="eq-fah-field-box";let T=document.createElement("div");T.className="eq-fah-field-label",T.textContent=y,C.appendChild(T);let M=document.createElement("div");M.className="eq-fah-field-val",M.textContent=x,C.appendChild(M),g.appendChild(C);let A=document.createElement("button");A.className="eq-fah-copy-inline",A.textContent="Copiar",A.addEventListener("click",()=>{navigator.clipboard.writeText(x),A.textContent="\u2713 Copiado",setTimeout(()=>A.textContent="Copiar",1200)}),g.appendChild(A),f.appendChild(g)}m.appendChild(f),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let v=0;v<i.length;v++){let h=i[v],g=document.createElement("div");g.className="eq-fah-item";let y=ke(h.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&h.v&&(y=String(h.v)),y=E(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let x="",C=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);C?(x=C[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=C[2].trim()||y):i.length>1&&(x=String.fromCharCode(65+v));let T=document.createElement("div");if(T.style.display="flex",T.style.alignItems="center",T.style.gap="8px",T.style.flex="1",x){let w=document.createElement("span");w.className="eq-fah-letter-badge",w.textContent=x,T.appendChild(w)}let M=document.createElement("span");M.className="eq-fah-item-text",M.textContent=y||(x?`Alternativa ${x}`:"Alternativa Selecionada"),T.appendChild(M),g.appendChild(T);let A=document.createElement("button");A.className="eq-fah-copy-inline",A.textContent="Copiar",A.addEventListener("click",()=>{navigator.clipboard.writeText(y||x),A.textContent="\u2713 Copiado",setTimeout(()=>A.textContent="Copiar",1200)}),g.appendChild(A),f.appendChild(g)}m.appendChild(f),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,a.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let v=0;v<d.length;v++){let h=d[v],g=document.createElement("div");g.className="eq-fah-item";let y=ke(h.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${v+1}`);let T=(Array.isArray(h.v)?h.v:[String(h.v??"")]).map(S=>{let q=$(h.id,void 0,!0)||$(E(h.id),void 0,!0),H=q instanceof HTMLSelectElement?q:q?.querySelector("select");if(H){let z=E(S).toLowerCase();for(let _=0;_<H.options.length;_++){let O=H.options[_];if(O.value.toLowerCase()===z||E(O.textContent).toLowerCase()===z){let V=E(O.textContent);if(V&&!V.toLowerCase().includes("selecione"))return V}}}return S}).join(", "),M=document.createElement("div");M.className="eq-fah-field-box";let A=document.createElement("div");A.className="eq-fah-field-label",A.textContent=y,M.appendChild(A);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=T,M.appendChild(w),g.appendChild(M);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(T),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),g.appendChild(L),f.appendChild(g)}m.appendChild(f),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(i=>i.t==="drag"),r=e.actions.filter(i=>i.t==="val"),n=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),s=e.actions.filter(i=>i.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let d of a){let l=E(d.to)||"Geral";i[l]||(i[l]=[]),i[l].push(E(d.from))}for(let[d,l]of Object.entries(i)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of r){let d=E(i.id);t.push(`- **${d||"Campo"}:** \`${i.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<n.length;i++){let d=n[i],l=ke(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=E(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=n.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(s.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of s){let d=E(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let a=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=a},1500)})}};var Wt=`
...
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let a=t?`[${t}] ${e}`:e;this.setLastError(a)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,a=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let r=e?.promptTokens!==void 0?String(e.promptTokens):"--",n=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${r} / ${n}`,this.dbgSplitTokens.title=`Prompt: ${r} tokens | Resposta: ${n} tokens`}if(this.dbgTotalTokens){let r=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=r!==void 0?`${r}`:"--"}if(this.dbgPromptLen){let r=a.length,n=Math.round(r/4);this.dbgPromptLen.textContent=`${r} chars (~${n} tokens est.)`}if(this.dbgPromptView&&(this.dbgPromptView.textContent=a||"Nenhum prompt enviado at\xE9 o momento."),this.dbgContextView)if(t){let r={scope:`${t.scope.tagName.toLowerCase()}${t.scope.id?"#"+t.scope.id:""}${t.scope.className?"."+t.scope.className.split(" ").join("."):""}`,questionLength:t.questionText.length,questionSnippet:t.questionText.slice(0,150)+(t.questionText.length>150?"...":""),controlsCount:t.controls.length,controls:t.controls.map((n,s)=>({index:s+1,tag:n.tag,type:n.type,name:n.name||void 0,id:n.id||void 0,value:n.value||void 0,label:n.label||void 0,role:n.role}))};this.dbgContextView.textContent=JSON.stringify(r,null,2)}else this.dbgContextView.textContent="Aguardando captura de contexto pelo EasyQuiz...";this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let a=new Date,r=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}:${String(a.getSeconds()).padStart(2,"0")}.${String(Math.floor(a.getMilliseconds()/100))}`,n=e;e.startsWith(">")?n=`> [${r}] ${e.slice(1).trim()}`:n=`[${r}] ${e}`;let s="all";t==="text-red"||n.includes("[ERRO]")||n.includes("Falha")||n.includes("Error")?s="error":n.includes("[IA]")||n.includes("[RAG]")||n.includes("Tokens")||n.includes("Gemini")||n.includes("Modelo:")?s="ai":(n.includes("[DOM]")||n.includes("[EXEC]")||n.includes("[VERIF]")||n.includes("[NAV]"))&&(s="dom");let i={id:Date.now()+Math.random(),timestamp:r,message:n,colorClass:t,category:s};for(this.logEntries.push(i);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),s==="error"&&this.setLastError(n),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===s)){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.liveDebugTerminal.appendChild(d);this.liveDebugTerminal.children.length>250;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.apConsole.appendChild(d),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.executionConsole.appendChild(d),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let a=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${a}%`,this.progressVal&&(this.progressVal.textContent=`${a}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),a>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions,this.renderMediaTab())),this.activeTab==="brain"?(this.renderContextTree(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&this.renderContextTree(),(this.activeTab==="media"||e.length>0)&&this.renderMediaTab()}renderMediaTab(){let e=this.shadow?.querySelector("#eq-media-grid"),t=this.shadow?.querySelector("#eq-media-count-badge");if(!e)return;let a=this.latestImages,r=this.latestImageDescriptions;if(t&&(t.textContent=`${a.length} m\xEDdias`),a.length===0){e.innerHTML=`
        <div class="text-muted" style="padding: 16px 0; text-align: center;">
          Nenhuma imagem capturada ainda.<br>
          <span style="font-size: 10px; opacity: 0.6;">Ative \u201CVis\xE3o Computacional\u201D nas configura\xE7\xF5es e execute uma an\xE1lise.</span>
        </div>`;return}e.innerHTML="",a.forEach((n,s)=>{let i=r.find(h=>h.index===s),d=n.captureStatus==="captured"?"\u2705":n.captureStatus==="text_only"?"\u{1F4DD}":"\u274C",l=n.captureStatus==="captured"?"Visual":n.captureStatus==="text_only"?"Texto":"Falhou",u=i?.relevant??!0,b=i?.description??(n.textContext||"Aguardando an\xE1lise da IA..."),c=document.createElement("div");c.style.cssText=["background: rgba(255,255,255,0.04)","border: 1px solid rgba(255,255,255,0.08)","border-radius: 8px","overflow: hidden",`border-left: 3px solid ${u?"#5865f2":"#666"}`].join(";");let m=n.base64?`data:${n.mediaType||"image/jpeg"};base64,${n.base64}`:"",p="";m?p=`
        ...
        </div>`;c.innerHTML=p+v,e.appendChild(c)})}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=Pe(),a=this.latestPlan;this.contextTreeContainer.innerHTML="";let r=this.createTreeFolder("\u{1F4C4} P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(r);let n=e?e.controls:[],s=n.map((p,f)=>{let v=p.role==="navigation"||p.type==="button",h=!v&&p.value?` [val: "${p.value}"]`:"";return{label:`[#${f+1}] ${p.type.toUpperCase()}`,value:`${p.label||p.id||p.name||"(Sem r\xF3tulo)"}${h}`.trim(),badge:v?"Navega\xE7\xE3o":p.role||p.type}}),i=this.createTreeFolder(`\u{1F39B}\uFE0F CONTROLES DETECTADOS (${n.length})`,n.length>0,s);this.contextTreeContainer.appendChild(i);let d=t.map((p,f)=>({label:`Mem\xF3ria #${f+1}`,value:p,badge:"RAG"})),l=this.createTreeFolder(`\u{1F9E0} MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,d);if(this.contextTreeContainer.appendChild(l),a){let p=this.createTreeFolder(`\u{1F916} \xDALTIMO PLANO IA (${a.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:a.pageType,badge:`${(a.confidence*100).toFixed(0)}%`},{label:"Modo",value:a.mode},{label:"Racioc\xEDnio",value:a.rationale||"N/A"},...a.actions.map((f,v)=>({label:`A\xE7\xE3o #${v+1} (${f.t})`,value:JSON.stringify(f)}))]);this.contextTreeContainer.appendChild(p)}let u=this.latestImages,b=this.latestImageDescriptions,c=u.map((p,f)=>{let v=b.find(C=>C.index===f),h=p.captureStatus==="captured"?"\u2705":p.captureStatus==="text_only"?"\u{1F4DD}":"\u274C",g=p.captureStatus==="captured"?"Visual":p.captureStatus==="text_only"?"Texto":"Falhou",y=v?v.relevant?"\u{1F3AF} Relevante":"\u26A0\uFE0F Ignorada":"\u2014",x=v?v.description:p.textContext?p.textContext:"Aguardando an\xE1lise IA...";return{label:`${h} Img ${f+1} [${g}]`,value:`${x}`,badge:y,imgSrc:p.base64?`data:${p.mediaType||"image/jpeg"};base64,${p.base64}`:void 0}}),m=this.createTreeFolder(`\u{1F5BC}\uFE0F IMAGENS DETECTADAS (${u.length})`,!0,c);this.contextTreeContainer.appendChild(m)}createTreeFolder(e,t,a){let r=document.createElement("div");r.className="eq-tree-node";let n=document.createElement("div");n.className="eq-tree-header",n.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let s=document.createElement("div");if(s.className="eq-tree-content",s.style.display=t?"flex":"none",a.length===0)s.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let i of a){let d=document.createElement("div");d.className="eq-tree-leaf";let l="";i.imgSrc&&i.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${i.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),d.innerHTML=`
...
`)).then(()=>{if(this.metricsCopyBtn){let a=this.metricsCopyBtn.innerHTML;this.metricsCopyBtn.innerHTML="\u2713 Copiado!",setTimeout(()=>{this.metricsCopyBtn.innerHTML=a},1500)}})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Po(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function zo(){let o=window;if(Te(),Po(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=Je(),t=null,a=null,r=0,n=new Qe(e,{onAnalyze:(l=1,u,b=!1)=>s(l,u,b),onApply:(l=1)=>void i(l),onDestroy:()=>{if(a){try{a.abort()}catch{}a=null}me(),delete o.__easyquiz},onCancel:()=>{if(a){try{a.abort()}catch{}a=null}me(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=qt(l)}});o.__easyquiz={toggle:()=>n.toggle(),destroy:()=>n.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q")){if(l.preventDefault(),!n)return;n.toggle(!0),s()}});async function s(l=1,u,b=!1){if(!e.apiKey){n.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),n.toggle(!0);return}if(a)try{a.abort()}catch{}a=new AbortController;let c=a,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){n.setBusy(!1),n.setProgress(0);return}r=Date.now(),n.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),n.setProgress(20,"Varrendo escopo do DOM e controles..."),me(),n.hideFloatingAnswers();try{let p=de(!1);p||(n.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=re()),He(p.scope),n.updateContext(p),n.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),n.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),n.setProgress(40,`Consultando Gemini (${e.model})...`);let f=await yt(p.scope,e.useVision);if(f.length>0){let C=f.map(T=>T.element).filter(Boolean);ft(C),n.updateImages(f)}if(c.signal.aborted)return;let v=e.model;n.setStatus(f.length>0?`Consultando Gemini (${v}) com ${f.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${v}) via DOM nativo (modo r\xE1pido)...`,"info");let h=Ae(p,f,e);n.setInspectorPrompt(h,e.model);let g=(C,T)=>{n.setStatus(C,T==="warning"?"info":T);let M=C.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(M){let A=M[1].split(",")[0].trim();n.setProgress(50,`Gemini ${A} respondendo...`)}},{plan:y,usedModel:x}=await Ne(p,f,e,g,c.signal);if(c.signal.aborted)return;if(y.needsMoreContext){if(n.setProgress(55,"Ampliando escopo da quest\xE3o..."),n.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=de(!0),p||(p=re()),He(p.scope),n.updateContext(p),f=await yt(p.scope,e.useVision),f.length>0){let M=f.map(A=>A.element).filter(Boolean);ft(M),n.updateImages(f)}n.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let C=Ae(p,f,e);n.setInspectorPrompt(C,e.model),y=(await Ne(p,f,e,g,c.signal)).plan}if(c.signal.aborted)return;if(n.setProgress(70,"Resposta recebida da IA! Processando plano..."),n.logToConsole(`> [IA] Modelo: ${x||e.model} | Modo: ${y.mode} | Confian\xE7a: ${(y.confidence*100).toFixed(0)}%`,"text-green"),y.rationale&&n.logToConsole(`> [IA] Racioc\xEDnio: "${y.rationale}"`,"text-blue"),n.logToConsole(`> [IA] ${y.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),y.memoryToStore&&(Ct(y.memoryToStore),n.logToConsole(`> [RAG] \u{1F9E0} Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${y.memoryToStore}"`,"text-yellow")),y.imageDescriptions&&y.imageDescriptions.length>0){n.logToConsole(`> [VISION] \u{1F5BC}\uFE0F An\xE1lise de ${y.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let C of y.imageDescriptions){let T=C.relevant?"\u2705":"\u26A0\uFE0F";n.logToConsole(`>   ${T} Imagem ${C.index+1} [${C.relevant?"RELEVANTE":"IGNORADA"}]: ${C.description}`,C.relevant?"text-blue":"text-yellow")}}return t=y,n.updateContext(p,y),Ft(y.actions,y.confidence),n.setPlan(y,!e.dryRun),y.pageType==="conclusion"?(n.setProgress(100,"Atividade conclu\xEDda!"),n.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):y.pageType==="info"?(n.setProgress(100,"Contexto absorvido na mem\xF3ria!"),n.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):y.pageType==="start"?(n.setProgress(100,"In\xEDcio detectado!"),n.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(n.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),n.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&y.pageType==="question"&&n.showFloatingAnswers(y),c.signal.aborted?void 0:((b||e.autoApply)&&!e.dryRun&&await i(l,c.signal,b),y)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){me(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}me(),n.setProgress(0);let f=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";n.setStatus(f,"error"),n.setErrorDiagnostic(f,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),a===c&&(a=null),c.signal.aborted||n.setBusy(!1)}}async function i(l=1,u,b=!1){if(u?.aborted)return;if(!t){n.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){n.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(v=>v.t!=="adv"),p=t.pageType==="question"||Ve(t.rationale||"");if(p&&m.length===0){n.logToConsole("> [NAV] \u26D4 Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let f=(b||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);n.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),n.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),n.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let v=await Ie(t,f,l,ve(e));if(u?.aborted)return;if(n.setExecutionReport(v),v.failedActions&&v.failedActions.length>0){n.logToConsole(`> [REPLAN] \u26A0\uFE0F ${v.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let C of v.failedActions){let T=C.action,M=T.t==="drag"?`drag: "${T.from}" \u2192 "${T.to}"`:T.t==="clk"||T.t==="chk"?`${T.t}: "${T.id}"`:T.t==="val"?`val: "${T.id}" = "${T.v}"`:JSON.stringify(T).slice(0,80);n.logToConsole(`>   \u2717 [${T.t.toUpperCase()}] ${M} | ${C.evidence.slice(0,80)}`,"text-yellow")}await d(v.failedActions,u)}let h=r>0?Date.now()-r:1200,g=v.verified>0,y=v.applied>0;if(v.success||g&&y){n.setProgress(100,"Sucesso! Resposta preenchida."),n.logToConsole(`> [DOM] \u2713 ${v.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${v.verified} verificada(s) no DOM.`,"text-green"),v.advanced?n.logToConsole("> [NAV] \u2713 Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):f&&n.logToConsole(`> [NAV] ${v.navigationEvidence}`,"text-blue"),n.setStatus(v.advanced?`Sucesso: ${v.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${v.applied} a\xE7\xE3o(\xF5es)).`,"success"),n.hideFloatingAnswers();let C=At({id:`q-${Date.now()}`,questionIndex:(Ce().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:h,status:"answered",mode:t.mode,actionsCount:v.applied});n.updateTimingMetrics(C)}else y?(n.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),n.logToConsole(`> [DOM] \u26A0\uFE0F ${v.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${v.failed.join(", ")||"nenhuma"}`,"text-yellow"),n.setStatus(`Resposta preenchida (${v.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(n.setProgress(0,"Alvo de resposta n\xE3o localizado."),n.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${v.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),n.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&n.showFloatingAnswers(t))}catch(v){n.setProgress(0);let h=v instanceof Error?v.message:"Falha ao aplicar plano.";n.setStatus(`Erro ao aplicar: ${h}`,"error"),n.logToConsole(`> [ERRO] ${h}`,"text-red")}finally{n.setBusy(!1)}}async function d(l,u){if(!t)return;let b=l.filter(m=>m.action.t==="drag");for(let m of b){if(u?.aborted)return;let p=m.action,f=String(p.from||""),v=String(p.to||""),h=_t(f,v,f,v);n.logToConsole(`> [REPLAN] \u{1F527} Drag JS fallback: "${f}" \u2192 "${v}"`,"text-blue");let g={...t,actions:[{t:"js",v:h}],pageType:"question"},y=await Ie(g,!1,1,ve(e));n.logToConsole(y.applied>0?"> [REPLAN] \u2705 Drag fallback aplicado!":"> [REPLAN] \u2717 Drag fallback sem efeito.",y.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){n.logToConsole(`> [REPLAN] \u{1F504} ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,f=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);n.logToConsole(`> [REPLAN] \u26A1 Recuperando: ${f}`,"text-blue");let v=String(p.id||p.name||p.selector||""),h=p.v!==void 0?String(p.v):"";n.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Ue(m.action),await new Promise(g=>setTimeout(g,250)),Z(m.action)){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 1 OK: ${f}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let g=$(v,h)||$(v.replace(/[^\w\s]/g," ").trim(),h);if(g&&(pt(g),await new Promise(y=>setTimeout(y,300)),Z(m.action))){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 2 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let g=$(v,h)||$(v.replace(/[^\w\s]/g," ").trim(),h);if(g&&(g.focus?.(),await new Promise(y=>setTimeout(y,50)),g.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),g.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80)),g.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),g.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200)),Z(m.action))){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 3 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){n.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let g=$(v,h)||$(v.replace(/[^\w\s]/g," ").trim(),h);if(g){let y=g.id,x=!!y;y||(y=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,g.id=y);let C=String(p.v??""),T=p.t==="val",M=document.createElement("script");if(M.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(M),M.remove(),x||setTimeout(()=>{try{g.id===y&&g.removeAttribute("id")}catch{}},0),await new Promise(A=>setTimeout(A,300)),Z(m.action)){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 4 OK: ${f}`,"text-green");continue}}}catch{}}if(u?.aborted)return;n.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let g="";try{let q=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(H=>(H.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));q&&(g=q.outerHTML.slice(0,400))}catch{}let y=de(!1)||re(),x=`A\xE7\xE3o (${p.t}) alvo="${v}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${g?`
HTML do alvo: ${g}`:""}`,C=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],T=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
