...
`;function Kt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=Eo,document.head.appendChild(o)}}catch{}}function fe(){ne&&(ne.style.removeProperty("outline"),ne.style.removeProperty("outline-offset"),ne.style.removeProperty("position"),ne=null);for(let o of ve)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ve=[];for(let o of ht)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");ht=[];for(let o of gt)try{o.remove()}catch{}gt=[],me&&typeof window<"u"&&(window.removeEventListener("scroll",me),window.removeEventListener("resize",me),me=null);for(let o of bt)try{o.remove()}catch{}if(bt=[],se){try{se.remove()}catch{}se=null}}function At(o){Kt();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),ht.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,i=r.height||t.offsetHeight||200;if(n>10&&i>10){let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
          position: absolute;
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-status-card eq-status-card-resolver" id="eq-status-card" aria-expanded="true">
                  ...
                  <div class="eq-status-summary" id="eq-status-summary" id="eq-status-text-ap">Sistema aguardando leitura da p\xE1gina.</div>
