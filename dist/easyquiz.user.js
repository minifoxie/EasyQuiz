 ...
 */
"use strict";(()=>{var re={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0};function $(n){if(!n||typeof n!="string")return!1;let e=n.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of t)if(e.includes(o))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var nt="easyquiz_settings_v2",xe="easyquiz_activity_metrics";function ot(){try{let n=localStorage.getItem(nt);if(!n){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let i=JSON.parse(r);return{...re,apiKey:i.apiKey||""}}return{...re}}let e=JSON.parse(n),t=typeof e.model=="string"&&$(e.model)?e.model:re.model,o=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],s=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(o.length===0&&s&&(o=[s]),o.length===0)try{let r=localStorage.getItem("easyquiz_api_keys");if(r){let i=JSON.parse(r);Array.isArray(i)&&(o=i.filter(c=>typeof c=="string"&&c.trim().length>5))}}catch{}return{apiKey:o[0]||s||re.apiKey,apiKeys:o,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:re.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:re.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:re.confidenceThreshold}}catch{return{...re}}}function Lt(){try{localStorage.removeItem(nt),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(xe),sessionStorage.removeItem(xe);let n=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&n.push(t)}n.forEach(e=>localStorage.removeItem(e)),je()}catch(n){console.warn("[EasyQuiz] Erro ao resetar dados:",n)}}function at(n){try{let e=localStorage.getItem("eq_domain_cache_"+n);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+n)}catch{}}return t}catch{return{}}}function it(n,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...at(n),...e};try{localStorage.setItem("eq_domain_cache_"+n,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function St(n){let e=ot(),t=Array.isArray(n.apiKeys)?n.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,o;typeof n.apiKey=="string"?o=n.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(n.apiKeys)&&n.apiKeys.length>0?o=t[0]||"":o=e.apiKey,o&&!t.includes(o)&&(t=[o,...t]),t.length>0&&(!o||!t.includes(o))&&(o=t[0]);let s={...e,...n,apiKey:o,apiKeys:t};try{localStorage.setItem(nt,JSON.stringify(s)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return s}var ye=[],kt=12,nn=1200;function Mt(n){let e=n.trim().replace(/\s+/g," ").slice(0,nn);e&&!ye.includes(e)&&(ye.push(e),ye.length>kt&&(ye=ye.slice(-kt)))}function Qe(){return ye}function je(){ye=[]}function It(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Se=It();function Me(){try{localStorage.removeItem(xe)}catch{}return Se}function on(n){Se=n;try{let e=JSON.stringify(n);sessionStorage.setItem(xe,e),localStorage.removeItem(xe)}catch{}}function Ht(n){let e=Se,t=Date.now(),o=e.records[e.records.length-1];if(o&&o.id===n.id&&t-o.timestamp<3e3)return e;let s={...n,timestamp:t},a=[...e.records,s],r=a.filter(u=>u.status==="answered"||u.status==="verified").length,i=a.reduce((u,f)=>u+f.durationMs,0),c=r>0?Math.round(i/r):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),i),completedQuestionsCount:r,averageDurationMs:c,records:a};return on(l),l}function Ie(){Se=It();try{sessionStorage.removeItem(xe),localStorage.removeItem(xe)}catch{}return Se}var zt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let A=p.filter(q=>q.type==="checkbox"||q.type==="chk"),y=new Set(p.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),C=A.filter(q=>!q.name||!y.has(q.name)),T=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),x=C.length>=2||T,E=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&y.size>=1,k=p.every(q=>q.type==="radio"||q.type==="chk")&&y.size===1&&!x&&!E,w=p.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),I=w.length>=2;return(E?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
...
${e.length===0?"Nenhum anexo visual.":e.map((A,y)=>{let C=A.associatedLabel||"Gr\xE1fico da Quest\xE3o",T=A.alt?` | alt: "${A.alt}"`:"";if(A.captureStatus==="text_only")return`  - Imagem ${y+1} [CONTEXTO_TEXTUAL]: ${C}${T} | ${A.textContext||"sem contexto adicional"}`;if(A.captureStatus==="captured"||A.base64){let x=A.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${A.textContext}"`:"";return`  - Imagem ${y+1} [VISUAL_INLINE]: ${C}${T}${x}`}return`  - Imagem ${y+1} [FALHOU]: ${C}${T}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var sn=new Set(["question","info","start","conclusion"]),rn=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),ln=new Set(["val","chk","sel","clk","adv","js","drag"]),cn=150,ze=2e3;function _(n,e=""){return n==null?e:typeof n=="string"?n.trim().slice(0,ze):typeof n=="number"||typeof n=="boolean"?String(n).trim().slice(0,ze):e}function dn(n,e){if(!n||typeof n!="object")return null;let t=n,o=t.t;if(typeof o!="string"||!ln.has(o))return null;if(o==="adv"){let i=t.id??t.target??t.name??t.selector;return{t:"adv",..._(i)?{id:_(i,"").slice(0,500)}:{}}}if(o==="drag"){let i=_(t.from??t.source),c=_(t.to??t.target??t.destination);return!i||!c?null:{t:"drag",from:i.slice(0,500),to:c.slice(0,500)}}if(o==="js"){let i=_(t.v??t.code??t.script);return!i||i.length>8e3?null:{t:"js",v:i}}let s=t.id??t.target??t.name??t.selector??t.element;(s==null||s==="")&&o==="val"&&(s="1");let a=_(s).slice(0,500);if(!a)return null;if(o==="val"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:_(i).slice(0,ze)}}if(o==="sel"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(i)?i:[i]).map(u=>_(u).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:l}}if(o==="chk"){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",c={t:"chk",id:a,c:!i};return t.v!==void 0&&(c.v=_(t.v).slice(0,ze)),c}let r={t:"clk",id:a};if(t.c!==void 0){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!i}return t.v!==void 0&&(r.v=_(t.v).slice(0,ze)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(i=>typeof i=="number"&&Number.isFinite(i))&&(r.co=[t.co[0],t.co[1]]),r}function un(n,e,t){if(t!=="question")return n;let o=n.filter(a=>a.t==="adv"),s=n.filter(a=>a.t!=="adv");if(e==="escolha_unica"){s=s.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=s.filter(r=>r.t==="chk"||r.t==="clk");if(a.length>1){let r=s.filter(c=>c.t!=="chk"&&c.t!=="clk"),i=a[a.length-1];s=[...r,i]}}else if(e==="escolha_multipla"){s=s.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=new Set;s=s.filter(r=>{let i="id"in r&&typeof r.id=="string"?r.id:"";return i?a.has(i)?!1:(a.add(i),!0):!0})}else if(e==="verdadeiro_falso"){let a=new Set,r=[...s].reverse(),i=[];for(let c of r){let l="id"in c&&typeof c.id=="string"?c.id:"";l?a.has(l)||(a.add(l),i.push(c)):i.push(c)}s=i.reverse()}return[...s,...o]}function Pt(n){if(!n||typeof n!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=n,t=e.pageType,o=e.mode;(typeof t!="string"||!sn.has(t))&&(t="question"),(typeof o!="string"||!rn.has(o))&&(o="escolha_unica");let s=Array.isArray(e.actions)?e.actions:[],a=[];for(let c=0;c<Math.min(s.length,cn);c++){let l=dn(s[c],c);l&&a.push(l)}a.some(c=>c.t==="val")&&(o==="escolha_unica"||!e.mode)&&(o="preenchimento"),a.some(c=>c.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(o)&&(o="arrastar_soltar"),a=un(a,o,t);let r=a.some(c=>c.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?r||a.push({t:"adv"}):t==="question"&&!r&&a.push({t:"adv"});let i=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:o,confidence:i,rationale:_(e.rationale,"Plano validado e auto-recuperado."),actions:a,..._(e.memoryToStore)?{memoryToStore:_(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var te=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let o=e.flatMap(a=>a.split(/[\n\r]+/));Array.from(new Set(o.map(a=>a.trim().replace(/^["']|["']$/g,"")).filter(a=>a.length>5))).forEach((a,r)=>{let i=this.generateId(a),c=t.get(i)||t.get(a);this.keys.set(i,{id:i,key:a,label:c?.label||`Chave ${r+1}`,addedAt:c?.addedAt||Date.now(),lastUsedAt:c?.lastUsedAt,lastLatencyMs:c?.lastLatencyMs,cooldownUntil:c?.cooldownUntil,errorCount:c?.errorCount||0,lastError:c?.lastError,winCount:c?.winCount||0})})}generateId(e){let t=0;for(let s=0;s<e.length;s++)t=(t<<5)-t+e.charCodeAt(s),t|=0;let o=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${o}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let o=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:o>0,remainingCooldownMs:o}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),o=Array.from(this.keys.values()).filter(a=>(a.errorCount||0)<50);if(o.length===0)return Array.from(this.keys.values()).slice(0,e);let s=o.filter(a=>(a.cooldownUntil||0)<=t);return s.length>0?(s.sort((a,r)=>{let i=a.lastLatencyMs!==void 0?a.lastLatencyMs:99999,c=r.lastLatencyMs!==void 0?r.lastLatencyMs:99999;if(i!==c)return i-c;let l=(a.lastUsedAt||0)-(r.lastUsedAt||0);return l!==0?l:a.addedAt-r.addedAt}),s.slice(0,e)):(o.sort((a,r)=>(a.cooldownUntil||0)-(r.cooldownUntil||0)),o.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let o=this.findKeyObj(e);o&&(o.lastLatencyMs=t,o.lastUsedAt=Date.now(),o.errorCount=0,o.lastError=void 0,o.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let o=this.findKeyObj(e);o&&(o.errorCount=99,o.lastError=t)}addKey(e,t){let o=e.trim().replace(/^["']|["']$/g,"");if(!o)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(o.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let s=this.generateId(o);if(this.keys.has(s)||Array.from(this.keys.values()).some(i=>i.key===o))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let r={id:s,key:o,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(s,r),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:r}}updateKey(e,t,o){let s=this.keys.get(e);if(!s)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=t.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(s.key=a,o!==void 0&&(s.label=o.trim()),s.errorCount=0,s.cooldownUntil=void 0,s.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},V=new te;var Te=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Dt=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],pn={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function lt(n){return pn[n]??n}function mn(n,e){let o={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??hn};return/lite/i.test(n)||(/gemini-3\.[0-9]+-?flash/i.test(n)?o.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(n)&&(o.thinkingConfig={thinkingBudget:0})),o}var hn={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Bt(n){let e=n.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=lt(e);return $(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function rt(n,e){let t="";try{let o=JSON.parse(n);t=o.error?.message||o.message||""}catch{t=n.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function gn(n){let e=n.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let o=e.match(/\{[\s\S]*\}/);if(o)try{return JSON.parse(o[0].trim())}catch{}try{let s=e.indexOf("{");if(s!==-1){let a=e.slice(s).trim();a=a.replace(/,\s*\{[^}]*$/,""),a=a.replace(/,\s*$/,"");let r=0,i=0,c=!1,l=!1;for(let f=0;f<a.length;f++){let d=a[f];if(l){l=!1;continue}if(d==="\\"){l=!0;continue}if(d==='"'){c=!c;continue}c||(d==="{"?r++:d==="}"?r=Math.max(0,r-1):d==="["?i++:d==="]"&&(i=Math.max(0,i-1)))}for(c&&(a+='"');i>0;)a+="]",i--;for(;r>0;)a+="}",r--;let u=JSON.parse(a);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Nt=(()=>{try{let n=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!n)return null;let e=JSON.parse(n);if(Array.isArray(e)){let t=e.filter(o=>o&&typeof o.id=="string"&&$(o.id));return t.length>0?t:null}return null}catch{return null}})(),st=new Set;async function Ve(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return Te;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of t)try{let s=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!s.ok){let r=await s.text(),i=rt(r,s.status);if(i.includes("inv\xE1lida")||i.includes("n\xE3o autorizada"))throw new Error(i);continue}let a=await s.json();if(Array.isArray(a.models)&&a.models.length>0){let r=a.models.filter(i=>{let c=i.supportedGenerationMethods||[],l=(i.name||"").replace(/^models\//,""),u=c.includes("generateContent");return $(l)&&u}).map(i=>{let c=i.supportedGenerationMethods||[],l=i.name.replace(/^models\//,""),u=i.displayName||l;return{id:l,name:u.includes(l)?u:`${u} (${l})`,description:i.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(r.length>0){r.sort((i,c)=>{let l=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return l(c.id)-l(i.id)}),Nt=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(s){if(s.message?.includes("Chave de API"))throw s}return Te}async function Ue(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await Ve(e);if(o.length>0&&o!==Te){let s=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${s.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let o of t)for(let s of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${s}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${s})!`,models:Te}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function ct(n,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:n,key:"",message:"Nenhuma chave dispon\xEDvel."};let o=lt(Bt(n)),s=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),a={"Content-Type":"application/json"};async function r(l,u,f){let d=new AbortController,m=setTimeout(()=>d.abort(),f);try{let p=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(l)}`,h=await fetch(p,{method:"POST",headers:{...a,"x-goog-api-key":l},body:s,signal:d.signal});if(clearTimeout(m),h.ok)return{ok:!0,model:u,key:l,message:`Modelo '${u}' validado com sucesso!`};let b=await h.text().catch(()=>"");throw new Error(`HTTP ${h.status}: ${b.slice(0,80)}`)}catch(p){throw clearTimeout(m),p}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(f=>r(f,o,8e3)))}catch{}}let i=t[0],c=[o,...Dt.filter(l=>l!==o)];for(let l of c)try{let u=await r(i,l,4e3);return l!==o&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),u}catch{}return{ok:!1,model:o,key:i,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function fn(n,e,t,o,s){let a=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${n}`),c={...mn(n,s)};for(let l of a){if(o.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${l}/models/${n}:generateContent?key=${encodeURIComponent(e)}`,f=Date.now();try{let d=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(!d.ok){let h=await d.text();if(d.status===400){let v=/thinking/i.test(h),A=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(h);if((v||A)&&(c.thinkingConfig||c.responseSchema)){let y={...c};v&&delete y.thinkingConfig,A&&(delete y.responseSchema,delete y.responseMimeType),c=y;let C=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(C.ok){let E=await C.json(),k=E.candidates?.[0];if(k?.content?.parts?.[0]?.text)return V.markSuccess(e,Date.now()-f),{rawText:k.content.parts[0].text,data:E,usedModel:n,usedKey:e}}let T=await C?.text?.().catch(()=>"")??h,x=rt(T,d.status);throw new Error(`[${n}|${te.maskKey(e)}] ${x}`)}}let b=rt(h,d.status);if(d.status===404&&l==="v1beta")continue;throw d.status===429?(V.markQuotaHit(e,8e3),Rt(e,n,1e4),new Error(`[${n}|${te.maskKey(e)}] ${b}`)):(d.status===503||/no capacity|overloaded|unavailable/i.test(h)?(V.markOverloaded(e,5e3),st.add(n)):d.status===403||/API_KEY_INVALID/i.test(h)?V.markInvalid(e,b):d.status===404&&st.add(n),new Error(`[${n}|${te.maskKey(e)}] ${b}`))}let m=await d.json(),p=m.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error(`[${n}|${te.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return V.markSuccess(e,Date.now()-f),{rawText:p.content.parts[0].text,data:m,usedModel:n,usedKey:e}}catch(d){if(o.aborted)throw d;r=d;let m=r.message||"";if(m.includes("404")||/no longer available/i.test(m)){st.add(n);break}if(m.includes("429")||m.includes("Quota"))break}}throw r}var Fe=new Map;function Ot(n,e){let t=`${n}::${e}`,o=Fe.get(t);return o===void 0?!1:Date.now()>o?(Fe.delete(t),!1):!0}function Rt(n,e,t=1e4){Fe.set(`${n}::${e}`,Date.now()+t)}function dt(){Fe.clear()}async function Xe(n,e,t,o,s,a){if(s?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let r=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];V.init(r);let i=t.apiKey.trim().replace(/^["']|["']$/g,""),c=V.getBestKey()||i;if(!c)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=Bt(t.model);if(!Nt&&c&&Ve(c).catch(()=>{}),s?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),f=He(n,e,t),d=[{text:f}];for(let P=0;P<e.length;P++){let q=e[P],z=q.associatedLabel||(q.alt?`Imagem: ${q.alt}`:`Imagem ${P+1}`);if(q.captureStatus==="text_only"||!q.base64){let R=q.textContext||q.alt||"";d.push({text:`[CONTEXTO_IMAGEM_${P+1} - V\xCDNCULO: ${z}]: ${R}`})}else d.push({text:`[ANEXO VISUAL ${P+1} - V\xCDNCULO: ${z}]:`}),d.push({inline_data:{mime_type:q.mediaType,data:q.base64}})}let m={system_instruction:{parts:[{text:a?.systemPromptOverride??zt}]},contents:[{role:"user",parts:d}]},p=lt(l),h=Dt.filter(P=>P!==p),v=V.getAllKeys().length,A=P=>v<=1||P===0?1:2,y=new Set,C=(P,q)=>{let z=/pro/i.test(P),R=/lite/i.test(P);return z?q===0?18e3:q===1?24e3:3e4:R?q===0?1e4:q===1?14e3:18e3:q===0?16e3:q===1?2e4:25e3},T=async(P,q)=>{if(q.length===0||s?.aborted)return null;let z=q.map(()=>new AbortController),R=()=>z.forEach(S=>{try{S.abort()}catch{}});s?.addEventListener("abort",R,{once:!0});let U=q.map(S=>`${S.model.replace("gemini-","")}/${S.label}`).join(" | ");o?.(`\u26A1 ${P}: ${q.length} slot(s) [${U}]...`,"info");try{let S=q.map(async(O,F)=>{let H=z[F],B=setTimeout(()=>{try{H.abort(new Error(`Timeout ${O.timeout/1e3}s (${O.model}|${O.label})`))}catch{H.abort()}},O.timeout);try{let Q=await fn(O.model,O.key,m,H.signal,a?.generationSchemaOverride);clearTimeout(B);let K=Pt(gn(Q.rawText));return K.usedModel=Q.usedModel,K.durationMs=Date.now()-u,K.promptSent=f,K.tokensUsed=Q.data.usageMetadata?.totalTokenCount,K.promptTokens=Q.data.usageMetadata?.promptTokenCount,K.candidatesTokens=Q.data.usageMetadata?.candidatesTokenCount,K.rawResponse=Q.rawText,z.forEach((ue,Ae)=>{if(Ae!==F)try{ue.abort(new Error("Cancelado: vencedor respondeu."))}catch{ue.abort()}}),{plan:K,rawUsage:Q.data.usageMetadata,usedModel:Q.usedModel,usedKey:Q.usedKey,slotLabel:O.label}}catch(Q){clearTimeout(B);let K=Q instanceof Error?Q.message:String(Q);throw(K.includes("429")||K.includes("Quota")||K.includes("RESOURCE_EXHAUSTED"))&&(Rt(O.key,O.model,1e4),V.markQuotaHit(O.key,8e3)),Q}}),D=await Promise.any(S);return s?.removeEventListener("abort",R),V.markWinner(D.usedKey),D}catch(S){return s?.removeEventListener("abort",R),S instanceof AggregateError&&S.errors.length>0?w=S.errors.map(D=>D instanceof Error?D.message:String(D)).join(" | "):S instanceof Error&&(w=S.message),console.warn(`[EasyQuiz ${P}] Falha na onda:`,w),null}},E=(v<=1?1:1+Math.ceil((v-1)/2))+4,k=0,w="",I=0;for(;k<E;){if(s?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let P=V.getRoundRobinKeys(v),q=P.filter(H=>!y.has(`${H.key}::${p}`)&&!Ot(H.key,p)),z,R;if(q.length>0)z=p,R=q;else{let H=h;z=H[I%H.length]||p,I++;let B=P.filter(Q=>!y.has(`${Q.key}::${z}`)&&!Ot(Q.key,z));R=B.length>0?B:P.filter(Q=>!y.has(`${Q.key}::${z}`))}if(R.length===0){if(I<h.length)continue;break}let U=R.slice(0,A(k));if(U.length===0)break;let S=C(z,k),D=U.map(H=>(y.add(`${H.key}::${z}`),{model:z,key:H.key,label:H.label||"Chave",timeout:S})),O=k===0?"Onda 1":`Onda ${k+1}`,F=await T(O,D);if(F){let H=F.plan.durationMs||Date.now()-u,B=te.maskKey(F.usedKey);return o?.(`\u2705 ${H}ms via '${F.usedModel}' (${F.slotLabel}: ${B})`,"info"),F}k++}throw new Error(w||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var bn=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function we(n){let e=n?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return n?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!n?.autoAdvance}}function ut(n,e){if(n.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(n.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Qt(n){if(!n.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(n.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(bn.find(t=>t.test(n)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(n)&&!n.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var qe=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),Oe=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,le=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,vn=0;function pt(n){try{let e=n.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!pe(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(n):n.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof n.getBoundingClientRect=="function"){let e=n.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(n.textContent||"").trim().length>0}function J(n){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(n)}catch{}return String(n).replace(/["\\]/g,"\\$&")}function N(n){let e=n;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||pe(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let o=e.type?.toLowerCase();if(o==="checkbox"||o==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${J(e.id)}"]`);if(a&&pt(a))return!0}catch{}let s=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(s&&s!==e&&pt(s))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return pt(e)}function An(n){if(n==null)return"";if(typeof n=="string")return n;if(typeof n=="number"||typeof n=="boolean")return String(n);if(n instanceof Node)return n.textContent||"";try{if(typeof n?.toString=="function"){let e=n.toString();if(typeof e=="string")return e}}catch{}return""}function G(n,e=500){return An(n).replace(/\s+/g," ").trim().slice(0,e)}function yn(n){let e=n.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(vn+=1).toString(36)}`;return n.dataset.easyquizId=t,t}function pe(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Pe=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function W(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element))return!1;if(pe(n))return!0;let e=n.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((n.type||"").toLowerCase()))return!1;let o=n.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||n,s=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||""),a=String(o.getAttribute?.("aria-label")||""),r=String(o.getAttribute?.("title")||""),i=typeof o.className=="string"?o.className:typeof o.className?.baseVal=="string"?o.className.baseVal:"",c=G(o.textContent,60);return!!(Pe.test(s)||Pe.test(a)||Pe.test(r)||Pe.test(i)||c.length>0&&c.length<=25&&Pe.test(c))}function ee(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element)||pe(n)||W(n)||n.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||n.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&n instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&n instanceof HTMLButtonElement?n.value:"",t=G(n.getAttribute?.("aria-label")||n.textContent||n.getAttribute?.("value")||e),o=n.type,s=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),a=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||n.getAttribute?.("href")||"").toLowerCase();return le.test(s)||le.test(t)?!1:Oe.test(s)||Oe.test(t)||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!n.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function mt(n){let e=n.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),l=c&&c!==n.closest("td")?G(c.textContent,100):"",u=G(n.closest("label, td")?.textContent||"",50);if(l&&u)return`${l}: ${u}`}let t=n.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let c=t.querySelector('.dropdown-label, [class*="label" i]'),l=c&&c!==n?G(c.textContent,150):"";if(l)return l}let o=n.getAttribute("aria-label");if(o)return G(o);let s=n.getAttribute("aria-labelledby");if(s){let c=s.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(c.trim())return G(c)}if("labels"in n&&n.labels){let c=Array.from(n.labels??[]).map(l=>l.textContent).join(" ");if(c.trim())return G(c)}let a=n.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==n){let c=G(a.textContent);if(c)return c}let r=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",i=n.getAttribute("placeholder")||n.getAttribute("title")||n.textContent||r||"";return G(i)}function ht(n,e){let o=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName.toLowerCase()==="select"?n:null,s=n;n.dataset.easyquizRole=e;let a=n.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(a)?a:"other",i=n.getAttribute("role")||"",c=(n.getAttribute("data-testid")||n.getAttribute("data-test-id")||"").toLowerCase(),l=(n.className&&typeof n.className=="string"?n.className:"").toLowerCase(),u=n.getAttribute("draggable")==="true"||n.classList.contains("perseus-drag-item")||n.classList.contains("sortable-item")||l.includes("cursor-grab")||!!n.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(l),f=n.getAttribute("data-role")==="dropzone"||n.classList.contains("category-container")||n.hasAttribute("data-category")||!!n.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(l),m=G((u?"draggable":f?"dropzone":"")||s.type||i||r,40),p="";if(s.type==="checkbox"||s.type==="radio"||i==="radio"||i==="checkbox"){let C=s.checked||n.getAttribute("aria-checked")==="true",T=s.value&&s.value!=="on"?s.value:n.getAttribute("data-value")||"";p=C?T?`checked:${T}`:"checked":T||"unchecked"}else if(r==="button"||a==="a"||e==="navigation"||ee(n))p="";else{let C=typeof n.value=="string"||typeof n.value=="number"?n.value:"";p=G(C||n.getAttribute("data-category")||"",2e3)}let h=[];if(o&&o.options)for(let C of Array.from(o.options).slice(0,80))h.push({value:G(C.value),label:G(C.textContent)});else if(i==="combobox"||i==="listbox"||l.includes("select")||l.includes("dropdown")){let C=n.getAttribute("aria-controls")||n.getAttribute("aria-owns"),T=C?document.getElementById(C):n;if(T){let x=T.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let E of Array.from(x).slice(0,80)){let k=G(E.textContent);k&&h.push({value:E.getAttribute("data-value")||E.getAttribute("value")||k,label:k})}}}let b=!!(s.required||n.getAttribute("aria-required")==="true"),v=!!(s.disabled||n.getAttribute("aria-disabled")==="true"),A=yn(n);return{id:n.id||A,tag:r,type:m,label:mt(n),name:G(s.name||n.getAttribute("name")||"",180),value:p,options:h,required:b,disabled:v,role:e}}var jt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Ft(n){if(!N(n))return-1/0;let e=n.getBoundingClientRect(),t=Array.from(n.querySelectorAll(qe)).filter(N),o=G(n.innerText||n.textContent||"",4e3).length;if(o<10||!t.length&&o<60)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),r=Math.min(1,a/s),i=e.top+e.height/2,c=Math.abs(i-window.innerHeight/2)/Math.max(1,window.innerHeight),l=o>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,o/20)+l+u-r*20-c*10}function Ge(n){let e=n;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,o=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&o!=="main"&&o!=="body"){e=t;break}let s=G(e.innerText||e.textContent||"",1e4),a=G(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(qe).length,i=t.querySelectorAll(qe).length;if(s.length<150&&a.length>s.length&&i<=r+4&&o!=="main"&&o!=="body"){e=t;continue}break}return e}function Vt(n){let e=n,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&N(t))return t;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Z(){let n=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(n&&N(n))return n;let e=document.activeElement;if(e&&e!==document.body){let r=e.closest(jt);if(r&&Ft(r)>0)return Ge(r)}let o=Array.from(document.querySelectorAll(jt)).map(r=>({element:r,score:Ft(r)})).filter(r=>Number.isFinite(r.score)).sort((r,i)=>i.score-r.score),s=o.find(r=>{let i=r.element.tagName.toLowerCase();return i!=="main"&&i!=="body"&&r.score>0});if(s)return Ge(s.element);if(o.length>0&&o[0].score>0)return Ge(o[0].element);let a=document.querySelector('form, main, [role="main"]');return a&&N(a)?a:document.body}function Ut(n){let e=n.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))t.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ke(n){let e=Array.from(n.querySelectorAll(qe)),t=new Set,o=[];for(let l of e){if(!N(l)||ee(l)||W(l))continue;let u=(l.value||l.textContent||"").trim();if(le.test(u))continue;let f=l.tagName.toLowerCase();["input","textarea","select"].includes(f)&&(t.add(l),o.push(l))}for(let l of e){if(!N(l)||ee(l)||W(l))continue;let u=(l.value||l.textContent||"").trim();if(le.test(u))continue;let f=l.tagName.toLowerCase();if(["input","textarea","select"].includes(f))continue;let d=l.querySelector("input, textarea, select");if(!(d&&t.has(d))){if(l.hasAttribute("for")){let m=l.getAttribute("for"),p=m?l.ownerDocument.getElementById(m):null;if(p&&t.has(p))continue}if(f==="a"){let m=l.getAttribute("role"),p=l.getAttribute("class")||"",h=l.getAttribute("data-testid")||"",b=l.getAttribute("draggable")==="true"||l.classList.contains("perseus-drag-item")||l.classList.contains("sortable-item")||p.includes("cursor-grab")||!!l.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(h)||/drag|card-item|sortable/i.test(p);if(!(m==="button"||m==="radio"||m==="checkbox"||m==="option"||b||l.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}o.push(l)}}let s=o.length>0&&o.every(l=>W(l)||/read-?aloud|audio/i.test(l.getAttribute("data-testid")||l.getAttribute("aria-label")||"")),a=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||n,r=document.body.querySelector('[class*="classification" i]')!==null||n.querySelector('[class*="classification" i]')!==null||n.querySelector('[data-cy*="quiz" i]')!==null||n.querySelector('[class*="draggable-item" i]')!==null||n.querySelector('[class*="drag-item" i]')!==null||n.querySelector('[class*="sortable-card" i]')!==null||n.matches?.('[class*="classification" i]');if((o.length===0||s)&&r){s&&(o.length=0);let l=Array.from(a.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(l.length>0){for(let u of l)if(!(!N(u)||W(u))&&(o.push(u),o.length>=50))break}else{let u=Array.from(a.querySelectorAll("button, div[class], span[class], p, li"));for(let f of u){if(!N(f)||ee(f)||W(f)||le.test((f.textContent||"").trim()))continue;let d=(f.textContent||"").trim();if(d.length<2||d.length>300)continue;if(Array.from(f.children).some(p=>p.className&&p.textContent?.trim())||o.push(f),o.length>=50)break}}}let c=!o.some(l=>["input","select","textarea"].includes(l.tagName.toLowerCase()))&&o.length>0&&o.every(l=>{let u=l.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let f=(l.textContent||"").trim();return!l.id||f.length<10||/^\d+\s*\/\s*\d+$/.test(f)||/^question text/i.test(f)});if(o.length===0||c){c&&(o.length=0);let l=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(l.length>0)for(let u of l){if(!N(u)||pe(u)||ee(u)||W(u)||le.test((u.textContent||"").trim()))continue;let f=(u.textContent||"").trim();if(!(f.length<10||f.length>500)&&!/^\d+\s*\/\s*\d+$/.test(f)&&(o.push(u),o.length>=20))break}}return o.slice(0,100).map(l=>ht(l,"answer"))}function gt(n){let e=[n,n.parentElement,n.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,o=[];for(let s of e)for(let a of Array.from(s.querySelectorAll(qe)))if(!(t.has(a)||!N(a)||!ee(a)||W(a))&&(t.add(a),o.push(ht(a,"navigation")),o.length>=10))return o;return o}function me(n=!1){let e=Z();e=Ge(e),n&&(e=Vt(e));let t=Ke(e),o=gt(e);if(t.length===0){let i=Ke(document.body);i.length>0&&(e=Vt(e),t=Ke(e),t.length===0&&(t=i,e=document.querySelector('main, article, form, [role="main"]')||document.body))}o.length===0&&(o=gt(document.body));let s=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=s.length>4e4?G(s.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+G(s.slice(-2e3),2e3):G(s,16e3),r=[...t,...o].slice(0,120);return!a||r.length===0&&a.length<30?G(document.body.innerText||document.body.textContent||"",16e3).length>=30?ce():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:Ut(e),controls:r,scope:e}}function ce(){let n=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=G(n,16e3),t=Ke(document.body),o=gt(document.body),s=[...t,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Ut(a).slice(0,15e3),controls:s,scope:a}}function ft(n){let e=n.controls.map(t=>{let o=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${o}`}).join("|");return[window.location.href,n.pageTitle,n.questionText.slice(0,400),e].join("::")}function Je(n){if(!n)return!1;let e=n.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(o=>e.includes(o))}function X(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function M(n){return n==null?"":(typeof n=="string"?n:String(n)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function Y(n){if(!n||n instanceof HTMLInputElement||n instanceof HTMLSelectElement||n instanceof HTMLTextAreaElement||n.getAttribute("draggable")==="true"||n.classList.contains("dnd-card")||n.hasAttribute("data-category")||n.hasAttribute("data-dropzone"))return n;if(n.hasAttribute("for")){let o=n.getAttribute("for");if(o){let s=n.ownerDocument.getElementById(o);if(s)return s}}let e=n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let o=e.getAttribute("for"),a=(o?e.ownerDocument.getElementById(o):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=n.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(n.tagName.toLowerCase())){let o=n.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(o)return Y(o)}return n}function Xt(n){let e=n;if(!e||!document.contains(e))try{e=Z()}catch{}e=e||document.body;let t=s=>{let a=Array.from(s.querySelectorAll("tr")).filter(u=>N(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let r=Array.from(s.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>N(u)&&!X(u));if(r.length>0)return r;let c=Array.from(s.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>N(u)&&!X(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return c.length>0?c:Array.from(s.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let f=u;return N(f)&&!X(f)&&(f.textContent||"").trim().length>2&&!ee(f)&&!W(f)&&!f.querySelector("[class]")})},o=t(e);return o.length>0?o:e!==document.body?t(document.body):[]}function j(n,e,t=!1){if(n==null)return null;let s=(typeof n=="string"?n:String(n)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!s)return null;let a=J(s),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!X(r))return Y(r);try{let d=document.getElementById(s);if(d&&N(d)&&!X(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:Y(d)}catch{}try{let d=document.querySelector(`[data-item-id="${a}"]`);if(d&&N(d)&&!X(d))return Y(d)}catch{}let i=s.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(i){let d=parseInt(i[1],10);if(t){let p=document.body;try{p=Z()||document.body}catch{}let h=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>N(b)&&!X(b));if(d>=1&&d-1<h.length)return h[d-1];if(d===0&&h.length>0)return h[0]}let m=d-1;if(m>=0){let p=Xt();if(m<p.length){let v=p[m];if(v.tagName.toLowerCase()==="tr"){if(e){let y=v.querySelector(`input[value="${J(e)}" i], [data-value="${J(e)}" i]`);if(y)return y}let A=v.querySelector("input");if(A)return A}return Y(v)}let h=document.body;try{h=Z()||document.body}catch{}let b=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>N(v)&&!X(v));if(m<b.length)return b[m]}}let c=s.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(c){let d=c[1].toUpperCase(),m=d.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${d}" i], input[type="checkbox"][value="${d}" i]`)).find(b=>N(b)&&!X(b));if(p)return Y(p);let h=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(b=>{if(!N(b)||X(b))return!1;let A=(b.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(A===d||A===`${d})`||A===`(${d})`||A===`${d}.`||A===`${d}:`)return!0;let y=(b.textContent||"").trim().toUpperCase();return y.startsWith(`${d})`)||y.startsWith(`(${d})`)||y.startsWith(`${d}.`)||y.startsWith(`${d}:`)});if(h)return Y(h);if(m>=0){let b=Xt();if(m<b.length){let v=b[m];if(v.tagName.toLowerCase()==="tr"){if(e){let y=v.querySelector(`input[value="${J(e)}" i], [data-value="${J(e)}" i]`);if(y)return y}let A=v.querySelector("input");if(A)return A}return Y(v)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(s)){let m=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(v=>N(v)&&!X(v));if(m)return m;let h=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(v=>N(v)&&!X(v));if(h)return Y(h);let b=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(v=>{if(!N(v)||X(v))return!1;let A=M(v.textContent).toLowerCase();return A===s.toLowerCase()||A===s.toLowerCase()+")"});if(b)return Y(b)}try{let d=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let p=d.find(h=>{if(!N(h)||X(h))return!1;if(h instanceof HTMLInputElement&&h.value.toLowerCase()===e.toLowerCase())return!0;let b=h.closest("label, .vf-label, td, div");return b&&M(b.textContent).toLowerCase().includes(M(e).toLowerCase())});if(p)return Y(p)}let m=d.find(p=>N(p)&&!X(p));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:Y(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(s))try{let m=Array.from(document.querySelectorAll(s)).find(p=>N(p)&&!X(p));if(m)return Y(m)}catch{}try{let d=s.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,p=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let h=0;h<p.snapshotLength;h++){let b=p.snapshotItem(h);if(b&&N(b)&&!X(b)){if(["body","html"].includes(b.tagName.toLowerCase())){let A=b.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(A&&N(A))return Y(A)}return b.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||Y(b)}}}catch{}let u=M(s).toLowerCase(),f=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of f){if(!N(d)||X(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||W(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=M(d.textContent).toLowerCase(),h=M(d.getAttribute("aria-label")||"").toLowerCase(),b=M(d.getAttribute("placeholder")||"").toLowerCase(),v=M(d.getAttribute("title")||"").toLowerCase(),A=M(d.getAttribute("name")||"").toLowerCase(),y=M(d.getAttribute("data-category")||"").toLowerCase(),C=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",T=M(C).toLowerCase(),x=p.startsWith(u+")")||p.startsWith(u+".")||p.startsWith(u+" -")||p.startsWith(u+":");if(p===u||h===u||b===u||v===u||A===u||y&&y===u||T&&T===u||x)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||Y(d)}if(u.length>=3)for(let d of f){if(!N(d)||X(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||W(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=M(d.textContent).toLowerCase(),h=M(d.getAttribute("aria-label")||"").toLowerCase(),b=M(d.getAttribute("placeholder")||"").toLowerCase(),v=M(d.getAttribute("title")||"").toLowerCase(),A=M(d.getAttribute("name")||"").toLowerCase();if(p.includes(u)||h.includes(u)||b.includes(u)||v.includes(u)||A.includes(u)){if(Array.from(d.children).some(x=>{let E=M(x.textContent).toLowerCase();return E&&E.includes(u)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||Y(d)}let y=u.split(/\s+/).filter(Boolean);if(y.length>=3){let C=y.slice(0,Math.min(5,y.length)).join(" ");if(p.includes(C)||h.includes(C)||b.includes(C))return Y(d)}}return null}function Gt(n,e){for(let t of e)n.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function ae(n,e){if(!n)return;try{n.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{n.focus?.()}catch{}let t=n.getBoundingClientRect(),o=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),s=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:o,clientY:s};try{n.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}if(typeof n.click=="function")try{n.click()}catch{try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let r=Object.keys(n).find(i=>i.startsWith("__reactFiber")||i.startsWith("__reactInternalInstance"));if(r){let i=n[r];for(;i;){let c=i.memoizedProps||i.pendingProps;if(c?.onClick){c.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}i=i.return}}}catch{}try{let r=Object.keys(n).find(i=>i.startsWith("__reactProps"));if(r){let i=n[r];i?.onClick&&i.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let r=n._vei;r?.onClick&&(Array.isArray(r.onClick.value)?r.onClick.value:[r.onClick.value]).forEach(c=>{try{c({type:"click",target:n})}catch{}})}catch{}try{n.$onclick&&n.$onclick({type:"click",target:n,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||n.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let i=n.querySelector('input[type="radio"], input[type="checkbox"]');i&&(i.focus?.(),i.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,!0),i.dispatchEvent(new Event("change",{bubbles:!0})));let c=n.closest("[jsaction]");if(c&&c!==n)try{c.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:o,clientY:s}))}catch{}}}catch{}if(n.getAttribute("role")==="button"||n.getAttribute("tabindex")!==null)try{n.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function At(n){try{let e=n.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,n.id=e);let o=document.createElement("script");return o.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(o),o.remove(),t||setTimeout(()=>{try{n.id===e&&n.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function We(n,e){let t=n;if(t.hasAttribute("for")){let l=t.getAttribute("for"),u=t.ownerDocument.getElementById(l);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Ye(t,[e]);return}let s=t.querySelector('select, [role="combobox"], [role="listbox"]');if(s){Ye(s,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)t=l;else{let f=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(f)t=f;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let l=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)t=l;else{let u=document.body;try{u=Z()||document.body}catch{}let f=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f)t=f;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=document.body;try{l=Z()||document.body}catch{}let u=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;he(t,l);return}let r=String(e??""),i=r;if(t instanceof HTMLInputElement&&t.type==="number"){let l=r.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(i=l)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let c=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(c=document.execCommand?.("insertText",!1,i)||!1):t.isContentEditable&&(c=document.execCommand?.("insertText",!1,i)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let f=t._valueTracker;f&&f.setValue(i===""?" ":"")}catch{}let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,i):t.value=i;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==i&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(i))){t.value=i;try{u?.call(t,i)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==i.trim()){t.textContent=i;try{t.innerText=i}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=i),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function De(n,e=""){if(n==null)return e;let t=typeof n=="string"?n:String(n);if(!t)return e;let o=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),s=M(t),a=j(t)||j(s);if(!a)return o?e:s||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let f=M(r.textContent);if(f&&f.length>0&&f.length<150)return f}if(a.id){let f=document.querySelector(`label[for="${J(a.id)}"]`);if(f){let d=M(f.textContent);if(d&&d.length>0&&d.length<150)return d}}let i=a.getAttribute("aria-label");if(i)return M(i);let c=a.getAttribute("placeholder");if(c)return M(c);let l=M(a.textContent);if(l&&l.length>0&&l.length<120)return l;let u=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return u?M(u):o?e:s||e}function he(n,e){if(!n)return;let t=n.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||n,o=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:t.querySelector('input[type="checkbox"], input[type="radio"]');!o&&t.hasAttribute("for")&&(o=t.ownerDocument.getElementById(t.getAttribute("for")));let s=n instanceof HTMLInputElement?n.closest("label")||(n.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||n:t&&N(t)?t:n;if(o){let a=o.type==="radio",r=o.type==="checkbox",i=!!o._valueTracker;if(o.checked===e){if(a&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(r){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(s&&s!==o&&ae(s),o.checked!==e)try{o.focus?.(),o.click()}catch{}if(o.checked!==e){try{let l=o._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,Gt(o,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;ae(s),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Ye(n,e){let t=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"?n:n.querySelector("select");if(t){let r=e.map(l=>M(l).toLowerCase()),i=!1,c=(l,u)=>{l.selected=!0,t.selectedIndex=u;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let f=t._valueTracker;f&&f.setValue(l.value)}catch{}i=!0};for(let l=0;l<t.options.length;l++){let u=t.options[l],f=u.value.toLowerCase(),d=M(u.textContent).toLowerCase();if(r.some(p=>p===f||p===d)){if(c(u,l),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!i)for(let l of r){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let f=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?f:f>=1?f-1:0;if(m>=0&&m<t.options.length&&(c(t.options[m],m),!t.multiple))break}}if(!i){for(let l of r)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(d>=0&&d<t.options.length&&(c(t.options[d],d),!t.multiple))break}}if(!i){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let f=t.options[u],d=l(f.value.toLowerCase()),m=l(M(f.textContent).toLowerCase());if(r.some(h=>{let b=l(h);return d.includes(b)||m.includes(b)||b.length>2&&(b.includes(d)||b.includes(m))})&&(c(f,u),!t.multiple))break}}if(i){Gt(t,["focus","input","change","blur"]);return}}let o=n.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?n:n.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');o&&ae(o);let s=e.map(r=>M(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>N(r)&&!X(r));for(let r of s){let i=a.find(l=>{let u=M(l.textContent).toLowerCase(),f=M(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===r||f===r||u.includes(r)||r.length>2&&r.includes(u)});if(i){ae(i);let l=i.querySelector('input[type="radio"], input[type="checkbox"]');l&&he(l,!0);return}let c=j(r);if(c){ae(c);return}}}function xn(n,e){try{let t=new DataTransfer;try{t.setData("text/plain",n)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function bt(n){try{n.click()}catch{let e=n.ownerDocument.defaultView||window;n.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function wn(n,e,t){try{if(e.contains(n))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(n))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let o=e.children.length;if(t!==void 0&&o>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${o}`};if([n.getAttribute("data-placed")==="true",n.getAttribute("data-assigned")==="true",n.getAttribute("data-matched")==="true",n.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(n.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(n.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(c=>c!==e&&(c.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:n.getAttribute("aria-hidden")==="true"||n.style.display==="none"||n.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function oe(n,e){let t=M(n).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(n.trim())){let i=document.getElementById(n.trim());if(i&&N(i)&&!X(i))return i}let r=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let i of r){let l=Array.from(document.querySelectorAll(i)).find(u=>{if(!N(u)||X(u))return!1;let f=M(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return f===t||f.includes(t)||u.id===n.trim()});if(l)return l}return null}let o=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),s=Array.from(document.querySelectorAll(o)),a=s.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(i=>i?.trim().toLowerCase()===t));return a&&N(a)&&!X(a)?a:s.find(r=>{if(!N(r)||X(r)||/unclassified/i.test(r.className))return!1;let i=r.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),c=M(i?.textContent||r.textContent||"").toLowerCase();return c.includes("op")&&(c.includes("es")||c.includes("\xF5es"))?!1:c===t||c.startsWith(t)||c.includes(t)})||null}async function Ze(n,e,t=1){try{n.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=n.getBoundingClientRect(),s=e.getBoundingClientRect(),a=Math.round(o.left+Math.max(1,o.width/2)),r=Math.round(o.top+Math.max(1,o.height/2)),i=Math.round(s.left+Math.max(1,s.width/2)),c=Math.round(s.top+Math.max(1,s.height/2)),l=M(e.textContent).toLowerCase();if(l){let h=Array.from(n.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let v=M(b.textContent).toLowerCase(),A=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?M(b.value).toLowerCase():"";return v&&(l.includes(v)||v.includes(l))||A&&(l.includes(A)||A.includes(l))});h&&(ae(h),await new Promise(b=>setTimeout(b,120)))}bt(n),await new Promise(p=>setTimeout(p,140)),bt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&bt(u),await new Promise(p=>setTimeout(p,100)),!e.contains(n)&&n.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(n),e.contains(n)&&n.matches('.dnd-card, [draggable="true"]'))return;let f={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{n.dispatchEvent(new PointerEvent("pointerdown",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}n.dispatchEvent(new MouseEvent("mousedown",f));let d=4;for(let p=1;p<=d;p++){let h=Math.round(a+(i-a)*(p/d)),b=Math.round(r+(c-r)*(p/d)),v={...f,clientX:h,clientY:b,screenX:h,screenY:b};try{n.dispatchEvent(new PointerEvent("pointermove",{...v,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",v))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:c,screenX:i,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let p=xn(G(n.textContent),n.outerHTML),h={...f},b={...m};p&&(h.dataTransfer=p,b.dataTransfer=p);let v=n.ownerDocument.defaultView?.DragEvent;if(!v)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");n.dispatchEvent(new v("dragstart",h)),e.dispatchEvent(new v("dragenter",b)),e.dispatchEvent(new v("dragover",b)),e.dispatchEvent(new v("drop",b)),n.dispatchEvent(new v("dragend",h))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:n,clientX:a,clientY:r}),h=new Touch({identifier:1,target:e,clientX:i,clientY:c});n.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[h]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(n))try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(n))try{let p=v=>{let A=Object.keys(v).find(C=>C.startsWith("__reactFiber")||C.startsWith("__reactInternalInstance"));if(!A)return null;let y=v[A];for(let C=0;C<10&&y;C++){if(y.memoizedProps)return y.memoizedProps;y=y.return}return null},h=p(n),b=p(e);if(h){let v=h.onMouseDown||h.onPointerDown||h.onDragStart;if(typeof v=="function")try{v({type:"mousedown",button:0,buttons:1,clientX:a,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:n,target:n}),await new Promise(A=>setTimeout(A,100))}catch{}}if(b){let v=b.onMouseUp||b.onPointerUp||b.onDrop;if(typeof v=="function")try{v({type:"mouseup",button:0,buttons:0,clientX:i,clientY:c,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,200));let v=c>r?"ArrowDown":"ArrowUp";for(let A=0;A<3;A++)document.dispatchEvent(new KeyboardEvent("keydown",{key:v,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(n.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:n.id||n.getAttribute("data-id")}})),await new Promise(A=>setTimeout(A,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}}function Kt(n,e,t,o){let s=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),a=s(n.toLowerCase()),r=s(e.toLowerCase()),i=s(t),c=s(o);return`var src=$eq.find('${i}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${a}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${r}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${a} -> ${r}');}`}var Jt={fill:(n,e)=>{let t=j(n);t?We(t,e):console.warn(`$eq.fill: Elemento '${n}' n\xE3o encontrado`)},click:n=>{let e=j(n);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?he(e,!0):ae(e):console.warn(`$eq.click: Elemento '${n}' n\xE3o encontrado`)},check:(n,e)=>{let t=j(n);t?he(t,e):console.warn(`$eq.check: Elemento '${n}' n\xE3o encontrado`)},find:(n,e)=>j(n,e),drag:(n,e)=>{let t=oe(n,"source")||j(n),o=oe(e,"destination")||j(e);t&&o?Ze(t,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${n}' -> '${e}')`)},categorize:async(n,e)=>{let t=oe(n,"source")||j(n),o=oe(e,"destination")||j(e);if(!t||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${n}' -> '${e}')`);return}await Ze(t,o)},execute:(n,e=!1,t=1)=>Be(n,e,t)};typeof window<"u"&&(window.$eq=Jt);async function En(n,e=1,t=we()){if(ut(n,t),n.t==="js"){let c=String(n.v||"");Qt(c);try{new Function("$eq","document","window",c)(Jt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(n.t==="drag"){let c=oe(n.from,"source")||j(n.from),l=oe(n.to,"destination")||j(n.to);!c&&n.from&&(c=j(M(n.from))),!l&&n.to&&(l=j(M(n.to))),c&&l?await Ze(c,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${n.from}' -> '${n.to}')`);return}let o=n.id!==void 0&&n.id!==null?String(n.id):"";!o&&n.t==="val"&&(o=n.target??n.name??n.selector??"1");let s=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,a=s!=null?String(s).trim():"",r=null,i=String(n.name??n.n??"").trim();if(!i&&o&&document.querySelector(`input[type="radio"][name="${J(o)}"]`)&&(i=o),(n.t==="chk"||n.t==="clk")&&i){let c=Array.from(document.querySelectorAll(`input[name="${J(i)}"]`));if(a&&(r=c.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!r&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||u){let f=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=c.find(d=>{let m=d.value?.toLowerCase()??"";if(f.includes(m))return!0;let h=(d.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return f.some(b=>h===b||h.startsWith(b+" ")||h.startsWith("("+b+")"))})??null}}!r&&c.length>0&&(r=c[0])}if(r||(r=j(o,a,n.t==="val"||n.t==="sel")),!r&&o&&(r=j(M(o),a,n.t==="val"||n.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(M(r.value).toLowerCase()!==M(a).toLowerCase()){let c=document.querySelector(`input[type="radio"][name="${J(r.name)}"][value="${J(a)}" i]`);if(c)r=c;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${J(r.name)}"]`)).find(f=>{let d=f.closest("label, .vf-label, .option-card, tr, td, div");return d&&M(d.textContent).toLowerCase().includes(M(a).toLowerCase())});u&&(r=u)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let c=r.querySelector(`input[value="${J(a)}" i], [data-value="${J(a)}" i]`);if(c)r=c;else{let u=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(f=>{let d=f.closest("label, .vf-label, .option-card, td, div");return d&&M(d.textContent).toLowerCase().includes(M(a).toLowerCase())});u&&(r=u)}}}if(!r&&(n.t==="val"||n.t==="sel")){let c=document.body;try{c=Z()||document.body}catch{}let l=Array.from(c.querySelectorAll(n.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>N(u)&&!X(u));if(l.length===1)r=l[0];else if(l.length>1){let u=M(o).toLowerCase(),f=u.match(/^#?_?([0-9]+)$/);if(f){let d=parseInt(f[1],10);d>=1&&d<=l.length?r=l[d-1]:d>=0&&d<l.length&&(r=l[d])}r||(r=l.find(m=>{let p=(m.getAttribute("placeholder")||"").toLowerCase(),h=(m.name||"").toLowerCase(),b=(m.getAttribute("aria-label")||"").toLowerCase(),v=(m.id||"").toLowerCase(),A=M(mt(m)).toLowerCase(),y=M(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(u)||h.includes(u)||b.includes(u)||v.includes(u)||A&&A.includes(u)||u.length>=2&&y.includes(u)})||(l.length===1?l[0]:null))}}if(!r&&n.t!=="adv")throw new Error(`Alvo '${o}' n\xE3o encontrado no DOM para a\xE7\xE3o '${n.t}'.`);switch(n.t){case"val":if(r){let u=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let p=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(u=p)}if(!u){let m=r.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){u=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){u=p;break}m=m.nextElementSibling}}if(!u){let m=document.body;try{m=Z()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>N(h)&&!X(h));p.length>0&&(u=p[0])}let f=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,d=f!=null?String(f):"";We(u||r,d)}break;case"chk":let c=n.c!==void 0?!!n.c:!0;r&&he(r,c);break;case"sel":if(r){let u=Array.isArray(n.v)?n.v:[String(n.v)];Ye(r,u)}break;case"clk":if(r)if(!!(r.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let f=n.c!==void 0?!!n.c:!0;he(r,f)}else ae(r,n.co);break;case"adv":let l=Wt(n.id);if(l){await vt(l,1200);let u=n.id||l.textContent?.trim()||"";u&&it(window.location.hostname,{advanceSelector:u}),ae(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Cn(){let n=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(n)).find(t=>{if(!N(t)||X(t)||t.closest("header, nav, aside"))return!1;let o=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",s=(t.textContent||o||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(s)})||null}function Wt(n){let e=d=>{let m=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return le.test(m)};if(n){let d=j(n);if(d&&N(d)&&!X(d)&&!W(d)&&!e(d))return d}try{let d=at(window.location.hostname);if(d.advanceSelector){let m=j(d.advanceSelector);if(m&&N(m)&&!X(m)&&!W(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(t)),s=d=>{let m=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||m||"").trim()},a=d=>{let m=s(d).trim();return/^\d{1,3}$/.test(m)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},r=o.filter(d=>N(d)&&!X(d)&&!d.closest("header, aside")&&!W(d)&&!e(d));for(let d of r){let m=s(d),p=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Oe.test(m)||Oe.test(p))&&!a(d)&&!W(d))return d}for(let d of r)if(ee(d)&&!W(d)&&!a(d))return d;let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(i&&N(i)&&!X(i)&&!W(i)&&!e(i))return i;let c=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of c)if(N(d)&&!X(d)&&!e(d)&&!W(d)&&!a(d))return d;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,f=l.filter(d=>{if(!N(d)||X(d)||e(d)||W(d)||d.closest("header, nav, aside, .eq-sidebar")||a(d))return!1;let m=d.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(f.length>0)return f.sort((d,m)=>{let p=d.getBoundingClientRect(),h=m.getBoundingClientRect(),b=p.left+p.top;return h.left+h.top-b}),f[0];for(let d of r)if(ee(d)&&!W(d))return d;return null}async function vt(n,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(n.disabled===!0||n.getAttribute("aria-disabled")==="true"||n.classList.contains("disabled")||n.getAttribute("disabled")!==null))return;await new Promise(s=>setTimeout(s,80))}}function Tn(){let n=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,o=(document.body?.innerText||document.body?.textContent||"").length;return`${n}|${e}|${t}|${o}`}async function qn(n,e=3500){let[t,o,s,a]=n.split("|"),r=parseInt(a||"0",10),i=Date.now();for(;Date.now()-i<e;){let c=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),f=(document.body?.innerText||document.body?.textContent||"").length;if(c!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${c}`};if(l!==o)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${o}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(s||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${s} \u2192 ${u}`};if(Math.abs(f-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(f-r)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function $e(n){if(n.t==="js"||n.t==="adv")return;if(n.t==="drag"){let a=j(n.from)||j(M(n.from)),r=j(n.to)||j(M(n.to));a&&r&&await Ze(a,r,2);return}let e=n.id||"",t=n.v!==void 0?String(n.v).trim():"",o=j(e,t)||j(M(e),t),s=String(n.name??n.n??"").trim();if(!s&&e&&document.querySelector(`input[type="radio"][name="${J(e)}"]`)&&(s=e),!o&&s){let a=Array.from(document.querySelectorAll(`input[name="${J(s)}"]`));if(t&&(o=a.find(r=>r.value?.toLowerCase()===t.toLowerCase())??null),!o&&t){let r=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),i=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(r||i){let c=r?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];o=a.find(l=>{let u=l.value?.toLowerCase()??"";if(c.includes(u))return!0;let d=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return c.some(m=>d===m||d.startsWith(m+" ")||d.startsWith("("+m+")"))})??null}}!o&&a.length>0&&(o=a[0])}if(n.t==="clk"||n.t==="chk"){if(!o&&e){let r=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),i=M(e).toLowerCase();o=r.find(c=>{let l=M(c.textContent).toLowerCase();return!!(M(c.value||"").toLowerCase()===i||l===i||l.startsWith(i+")")||l.startsWith("("+i+")")||l.startsWith(i+".")||l.startsWith(i+" - ")||l.startsWith(i+":")||i.length>=3&&l.includes(i))})||null}let a=n.v!==void 0?String(n.v).trim():"";if(o&&a){if(o instanceof HTMLInputElement&&o.type==="radio"&&o.name){if(M(o.value).toLowerCase()!==M(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${J(o.name)}"][value="${J(a)}" i]`);if(r)o=r;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${J(o.name)}"]`)).find(l=>{let u=l.closest("label, .vf-label, .option-card, tr, td, div");return u&&M(u.textContent).toLowerCase().includes(M(a).toLowerCase())});c&&(o=c)}}}else if(!(o instanceof HTMLInputElement)&&!(o instanceof HTMLSelectElement)&&!(o instanceof HTMLTextAreaElement)){let r=o.querySelector(`input[value="${J(a)}" i], [data-value="${J(a)}" i]`);if(r)o=r;else{let c=Array.from(o.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let u=l.closest("label, .vf-label, .option-card, td, div");return u&&M(u.textContent).toLowerCase().includes(M(a).toLowerCase())});c&&(o=c)}}}if(o){let r=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,i=o instanceof HTMLInputElement&&["radio","checkbox"].includes(o.type)?o:r.querySelector('input[type="radio"], input[type="checkbox"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),c=n.c!==void 0?!!n.c:!0;if(he(i||r,c),i&&i.checked!==c){try{let l=i._valueTracker;l&&l.setValue(!c)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,c)}catch{}i.checked=c,i.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),i.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(n.t==="val"){let a=null;if(o&&(a=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o.isContentEditable?o:o.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let r=document.body;try{r=Z()||document.body}catch{}let i=Array.from(r.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),c=M(e).toLowerCase();a=i.find(l=>{let u=(l.getAttribute("placeholder")||"").toLowerCase(),f=(l.name||"").toLowerCase(),d=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return u.includes(c)||f.includes(c)||d.includes(c)||m.includes(c)})||(i.length>0?i[0]:null)}if(a){let r=String(n.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,r)}}catch{}We(a,r)}return}if(n.t==="sel"){if(!o&&e){let a=Array.from(document.querySelectorAll("select")),r=M(e).toLowerCase();o=a.find(i=>{let c=(i.name||"").toLowerCase(),l=(i.id||"").toLowerCase(),u=(i.getAttribute("aria-label")||"").toLowerCase();return c.includes(r)||l.includes(r)||u.includes(r)})||null}if(o){let a=Array.isArray(n.v)?n.v:[String(n.v)];Ye(o,a)}return}}function ne(n){try{if(n.t==="val"){let e=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,t=String(e??"").trim(),o=t,s=n.id!==void 0&&n.id!==null?String(n.id):"";s||(s=n.target??n.name??n.selector??"1");let a=j(s,o,!0)||j(M(s),o,!0);if(!a){let m=document.body;try{m=Z()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>N(h)&&!X(h));p.length>0&&(a=p[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let m=document.querySelector(`input[type="radio"][name="${J(r.name)}"]:checked`);if(!m)return!1;let p=M(m.value).toLowerCase(),h=M(t).toLowerCase(),b=M(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===h||b===h||b.includes(h)}let i=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!i){let p=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(i=p)}if(!i){let m=a.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){i=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){i=p;break}m=m.nextElementSibling}}if(i instanceof HTMLSelectElement){let m=M(t).toLowerCase();return Array.from(i.options).some(p=>{if(!p.selected)return!1;let h=p.value.toLowerCase(),b=M(p.textContent).toLowerCase();return m===h||m===b||h.includes(m)||b.includes(m)})}let c=(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i?.textContent??a.textContent??"").trim();if(!c&&!t)return!0;if(!c&&t)return!1;let l=c.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),f=parseFloat(l),d=parseFloat(u);return!isNaN(f)&&!isNaN(d)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(f-d)<1e-4:l===u||c.toLowerCase()===t.toLowerCase()||u.length>=3&&l===u}if(n.t==="sel"){let e=j(n.id,void 0,!0)||j(M(n.id),void 0,!0);if(!e){let a=document.body;try{a=Z()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>N(l)&&!X(l)),i=M(n.id).toLowerCase();e=r.find(l=>{let u=(l.id||"").toLowerCase(),f=(l.getAttribute("name")||"").toLowerCase(),d=(l.getAttribute("aria-label")||"").toLowerCase(),m=M(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(i)||f.includes(i)||d.includes(i)||i.length>=2&&m.includes(i)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let i=(Array.isArray(n.v)?n.v:[String(n.v)]).map(l=>M(l).toLowerCase()),c=M(a.textContent).toLowerCase();return i.some(l=>c.includes(l)||l.includes(c))}return!1}let s=(Array.isArray(n.v)?n.v:[String(n.v)]).map(a=>M(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),i=M(a.textContent).toLowerCase();return s.some(c=>c===r||c===i||r.includes(c)||i.includes(c))})}if(n.t==="chk"||n.t==="clk"){let e=n.v!==void 0?String(n.v).trim():"",t=String(n.name??n.n??"").trim();if(t&&!n.id){let d=Array.from(document.querySelectorAll(`input[name="${J(t)}"]`));if(d.length>0){let m=d.find(A=>A.checked);if(!m)return!1;if(!e)return!0;let p=m.value?.toLowerCase()??"",h=e.toLowerCase();if(p===h)return!0;let b=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),v=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return b?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):v?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let o=j(n.id,e)||j(M(n.id),e);if(!o&&t){let d=document.querySelector(`input[name="${J(t)}"]`);d&&(o=d)}if(!o)return!1;let s=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:s.querySelector('input[type="checkbox"], input[type="radio"]')||(s.getAttribute("for")?s.ownerDocument.getElementById(s.getAttribute("for")):null),r=n.t==="chk"||n.c!==void 0?!!n.c:!0;if(a&&a.type==="radio"){if(a.checked===r)return!0;if(n.v&&a.name){let d=M(String(n.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${J(a.name)}"]:checked`);if(!m)return!1;if(m===a)return!0;let p=M(m.value).toLowerCase(),h=M(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===d||h.includes(d)||d.includes(p)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===r;let i=s.getAttribute("aria-checked")===String(r)||s.getAttribute("aria-selected")===String(r)||s.getAttribute("aria-pressed")===String(r),c=r?s.getAttribute("data-selected")==="true"||s.getAttribute("data-checked")==="true"||s.getAttribute("data-active")==="true"||s.getAttribute("data-state")==="checked"||s.getAttribute("data-state")==="on":s.getAttribute("data-selected")==="false"||s.getAttribute("data-checked")==="false"||s.getAttribute("data-state")==="unchecked",l=s.className||"",u=r?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(i||c||u)return!0;let f=!!s.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return n.t==="clk"&&!a&&!f||s.getAttribute("aria-expanded")!==null||s.getAttribute("aria-pressed")!==null}if(n.t==="drag"){let e=oe(n.from,"source")||j(n.from)||j(M(n.from)),t=oe(n.to,"destination")||j(n.to)||j(M(n.to));return!e||!t?!1:wn(e,t).success}}catch{}return!1}async function Be(n,e,t=1,o=we({engine:"smart",autoAdvance:e})){let s=n.actions.filter(w=>w.t!=="adv"),a=n.actions.filter(w=>w.t==="adv"),r=0,i=[],c=new Map,l=new Map,u=new Map,f=new Set,d=n.pageType==="question"||s.length>0,m=s.filter(w=>w.t==="chk"||w.t==="clk"&&w.c!==void 0),p=new Map;for(let w of s){let I=[];l.set(w,I);try{if(w.t==="drag"){I.push("declarative-A-F");try{let P=oe(w.from,"source")||j(w.from),q=oe(w.to,"destination")||j(w.to);P&&u.set(w,P.parentElement?.outerHTML?.slice(0,500)||""),q&&p.set(w,q.children.length)}catch{}}else I.push("declarative-primary");await En(w,t,o),r++,f.add(w)}catch(P){c.set(w,P instanceof Error?P.message:String(P)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",w,P)}await new Promise(P=>setTimeout(P,w.t==="drag"?180:35))}if(d&&n.mode==="escolha_multipla"&&m.length>0){let w=document.body;try{w=Z()||document.body}catch{}let I=Array.from(w.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(P=>N(P)&&!X(P));if(I.length>1){let q=function(z,R){if(z===R||z.contains(R)||R.contains(z))return!0;let U=z.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),S=R.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(U&&S&&U===S)return!0;let D=z.getAttribute("for")||z.id,O=R.getAttribute("for")||R.id;return!!(D&&O&&D===O)};var k=q;let P=new Set;for(let z of m){let R=z.t==="chk"?!!z.c:!!(z.c??!0),U="id"in z&&typeof z.id=="string"?z.id:"";if(R&&U){let S=j(U,z.v);if(S){P.add(S);let D=S.querySelector('input[type="checkbox"]');D&&P.add(D);let O=S.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');O&&(P.add(O),O.querySelectorAll('input[type="checkbox"]').forEach(F=>P.add(F)))}}}if(P.size>=m.length&&P.size>0){let z=Array.from(P);for(let R of I)z.some(S=>q(S,R))||(R instanceof HTMLInputElement&&R.checked||R.getAttribute("aria-checked")==="true"||R.closest(".option-card, label")?.classList.contains("selected"))&&he(R,!1)}}}await new Promise(w=>setTimeout(w,s.length>0?100:25));let h=0;for(let w of s){if(ne(w)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${w.t}' no alvo '${w.id||w.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{ut(w,o),l.get(w)?.push("alternative-path"),await $e(w)}catch(I){c.set(w,I instanceof Error?I.message:String(I)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",I)}await new Promise(I=>setTimeout(I,250)),ne(w)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++,f.has(w)?c.has(w)&&c.delete(w):(c.delete(w),r++,f.add(w)))}if(h<s.length&&s.length>0){console.warn(`[EasyQuiz Auto-Cura] ${s.length-h} de ${s.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(w=>setTimeout(w,200));for(let w of s)if(!ne(w))try{if(await $e(w),await new Promise(I=>setTimeout(I,80)),!ne(w)&&(w.t==="clk"||w.t==="chk"))try{let I="id"in w?String(w.id||""):"",P=w.v!==void 0?String(w.v).trim():"",q=j(I,P)||j(M(I),P);q&&(At(q),await new Promise(z=>setTimeout(z,120)))}catch{}}catch(I){c.set(w,I instanceof Error?I.message:String(I))}await new Promise(w=>setTimeout(w,200)),h=0;for(let w of s)ne(w)&&(h++,f.has(w)?c.has(w)&&c.delete(w):(c.delete(w),r++,f.add(w)))}let b=[];for(let[w,I]of s.entries())if(!ne(I)){let P=I.t==="drag"?`${I.from} -> ${I.to}`:"id"in I&&I.id?I.id:I.t;i.push(P),b.push({actionIndex:w,action:I,strategiesAttempted:l.get(I)||[],evidence:c.get(I)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(I)}),I.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${I.from}" -> "${I.to}"`,`
  Estrat\xE9gias: ${(l.get(I)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(I)?.slice(0,200)||"n/a"}`)}d&&s.length===0&&i.push("nenhuma a\xE7\xE3o de resposta prescrita");let v=s.map((w,I)=>{let P=w.t==="drag"?`${w.from} -> ${w.to}`:w.t==="js"?"$eq":w.id||w.t,q=w.t==="js"?!0:w.t==="drag"?!!(oe(w.from,"source")&&oe(w.to,"destination")):!!(j(w.id||"")||j(M(w.id||""))),z=ne(w);return{index:I,action:w,target:P,located:q,applied:!c.has(w),verified:z,strategy:w.t==="drag"?"drag-adaptive":w.t==="js"?"javascript":"declarative-dom",evidence:z?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(w)?{error:c.get(w)}:{}}}),A=d?s.length>0&&i.length===0&&(h===s.length||r===s.length&&h>0):!0,y=!1,C=!1,T="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",x=d?h>0&&h>=Math.ceil(s.length/2):r>0&&r>=s.length/2,E=d?h>0&&(A||x):A||s.length===0||x;if(e&&E){await new Promise(P=>setTimeout(P,s.length>0?120:40));let w=!1,I=null;if(n.pageType!=="info"){let P=Cn();if(P&&N(P)){await vt(P,1200),ae(P),w=!0,I=P,await new Promise(R=>setTimeout(R,350));let q=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');q&&N(q)&&(q.textContent||"").trim().length>0?(y=!1,C=!1,T=`Aviso do formul\xE1rio ap\xF3s checagem: ${q.textContent?.trim().slice(0,100)}`):(y=!0,C=!0,T="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!w){let P=Tn(),q=a.length>0&&"id"in a[0]?a[0].id:void 0,z=Wt(q);if(z){await vt(z,1500);let R=q||z.textContent?.trim()||"";R&&it(window.location.hostname,{advanceSelector:R}),ae(z);let U=await qn(P,1800);C=U.changed,T=U.evidence,y=U.changed||!0,U.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:h,success:A,advanced:y,failed:i,reports:v,navigationVerified:C,navigationEvidence:T,failedActions:b}}var ie=null,Ee=[],yt=[],xt=[],wt=[],se=null,ge=null,kn=`
...
`;function Yt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=kn,document.head.appendChild(n)}}catch{}}function fe(){ie&&(ie.style.removeProperty("outline"),ie.style.removeProperty("outline-offset"),ie.style.removeProperty("position"),ie=null);for(let n of Ee)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");Ee=[];for(let n of yt)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");yt=[];for(let n of xt)try{n.remove()}catch{}xt=[],ge&&typeof window<"u"&&(window.removeEventListener("scroll",ge),window.removeEventListener("resize",ge),ge=null);for(let n of wt)try{n.remove()}catch{}if(wt=[],se){try{se.remove()}catch{}se=null}}function Et(n){Yt();let e=[];for(let t of n){if(!t||typeof t.setAttribute!="function")continue;let o=t;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),yt.push(o)}catch{}try{let s=t.getBoundingClientRect(),a=s.width||t.offsetWidth||280,r=s.height||t.offsetHeight||200;if(a>10&&r>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(c),document.body.appendChild(i),xt.push(i),wt.push(c),e.push({element:t,frame:i})}}catch{}}e.length>0&&!ge&&typeof window<"u"&&(ge=()=>{for(let t of e)try{let o=t.element.getBoundingClientRect();o.width>0&&o.height>0&&(t.frame.style.top=`${o.top+window.scrollY-3}px`,t.frame.style.left=`${o.left+window.scrollX-3}px`,t.frame.style.width=`${o.width+6}px`,t.frame.style.height=`${o.height+6}px`)}catch{}},window.addEventListener("scroll",ge,{passive:!0}),window.addEventListener("resize",ge,{passive:!0}))}function Ne(n){ie&&ie!==n&&(ie.style.removeProperty("outline"),ie.style.removeProperty("outline-offset")),Yt(),ie=n,n.style.outline="2px solid #00e5ff",n.style.outlineOffset="4px";try{if(se){try{se.remove()}catch{}se=null}window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,n.appendChild(t),se=t}catch{}}function Ln(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Zt(n,e){if(se){try{se.remove()}catch{}se=null}let t=Ln(e);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let m=j(o.from),p=j(o.to);m&&(m.style.outline=`2px solid ${t.outline}`,Ee.push(m)),p&&(p.style.outline="2px dashed #00e5ff",Ee.push(p))}catch{}continue}let s=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${J(a)}"]`));if(s&&(r=m.find(p=>p.value?.toLowerCase()===s.toLowerCase())??null,!r)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(s),h=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(s);if(p||h){let b=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=m.find(v=>{let A=v.value?.toLowerCase()??"";if(b.includes(A))return!0;let C=(v.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(T=>C===T||C.startsWith(T+" ")||C.startsWith("("+T+")"))})??null}}!r&&m.length>0&&(r=m[0])}if(!r&&o.id&&(r=j(o.id,s,o.t==="val"||o.t==="sel")||j(M(o.id),s,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let m=document.body;try{m=Z()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>N(v)&&!pe(v)),h=M(o.id).toLowerCase();r=p.find(v=>{let A=(v.id||"").toLowerCase(),y=(v.getAttribute("name")||"").toLowerCase(),C=(v.getAttribute("aria-label")||"").toLowerCase(),T=M(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return A.includes(h)||y.includes(h)||C.includes(h)||h.length>=2&&T.includes(h)})||(p.length===1?p[0]:null)}if(!r)continue;let i=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",c=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=c||l||r;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),Ee.push(u);let f=i?r:u.querySelector('select, [role="combobox"], [role="listbox"]');f&&(f.style.outline=`2px solid ${t.outline}`,f.style.outlineOffset="2px",f.style.boxShadow=`0 0 10px ${t.glow}`,f.setAttribute("data-easyquiz-highlight","true"),Ee.push(f));let d=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:u.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==u&&(d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${t.glow}`,d.setAttribute("data-easyquiz-highlight","true"),Ee.push(d))}}var Ct=10,Sn=1400,Re=15e5;function de(n){return new Promise((e,t)=>{let o=new FileReader;o.onerror=()=>t(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");e(s.split(",")[1]||"")},o.readAsDataURL(n)})}async function Ce(n){let e=0,t=0;if(n instanceof HTMLImageElement?(e=n.naturalWidth||n.width,t=n.naturalHeight||n.height):(e=n.width,t=n.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Sn/Math.max(e,t)),s=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(t*o)),r=document.createElement("canvas");r.width=s,r.height=a;let i=r.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,s,a),i.drawImage(n,0,0,s,a),new Promise((c,l)=>{r.toBlob(u=>u?c(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function _t(n){let e=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=e.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,s=2,a=Math.min(1800,Math.max(120,Math.round(t*s))),r=Math.min(1800,Math.max(100,Math.round(o*s))),i=n.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(a)),i.setAttribute("height",String(r)),!i.getAttribute("viewBox")&&t>0&&o>0&&i.setAttribute("viewBox",`0 0 ${t} ${o}`);try{let d=Array.from(n.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(d.length,m.length);p++){let h=d[p],b=m[p];if(!h||!b||!b.style)continue;let v=window.getComputedStyle?window.getComputedStyle(h):null;v&&(v.fill&&v.fill!=="none"&&(b.style.fill=v.fill),v.stroke&&v.stroke!=="none"&&(b.style.stroke=v.stroke),v.strokeWidth&&(b.style.strokeWidth=v.strokeWidth),v.fontFamily&&(b.style.fontFamily=v.fontFamily),v.fontSize&&(b.style.fontSize=v.fontSize),v.fontWeight&&(b.style.fontWeight=v.fontWeight),v.color&&(b.style.color=v.color))}}catch{}let c="#ffffff";try{let d=n.parentElement||n;for(;d&&d!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(d):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){c=p;break}d=d.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),f="";try{f=btoa(unescape(encodeURIComponent(u)))}catch{}try{let d=b=>new Promise((v,A)=>{let y=new Image,C=setTimeout(()=>A(new Error("Timeout render SVG")),1200);y.onload=()=>{clearTimeout(C),v(y)},y.onerror=()=>{clearTimeout(C),A(new Error("Falha ao renderizar SVG em Image."))},y.src=b}),m=null;if(f)try{m=await d(`data:image/svg+xml;base64,${f}`)}catch{}if(!m){let b=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),v=URL.createObjectURL(b);try{m=await d(v)}finally{URL.revokeObjectURL(v)}}let p=document.createElement("canvas");p.width=a,p.height=r;let h=p.getContext("2d",{alpha:!1});if(h&&m){h.fillStyle=c,h.fillRect(0,0,a,r),h.drawImage(m,0,0,a,r);let b=await new Promise(v=>{p.toBlob(v,"image/jpeg",.92)});if(b){let v=await de(b);if(v)return{blob:b,base64:v,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function Tt(n){try{let e=n.getBoundingClientRect(),t=Math.round(e.width)||n.offsetWidth||400,o=Math.round(e.height)||n.offsetHeight||300;if(t<30||o<30)return null;let s=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(s&&n.querySelectorAll("input, select, textarea").length===0)try{let h=await _t(s);if(h.base64&&h.base64.length<=Re)return{mediaType:h.mediaType,base64:h.base64,alt:n.getAttribute("aria-label")||s.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:be(s)}}catch{}if(n instanceof HTMLCanvasElement)try{let h=await Ce(n),b=await de(h);if(b)return{mediaType:"image/jpeg",base64:b,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let h=n;for(;h&&h!==document.documentElement;){let v=(window.getComputedStyle?window.getComputedStyle(h):null)?.backgroundColor;if(v&&v!=="transparent"&&v!=="rgba(0, 0, 0, 0)"){a=v;break}h=h.parentElement}}catch{}let r=n.cloneNode(!0),i=Array.from(n.querySelectorAll("*")),c=Array.from(r.querySelectorAll("*"));for(let h=0;h<Math.min(i.length,c.length);h++){let b=i[h],v=c[h];if(!(!b||!v||!v.style))try{let A=window.getComputedStyle(b);v.style.color=A.color,v.style.backgroundColor=A.backgroundColor,v.style.borderColor=A.borderColor,v.style.borderWidth=A.borderWidth,v.style.borderStyle=A.borderStyle,v.style.fontSize=A.fontSize,v.style.fontFamily=A.fontFamily,v.style.fontWeight=A.fontWeight,v.style.lineHeight=A.lineHeight,v.style.letterSpacing=A.letterSpacing,v.style.textAlign=A.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,o))),u=Math.round(t*l),f=Math.round(o*l),d=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let s=this.element.querySelector("#eq-fah-copy-md-btn");s.addEventListener("click",()=>this.copyMarkdownToClipboard(s));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=o=>{if(o.target.closest(".eq-fah-btn"))return;o.preventDefault(),this.isDragging=!0,this.dragStartX=o.clientX,this.dragStartY=o.clientY;let s=this.element.getBoundingClientRect();this.initialLeft=s.left,this.initialTop=s.top;let a=i=>{if(!this.isDragging||!this.element)return;let c=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),f=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+c),u),m=Math.min(Math.max(10,this.initialTop+l),f);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),o=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let s=this.currentPlan,a=s.actions.filter(m=>m.t==="drag"),r=s.actions.filter(m=>{if(m.t!=="val")return!1;let p=M(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=s.actions.filter(m=>m.t==="clk"||m.t==="chk"),c=s.actions.filter(m=>m.t==="sel"),l=a.length||r.length||i.length||c.length,u=document.createElement("div");u.className="eq-fah-meta";let f=document.createElement("span");f.textContent=`Modo: ${s.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(s.confidence*100)}% Confian\xE7a`,u.append(f,d),e.appendChild(u),a.length>0||s.mode==="categorizacao"||s.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,o.textContent=String(a.length);let m={};for(let p of a){let h=M(p.to)||"Geral";m[h]||(m[h]=[]),m[h].push(M(p.from))}for(let[p,h]of Object.entries(m)){let b=document.createElement("div"),v=/fato|true|verdadeiro|sim/i.test(p),A=/opini[aã]o|false|falso|n[aã]o/i.test(p);b.className=`eq-fah-group ${v?"group-fato":A?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${p} (${h.length})`,b.appendChild(y);let C=document.createElement("div");C.className="eq-fah-group-items";for(let T of h){let x=document.createElement("div");x.className="eq-fah-item";let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=T,x.appendChild(E);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(T),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),x.appendChild(k),C.appendChild(x)}b.appendChild(C),e.appendChild(b)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,o.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<r.length;b++){let v=r[b],A=document.createElement("div");A.className="eq-fah-item";let y=De(v.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${b+1}`);let C=String(v.v??""),T=document.createElement("div");T.className="eq-fah-field-box";let x=document.createElement("div");x.className="eq-fah-field-label",x.textContent=y,T.appendChild(x);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=C,T.appendChild(E),A.appendChild(T);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),A.appendChild(k),h.appendChild(A)}m.appendChild(h),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,o.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<i.length;b++){let v=i[b],A=document.createElement("div");A.className="eq-fah-item";let y=De(v.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&v.v&&(y=String(v.v)),y=M(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let C="",T=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);T?(C=T[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=T[2].trim()||y):i.length>1&&(C=String.fromCharCode(65+b));let x=document.createElement("div");if(x.style.display="flex",x.style.alignItems="center",x.style.gap="8px",x.style.flex="1",C){let w=document.createElement("span");w.className="eq-fah-letter-badge",w.textContent=C,x.appendChild(w)}let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=y||(C?`Alternativa ${C}`:"Alternativa Selecionada"),x.appendChild(E),A.appendChild(x);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(y||C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),A.appendChild(k),h.appendChild(A)}m.appendChild(h),e.appendChild(m)}else if(c.length>0){t.textContent=`Sele\xE7\xE3o (${c.length} listas)`,o.textContent=String(c.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<c.length;b++){let v=c[b],A=document.createElement("div");A.className="eq-fah-item";let y=De(v.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${b+1}`);let x=(Array.isArray(v.v)?v.v:[String(v.v??"")]).map(P=>{let q=j(v.id,void 0,!0)||j(M(v.id),void 0,!0),z=q instanceof HTMLSelectElement?q:q?.querySelector("select");if(z){let R=M(P).toLowerCase();for(let U=0;U<z.options.length;U++){let S=z.options[U];if(S.value.toLowerCase()===R||M(S.textContent).toLowerCase()===R){let D=M(S.textContent);if(D&&!D.toLowerCase().includes("selecione"))return D}}}return P}).join(", "),E=document.createElement("div");E.className="eq-fah-field-box";let k=document.createElement("div");k.className="eq-fah-field-label",k.textContent=y,E.appendChild(k);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=x,E.appendChild(w),A.appendChild(E);let I=document.createElement("button");I.className="eq-fah-copy-inline",I.textContent="Copiar",I.addEventListener("click",()=>{navigator.clipboard.writeText(x),I.textContent="\u2713 Copiado",setTimeout(()=>I.textContent="Copiar",1200)}),A.appendChild(I),h.appendChild(A)}m.appendChild(h),e.appendChild(m)}else{t.textContent="Gabarito",o.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(s.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${s.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let o=e.actions.filter(i=>i.t==="drag"),s=e.actions.filter(i=>i.t==="val"),a=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),r=e.actions.filter(i=>i.t==="sel");if(o.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let c of o){let l=M(c.to)||"Geral";i[l]||(i[l]=[]),i[l].push(M(c.from))}for(let[c,l]of Object.entries(i)){t.push(`### Categoria: ${c}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(s.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of s){let c=M(i.id);t.push(`- **${c||"Campo"}:** \`${i.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<a.length;i++){let c=a[i],l=De(c.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&c.v&&(l=String(c.v)),l=M(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=a.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of r){let c=M(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${c}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let o=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=o},1500)})}};var en=`
...
`;var ve="v3.1.8";var tn=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:n=>n})}catch{}return null})();function On(n,e){try{if(tn){n.innerHTML=tn.createHTML(e);return}}catch{}try{if(typeof n.setHTMLUnsafe=="function"){n.setHTMLUnsafe(e);return}}catch{}n.innerHTML=e}var Dn=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Bn=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],tt=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new _e({onStatusChange:(i,c,l)=>{this.logToConsole(c,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),c.includes("conclus\xE3o")||c.includes("finalizada")||c.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,c)=>{try{return await this.callbacks.onAnalyze(i,c,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),On(this.shadow,`
          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                ...
                <span class="eq-brand-version">${ve}</span>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-resolver-hero">
                  <div class="eq-resolver-brand">
                    ...
                    <div class="eq-brand-copy">
                      ...
                      <div class="eq-brand-subline">BETA \u2022 ${ve}</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="eq-footer-note" style="margin-top: auto;">${ve} \u2022 H\xEDbrido 4.0 (RAG + AST + Vision)</div>
              </div>
              ...
              <div class="eq-view-pane" id="eq-view-debug" style="display:none;flex-direction:column;">
                ...
                <div id="eq-term-panel-terminal" style="flex:1;display:flex;flex-direction:column;overflow:hidden;min-height:0;position:relative;">
                  ...
                  <div id="eq-term-output" style="flex:1;overflow-y:auto;overflow-x:hidden;padding:10px 14px 6px;font-family:'Cascadia Code','Fira Code','Courier New',monospace;font-size:11.5px;line-height:1.65;background:#0a0a0a;color:#ddd;user-select:text;-webkit-user-select:text;cursor:text;outline:none;caret-color:transparent;">
                    <div data-perm="1" style="color:#444;padding:2px 0;"><span style="color:#666;font-weight:600;">EasyQuiz Terminal</span> <span style="color:#2a2a2a;">v${ve}</span></div>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new et(this.shadow,()=>{this.callbacks.onAnalyze(1)});let o=this.shadow.querySelector("#eq-open-hud-btn");o&&o.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),Te.filter(i=>$(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===e.model))),Dn.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===e.modeHint))),Bn.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let s=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];V.init(s),this.apiKeyInput.value=V.getBestKey()||e.apiKey||"",this.renderKeysList();let a=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof a?.unref=="function"&&a.unref();let r=V.getBestKey()||e.apiKey;r&&Ve(r).then(i=>{i&&i.length>0&&this.updateModelSelect(i,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];this.shadow.querySelector(".eq-views-wrapper")?.classList.toggle("is-brain-active",e==="brain");for(let s of t){let a=this.shadow.querySelector(`#eq-tab-${s}`),r=this.shadow.querySelector(`#eq-view-${s}`),i=s===e;a?.classList.toggle("active",i),r&&(r.style.display=i?"flex":"none")}switch(this.updateContextBar(e),e){case"brain":this.initBrainControls(),this.renderContextTree(),this.refreshInspectorView();break;case"metrics":try{this.updateTimingMetrics()}catch{}break;case"debug":try{this.refreshDebugView(),this.renderTerminalEntries(),this.initTerminalREPL()}catch{}break;case"settings":break}}updateContextBar(e){let t=this.shadow.querySelector("#eq-ctxbar-icon"),o=this.shadow.querySelector("#eq-ctxbar-name"),s=this.shadow.querySelector("#eq-ctxbar-sub"),a=this.shadow.querySelector("#eq-ctxbar-actions");if(!t||!o||!s||!a)return;a.innerHTML="";let i={resolver:{icon:L.sparkles,label:"Resolver",sub:"Autopilot & opera\xE7\xF5es",color:"#a78bfa",actions:()=>{let c=document.createElement("span");return c.id="eq-ctxbar-status",c.style.cssText="font-size:9px;font-weight:700;padding:2px 7px;border-radius:10px;background:rgba(167,139,250,0.13);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;letter-spacing:0.04em;",c.textContent="PRONTO",[c]}},brain:{icon:L.inspector,label:"C\xE9rebro da IA",sub:"Contexto & inspe\xE7\xE3o",color:"#60a5fa",actions:()=>{let c=this.shadow.querySelector("#eq-brain-canvas-toggle"),l=document.createElement("button");l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",l.innerHTML=this.brainCanvasHidden?L.eyeOff:L.eye,l.title="Mostrar/Ocultar canvas",l.addEventListener("click",()=>{c?.click(),l.innerHTML=this.brainCanvasHidden?L.eyeOff:L.eye});let u=document.createElement("button");return u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=L.copy,u.title="Copiar conte\xFAdo selecionado",u.addEventListener("click",()=>this.smartCopy()),[l,u]}},metrics:{icon:L.clock,label:"M\xE9tricas",sub:"Cron\xF4metro & hist\xF3rico",color:"#4ade80",actions:()=>{let c=document.createElement("button");c.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",c.innerHTML=L.copy,c.title="Copiar relat\xF3rio",c.addEventListener("click",()=>this.copyMetricsReport());let l=document.createElement("button");return l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.08);border:1px solid rgba(255,85,85,0.15);border-radius:4px;cursor:pointer;color:#ff8888;",l.innerHTML=L.trash,l.title="Zerar m\xE9tricas",l.addEventListener("click",()=>{this.shadow.querySelector("#eq-metrics-reset-btn")?.click()}),[c,l]}},debug:{icon:L.code,label:"Terminal",sub:"Comandos & logs",color:"#0098ff",actions:()=>{let c=document.createElement("div");c.style.cssText="display:inline-flex;align-items:center;gap:1px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:2px;";let l=(d,m,p)=>{let h=document.createElement("button");return h.id=d,h.type="button",h.textContent=m,h.style.cssText="font-size:9px;font-weight:600;padding:2px 8px;border-radius:3px;cursor:pointer;transition:all 0.1s;background:"+(p?"#1a1a1a":"transparent")+";border:1px solid "+(p?"#333":"transparent")+";color:"+(p?"#ddd":"#555")+";",h};c.appendChild(l("eq-term-mode-terminal","Terminal",!0)),c.appendChild(l("eq-term-mode-output","Output",!1));let u=document.createElement("button");u.id="eq-term-copy-btn",u.type="button",u.title="Copiar",u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=L.copy;let f=document.createElement("button");return f.id="eq-term-clear-btn",f.type="button",f.title="Limpar",f.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.06);border:1px solid rgba(255,85,85,0.12);border-radius:4px;cursor:pointer;color:#ff5555;",f.innerHTML=L.eraser,[c,u,f]}},settings:{icon:L.settings,label:"Configura\xE7\xF5es",sub:"Ajustes & prefer\xEAncias",color:"#fbbf24"}}[e];if(i&&(t.innerHTML=i.icon,t.style.color=i.color,o.textContent=i.label,o.style.color=i.color==="#a78bfa"?"#ccc":"#ddd",s.textContent=i.sub,i.actions))for(let c of i.actions())a.appendChild(c)}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let x=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!x))}),this.metricsResetBtn?.addEventListener("click",()=>{Ie(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-scroll-toggle");t?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,t&&(t.style.color=this.autoScrollLogs?"#ddd":"#333",t.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let o=this.shadow.querySelector("#eq-dbg-copy-logs");o?.addEventListener("click",()=>{let x=this.getFormattedLogs();navigator.clipboard.writeText(x).then(()=>{let E=o.innerHTML;o.innerHTML=L.check,setTimeout(()=>o.innerHTML=E,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let s=this.shadow.querySelector("#eq-dbg-copy-prompt");s?.addEventListener("click",()=>{let x=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(x).then(()=>{let E=s.innerHTML;s.innerHTML=`${L.check} Copiado!`,setTimeout(()=>s.innerHTML=E,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-context");a?.addEventListener("click",()=>{let x=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(x).then(()=>{let E=a.innerHTML;a.innerHTML=`${L.check} Copiado!`,setTimeout(()=>a.innerHTML=E,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-raw-resp");r?.addEventListener("click",()=>{let x=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(x).then(()=>{let E=r.innerHTML;r.innerHTML=`${L.check} Copiado!`,setTimeout(()=>r.innerHTML=E,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-error-btn");i?.addEventListener("click",()=>{let x=this.lastErrorMsg||"";navigator.clipboard.writeText(x).then(()=>{let E=i.innerHTML;i.innerHTML=L.check,setTimeout(()=>i.innerHTML=E,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",x=>{x.altKey&&(x.key==="q"||x.key==="Q"||x.key==="a"||x.key==="A")&&(x.preventDefault(),this.toggle())},!0);let c=x=>{let E=x.composedPath();E.includes(this.shadow)||(E.includes(this.sidebarEl)||E.includes(this.host))&&x.stopImmediatePropagation()};window.addEventListener("keydown",c,!0),window.addEventListener("keyup",c,!0),window.addEventListener("keypress",c,!0),this.apiKeyInput.addEventListener("input",()=>{let x=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:x})});let l=this.shadow.querySelector("#eq-keys-collapsible"),u=this.shadow.querySelector("#eq-keys-chevron"),f=this.shadow.querySelector("#eq-keys-section-header"),d=x=>{l&&(x?(l.style.display="none",u&&(u.style.transform="rotate(0deg)")):(l.style.display="block",l.style.maxHeight="none",l.style.overflow="visible",u&&(u.style.transform="rotate(90deg)")))},m=!1;try{m=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}d(m),f?.addEventListener("click",x=>{if(x.target?.closest("a"))return;let E=l?.style.display==="none";d(!E);try{localStorage.setItem("easyquiz_keys_collapsed",E?"false":"true")}catch{}});let p=this.shadow.querySelector("#eq-auto-menu-btn"),h=this.shadow.querySelector("#eq-auto-menu");h&&(h.hidden=!0),p?.classList.remove("is-open"),p?.addEventListener("click",x=>{if(x.stopPropagation(),!h)return;let E=h.hidden;h.hidden=!E,p.classList.toggle("is-open",!h.hidden)}),h?.querySelectorAll("[data-auto-action]").forEach(x=>{x.addEventListener("click",E=>{E.stopPropagation();let k=x.dataset.autoAction;k==="toggle"?this.analyzeBtn?.click():k==="memory"?(je(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):k==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),h&&(h.hidden=!0),p?.classList.remove("is-open")})}),this.shadow.addEventListener("click",x=>{x.target.closest(".eq-menu-shell")||(h&&(h.hidden=!0),p?.classList.remove("is-open"))});let b=this.shadow.querySelector("#eq-result-toggle"),v=this.shadow.querySelector("#eq-result-body");b&&v&&(v.classList.add("is-collapsed"),b.classList.remove("is-open"),b.addEventListener("click",()=>{let x=b.classList.toggle("is-open");v.classList.toggle("is-collapsed",!x)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let x=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!x){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let E=V.addKey(x);if(E.ok){let k=V.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${k.length} chaves ativas no pool)`,"success"),d(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Ue(x).then(w=>{w.ok?(V.markSuccess(x,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(V.markInvalid(x,w.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${w.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(E.message,"warning")}),this.keyMoreBtn.addEventListener("click",x=>{x.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",x=>{let E=x.target;!E.closest("#eq-key-context-menu")&&!E.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(x!==null&&x.trim()){let E=x.trim().replace(/^["']|["']$/g,""),k=V.addKey(E);if(k.ok){let w=V.exportRawKeys();this.callbacks.onSettingsChange({apiKey:w[0],apiKeys:w}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(k.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let x=await navigator.clipboard.readText();if(x){let E=x.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=E,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let x=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(x!==null&&x.trim()){let E=x.trim().replace(/^["']|["']$/g,"");if(V.addKey(E).ok){let w=V.exportRawKeys();this.callbacks.onSettingsChange({apiKey:w[0],apiKeys:w}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=this.apiKeyInput.type==="password";this.apiKeyInput.type=x?"text":"password";let E=this.shadow.querySelector("#eq-menu-vis-icon"),k=this.shadow.querySelector("#eq-menu-vis-text");E&&(E.innerHTML=x?L.eyeOff:L.eye),k&&(k.textContent=x?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let x=document.createElement("div");x.id="eq-bulk-overlay",x.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let E=document.createElement("div");E.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),E.innerHTML=`
      ...
      `,x.appendChild(E),this.shadow.appendChild(x);let k=E.querySelector("#eq-bulk-ta"),w=E.querySelector("#eq-bulk-status"),I=E.querySelector("#eq-bulk-import"),P=E.querySelector("#eq-bulk-paste-btn"),q=E.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>k?.focus());let z=()=>{x.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(R=>{x.addEventListener(R,U=>{U.stopPropagation(),U.stopImmediatePropagation()},!0)}),x.addEventListener("keydown",R=>{R.key==="Escape"&&z()}),x.addEventListener("click",R=>{R.target===x&&z()}),E.querySelector("#eq-bulk-x")?.addEventListener("click",z),E.querySelector("#eq-bulk-cancel")?.addEventListener("click",z),q.addEventListener("click",()=>{k.value="",w.textContent="",k.focus()}),P.addEventListener("click",async()=>{try{let R=await navigator.clipboard?.readText();R?(k.value=R,k.focus(),w.style.color="#38bdf8",w.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(w.style.color="#fbbf24",w.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{w.style.color="#fbbf24",w.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",k.focus()}}),E.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let R=k.value.trim();if(!R){w.style.color="#f87171",w.textContent="Insira pelo menos uma chave de API antes de importar.";return}let U=R.match(/AIza[0-9A-Za-z\-_]{35}/g),S=[];if(U&&U.length>0?S=Array.from(new Set(U)):S=Array.from(new Set(R.split(/[\n,;\s]+/).map(Q=>Q.trim().replace(/^["'`]|["'`]$/g,"")).filter(Q=>Q.length>=20))),S.length===0){w.style.color="#f87171",w.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}w.style.color="#00e5ff",w.textContent=`Processando ${S.length} chave(s)...`,I.disabled=!0,I.style.opacity="0.6";let D=0,O=0;for(let Q of S){let K=V.addKey(Q);K.ok?D++:K.message.includes("j\xE1 est\xE1 cadastrada")&&O++}if(D>0){let Q=V.exportRawKeys();this.callbacks.onSettingsChange({apiKey:Q[0],apiKeys:Q}),d(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}w.textContent=`${D} adicionada(s), ${O} duplicada(s). Validando modelo em paralelo...`;let F=V.exportRawKeys(),H=this.modelSelect?.value||"gemini-3.5-flash-lite",B=await ct(H,F);B.ok?(V.markSuccess(B.key,200),w.style.color="#4ade80",w.textContent=` ${D} adicionada(s), ${O} duplicada(s). Modelo '${B.model}' pronto!`):(w.style.color="#fbbf24",w.textContent=`${D} adicionada(s), ${O} duplicada(s). Aviso: ${B.message}`),this.renderKeysList(),I.disabled=!1,I.style.opacity="1",D>0&&(this.setStatus(` Lote importado: ${D} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(z,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let x=V.exportRawKeys(),E=document.createElement("div");E.id="eq-text-editor-overlay",E.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let k=document.createElement("div");k.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),k.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
      ...
      `,E.appendChild(k),this.shadow.appendChild(E);let w=k.querySelector("#eq-edittext-ta"),I=k.querySelector("#eq-edittext-status");w.value=x.join(`
`),requestAnimationFrame(()=>{w.focus(),w.select()});let P=()=>E.remove();["keydown","keyup","keypress","paste","copy","cut"].forEach(q=>{E.addEventListener(q,z=>{z.stopPropagation(),z.stopImmediatePropagation()},!0)}),E.addEventListener("keydown",q=>{q.key==="Escape"&&P()}),E.addEventListener("click",q=>{q.target===E&&P()}),k.querySelector("#eq-edittext-x")?.addEventListener("click",P),k.querySelector("#eq-edittext-cancel")?.addEventListener("click",P),k.querySelector("#eq-edittext-clear")?.addEventListener("click",()=>{confirm("Apagar todas as chaves? Esta a\xE7\xE3o \xE9 irrevers\xEDvel.")&&(w.value="",I.style.color="#fbbf24",I.textContent="Campo limpo. Clique em Salvar para confirmar a remo\xE7\xE3o de todas as chaves.")}),k.querySelector("#eq-edittext-save")?.addEventListener("click",()=>{let q=w.value.split(/[\n\r]+/).map(U=>U.trim().replace(/^["']|["']$/g,"")).filter(U=>U.length>5),z=Array.from(new Set(q));V.init(z);let R=V.exportRawKeys();this.callbacks.onSettingsChange({apiKey:R[0]||"",apiKeys:R}),this.renderKeysList(),I.style.color="#4ade80",z.length===0?I.textContent=" Todas as chaves removidas.":I.textContent=` ${z.length} chave(s) salva(s) com sucesso!`,this.setStatus(z.length>0?` ${z.length} chave(s) salva(s)!`:"Todas as chaves foram removidas.",z.length>0?"success":"info"),setTimeout(P,1400)})}),this.shadow.querySelector("#eq-menu-delete-all")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=V.getAllKeys();if(x.length===0)return this.setStatus("Nenhuma chave para apagar.","info");confirm(`Apagar todas as ${x.length} chave(s) permanentemente?`)&&(V.init([]),this.callbacks.onSettingsChange({apiKey:"",apiKeys:[]}),this.renderKeysList(),this.setStatus("Todas as chaves foram removidas.","info"))}),this.shadow.querySelector("#eq-menu-test")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;let x=V.getAllKeys();if(x.length===0)return this.setStatus("Nenhuma chave cadastrada para testar.","error");this.setStatus(` Testando ${x.length} chave(s) em paralelo...`,"info");let E=this.modelSelect?.value||"gemini-3.5-flash-lite",k=x.map(I=>I.key),w=await ct(E,k);if(w.ok)V.markSuccess(w.key,150),this.setStatus(` Validado! Modelo '${w.model}' respondeu com sucesso!`,"success");else{let I=await Promise.allSettled(k.map(q=>Ue(q))),P=0;I.forEach((q,z)=>{if(q.status==="fulfilled"&&q.value.ok)P++,V.markSuccess(k[z],200);else{let R=q.status==="fulfilled"?q.value.message:String(q.reason);V.markInvalid(k[z],R)}}),this.setStatus(`Teste: ${P}/${x.length} chave(s) v\xE1lidas. ${w.message}`,P>0?"info":"error")}this.renderKeysList()});let y=()=>{this.keyContextMenu.hidden=!0,window.confirm("Deseja realmente resetar todos os dados, chaves e mem\xF3ria de sess\xE3o do EasyQuiz?")&&(this.autopilot.isActive()&&this.autopilot.stop(),this.updateAutopilotUi(!1),this.setBusy(!1),Lt(),Ie(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.className="eq-live-stopwatch-status"),this.updateTimingMetrics(),this.apiKeyInput.value="",this.callbacks.onSettingsChange({apiKey:""}),this.setStatus("Todos os dados do EasyQuiz foram limpos.","info"),this.logToConsole("> [SYS] Armazenamento local resetado.","text-yellow"))};this.shadow.querySelector("#eq-menu-reset")?.addEventListener("click",y),this.shadow.querySelector("#eq-reset-all-btn")?.addEventListener("click",y),this.apToggleBtn?.addEventListener("click",()=>{if(this.autopilot.isActive())this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setInterrupted("Autopilot interrompido imediatamente pelo usu\xE1rio.");else{if(!this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"")){this.setStatus("Configure sua chave de API Gemini na aba Configura\xE7\xF5es antes de ligar o Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,dt(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Autopilot ativo. Monitorando exerc\xEDcios...","info")}}),this.shadow.querySelector("#eq-ap-clear-memory")?.addEventListener("click",()=>{je(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")});let T=this.shadow.querySelector("#eq-copy-console-btn");T?.addEventListener("click",()=>{let x=this.apConsole?.innerText||"";navigator.clipboard.writeText(x).then(()=>{let E=T.innerHTML;T.innerHTML=L.check,setTimeout(()=>T.innerHTML=E,1800)})}),this.copyPromptBtn?.addEventListener("click",()=>{let x=this.inspPrompt.textContent||"";navigator.clipboard.writeText(x).then(()=>{if(!this.copyPromptBtn)return;let E=this.copyPromptBtn.innerHTML;this.copyPromptBtn.innerHTML=`${L.check} Copiado!`,setTimeout(()=>this.copyPromptBtn.innerHTML=E,2e3)})}),this.modelSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({model:this.modelSelect.value})),this.modeSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({modeHint:this.modeSelect.value})),this.engineSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({engine:this.engineSelect.value})),this.dryRunCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({dryRun:this.dryRunCheckbox.checked})),this.autoApplyCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoApply:this.autoApplyCheckbox.checked})),this.autoAdvanceCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoAdvance:this.autoAdvanceCheckbox.checked})),this.useVisionCheckbox.addEventListener("change",()=>{let x=this.useVisionCheckbox.checked;this.callbacks.onSettingsChange({useVision:x}),this.setStatus(x?"Vis\xE3o Computacional ativada (capturas habilitadas).":"Modo DOM R\xE1pido ativado (capturas desabilitadas).","info")}),this.hostDarkModeCheckbox.addEventListener("change",()=>{let x=this.hostDarkModeCheckbox.checked;this.callbacks.onSettingsChange({hostDarkMode:x}),this.applyHostDarkMode(x)}),this.analyzeBtn?.addEventListener("click",async()=>{if(this.analyzeBtn.classList.contains("danger")){this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setBusy(!1),this.setInterrupted("Resolver Autopilot interrompido pelo usu\xE1rio.");return}if(!this.apiKeyInput.value.trim().replace(/^['"]|['"]$/g,"")){this.setStatus("Configure sua chave de API Gemini antes de ativar o Resolver Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,dt(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Resolver Autopilot ativo. Monitorando e respondendo...","info")}),this.applyBtn&&this.applyBtn.addEventListener("click",()=>this.callbacks.onApply())}startStopwatch(){this.stopStopwatch(),this.stopwatchStartTime=Date.now();let e=()=>{let t=((Date.now()-this.stopwatchStartTime)/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)};e(),this.stopwatchInterval=setInterval(e,100)}stopStopwatch(e){if(this.stopwatchInterval&&(clearInterval(this.stopwatchInterval),this.stopwatchInterval=null),e!==void 0){let t=(e/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)}}setLogFilter(e){this.activeLogFilter=e;let t=["all","error","ai","dom"];for(let o of t){let s=this.shadow.querySelector(`#eq-dbg-filter-${o}`);o===e?s?.classList.add("active"):s?.classList.remove("active")}this.renderTerminalEntries()}updateLogCounters(){let e=0,t=0,o=0;for(let s of this.logEntries)s.category==="error"?e++:s.category==="ai"?t++:s.category==="dom"&&o++;this.dbgCountAll&&(this.dbgCountAll.textContent=String(this.logEntries.length)),this.dbgCountError&&(this.dbgCountError.textContent=String(e)),this.dbgCountAi&&(this.dbgCountAi.textContent=String(t)),this.dbgCountDom&&(this.dbgCountDom.textContent=String(o))}renderTerminalEntries(){if(!this.liveDebugTerminal)return;this.liveDebugTerminal.replaceChildren();let e=this.activeLogFilter==="all"?[...this.logEntries]:this.logEntries.filter(t=>t.category===this.activeLogFilter);if(this.outputSearchQuery){let t=this.outputSearchQuery.toLowerCase();e=e.filter(o=>o.message.toLowerCase().includes(t))}if(this.outputSortNewest||(e=e.reverse()),e.length===0){let t=document.createElement("div");t.style.cssText="color:#333;font-style:italic;white-space:pre-wrap;",t.textContent=this.outputSearchQuery?'Nenhum resultado para "'+this.outputSearchQuery+'".':'Nenhum log para o filtro "'+this.activeLogFilter.toUpperCase()+'".',this.liveDebugTerminal.appendChild(t);return}for(let t of e){let o=document.createElement("div");o.style.cssText="padding:1px 0;white-space:pre-wrap;overflow-wrap:break-word;word-break:break-word;max-width:100%;",o.textContent=t.message,t.colorClass&&(o.className=t.colorClass),this.liveDebugTerminal.appendChild(o)}this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}appendTerminalLine(e,t){if(!this.liveTerminalOutput)return;let o=this.shadow.querySelector("#eq-term-current-line"),s=document.createElement("div");s.style.cssText="padding:0;white-space:pre-wrap;overflow-wrap:break-word;",s.textContent=e;let a=t==="text-red"?"#ff4444":t==="text-blue"?"#888":t==="text-green"?"#aaa":t==="text-yellow"?"#888":"#ccc";for(s.style.color=a,o?this.liveTerminalOutput.insertBefore(s,o):this.liveTerminalOutput.appendChild(s);this.liveTerminalOutput.children.length>600;){let r=this.liveTerminalOutput.firstChild;if(r&&r!==o)this.liveTerminalOutput.removeChild(r);else break}this.liveTerminalOutput.scrollTop=this.liveTerminalOutput.scrollHeight}initTerminalREPL(){if(this.liveTerminalOutput=this.shadow.querySelector("#eq-term-output"),this._terminalInited){this._reconnectContextbarBtns();return}this._terminalInited=!0;let e=this.shadow.querySelector("#eq-term-capture"),t=this.shadow.querySelector("#eq-term-output"),o=this.shadow.querySelector("#eq-term-typed"),s=this.shadow.querySelector("#eq-term-current-line"),a=this.shadow.querySelector("#eq-term-panel-terminal"),r=this.shadow.querySelector("#eq-term-panel-output"),i=this.shadow.querySelector("#eq-output-toolbar"),c=this.shadow.querySelector("#eq-output-search"),l=this.shadow.querySelector("#eq-output-search-clear"),u=this.shadow.querySelector("#eq-output-filter-btn"),f=this.shadow.querySelector("#eq-output-filter-menu"),d=this.shadow.querySelector("#eq-fchk-apply"),m=(S,D="#888",O=13)=>`<span style="display:inline-flex;vertical-align:middle;width:${O}px;height:${O}px;color:${D};flex-shrink:0;">${L[S]||""}</span>`,p=(S,D="")=>{if(!t||!s)return;let O=document.createElement("div");O.style.cssText="padding:0;white-space:pre-wrap;overflow-wrap:break-word;word-break:break-word;max-width:100%;line-height:1.65;"+D,O.innerHTML=S,t.insertBefore(O,s)},h=(S,D="#cccccc")=>p(`<span style="color:${D};">${S}</span>`),b=()=>h("","#000"),v=(S=52)=>h("  "+"\u2500".repeat(S),"#222"),A=(S,D,O)=>{let F=S.map((B,Q)=>B.padEnd(D[Q]||0)),H=O?F.map((B,Q)=>`<span style="color:${O[Q]||"#aaa"}">${B}</span>`):F.map(B=>`<span style="color:#aaa">${B}</span>`);p("  "+H.join("  ")+"  ")},y=S=>{let D=S.trim().split(/s+/),O=D[0].toLowerCase();switch(O){case"help":b(),p("  "+m("terminal","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> COMANDOS DISPON\xCDVEIS</span>'),b(),[["help","lista todos os comandos","list","#666"],["status","estado atual do sistema","sparkles","#666"],["version","vers\xE3o e info do build","info","#666"],["info-api","dados da \xFAltima requisi\xE7\xE3o \xE0 API","chip","#666"],["tokens","tokens consumidos (detalhado)","code","#666"],["context","contexto da quest\xE3o atual","eye","#666"],["controls","controles detectados (tabela)","list","#666"],["errors","erros recentes registrados","info","#666"],["logs [n]","\xFAltimas N entradas do output","file","#666"],["history","hist\xF3rico de quest\xF5es respondidas","clock","#666"],["reset","limpa logs e m\xE9tricas","eraser","#666"],["clear","limpa o terminal","trash","#666"],["copy","copia terminal para clipboard","copy","#666"]].forEach(([H,B,Q,K])=>{p(`    ${m(Q,K,11)} <span style="color:#ccc;font-weight:600;min-width:72px;display:inline-block;">${H.padEnd(10)}</span> <span style="color:#555;">${B}</span>`)}),b();break;case"clear":t&&s&&[...t.children].forEach(B=>{B!==s&&B.remove()});return;case"info-api":{let H=this.latestPlan;b(),p("  "+m("chip","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> INFORMA\xC7\xD5ES DA API</span>'),v(44);let B=(Q,K,ue,Ae,ke="#aaa")=>p(`  ${m(Q,K,11)}  <span style="color:#444;">${ue.padEnd(16)}</span><span style="color:${ke};font-weight:600;">${Ae||"--"}</span>`);B("sparkles","#888","Modelo",H?.usedModel||this.initialSettings?.model||"--","#ccc"),B("clock","#888","Lat\xEAncia",H?.durationMs?H.durationMs+"ms":"--","#ccc"),B("code","#888","Prompt tokens",String(H?.promptTokens??"--")),B("code","#888","Resp. tokens",String(H?.candidatesTokens??"--")),B("chip","#aaa","Total tokens",String(H?.tokensUsed??"--"),"#fff"),B("file","#888","Prompt chars",this.latestPromptText?.length?this.latestPromptText.length+" chars":"--"),v(44),b();break}case"version":b(),p("  "+m("sparkles","#888",14)+` <span style="color:#ddd;font-weight:700;"> EasyQuiz ${typeof ve<"u"?ve:"?"}</span>`),h("  Motor: H\xEDbrido 4.0  \xB7  RAG + AST + Vision + Multimodal","#555"),h("  Build: "+new Date().toLocaleDateString("pt-BR"),"#333"),b();break;case"status":{let H=this.latestPlan,B=this.latestContext;b(),p("  "+m("inspector","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> STATUS DO SISTEMA</span>'),v(44);let Q=(K,ue,Ae,ke,Le="#aaa")=>p(`  ${m(K,ue,11)}  <span style="color:#444;">${Ae.padEnd(14)}</span><span style="color:${Le};">${ke||"--"}</span>`);if(Q("sparkles","#888","Modelo",H?.usedModel||this.initialSettings?.model||"--","#ccc"),Q("play","#888","Modo",H?.mode||"aguardando"),Q("clock","#888","Lat\xEAncia",H?.durationMs?H.durationMs+"ms":"--","#aaa"),Q("chip","#888","Tokens",String(H?.tokensUsed??"--")),Q("analyze","#888","Confian\xE7a",H?Math.round(H.confidence*100)+"%":"--"),Q("eye","#888","Controles",B?String(B.controls.length):"--"),B){let K='"'+B.questionText.slice(0,50)+(B.questionText.length>50?"...":"")+'"';Q("file","#888","Contexto",K,"#666")}v(44),b();break}case"tokens":{let H=this.latestPlan;if(b(),!H){h("  Nenhuma requisi\xE7\xE3o ainda.","#444"),b();break}p("  "+m("code","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> TOKENS CONSUMIDOS</span>'),v(38),h(`  Prompt tokens    ${String(H.promptTokens??"--").padStart(8)}`,"#888"),h(`  Response tokens  ${String(H.candidatesTokens??"--").padStart(8)}`,"#888"),h("  "+"\u2508".repeat(28),"#222"),h(`  Total            ${String(H.tokensUsed??"--").padStart(8)}`,"#ddd"),h(`  Lat\xEAncia         ${(H.durationMs?H.durationMs+"ms":"--").padStart(8)}`,"#aaa"),v(38),b();break}case"context":{let H=this.latestContext;if(b(),!H){h("  Contexto n\xE3o dispon\xEDvel.","#444"),b();break}p("  "+m("eye","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> CONTEXTO ATUAL</span>'),v(44),h("  Escopo    "+H.scope.tagName.toLowerCase()+(H.scope.id?"#"+H.scope.id:""),"#aaa"),h("  Controles "+H.controls.length,"#aaa"),h("  Texto     "+H.questionText.slice(0,55)+(H.questionText.length>55?"...":""),"#888"),v(44),b();break}case"controls":{let H=this.latestContext;if(b(),!H?.controls.length){h("  Nenhum controle detectado.","#444"),b();break}p("  "+m("list","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> CONTROLES (${H.controls.length})</span>`),v(55),A(["#","Tipo","Label / ID","Valor"],[3,10,27,10],["#555","#777","#aaa","#888"]),h("  "+"\u2508".repeat(53),"#222"),H.controls.forEach((B,Q)=>A([String(Q+1),(B.type||B.tag||"?").toUpperCase().slice(0,9),(B.label||B.id||B.name||"\u2014").slice(0,26),(B.value||"\u2014").slice(0,9)],[3,10,27,10],["#555","#777","#ccc","#888"])),v(55),b();break}case"errors":{let H=this.logEntries.filter(B=>B.category==="error");if(b(),!H.length){p("  "+m("check","#4ade80",11)+' <span style="color:#555;"> Nenhum erro nesta sess\xE3o.</span>'),b();break}p("  "+m("info","#ff5555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> ERROS (${H.length})</span>`),v(44),H.slice(-15).forEach(B=>h("  "+B.message,"#888")),v(44),b();break}case"logs":{let H=Math.min(parseInt(D[1]||"10",10)||10,50),B=this.logEntries.slice(-H);if(b(),!B.length){h("  Nenhum log.","#444"),b();break}p("  "+m("file","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> \xDALTIMAS ${H} ENTRADAS</span>`),v(44),B.forEach(Q=>h("  "+Q.message,"#777")),v(44),b();break}case"history":{let H=this.metricsHistory;if(b(),!H?.length){h("  Nenhuma quest\xE3o respondida.","#444"),b();break}p("  "+m("clock","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> HIST\xD3RICO (${H.length})</span>`),v(58),A(["#","Quest\xE3o","Tempo","Modelo"],[3,38,7,10],["#555","#aaa","#888","#777"]),h("  "+"\u2508".repeat(58),"#222"),H.slice(-15).forEach((B,Q)=>A([String(Q+1),(B.questionTitle||"Quest\xE3o").slice(0,37),B.durationMs?(B.durationMs/1e3).toFixed(1)+"s":"--",(B.model||"--").slice(0,9)],[3,38,7,10],["#555","#ccc","#888","#777"])),v(58),b();break}case"reset":this.clearLogs(),b(),p("  "+m("check","#888",11)+' <span style="color:#666;"> Logs e m\xE9tricas resetados.</span>'),b();break;case"copy":{if(!t)break;let H=Array.from(t.children).filter(B=>B!==s).map(B=>B.textContent||"");navigator.clipboard.writeText(H.join(`
`)).then(()=>{p("  "+m("copy","#888",11)+' <span style="color:#666;"> Conte\xFAdo copiado para a \xE1rea de transfer\xEAncia.</span>'),this.showToast("Terminal copiado","success",2e3)});break}case"":break;default:b(),p(`  <span style="color:#555;">Comando n\xE3o reconhecido: </span><span style="color:#888;">&quot;${O}&quot;</span>`),p('  <span style="color:#333;">Digite </span><span style="color:#666;font-weight:600;">help</span><span style="color:#333;"> para ver os comandos.</span>'),b()}t&&(t.scrollTop=t.scrollHeight)},C=S=>{this.terminalMode=S;let D=S==="terminal";a&&(a.style.display=D?"flex":"none"),r&&(r.style.display=D?"none":"flex"),i&&(i.style.display=D?"none":"flex");let O=this.shadow.querySelector("#eq-term-mode-terminal"),F=this.shadow.querySelector("#eq-term-mode-output");O&&(O.style.background=D?"#181818":"transparent",O.style.borderColor=D?"#2a2a2a":"transparent",O.style.color=D?"#ddd":"#555"),F&&(F.style.background=D?"transparent":"#181818",F.style.borderColor=D?"transparent":"#2a2a2a",F.style.color=D?"#555":"#ddd"),D||this.renderTerminalEntries()};this._reconnectContextbarBtns=()=>{let S=this.shadow.querySelector("#eq-term-mode-terminal"),D=this.shadow.querySelector("#eq-term-mode-output");S?.addEventListener("click",()=>C("terminal")),D?.addEventListener("click",()=>C("output"));let O=this.shadow.querySelector("#eq-term-copy-btn"),F=this.shadow.querySelector("#eq-term-clear-btn");O?.addEventListener("click",()=>{let H=Q=>{let K=Q.style.color;Q.style.color="#4ade80",setTimeout(()=>Q.style.color=K,400)},B=window.getSelection()?.toString()||"";if(this.terminalMode==="terminal"){if(B)navigator.clipboard.writeText(B).then(()=>{this.showToast("Sele\xE7\xE3o copiada","success",2e3),O&&H(O)});else if(t){let Q=Array.from(t.children).filter(K=>K!==s).map(K=>K.textContent||"");navigator.clipboard.writeText(Q.join(`
`)).then(()=>{this.showToast("Terminal copiado","success",2e3),O&&H(O)})}}else B?navigator.clipboard.writeText(B).then(()=>{this.showToast("Sele\xE7\xE3o copiada","success",2e3),O&&H(O)}):navigator.clipboard.writeText(this.getFormattedLogs()).then(()=>{this.showToast("Output copiado","success",2e3),O&&H(O)})}),F?.addEventListener("click",()=>{this.terminalMode==="terminal"?(t&&s&&[...t.children].forEach(H=>{H!==s&&H.dataset?.perm!=="1"&&H.remove()}),o&&(o.textContent="")):this.clearLogs()})},this._reconnectContextbarBtns();let T=()=>{e?.focus(),t?.classList.remove("eq-term-unfocused")},x=this.shadow.querySelector("#eq-click-cursor"),E=!1;t?.addEventListener("mousedown",S=>{if(E=!1,x&&(x.style.display="none"),setTimeout(()=>T(),0),x){let D=parseFloat(getComputedStyle(t).lineHeight)||19,O=S.clientX,F=S.clientY-D*.85;try{let H=document.caretRangeFromPoint?document.caretRangeFromPoint(S.clientX,S.clientY):null;if(H){let B=H.getBoundingClientRect();B.height>0&&(O=B.left,F=B.top)}}catch{}x.style.left=O+"px",x.style.top=F+"px",x.style.display="block"}}),t?.addEventListener("mousemove",S=>{S.buttons===1&&(E=!0,x&&(x.style.display="none"))}),t?.addEventListener("mouseup",()=>{let S=window.getSelection();S&&S.toString().length>0&&(x&&(x.style.display="none"),E=!1)}),e?.addEventListener("keydown",()=>{x&&(x.style.display="none")},{passive:!0}),t?.addEventListener("focus",()=>t.classList.remove("eq-term-unfocused")),e?.addEventListener("blur",()=>t?.classList.add("eq-term-unfocused")),e?.addEventListener("focus",()=>t?.classList.remove("eq-term-unfocused")),e?.addEventListener("keydown",S=>{if(!o)return;let D=o.textContent||"";if(S.key==="Enter"){S.preventDefault();let O=D.trim();if(o.textContent="",this.terminalCmdHistoryIdx=-1,O&&(this.terminalCmdHistory.unshift(O),this.terminalCmdHistory.length>50&&this.terminalCmdHistory.pop()),s){let F=document.createElement("div");F.style.cssText="white-space:pre-wrap;overflow-wrap:break-word;",F.innerHTML=`<span style="color:#fff;font-weight:700;">EasyQuiz_Legacy:&nbsp;</span><span style="color:#888;">${O}</span>`,t?.insertBefore(F,s)}O&&y(O),t&&(t.scrollTop=t.scrollHeight)}else if(S.key==="Backspace")S.preventDefault(),o.textContent=D.slice(0,-1);else if(S.key==="ArrowUp")S.preventDefault(),this.terminalCmdHistoryIdx=Math.min(this.terminalCmdHistoryIdx+1,this.terminalCmdHistory.length-1),this.terminalCmdHistoryIdx>=0&&(o.textContent=this.terminalCmdHistory[this.terminalCmdHistoryIdx]);else if(S.key==="ArrowDown")S.preventDefault(),this.terminalCmdHistoryIdx=Math.max(this.terminalCmdHistoryIdx-1,-1),o.textContent=this.terminalCmdHistoryIdx>=0?this.terminalCmdHistory[this.terminalCmdHistoryIdx]:"";else if(S.key==="c"&&S.ctrlKey){let O=window.getSelection()?.toString()||"";O?navigator.clipboard.writeText(O):o?.textContent&&navigator.clipboard.writeText(o.textContent);let F=this.shadow.querySelector("#eq-term-copy-btn");if(F){let H=F.style.color;F.style.color="#4ade80",setTimeout(()=>F.style.color=H,400)}}else S.key==="v"&&S.ctrlKey?(S.preventDefault(),navigator.clipboard.readText().then(O=>{o&&(o.textContent=(o.textContent||"")+O.replace(/\n/g," ")),t&&(t.scrollTop=t.scrollHeight)})):S.key==="l"&&S.ctrlKey?(S.preventDefault(),t&&s&&[...t.children].forEach(O=>{O!==s&&O.dataset?.perm!=="1"&&O.remove()}),o.textContent=""):S.key.length===1&&!S.ctrlKey&&!S.metaKey&&(S.preventDefault(),o.textContent=D+S.key,t&&(t.scrollTop=t.scrollHeight))}),e?.addEventListener("paste",S=>{S.preventDefault();let D=S.clipboardData?.getData("text")||"",O=/\n/g;o&&(o.textContent=(o.textContent||"")+D.replace(O," "))});let k=()=>{let S=this.shadow.querySelector("#eq-fchk-all")?.checked,D=this.shadow.querySelector("#eq-fchk-error")?.checked,O=this.shadow.querySelector("#eq-fchk-ai")?.checked,F=this.shadow.querySelector("#eq-fchk-dom")?.checked;S?this.activeLogFilter="all":D&&!O&&!F?this.activeLogFilter="error":O&&!D&&!F?this.activeLogFilter="ai":F&&!D&&!O?this.activeLogFilter="dom":this.activeLogFilter="all";let H=this.shadow.querySelector("#eq-output-filter-label"),B={all:"Todos",error:"Erros",ai:"IA",dom:"DOM"};if(H){let Q={all:"Todos",error:"Erros",ai:"IA",dom:"DOM"},K=this.shadow.querySelector("#eq-fchk-error")?.checked,ue=this.shadow.querySelector("#eq-fchk-ai")?.checked,Ae=this.shadow.querySelector("#eq-fchk-dom")?.checked,ke=this.shadow.querySelector("#eq-fchk-all")?.checked,Le=[K,ue,Ae].filter(Boolean).length;ke||Le===0?H.textContent="Todos":Le===1?H.textContent=Q[this.activeLogFilter]||this.activeLogFilter:H.textContent="\u22EF ("+Le+")"}this.renderTerminalEntries()};u?.addEventListener("click",S=>{if(S.stopPropagation(),!f)return;let D=f.style.display!=="none";f.style.display=D?"none":"block"}),f?.addEventListener("mousedown",S=>S.stopPropagation());let w=this.shadow.querySelector("#eq-fchk-all"),I=this.shadow.querySelector("#eq-fchk-error"),P=this.shadow.querySelector("#eq-fchk-ai"),q=this.shadow.querySelector("#eq-fchk-dom"),z=[I,P,q].filter(Boolean);w?.addEventListener("change",()=>{w.checked?z.forEach(S=>{S.checked=!1}):w.checked=!0,k()}),z.forEach(S=>{S.addEventListener("change",()=>{S.checked&&w&&(w.checked=!1),!z.some(O=>O.checked)&&w&&(w.checked=!0),k()})}),document.addEventListener("mousedown",()=>{f&&f.style.display!=="none"&&(f.style.display="none")});let R=this.shadow.querySelector("#eq-output-sort-btn"),U=this.shadow.querySelector("#eq-sort-arrow");if(U&&(U.style.transform="rotate(270deg)"),R?.addEventListener("click",()=>{this.outputSortNewest=!this.outputSortNewest,U&&(U.style.transform=this.outputSortNewest?"rotate(270deg)":"rotate(90deg)"),R&&(R.style.color=this.outputSortNewest?"#aaa":"#60a5fa"),this.renderTerminalEntries()}),c?.addEventListener("input",()=>{this.outputSearchQuery=c.value,l&&(l.style.display=c.value?"inline":"none"),this.renderTerminalEntries()}),l?.addEventListener("click",()=>{c&&(c.value=""),this.outputSearchQuery="",l&&(l.style.display="none"),this.renderTerminalEntries()}),this.liveDebugTerminal){let S=null;this.liveDebugTerminal.addEventListener("scroll",()=>{S&&clearTimeout(S),S=setTimeout(()=>{if(!this.liveDebugTerminal)return;let D=this.liveDebugTerminal,O=D.scrollHeight-D.scrollTop-D.clientHeight,F=this.shadow.querySelector("#eq-dbg-scroll-toggle");O>40?(this.autoScrollLogs=!1,F&&(F.style.color="#333",F.style.borderColor="rgba(255,255,255,0.07)",F.title="Auto-scroll: desativado")):O<10&&(this.autoScrollLogs=!0,F&&(F.style.color="#ddd",F.style.borderColor="rgba(255,255,255,0.18)",F.title="Auto-scroll: ativo"))},150)})}this.shadow.querySelector("#eq-dbg-scroll-toggle")?.addEventListener("click",S=>{this.autoScrollLogs=!this.autoScrollLogs;let D=S.currentTarget;D.style.color=this.autoScrollLogs?"#ddd":"#333",D.style.borderColor=this.autoScrollLogs?"rgba(255,255,255,0.18)":"rgba(255,255,255,0.07)",D.title=this.autoScrollLogs?"Auto-scroll: ativo":"Auto-scroll: desativado"}),C("terminal"),setTimeout(()=>T(),80)}clearLogs(){if(this.logEntries=[],this.updateLogCounters(),this.liveDebugTerminal){this.liveDebugTerminal.replaceChildren();let e=document.createElement("div");e.style.cssText="color:#333;",e.textContent="> [SYS] Output limpo.",this.liveDebugTerminal.appendChild(e)}this.apConsole&&this.apConsole.replaceChildren(),this.executionConsole&&this.executionConsole.replaceChildren()}getFormattedLogs(){return(this.activeLogFilter==="all"?this.logEntries:this.logEntries.filter(t=>t.category===this.activeLogFilter)).map(t=>t.message).join(`
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let o=t?`[${t}] ${e}`:e;this.setLastError(o)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,o=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let s=e?.promptTokens!==void 0?String(e.promptTokens):"--",a=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${s} / ${a}`,this.dbgSplitTokens.title=`Prompt: ${s} tokens | Resposta: ${a} tokens`}if(this.dbgTotalTokens){let s=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=s!==void 0?`${s}`:"--"}if(this.dbgPromptLen){let s=o.length,a=Math.round(s/4);this.dbgPromptLen.textContent=`${s}c (~${a}tok)`}this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let o=new Date,s=`${String(o.getHours()).padStart(2,"0")}:${String(o.getMinutes()).padStart(2,"0")}:${String(o.getSeconds()).padStart(2,"0")}.${String(Math.floor(o.getMilliseconds()/100))}`,a=e;e.startsWith(">")?a=`> [${s}] ${e.slice(1).trim()}`:a=`[${s}] ${e}`;let r="all";t==="text-red"||a.includes("[ERRO]")||a.includes("Falha")||a.includes("Error")?r="error":a.includes("[IA]")||a.includes("[RAG]")||a.includes("Tokens")||a.includes("Gemini")||a.includes("Modelo:")?r="ai":(a.includes("[DOM]")||a.includes("[EXEC]")||a.includes("[VERIF]")||a.includes("[NAV]"))&&(r="dom");let i={id:Date.now()+Math.random(),timestamp:s,message:a,colorClass:t,category:r};for(this.logEntries.push(i);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),r==="error"&&this.setLastError(a),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===r)){let c=document.createElement("div");c.style.cssText="padding:1px 0;",c.textContent=a,t&&(c.className=t),this.liveDebugTerminal.appendChild(c)}if(this.liveTerminalOutput&&(r==="dom"||r==="all"||r==="error")){for(this.appendTerminalLine(a,t);this.liveDebugTerminal.children.length>300;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.apConsole.appendChild(c),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.executionConsole.appendChild(c),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let o=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${o}%`,this.progressVal&&(this.progressVal.textContent=`${o}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),o>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions)),this.activeTab==="brain"?(this.renderContextTree(),this.refreshBrainCanvas(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&(this.renderContextTree(),this.refreshBrainCanvas()),this.activeTab==="brain"&&(this.brainSelectedFolder==="media-images"||(this.brainActiveTab||"").startsWith("img-"))&&this.refreshBrainCanvas()}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=Qe(),o=this.latestPlan,s=!!(this.latestPromptText||o?.promptSent),a=!!e,r=!!o;this.contextTreeContainer.innerHTML="";let i=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(i);let c=e?e.controls:[],l=c.map((v,A)=>{let y=v.role==="navigation"||v.type==="button",C=!y&&v.value?` [val: "${v.value}"]`:"";return{label:`[#${A+1}] ${v.type.toUpperCase()}`,value:`${v.label||v.id||v.name||"(Sem r\xF3tulo)"}${C}`.trim(),badge:y?"Navega\xE7\xE3o":v.role||v.type}}),u=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${c.length})`,c.length>0,l);this.contextTreeContainer.appendChild(u);let f=t.map((v,A)=>({label:`Mem\xF3ria #${A+1}`,value:v,badge:"RAG"})),d=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,f);if(this.contextTreeContainer.appendChild(d),o){let v=this.createTreeFolder(` \xDALTIMO PLANO IA (${o.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:o.pageType,badge:`${(o.confidence*100).toFixed(0)}%`},{label:"Modo",value:o.mode},{label:"Racioc\xEDnio",value:o.rationale||"N/A"},...o.actions.map((A,y)=>({label:`A\xE7\xE3o #${y+1} (${A.t})`,value:JSON.stringify(A)}))]);this.contextTreeContainer.appendChild(v)}{let v=document.createElement("div");v.style.cssText="border-bottom:1px solid rgba(255,255,255,0.04);";let A=document.createElement("div");A.style.cssText="display:flex;align-items:center;gap:6px;padding:5px 10px;cursor:pointer;font-size:10px;font-weight:600;color:#fbbf24;letter-spacing:0.04em;user-select:none;",A.innerHTML='<span style="display:inline-flex;width:12px;height:12px;color:#fbbf24;">'+L.inspector+"</span> IA ARTIFACTS";let y=document.createElement("div");y.style.cssText="padding-left:16px;overflow:hidden;";let C=(x,E,k,w)=>{let I=document.createElement("div");return I.style.cssText="display:flex;align-items:center;gap:6px;padding:4px 10px 4px 4px;cursor:pointer;border-radius:4px;transition:background 0.1s;"+(this.brainActiveTab===x?"background:rgba(251,191,36,0.1);":""),I.innerHTML='<span style="font-size:9px;color:'+(w?"#fbbf24":"#444")+';">'+L.code+'</span><span style="font-size:10px;color:'+(w?"#ddd":"#444")+';flex:1;">'+E+'</span><span style="font-size:8px;color:#333;">'+k+"</span>",I.addEventListener("click",()=>{this.brainSelectedFolder=null,this.brainActiveTab=x;let P=this.getBrainFileText(x),q=this.shadow.querySelector("#eq-brain-content");if(q){q.innerHTML="";let z=document.createElement("pre");z.className="eq-brain-code",z.style.cssText='padding:12px;font-size:10.5px;line-height:1.55;white-space:pre-wrap;word-break:break-word;color:#d0d8e8;font-family:"Cascadia Code","Fira Code","Courier New",monospace;',z.textContent=P,q.appendChild(z)}this.renderBrainExplorer(),this.renderBrainTabs()}),I};y.appendChild(C("ai-prompt","prompt.txt",s?"pronto":"aguardando",s)),y.appendChild(C("ai-context","context.json",a?"pronto":"aguardando",a)),y.appendChild(C("ai-response","response.txt",r?"pronto":"aguardando",!!o));let T=!1;A.addEventListener("click",()=>{T=!T,y.style.display=T?"block":"none"}),y.style.display="none",v.appendChild(A),v.appendChild(y),this.contextTreeContainer.appendChild(v)}let m=this.latestImages,p=this.latestImageDescriptions,h=m.map((v,A)=>{let y=p.find(k=>k.index===A),C=(v.captureStatus==="captured"||v.captureStatus==="text_only",""),T=v.captureStatus==="captured"?"Visual":v.captureStatus==="text_only"?"Texto":"Falhou",x=y?y.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",E=y?y.description:v.textContext?v.textContext:"Aguardando an\xE1lise IA...";return{label:`${C} Img ${A+1} [${T}]`,value:`${E}`,badge:x,imgSrc:v.base64?`data:${v.mediaType||"image/jpeg"};base64,${v.base64}`:void 0}}),b=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${m.length})`,!0,h);this.contextTreeContainer.appendChild(b)}createTreeFolder(e,t,o){let s=document.createElement("div");s.className="eq-tree-node";let a=document.createElement("div");a.className="eq-tree-header",a.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let r=document.createElement("div");if(r.className="eq-tree-content",r.style.display=t?"flex":"none",o.length===0)r.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let i of o){let c=document.createElement("div");c.className="eq-tree-leaf";let l="";i.imgSrc&&i.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${i.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),c.innerHTML=`
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Nn(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Rn(){let n=window;if(Ie(),Nn(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=ot(),t=null,o=null,s=0,a=new tt(e,{onAnalyze:(l=1,u,f=!1)=>r(l,u,f),onApply:(l=1)=>void i(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}fe(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}fe(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=St(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,f=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,m=()=>{try{d.abort()}catch{}};if(u&&(u.aborted?d.abort():u.addEventListener("abort",m,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}s=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),fe(),a.hideFloatingAnswers();try{let p=me(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ce()),Ne(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let h=await qt(p.scope,e.useVision);if(h.length>0){let T=h.map(x=>x.element).filter(Boolean);Et(T),a.updateImages(h)}if(d.signal.aborted)return;let b=e.model;a.setStatus(h.length>0?`Consultando Gemini (${b}) com ${h.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let v=He(p,h,e);a.setInspectorPrompt(v,e.model);let A=(T,x)=>{a.setStatus(T,x==="warning"?"info":x);let E=T.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(E){let k=E[1].split(",")[0].trim();a.setProgress(50,`Gemini ${k} respondendo...`)}},{plan:y,usedModel:C}=await Xe(p,h,e,A,d.signal);if(d.signal.aborted)return;if(y.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=me(!0),p||(p=ce()),Ne(p.scope),a.updateContext(p),h=await qt(p.scope,e.useVision),h.length>0){let E=h.map(k=>k.element).filter(Boolean);Et(E),a.updateImages(h)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let T=He(p,h,e);a.setInspectorPrompt(T,e.model),y=(await Xe(p,h,e,A,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||e.model} | Modo: ${y.mode} | Confian\xE7a: ${(y.confidence*100).toFixed(0)}%`,"text-green"),y.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${y.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${y.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),y.memoryToStore&&(Mt(y.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${y.memoryToStore}"`,"text-yellow")),y.imageDescriptions&&y.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${y.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let T of y.imageDescriptions){let x=T.relevant?"":"\uFE0F";a.logToConsole(`>   ${x} Imagem ${T.index+1} [${T.relevant?"RELEVANTE":"IGNORADA"}]: ${T.description}`,T.relevant?"text-blue":"text-yellow")}}return t=y,a.updateContext(p,y),Zt(y.actions,y.confidence),a.setPlan(y,!e.dryRun),y.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):y.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):y.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&y.pageType==="question"&&a.showFloatingAnswers(y),d.signal.aborted?void 0:((f||e.autoApply)&&!e.dryRun&&await i(l,d.signal,f),y)}catch(p){if(d.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){fe(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}fe(),a.setProgress(0);let h=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(h,"error"),a.setErrorDiagnostic(h,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function i(l=1,u,f=!1){if(u?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(b=>b.t!=="adv"),p=t.pageType==="question"||Je(t.rationale||"");if(p&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let h=(f||e.autoAdvance||d)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Be(t,h,l,we(e));if(u?.aborted)return;if(a.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let T of b.failedActions){let x=T.action,E=x.t==="drag"?`drag: "${x.from}" \u2192 "${x.to}"`:x.t==="clk"||x.t==="chk"?`${x.t}: "${x.id}"`:x.t==="val"?`val: "${x.id}" = "${x.v}"`:JSON.stringify(x).slice(0,80);a.logToConsole(`>    [${x.t.toUpperCase()}] ${E} | ${T.evidence.slice(0,80)}`,"text-yellow")}await c(b.failedActions,u)}let v=s>0?Date.now()-s:1200,A=b.verified>0,y=b.applied>0;if(b.success||A&&y){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):h&&a.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),a.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let T=Ht({id:`q-${Date.now()}`,questionIndex:(Me().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:v,status:"answered",mode:t.mode,actionsCount:b.applied});a.updateTimingMetrics(T)}else y?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(b){a.setProgress(0);let v=b instanceof Error?b.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${v}`,"error"),a.logToConsole(`> [ERRO] ${v}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,u){if(!t)return;let f=l.filter(m=>m.action.t==="drag");for(let m of f){if(u?.aborted)return;let p=m.action,h=String(p.from||""),b=String(p.to||""),v=Kt(h,b,h,b);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${h}" \u2192 "${b}"`,"text-blue");let A={...t,actions:[{t:"js",v}],pageType:"question"},y=await Be(A,!1,1,we(e));a.logToConsole(y.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",y.applied>0?"text-green":"text-yellow")}let d=l.filter(m=>m.action.t!=="drag");if(d.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of d){if(u?.aborted)return;let p=m.action,h=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${h}`,"text-blue");let b=String(p.id||p.name||p.selector||""),v=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await $e(m.action),await new Promise(A=>setTimeout(A,250)),ne(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${h}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let A=j(b,v)||j(b.replace(/[^\w\s]/g," ").trim(),v);if(A&&(At(A),await new Promise(y=>setTimeout(y,300)),ne(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let A=j(b,v)||j(b.replace(/[^\w\s]/g," ").trim(),v);if(A&&(A.focus?.(),await new Promise(y=>setTimeout(y,50)),A.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80)),A.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200)),ne(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let A=j(b,v)||j(b.replace(/[^\w\s]/g," ").trim(),v);if(A){let y=A.id,C=!!y;y||(y=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,A.id=y);let T=String(p.v??""),x=p.t==="val",E=document.createElement("script");if(E.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(E),E.remove(),C||setTimeout(()=>{try{A.id===y&&A.removeAttribute("id")}catch{}},0),await new Promise(k=>setTimeout(k,300)),ne(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${h}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let A="";try{let q=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(z=>(z.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));q&&(A=q.outerHTML.slice(0,400))}catch{}let y=me(!1)||ce(),C=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${A?`
HTML do alvo: ${A}`:""}`,T=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],x=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
...
${JSON.stringify((y?.controls||[]).slice(0,6).map(q=>({id:q.id,type:q.type,label:q.label,options:q.options?.slice(0,3)})),null,2)}
