 ...
 */
"use strict";(()=>{var ee={apiKey:"",apiKeys:[],model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function B(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let n of t)if(e.includes(n))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var je="easyquiz_settings_v2",ne="easyquiz_activity_metrics";function Fe(){try{let o=localStorage.getItem(je);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...ee,apiKey:s.apiKey||""}}return{...ee}}let e=JSON.parse(o),t=typeof e.model=="string"&&B(e.model)?e.model:ee.model,n=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return n.length===0&&i&&(n=[i]),{apiKey:n[0]||i||ee.apiKey,apiKeys:n,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ee.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ee.confidenceThreshold}}catch{return{...ee}}}function xt(){try{localStorage.removeItem(je),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(ne),sessionStorage.removeItem(ne);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ue()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function ye(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ge(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let n={...ye(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(n))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function wt(o){let e=Fe(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,n;typeof o.apiKey=="string"?n=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?n=t[0]||"":n=e.apiKey,n&&!t.includes(n)&&(t=[n,...t]),t.length>0&&(!n||!t.includes(n))&&(n=t[0]);let i={...e,...o,apiKey:n,apiKeys:t};try{localStorage.setItem(je,JSON.stringify(i))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var oe=[],yt=12,Gt=1200;function qt(o){let e=o.trim().replace(/\s+/g," ").slice(0,Gt);e&&!oe.includes(e)&&(oe.push(e),oe.length>yt&&(oe=oe.slice(-yt)))}function Se(){return oe}function Ue(){oe=[]}function Et(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var ve=Et();function re(){try{localStorage.removeItem(ne)}catch{}return ve}function Ut(o){ve=o;try{let e=JSON.stringify(o);sessionStorage.setItem(ne,e),localStorage.removeItem(ne)}catch{}}function Qe(o){let e=ve,t=Date.now(),n=e.records[e.records.length-1];if(n&&n.id===o.id&&t-n.timestamp<3e3)return e;let i={...o,timestamp:t},a=[...e.records,i],l=a.filter(p=>p.status==="answered"||p.status==="verified").length,s=a.reduce((p,h)=>p+h.durationMs,0),r=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:r,records:a};return Ut(c),c}function xe(){ve=Et();try{sessionStorage.removeItem(ne),localStorage.removeItem(ne)}catch{}return ve}var Ct=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown ou conversa.
...
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Yt=new Set(["question","info","start","conclusion"]),Jt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Xt=new Set(["val","chk","sel","clk","adv","js","drag"]),Wt=150,qe=2e3;function j(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,qe):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,qe):e}function Zt(o,e){if(!o||typeof o!="object")return null;let t=o,n=t.t;if(typeof n!="string"||!Xt.has(n))return null;if(n==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...j(s)?{id:j(s,"").slice(0,500)}:{}}}if(n==="drag"){let s=j(t.from??t.source),r=j(t.to??t.target??t.destination);return!s||!r?null:{t:"drag",from:s.slice(0,500),to:r.slice(0,500)}}if(n==="js"){let s=j(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&n==="val"&&(i="1");let a=j(i).slice(0,500);if(!a)return null;if(n==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:j(s).slice(0,qe)}}if(n==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,c=(Array.isArray(s)?s:[s]).map(p=>j(p).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:c}}if(n==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",r={t:"chk",id:a,c:!s};return t.v!==void 0&&(r.v=j(t.v).slice(0,qe)),r}let l={t:"clk",id:a};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";l.c=!s}return t.v!==void 0&&(l.v=j(t.v).slice(0,qe)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(l.co=[t.co[0],t.co[1]]),l}function Ye(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,n=e.mode;(typeof t!="string"||!Yt.has(t))&&(t="question"),(typeof n!="string"||!Jt.has(n))&&(n="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],a=[];for(let c=0;c<Math.min(i.length,Wt);c++){let p=Zt(i[c],c);p&&a.push(p)}let l=a.filter(c=>c.t!=="adv"),s=a.some(c=>c.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?s||a.push({t:"adv"}):t==="question"&&!s&&a.push({t:"adv"});let r=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:n,confidence:r,rationale:j(e.rationale,"Plano validado e auto-recuperado."),actions:a,...j(e.memoryToStore)?{memoryToStore:j(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var G=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear(),Array.from(new Set(e.map(i=>i.trim().replace(/^["']|["']$/g,"")).filter(i=>i.length>5))).forEach((i,a)=>{let l=this.generateId(i),s=t.get(l)||t.get(i);this.keys.set(l,{id:l,key:i,label:s?.label||`Chave ${a+1}`,addedAt:s?.addedAt||Date.now(),lastUsedAt:s?.lastUsedAt,lastLatencyMs:s?.lastLatencyMs,cooldownUntil:s?.cooldownUntil,errorCount:s?.errorCount||0,lastError:s?.lastError,winCount:s?.winCount||0})})}generateId(e){let t=0;for(let n=0;n<e.length;n++)t=(t<<5)-t+e.charCodeAt(n),t|=0;return`key_${Math.abs(t).toString(36).slice(0,8)}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let n=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:n>0,remainingCooldownMs:n}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<5)}getBestKey(){let e=this.getHealthyKeys();if(e.length>0)return e.sort((n,i)=>{let a=n.lastLatencyMs??99999,l=i.lastLatencyMs??99999;return a-l}),e[0].key;let t=Array.from(this.keys.values());return t.length>0?(t.sort((n,i)=>(n.cooldownUntil||0)-(i.cooldownUntil||0)),t[0].key):""}getDiverseKeys(e){let t=this.getHealthyKeys();if(t.length===0){let i=this.getBestKey();return i?[i]:[]}t.sort((i,a)=>{let l=i.lastLatencyMs??99999,s=a.lastLatencyMs??99999;return l-s});let n=[];for(let i=0;i<e;i++){let a=t[i%t.length];n.push(a.key)}return n}markQuotaHit(e,t=5e3){let n=this.findKeyObj(e);n&&(n.cooldownUntil=Date.now()+t,n.errorCount=(n.errorCount||0)+1,n.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${t/1e3}s ativado.`)}markOverloaded(e,t=5e3){let n=this.findKeyObj(e);n&&(n.cooldownUntil=Date.now()+t,n.errorCount=(n.errorCount||0)+1,n.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${t/1e3}s ativado.`)}markSuccess(e,t){let n=this.findKeyObj(e);n&&(n.lastLatencyMs=t,n.lastUsedAt=Date.now(),n.errorCount=0,n.lastError=void 0,n.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let n=this.findKeyObj(e);n&&(n.errorCount=99,n.lastError=t)}addKey(e,t){let n=e.trim().replace(/^["']|["']$/g,"");if(!n)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(n.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(n);if(this.keys.has(i))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let a={id:i,key:n,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,a),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:a}}updateKey(e,t,n){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=t.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=a,n!==void 0&&(i.label=n.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},M=new G;var le=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico)",description:"Modelo econ\xF4mico de alta velocidade para volume elevado.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Legacy R\xE1pido)",description:"Modelo legacy com zero-thinking suportado. Ultra-baixa lat\xEAncia.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Legacy Avan\xE7ado)",description:"Modelo legacy avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Tt=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"],eo={"gemini-2.5-flash":"gemini-3.6-flash","gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash"};function Je(o){return eo[o]??o}var ke=null;function to(o){let e={temperature:0,maxOutputTokens:1200,response_mime_type:"application/json",response_schema:oo};return/gemini-3\.[567]-flash/i.test(o)?e.thinkingConfig={thinkingLevel:"none"}:/gemini-3\.[89]|gemini-3\.[1-9][0-9]/i.test(o)?e.thinkingConfig={thinkingLevel:"low"}:/gemini-2\.5-flash/i.test(o)&&(e.thinkingConfig={thinkingBudget:0}),e}var oo={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function no(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");return!e||!B(e)?"gemini-3.8-flash":e}function Mt(o,e){let t="";try{let n=JSON.parse(o);t=n.error?.message||n.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function At(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let n=e.match(/\{[\s\S]*\}/);if(n)try{return JSON.parse(n[0].trim())}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var St=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(n=>n&&typeof n.id=="string"&&B(n.id));return t.length>0?t:null}return null}catch{return null}})(),He=new Set;async function Ie(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return le;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let n of t)try{let i=await fetch(n,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let l=await i.text(),s=Mt(l,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let a=await i.json();if(Array.isArray(a.models)&&a.models.length>0){let l=a.models.filter(s=>{let r=s.supportedGenerationMethods||[],c=(s.name||"").replace(/^models\//,""),p=r.includes("generateContent");return B(c)&&p}).map(s=>{let r=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),p=s.displayName||c;return{id:c,name:p.includes(c)?p:`${p} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:r.includes("generateContent"),supportedGenerationMethods:r,discoveredAt:Date.now()}});if(l.length>0){l.sort((s,r)=>{let c=p=>p==="gemini-3.8-flash"?200:p==="gemini-3.7-flash"?190:p==="gemini-3.6-flash"?180:p==="gemini-3.5-flash"?170:p==="gemini-3.5-flash-lite"?160:p==="gemini-2.5-flash"?130:p.includes("flash")?80:p==="gemini-2.5-pro"?60:p.includes("pro")?50:10;return c(r.id)-c(s.id)}),St=l;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(l))}catch{}return l}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return le}async function ze(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let n=await Ie(e);if(n.length>0&&n!==le){let i=n[0];return{ok:!0,message:`Chave v\xE1lida! ${n.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:n}}}catch(n){return{ok:!1,message:n instanceof Error?n.message:String(n)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let n of t)for(let i of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${i}/models/${n}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${n} (${i})!`,models:le}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function Lt(o,e,t,n,i){let a=["v1beta","v1"],l=new Error(`Falha ao consultar modelo ${o}`),r={...to(o)};for(let c of a){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let p=`https://generativelanguage.googleapis.com/${c}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,h=Date.now();try{let d=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:r}),signal:i,keepalive:n});if(!d.ok){let v=await d.text();if(d.status===400&&r.thinkingConfig&&/thinking/i.test(v)){delete r.thinkingConfig;let u=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:r}),signal:i,keepalive:n});if(u.ok){let b=await u.json(),x=b.candidates?.[0];if(x?.content?.parts?.[0]?.text)return M.markSuccess(e,Date.now()-h),{rawText:x.content.parts[0].text,data:b,usedModel:o,usedKey:e}}}let f=Mt(v,d.status);if(d.status===404&&c==="v1beta")continue;throw d.status===429?M.markQuotaHit(e,5e3):d.status===503||/no capacity|overloaded|unavailable/i.test(v)?(M.markOverloaded(e,5e3),He.add(o)):d.status===403||/API_KEY_INVALID/i.test(v)?M.markInvalid(e,f):d.status===404&&He.add(o),new Error(`[${o}|${G.maskKey(e)}] ${f}`)}let m=await d.json(),g=m.candidates?.[0];if(!g||!g.content?.parts?.[0]?.text)throw new Error(`[${o}|${G.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return M.markSuccess(e,Date.now()-h),{rawText:g.content.parts[0].text,data:m,usedModel:o,usedKey:e}}catch(d){if(i.aborted)throw d;l=d;let m=l.message||"";if(m.includes("404")||/no longer available/i.test(m)){He.add(o);break}}}throw l}var Ee=new Set;function kt(){Ee.clear()}async function Xe(o,e,t,n,i){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let a=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];M.init(a);let l=t.apiKey.trim().replace(/^[\"']|[\"']$/g,""),s=M.getBestKey()||l;if(!s)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let r=no(t.model);if(!St&&s&&Ie(s).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let c=Date.now(),p=we(o,e,t),h=[{text:p}];for(let E=0;E<e.length;E++){let k=e[E],R=k.associatedLabel||(k.alt?`Imagem: ${k.alt}`:`Imagem ${E+1}`);h.push({text:`[ANEXO VISUAL ${E+1} - V\xCDNCULO: ${R}]:`}),h.push({inline_data:{mime_type:k.mediaType,data:k.base64}})}let d={system_instruction:{parts:[{text:Ct}]},contents:[{role:"user",parts:h}]},m=!0;He.clear();let g=Je(r),v=ke?Je(ke):null,f=[];v&&B(v)&&f.push(v),B(g)&&g!==v&&f.push(g);for(let E of Tt)f.includes(E)||f.push(E);let u=f.map(E=>Je(E)).filter(E=>B(E)).filter((E,k,R)=>R.indexOf(E)===k).slice(0,3);u.length<2&&u.push(...Tt.filter(E=>!u.includes(E)));let b=M.getHealthyKeys().filter(E=>!Ee.has(E.key)).sort((E,k)=>(E.lastLatencyMs??99999)-(k.lastLatencyMs??99999)),x=M.getAllKeys().filter(E=>!Ee.has(E.key)),w=b.length>0?b:x.map(E=>({key:E.key,lastLatencyMs:E.lastLatencyMs,label:E.label})),A=async(E,k,R,Q)=>{if(k.length===0||i?.aborted)return null;let V=k.slice(0,2).map((Y,se)=>({model:R[se%R.length],key:Y.key,label:Y.label||`Chave ${se+1}`})),N=V.map(()=>new AbortController),be=()=>N.forEach(Y=>{try{Y.abort()}catch{}});i?.addEventListener("abort",be,{once:!0}),n?.(`\u26A1 ${E}: ${V.length} slot(s) [${V.map(Y=>Y.model.replace("gemini-","")).join(", ")}]...`,"info");try{let Y=V.map(async(Z,gt)=>{let Ke=N[gt],ft=14e3,bt=setTimeout(()=>{try{Ke.abort(new Error(`Timeout ${ft/1e3}s (${Z.model}|${Z.label})`))}catch{Ke.abort()}},ft);try{let _=await Lt(Z.model,Z.key,d,m,Ke.signal);clearTimeout(bt);let F=Ye(At(_.rawText));return F.usedModel=_.usedModel,F.durationMs=Date.now()-c,F.promptSent=p,F.tokensUsed=_.data.usageMetadata?.totalTokenCount,F.promptTokens=_.data.usageMetadata?.promptTokenCount,F.candidatesTokens=_.data.usageMetadata?.candidatesTokenCount,F.rawResponse=_.rawText,N.forEach((vt,Ft)=>{if(Ft!==gt)try{vt.abort(new Error("Cancelado: vencedor respondeu."))}catch{vt.abort()}}),{plan:F,rawUsage:_.data.usageMetadata,usedModel:_.usedModel,usedKey:_.usedKey,slotLabel:Z.label}}catch(_){clearTimeout(bt);let F=_ instanceof Error?_.message:String(_);throw(F.includes("429")||F.includes("Quota")||F.includes("RESOURCE_EXHAUSTED"))&&Ee.add(Z.key),_}}),se=await Promise.any(Y);return i?.removeEventListener("abort",be),V.forEach(Z=>Q.add(Z.key)),M.markWinner(se.usedKey),ke=se.usedModel,se}catch{return i?.removeEventListener("abort",be),V.forEach(Y=>Q.add(Y.key)),null}},L=new Set,S="",H=w.filter(E=>!L.has(E.key)).slice(0,2),O=await A("Onda 1",H,u,L);if(O){let E=O.plan.durationMs||Date.now()-c,k=G.maskKey(O.usedKey);return n?.(`\u26A1 ${E}ms via '${O.usedModel}' (${O.slotLabel}: ${k})`,"info"),O}if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let X=w.filter(E=>!L.has(E.key)).slice(0,2);if(X.length>0){let E=[...u].reverse(),k=await A("Onda 2",X,E,L);if(k){let R=k.plan.durationMs||Date.now()-c,Q=G.maskKey(k.usedKey);return n?.(`\u26A1 ${R}ms via '${k.usedModel}' (${k.slotLabel}: ${Q})`,"info"),k}}if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let fe=M.getAllKeys().filter(E=>!L.has(E.key)&&!Ee.has(E.key)).sort((E,k)=>(E.lastLatencyMs??99999)-(k.lastLatencyMs??99999));if(fe.length>0){let E=fe[0],k=u[0]||"gemini-3.6-flash";n?.(`Fallback: ${k} com ${E.label||"chave reserva"}...`,"info");try{let R=new AbortController,Q=setTimeout(()=>{try{R.abort()}catch{}},16e3),V=await Lt(k,E.key,d,m,R.signal);clearTimeout(Q);let N=Ye(At(V.rawText));N.usedModel=V.usedModel,N.durationMs=Date.now()-c,N.promptSent=p,N.rawResponse=V.rawText,M.markSuccess(E.key,N.durationMs),ke=k;let be=G.maskKey(E.key);return n?.(`\u26A1 Fallback OK: ${N.durationMs}ms via '${k}' (${be})`,"info"),{plan:N,rawUsage:void 0,usedModel:k,usedKey:E.key}}catch(R){S=R instanceof Error?R.message:String(R)}}throw new Error(S||"Todas as ondas e fallback falharam. Verifique sua cota e conex\xE3o.")}var ao=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Ce(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function We(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ht(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(ao.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var ce=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),$e=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,io=0;function Ze(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!de(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function $(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function T(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||de(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let n=e.type?.toLowerCase();if(n==="checkbox"||n==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${$(e.id)}"]`);if(a&&Ze(a))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Ze(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let l=e.getBoundingClientRect();if(l.width>0||l.height>0)return!0}return!0}}}catch{}}return Ze(e)}function so(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function I(o,e=500){return so(o).replace(/\s+/g," ").trim().slice(0,e)}function ro(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(io+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function de(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Te=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function P(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(de(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let n=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||""),a=String(n.getAttribute?.("aria-label")||""),l=String(n.getAttribute?.("title")||""),s=typeof n.className=="string"?n.className:typeof n.className?.baseVal=="string"?n.className.baseVal:"",r=I(n.textContent,60);return!!(Te.test(i)||Te.test(a)||Te.test(l)||Te.test(s)||r.length>0&&r.length<=25&&Te.test(r))}function W(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||de(o)||P(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=I(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),n=o.type,i=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),a=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return $e.test(i)||$e.test(t)||n==="submit"||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")||!1}function et(o){let e=o.closest("tr");if(e){let r=e.querySelector("th, td:first-child"),c=r&&r!==o.closest("td")?I(r.textContent,100):"",p=I(o.closest("label, td")?.textContent||"",50);if(c&&p)return`${c}: ${p}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let r=t.querySelector('.dropdown-label, [class*="label" i]'),c=r&&r!==o?I(r.textContent,150):"";if(c)return c}let n=o.getAttribute("aria-label");if(n)return I(n);let i=o.getAttribute("aria-labelledby");if(i){let r=i.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(r.trim())return I(r)}if("labels"in o&&o.labels){let r=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(r.trim())return I(r)}let a=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==o){let r=I(a.textContent);if(r)return r}let l=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||l||"";return I(s)}function tt(o,e){let n=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let a=o.tagName.toLowerCase(),l=["input","textarea","select","button"].includes(a)?a:"other",s=o.getAttribute("role")||"",r=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),p=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(r)||/drag|card-item|sortable/i.test(c),h=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(r)||/dropzone|category-box|bucket|target-zone/i.test(c),m=I((p?"draggable":h?"dropzone":"")||i.type||s||l,40),g="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox")g=i.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(l==="button"||a==="a"||e==="navigation"||W(o))g="";else{let w=typeof o.value=="string"||typeof o.value=="number"?o.value:"";g=I(w||o.getAttribute("data-category")||"",2e3)}let v=[];if(n&&n.options)for(let w of Array.from(n.options).slice(0,80))v.push({value:I(w.value),label:I(w.textContent)});else if(s==="combobox"||s==="listbox"||c.includes("select")||c.includes("dropdown")){let w=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),A=w?document.getElementById(w):o;if(A){let L=A.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let S of Array.from(L).slice(0,80)){let H=I(S.textContent);H&&v.push({value:S.getAttribute("data-value")||S.getAttribute("value")||H,label:H})}}}let f=!!(i.required||o.getAttribute("aria-required")==="true"),u=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),b=ro(o);return{id:o.id||b,tag:l,type:m,label:et(o),name:I(i.name||o.getAttribute("name")||"",180),value:g,options:v,required:f,disabled:u,role:e}}var It=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function zt(o){if(!T(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(ce)).filter(T),n=I(o.innerText||o.textContent||"",4e3).length;if(n<10||!t.length&&n<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),l=Math.min(1,a/i),s=e.top+e.height/2,r=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=n>40?35:0,p=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,n/20)+c+p-l*20-r*10}function Pe(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,n=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(n))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&n!=="main"&&n!=="body"){e=t;break}let i=I(e.innerText||e.textContent||"",1e4),a=I(t.innerText||t.textContent||"",1e4),l=e.querySelectorAll(ce).length,s=t.querySelectorAll(ce).length;if(i.length<150&&a.length>i.length&&s<=l+4&&n!=="main"&&n!=="body"){e=t;continue}break}return e}function $t(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&T(t))return t;let n=0;for(;e.parentElement&&e.parentElement!==document.body&&n<3;)e=e.parentElement,n++;return e||document.body}function D(){let o=document.activeElement;if(o&&o!==document.body){let a=o.closest(It);if(a&&zt(a)>0)return Pe(a)}let t=Array.from(document.querySelectorAll(It)).map(a=>({element:a,score:zt(a)})).filter(a=>Number.isFinite(a.score)).sort((a,l)=>l.score-a.score),n=t.find(a=>{let l=a.element.tagName.toLowerCase();return l!=="main"&&l!=="body"&&a.score>0});if(n)return Pe(n.element);if(t.length>0&&t[0].score>0)return Pe(t[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&T(i)?i:document.body}function Pt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(n=>n.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(n=>{for(let i of Array.from(n.attributes))t.includes(i.name)||n.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Re(o){let e=Array.from(o.querySelectorAll(ce)),t=new Set,n=[];for(let i of e){if(!T(i)||W(i)||P(i))continue;let a=i.tagName.toLowerCase();["input","textarea","select"].includes(a)&&(t.add(i),n.push(i))}for(let i of e){if(!T(i)||W(i)||P(i))continue;let a=i.tagName.toLowerCase();if(["input","textarea","select"].includes(a))continue;let l=i.querySelector("input, textarea, select");if(!(l&&t.has(l))){if(i.hasAttribute("for")){let s=i.getAttribute("for"),r=s?i.ownerDocument.getElementById(s):null;if(r&&t.has(r))continue}if(a==="a"){let s=i.getAttribute("role");if(!(s==="button"||s==="radio"||s==="checkbox"||s==="option"||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}n.push(i)}}return n.slice(0,100).map(i=>tt(i,"answer"))}function ot(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,n=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(ce)))if(!(t.has(a)||!T(a)||!W(a)||P(a))&&(t.add(a),n.push(tt(a,"navigation")),n.length>=10))return n;return n}function Ae(o=!1){let e=D();e=Pe(e),o&&(e=$t(e));let t=Re(e),n=ot(e);if(t.length===0){let s=Re(document.body);s.length>0&&(e=$t(e),t=Re(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}n.length===0&&(n=ot(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=I(i,16e3),l=[...t,...n].slice(0,120);return!a||l.length===0&&a.length<30?I(document.body.innerText||document.body.textContent||"",16e3).length>=30?ue():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:Pt(e),controls:l,scope:e}}function ue(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=I(o,16e3),t=Re(document.body),n=ot(document.body),i=[...t,...n].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Pt(a).slice(0,15e3),controls:i,scope:a}}function Rt(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function z(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function y(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function K(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let n=o.getAttribute("for");if(n){let i=o.ownerDocument.getElementById(n);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let n=e.getAttribute("for"),a=(n?e.ownerDocument.getElementById(n):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let n=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(n)return K(n)}return o}function Bt(o){let e=o;if(!e||!document.contains(e))try{e=D()}catch{}e=e||document.body;let t=Array.from(e.querySelectorAll("tr")).filter(a=>T(a)&&a.querySelector('input[type="radio"], input[type="checkbox"]'));if(t.length>1)return t;let n=Array.from(e.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(a=>T(a)&&!z(a));return n.length>0?n:Array.from(e.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(a=>T(a)&&!z(a)).filter(a=>!a.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'))}function C(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=$(i),l=document.querySelector(`[data-easyquiz-id="${a}"]`);if(l&&!z(l)&&T(l))return K(l);try{let d=document.getElementById(i);if(d&&!z(d)&&T(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:K(d)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let d=parseInt(s[1],10);if(t){let g=document.body;try{g=D()||document.body}catch{}let v=Array.from(g.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(f=>T(f)&&!z(f));if(d>=1&&d-1<v.length)return v[d-1];if(d===0&&v.length>0)return v[0]}let m=d-1;if(m>=0){let g=Bt();if(m<g.length){let u=g[m];if(u.tagName.toLowerCase()==="tr"){if(e){let x=u.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(x)return x}let b=u.querySelector("input");if(b)return b}return K(u)}let v=document.body;try{v=D()||document.body}catch{}let f=Array.from(v.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>T(u)&&!z(u));if(m<f.length)return f[m]}}let r=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(r){let d=r[1].toUpperCase().charCodeAt(0)-65;if(d>=0){let m=Bt();if(d<m.length){let g=m[d];if(g.tagName.toLowerCase()==="tr"){if(e){let f=g.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(f)return f}let v=g.querySelector("input");if(v)return v}return K(g)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let m=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(u=>T(u)&&!z(u));if(m)return m;let v=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(u=>T(u)&&!z(u));if(v)return K(v);let f=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(u=>{if(!T(u)||z(u))return!1;let b=y(u.textContent).toLowerCase();return b===i.toLowerCase()||b===i.toLowerCase()+")"});if(f)return K(f)}try{let m=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`)).find(g=>T(g)&&!z(g));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:K(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let m=Array.from(document.querySelectorAll(i)).find(g=>T(g)&&!z(g));if(m)return K(m)}catch{}try{let d=i.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,g=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let v=0;v<g.snapshotLength;v++){let f=g.snapshotItem(v);if(f&&T(f)&&!z(f)){if(["body","html"].includes(f.tagName.toLowerCase())){let b=f.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&T(b))return K(b)}return f.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(f)}}}catch{}let p=y(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of h){if(!T(d)||z(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||P(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=y(d.textContent).toLowerCase(),v=y(d.getAttribute("aria-label")||"").toLowerCase(),f=y(d.getAttribute("placeholder")||"").toLowerCase(),u=y(d.getAttribute("title")||"").toLowerCase(),b=y(d.getAttribute("name")||"").toLowerCase(),x=y(d.getAttribute("data-category")||"").toLowerCase(),w=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",A=y(w).toLowerCase(),L=g.startsWith(p+")")||g.startsWith(p+".")||g.startsWith(p+" -")||g.startsWith(p+":");if(g===p||v===p||f===p||u===p||b===p||x&&x===p||A&&A===p||L)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(d)}if(p.length>=3)for(let d of h){if(!T(d)||z(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||P(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=y(d.textContent).toLowerCase(),v=y(d.getAttribute("aria-label")||"").toLowerCase(),f=y(d.getAttribute("placeholder")||"").toLowerCase(),u=y(d.getAttribute("title")||"").toLowerCase(),b=y(d.getAttribute("name")||"").toLowerCase();if(g.includes(p)||v.includes(p)||f.includes(p)||u.includes(p)||b.includes(p)){if(Array.from(d.children).some(L=>{let S=y(L.textContent).toLowerCase();return S&&S.includes(p)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(d)}let x=p.split(/\s+/).filter(Boolean);if(x.length>=3){let w=x.slice(0,Math.min(5,x.length)).join(" ");if(g.includes(w)||v.includes(w)||f.includes(w))return K(d)}}return null}function Dt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function U(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){J(t,!0);return}if(t.type==="radio"){J(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement||typeof HTMLAnchorElement<"u"&&o instanceof HTMLAnchorElement||o.tagName?.toLowerCase()==="a"||o.tagName?.toLowerCase()==="button"||typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let i=o.getBoundingClientRect(),a=e?e[0]:Math.round(i.left+Math.max(1,i.width/2)),l=e?e[1]:Math.round(i.top+Math.max(1,i.height/2)),s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:l};try{o.dispatchEvent(new PointerEvent("pointerdown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function Be(o,e){let t=o;if(t.hasAttribute("for")){let c=t.getAttribute("for"),p=t.ownerDocument.getElementById(c);p&&(t=p)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Ne(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){Ne(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)t=c;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let c=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{let p=document.body;try{p=D()||document.body}catch{}let h=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=document.body;try{c=D()||document.body}catch{}let p=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p)t=p;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;J(t,c);return}let l=String(e??""),s=l;if(t instanceof HTMLInputElement&&t.type==="number"){let c=l.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(s=c)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let r=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}r=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}r=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(s===""?" ":"")}catch{}let c=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,p=Object.getOwnPropertyDescriptor(c,"value")?.set;p?p.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{p?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Le(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let n=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=y(t),a=C(t)||C(i);if(!a)return n?e:i||e;let l=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(l){let h=y(l.textContent);if(h&&h.length>0&&h.length<150)return h}if(a.id){let h=document.querySelector(`label[for="${$(a.id)}"]`);if(h){let d=y(h.textContent);if(d&&d.length>0&&d.length<150)return d}}let s=a.getAttribute("aria-label");if(s)return y(s);let r=a.getAttribute("placeholder");if(r)return y(r);let c=y(a.textContent);if(c&&c.length>0&&c.length<120)return c;let p=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return p?y(p):n?e:i||e}function J(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,n=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!n&&t.hasAttribute("for")&&(n=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let i=e?"true":"false";t.setAttribute("aria-checked",i),t.setAttribute("aria-selected",i),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(n){if(n.checked===e)return;try{n.focus?.(),n.click()}catch{}if(n.checked!==e){try{let i=n._valueTracker;i&&i.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(n,e)}catch{}n.checked=e,Dt(n,["input","change"])}}else{try{t.focus?.()}catch{}try{t.click()}catch{U(t)}}}function Ne(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let l=e.map(c=>y(c).toLowerCase()),s=!1,r=(c,p)=>{c.selected=!0,t.selectedIndex=p;try{t.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,c.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(c.value)}catch{}s=!0};for(let c=0;c<t.options.length;c++){let p=t.options[c],h=p.value.toLowerCase(),d=y(p.textContent).toLowerCase();if(l.some(g=>g===h||g===d)){if(r(p,c),!t.multiple)break}else t.multiple||(p.selected=!1)}if(!s)for(let c of l){let p=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(p){let h=parseInt(p[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(m>=0&&m<t.options.length&&(r(t.options[m],m),!t.multiple))break}}if(!s){for(let c of l)if(/^[a-z]$/i.test(c)){let p=c.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?p+1:p;if(d>=0&&d<t.options.length&&(r(t.options[d],d),!t.multiple))break}}if(!s){let c=p=>p.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let p=0;p<t.options.length;p++){let h=t.options[p],d=c(h.value.toLowerCase()),m=c(y(h.textContent).toLowerCase());if(l.some(v=>{let f=c(v);return d.includes(f)||m.includes(f)||f.length>2&&(f.includes(d)||f.includes(m))})&&(r(h,p),!t.multiple))break}}if(s){Dt(t,["focus","input","change","blur"]);return}}let n=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');n&&U(n);let i=e.map(l=>y(l).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(l=>T(l)&&!z(l));for(let l of i){let s=a.find(c=>{let p=y(c.textContent).toLowerCase(),h=y(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return p===l||h===l||p.includes(l)||l.length>2&&l.includes(p)});if(s){U(s);let c=s.querySelector('input[type="radio"], input[type="checkbox"]');c&&J(c,!0);return}let r=C(l);if(r){U(r);return}}}function lo(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function nt(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function te(o,e){let t=y(o).toLowerCase();if(!t)return null;let n=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',i=Array.from(document.querySelectorAll(n)),a=e==="destination"?i.find(l=>[l.getAttribute("data-category"),l.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t)):null;return a&&T(a)&&!z(a)?a:i.find(l=>{if(!T(l)||z(l))return!1;let s=y(`${l.textContent||""} ${l.getAttribute("data-category")||""} ${l.getAttribute("data-dropzone")||""}`).toLowerCase();return s===t||s.includes(t)})||null}async function De(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let n=o.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(n.left+Math.max(1,n.width/2)),l=Math.round(n.top+Math.max(1,n.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),r=Math.round(i.top+Math.max(1,i.height/2)),c=y(e.textContent).toLowerCase();if(c){let v=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(f=>{let u=y(f.textContent).toLowerCase(),b=f instanceof HTMLInputElement||f instanceof HTMLOptionElement?y(f.value).toLowerCase():"";return u&&(c.includes(u)||u.includes(c))||b&&(c.includes(b)||b.includes(c))});v&&(U(v),await new Promise(f=>setTimeout(f,120)))}nt(o),await new Promise(g=>setTimeout(g,140)),nt(e);let p=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(p&&p!==e&&nt(p),await new Promise(g=>setTimeout(g,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:l,screenX:a,screenY:l,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",h));let d=4;for(let g=1;g<=d;g++){let v=Math.round(a+(s-a)*(g/d)),f=Math.round(l+(r-l)*(g/d)),u={...h,clientX:v,clientY:f,screenX:v,screenY:f};try{o.dispatchEvent(new PointerEvent("pointermove",{...u,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",u))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:r,screenX:s,screenY:r,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let g=lo(I(o.textContent),o.outerHTML),v={...h},f={...m};g&&(v.dataTransfer=g,f.dataTransfer=g);let u=o.ownerDocument.defaultView?.DragEvent;if(!u)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new u("dragstart",v)),e.dispatchEvent(new u("dragenter",f)),e.dispatchEvent(new u("dragover",f)),e.dispatchEvent(new u("drop",f)),o.dispatchEvent(new u("dragend",v))}catch(g){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",g)}try{let g=new Touch({identifier:1,target:o,clientX:a,clientY:l}),v=new Touch({identifier:1,target:e,clientX:s,clientY:r});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[v]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(g=>setTimeout(g,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Ot={fill:(o,e)=>{let t=C(o);t?Be(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=C(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?J(e,!0):U(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=C(o);t?J(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>C(o,e),drag:(o,e)=>{let t=te(o,"source")||C(o),n=te(e,"destination")||C(e);t&&n?De(t,n):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=te(o,"source")||C(o),n=te(e,"destination")||C(e);if(!t||!n){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await De(t,n)},execute:(o,e=!1,t=1)=>st(o,e,t)};typeof window<"u"&&(window.$eq=Ot);async function co(o,e=1,t=Ce()){if(We(o,t),o.t==="js"){let s=String(o.v||"");Ht(s);try{new Function("$eq","document","window",s)(Ot,document,window)}catch(r){throw console.warn("[EasyQuiz JS Execution]",r),r}return}if(o.t==="drag"){let s=te(o.from,"source")||C(o.from),r=te(o.to,"destination")||C(o.to);!s&&o.from&&(s=C(y(o.from))),!r&&o.to&&(r=C(y(o.to))),s&&r?await De(s,r,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let n=o.id!==void 0&&o.id!==null?String(o.id):"";!n&&o.t==="val"&&(n=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,a=i!=null?String(i).trim():"",l=C(n,a,o.t==="val"||o.t==="sel");if(!l&&n&&(l=C(y(n),a,o.t==="val"||o.t==="sel")),l&&a){if(l instanceof HTMLInputElement&&l.type==="radio"&&l.name){if(y(l.value).toLowerCase()!==y(a).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${$(l.name)}"][value="${$(a)}" i]`);if(s)l=s;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(l.name)}"]`)).find(p=>{let h=p.closest("label, .vf-label, .option-card, tr, td, div");return h&&y(h.textContent).toLowerCase().includes(y(a).toLowerCase())});c&&(l=c)}}}else if(!(l instanceof HTMLInputElement)&&!(l instanceof HTMLSelectElement)&&!(l instanceof HTMLTextAreaElement)){let s=l.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(s)l=s;else{let c=Array.from(l.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(p=>{let h=p.closest("label, .vf-label, .option-card, td, div");return h&&y(h.textContent).toLowerCase().includes(y(a).toLowerCase())});c&&(l=c)}}}if(!l&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=D()||document.body}catch{}let r=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(c=>T(c)&&!z(c));if(r.length===1)l=r[0];else if(r.length>1){let c=y(n).toLowerCase(),p=c.match(/^#?_?([0-9]+)$/);if(p){let h=parseInt(p[1],10);h>=1&&h<=r.length?l=r[h-1]:h>=0&&h<r.length&&(l=r[h])}l||(l=r.find(d=>{let m=(d.getAttribute("placeholder")||"").toLowerCase(),g=(d.name||"").toLowerCase(),v=(d.getAttribute("aria-label")||"").toLowerCase(),f=(d.id||"").toLowerCase(),u=y(et(d)).toLowerCase(),b=y(d.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return m.includes(c)||g.includes(c)||v.includes(c)||f.includes(c)||u&&u.includes(c)||c.length>=2&&b.includes(c)})||(r.length===1?r[0]:null))}}if(!l&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${n}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":if(l){let r=l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement||l instanceof HTMLSelectElement||l.isContentEditable?l:l.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!r){let d=l.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(r=d)}if(!r){let h=l.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){r=h;break}let d=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){r=d;break}h=h.nextElementSibling}}if(!r){let h=document.body;try{h=D()||document.body}catch{}let d=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>T(m)&&!z(m));d.length>0&&(r=d[0])}let c=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,p=c!=null?String(c):"";Be(r||l,p)}break;case"chk":l&&J(l,!!o.c);break;case"sel":if(l){let r=Array.isArray(o.v)?o.v:[String(o.v)];Ne(l,r)}break;case"clk":if(l)if(!!(l.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||l.querySelector('input[type="radio"], input[type="checkbox"]')||l instanceof HTMLInputElement&&["checkbox","radio"].includes(l.type))){let c=o.c!==void 0?!!o.c:!0;J(l,c)}else U(l,o.co);break;case"adv":let s=at(o.id);if(s){await it(s,1200);let r=o.id||s.textContent?.trim()||"";r&&Ge(window.location.hostname,{advanceSelector:r}),U(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function uo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!T(t)||z(t)||t.closest("header, nav, aside"))return!1;let n=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||n||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function at(o){if(o){let a=C(o);if(a&&T(a)&&!z(a)&&!P(a))return a}try{let a=ye(window.location.hostname);if(a.advanceSelector){let l=C(a.advanceSelector);if(l&&T(l)&&!z(l)&&!P(l))return l}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),n=Array.from(document.querySelectorAll(e)).filter(a=>T(a)&&!z(a)&&!a.closest("header, nav, aside")&&!P(a));for(let a of n)if(W(a)&&!P(a))return a;for(let a of n){let l=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"",s=(a.textContent||l||a.getAttribute("aria-label")||"").trim();if($e.test(s)&&!P(a))return a}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&T(i)&&!z(i)&&!P(i)?i:null}async function it(o,e=1500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,100))}}function Vt(){let o=(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim(),e=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"]').length;return`${window.location.href}|${document.title}|${o.slice(0,900)}|${e}`}async function po(o,e=1800){let t=Date.now();for(;Date.now()-t<e;){if(Vt()!==o)return{changed:!0,evidence:"URL, texto, t\xEDtulo ou conjunto de controles mudou ap\xF3s a a\xE7\xE3o."};await new Promise(i=>setTimeout(i,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a observ\xE1vel foi detectada dentro do tempo limite."}}async function Nt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let i=C(o.from)||C(y(o.from)),a=C(o.to)||C(y(o.to));i&&a&&await De(i,a,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",n=C(e,t)||C(y(e),t);if(o.t==="clk"||o.t==="chk"){if(!n&&e){let a=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),l=y(e).toLowerCase();n=a.find(s=>{let r=y(s.textContent).toLowerCase(),c=y(s.value||"").toLowerCase();return r.includes(l)||c===l||r.startsWith(l+")")||r.startsWith("("+l+")")})||null}let i=o.v!==void 0?String(o.v).trim():"";if(n&&i){if(n instanceof HTMLInputElement&&n.type==="radio"&&n.name){if(y(n.value).toLowerCase()!==y(i).toLowerCase()){let a=document.querySelector(`input[type="radio"][name="${$(n.name)}"][value="${$(i)}" i]`);if(a)n=a;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(n.name)}"]`)).find(r=>{let c=r.closest("label, .vf-label, .option-card, tr, td, div");return c&&y(c.textContent).toLowerCase().includes(y(i).toLowerCase())});s&&(n=s)}}}else if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLSelectElement)&&!(n instanceof HTMLTextAreaElement)){let a=n.querySelector(`input[value="${$(i)}" i], [data-value="${$(i)}" i]`);if(a)n=a;else{let s=Array.from(n.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(r=>{let c=r.closest("label, .vf-label, .option-card, td, div");return c&&y(c.textContent).toLowerCase().includes(y(i).toLowerCase())});s&&(n=s)}}}if(n){let a=n.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,l=n instanceof HTMLInputElement&&["radio","checkbox"].includes(n.type)?n:a.querySelector('input[type="radio"], input[type="checkbox"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(J(l||a,s),l&&l.checked!==s){try{let r=l._valueTracker;r&&r.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(l,s)}catch{}l.checked=s,l.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),l.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let i=null;if(n&&(i=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let a=document.body;try{a=D()||document.body}catch{}let l=Array.from(a.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=y(e).toLowerCase();i=l.find(r=>{let c=(r.getAttribute("placeholder")||"").toLowerCase(),p=(r.name||"").toLowerCase(),h=(r.id||"").toLowerCase(),d=(r.getAttribute("aria-label")||"").toLowerCase();return c.includes(s)||p.includes(s)||h.includes(s)||d.includes(s)})||(l.length>0?l[0]:null)}if(i){let a=String(o.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,a)}}catch{}Be(i,a)}return}if(o.t==="sel"){if(!n&&e){let i=Array.from(document.querySelectorAll("select")),a=y(e).toLowerCase();n=i.find(l=>{let s=(l.name||"").toLowerCase(),r=(l.id||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase();return s.includes(a)||r.includes(a)||c.includes(a)})||null}if(n){let i=Array.isArray(o.v)?o.v:[String(o.v)];Ne(n,i)}return}}function pe(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),n=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let a=C(i,n,!0)||C(y(i),n,!0);if(!a){let h=document.body;try{h=D()||document.body}catch{}let d=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>T(m)&&!z(m));d.length>0&&(a=d[0])}if(!a)return!1;let l=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(l&&l.name){let h=document.querySelector(`input[type="radio"][name="${$(l.name)}"]:checked`);if(!h)return!1;let d=y(h.value).toLowerCase(),m=y(t).toLowerCase(),g=y(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===m||g===m||g.includes(m)}let s=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let d=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(s=d)}if(!s){let h=a.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){s=h;break}let d=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){s=d;break}h=h.nextElementSibling}}if(s instanceof HTMLSelectElement){let h=y(t).toLowerCase();return Array.from(s.options).some(d=>{if(!d.selected)return!1;let m=d.value.toLowerCase(),g=y(d.textContent).toLowerCase();return h===m||h===g||m.includes(h)||g.includes(h)})}let r=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??a.textContent??"").trim();if(!r&&!t)return!0;if(!r&&t)return!1;let c=r.replace(",",".").replace(/\s+/g,"").toLowerCase(),p=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return c===p||c.includes(p)||p.includes(c)||r.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=C(o.id,void 0,!0)||C(y(o.id),void 0,!0);if(!e){let a=document.body;try{a=D()||document.body}catch{}let l=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>T(c)&&!z(c)),s=y(o.id).toLowerCase();e=l.find(c=>{let p=(c.id||"").toLowerCase(),h=(c.getAttribute("name")||"").toLowerCase(),d=(c.getAttribute("aria-label")||"").toLowerCase(),m=y(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return p.includes(s)||h.includes(s)||d.includes(s)||s.length>=2&&m.includes(s)})||(l.length===1?l[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(c=>y(c).toLowerCase()),r=y(a.textContent).toLowerCase();return s.some(c=>r.includes(c)||c.includes(r))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(a=>y(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let l=a.value.toLowerCase(),s=y(a.textContent).toLowerCase();return i.some(r=>r===l||r===s||l.includes(r)||s.includes(r))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=C(o.id,e)||C(y(o.id),e);if(!t)return!1;let n=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,i=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:n.querySelector('input[type="checkbox"], input[type="radio"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),a=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(i&&i.type==="radio"){if(i.checked===a)return!0;if(o.v&&i.name){let p=y(String(o.v)).toLowerCase(),h=document.querySelector(`input[type="radio"][name="${$(i.name)}"]:checked`);if(!h)return!1;if(h===i)return!0;let d=y(h.value).toLowerCase(),m=y(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===p||m.includes(p)||p.includes(d)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===a;let l=n.getAttribute("aria-checked")===String(a)||n.getAttribute("aria-selected")===String(a)||n.getAttribute("aria-pressed")===String(a),s=a?n.getAttribute("data-selected")==="true"||n.getAttribute("data-checked")==="true"||n.getAttribute("data-active")==="true"||n.getAttribute("data-state")==="checked"||n.getAttribute("data-state")==="on":n.getAttribute("data-selected")==="false"||n.getAttribute("data-checked")==="false"||n.getAttribute("data-state")==="unchecked",r=a?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(n.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(n.className||"");return!!(l||s||r||(n instanceof HTMLButtonElement||n.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!i)}if(o.t==="drag"){let e=C(o.from)||C(y(o.from)),t=C(o.to)||C(y(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function st(o,e,t=1,n=Ce({engine:"smart",autoAdvance:e})){let i=o.actions.filter(u=>u.t!=="adv"),a=o.actions.filter(u=>u.t==="adv"),l=0,s=[],r=new Map,c=o.pageType==="question",p=i.filter(u=>u.t==="chk"||u.t==="clk"&&u.c!==void 0);if(c&&p.length>0){let u=document.body;try{u=D()||document.body}catch{}let b=Array.from(u.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(x=>T(x)&&!z(x));if(b.length>1){let x=new Set;for(let w of p){let A=w.t==="chk"?!!w.c:!!(w.c??!0),L="id"in w&&typeof w.id=="string"?w.id:"";if(A&&L){let S=C(L,w.v);if(S){let H=S instanceof HTMLInputElement&&S.type==="checkbox"?S:S.querySelector('input[type="checkbox"]');x.add(H||S)}}}if(x.size>0)for(let w of b)x.has(w)||(w instanceof HTMLInputElement&&w.checked||w.getAttribute("aria-checked")==="true"||w.closest(".option-card, label")?.classList.contains("selected"))&&J(w,!1)}}for(let u of i){try{await co(u,t,n),l++}catch(b){r.set(u,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",u,b)}await new Promise(b=>setTimeout(b,u.t==="drag"?250:70))}await new Promise(u=>setTimeout(u,i.length>0?300:50));let h=0;for(let u of i){if(pe(u)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${u.t}' no alvo '${u.id||u.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{We(u,n),await Nt(u)}catch(b){r.set(u,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",b)}await new Promise(b=>setTimeout(b,180)),pe(u)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++)}if(h<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-h} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(u=>setTimeout(u,200));for(let u of i)if(!pe(u))try{await Nt(u)}catch(b){r.set(u,b instanceof Error?b.message:String(b))}await new Promise(u=>setTimeout(u,200)),h=0;for(let u of i)pe(u)&&h++}for(let u of i)pe(u)||s.push(u.t==="drag"?`${u.from} -> ${u.to}`:"id"in u?u.id:u.t);c&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let d=i.map((u,b)=>{let x=u.t==="drag"?`${u.from} -> ${u.to}`:u.t==="js"?"$eq":u.id||u.t,w=u.t==="js"?!0:u.t==="drag"?!!(te(u.from,"source")&&te(u.to,"destination")):!!(C(u.id||"")||C(y(u.id||""))),A=pe(u);return{index:b,action:u,target:x,located:w,applied:!r.has(u),verified:A,strategy:u.t==="drag"?"drag-adaptive":u.t==="js"?"javascript":"declarative-dom",evidence:A?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...r.has(u)?{error:r.get(u)}:{}}}),m=c?i.length>0&&s.length===0&&(h===i.length||l===i.length&&h>0):!0,g=!1,v=!1,f="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.";if(e&&(m||!c)){await new Promise(A=>setTimeout(A,i.length>0?400:150));let u=!1;if(o.pageType!=="info"){let A=uo();A&&T(A)&&(await it(A,1200),U(A),u=!0,await new Promise(L=>setTimeout(L,800)))}let b=Vt(),x=a.length>0?a[0].id:void 0,w=at(x);if(!w&&u&&(await new Promise(A=>setTimeout(A,600)),w=at(x)),w){await it(w,1500);let A=x||w.textContent?.trim()||"";A&&Ge(window.location.hostname,{advanceSelector:A}),U(w);let L=await po(b,2500);v=L.changed,f=L.evidence,g=L.changed||u,!L.changed&&!u&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else u?(g=!0,v=!0,f="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:l,verified:h,success:m,advanced:g,failed:s,reports:d,navigationVerified:v,navigationEvidence:f}}var he=null,ae=[],rt=[],lt=[],me=null,ho=`
...
`;function _t(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=ho,document.head.appendChild(o)}}catch{}}function ie(){he&&(he.style.removeProperty("outline"),he.style.removeProperty("outline-offset"),he.style.removeProperty("position"),he=null);for(let o of ae)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ae=[];for(let o of rt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");rt=[];for(let o of lt)try{o.remove()}catch{}if(lt=[],me){try{me.remove()}catch{}me=null}}function ct(o){_t();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),rt.push(t);try{let n=t.parentElement;if(n&&!n.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let a=document.createElement("div");a.setAttribute("data-easyquiz-capture-badge","true"),a.textContent="\u{1F4F7} Capturado pela IA",a.style.cssText=`
        ...
        `,n.appendChild(a),lt.push(a)}}catch{}}}function dt(o){ie(),_t(),he=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),me=t,setTimeout(()=>{try{t.remove()}catch{}me===t&&(me=null)},900)}catch{}}function mo(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Kt(o,e){let t=mo(e);for(let n of o){if(n.t==="adv"||n.t==="js")continue;if(n.t==="drag"){try{let h=C(n.from),d=C(n.to);h&&(h.style.outline=`2px solid ${t.outline}`,ae.push(h)),d&&(d.style.outline="2px dashed #00e5ff",ae.push(d))}catch{}continue}if(!n.id)continue;let i=n.v!==void 0?Array.isArray(n.v)?n.v[0]:String(n.v):"",a=C(n.id,i,n.t==="val"||n.t==="sel")||C(y(n.id),i,n.t==="val"||n.t==="sel");if(!a&&n.t==="sel"){let h=document.body;try{h=D()||document.body}catch{}let d=Array.from(h.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>T(v)&&!de(v)),m=y(n.id).toLowerCase();a=d.find(v=>{let f=(v.id||"").toLowerCase(),u=(v.getAttribute("name")||"").toLowerCase(),b=(v.getAttribute("aria-label")||"").toLowerCase(),x=y(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return f.includes(m)||u.includes(m)||b.includes(m)||m.length>=2&&x.includes(m)})||(d.length===1?d[0]:null)}if(!a)continue;let l=typeof HTMLSelectElement<"u"&&a instanceof HTMLSelectElement||a.tagName?.toLowerCase()==="select"||a.getAttribute("role")==="combobox"||a.getAttribute("role")==="listbox",r=a.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||a.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||a;r.style.outline=`2px solid ${t.outline}`,r.style.outlineOffset="2px",r.style.backgroundColor=t.bg,r.setAttribute("data-easyquiz-highlight","true"),ae.push(r);let c=l?a:r.querySelector('select, [role="combobox"], [role="listbox"]');c&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ae.push(c));let p=a instanceof HTMLInputElement&&["checkbox","radio"].includes(a.type)?a:r.querySelector('input[type="checkbox"], input[type="radio"]');p&&p!==r&&(p.style.outline=`2px solid ${t.outline}`,p.style.outlineOffset="2px",p.style.boxShadow=`0 0 10px ${t.glow}`,p.setAttribute("data-easyquiz-highlight","true"),ae.push(p))}}var ut=10,go=1400,pt=15e5;function ge(o){return new Promise((e,t)=>{let n=new FileReader;n.onerror=()=>t(new Error("Falha ao converter blob para base64.")),n.onload=()=>{let i=String(n.result||"");e(i.split(",")[1]||"")},n.readAsDataURL(o)})}async function Me(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let n=Math.min(1,go/Math.max(e,t)),i=Math.max(1,Math.round(e*n)),a=Math.max(1,Math.round(t*n)),l=document.createElement("canvas");l.width=i,l.height=a;let s=l.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,a),s.drawImage(o,0,0,i,a),new Promise((r,c)=>{l.toBlob(p=>p?r(p):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function fo(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,n=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),l=Math.min(1800,Math.max(100,Math.round(n*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(a)),s.setAttribute("height",String(l)),!s.getAttribute("viewBox")&&t>0&&n>0&&s.setAttribute("viewBox",`0 0 ${t} ${n}`);let c=new XMLSerializer().serializeToString(s),p=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(p);try{let d=new Image;d.crossOrigin="anonymous",await new Promise((v,f)=>{d.onload=()=>v(),d.onerror=()=>f(new Error("Falha ao renderizar SVG em Image.")),d.src=h});let m=document.createElement("canvas");m.width=a,m.height=l;let g=m.getContext("2d",{alpha:!1});if(!g)throw new Error("Sem suporte a Canvas 2D.");return g.fillStyle="#ffffff",g.fillRect(0,0,a,l),g.drawImage(d,0,0,a,l),new Promise((v,f)=>{m.toBlob(u=>u?v(u):f(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(h)}}async function ht(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,n=o.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=n=>{if(n.target.closest(".eq-fah-btn"))return;n.preventDefault(),this.isDragging=!0,this.dragStartX=n.clientX,this.dragStartY=n.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let a=s=>{if(!this.isDragging||!this.element)return;let r=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,p=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+r),p),m=Math.min(Math.max(10,this.initialTop+c),h);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),n=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,a=i.actions.filter(m=>m.t==="drag"),l=i.actions.filter(m=>{if(m.t!=="val")return!1;let g=y(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(g)}),s=i.actions.filter(m=>m.t==="clk"||m.t==="chk"),r=i.actions.filter(m=>m.t==="sel"),c=a.length||l.length||s.length||r.length,p=document.createElement("div");p.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,p.append(h,d),e.appendChild(p),a.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,n.textContent=String(a.length);let m={};for(let g of a){let v=y(g.to)||"Geral";m[v]||(m[v]=[]),m[v].push(y(g.from))}for(let[g,v]of Object.entries(m)){let f=document.createElement("div"),u=/fato|true|verdadeiro|sim/i.test(g),b=/opini[aã]o|false|falso|n[aã]o/i.test(g);f.className=`eq-fah-group ${u?"group-fato":b?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${g} (${v.length})`,f.appendChild(x);let w=document.createElement("div");w.className="eq-fah-group-items";for(let A of v){let L=document.createElement("div");L.className="eq-fah-item";let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=A,L.appendChild(S);let H=document.createElement("button");H.className="eq-fah-copy-inline",H.textContent="Copiar",H.addEventListener("click",()=>{navigator.clipboard.writeText(A),H.textContent="\u2713 Copiado",setTimeout(()=>H.textContent="Copiar",1200)}),L.appendChild(H),w.appendChild(L)}f.appendChild(w),e.appendChild(f)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,n.textContent=String(l.length);let m=document.createElement("div");m.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let f=0;f<l.length;f++){let u=l[f],b=document.createElement("div");b.className="eq-fah-item";let x=Le(u.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${f+1}`);let w=String(u.v??""),A=document.createElement("div");A.className="eq-fah-field-box";let L=document.createElement("div");L.className="eq-fah-field-label",L.textContent=x,A.appendChild(L);let S=document.createElement("div");S.className="eq-fah-field-val",S.textContent=w,A.appendChild(S),b.appendChild(A);let H=document.createElement("button");H.className="eq-fah-copy-inline",H.textContent="Copiar",H.addEventListener("click",()=>{navigator.clipboard.writeText(w),H.textContent="\u2713 Copiado",setTimeout(()=>H.textContent="Copiar",1200)}),b.appendChild(H),v.appendChild(b)}m.appendChild(v),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,n.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let f=0;f<s.length;f++){let u=s[f],b=document.createElement("div");b.className="eq-fah-item";let x=Le(u.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&u.v&&(x=String(u.v)),x=y(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let w="",A=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);A?(w=A[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=A[2].trim()||x):s.length>1&&(w=String.fromCharCode(65+f));let L=document.createElement("div");if(L.style.display="flex",L.style.alignItems="center",L.style.gap="8px",L.style.flex="1",w){let O=document.createElement("span");O.className="eq-fah-letter-badge",O.textContent=w,L.appendChild(O)}let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=x||(w?`Alternativa ${w}`:"Alternativa Selecionada"),L.appendChild(S),b.appendChild(L);let H=document.createElement("button");H.className="eq-fah-copy-inline",H.textContent="Copiar",H.addEventListener("click",()=>{navigator.clipboard.writeText(x||w),H.textContent="\u2713 Copiado",setTimeout(()=>H.textContent="Copiar",1200)}),b.appendChild(H),v.appendChild(b)}m.appendChild(v),e.appendChild(m)}else if(r.length>0){t.textContent=`Sele\xE7\xE3o (${r.length} listas)`,n.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let f=0;f<r.length;f++){let u=r[f],b=document.createElement("div");b.className="eq-fah-item";let x=Le(u.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${f+1}`);let L=(Array.isArray(u.v)?u.v:[String(u.v??"")]).map(fe=>{let E=C(u.id,void 0,!0)||C(y(u.id),void 0,!0),k=E instanceof HTMLSelectElement?E:E?.querySelector("select");if(k){let R=y(fe).toLowerCase();for(let Q=0;Q<k.options.length;Q++){let V=k.options[Q];if(V.value.toLowerCase()===R||y(V.textContent).toLowerCase()===R){let N=y(V.textContent);if(N&&!N.toLowerCase().includes("selecione"))return N}}}return fe}).join(", "),S=document.createElement("div");S.className="eq-fah-field-box";let H=document.createElement("div");H.className="eq-fah-field-label",H.textContent=x,S.appendChild(H);let O=document.createElement("div");O.className="eq-fah-field-val",O.textContent=L,S.appendChild(O),b.appendChild(S);let X=document.createElement("button");X.className="eq-fah-copy-inline",X.textContent="Copiar",X.addEventListener("click",()=>{navigator.clipboard.writeText(L),X.textContent="\u2713 Copiado",setTimeout(()=>X.textContent="Copiar",1200)}),b.appendChild(X),v.appendChild(b)}m.appendChild(v),e.appendChild(m)}else{t.textContent="Gabarito",n.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(i.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let n=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),a=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(n.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let r of n){let c=y(r.to)||"Geral";s[c]||(s[c]=[]),s[c].push(y(r.from))}for(let[r,c]of Object.entries(s)){t.push(`### Categoria: ${r}`);for(let p of c)t.push(`- ${p}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let r=y(s.id);t.push(`- **${r||"Campo"}:** \`${s.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<a.length;s++){let r=a[s],c=Le(r.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&r.v&&(c=String(r.v)),c=y(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let p=a.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${p}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let r=y(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${r}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
