...
[HTML]:
${n.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",f="";if(i&&typeof document<"u")try{let A=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(x=>{let C=x,v=C.getBoundingClientRect?.()||{width:0,height:0};return v.width>0&&v.height>0&&!C.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(x=>{let C=x,v=C.tagName.toLowerCase(),E=C.id?`#${C.id}`:"",T=C.className&&typeof C.className=="string"?`.${C.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",q=(C.textContent||C.value||C.getAttribute("aria-label")||"").trim().slice(0,60),w=C.getAttribute("type")||C.getAttribute("role")||"";return`${v}${E}${T}[${w}] txt="${q}"`});A.length>0&&(f=`
[DOM-INTERATIVO]:
${A.join(`
`)}`)}catch{}let d=Ze(),h=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",p=n.controls.filter(A=>A.role!=="navigation"),m=n.controls.filter(A=>A.role==="navigation"),b=Ln(n.sourceUrl,n.htmlSnippet),y=b?`
${b}
`:"";return`--- AN\xC1LISE ---
[MODO]: ${e.engine} | Dica: ${e.modeHint||"Auto"}
[URL]: ${n.sourceUrl}
[P\xC1GINA]: ${n.pageTitle}${h}${y}
[DADOS]
[TEXTO]:
${n.questionText}${u}${f}

[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let A=p.filter(k=>k.type==="checkbox"||k.type==="chk"),x=new Set(p.filter(k=>k.type==="radio").map(k=>k.name).filter(Boolean)),C=A.filter(k=>!k.name||!x.has(k.name)),v=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),E=C.length>=2||v,T=x.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&x.size>=1,q=p.every(k=>k.type==="radio"||k.type==="chk")&&x.size===1&&!E&&!T,w=p.filter(k=>k.type==="text"||k.type==="number"||k.type==="val"||k.tag==="input"||k.tag==="textarea"),z=w.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${x.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${x.size} afirma\xE7\xF5es \u2014 emita ${x.size} a\xE7\xF5es chk separadas + adv]
...
`;function pn(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=Yn,document.head.appendChild(n)}}catch{}}function Ce(){me&&(me.style.removeProperty("outline"),me.style.removeProperty("outline-offset"),me.style.removeProperty("position"),me=null);for(let n of He)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");He=[];for(let n of zt)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");zt=[];for(let n of Ot)try{n.remove()}catch{}Ot=[],Ee&&typeof window<"u"&&(window.removeEventListener("scroll",Ee),window.removeEventListener("resize",Ee),Ee=null);for(let n of Dt)try{n.remove()}catch{}if(Dt=[],ge){try{ge.remove()}catch{}ge=null}}function Bt(n){pn();let t=[];for(let e of n){if(!e||typeof e.setAttribute!="function")continue;let o=e;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),zt.push(o)}catch{}try{let s=e.getBoundingClientRect(),a=s.width||e.offsetWidth||280,r=s.height||e.offsetHeight||200;if(a>10&&r>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
        ...
        `,i.appendChild(c),document.body.appendChild(i),Ot.push(i),Dt.push(c),t.push({element:e,frame:i})}}catch{}}t.length>0&&!Ee&&typeof window<"u"&&(Ee=()=>{for(let e of t)try{let o=e.element.getBoundingClientRect();o.width>0&&o.height>0&&(e.frame.style.top=`${o.top+window.scrollY-3}px`,e.frame.style.left=`${o.left+window.scrollX-3}px`,e.frame.style.width=`${o.width+6}px`,e.frame.style.height=`${o.height+6}px`)}catch{}},window.addEventListener("scroll",Ee,{passive:!0}),window.addEventListener("resize",Ee,{passive:!0}))}function Je(n){me&&me!==n&&(me.style.removeProperty("outline"),me.style.removeProperty("outline-offset")),pn(),me=n,n.style.outline="2px solid #00e5ff",n.style.outlineOffset="4px";try{if(ge){try{ge.remove()}catch{}ge=null}window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let e=document.createElement("div");e.style.cssText=`
    ...
    `,n.appendChild(e),ge=e}catch{}}function Zn(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function hn(n,t){if(ge){try{ge.remove()}catch{}ge=null}let e=Zn(t);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let h=R(o.from),p=R(o.to);h&&(h.style.outline=`2px solid ${e.outline}`,He.push(h)),p&&(p.style.outline="2px dashed #00e5ff",He.push(p))}catch{}continue}let s=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let h=Array.from(document.querySelectorAll(`input[name="${Z(a)}"]`));if(s&&(r=h.find(p=>p.value?.toLowerCase()===s.toLowerCase())??null,!r)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(s),m=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(s);if(p||m){let b=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=h.find(y=>{let A=y.value?.toLowerCase()??"";if(b.includes(A))return!0;let C=(y.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(v=>C===v||C.startsWith(v+" ")||C.startsWith("("+v+")"))})??null}}!r&&h.length>0&&(r=h[0])}if(!r&&o.id&&(r=R(o.id,s,o.t==="val"||o.t==="sel")||R(H(o.id),s,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let h=document.body;try{h=se()||document.body}catch{}let p=Array.from(h.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(y=>N(y)&&!Ae(y)),m=H(o.id).toLowerCase();r=p.find(y=>{let A=(y.id||"").toLowerCase(),x=(y.getAttribute("name")||"").toLowerCase(),C=(y.getAttribute("aria-label")||"").toLowerCase(),v=H(y.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return A.includes(m)||x.includes(m)||C.includes(m)||m.length>=2&&v.includes(m)})||(p.length===1?p[0]:null)}if(!r)continue;let i=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",c=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=c||l||r;u.style.outline=`2px solid ${e.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=e.bg,u.setAttribute("data-easyquiz-highlight","true"),He.push(u);let f=i?r:u.querySelector('select, [role="combobox"], [role="listbox"]');f&&(f.style.outline=`2px solid ${e.outline}`,f.style.outlineOffset="2px",f.style.boxShadow=`0 0 10px ${e.glow}`,f.setAttribute("data-easyquiz-highlight","true"),He.push(f));let d=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:u.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==u&&(d.style.outline=`2px solid ${e.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${e.glow}`,d.setAttribute("data-easyquiz-highlight","true"),He.push(d))}}var Nt=10,$n=1400,We=15e5;function ve(n){return new Promise((t,e)=>{let o=new FileReader;o.onerror=()=>e(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");t(s.split(",")[1]||"")},o.readAsDataURL(n)})}async function Pe(n){let t=0,e=0;if(n instanceof HTMLImageElement?(t=n.naturalWidth||n.width,e=n.naturalHeight||n.height):(t=n.width,e=n.height),t<=0||e<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,$n/Math.max(t,e)),s=Math.max(1,Math.round(t*o)),a=Math.max(1,Math.round(e*o)),r=document.createElement("canvas");r.width=s,r.height=a;let i=r.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,s,a),i.drawImage(n,0,0,s,a),new Promise((c,l)=>{r.toBlob(u=>u?c(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function gn(n){let t=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},e=t.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=t.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,s=2,a=Math.min(1800,Math.max(120,Math.round(e*s))),r=Math.min(1800,Math.max(100,Math.round(o*s))),i=n.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(a)),i.setAttribute("height",String(r)),!i.getAttribute("viewBox")&&e>0&&o>0&&i.setAttribute("viewBox",`0 0 ${e} ${o}`);try{let d=Array.from(n.querySelectorAll("*")),h=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(d.length,h.length);p++){let m=d[p],b=h[p];if(!m||!b||!b.style)continue;let y=window.getComputedStyle?window.getComputedStyle(m):null;y&&(y.fill&&y.fill!=="none"&&(b.style.fill=y.fill),y.stroke&&y.stroke!=="none"&&(b.style.stroke=y.stroke),y.strokeWidth&&(b.style.strokeWidth=y.strokeWidth),y.fontFamily&&(b.style.fontFamily=y.fontFamily),y.fontSize&&(b.style.fontSize=y.fontSize),y.fontWeight&&(b.style.fontWeight=y.fontWeight),y.color&&(b.style.color=y.color))}}catch{}let c="#ffffff";try{let d=n.parentElement||n;for(;d&&d!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(d):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){c=p;break}d=d.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),f="";try{f=btoa(unescape(encodeURIComponent(u)))}catch{}try{let d=b=>new Promise((y,A)=>{let x=new Image,C=setTimeout(()=>A(new Error("Timeout render SVG")),1200);x.onload=()=>{clearTimeout(C),y(x)},x.onerror=()=>{clearTimeout(C),A(new Error("Falha ao renderizar SVG em Image."))},x.src=b}),h=null;if(f)try{h=await d(`data:image/svg+xml;base64,${f}`)}catch{}if(!h){let b=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),y=URL.createObjectURL(b);try{h=await d(y)}finally{URL.revokeObjectURL(y)}}let p=document.createElement("canvas");p.width=a,p.height=r;let m=p.getContext("2d",{alpha:!1});if(m&&h){m.fillStyle=c,m.fillRect(0,0,a,r),m.drawImage(h,0,0,a,r);let b=await new Promise(y=>{p.toBlob(y,"image/jpeg",.92)});if(b){let y=await ve(b);if(y)return{blob:b,base64:y,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function Rt(n){try{let t=n.getBoundingClientRect(),e=Math.round(t.width)||n.offsetWidth||400,o=Math.round(t.height)||n.offsetHeight||300;if(e<30||o<30)return null;let s=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(s&&n.querySelectorAll("input, select, textarea").length===0)try{let m=await gn(s);if(m.base64&&m.base64.length<=We)return{mediaType:m.mediaType,base64:m.base64,alt:n.getAttribute("aria-label")||s.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:Te(s)}}catch{}if(n instanceof HTMLCanvasElement)try{let m=await Pe(n),b=await ve(m);if(b)return{mediaType:"image/jpeg",base64:b,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let m=n;for(;m&&m!==document.documentElement;){let y=(window.getComputedStyle?window.getComputedStyle(m):null)?.backgroundColor;if(y&&y!=="transparent"&&y!=="rgba(0, 0, 0, 0)"){a=y;break}m=m.parentElement}}catch{}let r=n.cloneNode(!0),i=Array.from(n.querySelectorAll("*")),c=Array.from(r.querySelectorAll("*"));for(let m=0;m<Math.min(i.length,c.length);m++){let b=i[m],y=c[m];if(!(!b||!y||!y.style))try{let A=window.getComputedStyle(b);y.style.color=A.color,y.style.backgroundColor=A.backgroundColor,y.style.borderColor=A.borderColor,y.style.borderWidth=A.borderWidth,y.style.borderStyle=A.borderStyle,y.style.fontSize=A.fontSize,y.style.fontFamily=A.fontFamily,y.style.fontWeight=A.fontWeight,y.style.lineHeight=A.lineHeight,y.style.letterSpacing=A.letterSpacing,y.style.textAlign=A.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(e,o))),u=Math.round(e*l),f=Math.round(o*l),d=`
...
`};var ut=class{element=null;shadow;isMinimized=!1;currentPlan=null;isDragging=!1;dragStartX=0;dragStartY=0;initialLeft=25;initialTop=25;onAdvanceCallback;constructor(t,e){this.shadow=t,this.onAdvanceCallback=e,this.initGlobalListeners()}initGlobalListeners(){window.addEventListener("popstate",()=>this.handlePageNavigated()),window.addEventListener("hashchange",()=>this.handlePageNavigated()),document.addEventListener("click",t=>{if(!this.isOpen())return;let e=t.target;if(!e||this.shadow.contains(e)||e.closest("#easyquiz-shadow-root"))return;let o=e.closest('button, [role="button"], a, input[type="submit"]');if(o){let s=(o.textContent||o.value||"").toLowerCase();/pr[oó]xim|avan[cç]|continu|verific|enviar|submit|confirm|checar|validar|next/i.test(s)&&setTimeout(()=>{this.isOpen()&&this.handlePageNavigated()},800)}},!0)}handlePageNavigated(){this.isOpen()&&(this.hide(),this.onAdvanceCallback?.())}isOpen(){return this.element!==null&&this.element.style.display!=="none"}show(t){this.currentPlan=t,this.element||this.createElement(),this.renderContent(),this.element&&(this.element.style.display="flex")}hide(){this.element&&(this.element.style.display="none")}minimize(){this.isMinimized=!0,this.element&&this.element.classList.add("minimized")}restore(){this.isMinimized=!1,this.element&&this.element.classList.remove("minimized")}createElement(){this.element=document.createElement("div"),this.element.className="eq-floating-hud",this.element.style.left=`${this.initialLeft}px`,this.element.style.top=`${this.initialTop}px`,this.element.innerHTML=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let s=this.element.querySelector("#eq-fah-copy-md-btn");s.addEventListener("click",()=>this.copyMarkdownToClipboard(s));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(t){let e=o=>{if(o.target.closest(".eq-fah-btn"))return;o.preventDefault(),this.isDragging=!0,this.dragStartX=o.clientX,this.dragStartY=o.clientY;let s=this.element.getBoundingClientRect();this.initialLeft=s.left,this.initialTop=s.top;let a=i=>{if(!this.isDragging||!this.element)return;let c=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),f=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+c),u),h=Math.min(Math.max(10,this.initialTop+l),f);this.element.style.left=`${d}px`,this.element.style.top=`${h}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};t.addEventListener("mousedown",e)}renderContent(){if(!this.element||!this.currentPlan)return;let t=this.element.querySelector("#eq-fah-body"),e=this.element.querySelector("#eq-fah-pill-text"),o=this.element.querySelector("#eq-fah-pill-badge");t.innerHTML="";let s=this.currentPlan,a=s.actions.filter(h=>h.t==="drag"),r=s.actions.filter(h=>{if(h.t!=="val")return!1;let p=H(h.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=s.actions.filter(h=>h.t==="clk"||h.t==="chk"),c=s.actions.filter(h=>h.t==="sel"),l=a.length||r.length||i.length||c.length,u=document.createElement("div");u.className="eq-fah-meta";let f=document.createElement("span");f.textContent=`Modo: ${s.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(s.confidence*100)}% Confian\xE7a`,u.append(f,d),t.appendChild(u),a.length>0||s.mode==="categorizacao"||s.mode==="arrastar_soltar"){e.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,o.textContent=String(a.length);let h={};for(let p of a){let m=H(p.to)||"Geral";h[m]||(h[m]=[]),h[m].push(H(p.from))}for(let[p,m]of Object.entries(h)){let b=document.createElement("div"),y=/fato|true|verdadeiro|sim/i.test(p),A=/opini[aã]o|false|falso|n[aã]o/i.test(p);b.className=`eq-fah-group ${y?"group-fato":A?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${p} (${m.length})`,b.appendChild(x);let C=document.createElement("div");C.className="eq-fah-group-items";for(let v of m){let E=document.createElement("div");E.className="eq-fah-item";let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=v,E.appendChild(T);let q=document.createElement("button");q.className="eq-fah-copy-inline",q.textContent="Copiar",q.addEventListener("click",()=>{navigator.clipboard.writeText(v),q.textContent="\u2713 Copiado",setTimeout(()=>q.textContent="Copiar",1200)}),E.appendChild(q),C.appendChild(E)}b.appendChild(C),t.appendChild(b)}}else if(r.length>0){e.textContent=`Preenchimento (${r.length} campos)`,o.textContent=String(r.length);let h=document.createElement("div");h.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",h.appendChild(p);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b=0;b<r.length;b++){let y=r[b],A=document.createElement("div");A.className="eq-fah-item";let x=Ge(y.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${b+1}`);let C=String(y.v??""),v=document.createElement("div");v.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=x,v.appendChild(E);let T=document.createElement("div");T.className="eq-fah-field-val",T.textContent=C,v.appendChild(T),A.appendChild(v);let q=document.createElement("button");q.className="eq-fah-copy-inline",q.textContent="Copiar",q.addEventListener("click",()=>{navigator.clipboard.writeText(C),q.textContent="\u2713 Copiado",setTimeout(()=>q.textContent="Copiar",1200)}),A.appendChild(q),m.appendChild(A)}h.appendChild(m),t.appendChild(h)}else if(i.length>0){e.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,o.textContent=String(i.length);let h=document.createElement("div");h.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",h.appendChild(p);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b=0;b<i.length;b++){let y=i[b],A=document.createElement("div");A.className="eq-fah-item";let x=Ge(y.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&y.v&&(x=String(y.v)),x=H(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let C="",v=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);v?(C=v[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=v[2].trim()||x):i.length>1&&(C=String.fromCharCode(65+b));let E=document.createElement("div");if(E.style.display="flex",E.style.alignItems="center",E.style.gap="8px",E.style.flex="1",C){let w=document.createElement("span");w.className="eq-fah-letter-badge",w.textContent=C,E.appendChild(w)}let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=x||(C?`Alternativa ${C}`:"Alternativa Selecionada"),E.appendChild(T),A.appendChild(E);let q=document.createElement("button");q.className="eq-fah-copy-inline",q.textContent="Copiar",q.addEventListener("click",()=>{navigator.clipboard.writeText(x||C),q.textContent="\u2713 Copiado",setTimeout(()=>q.textContent="Copiar",1200)}),A.appendChild(q),m.appendChild(A)}h.appendChild(m),t.appendChild(h)}else if(c.length>0){e.textContent=`Sele\xE7\xE3o (${c.length} listas)`,o.textContent=String(c.length);let h=document.createElement("div");h.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",h.appendChild(p);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b=0;b<c.length;b++){let y=c[b],A=document.createElement("div");A.className="eq-fah-item";let x=Ge(y.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${b+1}`);let E=(Array.isArray(y.v)?y.v:[String(y.v??"")]).map(P=>{let k=R(y.id,void 0,!0)||R(H(y.id),void 0,!0),I=k instanceof HTMLSelectElement?k:k?.querySelector("select");if(I){let j=H(P).toLowerCase();for(let Q=0;Q<I.options.length;Q++){let F=I.options[Q];if(F.value.toLowerCase()===j||H(F.textContent).toLowerCase()===j){let K=H(F.textContent);if(K&&!K.toLowerCase().includes("selecione"))return K}}}return P}).join(", "),T=document.createElement("div");T.className="eq-fah-field-box";let q=document.createElement("div");q.className="eq-fah-field-label",q.textContent=x,T.appendChild(q);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=E,T.appendChild(w),A.appendChild(T);let z=document.createElement("button");z.className="eq-fah-copy-inline",z.textContent="Copiar",z.addEventListener("click",()=>{navigator.clipboard.writeText(E),z.textContent="\u2713 Copiado",setTimeout(()=>z.textContent="Copiar",1200)}),A.appendChild(z),m.appendChild(A)}h.appendChild(m),t.appendChild(h)}else{e.textContent="Gabarito",o.textContent="0";let h=document.createElement("div");h.style.padding="10px",h.style.color="#888",h.textContent="Nenhuma resposta direta para exibir.",t.appendChild(h)}if(s.rationale){let h=document.createElement("div");h.className="eq-fah-rationale",h.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${s.rationale}`,t.appendChild(h)}}generateMarkdown(){if(!this.currentPlan)return"";let t=this.currentPlan,e=[];e.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),e.push(`- **Modo:** ${t.mode}`),e.push(`- **Confian\xE7a:** ${(t.confidence*100).toFixed(0)}%`),e.push("");let o=t.actions.filter(i=>i.t==="drag"),s=t.actions.filter(i=>i.t==="val"),a=t.actions.filter(i=>i.t==="clk"||i.t==="chk"),r=t.actions.filter(i=>i.t==="sel");if(o.length>0){e.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let c of o){let l=H(c.to)||"Geral";i[l]||(i[l]=[]),i[l].push(H(c.from))}for(let[c,l]of Object.entries(i)){e.push(`### Categoria: ${c}`);for(let u of l)e.push(`- ${u}`);e.push("")}}else if(s.length>0){e.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of s){let c=H(i.id);e.push(`- **${c||"Campo"}:** \`${i.v}\``)}e.push("")}else if(a.length>0){e.push("## \u2705 Alternativas Corretas:");for(let i=0;i<a.length;i++){let c=a[i],l=Ge(c.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&c.v&&(l=String(c.v)),l=H(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=a.length>1?`${String.fromCharCode(65+i)}) `:"";e.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}e.push("")}else if(r.length>0){e.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of r){let c=H(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");e.push(`- **${c}:** \`${l}\``)}e.push("")}return t.rationale&&(e.push("---"),e.push(`**\u{1F4A1} Racioc\xEDnio:** ${t.rationale}`)),e.join(`
...
`;var qe="v3.3.5";var bn=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:n=>n})}catch{}return null})();function ao(n,t){try{if(bn){n.innerHTML=bn.createHTML(t);return}}catch{}try{if(typeof n.setHTMLUnsafe=="function"){n.setHTMLUnsafe(t);return}}catch{}n.innerHTML=t}var io=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],so=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],pt=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_wallpaperRAF=0;_wlpWhiteLogo=null;_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(t,e){this.initialSettings=t,this.callbacks=e,this.autopilot=new dt({onStatusChange:(i,c,l)=>{this.logToConsole(c,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),c.includes("conclus\xE3o")||c.includes("finalizada")||c.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,c)=>{try{return await this.callbacks.onAnalyze(i,c,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),ao(this.shadow,`
                  ...
                  <div class="eq-key-input-container">
                    ...
                    <div class="eq-ctx" id="eq-key-context-menu" hidden>
                      <button class="eq-ctx-item" id="eq-menu-prompt" type="button">
                        <span class="eq-ctx-icon">${S.edit}</span>
                      ...
                      <button class="eq-ctx-item" id="eq-menu-paste" type="button">
                        <span class="eq-ctx-icon">${S.paste}</span>
                      ...
                      <button class="eq-ctx-item" id="eq-menu-toggle-vis" type="button">
                        <span class="eq-ctx-icon" id="eq-menu-vis-icon">${S.eye}</span>
                      ...
                      <button class="eq-ctx-item" id="eq-menu-bulk" type="button">
                        <span class="eq-ctx-icon">${S.listPlus}</span>
                      ...
                      <button class="eq-ctx-item danger" id="eq-menu-delete-all" type="button">
                        <span class="eq-ctx-icon">${S.trash}</span>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new ut(this.shadow,()=>{this.callbacks.onAnalyze(1)});let o=this.shadow.querySelector("#eq-open-hud-btn");o&&o.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),ze.filter(i=>re(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===t.model))),io.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===t.modeHint))),so.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===t.engine))),this.apiKeyInput.value=t.apiKey,this.dryRunCheckbox.checked=t.dryRun,this.autoApplyCheckbox.checked=t.autoApply,this.autoAdvanceCheckbox.checked=t.autoAdvance,this.hostDarkModeCheckbox.checked=t.hostDarkMode,this.useVisionCheckbox.checked=t.useVision,this.toastStackingCheckbox.checked=t.toastStacking??!0,this.toastStackingCheckbox.checked=t.toastStacking??!0,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(t.hostDarkMode);let s=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];X.init(s),this.apiKeyInput.value=X.getBestKey()||t.apiKey||"",this.renderKeysList();let a=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof a?.unref=="function"&&a.unref();let r=X.getBestKey()||t.apiKey;r&&et(r).then(i=>{i&&i.length>0&&this.updateModelSelect(i,t.model)}).catch(()=>{})}switchTab(t){this.activeTab=t;let e=["resolver","brain","metrics","debug","settings"];this.shadow.querySelector(".eq-views-wrapper")?.classList.toggle("is-brain-active",t==="brain");for(let s of e){let a=this.shadow.querySelector(`#eq-tab-${s}`),r=this.shadow.querySelector(`#eq-view-${s}`),i=s===t;a?.classList.toggle("active",i),r&&(r.style.display=i?"flex":"none")}switch(this.updateContextBar(t),t){case"brain":this.initBrainControls(),this.renderContextTree(),this.refreshInspectorView();break;case"metrics":try{this.updateTimingMetrics()}catch{}break;case"debug":this.terminalMode="terminal";try{this.refreshDebugView(),this.renderTerminalEntries(),this.initTerminalREPL(),this.initTerminalWallpaper()}catch{}break;case"settings":break}}updateContextBar(t){let e=this.shadow.querySelector("#eq-ctxbar-icon"),o=this.shadow.querySelector("#eq-ctxbar-name"),s=this.shadow.querySelector("#eq-ctxbar-sub"),a=this.shadow.querySelector("#eq-ctxbar-actions");if(!e||!o||!s||!a)return;a.innerHTML="";let i={resolver:{icon:S.sparkles,label:"Resolver",sub:"Autopilot & opera\xE7\xF5es",color:"#a78bfa",actions:()=>{let c=document.createElement("span");return c.id="eq-ctxbar-status",c.style.cssText="font-size:9px;font-weight:700;padding:2px 7px;border-radius:10px;background:rgba(167,139,250,0.13);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;letter-spacing:0.04em;",c.textContent="PRONTO",[c]}},brain:{icon:S.inspector,label:"C\xE9rebro da IA",sub:"Contexto & inspe\xE7\xE3o",color:"#60a5fa",actions:()=>{let c=this.shadow.querySelector("#eq-brain-canvas-toggle"),l=document.createElement("button");l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",l.innerHTML=this.brainCanvasHidden?S.eyeOff:S.eye,l.title="Mostrar/Ocultar canvas",l.addEventListener("click",()=>{c?.click(),l.innerHTML=this.brainCanvasHidden?S.eyeOff:S.eye});let u=document.createElement("button");return u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=S.copy,u.title="Copiar conte\xFAdo selecionado",u.addEventListener("click",()=>this.smartCopy()),[l,u]}},metrics:{icon:S.clock,label:"M\xE9tricas",sub:"Cron\xF4metro & hist\xF3rico",color:"#4ade80",actions:()=>{let c=document.createElement("button");c.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",c.innerHTML=S.copy,c.title="Copiar relat\xF3rio",c.addEventListener("click",()=>this.copyMetricsReport());let l=document.createElement("button");return l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.07);border:1px solid rgba(255,85,85,0.13);border-radius:4px;cursor:pointer;color:#ff5555;",l.innerHTML=S.trash,l.title="Zerar m\xE9tricas",l.addEventListener("click",()=>{this.shadow.querySelector("#eq-metrics-reset-btn")?.click()}),[c,l]}},debug:{icon:S.code,label:"Terminal",sub:"Comandos & logs",color:"#0098ff",actions:()=>{let c=document.createElement("div");c.style.cssText="display:inline-flex;align-items:center;gap:1px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:2px;";let l=(d,h,p)=>{let m=document.createElement("button");return m.id=d,m.type="button",m.textContent=h,m.style.cssText="font-size:9px;font-weight:600;padding:2px 8px;border-radius:3px;cursor:pointer;transition:all 0.1s;background:"+(p?"#1a1a1a":"transparent")+";border:1px solid "+(p?"#333":"transparent")+";color:"+(p?"#ddd":"#555")+";",m};c.appendChild(l("eq-term-mode-terminal","Terminal",!0)),c.appendChild(l("eq-term-mode-output","Output",!1));let u=document.createElement("button");u.id="eq-term-copy-btn",u.type="button",u.title="Copiar",u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=S.copy;let f=document.createElement("button");return f.id="eq-term-clear-btn",f.type="button",f.title="Limpar",f.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.07);border:1px solid rgba(255,85,85,0.13);border-radius:4px;cursor:pointer;color:#ff5555;",f.innerHTML=S.trash,[c,u,f]}},settings:{icon:S.settings,label:"Configura\xE7\xF5es",sub:"Ajustes & prefer\xEAncias",color:"#fbbf24"}}[t];if(i&&(e.innerHTML=i.icon,e.style.color=i.color,o.textContent=i.label,o.style.color=i.color==="#a78bfa"?"#ccc":"#ddd",s.textContent=i.sub,i.actions))for(let c of i.actions())a.appendChild(c)}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let t=this.shadow.querySelector("#eq-status-card");t?.addEventListener("click",()=>{let v=t.classList.toggle("is-collapsed");t.setAttribute("aria-expanded",String(!v))}),this.metricsResetBtn?.addEventListener("click",()=>{Qe(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let e=this.shadow.querySelector("#eq-dbg-copy-logs");e?.addEventListener("click",()=>{let v=this.getFormattedLogs();navigator.clipboard.writeText(v).then(()=>{let E=e.innerHTML;e.innerHTML=S.check,setTimeout(()=>e.innerHTML=E,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let o=this.shadow.querySelector("#eq-dbg-copy-prompt");o?.addEventListener("click",()=>{let v=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(v).then(()=>{let E=o.innerHTML;o.innerHTML=`${S.check} Copiado!`,setTimeout(()=>o.innerHTML=E,1800)})});let s=this.shadow.querySelector("#eq-dbg-copy-context");s?.addEventListener("click",()=>{let v=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let E=s.innerHTML;s.innerHTML=`${S.check} Copiado!`,setTimeout(()=>s.innerHTML=E,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-raw-resp");a?.addEventListener("click",()=>{let v=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let E=a.innerHTML;a.innerHTML=`${S.check} Copiado!`,setTimeout(()=>a.innerHTML=E,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-error-btn");r?.addEventListener("click",()=>{let v=this.lastErrorMsg||"";navigator.clipboard.writeText(v).then(()=>{let E=r.innerHTML;r.innerHTML=S.check,setTimeout(()=>r.innerHTML=E,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",v=>{v.altKey&&(v.key==="q"||v.key==="Q"||v.key==="a"||v.key==="A")&&(v.preventDefault(),this.toggle())},!0);let i=v=>{let E=v.composedPath();E.includes(this.shadow)||(E.includes(this.sidebarEl)||E.includes(this.host))&&v.stopImmediatePropagation()};window.addEventListener("keydown",i,!0),window.addEventListener("keyup",i,!0),window.addEventListener("keypress",i,!0),this.apiKeyInput.addEventListener("input",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:v})});let c=this.shadow.querySelector("#eq-keys-collapsible"),l=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),f=v=>{c&&(v?(c.style.display="none",l&&(l.style.transform="rotate(0deg)")):(c.style.display="block",c.style.maxHeight="none",c.style.overflow="visible",l&&(l.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}f(d),u?.addEventListener("click",v=>{if(v.target?.closest("a"))return;let E=c?.style.display==="none";f(!E);try{localStorage.setItem("easyquiz_keys_collapsed",E?"false":"true")}catch{}});let h=this.shadow.querySelector("#eq-auto-menu-btn"),p=this.shadow.querySelector("#eq-auto-menu");p&&(p.hidden=!0),h?.classList.remove("is-open"),h?.addEventListener("click",v=>{if(v.stopPropagation(),!p)return;let E=p.hidden;if(p.hidden=!E,h.classList.toggle("is-open",!p.hidden),E){let T=h.getBoundingClientRect(),q=220;p.style.position="fixed",p.style.top=T.bottom+4+"px",p.style.left=Math.max(4,T.right-q)+"px",p.style.right="auto",p.style.width=q+"px",p.style.zIndex="2147483645"}}),p?.querySelectorAll("[data-auto-action]").forEach(v=>{v.addEventListener("click",E=>{E.stopPropagation();let T=v.dataset.autoAction;T==="toggle"?this.analyzeBtn?.click():T==="memory"?($e(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):T==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),p&&(p.hidden=!0),h?.classList.remove("is-open")})}),this.shadow.addEventListener("click",v=>{v.target.closest(".eq-menu-shell")||(p&&(p.hidden=!0),h?.classList.remove("is-open"))});let m=this.shadow.querySelector("#eq-result-toggle"),b=this.shadow.querySelector("#eq-result-body");m&&b&&(b.classList.add("is-collapsed"),m.classList.remove("is-open"),m.addEventListener("click",()=>{let v=m.classList.toggle("is-open");b.classList.toggle("is-collapsed",!v)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!v){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let E=X.addKey(v);if(E.ok){let T=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${T.length} chaves ativas no pool)`,"success"),f(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,tt(v).then(q=>{q.ok?(X.markSuccess(v,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(X.markInvalid(v,q.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${q.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(E.message,"warning")}),this.keyMoreBtn.addEventListener("click",v=>{v.stopPropagation();let E=this.keyContextMenu.hidden;if(this.keyContextMenu.hidden=!E,E){let T=this.keyMoreBtn.getBoundingClientRect(),q=240;this.keyContextMenu.style.position="fixed",this.keyContextMenu.style.top=T.bottom+4+"px",this.keyContextMenu.style.left=Math.max(4,T.right-q)+"px",this.keyContextMenu.style.right="auto",this.keyContextMenu.style.width=q+"px",this.keyContextMenu.style.zIndex="2147483645"}}),this.shadow.addEventListener("click",v=>{let E=v.target;!E.closest("#eq-key-context-menu")&&!E.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(v!==null&&v.trim()){let E=v.trim().replace(/^["']|["']$/g,""),T=X.addKey(E);if(T.ok){let q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:q[0],apiKeys:q}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(T.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let v=await navigator.clipboard.readText();if(v){let E=v.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=E,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let v=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(v!==null&&v.trim()){let E=v.trim().replace(/^["']|["']$/g,"");if(X.addKey(E).ok){let q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:q[0],apiKeys:q}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=this.apiKeyInput.type==="password";this.apiKeyInput.type=v?"text":"password";let E=this.shadow.querySelector("#eq-menu-vis-icon"),T=this.shadow.querySelector("#eq-menu-vis-text");E&&(E.innerHTML=v?S.eyeOff:S.eye),T&&(T.textContent=v?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let v=document.createElement("div");v.id="eq-bulk-overlay",v.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let E=document.createElement("div");E.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),E.innerHTML=`
      ...
      `,v.appendChild(E),this.shadow.appendChild(v);let T=E.querySelector("#eq-bulk-ta"),q=E.querySelector("#eq-bulk-status"),w=E.querySelector("#eq-bulk-import"),z=E.querySelector("#eq-bulk-paste-btn"),P=E.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>T?.focus());let k=()=>{v.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(I=>{v.addEventListener(I,j=>{j.stopPropagation(),j.stopImmediatePropagation()},!0)}),v.addEventListener("keydown",I=>{I.key==="Escape"&&k()}),v.addEventListener("click",I=>{I.target===v&&k()}),E.querySelector("#eq-bulk-x")?.addEventListener("click",k),E.querySelector("#eq-bulk-cancel")?.addEventListener("click",k),P.addEventListener("click",()=>{T.value="",q.textContent="",T.focus()}),z.addEventListener("click",async()=>{try{let I=await navigator.clipboard?.readText();I?(T.value=I,T.focus(),q.style.color="#38bdf8",q.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(q.style.color="#fbbf24",q.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{q.style.color="#fbbf24",q.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",T.focus()}}),E.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let I=T.value.trim();if(!I){q.style.color="#f87171",q.textContent="Insira pelo menos uma chave de API antes de importar.";return}let j=I.match(/AIza[0-9A-Za-z\-_]{35}/g),Q=[];if(j&&j.length>0?Q=Array.from(new Set(j)):Q=Array.from(new Set(I.split(/[\n,;\s]+/).map(ne=>ne.trim().replace(/^["'`]|["'`]$/g,"")).filter(ne=>ne.length>=20))),Q.length===0){q.style.color="#f87171",q.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}q.style.color="#00e5ff",q.textContent=`Processando ${Q.length} chave(s)...`,w.disabled=!0,w.style.opacity="0.6";let F=0,K=0;for(let ne of Q){let _=X.addKey(ne);_.ok?F++:_.message.includes("j\xE1 est\xE1 cadastrada")&&K++}if(F>0){let ne=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:ne[0],apiKeys:ne}),f(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}q.textContent=`${F} adicionada(s), ${K} duplicada(s). Validando modelo em paralelo...`;let J=X.exportRawKeys(),te=this.modelSelect?.value||"gemini-3.5-flash-lite",ee=await Et(te,J);ee.ok?(X.markSuccess(ee.key,200),q.style.color="#4ade80",q.textContent=` ${F} adicionada(s), ${K} duplicada(s). Modelo '${ee.model}' pronto!`):(q.style.color="#fbbf24",q.textContent=`${F} adicionada(s), ${K} duplicada(s). Aviso: ${ee.message}`),this.renderKeysList(),w.disabled=!1,w.style.opacity="1",F>0&&(this.setStatus(` Lote importado: ${F} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(k,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let v=X.exportRawKeys(),E=document.createElement("div");E.id="eq-text-editor-overlay",E.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let T=document.createElement("div");T.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),T.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function ro(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let t=document.createElement("link");t.rel="dns-prefetch",t.href="https://generativelanguage.googleapis.com",t.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(t)}catch{}}async function lo(){let n=window;if(Qe(),ro(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let t=bt(),e=null,o=null,s=0,a=new pt(t,{onAnalyze:(l=1,u,f=!1)=>r(l,u,f),onApply:(l=1)=>void i(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}Ce(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}Ce(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{t=Xt(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,f=!1){if(!t.apiKey&&(!Array.isArray(t.apiKeys)||t.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,h=()=>{try{d.abort()}catch{}};if(u&&(u.aborted?d.abort():u.addEventListener("abort",h,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}s=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),Ce(),a.hideFloatingAnswers();try{let p=xe(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ye()),Je(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${t.model})...`);let m=await jt(p.scope,t.useVision);if(m.length>0){let v=m.map(E=>E.element).filter(Boolean);Bt(v),a.updateImages(m)}if(d.signal.aborted)return;let b=t.model;a.setStatus(m.length>0?`Consultando Gemini (${b}) com ${m.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let y=Fe(p,m,t);a.setInspectorPrompt(y,t.model);let A=(v,E)=>{a.setStatus(v,E==="warning"?"info":E);let T=v.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(T){let q=T[1].split(",")[0].trim();a.setProgress(50,`Gemini ${q} respondendo...`)}},{plan:x,usedModel:C}=await nt(p,m,t,A,d.signal);if(d.signal.aborted)return;if(x.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=xe(!0),p||(p=ye()),Je(p.scope),a.updateContext(p),m=await jt(p.scope,t.useVision),m.length>0){let T=m.map(q=>q.element).filter(Boolean);Bt(T),a.updateImages(m)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let v=Fe(p,m,t);a.setInspectorPrompt(v,t.model),x=(await nt(p,m,t,A,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||t.model} | Modo: ${x.mode} | Confian\xE7a: ${(x.confidence*100).toFixed(0)}%`,"text-green"),x.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${x.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${x.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),x.memoryToStore&&(Vt(x.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${x.memoryToStore}"`,"text-yellow")),x.imageDescriptions&&x.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${x.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let v of x.imageDescriptions){let E=v.relevant?"":"\uFE0F";a.logToConsole(`>   ${E} Imagem ${v.index+1} [${v.relevant?"RELEVANTE":"IGNORADA"}]: ${v.description}`,v.relevant?"text-blue":"text-yellow")}}return e=x,a.updateContext(p,x),hn(x.actions,x.confidence),a.setPlan(x,!t.dryRun),x.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):x.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):x.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(t.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),t.dryRun&&x.pageType==="question"&&a.showFloatingAnswers(x),d.signal.aborted?void 0:((f||t.autoApply)&&!t.dryRun&&await i(l,d.signal,f),x)}catch(p){if(d.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){Ce(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}Ce(),a.setProgress(0);let m=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(m,"error"),a.setErrorDiagnostic(m,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",h),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function i(l=1,u,f=!1){if(u?.aborted)return;if(!e){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(t.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=e.pageType==="info"||e.pageType==="start",h=e.actions.filter(b=>b.t!=="adv"),p=e.pageType==="question"||it(e.rationale||"");if(p&&h.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let m=(f||t.autoAdvance||d)&&e.confidence>=t.confidenceThreshold&&!e.needsMoreContext&&(!p||h.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${e.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${e.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Ke(e,m,l,Ie(t));if(u?.aborted)return;if(a.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let v of b.failedActions){let E=v.action,T=E.t==="drag"?`drag: "${E.from}" \u2192 "${E.to}"`:E.t==="clk"||E.t==="chk"?`${E.t}: "${E.id}"`:E.t==="val"?`val: "${E.id}" = "${E.v}"`:JSON.stringify(E).slice(0,80);a.logToConsole(`>    [${E.t.toUpperCase()}] ${T} | ${v.evidence.slice(0,80)}`,"text-yellow")}await c(b.failedActions,u)}let y=s>0?Date.now()-s:1200,A=b.verified>0,x=b.applied>0;if(b.success||A&&x){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):m&&a.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),a.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let v=Kt({id:`q-${Date.now()}`,questionIndex:(je().records.length||0)+1,questionTitle:e.rationale?e.rationale.slice(0,45)+"...":`Quest\xE3o ${e.mode||"Auto"}`,durationMs:y,status:"answered",mode:e.mode,actionsCount:b.applied});a.updateTimingMetrics(v)}else x?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),t.dryRun&&a.showFloatingAnswers(e))}catch(b){a.setProgress(0);let y=b instanceof Error?b.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${y}`,"error"),a.logToConsole(`> [ERRO] ${y}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,u){if(!e)return;let f=l.filter(h=>h.action.t==="drag");for(let h of f){if(u?.aborted)return;let p=h.action,m=String(p.from||""),b=String(p.to||""),y=cn(m,b,m,b);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${m}" \u2192 "${b}"`,"text-blue");let A={...e,actions:[{t:"js",v:y}],pageType:"question"},x=await Ke(A,!1,1,Ie(t));a.logToConsole(x.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",x.applied>0?"text-green":"text-yellow")}let d=l.filter(h=>h.action.t!=="drag");if(d.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let h of d){if(u?.aborted)return;let p=h.action,m=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${m}`,"text-blue");let b=String(p.id||p.name||p.selector||""),y=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await ct(h.action),await new Promise(A=>setTimeout(A,250)),ue(h.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${m}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let A=R(b,y)||R(b.replace(/[^\w\s]/g," ").trim(),y);if(A&&(Pt(A),await new Promise(x=>setTimeout(x,300)),ue(h.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${m}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let A=R(b,y)||R(b.replace(/[^\w\s]/g," ").trim(),y);if(A&&(A.focus?.(),await new Promise(x=>setTimeout(x,50)),A.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80)),A.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200)),ue(h.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${m}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let A=R(b,y)||R(b.replace(/[^\w\s]/g," ").trim(),y);if(A){let x=A.id,C=!!x;x||(x=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,A.id=x);let v=String(p.v??""),E=p.t==="val",T=document.createElement("script");if(T.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(T),T.remove(),C||setTimeout(()=>{try{A.id===x&&A.removeAttribute("id")}catch{}},0),await new Promise(q=>setTimeout(q,300)),ue(h.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${m}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let A="";try{let k=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(I=>(I.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));k&&(A=k.outerHTML.slice(0,400))}catch{}let x=xe(!1)||ye(),C=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${h.evidence.slice(0,80)}"${A?`
HTML do alvo: ${A}`:""}`,v=h.strategiesAttempted?[h.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],E=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
