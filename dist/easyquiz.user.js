...
[HTML]:
${o.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",b="";if(i&&typeof document<"u")try{let g=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(y=>{let w=y,C=w.getBoundingClientRect?.()||{width:0,height:0};return C.width>0&&C.height>0&&!w.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(y=>{let w=y,C=w.tagName.toLowerCase(),A=w.id?`#${w.id}`:"",S=w.className&&typeof w.className=="string"?`.${w.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",x=(w.textContent||w.value||w.getAttribute("aria-label")||"").trim().slice(0,60),T=w.getAttribute("type")||w.getAttribute("role")||"";return`${C}${A}${S}[${T}] txt="${x}"`});g.length>0&&(b=`
[DOM-INTERATIVO]:
${g.join(`
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let g=p.filter(E=>E.type==="checkbox"||E.type==="chk"),y=new Set(p.filter(E=>E.type==="radio").map(E=>E.name).filter(Boolean)),w=g.filter(E=>!E.name||!y.has(E.name)),C=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),A=w.length>=2||C,S=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&y.size>=1,x=p.every(E=>E.type==="radio"||E.type==="chk")&&y.size===1&&!A&&!S,T=p.filter(E=>E.type==="text"||E.type==="number"||E.type==="val"||E.tag==="input"||E.tag==="textarea"),M=T.length>=2;return(S?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
...
`;function Ut(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=qo,document.head.appendChild(o)}}catch{}}function Ee(){oe&&(oe.style.removeProperty("outline"),oe.style.removeProperty("outline-offset"),oe.style.removeProperty("position"),oe=null);for(let o of ve)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ve=[];for(let o of ut)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");ut=[];for(let o of pt)try{o.remove()}catch{}pt=[],ue&&typeof window<"u"&&(window.removeEventListener("scroll",ue),window.removeEventListener("resize",ue),ue=null);for(let o of mt)try{o.remove()}catch{}if(mt=[],ae){try{ae.remove()}catch{}ae=null}}function ht(o){Ut();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),ut.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,s=r.height||t.offsetHeight||200;if(n>10&&s>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(d),document.body.appendChild(i),pt.push(i),mt.push(d),e.push({element:t,frame:i})}}catch{}}e.length>0&&!ue&&typeof window<"u"&&(ue=()=>{for(let t of e)try{let a=t.element.getBoundingClientRect();a.width>0&&a.height>0&&(t.frame.style.top=`${a.top+window.scrollY-3}px`,t.frame.style.left=`${a.left+window.scrollX-3}px`,t.frame.style.width=`${a.width+6}px`,t.frame.style.height=`${a.height+6}px`)}catch{}},window.addEventListener("scroll",ue,{passive:!0}),window.addEventListener("resize",ue,{passive:!0}))}function gt(o){oe&&oe!==o&&(oe.style.removeProperty("outline"),oe.style.removeProperty("outline-offset")),Ut(),oe=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(ae){try{ae.remove()}catch{}ae=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let s=this.element.querySelector("#eq-fah-header");this.setupDraggable(s)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=i=>{if(!this.isDragging||!this.element)return;let d=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),b=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),b);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},s=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",s)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",s)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),s=r.actions.filter(m=>{if(m.t!=="val")return!1;let p=q(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=r.actions.filter(m=>m.t==="sel"),l=n.length||s.length||i.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let b=document.createElement("span");b.textContent=`Modo: ${r.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(b,c),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let p of n){let f=q(p.to)||"Geral";m[f]||(m[f]=[]),m[f].push(q(p.from))}for(let[p,f]of Object.entries(m)){let v=document.createElement("div"),h=/fato|true|verdadeiro|sim/i.test(p),g=/opini[aã]o|false|falso|n[aã]o/i.test(p);v.className=`eq-fah-group ${h?"group-fato":g?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${p} (${f.length})`,v.appendChild(y);let w=document.createElement("div");w.className="eq-fah-group-items";for(let C of f){let A=document.createElement("div");A.className="eq-fah-item";let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=C,A.appendChild(S);let x=document.createElement("button");x.className="eq-fah-copy-inline",x.textContent="Copiar",x.addEventListener("click",()=>{navigator.clipboard.writeText(C),x.textContent="\u2713 Copiado",setTimeout(()=>x.textContent="Copiar",1200)}),A.appendChild(x),w.appendChild(A)}v.appendChild(w),e.appendChild(v)}}else if(s.length>0){t.textContent=`Preenchimento (${s.length} campos)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let v=0;v<s.length;v++){let h=s[v],g=document.createElement("div");g.className="eq-fah-item";let y=ke(h.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${v+1}`);let w=String(h.v??""),C=document.createElement("div");C.className="eq-fah-field-box";let A=document.createElement("div");A.className="eq-fah-field-label",A.textContent=y,C.appendChild(A);let S=document.createElement("div");S.className="eq-fah-field-val",S.textContent=w,C.appendChild(S),g.appendChild(C);let x=document.createElement("button");x.className="eq-fah-copy-inline",x.textContent="Copiar",x.addEventListener("click",()=>{navigator.clipboard.writeText(w),x.textContent="\u2713 Copiado",setTimeout(()=>x.textContent="Copiar",1200)}),g.appendChild(x),f.appendChild(g)}m.appendChild(f),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let v=0;v<i.length;v++){let h=i[v],g=document.createElement("div");g.className="eq-fah-item";let y=ke(h.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&h.v&&(y=String(h.v)),y=q(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let w="",C=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);C?(w=C[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=C[2].trim()||y):i.length>1&&(w=String.fromCharCode(65+v));let A=document.createElement("div");if(A.style.display="flex",A.style.alignItems="center",A.style.gap="8px",A.style.flex="1",w){let T=document.createElement("span");T.className="eq-fah-letter-badge",T.textContent=w,A.appendChild(T)}let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=y||(w?`Alternativa ${w}`:"Alternativa Selecionada"),A.appendChild(S),g.appendChild(A);let x=document.createElement("button");x.className="eq-fah-copy-inline",x.textContent="Copiar",x.addEventListener("click",()=>{navigator.clipboard.writeText(y||w),x.textContent="\u2713 Copiado",setTimeout(()=>x.textContent="Copiar",1200)}),g.appendChild(x),f.appendChild(g)}m.appendChild(f),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,a.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let v=0;v<d.length;v++){let h=d[v],g=document.createElement("div");g.className="eq-fah-item";let y=ke(h.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${v+1}`);let A=(Array.isArray(h.v)?h.v:[String(h.v??"")]).map($=>{let E=I(h.id,void 0,!0)||I(q(h.id),void 0,!0),H=E instanceof HTMLSelectElement?E:E?.querySelector("select");if(H){let O=q($).toLowerCase();for(let _=0;_<H.options.length;_++){let N=H.options[_];if(N.value.toLowerCase()===O||q(N.textContent).toLowerCase()===O){let D=q(N.textContent);if(D&&!D.toLowerCase().includes("selecione"))return D}}}return $}).join(", "),S=document.createElement("div");S.className="eq-fah-field-box";let x=document.createElement("div");x.className="eq-fah-field-label",x.textContent=y,S.appendChild(x);let T=document.createElement("div");T.className="eq-fah-field-val",T.textContent=A,S.appendChild(T),g.appendChild(S);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(A),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),g.appendChild(M),f.appendChild(g)}m.appendChild(f),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(i=>i.t==="drag"),r=e.actions.filter(i=>i.t==="val"),n=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),s=e.actions.filter(i=>i.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let d of a){let l=q(d.to)||"Geral";i[l]||(i[l]=[]),i[l].push(q(d.from))}for(let[d,l]of Object.entries(i)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of r){let d=q(i.id);t.push(`- **${d||"Campo"}:** \`${i.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<n.length;i++){let d=n[i],l=ke(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=q(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=n.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(s.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of s){let d=q(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`;var Jt=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function Io(o,e){try{if(Jt){o.innerHTML=Jt.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var Ho=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],$o=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Ge=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new Ue({onStatusChange:(i,d,l)=>{this.logToConsole(d,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),d.includes("conclus\xE3o")||d.includes("finalizada")||d.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda com sucesso! Autopilot finalizado.","success"):this.setStatus("Autopilot desativado.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,d)=>{try{return await this.callbacks.onAnalyze(i,d,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Io(this.shadow,`
      ...
      <button class="eq-launcher" type="button" title="Abrir / Recolher EasyQuiz (Alt+Q)">
        <span class="eq-launcher-icon">${L.logo}</span>
        <span>EasyQuiz</span>
        ...
        <button class="eq-dock-toggle" id="eq-dock-toggle" type="button" title="Recolher / Expandir Painel (Alt+Q)">
          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                <span class="eq-brand-icon">${L.logo}</span>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-operation-actions">
                  <button class="eq-btn-primary" id="eq-analyze-btn" type="button">${L.analyze} Analisar quest\xE3o</button>
                  <button class="eq-btn-secondary" id="eq-apply-btn" type="button">${L.apply} Aplicar respostas</button>
                </div>

                <div style="display: flex; gap: 8px; width: 100%; align-items: center;">
                  <button class="eq-btn-primary" id="eq-ap-toggle-btn" type="button" style="flex: 1;">
                    ${L.play} INICIAR AUTOPILOT
                  </button>
                </div>
...
`)).then(()=>{if(this.metricsCopyBtn){let a=this.metricsCopyBtn.innerHTML;this.metricsCopyBtn.innerHTML="\u2713 Copiado!",setTimeout(()=>{this.metricsCopyBtn.innerHTML=a},1500)}})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Po(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function zo(){let o=window;if(Te(),Po(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=We(),t=null,a=null,r=0,n=new Ge(e,{onAnalyze:(l=1,u,b=!1)=>s(l,u,b),onApply:(l=1)=>void i(l),onDestroy:()=>{if(a){try{a.abort()}catch{}a=null}Ee(),delete o.__easyquiz},onCancel:()=>{if(a){try{a.abort()}catch{}a=null}Ee(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=Et(l)}});o.__easyquiz={toggle:()=>n.toggle(),destroy:()=>n.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q")){if(l.preventDefault(),!n)return;n.toggle(!0),s()}});async function s(l=1,u,b=!1){if(!e.apiKey){n.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),n.toggle(!0);return}if(a)try{a.abort()}catch{}a=new AbortController;let c=a,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){n.setBusy(!1),n.setProgress(0);return}r=Date.now(),n.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),n.setProgress(20,"Varrendo escopo do DOM e controles..."),Ee(),n.hideFloatingAnswers();try{let p=be(!1);p||(n.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ce()),gt(p.scope),n.updateContext(p),n.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),n.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),n.setProgress(40,`Consultando Gemini (${e.model})...`);let f=await vt(p.scope,e.useVision);if(f.length>0){let C=f.map(A=>A.element).filter(Boolean);ht(C),n.updateImages(f)}if(c.signal.aborted)return;let v=e.model;n.setStatus(f.length>0?`Consultando Gemini (${v}) com ${f.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${v}) via DOM nativo (modo r\xE1pido)...`,"info");let h=Ae(p,f,e);n.setInspectorPrompt(h,e.model);let g=(C,A)=>{n.setStatus(C,A==="warning"?"info":A);let S=C.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(S){let x=S[1].split(",")[0].trim();n.setProgress(50,`Gemini ${x} respondendo...`)}},{plan:y,usedModel:w}=await Oe(p,f,e,g,c.signal);if(c.signal.aborted)return;if(y.needsMoreContext){if(n.setProgress(55,"Ampliando escopo da quest\xE3o..."),n.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=be(!0),p||(p=ce()),gt(p.scope),n.updateContext(p),f=await vt(p.scope,e.useVision),f.length>0){let S=f.map(x=>x.element).filter(Boolean);ht(S),n.updateImages(f)}n.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let C=Ae(p,f,e);n.setInspectorPrompt(C,e.model),y=(await Oe(p,f,e,g,c.signal)).plan}if(c.signal.aborted)return;if(n.setProgress(70,"Resposta recebida da IA! Processando plano..."),n.logToConsole(`> [IA] Modelo: ${w||e.model} | Modo: ${y.mode} | Confian\xE7a: ${(y.confidence*100).toFixed(0)}%`,"text-green"),y.rationale&&n.logToConsole(`> [IA] Racioc\xEDnio: "${y.rationale}"`,"text-blue"),n.logToConsole(`> [IA] ${y.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),y.memoryToStore&&(qt(y.memoryToStore),n.logToConsole(`> [RAG] \u{1F9E0} Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${y.memoryToStore}"`,"text-yellow")),y.imageDescriptions&&y.imageDescriptions.length>0){n.logToConsole(`> [VISION] \u{1F5BC}\uFE0F An\xE1lise de ${y.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let C of y.imageDescriptions){let A=C.relevant?"\u2705":"\u26A0\uFE0F";n.logToConsole(`>   ${A} Imagem ${C.index+1} [${C.relevant?"RELEVANTE":"IGNORADA"}]: ${C.description}`,C.relevant?"text-blue":"text-yellow")}}return t=y,n.updateContext(p,y),Ft(y.actions,y.confidence),n.setPlan(y,!e.dryRun),y.pageType==="conclusion"?(n.setProgress(100,"Atividade conclu\xEDda!"),n.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):y.pageType==="info"?(n.setProgress(100,"Contexto absorvido na mem\xF3ria!"),n.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):y.pageType==="start"?(n.setProgress(100,"In\xEDcio detectado!"),n.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(n.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),n.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&y.pageType==="question"&&n.showFloatingAnswers(y),c.signal.aborted?void 0:((b||e.autoApply)&&!e.dryRun&&await i(l,c.signal,b),y)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){Ee(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}Ee(),n.setProgress(0);let f=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";n.setStatus(f,"error"),n.setErrorDiagnostic(f,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),a===c&&(a=null),c.signal.aborted||n.setBusy(!1)}}async function i(l=1,u,b=!1){if(u?.aborted)return;if(!t){n.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){n.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(v=>v.t!=="adv"),p=t.pageType==="question"||Be(t.rationale||"");if(p&&m.length===0){n.logToConsole("> [NAV] \u26D4 Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let f=(b||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);n.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),n.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),n.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let v=await Ie(t,f,l,fe(e));if(u?.aborted)return;if(n.setExecutionReport(v),v.failedActions&&v.failedActions.length>0){n.logToConsole(`> [REPLAN] \u26A0\uFE0F ${v.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let C of v.failedActions){let A=C.action,S=A.t==="drag"?`drag: "${A.from}" \u2192 "${A.to}"`:A.t==="clk"||A.t==="chk"?`${A.t}: "${A.id}"`:A.t==="val"?`val: "${A.id}" = "${A.v}"`:JSON.stringify(A).slice(0,80);n.logToConsole(`>   \u2717 [${A.t.toUpperCase()}] ${S} | ${C.evidence.slice(0,80)}`,"text-yellow")}await d(v.failedActions,u)}let h=r>0?Date.now()-r:1200,g=v.verified>0,y=v.applied>0;if(v.success||g&&y){n.setProgress(100,"Sucesso! Resposta preenchida."),n.logToConsole(`> [DOM] \u2713 ${v.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${v.verified} verificada(s) no DOM.`,"text-green"),v.advanced?n.logToConsole("> [NAV] \u2713 Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):f&&n.logToConsole(`> [NAV] ${v.navigationEvidence}`,"text-blue"),n.setStatus(v.advanced?`Sucesso: ${v.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${v.applied} a\xE7\xE3o(\xF5es)).`,"success"),n.hideFloatingAnswers();let C=Tt({id:`q-${Date.now()}`,questionIndex:(Ce().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:h,status:"answered",mode:t.mode,actionsCount:v.applied});n.updateTimingMetrics(C)}else y?(n.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),n.logToConsole(`> [DOM] \u26A0\uFE0F ${v.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${v.failed.join(", ")||"nenhuma"}`,"text-yellow"),n.setStatus(`Resposta preenchida (${v.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(n.setProgress(0,"Alvo de resposta n\xE3o localizado."),n.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${v.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),n.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&n.showFloatingAnswers(t))}catch(v){n.setProgress(0);let h=v instanceof Error?v.message:"Falha ao aplicar plano.";n.setStatus(`Erro ao aplicar: ${h}`,"error"),n.logToConsole(`> [ERRO] ${h}`,"text-red")}finally{n.setBusy(!1)}}async function d(l,u){if(!t)return;let b=l.filter(m=>m.action.t==="drag");for(let m of b){if(u?.aborted)return;let p=m.action,f=String(p.from||""),v=String(p.to||""),h=_t(f,v,f,v);n.logToConsole(`> [REPLAN] \u{1F527} Drag JS fallback: "${f}" \u2192 "${v}"`,"text-blue");let g={...t,actions:[{t:"js",v:h}],pageType:"question"},y=await Ie(g,!1,1,fe(e));n.logToConsole(y.applied>0?"> [REPLAN] \u2705 Drag fallback aplicado!":"> [REPLAN] \u2717 Drag fallback sem efeito.",y.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){n.logToConsole(`> [REPLAN] \u{1F504} ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,f=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);n.logToConsole(`> [REPLAN] \u26A1 Recuperando: ${f}`,"text-blue");let v=String(p.id||p.name||p.selector||""),h=p.v!==void 0?String(p.v):"";n.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await je(m.action),await new Promise(g=>setTimeout(g,250)),Z(m.action)){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 1 OK: ${f}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let g=I(v,h)||I(v.replace(/[^\w\s]/g," ").trim(),h);if(g&&(dt(g),await new Promise(y=>setTimeout(y,300)),Z(m.action))){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 2 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let g=I(v,h)||I(v.replace(/[^\w\s]/g," ").trim(),h);if(g&&(g.focus?.(),await new Promise(y=>setTimeout(y,50)),g.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),g.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80)),g.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),g.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200)),Z(m.action))){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 3 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){n.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let g=I(v,h)||I(v.replace(/[^\w\s]/g," ").trim(),h);if(g){let y=g.id,w=!!y;y||(y=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,g.id=y);let C=String(p.v??""),A=p.t==="val",S=document.createElement("script");if(S.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(S),S.remove(),w||setTimeout(()=>{try{g.id===y&&g.removeAttribute("id")}catch{}},0),await new Promise(x=>setTimeout(x,300)),Z(m.action)){n.logToConsole(`> [REPLAN] \u2705 Estrat\xE9gia 4 OK: ${f}`,"text-green");continue}}}catch{}}if(u?.aborted)return;n.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let g="";try{let E=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(H=>(H.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));E&&(g=E.outerHTML.slice(0,400))}catch{}let y=be(!1)||ce(),w=`A\xE7\xE3o (${p.t}) alvo="${v}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${g?`
HTML do alvo: ${g}`:""}`,C=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],A=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
