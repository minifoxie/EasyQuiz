 ...
 */
"use strict";(()=>{var se={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8};function W(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ye="easyquiz_settings_v2",Ae="easyquiz_activity_metrics";function Ze(){try{let o=localStorage.getItem(Ye);if(!o){let s=localStorage.getItem("easyquiz_settings_v1");if(s){let i=JSON.parse(s);return{...se,apiKey:i.apiKey||""}}return{...se}}let e=JSON.parse(o),t=typeof e.model=="string"&&W(e.model)?e.model:se.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(s=>typeof s=="string"?s.trim().replace(/^["']|["']$/g,""):"").filter(s=>s.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(a.length===0&&r&&(a=[r]),a.length===0)try{let s=localStorage.getItem("easyquiz_api_keys");if(s){let i=JSON.parse(s);Array.isArray(i)&&(a=i.filter(d=>typeof d=="string"&&d.trim().length>5))}}catch{}return{apiKey:a[0]||r||se.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:se.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:se.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:se.confidenceThreshold}}catch{return{...se}}}function Et(){try{localStorage.removeItem(Ye),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(Ae),sessionStorage.removeItem(Ae);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),et()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function $e(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function _e(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...$e(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function Ct(o){let e=Ze(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ye,JSON.stringify(r)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var ge=[],wt=12,_t=1200;function qt(o){let e=o.trim().replace(/\s+/g," ").slice(0,_t);e&&!ge.includes(e)&&(ge.push(e),ge.length>wt&&(ge=ge.slice(-wt)))}function Oe(){return ge}function et(){ge=[]}function Tt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Ee=Tt();function Ce(){try{localStorage.removeItem(Ae)}catch{}return Ee}function eo(o){Ee=o;try{let e=JSON.stringify(o);sessionStorage.setItem(Ae,e),localStorage.removeItem(Ae)}catch{}}function St(o){let e=Ee,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],s=n.filter(u=>u.status==="answered"||u.status==="verified").length,i=n.reduce((u,h)=>u+h.durationMs,0),d=s>0?Math.round(i/s):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),i),completedQuestionsCount:s,averageDurationMs:d,records:n};return eo(l),l}function qe(){Ee=Tt();try{sessionStorage.removeItem(Ae),localStorage.removeItem(Ae)}catch{}return Ee}var Lt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let b=p.filter(E=>E.type==="checkbox"||E.type==="chk"),y=new Set(p.filter(E=>E.type==="radio").map(E=>E.name).filter(Boolean)),v=b.filter(E=>!E.name||!y.has(E.name)),x=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),q=v.length>=2||x,T=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&y.size>=1,M=p.every(E=>E.type==="radio"||E.type==="chk")&&y.size===1&&!q&&!T,w=p.filter(E=>E.type==="text"||E.type==="number"||E.type==="val"||E.tag==="input"||E.tag==="textarea"),L=w.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
