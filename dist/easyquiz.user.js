...
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",p=n.controls.filter(x=>x.role!=="navigation"),m=n.controls.filter(x=>x.role==="navigation"),b=Ln(n.sourceUrl,n.htmlSnippet),v=b?`
${b}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let x=p.filter(q=>q.type==="checkbox"||q.type==="chk"),A=new Set(p.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),C=x.filter(q=>!q.name||!A.has(q.name)),y=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),w=C.length>=2||y,T=A.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&A.size>=1,k=p.every(q=>q.type==="radio"||q.type==="chk")&&A.size===1&&!w&&!T,E=p.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),z=E.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${A.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${A.size} afirma\xE7\xF5es \u2014 emita ${A.size} a\xE7\xF5es chk separadas + adv]
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function ro(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let t=document.createElement("link");t.rel="dns-prefetch",t.href="https://generativelanguage.googleapis.com",t.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(t)}catch{}}async function lo(){let n=window;if(Qe(),ro(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let t=bt(),e=null,o=null,s=0,a=new pt(t,{onAnalyze:(l=1,u,f=!1)=>r(l,u,f),onApply:(l=1)=>void i(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}Ce(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}Ce(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{t=Xt(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,f=!1){if(!t.apiKey&&(!Array.isArray(t.apiKeys)||t.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,h=()=>{try{d.abort()}catch{}};if(u&&(u.aborted?d.abort():u.addEventListener("abort",h,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}s=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),Ce(),a.hideFloatingAnswers();try{let p=Ae(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ve()),Je(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${t.model})...`);let m=await jt(p.scope,t.useVision);if(m.length>0){let y=m.map(w=>w.element).filter(Boolean);Bt(y),a.updateImages(m)}if(d.signal.aborted)return;let b=t.model;a.setStatus(m.length>0?`Consultando Gemini (${b}) com ${m.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let v=Fe(p,m,t);a.setInspectorPrompt(v,t.model);let x=(y,w)=>{a.setStatus(y,w==="warning"?"info":w);let T=y.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(T){let k=T[1].split(",")[0].trim();a.setProgress(50,`Gemini ${k} respondendo...`)}},{plan:A,usedModel:C}=await nt(p,m,t,x,d.signal);if(d.signal.aborted)return;if(A.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=Ae(!0),p||(p=ve()),Je(p.scope),a.updateContext(p),m=await jt(p.scope,t.useVision),m.length>0){let T=m.map(k=>k.element).filter(Boolean);Bt(T),a.updateImages(m)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let y=Fe(p,m,t);a.setInspectorPrompt(y,t.model),A=(await nt(p,m,t,x,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||t.model} | Modo: ${A.mode} | Confian\xE7a: ${(A.confidence*100).toFixed(0)}%`,"text-green"),A.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${A.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${A.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),A.memoryToStore&&(Vt(A.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${A.memoryToStore}"`,"text-yellow")),A.imageDescriptions&&A.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${A.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let y of A.imageDescriptions){let w=y.relevant?"":"\uFE0F";a.logToConsole(`>   ${w} Imagem ${y.index+1} [${y.relevant?"RELEVANTE":"IGNORADA"}]: ${y.description}`,y.relevant?"text-blue":"text-yellow")}}return e=A,a.updateContext(p,A),hn(A.actions,A.confidence),a.setPlan(A,!t.dryRun),A.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):A.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):A.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(t.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),t.dryRun&&A.pageType==="question"&&a.showFloatingAnswers(A),d.signal.aborted?void 0:((f||t.autoApply)&&!t.dryRun&&await i(l,d.signal,f),A)}catch(p){if(d.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){Ce(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}Ce(),a.setProgress(0);let m=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(m,"error"),a.setErrorDiagnostic(m,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",h),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function i(l=1,u,f=!1){if(u?.aborted)return;if(!e){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(t.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=e.pageType==="info"||e.pageType==="start",h=e.actions.filter(b=>b.t!=="adv"),p=e.pageType==="question"||it(e.rationale||"");if(p&&h.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let m=(f||t.autoAdvance||d)&&e.confidence>=t.confidenceThreshold&&!e.needsMoreContext&&(!p||h.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${e.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${e.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Ke(e,m,l,Ie(t));if(u?.aborted)return;if(a.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let y of b.failedActions){let w=y.action,T=w.t==="drag"?`drag: "${w.from}" \u2192 "${w.to}"`:w.t==="clk"||w.t==="chk"?`${w.t}: "${w.id}"`:w.t==="val"?`val: "${w.id}" = "${w.v}"`:JSON.stringify(w).slice(0,80);a.logToConsole(`>    [${w.t.toUpperCase()}] ${T} | ${y.evidence.slice(0,80)}`,"text-yellow")}await c(b.failedActions,u)}let v=s>0?Date.now()-s:1200,x=b.verified>0,A=b.applied>0;if(b.success||x&&A){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):m&&a.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),a.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let y=Kt({id:`q-${Date.now()}`,questionIndex:(je().records.length||0)+1,questionTitle:e.rationale?e.rationale.slice(0,45)+"...":`Quest\xE3o ${e.mode||"Auto"}`,durationMs:v,status:"answered",mode:e.mode,actionsCount:b.applied});a.updateTimingMetrics(y)}else A?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),t.dryRun&&a.showFloatingAnswers(e))}catch(b){a.setProgress(0);let v=b instanceof Error?b.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${v}`,"error"),a.logToConsole(`> [ERRO] ${v}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,u){if(!e)return;let f=l.filter(h=>h.action.t==="drag");for(let h of f){if(u?.aborted)return;let p=h.action,m=String(p.from||""),b=String(p.to||""),v=cn(m,b,m,b);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${m}" \u2192 "${b}"`,"text-blue");let x={...e,actions:[{t:"js",v}],pageType:"question"},A=await Ke(x,!1,1,Ie(t));a.logToConsole(A.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",A.applied>0?"text-green":"text-yellow")}let d=l.filter(h=>h.action.t!=="drag");if(d.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let h of d){if(u?.aborted)return;let p=h.action,m=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${m}`,"text-blue");let b=String(p.id||p.name||p.selector||""),v=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await ct(h.action),await new Promise(x=>setTimeout(x,250)),ue(h.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${m}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let x=R(b,v)||R(b.replace(/[^\w\s]/g," ").trim(),v);if(x&&(Pt(x),await new Promise(A=>setTimeout(A,300)),ue(h.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${m}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let x=R(b,v)||R(b.replace(/[^\w\s]/g," ").trim(),v);if(x&&(x.focus?.(),await new Promise(A=>setTimeout(A,50)),x.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),x.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,80)),x.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),x.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,200)),ue(h.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${m}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let x=R(b,v)||R(b.replace(/[^\w\s]/g," ").trim(),v);if(x){let A=x.id,C=!!A;A||(A=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,x.id=A);let y=String(p.v??""),w=p.t==="val",T=document.createElement("script");if(T.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(T),T.remove(),C||setTimeout(()=>{try{x.id===A&&x.removeAttribute("id")}catch{}},0),await new Promise(k=>setTimeout(k,300)),ue(h.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${m}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let x="";try{let q=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(I=>(I.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));q&&(x=q.outerHTML.slice(0,400))}catch{}let A=Ae(!1)||ve(),C=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${h.evidence.slice(0,80)}"${x?`
