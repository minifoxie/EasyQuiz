...
[MEM\xD3RIA]:
${s.join(" | ")}
`:"",c=o.controls.filter(m=>m.role!=="navigation"),p=o.controls.filter(m=>m.role==="navigation"),h=Ut(o.sourceUrl,o.htmlSnippet),u=h?`
${h}
`:"";return`--- AN\xC1LISE ---
