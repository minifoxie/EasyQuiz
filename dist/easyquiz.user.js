...
/* EasyQuiz v3.7.3 (d20e4af) — Resolução inteligente de quizzes sem servidor
 * GitHub: https://github.com/minifoxie/EasyQuiz
 * 100% Client-side. Direct Google Gemini REST API.
 */
"use strict";(()=>{var te={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0,theme:"mega-black",panelOpacity:.65,borderRadius:"none",glowEffects:!1,highlightColor:"#ffd600",languageHint:"auto",maxRetries:2,showTokenUsage:!0,autoScrollLogs:!0,compactMode:!1,enableSoundFeedback:!1};function de(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let n of t)if(e.includes(n))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Tt="easyquiz_settings_v2",He="easyquiz_activity_metrics";function St(){try{let o=localStorage.getItem(Tt);if(!o){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let s=JSON.parse(r);return{...te,apiKey:s.apiKey||""}}return{...te}}let e=JSON.parse(o),t=typeof e.model=="string"&&de(e.model)?e.model:te.model,n=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(n.length===0&&i&&(n=[i]),n.length===0)try{let r=localStorage.getItem("easyquiz_api_keys");if(r){let s=JSON.parse(r);Array.isArray(s)&&(n=s.filter(d=>typeof d=="string"&&d.trim().length>5))}}catch{}return{apiKey:n[0]||i||te.apiKey,apiKeys:n,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:te.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:te.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:te.confidenceThreshold,toastStacking:e.toastStacking!==void 0?!!e.toastStacking:te.toastStacking,theme:["mega-black","dark","purple-neon","gray-blue","light"].includes(e.theme)?e.theme:te.theme,panelOpacity:typeof e.panelOpacity=="number"?e.panelOpacity:te.panelOpacity,borderRadius:["none","soft","rounded"].includes(e.borderRadius)?e.borderRadius:te.borderRadius,glowEffects:e.glowEffects!==void 0?!!e.glowEffects:te.glowEffects,highlightColor:typeof e.highlightColor=="string"?e.highlightColor:te.highlightColor,languageHint:typeof e.languageHint=="string"?e.languageHint:te.languageHint,maxRetries:typeof e.maxRetries=="number"?e.maxRetries:te.maxRetries,showTokenUsage:e.showTokenUsage!==void 0?!!e.showTokenUsage:te.showTokenUsage,autoScrollLogs:e.autoScrollLogs!==void 0?!!e.autoScrollLogs:te.autoScrollLogs,compactMode:e.compactMode!==void 0?!!e.compactMode:te.compactMode,enableSoundFeedback:e.enableSoundFeedback!==void 0?!!e.enableSoundFeedback:te.enableSoundFeedback}}catch{return{...te}}}function $t(){try{localStorage.removeItem(Tt),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(He),sessionStorage.removeItem(He);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),nt()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function Lt(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Mt(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let n={...Lt(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(n))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function Zt(o){let e=St(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,n;typeof o.apiKey=="string"?n=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?n=t[0]||"":n=e.apiKey,n&&!t.includes(n)&&(t=[n,...t]),t.length>0&&(!n||!t.includes(n))&&(n=t[0]);let i={...e,...o,apiKey:n,apiKeys:t};try{localStorage.setItem(Tt,JSON.stringify(i)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var Ie=[],Yt=12,No=1200;function _t(o){let e=o.trim().replace(/\s+/g," ").slice(0,No);e&&!Ie.includes(e)&&(Ie.push(e),Ie.length>Yt&&(Ie=Ie.slice(-Yt)))}function ot(){return Ie}function nt(){Ie=[]}function eo(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Fe=eo();function Ue(){try{localStorage.removeItem(He)}catch{}return Fe}function jo(o){Fe=o;try{let e=JSON.stringify(o);sessionStorage.setItem(He,e),localStorage.removeItem(He)}catch{}}function to(o){let e=Fe,t=Date.now(),n=e.records[e.records.length-1];if(n&&n.id===o.id&&t-n.timestamp<3e3)return e;let i={...o,timestamp:t},a=[...e.records,i],r=a.filter(u=>u.status==="answered"||u.status==="verified").length,s=a.reduce((u,h)=>u+h.durationMs,0),d=r>0?Math.round(s/r):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:r,averageDurationMs:d,records:a};return jo(l),l}function Xe(){Fe=eo();try{sessionStorage.removeItem(He),localStorage.removeItem(He)}catch{}return Fe}var oo=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
[MEM\xD3RIA]:
${c.join(" | ")}
`:"",p=o.controls.filter(x=>x.role!=="navigation"),f=o.controls.filter(x=>x.role==="navigation"),b=Qo(o.sourceUrl,o.htmlSnippet),v=b?`
${b}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let x=p.filter(T=>T.type==="checkbox"||T.type==="chk"),A=new Set(p.filter(T=>T.type==="radio").map(T=>T.name).filter(Boolean)),C=x.filter(T=>!T.name||!A.has(T.name)),y=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),w=C.length>=2||y,q=A.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&A.size>=1,k=p.every(T=>T.type==="radio"||T.type==="chk")&&A.size===1&&!w&&!q,E=p.filter(T=>T.type==="text"||T.type==="number"||T.type==="val"||T.tag==="input"||T.tag==="textarea"),M=E.length>=2;return(q?`[GRADE VERDADEIRO/FALSO (${A.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${A.size} afirma\xE7\xF5es \u2014 emita ${A.size} a\xE7\xF5es chk separadas + adv]
`:w?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:k?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:M?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${E.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${E.length} campos abaixo com seu id exato]
`:"")+JSON.stringify(p.map(T=>({id:T.id,t:T.type,n:T.name||void 0,txt:T.label?T.label.length>160?T.label.slice(0,160)+"...":T.label:void 0,v:T.value||void 0,opt:T.options&&T.options.length?T.options.slice(0,20).map(z=>z.label||z.value):void 0})))})()}
...
${d}`:"");return J(u,e)}function rn(o){let e=[];function t(n){let i=n.tagName?.toLowerCase();if(i==="mfrac"){let a=Array.from(n.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`(${r}/${s})`);return}if(i==="msqrt"){e.push(`sqrt(${n.textContent?.trim()||"?"})`);return}if(i==="msup"){let a=Array.from(n.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`${r}^{${s}}`);return}if(i==="msub"){let a=Array.from(n.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`${r}_{${s}}`);return}if(i==="mn"||i==="mi"||i==="mo"||i==="mtext"){e.push(n.textContent?.trim()||"");return}for(let a of Array.from(n.children))t(a)}return t(o),e.join(" ")}function fo(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&R(t))return t;let n=0;for(;e.parentElement&&e.parentElement!==document.body&&n<3;)e=e.parentElement,n++;return e||document.body}var ut=new Map,ln=3e4,bo=8;function cn(){let o=window.location.href,e=ut.get(o);return e?Date.now()-e.timestamp>ln?(ut.delete(o),null):e.selector:null}function Je(o){try{if(ct(o)<bo)return;let e=o.tagName.toLowerCase(),t=o.id?`#${o.id}`:"",n=o.dataset.easyquizId?`[data-easyquiz-id="${o.dataset.easyquizId}"]`:"",i=Array.from(o.classList).slice(0,3).map(r=>`.${r}`).join(""),a=`${e}${t}${n}${i}`;a&&a!=="body"&&a!=="html"&&ut.set(window.location.href,{selector:a,timestamp:Date.now()})}catch{}}function ce(){let o=cn();if(o){try{let s=document.querySelector(o);if(s&&R(s)&&!we(s)&&ct(s)>=bo)return Re(s)}catch{}ut.delete(window.location.href)}let e=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(e&&R(e))return Je(e),e;if(Be()){let d=Array.from(document.querySelectorAll(".perseus-renderer, .framework-perseus")).filter(l=>{if(!R(l)||we(l))return!1;let u=l.getBoundingClientRect();return u.width>100&&u.height>50&&u.bottom>0&&u.top<window.innerHeight});if(d.length>0){d.sort((u,h)=>{let c=u.getBoundingClientRect(),m=h.getBoundingClientRect();return m.width*m.height-c.width*c.height});let l=Re(d[0]);return Je(l),l}}let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(go);if(s&&!we(s)&&ct(s)>0){let d=Re(s);return Je(d),d}}let i=Array.from(document.querySelectorAll(go)).filter(s=>!we(s)).map(s=>({element:s,score:ct(s)})).filter(s=>Number.isFinite(s.score)).sort((s,d)=>d.score-s.score),a=i.find(s=>{let d=s.element.tagName.toLowerCase();return d!=="main"&&d!=="body"&&s.score>0});if(a){let s=Re(a.element);return Je(s),s}if(i.length>0&&i[0].score>0){let s=Re(i[0].element);return Je(s),s}let r=document.querySelector('form, main, [role="main"]');return r&&R(r)?r:document.body}function vo(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(n=>n.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(n=>{for(let i of Array.from(n.attributes))t.includes(i.name)||n.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function dt(o){let e=Array.from(o.querySelectorAll(De)),t=new Set,n=[],i=Be();for(let u of e){if(!R(u)||le(u)||Y(u)||i&&we(u))continue;let h=(u.value||u.textContent||"").trim();if(Ae.test(h))continue;let c=u.tagName.toLowerCase();["input","textarea","select"].includes(c)&&(t.add(u),n.push(u))}for(let u of e){if(!R(u)||le(u)||Y(u)||i&&we(u))continue;let h=(u.value||u.textContent||"").trim();if(Ae.test(h))continue;let c=u.tagName.toLowerCase();if(["input","textarea","select"].includes(c))continue;let m=u.querySelector("input, textarea, select");if(!(m&&t.has(m))){if(u.hasAttribute("for")){let p=u.getAttribute("for"),f=p?u.ownerDocument.getElementById(p):null;if(f&&t.has(f))continue}if(c==="a"){let p=u.getAttribute("role"),f=u.getAttribute("class")||"",b=u.getAttribute("data-testid")||"",v=u.getAttribute("draggable")==="true"||u.classList.contains("perseus-drag-item")||u.classList.contains("sortable-item")||f.includes("cursor-grab")||!!u.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(b)||/drag|card-item|sortable/i.test(f);if(!(p==="button"||p==="radio"||p==="checkbox"||p==="option"||v||u.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}n.push(u)}}let a=n.length>0&&n.every(u=>Y(u)||/read-?aloud|audio/i.test(u.getAttribute("data-testid")||u.getAttribute("aria-label")||"")),r=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,s=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((n.length===0||a)&&s){a&&(n.length=0);let u=Array.from(r.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(u.length>0){for(let h of u)if(!(!R(h)||Y(h))&&(n.push(h),n.length>=50))break}else{let h=Array.from(r.querySelectorAll("button, div[class], span[class], p, li"));for(let c of h){if(!R(c)||le(c)||Y(c)||Ae.test((c.textContent||"").trim()))continue;let m=(c.textContent||"").trim();if(m.length<2||m.length>300)continue;if(Array.from(c.children).some(f=>f.className&&f.textContent?.trim())||n.push(c),n.length>=50)break}}}let d=n.some(u=>["input","select","textarea"].includes(u.tagName.toLowerCase())),l=!d&&n.length>0&&n.every(u=>{let h=u.tagName.toLowerCase();if(["input","select","textarea","button"].includes(h))return!1;let c=(u.textContent||"").trim();return!u.id||c.length<10||/^\d+\s*\/\s*\d+$/.test(c)||/^question text/i.test(c)});if(n.length===0||l){l&&(n.length=0);let u=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(u.length>0)for(let h of u){if(!R(h)||pe(h)||le(h)||Y(h)||Ae.test((h.textContent||"").trim()))continue;let c=(h.textContent||"").trim();if(!(c.length<10||c.length>500)&&!/^\d+\s*\/\s*\d+$/.test(c)&&(n.push(h),n.length>=20))break}}if(n.length===0||n.length>0&&!d&&!n.some(u=>u.getAttribute("role")==="radio"||u.getAttribute("role")==="checkbox"||u.classList.contains("mq-editable-field")||u.closest(".perseus-widget-container"))){let h=document.querySelector(".perseus-renderer, .framework-perseus")||o,c=Array.from(h.querySelectorAll('.mq-editable-field, .mq-root-block, [class*="expression-editor" i], [class*="math-input" i]'));for(let v of c)!R(v)||pe(v)||n.includes(v)||n.push(v);let m=Array.from(h.querySelectorAll('[class*="perseus-dropdown" i], .perseus-widget-container select, .perseus-widget-container [role="combobox"], .perseus-widget-container [role="listbox"]'));for(let v of m)!R(v)||pe(v)||n.includes(v)||n.push(v);let p=Array.from(h.querySelectorAll('[class*="perseus-radio" i] [role="radio"], .perseus-widget-container [role="radio"], .perseus-widget-container [role="checkbox"]'));for(let v of p)!R(v)||pe(v)||v.querySelector('input[type="radio"], input[type="checkbox"]')||n.includes(v)||n.push(v);let f=Array.from(h.querySelectorAll('.perseus-widget-container [role="button"], .number-line [role="slider"], [class*="interactive-graph" i] [role="button"]'));for(let v of f)!R(v)||pe(v)||le(v)||n.includes(v)||n.push(v);let b=Array.from(h.querySelectorAll('.perseus-widget-container input:not([type="hidden"]), .perseus-widget-container textarea, .perseus-widget-container select'));for(let v of b)!R(v)||pe(v)||t.has(v)||n.includes(v)||n.push(v)}return n.slice(0,100).map(u=>Nt(u,"answer"))}function jt(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,n=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(De)))if(!(t.has(a)||!R(a)||!le(a)||Y(a))&&(t.add(a),n.push(Nt(a,"navigation")),n.length>=10))return n;return n}function Ce(o=!1){let e=ce();e=Re(e),o&&(e=fo(e));let t=dt(e),n=jt(e);if(t.length===0){let s=dt(document.body);s.length>0&&(e=fo(e),t=dt(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}n.length===0&&(n=jt(document.body));let i=e.querySelector(".katex, math, .mq-root-block, .mq-editable-field"),a;if(i)a=sn(e,16e3);else{let s=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"";a=s.length>4e4?J(s.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+J(s.slice(-2e3),2e3):J(s,16e3)}let r=[...t,...n].slice(0,120);return!a||r.length===0&&a.length<30?J(document.body.innerText||document.body.textContent||"",16e3).length>=30?Ee():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:vo(e),controls:r,scope:e}}function Ee(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=J(o,16e3),t=dt(document.body),n=jt(document.body),i=[...t,...n].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:vo(a).slice(0,15e3),controls:i,scope:a}}function Qt(o){let e=o.controls.map(t=>{let n=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${n}`}).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function pt(o){if(!o)return!1;let e=o.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(n=>e.includes(n))}function K(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function P(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function ie(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let n=o.getAttribute("for");if(n){let i=o.ownerDocument.getElementById(n);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let n=e.getAttribute("for"),a=(n?e.ownerDocument.getElementById(n):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let n=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(n)return ie(n)}return o}function yo(o){let e=o;if(!e||!document.contains(e))try{e=ce()}catch{}e=e||document.body;let t=i=>{let a=Array.from(i.querySelectorAll("tr")).filter(u=>R(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let r=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>R(u)&&!K(u));if(r.length>0)return r;let d=Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>R(u)&&!K(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return d.length>0?d:Array.from(i.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let h=u;return R(h)&&!K(h)&&(h.textContent||"").trim().length>2&&!le(h)&&!Y(h)&&!h.querySelector("[class]")})},n=t(e);return n.length>0?n:e!==document.body?t(document.body):[]}function N(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=Z(i),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!K(r))return ie(r);try{let c=document.getElementById(i);if(c&&R(c)&&!K(c))return c.hasAttribute("data-category")||c.hasAttribute("data-dropzone")||c.classList.contains("dnd-zone")?c:ie(c)}catch{}try{let c=document.querySelector(`[data-item-id="${a}"]`);if(c&&R(c)&&!K(c))return ie(c)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let c=parseInt(s[1],10);if(t){let p=document.body;try{p=ce()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>R(b)&&!K(b));if(c>=1&&c-1<f.length)return f[c-1];if(c===0&&f.length>0)return f[0]}let m=c-1;if(m>=0){let p=yo();if(m<p.length){let v=p[m];if(v.tagName.toLowerCase()==="tr"){if(e){let A=v.querySelector(`input[value="${Z(e)}" i], [data-value="${Z(e)}" i]`);if(A)return A}let x=v.querySelector("input");if(x)return x}return ie(v)}let f=document.body;try{f=ce()||document.body}catch{}let b=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>R(v)&&!K(v));if(m<b.length)return b[m]}}let d=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(d){let c=d[1].toUpperCase(),m=c.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${c}" i], input[type="checkbox"][value="${c}" i]`)).find(b=>R(b)&&!K(b));if(p)return ie(p);let f=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(b=>{if(!R(b)||K(b))return!1;let x=(b.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(x===c||x===`${c})`||x===`(${c})`||x===`${c}.`||x===`${c}:`)return!0;let A=(b.textContent||"").trim().toUpperCase();return A.startsWith(`${c})`)||A.startsWith(`(${c})`)||A.startsWith(`${c}.`)||A.startsWith(`${c}:`)});if(f)return ie(f);if(m>=0){let b=yo();if(m<b.length){let v=b[m];if(v.tagName.toLowerCase()==="tr"){if(e){let A=v.querySelector(`input[value="${Z(e)}" i], [data-value="${Z(e)}" i]`);if(A)return A}let x=v.querySelector("input");if(x)return x}return ie(v)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let m=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(v=>R(v)&&!K(v));if(m)return m;let f=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(v=>R(v)&&!K(v));if(f)return ie(f);let b=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(v=>{if(!R(v)||K(v))return!1;let x=P(v.textContent).toLowerCase();return x===i.toLowerCase()||x===i.toLowerCase()+")"});if(b)return ie(b)}try{let c=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let p=c.find(f=>{if(!R(f)||K(f))return!1;if(f instanceof HTMLInputElement&&f.value.toLowerCase()===e.toLowerCase())return!0;let b=f.closest("label, .vf-label, td, div");return b&&P(b.textContent).toLowerCase().includes(P(e).toLowerCase())});if(p)return ie(p)}let m=c.find(p=>R(p)&&!K(p));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:ie(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let m=Array.from(document.querySelectorAll(i)).find(p=>R(p)&&!K(p));if(m)return ie(m)}catch{}try{let c=i.replace(/"/g,""),m=`//button[normalize-space(.)="${c}"] | //a[normalize-space(.)="${c}"] | //*[not(*) and normalize-space(.)="${c}"] | //*[@aria-label="${c}"] | //*[@data-category="${c}"] | //*[@data-testid="${c}"]`,p=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let f=0;f<p.snapshotLength;f++){let b=p.snapshotItem(f);if(b&&R(b)&&!K(b)){if(["body","html"].includes(b.tagName.toLowerCase())){let x=b.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(x&&R(x))return ie(x)}return b.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ie(b)}}}catch{}let u=P(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let c of h){if(!R(c)||K(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=P(c.textContent).toLowerCase(),f=P(c.getAttribute("aria-label")||"").toLowerCase(),b=P(c.getAttribute("placeholder")||"").toLowerCase(),v=P(c.getAttribute("title")||"").toLowerCase(),x=P(c.getAttribute("name")||"").toLowerCase(),A=P(c.getAttribute("data-category")||"").toLowerCase(),C=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"",y=P(C).toLowerCase(),w=p.startsWith(u+")")||p.startsWith(u+".")||p.startsWith(u+" -")||p.startsWith(u+":");if(p===u||f===u||b===u||v===u||x===u||A&&A===u||y&&y===u||w)return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ie(c)}if(u.length>=3)for(let c of h){if(!R(c)||K(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=P(c.textContent).toLowerCase(),f=P(c.getAttribute("aria-label")||"").toLowerCase(),b=P(c.getAttribute("placeholder")||"").toLowerCase(),v=P(c.getAttribute("title")||"").toLowerCase(),x=P(c.getAttribute("name")||"").toLowerCase();if(p.includes(u)||f.includes(u)||b.includes(u)||v.includes(u)||x.includes(u)){if(Array.from(c.children).some(w=>{let q=P(w.textContent).toLowerCase();return q&&q.includes(u)}))continue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ie(c)}let A=u.split(/\s+/).filter(Boolean);if(A.length>=3){let C=A.slice(0,Math.min(5,A.length)).join(" ");if(p.includes(C)||f.includes(C)||b.includes(C))return ie(c)}}return null}function xo(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function se(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),n=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),i=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:i};try{o.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}if(typeof o.click=="function")try{o.click()}catch{try{o.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{o.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let r=Object.keys(o).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(r){let s=o[r];for(;s;){let d=s.memoizedProps||s.pendingProps;if(d?.onClick){d.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let r=Object.keys(o).find(s=>s.startsWith("__reactProps"));if(r){let s=o[r];s?.onClick&&s.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let r=o._vei;r?.onClick&&(Array.isArray(r.onClick.value)?r.onClick.value:[r.onClick.value]).forEach(d=>{try{d({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=o.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let d=o.closest("[jsaction]");if(d&&d!==o)try{d.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:n,clientY:i}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function Xt(o){try{let e=o.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,o.id=e);let n=document.createElement("script");return n.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(n),n.remove(),t||setTimeout(()=>{try{o.id===e&&o.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function ht(o,e){let t=o;if(t.hasAttribute("for")){let h=t.getAttribute("for"),c=t.ownerDocument.getElementById(h);c&&(t=c)}let n=t.classList?.contains("mq-editable-field")||t.classList?.contains("mq-root-block")?t:t.querySelector(".mq-editable-field, .mq-root-block");if(n)try{let h=n.__mathquill||n.mathquill;if(h&&typeof h.latex=="function"){h.latex(e),n.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),n.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));return}let c=window.MathQuill?.getInterface?.(2)||window.MathQuill?.getInterface?.(1);if(c){let m=c(n);if(m&&typeof m.latex=="function"){m.latex(e),n.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}));return}}n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:"a",code:"KeyA",ctrlKey:!0,bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keydown",{key:"Backspace",code:"Backspace",bubbles:!0}));for(let m of e)n.dispatchEvent(new KeyboardEvent("keydown",{key:m,code:`Key${m.toUpperCase()}`,bubbles:!0,cancelable:!0})),n.dispatchEvent(new KeyboardEvent("keypress",{key:m,code:`Key${m.toUpperCase()}`,bubbles:!0,cancelable:!0})),n.dispatchEvent(new InputEvent("input",{data:m,inputType:"insertText",bubbles:!0,cancelable:!0,composed:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:m,code:`Key${m.toUpperCase()}`,bubbles:!0,cancelable:!0}));n.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));return}catch(h){console.warn("[EasyQuiz] MathQuill fill falhou, continuando com fallback padr\xE3o:",h)}let i=t.matches?.('[class*="perseus-dropdown" i], [class*="perseus"] [role="combobox"]')?t:t.querySelector('[class*="perseus-dropdown" i], [class*="perseus"] [role="combobox"]');if(i)try{se(i),setTimeout(()=>{let h=e.trim().toLowerCase(),c=Array.from(document.querySelectorAll('[role="option"], [role="listbox"] [role="option"], [class*="dropdown"] [role="option"], [class*="perseus"] [class*="option"], .dropdown-option, [class*="select-option"]')).filter(m=>{let p=m;if(!R(p)||K(p))return!1;let f=(p.textContent||"").trim().toLowerCase(),b=p.getAttribute("data-value")?.toLowerCase()||"";return f===h||b===h||f.includes(h)||h.length>2&&h.includes(f)});c.length>0&&se(c[0])},250);return}catch(h){console.warn("[EasyQuiz] Perseus dropdown fill falhou:",h)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){mt(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){mt(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let h=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let m=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(m)t=m;else{let p=t.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){t=p;break}let f=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f){t=f;break}p=p.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let h=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{let c=document.body;try{c=ce()||document.body}catch{}let m=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m)t=m;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let h=document.body;try{h=ce()||document.body}catch{}let c=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let h=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;qe(t,h);return}let d=String(e??""),l=d;if(t instanceof HTMLInputElement&&t.type==="number"){let h=d.replace(",",".").replace(/[^0-9.-]/g,"");h&&!isNaN(Number(h))&&(l=h)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let h=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,c=Object.getOwnPropertyDescriptor(h,"value")?.set;c?c.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let u=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(u=document.execCommand?.("insertText",!1,l)||!1):t.isContentEditable&&(u=document.execCommand?.("insertText",!1,l)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let m=t._valueTracker;m&&m.setValue(l===""?" ":"")}catch{}let h=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,c=Object.getOwnPropertyDescriptor(h,"value")?.set;c?c.call(t,l):t.value=l;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:l.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:l.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==l&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(l))){t.value=l;try{c?.call(t,l)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==l.trim()){t.textContent=l;try{t.innerText=l}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=l),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Ye(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let n=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=P(t),a=N(t)||N(i);if(!a)return n?e:i||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let h=P(r.textContent);if(h&&h.length>0&&h.length<150)return h}if(a.id){let h=document.querySelector(`label[for="${Z(a.id)}"]`);if(h){let c=P(h.textContent);if(c&&c.length>0&&c.length<150)return c}}let s=a.getAttribute("aria-label");if(s)return P(s);let d=a.getAttribute("placeholder");if(d)return P(d);let l=P(a.textContent);if(l&&l.length>0&&l.length<120)return l;let u=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return u?P(u):n?e:i||e}function qe(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,n=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!n&&t.hasAttribute("for")&&(n=t.ownerDocument.getElementById(t.getAttribute("for")));let i=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&R(t)?t:o;if(n){let a=n.type==="radio",r=n.type==="checkbox",s=!!n._valueTracker;if(n.checked===e){if(a&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(r){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(i&&i!==n&&se(i),n.checked!==e)try{n.focus?.(),n.click()}catch{}if(n.checked!==e){try{let l=n._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(n,e)}catch{}n.checked=e,xo(n,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;se(i),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function mt(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let r=e.map(l=>P(l).toLowerCase()),s=!1,d=(l,u)=>{l.selected=!0,t.selectedIndex=u;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(l.value)}catch{}s=!0};for(let l=0;l<t.options.length;l++){let u=t.options[l],h=u.value.toLowerCase(),c=P(u.textContent).toLowerCase();if(r.some(p=>p===h||p===c)){if(d(u,l),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!s)for(let l of r){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let h=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(m>=0&&m<t.options.length&&(d(t.options[m],m),!t.multiple))break}}if(!s){for(let l of r)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,c=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(c>=0&&c<t.options.length&&(d(t.options[c],c),!t.multiple))break}}if(!s){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let h=t.options[u],c=l(h.value.toLowerCase()),m=l(P(h.textContent).toLowerCase());if(r.some(f=>{let b=l(f);return c.includes(b)||m.includes(b)||b.length>2&&(b.includes(c)||b.includes(m))})&&(d(h,u),!t.multiple))break}}if(s){xo(t,["focus","input","change","blur"]);return}}let n=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');n&&se(n);let i=e.map(r=>P(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>R(r)&&!K(r));for(let r of i){let s=a.find(l=>{let u=P(l.textContent).toLowerCase(),h=P(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===r||h===r||u.includes(r)||r.length>2&&r.includes(u)});if(s){se(s);let l=s.querySelector('input[type="radio"], input[type="checkbox"]');l&&qe(l,!0);return}let d=N(r);if(d){se(d);return}}}function dn(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Ft(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function un(o,e,t){try{if(e.contains(o))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(o))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let n=e.children.length;if(t!==void 0&&n>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${n}`};if([o.getAttribute("data-placed")==="true",o.getAttribute("data-assigned")==="true",o.getAttribute("data-matched")==="true",o.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(o.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(o.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(d=>d!==e&&(d.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:o.getAttribute("aria-hidden")==="true"||o.style.display==="none"||o.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function ge(o,e){let t=P(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let s=document.getElementById(o.trim());if(s&&R(s)&&!K(s))return s}let r=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of r){let l=Array.from(document.querySelectorAll(s)).find(u=>{if(!R(u)||K(u))return!1;let h=P(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return h===t||h.includes(t)||u.id===o.trim()});if(l)return l}return null}let n=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),i=Array.from(document.querySelectorAll(n)),a=i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return a&&R(a)&&!K(a)?a:i.find(r=>{if(!R(r)||K(r)||/unclassified/i.test(r.className))return!1;let s=r.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),d=P(s?.textContent||r.textContent||"").toLowerCase();return d.includes("op")&&(d.includes("es")||d.includes("\xF5es"))?!1:d===t||d.startsWith(t)||d.includes(t)})||null}async function gt(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let n=o.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(n.left+Math.max(1,n.width/2)),r=Math.round(n.top+Math.max(1,n.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),d=Math.round(i.top+Math.max(1,i.height/2)),l=P(e.textContent).toLowerCase();if(l){let f=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let v=P(b.textContent).toLowerCase(),x=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?P(b.value).toLowerCase():"";return v&&(l.includes(v)||v.includes(l))||x&&(l.includes(x)||x.includes(l))});f&&(se(f),await new Promise(b=>setTimeout(b,120)))}Ft(o),await new Promise(p=>setTimeout(p,140)),Ft(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&Ft(u),await new Promise(p=>setTimeout(p,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",h));let c=4;for(let p=1;p<=c;p++){let f=Math.round(a+(s-a)*(p/c)),b=Math.round(r+(d-r)*(p/c)),v={...h,clientX:f,clientY:b,screenX:f,screenY:b};try{o.dispatchEvent(new PointerEvent("pointermove",{...v,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",v))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:d,screenX:s,screenY:d,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let p=dn(J(o.textContent),o.outerHTML),f={...h},b={...m};p&&(f.dataTransfer=p,b.dataTransfer=p);let v=o.ownerDocument.defaultView?.DragEvent;if(!v)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new v("dragstart",f)),e.dispatchEvent(new v("dragenter",b)),e.dispatchEvent(new v("dragover",b)),e.dispatchEvent(new v("drop",b)),o.dispatchEvent(new v("dragend",f))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:o,clientX:a,clientY:r}),f=new Touch({identifier:1,target:e,clientX:s,clientY:d});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(o))try{let p=v=>{let x=Object.keys(v).find(C=>C.startsWith("__reactFiber")||C.startsWith("__reactInternalInstance"));if(!x)return null;let A=v[x];for(let C=0;C<10&&A;C++){if(A.memoizedProps)return A.memoizedProps;A=A.return}return null},f=p(o),b=p(e);if(f){let v=f.onMouseDown||f.onPointerDown||f.onDragStart;if(typeof v=="function")try{v({type:"mousedown",button:0,buttons:1,clientX:a,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:o,target:o}),await new Promise(x=>setTimeout(x,100))}catch{}}if(b){let v=b.onMouseUp||b.onPointerUp||b.onDrop;if(typeof v=="function")try{v({type:"mouseup",button:0,buttons:0,clientX:s,clientY:d,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200));let v=d>r?"ArrowDown":"ArrowUp";for(let x=0;x<3;x++)document.dispatchEvent(new KeyboardEvent("keydown",{key:v,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80))}catch{}try{document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(o.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:o.id||o.getAttribute("data-id")}})),await new Promise(x=>setTimeout(x,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}if(!e.contains(o))try{let p=o.closest("[data-rbd-draggable-id]"),f=e.closest("[data-rbd-droppable-id]");if(p&&f){let b=p.getBoundingClientRect(),v=f.getBoundingClientRect(),x=b.left+b.width/2,A=b.top+b.height/2,C=v.left+v.width/2,y=v.top+v.height/2,w=(k,E,M,H)=>new PointerEvent(k,{bubbles:!0,cancelable:!0,composed:!0,clientX:E,clientY:M,screenX:E,screenY:M,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:k==="pointerup"?0:.5,...H});p.dispatchEvent(w("pointerdown",x,A)),await new Promise(k=>setTimeout(k,80));let q=8;for(let k=1;k<=q;k++){let E=x+(C-x)*(k/q),M=A+(y-A)*(k/q);window.dispatchEvent(w("pointermove",E,M)),document.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:E,clientY:M})),await new Promise(H=>setTimeout(H,20))}f.dispatchEvent(w("pointerup",C,y,{pressure:0})),f.dispatchEvent(new MouseEvent("mouseup",{bubbles:!0,clientX:C,clientY:y,button:0})),await new Promise(k=>setTimeout(k,120)),console.log("[EasyQuiz] Estrat\xE9gia H (Quizizz RBD) executada")}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia H (Quizizz RBD) falhou:",p)}}function Ao(o,e,t,n){let i=d=>d.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),a=i(o.toLowerCase()),r=i(e.toLowerCase());return`var src=$eq.find('${i(t)}')||Array.from(document.querySelectorAll('[data-rbd-draggable-id],[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${a}');});var dst=Array.from(document.querySelectorAll('[data-rbd-droppable-id],[class*="list-group"],[class*="dropzone"],[data-category]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${r}');});if(src&&dst){try{src.focus();src.dispatchEvent(new KeyboardEvent('keydown',{key:' ',code:'Space',keyCode:32,bubbles:true}));setTimeout(function(){dst.dispatchEvent(new KeyboardEvent('keydown',{key:'Enter',code:'Enter',bubbles:true}));},200);}catch(e){}try{dst.appendChild(src);}catch(e){}[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${a} -> ${r}');}`}var wo={fill:(o,e)=>{let t=N(o);t?ht(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=N(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?qe(e,!0):se(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=N(o);t?qe(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>N(o,e),drag:(o,e)=>{let t=ge(o,"source")||N(o),n=ge(e,"destination")||N(e);t&&n?gt(t,n):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=ge(o,"source")||N(o),n=ge(e,"destination")||N(e);if(!t||!n){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await gt(t,n)},execute:(o,e=!1,t=1)=>$e(o,e,t)};typeof window<"u"&&(window.$eq=wo);async function pn(o,e,t){if(!e)return!1;if(o.t==="val"&&(e.classList.contains("mq-editable-field")||e.closest(".mq-editable-field"))){let n=e.classList.contains("mq-editable-field")?e:e.closest(".mq-editable-field");if(n){try{let i=n.__controller||n.__mathquill_controller;if(i&&i.API)return i.API.latex(t),!0}catch{}try{n.focus();for(let i of t){let a={key:i,bubbles:!0,cancelable:!0};n.dispatchEvent(new KeyboardEvent("keydown",a)),n.dispatchEvent(new KeyboardEvent("keypress",a)),document.execCommand?.("insertText",!1,i),n.dispatchEvent(new KeyboardEvent("keyup",a))}return!0}catch{}}}if(o.t==="sel"&&e.closest(".perseus-widget-container")){let n=e.tagName==="BUTTON"?e:e.querySelector("button")||e.closest("button");if(n)try{se(n),await new Promise(a=>setTimeout(a,150));let i=Array.from(document.querySelectorAll('[data-reach-popover], [role="listbox"], .perseus-dropdown'));for(let a of i){let s=Array.from(a.querySelectorAll('[role="option"], li, button')).find(d=>P(d.textContent).toLowerCase().includes(P(t).toLowerCase()));if(s)return se(s),!0}se(n)}catch{}}if((o.t==="clk"||o.t==="chk")&&e.closest(".perseus-widget-container"))try{let n=Object.keys(e).find(a=>a.startsWith("__reactFiber$")),i=Object.keys(e).find(a=>a.startsWith("__reactProps$"));if(i&&e[i]){let a=e[i];if(typeof a.onClick=="function")return a.onClick({preventDefault:()=>{},stopPropagation:()=>{}}),!0;if(typeof a.onChange=="function")return a.onChange({target:{checked:!0,value:t},preventDefault:()=>{}}),!0}}catch{}return!1}async function hn(o,e=1,t=Pe()){if(Dt(o,t),o.t==="js"){let d=String(o.v||"");co(d);try{new Function("$eq","document","window",d)(wo,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let d=ge(o.from,"source")||N(o.from),l=ge(o.to,"destination")||N(o.to);!d&&o.from&&(d=N(P(o.from))),!l&&o.to&&(l=N(P(o.to))),d&&l?await gt(d,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let n=o.id!==void 0&&o.id!==null?String(o.id):"";!n&&o.t==="val"&&(n=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,a=i!=null?String(i).trim():"",r=null,s=String(o.name??o.n??"").trim();if(!s&&n&&document.querySelector(`input[type="radio"][name="${Z(n)}"]`)&&(s=n),(o.t==="chk"||o.t==="clk")&&s){let d=Array.from(document.querySelectorAll(`input[name="${Z(s)}"]`));if(a&&(r=d.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!r&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||u){let h=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=d.find(c=>{let m=c.value?.toLowerCase()??"";if(h.includes(m))return!0;let f=(c.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return h.some(b=>f===b||f.startsWith(b+" ")||f.startsWith("("+b+")"))})??null}}!r&&d.length>0&&(r=d[0])}if(r||(r=N(n,a,o.t==="val"||o.t==="sel")),!r&&n&&(r=N(P(n),a,o.t==="val"||o.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(P(r.value).toLowerCase()!==P(a).toLowerCase()){let d=document.querySelector(`input[type="radio"][name="${Z(r.name)}"][value="${Z(a)}" i]`);if(d)r=d;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${Z(r.name)}"]`)).find(h=>{let c=h.closest("label, .vf-label, .option-card, tr, td, div");return c&&P(c.textContent).toLowerCase().includes(P(a).toLowerCase())});u&&(r=u)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let d=r.querySelector(`input[value="${Z(a)}" i], [data-value="${Z(a)}" i]`);if(d)r=d;else{let u=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(h=>{let c=h.closest("label, .vf-label, .option-card, td, div");return c&&P(c.textContent).toLowerCase().includes(P(a).toLowerCase())});u&&(r=u)}}}if(!r&&(o.t==="val"||o.t==="sel")){let d=document.body;try{d=ce()||document.body}catch{}let l=Array.from(d.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>R(u)&&!K(u));if(l.length===1)r=l[0];else if(l.length>1){let u=P(n).toLowerCase(),h=u.match(/^#?_?([0-9]+)$/);if(h){let c=parseInt(h[1],10);c>=1&&c<=l.length?r=l[c-1]:c>=0&&c<l.length&&(r=l[c])}r||(r=l.find(m=>{let p=(m.getAttribute("placeholder")||"").toLowerCase(),f=(m.name||"").toLowerCase(),b=(m.getAttribute("aria-label")||"").toLowerCase(),v=(m.id||"").toLowerCase(),x=P(Rt(m)).toLowerCase(),A=P(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(u)||f.includes(u)||b.includes(u)||v.includes(u)||x&&x.includes(u)||u.length>=2&&A.includes(u)})||(l.length===1?l[0]:null))}}if(!r&&o.t!=="adv"){let d=document.querySelector(".perseus-renderer, .framework-perseus, .perseus-widget-container");if(d){let l=P(n).toLowerCase(),u=Array.from(d.querySelectorAll('.mq-editable-field, [role="radio"], [role="checkbox"], [role="combobox"], input:not([type="hidden"]), textarea, select, [role="button"], [role="option"]')).filter(h=>R(h)&&!K(h));if(r=u.find(h=>{let c=(h.textContent||"").trim().toLowerCase(),m=(h.id||"").toLowerCase(),p=(h.getAttribute("aria-label")||"").toLowerCase(),f=(h.value||h.getAttribute("data-value")||"").toLowerCase();return m===l||c===l||p===l||f===l||l.length>=3&&(c.includes(l)||p.includes(l))})||null,!r&&o.t==="val"&&u.length>0){let h=u.filter(c=>c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement||c.classList.contains("mq-editable-field")||c.classList.contains("mq-root-block")||c.isContentEditable);if(h.length>0){let c=l.match(/^#?_?([0-9]+)$/);if(c){let m=parseInt(c[1],10);r=h[Math.min(m-1,h.length-1)]||h[0]}else r=h[0]}}}}if(!r&&o.t!=="adv")throw new Error(`Alvo '${n}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);if(!(Be()&&r&&o.t!=="js"&&o.t!=="adv"&&await pn(o,r,a)))switch(o.t){case"val":if(r){let u=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let f=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');f&&(u=f)}if(!u){let p=r.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){u=p;break}let f=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f){u=f;break}p=p.nextElementSibling}}if(!u){let p=document.body;try{p=ce()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(b=>R(b)&&!K(b));f.length>0&&(u=f[0])}let h=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,c=h!=null?String(h):"",m=u||r;if(m instanceof HTMLInputElement){let p=m.type.toLowerCase(),f=m.maxLength,b=m.min,v=m.max,x=m.step,A=m.pattern;if(f>0&&c.length>f&&(c=c.slice(0,f)),p==="number"||p==="range"){let C=parseFloat(c);if(!isNaN(C)){let y=C;if(b!==""&&!isNaN(parseFloat(b))&&(y=Math.max(y,parseFloat(b))),v!==""&&!isNaN(parseFloat(v))&&(y=Math.min(y,parseFloat(v))),x!==""&&x!=="any"&&!isNaN(parseFloat(x))){let w=parseFloat(x),q=b!==""?parseFloat(b):0;y=q+Math.round((y-q)/w)*w,b!==""&&!isNaN(parseFloat(b))&&(y=Math.max(y,parseFloat(b))),v!==""&&!isNaN(parseFloat(v))&&(y=Math.min(y,parseFloat(v)))}c=Number.isInteger(y)?String(y):String(parseFloat(y.toFixed(6)))}}if(A)try{let C=new RegExp(`^(?:${A})$`);if(!C.test(c)){let y=c.match(/-?\d+\.?\d*/);y&&C.test(y[0])&&(c=y[0])}}catch{}}ht(u||r,c)}break;case"chk":let d=o.c!==void 0?!!o.c:!0;r&&qe(r,d);break;case"sel":if(r){let u=Array.isArray(o.v)?o.v:[String(o.v)];mt(r,u)}break;case"clk":if(r)if(!!(r.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let h=o.c!==void 0?!!o.c:!0;qe(r,h)}else se(r,o.co);break;case"adv":let l=bt(o.id);if(l){await Ut(l,1200);let u=o.id||l.textContent?.trim()||"";u&&Mt(window.location.hostname,{advanceSelector:u}),se(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function mn(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!R(t)||K(t)||t.closest("header, nav, aside"))return!1;let n=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||n||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function bt(o){let e=c=>{let m=(c.getAttribute("aria-label")||c.textContent||(c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"")||"").trim();return Ae.test(m)};if(o){let c=N(o);if(c&&R(c)&&!K(c)&&!Y(c)&&!e(c))return c}try{let c=Lt(window.location.hostname);if(c.advanceSelector){let m=N(c.advanceSelector);if(m&&R(m)&&!K(m)&&!Y(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),n=Array.from(document.querySelectorAll(t)),i=c=>{let m=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"";return(c.getAttribute("aria-label")||c.textContent||m||"").trim()},a=c=>{let m=i(c).trim();return/^\d{1,3}$/.test(m)?!!c.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},r=n.filter(c=>R(c)&&!K(c)&&!c.closest("header, aside")&&!Y(c)&&!e(c));for(let c of r){let m=i(c),p=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((We.test(m)||We.test(p))&&!a(c)&&!Y(c))return c}for(let c of r)if(le(c)&&!Y(c)&&!a(c))return c;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&R(s)&&!K(s)&&!Y(s)&&!e(s))return s;let d=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let c of d)if(R(c)&&!K(c)&&!e(c)&&!Y(c)&&!a(c))return c;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,h=l.filter(c=>{if(!R(c)||K(c)||e(c)||Y(c)||c.closest("header, nav, aside, .eq-sidebar")||a(c))return!1;let m=c.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(h.length>0)return h.sort((c,m)=>{let p=c.getBoundingClientRect(),f=m.getBoundingClientRect(),b=p.left+p.top;return f.left+f.top-b}),h[0];for(let c of r)if(le(c)&&!Y(c))return c;return null}async function Ut(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function gn(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,n=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${n}`}async function fn(o,e=3500){let[t,n,i,a]=o.split("|"),r=parseInt(a||"0",10),s=Date.now();for(;Date.now()-s<e;){let d=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),h=(document.body?.innerText||document.body?.textContent||"").length;if(d!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${d}`};if(l!==n)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${n}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${u}`};if(Math.abs(h-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(h-r)} chars)`};await new Promise(c=>setTimeout(c,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function ft(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let a=N(o.from)||N(P(o.from)),r=N(o.to)||N(P(o.to));a&&r&&await gt(a,r,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",n=N(e,t)||N(P(e),t),i=String(o.name??o.n??"").trim();if(!i&&e&&document.querySelector(`input[type="radio"][name="${Z(e)}"]`)&&(i=e),!n&&i){let a=Array.from(document.querySelectorAll(`input[name="${Z(i)}"]`));if(t&&(n=a.find(r=>r.value?.toLowerCase()===t.toLowerCase())??null),!n&&t){let r=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),s=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(r||s){let d=r?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];n=a.find(l=>{let u=l.value?.toLowerCase()??"";if(d.includes(u))return!0;let c=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return d.some(m=>c===m||c.startsWith(m+" ")||c.startsWith("("+m+")"))})??null}}!n&&a.length>0&&(n=a[0])}if(o.t==="clk"||o.t==="chk"){if(!n&&e){let r=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=P(e).toLowerCase();n=r.find(d=>{let l=P(d.textContent).toLowerCase();return!!(P(d.value||"").toLowerCase()===s||l===s||l.startsWith(s+")")||l.startsWith("("+s+")")||l.startsWith(s+".")||l.startsWith(s+" - ")||l.startsWith(s+":")||s.length>=3&&l.includes(s))})||null}let a=o.v!==void 0?String(o.v).trim():"";if(n&&a){if(n instanceof HTMLInputElement&&n.type==="radio"&&n.name){if(P(n.value).toLowerCase()!==P(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${Z(n.name)}"][value="${Z(a)}" i]`);if(r)n=r;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${Z(n.name)}"]`)).find(l=>{let u=l.closest("label, .vf-label, .option-card, tr, td, div");return u&&P(u.textContent).toLowerCase().includes(P(a).toLowerCase())});d&&(n=d)}}}else if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLSelectElement)&&!(n instanceof HTMLTextAreaElement)){let r=n.querySelector(`input[value="${Z(a)}" i], [data-value="${Z(a)}" i]`);if(r)n=r;else{let d=Array.from(n.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let u=l.closest("label, .vf-label, .option-card, td, div");return u&&P(u.textContent).toLowerCase().includes(P(a).toLowerCase())});d&&(n=d)}}}if(n){let r=n.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,s=n instanceof HTMLInputElement&&["radio","checkbox"].includes(n.type)?n:r.querySelector('input[type="radio"], input[type="checkbox"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),d=o.c!==void 0?!!o.c:!0;if(qe(s||r,d),s&&s.checked!==d){try{let l=s._valueTracker;l&&l.setValue(!d)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,d)}catch{}s.checked=d,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let a=null;if(n&&(a=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let r=document.body;try{r=ce()||document.body}catch{}let s=Array.from(r.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),d=P(e).toLowerCase();a=s.find(l=>{let u=(l.getAttribute("placeholder")||"").toLowerCase(),h=(l.name||"").toLowerCase(),c=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return u.includes(d)||h.includes(d)||c.includes(d)||m.includes(d)})||(s.length>0?s[0]:null)}if(a){let r=String(o.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,r)}}catch{}ht(a,r)}return}if(o.t==="sel"){if(!n&&e){let a=Array.from(document.querySelectorAll("select")),r=P(e).toLowerCase();n=a.find(s=>{let d=(s.name||"").toLowerCase(),l=(s.id||"").toLowerCase(),u=(s.getAttribute("aria-label")||"").toLowerCase();return d.includes(r)||l.includes(r)||u.includes(r)})||null}if(n){let a=Array.isArray(o.v)?o.v:[String(o.v)];mt(n,a)}return}}function me(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),n=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let a=N(i,n,!0)||N(P(i),n,!0);if(!a){let m=document.body;try{m=ce()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>R(f)&&!K(f));p.length>0&&(a=p[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let m=document.querySelector(`input[type="radio"][name="${Z(r.name)}"]:checked`);if(!m)return!1;let p=P(m.value).toLowerCase(),f=P(t).toLowerCase(),b=P(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===f||b===f||b.includes(f)}let s=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let p=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(s=p)}if(!s){let m=a.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){s=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){s=p;break}m=m.nextElementSibling}}if(s instanceof HTMLSelectElement){let m=P(t).toLowerCase();return Array.from(s.options).some(p=>{if(!p.selected)return!1;let f=p.value.toLowerCase(),b=P(p.textContent).toLowerCase();return m===f||m===b||f.includes(m)||b.includes(m)})}let d=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??a.textContent??"").trim();if(!d&&!t)return!0;if(!d&&t)return!1;let l=d.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),h=parseFloat(l),c=parseFloat(u);return!isNaN(h)&&!isNaN(c)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(h-c)<1e-4:l===u||d.toLowerCase()===t.toLowerCase()||u.length>=3&&l===u}if(o.t==="sel"){let e=N(o.id,void 0,!0)||N(P(o.id),void 0,!0);if(!e){let a=document.body;try{a=ce()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>R(l)&&!K(l)),s=P(o.id).toLowerCase();e=r.find(l=>{let u=(l.id||"").toLowerCase(),h=(l.getAttribute("name")||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase(),m=P(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(s)||h.includes(s)||c.includes(s)||s.length>=2&&m.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(l=>P(l).toLowerCase()),d=P(a.textContent).toLowerCase();return s.some(l=>d.includes(l)||l.includes(d))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(a=>P(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),s=P(a.textContent).toLowerCase();return i.some(d=>d===r||d===s||r.includes(d)||s.includes(d))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=String(o.name??o.n??"").trim();if(t&&!o.id){let c=Array.from(document.querySelectorAll(`input[name="${Z(t)}"]`));if(c.length>0){let m=c.find(x=>x.checked);if(!m)return!1;if(!e)return!0;let p=m.value?.toLowerCase()??"",f=e.toLowerCase();if(p===f)return!0;let b=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),v=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return b?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):v?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let n=N(o.id,e)||N(P(o.id),e);if(!n&&t){let c=document.querySelector(`input[name="${Z(t)}"]`);c&&(n=c)}if(!n)return!1;let i=n.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,a=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:i.querySelector('input[type="checkbox"], input[type="radio"]')||(i.getAttribute("for")?i.ownerDocument.getElementById(i.getAttribute("for")):null),r=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(a&&a.type==="radio"){if(a.checked===r)return!0;if(o.v&&a.name){let c=P(String(o.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${Z(a.name)}"]:checked`);if(!m)return!1;if(m===a)return!0;let p=P(m.value).toLowerCase(),f=P(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===c||f.includes(c)||c.includes(p)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===r;let s=i.getAttribute("aria-checked")===String(r)||i.getAttribute("aria-selected")===String(r)||i.getAttribute("aria-pressed")===String(r),d=r?i.getAttribute("data-selected")==="true"||i.getAttribute("data-checked")==="true"||i.getAttribute("data-active")==="true"||i.getAttribute("data-state")==="checked"||i.getAttribute("data-state")==="on":i.getAttribute("data-selected")==="false"||i.getAttribute("data-checked")==="false"||i.getAttribute("data-state")==="unchecked",l=i.className||"",u=r?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(s||d||u)return!0;let h=!!i.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return o.t==="clk"&&!a&&!h||i.getAttribute("aria-expanded")!==null||i.getAttribute("aria-pressed")!==null}if(o.t==="drag"){let e=ge(o.from,"source")||N(o.from)||N(P(o.from)),t=ge(o.to,"destination")||N(o.to)||N(P(o.to));return!e||!t?!1:un(e,t).success}}catch{}return!1}async function $e(o,e,t=1,n=Pe({engine:"smart",autoAdvance:e})){let i=o.actions.filter(E=>E.t!=="adv"),a=o.actions.filter(E=>E.t==="adv"),r=0,s=[],d=new Map,l=new Map,u=new Map,h=new Set,c=o.pageType==="question"||i.length>0,m=i.filter(E=>E.t==="chk"||E.t==="clk"&&E.c!==void 0),p=new Map;for(let E of i){let M=[];l.set(E,M);try{if(E.t==="drag"){M.push("declarative-A-F");try{let H=ge(E.from,"source")||N(E.from),T=ge(E.to,"destination")||N(E.to);H&&u.set(E,H.parentElement?.outerHTML?.slice(0,500)||""),T&&p.set(E,T.children.length)}catch{}}else M.push("declarative-primary");await hn(E,t,n),r++,h.add(E)}catch(H){d.set(E,H instanceof Error?H.message:String(H)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",E,H)}await new Promise(H=>setTimeout(H,E.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&m.length>0){let E=document.body;try{E=ce()||document.body}catch{}let M=Array.from(E.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(H=>R(H)&&!K(H));if(M.length>1){let T=function(z,j){if(z===j||z.contains(j)||j.contains(z))return!0;let Q=z.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),F=j.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(Q&&F&&Q===F)return!0;let G=z.getAttribute("for")||z.id,W=j.getAttribute("for")||j.id;return!!(G&&W&&G===W)};var k=T;let H=new Set;for(let z of m){let j=z.t==="chk"?!!z.c:!!(z.c??!0),Q="id"in z&&typeof z.id=="string"?z.id:"";if(j&&Q){let F=N(Q,z.v);if(F){H.add(F);let G=F.querySelector('input[type="checkbox"]');G&&H.add(G);let W=F.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');W&&(H.add(W),W.querySelectorAll('input[type="checkbox"]').forEach(oe=>H.add(oe)))}}}if(H.size>=m.length&&H.size>0){let z=Array.from(H);for(let j of M)z.some(F=>T(F,j))||(j instanceof HTMLInputElement&&j.checked||j.getAttribute("aria-checked")==="true"||j.closest(".option-card, label")?.classList.contains("selected"))&&qe(j,!1)}}}await new Promise(E=>setTimeout(E,i.length>0?100:25));let f=0;for(let E of i){if(me(E)){f++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${E.t}' no alvo '${E.id||E.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Dt(E,n),l.get(E)?.push("alternative-path"),await ft(E)}catch(M){d.set(E,M instanceof Error?M.message:String(M)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",M)}await new Promise(M=>setTimeout(M,250)),me(E)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),f++,h.has(E)?d.has(E)&&d.delete(E):(d.delete(E),r++,h.add(E)))}if(f<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-f} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(E=>setTimeout(E,200));for(let E of i)if(!me(E))try{if(await ft(E),await new Promise(M=>setTimeout(M,80)),!me(E)&&(E.t==="clk"||E.t==="chk"))try{let M="id"in E?String(E.id||""):"",H=E.v!==void 0?String(E.v).trim():"",T=N(M,H)||N(P(M),H);T&&(Xt(T),await new Promise(z=>setTimeout(z,120)))}catch{}}catch(M){d.set(E,M instanceof Error?M.message:String(M))}await new Promise(E=>setTimeout(E,200)),f=0;for(let E of i)me(E)&&(f++,h.has(E)?d.has(E)&&d.delete(E):(d.delete(E),r++,h.add(E)))}let b=[];for(let[E,M]of i.entries())if(!me(M)){let H=M.t==="drag"?`${M.from} -> ${M.to}`:"id"in M&&M.id?M.id:M.t;s.push(H),b.push({actionIndex:E,action:M,strategiesAttempted:l.get(M)||[],evidence:d.get(M)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(M)}),M.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${M.from}" -> "${M.to}"`,`
  Estrat\xE9gias: ${(l.get(M)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(M)?.slice(0,200)||"n/a"}`)}c&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let v=i.map((E,M)=>{let H=E.t==="drag"?`${E.from} -> ${E.to}`:E.t==="js"?"$eq":E.id||E.t,T=E.t==="js"?!0:E.t==="drag"?!!(ge(E.from,"source")&&ge(E.to,"destination")):!!(N(E.id||"")||N(P(E.id||""))),z=me(E);return{index:M,action:E,target:H,located:T,applied:!d.has(E),verified:z,strategy:E.t==="drag"?"drag-adaptive":E.t==="js"?"javascript":"declarative-dom",evidence:z?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...d.has(E)?{error:d.get(E)}:{}}}),x=c?i.length>0&&s.length===0&&(f===i.length||r===i.length&&f>0):!0,A=!1,C=!1,y="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",w=c?f>0&&f>=Math.ceil(i.length/2):r>0&&r>=i.length/2,q=c?f>0&&(x||w):x||i.length===0||w;if(e&&q){await new Promise(H=>setTimeout(H,i.length>0?120:40));let E=!1,M=null;if(o.pageType!=="info"){let H=mn();if(H&&R(H)){await Ut(H,1200),se(H),E=!0,M=H,await new Promise(j=>setTimeout(j,350));let T=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');T&&R(T)&&(T.textContent||"").trim().length>0?(A=!1,C=!1,y=`Aviso do formul\xE1rio ap\xF3s checagem: ${T.textContent?.trim().slice(0,100)}`):(A=!0,C=!0,y="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!E){let H=gn(),T=a.length>0&&"id"in a[0]?a[0].id:void 0,z=bt(T);if(z){await Ut(z,1500);let j=T||z.textContent?.trim()||"";j&&Mt(window.location.hostname,{advanceSelector:j}),se(z);let Q=await fn(H,1800);C=Q.changed,y=Q.evidence,A=Q.changed||!0,Q.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:f,success:x,advanced:A,failed:s,reports:v,navigationVerified:C,navigationEvidence:y,failedActions:b}}var be=null,ze=[],Vt=[],Ze=[],Kt=[],ve=null,fe=null,Eo=40,bn=`
...
`;function Co(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=bn,document.head.appendChild(o)}}catch{}}function ke(){be&&(be.style.removeProperty("outline"),be.style.removeProperty("outline-offset"),be.style.removeProperty("position"),be=null);for(let o of ze)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ze=[];for(let o of Vt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");Vt=[];for(let o of Ze)try{o.remove()}catch{}Ze=[],fe&&typeof window<"u"&&(window.removeEventListener("scroll",fe),window.removeEventListener("resize",fe),fe=null);for(let o of Kt)try{o.remove()}catch{}if(Kt=[],ve){try{ve.remove()}catch{}ve=null}try{document.querySelectorAll("[data-easyquiz-image-frame]").forEach(o=>{try{o.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-capture-badge]").forEach(o=>{try{o.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-image-highlight]").forEach(o=>{try{let e=o;e.style.removeProperty("animation"),e.style.removeProperty("outline"),e.style.removeProperty("outline-offset"),e.style.removeProperty("box-shadow"),e.style.removeProperty("filter"),e.removeAttribute("data-easyquiz-image-highlight")}catch{}})}catch{}}function Gt(o){Co();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let n=t;try{let i=t.getBoundingClientRect(),a=i.width||n.offsetWidth||0,r=i.height||n.offsetHeight||0;if(a>=Eo&&r>=Eo){try{n.style&&(n.style.outline="3px solid #ffd600",n.style.outlineOffset="4px",n.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",n.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",n.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),n.setAttribute("data-easyquiz-image-highlight","true"),Vt.push(n)}catch{}let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
          position: absolute;
        ...
        `,s.appendChild(d),document.body.appendChild(s),Ze.push(s),Kt.push(d),e.push({element:t,frame:s})}}catch{}}e.length>0&&!fe&&typeof window<"u"&&(fe=()=>{for(let t=e.length-1;t>=0;t--){let n=e[t];try{if(!document.contains(n.element)){try{n.frame.remove()}catch{}let a=Ze.indexOf(n.frame);a!==-1&&Ze.splice(a,1),e.splice(t,1);continue}let i=n.element.getBoundingClientRect();i.width>0&&i.height>0?(n.frame.style.top=`${i.top+window.scrollY-3}px`,n.frame.style.left=`${i.left+window.scrollX-3}px`,n.frame.style.width=`${i.width+6}px`,n.frame.style.height=`${i.height+6}px`):n.frame.style.display="none"}catch{}}e.length===0&&fe&&(window.removeEventListener("scroll",fe),window.removeEventListener("resize",fe),fe=null)},window.addEventListener("scroll",fe,{passive:!0}),window.addEventListener("resize",fe,{passive:!0}))}function _e(o){be&&be!==o&&(be.style.removeProperty("outline"),be.style.removeProperty("outline-offset")),Co(),be=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(ve){try{ve.remove()}catch{}ve=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
...
`;var Se="v3.7.3";var Mo=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function qn(o,e){try{if(Mo){o.innerHTML=Mo.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var kn=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Tn=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Et=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_wallpaperRAF=0;_wlpWhiteLogo=null;_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;keyContextMenu;_ctxPopup=null;_ctxCloseH=null;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;showTokensCheckbox;soundFeedbackCheckbox;compactModeCheckbox;glowEffectsCheckbox;languageHintSelect;autoScrollLogsCheckbox;analyzeBtn;applyBtn=null;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new At({onStatusChange:(l,u,h)=>{this.logToConsole(u,h),l==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):l==="advancing"||l==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):l==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),u.includes("conclus\xE3o")||u.includes("finalizada")||u.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):l==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(l,u)=>{try{return await this.callbacks.onAnalyze(l,u,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),qn(this.shadow,`
    ...
    `).join(""),e.querySelectorAll(".eq-theme-card").forEach(i=>{i.addEventListener("click",a=>{let r=a.currentTarget,s=r.dataset.themeId;s&&(localStorage.setItem("easyquiz_theme",s),this.shadow.host.setAttribute("data-eq-theme",s),e.querySelectorAll(".eq-theme-card").forEach(d=>d.classList.remove("active")),r.classList.add("active"),this.setStatus(`Tema atualizado para ${s}`,"info"))})})}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.setupSettingsTabs();let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let y=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!y))}),this.metricsResetBtn?.addEventListener("click",()=>{Xe(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let y=this.getFormattedLogs();navigator.clipboard.writeText(y).then(()=>{let w=t.innerHTML;t.innerHTML=S.check,setTimeout(()=>t.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let n=this.shadow.querySelector("#eq-dbg-copy-prompt");n?.addEventListener("click",()=>{let y=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(y).then(()=>{let w=n.innerHTML;n.innerHTML=`${S.check} Copiado!`,setTimeout(()=>n.innerHTML=w,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-context");i?.addEventListener("click",()=>{let y=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(y).then(()=>{let w=i.innerHTML;i.innerHTML=`${S.check} Copiado!`,setTimeout(()=>i.innerHTML=w,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-raw-resp");a?.addEventListener("click",()=>{let y=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(y).then(()=>{let w=a.innerHTML;a.innerHTML=`${S.check} Copiado!`,setTimeout(()=>a.innerHTML=w,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-error-btn");r?.addEventListener("click",()=>{let y=this.lastErrorMsg||"";navigator.clipboard.writeText(y).then(()=>{let w=r.innerHTML;r.innerHTML=S.check,setTimeout(()=>r.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",y=>{y.altKey&&(y.key==="q"||y.key==="Q"||y.key==="a"||y.key==="A")&&(y.preventDefault(),this.toggle())},!0);let s=y=>{let w=y.composedPath();w.includes(this.shadow)||(w.includes(this.sidebarEl)||w.includes(this.host))&&y.stopImmediatePropagation()};window.addEventListener("keydown",s,!0),window.addEventListener("keyup",s,!0),window.addEventListener("keypress",s,!0),this.apiKeyInput.addEventListener("input",()=>{let y=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:y})});let d=this.shadow.querySelector("#eq-keys-collapsible"),l=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),h=y=>{d&&(y?(d.style.display="none",l&&(l.style.transform="rotate(0deg)")):(d.style.display="block",d.style.maxHeight="none",d.style.overflow="visible",l&&(l.style.transform="rotate(90deg)")))},c=!1;try{c=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}h(c),u?.addEventListener("click",y=>{if(y.target?.closest("a"))return;let w=d?.style.display==="none";h(!w);try{localStorage.setItem("easyquiz_keys_collapsed",w?"false":"true")}catch{}});let m=this.shadow.querySelector("#eq-auto-menu-btn"),p=this.shadow.querySelector("#eq-auto-menu");p&&(p.hidden=!0),m?.classList.remove("is-open"),m?.addEventListener("click",y=>{if(y.stopPropagation(),!!p){if(this._ctxPopup){this.closeCtxPopup(),m.classList.remove("is-open");return}m.classList.add("is-open"),this.showCtxPopup(m,[{ic:"sparkles",label:"Resolver Autopilot",onClick:()=>{m.classList.remove("is-open"),p.querySelector('[data-auto-action="toggle"]')?.click()}},{ic:"eraser",label:"Limpar mem\xF3ria",onClick:()=>{m.classList.remove("is-open"),p.querySelector('[data-auto-action="memory"]')?.click()}},{ic:"info",label:"Mostrar status",onClick:()=>{m.classList.remove("is-open"),p.querySelector('[data-auto-action="status"]')?.click()}}])}}),p?.querySelectorAll("[data-auto-action]").forEach(y=>{y.addEventListener("click",w=>{w.stopPropagation();let q=y.dataset.autoAction;q==="toggle"?this.analyzeBtn?.click():q==="memory"?(nt(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):q==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),p&&(p.hidden=!0),m?.classList.remove("is-open")})}),this.shadow.addEventListener("click",y=>{y.target.closest(".eq-menu-shell")||(p&&(p.hidden=!0),m?.classList.remove("is-open"))});let f=this.shadow.querySelector("#eq-result-toggle"),b=this.shadow.querySelector("#eq-result-body");f&&b&&(b.classList.add("is-collapsed"),f.classList.remove("is-open"),f.addEventListener("click",()=>{let y=f.classList.toggle("is-open");b.classList.toggle("is-collapsed",!y)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let y=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!y){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let w=X.addKey(y);if(w.ok){let q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:q[0],apiKeys:q}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${q.length} chaves ativas no pool)`,"success"),h(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,st(y).then(k=>{k.ok?(X.markSuccess(y,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(X.markInvalid(y,k.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${k.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(w.message,"warning")}),this.keyMoreBtn.addEventListener("click",y=>{if(y.stopPropagation(),this._ctxPopup){this.closeCtxPopup();return}let w=q=>this.shadow.querySelector(q);this.showCtxPopup(this.keyMoreBtn,[{ic:"edit",label:"Inserir via Janela Nativa",badge:"Bypass",onClick:()=>w("#eq-menu-prompt")?.click()},{ic:"paste",label:"Colar da \xC1rea de Transfer\xEAncia",onClick:()=>w("#eq-menu-paste")?.click()},{ic:"eye",label:"Mostrar/Ocultar Campo",onClick:()=>w("#eq-menu-toggle-vis")?.click()},{ic:"eraser",label:"Limpar Campo",onClick:()=>w("#eq-menu-clear")?.click()},{ic:"upload",label:"Importar Chaves em Lote",onClick:()=>w("#eq-menu-bulk")?.click()},{ic:"code",label:"Ver/Editar Chaves como Texto",onClick:()=>w("#eq-menu-edit-text")?.click()},{ic:"zap",label:"Testar Todas as Chaves",onClick:()=>w("#eq-menu-test")?.click()},{divider:!0,label:"",onClick:()=>{}},{ic:"trash",label:"Apagar Todas as Chaves",danger:!0,onClick:()=>w("#eq-menu-delete-all")?.click()},{ic:"refreshCw",label:"Resetar Todos os Dados",danger:!0,onClick:()=>w("#eq-menu-reset")?.click()}])}),this.shadow.addEventListener("click",y=>{let w=y.target;!w.closest("#eq-key-context-menu")&&!w.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let y=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(y!==null&&y.trim()){let w=y.trim().replace(/^["']|["']$/g,""),q=X.addKey(w);if(q.ok){let k=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(q.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let y=await navigator.clipboard.readText();if(y){let w=y.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=w,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let y=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(y!==null&&y.trim()){let w=y.trim().replace(/^["']|["']$/g,"");if(X.addKey(w).ok){let k=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let y=this.apiKeyInput.type==="password";this.apiKeyInput.type=y?"text":"password";let w=this.shadow.querySelector("#eq-menu-vis-icon"),q=this.shadow.querySelector("#eq-menu-vis-text");w&&(w.innerHTML=y?S.eyeOff:S.eye),q&&(q.textContent=y?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let y=document.createElement("div");y.id="eq-bulk-overlay",y.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let w=document.createElement("div");w.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),w.innerHTML=`
      ...
      `,y.appendChild(w),this.shadow.appendChild(y);let q=w.querySelector("#eq-bulk-ta"),k=w.querySelector("#eq-bulk-status"),E=w.querySelector("#eq-bulk-import"),M=w.querySelector("#eq-bulk-paste-btn"),H=w.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>q?.focus());let T=()=>{y.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(z=>{y.addEventListener(z,j=>{j.stopPropagation(),j.stopImmediatePropagation()},!0)}),y.addEventListener("keydown",z=>{z.key==="Escape"&&T()}),y.addEventListener("click",z=>{z.target===y&&T()}),w.querySelector("#eq-bulk-x")?.addEventListener("click",T),w.querySelector("#eq-bulk-cancel")?.addEventListener("click",T),H.addEventListener("click",()=>{q.value="",k.textContent="",q.focus()}),M.addEventListener("click",async()=>{try{let z=await navigator.clipboard?.readText();z?(q.value=z,q.focus(),k.style.color="#38bdf8",k.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(k.style.color="#fbbf24",k.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{k.style.color="#fbbf24",k.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",q.focus()}}),w.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let z=q.value.trim();if(!z){k.style.color="#f87171",k.textContent="Insira pelo menos uma chave de API antes de importar.";return}let j=z.match(/AIza[0-9A-Za-z\-_]{35}/g),Q=[];if(j&&j.length>0?Q=Array.from(new Set(j)):Q=Array.from(new Set(z.split(/[\n,;\s]+/).map(ne=>ne.trim().replace(/^["'`]|["'`]$/g,"")).filter(ne=>ne.length>=20))),Q.length===0){k.style.color="#f87171",k.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}k.style.color="#00e5ff",k.textContent=`Processando ${Q.length} chave(s)...`,E.disabled=!0,E.style.opacity="0.6";let F=0,G=0;for(let ne of Q){let _=X.addKey(ne);_.ok?F++:_.message.includes("j\xE1 est\xE1 cadastrada")&&G++}if(F>0){let ne=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:ne[0],apiKeys:ne}),h(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}k.textContent=`${F} adicionada(s), ${G} duplicada(s). Validando modelo em paralelo...`;let W=X.exportRawKeys(),oe=this.modelSelect?.value||"gemini-3.5-flash-lite",ee=await zt(oe,W);ee.ok?(X.markSuccess(ee.key,200),k.style.color="#4ade80",k.textContent=` ${F} adicionada(s), ${G} duplicada(s). Modelo '${ee.model}' pronto!`):(k.style.color="#fbbf24",k.textContent=`${F} adicionada(s), ${G} duplicada(s). Aviso: ${ee.message}`),this.renderKeysList(),E.disabled=!1,E.style.opacity="1",F>0&&(this.setStatus(` Lote importado: ${F} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(T,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let y=X.exportRawKeys(),w=document.createElement("div");w.id="eq-text-editor-overlay",w.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let q=document.createElement("div");q.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),q.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
