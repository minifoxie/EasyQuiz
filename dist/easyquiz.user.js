              ...
              <div class="eq-view-pane eq-brain-pane" id="eq-view-brain" style="display: none;">
                ...
                <div class="eq-brain-toolbar">
                  ...
                  <div class="eq-brain-toolbar-actions">
                    <button class="eq-icon-btn" id="eq-refresh-context-btn" type="button" title="Atualizar">${I.refresh}</button>
                    <button class="eq-icon-btn" id="eq-ap-clear-memory" type="button" title="Limpar mem\xF3ria RAG" style="color:#ff6b6b;">${I.eraser}</button>
                    <button class="eq-icon-btn" id="eq-copy-prompt-btn" type="button" title="Copiar prompt">${I.copy}</button>
                  </div>
                </div>
                  ...
                  <div class="eq-brain-canvas">
                    ...
                    <div class="eq-brain-content" id="eq-brain-content">
                      <div class="eq-brain-empty-canvas">
                        <div class="eq-brain-empty-icon">\u{1F4C2}</div>
