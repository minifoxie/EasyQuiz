              ...
              <div class="eq-view-pane eq-brain-pane" id="eq-view-brain" style="display: none;">
                ...
                <div class="eq-brain-toolbar">
                  ...
                  <div class="eq-brain-toolbar-actions">
                    <button class="eq-icon-btn" id="eq-refresh-context-btn" type="button" title="Atualizar">${S.refresh}</button>
                    <button class="eq-icon-btn" id="eq-ap-clear-memory" type="button" title="Limpar mem\xF3ria RAG" style="color:#ff6b6b;">${S.eraser}</button>
                    <button class="eq-icon-btn" id="eq-copy-prompt-btn" type="button" title="Copiar prompt">${S.copy}</button>
                  </div>
                </div>
