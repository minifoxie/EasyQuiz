 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function _(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ge="easyquiz_settings_v2",de="easyquiz_activity_metrics";function Fe(){try{let o=localStorage.getItem(Ge);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...ie,apiKey:s.apiKey||""}}return{...ie}}let e=JSON.parse(o),t=typeof e.model=="string"&&_(e.model)?e.model:ie.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&r&&(a=[r]),{apiKey:a[0]||r||ie.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function Et(){try{localStorage.removeItem(Ge),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(de),sessionStorage.removeItem(de);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ye()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function qe(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Qe(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...qe(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function Tt(o){let e=Fe(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ge,JSON.stringify(r))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var ce=[],wt=12,Yt=1200;function Ct(o){let e=o.trim().replace(/\s+/g," ").slice(0,Yt);e&&!ce.includes(e)&&(ce.push(e),ce.length>wt&&(ce=ce.slice(-wt)))}function ze(){return ce}function Ye(){ce=[]}function At(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var xe=At();function we(){try{localStorage.removeItem(de)}catch{}return xe}function Jt(o){xe=o;try{let e=JSON.stringify(o);sessionStorage.setItem(de,e),localStorage.removeItem(de)}catch{}}function St(o){let e=xe,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],l=n.filter(u=>u.status==="answered"||u.status==="verified").length,s=n.reduce((u,m)=>u+m.durationMs,0),i=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:i,records:n};return Jt(c),c}function Ee(){xe=At();try{sessionStorage.removeItem(de),localStorage.removeItem(de)}catch{}return xe}var Lt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Te(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(h=>h.type==="draggable"||h.type==="dropzone"),r=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),l=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(h=>h.role==="answer").length===0),s=o.controls.filter(h=>h.role!=="navigation").length===0,i=s||a||n||l||r&&o.questionText.length<60,c=s?4500:l?6e3:1800,u=i?`
[HTML]:
${o.htmlSnippet.slice(0,c).replace(/\s+/g," ")}`:"",m="";if(s&&typeof document<"u")try{let h=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(g=>{let v=g,T=v.getBoundingClientRect?.()||{width:0,height:0};return T.width>0&&T.height>0&&!v.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(g=>{let v=g,T=v.tagName.toLowerCase(),C=v.id?`#${v.id}`:"",w=v.className&&typeof v.className=="string"?`.${v.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",E=(v.textContent||v.value||v.getAttribute("aria-label")||"").trim().slice(0,60),H=v.getAttribute("type")||v.getAttribute("role")||"";return`${T}${C}${w}[${H}] txt="${E}"`});h.length>0&&(m=`
[DOM-INTERATIVO]:
${h.join(`
`)}`)}catch{}let d=ze(),p=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",b=o.controls.filter(h=>h.role!=="navigation"),y=o.controls.filter(h=>h.role==="navigation"),x=Wt(o.sourceUrl,o.htmlSnippet),f=x?`
${x}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(b.length===0)return"Nenhuma";let h=b.filter(L=>L.type==="checkbox"||L.type==="chk"),g=new Set(b.filter(L=>L.type==="radio").map(L=>L.name).filter(Boolean)),v=h.filter(L=>!L.name||!g.has(L.name)),T=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),C=v.length>=2||T,w=g.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&g.size>=1,E=b.every(L=>L.type==="radio"||L.type==="chk")&&g.size===1&&!C&&!w,H=b.filter(L=>L.type==="text"||L.type==="number"||L.type==="val"||L.tag==="input"||L.tag==="textarea"),P=H.length>=2;return(w?`[GRADE VERDADEIRO/FALSO (${g.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${g.size} afirma\xE7\xF5es \u2014 emita ${g.size} a\xE7\xF5es chk separadas + adv]
`:C?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:E?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:P?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${H.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${H.length} campos abaixo com seu id exato]
`:"")+JSON.stringify(b.map(L=>({id:L.id,t:L.type,n:L.name||void 0,txt:L.label?L.label.length>160?L.label.slice(0,160)+"...":L.label:void 0,v:L.value||void 0,opt:L.options&&L.options.length?L.options.slice(0,20).map(U=>U.label||U.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${y.length>0?y.map(h=>`"${h.label||h.id}"[${h.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length>0?e.map((h,g)=>`  - Imagem ${g+1}: ${h.associatedLabel||"Gr\xE1fico da Quest\xE3o"}${h.alt?` (Texto alt: "${h.alt}")`:""}`).join(`
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Xt=new Set(["question","info","start","conclusion"]),Zt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),eo=new Set(["val","chk","sel","clk","adv","js","drag"]),to=150,Ce=2e3;function Y(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Ce):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Ce):e}function oo(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!eo.has(a))return null;if(a==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...Y(s)?{id:Y(s,"").slice(0,500)}:{}}}if(a==="drag"){let s=Y(t.from??t.source),i=Y(t.to??t.target??t.destination);return!s||!i?null:{t:"drag",from:s.slice(0,500),to:i.slice(0,500)}}if(a==="js"){let s=Y(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let r=t.id??t.target??t.name??t.selector??t.element;(r==null||r==="")&&a==="val"&&(r="1");let n=Y(r).slice(0,500);if(!n)return null;if(a==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:Y(s).slice(0,Ce)}}if(a==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,c=(Array.isArray(s)?s:[s]).map(u=>Y(u).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:c}}if(a==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",i={t:"chk",id:n,c:!s};return t.v!==void 0&&(i.v=Y(t.v).slice(0,Ce)),i}let l={t:"clk",id:n};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";l.c=!s}return t.v!==void 0&&(l.v=Y(t.v).slice(0,Ce)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(l.co=[t.co[0],t.co[1]]),l}function ao(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),r=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){r=r.filter(l=>!(l.t==="chk"&&l.c===!1||l.t==="clk"&&l.c===!1));let n=r.filter(l=>l.t==="chk"||l.t==="clk");if(n.length>1){let l=r.filter(i=>i.t!=="chk"&&i.t!=="clk"),s=n[n.length-1];r=[...l,s]}}else if(e==="escolha_multipla"){r=r.filter(l=>!(l.t==="chk"&&l.c===!1||l.t==="clk"&&l.c===!1));let n=new Set;r=r.filter(l=>{let s="id"in l&&typeof l.id=="string"?l.id:"";return s?n.has(s)?!1:(n.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,l=[...r].reverse(),s=[];for(let i of l){let c="id"in i&&typeof i.id=="string"?i.id:"";c?n.has(c)||(n.add(c),s.push(i)):s.push(i)}r=s.reverse()}return[...r,...a]}function Mt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!Xt.has(t))&&(t="question"),(typeof a!="string"||!Zt.has(a))&&(a="escolha_unica");let r=Array.isArray(e.actions)?e.actions:[],n=[];for(let i=0;i<Math.min(r.length,to);i++){let c=oo(r[i],i);c&&n.push(c)}n.some(i=>i.t==="val")&&(a==="escolha_unica"||!e.mode)&&(a="preenchimento"),n.some(i=>i.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(a)&&(a="arrastar_soltar"),n=ao(n,a,t);let l=n.some(i=>i.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?l||n.push({t:"adv"}):t==="question"&&!l&&n.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:s,rationale:Y(e.rationale,"Plano validado e auto-recuperado."),actions:n,...Y(e.memoryToStore)?{memoryToStore:Y(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var Z=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let a=e.flatMap(n=>n.split(/[\n\r]+/));Array.from(new Set(a.map(n=>n.trim().replace(/^["']|["']$/g,"")).filter(n=>n.length>5))).forEach((n,l)=>{let s=this.generateId(n),i=t.get(s)||t.get(n);this.keys.set(s,{id:s,key:n,label:i?.label||`Chave ${l+1}`,addedAt:i?.addedAt||Date.now(),lastUsedAt:i?.lastUsedAt,lastLatencyMs:i?.lastLatencyMs,cooldownUntil:i?.cooldownUntil,errorCount:i?.errorCount||0,lastError:i?.lastError,winCount:i?.winCount||0})})}generateId(e){let t=0;for(let r=0;r<e.length;r++)t=(t<<5)-t+e.charCodeAt(r),t|=0;let a=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${a}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<5)}getBestKey(){let e=this.getHealthyKeys();if(e.length>0)return e.sort((a,r)=>{let n=a.lastLatencyMs??99999,l=r.lastLatencyMs??99999;return n-l}),e[0].key;let t=Array.from(this.keys.values());return t.length>0?(t.sort((a,r)=>(a.cooldownUntil||0)-(r.cooldownUntil||0)),t[0].key):""}getDiverseKeys(e){let t=this.getHealthyKeys();if(t.length===0){let r=this.getBestKey();return r?[r]:[]}t.sort((r,n)=>{let l=r.lastLatencyMs??99999,s=n.lastLatencyMs??99999;return l-s});let a=[];for(let r=0;r<e;r++){let n=t[r%t.length];a.push(n.key)}return a}markQuotaHit(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${t/1e3}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${t/1e3}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let r=this.generateId(a);if(this.keys.has(r)||Array.from(this.keys.values()).some(s=>s.key===a))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let l={id:r,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(r,l),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:l}}updateKey(e,t,a){let r=this.keys.get(e);if(!r)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(r.key=n,a!==void 0&&(r.label=a.trim()),r.errorCount=0,r.cooldownUntil=void 0,r.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},I=new Z;var me=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico)",description:"Modelo econ\xF4mico de alta velocidade para volume elevado.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Legacy R\xE1pido)",description:"Modelo legacy com zero-thinking suportado. Ultra-baixa lat\xEAncia.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Legacy Avan\xE7ado)",description:"Modelo legacy avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],We=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash"],no={"gemini-2.5-flash":"gemini-3.6-flash","gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash"};function Xe(o){return no[o]??o}var Ae=null;function io(o,e){let a={temperature:0,maxOutputTokens:1800,responseMimeType:"application/json",responseSchema:e??so};return/lite/i.test(o)||(/gemini-3\.5-flash/i.test(o)||/gemini-3\.[0-4]/i.test(o)?a.thinkingConfig={thinkingBudget:0}:/gemini-3\.[67]-flash/i.test(o)?a.thinkingConfig={thinkingBudget:512}:/gemini-3\.[89]|gemini-3\.[1-9][0-9]/i.test(o)?a.thinkingConfig={thinkingBudget:512}:/gemini-2\.5-flash/i.test(o)&&(a.thinkingConfig={thinkingBudget:0})),a}var so={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Ht(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");return!e||!_(e)?"gemini-3.5-flash-lite":e}function Ze(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function ro(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}try{let r=e.indexOf("{");if(r!==-1){let n=e.slice(r).trim();n=n.replace(/,\s*\{[^}]*$/,""),n=n.replace(/,\s*$/,"");let l=0,s=0,i=!1,c=!1;for(let m=0;m<n.length;m++){let d=n[m];if(c){c=!1;continue}if(d==="\\"){c=!0;continue}if(d==='"'){i=!i;continue}i||(d==="{"?l++:d==="}"?l=Math.max(0,l-1):d==="["?s++:d==="]"&&(s=Math.max(0,s-1)))}for(i&&(n+='"');s>0;)n+="]",s--;for(;l>0;)n+="}",l--;let u=JSON.parse(n);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var It=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&_(a.id));return t.length>0?t:null}return null}catch{return null}})(),Je=new Set;async function Pe(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return me;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let r=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!r.ok){let l=await r.text(),s=Ze(l,r.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let n=await r.json();if(Array.isArray(n.models)&&n.models.length>0){let l=n.models.filter(s=>{let i=s.supportedGenerationMethods||[],c=(s.name||"").replace(/^models\//,""),u=i.includes("generateContent");return _(c)&&u}).map(s=>{let i=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),u=s.displayName||c;return{id:c,name:u.includes(c)?u:`${u} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:i.includes("generateContent"),supportedGenerationMethods:i,discoveredAt:Date.now()}});if(l.length>0){l.sort((s,i)=>{let c=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return c(i.id)-c(s.id)}),It=l;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(l))}catch{}return l}}}catch(r){if(r.message?.includes("Chave de API"))throw r}return me}async function Oe(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await Pe(e);if(a.length>0&&a!==me){let r=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${r.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let r of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${r}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${r})!`,models:me}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function et(o,e){let t=e.map(c=>c.trim().replace(/^["']|["']$/g,"")).filter(c=>c.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=Xe(Ht(o)),r=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function l(c,u,m){let d=new AbortController,p=setTimeout(()=>d.abort(),m);try{let b=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(c)}`,y=await fetch(b,{method:"POST",headers:{...n,"x-goog-api-key":c},body:r,signal:d.signal});if(clearTimeout(p),y.ok)return{ok:!0,model:u,key:c,message:`Modelo '${u}' validado com sucesso!`};let x=await y.text().catch(()=>"");throw new Error(`HTTP ${y.status}: ${x.slice(0,80)}`)}catch(b){throw clearTimeout(p),b}}if(t.length>=2){let c=t.slice(0,6);try{return await Promise.any(c.map(m=>l(m,a,8e3)))}catch{}}let s=t[0],i=[a,...We.filter(c=>c!==a)];for(let c of i)try{let u=await l(s,c,4e3);return c!==a&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${c}'.`),u}catch{}return{ok:!1,model:a,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function lo(o,e,t,a,r,n){let l=["v1beta","v1"],s=new Error(`Falha ao consultar modelo ${o}`),c={...io(o,n)};for(let u of l){if(r.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let m=`https://generativelanguage.googleapis.com/${u}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,d=Date.now();try{let p=await fetch(m,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:r,keepalive:a});if(!p.ok){let x=await p.text();if(p.status===400){let h=/thinking/i.test(x),g=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(x);if((h||g)&&(c.thinkingConfig||c.responseSchema)){let v={...c};h&&delete v.thinkingConfig,g&&(delete v.responseSchema,delete v.responseMimeType),c=v;let T=await fetch(m,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:r,keepalive:a});if(T.ok){let E=await T.json(),H=E.candidates?.[0];if(H?.content?.parts?.[0]?.text)return I.markSuccess(e,Date.now()-d),{rawText:H.content.parts[0].text,data:E,usedModel:o,usedKey:e}}let C=await T?.text?.().catch(()=>"")??x,w=Ze(C,p.status);throw new Error(`[${o}|${Z.maskKey(e)}] ${w}`)}}let f=Ze(x,p.status);if(p.status===404&&u==="v1beta")continue;throw p.status===429?I.markQuotaHit(e,5e3):p.status===503||/no capacity|overloaded|unavailable/i.test(x)?(I.markOverloaded(e,5e3),Je.add(o)):p.status===403||/API_KEY_INVALID/i.test(x)?I.markInvalid(e,f):p.status===404&&Je.add(o),new Error(`[${o}|${Z.maskKey(e)}] ${f}`)}let b=await p.json(),y=b.candidates?.[0];if(!y||!y.content?.parts?.[0]?.text)throw new Error(`[${o}|${Z.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return I.markSuccess(e,Date.now()-d),{rawText:y.content.parts[0].text,data:b,usedModel:o,usedKey:e}}catch(p){if(r.aborted)throw p;s=p;let b=s.message||"";if(b.includes("404")||/no longer available/i.test(b)){Je.add(o);break}}}throw s}var $e=new Map;function kt(o){let e=$e.get(o);return e===void 0?!1:Date.now()>e?($e.delete(o),!1):!0}function co(o,e=6e4){$e.set(o,Date.now()+e)}function zt(){$e.clear()}async function tt(o,e,t,a,r,n){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let l=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];I.init(l);let s=t.apiKey.trim().replace(/^[\"']|[\"']$/g,""),i=I.getBestKey()||s;if(!i)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let c=Ht(t.model);if(!It&&i&&Pe(i).catch(()=>{}),r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),m=Te(o,e,t),d=[{text:m}];for(let k=0;k<e.length;k++){let z=e[k],B=z.associatedLabel||(z.alt?`Imagem: ${z.alt}`:`Imagem ${k+1}`);d.push({text:`[ANEXO VISUAL ${k+1} - V\xCDNCULO: ${B}]:`}),d.push({inline_data:{mime_type:z.mediaType,data:z.base64}})}let p={system_instruction:{parts:[{text:n?.systemPromptOverride??Lt}]},contents:[{role:"user",parts:d}]},b=!0,y=Xe(c),x=Ae?Xe(Ae):null,f=[];x&&_(x)&&x!==y&&f.push(x);for(let k of We)k!==y&&!f.includes(k)&&f.push(k);let h=[];_(y)&&h.push(y);for(let k of f)_(k)&&!h.includes(k)&&h.push(k);h.length<2&&h.push(...We.filter(k=>!h.includes(k)));let g=I.getHealthyKeys().filter(k=>!kt(k.key)).sort((k,z)=>(k.lastLatencyMs??99999)-(z.lastLatencyMs??99999)),v=I.getAllKeys().filter(k=>!kt(k.key)),T=g.length>0?g:v.map(k=>({key:k.key,lastLatencyMs:k.lastLatencyMs,label:k.label})),C=new Set;function w(k,z,B,ae){let Q=[];for(let D of z){for(let K of k){let X=`${K.key}::${D}`;!C.has(X)&&Q.length<B&&(Q.push({model:D,key:K.key,label:K.label||"Chave",timeout:ae}),C.add(X))}if(Q.length>=B)break}return Q}let E=async(k,z)=>{if(z.length===0||r?.aborted)return null;let B=z.map(()=>new AbortController),ae=()=>B.forEach(D=>{try{D.abort()}catch{}});r?.addEventListener("abort",ae,{once:!0});let Q=z.map(D=>`${D.model.replace("gemini-","")}/${D.label}`).join(" | ");a?.(`\u26A1 ${k}: ${z.length} slot(s) [${Q}]...`,"info");try{let D=z.map(async(X,yt)=>{let je=B[yt],xt=setTimeout(()=>{try{je.abort(new Error(`Timeout ${X.timeout/1e3}s (${X.model}|${X.label})`))}catch{je.abort()}},X.timeout);try{let F=await lo(X.model,X.key,p,b,je.signal,n?.generationSchemaOverride);clearTimeout(xt);let W=Mt(ro(F.rawText));return W.usedModel=F.usedModel,W.durationMs=Date.now()-u,W.promptSent=m,W.tokensUsed=F.data.usageMetadata?.totalTokenCount,W.promptTokens=F.data.usageMetadata?.promptTokenCount,W.candidatesTokens=F.data.usageMetadata?.candidatesTokenCount,W.rawResponse=F.rawText,B.forEach((qt,Qt)=>{if(Qt!==yt)try{qt.abort(new Error("Cancelado: vencedor respondeu."))}catch{qt.abort()}}),{plan:W,rawUsage:F.data.usageMetadata,usedModel:F.usedModel,usedKey:F.usedKey,slotLabel:X.label}}catch(F){clearTimeout(xt);let W=F instanceof Error?F.message:String(F);throw(W.includes("429")||W.includes("Quota")||W.includes("RESOURCE_EXHAUSTED"))&&co(X.key,6e4),F}}),K=await Promise.any(D);return r?.removeEventListener("abort",ae),I.markWinner(K.usedKey),K.usedModel!==y&&(Ae=K.usedModel),K}catch(D){return r?.removeEventListener("abort",ae),D instanceof AggregateError&&D.errors.length>0?oe=D.errors.map(K=>K instanceof Error?K.message:String(K)).join(" | "):D instanceof Error&&(oe=D.message),console.warn(`[EasyQuiz ${k}] Falha na onda:`,oe),null}},H=T.length,P=Math.min(Math.max(H,1),6),V=/pro/i.test(y),L=(k,z)=>{let B=z?/pro/i.test(z):V,ae=z?/lite/i.test(z):/lite/i.test(y);return k===0?B?12e3:ae?5e3:6e3:k===1?B?16e3:ae?8e3:9e3:B?2e4:12e3},U=6,te=0,oe="";for(;te<U;){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let k=h.find(D=>!Array.from(C).some(K=>K.startsWith(`${T[0]?.key}::${D}`)))??h[0],z=L(te,k),B=w(T,h,P,z);if(B.length===0)break;let ae=te===0?"Onda 1":`Onda ${te+1}`,Q=await E(ae,B);if(Q){let D=Q.plan.durationMs||Date.now()-u,K=Z.maskKey(Q.usedKey);return a?.(`\u2705 ${D}ms via '${Q.usedModel}' (${Q.slotLabel}: ${K})`,"info"),Q}te++}throw new Error(oe||"Todas as ondas falharam. Verifique sua cota e conex\xE3o com a internet.")}var uo=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Se(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function ot(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function $t(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(uo.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var he=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),Me=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,ne=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,po=0;function at(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!se(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function N(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function S(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||se(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${N(e.id)}"]`);if(n&&at(n))return!0}catch{}let r=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(r&&r!==e&&at(r))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let l=e.getBoundingClientRect();if(l.width>0||l.height>0)return!0}return!0}}}catch{}}return at(e)}function mo(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function O(o,e=500){return mo(o).replace(/\s+/g," ").trim().slice(0,e)}function ho(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(po+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function se(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Le=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function R(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(se(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,r=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),l=String(a.getAttribute?.("title")||""),s=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",i=O(a.textContent,60);return!!(Le.test(r)||Le.test(n)||Le.test(l)||Le.test(s)||i.length>0&&i.length<=25&&Le.test(i))}function J(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||se(o)||R(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=O(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,r=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return ne.test(r)||ne.test(t)?!1:Me.test(r)||Me.test(t)||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!o.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function nt(o){let e=o.closest("tr");if(e){let i=e.querySelector("th, td:first-child"),c=i&&i!==o.closest("td")?O(i.textContent,100):"",u=O(o.closest("label, td")?.textContent||"",50);if(c&&u)return`${c}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let i=t.querySelector('.dropdown-label, [class*="label" i]'),c=i&&i!==o?O(i.textContent,150):"";if(c)return c}let a=o.getAttribute("aria-label");if(a)return O(a);let r=o.getAttribute("aria-labelledby");if(r){let i=r.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(i.trim())return O(i)}if("labels"in o&&o.labels){let i=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(i.trim())return O(i)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let i=O(n.textContent);if(i)return i}let l=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||l||"";return O(s)}function it(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,r=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),l=["input","textarea","select","button"].includes(n)?n:"other",s=o.getAttribute("role")||"",i=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||c.includes("cursor-grab")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(i)||/drag|card-item|sortable/i.test(c),m=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(i)||/dropzone|category-box|bucket|target-zone/i.test(c),p=O((u?"draggable":m?"dropzone":"")||r.type||s||l,40),b="";if(r.type==="checkbox"||r.type==="radio"||s==="radio"||s==="checkbox"){let v=r.checked||o.getAttribute("aria-checked")==="true",T=r.value&&r.value!=="on"?r.value:o.getAttribute("data-value")||"";b=v?T?`checked:${T}`:"checked":T||"unchecked"}else if(l==="button"||n==="a"||e==="navigation"||J(o))b="";else{let v=typeof o.value=="string"||typeof o.value=="number"?o.value:"";b=O(v||o.getAttribute("data-category")||"",2e3)}let y=[];if(a&&a.options)for(let v of Array.from(a.options).slice(0,80))y.push({value:O(v.value),label:O(v.textContent)});else if(s==="combobox"||s==="listbox"||c.includes("select")||c.includes("dropdown")){let v=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),T=v?document.getElementById(v):o;if(T){let C=T.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let w of Array.from(C).slice(0,80)){let E=O(w.textContent);E&&y.push({value:w.getAttribute("data-value")||w.getAttribute("value")||E,label:E})}}}let x=!!(r.required||o.getAttribute("aria-required")==="true"),f=!!(r.disabled||o.getAttribute("aria-disabled")==="true"),h=ho(o);return{id:o.id||h,tag:l,type:p,label:nt(o),name:O(r.name||o.getAttribute("name")||"",180),value:b,options:y,required:x,disabled:f,role:e}}var Pt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Ot(o){if(!S(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(he)).filter(S),a=O(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let r=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),l=Math.min(1,n/r),s=e.top+e.height/2,i=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=a>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+c+u-l*20-i*10}function Re(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let r=O(e.innerText||e.textContent||"",1e4),n=O(t.innerText||t.textContent||"",1e4),l=e.querySelectorAll(he).length,s=t.querySelectorAll(he).length;if(r.length<150&&n.length>r.length&&s<=l+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Rt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&S(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function j(){let o=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(o&&S(o))return o;let e=document.activeElement;if(e&&e!==document.body){let l=e.closest(Pt);if(l&&Ot(l)>0)return Re(l)}let a=Array.from(document.querySelectorAll(Pt)).map(l=>({element:l,score:Ot(l)})).filter(l=>Number.isFinite(l.score)).sort((l,s)=>s.score-l.score),r=a.find(l=>{let s=l.element.tagName.toLowerCase();return s!=="main"&&s!=="body"&&l.score>0});if(r)return Re(r.element);if(a.length>0&&a[0].score>0)return Re(a[0].element);let n=document.querySelector('form, main, [role="main"]');return n&&S(n)?n:document.body}function Nt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let r of Array.from(a.attributes))t.includes(r.name)||a.removeAttribute(r.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ne(o){let e=Array.from(o.querySelectorAll(he)),t=new Set,a=[];for(let i of e){if(!S(i)||J(i)||R(i))continue;let c=(i.value||i.textContent||"").trim();if(ne.test(c))continue;let u=i.tagName.toLowerCase();["input","textarea","select"].includes(u)&&(t.add(i),a.push(i))}for(let i of e){if(!S(i)||J(i)||R(i))continue;let c=(i.value||i.textContent||"").trim();if(ne.test(c))continue;let u=i.tagName.toLowerCase();if(["input","textarea","select"].includes(u))continue;let m=i.querySelector("input, textarea, select");if(!(m&&t.has(m))){if(i.hasAttribute("for")){let d=i.getAttribute("for"),p=d?i.ownerDocument.getElementById(d):null;if(p&&t.has(p))continue}if(u==="a"){let d=i.getAttribute("role"),p=i.getAttribute("class")||"",b=i.getAttribute("data-testid")||"",y=i.getAttribute("draggable")==="true"||i.classList.contains("perseus-drag-item")||i.classList.contains("sortable-item")||p.includes("cursor-grab")||!!i.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(b)||/drag|card-item|sortable/i.test(p);if(!(d==="button"||d==="radio"||d==="checkbox"||d==="option"||y||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(i)}}let r=a.length>0&&a.every(i=>R(i)||/read-?aloud|audio/i.test(i.getAttribute("data-testid")||i.getAttribute("aria-label")||"")),n=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,l=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((a.length===0||r)&&l){r&&(a.length=0);let i=Array.from(n.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(i.length>0){for(let c of i)if(!(!S(c)||R(c))&&(a.push(c),a.length>=50))break}else{let c=Array.from(n.querySelectorAll("button, div[class], span[class], p, li"));for(let u of c){if(!S(u)||J(u)||R(u)||ne.test((u.textContent||"").trim()))continue;let m=(u.textContent||"").trim();if(m.length<2||m.length>300)continue;if(Array.from(u.children).some(p=>p.className&&p.textContent?.trim())||a.push(u),a.length>=50)break}}}let s=a.length>0&&a.every(i=>{let c=(i.textContent||"").trim();return!i.id||c.length<10||/^\d+\s*\/\s*\d+$/.test(c)||/^question text/i.test(c)});if(a.length===0||s){s&&(a.length=0);let i=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(i.length>0)for(let c of i){if(!S(c)||se(c)||J(c)||R(c)||ne.test((c.textContent||"").trim()))continue;let u=(c.textContent||"").trim();if(!(u.length<10||u.length>500)&&!/^\d+\s*\/\s*\d+$/.test(u)&&(a.push(c),a.length>=20))break}}return a.slice(0,100).map(i=>it(i,"answer"))}function st(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let r of e)for(let n of Array.from(r.querySelectorAll(he)))if(!(t.has(n)||!S(n)||!J(n)||R(n))&&(t.add(n),a.push(it(n,"navigation")),a.length>=10))return a;return a}function ke(o=!1){let e=j();e=Re(e),o&&(e=Rt(e));let t=Ne(e),a=st(e);if(t.length===0){let s=Ne(document.body);s.length>0&&(e=Rt(e),t=Ne(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=st(document.body));let r=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=r.length>4e4?O(r.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+O(r.slice(-2e3),2e3):O(r,16e3),l=[...t,...a].slice(0,120);return!n||l.length===0&&n.length<30?O(document.body.innerText||document.body.textContent||"",16e3).length>=30?ge():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:Nt(e),controls:l,scope:e}}function ge(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=O(o,16e3),t=Ne(document.body),a=st(document.body),r=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Nt(n).slice(0,15e3),controls:r,scope:n}}function Dt(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function $(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function q(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function G(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let r=o.ownerDocument.getElementById(a);if(r)return r}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return G(a)}return o}function Bt(o){let e=o;if(!e||!document.contains(e))try{e=j()}catch{}e=e||document.body;let t=r=>{let n=Array.from(r.querySelectorAll("tr")).filter(u=>S(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(n.length>1)return n;let l=Array.from(r.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>S(u)&&!$(u));if(l.length>0)return l;let i=Array.from(r.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>S(u)&&!$(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return i.length>0?i:Array.from(r.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let m=u;return S(m)&&!$(m)&&(m.textContent||"").trim().length>2&&!J(m)&&!R(m)&&!m.querySelector("[class]")})},a=t(e);return a.length>0?a:e!==document.body?t(document.body):[]}function M(o,e,t=!1){if(o==null)return null;let r=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!r)return null;let n=N(r),l=document.querySelector(`[data-easyquiz-id="${n}"]`);if(l&&!$(l))return G(l);try{let d=document.getElementById(r);if(d&&S(d)&&!$(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:G(d)}catch{}try{let d=document.querySelector(`[data-item-id="${n}"]`);if(d&&S(d)&&!$(d))return G(d)}catch{}let s=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let d=parseInt(s[1],10);if(t){let b=document.body;try{b=j()||document.body}catch{}let y=Array.from(b.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(x=>S(x)&&!$(x));if(d>=1&&d-1<y.length)return y[d-1];if(d===0&&y.length>0)return y[0]}let p=d-1;if(p>=0){let b=Bt();if(p<b.length){let f=b[p];if(f.tagName.toLowerCase()==="tr"){if(e){let g=f.querySelector(`input[value="${N(e)}" i], [data-value="${N(e)}" i]`);if(g)return g}let h=f.querySelector("input");if(h)return h}return G(f)}let y=document.body;try{y=j()||document.body}catch{}let x=Array.from(y.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(f=>S(f)&&!$(f));if(p<x.length)return x[p]}}let i=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(i){let d=i[1].toUpperCase().charCodeAt(0)-65;if(d>=0){let p=Bt();if(d<p.length){let b=p[d];if(b.tagName.toLowerCase()==="tr"){if(e){let x=b.querySelector(`input[value="${N(e)}" i], [data-value="${N(e)}" i]`);if(x)return x}let y=b.querySelector("input");if(y)return y}return G(b)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(r)){let p=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(f=>S(f)&&!$(f));if(p)return p;let y=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(f=>S(f)&&!$(f));if(y)return G(y);let x=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(f=>{if(!S(f)||$(f))return!1;let h=q(f.textContent).toLowerCase();return h===r.toLowerCase()||h===r.toLowerCase()+")"});if(x)return G(x)}try{let p=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`)).find(b=>S(b)&&!$(b));if(p)return p.hasAttribute("data-category")||p.hasAttribute("data-dropzone")||p.classList.contains("dnd-zone")?p:G(p)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(r))try{let p=Array.from(document.querySelectorAll(r)).find(b=>S(b)&&!$(b));if(p)return G(p)}catch{}try{let d=r.replace(/"/g,""),p=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,b=document.evaluate(p,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let y=0;y<b.snapshotLength;y++){let x=b.snapshotItem(y);if(x&&S(x)&&!$(x)){if(["body","html"].includes(x.tagName.toLowerCase())){let h=x.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(h&&S(h))return G(h)}return x.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(x)}}}catch{}let u=q(r).toLowerCase(),m=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of m){if(!S(d)||$(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||R(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let b=q(d.textContent).toLowerCase(),y=q(d.getAttribute("aria-label")||"").toLowerCase(),x=q(d.getAttribute("placeholder")||"").toLowerCase(),f=q(d.getAttribute("title")||"").toLowerCase(),h=q(d.getAttribute("name")||"").toLowerCase(),g=q(d.getAttribute("data-category")||"").toLowerCase(),v=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",T=q(v).toLowerCase(),C=b.startsWith(u+")")||b.startsWith(u+".")||b.startsWith(u+" -")||b.startsWith(u+":");if(b===u||y===u||x===u||f===u||h===u||g&&g===u||T&&T===u||C)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(d)}if(u.length>=3)for(let d of m){if(!S(d)||$(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||R(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let b=q(d.textContent).toLowerCase(),y=q(d.getAttribute("aria-label")||"").toLowerCase(),x=q(d.getAttribute("placeholder")||"").toLowerCase(),f=q(d.getAttribute("title")||"").toLowerCase(),h=q(d.getAttribute("name")||"").toLowerCase();if(b.includes(u)||y.includes(u)||x.includes(u)||f.includes(u)||h.includes(u)){if(Array.from(d.children).some(C=>{let w=q(C.textContent).toLowerCase();return w&&w.includes(u)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(d)}let g=u.split(/\s+/).filter(Boolean);if(g.length>=3){let v=g.slice(0,Math.min(5,g.length)).join(" ");if(b.includes(v)||y.includes(v)||x.includes(v))return G(d)}}return null}function _t(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function ee(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),a=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),r=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),n={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerover",{...n}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...n}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}try{o.click()}catch{}try{let l=Object.keys(o).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(l){let s=o[l];for(;s;){let i=s.memoizedProps||s.pendingProps;if(i?.onClick){i.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let l=Object.keys(o).find(s=>s.startsWith("__reactProps"));if(l){let s=o[l];s?.onClick&&s.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let l=o._vei;l?.onClick&&(Array.isArray(l.onClick.value)?l.onClick.value:[l.onClick.value]).forEach(i=>{try{i({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=o.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let i=o.closest("[jsaction]");if(i&&i!==o)try{i.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:a,clientY:r}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function De(o,e){let t=o;if(t.hasAttribute("for")){let c=t.getAttribute("for"),u=t.ownerDocument.getElementById(c);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Be(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){Be(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)t=c;else{let m=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(m)t=m;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let p=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){t=p;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let c=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{let u=document.body;try{u=j()||document.body}catch{}let m=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m)t=m;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=document.body;try{c=j()||document.body}catch{}let u=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;le(t,c);return}let l=String(e??""),s=l;if(t instanceof HTMLInputElement&&t.type==="number"){let c=l.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(s=c)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let i=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}i=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}i=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let m=t._valueTracker;m&&m.setValue(s===""?" ":"")}catch{}let c=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(c,"value")?.set;u?u.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{u?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function He(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),r=q(t),n=M(t)||M(r);if(!n)return a?e:r||e;let l=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(l){let m=q(l.textContent);if(m&&m.length>0&&m.length<150)return m}if(n.id){let m=document.querySelector(`label[for="${N(n.id)}"]`);if(m){let d=q(m.textContent);if(d&&d.length>0&&d.length<150)return d}}let s=n.getAttribute("aria-label");if(s)return q(s);let i=n.getAttribute("placeholder");if(i)return q(i);let c=q(n.textContent);if(c&&c.length>0&&c.length<120)return c;let u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return u?q(u):a?e:r||e}function le(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for")));let r=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&S(t)?t:o;if(a){let n=a.type==="radio",l=a.type==="checkbox",s=!!a._valueTracker;if(a.checked===e){if(n&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(l){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}r&&r!==a&&ee(r);try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let c=a._valueTracker;c&&c.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,_t(a,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;ee(r),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Be(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let l=e.map(c=>q(c).toLowerCase()),s=!1,i=(c,u)=>{c.selected=!0,t.selectedIndex=u;try{t.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,c.value)}catch{}try{let m=t._valueTracker;m&&m.setValue(c.value)}catch{}s=!0};for(let c=0;c<t.options.length;c++){let u=t.options[c],m=u.value.toLowerCase(),d=q(u.textContent).toLowerCase();if(l.some(b=>b===m||b===d)){if(i(u,c),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!s)for(let c of l){let u=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let m=parseInt(u[1],10),p=t.options[0]?.value===""||t.options[0]?.disabled?m:m>=1?m-1:0;if(p>=0&&p<t.options.length&&(i(t.options[p],p),!t.multiple))break}}if(!s){for(let c of l)if(/^[a-z]$/i.test(c)){let u=c.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(d>=0&&d<t.options.length&&(i(t.options[d],d),!t.multiple))break}}if(!s){let c=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let m=t.options[u],d=c(m.value.toLowerCase()),p=c(q(m.textContent).toLowerCase());if(l.some(y=>{let x=c(y);return d.includes(x)||p.includes(x)||x.length>2&&(x.includes(d)||x.includes(p))})&&(i(m,u),!t.multiple))break}}if(s){_t(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&ee(a);let r=e.map(l=>q(l).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(l=>S(l)&&!$(l));for(let l of r){let s=n.find(c=>{let u=q(c.textContent).toLowerCase(),m=q(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return u===l||m===l||u.includes(l)||l.length>2&&l.includes(u)});if(s){ee(s);let c=s.querySelector('input[type="radio"], input[type="checkbox"]');c&&le(c,!0);return}let i=M(l);if(i){ee(i);return}}}function go(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function rt(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function re(o,e){let t=q(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let s=document.getElementById(o.trim());if(s&&S(s)&&!$(s))return s}let l=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of l){let c=Array.from(document.querySelectorAll(s)).find(u=>{if(!S(u)||$(u))return!1;let m=q(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return m===t||m.includes(t)||u.id===o.trim()});if(c)return c}return null}let a=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),r=Array.from(document.querySelectorAll(a)),n=r.find(l=>[l.getAttribute("data-category"),l.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return n&&S(n)&&!$(n)?n:r.find(l=>{if(!S(l)||$(l)||/unclassified/i.test(l.className))return!1;let s=l.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),i=q(s?.textContent||l.textContent||"").toLowerCase();return i.includes("op")&&(i.includes("es")||i.includes("\xF5es"))?!1:i===t||i.startsWith(t)||i.includes(t)})||null}async function Ve(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),r=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),l=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(r.left+Math.max(1,r.width/2)),i=Math.round(r.top+Math.max(1,r.height/2)),c=q(e.textContent).toLowerCase();if(c){let y=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(x=>{let f=q(x.textContent).toLowerCase(),h=x instanceof HTMLInputElement||x instanceof HTMLOptionElement?q(x.value).toLowerCase():"";return f&&(c.includes(f)||f.includes(c))||h&&(c.includes(h)||h.includes(c))});y&&(ee(y),await new Promise(x=>setTimeout(x,120)))}rt(o),await new Promise(b=>setTimeout(b,140)),rt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&rt(u),await new Promise(b=>setTimeout(b,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:l,screenX:n,screenY:l,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",m));let d=4;for(let b=1;b<=d;b++){let y=Math.round(n+(s-n)*(b/d)),x=Math.round(l+(i-l)*(b/d)),f={...m,clientX:y,clientY:x,screenX:y,screenY:x};try{o.dispatchEvent(new PointerEvent("pointermove",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",f))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:i,screenX:s,screenY:i,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let b=go(O(o.textContent),o.outerHTML),y={...m},x={...p};b&&(y.dataTransfer=b,x.dataTransfer=b);let f=o.ownerDocument.defaultView?.DragEvent;if(!f)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new f("dragstart",y)),e.dispatchEvent(new f("dragenter",x)),e.dispatchEvent(new f("dragover",x)),e.dispatchEvent(new f("drop",x)),o.dispatchEvent(new f("dragend",y))}catch(b){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",b)}try{let b=new Touch({identifier:1,target:o,clientX:n,clientY:l}),y=new Touch({identifier:1,target:e,clientX:s,clientY:i});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[b]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[y]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(b=>setTimeout(b,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Kt={fill:(o,e)=>{let t=M(o);t?De(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=M(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?le(e,!0):ee(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=M(o);t?le(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>M(o,e),drag:(o,e)=>{let t=re(o,"source")||M(o),a=re(e,"destination")||M(e);t&&a?Ve(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=re(o,"source")||M(o),a=re(e,"destination")||M(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Ve(t,a)},execute:(o,e=!1,t=1)=>dt(o,e,t)};typeof window<"u"&&(window.$eq=Kt);async function fo(o,e=1,t=Se()){if(ot(o,t),o.t==="js"){let s=String(o.v||"");$t(s);try{new Function("$eq","document","window",s)(Kt,document,window)}catch(i){throw console.warn("[EasyQuiz JS Execution]",i),i}return}if(o.t==="drag"){let s=re(o.from,"source")||M(o.from),i=re(o.to,"destination")||M(o.to);!s&&o.from&&(s=M(q(o.from))),!i&&o.to&&(i=M(q(o.to))),s&&i?await Ve(s,i,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let r=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=r!=null?String(r).trim():"",l=M(a,n,o.t==="val"||o.t==="sel");if(!l&&a&&(l=M(q(a),n,o.t==="val"||o.t==="sel")),l&&n){if(l instanceof HTMLInputElement&&l.type==="radio"&&l.name){if(q(l.value).toLowerCase()!==q(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${N(l.name)}"][value="${N(n)}" i]`);if(s)l=s;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${N(l.name)}"]`)).find(u=>{let m=u.closest("label, .vf-label, .option-card, tr, td, div");return m&&q(m.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(l=c)}}}else if(!(l instanceof HTMLInputElement)&&!(l instanceof HTMLSelectElement)&&!(l instanceof HTMLTextAreaElement)){let s=l.querySelector(`input[value="${N(n)}" i], [data-value="${N(n)}" i]`);if(s)l=s;else{let c=Array.from(l.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(u=>{let m=u.closest("label, .vf-label, .option-card, td, div");return m&&q(m.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(l=c)}}}if(!l&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=j()||document.body}catch{}let i=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(c=>S(c)&&!$(c));if(i.length===1)l=i[0];else if(i.length>1){let c=q(a).toLowerCase(),u=c.match(/^#?_?([0-9]+)$/);if(u){let m=parseInt(u[1],10);m>=1&&m<=i.length?l=i[m-1]:m>=0&&m<i.length&&(l=i[m])}l||(l=i.find(d=>{let p=(d.getAttribute("placeholder")||"").toLowerCase(),b=(d.name||"").toLowerCase(),y=(d.getAttribute("aria-label")||"").toLowerCase(),x=(d.id||"").toLowerCase(),f=q(nt(d)).toLowerCase(),h=q(d.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(c)||b.includes(c)||y.includes(c)||x.includes(c)||f&&f.includes(c)||c.length>=2&&h.includes(c)})||(i.length===1?i[0]:null))}}if(!l&&o.t!=="adv")throw new Error(`Alvo '${a}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);switch(o.t){case"val":if(l){let i=l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement||l instanceof HTMLSelectElement||l.isContentEditable?l:l.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!i){let d=l.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(i=d)}if(!i){let m=l.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){i=m;break}let d=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){i=d;break}m=m.nextElementSibling}}if(!i){let m=document.body;try{m=j()||document.body}catch{}let d=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>S(p)&&!$(p));d.length>0&&(i=d[0])}let c=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,u=c!=null?String(c):"";De(i||l,u)}break;case"chk":l&&le(l,!!o.c);break;case"sel":if(l){let i=Array.isArray(o.v)?o.v:[String(o.v)];Be(l,i)}break;case"clk":if(l)if(!!(l.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||l.querySelector('input[type="radio"], input[type="checkbox"]')||l instanceof HTMLInputElement&&["checkbox","radio"].includes(l.type))){let c=o.c!==void 0?!!o.c:!0;le(l,c)}else ee(l,o.co);break;case"adv":let s=lt(o.id);if(s){await ct(s,1200);let i=o.id||s.textContent?.trim()||"";i&&Qe(window.location.hostname,{advanceSelector:i}),ee(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function bo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!S(t)||$(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(r)})||null}function lt(o){let e=d=>{let p=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return ne.test(p)};if(o){let d=M(o);if(d&&S(d)&&!$(d)&&!R(d)&&!e(d))return d}try{let d=qe(window.location.hostname);if(d.advanceSelector){let p=M(d.advanceSelector);if(p&&S(p)&&!$(p)&&!R(p)&&!e(p))return p}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(t)),r=d=>{let p=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||p||"").trim()},n=d=>{let p=r(d).trim();return/^\d{1,3}$/.test(p)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},l=a.filter(d=>S(d)&&!$(d)&&!d.closest("header, aside")&&!R(d)&&!e(d));for(let d of l){let p=r(d),b=p.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Me.test(p)||Me.test(b))&&!n(d)&&!R(d))return d}for(let d of l)if(J(d)&&!R(d)&&!n(d))return d;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&S(s)&&!$(s)&&!R(s)&&!e(s))return s;let i=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of i)if(S(d)&&!$(d)&&!e(d)&&!R(d)&&!n(d))return d;let c=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,m=c.filter(d=>{if(!S(d)||$(d)||e(d)||R(d)||d.closest("header, nav, aside, .eq-sidebar")||n(d))return!1;let p=d.getBoundingClientRect();return p.top>u*.45&&p.height>=24&&p.width>=24});if(m.length>0)return m.sort((d,p)=>{let b=d.getBoundingClientRect(),y=p.getBoundingClientRect(),x=b.left+b.top;return y.left+y.top-x}),m[0];for(let d of l)if(J(d)&&!R(d))return d;return null}async function ct(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(r=>setTimeout(r,80))}}function vo(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function yo(o,e=3500){let[t,a,r,n]=o.split("|"),l=parseInt(n||"0",10),s=Date.now();for(;Date.now()-s<e;){let i=window.location.href,c=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),m=(document.body?.innerText||document.body?.textContent||"").length;if(i!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${i}`};if(c!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${c}"`};if(Math.abs(parseInt(u)-parseInt(r||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${r} \u2192 ${u}`};if(Math.abs(m-l)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(m-l)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Vt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let r=M(o.from)||M(q(o.from)),n=M(o.to)||M(q(o.to));r&&n&&await Ve(r,n,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=M(e,t)||M(q(e),t);if(o.t==="clk"||o.t==="chk"){if(!a&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),l=q(e).toLowerCase();a=n.find(s=>{let i=q(s.textContent).toLowerCase();return!!(q(s.value||"").toLowerCase()===l||i===l||i.startsWith(l+")")||i.startsWith("("+l+")")||i.startsWith(l+".")||i.startsWith(l+" - ")||i.startsWith(l+":")||l.length>=3&&i.includes(l))})||null}let r=o.v!==void 0?String(o.v).trim():"";if(a&&r){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(q(a.value).toLowerCase()!==q(r).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${N(a.name)}"][value="${N(r)}" i]`);if(n)a=n;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${N(a.name)}"]`)).find(i=>{let c=i.closest("label, .vf-label, .option-card, tr, td, div");return c&&q(c.textContent).toLowerCase().includes(q(r).toLowerCase())});s&&(a=s)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let n=a.querySelector(`input[value="${N(r)}" i], [data-value="${N(r)}" i]`);if(n)a=n;else{let s=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(i=>{let c=i.closest("label, .vf-label, .option-card, td, div");return c&&q(c.textContent).toLowerCase().includes(q(r).toLowerCase())});s&&(a=s)}}}if(a){let n=a.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,l=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(le(l||n,s),l&&l.checked!==s){try{let i=l._valueTracker;i&&i.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(l,s)}catch{}l.checked=s,l.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),l.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let r=null;if(a&&(r=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!r){let n=document.body;try{n=j()||document.body}catch{}let l=Array.from(n.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=q(e).toLowerCase();r=l.find(i=>{let c=(i.getAttribute("placeholder")||"").toLowerCase(),u=(i.name||"").toLowerCase(),m=(i.id||"").toLowerCase(),d=(i.getAttribute("aria-label")||"").toLowerCase();return c.includes(s)||u.includes(s)||m.includes(s)||d.includes(s)})||(l.length>0?l[0]:null)}if(r){let n=String(o.v??"");try{if(r.focus?.(),r.type!=="number"){try{r.select?.()}catch{}document.execCommand?.("insertText",!1,n)}}catch{}De(r,n)}return}if(o.t==="sel"){if(!a&&e){let r=Array.from(document.querySelectorAll("select")),n=q(e).toLowerCase();a=r.find(l=>{let s=(l.name||"").toLowerCase(),i=(l.id||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase();return s.includes(n)||i.includes(n)||c.includes(n)})||null}if(a){let r=Array.isArray(o.v)?o.v:[String(o.v)];Be(a,r)}return}}function fe(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,r=o.id!==void 0&&o.id!==null?String(o.id):"";r||(r=o.target??o.name??o.selector??"1");let n=M(r,a,!0)||M(q(r),a,!0);if(!n){let m=document.body;try{m=j()||document.body}catch{}let d=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>S(p)&&!$(p));d.length>0&&(n=d[0])}if(!n)return!1;let l=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(l&&l.name){let m=document.querySelector(`input[type="radio"][name="${N(l.name)}"]:checked`);if(!m)return!1;let d=q(m.value).toLowerCase(),p=q(t).toLowerCase(),b=q(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===p||b===p||b.includes(p)}let s=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let d=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(s=d)}if(!s){let m=n.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){s=m;break}let d=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){s=d;break}m=m.nextElementSibling}}if(s instanceof HTMLSelectElement){let m=q(t).toLowerCase();return Array.from(s.options).some(d=>{if(!d.selected)return!1;let p=d.value.toLowerCase(),b=q(d.textContent).toLowerCase();return m===p||m===b||p.includes(m)||b.includes(m)})}let i=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??n.textContent??"").trim();if(!i&&!t)return!0;if(!i&&t)return!1;let c=i.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return c===u||c.includes(u)||u.includes(c)||i.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=M(o.id,void 0,!0)||M(q(o.id),void 0,!0);if(!e){let n=document.body;try{n=j()||document.body}catch{}let l=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>S(c)&&!$(c)),s=q(o.id).toLowerCase();e=l.find(c=>{let u=(c.id||"").toLowerCase(),m=(c.getAttribute("name")||"").toLowerCase(),d=(c.getAttribute("aria-label")||"").toLowerCase(),p=q(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(s)||m.includes(s)||d.includes(s)||s.length>=2&&p.includes(s)})||(l.length===1?l[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(c=>q(c).toLowerCase()),i=q(n.textContent).toLowerCase();return s.some(c=>i.includes(c)||c.includes(i))}return!1}let r=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>q(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let l=n.value.toLowerCase(),s=q(n.textContent).toLowerCase();return r.some(i=>i===l||i===s||l.includes(i)||s.includes(i))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=M(o.id,e)||M(q(o.id),e);if(!t)return!1;let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,r=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),n=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(r&&r.type==="radio"){if(r.checked===n)return!0;if(o.v&&r.name){let u=q(String(o.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${N(r.name)}"]:checked`);if(!m)return!1;if(m===r)return!0;let d=q(m.value).toLowerCase(),p=q(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===u||p.includes(u)||u.includes(d)}}if(r&&["checkbox","radio"].includes(r.type))return r.checked===n;let l=a.getAttribute("aria-checked")===String(n)||a.getAttribute("aria-selected")===String(n)||a.getAttribute("aria-pressed")===String(n),s=n?a.getAttribute("data-selected")==="true"||a.getAttribute("data-checked")==="true"||a.getAttribute("data-active")==="true"||a.getAttribute("data-state")==="checked"||a.getAttribute("data-state")==="on":a.getAttribute("data-selected")==="false"||a.getAttribute("data-checked")==="false"||a.getAttribute("data-state")==="unchecked",i=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||"");return!!(l||s||i||(a instanceof HTMLButtonElement||a.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!r)}if(o.t==="drag"){let e=M(o.from)||M(q(o.from)),t=M(o.to)||M(q(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function dt(o,e,t=1,a=Se({engine:"smart",autoAdvance:e})){let r=o.actions.filter(g=>g.t!=="adv"),n=o.actions.filter(g=>g.t==="adv"),l=0,s=[],i=new Map,c=o.pageType==="question",u=r.filter(g=>g.t==="chk"||g.t==="clk"&&g.c!==void 0);for(let g of r){try{await fo(g,t,a),l++}catch(v){i.set(g,v instanceof Error?v.message:String(v)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",g,v)}await new Promise(v=>setTimeout(v,g.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&u.length>0){let g=document.body;try{g=j()||document.body}catch{}let v=Array.from(g.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(T=>S(T)&&!$(T));if(v.length>1){let C=function(w,E){if(w===E||w.contains(E)||E.contains(w))return!0;let H=w.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),P=E.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(H&&P&&H===P)return!0;let V=w.getAttribute("for")||w.id,L=E.getAttribute("for")||E.id;return!!(V&&L&&V===L)};var h=C;let T=new Set;for(let w of u){let E=w.t==="chk"?!!w.c:!!(w.c??!0),H="id"in w&&typeof w.id=="string"?w.id:"";if(E&&H){let P=M(H,w.v);if(P){T.add(P);let V=P.querySelector('input[type="checkbox"]');V&&T.add(V);let L=P.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');L&&(T.add(L),L.querySelectorAll('input[type="checkbox"]').forEach(U=>T.add(U)))}}}if(T.size>=u.length&&T.size>0){let w=Array.from(T);for(let E of v)w.some(P=>C(P,E))||(E instanceof HTMLInputElement&&E.checked||E.getAttribute("aria-checked")==="true"||E.closest(".option-card, label")?.classList.contains("selected"))&&le(E,!1)}}}await new Promise(g=>setTimeout(g,r.length>0?100:25));let m=0;for(let g of r){if(fe(g)){m++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${g.t}' no alvo '${g.id||g.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{ot(g,a),await Vt(g)}catch(v){i.set(g,v instanceof Error?v.message:String(v)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",v)}await new Promise(v=>setTimeout(v,250)),fe(g)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),m++,i.has(g)&&(i.delete(g),l++))}if(m<r.length&&r.length>0){console.warn(`[EasyQuiz Auto-Cura] ${r.length-m} de ${r.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(g=>setTimeout(g,200));for(let g of r)if(!fe(g))try{await Vt(g)}catch(v){i.set(g,v instanceof Error?v.message:String(v))}await new Promise(g=>setTimeout(g,200)),m=0;for(let g of r)fe(g)&&(m++,i.has(g)&&(i.delete(g),l++))}for(let g of r)fe(g)||s.push(g.t==="drag"?`${g.from} -> ${g.to}`:"id"in g?g.id:g.t);c&&r.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let d=r.map((g,v)=>{let T=g.t==="drag"?`${g.from} -> ${g.to}`:g.t==="js"?"$eq":g.id||g.t,C=g.t==="js"?!0:g.t==="drag"?!!(re(g.from,"source")&&re(g.to,"destination")):!!(M(g.id||"")||M(q(g.id||""))),w=fe(g);return{index:v,action:g,target:T,located:C,applied:!i.has(g),verified:w,strategy:g.t==="drag"?"drag-adaptive":g.t==="js"?"javascript":"declarative-dom",evidence:w?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...i.has(g)?{error:i.get(g)}:{}}}),p=c?r.length>0&&s.length===0&&(m===r.length||l===r.length&&m>0):!0,b=!1,y=!1,x="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",f=l>0&&l>=r.length/2;if(e&&(p||!c||f)){await new Promise(w=>setTimeout(w,r.length>0?120:40));let g=!1;if(o.pageType!=="info"){let w=bo();w&&S(w)&&(await ct(w,1200),ee(w),g=!0,await new Promise(E=>setTimeout(E,350)))}let v=vo(),T=n.length>0?n[0].id:void 0,C=lt(T);if(!C&&g&&(await new Promise(w=>setTimeout(w,250)),C=lt(T)),C){await ct(C,1500);let w=T||C.textContent?.trim()||"";w&&Qe(window.location.hostname,{advanceSelector:w}),ee(C);let E=await yo(v,1800);y=E.changed,x=E.evidence,b=E.changed||g,!E.changed&&!g&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else g?(b=!0,y=!0,x="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:l,verified:m,success:p,advanced:b,failed:s,reports:d,navigationVerified:y,navigationEvidence:x}}var be=null,ue=[],ut=[],pt=[],ve=null,xo=`
...
`;function Ut(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=xo,document.head.appendChild(o)}}catch{}}function pe(){be&&(be.style.removeProperty("outline"),be.style.removeProperty("outline-offset"),be.style.removeProperty("position"),be=null);for(let o of ue)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ue=[];for(let o of ut)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");ut=[];for(let o of pt)try{o.remove()}catch{}if(pt=[],ve){try{ve.remove()}catch{}ve=null}}function mt(o){Ut();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),ut.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),pt.push(n)}}catch{}}}function ht(o){pe(),Ut(),be=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=s=>{if(!this.isDragging||!this.element)return;let i=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),m=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+i),u),p=Math.min(Math.max(10,this.initialTop+c),m);this.element.style.left=`${d}px`,this.element.style.top=`${p}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(p=>p.t==="drag"),l=r.actions.filter(p=>{if(p.t!=="val")return!1;let b=q(p.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(b)}),s=r.actions.filter(p=>p.t==="clk"||p.t==="chk"),i=r.actions.filter(p=>p.t==="sel"),c=n.length||l.length||s.length||i.length,u=document.createElement("div");u.className="eq-fah-meta";let m=document.createElement("span");m.textContent=`Modo: ${r.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(m,d),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let p={};for(let b of n){let y=q(b.to)||"Geral";p[y]||(p[y]=[]),p[y].push(q(b.from))}for(let[b,y]of Object.entries(p)){let x=document.createElement("div"),f=/fato|true|verdadeiro|sim/i.test(b),h=/opini[aã]o|false|falso|n[aã]o/i.test(b);x.className=`eq-fah-group ${f?"group-fato":h?"group-opiniao":""}`;let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent=`\u{1F4C1} ${b} (${y.length})`,x.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let T of y){let C=document.createElement("div");C.className="eq-fah-item";let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=T,C.appendChild(w);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(T),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),C.appendChild(E),v.appendChild(C)}x.appendChild(v),e.appendChild(x)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,a.textContent=String(l.length);let p=document.createElement("div");p.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4DD} Respostas para os Campos de Texto:",p.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<l.length;x++){let f=l[x],h=document.createElement("div");h.className="eq-fah-item";let g=He(f.id);(!g||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Campo ${x+1}`);let v=String(f.v??""),T=document.createElement("div");T.className="eq-fah-field-box";let C=document.createElement("div");C.className="eq-fah-field-label",C.textContent=g,T.appendChild(C);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=v,T.appendChild(w),h.appendChild(T);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),h.appendChild(E),y.appendChild(h)}p.appendChild(y),e.appendChild(p)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let p=document.createElement("div");p.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F3AF} Alternativa(s) Correta(s):",p.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<s.length;x++){let f=s[x],h=document.createElement("div");h.className="eq-fah-item";let g=He(f.id);(!g||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g))&&f.v&&(g=String(f.v)),g=q(g),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g)&&(g="");let v="",T=g.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);T?(v=T[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),g=T[2].trim()||g):s.length>1&&(v=String.fromCharCode(65+x));let C=document.createElement("div");if(C.style.display="flex",C.style.alignItems="center",C.style.gap="8px",C.style.flex="1",v){let H=document.createElement("span");H.className="eq-fah-letter-badge",H.textContent=v,C.appendChild(H)}let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=g||(v?`Alternativa ${v}`:"Alternativa Selecionada"),C.appendChild(w),h.appendChild(C);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(g||v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),h.appendChild(E),y.appendChild(h)}p.appendChild(y),e.appendChild(p)}else if(i.length>0){t.textContent=`Sele\xE7\xE3o (${i.length} listas)`,a.textContent=String(i.length);let p=document.createElement("div");p.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",p.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<i.length;x++){let f=i[x],h=document.createElement("div");h.className="eq-fah-item";let g=He(f.id);(!g||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Lista ${x+1}`);let C=(Array.isArray(f.v)?f.v:[String(f.v??"")]).map(V=>{let L=M(f.id,void 0,!0)||M(q(f.id),void 0,!0),U=L instanceof HTMLSelectElement?L:L?.querySelector("select");if(U){let te=q(V).toLowerCase();for(let oe=0;oe<U.options.length;oe++){let k=U.options[oe];if(k.value.toLowerCase()===te||q(k.textContent).toLowerCase()===te){let z=q(k.textContent);if(z&&!z.toLowerCase().includes("selecione"))return z}}}return V}).join(", "),w=document.createElement("div");w.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=g,w.appendChild(E);let H=document.createElement("div");H.className="eq-fah-field-val",H.textContent=C,w.appendChild(H),h.appendChild(w);let P=document.createElement("button");P.className="eq-fah-copy-inline",P.textContent="Copiar",P.addEventListener("click",()=>{navigator.clipboard.writeText(C),P.textContent="\u2713 Copiado",setTimeout(()=>P.textContent="Copiar",1200)}),h.appendChild(P),y.appendChild(h)}p.appendChild(y),e.appendChild(p)}else{t.textContent="Gabarito",a.textContent="0";let p=document.createElement("div");p.style.padding="10px",p.style.color="#888",p.textContent="Nenhuma resposta direta para exibir.",e.appendChild(p)}if(r.rationale){let p=document.createElement("div");p.className="eq-fah-rationale",p.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(p)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),r=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let i of a){let c=q(i.to)||"Geral";s[c]||(s[c]=[]),s[c].push(q(i.from))}for(let[i,c]of Object.entries(s)){t.push(`### Categoria: ${i}`);for(let u of c)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of r){let i=q(s.id);t.push(`- **${i||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let i=n[s],c=He(i.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&i.v&&(c=String(i.v)),c=q(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let u=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let i=q(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${i}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`;var Ft=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function Mo(o,e){try{if(Ft){o.innerHTML=Ft.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var ko=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Ho=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Ue=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new _e({onStatusChange:(s,i,c)=>{this.logToConsole(i,c),s==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):s==="advancing"||s==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):s==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),i.includes("conclus\xE3o")||i.includes("finalizada")||i.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda com sucesso! Autopilot finalizado.","success"):this.setStatus("Autopilot desativado.","info")):s==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(s,i)=>{try{return await this.callbacks.onAnalyze(s,i,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Mo(this.shadow,`
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap"),this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn.disabled=!0,this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new Ke(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),me.filter(s=>_(s.id)).forEach(s=>this.modelSelect.add(new Option(s.name,s.id,!1,s.id===e.model))),ko.forEach(s=>this.modeSelect.add(new Option(s.label,s.value,!1,s.value===e.modeHint))),Ho.forEach(s=>this.engineSelect.add(new Option(s.label,s.value,!1,s.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let r=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];I.init(r),this.renderKeysList();let n=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof n?.unref=="function"&&n.unref();let l=I.getBestKey()||e.apiKey;l&&Pe(l).then(s=>{s&&s.length>0&&this.updateModelSelect(s,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];for(let a of t){let r=this.shadow.querySelector(`#eq-tab-${a}`),n=this.shadow.querySelector(`#eq-view-${a}`);a===e?(r?.classList.add("active"),n&&(n.style.display="flex")):(r?.classList.remove("active"),n&&(n.style.display="none"))}e==="brain"?(this.renderContextTree(),this.refreshInspectorView()):e==="metrics"?this.updateTimingMetrics():e==="debug"&&(this.refreshDebugView(),this.renderTerminalEntries())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.metricsResetBtn?.addEventListener("click",()=>{Ee(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let e=this.shadow.querySelector("#eq-dbg-scroll-toggle");e?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,e&&(e.style.color=this.autoScrollLogs?"#00ffcc":"#858585",e.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let f=this.getFormattedLogs();navigator.clipboard.writeText(f).then(()=>{let h=t.innerHTML;t.innerHTML=A.check,setTimeout(()=>t.innerHTML=h,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let a=this.shadow.querySelector("#eq-dbg-copy-prompt");a?.addEventListener("click",()=>{let f=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(f).then(()=>{let h=a.innerHTML;a.innerHTML=`${A.check} Copiado!`,setTimeout(()=>a.innerHTML=h,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-context");r?.addEventListener("click",()=>{let f=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let h=r.innerHTML;r.innerHTML=`${A.check} Copiado!`,setTimeout(()=>r.innerHTML=h,1800)})});let n=this.shadow.querySelector("#eq-dbg-copy-raw-resp");n?.addEventListener("click",()=>{let f=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let h=n.innerHTML;n.innerHTML=`${A.check} Copiado!`,setTimeout(()=>n.innerHTML=h,1800)})});let l=this.shadow.querySelector("#eq-dbg-copy-error-btn");l?.addEventListener("click",()=>{let f=this.lastErrorMsg||"";navigator.clipboard.writeText(f).then(()=>{let h=l.innerHTML;l.innerHTML=A.check,setTimeout(()=>l.innerHTML=h,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),this.shadow.querySelector("#eq-min-btn")?.addEventListener("click",()=>this.toggle(!1)),this.shadow.querySelector("#eq-close-btn")?.addEventListener("click",()=>this.toggle(!1)),window.addEventListener("keydown",f=>{f.altKey&&(f.key==="q"||f.key==="Q")&&(f.preventDefault(),this.toggle())},!0);let s=f=>{let h=f.composedPath();h.includes(this.shadow)||(h.includes(this.sidebarEl)||h.includes(this.host))&&f.stopImmediatePropagation()};window.addEventListener("keydown",s,!0),window.addEventListener("keyup",s,!0),window.addEventListener("keypress",s,!0),this.apiKeyInput.addEventListener("input",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:f})});let i=this.shadow.querySelector("#eq-keys-collapsible"),c=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),m=f=>{i&&(f?(i.style.display="none",c&&(c.style.transform="rotate(0deg)")):(i.style.display="block",i.style.maxHeight="none",i.style.overflow="visible",c&&(c.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}m(d),u?.addEventListener("click",f=>{if(f.target?.closest("a"))return;let h=i?.style.display==="none";m(!h);try{localStorage.setItem("easyquiz_keys_collapsed",h?"false":"true")}catch{}}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!f){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let h=I.addKey(f);if(h.ok){let g=I.exportRawKeys();this.callbacks.onSettingsChange({apiKey:g[0],apiKeys:g}),this.apiKeyInput.value="",this.setStatus(`\u2713 Nova chave adicionada com sucesso! (${g.length} chaves ativas no pool)`,"success"),m(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Oe(f).then(v=>{v.ok?(I.markSuccess(f,100),this.setStatus("\u2713 Nova chave validada com sucesso no Google AI Studio!","success")):(I.markInvalid(f,v.message),this.setStatus(`\u26A0\uFE0F Chave cadastrada, mas aviso retornado: ${v.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(h.message,"warning")}),this.keyMoreBtn.addEventListener("click",f=>{f.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",f=>{let h=f.target;!h.closest("#eq-key-context-menu")&&!h.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(f!==null&&f.trim()){let h=f.trim().replace(/^["']|["']$/g,""),g=I.addKey(h);if(g.ok){let v=I.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(g.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let f=await navigator.clipboard.readText();if(f){let h=f.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=h,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let f=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(f!==null&&f.trim()){let h=f.trim().replace(/^["']|["']$/g,"");if(I.addKey(h).ok){let v=I.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=this.apiKeyInput.type==="password";this.apiKeyInput.type=f?"text":"password";let h=this.shadow.querySelector("#eq-menu-vis-icon"),g=this.shadow.querySelector("#eq-menu-vis-text");h&&(h.innerHTML=f?A.eyeOff:A.eye),g&&(g.textContent=f?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let f=document.createElement("div");f.id="eq-bulk-overlay",f.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let h=document.createElement("div");h.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),h.innerHTML=`
      ...
      `,f.appendChild(h),this.shadow.appendChild(f);let g=h.querySelector("#eq-bulk-ta"),v=h.querySelector("#eq-bulk-status"),T=h.querySelector("#eq-bulk-import"),C=h.querySelector("#eq-bulk-paste-btn"),w=h.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>g?.focus());let E=()=>{f.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(H=>{f.addEventListener(H,P=>{P.stopPropagation(),P.stopImmediatePropagation()},!0)}),f.addEventListener("keydown",H=>{H.key==="Escape"&&E()}),f.addEventListener("click",H=>{H.target===f&&E()}),h.querySelector("#eq-bulk-x")?.addEventListener("click",E),h.querySelector("#eq-bulk-cancel")?.addEventListener("click",E),w.addEventListener("click",()=>{g.value="",v.textContent="",g.focus()}),C.addEventListener("click",async()=>{try{let H=await navigator.clipboard?.readText();H?(g.value=H,g.focus(),v.style.color="#38bdf8",v.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(v.style.color="#fbbf24",v.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{v.style.color="#fbbf24",v.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",g.focus()}}),h.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let H=g.value.trim();if(!H){v.style.color="#f87171",v.textContent="Insira pelo menos uma chave de API antes de importar.";return}let P=H.match(/AIza[0-9A-Za-z\-_]{35}/g),V=[];if(P&&P.length>0?V=Array.from(new Set(P)):V=Array.from(new Set(H.split(/[\n,;\s]+/).map(z=>z.trim().replace(/^["'`]|["'`]$/g,"")).filter(z=>z.length>=20))),V.length===0){v.style.color="#f87171",v.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}v.style.color="#00e5ff",v.textContent=`Processando ${V.length} chave(s)...`,T.disabled=!0,T.style.opacity="0.6";let L=0,U=0;for(let z of V){let B=I.addKey(z);B.ok?L++:B.message.includes("j\xE1 est\xE1 cadastrada")&&U++}if(L>0){let z=I.exportRawKeys();this.callbacks.onSettingsChange({apiKey:z[0],apiKeys:z}),m(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}v.textContent=`${L} adicionada(s), ${U} duplicada(s). Validando modelo em paralelo...`;let te=I.exportRawKeys(),oe=this.modelSelect?.value||"gemini-3.5-flash-lite",k=await et(oe,te);k.ok?(I.markSuccess(k.key,200),v.style.color="#4ade80",v.textContent=`\u2713 ${L} adicionada(s), ${U} duplicada(s). Modelo '${k.model}' pronto!`):(v.style.color="#fbbf24",v.textContent=`${L} adicionada(s), ${U} duplicada(s). Aviso: ${k.message}`),this.renderKeysList(),T.disabled=!1,T.style.opacity="1",L>0&&(this.setStatus(`\u2713 Lote importado: ${L} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(E,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let f=I.exportRawKeys(),h=document.createElement("div");h.id="eq-text-editor-overlay",h.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let g=document.createElement("div");g.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),g.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
