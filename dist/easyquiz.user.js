 ...
 */
"use strict";(()=>{var ne={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function O(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ge="easyquiz_settings_v2",se="easyquiz_activity_metrics";function Fe(){try{let o=localStorage.getItem(Ge);if(!o){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let s=JSON.parse(r);return{...ne,apiKey:s.apiKey||""}}return{...ne}}let e=JSON.parse(o),t=typeof e.model=="string"&&O(e.model)?e.model:ne.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&i&&(a=[i]),{apiKey:a[0]||i||ne.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ne.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ne.confidenceThreshold}}catch{return{...ne}}}function wt(){try{localStorage.removeItem(Ge),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(se),sessionStorage.removeItem(se);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Qe()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function xe(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ue(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...xe(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function Et(o){let e=Fe(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let i={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ge,JSON.stringify(i))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return i}var ie=[],qt=12,Ft=1200;function Ct(o){let e=o.trim().replace(/\s+/g," ").slice(0,Ft);e&&!ie.includes(e)&&(ie.push(e),ie.length>qt&&(ie=ie.slice(-qt)))}function ke(){return ie}function Qe(){ie=[]}function Tt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var ye=Tt();function de(){try{localStorage.removeItem(se)}catch{}return ye}function Ut(o){ye=o;try{let e=JSON.stringify(o);sessionStorage.setItem(se,e),localStorage.removeItem(se)}catch{}}function Ye(o){let e=ye,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let i={...o,timestamp:t},n=[...e.records,i],r=n.filter(d=>d.status==="answered"||d.status==="verified").length,s=n.reduce((d,h)=>d+h.durationMs,0),l=r>0?Math.round(s/r):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:r,averageDurationMs:l,records:n};return Ut(c),c}function qe(){ye=Tt();try{sessionStorage.removeItem(se),localStorage.removeItem(se)}catch{}return ye}var At=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown ou conversa.
...
`;function Qt(o,e){return/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/forms\.google|docs\.google.*forms/i.test(o)||e.includes("Qr7Oae")?"[PLATAFORMA: Google Forms \u2014 IDs via data-item-id, data-params]":/wayground|quizizz/i.test(o)||e.includes("data-functional-selector")?"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function we(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(p=>p.type==="draggable"||p.type==="dropzone"),i=/katex|latex|math|matrix|formula|frac|\$|\^|\_/i.test(o.htmlSnippet)||/calcular|calcule|resolva|matriz|equação|função|probabilidade|geometria|fórmula|coordenada|sistema/i.test(o.questionText),r=o.questionText.length<150||a||i?`
[HTML]:
${o.htmlSnippet.slice(0,1800).replace(/\s+/g," ")}`:"",s=ke(),l=s.length>0?`
[MEM\xD3RIA]:
${s.join(" | ")}
`:"",c=o.controls.filter(p=>p.role!=="navigation"),d=o.controls.filter(p=>p.role==="navigation"),h=Qt(o.sourceUrl,o.htmlSnippet),u=h?`
${h}
`:"";return`--- AN\xC1LISE ---
[MODO]: ${t.engine} | Dica: ${t.modeHint||"Auto"}
[URL]: ${o.sourceUrl}
[P\xC1GINA]: ${o.pageTitle}${l}${u}
[DADOS]
[TEXTO]:
${o.questionText}${r}

[RESPOSTAS]:
${(()=>{if(c.length===0)return"Nenhuma";let p=c.filter(g=>g.type==="checkbox"||g.type==="chk"),f=new Set(c.filter(g=>g.type==="radio").map(g=>g.name).filter(Boolean)),v=p.filter(g=>!g.name||!f.has(g.name)).length>=2,m=c.every(g=>g.type==="radio"||g.type==="chk")&&f.size>=1&&!v;return(v?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:m?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:"")+JSON.stringify(c.map(g=>({id:g.id,t:g.type,n:g.name||void 0,txt:g.label,v:g.value||void 0,opt:g.options.length?g.options:void 0})))})()}
...
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Yt=new Set(["question","info","start","conclusion"]),Jt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Xt=new Set(["val","chk","sel","clk","adv","js","drag"]),Wt=150,Ee=2e3;function Q(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Ee):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Ee):e}function Zt(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!Xt.has(a))return null;if(a==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...Q(s)?{id:Q(s,"").slice(0,500)}:{}}}if(a==="drag"){let s=Q(t.from??t.source),l=Q(t.to??t.target??t.destination);return!s||!l?null:{t:"drag",from:s.slice(0,500),to:l.slice(0,500)}}if(a==="js"){let s=Q(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&a==="val"&&(i="1");let n=Q(i).slice(0,500);if(!n)return null;if(a==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:Q(s).slice(0,Ee)}}if(a==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,c=(Array.isArray(s)?s:[s]).map(d=>Q(d).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:c}}if(a==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",l={t:"chk",id:n,c:!s};return t.v!==void 0&&(l.v=Q(t.v).slice(0,Ee)),l}let r={t:"clk",id:n};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!s}return t.v!==void 0&&(r.v=Q(t.v).slice(0,Ee)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(r.co=[t.co[0],t.co[1]]),r}function eo(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),i=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let n=i.filter(r=>r.t==="chk"||r.t==="clk");if(n.length>1){let r=i.filter(l=>l.t!=="chk"&&l.t!=="clk"),s=n[n.length-1];i=[...r,s]}}else if(e==="escolha_multipla"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let n=new Set;i=i.filter(r=>{let s="id"in r&&typeof r.id=="string"?r.id:"";return s?n.has(s)?!1:(n.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,r=[...i].reverse(),s=[];for(let l of r){let c="id"in l&&typeof l.id=="string"?l.id:"";c?n.has(c)||(n.add(c),s.push(l)):s.push(l)}i=s.reverse()}return[...i,...a]}function Lt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!Yt.has(t))&&(t="question"),(typeof a!="string"||!Jt.has(a))&&(a="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],n=[];for(let l=0;l<Math.min(i.length,Wt);l++){let c=Zt(i[l],l);c&&n.push(c)}n=eo(n,a,t);let r=n.some(l=>l.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?r||n.push({t:"adv"}):t==="question"&&!r&&n.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:s,rationale:Q(e.rationale,"Plano validado e auto-recuperado."),actions:n,...Q(e.memoryToStore)?{memoryToStore:Q(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var ee=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear(),Array.from(new Set(e.map(i=>i.trim().replace(/^["']|["']$/g,"")).filter(i=>i.length>5))).forEach((i,n)=>{let r=this.generateId(i),s=t.get(r)||t.get(i);this.keys.set(r,{id:r,key:i,label:s?.label||`Chave ${n+1}`,addedAt:s?.addedAt||Date.now(),lastUsedAt:s?.lastUsedAt,lastLatencyMs:s?.lastLatencyMs,cooldownUntil:s?.cooldownUntil,errorCount:s?.errorCount||0,lastError:s?.lastError,winCount:s?.winCount||0})})}generateId(e){let t=0;for(let a=0;a<e.length;a++)t=(t<<5)-t+e.charCodeAt(a),t|=0;return`key_${Math.abs(t).toString(36).slice(0,8)}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<5)}getBestKey(){let e=this.getHealthyKeys();if(e.length>0)return e.sort((a,i)=>{let n=a.lastLatencyMs??99999,r=i.lastLatencyMs??99999;return n-r}),e[0].key;let t=Array.from(this.keys.values());return t.length>0?(t.sort((a,i)=>(a.cooldownUntil||0)-(i.cooldownUntil||0)),t[0].key):""}getDiverseKeys(e){let t=this.getHealthyKeys();if(t.length===0){let i=this.getBestKey();return i?[i]:[]}t.sort((i,n)=>{let r=i.lastLatencyMs??99999,s=n.lastLatencyMs??99999;return r-s});let a=[];for(let i=0;i<e;i++){let n=t[i%t.length];a.push(n.key)}return a}markQuotaHit(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${t/1e3}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${t/1e3}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(a);if(this.keys.has(i))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let n={id:i,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,n),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:n}}updateKey(e,t,a){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=n,a!==void 0&&(i.label=a.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},k=new ee;var ue=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico)",description:"Modelo econ\xF4mico de alta velocidade para volume elevado.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Legacy R\xE1pido)",description:"Modelo legacy com zero-thinking suportado. Ultra-baixa lat\xEAncia.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Legacy Avan\xE7ado)",description:"Modelo legacy avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Je=["gemini-3.5-flash-lite","gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"],to={"gemini-2.5-flash":"gemini-3.6-flash","gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash"};function Xe(o){return to[o]??o}var Ce=null;function oo(o){let e={temperature:0,maxOutputTokens:1200,response_mime_type:"application/json",response_schema:no};return/gemini-3\.[567]-flash/i.test(o)?e.thinkingConfig={thinkingLevel:"none"}:/gemini-3\.[89]|gemini-3\.[1-9][0-9]/i.test(o)?e.thinkingConfig={thinkingLevel:"low"}:/gemini-2\.5-flash/i.test(o)&&(e.thinkingConfig={thinkingBudget:0}),e}var no={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function St(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");return!e||!O(e)?"gemini-3.5-flash-lite":e}function kt(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function ao(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Ht=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&O(a.id));return t.length>0?t:null}return null}catch{return null}})(),He=new Set;async function ze(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return ue;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let i=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let r=await i.text(),s=kt(r,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let n=await i.json();if(Array.isArray(n.models)&&n.models.length>0){let r=n.models.filter(s=>{let l=s.supportedGenerationMethods||[],c=(s.name||"").replace(/^models\//,""),d=l.includes("generateContent");return O(c)&&d}).map(s=>{let l=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),d=s.displayName||c;return{id:c,name:d.includes(c)?d:`${d} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:l.includes("generateContent"),supportedGenerationMethods:l,discoveredAt:Date.now()}});if(r.length>0){r.sort((s,l)=>{let c=d=>d==="gemini-3.8-flash"?200:d==="gemini-3.7-flash"?190:d==="gemini-3.6-flash"?180:d==="gemini-3.5-flash"?170:d==="gemini-3.5-flash-lite"?160:d==="gemini-2.5-flash"?130:d.includes("flash")?80:d==="gemini-2.5-pro"?60:d.includes("pro")?50:10;return c(l.id)-c(s.id)}),Ht=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return ue}async function $e(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await ze(e);if(a.length>0&&a!==ue){let i=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let i of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${i}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${i})!`,models:ue}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function We(o,e){let t=e.map(c=>c.trim().replace(/^["']|["']$/g,"")).filter(c=>c.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=Xe(St(o)),i=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function r(c,d,h){let u=new AbortController,p=setTimeout(()=>u.abort(),h);try{let f=`https://generativelanguage.googleapis.com/v1beta/models/${d}:generateContent?key=${encodeURIComponent(c)}`,y=await fetch(f,{method:"POST",headers:{...n,"x-goog-api-key":c},body:i,signal:u.signal});if(clearTimeout(p),y.ok)return{ok:!0,model:d,key:c,message:`Modelo '${d}' validado com sucesso!`};let v=await y.text().catch(()=>"");throw new Error(`HTTP ${y.status}: ${v.slice(0,80)}`)}catch(f){throw clearTimeout(p),f}}if(t.length>=2){let c=t.slice(0,6);try{return await Promise.any(c.map(h=>r(h,a,8e3)))}catch{}}let s=t[0],l=[a,...Je.filter(c=>c!==a)];for(let c of l)try{let d=await r(s,c,4e3);return c!==a&&(d.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${c}'.`),d}catch{}return{ok:!1,model:a,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function io(o,e,t,a,i){let n=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${o}`),l={...oo(o)};for(let c of n){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let d=`https://generativelanguage.googleapis.com/${c}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,h=Date.now();try{let u=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:l}),signal:i,keepalive:a});if(!u.ok){let y=await u.text();if(u.status===400&&l.thinkingConfig&&/thinking/i.test(y)){delete l.thinkingConfig;let m=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:l}),signal:i,keepalive:a});if(m.ok){let b=await m.json(),g=b.candidates?.[0];if(g?.content?.parts?.[0]?.text)return k.markSuccess(e,Date.now()-h),{rawText:g.content.parts[0].text,data:b,usedModel:o,usedKey:e}}}let v=kt(y,u.status);if(u.status===404&&c==="v1beta")continue;throw u.status===429?k.markQuotaHit(e,5e3):u.status===503||/no capacity|overloaded|unavailable/i.test(y)?(k.markOverloaded(e,5e3),He.add(o)):u.status===403||/API_KEY_INVALID/i.test(y)?k.markInvalid(e,v):u.status===404&&He.add(o),new Error(`[${o}|${ee.maskKey(e)}] ${v}`)}let p=await u.json(),f=p.candidates?.[0];if(!f||!f.content?.parts?.[0]?.text)throw new Error(`[${o}|${ee.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return k.markSuccess(e,Date.now()-h),{rawText:f.content.parts[0].text,data:p,usedModel:o,usedKey:e}}catch(u){if(i.aborted)throw u;r=u;let p=r.message||"";if(p.includes("404")||/no longer available/i.test(p)){He.add(o);break}}}throw r}var Ie=new Map;function Mt(o){let e=Ie.get(o);return e===void 0?!1:Date.now()>e?(Ie.delete(o),!1):!0}function so(o,e=6e4){Ie.set(o,Date.now()+e)}function It(){Ie.clear()}async function Ze(o,e,t,a,i){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let n=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];k.init(n);let r=t.apiKey.trim().replace(/^[\"']|[\"']$/g,""),s=k.getBestKey()||r;if(!s)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=St(t.model);if(!Ht&&s&&ze(s).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let c=Date.now(),d=we(o,e,t),h=[{text:d}];for(let S=0;S<e.length;S++){let I=e[S],$=I.associatedLabel||(I.alt?`Imagem: ${I.alt}`:`Imagem ${S+1}`);h.push({text:`[ANEXO VISUAL ${S+1} - V\xCDNCULO: ${$}]:`}),h.push({inline_data:{mime_type:I.mediaType,data:I.base64}})}let u={system_instruction:{parts:[{text:At}]},contents:[{role:"user",parts:h}]},p=!0;He.clear();let f=Xe(l),y=Ce?Xe(Ce):null,v=[];y&&O(y)&&y!==f&&v.push(y);for(let S of Je)S!==f&&!v.includes(S)&&v.push(S);let m=[];O(f)&&m.push(f);for(let S of v)O(S)&&!m.includes(S)&&m.push(S);m.length<2&&m.push(...Je.filter(S=>!m.includes(S)));let b=k.getHealthyKeys().filter(S=>!Mt(S.key)).sort((S,I)=>(S.lastLatencyMs??99999)-(I.lastLatencyMs??99999)),g=k.getAllKeys().filter(S=>!Mt(S.key)),x=b.length>0?b:g.map(S=>({key:S.key,lastLatencyMs:S.lastLatencyMs,label:S.label})),T=new Set;function A(S,I,$,Z){let F=[];for(let U of I){for(let Y of S){let W=`${Y.key}::${U}`;!T.has(W)&&F.length<$&&(F.push({model:U,key:Y.key,label:Y.label||"Chave",timeout:Z}),T.add(W))}if(F.length>=$)break}return F}let w=async(S,I)=>{if(I.length===0||i?.aborted)return null;let $=I.map(()=>new AbortController),Z=()=>$.forEach(U=>{try{U.abort()}catch{}});i?.addEventListener("abort",Z,{once:!0});let F=I.map(U=>`${U.model.replace("gemini-","")}/${U.label}`).join(" | ");a?.(`\u26A1 ${S}: ${I.length} slot(s) [${F}]...`,"info");try{let U=I.map(async(W,vt)=>{let je=$[vt],yt=setTimeout(()=>{try{je.abort(new Error(`Timeout ${W.timeout/1e3}s (${W.model}|${W.label})`))}catch{je.abort()}},W.timeout);try{let j=await io(W.model,W.key,u,p,je.signal);clearTimeout(yt);let J=Lt(ao(j.rawText));return J.usedModel=j.usedModel,J.durationMs=Date.now()-c,J.promptSent=d,J.tokensUsed=j.data.usageMetadata?.totalTokenCount,J.promptTokens=j.data.usageMetadata?.promptTokenCount,J.candidatesTokens=j.data.usageMetadata?.candidatesTokenCount,J.rawResponse=j.rawText,$.forEach((xt,Gt)=>{if(Gt!==vt)try{xt.abort(new Error("Cancelado: vencedor respondeu."))}catch{xt.abort()}}),{plan:J,rawUsage:j.data.usageMetadata,usedModel:j.usedModel,usedKey:j.usedKey,slotLabel:W.label}}catch(j){clearTimeout(yt);let J=j instanceof Error?j.message:String(j);throw(J.includes("429")||J.includes("Quota")||J.includes("RESOURCE_EXHAUSTED"))&&so(W.key,6e4),j}}),Y=await Promise.any(U);return i?.removeEventListener("abort",Z),k.markWinner(Y.usedKey),Y.usedModel!==f&&(Ce=Y.usedModel),Y}catch{return i?.removeEventListener("abort",Z),null}},E=x.length,H=E<=1?1:E<=3?2:3,R=/pro/i.test(f),V=(S,I)=>{let $=I?/pro/i.test(I):R;return S===0?$?15e3:1e4:S===1?$?18e3:13e3:$?22e3:16e3},B=6,_=0,ce="";for(;_<B;){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let S=m.find(U=>!Array.from(T).some(Y=>Y.startsWith(`${x[0]?.key}::${U}`)))??m[0],I=V(_,S),$=A(x,m,H,I);if($.length===0)break;let Z=_===0?"Onda 1":`Onda ${_+1}`,F=await w(Z,$);if(F){let U=F.plan.durationMs||Date.now()-c,Y=ee.maskKey(F.usedKey);return a?.(`\u2705 ${U}ms via '${F.usedModel}' (${F.slotLabel}: ${Y})`,"info"),F}_++}throw new Error(ce||"Todas as ondas falharam. Verifique sua cota e conex\xE3o com a internet.")}var ro=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Te(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function et(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function zt(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(ro.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var pe=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),Pe=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,lo=0;function tt(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!he(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function N(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function M(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||he(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${N(e.id)}"]`);if(n&&tt(n))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&tt(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return tt(e)}function co(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function z(o,e=500){return co(o).replace(/\s+/g," ").trim().slice(0,e)}function uo(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(lo+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function he(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Ae=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function D(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(he(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),r=String(a.getAttribute?.("title")||""),s=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",l=z(a.textContent,60);return!!(Ae.test(i)||Ae.test(n)||Ae.test(r)||Ae.test(s)||l.length>0&&l.length<=25&&Ae.test(l))}function oe(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||he(o)||D(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=z(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,i=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return Pe.test(i)||Pe.test(t)||a==="submit"||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")||!1}function ot(o){let e=o.closest("tr");if(e){let l=e.querySelector("th, td:first-child"),c=l&&l!==o.closest("td")?z(l.textContent,100):"",d=z(o.closest("label, td")?.textContent||"",50);if(c&&d)return`${c}: ${d}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let l=t.querySelector('.dropdown-label, [class*="label" i]'),c=l&&l!==o?z(l.textContent,150):"";if(c)return c}let a=o.getAttribute("aria-label");if(a)return z(a);let i=o.getAttribute("aria-labelledby");if(i){let l=i.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(l.trim())return z(l)}if("labels"in o&&o.labels){let l=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(l.trim())return z(l)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let l=z(n.textContent);if(l)return l}let r=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||r||"";return z(s)}function nt(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(n)?n:"other",s=o.getAttribute("role")||"",l=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),d=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(l)||/drag|card-item|sortable/i.test(c),h=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(l)||/dropzone|category-box|bucket|target-zone/i.test(c),p=z((d?"draggable":h?"dropzone":"")||i.type||s||r,40),f="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox")f=i.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(r==="button"||n==="a"||e==="navigation"||oe(o))f="";else{let x=typeof o.value=="string"||typeof o.value=="number"?o.value:"";f=z(x||o.getAttribute("data-category")||"",2e3)}let y=[];if(a&&a.options)for(let x of Array.from(a.options).slice(0,80))y.push({value:z(x.value),label:z(x.textContent)});else if(s==="combobox"||s==="listbox"||c.includes("select")||c.includes("dropdown")){let x=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),T=x?document.getElementById(x):o;if(T){let A=T.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let w of Array.from(A).slice(0,80)){let E=z(w.textContent);E&&y.push({value:w.getAttribute("data-value")||w.getAttribute("value")||E,label:E})}}}let v=!!(i.required||o.getAttribute("aria-required")==="true"),m=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),b=uo(o);return{id:o.id||b,tag:r,type:p,label:ot(o),name:z(i.name||o.getAttribute("name")||"",180),value:f,options:y,required:v,disabled:m,role:e}}var $t=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Pt(o){if(!M(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(pe)).filter(M),a=z(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),r=Math.min(1,n/i),s=e.top+e.height/2,l=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=a>40?35:0,d=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+c+d-r*20-l*10}function Re(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let i=z(e.innerText||e.textContent||"",1e4),n=z(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(pe).length,s=t.querySelectorAll(pe).length;if(i.length<150&&n.length>i.length&&s<=r+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Rt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&M(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function K(){let o=document.activeElement;if(o&&o!==document.body){let n=o.closest($t);if(n&&Pt(n)>0)return Re(n)}let t=Array.from(document.querySelectorAll($t)).map(n=>({element:n,score:Pt(n)})).filter(n=>Number.isFinite(n.score)).sort((n,r)=>r.score-n.score),a=t.find(n=>{let r=n.element.tagName.toLowerCase();return r!=="main"&&r!=="body"&&n.score>0});if(a)return Re(a.element);if(t.length>0&&t[0].score>0)return Re(t[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&M(i)?i:document.body}function Bt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let i of Array.from(a.attributes))t.includes(i.name)||a.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Be(o){let e=Array.from(o.querySelectorAll(pe)),t=new Set,a=[];for(let i of e){if(!M(i)||oe(i)||D(i))continue;let n=i.tagName.toLowerCase();["input","textarea","select"].includes(n)&&(t.add(i),a.push(i))}for(let i of e){if(!M(i)||oe(i)||D(i))continue;let n=i.tagName.toLowerCase();if(["input","textarea","select"].includes(n))continue;let r=i.querySelector("input, textarea, select");if(!(r&&t.has(r))){if(i.hasAttribute("for")){let s=i.getAttribute("for"),l=s?i.ownerDocument.getElementById(s):null;if(l&&t.has(l))continue}if(n==="a"){let s=i.getAttribute("role");if(!(s==="button"||s==="radio"||s==="checkbox"||s==="option"||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(i)}}return a.slice(0,100).map(i=>nt(i,"answer"))}function at(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let i of e)for(let n of Array.from(i.querySelectorAll(pe)))if(!(t.has(n)||!M(n)||!oe(n)||D(n))&&(t.add(n),a.push(nt(n,"navigation")),a.length>=10))return a;return a}function Le(o=!1){let e=K();e=Re(e),o&&(e=Rt(e));let t=Be(e),a=at(e);if(t.length===0){let s=Be(document.body);s.length>0&&(e=Rt(e),t=Be(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=at(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=z(i,16e3),r=[...t,...a].slice(0,120);return!n||r.length===0&&n.length<30?z(document.body.innerText||document.body.textContent||"",16e3).length>=30?me():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:Bt(e),controls:r,scope:e}}function me(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=z(o,16e3),t=Be(document.body),a=at(document.body),i=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Bt(n).slice(0,15e3),controls:i,scope:n}}function Nt(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function P(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function q(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function G(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let i=o.ownerDocument.getElementById(a);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return G(a)}return o}function Dt(o){let e=o;if(!e||!document.contains(e))try{e=K()}catch{}e=e||document.body;let t=Array.from(e.querySelectorAll("tr")).filter(n=>M(n)&&n.querySelector('input[type="radio"], input[type="checkbox"]'));if(t.length>1)return t;let a=Array.from(e.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(n=>M(n)&&!P(n));return a.length>0?a:Array.from(e.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(n=>M(n)&&!P(n)).filter(n=>!n.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'))}function L(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let n=N(i),r=document.querySelector(`[data-easyquiz-id="${n}"]`);if(r&&!P(r)&&M(r))return G(r);try{let u=document.getElementById(i);if(u&&!P(u)&&M(u))return u.hasAttribute("data-category")||u.hasAttribute("data-dropzone")||u.classList.contains("dnd-zone")?u:G(u)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let u=parseInt(s[1],10);if(t){let f=document.body;try{f=K()||document.body}catch{}let y=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>M(v)&&!P(v));if(u>=1&&u-1<y.length)return y[u-1];if(u===0&&y.length>0)return y[0]}let p=u-1;if(p>=0){let f=Dt();if(p<f.length){let m=f[p];if(m.tagName.toLowerCase()==="tr"){if(e){let g=m.querySelector(`input[value="${N(e)}" i], [data-value="${N(e)}" i]`);if(g)return g}let b=m.querySelector("input");if(b)return b}return G(m)}let y=document.body;try{y=K()||document.body}catch{}let v=Array.from(y.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(m=>M(m)&&!P(m));if(p<v.length)return v[p]}}let l=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(l){let u=l[1].toUpperCase().charCodeAt(0)-65;if(u>=0){let p=Dt();if(u<p.length){let f=p[u];if(f.tagName.toLowerCase()==="tr"){if(e){let v=f.querySelector(`input[value="${N(e)}" i], [data-value="${N(e)}" i]`);if(v)return v}let y=f.querySelector("input");if(y)return y}return G(f)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let p=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(m=>M(m)&&!P(m));if(p)return p;let y=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(m=>M(m)&&!P(m));if(y)return G(y);let v=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(m=>{if(!M(m)||P(m))return!1;let b=q(m.textContent).toLowerCase();return b===i.toLowerCase()||b===i.toLowerCase()+")"});if(v)return G(v)}try{let p=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`)).find(f=>M(f)&&!P(f));if(p)return p.hasAttribute("data-category")||p.hasAttribute("data-dropzone")||p.classList.contains("dnd-zone")?p:G(p)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let p=Array.from(document.querySelectorAll(i)).find(f=>M(f)&&!P(f));if(p)return G(p)}catch{}try{let u=i.replace(/"/g,""),p=`//button[normalize-space(.)="${u}"] | //a[normalize-space(.)="${u}"] | //*[not(*) and normalize-space(.)="${u}"] | //*[@aria-label="${u}"] | //*[@data-category="${u}"] | //*[@data-testid="${u}"]`,f=document.evaluate(p,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let y=0;y<f.snapshotLength;y++){let v=f.snapshotItem(y);if(v&&M(v)&&!P(v)){if(["body","html"].includes(v.tagName.toLowerCase())){let b=v.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&M(b))return G(b)}return v.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(v)}}}catch{}let d=q(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let u of h){if(!M(u)||P(u)||u.closest("header, nav, .stepper, .step-item, .progress-bar-container")||D(u)||!!(u.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||u.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!u.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let f=q(u.textContent).toLowerCase(),y=q(u.getAttribute("aria-label")||"").toLowerCase(),v=q(u.getAttribute("placeholder")||"").toLowerCase(),m=q(u.getAttribute("title")||"").toLowerCase(),b=q(u.getAttribute("name")||"").toLowerCase(),g=q(u.getAttribute("data-category")||"").toLowerCase(),x=u instanceof HTMLInputElement||u instanceof HTMLButtonElement?u.value:"",T=q(x).toLowerCase(),A=f.startsWith(d+")")||f.startsWith(d+".")||f.startsWith(d+" -")||f.startsWith(d+":");if(f===d||y===d||v===d||m===d||b===d||g&&g===d||T&&T===d||A)return u.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(u)}if(d.length>=3)for(let u of h){if(!M(u)||P(u)||u.closest("header, nav, .stepper, .step-item, .progress-bar-container")||D(u)||!!(u.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||u.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!u.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let f=q(u.textContent).toLowerCase(),y=q(u.getAttribute("aria-label")||"").toLowerCase(),v=q(u.getAttribute("placeholder")||"").toLowerCase(),m=q(u.getAttribute("title")||"").toLowerCase(),b=q(u.getAttribute("name")||"").toLowerCase();if(f.includes(d)||y.includes(d)||v.includes(d)||m.includes(d)||b.includes(d)){if(Array.from(u.children).some(A=>{let w=q(A.textContent).toLowerCase();return w&&w.includes(d)}))continue;return u.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(u)}let g=d.split(/\s+/).filter(Boolean);if(g.length>=3){let x=g.slice(0,Math.min(5,g.length)).join(" ");if(f.includes(x)||y.includes(x)||v.includes(x))return G(u)}}return null}function st(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function X(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){te(t,!0);return}if(t.type==="radio"){te(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement||typeof HTMLAnchorElement<"u"&&o instanceof HTMLAnchorElement||o.tagName?.toLowerCase()==="a"||o.tagName?.toLowerCase()==="button"||typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let i=o.getBoundingClientRect(),n=e?e[0]:Math.round(i.left+Math.max(1,i.width/2)),r=e?e[1]:Math.round(i.top+Math.max(1,i.height/2)),s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerdown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function Ne(o,e){let t=o;if(t.hasAttribute("for")){let c=t.getAttribute("for"),d=t.ownerDocument.getElementById(c);d&&(t=d)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){De(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){De(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)t=c;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let u=t.nextElementSibling;for(;u;){if(u instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(u.type)||u instanceof HTMLTextAreaElement||u instanceof HTMLElement&&u.isContentEditable){t=u;break}let p=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){t=p;break}u=u.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let c=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{let d=document.body;try{d=K()||document.body}catch{}let h=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=document.body;try{c=K()||document.body}catch{}let d=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d)t=d;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;te(t,c);return}let r=String(e??""),s=r;if(t instanceof HTMLInputElement&&t.type==="number"){let c=r.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(s=c)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let l=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}l=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}l=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(s===""?" ":"")}catch{}let c=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(c,"value")?.set;d?d.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{d?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Me(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=q(t),n=L(t)||L(i);if(!n)return a?e:i||e;let r=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let h=q(r.textContent);if(h&&h.length>0&&h.length<150)return h}if(n.id){let h=document.querySelector(`label[for="${N(n.id)}"]`);if(h){let u=q(h.textContent);if(u&&u.length>0&&u.length<150)return u}}let s=n.getAttribute("aria-label");if(s)return q(s);let l=n.getAttribute("placeholder");if(l)return q(l);let c=q(n.textContent);if(c&&c.length>0&&c.length<120)return c;let d=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return d?q(d):a?e:i||e}function te(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let i=e?"true":"false";t.setAttribute("aria-checked",i),t.setAttribute("aria-selected",i),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(a){let i=!!a._valueTracker,n=a.checked===e;if(n&&a.type==="radio"&&!i)return;if(n&&i){try{let r=a._valueTracker;r&&r.setValue(!e)}catch{}st(a,["click","input","change"]);return}try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let r=a._valueTracker;r&&r.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,st(a,["input","change"])}}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false");return}try{t.focus?.()}catch{}try{t.click()}catch{X(t)}}}function De(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let r=e.map(c=>q(c).toLowerCase()),s=!1,l=(c,d)=>{c.selected=!0,t.selectedIndex=d;try{t.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,c.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(c.value)}catch{}s=!0};for(let c=0;c<t.options.length;c++){let d=t.options[c],h=d.value.toLowerCase(),u=q(d.textContent).toLowerCase();if(r.some(f=>f===h||f===u)){if(l(d,c),!t.multiple)break}else t.multiple||(d.selected=!1)}if(!s)for(let c of r){let d=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(d){let h=parseInt(d[1],10),p=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(p>=0&&p<t.options.length&&(l(t.options[p],p),!t.multiple))break}}if(!s){for(let c of r)if(/^[a-z]$/i.test(c)){let d=c.toUpperCase().charCodeAt(0)-65,u=t.options[0]?.value===""||t.options[0]?.disabled?d+1:d;if(u>=0&&u<t.options.length&&(l(t.options[u],u),!t.multiple))break}}if(!s){let c=d=>d.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let d=0;d<t.options.length;d++){let h=t.options[d],u=c(h.value.toLowerCase()),p=c(q(h.textContent).toLowerCase());if(r.some(y=>{let v=c(y);return u.includes(v)||p.includes(v)||v.length>2&&(v.includes(u)||v.includes(p))})&&(l(h,d),!t.multiple))break}}if(s){st(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&X(a);let i=e.map(r=>q(r).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>M(r)&&!P(r));for(let r of i){let s=n.find(c=>{let d=q(c.textContent).toLowerCase(),h=q(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return d===r||h===r||d.includes(r)||r.length>2&&r.includes(d)});if(s){X(s);let c=s.querySelector('input[type="radio"], input[type="checkbox"]');c&&te(c,!0);return}let l=L(r);if(l){X(l);return}}}function po(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function it(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function ae(o,e){let t=q(o).toLowerCase();if(!t)return null;let a=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',i=Array.from(document.querySelectorAll(a)),n=e==="destination"?i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t)):null;return n&&M(n)&&!P(n)?n:i.find(r=>{if(!M(r)||P(r))return!1;let s=q(`${r.textContent||""} ${r.getAttribute("data-category")||""} ${r.getAttribute("data-dropzone")||""}`).toLowerCase();return s===t||s.includes(t)})||null}async function Oe(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),i=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),r=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),l=Math.round(i.top+Math.max(1,i.height/2)),c=q(e.textContent).toLowerCase();if(c){let y=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(v=>{let m=q(v.textContent).toLowerCase(),b=v instanceof HTMLInputElement||v instanceof HTMLOptionElement?q(v.value).toLowerCase():"";return m&&(c.includes(m)||m.includes(c))||b&&(c.includes(b)||b.includes(c))});y&&(X(y),await new Promise(v=>setTimeout(v,120)))}it(o),await new Promise(f=>setTimeout(f,140)),it(e);let d=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(d&&d!==e&&it(d),await new Promise(f=>setTimeout(f,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,screenX:n,screenY:r,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",h));let u=4;for(let f=1;f<=u;f++){let y=Math.round(n+(s-n)*(f/u)),v=Math.round(r+(l-r)*(f/u)),m={...h,clientX:y,clientY:v,screenX:y,screenY:v};try{o.dispatchEvent(new PointerEvent("pointermove",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",m))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:l,screenX:s,screenY:l,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let f=po(z(o.textContent),o.outerHTML),y={...h},v={...p};f&&(y.dataTransfer=f,v.dataTransfer=f);let m=o.ownerDocument.defaultView?.DragEvent;if(!m)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new m("dragstart",y)),e.dispatchEvent(new m("dragenter",v)),e.dispatchEvent(new m("dragover",v)),e.dispatchEvent(new m("drop",v)),o.dispatchEvent(new m("dragend",y))}catch(f){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",f)}try{let f=new Touch({identifier:1,target:o,clientX:n,clientY:r}),y=new Touch({identifier:1,target:e,clientX:s,clientY:l});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[y]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(f=>setTimeout(f,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Vt={fill:(o,e)=>{let t=L(o);t?Ne(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=L(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?te(e,!0):X(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=L(o);t?te(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>L(o,e),drag:(o,e)=>{let t=ae(o,"source")||L(o),a=ae(e,"destination")||L(e);t&&a?Oe(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=ae(o,"source")||L(o),a=ae(e,"destination")||L(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Oe(t,a)},execute:(o,e=!1,t=1)=>ct(o,e,t)};typeof window<"u"&&(window.$eq=Vt);async function ho(o,e=1,t=Te()){if(et(o,t),o.t==="js"){let s=String(o.v||"");zt(s);try{new Function("$eq","document","window",s)(Vt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let s=ae(o.from,"source")||L(o.from),l=ae(o.to,"destination")||L(o.to);!s&&o.from&&(s=L(q(o.from))),!l&&o.to&&(l=L(q(o.to))),s&&l?await Oe(s,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=i!=null?String(i).trim():"",r=L(a,n,o.t==="val"||o.t==="sel");if(!r&&a&&(r=L(q(a),n,o.t==="val"||o.t==="sel")),r&&n){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(q(r.value).toLowerCase()!==q(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${N(r.name)}"][value="${N(n)}" i]`);if(s)r=s;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${N(r.name)}"]`)).find(d=>{let h=d.closest("label, .vf-label, .option-card, tr, td, div");return h&&q(h.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(r=c)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let s=r.querySelector(`input[value="${N(n)}" i], [data-value="${N(n)}" i]`);if(s)r=s;else{let c=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(d=>{let h=d.closest("label, .vf-label, .option-card, td, div");return h&&q(h.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(r=c)}}}if(!r&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=K()||document.body}catch{}let l=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(c=>M(c)&&!P(c));if(l.length===1)r=l[0];else if(l.length>1){let c=q(a).toLowerCase(),d=c.match(/^#?_?([0-9]+)$/);if(d){let h=parseInt(d[1],10);h>=1&&h<=l.length?r=l[h-1]:h>=0&&h<l.length&&(r=l[h])}r||(r=l.find(u=>{let p=(u.getAttribute("placeholder")||"").toLowerCase(),f=(u.name||"").toLowerCase(),y=(u.getAttribute("aria-label")||"").toLowerCase(),v=(u.id||"").toLowerCase(),m=q(ot(u)).toLowerCase(),b=q(u.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(c)||f.includes(c)||y.includes(c)||v.includes(c)||m&&m.includes(c)||c.length>=2&&b.includes(c)})||(l.length===1?l[0]:null))}}if(!r&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":if(r){let l=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!l){let u=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(l=u)}if(!l){let h=r.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){l=h;break}let u=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){l=u;break}h=h.nextElementSibling}}if(!l){let h=document.body;try{h=K()||document.body}catch{}let u=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>M(p)&&!P(p));u.length>0&&(l=u[0])}let c=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,d=c!=null?String(c):"";Ne(l||r,d)}break;case"chk":r&&te(r,!!o.c);break;case"sel":if(r){let l=Array.isArray(o.v)?o.v:[String(o.v)];De(r,l)}break;case"clk":if(r)if(!!(r.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let c=o.c!==void 0?!!o.c:!0;te(r,c)}else X(r,o.co);break;case"adv":let s=rt(o.id);if(s){await lt(s,1200);let l=o.id||s.textContent?.trim()||"";l&&Ue(window.location.hostname,{advanceSelector:l}),X(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function mo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!M(t)||P(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function rt(o){if(o){let n=L(o);if(n&&M(n)&&!P(n)&&!D(n))return n}try{let n=xe(window.location.hostname);if(n.advanceSelector){let r=L(n.advanceSelector);if(r&&M(r)&&!P(r)&&!D(r))return r}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(e)).filter(n=>M(n)&&!P(n)&&!n.closest("header, nav, aside")&&!D(n));for(let n of a)if(oe(n)&&!D(n))return n;for(let n of a){let r=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",s=(n.textContent||r||n.getAttribute("aria-label")||"").trim();if(Pe.test(s)&&!D(n))return n}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&M(i)&&!P(i)&&!D(i)?i:null}async function lt(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function go(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function fo(o,e=3500){let[t,a,i,n]=o.split("|"),r=parseInt(n||"0",10),s=Date.now();for(;Date.now()-s<e;){let l=window.location.href,c=document.title,d=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),h=(document.body?.innerText||document.body?.textContent||"").length;if(l!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${l}`};if(c!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${c}"`};if(Math.abs(parseInt(d)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${d}`};if(Math.abs(h-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(h-r)} chars)`};await new Promise(u=>setTimeout(u,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Ot(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let i=L(o.from)||L(q(o.from)),n=L(o.to)||L(q(o.to));i&&n&&await Oe(i,n,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=L(e,t)||L(q(e),t);if(o.t==="clk"||o.t==="chk"){if(!a&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),r=q(e).toLowerCase();a=n.find(s=>{let l=q(s.textContent).toLowerCase();return!!(q(s.value||"").toLowerCase()===r||l===r||l.startsWith(r+")")||l.startsWith("("+r+")")||l.startsWith(r+".")||l.startsWith(r+" - ")||l.startsWith(r+":")||r.length>=3&&l.includes(r))})||null}let i=o.v!==void 0?String(o.v).trim():"";if(a&&i){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(q(a.value).toLowerCase()!==q(i).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${N(a.name)}"][value="${N(i)}" i]`);if(n)a=n;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${N(a.name)}"]`)).find(l=>{let c=l.closest("label, .vf-label, .option-card, tr, td, div");return c&&q(c.textContent).toLowerCase().includes(q(i).toLowerCase())});s&&(a=s)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let n=a.querySelector(`input[value="${N(i)}" i], [data-value="${N(i)}" i]`);if(n)a=n;else{let s=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let c=l.closest("label, .vf-label, .option-card, td, div");return c&&q(c.textContent).toLowerCase().includes(q(i).toLowerCase())});s&&(a=s)}}}if(a){let n=a.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,r=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(te(r||n,s),r&&r.checked!==s){try{let l=r._valueTracker;l&&l.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(r,s)}catch{}r.checked=s,r.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),r.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let i=null;if(a&&(i=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let n=document.body;try{n=K()||document.body}catch{}let r=Array.from(n.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=q(e).toLowerCase();i=r.find(l=>{let c=(l.getAttribute("placeholder")||"").toLowerCase(),d=(l.name||"").toLowerCase(),h=(l.id||"").toLowerCase(),u=(l.getAttribute("aria-label")||"").toLowerCase();return c.includes(s)||d.includes(s)||h.includes(s)||u.includes(s)})||(r.length>0?r[0]:null)}if(i){let n=String(o.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,n)}}catch{}Ne(i,n)}return}if(o.t==="sel"){if(!a&&e){let i=Array.from(document.querySelectorAll("select")),n=q(e).toLowerCase();a=i.find(r=>{let s=(r.name||"").toLowerCase(),l=(r.id||"").toLowerCase(),c=(r.getAttribute("aria-label")||"").toLowerCase();return s.includes(n)||l.includes(n)||c.includes(n)})||null}if(a){let i=Array.isArray(o.v)?o.v:[String(o.v)];De(a,i)}return}}function ge(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let n=L(i,a,!0)||L(q(i),a,!0);if(!n){let h=document.body;try{h=K()||document.body}catch{}let u=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>M(p)&&!P(p));u.length>0&&(n=u[0])}if(!n)return!1;let r=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(r&&r.name){let h=document.querySelector(`input[type="radio"][name="${N(r.name)}"]:checked`);if(!h)return!1;let u=q(h.value).toLowerCase(),p=q(t).toLowerCase(),f=q(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===p||f===p||f.includes(p)}let s=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let u=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(s=u)}if(!s){let h=n.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){s=h;break}let u=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){s=u;break}h=h.nextElementSibling}}if(s instanceof HTMLSelectElement){let h=q(t).toLowerCase();return Array.from(s.options).some(u=>{if(!u.selected)return!1;let p=u.value.toLowerCase(),f=q(u.textContent).toLowerCase();return h===p||h===f||p.includes(h)||f.includes(h)})}let l=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??n.textContent??"").trim();if(!l&&!t)return!0;if(!l&&t)return!1;let c=l.replace(",",".").replace(/\s+/g,"").toLowerCase(),d=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return c===d||c.includes(d)||d.includes(c)||l.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=L(o.id,void 0,!0)||L(q(o.id),void 0,!0);if(!e){let n=document.body;try{n=K()||document.body}catch{}let r=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>M(c)&&!P(c)),s=q(o.id).toLowerCase();e=r.find(c=>{let d=(c.id||"").toLowerCase(),h=(c.getAttribute("name")||"").toLowerCase(),u=(c.getAttribute("aria-label")||"").toLowerCase(),p=q(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return d.includes(s)||h.includes(s)||u.includes(s)||s.length>=2&&p.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(c=>q(c).toLowerCase()),l=q(n.textContent).toLowerCase();return s.some(c=>l.includes(c)||c.includes(l))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>q(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let r=n.value.toLowerCase(),s=q(n.textContent).toLowerCase();return i.some(l=>l===r||l===s||r.includes(l)||s.includes(l))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=L(o.id,e)||L(q(o.id),e);if(!t)return!1;let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,i=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),n=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(i&&i.type==="radio"){if(i.checked===n)return!0;if(o.v&&i.name){let d=q(String(o.v)).toLowerCase(),h=document.querySelector(`input[type="radio"][name="${N(i.name)}"]:checked`);if(!h)return!1;if(h===i)return!0;let u=q(h.value).toLowerCase(),p=q(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===d||p.includes(d)||d.includes(u)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===n;let r=a.getAttribute("aria-checked")===String(n)||a.getAttribute("aria-selected")===String(n)||a.getAttribute("aria-pressed")===String(n),s=n?a.getAttribute("data-selected")==="true"||a.getAttribute("data-checked")==="true"||a.getAttribute("data-active")==="true"||a.getAttribute("data-state")==="checked"||a.getAttribute("data-state")==="on":a.getAttribute("data-selected")==="false"||a.getAttribute("data-checked")==="false"||a.getAttribute("data-state")==="unchecked",l=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||"");return!!(r||s||l||(a instanceof HTMLButtonElement||a.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!i)}if(o.t==="drag"){let e=L(o.from)||L(q(o.from)),t=L(o.to)||L(q(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function ct(o,e,t=1,a=Te({engine:"smart",autoAdvance:e})){let i=o.actions.filter(g=>g.t!=="adv"),n=o.actions.filter(g=>g.t==="adv"),r=0,s=[],l=new Map,c=o.pageType==="question",d=i.filter(g=>g.t==="chk"||g.t==="clk"&&g.c!==void 0);for(let g of i){try{await ho(g,t,a),r++}catch(x){l.set(g,x instanceof Error?x.message:String(x)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",g,x)}await new Promise(x=>setTimeout(x,g.t==="drag"?300:100))}if(c&&o.mode==="escolha_multipla"&&d.length>0){let g=document.body;try{g=K()||document.body}catch{}let x=Array.from(g.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(T=>M(T)&&!P(T));if(x.length>1){let A=function(w,E){if(w===E||w.contains(E)||E.contains(w))return!0;let H=w.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),R=E.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(H&&R&&H===R)return!0;let V=w.getAttribute("for")||w.id,B=E.getAttribute("for")||E.id;return!!(V&&B&&V===B)};var b=A;let T=new Set;for(let w of d){let E=w.t==="chk"?!!w.c:!!(w.c??!0),H="id"in w&&typeof w.id=="string"?w.id:"";if(E&&H){let R=L(H,w.v);if(R){T.add(R);let V=R.querySelector('input[type="checkbox"]');V&&T.add(V);let B=R.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');B&&(T.add(B),B.querySelectorAll('input[type="checkbox"]').forEach(_=>T.add(_)))}}}if(T.size>0){let w=Array.from(T);for(let E of x)w.some(R=>A(R,E))||(E instanceof HTMLInputElement&&E.checked||E.getAttribute("aria-checked")==="true"||E.closest(".option-card, label")?.classList.contains("selected"))&&te(E,!1)}}}await new Promise(g=>setTimeout(g,i.length>0?450:80));let h=0;for(let g of i){if(ge(g)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${g.t}' no alvo '${g.id||g.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{et(g,a),await Ot(g)}catch(x){l.set(g,x instanceof Error?x.message:String(x)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",x)}await new Promise(x=>setTimeout(x,250)),ge(g)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++)}if(h<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-h} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(g=>setTimeout(g,300));for(let g of i)if(!ge(g))try{await Ot(g)}catch(x){l.set(g,x instanceof Error?x.message:String(x))}await new Promise(g=>setTimeout(g,300)),h=0;for(let g of i)ge(g)&&h++}for(let g of i)ge(g)||s.push(g.t==="drag"?`${g.from} -> ${g.to}`:"id"in g?g.id:g.t);c&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let u=i.map((g,x)=>{let T=g.t==="drag"?`${g.from} -> ${g.to}`:g.t==="js"?"$eq":g.id||g.t,A=g.t==="js"?!0:g.t==="drag"?!!(ae(g.from,"source")&&ae(g.to,"destination")):!!(L(g.id||"")||L(q(g.id||""))),w=ge(g);return{index:x,action:g,target:T,located:A,applied:!l.has(g),verified:w,strategy:g.t==="drag"?"drag-adaptive":g.t==="js"?"javascript":"declarative-dom",evidence:w?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...l.has(g)?{error:l.get(g)}:{}}}),p=c?i.length>0&&s.length===0&&(h===i.length||r===i.length&&h>0):!0,f=!1,y=!1,v="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",m=r>0&&r>=i.length/2;if(e&&(p||!c||m)){await new Promise(w=>setTimeout(w,i.length>0?600:200));let g=!1;if(o.pageType!=="info"){let w=mo();w&&M(w)&&(await lt(w,1200),X(w),g=!0,await new Promise(E=>setTimeout(E,800)))}let x=go(),T=n.length>0?n[0].id:void 0,A=rt(T);if(!A&&g&&(await new Promise(w=>setTimeout(w,600)),A=rt(T)),A){await lt(A,1500);let w=T||A.textContent?.trim()||"";w&&Ue(window.location.hostname,{advanceSelector:w}),X(A);let E=await fo(x,2500);y=E.changed,v=E.evidence,f=E.changed||g,!E.changed&&!g&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else g?(f=!0,y=!0,v="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:r,verified:h,success:p,advanced:f,failed:s,reports:u,navigationVerified:y,navigationEvidence:v}}var fe=null,re=[],dt=[],ut=[],be=null,bo=`
...
`;function _t(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=bo,document.head.appendChild(o)}}catch{}}function le(){fe&&(fe.style.removeProperty("outline"),fe.style.removeProperty("outline-offset"),fe.style.removeProperty("position"),fe=null);for(let o of re)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");re=[];for(let o of dt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");dt=[];for(let o of ut)try{o.remove()}catch{}if(ut=[],be){try{be.remove()}catch{}be=null}}function pt(o){_t();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),dt.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),ut.push(n)}}catch{}}}function ht(o){le(),_t(),fe=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),be=t,setTimeout(()=>{try{t.remove()}catch{}be===t&&(be=null)},900)}catch{}}function vo(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Kt(o,e){let t=vo(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let h=L(a.from),u=L(a.to);h&&(h.style.outline=`2px solid ${t.outline}`,re.push(h)),u&&(u.style.outline="2px dashed #00e5ff",re.push(u))}catch{}continue}if(!a.id)continue;let i=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=L(a.id,i,a.t==="val"||a.t==="sel")||L(q(a.id),i,a.t==="val"||a.t==="sel");if(!n&&a.t==="sel"){let h=document.body;try{h=K()||document.body}catch{}let u=Array.from(h.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(y=>M(y)&&!he(y)),p=q(a.id).toLowerCase();n=u.find(y=>{let v=(y.id||"").toLowerCase(),m=(y.getAttribute("name")||"").toLowerCase(),b=(y.getAttribute("aria-label")||"").toLowerCase(),g=q(y.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return v.includes(p)||m.includes(p)||b.includes(p)||p.length>=2&&g.includes(p)})||(u.length===1?u[0]:null)}if(!n)continue;let r=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox",l=n.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||n;l.style.outline=`2px solid ${t.outline}`,l.style.outlineOffset="2px",l.style.backgroundColor=t.bg,l.setAttribute("data-easyquiz-highlight","true"),re.push(l);let c=r?n:l.querySelector('select, [role="combobox"], [role="listbox"]');c&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),re.push(c));let d=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:l.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==l&&(d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${t.glow}`,d.setAttribute("data-easyquiz-highlight","true"),re.push(d))}}var mt=10,yo=1400,gt=15e5;function ve(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let i=String(a.result||"");e(i.split(",")[1]||"")},a.readAsDataURL(o)})}async function Se(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,yo/Math.max(e,t)),i=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),r=document.createElement("canvas");r.width=i,r.height=n;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,n),s.drawImage(o,0,0,i,n),new Promise((l,c)=>{r.toBlob(d=>d?l(d):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function xo(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,n=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(a*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(n)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&a>0&&s.setAttribute("viewBox",`0 0 ${t} ${a}`);let c=new XMLSerializer().serializeToString(s),d=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(d);try{let u=new Image;u.crossOrigin="anonymous",await new Promise((y,v)=>{u.onload=()=>y(),u.onerror=()=>v(new Error("Falha ao renderizar SVG em Image.")),u.src=h});let p=document.createElement("canvas");p.width=n,p.height=r;let f=p.getContext("2d",{alpha:!1});if(!f)throw new Error("Sem suporte a Canvas 2D.");return f.fillStyle="#ffffff",f.fillRect(0,0,n,r),f.drawImage(u,0,0,n,r),new Promise((y,v)=>{p.toBlob(m=>m?y(m):v(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(h)}}async function ft(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let n=s=>{if(!this.isDragging||!this.element)return;let l=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,d=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),u=Math.min(Math.max(10,this.initialLeft+l),d),p=Math.min(Math.max(10,this.initialTop+c),h);this.element.style.left=`${u}px`,this.element.style.top=`${p}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,n=i.actions.filter(p=>p.t==="drag"),r=i.actions.filter(p=>{if(p.t!=="val")return!1;let f=q(p.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(f)}),s=i.actions.filter(p=>p.t==="clk"||p.t==="chk"),l=i.actions.filter(p=>p.t==="sel"),c=n.length||r.length||s.length||l.length,d=document.createElement("div");d.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let u=document.createElement("span");if(u.className="eq-fah-meta-badge",u.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,d.append(h,u),e.appendChild(d),n.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let p={};for(let f of n){let y=q(f.to)||"Geral";p[y]||(p[y]=[]),p[y].push(q(f.from))}for(let[f,y]of Object.entries(p)){let v=document.createElement("div"),m=/fato|true|verdadeiro|sim/i.test(f),b=/opini[aã]o|false|falso|n[aã]o/i.test(f);v.className=`eq-fah-group ${m?"group-fato":b?"group-opiniao":""}`;let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent=`\u{1F4C1} ${f} (${y.length})`,v.appendChild(g);let x=document.createElement("div");x.className="eq-fah-group-items";for(let T of y){let A=document.createElement("div");A.className="eq-fah-item";let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=T,A.appendChild(w);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(T),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),A.appendChild(E),x.appendChild(A)}v.appendChild(x),e.appendChild(v)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,a.textContent=String(r.length);let p=document.createElement("div");p.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F4DD} Respostas para os Campos de Texto:",p.appendChild(f);let y=document.createElement("div");y.className="eq-fah-group-items";for(let v=0;v<r.length;v++){let m=r[v],b=document.createElement("div");b.className="eq-fah-item";let g=Me(m.id);(!g||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Campo ${v+1}`);let x=String(m.v??""),T=document.createElement("div");T.className="eq-fah-field-box";let A=document.createElement("div");A.className="eq-fah-field-label",A.textContent=g,T.appendChild(A);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=x,T.appendChild(w),b.appendChild(T);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(x),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),b.appendChild(E),y.appendChild(b)}p.appendChild(y),e.appendChild(p)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let p=document.createElement("div");p.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F3AF} Alternativa(s) Correta(s):",p.appendChild(f);let y=document.createElement("div");y.className="eq-fah-group-items";for(let v=0;v<s.length;v++){let m=s[v],b=document.createElement("div");b.className="eq-fah-item";let g=Me(m.id);(!g||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g))&&m.v&&(g=String(m.v)),g=q(g),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g)&&(g="");let x="",T=g.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);T?(x=T[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),g=T[2].trim()||g):s.length>1&&(x=String.fromCharCode(65+v));let A=document.createElement("div");if(A.style.display="flex",A.style.alignItems="center",A.style.gap="8px",A.style.flex="1",x){let H=document.createElement("span");H.className="eq-fah-letter-badge",H.textContent=x,A.appendChild(H)}let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=g||(x?`Alternativa ${x}`:"Alternativa Selecionada"),A.appendChild(w),b.appendChild(A);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(g||x),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),b.appendChild(E),y.appendChild(b)}p.appendChild(y),e.appendChild(p)}else if(l.length>0){t.textContent=`Sele\xE7\xE3o (${l.length} listas)`,a.textContent=String(l.length);let p=document.createElement("div");p.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",p.appendChild(f);let y=document.createElement("div");y.className="eq-fah-group-items";for(let v=0;v<l.length;v++){let m=l[v],b=document.createElement("div");b.className="eq-fah-item";let g=Me(m.id);(!g||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Lista ${v+1}`);let A=(Array.isArray(m.v)?m.v:[String(m.v??"")]).map(V=>{let B=L(m.id,void 0,!0)||L(q(m.id),void 0,!0),_=B instanceof HTMLSelectElement?B:B?.querySelector("select");if(_){let ce=q(V).toLowerCase();for(let S=0;S<_.options.length;S++){let I=_.options[S];if(I.value.toLowerCase()===ce||q(I.textContent).toLowerCase()===ce){let $=q(I.textContent);if($&&!$.toLowerCase().includes("selecione"))return $}}}return V}).join(", "),w=document.createElement("div");w.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=g,w.appendChild(E);let H=document.createElement("div");H.className="eq-fah-field-val",H.textContent=A,w.appendChild(H),b.appendChild(w);let R=document.createElement("button");R.className="eq-fah-copy-inline",R.textContent="Copiar",R.addEventListener("click",()=>{navigator.clipboard.writeText(A),R.textContent="\u2713 Copiado",setTimeout(()=>R.textContent="Copiar",1200)}),b.appendChild(R),y.appendChild(b)}p.appendChild(y),e.appendChild(p)}else{t.textContent="Gabarito",a.textContent="0";let p=document.createElement("div");p.style.padding="10px",p.style.color="#888",p.textContent="Nenhuma resposta direta para exibir.",e.appendChild(p)}if(i.rationale){let p=document.createElement("div");p.className="eq-fah-rationale",p.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(p)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),r=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let l of a){let c=q(l.to)||"Geral";s[c]||(s[c]=[]),s[c].push(q(l.from))}for(let[l,c]of Object.entries(s)){t.push(`### Categoria: ${l}`);for(let d of c)t.push(`- ${d}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let l=q(s.id);t.push(`- **${l||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let l=n[s],c=Me(l.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&l.v&&(c=String(l.v)),c=q(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let d=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${d}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of r){let l=q(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${l}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
