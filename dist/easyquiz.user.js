 ...
 */
"use strict";(()=>{var A={apiKey:"",model:"gemini-3.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};var ae="easyquiz_settings_v2";function oe(){try{let t=localStorage.getItem(ae);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let i=JSON.parse(o);return{...A,apiKey:i.apiKey||""}}return{...A}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:A.model;return a==="gemini-2.5-flash"&&(a="gemini-3.5-flash"),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():A.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:A.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:A.confidenceThreshold}}catch{return{...A}}}function ve(){try{localStorage.removeItem(ae),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),ie()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function R(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function ne(t,e){let o={...R(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function ye(t){let a={...oe(),...t};try{localStorage.setItem(ae,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}var F=[];function xe(t){let e=t.trim();e&&!F.includes(e)&&F.push(e)}function we(){return F}function ie(){F=[]}var Ee=`Voc\xEA \xE9 o EasyQuiz Engine v4.8 Supreme. Responda estritamente em JSON v\xE1lido.
...
Responda estritamente em JSON.`}var z=[{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Padr\xE3o 2026 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente e Est\xE1vel)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Compatibilidade)",description:"Modelo r\xE1pido para contas com acesso ativo."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Legado Universal)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],Be={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function Ne(t){let e=t.trim().replace(/^google\//,"").replace(/^models\//,"");return e==="gemini-2.5-flash"?"gemini-3.5-flash":e||"gemini-3.5-flash"}function Te(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function De(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let i of o)try{let r=JSON.parse(i);if(r&&typeof r=="object")return r}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var j=null,se=new Set;async function Q(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return z;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let n=await i.text(),s=Te(n,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let r=await i.json();if(Array.isArray(r.models)&&r.models.length>0){let n=r.models.filter(s=>{let l=s.supportedGenerationMethods||[],d=(s.name||"").includes("gemini"),c=l.includes("generateContent"),h=(s.name||"").includes("embedding")||(s.name||"").includes("tts")||(s.name||"").includes("imagen")||(s.name||"").includes("aqa")||(s.name||"").includes("computer-use");return d&&c&&!h}).map(s=>{let l=s.name.replace(/^models\//,""),d=s.displayName||l;return{id:l,name:d.includes(l)?d:`${d} (${l})`,description:s.description||""}});if(n.length>0)return n.sort((s,l)=>{let d=c=>c==="gemini-2.5-flash"?100:c==="gemini-3.5-flash"?95:c==="gemini-3.1-flash-lite"?90:c==="gemini-2.5-pro"?85:c==="gemini-3.1-pro"?80:c==="gemini-1.5-flash"?60:c.includes("flash")?50:10;return d(l.id)-d(s.id)}),j=n,n}}catch(i){if(i.message?.includes("Chave de API"))throw i}return z}async function Ce(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await Q(e);if(o.length>0&&o!==z){let i=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let i of["v1beta","v1"]){let r=`https://generativelanguage.googleapis.com/${i}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(r,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${i})!`,models:z}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function re(t,e,a,o){let i=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!i)throw new Error("Chave de API n\xE3o configurada.");let r=Ne(a.model);if(!j||j.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await Q(i)}catch(m){let u=m instanceof Error?m.message:String(m);if(u.includes("inv\xE1lida")||u.includes("n\xE3o autorizada"))throw new Error(u)}let n=Date.now(),s=qe(t,e,a),l=[{text:s}];for(let m of e)l.push({inline_data:{mime_type:m.mediaType,data:m.base64}});let d={system_instruction:{parts:[{text:Ee}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:Be}},c=[r,...j?.map(m=>m.id)||[],"gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-flash","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],h=Array.from(new Set(c)).filter(m=>!se.has(m));h.length===0&&(se.clear(),h.push(...z.map(m=>m.id)));let p=new Error("Nenhum modelo tentado.");for(let m=0;m<h.length;m++){let u=h[m],x=h[m+1];o?.(`Aguardando resposta da API (${u})...`,"info");let y=["v1beta","v1"];for(let k of y){let T=`https://generativelanguage.googleapis.com/${k}/models/${u}:generateContent?key=${encodeURIComponent(i)}`,G=new AbortController,be=setTimeout(()=>G.abort(),35e3);try{let L=await fetch(T,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":i},body:JSON.stringify(d),signal:G.signal});if(clearTimeout(be),!L.ok){let $e=await L.text(),Oe=Te($e,L.status);if(L.status===404&&k==="v1beta")continue;throw new Error(Oe)}let ee=await L.json(),te=ee.candidates?.[0];if(!te||!te.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let Re=te.content.parts[0].text,C=De(Re);if(Array.isArray(C.actions)||(C.actions=[]),Array.isArray(C.warnings)||(C.warnings=[]),typeof C.confidence!="number"&&(C.confidence=.8),C.usedModel=u,C.durationMs=Date.now()-n,C.promptSent=s,C.tokensUsed=ee.usageMetadata?.totalTokenCount,u!==r){o?.(`Resolvido com sucesso pelo fallback '${u}' (${k})!`,"info");try{a.model=u}catch{}}return{plan:C,rawUsage:ee.usageMetadata,usedModel:u}}catch(L){if(clearTimeout(be),p=L,p.message.includes("inv\xE1lida")||p.message.includes("n\xE3o autorizada"))throw p}}let f=p.message.includes("429")||p.message.includes("cota"),M=p.message.includes("503")||p.message.includes("sobrecarregado");if(p.message.includes("404")&&se.add(u),x){let k=f?3500:M?2500:900,T=`Modelo '${u}' indispon\xEDvel (${p.message}). Aguardando ${k/1e3}s antes de alternar para '${x}'...`;console.warn(`[EasyQuiz Fallback] ${T}`),o?.(T,"warning"),await new Promise(G=>setTimeout(G,k))}else console.warn(`[EasyQuiz Fallback] Modelo '${u}' falhou: ${p.message}. Todos os modelos esgotados.`)}throw p}var H=['input:not([type="hidden"])',"textarea","select","button","a",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),U=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,_e=0;function E(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function Ve(t){if(t==null)return"";if(typeof t=="string")return t;if(typeof t=="number"||typeof t=="boolean")return String(t);if(t instanceof Node)return t.textContent||"";try{if(typeof t?.toString=="function"){let e=t.toString();if(typeof e=="string")return e}}catch{}return""}function w(t,e=500){return Ve(t).replace(/\s+/g," ").trim().slice(0,e)}function Ge(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(_e+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function $(t){if(!t||!(t instanceof Element))return!1;let e=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",a=w(t.getAttribute?.("aria-label")||t.textContent||t.getAttribute?.("value")||e),o=t.type,i=a.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),r=String(t.getAttribute?.("data-testid")||t.getAttribute?.("data-test-id")||t.getAttribute?.("id")||t.getAttribute?.("href")||"").toLowerCase();return U.test(i)||U.test(a)||o==="submit"||r.includes("next")||r.includes("check")||r.includes("continue")||r.includes("proximo")||r.includes("forward")||!1}function Fe(t){let e=t.getAttribute("aria-label");if(e)return w(e);let a=t.getAttribute("aria-labelledby");if(a){let n=a.split(/\s+/).map(s=>document.getElementById(s)?.textContent).filter(Boolean).join(" ");if(n.trim())return w(n)}if("labels"in t&&t.labels){let n=Array.from(t.labels??[]).map(s=>s.textContent).join(" ");if(n.trim())return w(n)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let n=w(o.textContent);if(n)return n}let i=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||i||"";return w(r)}function le(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let i=t.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(i)?i:"other",n=t.getAttribute("role")||"",s=(t.getAttribute("data-testid")||t.getAttribute("data-test-id")||"").toLowerCase(),l=(t.className&&typeof t.className=="string"?t.className:"").toLowerCase(),d=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item")||t.classList.contains("sortable-item")||!!t.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(s)||/drag|card-item|sortable/i.test(l),c=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category")||!!t.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(s)||/dropzone|category-box|bucket|target-zone/i.test(l),p=w((d?"draggable":c?"dropzone":"")||o.type||n||r,40),m="";if(o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox")m=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked";else{let f=t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement?t.value:"";m=w(f||t.getAttribute("data-category")||t.textContent||"",2e3)}let u=[];if(a)for(let f of Array.from(a.options).slice(0,80))u.push({value:w(f.value),label:w(f.textContent)});let x=!!(o.required||t.getAttribute("aria-required")==="true"),y=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Ge(t),tag:r,type:p,label:Fe(t),name:w(o.name||t.getAttribute("name")||"",180),value:m,options:u,required:x,disabled:y,role:e}}var Se=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function ke(t){if(!E(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(H)).filter(E),o=w(t.innerText,4e3).length;if(o<10||!a.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),r=Math.max(1,e.width*e.height),n=Math.min(1,r/i),s=e.top+e.height/2,l=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),d=o>40?35:0,c=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+d+c-n*20-l*10}function ce(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let i=w(e.innerText,1e4),r=w(a.innerText,1e4),n=e.querySelectorAll(H).length,s=a.querySelectorAll(H).length;if(i.length<150&&r.length>i.length&&s<=n+4){e=a;continue}break}return e}function je(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&E(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Qe(){let t=document.activeElement;if(t&&t!==document.body){let i=t.closest(Se);if(i&&ke(i)>0)return ce(i)}let a=Array.from(document.querySelectorAll(Se)).map(i=>({element:i,score:ke(i)})).filter(i=>Number.isFinite(i.score)).sort((i,r)=>r.score-i.score);if(a.length>0&&a[0].score>0)return ce(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&E(o)?o:document.body}function Me(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))a.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ue(t){return Array.from(t.querySelectorAll(H)).filter(e=>{if(!E(e)||$(e))return!1;if(e.tagName.toLowerCase()==="a"){let a=e.getAttribute("role");return!!(a==="button"||a==="radio"||a==="checkbox"||a==="option"||e.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]'))}return!0}).slice(0,100).map(e=>le(e,"answer"))}function de(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let i of e)for(let r of Array.from(i.querySelectorAll(H)))if(!(a.has(r)||!E(r)||!$(r))&&(a.add(r),o.push(le(r,"navigation")),o.length>=10))return o;return o}function O(t=!1){let e=Qe();e=ce(e),t&&(e=je(e));let a=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",o=w(a,16e3),i=Ue(e),r=de(e);r.length===0&&(r=de(document.body));let n=[...i,...r].slice(0,120);return!o||n.length===0&&o.length<30?w(document.body.innerText||document.body.textContent||"",16e3).length>=30?I():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:o,htmlSnippet:Me(e),controls:n,scope:e}}function I(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=w(t,14e3),a=de(document.body),o=document.querySelector('main, article, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Leitura/Contexto",questionText:e,htmlSnippet:Me(o).slice(0,15e3),controls:a,scope:o}}function S(t){return!!t.closest("#easyquiz-shadow-root, .eq-sidebar, .eq-launcher")}function v(t){return t?t.replace(/^[\d\.\-\)\s]+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim():""}function b(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o&&!S(o))return o;try{if(o=document.querySelector(e),o&&!S(o))return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o&&!S(o))return o}catch{}try{let n=e.replace(/"/g,""),s=`//*[normalize-space(.)="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(s,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let d=l.singleNodeValue;if(!S(d))return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||d}}catch{}let i=v(e).toLowerCase(),r=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of r){if(!E(n)||S(n))continue;let s=v(n.textContent).toLowerCase(),l=v(n.getAttribute("aria-label")||"").toLowerCase(),d=v(n.getAttribute("data-category")||"").toLowerCase(),c=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",h=v(c).toLowerCase(),p=s.startsWith(i+")")||s.startsWith(i+".")||s.startsWith(i+" -")||s.startsWith(i+":");if(s===i||l===i||d&&d===i||h&&h===i||p){let m=n.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]'),u=n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li');return m||u||n}}if(i.length>=3)for(let n of r){if(!E(n)||S(n))continue;let s=v(n.textContent).toLowerCase(),l=v(n.getAttribute("aria-label")||"").toLowerCase();if(s.includes(i)||l.includes(i)||i.length>8&&s&&i.includes(s)){let c=n.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]'),h=n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li');return c||h||n}let d=i.split(" ").filter(c=>c.length>2);if(d.length>=3){let c=d.slice(0,Math.min(4,d.length)).join(" ");if(s.includes(c)||l.includes(c))return n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li')||n}}return null}function B(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function q(t,e){if(!t)return;try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let s=t.getBoundingClientRect();a=Math.round(s.left+Math.max(1,s.width/2)),o=Math.round(s.top+Math.max(1,s.height/2))}try{t.focus?.()}catch{}let i={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};try{t.dispatchEvent(new PointerEvent("pointerdown",{...i,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:1}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",{...i,button:0,buttons:1}));try{t.dispatchEvent(new PointerEvent("pointerup",{...i,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:0}))}catch{}t.dispatchEvent(new MouseEvent("mouseup",{...i,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...i,button:0,buttons:0}));try{let s=new Touch({identifier:Date.now(),target:t,clientX:a,clientY:o,screenX:a,screenY:o,pageX:a+(window.scrollX||0),pageY:o+(window.scrollY||0)});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,composed:!0,touches:[s],targetTouches:[s]})),t.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,composed:!0,touches:[],targetTouches:[]}))}catch{}try{t.click()}catch{}let r=t.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], label');if(r&&r!==t)try{r.click()}catch{}let n=t.querySelector('input[type="radio"], input[type="checkbox"]');if(n&&n!==t)try{n.click()}catch{}}function Ae(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let i=t._valueTracker;i&&i.setValue("")}catch{}let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,B(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,B(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function pe(t,e){let a=t instanceof HTMLInputElement?t:t.querySelector('input[type="checkbox"], input[type="radio"]');if(a&&["checkbox","radio"].includes(a.type)){if(a.checked!==e&&a.click(),a.checked!==e){try{let r=a._valueTracker;r&&r.setValue("")}catch{}Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e),B(a,["input","change"])}return}let o=t.getAttribute("role");if(o==="radio"||o==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(q(t),t.setAttribute("aria-checked",e?"true":"false"),B(t,["input","change"]));return}q(t)}function Ye(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);B(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function Ke(t,e){try{let a=new DataTransfer;try{a.setData("text/plain",t)}catch{}try{a.setData("text/html",e)}catch{}return a}catch{return null}}async function ue(t,e,a=1){try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=t.getBoundingClientRect(),i=e.getBoundingClientRect(),r=Math.round(o.left+Math.max(1,o.width/2)),n=Math.round(o.top+Math.max(1,o.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),l=Math.round(i.top+Math.max(1,i.height/2)),d=v(e.textContent).toLowerCase();if(d){let x=Array.from(t.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(y=>{let f=v(y.textContent).toLowerCase(),M=y instanceof HTMLInputElement||y instanceof HTMLOptionElement?v(y.value).toLowerCase():"";return f&&(d.includes(f)||f.includes(d))||M&&(d.includes(M)||M.includes(d))});x&&(q(x),await new Promise(y=>setTimeout(y,120)))}q(t,[r,n]),await new Promise(u=>setTimeout(u,140)),q(e,[s,l]);let c=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');c&&c!==e&&q(c),await new Promise(u=>setTimeout(u,100));let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:n,screenX:r,screenY:n,button:0,buttons:1};try{t.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",h));let p=4;for(let u=1;u<=p;u++){let x=Math.round(r+(s-r)*(u/p)),y=Math.round(n+(l-n)*(u/p)),f={...h,clientX:x,clientY:y,screenX:x,screenY:y};try{t.dispatchEvent(new PointerEvent("pointermove",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",f))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:l,screenX:s,screenY:l,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let u=Ke(w(t.textContent),t.outerHTML),x={...h},y={...m};u&&(x.dataTransfer=u,y.dataTransfer=u),t.dispatchEvent(new DragEvent("dragstart",x)),e.dispatchEvent(new DragEvent("dragenter",y)),e.dispatchEvent(new DragEvent("dragover",y)),e.dispatchEvent(new DragEvent("drop",y)),t.dispatchEvent(new DragEvent("dragend",x))}catch(u){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",u)}try{let u=new Touch({identifier:1,target:t,clientX:r,clientY:n}),x=new Touch({identifier:1,target:e,clientX:s,clientY:l});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[u]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[x]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(a>=2&&!e.contains(t))try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(u=>setTimeout(u,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Le={fill:(t,e)=>{let a=b(t);a?Ae(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=b(t);e?q(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=b(t);a?pe(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=b(t),o=b(e);a&&o?ue(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=b(t),o=b(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await ue(a,o)}};window.$eq=Le;async function Xe(t,e=1){if(t.t==="js"){let i=String(t.v||"");try{new Function("$eq","document","window",i)(Le,document,window)}catch(r){console.warn("[EasyQuiz JS Execution]",r)}return}if(t.t==="drag"){let i=b(t.from),r=b(t.to);!i&&t.from&&(i=b(v(t.from))),!r&&t.to&&(r=b(v(t.to))),i&&r?await ue(i,r,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let a=t.id||"",o=b(a);if(!o&&a&&(o=b(v(a))),!o&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":o&&Ae(o,String(t.v));break;case"chk":o&&pe(o,!!t.c);break;case"sel":if(o){let r=Array.isArray(t.v)?t.v:[String(t.v)];Ye(o,r)}break;case"clk":if(o){q(o,t.co);let r=o.querySelector('input[type="radio"], input[type="checkbox"]');r&&!r.checked&&pe(r,!0)}break;case"adv":let i=Y(t.id);if(i){await he(i,1200);let r=t.id||i.textContent?.trim()||"";r&&ne(window.location.hostname,{advanceSelector:r}),q(i)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Je(){let t=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(t)).find(a=>{if(!E(a)||S(a))return!1;let o=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"",i=(a.textContent||o||a.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function Y(t){if(t){let r=b(t);if(r&&E(r)&&!S(r))return r}try{let r=R(window.location.hostname);if(r.advanceSelector){let n=b(r.advanceSelector);if(n&&E(n)&&!S(n))return n}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(e)).filter(r=>E(r)&&!S(r));for(let r of o)if($(r))return r;for(let r of o){let n=r instanceof HTMLInputElement||r instanceof HTMLButtonElement?r.value:"",s=(r.textContent||n||r.getAttribute("aria-label")||"").trim();if(U.test(s))return r}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&E(i)&&!S(i)?i:null}async function he(t,e=1500){let a=Date.now();for(;Date.now()-a<e;){if(!(t.disabled===!0||t.getAttribute("aria-disabled")==="true"||t.classList.contains("disabled")||t.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,100))}try{t.removeAttribute("disabled"),t.removeAttribute("aria-disabled"),t.classList.remove("disabled"),t.disabled=!1}catch{}}function We(t){try{if(t.t==="val"){let e=b(t.id)||b(v(t.id));if(!e)return!1;let a=e.value??e.textContent??"";return v(a)===v(String(t.v))||a.includes(String(t.v))}if(t.t==="chk"){let e=b(t.id)||b(v(t.id));return e?(e.checked??e.getAttribute("aria-checked")==="true")===!!t.c:!1}if(t.t==="sel"){let e=b(t.id)||b(v(t.id));if(!e||!(e instanceof HTMLSelectElement))return!1;let a=Array.isArray(t.v)?t.v:[String(t.v)];return Array.from(e.options).some(o=>o.selected&&a.includes(o.value))}if(t.t==="clk"){let e=b(t.id)||b(v(t.id));if(!e)return!1;let a=e.querySelector('input[type="radio"], input[type="checkbox"]');if(a)return a.checked;let o=e.getAttribute("aria-checked")==="true"||e.getAttribute("aria-selected")==="true",i=/active|selected|checked|picked/i.test(e.className||"");return o||i||!0}if(t.t==="drag"){let e=b(t.from)||b(v(t.from)),a=b(t.to)||b(v(t.to));return!e||!a?!1:a.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function ze(t,e,a=1){let o=t.actions.filter(c=>c.t!=="adv"),i=t.actions.filter(c=>c.t==="adv"),r=0;for(let c of o){try{await Xe(c,a),r++}catch(h){console.warn("[EasyQuiz] A\xE7\xE3o declarativa falhou com seguran\xE7a:",c,h)}c.t==="drag"&&await new Promise(h=>setTimeout(h,250))}await new Promise(c=>setTimeout(c,o.length>0?300:50));let n=0;for(let c of o)We(c)&&n++;let s=t.pageType==="question",l=!s||o.length===0?!0:r>0&&n>0&&n>=Math.ceil(o.length*.35),d=!1;if((e||a>=2)&&(l||!s)){if(await new Promise(p=>setTimeout(p,o.length>0?500:200)),t.pageType!=="info"){let p=Je();p&&E(p)&&(await he(p,1200),q(p),await new Promise(m=>setTimeout(m,800)))}let c=i.length>0?i[0].id:void 0,h=Y(c);if(h){await he(h,1200);let p=c||h.textContent?.trim()||"";p&&ne(window.location.hostname,{advanceSelector:p}),q(h),d=!0}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:r,verified:n,success:l,advanced:d}}var N=null,D=[];function _(){N&&(N.style.removeProperty("outline"),N.style.removeProperty("outline-offset"),N=null);for(let t of D)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");D=[]}function me(t){_(),N=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function He(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let r=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);r&&(r.style.outline="2px solid #00ff88",D.push(r)),n&&(n.style.outline="2px dashed #00e5ff",D.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let i=o.closest('label, [role="listitem"], .answer, .form-check')||o;i.style.outline="2px solid #00ff88",i.style.outlineOffset="2px",i.style.backgroundColor="rgba(0, 255, 136, 0.08)",D.push(i)}}var V=4,Ze=1200,ge=12e5;function K(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function X(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Ze/Math.max(e,a)),i=Math.max(1,Math.round(e*o)),r=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=i,n.height=r;let s=n.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,r),s.drawImage(t,0,0,i,r),new Promise((l,d)=>{n.toBlob(c=>c?l(c):d(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function Ie(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,i=`
    ...
    `,e.appendChild(d),r.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){a.textContent=`Categoriza\xE7\xE3o (${r.length} itens)`,o.textContent=String(r.length);let c={};for(let h of r){let p=v(h.to)||"Geral";c[p]||(c[p]=[]),c[p].push(v(h.from))}for(let[h,p]of Object.entries(c)){let m=document.createElement("div"),u=/fato|true|verdadeiro|sim/i.test(h),x=/opini[aã]o|false|falso|n[aã]o/i.test(h);m.className=`eq-fah-group ${u?"group-fato":x?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.innerHTML=`<span>\u{1F4C1}</span> <span>${h} (${p.length})</span>`,m.appendChild(y);let f=document.createElement("div");f.className="eq-fah-group-items";for(let M of p){let P=document.createElement("div");P.className="eq-fah-item";let k=document.createElement("span");k.className="eq-fah-item-text",k.textContent=M,P.appendChild(k);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(M),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),P.appendChild(T),f.appendChild(P)}m.appendChild(f),e.appendChild(m)}}else if(n.length>0){a.textContent=`Preenchimento (${n.length} campos)`,o.textContent=String(n.length);let c=document.createElement("div");c.className="eq-fah-group";let h=document.createElement("div");h.className="eq-fah-group-title",h.textContent="Respostas para Inserir:",c.appendChild(h);let p=document.createElement("div");p.className="eq-fah-group-items";for(let m of n){let u=document.createElement("div");u.className="eq-fah-item";let x=document.createElement("span");x.className="eq-fah-item-text";let y=v(m.id);x.innerHTML=`${y?`<strong>${y}:</strong> `:""}<code style="color:#00ffcc; background:rgba(0,255,204,0.1); padding:1px 4px; border-radius:3px;">${m.v}</code>`,u.appendChild(x);let f=document.createElement("button");f.className="eq-fah-copy-inline",f.textContent="Copiar",f.addEventListener("click",()=>{navigator.clipboard.writeText(String(m.v)),f.textContent="\u2713 Copiado",setTimeout(()=>f.textContent="Copiar",1200)}),u.appendChild(f),p.appendChild(u)}c.appendChild(p),e.appendChild(c)}else if(s.length>0){a.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,o.textContent=String(s.length);let c=document.createElement("div");c.className="eq-fah-group";let h=document.createElement("div");h.className="eq-fah-group-title",h.textContent="Alternativa(s) Correta(s):",c.appendChild(h);let p=document.createElement("div");p.className="eq-fah-group-items";for(let m of s){let u=document.createElement("div");u.className="eq-fah-item";let x=document.createElement("span");x.className="eq-fah-item-text";let y=v(m.id);x.innerHTML=`<span style="color:#00ffcc; font-weight:bold; margin-right:4px;">\u2611</span> ${y}`,u.appendChild(x);let f=document.createElement("button");f.className="eq-fah-copy-inline",f.textContent="Copiar",f.addEventListener("click",()=>{navigator.clipboard.writeText(y),f.textContent="\u2713 Copiado",setTimeout(()=>f.textContent="Copiar",1200)}),u.appendChild(f),p.appendChild(u)}c.appendChild(p),e.appendChild(c)}else a.textContent="Gabarito",o.textContent="0",e.innerHTML+='<div style="padding:10px; color:#888;">Nenhuma resposta direta para exibir.</div>';if(i.rationale){let c=document.createElement("div");c.className="eq-fah-rationale",c.innerHTML=`<strong>\u{1F4A1} Racioc\xEDnio da IA:</strong> ${i.rationale}`,e.appendChild(c)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,a=[];a.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),a.push(`- **Modo:** ${e.mode}`),a.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),a.push("");let o=e.actions.filter(n=>n.t==="drag"),i=e.actions.filter(n=>n.t==="val"),r=e.actions.filter(n=>n.t==="clk"||n.t==="chk");if(o.length>0){a.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let n={};for(let s of o){let l=v(s.to)||"Geral";n[l]||(n[l]=[]),n[l].push(v(s.from))}for(let[s,l]of Object.entries(n)){a.push(`### Categoria: ${s}`);for(let d of l)a.push(`- ${d}`);a.push("")}}else if(i.length>0){a.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let n of i){let s=v(n.id);a.push(`- **${s||"Campo"}:** \`${n.v}\``)}a.push("")}else if(r.length>0){a.push("## \u2705 Alternativas Corretas:");for(let n of r)a.push(`- [x] ${v(n.id)}`);a.push("")}return e.rationale&&(a.push("---"),a.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),a.join(`
`)}copyMarkdownToClipboard(e){let a=this.generateMarkdown();a&&navigator.clipboard.writeText(a).then(()=>{let o=e.textContent;e.textContent="\u2713 Copiado!",setTimeout(()=>{e.textContent=o},1500)})}};var Pe=`
