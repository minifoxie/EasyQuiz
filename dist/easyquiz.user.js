...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let v=p.filter(q=>q.type==="checkbox"||q.type==="chk"),y=new Set(p.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),C=v.filter(q=>!q.name||!y.has(q.name)),L=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),x=C.length>=2||L,E=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&y.size>=1,S=p.every(q=>q.type==="radio"||q.type==="chk")&&y.size===1&&!x&&!E,w=p.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),M=w.length>=2;return(E?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
...
`;function Kt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=qo,document.head.appendChild(o)}}catch{}}function ge(){ie&&(ie.style.removeProperty("outline"),ie.style.removeProperty("outline-offset"),ie.style.removeProperty("position"),ie=null);for(let o of ye)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ye=[];for(let o of ft)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");ft=[];for(let o of bt)try{o.remove()}catch{}bt=[],he&&typeof window<"u"&&(window.removeEventListener("scroll",he),window.removeEventListener("resize",he),he=null);for(let o of At)try{o.remove()}catch{}if(At=[],se){try{se.remove()}catch{}se=null}}function vt(o){Kt();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let n=t;try{n.style&&(n.style.outline="3px solid #ffd600",n.style.outlineOffset="4px",n.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",n.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",n.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),n.setAttribute("data-easyquiz-image-highlight","true"),ft.push(n)}catch{}try{let r=t.getBoundingClientRect(),a=r.width||t.offsetWidth||280,s=r.height||t.offsetHeight||200;if(a>10&&s>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
    ...
    `,o.appendChild(t),se=t}catch{}}function To(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Jt(o,e){if(se){try{se.remove()}catch{}se=null}let t=To(e);for(let n of o){if(n.t==="adv"||n.t==="js")continue;if(n.t==="drag"){try{let m=P(n.from),p=P(n.to);m&&(m.style.outline=`2px solid ${t.outline}`,ye.push(m)),p&&(p.style.outline="2px dashed #00e5ff",ye.push(p))}catch{}continue}let r=n.v!==void 0?Array.isArray(n.v)?n.v[0]:String(n.v):"",a=String(n.name??n.n??"").trim(),s=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${V(a)}"]`));if(r&&(s=m.find(p=>p.value?.toLowerCase()===r.toLowerCase())??null,!s)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(r),h=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(r);if(p||h){let A=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=m.find(b=>{let v=b.value?.toLowerCase()??"";if(A.includes(v))return!0;let C=(b.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return A.some(L=>C===L||C.startsWith(L+" ")||C.startsWith("("+L+")"))})??null}}!s&&m.length>0&&(s=m[0])}if(!s&&n.id&&(s=P(n.id,r,n.t==="val"||n.t==="sel")||P(T(n.id),r,n.t==="val"||n.t==="sel")),!s&&n.t==="sel"){let m=document.body;try{m=W()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(b=>z(b)&&!ue(b)),h=T(n.id).toLowerCase();s=p.find(b=>{let v=(b.id||"").toLowerCase(),y=(b.getAttribute("name")||"").toLowerCase(),C=(b.getAttribute("aria-label")||"").toLowerCase(),L=T(b.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return v.includes(h)||y.includes(h)||C.includes(h)||h.length>=2&&L.includes(h)})||(p.length===1?p[0]:null)}if(!s)continue;let i=typeof HTMLSelectElement<"u"&&s instanceof HTMLSelectElement||s.tagName?.toLowerCase()==="select"||s.getAttribute("role")==="combobox"||s.getAttribute("role")==="listbox",d=s.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?s.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=d||l||s;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),ye.push(u);let f=i?s:u.querySelector('select, [role="combobox"], [role="listbox"]');f&&(f.style.outline=`2px solid ${t.outline}`,f.style.outlineOffset="2px",f.style.boxShadow=`0 0 10px ${t.glow}`,f.setAttribute("data-easyquiz-highlight","true"),ye.push(f));let c=s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type)?s:u.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==u&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ye.push(c))}}var yt=10,So=1400,Pe=15e5;function de(o){return new Promise((e,t)=>{let n=new FileReader;n.onerror=()=>t(new Error("Falha ao converter blob para base64.")),n.onload=()=>{let r=String(n.result||"");e(r.split(",")[1]||"")},n.readAsDataURL(o)})}async function xe(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let n=Math.min(1,So/Math.max(e,t)),r=Math.max(1,Math.round(e*n)),a=Math.max(1,Math.round(t*n)),s=document.createElement("canvas");s.width=r,s.height=a;let i=s.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,r,a),i.drawImage(o,0,0,r,a),new Promise((d,l)=>{s.toBlob(u=>u?d(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Yt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,n=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,r=2,a=Math.min(1800,Math.max(120,Math.round(t*r))),s=Math.min(1800,Math.max(100,Math.round(n*r))),i=o.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(a)),i.setAttribute("height",String(s)),!i.getAttribute("viewBox")&&t>0&&n>0&&i.setAttribute("viewBox",`0 0 ${t} ${n}`);try{let c=Array.from(o.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,m.length);p++){let h=c[p],A=m[p];if(!h||!A||!A.style)continue;let b=window.getComputedStyle?window.getComputedStyle(h):null;b&&(b.fill&&b.fill!=="none"&&(A.style.fill=b.fill),b.stroke&&b.stroke!=="none"&&(A.style.stroke=b.stroke),b.strokeWidth&&(A.style.strokeWidth=b.strokeWidth),b.fontFamily&&(A.style.fontFamily=b.fontFamily),b.fontSize&&(A.style.fontSize=b.fontSize),b.fontWeight&&(A.style.fontWeight=b.fontWeight),b.color&&(A.style.color=b.color))}}catch{}let d="#ffffff";try{let c=o.parentElement||o;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){d=p;break}c=c.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),f="";try{f=btoa(unescape(encodeURIComponent(u)))}catch{}try{let c=A=>new Promise((b,v)=>{let y=new Image,C=setTimeout(()=>v(new Error("Timeout render SVG")),1200);y.onload=()=>{clearTimeout(C),b(y)},y.onerror=()=>{clearTimeout(C),v(new Error("Falha ao renderizar SVG em Image."))},y.src=A}),m=null;if(f)try{m=await c(`data:image/svg+xml;base64,${f}`)}catch{}if(!m){let A=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),b=URL.createObjectURL(A);try{m=await c(b)}finally{URL.revokeObjectURL(b)}}let p=document.createElement("canvas");p.width=a,p.height=s;let h=p.getContext("2d",{alpha:!1});if(h&&m){h.fillStyle=d,h.fillRect(0,0,a,s),h.drawImage(m,0,0,a,s);let A=await new Promise(b=>{p.toBlob(b,"image/jpeg",.92)});if(A){let b=await de(A);if(b)return{blob:A,base64:b,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function xt(o){try{let e=o.getBoundingClientRect(),t=Math.round(e.width)||o.offsetWidth||400,n=Math.round(e.height)||o.offsetHeight||300;if(t<30||n<30)return null;let r=o.tagName.toLowerCase()==="svg"?o:o.querySelector("svg");if(r&&o.querySelectorAll("input, select, textarea").length===0)try{let h=await Yt(r);if(h.base64&&h.base64.length<=Pe)return{mediaType:h.mediaType,base64:h.base64,alt:o.getAttribute("aria-label")||r.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:fe(r)}}catch{}if(o instanceof HTMLCanvasElement)try{let h=await xe(o),A=await de(h);if(A)return{mediaType:"image/jpeg",base64:A,alt:o.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let h=o;for(;h&&h!==document.documentElement;){let b=(window.getComputedStyle?window.getComputedStyle(h):null)?.backgroundColor;if(b&&b!=="transparent"&&b!=="rgba(0, 0, 0, 0)"){a=b;break}h=h.parentElement}}catch{}let s=o.cloneNode(!0),i=Array.from(o.querySelectorAll("*")),d=Array.from(s.querySelectorAll("*"));for(let h=0;h<Math.min(i.length,d.length);h++){let A=i[h],b=d[h];if(!(!A||!b||!b.style))try{let v=window.getComputedStyle(A);b.style.color=v.color,b.style.backgroundColor=v.backgroundColor,b.style.borderColor=v.borderColor,b.style.borderWidth=v.borderWidth,b.style.borderStyle=v.borderStyle,b.style.fontSize=v.fontSize,b.style.fontFamily=v.fontFamily,b.style.fontWeight=v.fontWeight,b.style.lineHeight=v.lineHeight,b.style.letterSpacing=v.letterSpacing,b.style.textAlign=v.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,n))),u=Math.round(t*l),f=Math.round(n*l),c=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let s=this.element.querySelector("#eq-fah-header");this.setupDraggable(s)}setupDraggable(e){let t=n=>{if(n.target.closest(".eq-fah-btn"))return;n.preventDefault(),this.isDragging=!0,this.dragStartX=n.clientX,this.dragStartY=n.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let a=i=>{if(!this.isDragging||!this.element)return;let d=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),f=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),f);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},s=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",s)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",s)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),n=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,a=r.actions.filter(m=>m.t==="drag"),s=r.actions.filter(m=>{if(m.t!=="val")return!1;let p=T(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=r.actions.filter(m=>m.t==="sel"),l=a.length||s.length||i.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let f=document.createElement("span");f.textContent=`Modo: ${r.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(f,c),e.appendChild(u),a.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,n.textContent=String(a.length);let m={};for(let p of a){let h=T(p.to)||"Geral";m[h]||(m[h]=[]),m[h].push(T(p.from))}for(let[p,h]of Object.entries(m)){let A=document.createElement("div"),b=/fato|true|verdadeiro|sim/i.test(p),v=/opini[aã]o|false|falso|n[aã]o/i.test(p);A.className=`eq-fah-group ${b?"group-fato":v?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${p} (${h.length})`,A.appendChild(y);let C=document.createElement("div");C.className="eq-fah-group-items";for(let L of h){let x=document.createElement("div");x.className="eq-fah-item";let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=L,x.appendChild(E);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(L),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),x.appendChild(S),C.appendChild(x)}A.appendChild(C),e.appendChild(A)}}else if(s.length>0){t.textContent=`Preenchimento (${s.length} campos)`,n.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let A=0;A<s.length;A++){let b=s[A],v=document.createElement("div");v.className="eq-fah-item";let y=Ie(b.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${A+1}`);let C=String(b.v??""),L=document.createElement("div");L.className="eq-fah-field-box";let x=document.createElement("div");x.className="eq-fah-field-label",x.textContent=y,L.appendChild(x);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=C,L.appendChild(E),v.appendChild(L);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(C),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),v.appendChild(S),h.appendChild(v)}m.appendChild(h),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,n.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let A=0;A<i.length;A++){let b=i[A],v=document.createElement("div");v.className="eq-fah-item";let y=Ie(b.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&b.v&&(y=String(b.v)),y=T(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let C="",L=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);L?(C=L[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=L[2].trim()||y):i.length>1&&(C=String.fromCharCode(65+A));let x=document.createElement("div");if(x.style.display="flex",x.style.alignItems="center",x.style.gap="8px",x.style.flex="1",C){let w=document.createElement("span");w.className="eq-fah-letter-badge",w.textContent=C,x.appendChild(w)}let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=y||(C?`Alternativa ${C}`:"Alternativa Selecionada"),x.appendChild(E),v.appendChild(x);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(y||C),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),v.appendChild(S),h.appendChild(v)}m.appendChild(h),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,n.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let A=0;A<d.length;A++){let b=d[A],v=document.createElement("div");v.className="eq-fah-item";let y=Ie(b.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${A+1}`);let x=(Array.isArray(b.v)?b.v:[String(b.v??"")]).map(I=>{let q=P(b.id,void 0,!0)||P(T(b.id),void 0,!0),H=q instanceof HTMLSelectElement?q:q?.querySelector("select");if(H){let O=T(I).toLowerCase();for(let Q=0;Q<H.options.length;Q++){let N=H.options[Q];if(N.value.toLowerCase()===O||T(N.textContent).toLowerCase()===O){let U=T(N.textContent);if(U&&!U.toLowerCase().includes("selecione"))return U}}}return I}).join(", "),E=document.createElement("div");E.className="eq-fah-field-box";let S=document.createElement("div");S.className="eq-fah-field-label",S.textContent=y,E.appendChild(S);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=x,E.appendChild(w),v.appendChild(E);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(x),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),v.appendChild(M),h.appendChild(v)}m.appendChild(h),e.appendChild(m)}else{t.textContent="Gabarito",n.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let n=e.actions.filter(i=>i.t==="drag"),r=e.actions.filter(i=>i.t==="val"),a=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),s=e.actions.filter(i=>i.t==="sel");if(n.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let d of n){let l=T(d.to)||"Geral";i[l]||(i[l]=[]),i[l].push(T(d.from))}for(let[d,l]of Object.entries(i)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of r){let d=T(i.id);t.push(`- **${d||"Campo"}:** \`${i.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<a.length;i++){let d=a[i],l=Ie(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=T(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=a.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(s.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of s){let d=T(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`)).then(()=>{if(this.metricsCopyBtn){let n=this.metricsCopyBtn.innerHTML;this.metricsCopyBtn.innerHTML=" Copiado!",setTimeout(()=>{this.metricsCopyBtn.innerHTML=n},1500)}})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Do(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Bo(){let o=window;if(Te(),Do(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=_e(),t=null,n=null,r=0,a=new Ze(e,{onAnalyze:(l=1,u,f=!1)=>s(l,u,f),onApply:(l=1)=>void i(l),onDestroy:()=>{if(n){try{n.abort()}catch{}n=null}ge(),delete o.__easyquiz},onCancel:()=>{if(n){try{n.abort()}catch{}n=null}ge(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=Tt(l)}});o.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),s()}});async function s(l=1,u,f=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(n)try{n.abort()}catch{}n=new AbortController;let c=n,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){a.setBusy(!1),a.setProgress(0);return}r=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),ge(),a.hideFloatingAnswers();try{let p=pe(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ce()),ze(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let h=await wt(p.scope,e.useVision);if(h.length>0){let L=h.map(x=>x.element).filter(Boolean);vt(L),a.updateImages(h)}if(c.signal.aborted)return;let A=e.model;a.setStatus(h.length>0?`Consultando Gemini (${A}) com ${h.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${A}) via DOM nativo (modo r\xE1pido)...`,"info");let b=Se(p,h,e);a.setInspectorPrompt(b,e.model);let v=(L,x)=>{a.setStatus(L,x==="warning"?"info":x);let E=L.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(E){let S=E[1].split(",")[0].trim();a.setProgress(50,`Gemini ${S} respondendo...`)}},{plan:y,usedModel:C}=await je(p,h,e,v,c.signal);if(c.signal.aborted)return;if(y.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=pe(!0),p||(p=ce()),ze(p.scope),a.updateContext(p),h=await wt(p.scope,e.useVision),h.length>0){let E=h.map(S=>S.element).filter(Boolean);vt(E),a.updateImages(h)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let L=Se(p,h,e);a.setInspectorPrompt(L,e.model),y=(await je(p,h,e,v,c.signal)).plan}if(c.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||e.model} | Modo: ${y.mode} | Confian\xE7a: ${(y.confidence*100).toFixed(0)}%`,"text-green"),y.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${y.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${y.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),y.memoryToStore&&(St(y.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${y.memoryToStore}"`,"text-yellow")),y.imageDescriptions&&y.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${y.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let L of y.imageDescriptions){let x=L.relevant?"":"\uFE0F";a.logToConsole(`>   ${x} Imagem ${L.index+1} [${L.relevant?"RELEVANTE":"IGNORADA"}]: ${L.description}`,L.relevant?"text-blue":"text-yellow")}}return t=y,a.updateContext(p,y),Jt(y.actions,y.confidence),a.setPlan(y,!e.dryRun),y.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):y.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):y.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&y.pageType==="question"&&a.showFloatingAnswers(y),c.signal.aborted?void 0:((f||e.autoApply)&&!e.dryRun&&await i(l,c.signal,f),y)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){ge(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}ge(),a.setProgress(0);let h=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(h,"error"),a.setErrorDiagnostic(h,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),n===c&&(n=null),c.signal.aborted||a.setBusy(!1)}}async function i(l=1,u,f=!1){if(u?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(A=>A.t!=="adv"),p=t.pageType==="question"||Ue(t.rationale||"");if(p&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let h=(f||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let A=await He(t,h,l,ve(e));if(u?.aborted)return;if(a.setExecutionReport(A),A.failedActions&&A.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${A.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let L of A.failedActions){let x=L.action,E=x.t==="drag"?`drag: "${x.from}" \u2192 "${x.to}"`:x.t==="clk"||x.t==="chk"?`${x.t}: "${x.id}"`:x.t==="val"?`val: "${x.id}" = "${x.v}"`:JSON.stringify(x).slice(0,80);a.logToConsole(`>    [${x.t.toUpperCase()}] ${E} | ${L.evidence.slice(0,80)}`,"text-yellow")}await d(A.failedActions,u)}let b=r>0?Date.now()-r:1200,v=A.verified>0,y=A.applied>0;if(A.success||v&&y){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${A.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${A.verified} verificada(s) no DOM.`,"text-green"),A.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):h&&a.logToConsole(`> [NAV] ${A.navigationEvidence}`,"text-blue"),a.setStatus(A.advanced?`Sucesso: ${A.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${A.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let L=kt({id:`q-${Date.now()}`,questionIndex:(qe().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:b,status:"answered",mode:t.mode,actionsCount:A.applied});a.updateTimingMetrics(L)}else y?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${A.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${A.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${A.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${A.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(A){a.setProgress(0);let b=A instanceof Error?A.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${b}`,"error"),a.logToConsole(`> [ERRO] ${b}`,"text-red")}finally{a.setBusy(!1)}}async function d(l,u){if(!t)return;let f=l.filter(m=>m.action.t==="drag");for(let m of f){if(u?.aborted)return;let p=m.action,h=String(p.from||""),A=String(p.to||""),b=Ut(h,A,h,A);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${h}" \u2192 "${A}"`,"text-blue");let v={...t,actions:[{t:"js",v:b}],pageType:"question"},y=await He(v,!1,1,ve(e));a.logToConsole(y.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",y.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,h=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${h}`,"text-blue");let A=String(p.id||p.name||p.selector||""),b=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Je(m.action),await new Promise(v=>setTimeout(v,250)),oe(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${h}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let v=P(A,b)||P(A.replace(/[^\w\s]/g," ").trim(),b);if(v&&(gt(v),await new Promise(y=>setTimeout(y,300)),oe(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let v=P(A,b)||P(A.replace(/[^\w\s]/g," ").trim(),b);if(v&&(v.focus?.(),await new Promise(y=>setTimeout(y,50)),v.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),v.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80)),v.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),v.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200)),oe(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let v=P(A,b)||P(A.replace(/[^\w\s]/g," ").trim(),b);if(v){let y=v.id,C=!!y;y||(y=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,v.id=y);let L=String(p.v??""),x=p.t==="val",E=document.createElement("script");if(E.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(E),E.remove(),C||setTimeout(()=>{try{v.id===y&&v.removeAttribute("id")}catch{}},0),await new Promise(S=>setTimeout(S,300)),oe(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${h}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let v="";try{let q=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(H=>(H.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));q&&(v=q.outerHTML.slice(0,400))}catch{}let y=pe(!1)||ce(),C=`A\xE7\xE3o (${p.t}) alvo="${A}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${v?`
