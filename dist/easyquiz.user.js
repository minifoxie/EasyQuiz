...
`)})()}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Bo=new Set(["question","info","start","conclusion"]),Ro=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),No=new Set(["val","chk","sel","clk","adv","js","drag"]),jo=150,Ge=2e3;function ue(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Ge):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Ge):e}function Qo(o,e){if(!o||typeof o!="object")return null;let t=o,n=t.t;if(typeof n!="string"||!No.has(n))return null;if(n==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...ue(s)?{id:ue(s,"").slice(0,500)}:{}}}if(n==="drag"){let s=ue(t.from??t.source),u=ue(t.to??t.target??t.destination);return!s||!u?null:{t:"drag",from:s.slice(0,500),to:u.slice(0,500)}}if(n==="js"){let s=ue(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&n==="val"&&(i="1");let a=ue(i).slice(0,500);if(!a)return null;if(n==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:ue(s).slice(0,Ge)}}if(n==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(s)?s:[s]).map(d=>ue(d).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:l}}if(n==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",u={t:"chk",id:a,c:!s};return t.v!==void 0&&(u.v=ue(t.v).slice(0,Ge)),u}let r={t:"clk",id:a};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!s}return t.v!==void 0&&(r.v=ue(t.v).slice(0,Ge)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(r.co=[t.co[0],t.co[1]]),r}function Fo(o,e,t){if(t!=="question")return o;let n=o.filter(a=>a.t==="adv"),i=o.filter(a=>a.t!=="adv");if(e==="escolha_unica"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=i.filter(r=>r.t==="chk"||r.t==="clk");if(a.length>1){let r=i.filter(u=>u.t!=="chk"&&u.t!=="clk"),s=a[a.length-1];i=[...r,s]}}else if(e==="escolha_multipla"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=new Set;i=i.filter(r=>{let s="id"in r&&typeof r.id=="string"?r.id:"";return s?a.has(s)?!1:(a.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let a=new Set,r=[...i].reverse(),s=[];for(let u of r){let l="id"in u&&typeof u.id=="string"?u.id:"";l?a.has(l)||(a.add(l),s.push(u)):s.push(u)}i=s.reverse()}return[...i,...n]}function oo(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,n=e.mode;(typeof t!="string"||!Bo.has(t))&&(t="question"),(typeof n!="string"||!Ro.has(n))&&(n="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],a=[];for(let u=0;u<Math.min(i.length,jo);u++){let l=Qo(i[u],u);l&&a.push(l)}a.some(u=>u.t==="val")&&(n==="escolha_unica"||!e.mode)&&(n="preenchimento"),a.some(u=>u.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(n)&&(n="arrastar_soltar"),a=Fo(a,n,t);let r=a.some(u=>u.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?r||a.push({t:"adv"}):t==="question"&&!r&&a.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:n,confidence:s,rationale:ue(e.rationale,"Plano validado e auto-recuperado."),actions:a,...ue(e.memoryToStore)?{memoryToStore:ue(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var he=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let n=e.flatMap(a=>a.split(/[\n\r]+/));Array.from(new Set(n.map(a=>a.trim().replace(/^["']|["']$/g,"")).filter(a=>a.length>5))).forEach((a,r)=>{let s=this.generateId(a),u=t.get(s)||t.get(a);this.keys.set(s,{id:s,key:a,label:u?.label||`Chave ${r+1}`,addedAt:u?.addedAt||Date.now(),lastUsedAt:u?.lastUsedAt,lastLatencyMs:u?.lastLatencyMs,cooldownUntil:u?.cooldownUntil,errorCount:u?.errorCount||0,lastError:u?.lastError,winCount:u?.winCount||0})})}generateId(e){let t=0;for(let i=0;i<e.length;i++)t=(t<<5)-t+e.charCodeAt(i),t|=0;let n=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${n}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let n=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:n>0,remainingCooldownMs:n}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),n=Array.from(this.keys.values()).filter(a=>(a.errorCount||0)<50);if(n.length===0)return Array.from(this.keys.values()).slice(0,e);let i=n.filter(a=>(a.cooldownUntil||0)<=t);return i.length>0?(i.sort((a,r)=>{let s=a.lastLatencyMs!==void 0?a.lastLatencyMs:99999,u=r.lastLatencyMs!==void 0?r.lastLatencyMs:99999;if(s!==u)return s-u;let l=(a.lastUsedAt||0)-(r.lastUsedAt||0);return l!==0?l:a.addedAt-r.addedAt}),i.slice(0,e)):(n.sort((a,r)=>(a.cooldownUntil||0)-(r.cooldownUntil||0)),n.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let n=this.findKeyObj(e);n&&(n.cooldownUntil=Date.now()+t,n.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let n=this.findKeyObj(e);n&&(n.cooldownUntil=Date.now()+t,n.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let n=this.findKeyObj(e);n&&(n.lastLatencyMs=t,n.lastUsedAt=Date.now(),n.errorCount=0,n.lastError=void 0,n.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let n=this.findKeyObj(e);n&&(n.errorCount=99,n.lastError=t)}addKey(e,t){let n=e.trim().replace(/^["']|["']$/g,"");if(!n)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(n.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(n);if(this.keys.has(i)||Array.from(this.keys.values()).some(s=>s.key===n))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let r={id:i,key:n,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,r),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:r}}updateKey(e,t,n){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=t.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=a,n!==void 0&&(i.label=n.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},X=new he;var Oe=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],ao=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],Uo={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function Ht(o){return Uo[o]??o}function Xo(o,e){let n={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??Vo};return/lite/i.test(o)||(/gemini-3\.[0-9]+-?flash/i.test(o)?n.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(o)&&(n.thinkingConfig={thinkingBudget:0})),n}var Vo={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function io(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=Ht(e);return de(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function It(o,e){let t="";try{let n=JSON.parse(o);t=n.error?.message||n.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Go(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let n=e.match(/\{[\s\S]*\}/);if(n)try{return JSON.parse(n[0].trim())}catch{}try{let i=e.indexOf("{");if(i!==-1){let a=e.slice(i).trim();a=a.replace(/,\s*\{[^}]*$/,""),a=a.replace(/,\s*$/,"");let r=0,s=0,u=!1,l=!1;for(let m=0;m<a.length;m++){let c=a[m];if(l){l=!1;continue}if(c==="\\"){l=!0;continue}if(c==='"'){u=!u;continue}u||(c==="{"?r++:c==="}"?r=Math.max(0,r-1):c==="["?s++:c==="]"&&(s=Math.max(0,s-1)))}for(u&&(a+='"');s>0;)a+="]",s--;for(;r>0;)a+="}",r--;let d=JSON.parse(a);if(d&&typeof d=="object")return d}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var so=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(n=>n&&typeof n.id=="string"&&de(n.id));return t.length>0?t:null}return null}catch{return null}})(),Mt=new Set;async function it(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return Oe;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let n of t)try{let i=await fetch(n,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let r=await i.text(),s=It(r,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let a=await i.json();if(Array.isArray(a.models)&&a.models.length>0){let r=a.models.filter(s=>{let u=s.supportedGenerationMethods||[],l=(s.name||"").replace(/^models\//,""),d=u.includes("generateContent");return de(l)&&d}).map(s=>{let u=s.supportedGenerationMethods||[],l=s.name.replace(/^models\//,""),d=s.displayName||l;return{id:l,name:d.includes(l)?d:`${d} (${l})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:u.includes("generateContent"),supportedGenerationMethods:u,discoveredAt:Date.now()}});if(r.length>0){r.sort((s,u)=>{let l=d=>d==="gemini-3.8-flash"?200:d==="gemini-3.7-flash"?190:d==="gemini-3.6-flash"?180:d==="gemini-3.5-flash"?170:d==="gemini-3.5-flash-lite"?160:d==="gemini-2.5-flash"?130:d.includes("flash")?80:d==="gemini-2.5-pro"?60:d.includes("pro")?50:10;return l(u.id)-l(s.id)}),so=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return Oe}async function st(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let n=await it(e);if(n.length>0&&n!==Oe){let i=n[0];return{ok:!0,message:`Chave v\xE1lida! ${n.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:n}}}catch(n){return{ok:!1,message:n instanceof Error?n.message:String(n)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let n of t)for(let i of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${i}/models/${n}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${n} (${i})!`,models:Oe}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function Pt(o,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let n=Ht(io(o)),i=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),a={"Content-Type":"application/json"};async function r(l,d,m){let c=new AbortController,h=setTimeout(()=>c.abort(),m);try{let p=`https://generativelanguage.googleapis.com/v1beta/models/${d}:generateContent?key=${encodeURIComponent(l)}`,f=await fetch(p,{method:"POST",headers:{...a,"x-goog-api-key":l},body:i,signal:c.signal});if(clearTimeout(h),f.ok)return{ok:!0,model:d,key:l,message:`Modelo '${d}' validado com sucesso!`};let b=await f.text().catch(()=>"");throw new Error(`HTTP ${f.status}: ${b.slice(0,80)}`)}catch(p){throw clearTimeout(h),p}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(m=>r(m,n,8e3)))}catch{}}let s=t[0],u=[n,...ao.filter(l=>l!==n)];for(let l of u)try{let d=await r(s,l,4e3);return l!==n&&(d.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),d}catch{}return{ok:!1,model:n,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function Ko(o,e,t,n,i){let a=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${o}`),u={...Xo(o,i)};for(let l of a){if(n.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let d=`https://generativelanguage.googleapis.com/${l}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,m=Date.now();try{let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:u}),signal:n});if(!c.ok){let f=await c.text();if(c.status===400){let v=/thinking/i.test(f),x=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(f);if((v||x)&&(u.thinkingConfig||u.responseSchema)){let A={...u};v&&delete A.thinkingConfig,x&&(delete A.responseSchema,delete A.responseMimeType),u=A;let C=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:u}),signal:n});if(C.ok){let q=await C.json(),k=q.candidates?.[0];if(k?.content?.parts?.[0]?.text)return X.markSuccess(e,Date.now()-m),{rawText:k.content.parts[0].text,data:q,usedModel:o,usedKey:e}}let y=await C?.text?.().catch(()=>"")??f,w=It(y,c.status);throw new Error(`[${o}|${he.maskKey(e)}] ${w}`)}}let b=It(f,c.status);if(c.status===404&&l==="v1beta")continue;throw c.status===429?(X.markQuotaHit(e,8e3),ro(e,o,1e4),new Error(`[${o}|${he.maskKey(e)}] ${b}`)):(c.status===503||/no capacity|overloaded|unavailable/i.test(f)?(X.markOverloaded(e,5e3),Mt.add(o)):c.status===403||/API_KEY_INVALID/i.test(f)?X.markInvalid(e,b):c.status===404&&Mt.add(o),new Error(`[${o}|${he.maskKey(e)}] ${b}`))}let h=await c.json(),p=h.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error(`[${o}|${he.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return X.markSuccess(e,Date.now()-m),{rawText:p.content.parts[0].text,data:h,usedModel:o,usedKey:e}}catch(c){if(n.aborted)throw c;r=c;let h=r.message||"";if(h.includes("404")||/no longer available/i.test(h)){Mt.add(o);break}if(h.includes("429")||h.includes("Quota"))break}}throw r}var at=new Map;function no(o,e){let t=`${o}::${e}`,n=at.get(t);return n===void 0?!1:Date.now()>n?(at.delete(t),!1):!0}function ro(o,e,t=1e4){at.set(`${o}::${e}`,Date.now()+t)}function zt(){at.clear()}async function rt(o,e,t,n,i,a){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let r=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];X.init(r);let s=t.apiKey.trim().replace(/^["']|["']$/g,""),u=X.getBestKey()||s;if(!u)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=io(t.model);if(!so&&u&&it(u).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let d=Date.now(),m=Ve(o,e,t),c=[{text:m}];for(let z=0;z<e.length;z++){let T=e[z],P=T.associatedLabel||(T.alt?`Imagem: ${T.alt}`:`Imagem ${z+1}`);if(T.captureStatus==="text_only"||!T.base64){let j=T.textContext||T.alt||"";c.push({text:`[CONTEXTO_IMAGEM_${z+1} - V\xCDNCULO: ${P}]: ${j}`})}else c.push({text:`[ANEXO VISUAL ${z+1} - V\xCDNCULO: ${P}]:`}),c.push({inline_data:{mime_type:T.mediaType,data:T.base64}})}let h={system_instruction:{parts:[{text:a?.systemPromptOverride??to}]},contents:[{role:"user",parts:c}]},p=Ht(l),f=ao.filter(z=>z!==p),v=X.getAllKeys().length,x=z=>v<=1||z===0?1:2,A=new Set,C=(z,T)=>{let P=/pro/i.test(z),j=/lite/i.test(z);return P?T===0?18e3:T===1?24e3:3e4:j?T===0?1e4:T===1?14e3:18e3:T===0?16e3:T===1?2e4:25e3},y=async(z,T)=>{if(T.length===0||i?.aborted)return null;let P=T.map(()=>new AbortController),j=()=>P.forEach(F=>{try{F.abort()}catch{}});i?.addEventListener("abort",j,{once:!0});let Q=T.map(F=>`${F.model.replace("gemini-","")}/${F.label}`).join(" | ");n?.(`\u26A1 ${z}: ${T.length} slot(s) [${Q}]...`,"info");try{let F=T.map(async(W,oe)=>{let ee=P[oe],ne=setTimeout(()=>{try{ee.abort(new Error(`Timeout ${W.timeout/1e3}s (${W.model}|${W.label})`))}catch{ee.abort()}},W.timeout);try{let _=await Ko(W.model,W.key,h,ee.signal,a?.generationSchemaOverride);clearTimeout(ne);let re=oo(Go(_.rawText));return re.usedModel=_.usedModel,re.durationMs=Date.now()-d,re.promptSent=m,re.tokensUsed=_.data.usageMetadata?.totalTokenCount,re.promptTokens=_.data.usageMetadata?.promptTokenCount,re.candidatesTokens=_.data.usageMetadata?.candidatesTokenCount,re.rawResponse=_.rawText,P.forEach((Ne,Et)=>{if(Et!==oe)try{Ne.abort(new Error("Cancelado: vencedor respondeu."))}catch{Ne.abort()}}),{plan:re,rawUsage:_.data.usageMetadata,usedModel:_.usedModel,usedKey:_.usedKey,slotLabel:W.label}}catch(_){clearTimeout(ne);let re=_ instanceof Error?_.message:String(_);throw(re.includes("429")||re.includes("Quota")||re.includes("RESOURCE_EXHAUSTED"))&&(ro(W.key,W.model,1e4),X.markQuotaHit(W.key,8e3)),_}}),K=await Promise.any(F);return i?.removeEventListener("abort",j),X.markWinner(K.usedKey),K}catch(F){return i?.removeEventListener("abort",j),F instanceof AggregateError&&F.errors.length>0?E=F.errors.map(K=>K instanceof Error?K.message:String(K)).join(" | "):F instanceof Error&&(E=F.message),console.warn(`[EasyQuiz ${z}] Falha na onda:`,E),null}},q=(v<=1?1:1+Math.ceil((v-1)/2))+4,k=0,E="",H=0;for(;k<q;){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let z=X.getRoundRobinKeys(v),T=z.filter(ee=>!A.has(`${ee.key}::${p}`)&&!no(ee.key,p)),P,j;if(T.length>0)P=p,j=T;else{let ee=f;P=ee[H%ee.length]||p,H++;let ne=z.filter(_=>!A.has(`${_.key}::${P}`)&&!no(_.key,P));j=ne.length>0?ne:z.filter(_=>!A.has(`${_.key}::${P}`))}if(j.length===0){if(H<f.length)continue;break}let Q=j.slice(0,x(k));if(Q.length===0)break;let F=C(P,k),K=Q.map(ee=>(A.add(`${ee.key}::${P}`),{model:P,key:ee.key,label:ee.label||"Chave",timeout:F})),W=k===0?"Onda 1":`Onda ${k+1}`,oe=await y(W,K);if(oe){let ee=oe.plan.durationMs||Date.now()-d,ne=he.maskKey(oe.usedKey);return n?.(`\u2705 ${ee}ms via '${oe.usedModel}' (${oe.slotLabel}: ${ne})`,"info"),oe}k++}throw new Error(E||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var Wo=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Pe(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function Ot(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function lo(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(Wo.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var De=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]',".mq-editable-field",".mq-root-block",'[class*="expression-editor" i]','[class*="math-input" i]','[class*="perseus-dropdown" i]','[class*="perseus-radio" i]','[class*="perseus"] [role="listbox"]','[class*="perseus"] [role="radio"]','[class*="perseus"] [role="combobox"]','.perseus-widget-container [role="button"]',".perseus-widget-container input",".perseus-widget-container select",'.number-line [role="slider"]','[class*="interactive-graph" i]'].join(","),We=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,Ae=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,Jo=0;function Dt(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!pe(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function $(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function R(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||pe(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let n=e.type?.toLowerCase();if(n==="checkbox"||n==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${$(e.id)}"]`);if(a&&Dt(a))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Dt(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return Dt(e)}function Yo(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function J(o,e=500){return Yo(o).replace(/\s+/g," ").trim().slice(0,e)}function Zo(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(Jo+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function pe(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function we(o){if(!o)return!1;let e=o.closest('aside, nav, [class*="task-list" i], [class*="lesson-list" i], [class*="mastery" i], [class*="sidebar" i], [class*="side-bar" i], [class*="side_bar" i], [class*="unit-nav" i], [class*="course-nav" i], [data-testid*="sidebar" i], [data-testid*="task-list" i], [class*="practice-tab" i], [class*="progress-nav" i], [role="navigation"], [role="complementary"]');if(e&&!e.querySelector('.perseus-renderer, .framework-perseus, [data-test-id*="exercise" i]'))return!0;if(Be())try{let t=o.getBoundingClientRect();if(t.width>0&&t.left>=0&&t.right<window.innerWidth*.35)return!0}catch{}return!1}function Be(){try{if(/khanacademy\.org/i.test(window.location.href)||document.querySelector(".perseus-renderer, .framework-perseus"))return!0}catch{}return!1}var Ke=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function Y(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(pe(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let n=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||""),a=String(n.getAttribute?.("aria-label")||""),r=String(n.getAttribute?.("title")||""),s=typeof n.className=="string"?n.className:typeof n.className?.baseVal=="string"?n.className.baseVal:"",u=J(n.textContent,60);return!!(Ke.test(i)||Ke.test(a)||Ke.test(r)||Ke.test(s)||u.length>0&&u.length<=25&&Ke.test(u))}function le(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||pe(o)||Y(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=J(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),n=o.type,i=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),a=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return Ae.test(i)||Ae.test(t)?!1:We.test(i)||We.test(t)||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!o.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function Bt(o){let e=o.closest("tr");if(e){let u=e.querySelector("th, td:first-child"),l=u&&u!==o.closest("td")?J(u.textContent,100):"",d=J(o.closest("label, td")?.textContent||"",50);if(l&&d)return`${l}: ${d}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let u=t.querySelector('.dropdown-label, [class*="label" i]'),l=u&&u!==o?J(u.textContent,150):"";if(l)return l}let n=o.getAttribute("aria-label");if(n)return J(n);let i=o.getAttribute("aria-labelledby");if(i){let u=i.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(u.trim())return J(u)}if("labels"in o&&o.labels){let u=Array.from(o.labels??[]).map(l=>l.textContent).join(" ");if(u.trim())return J(u)}let a=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==o){let u=J(a.textContent);if(u)return u}let r=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||r||"";return J(s)}function Rt(o,e){let n=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let a=o.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(a)?a:"other",s=o.getAttribute("role")||"",u=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),l=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),d=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||l.includes("cursor-grab")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(u)||/drag|card-item|sortable/i.test(l),m=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(u)||/dropzone|category-box|bucket|target-zone/i.test(l),h=J((d?"draggable":m?"dropzone":"")||i.type||s||r,40),p="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox"){let C=i.checked||o.getAttribute("aria-checked")==="true",y=i.value&&i.value!=="on"?i.value:o.getAttribute("data-value")||"";p=C?y?`checked:${y}`:"checked":y||"unchecked"}else if(r==="button"||a==="a"||e==="navigation"||le(o))p="";else{let C=typeof o.value=="string"||typeof o.value=="number"?o.value:"";p=J(C||o.getAttribute("data-category")||"",2e3)}let f=[];if(n&&n.options)for(let C of Array.from(n.options).slice(0,80))f.push({value:J(C.value),label:J(C.textContent)});else if(s==="combobox"||s==="listbox"||l.includes("select")||l.includes("dropdown")){let C=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),y=C?document.getElementById(C):o;if(y){let w=y.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let q of Array.from(w).slice(0,80)){let k=J(q.textContent);k&&f.push({value:q.getAttribute("data-value")||q.getAttribute("value")||k,label:k})}}}let b=!!(i.required||o.getAttribute("aria-required")==="true"),v=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),x=Zo(o);return{id:o.id||x,tag:r,type:h,label:Bt(o),name:J(i.name||o.getAttribute("name")||"",180),value:p,options:f,required:b,disabled:v,role:e}}var co=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]','[role="group"]',"article","form","section","main"].join(",");function lt(o){if(!R(o)||we(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(De)).filter(b=>R(b)&&!we(b)),n=J(o.innerText||o.textContent||"",4e3).length;if(n<10||!t.length&&n<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),r=Math.min(1,a/i),s=e.top+e.height/2,u=e.left+e.width/2,l=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),d=Math.abs(u-window.innerWidth/2)/Math.max(1,window.innerWidth),m=n>40?35:0,c=e.top>=0&&e.bottom<=window.innerHeight?25:0,h=d>.35?150:0,p=r>.85?100:0,f=o.matches?.('.perseus-renderer, .framework-perseus, [data-test-id*="exercise" i]')?50:0;return Math.min(10,t.length)*15+Math.min(60,n/20)+m+c+f-r*30-l*20-h-p}function Re(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,n=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(n))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&n!=="main"&&n!=="body"){e=t;break}let i=J(e.innerText||e.textContent||"",1e4),a=J(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(De).length,s=t.querySelectorAll(De).length;if(i.length<150&&a.length>i.length&&s<=r+4&&n!=="main"&&n!=="body"){e=t;continue}break}return e}function $o(o,e=16e3){let t=o.cloneNode(!0);t.querySelectorAll('nav, aside, [class*="sidebar" i], [class*="lesson" i], [class*="_ka-drawer_" i], [class*="navigation" i], [role="navigation"]').forEach(l=>l.remove());let n=Array.from(t.querySelectorAll(".katex"));for(let l of n){let d=l.querySelector('annotation[encoding="application/x-tex"]');if(d&&d.textContent){let m=` $${d.textContent.trim()}$ `,c=document.createTextNode(m);l.replaceWith(c)}}let i=Array.from(t.querySelectorAll("math"));for(let l of i)try{let d=_o(l);if(d){let m=document.createTextNode(` ${d} `);l.replaceWith(m)}}catch{}let a=Array.from(t.querySelectorAll(".mq-root-block, .mq-editable-field"));for(let l of a){let d=l.textContent?.trim();d&&(l.textContent=` [math: ${d}] `)}let r=Array.from(t.querySelectorAll("sup"));for(let l of r)l.textContent=`^{${l.textContent?.trim()||""}}`;let s=Array.from(t.querySelectorAll("sub"));for(let l of s)l.textContent=`_{${l.textContent?.trim()||""}}`;let u=t.innerText&&t.innerText.trim().length>0?t.innerText:t.textContent||"";return J(u,e)}function _o(o){let e=[];function t(n){let i=n.tagName?.toLowerCase();if(i==="mfrac"){let a=Array.from(n.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`(${r}/${s})`);return}if(i==="msqrt"){e.push(`sqrt(${n.textContent?.trim()||"?"})`);return}if(i==="msup"){let a=Array.from(n.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`${r}^{${s}}`);return}if(i==="msub"){let a=Array.from(n.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`${r}_{${s}}`);return}if(i==="mn"||i==="mi"||i==="mo"||i==="mtext"){e.push(n.textContent?.trim()||"");return}for(let a of Array.from(n.children))t(a)}return t(o),e.join(" ")}function uo(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&R(t))return t;let n=0;for(;e.parentElement&&e.parentElement!==document.body&&n<3;)e=e.parentElement,n++;return e||document.body}var dt=new Map,en=3e4,po=8;function tn(){let o=window.location.href,e=dt.get(o);return e?Date.now()-e.timestamp>en?(dt.delete(o),null):e.selector:null}function Je(o){try{if(lt(o)<po)return;let e=o.tagName.toLowerCase(),t=o.id?`#${o.id}`:"",n=o.dataset.easyquizId?`[data-easyquiz-id="${o.dataset.easyquizId}"]`:"",i=Array.from(o.classList).slice(0,3).map(r=>`.${r}`).join(""),a=`${e}${t}${n}${i}`;a&&a!=="body"&&a!=="html"&&dt.set(window.location.href,{selector:a,timestamp:Date.now()})}catch{}}function ce(){let o=tn();if(o){try{let s=document.querySelector(o);if(s&&R(s)&&!we(s)&&lt(s)>=po)return Re(s)}catch{}dt.delete(window.location.href)}let e=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(e&&R(e))return Je(e),e;if(Be()){let u=Array.from(document.querySelectorAll(".perseus-renderer, .framework-perseus")).filter(l=>{if(!R(l)||we(l))return!1;let d=l.getBoundingClientRect();return d.width>100&&d.height>50&&d.bottom>0&&d.top<window.innerHeight});if(u.length>0){u.sort((d,m)=>{let c=d.getBoundingClientRect(),h=m.getBoundingClientRect();return h.width*h.height-c.width*c.height});let l=Re(u[0]);return Je(l),l}}let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(co);if(s&&!we(s)&&lt(s)>0){let u=Re(s);return Je(u),u}}let i=Array.from(document.querySelectorAll(co)).filter(s=>!we(s)).map(s=>({element:s,score:lt(s)})).filter(s=>Number.isFinite(s.score)).sort((s,u)=>u.score-s.score),a=i.find(s=>{let u=s.element.tagName.toLowerCase();return u!=="main"&&u!=="body"&&s.score>0});if(a){let s=Re(a.element);return Je(s),s}if(i.length>0&&i[0].score>0){let s=Re(i[0].element);return Je(s),s}let r=document.querySelector('form, main, [role="main"]');return r&&R(r)?r:document.body}function ho(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(n=>n.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(n=>{for(let i of Array.from(n.attributes))t.includes(i.name)||n.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function ct(o){let e=Array.from(o.querySelectorAll(De)),t=new Set,n=[],i=Be();for(let d of e){if(!R(d)||le(d)||Y(d)||i&&we(d))continue;let m=(d.value||d.textContent||"").trim();if(Ae.test(m))continue;let c=d.tagName.toLowerCase();["input","textarea","select"].includes(c)&&(t.add(d),n.push(d))}for(let d of e){if(!R(d)||le(d)||Y(d)||i&&we(d))continue;let m=(d.value||d.textContent||"").trim();if(Ae.test(m))continue;let c=d.tagName.toLowerCase();if(["input","textarea","select"].includes(c))continue;let h=d.querySelector("input, textarea, select");if(!(h&&t.has(h))){if(d.hasAttribute("for")){let p=d.getAttribute("for"),f=p?d.ownerDocument.getElementById(p):null;if(f&&t.has(f))continue}if(c==="a"){let p=d.getAttribute("role"),f=d.getAttribute("class")||"",b=d.getAttribute("data-testid")||"",v=d.getAttribute("draggable")==="true"||d.classList.contains("perseus-drag-item")||d.classList.contains("sortable-item")||f.includes("cursor-grab")||!!d.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(b)||/drag|card-item|sortable/i.test(f);if(!(p==="button"||p==="radio"||p==="checkbox"||p==="option"||v||d.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}n.push(d)}}let a=n.length>0&&n.every(d=>Y(d)||/read-?aloud|audio/i.test(d.getAttribute("data-testid")||d.getAttribute("aria-label")||"")),r=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,s=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((n.length===0||a)&&s){a&&(n.length=0);let d=Array.from(r.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(d.length>0){for(let m of d)if(!(!R(m)||Y(m))&&(n.push(m),n.length>=50))break}else{let m=Array.from(r.querySelectorAll("button, div[class], span[class], p, li"));for(let c of m){if(!R(c)||le(c)||Y(c)||Ae.test((c.textContent||"").trim()))continue;let h=(c.textContent||"").trim();if(h.length<2||h.length>300)continue;if(Array.from(c.children).some(f=>f.className&&f.textContent?.trim())||n.push(c),n.length>=50)break}}}let u=n.some(d=>["input","select","textarea"].includes(d.tagName.toLowerCase())),l=!u&&n.length>0&&n.every(d=>{let m=d.tagName.toLowerCase();if(["input","select","textarea","button"].includes(m))return!1;let c=(d.textContent||"").trim();return!d.id||c.length<10||/^\d+\s*\/\s*\d+$/.test(c)||/^question text/i.test(c)});if(n.length===0||l){l&&(n.length=0);let d=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(d.length>0)for(let m of d){if(!R(m)||pe(m)||le(m)||Y(m)||Ae.test((m.textContent||"").trim()))continue;let c=(m.textContent||"").trim();if(!(c.length<10||c.length>500)&&!/^\d+\s*\/\s*\d+$/.test(c)&&(n.push(m),n.length>=20))break}}if(n.length===0||n.length>0&&!u&&!n.some(d=>d.getAttribute("role")==="radio"||d.getAttribute("role")==="checkbox"||d.classList.contains("mq-editable-field")||d.closest(".perseus-widget-container"))){let m=document.querySelector(".perseus-renderer, .framework-perseus")||o,c=Array.from(m.querySelectorAll('.mq-editable-field, .mq-root-block, [class*="expression-editor" i], [class*="math-input" i]'));for(let v of c)!R(v)||pe(v)||n.includes(v)||n.push(v);let h=Array.from(m.querySelectorAll('[class*="perseus-dropdown" i], .perseus-widget-container select, .perseus-widget-container [role="combobox"], .perseus-widget-container [role="listbox"]'));for(let v of h)!R(v)||pe(v)||n.includes(v)||n.push(v);let p=Array.from(m.querySelectorAll('[class*="perseus-radio" i] [role="radio"], .perseus-widget-container [role="radio"], .perseus-widget-container [role="checkbox"]'));for(let v of p)!R(v)||pe(v)||v.querySelector('input[type="radio"], input[type="checkbox"]')||n.includes(v)||n.push(v);let f=Array.from(m.querySelectorAll('.perseus-widget-container [role="button"], .number-line [role="slider"], [class*="interactive-graph" i] [role="button"]'));for(let v of f)!R(v)||pe(v)||le(v)||n.includes(v)||n.push(v);let b=Array.from(m.querySelectorAll('.perseus-widget-container input:not([type="hidden"]), .perseus-widget-container textarea, .perseus-widget-container select'));for(let v of b)!R(v)||pe(v)||t.has(v)||n.includes(v)||n.push(v)}return n.slice(0,100).map(d=>Rt(d,"answer"))}function Nt(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,n=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(De)))if(!(t.has(a)||!R(a)||!le(a)||Y(a))&&(t.add(a),n.push(Rt(a,"navigation")),n.length>=10))return n;return n}function Ce(o=!1){let e=ce();e=Re(e),o&&(e=uo(e));let t=ct(e),n=Nt(e);if(t.length===0){let s=ct(document.body);s.length>0&&(e=uo(e),t=ct(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}n.length===0&&(n=Nt(document.body));let i=e.querySelector(".katex, math, .mq-root-block, .mq-editable-field"),a;if(i)a=$o(e,16e3);else{let s=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"";a=s.length>4e4?J(s.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+J(s.slice(-2e3),2e3):J(s,16e3)}let r=[...t,...n].slice(0,120);return!a||r.length===0&&a.length<30?J(document.body.innerText||document.body.textContent||"",16e3).length>=30?Ee():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:ho(e),controls:r,scope:e}}function Ee(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=J(o,16e3),t=ct(document.body),n=Nt(document.body),i=[...t,...n].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:ho(a).slice(0,15e3),controls:i,scope:a}}function jt(o){let e=o.controls.map(t=>{let n=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${n}`}).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function ut(o){if(!o)return!1;let e=o.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(n=>e.includes(n))}function G(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function I(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function ie(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let n=o.getAttribute("for");if(n){let i=o.ownerDocument.getElementById(n);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let n=e.getAttribute("for"),a=(n?e.ownerDocument.getElementById(n):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let n=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(n)return ie(n)}return o}function mo(o){let e=o;if(!e||!document.contains(e))try{e=ce()}catch{}e=e||document.body;let t=i=>{let a=Array.from(i.querySelectorAll("tr")).filter(d=>R(d)&&d.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let r=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(d=>R(d)&&!G(d));if(r.length>0)return r;let u=Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(d=>R(d)&&!G(d)).filter(d=>!d.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return u.length>0?u:Array.from(i.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(d=>{let m=d;return R(m)&&!G(m)&&(m.textContent||"").trim().length>2&&!le(m)&&!Y(m)&&!m.querySelector("[class]")})},n=t(e);return n.length>0?n:e!==document.body?t(document.body):[]}function N(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=$(i),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!G(r))return ie(r);try{let c=document.getElementById(i);if(c&&R(c)&&!G(c))return c.hasAttribute("data-category")||c.hasAttribute("data-dropzone")||c.classList.contains("dnd-zone")?c:ie(c)}catch{}try{let c=document.querySelector(`[data-item-id="${a}"]`);if(c&&R(c)&&!G(c))return ie(c)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let c=parseInt(s[1],10);if(t){let p=document.body;try{p=ce()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>R(b)&&!G(b));if(c>=1&&c-1<f.length)return f[c-1];if(c===0&&f.length>0)return f[0]}let h=c-1;if(h>=0){let p=mo();if(h<p.length){let v=p[h];if(v.tagName.toLowerCase()==="tr"){if(e){let A=v.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(A)return A}let x=v.querySelector("input");if(x)return x}return ie(v)}let f=document.body;try{f=ce()||document.body}catch{}let b=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>R(v)&&!G(v));if(h<b.length)return b[h]}}let u=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(u){let c=u[1].toUpperCase(),h=c.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${c}" i], input[type="checkbox"][value="${c}" i]`)).find(b=>R(b)&&!G(b));if(p)return ie(p);let f=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(b=>{if(!R(b)||G(b))return!1;let x=(b.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(x===c||x===`${c})`||x===`(${c})`||x===`${c}.`||x===`${c}:`)return!0;let A=(b.textContent||"").trim().toUpperCase();return A.startsWith(`${c})`)||A.startsWith(`(${c})`)||A.startsWith(`${c}.`)||A.startsWith(`${c}:`)});if(f)return ie(f);if(h>=0){let b=mo();if(h<b.length){let v=b[h];if(v.tagName.toLowerCase()==="tr"){if(e){let A=v.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(A)return A}let x=v.querySelector("input");if(x)return x}return ie(v)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let h=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(v=>R(v)&&!G(v));if(h)return h;let f=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(v=>R(v)&&!G(v));if(f)return ie(f);let b=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(v=>{if(!R(v)||G(v))return!1;let x=I(v.textContent).toLowerCase();return x===i.toLowerCase()||x===i.toLowerCase()+")"});if(b)return ie(b)}try{let c=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let p=c.find(f=>{if(!R(f)||G(f))return!1;if(f instanceof HTMLInputElement&&f.value.toLowerCase()===e.toLowerCase())return!0;let b=f.closest("label, .vf-label, td, div");return b&&I(b.textContent).toLowerCase().includes(I(e).toLowerCase())});if(p)return ie(p)}let h=c.find(p=>R(p)&&!G(p));if(h)return h.hasAttribute("data-category")||h.hasAttribute("data-dropzone")||h.classList.contains("dnd-zone")?h:ie(h)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let h=Array.from(document.querySelectorAll(i)).find(p=>R(p)&&!G(p));if(h)return ie(h)}catch{}try{let c=i.replace(/"/g,""),h=`//button[normalize-space(.)="${c}"] | //a[normalize-space(.)="${c}"] | //*[not(*) and normalize-space(.)="${c}"] | //*[@aria-label="${c}"] | //*[@data-category="${c}"] | //*[@data-testid="${c}"]`,p=document.evaluate(h,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let f=0;f<p.snapshotLength;f++){let b=p.snapshotItem(f);if(b&&R(b)&&!G(b)){if(["body","html"].includes(b.tagName.toLowerCase())){let x=b.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(x&&R(x))return ie(x)}return b.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ie(b)}}}catch{}let d=I(i).toLowerCase(),m=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let c of m){if(!R(c)||G(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=I(c.textContent).toLowerCase(),f=I(c.getAttribute("aria-label")||"").toLowerCase(),b=I(c.getAttribute("placeholder")||"").toLowerCase(),v=I(c.getAttribute("title")||"").toLowerCase(),x=I(c.getAttribute("name")||"").toLowerCase(),A=I(c.getAttribute("data-category")||"").toLowerCase(),C=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"",y=I(C).toLowerCase(),w=p.startsWith(d+")")||p.startsWith(d+".")||p.startsWith(d+" -")||p.startsWith(d+":");if(p===d||f===d||b===d||v===d||x===d||A&&A===d||y&&y===d||w)return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ie(c)}if(d.length>=3)for(let c of m){if(!R(c)||G(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=I(c.textContent).toLowerCase(),f=I(c.getAttribute("aria-label")||"").toLowerCase(),b=I(c.getAttribute("placeholder")||"").toLowerCase(),v=I(c.getAttribute("title")||"").toLowerCase(),x=I(c.getAttribute("name")||"").toLowerCase();if(p.includes(d)||f.includes(d)||b.includes(d)||v.includes(d)||x.includes(d)){if(Array.from(c.children).some(w=>{let q=I(w.textContent).toLowerCase();return q&&q.includes(d)}))continue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ie(c)}let A=d.split(/\s+/).filter(Boolean);if(A.length>=3){let C=A.slice(0,Math.min(5,A.length)).join(" ");if(p.includes(C)||f.includes(C)||b.includes(C))return ie(c)}}return null}function go(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function se(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),n=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),i=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:i};try{o.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}if(typeof o.click=="function")try{o.click()}catch{try{o.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{o.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let r=Object.keys(o).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(r){let s=o[r];for(;s;){let u=s.memoizedProps||s.pendingProps;if(u?.onClick){u.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let r=Object.keys(o).find(s=>s.startsWith("__reactProps"));if(r){let s=o[r];s?.onClick&&s.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let r=o._vei;r?.onClick&&(Array.isArray(r.onClick.value)?r.onClick.value:[r.onClick.value]).forEach(u=>{try{u({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=o.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let u=o.closest("[jsaction]");if(u&&u!==o)try{u.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:n,clientY:i}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function Ut(o){try{let e=o.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,o.id=e);let n=document.createElement("script");return n.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(n),n.remove(),t||setTimeout(()=>{try{o.id===e&&o.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function pt(o,e){let t=o;if(t.hasAttribute("for")){let m=t.getAttribute("for"),c=t.ownerDocument.getElementById(m);c&&(t=c)}let n=t.classList?.contains("mq-editable-field")||t.classList?.contains("mq-root-block")?t:t.querySelector(".mq-editable-field, .mq-root-block");if(n)try{let m=n.__mathquill||n.mathquill;if(m&&typeof m.latex=="function"){m.latex(e),n.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),n.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));return}let c=window.MathQuill?.getInterface?.(2)||window.MathQuill?.getInterface?.(1);if(c){let h=c(n);if(h&&typeof h.latex=="function"){h.latex(e),n.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}));return}}n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:"a",code:"KeyA",ctrlKey:!0,bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keydown",{key:"Backspace",code:"Backspace",bubbles:!0}));for(let h of e)n.dispatchEvent(new KeyboardEvent("keydown",{key:h,code:`Key${h.toUpperCase()}`,bubbles:!0,cancelable:!0})),n.dispatchEvent(new KeyboardEvent("keypress",{key:h,code:`Key${h.toUpperCase()}`,bubbles:!0,cancelable:!0})),n.dispatchEvent(new InputEvent("input",{data:h,inputType:"insertText",bubbles:!0,cancelable:!0,composed:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:h,code:`Key${h.toUpperCase()}`,bubbles:!0,cancelable:!0}));n.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));return}catch(m){console.warn("[EasyQuiz] MathQuill fill falhou, continuando com fallback padr\xE3o:",m)}let i=t.matches?.('[class*="perseus-dropdown" i], [class*="perseus"] [role="combobox"]')?t:t.querySelector('[class*="perseus-dropdown" i], [class*="perseus"] [role="combobox"]');if(i)try{se(i),setTimeout(()=>{let m=e.trim().toLowerCase(),c=Array.from(document.querySelectorAll('[role="option"], [role="listbox"] [role="option"], [class*="dropdown"] [role="option"], [class*="perseus"] [class*="option"], .dropdown-option, [class*="select-option"]')).filter(h=>{let p=h;if(!R(p)||G(p))return!1;let f=(p.textContent||"").trim().toLowerCase(),b=p.getAttribute("data-value")?.toLowerCase()||"";return f===m||b===m||f.includes(m)||m.length>2&&m.includes(f)});c.length>0&&se(c[0])},250);return}catch(m){console.warn("[EasyQuiz] Perseus dropdown fill falhou:",m)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){ht(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){ht(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let m=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(m)t=m;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let p=t.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){t=p;break}let f=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f){t=f;break}p=p.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let m=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m)t=m;else{let c=document.body;try{c=ce()||document.body}catch{}let h=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let m=document.body;try{m=ce()||document.body}catch{}let c=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let m=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;qe(t,m);return}let u=String(e??""),l=u;if(t instanceof HTMLInputElement&&t.type==="number"){let m=u.replace(",",".").replace(/[^0-9.-]/g,"");m&&!isNaN(Number(m))&&(l=m)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let m=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,c=Object.getOwnPropertyDescriptor(m,"value")?.set;c?c.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let d=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(d=document.execCommand?.("insertText",!1,l)||!1):t.isContentEditable&&(d=document.execCommand?.("insertText",!1,l)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(l===""?" ":"")}catch{}let m=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,c=Object.getOwnPropertyDescriptor(m,"value")?.set;c?c.call(t,l):t.value=l;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:l.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:l.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==l&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(l))){t.value=l;try{c?.call(t,l)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==l.trim()){t.textContent=l;try{t.innerText=l}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=l),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Ye(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let n=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=I(t),a=N(t)||N(i);if(!a)return n?e:i||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let m=I(r.textContent);if(m&&m.length>0&&m.length<150)return m}if(a.id){let m=document.querySelector(`label[for="${$(a.id)}"]`);if(m){let c=I(m.textContent);if(c&&c.length>0&&c.length<150)return c}}let s=a.getAttribute("aria-label");if(s)return I(s);let u=a.getAttribute("placeholder");if(u)return I(u);let l=I(a.textContent);if(l&&l.length>0&&l.length<120)return l;let d=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return d?I(d):n?e:i||e}function qe(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,n=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!n&&t.hasAttribute("for")&&(n=t.ownerDocument.getElementById(t.getAttribute("for")));let i=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&R(t)?t:o;if(n){let a=n.type==="radio",r=n.type==="checkbox",s=!!n._valueTracker;if(n.checked===e){if(a&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(r){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(i&&i!==n&&se(i),n.checked!==e)try{n.focus?.(),n.click()}catch{}if(n.checked!==e){try{let l=n._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(n,e)}catch{}n.checked=e,go(n,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;se(i),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function ht(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let r=e.map(l=>I(l).toLowerCase()),s=!1,u=(l,d)=>{l.selected=!0,t.selectedIndex=d;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let m=t._valueTracker;m&&m.setValue(l.value)}catch{}s=!0};for(let l=0;l<t.options.length;l++){let d=t.options[l],m=d.value.toLowerCase(),c=I(d.textContent).toLowerCase();if(r.some(p=>p===m||p===c)){if(u(d,l),!t.multiple)break}else t.multiple||(d.selected=!1)}if(!s)for(let l of r){let d=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(d){let m=parseInt(d[1],10),h=t.options[0]?.value===""||t.options[0]?.disabled?m:m>=1?m-1:0;if(h>=0&&h<t.options.length&&(u(t.options[h],h),!t.multiple))break}}if(!s){for(let l of r)if(/^[a-z]$/i.test(l)){let d=l.toUpperCase().charCodeAt(0)-65,c=t.options[0]?.value===""||t.options[0]?.disabled?d+1:d;if(c>=0&&c<t.options.length&&(u(t.options[c],c),!t.multiple))break}}if(!s){let l=d=>d.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let d=0;d<t.options.length;d++){let m=t.options[d],c=l(m.value.toLowerCase()),h=l(I(m.textContent).toLowerCase());if(r.some(f=>{let b=l(f);return c.includes(b)||h.includes(b)||b.length>2&&(b.includes(c)||b.includes(h))})&&(u(m,d),!t.multiple))break}}if(s){go(t,["focus","input","change","blur"]);return}}let n=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');n&&se(n);let i=e.map(r=>I(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>R(r)&&!G(r));for(let r of i){let s=a.find(l=>{let d=I(l.textContent).toLowerCase(),m=I(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return d===r||m===r||d.includes(r)||r.length>2&&r.includes(d)});if(s){se(s);let l=s.querySelector('input[type="radio"], input[type="checkbox"]');l&&qe(l,!0);return}let u=N(r);if(u){se(u);return}}}function on(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Qt(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function nn(o,e,t){try{if(e.contains(o))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(o))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let n=e.children.length;if(t!==void 0&&n>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${n}`};if([o.getAttribute("data-placed")==="true",o.getAttribute("data-assigned")==="true",o.getAttribute("data-matched")==="true",o.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(o.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(o.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(u=>u!==e&&(u.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:o.getAttribute("aria-hidden")==="true"||o.style.display==="none"||o.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function ge(o,e){let t=I(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let s=document.getElementById(o.trim());if(s&&R(s)&&!G(s))return s}let r=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of r){let l=Array.from(document.querySelectorAll(s)).find(d=>{if(!R(d)||G(d))return!1;let m=I(`${d.id} ${d.textContent||""} ${d.getAttribute("data-id")||""}`).toLowerCase();return m===t||m.includes(t)||d.id===o.trim()});if(l)return l}return null}let n=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),i=Array.from(document.querySelectorAll(n)),a=i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return a&&R(a)&&!G(a)?a:i.find(r=>{if(!R(r)||G(r)||/unclassified/i.test(r.className))return!1;let s=r.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),u=I(s?.textContent||r.textContent||"").toLowerCase();return u.includes("op")&&(u.includes("es")||u.includes("\xF5es"))?!1:u===t||u.startsWith(t)||u.includes(t)})||null}async function mt(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let n=o.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(n.left+Math.max(1,n.width/2)),r=Math.round(n.top+Math.max(1,n.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),u=Math.round(i.top+Math.max(1,i.height/2)),l=I(e.textContent).toLowerCase();if(l){let f=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let v=I(b.textContent).toLowerCase(),x=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?I(b.value).toLowerCase():"";return v&&(l.includes(v)||v.includes(l))||x&&(l.includes(x)||x.includes(l))});f&&(se(f),await new Promise(b=>setTimeout(b,120)))}Qt(o),await new Promise(p=>setTimeout(p,140)),Qt(e);let d=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(d&&d!==e&&Qt(d),await new Promise(p=>setTimeout(p,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",m));let c=4;for(let p=1;p<=c;p++){let f=Math.round(a+(s-a)*(p/c)),b=Math.round(r+(u-r)*(p/c)),v={...m,clientX:f,clientY:b,screenX:f,screenY:b};try{o.dispatchEvent(new PointerEvent("pointermove",{...v,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",v))}let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:u,screenX:s,screenY:u,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",h)),e.dispatchEvent(new MouseEvent("click",h));try{let p=on(J(o.textContent),o.outerHTML),f={...m},b={...h};p&&(f.dataTransfer=p,b.dataTransfer=p);let v=o.ownerDocument.defaultView?.DragEvent;if(!v)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new v("dragstart",f)),e.dispatchEvent(new v("dragenter",b)),e.dispatchEvent(new v("dragover",b)),e.dispatchEvent(new v("drop",b)),o.dispatchEvent(new v("dragend",f))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:o,clientX:a,clientY:r}),f=new Touch({identifier:1,target:e,clientX:s,clientY:u});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(o))try{let p=v=>{let x=Object.keys(v).find(C=>C.startsWith("__reactFiber")||C.startsWith("__reactInternalInstance"));if(!x)return null;let A=v[x];for(let C=0;C<10&&A;C++){if(A.memoizedProps)return A.memoizedProps;A=A.return}return null},f=p(o),b=p(e);if(f){let v=f.onMouseDown||f.onPointerDown||f.onDragStart;if(typeof v=="function")try{v({type:"mousedown",button:0,buttons:1,clientX:a,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:o,target:o}),await new Promise(x=>setTimeout(x,100))}catch{}}if(b){let v=b.onMouseUp||b.onPointerUp||b.onDrop;if(typeof v=="function")try{v({type:"mouseup",button:0,buttons:0,clientX:s,clientY:u,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200));let v=u>r?"ArrowDown":"ArrowUp";for(let x=0;x<3;x++)document.dispatchEvent(new KeyboardEvent("keydown",{key:v,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80))}catch{}try{document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(o.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:o.id||o.getAttribute("data-id")}})),await new Promise(x=>setTimeout(x,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}}function fo(o,e,t,n){let i=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),a=i(o.toLowerCase()),r=i(e.toLowerCase()),s=i(t),u=i(n);return`var src=$eq.find('${s}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${a}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${r}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${a} -> ${r}');}`}var bo={fill:(o,e)=>{let t=N(o);t?pt(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=N(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?qe(e,!0):se(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=N(o);t?qe(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>N(o,e),drag:(o,e)=>{let t=ge(o,"source")||N(o),n=ge(e,"destination")||N(e);t&&n?mt(t,n):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=ge(o,"source")||N(o),n=ge(e,"destination")||N(e);if(!t||!n){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await mt(t,n)},execute:(o,e=!1,t=1)=>Ze(o,e,t)};typeof window<"u"&&(window.$eq=bo);async function an(o,e,t){if(!e)return!1;if(o.t==="val"&&(e.classList.contains("mq-editable-field")||e.closest(".mq-editable-field"))){let n=e.classList.contains("mq-editable-field")?e:e.closest(".mq-editable-field");if(n){try{let i=n.__controller||n.__mathquill_controller;if(i&&i.API)return i.API.latex(t),!0}catch{}try{n.focus();for(let i of t){let a={key:i,bubbles:!0,cancelable:!0};n.dispatchEvent(new KeyboardEvent("keydown",a)),n.dispatchEvent(new KeyboardEvent("keypress",a)),document.execCommand?.("insertText",!1,i),n.dispatchEvent(new KeyboardEvent("keyup",a))}return!0}catch{}}}if(o.t==="sel"&&e.closest(".perseus-widget-container")){let n=e.tagName==="BUTTON"?e:e.querySelector("button")||e.closest("button");if(n)try{se(n),await new Promise(a=>setTimeout(a,150));let i=Array.from(document.querySelectorAll('[data-reach-popover], [role="listbox"], .perseus-dropdown'));for(let a of i){let s=Array.from(a.querySelectorAll('[role="option"], li, button')).find(u=>I(u.textContent).toLowerCase().includes(I(t).toLowerCase()));if(s)return se(s),!0}se(n)}catch{}}if((o.t==="clk"||o.t==="chk")&&e.closest(".perseus-widget-container"))try{let n=Object.keys(e).find(a=>a.startsWith("__reactFiber$")),i=Object.keys(e).find(a=>a.startsWith("__reactProps$"));if(i&&e[i]){let a=e[i];if(typeof a.onClick=="function")return a.onClick({preventDefault:()=>{},stopPropagation:()=>{}}),!0;if(typeof a.onChange=="function")return a.onChange({target:{checked:!0,value:t},preventDefault:()=>{}}),!0}}catch{}return!1}async function sn(o,e=1,t=Pe()){if(Ot(o,t),o.t==="js"){let u=String(o.v||"");lo(u);try{new Function("$eq","document","window",u)(bo,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let u=ge(o.from,"source")||N(o.from),l=ge(o.to,"destination")||N(o.to);!u&&o.from&&(u=N(I(o.from))),!l&&o.to&&(l=N(I(o.to))),u&&l?await mt(u,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let n=o.id!==void 0&&o.id!==null?String(o.id):"";!n&&o.t==="val"&&(n=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,a=i!=null?String(i).trim():"",r=null,s=String(o.name??o.n??"").trim();if(!s&&n&&document.querySelector(`input[type="radio"][name="${$(n)}"]`)&&(s=n),(o.t==="chk"||o.t==="clk")&&s){let u=Array.from(document.querySelectorAll(`input[name="${$(s)}"]`));if(a&&(r=u.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!r&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),d=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||d){let m=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=u.find(c=>{let h=c.value?.toLowerCase()??"";if(m.includes(h))return!0;let f=(c.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return m.some(b=>f===b||f.startsWith(b+" ")||f.startsWith("("+b+")"))})??null}}!r&&u.length>0&&(r=u[0])}if(r||(r=N(n,a,o.t==="val"||o.t==="sel")),!r&&n&&(r=N(I(n),a,o.t==="val"||o.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(I(r.value).toLowerCase()!==I(a).toLowerCase()){let u=document.querySelector(`input[type="radio"][name="${$(r.name)}"][value="${$(a)}" i]`);if(u)r=u;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(r.name)}"]`)).find(m=>{let c=m.closest("label, .vf-label, .option-card, tr, td, div");return c&&I(c.textContent).toLowerCase().includes(I(a).toLowerCase())});d&&(r=d)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let u=r.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(u)r=u;else{let d=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(m=>{let c=m.closest("label, .vf-label, .option-card, td, div");return c&&I(c.textContent).toLowerCase().includes(I(a).toLowerCase())});d&&(r=d)}}}if(!r&&(o.t==="val"||o.t==="sel")){let u=document.body;try{u=ce()||document.body}catch{}let l=Array.from(u.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(d=>R(d)&&!G(d));if(l.length===1)r=l[0];else if(l.length>1){let d=I(n).toLowerCase(),m=d.match(/^#?_?([0-9]+)$/);if(m){let c=parseInt(m[1],10);c>=1&&c<=l.length?r=l[c-1]:c>=0&&c<l.length&&(r=l[c])}r||(r=l.find(h=>{let p=(h.getAttribute("placeholder")||"").toLowerCase(),f=(h.name||"").toLowerCase(),b=(h.getAttribute("aria-label")||"").toLowerCase(),v=(h.id||"").toLowerCase(),x=I(Bt(h)).toLowerCase(),A=I(h.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(d)||f.includes(d)||b.includes(d)||v.includes(d)||x&&x.includes(d)||d.length>=2&&A.includes(d)})||(l.length===1?l[0]:null))}}if(!r&&o.t!=="adv"){let u=document.querySelector(".perseus-renderer, .framework-perseus, .perseus-widget-container");if(u){let l=I(n).toLowerCase(),d=Array.from(u.querySelectorAll('.mq-editable-field, [role="radio"], [role="checkbox"], [role="combobox"], input:not([type="hidden"]), textarea, select, [role="button"], [role="option"]')).filter(m=>R(m)&&!G(m));if(r=d.find(m=>{let c=(m.textContent||"").trim().toLowerCase(),h=(m.id||"").toLowerCase(),p=(m.getAttribute("aria-label")||"").toLowerCase(),f=(m.value||m.getAttribute("data-value")||"").toLowerCase();return h===l||c===l||p===l||f===l||l.length>=3&&(c.includes(l)||p.includes(l))})||null,!r&&o.t==="val"&&d.length>0){let m=d.filter(c=>c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement||c.classList.contains("mq-editable-field")||c.classList.contains("mq-root-block")||c.isContentEditable);if(m.length>0){let c=l.match(/^#?_?([0-9]+)$/);if(c){let h=parseInt(c[1],10);r=m[Math.min(h-1,m.length-1)]||m[0]}else r=m[0]}}}}if(!r&&o.t!=="adv")throw new Error(`Alvo '${n}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);if(!(Be()&&r&&o.t!=="js"&&o.t!=="adv"&&await an(o,r,a)))switch(o.t){case"val":if(r){let d=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!d){let f=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');f&&(d=f)}if(!d){let p=r.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){d=p;break}let f=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f){d=f;break}p=p.nextElementSibling}}if(!d){let p=document.body;try{p=ce()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(b=>R(b)&&!G(b));f.length>0&&(d=f[0])}let m=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,c=m!=null?String(m):"",h=d||r;if(h instanceof HTMLInputElement){let p=h.type.toLowerCase(),f=h.maxLength,b=h.min,v=h.max,x=h.step,A=h.pattern;if(f>0&&c.length>f&&(c=c.slice(0,f)),p==="number"||p==="range"){let C=parseFloat(c);if(!isNaN(C)){let y=C;if(b!==""&&!isNaN(parseFloat(b))&&(y=Math.max(y,parseFloat(b))),v!==""&&!isNaN(parseFloat(v))&&(y=Math.min(y,parseFloat(v))),x!==""&&x!=="any"&&!isNaN(parseFloat(x))){let w=parseFloat(x),q=b!==""?parseFloat(b):0;y=q+Math.round((y-q)/w)*w,b!==""&&!isNaN(parseFloat(b))&&(y=Math.max(y,parseFloat(b))),v!==""&&!isNaN(parseFloat(v))&&(y=Math.min(y,parseFloat(v)))}c=Number.isInteger(y)?String(y):String(parseFloat(y.toFixed(6)))}}if(A)try{let C=new RegExp(`^(?:${A})$`);if(!C.test(c)){let y=c.match(/-?\d+\.?\d*/);y&&C.test(y[0])&&(c=y[0])}}catch{}}pt(d||r,c)}break;case"chk":let u=o.c!==void 0?!!o.c:!0;r&&qe(r,u);break;case"sel":if(r){let d=Array.isArray(o.v)?o.v:[String(o.v)];ht(r,d)}break;case"clk":if(r)if(!!(r.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let m=o.c!==void 0?!!o.c:!0;qe(r,m)}else se(r,o.co);break;case"adv":let l=ft(o.id);if(l){await Ft(l,1200);let d=o.id||l.textContent?.trim()||"";d&&Lt(window.location.hostname,{advanceSelector:d}),se(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function rn(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!R(t)||G(t)||t.closest("header, nav, aside"))return!1;let n=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||n||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function ft(o){let e=c=>{let h=(c.getAttribute("aria-label")||c.textContent||(c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"")||"").trim();return Ae.test(h)};if(o){let c=N(o);if(c&&R(c)&&!G(c)&&!Y(c)&&!e(c))return c}try{let c=St(window.location.hostname);if(c.advanceSelector){let h=N(c.advanceSelector);if(h&&R(h)&&!G(h)&&!Y(h)&&!e(h))return h}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),n=Array.from(document.querySelectorAll(t)),i=c=>{let h=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"";return(c.getAttribute("aria-label")||c.textContent||h||"").trim()},a=c=>{let h=i(c).trim();return/^\d{1,3}$/.test(h)?!!c.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},r=n.filter(c=>R(c)&&!G(c)&&!c.closest("header, aside")&&!Y(c)&&!e(c));for(let c of r){let h=i(c),p=h.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((We.test(h)||We.test(p))&&!a(c)&&!Y(c))return c}for(let c of r)if(le(c)&&!Y(c)&&!a(c))return c;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&R(s)&&!G(s)&&!Y(s)&&!e(s))return s;let u=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let c of u)if(R(c)&&!G(c)&&!e(c)&&!Y(c)&&!a(c))return c;let l=Array.from(document.querySelectorAll('button, [role="button"]')),d=window.innerHeight,m=l.filter(c=>{if(!R(c)||G(c)||e(c)||Y(c)||c.closest("header, nav, aside, .eq-sidebar")||a(c))return!1;let h=c.getBoundingClientRect();return h.top>d*.45&&h.height>=24&&h.width>=24});if(m.length>0)return m.sort((c,h)=>{let p=c.getBoundingClientRect(),f=h.getBoundingClientRect(),b=p.left+p.top;return f.left+f.top-b}),m[0];for(let c of r)if(le(c)&&!Y(c))return c;return null}async function Ft(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function ln(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,n=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${n}`}async function cn(o,e=3500){let[t,n,i,a]=o.split("|"),r=parseInt(a||"0",10),s=Date.now();for(;Date.now()-s<e;){let u=window.location.href,l=document.title,d=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),m=(document.body?.innerText||document.body?.textContent||"").length;if(u!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${u}`};if(l!==n)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${n}" \u2192 "${l}"`};if(Math.abs(parseInt(d)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${d}`};if(Math.abs(m-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(m-r)} chars)`};await new Promise(c=>setTimeout(c,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function gt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let a=N(o.from)||N(I(o.from)),r=N(o.to)||N(I(o.to));a&&r&&await mt(a,r,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",n=N(e,t)||N(I(e),t),i=String(o.name??o.n??"").trim();if(!i&&e&&document.querySelector(`input[type="radio"][name="${$(e)}"]`)&&(i=e),!n&&i){let a=Array.from(document.querySelectorAll(`input[name="${$(i)}"]`));if(t&&(n=a.find(r=>r.value?.toLowerCase()===t.toLowerCase())??null),!n&&t){let r=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),s=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(r||s){let u=r?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];n=a.find(l=>{let d=l.value?.toLowerCase()??"";if(u.includes(d))return!0;let c=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return u.some(h=>c===h||c.startsWith(h+" ")||c.startsWith("("+h+")"))})??null}}!n&&a.length>0&&(n=a[0])}if(o.t==="clk"||o.t==="chk"){if(!n&&e){let r=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=I(e).toLowerCase();n=r.find(u=>{let l=I(u.textContent).toLowerCase();return!!(I(u.value||"").toLowerCase()===s||l===s||l.startsWith(s+")")||l.startsWith("("+s+")")||l.startsWith(s+".")||l.startsWith(s+" - ")||l.startsWith(s+":")||s.length>=3&&l.includes(s))})||null}let a=o.v!==void 0?String(o.v).trim():"";if(n&&a){if(n instanceof HTMLInputElement&&n.type==="radio"&&n.name){if(I(n.value).toLowerCase()!==I(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${$(n.name)}"][value="${$(a)}" i]`);if(r)n=r;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(n.name)}"]`)).find(l=>{let d=l.closest("label, .vf-label, .option-card, tr, td, div");return d&&I(d.textContent).toLowerCase().includes(I(a).toLowerCase())});u&&(n=u)}}}else if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLSelectElement)&&!(n instanceof HTMLTextAreaElement)){let r=n.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(r)n=r;else{let u=Array.from(n.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let d=l.closest("label, .vf-label, .option-card, td, div");return d&&I(d.textContent).toLowerCase().includes(I(a).toLowerCase())});u&&(n=u)}}}if(n){let r=n.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,s=n instanceof HTMLInputElement&&["radio","checkbox"].includes(n.type)?n:r.querySelector('input[type="radio"], input[type="checkbox"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),u=o.c!==void 0?!!o.c:!0;if(qe(s||r,u),s&&s.checked!==u){try{let l=s._valueTracker;l&&l.setValue(!u)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,u)}catch{}s.checked=u,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let a=null;if(n&&(a=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let r=document.body;try{r=ce()||document.body}catch{}let s=Array.from(r.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),u=I(e).toLowerCase();a=s.find(l=>{let d=(l.getAttribute("placeholder")||"").toLowerCase(),m=(l.name||"").toLowerCase(),c=(l.id||"").toLowerCase(),h=(l.getAttribute("aria-label")||"").toLowerCase();return d.includes(u)||m.includes(u)||c.includes(u)||h.includes(u)})||(s.length>0?s[0]:null)}if(a){let r=String(o.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,r)}}catch{}pt(a,r)}return}if(o.t==="sel"){if(!n&&e){let a=Array.from(document.querySelectorAll("select")),r=I(e).toLowerCase();n=a.find(s=>{let u=(s.name||"").toLowerCase(),l=(s.id||"").toLowerCase(),d=(s.getAttribute("aria-label")||"").toLowerCase();return u.includes(r)||l.includes(r)||d.includes(r)})||null}if(n){let a=Array.isArray(o.v)?o.v:[String(o.v)];ht(n,a)}return}}function me(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),n=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let a=N(i,n,!0)||N(I(i),n,!0);if(!a){let h=document.body;try{h=ce()||document.body}catch{}let p=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>R(f)&&!G(f));p.length>0&&(a=p[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let h=document.querySelector(`input[type="radio"][name="${$(r.name)}"]:checked`);if(!h)return!1;let p=I(h.value).toLowerCase(),f=I(t).toLowerCase(),b=I(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===f||b===f||b.includes(f)}let s=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let p=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(s=p)}if(!s){let h=a.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){s=h;break}let p=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){s=p;break}h=h.nextElementSibling}}if(s instanceof HTMLSelectElement){let h=I(t).toLowerCase();return Array.from(s.options).some(p=>{if(!p.selected)return!1;let f=p.value.toLowerCase(),b=I(p.textContent).toLowerCase();return h===f||h===b||f.includes(h)||b.includes(h)})}let u=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??a.textContent??"").trim();if(!u&&!t)return!0;if(!u&&t)return!1;let l=u.replace(",",".").replace(/\s+/g,"").toLowerCase(),d=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),m=parseFloat(l),c=parseFloat(d);return!isNaN(m)&&!isNaN(c)&&l.match(/^-?[\d.,]+$/)&&d.match(/^-?[\d.,]+$/)?Math.abs(m-c)<1e-4:l===d||u.toLowerCase()===t.toLowerCase()||d.length>=3&&l===d}if(o.t==="sel"){let e=N(o.id,void 0,!0)||N(I(o.id),void 0,!0);if(!e){let a=document.body;try{a=ce()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>R(l)&&!G(l)),s=I(o.id).toLowerCase();e=r.find(l=>{let d=(l.id||"").toLowerCase(),m=(l.getAttribute("name")||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase(),h=I(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return d.includes(s)||m.includes(s)||c.includes(s)||s.length>=2&&h.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(l=>I(l).toLowerCase()),u=I(a.textContent).toLowerCase();return s.some(l=>u.includes(l)||l.includes(u))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(a=>I(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),s=I(a.textContent).toLowerCase();return i.some(u=>u===r||u===s||r.includes(u)||s.includes(u))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=String(o.name??o.n??"").trim();if(t&&!o.id){let c=Array.from(document.querySelectorAll(`input[name="${$(t)}"]`));if(c.length>0){let h=c.find(x=>x.checked);if(!h)return!1;if(!e)return!0;let p=h.value?.toLowerCase()??"",f=e.toLowerCase();if(p===f)return!0;let b=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),v=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return b?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):v?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let n=N(o.id,e)||N(I(o.id),e);if(!n&&t){let c=document.querySelector(`input[name="${$(t)}"]`);c&&(n=c)}if(!n)return!1;let i=n.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,a=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:i.querySelector('input[type="checkbox"], input[type="radio"]')||(i.getAttribute("for")?i.ownerDocument.getElementById(i.getAttribute("for")):null),r=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(a&&a.type==="radio"){if(a.checked===r)return!0;if(o.v&&a.name){let c=I(String(o.v)).toLowerCase(),h=document.querySelector(`input[type="radio"][name="${$(a.name)}"]:checked`);if(!h)return!1;if(h===a)return!0;let p=I(h.value).toLowerCase(),f=I(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===c||f.includes(c)||c.includes(p)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===r;let s=i.getAttribute("aria-checked")===String(r)||i.getAttribute("aria-selected")===String(r)||i.getAttribute("aria-pressed")===String(r),u=r?i.getAttribute("data-selected")==="true"||i.getAttribute("data-checked")==="true"||i.getAttribute("data-active")==="true"||i.getAttribute("data-state")==="checked"||i.getAttribute("data-state")==="on":i.getAttribute("data-selected")==="false"||i.getAttribute("data-checked")==="false"||i.getAttribute("data-state")==="unchecked",l=i.className||"",d=r?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(s||u||d)return!0;let m=!!i.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return o.t==="clk"&&!a&&!m||i.getAttribute("aria-expanded")!==null||i.getAttribute("aria-pressed")!==null}if(o.t==="drag"){let e=ge(o.from,"source")||N(o.from)||N(I(o.from)),t=ge(o.to,"destination")||N(o.to)||N(I(o.to));return!e||!t?!1:nn(e,t).success}}catch{}return!1}async function Ze(o,e,t=1,n=Pe({engine:"smart",autoAdvance:e})){let i=o.actions.filter(E=>E.t!=="adv"),a=o.actions.filter(E=>E.t==="adv"),r=0,s=[],u=new Map,l=new Map,d=new Map,m=new Set,c=o.pageType==="question"||i.length>0,h=i.filter(E=>E.t==="chk"||E.t==="clk"&&E.c!==void 0),p=new Map;for(let E of i){let H=[];l.set(E,H);try{if(E.t==="drag"){H.push("declarative-A-F");try{let z=ge(E.from,"source")||N(E.from),T=ge(E.to,"destination")||N(E.to);z&&d.set(E,z.parentElement?.outerHTML?.slice(0,500)||""),T&&p.set(E,T.children.length)}catch{}}else H.push("declarative-primary");await sn(E,t,n),r++,m.add(E)}catch(z){u.set(E,z instanceof Error?z.message:String(z)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",E,z)}await new Promise(z=>setTimeout(z,E.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&h.length>0){let E=document.body;try{E=ce()||document.body}catch{}let H=Array.from(E.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(z=>R(z)&&!G(z));if(H.length>1){let T=function(P,j){if(P===j||P.contains(j)||j.contains(P))return!0;let Q=P.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),F=j.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(Q&&F&&Q===F)return!0;let K=P.getAttribute("for")||P.id,W=j.getAttribute("for")||j.id;return!!(K&&W&&K===W)};var k=T;let z=new Set;for(let P of h){let j=P.t==="chk"?!!P.c:!!(P.c??!0),Q="id"in P&&typeof P.id=="string"?P.id:"";if(j&&Q){let F=N(Q,P.v);if(F){z.add(F);let K=F.querySelector('input[type="checkbox"]');K&&z.add(K);let W=F.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');W&&(z.add(W),W.querySelectorAll('input[type="checkbox"]').forEach(oe=>z.add(oe)))}}}if(z.size>=h.length&&z.size>0){let P=Array.from(z);for(let j of H)P.some(F=>T(F,j))||(j instanceof HTMLInputElement&&j.checked||j.getAttribute("aria-checked")==="true"||j.closest(".option-card, label")?.classList.contains("selected"))&&qe(j,!1)}}}await new Promise(E=>setTimeout(E,i.length>0?100:25));let f=0;for(let E of i){if(me(E)){f++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${E.t}' no alvo '${E.id||E.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ot(E,n),l.get(E)?.push("alternative-path"),await gt(E)}catch(H){u.set(E,H instanceof Error?H.message:String(H)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",H)}await new Promise(H=>setTimeout(H,250)),me(E)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),f++,m.has(E)?u.has(E)&&u.delete(E):(u.delete(E),r++,m.add(E)))}if(f<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-f} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(E=>setTimeout(E,200));for(let E of i)if(!me(E))try{if(await gt(E),await new Promise(H=>setTimeout(H,80)),!me(E)&&(E.t==="clk"||E.t==="chk"))try{let H="id"in E?String(E.id||""):"",z=E.v!==void 0?String(E.v).trim():"",T=N(H,z)||N(I(H),z);T&&(Ut(T),await new Promise(P=>setTimeout(P,120)))}catch{}}catch(H){u.set(E,H instanceof Error?H.message:String(H))}await new Promise(E=>setTimeout(E,200)),f=0;for(let E of i)me(E)&&(f++,m.has(E)?u.has(E)&&u.delete(E):(u.delete(E),r++,m.add(E)))}let b=[];for(let[E,H]of i.entries())if(!me(H)){let z=H.t==="drag"?`${H.from} -> ${H.to}`:"id"in H&&H.id?H.id:H.t;s.push(z),b.push({actionIndex:E,action:H,strategiesAttempted:l.get(H)||[],evidence:u.get(H)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:d.get(H)}),H.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${H.from}" -> "${H.to}"`,`
  Estrat\xE9gias: ${(l.get(H)||[]).join(", ")}`,`
  Snapshot DOM: ${d.get(H)?.slice(0,200)||"n/a"}`)}c&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let v=i.map((E,H)=>{let z=E.t==="drag"?`${E.from} -> ${E.to}`:E.t==="js"?"$eq":E.id||E.t,T=E.t==="js"?!0:E.t==="drag"?!!(ge(E.from,"source")&&ge(E.to,"destination")):!!(N(E.id||"")||N(I(E.id||""))),P=me(E);return{index:H,action:E,target:z,located:T,applied:!u.has(E),verified:P,strategy:E.t==="drag"?"drag-adaptive":E.t==="js"?"javascript":"declarative-dom",evidence:P?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...u.has(E)?{error:u.get(E)}:{}}}),x=c?i.length>0&&s.length===0&&(f===i.length||r===i.length&&f>0):!0,A=!1,C=!1,y="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",w=c?f>0&&f>=Math.ceil(i.length/2):r>0&&r>=i.length/2,q=c?f>0&&(x||w):x||i.length===0||w;if(e&&q){await new Promise(z=>setTimeout(z,i.length>0?120:40));let E=!1,H=null;if(o.pageType!=="info"){let z=rn();if(z&&R(z)){await Ft(z,1200),se(z),E=!0,H=z,await new Promise(j=>setTimeout(j,350));let T=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');T&&R(T)&&(T.textContent||"").trim().length>0?(A=!1,C=!1,y=`Aviso do formul\xE1rio ap\xF3s checagem: ${T.textContent?.trim().slice(0,100)}`):(A=!0,C=!0,y="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!E){let z=ln(),T=a.length>0&&"id"in a[0]?a[0].id:void 0,P=ft(T);if(P){await Ft(P,1500);let j=T||P.textContent?.trim()||"";j&&Lt(window.location.hostname,{advanceSelector:j}),se(P);let Q=await cn(z,1800);C=Q.changed,y=Q.evidence,A=Q.changed||!0,Q.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:f,success:x,advanced:A,failed:s,reports:v,navigationVerified:C,navigationEvidence:y,failedActions:b}}var be=null,ze=[],Xt=[],$e=[],Vt=[],ve=null,fe=null,vo=40,dn=`
...
`;function yo(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=dn,document.head.appendChild(o)}}catch{}}function ke(){be&&(be.style.removeProperty("outline"),be.style.removeProperty("outline-offset"),be.style.removeProperty("position"),be=null);for(let o of ze)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ze=[];for(let o of Xt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");Xt=[];for(let o of $e)try{o.remove()}catch{}$e=[],fe&&typeof window<"u"&&(window.removeEventListener("scroll",fe),window.removeEventListener("resize",fe),fe=null);for(let o of Vt)try{o.remove()}catch{}if(Vt=[],ve){try{ve.remove()}catch{}ve=null}try{document.querySelectorAll("[data-easyquiz-image-frame]").forEach(o=>{try{o.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-capture-badge]").forEach(o=>{try{o.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-image-highlight]").forEach(o=>{try{let e=o;e.style.removeProperty("animation"),e.style.removeProperty("outline"),e.style.removeProperty("outline-offset"),e.style.removeProperty("box-shadow"),e.style.removeProperty("filter"),e.removeAttribute("data-easyquiz-image-highlight")}catch{}})}catch{}}function Gt(o){yo();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let n=t;try{let i=t.getBoundingClientRect(),a=i.width||n.offsetWidth||0,r=i.height||n.offsetHeight||0;if(a>=vo&&r>=vo){try{n.style&&(n.style.outline="3px solid #ffd600",n.style.outlineOffset="4px",n.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",n.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",n.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),n.setAttribute("data-easyquiz-image-highlight","true"),Xt.push(n)}catch{}let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
          ...
          box-shadow: 0 0 16px rgba(255, 214, 0, 0.95), 0 0 32px rgba(255, 214, 0, 0.5), inset 0 0 12px rgba(255, 214, 0, 0.25);
        `;let u=document.createElement("div");u.setAttribute("data-easyquiz-capture-badge","true"),u.textContent="\u{1F4F7} Imagem / Gr\xE1fico Analisado pela IA",u.style.cssText=`
          position: absolute;
          top: -14px;
          left: 8px;
    ...
    `,o.appendChild(t),ve=t}catch{}}function un(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function xo(o,e){if(ve){try{ve.remove()}catch{}ve=null}let t=un(e);for(let n of o){if(n.t==="adv"||n.t==="js")continue;if(n.t==="drag"){try{let h=N(n.from),p=N(n.to);h&&(h.style.outline=`2px solid ${t.outline}`,ze.push(h)),p&&(p.style.outline="2px dashed #00e5ff",ze.push(p))}catch{}continue}let i=n.v!==void 0?Array.isArray(n.v)?n.v[0]:String(n.v):"",a=String(n.name??n.n??"").trim(),r=null;if(a){let h=Array.from(document.querySelectorAll(`input[name="${$(a)}"]`));if(i&&(r=h.find(p=>p.value?.toLowerCase()===i.toLowerCase())??null,!r)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(i),f=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(i);if(p||f){let b=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=h.find(v=>{let x=v.value?.toLowerCase()??"";if(b.includes(x))return!0;let C=(v.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(y=>C===y||C.startsWith(y+" ")||C.startsWith("("+y+")"))})??null}}!r&&h.length>0&&(r=h[0])}if(!r&&n.id&&(r=N(n.id,i,n.t==="val"||n.t==="sel")||N(I(n.id),i,n.t==="val"||n.t==="sel")),!r&&n.t==="sel"){let h=document.body;try{h=ce()||document.body}catch{}let p=Array.from(h.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>R(v)&&!pe(v)),f=I(n.id).toLowerCase();r=p.find(v=>{let x=(v.id||"").toLowerCase(),A=(v.getAttribute("name")||"").toLowerCase(),C=(v.getAttribute("aria-label")||"").toLowerCase(),y=I(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return x.includes(f)||A.includes(f)||C.includes(f)||f.length>=2&&y.includes(f)})||(p.length===1?p[0]:null)}if(!r)continue;let s=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",u=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=s?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,d=u||l||r;d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.backgroundColor=t.bg,d.setAttribute("data-easyquiz-highlight","true"),ze.push(d);let m=s?r:d.querySelector('select, [role="combobox"], [role="listbox"]');m&&(m.style.outline=`2px solid ${t.outline}`,m.style.outlineOffset="2px",m.style.boxShadow=`0 0 10px ${t.glow}`,m.setAttribute("data-easyquiz-highlight","true"),ze.push(m));let c=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:d.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==d&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ze.push(c))}}var bt=10,pn=1400,et=15e5;function xe(o){return new Promise((e,t)=>{let n=new FileReader;n.onerror=()=>t(new Error("Falha ao converter blob para base64.")),n.onload=()=>{let i=String(n.result||"");e(i.split(",")[1]||"")},n.readAsDataURL(o)})}function Ao(o){try{let e=o.getContext("2d");if(!e)return!0;let t=o.width,n=o.height;if(t<=0||n<=0)return!0;let i=Math.min(40,Math.floor(t/3),Math.floor(n/3));if(i<=0)return!0;let a=[[0,0],[Math.floor(t/2)-Math.floor(i/2),Math.floor(n/2)-Math.floor(i/2)],[Math.floor(t/3),Math.floor(n*2/3)]],r=0,s=0,u=-1,l=-1,d=-1;for(let[m,c]of a){let h=Math.max(0,Math.min(m,t-i)),p=Math.max(0,Math.min(c,n-i)),f=e.getImageData(h,p,i,i).data;for(let b=0;b<f.length;b+=4){r++;let v=f[b],x=f[b+1],A=f[b+2];if(f[b+3]===0){s++;continue}u===-1&&(u=v,l=x,d=A),Math.abs(v-u)<8&&Math.abs(x-l)<8&&Math.abs(A-d)<8&&s++}}return r>0&&s/r>.97}catch{return!1}}function wo(o){try{let e=o.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/);if(e){let[t,n,i]=[parseInt(e[1]),parseInt(e[2]),parseInt(e[3])];if((.299*t+.587*n+.114*i)/255<.15)return"#ffffff"}if(o==="transparent"||o==="rgba(0, 0, 0, 0)")return"#ffffff"}catch{}return o}async function Te(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let n=Math.min(1,pn/Math.max(e,t)),i=Math.max(1,Math.round(e*n)),a=Math.max(1,Math.round(t*n)),r=document.createElement("canvas");r.width=i,r.height=a;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,a),s.drawImage(o,0,0,i,a),new Promise((u,l)=>{r.toBlob(d=>d?u(d):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Eo(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,n=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(n*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.getAttribute("xmlns:xlink")||s.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),s.setAttribute("width",String(a)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&n>0&&s.setAttribute("viewBox",`0 0 ${t} ${n}`);try{let c=Array.from(o.querySelectorAll("*")),h=Array.from(s.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,h.length);p++){let f=c[p],b=h[p];if(!f||!b||!b.style)continue;let v=window.getComputedStyle?window.getComputedStyle(f):null;v&&(v.fill&&v.fill!=="none"&&(b.style.fill=v.fill),v.stroke&&v.stroke!=="none"&&(b.style.stroke=v.stroke),v.strokeWidth&&(b.style.strokeWidth=v.strokeWidth),v.fontFamily&&(b.style.fontFamily=v.fontFamily),v.fontSize&&(b.style.fontSize=v.fontSize),v.fontWeight&&(b.style.fontWeight=v.fontWeight),v.color&&(b.style.color=v.color))}}catch{}let u="#ffffff";try{let c=o.parentElement||o;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){u=p;break}c=c.parentElement}}catch{}u=wo(u),s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg");let d=new XMLSerializer().serializeToString(s),m="";try{m=btoa(unescape(encodeURIComponent(d)))}catch{}try{let c=b=>new Promise((v,x)=>{let A=new Image,C=setTimeout(()=>x(new Error("Timeout render SVG")),1200);A.onload=()=>{clearTimeout(C),v(A)},A.onerror=()=>{clearTimeout(C),x(new Error("Falha ao renderizar SVG em Image."))},A.src=b}),h=null;if(m)try{h=await c(`data:image/svg+xml;base64,${m}`)}catch{}if(!h){let b=new Blob([d],{type:"image/svg+xml;charset=utf-8"}),v=URL.createObjectURL(b);try{h=await c(v)}finally{URL.revokeObjectURL(v)}}let p=document.createElement("canvas");p.width=a,p.height=r;let f=p.getContext("2d",{alpha:!1});if(f&&h){if(f.fillStyle="#ffffff",f.fillRect(0,0,a,r),f.drawImage(h,0,0,a,r),Ao(p))return{base64:m,mediaType:"image/svg+xml"};let b=await new Promise(v=>{p.toBlob(v,"image/jpeg",.92)});if(b){let v=await xe(b);if(v)return{blob:b,base64:v,mediaType:"image/jpeg"}}}}catch{}return{base64:m,mediaType:"image/svg+xml"}}async function vt(o){try{let e=o.getBoundingClientRect(),t=Math.round(e.width)||o.offsetWidth||400,n=Math.round(e.height)||o.offsetHeight||300;if(t<30||n<30)return null;let i=o.tagName.toLowerCase()==="svg"?o:o.querySelector("svg");if(i&&o.querySelectorAll("input, select, textarea").length===0)try{let f=await Eo(i);if(f.base64&&f.base64.length<=et)return{mediaType:f.mediaType,base64:f.base64,alt:o.getAttribute("aria-label")||i.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:ye(i)}}catch{}if(o instanceof HTMLCanvasElement)try{let f=await Te(o),b=await xe(f);if(b)return{mediaType:"image/jpeg",base64:b,alt:o.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let f=o;for(;f&&f!==document.documentElement;){let v=(window.getComputedStyle?window.getComputedStyle(f):null)?.backgroundColor;if(v&&v!=="transparent"&&v!=="rgba(0, 0, 0, 0)"){a=v;break}f=f.parentElement}}catch{}a=wo(a);let r=o.cloneNode(!0),s=Array.from(o.querySelectorAll("*")),u=Array.from(r.querySelectorAll("*"));for(let f=0;f<Math.min(s.length,u.length);f++){let b=s[f],v=u[f];if(!(!b||!v||!v.style))try{let x=window.getComputedStyle(b);v.style.color=x.color,v.style.backgroundColor=x.backgroundColor,v.style.borderColor=x.borderColor,v.style.borderWidth=x.borderWidth,v.style.borderStyle=x.borderStyle,v.style.fontSize=x.fontSize,v.style.fontFamily=x.fontFamily,v.style.fontWeight=x.fontWeight,v.style.lineHeight=x.lineHeight,v.style.letterSpacing=x.letterSpacing,v.style.textAlign=x.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,n))),d=Math.round(t*l),m=Math.round(n*l),c=`
      <svg xmlns="http://www.w3.org/2000/svg" width="${d}" height="${m}" viewBox="0 0 ${t} ${n}">
...
`};var At=class{element=null;shadow;isMinimized=!1;currentPlan=null;isDragging=!1;dragStartX=0;dragStartY=0;initialLeft=25;initialTop=25;onAdvanceCallback;constructor(e,t){this.shadow=e,this.onAdvanceCallback=t,this.initGlobalListeners()}initGlobalListeners(){window.addEventListener("popstate",()=>this.handlePageNavigated()),window.addEventListener("hashchange",()=>this.handlePageNavigated()),document.addEventListener("click",e=>{if(!this.isOpen())return;let t=e.target;if(!t||this.shadow.contains(t)||t.closest("#easyquiz-shadow-root"))return;let n=t.closest('button, [role="button"], a, input[type="submit"]');if(n){let i=(n.textContent||n.value||"").toLowerCase();/pr[oó]xim|avan[cç]|continu|verific|enviar|submit|confirm|checar|validar|next/i.test(i)&&setTimeout(()=>{this.isOpen()&&this.handlePageNavigated()},800)}},!0)}handlePageNavigated(){this.isOpen()&&(this.hide(),this.onAdvanceCallback?.())}isOpen(){return this.element!==null&&this.element.style.display!=="none"}show(e){this.currentPlan=e,this.element||this.createElement(),this.renderContent(),this.element&&(this.element.style.display="flex")}hide(){this.element&&(this.element.style.display="none")}minimize(){this.isMinimized=!0,this.element&&this.element.classList.add("minimized")}restore(){this.isMinimized=!1,this.element&&this.element.classList.remove("minimized")}createElement(){this.element=document.createElement("div"),this.element.className="eq-floating-hud",this.element.style.left=`${this.initialLeft}px`,this.element.style.top=`${this.initialTop}px`,this.element.innerHTML=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=n=>{if(n.target.closest(".eq-fah-btn"))return;n.preventDefault(),this.isDragging=!0,this.dragStartX=n.clientX,this.dragStartY=n.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let a=s=>{if(!this.isDragging||!this.element)return;let u=s.clientX-this.dragStartX,l=s.clientY-this.dragStartY,d=Math.max(10,window.innerWidth-this.element.offsetWidth-10),m=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+u),d),h=Math.min(Math.max(10,this.initialTop+l),m);this.element.style.left=`${c}px`,this.element.style.top=`${h}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),n=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,a=i.actions.filter(h=>h.t==="drag"),r=i.actions.filter(h=>{if(h.t!=="val")return!1;let p=I(h.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),s=i.actions.filter(h=>h.t==="clk"||h.t==="chk"),u=i.actions.filter(h=>h.t==="sel"),l=a.length||r.length||s.length||u.length,d=document.createElement("div");d.className="eq-fah-meta";let m=document.createElement("span");m.textContent=`Modo: ${i.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,d.append(m,c),e.appendChild(d),a.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,n.textContent=String(a.length);let h={};for(let p of a){let f=I(p.to)||"Geral";h[f]||(h[f]=[]),h[f].push(I(p.from))}for(let[p,f]of Object.entries(h)){let b=document.createElement("div"),v=/fato|true|verdadeiro|sim/i.test(p),x=/opini[aã]o|false|falso|n[aã]o/i.test(p);b.className=`eq-fah-group ${v?"group-fato":x?"group-opiniao":""}`;let A=document.createElement("div");A.className="eq-fah-group-title",A.textContent=`\u{1F4C1} ${p} (${f.length})`,b.appendChild(A);let C=document.createElement("div");C.className="eq-fah-group-items";for(let y of f){let w=document.createElement("div");w.className="eq-fah-item";let q=document.createElement("span");q.className="eq-fah-item-text",q.textContent=y,w.appendChild(q);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(y),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),w.appendChild(k),C.appendChild(w)}b.appendChild(C),e.appendChild(b)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,n.textContent=String(r.length);let h=document.createElement("div");h.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",h.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let b=0;b<r.length;b++){let v=r[b],x=document.createElement("div");x.className="eq-fah-item";let A=Ye(v.id);(!A||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(A))&&(A=`Campo ${b+1}`);let C=String(v.v??""),y=document.createElement("div");y.className="eq-fah-field-box";let w=document.createElement("div");w.className="eq-fah-field-label",w.textContent=A,y.appendChild(w);let q=document.createElement("div");q.className="eq-fah-field-val",q.textContent=C,y.appendChild(q),x.appendChild(y);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),x.appendChild(k),f.appendChild(x)}h.appendChild(f),e.appendChild(h)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,n.textContent=String(s.length);let h=document.createElement("div");h.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",h.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let b=0;b<s.length;b++){let v=s[b],x=document.createElement("div");x.className="eq-fah-item";let A=Ye(v.id);(!A||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(A))&&v.v&&(A=String(v.v)),A=I(A),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(A)&&(A="");let C="",y=A.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);y?(C=y[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),A=y[2].trim()||A):s.length>1&&(C=String.fromCharCode(65+b));let w=document.createElement("div");if(w.style.display="flex",w.style.alignItems="center",w.style.gap="8px",w.style.flex="1",C){let E=document.createElement("span");E.className="eq-fah-letter-badge",E.textContent=C,w.appendChild(E)}let q=document.createElement("span");q.className="eq-fah-item-text",q.textContent=A||(C?`Alternativa ${C}`:"Alternativa Selecionada"),w.appendChild(q),x.appendChild(w);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(A||C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),x.appendChild(k),f.appendChild(x)}h.appendChild(f),e.appendChild(h)}else if(u.length>0){t.textContent=`Sele\xE7\xE3o (${u.length} listas)`,n.textContent=String(u.length);let h=document.createElement("div");h.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",h.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let b=0;b<u.length;b++){let v=u[b],x=document.createElement("div");x.className="eq-fah-item";let A=Ye(v.id);(!A||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(A))&&(A=`Lista ${b+1}`);let w=(Array.isArray(v.v)?v.v:[String(v.v??"")]).map(z=>{let T=N(v.id,void 0,!0)||N(I(v.id),void 0,!0),P=T instanceof HTMLSelectElement?T:T?.querySelector("select");if(P){let j=I(z).toLowerCase();for(let Q=0;Q<P.options.length;Q++){let F=P.options[Q];if(F.value.toLowerCase()===j||I(F.textContent).toLowerCase()===j){let K=I(F.textContent);if(K&&!K.toLowerCase().includes("selecione"))return K}}}return z}).join(", "),q=document.createElement("div");q.className="eq-fah-field-box";let k=document.createElement("div");k.className="eq-fah-field-label",k.textContent=A,q.appendChild(k);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=w,q.appendChild(E),x.appendChild(q);let H=document.createElement("button");H.className="eq-fah-copy-inline",H.textContent="Copiar",H.addEventListener("click",()=>{navigator.clipboard.writeText(w),H.textContent="\u2713 Copiado",setTimeout(()=>H.textContent="Copiar",1200)}),x.appendChild(H),f.appendChild(x)}h.appendChild(f),e.appendChild(h)}else{t.textContent="Gabarito",n.textContent="0";let h=document.createElement("div");h.style.padding="10px",h.style.color="#888",h.textContent="Nenhuma resposta direta para exibir.",e.appendChild(h)}if(i.rationale){let h=document.createElement("div");h.className="eq-fah-rationale",h.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(h)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let n=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),a=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),r=e.actions.filter(s=>s.t==="sel");if(n.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let u of n){let l=I(u.to)||"Geral";s[l]||(s[l]=[]),s[l].push(I(u.from))}for(let[u,l]of Object.entries(s)){t.push(`### Categoria: ${u}`);for(let d of l)t.push(`- ${d}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let u=I(s.id);t.push(`- **${u||"Campo"}:** \`${s.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<a.length;s++){let u=a[s],l=Ye(u.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&u.v&&(l=String(u.v)),l=I(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let d=a.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${d}${l||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of r){let u=I(s.id)||"Lista",l=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${u}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function An(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function wn(){let o=window;if(Xe(),An(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=Tt(),t=null,n=null,i=0,a=new wt(e,{onAnalyze:(l=1,d,m=!1)=>r(l,d,m),onApply:(l=1)=>{s(l)},onDestroy:()=>{if(n){try{n.abort()}catch{}n=null}ke(),delete o.__easyquiz},onCancel:()=>{if(n){try{n.abort()}catch{}n=null}ke(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=Zt(l)}});o.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,d,m=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(n)try{n.abort()}catch{}n=new AbortController;let c=n,h=()=>{try{c.abort()}catch{}};if(d&&(d.aborted?c.abort():d.addEventListener("abort",h,{once:!0})),c.signal.aborted){a.setBusy(!1),a.setProgress(0);return}i=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),ke(),a.hideFloatingAnswers();try{let p=Ce(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=Ee()),_e(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let f=await Kt(p.scope,e.useVision);if(console.log("================ [SANITY CHECK] ================"),console.log(`[DOM Scope]: ${p.scope.tagName.toLowerCase()}#${p.scope.id||"N/A"}`),console.log(`[Imagens Capturadas]: ${f.length}`),console.log(`[Texto Extra\xEDdo (In\xEDcio)]: ${p.questionText.slice(0,150).replace(/\n/g," ")}...`),console.log("================================================"),p.questionText.trim().length<10&&f.length===0){a.logToConsole("> [ERRO] Texto extra\xEDdo muito curto e sem imagens. Abortando API.","text-red"),a.setStatus("Falha de escopo: cont\xEAiner inv\xE1lido ou vazio.","error");return}if(f.length>0){let y=f.filter(w=>w.captureStatus==="captured"&&w.base64&&w.base64.length>100&&w.element);if(y.length>0){let w=y.map(q=>q.element).filter(Boolean);Gt(w)}a.updateImages(f)}if(c.signal.aborted)return;let b=e.model;a.setStatus(f.length>0?`Consultando Gemini (${b}) com ${f.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let v=Ve(p,f,e);a.setInspectorPrompt(v,e.model);let x=(y,w)=>{a.setStatus(y,w==="warning"?"info":w);let q=y.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(q){let k=q[1].split(",")[0].trim();a.setProgress(50,`Gemini ${k} respondendo...`)}},{plan:A,usedModel:C}=await rt(p,f,e,x,c.signal);if(c.signal.aborted)return;if(A.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=Ce(!0),p||(p=Ee()),_e(p.scope),a.updateContext(p),f=await Kt(p.scope,e.useVision),f.length>0){let q=f.filter(k=>k.captureStatus==="captured"&&k.base64&&k.base64.length>100&&k.element);if(q.length>0){let k=q.map(E=>E.element).filter(Boolean);Gt(k)}a.updateImages(f)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let y=Ve(p,f,e);a.setInspectorPrompt(y,e.model),A=(await rt(p,f,e,x,c.signal)).plan}if(c.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||e.model} | Modo: ${A.mode} | Confian\xE7a: ${(A.confidence*100).toFixed(0)}%`,"text-green"),A.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${A.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${A.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),A.memoryToStore&&($t(A.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${A.memoryToStore}"`,"text-yellow")),A.imageDescriptions&&A.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${A.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let y of A.imageDescriptions){let w=y.relevant?"":"\uFE0F";a.logToConsole(`>   ${w} Imagem ${y.index+1} [${y.relevant?"RELEVANTE":"IGNORADA"}]: ${y.description}`,y.relevant?"text-blue":"text-yellow")}}return t=A,a.updateContext(p,A),xo(A.actions,A.confidence),a.setPlan(A,!e.dryRun),A.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):A.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):A.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&A.pageType==="question"&&a.showFloatingAnswers(A),c.signal.aborted?void 0:((m||e.autoApply)&&!e.dryRun&&await s(l,c.signal,m),A)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){ke(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}ke(),a.setProgress(0);let f=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(f,"error"),a.setErrorDiagnostic(f,"An\xE1lise da IA");return}finally{d?.removeEventListener("abort",h),n===c&&(n=null),c.signal.aborted||a.setBusy(!1)}}async function s(l=1,d,m=!1){if(d?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",h=t.actions.filter(b=>b.t!=="adv"),p=t.pageType==="question"||ut(t.rationale||"");if(p&&h.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let f=(m||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||h.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Ze(t,f,l,Pe(e));if(d?.aborted)return;if(a.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let y of b.failedActions){let w=y.action,q=w.t==="drag"?`drag: "${w.from}" \u2192 "${w.to}"`:w.t==="clk"||w.t==="chk"?`${w.t}: "${w.id}"`:w.t==="val"?`val: "${w.id}" = "${w.v}"`:JSON.stringify(w).slice(0,80);a.logToConsole(`>    [${w.t.toUpperCase()}] ${q} | ${y.evidence.slice(0,80)}`,"text-yellow")}await u(b.failedActions,d)}let v=i>0?Date.now()-i:1200,x=b.verified>0,A=b.applied>0;if(b.success||x&&A){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):f&&a.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),a.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let y=eo({id:`q-${Date.now()}`,questionIndex:(Ue().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:v,status:"answered",mode:t.mode,actionsCount:b.applied});a.updateTimingMetrics(y)}else A?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(b){a.setProgress(0);let v=b instanceof Error?b.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${v}`,"error"),a.logToConsole(`> [ERRO] ${v}`,"text-red")}finally{a.setBusy(!1)}}async function u(l,d){if(!t)return;let m=l.filter(h=>h.action.t==="drag");for(let h of m){if(d?.aborted)return;let p=h.action,f=String(p.from||""),b=String(p.to||""),v=fo(f,b,f,b);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${f}" \u2192 "${b}"`,"text-blue");let x={...t,actions:[{t:"js",v}],pageType:"question"},A=await Ze(x,!1,1,Pe(e));a.logToConsole(A.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",A.applied>0?"text-green":"text-yellow")}let c=l.filter(h=>h.action.t!=="drag");if(c.length!==0&&!d?.aborted){a.logToConsole(`> [REPLAN]  ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let h of c){if(d?.aborted)return;let p=h.action,f=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${f}`,"text-blue");let b=String(p.id||p.name||p.selector||""),v=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await gt(h.action),await new Promise(x=>setTimeout(x,250)),me(h.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${f}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let x=N(b,v)||N(b.replace(/[^\w\s]/g," ").trim(),v);if(x&&(Ut(x),await new Promise(A=>setTimeout(A,300)),me(h.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let x=N(b,v)||N(b.replace(/[^\w\s]/g," ").trim(),v);if(x&&(x.focus?.(),await new Promise(A=>setTimeout(A,50)),x.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),x.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,80)),x.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),x.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,200)),me(h.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let x=N(b,v)||N(b.replace(/[^\w\s]/g," ").trim(),v);if(x){let A=x.id,C=!!A;A||(A=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,x.id=A);let y=String(p.v??""),w=p.t==="val",q=document.createElement("script");if(q.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(q),q.remove(),C||setTimeout(()=>{try{x.id===A&&x.removeAttribute("id")}catch{}},0),await new Promise(k=>setTimeout(k,300)),me(h.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${f}`,"text-green");continue}}}catch{}}if(d?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let x="";try{let T=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(P=>(P.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));T&&(x=T.outerHTML.slice(0,400))}catch{}let A=Ce(!1)||Ee(),C=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${h.evidence.slice(0,80)}"${x?`
