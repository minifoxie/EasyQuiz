 ...
 */
"use strict";(()=>{var Ne=Object.defineProperty;var O=(t,e)=>()=>(t&&(e=t(t=0)),e);var ge=(t,e)=>{for(var a in e)Ne(t,a,{get:e[a],enumerable:!0})};var b,me=O(()=>{"use strict";b={apiKey:"",model:"gemini-2.5-flash",uiMode:"advanced",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,confidenceThreshold:.8}});var ye={};ge(ye,{addSessionMemory:()=>_e,clearSessionMemories:()=>oe,getSessionMemories:()=>te,loadDomainCache:()=>_,loadSettings:()=>N,saveDomainCache:()=>ee,saveSettings:()=>k});function N(){try{let t=localStorage.getItem(fe);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let s=JSON.parse(o);return{...b,apiKey:s.apiKey||""}}return{...b}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:b.model;return(a.includes("3.8")||a.includes("3.7")||a.includes("3.6")||a.includes("3.5")||a.includes("3.1"))&&(a=b.model),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():b.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:b.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:b.confidenceThreshold}}catch{return{...b}}}function _(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function ee(t,e){let o={..._(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function k(t){let a={...N(),...t};try{localStorage.setItem(fe,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}function _e(t){let e=t.trim();e&&!D.includes(e)&&D.push(e)}function te(){return D}function oe(){D=[]}var fe,D,w=O(()=>{"use strict";me();fe="easyquiz_settings_v2";D=[]});function y(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function h(t,e=500){return(t??"").replace(/\s+/g," ").trim().slice(0,e)}function Fe(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(je+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function ie(t){let e=h(t.getAttribute("aria-label")||t.textContent||t.getAttribute("value")||t.value),a=t.type,o=e.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim();return Q.test(o)||Q.test(e)||a==="submit"||t.getAttribute("data-testid")?.toLowerCase().includes("next")||t.getAttribute("data-testid")?.toLowerCase().includes("check")||!1}function Ve(t){let e=t.getAttribute("aria-label");if(e)return h(e);let a=t.getAttribute("aria-labelledby");if(a){let n=a.split(/\s+/).map(i=>document.getElementById(i)?.textContent).filter(Boolean).join(" ");if(n.trim())return h(n)}if("labels"in t&&t.labels){let n=Array.from(t.labels??[]).map(i=>i.textContent).join(" ");if(n.trim())return h(n)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let n=h(o.textContent);if(n)return n}let s=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||t.value||"";return h(s)}function se(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let s=t.tagName.toLowerCase(),n=["input","textarea","select","button"].includes(s)?s:"other",i=t.getAttribute("role")||"",r=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item"),l=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category"),c=h((r?"draggable":l?"dropzone":"")||o.type||i||n,40),u="";o.type==="checkbox"||o.type==="radio"||i==="radio"||i==="checkbox"?u=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked":u=h(o.value||t.getAttribute("data-category")||t.textContent||"",2e3);let p=[];if(a)for(let C of Array.from(a.options).slice(0,80))p.push({value:h(C.value),label:h(C.textContent)});let g=!!(o.required||t.getAttribute("aria-required")==="true"),R=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Fe(t),tag:n,type:c,label:Ve(t),name:h(o.name||t.getAttribute("name")||"",180),value:u,options:p,required:g,disabled:R,role:e}}var A,Q,je,j=O(()=>{"use strict";A=['input:not([type="hidden"])',"textarea","select","button",'[role="button"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),Q=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi)/i,je=0});var U={};ge(U,{captureCurrentContext:()=>q,captureFullPageText:()=>Ue,expandToGeneralSelection:()=>Se,extractAnswerControls:()=>qe,extractNavigationControls:()=>V,findActiveScope:()=>Ae,findTrueQuestionContainer:()=>F,sanitizeHtml:()=>re});function Te(t){if(!y(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(A)).filter(y),o=h(t.innerText,4e3).length;if(!a.length||o<10)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),i=Math.min(1,n/s),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),d=o>40?35:0,c=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+d+c-i*20-l*10}function F(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let s=h(e.innerText,1e4),n=h(a.innerText,1e4),i=e.querySelectorAll(A).length,r=a.querySelectorAll(A).length;if(s.length<150&&n.length>s.length&&r<=i+4){e=a;continue}break}return e}function Se(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&y(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Ae(){let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(we);if(s&&Te(s)>0)return F(s)}let a=Array.from(document.querySelectorAll(we)).map(s=>({element:s,score:Te(s)})).filter(s=>Number.isFinite(s.score)).sort((s,n)=>n.score-s.score);if(a.length>0&&a[0].score>0)return F(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&y(o)?o:document.body}function re(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))a.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function qe(t){return Array.from(t.querySelectorAll(A)).filter(e=>y(e)&&!ie(e)).slice(0,100).map(e=>se(e,"answer"))}function V(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let s of e)for(let n of Array.from(s.querySelectorAll(A)))if(!(a.has(n)||!y(n)||!ie(n))&&(a.add(n),o.push(se(n,"navigation")),o.length>=10))return o;return o}function q(t=!1){let e=Ae();e=F(e),t&&(e=Se(e));let a=h(e.innerText,16e3),o=qe(e),s=V(e);s.length===0&&(s=V(document.body));let n=[...o,...s].slice(0,120);return!a||n.length===0&&a.length<30?null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:re(e),controls:n,scope:e}}function Ue(){let t=document.body.innerText||document.documentElement.innerText,e=h(t,8e3),a=V(document.body),o=document.querySelector('main, article, [role="main"]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina Inteira",questionText:e,htmlSnippet:re(o).slice(0,1e4),controls:a,scope:o}}var we,M=O(()=>{"use strict";j();we=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",")});w();var be=`Voc\xEA \xE9 o EasyQuiz Engine v4.5. Retorne JSON estrito.
Regras Absolutas:
1. "pageType": 
      ...
      <section class="eq-panel" hidden aria-label="EasyQuiz">
        <header class="eq-header">
          ...
          <div class="eq-header-tools">
            <button class="eq-icon-btn" id="eq-min-btn" type="button" title="Minimizar">${v.minimize}</button>
        ...
        <div class="eq-content" id="eq-content-easy" style="display: none;">
          <div class="eq-field-group" style="margin-bottom: 2px;">
            ...
            <div class="eq-input-wrap">
              ...
              <button class="eq-input-action-btn" id="eq-test-key-easy" type="button" title="Testar Chave">${v.key} Testar</button>
            </div>
          </div>
        ...
        <div class="eq-content" id="eq-content-advanced" style="display: none;">
          <div class="eq-field-group">
            ...
            <div class="eq-input-wrap">
              ...
              <button class="eq-input-action-btn" id="eq-test-key-btn" type="button" title="Testar Chave">${v.key} Testar</button>
            </div>
          </div>
          ...
          <button class="eq-btn-primary" id="eq-analyze-btn" type="button">
            ${v.analyze} Analisar & Resolver Quest\xE3o
          </button>
