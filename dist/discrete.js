...
[RESPOSTAS]:
${(()=>{if(h.length===0)return"Nenhuma";let E=h.filter(w=>w.type==="checkbox"||w.type==="chk"),f=new Set(h.filter(w=>w.type==="radio").map(w=>w.name).filter(Boolean)),b=E.filter(w=>!w.name||!f.has(w.name)),x=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),C=b.length>=2||x,S=f.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&f.size>=1,A=h.every(w=>w.type==="radio"||w.type==="chk")&&f.size===1&&!C&&!S,M=h.filter(w=>w.type==="text"||w.type==="number"||w.type==="val"||w.tag==="input"||w.tag==="textarea"),O=M.length>=2;return(S?`[GRADE VERDADEIRO/FALSO (${f.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${f.size} afirma\xE7\xF5es \u2014 emita ${f.size} a\xE7\xF5es chk separadas + adv]
`:C?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:A?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:O?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${M.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${M.length} campos abaixo com seu id exato]
...
`+q(i.slice(-2e3),2e3):q(i,16e3),s=[...t,...o].slice(0,120);return!a||s.length===0&&a.length<30?q(document.body.innerText||document.body.textContent||"",16e3).length>=30?Ve():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:vt(e),controls:s,scope:e}}function Ve(){let n=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=q(n,16e3),t=Ee(document.body),o=je(document.body),i=[...t,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:vt(a).slice(0,15e3),controls:i,scope:a}}var Ge=10,Wt=1400,We=15e5;function de(n){return new Promise((e,t)=>{let o=new FileReader;o.onerror=()=>t(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(n)})}async function be(n){let e=0,t=0;if(n instanceof HTMLImageElement?(e=n.naturalWidth||n.width,t=n.naturalHeight||n.height):(e=n.width,t=n.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Wt/Math.max(e,t)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(t*o)),s=document.createElement("canvas");s.width=i,s.height=a;let r=s.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,a),r.drawImage(n,0,0,i,a),new Promise((l,c)=>{s.toBlob(u=>u?l(u):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Qt(n){let e=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=e.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),s=Math.min(1800,Math.max(100,Math.round(o*i))),r=n.cloneNode(!0);r.getAttribute("xmlns")||r.setAttribute("xmlns","http://www.w3.org/2000/svg"),r.setAttribute("width",String(a)),r.setAttribute("height",String(s)),!r.getAttribute("viewBox")&&t>0&&o>0&&r.setAttribute("viewBox",`0 0 ${t} ${o}`);let c=new XMLSerializer().serializeToString(r),u=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(u);try{let d=new Image;d.crossOrigin="anonymous",await new Promise((g,_)=>{d.onload=()=>g(),d.onerror=()=>_(new Error("Falha ao renderizar SVG em Image.")),d.src=p});let m=document.createElement("canvas");m.width=a,m.height=s;let h=m.getContext("2d",{alpha:!1});if(!h)throw new Error("Sem suporte a Canvas 2D.");return h.fillStyle="#ffffff",h.fillRect(0,0,a,s),h.drawImage(d,0,0,a,s),new Promise((g,_)=>{m.toBlob(y=>y?g(y):_(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(p)}}async function Qe(n){try{let e=n.cloneNode(!0),t=n.offsetWidth||500,o=n.offsetHeight||500,i=`
    ...
    `,document.documentElement.appendChild(e)}open(){this.close();let t=Z().model,o=[...ye],i=(ve||[]).filter(g=>!o.some(_=>_.id===g.id)),a=document.createElement("div");a.id="__eqdm_menu__",a.setAttribute("role","menu"),a.tabIndex=-1;let s=document.createElement("div");s.className="__eqdm_section__",s.textContent="Modelo Gemini",a.appendChild(s);let r=document.createElement("div");r.className="__eqdm_sep__",a.appendChild(r);let l=(g,_,y)=>{let E=g===t,f=document.createElement("div");f.className="__eqdm_item__",f.setAttribute("role","menuitemradio"),f.setAttribute("aria-checked",E?"true":"false"),f.tabIndex=0;let b=document.createElement("span");b.className="__eqdm_check__",E&&(b.innerHTML=`<svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
...
`;function Ct(n){let e=[],t=1;for(let o of n){let i=o.t;if(i==="val"){let a=String(o.v??""),s=Math.max(1,a.length);for(let r=0;r<s;r++){let l=r===0,c=r===s-1,u=s>1?`${r+1}/${s}`:null;e.push({step:t++,trigger:"key",action:o,chars:1,hint:l?"Keyboard Interact":c?"Buffer Flush":"Key Capture",customMsg:u})}}else i==="chk"||i==="clk"?e.push({step:t++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:null}):i==="sel"?(e.push({step:t++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:"Opening..."}),e.push({step:t++,trigger:"click",action:o,hint:"Option Selected",customMsg:null})):i==="drag"?e.push({step:t++,trigger:"click",action:o,hint:"Mover Item",customMsg:null}):i==="adv"&&e.push({step:t++,trigger:"click",action:o,hint:"Next Page Loading",customMsg:null})}return e}function Lt(n,e){if(!Array.isArray(n)||n.length===0)return Ct(e);let t=[];for(let o of n){if(!o||typeof o!="object")continue;let i=o,a=i.trigger==="key"?"key":"click",s=i.action||{},r=a==="key"?1:void 0;t.push({step:typeof i.step=="number"?i.step:t.length+1,trigger:a,action:s,chars:r,hint:typeof i.hint=="string"?i.hint.slice(0,30):a==="key"?"Keyboard Interact":"Mouse Interact",customMsg:typeof i.customMsg=="string"?i.customMsg.slice(0,22):null})}return t.length===0?Ct(e):pn(t,e)}function pn(n,e){let t=[];for(let o=0;o<n.length;o++){let i=n[o],a=i.action;if(!a.t&&e[o]&&(i.action=e[o]),a.t==="chk"&&!a.name&&a.id){let r=String(a.id);if(r.startsWith("eq-")||r.match(/^[a-z0-9]+-[a-z0-9]+-[a-z0-9]+$/))try{let l=document.querySelector(`[data-easyquiz-id="${r}"], #${r}`);l?.name&&(i.action.name=l.name,l.value&&l.value!=="on"&&(i.action.v=l.value))}catch{}}let s=t[t.length-1];if(s){let r=s.action;if(s.trigger===i.trigger&&r.t===a.t&&r.name===a.name&&r.v===a.v&&r.id===a.id)continue}t.push(i)}return t.length>0?t:n}window.__eqdiscrete?window.__eqdiscrete.analyze():hn();function mn(){try{if(document.querySelector("link[data-eqdiscrete-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-eqdiscrete-preconnect","true"),document.head?.appendChild(n)}catch{}}var fn=_e+Mt;async function hn(){mn(),ct();let n=new Te,e=new Ae,t=new Me,o=new qe(n,e,t),i=new Oe({onForceStep:b=>o.forceStep(b),onForceAllSteps:()=>o.forceAll()});o.setDebugOutput(i);let a=new ke({onModelChange:()=>e.flash("Modelo OK")}),s=new Ce(n,e),r=new Ie,l=null,c=!1,u=null,p=new Le({onPageAdvance:()=>{o.isActive()||c||g(!0)}});p.start();let d=Z();d.apiKey&&Fe(d.apiKey).catch(()=>{}),e.flash("EQ Ativo");let m=0,h=[1500,3e3,5e3,8e3];async function g(b=!1,x=0){if(u&&(clearTimeout(u),u=null),l){try{l.abort()}catch{}l=null}o.isActive()&&o.abort();let C=Z();if(!C.apiKey){e.flash("Config: Shift+A"),n.flashError(2e3);return}c=!0,m=x,l=new AbortController;let S=l.signal;p.resetHash(),n.setState("loading"),(!b||x>0)&&e.flash(x>0?`Tentativa ${x+1}`:"Analisando"),i.log("SYS",`Iniciando an\xE1lise (proativo: ${b}, retry: ${x})`);function A(){let M=h[Math.min(x,h.length-1)];i.log("WARN",`Agendando retry em ${M}ms`),u=window.setTimeout(()=>{o.isActive()||g(!1,x+1)},M)}try{if(b&&await new Promise(z=>setTimeout(z,700)),S.aborted)return;let M=xt(!1);if(M||(M=Ve()),!M||!M.questionText?.trim()){n.setState("idle"),x===0&&!b&&e.flash("Sem conte\xFAdo"),i.log("WARN","Nenhum conte\xFAdo ou quest\xE3o detectada na p\xE1gina"),A();return}i.log("DOM",`Contexto detectado: ${M.controls.length} controles, ${M.questionText.length} chars`,M.questionText);let O=await Et(M.scope,C.useVision);if(S.aborted)return;let I=performance.now(),w=await gt(M,O,C,(z,B)=>i.log(B==="error"?"ERROR":B==="warning"?"WARN":"SYS",`[IA] ${z}`),S,{systemPromptOverride:fn}),$=Math.round(performance.now()-I);if(S.aborted)return;n.setState("idle");let R=w.plan;if(i.log("SYS",`An\xE1lise conclu\xEDda em ${$}ms via ${w.usedModel??C.model} \u2014 pageType: ${R.pageType} | mode: ${R.mode} | ${R.actions?.length??0} a\xE7\xE3o(\xF5es)`),i.setPlan(R,M.questionText,$,C.model),R.memoryToStore&&rt(R.memoryToStore),R.pageType==="conclusion"){e.flash("Sess\xE3o encerrada"),i.log("SYS","P\xE1gina de conclus\xE3o detectada");return}let Q=Lt(R.interactionFlow,R.actions||[]);if(i.log("SYS",`Fluxo gerado: ${Q.length} step(s) \u2014 ${Q.map(z=>`${z.trigger}[${z.action?.t}]`).join(", ")}`),R.pageType==="info"||R.pageType==="start"){if(n.flashOk(1e3),e.flash("Avan\xE7ar \u2192"),i.log("SYS",`P\xE1gina informativa (${R.pageType}) \u2014 aguardando clique do usu\xE1rio para avan\xE7ar`),Q.length>0)o.start(Q);else{let z=[{step:1,trigger:"click",action:{t:"adv",label:"continuar"},hint:"Clique para avan\xE7ar",customMsg:null}];i.log("SYS","Fluxo adv gerado automaticamente para p\xE1gina informativa"),o.start(z)}return}if(!Q.length){i.log("WARN","Plano da IA retornou sem a\xE7\xF5es ou fluxo de intera\xE7\xE3o"),A();return}m=0,n.flashOk(500);let D=Q[0];e.flash(D.hint||"Pronto"),D.customMsg&&setTimeout(()=>e.flash(D.customMsg),1400),o.start(Q)}catch(M){if(S.aborted)return;n.setState("idle");let O=M instanceof Error?M.message:String(M);if(i.log("ERROR",`Erro na an\xE1lise: ${O}`),O.includes("403")||O.includes("API key")||O.includes("inv\xE1lida")){e.flash("Acesso negado"),n.flashError();return}if(O.includes("429")||O.includes("Quota")||O.includes("RESOURCE_EXHAUSTED")||O.includes("Todas as tentativas")){O.includes("Todas as tentativas")||x>=4?(e.flash("Limite \u2014 aguarde"),n.flashError(),A()):(e.flash("Chave rotacionando"),n.flashError(300),g(!1,x+1));return}n.flashError(800),A()}finally{l?.signal===S&&(l=null),c=!1}}function _(){if(c){e.flash("Analisando...");return}if(o.isActive()){let b=o.getCurrentStep()+1,x=o.getTotalSteps(),C=o.getState()==="waiting_key"?"Tecla":"Mouse";e.flash(`${b}/${x} ${C}`)}else{let x=Z().model.replace("gemini-","").replace("-flash","F").replace("-lite","L").replace("-preview","P");e.flash(`OK \u2014 ${x}`)}}function y(){a.isOpen()&&a.close(),s.isOpen()&&s.close(),r.isOpen()&&r.close(),i.isOpen()&&i.close()}let E=[{keys:"Shift+Q",label:"Analisar p\xE1gina",action:()=>void g()},{keys:"Shift+M",label:"Trocar modelo",action:()=>a.isOpen()?a.close():a.open()},{keys:"Shift+A",label:"Config API keys",action:()=>s.isOpen()?s.close():s.open()},{keys:"Shift+Z",label:"Abortar fluxo",action:()=>o.isActive()?o.abort():e.flash("Nada ativo")},{keys:"Shift+R",label:"Re-analisar",action:()=>void g()},{keys:"Shift+H",label:"Debug Output",action:()=>i.toggle()},{keys:"Shift+I",label:"\xDAltimo aviso",action:()=>e.reshow()},{keys:"Shift+C",label:"Comandos",action:()=>r.isOpen()?r.close():r.open()},{keys:"Escape",label:"Fechar menus",action:y}];r.setCommands(E);function f(b){let x=b.key;if(b.altKey&&(x==="q"||x==="Q")||b.shiftKey&&x==="Q"){b.preventDefault(),b.stopPropagation(),g();return}if(b.shiftKey&&x==="M"){b.preventDefault(),b.stopPropagation(),a.isOpen()?a.close():a.open();return}if(b.shiftKey&&x==="A"){b.preventDefault(),b.stopPropagation(),s.isOpen()?s.close():s.open();return}if(b.shiftKey&&x==="Z"){if(b.preventDefault(),b.stopPropagation(),l){try{l.abort()}catch{}l=null}u&&(clearTimeout(u),u=null),o.isActive()?o.abort():e.flash("Abortado"),c=!1,n.setState("idle");return}if(b.shiftKey&&x==="R"){b.preventDefault(),b.stopPropagation(),g();return}if(b.shiftKey&&x==="H"){b.preventDefault(),b.stopPropagation(),i.toggle();return}if(b.shiftKey&&x==="I"){b.preventDefault(),b.stopPropagation(),e.reshow();return}if(b.shiftKey&&x==="C"){b.preventDefault(),b.stopPropagation(),r.isOpen()?r.close():r.open();return}x==="Escape"&&(a.isOpen()||s.isOpen()||r.isOpen()||i.isOpen())&&(b.stopPropagation(),b.preventDefault(),y())}window.addEventListener("keydown",f,{capture:!0}),window.__eqdiscrete={analyze:()=>g(),destroy:()=>{window.removeEventListener("keydown",f,{capture:!0}),u&&clearTimeout(u),o.destroy(),i.destroy(),a.destroy(),s.destroy(),r.destroy(),p.stop(),n.destroy(),e.destroy(),t.clearAll(),delete window.__eqdiscrete}}}})();
