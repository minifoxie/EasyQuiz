...
`+H(i.slice(-2e3),2e3):H(i,16e3),s=[...n,...o].slice(0,120);return!a||s.length===0&&a.length<30?H(document.body.innerText||document.body.textContent||"",16e3).length>=30?We():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:Et(e),controls:s,scope:e}}function We(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=H(t,16e3),n=we(document.body),o=Ge(document.body),i=[...n,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Et(a).slice(0,15e3),controls:i,scope:a}}var Qe=10,Ye=1400,_e=15e5;function re(t){return new Promise((e,n)=>{let o=new FileReader;o.onerror=()=>n(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function le(t){let e=0,n=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,n=t.naturalHeight||t.height):(e=t.width,n=t.height),e<=0||n<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Ye/Math.max(e,n)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(n*o)),s=document.createElement("canvas");s.width=i,s.height=a;let c=s.getContext("2d",{alpha:!1});if(!c)throw new Error("Sem suporte a Canvas 2D.");return c.fillStyle="#ffffff",c.fillRect(0,0,i,a),c.drawImage(t,0,0,i,a),new Promise((r,l)=>{s.toBlob(u=>u?r(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Jt(t){let e=typeof t.getBoundingClientRect=="function"?t.getBoundingClientRect():{width:0,height:0},n=e.width||parseFloat(t.getAttribute("width")||"0")||parseFloat(t.style.width||"0")||400,o=e.height||parseFloat(t.getAttribute("height")||"0")||parseFloat(t.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(n*i))),s=Math.min(1800,Math.max(100,Math.round(o*i))),c=t.cloneNode(!0);c.getAttribute("xmlns")||c.setAttribute("xmlns","http://www.w3.org/2000/svg"),c.setAttribute("width",String(a)),c.setAttribute("height",String(s)),!c.getAttribute("viewBox")&&n>0&&o>0&&c.setAttribute("viewBox",`0 0 ${n} ${o}`);let l=new XMLSerializer().serializeToString(c),u=new Blob([l],{type:"image/svg+xml;charset=utf-8"}),f=URL.createObjectURL(u);try{let d=new Image;d.crossOrigin="anonymous",await new Promise((g,h)=>{d.onload=()=>g(),d.onerror=()=>h(new Error("Falha ao renderizar SVG em Image.")),d.src=f});let p=document.createElement("canvas");p.width=a,p.height=s;let m=p.getContext("2d",{alpha:!1});if(!m)throw new Error("Sem suporte a Canvas 2D.");return m.fillStyle="#ffffff",m.fillRect(0,0,a,s),m.drawImage(d,0,0,a,s),new Promise((g,h)=>{p.toBlob(y=>y?g(y):h(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(f)}}async function Xe(t){try{let e=t.cloneNode(!0),n=t.offsetWidth||500,o=t.offsetHeight||500,i=`
    ...
    `,a=new Blob([i],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(a),c=new Image;c.crossOrigin="anonymous",await new Promise((u,f)=>{c.onload=()=>u(),c.onerror=()=>f(new Error("Falha ao renderizar ForeignObject.")),c.src=s});let r=await le(c),l=await re(r);if(URL.revokeObjectURL(s),l&&l.length<=_e)return{mediaType:"image/jpeg",base64:l,alt:"Captura via rasteriza\xE7\xE3o DOM",source:"rasterized",captureStatus:"captured"}}catch(e){console.warn("[EasyQuiz] Falha na rasteriza\xE7\xE3o do n\xF3:",e)}return null}function St(t,e,n,o){if(n<=0||o<=0){let d=typeof t.getBoundingClientRect=="function"?t.getBoundingClientRect():{width:0,height:0};if(n=d.width||n,o=d.height||o,n<=0||o<=0){if(e&&/\b(icon|logo|avatar|badge|emoji|spinner|loading)\b/i.test(e))return!1;let m=t instanceof HTMLImageElement&&t.src||"";return m&&/\/icons?\/|\/logos?\/|\/avatars?\/|\/badges?\//i.test(m)?!1:!!(m||e)}}if(n<48||o<48||Math.max(n,o)/Math.max(1,Math.min(n,o))>15)return!1;let a=t.getAttribute("class")||"",s=t.getAttribute("aria-hidden"),c=t.getAttribute("role"),r=t instanceof HTMLImageElement&&t.src||"";if(s==="true"||c==="presentation"||c==="none")return!1;let l=/\b(icon|logo|avatar|badge|emoji|decoration|ornament|spinner|loading|thumbnail|profile|photo)\b/i;if(l.test(a)||e&&l.test(e)||r&&/\/icons?\/|\/logos?\/|\/avatars?\/|\/badges?\/|\/emojis?\//i.test(r)||e===""||e===" "||e==="-")return!1;let u=/\b(graph|chart|diagram|table|map|formula|equation|figure|plot|curve|histogram|scatter|matrix|image|foto|imagem|gráfico|tabela|mapa|fórmula|questão|enunciado|stimulus)\b/i;return u.test(e)||u.test(a)||t.closest('[data-question], [class*="question" i], [class*="prompt" i], [class*="stimulus" i], [class*="enunciado" i], [class*="statement" i], article, .problem, .exercise')?!0:n>=80&&o>=80}function Tt(t){let e=[],n=t.getAttribute("alt")||t.getAttribute("aria-label")||t.getAttribute("title")||"";n&&n.length>2&&e.push(`Alt: "${n}"`);let a=t.closest("figure")?.querySelector("figcaption")?.textContent?.trim();a&&a.length>2&&e.push(`Legenda: "${a}"`);let s=t.getAttribute("aria-describedby");if(s){let u=document.getElementById(s)?.textContent?.trim();u&&e.push(`Descri\xE7\xE3o: "${u.slice(0,200)}"`)}let c=t.parentElement;if(c){let l=H(c.textContent||"",300);l&&l.length>5&&l!==n&&e.push(`Contexto: "${l.slice(0,200)}"`)}let r=t.getAttribute("data-alt")||t.getAttribute("data-description")||"";return r&&e.push(`Data: "${r}"`),e.length===0?"":e.join(" | ")}async function Zt(t){let e=t.currentSrc||t.src;if(!e)return null;let n=(t.alt||t.getAttribute("aria-label")||"Imagem da quest\xE3o").slice(0,500);if(t.complete&&t.naturalWidth>0)try{let s=await le(t),c=await re(s);if(c&&c.length<=_e)return{mediaType:"image/jpeg",base64:c,alt:n,source:e.slice(0,2e3),captureStatus:"captured"}}catch{}try{let s=await fetch(e,{mode:"cors"});if(s.ok){let c=await s.blob();if(c.type.startsWith("image/")){let r=await createImageBitmap(c),l=await le(r);r.close();let u=await re(l);if(u&&u.length<=_e)return{mediaType:"image/jpeg",base64:u,alt:n,source:e.slice(0,2e3),captureStatus:"captured"}}}}catch{}if(!e.startsWith("data:"))try{let c=await(await fetch(e,{mode:"no-cors"})).blob();if(c.size>100)try{let r=await createImageBitmap(c),l=await le(r);r.close();let u=await re(l);if(u&&u.length>100&&u.length<=_e)return{mediaType:"image/jpeg",base64:u,alt:n,source:e.slice(0,2e3),captureStatus:"captured"}}catch{}}catch{}let o=t.parentElement||t,i=await Xe(o);if(i)return i;try{if(t.complete&&t.naturalWidth>0&&typeof HTMLCanvasElement.prototype.captureStream=="function"){let s=document.createElement("canvas");s.width=Math.min(t.naturalWidth,Ye),s.height=Math.min(t.naturalHeight,Ye);let c=s.getContext("2d");if(c){c.drawImage(t,0,0,s.width,s.height);let r=s.toDataURL("image/jpeg",.88).split(",")[1];if(r&&r.length>100&&r.length<=_e)return{mediaType:"image/jpeg",base64:r,alt:n,source:e.slice(0,2e3),captureStatus:"captured"}}}}catch{}let a=Tt(t);return a||n?{mediaType:"image/jpeg",base64:"",alt:n,source:e.slice(0,2e3),captureStatus:"text_only",textContext:a||`Imagem sem descri\xE7\xE3o textual dispon\xEDvel (src: ${e.slice(0,100)})`}:null}function en(t){return t.querySelectorAll("path, line, polyline, polygon, circle, rect, text, image").length>0}function tn(t){try{let e=t.style.backgroundImage||(window.getComputedStyle?window.getComputedStyle(t).backgroundImage:"");if(e&&e.includes("url(")){let n=e.match(/url\(["']?([^"')]+)["']?\)/);if(n&&n[1]&&!n[1].startsWith("data:image/svg+xml"))return n[1]}}catch{}return null}function nn(t,e){let n=t.closest('[data-easyquiz-id], button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], label, .option-card, .quiz-option, .choice, .answer, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr');if(n&&n!==e&&A(n)&&!X(n)&&!P(n)){let a=n.dataset.easyquizId||n.id||void 0,s=H(n.innerText||n.textContent||"",120),c=n.getAttribute("aria-label")||n.getAttribute("title")||"",r=s||c,l=a?` [id: ${a}]`:"";if(r)return{associatedLabel:`Alternativa/Op\xE7\xE3o: "${r}"${l}`,targetControlId:a};if(a)return{associatedLabel:`Alternativa/Op\xE7\xE3o ${l}`,targetControlId:a}}let o=t.closest("figure")?.querySelector("figcaption")?.textContent?.trim();if(o)return{associatedLabel:`Figura do Enunciado: "${H(o,100)}"`};let i=t.closest('[class*="prompt" i], [class*="stimulus" i], [class*="question-text" i], [class*="statement" i], header, h1, h2, h3, h4, p');if(i){let a=H(i.textContent||"",80);if(a)return{associatedLabel:`Gr\xE1fico do Enunciado: "${a}"`}}return{associatedLabel:"Gr\xE1fico/Imagem do Enunciado Principal"}}async function At(t,e=!0){if(!e)return[];let n=[],o=0,i=35e5,a=(r,l)=>{if(!r)return!1;let u=r.base64?r.base64.length:0;if(u>0&&o+u>i)return!1;let f=nn(l,t);return r.associatedLabel=f.associatedLabel,r.targetControlId=f.targetControlId,r.element=l,n.push(r),o+=u,n.filter(p=>p.captureStatus==="captured").length>=Qe},s=Array.from(t.querySelectorAll("img")).filter(r=>A(r)&&!P(r));for(let r of s)try{let l=r.getBoundingClientRect(),u=r.naturalWidth||l.width||r.width||0,f=r.naturalHeight||l.height||r.height||0,d=r.alt||"";if(!St(r,d,u,f))continue;let p=await Zt(r);if(a(p,r))return n}catch{}let c=Array.from(t.querySelectorAll("svg")).filter(r=>{if(!A(r)||P(r))return!1;let l=typeof r.getBoundingClientRect=="function"?r.getBoundingClientRect():{width:0,height:0},u=l.width||parseFloat(r.getAttribute("width")||"0"),f=l.height||parseFloat(r.getAttribute("height")||"0");return u<30||f<30?!1:en(r)});for(let r of c)try{let l=await Jt(r),u=await re(l);if(u){let f={mediaType:"image/jpeg",base64:u,alt:r.getAttribute("aria-label")||"Gr\xE1fico/Diagrama vetorial da quest\xE3o",source:"svg",captureStatus:"captured"};if(a(f,r))return n}}catch{let l=await Xe(r.parentElement||r);if(l){if(a(l,r))return n}else{let u=Tt(r);if(u){let f={mediaType:"image/jpeg",base64:"",alt:r.getAttribute("aria-label")||"Gr\xE1fico vetorial",source:"svg",captureStatus:"text_only",textContext:u};a(f,r)}}}if(n.filter(r=>r.captureStatus==="captured").length<Qe){let r=Array.from(t.querySelectorAll("canvas")).filter(l=>A(l)&&!P(l));for(let l of r)try{let u=await le(l),f=await re(u);if(f){let d={mediaType:"image/jpeg",base64:f,alt:l.getAttribute("aria-label")||"Gr\xE1fico Canvas inline",source:"canvas",captureStatus:"captured"};if(a(d,l))return n}}catch{let u=await Xe(l.parentElement||l);if(a(u,l))return n}}if(n.filter(r=>r.captureStatus==="captured").length<Qe){let r=Array.from(t.querySelectorAll('[style*="background-image"], .option-image, .question-media')).filter(l=>A(l)&&!P(l));for(let l of r){let u=tn(l);if(!u)continue;let f=l.getBoundingClientRect();if(St(l,l.getAttribute("aria-label")||"",f.width,f.height))try{let d=await fetch(u,{mode:"cors"});if(d.ok){let p=await d.blob();if(p.type.startsWith("image/")){let m=await createImageBitmap(p),g=await le(m);m.close();let h=await re(g);if(h){let y={mediaType:"image/jpeg",base64:h,alt:"Imagem de fundo da alternativa",source:u.slice(0,2e3),captureStatus:"captured"};if(a(y,l))return n}}}}catch{try{let p=await(await fetch(u,{mode:"no-cors"})).blob();if(p.size>100){let m=await createImageBitmap(p),g=await le(m);m.close();let h=await re(g);if(h&&h.length>100){let y={mediaType:"image/jpeg",base64:h,alt:"Imagem CSS background",source:u.slice(0,2e3),captureStatus:"captured"};if(a(y,l))return n}}}catch{}}}}return n}var on=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Je(t){let e=t?.engine||"smart",n=new Set(["dom","framework","keyboard","drag"]);return t?.autoAdvance&&n.add("navigation"),e==="javascript"&&n.add("javascript"),{engine:e,capabilities:n,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!t?.autoAdvance}}function Ze(t,e){if(t.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(t.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function kt(t){if(!t.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(t.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(on.find(n=>n.test(t)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(t)&&!t.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}function O(t){return t?!!(t.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||t.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function E(t){return t==null?"":(typeof t=="string"?t:String(t)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function K(t){if(!t||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t.getAttribute("draggable")==="true"||t.classList.contains("dnd-card")||t.hasAttribute("data-category")||t.hasAttribute("data-dropzone"))return t;if(t.hasAttribute("for")){let o=t.getAttribute("for");if(o){let i=t.ownerDocument.getElementById(o);if(i)return i}}let e=t.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let o=e.getAttribute("for"),a=(o?e.ownerDocument.getElementById(o):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let n=t.closest('button, a, [role="button"], [draggable="true"]');if(n)return n;if(["body","html","main","section","article","form"].includes(t.tagName.toLowerCase())){let o=t.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(o)return K(o)}return t}function Ct(t){let e=t;if(!e||!document.contains(e))try{e=J()}catch{}e=e||document.body;let n=i=>{let a=Array.from(i.querySelectorAll("tr")).filter(u=>A(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let s=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>A(u)&&!O(u));if(s.length>0)return s;let r=Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>A(u)&&!O(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return r.length>0?r:Array.from(i.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let f=u;return A(f)&&!O(f)&&(f.textContent||"").trim().length>2&&!X(f)&&!P(f)&&!f.querySelector("[class]")})},o=n(e);return o.length>0?o:e!==document.body?n(document.body):[]}function M(t,e,n=!1){if(t==null)return null;let i=(typeof t=="string"?t:String(t)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=R(i),s=document.querySelector(`[data-easyquiz-id="${a}"]`);if(s&&!O(s))return K(s);try{let d=document.getElementById(i);if(d&&A(d)&&!O(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:K(d)}catch{}try{let d=document.querySelector(`[data-item-id="${a}"]`);if(d&&A(d)&&!O(d))return K(d)}catch{}let c=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(c){let d=parseInt(c[1],10);if(n){let m=document.body;try{m=J()||document.body}catch{}let g=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(h=>A(h)&&!O(h));if(d>=1&&d-1<g.length)return g[d-1];if(d===0&&g.length>0)return g[0]}let p=d-1;if(p>=0){let m=Ct();if(p<m.length){let y=m[p];if(y.tagName.toLowerCase()==="tr"){if(e){let w=y.querySelector(`input[value="${R(e)}" i], [data-value="${R(e)}" i]`);if(w)return w}let x=y.querySelector("input");if(x)return x}return K(y)}let g=document.body;try{g=J()||document.body}catch{}let h=Array.from(g.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(y=>A(y)&&!O(y));if(p<h.length)return h[p]}}let r=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(r){let d=r[1].toUpperCase().charCodeAt(0)-65;if(d>=0){let p=Ct();if(d<p.length){let m=p[d];if(m.tagName.toLowerCase()==="tr"){if(e){let h=m.querySelector(`input[value="${R(e)}" i], [data-value="${R(e)}" i]`);if(h)return h}let g=m.querySelector("input");if(g)return g}return K(m)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let p=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(y=>A(y)&&!O(y));if(p)return p;let g=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(y=>A(y)&&!O(y));if(g)return K(g);let h=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(y=>{if(!A(y)||O(y))return!1;let x=E(y.textContent).toLowerCase();return x===i.toLowerCase()||x===i.toLowerCase()+")"});if(h)return K(h)}try{let p=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`)).find(m=>A(m)&&!O(m));if(p)return p.hasAttribute("data-category")||p.hasAttribute("data-dropzone")||p.classList.contains("dnd-zone")?p:K(p)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let p=Array.from(document.querySelectorAll(i)).find(m=>A(m)&&!O(m));if(p)return K(p)}catch{}try{let d=i.replace(/"/g,""),p=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,m=document.evaluate(p,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let g=0;g<m.snapshotLength;g++){let h=m.snapshotItem(g);if(h&&A(h)&&!O(h)){if(["body","html"].includes(h.tagName.toLowerCase())){let x=h.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(x&&A(x))return K(x)}return h.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(h)}}}catch{}let u=E(i).toLowerCase(),f=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of f){if(!A(d)||O(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||P(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let m=E(d.textContent).toLowerCase(),g=E(d.getAttribute("aria-label")||"").toLowerCase(),h=E(d.getAttribute("placeholder")||"").toLowerCase(),y=E(d.getAttribute("title")||"").toLowerCase(),x=E(d.getAttribute("name")||"").toLowerCase(),w=E(d.getAttribute("data-category")||"").toLowerCase(),_=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",T=E(_).toLowerCase(),$=m.startsWith(u+")")||m.startsWith(u+".")||m.startsWith(u+" -")||m.startsWith(u+":");if(m===u||g===u||h===u||y===u||x===u||w&&w===u||T&&T===u||$)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(d)}if(u.length>=3)for(let d of f){if(!A(d)||O(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||P(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let m=E(d.textContent).toLowerCase(),g=E(d.getAttribute("aria-label")||"").toLowerCase(),h=E(d.getAttribute("placeholder")||"").toLowerCase(),y=E(d.getAttribute("title")||"").toLowerCase(),x=E(d.getAttribute("name")||"").toLowerCase();if(m.includes(u)||g.includes(u)||h.includes(u)||y.includes(u)||x.includes(u)){if(Array.from(d.children).some($=>{let D=E($.textContent).toLowerCase();return D&&D.includes(u)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(d)}let w=u.split(/\s+/).filter(Boolean);if(w.length>=3){let _=w.slice(0,Math.min(5,w.length)).join(" ");if(m.includes(_)||g.includes(_)||h.includes(_))return K(d)}}return null}function Lt(t,e){for(let n of e)t.dispatchEvent(new Event(n,{bubbles:!0,composed:!0}))}function j(t,e){if(!t)return;try{t.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{t.focus?.()}catch{}let n=t.getBoundingClientRect(),o=e?e[0]:Math.round(n.left+Math.max(1,n.width/2)),i=e?e[1]:Math.round(n.top+Math.max(1,n.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:o,clientY:i};try{t.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{t.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{t.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{t.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{t.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{t.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}try{t.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{t.click()}catch{}try{let s=Object.keys(t).find(c=>c.startsWith("__reactFiber")||c.startsWith("__reactInternalInstance"));if(s){let c=t[s];for(;c;){let r=c.memoizedProps||c.pendingProps;if(r?.onClick){r.onClick({type:"click",target:t,currentTarget:t,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}c=c.return}}}catch{}try{let s=Object.keys(t).find(c=>c.startsWith("__reactProps"));if(s){let c=t[s];c?.onClick&&c.onClick({type:"click",target:t,currentTarget:t,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let s=t._vei;s?.onClick&&(Array.isArray(s.onClick.value)?s.onClick.value:[s.onClick.value]).forEach(r=>{try{r({type:"click",target:t})}catch{}})}catch{}try{t.$onclick&&t.$onclick({type:"click",target:t,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||t.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let c=t.querySelector('input[type="radio"], input[type="checkbox"]');c&&(c.focus?.(),c.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(c,!0),c.dispatchEvent(new Event("change",{bubbles:!0})));let r=t.closest("[jsaction]");if(r&&r!==t)try{r.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:o,clientY:i}))}catch{}}}catch{}if(t.getAttribute("role")==="button"||t.getAttribute("tabindex")!==null)try{t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function Ae(t){try{let e=t.id,n=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,t.id=e);let o=document.createElement("script");return o.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(o),o.remove(),n||setTimeout(()=>{try{t.id===e&&t.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function Se(t,e){let n=t;if(n.hasAttribute("for")){let l=n.getAttribute("for"),u=n.ownerDocument.getElementById(l);u&&(n=u)}if(typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox"||n.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Te(n,[e]);return}let i=n.querySelector('select, [role="combobox"], [role="listbox"]');if(i){Te(i,[e]);return}if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLTextAreaElement)&&!(n instanceof HTMLSelectElement)&&!n.isContentEditable){let l=n.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)n=l;else{let f=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(f)n=f;else{let d=n.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){n=d;break}let p=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){n=p;break}d=d.nextElementSibling}}}}if(n instanceof HTMLButtonElement||n.tagName.toLowerCase()==="a"||n.getAttribute("role")==="button"||n instanceof HTMLInputElement&&["button","submit","reset","image"].includes(n.type)){let l=n.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)n=l;else{let u=document.body;try{u=J()||document.body}catch{}let f=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f)n=f;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLTextAreaElement)&&!(n instanceof HTMLSelectElement)&&!n.isContentEditable){let l=document.body;try{l=J()||document.body}catch{}let u=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)n=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===n.value;oe(n,l);return}let s=String(e??""),c=s;if(n instanceof HTMLInputElement&&n.type==="number"){let l=s.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(c=l)}try{n.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),n.focus?.()}catch{}let r=!1;try{if(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement){if(n.type!=="number"&&n.type!=="range"){try{n.select?.()}catch{}r=document.execCommand?.("insertText",!1,c)||!1}}else if(n.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}r=document.execCommand?.("insertText",!1,c)||!1}}catch{}if(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement){try{let f=n._valueTracker;f&&f.setValue(c===""?" ":"")}catch{}let l=n instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(n,c):n.value=c;try{n.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:c.slice(-1)||"a"}))}catch{}try{n.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:c,inputType:"insertText"}))}catch{}try{n.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:c,inputType:"insertText"}))}catch{n.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{n.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:c.slice(-1)||"a"}))}catch{}try{n.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{n.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(n.value!==c&&!(n instanceof HTMLInputElement&&n.type==="number"&&Number(n.value)===Number(c))){n.value=c;try{u?.call(n,c)}catch{}}return}if(n.isContentEditable){if(n.textContent?.trim()!==c.trim()){n.textContent=c;try{n.innerText=c}catch{}}try{n.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:c,inputType:"insertText"}))}catch{n.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{n.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{n.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in n&&(n.value=c),n.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),n.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function oe(t,e){if(!t)return;let n=t.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||t,o=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:n.querySelector('input[type="checkbox"], input[type="radio"]');!o&&n.hasAttribute("for")&&(o=n.ownerDocument.getElementById(n.getAttribute("for")));let i=t instanceof HTMLInputElement?t.closest("label")||(t.id?n.ownerDocument.getElementById(n.getAttribute("for")):null)||t:n&&A(n)?n:t;if(o){let a=o.type==="radio",s=o.type==="checkbox",c=!!o._valueTracker;if(o.checked===e){if(a&&e){n.setAttribute("aria-checked","true"),n.setAttribute("aria-selected","true"),n.classList.add("selected","active","checked");return}if(s){n.setAttribute("aria-checked",e?"true":"false"),n.setAttribute("aria-selected",e?"true":"false"),n.classList.toggle("selected",e),n.classList.toggle("active",e),n.classList.toggle("checked",e);return}}i&&i!==o&&j(i);try{o.focus?.(),o.click()}catch{}if(o.checked!==e){try{let l=o._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,Lt(o,["input","change"])}n.setAttribute("aria-checked",e?"true":"false"),n.setAttribute("aria-selected",e?"true":"false"),n.classList.toggle("selected",e),n.classList.toggle("active",e),n.classList.toggle("checked",e)}else{if((n.getAttribute("aria-checked")==="true"||n.getAttribute("aria-selected")==="true"||n.getAttribute("data-selected")==="true"||n.getAttribute("data-checked")==="true"||n.classList.contains("selected")||n.classList.contains("active")||n.classList.contains("checked"))===e&&e)return;j(i),n.setAttribute("aria-checked",e?"true":"false"),n.setAttribute("aria-selected",e?"true":"false"),n.classList.toggle("selected",e),n.classList.toggle("active",e),n.classList.toggle("checked",e)}}function Te(t,e){let n=typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"?t:t.querySelector("select");if(n){let s=e.map(l=>E(l).toLowerCase()),c=!1,r=(l,u)=>{l.selected=!0,n.selectedIndex=u;try{n.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(n,l.value)}catch{}try{let f=n._valueTracker;f&&f.setValue(l.value)}catch{}c=!0};for(let l=0;l<n.options.length;l++){let u=n.options[l],f=u.value.toLowerCase(),d=E(u.textContent).toLowerCase();if(s.some(m=>m===f||m===d)){if(r(u,l),!n.multiple)break}else n.multiple||(u.selected=!1)}if(!c)for(let l of s){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let f=parseInt(u[1],10),p=n.options[0]?.value===""||n.options[0]?.disabled?f:f>=1?f-1:0;if(p>=0&&p<n.options.length&&(r(n.options[p],p),!n.multiple))break}}if(!c){for(let l of s)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,d=n.options[0]?.value===""||n.options[0]?.disabled?u+1:u;if(d>=0&&d<n.options.length&&(r(n.options[d],d),!n.multiple))break}}if(!c){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<n.options.length;u++){let f=n.options[u],d=l(f.value.toLowerCase()),p=l(E(f.textContent).toLowerCase());if(s.some(g=>{let h=l(g);return d.includes(h)||p.includes(h)||h.length>2&&(h.includes(d)||h.includes(p))})&&(r(f,u),!n.multiple))break}}if(c){Lt(n,["focus","input","change","blur"]);return}}let o=t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?t:t.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');o&&j(o);let i=e.map(s=>E(s).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(s=>A(s)&&!O(s));for(let s of i){let c=a.find(l=>{let u=E(l.textContent).toLowerCase(),f=E(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===s||f===s||u.includes(s)||s.length>2&&s.includes(u)});if(c){j(c);let l=c.querySelector('input[type="radio"], input[type="checkbox"]');l&&oe(l,!0);return}let r=M(s);if(r){j(r);return}}}function an(t,e){try{let n=new DataTransfer;try{n.setData("text/plain",t)}catch{}try{n.setData("text/html",e)}catch{}return n}catch{return null}}function et(t){try{t.click()}catch{let e=t.ownerDocument.defaultView||window;t.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function rn(t,e,n){try{if(e.contains(t))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(t))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let o=e.children.length;if(n!==void 0&&o>n)return{success:!0,evidence:`dest child count increased: ${n} \u2192 ${o}`};if([t.getAttribute("data-placed")==="true",t.getAttribute("data-assigned")==="true",t.getAttribute("data-matched")==="true",t.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(t.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(t.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(r=>r!==e&&(r.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:t.getAttribute("aria-hidden")==="true"||t.style.display==="none"||t.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function G(t,e){let n=E(t).toLowerCase();if(!n)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(t.trim())){let c=document.getElementById(t.trim());if(c&&A(c)&&!O(c))return c}let s=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let c of s){let l=Array.from(document.querySelectorAll(c)).find(u=>{if(!A(u)||O(u))return!1;let f=E(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return f===n||f.includes(n)||u.id===t.trim()});if(l)return l}return null}let o=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),i=Array.from(document.querySelectorAll(o)),a=i.find(s=>[s.getAttribute("data-category"),s.getAttribute("data-dropzone")].some(c=>c?.trim().toLowerCase()===n));return a&&A(a)&&!O(a)?a:i.find(s=>{if(!A(s)||O(s)||/unclassified/i.test(s.className))return!1;let c=s.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),r=E(c?.textContent||s.textContent||"").toLowerCase();return r.includes("op")&&(r.includes("es")||r.includes("\xF5es"))?!1:r===n||r.startsWith(n)||r.includes(n)})||null}async function me(t,e,n=1){try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=t.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(o.left+Math.max(1,o.width/2)),s=Math.round(o.top+Math.max(1,o.height/2)),c=Math.round(i.left+Math.max(1,i.width/2)),r=Math.round(i.top+Math.max(1,i.height/2)),l=E(e.textContent).toLowerCase();if(l){let g=Array.from(t.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(h=>{let y=E(h.textContent).toLowerCase(),x=h instanceof HTMLInputElement||h instanceof HTMLOptionElement?E(h.value).toLowerCase():"";return y&&(l.includes(y)||y.includes(l))||x&&(l.includes(x)||x.includes(l))});g&&(j(g),await new Promise(h=>setTimeout(h,120)))}et(t),await new Promise(m=>setTimeout(m,140)),et(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&et(u),await new Promise(m=>setTimeout(m,100)),!e.contains(t)&&t.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(t),e.contains(t)&&t.matches('.dnd-card, [draggable="true"]'))return;let f={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:s,screenX:a,screenY:s,button:0,buttons:1};try{t.dispatchEvent(new PointerEvent("pointerdown",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",f));let d=4;for(let m=1;m<=d;m++){let g=Math.round(a+(c-a)*(m/d)),h=Math.round(s+(r-s)*(m/d)),y={...f,clientX:g,clientY:h,screenX:g,screenY:h};try{t.dispatchEvent(new PointerEvent("pointermove",{...y,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",y))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:c,clientY:r,screenX:c,screenY:r,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let m=an(H(t.textContent),t.outerHTML),g={...f},h={...p};m&&(g.dataTransfer=m,h.dataTransfer=m);let y=t.ownerDocument.defaultView?.DragEvent;if(!y)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");t.dispatchEvent(new y("dragstart",g)),e.dispatchEvent(new y("dragenter",h)),e.dispatchEvent(new y("dragover",h)),e.dispatchEvent(new y("drop",h)),t.dispatchEvent(new y("dragend",g))}catch(m){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",m)}try{let m=new Touch({identifier:1,target:t,clientX:a,clientY:s}),g=new Touch({identifier:1,target:e,clientX:c,clientY:r});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[m]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(n>=2&&!e.contains(t))try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(m=>setTimeout(m,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(t))try{let m=y=>{let x=Object.keys(y).find(_=>_.startsWith("__reactFiber")||_.startsWith("__reactInternalInstance"));if(!x)return null;let w=y[x];for(let _=0;_<10&&w;_++){if(w.memoizedProps)return w.memoizedProps;w=w.return}return null},g=m(t),h=m(e);if(g){let y=g.onMouseDown||g.onPointerDown||g.onDragStart;if(typeof y=="function")try{y({type:"mousedown",button:0,buttons:1,clientX:a,clientY:s,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:t,target:t}),await new Promise(x=>setTimeout(x,100))}catch{}}if(h){let y=h.onMouseUp||h.onPointerUp||h.onDrop;if(typeof y=="function")try{y({type:"mouseup",button:0,buttons:0,clientX:c,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200));let y=r>s?"ArrowDown":"ArrowUp";for(let x=0;x<3;x++)document.dispatchEvent(new KeyboardEvent("keydown",{key:y,bubbles:!0,cancelable:!0})),await new Promise(w=>setTimeout(w,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(t.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:t.id||t.getAttribute("data-id")}})),await new Promise(x=>setTimeout(x,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(m){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",m)}}var qt={fill:(t,e)=>{let n=M(t);n?Se(n,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=M(t);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?oe(e,!0):j(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let n=M(t);n?oe(n,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},find:(t,e)=>M(t,e),drag:(t,e)=>{let n=G(t,"source")||M(t),o=G(e,"destination")||M(e);n&&o?me(n,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let n=G(t,"source")||M(t),o=G(e,"destination")||M(e);if(!n||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await me(n,o)},execute:(t,e=!1,n=1)=>un(t,e,n)};typeof window<"u"&&(window.$eq=qt);async function sn(t,e=1,n=Je()){if(Ze(t,n),t.t==="js"){let r=String(t.v||"");kt(r);try{new Function("$eq","document","window",r)(qt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(t.t==="drag"){let r=G(t.from,"source")||M(t.from),l=G(t.to,"destination")||M(t.to);!r&&t.from&&(r=M(E(t.from))),!l&&t.to&&(l=M(E(t.to))),r&&l?await me(r,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let o=t.id!==void 0&&t.id!==null?String(t.id):"";!o&&t.t==="val"&&(o=t.target??t.name??t.selector??"1");let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text,a=i!=null?String(i).trim():"",s=null,c=String(t.name??t.n??"").trim();if(t.t==="chk"&&c){let r=Array.from(document.querySelectorAll(`input[name="${R(c)}"]`));if(a&&(s=r.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!s&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||u){let f=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=r.find(d=>{let p=d.value?.toLowerCase()??"";if(f.includes(p))return!0;let g=(d.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return f.some(h=>g===h||g.startsWith(h+" ")||g.startsWith("("+h+")"))})??null}}!s&&r.length>0&&(s=r[0])}if(s||(s=M(o,a,t.t==="val"||t.t==="sel")),!s&&o&&(s=M(E(o),a,t.t==="val"||t.t==="sel")),s&&a){if(s instanceof HTMLInputElement&&s.type==="radio"&&s.name){if(E(s.value).toLowerCase()!==E(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${R(s.name)}"][value="${R(a)}" i]`);if(r)s=r;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${R(s.name)}"]`)).find(f=>{let d=f.closest("label, .vf-label, .option-card, tr, td, div");return d&&E(d.textContent).toLowerCase().includes(E(a).toLowerCase())});u&&(s=u)}}}else if(!(s instanceof HTMLInputElement)&&!(s instanceof HTMLSelectElement)&&!(s instanceof HTMLTextAreaElement)){let r=s.querySelector(`input[value="${R(a)}" i], [data-value="${R(a)}" i]`);if(r)s=r;else{let u=Array.from(s.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(f=>{let d=f.closest("label, .vf-label, .option-card, td, div");return d&&E(d.textContent).toLowerCase().includes(E(a).toLowerCase())});u&&(s=u)}}}if(!s&&(t.t==="val"||t.t==="sel")){let r=document.body;try{r=J()||document.body}catch{}let l=Array.from(r.querySelectorAll(t.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>A(u)&&!O(u));if(l.length===1)s=l[0];else if(l.length>1){let u=E(o).toLowerCase(),f=u.match(/^#?_?([0-9]+)$/);if(f){let d=parseInt(f[1],10);d>=1&&d<=l.length?s=l[d-1]:d>=0&&d<l.length&&(s=l[d])}s||(s=l.find(p=>{let m=(p.getAttribute("placeholder")||"").toLowerCase(),g=(p.name||"").toLowerCase(),h=(p.getAttribute("aria-label")||"").toLowerCase(),y=(p.id||"").toLowerCase(),x=E(Ve(p)).toLowerCase(),w=E(p.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return m.includes(u)||g.includes(u)||h.includes(u)||y.includes(u)||x&&x.includes(u)||u.length>=2&&w.includes(u)})||(l.length===1?l[0]:null))}}if(!s&&t.t!=="adv")throw new Error(`Alvo '${o}' n\xE3o encontrado no DOM para a\xE7\xE3o '${t.t}'.`);switch(t.t){case"val":if(s){let l=s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement||s.isContentEditable?s:s.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!l){let p=s.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(l=p)}if(!l){let d=s.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){l=d;break}let p=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){l=p;break}d=d.nextElementSibling}}if(!l){let d=document.body;try{d=J()||document.body}catch{}let p=Array.from(d.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>A(m)&&!O(m));p.length>0&&(l=p[0])}let u=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text,f=u!=null?String(u):"";Se(l||s,f)}break;case"chk":s&&oe(s,!!t.c);break;case"sel":if(s){let l=Array.isArray(t.v)?t.v:[String(t.v)];Te(s,l)}break;case"clk":if(s)if(!!(s.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||s.querySelector('input[type="radio"], input[type="checkbox"]')||s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type))){let u=t.c!==void 0?!!t.c:!0;oe(s,u)}else j(s,t.co);break;case"adv":let r=tt(t.id);if(r){await nt(r,1200);let l=t.id||r.textContent?.trim()||"";l&&Re(window.location.hostname,{advanceSelector:l}),j(r)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function cn(){let t=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(t)).find(n=>{if(!A(n)||O(n)||n.closest("header, nav, aside"))return!1;let o=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",i=(n.textContent||o||n.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function tt(t){let e=d=>{let p=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return ie.test(p)};if(t){let d=M(t);if(d&&A(d)&&!O(d)&&!P(d)&&!e(d))return d}try{let d=Pe(window.location.hostname);if(d.advanceSelector){let p=M(d.advanceSelector);if(p&&A(p)&&!O(p)&&!P(p)&&!e(p))return p}}catch{}let n=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(n)),i=d=>{let p=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||p||"").trim()},a=d=>{let p=i(d).trim();return/^\d{1,3}$/.test(p)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},s=o.filter(d=>A(d)&&!O(d)&&!d.closest("header, aside")&&!P(d)&&!e(d));for(let d of s){let p=i(d),m=p.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((be.test(p)||be.test(m))&&!a(d)&&!P(d))return d}for(let d of s)if(X(d)&&!P(d)&&!a(d))return d;let c=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(c&&A(c)&&!O(c)&&!P(c)&&!e(c))return c;let r=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of r)if(A(d)&&!O(d)&&!e(d)&&!P(d)&&!a(d))return d;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,f=l.filter(d=>{if(!A(d)||O(d)||e(d)||P(d)||d.closest("header, nav, aside, .eq-sidebar")||a(d))return!1;let p=d.getBoundingClientRect();return p.top>u*.45&&p.height>=24&&p.width>=24});if(f.length>0)return f.sort((d,p)=>{let m=d.getBoundingClientRect(),g=p.getBoundingClientRect(),h=m.left+m.top;return g.left+g.top-h}),f[0];for(let d of s)if(X(d)&&!P(d))return d;return null}async function nt(t,e=2500){let n=Date.now();for(;Date.now()-n<e;){if(!(t.disabled===!0||t.getAttribute("aria-disabled")==="true"||t.classList.contains("disabled")||t.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function ln(){let t=window.location.href,e=document.title,n=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,o=(document.body?.innerText||document.body?.textContent||"").length;return`${t}|${e}|${n}|${o}`}async function dn(t,e=3500){let[n,o,i,a]=t.split("|"),s=parseInt(a||"0",10),c=Date.now();for(;Date.now()-c<e;){let r=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),f=(document.body?.innerText||document.body?.textContent||"").length;if(r!==n)return{changed:!0,evidence:`URL mudou: ${n} \u2192 ${r}`};if(l!==o)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${o}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${u}`};if(Math.abs(f-s)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(f-s)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Mt(t){if(t.t==="js"||t.t==="adv")return;if(t.t==="drag"){let i=M(t.from)||M(E(t.from)),a=M(t.to)||M(E(t.to));i&&a&&await me(i,a,2);return}let e=t.id||"",n=t.v!==void 0?String(t.v).trim():"",o=M(e,n)||M(E(e),n);if(t.t==="clk"||t.t==="chk"){if(!o&&e){let a=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=E(e).toLowerCase();o=a.find(c=>{let r=E(c.textContent).toLowerCase();return!!(E(c.value||"").toLowerCase()===s||r===s||r.startsWith(s+")")||r.startsWith("("+s+")")||r.startsWith(s+".")||r.startsWith(s+" - ")||r.startsWith(s+":")||s.length>=3&&r.includes(s))})||null}let i=t.v!==void 0?String(t.v).trim():"";if(o&&i){if(o instanceof HTMLInputElement&&o.type==="radio"&&o.name){if(E(o.value).toLowerCase()!==E(i).toLowerCase()){let a=document.querySelector(`input[type="radio"][name="${R(o.name)}"][value="${R(i)}" i]`);if(a)o=a;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${R(o.name)}"]`)).find(r=>{let l=r.closest("label, .vf-label, .option-card, tr, td, div");return l&&E(l.textContent).toLowerCase().includes(E(i).toLowerCase())});c&&(o=c)}}}else if(!(o instanceof HTMLInputElement)&&!(o instanceof HTMLSelectElement)&&!(o instanceof HTMLTextAreaElement)){let a=o.querySelector(`input[value="${R(i)}" i], [data-value="${R(i)}" i]`);if(a)o=a;else{let c=Array.from(o.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(r=>{let l=r.closest("label, .vf-label, .option-card, td, div");return l&&E(l.textContent).toLowerCase().includes(E(i).toLowerCase())});c&&(o=c)}}}if(o){let a=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,s=o instanceof HTMLInputElement&&["radio","checkbox"].includes(o.type)?o:a.querySelector('input[type="radio"], input[type="checkbox"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),c=t.t==="chk"||t.c!==void 0?!!t.c:!0;if(oe(s||a,c),s&&s.checked!==c){try{let r=s._valueTracker;r&&r.setValue(!c)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,c)}catch{}s.checked=c,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(t.t==="val"){let i=null;if(o&&(i=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o.isContentEditable?o:o.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let a=document.body;try{a=J()||document.body}catch{}let s=Array.from(a.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),c=E(e).toLowerCase();i=s.find(r=>{let l=(r.getAttribute("placeholder")||"").toLowerCase(),u=(r.name||"").toLowerCase(),f=(r.id||"").toLowerCase(),d=(r.getAttribute("aria-label")||"").toLowerCase();return l.includes(c)||u.includes(c)||f.includes(c)||d.includes(c)})||(s.length>0?s[0]:null)}if(i){let a=String(t.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,a)}}catch{}Se(i,a)}return}if(t.t==="sel"){if(!o&&e){let i=Array.from(document.querySelectorAll("select")),a=E(e).toLowerCase();o=i.find(s=>{let c=(s.name||"").toLowerCase(),r=(s.id||"").toLowerCase(),l=(s.getAttribute("aria-label")||"").toLowerCase();return c.includes(a)||r.includes(a)||l.includes(a)})||null}if(o){let i=Array.isArray(t.v)?t.v:[String(t.v)];Te(o,i)}return}}function ee(t){try{if(t.t==="val"){let e=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text,n=String(e??"").trim(),o=n,i=t.id!==void 0&&t.id!==null?String(t.id):"";i||(i=t.target??t.name??t.selector??"1");let a=M(i,o,!0)||M(E(i),o,!0);if(!a){let p=document.body;try{p=J()||document.body}catch{}let m=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(g=>A(g)&&!O(g));m.length>0&&(a=m[0])}if(!a)return!1;let s=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(s&&s.name){let p=document.querySelector(`input[type="radio"][name="${R(s.name)}"]:checked`);if(!p)return!1;let m=E(p.value).toLowerCase(),g=E(n).toLowerCase(),h=E(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return m===g||h===g||h.includes(g)}let c=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!c){let m=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');m&&(c=m)}if(!c){let p=a.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){c=p;break}let m=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){c=m;break}p=p.nextElementSibling}}if(c instanceof HTMLSelectElement){let p=E(n).toLowerCase();return Array.from(c.options).some(m=>{if(!m.selected)return!1;let g=m.value.toLowerCase(),h=E(m.textContent).toLowerCase();return p===g||p===h||g.includes(p)||h.includes(p)})}let r=(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement?c.value:c?.textContent??a.textContent??"").trim();if(!r&&!n)return!0;if(!r&&n)return!1;let l=r.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=n.replace(",",".").replace(/\s+/g,"").toLowerCase(),f=parseFloat(l),d=parseFloat(u);return!isNaN(f)&&!isNaN(d)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(f-d)<1e-4:l===u||r.toLowerCase()===n.toLowerCase()||u.length>=3&&l===u}if(t.t==="sel"){let e=M(t.id,void 0,!0)||M(E(t.id),void 0,!0);if(!e){let a=document.body;try{a=J()||document.body}catch{}let s=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>A(l)&&!O(l)),c=E(t.id).toLowerCase();e=s.find(l=>{let u=(l.id||"").toLowerCase(),f=(l.getAttribute("name")||"").toLowerCase(),d=(l.getAttribute("aria-label")||"").toLowerCase(),p=E(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(c)||f.includes(c)||d.includes(c)||c.length>=2&&p.includes(c)})||(s.length===1?s[0]:null)}if(!e)return!1;let n=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!n){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let c=(Array.isArray(t.v)?t.v:[String(t.v)]).map(l=>E(l).toLowerCase()),r=E(a.textContent).toLowerCase();return c.some(l=>r.includes(l)||l.includes(r))}return!1}let i=(Array.isArray(t.v)?t.v:[String(t.v)]).map(a=>E(a).toLowerCase());return Array.from(n.options).some(a=>{if(!a.selected)return!1;let s=a.value.toLowerCase(),c=E(a.textContent).toLowerCase();return i.some(r=>r===s||r===c||s.includes(r)||c.includes(r))})}if(t.t==="chk"||t.t==="clk"){let e=t.v!==void 0?String(t.v).trim():"",n=M(t.id,e)||M(E(t.id),e);if(!n)return!1;let o=n.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||n,i=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.getAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null),a=t.t==="chk"||t.c!==void 0?!!t.c:!0;if(i&&i.type==="radio"){if(i.checked===a)return!0;if(t.v&&i.name){let f=E(String(t.v)).toLowerCase(),d=document.querySelector(`input[type="radio"][name="${R(i.name)}"]:checked`);if(!d)return!1;if(d===i)return!0;let p=E(d.value).toLowerCase(),m=E(d.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===f||m.includes(f)||f.includes(p)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===a;let s=o.getAttribute("aria-checked")===String(a)||o.getAttribute("aria-selected")===String(a)||o.getAttribute("aria-pressed")===String(a),c=a?o.getAttribute("data-selected")==="true"||o.getAttribute("data-checked")==="true"||o.getAttribute("data-active")==="true"||o.getAttribute("data-state")==="checked"||o.getAttribute("data-state")==="on":o.getAttribute("data-selected")==="false"||o.getAttribute("data-checked")==="false"||o.getAttribute("data-state")==="unchecked",r=o.className||"",l=a?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(r):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(r);if(s||c||l)return!0;let u=!!o.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return t.t==="clk"&&!i&&!u||o.getAttribute("aria-expanded")!==null||o.getAttribute("aria-pressed")!==null}if(t.t==="drag"){let e=G(t.from,"source")||M(t.from)||M(E(t.from)),n=G(t.to,"destination")||M(t.to)||M(E(t.to));return!e||!n?!1:rn(e,n).success}}catch{}return!1}async function un(t,e,n=1,o=Je({engine:"smart",autoAdvance:e})){let i=t.actions.filter(b=>b.t!=="adv"),a=t.actions.filter(b=>b.t==="adv"),s=0,c=[],r=new Map,l=new Map,u=new Map,f=new Set,d=t.pageType==="question",p=i.filter(b=>b.t==="chk"||b.t==="clk"&&b.c!==void 0),m=new Map;for(let b of i){let S=[];l.set(b,S);try{if(b.t==="drag"){S.push("declarative-A-F");try{let k=G(b.from,"source")||M(b.from),L=G(b.to,"destination")||M(b.to);k&&u.set(b,k.parentElement?.outerHTML?.slice(0,500)||""),L&&m.set(b,L.children.length)}catch{}}else S.push("declarative-primary");await sn(b,n,o),s++,f.add(b)}catch(k){r.set(b,k instanceof Error?k.message:String(k)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",b,k)}await new Promise(k=>setTimeout(k,b.t==="drag"?180:35))}if(d&&t.mode==="escolha_multipla"&&p.length>0){let b=document.body;try{b=J()||document.body}catch{}let S=Array.from(b.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(k=>A(k)&&!O(k));if(S.length>1){let L=function(v,C){if(v===C||v.contains(C)||C.contains(v))return!0;let q=v.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),N=C.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(q&&N&&q===N)return!0;let z=v.getAttribute("for")||v.id,F=C.getAttribute("for")||C.id;return!!(z&&F&&z===F)};var D=L;let k=new Set;for(let v of p){let C=v.t==="chk"?!!v.c:!!(v.c??!0),q="id"in v&&typeof v.id=="string"?v.id:"";if(C&&q){let N=M(q,v.v);if(N){k.add(N);let z=N.querySelector('input[type="checkbox"]');z&&k.add(z);let F=N.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');F&&(k.add(F),F.querySelectorAll('input[type="checkbox"]').forEach(I=>k.add(I)))}}}if(k.size>=p.length&&k.size>0){let v=Array.from(k);for(let C of S)v.some(N=>L(N,C))||(C instanceof HTMLInputElement&&C.checked||C.getAttribute("aria-checked")==="true"||C.closest(".option-card, label")?.classList.contains("selected"))&&oe(C,!1)}}}await new Promise(b=>setTimeout(b,i.length>0?100:25));let g=0;for(let b of i){if(ee(b)){g++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${b.t}' no alvo '${b.id||b.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ze(b,o),l.get(b)?.push("alternative-path"),await Mt(b)}catch(S){r.set(b,S instanceof Error?S.message:String(S)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",S)}await new Promise(S=>setTimeout(S,250)),ee(b)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),g++,f.has(b)?r.has(b)&&r.delete(b):(r.delete(b),s++,f.add(b)))}if(g<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-g} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(b=>setTimeout(b,200));for(let b of i)if(!ee(b))try{if(await Mt(b),await new Promise(S=>setTimeout(S,80)),!ee(b)&&(b.t==="clk"||b.t==="chk"))try{let S="id"in b?String(b.id||""):"",k=b.v!==void 0?String(b.v).trim():"",L=M(S,k)||M(E(S),k);L&&(Ae(L),await new Promise(v=>setTimeout(v,120)))}catch{}}catch(S){r.set(b,S instanceof Error?S.message:String(S))}await new Promise(b=>setTimeout(b,200)),g=0;for(let b of i)ee(b)&&(g++,f.has(b)?r.has(b)&&r.delete(b):(r.delete(b),s++,f.add(b)))}let h=[];for(let[b,S]of i.entries())if(!ee(S)){let k=S.t==="drag"?`${S.from} -> ${S.to}`:"id"in S?S.id:S.t;c.push(k),h.push({actionIndex:b,action:S,strategiesAttempted:l.get(S)||[],evidence:r.get(S)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(S)}),S.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${S.from}" -> "${S.to}"`,`
  Estrat\xE9gias: ${(l.get(S)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(S)?.slice(0,200)||"n/a"}`)}d&&i.length===0&&c.push("nenhuma a\xE7\xE3o de resposta prescrita");let y=i.map((b,S)=>{let k=b.t==="drag"?`${b.from} -> ${b.to}`:b.t==="js"?"$eq":b.id||b.t,L=b.t==="js"?!0:b.t==="drag"?!!(G(b.from,"source")&&G(b.to,"destination")):!!(M(b.id||"")||M(E(b.id||""))),v=ee(b);return{index:S,action:b,target:k,located:L,applied:!r.has(b),verified:v,strategy:b.t==="drag"?"drag-adaptive":b.t==="js"?"javascript":"declarative-dom",evidence:v?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...r.has(b)?{error:r.get(b)}:{}}}),x=d?i.length>0&&c.length===0&&(g===i.length||s===i.length&&g>0):!0,w=!1,_=!1,T="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",$=s>0&&s>=i.length/2;if(e&&(x||!d||$)){await new Promise(v=>setTimeout(v,i.length>0?120:40));let b=!1;if(t.pageType!=="info"){let v=cn();v&&A(v)&&(await nt(v,1200),j(v),b=!0,await new Promise(C=>setTimeout(C,350)))}let S=ln(),k=a.length>0?a[0].id:void 0,L=tt(k);if(!L&&b&&(await new Promise(v=>setTimeout(v,250)),L=tt(k)),L){await nt(L,1500);let v=k||L.textContent?.trim()||"";v&&Re(window.location.hostname,{advanceSelector:v}),j(L);let C=await dn(S,1800);_=C.changed,T=C.evidence,w=C.changed||b,!C.changed&&!b&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else b?(w=!0,_=!0,T="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:s,verified:g,success:x,advanced:w,failed:c,reports:y,navigationVerified:_,navigationEvidence:T,failedActions:h}}var ke=class{el=null;state="idle";mouseX=-300;mouseY=-300;displayX=-300;displayY=-300;rafId=null;flashTimer=null;boundMove;constructor(){this.boundMove=e=>{this.mouseX=e.clientX,this.mouseY=e.clientY,this.displayX===-300&&(this.displayX=e.clientX,this.displayY=e.clientY)},window.addEventListener("mousemove",this.boundMove,{passive:!0}),this.injectStyle(),this.createEl(),this.startRaf()}injectStyle(){if(document.getElementById("__eqdc_style__"))return;let e=document.createElement("style");e.id="__eqdc_style__",e.textContent=`
    ...
    `,document.documentElement.appendChild(e)}open(){this.close();let n=te().model,o=[...ve],i=(xe||[]).filter(g=>!o.some(h=>h.id===g.id)),a=document.createElement("div");a.id="__eqdm_menu__",a.setAttribute("role","menu"),a.tabIndex=-1;let s=document.createElement("div");s.className="__eqdm_section__",s.textContent="Modelo Gemini",a.appendChild(s);let c=document.createElement("div");c.className="__eqdm_sep__",a.appendChild(c);let r=(g,h,y)=>{let x=g===n,w=document.createElement("div");w.className="__eqdm_item__",w.setAttribute("role","menuitemradio"),w.setAttribute("aria-checked",x?"true":"false"),w.tabIndex=0;let _=document.createElement("span");_.className="__eqdm_check__",x&&(_.innerHTML=`<svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
...
`);navigator.clipboard.writeText(i).then(()=>{n.textContent="\u2713",setTimeout(()=>n.textContent="\u{1F4CB}",1e3)})}),this.el.querySelector("#__eq_dbg_btn_clear__")?.addEventListener("click",()=>{this.logs=[],this.renderConsoleLogs(),this.updateTabCounters()})}renderFlow(){let e=this.el?.querySelector(".__eq_dbg_body__");if(!e)return;if(!this.currentFlow||this.currentFlow.length===0){e.innerHTML=`
      ...
      `;return}let n=this.currentFlow.map((i,a)=>{let s=i.action,c=this.stepStatuses.get(a)||(a===this.currentStepIdx?"active":a<this.currentStepIdx?"done":"pending"),r=c==="done"?'<span class="__eq_status_done__">\u2713 Conclu\xEDdo</span>':c==="active"?'<span class="__eq_status_active__">\u25B6 Em Andamento</span>':c==="failed"?'<span class="__eq_status_failed__">\u2715 Falhou</span>':'<span class="__eq_status_pending__">Pendente</span>',l=i.trigger==="key"?"\u2328\uFE0F Tecla":"\u{1F5B1}\uFE0F Clique",u=String(s.t||"act").toUpperCase(),f=s.id?`#${s.id}`:s.name?`[name="${s.name}"]`:s.label||s.from||"alvo",d=s.v!==void 0?` = "${s.v}"`:s.c!==void 0?` (check: ${s.c})`:"";return`
        <div class="__eq_flow_card__ ${c==="active"?"__eq_flow_active__":""}">
          ...
          <div class="__eq_flow_content__">
            <div class="__eq_flow_target__">${W(String(f))}<span style="color:#8ab4f8;">${W(String(d))}</span></div>
    ...
    `,e.querySelector("#__eq_btn_copy_json__")?.addEventListener("click",a=>{navigator.clipboard.writeText(i).then(()=>{let s=a.currentTarget;s.textContent="\u2713 Copiado",setTimeout(()=>s.textContent="Copiar JSON",1200)})})}renderMedia(){let e=this.el?.querySelector(".__eq_dbg_body__");if(!e)return;if(!this.capturedImages||this.capturedImages.length===0){e.innerHTML=`
      ...
      `;return}let n=this.currentPlan?.imageDescriptions||[],o="";this.capturedImages.forEach((i,a)=>{let s=n.find(m=>m.index===a),c=s?.relevant??!0,r=s?.description??(i.textContext||"Aguardando an\xE1lise da IA..."),l=i.captureStatus==="captured"?"\u2705":i.captureStatus==="text_only"?"\u{1F4DD}":"\u26A0\uFE0F",u=i.captureStatus==="captured"?"Visual":i.captureStatus==="text_only"?"Texto":"Falhou",f=i.base64?`data:${i.mediaType||"image/jpeg"};base64,${i.base64}`:"",d="";f?d=`
...
`;function It(t){let e=[],n=1;for(let o of t){let i=o.t;if(i==="val"){let a=String(o.v??""),s=Math.max(1,a.length);for(let c=0;c<s;c++){let r=c===0,l=c===s-1,u=s>1?`${c+1}/${s}`:null;e.push({step:n++,trigger:"key",action:o,chars:1,hint:r?"Keyboard Interact":l?"Buffer Flush":"Key Capture",customMsg:u})}}else i==="chk"||i==="clk"?e.push({step:n++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:null}):i==="sel"?(e.push({step:n++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:"Opening..."}),e.push({step:n++,trigger:"click",action:o,hint:"Option Selected",customMsg:null})):i==="drag"?e.push({step:n++,trigger:"click",action:o,hint:"Mover Item",customMsg:null}):i==="adv"&&e.push({step:n++,trigger:"click",action:o,hint:"Next Page Loading",customMsg:null})}return e}function Ht(t,e){if(!Array.isArray(t)||t.length===0)return It(e);let n=[];for(let o of t){if(!o||typeof o!="object")continue;let i=o,a=i.trigger==="key"?"key":"click",s=i.action||{},c=a==="key"?1:void 0;n.push({step:typeof i.step=="number"?i.step:n.length+1,trigger:a,action:s,chars:c,hint:typeof i.hint=="string"?i.hint.slice(0,30):a==="key"?"Keyboard Interact":"Mouse Interact",customMsg:typeof i.customMsg=="string"?i.customMsg.slice(0,22):null})}return n.length===0?It(e):hn(n,e)}function hn(t,e){let n=[];for(let o=0;o<t.length;o++){let i=t[o],a=i.action;if(!a.t&&e[o]&&(i.action=e[o]),a.t==="chk"&&!a.name&&a.id){let c=String(a.id);if(c.startsWith("eq-")||c.match(/^[a-z0-9]+-[a-z0-9]+-[a-z0-9]+$/))try{let r=document.querySelector(`[data-easyquiz-id="${c}"], #${c}`);r?.name&&(i.action.name=r.name,r.value&&r.value!=="on"&&(i.action.v=r.value))}catch{}}let s=n[n.length-1];if(s){let c=s.action;if(s.trigger===i.trigger&&c.t===a.t&&c.name===a.name&&c.v===a.v&&c.id===a.id)continue}n.push(i)}return n.length>0?n:t}if(window.__eqdiscrete)try{window.__eqdiscrete.destroy()}catch{}yn();function bn(){try{if(document.querySelector("link[data-eqdiscrete-preconnect]"))return;let t=document.createElement("link");t.rel="preconnect",t.href="https://generativelanguage.googleapis.com",t.crossOrigin="anonymous",t.setAttribute("data-eqdiscrete-preconnect","true"),document.head?.appendChild(t)}catch{}}var _n=ye+Ot;async function yn(){bn(),ut();let t=new ke,e=new Ce,n=new qe,o=new Oe(t,e,n),i=new $e({onForceStep:_=>o.forceStep(_),onForceAllSteps:()=>o.forceAll()});o.setDebugOutput(i);let a=new Me({onModelChange:()=>e.flash("Modelo OK")}),s=new Le(t,e),c=new He,r=null,l=!1,u=null,f=new Ie({onPageAdvance:()=>{o.isActive()||l||g(!0)}});f.start();let d=te();d.apiKey&&Ue(d.apiKey).catch(()=>{}),e.flash("EQ Ativo");let p=0,m=[1500,3e3,5e3,8e3];async function g(_=!1,T=0){if(u&&(clearTimeout(u),u=null),r){try{r.abort()}catch{}r=null}o.isActive()&&o.abort();let $=te();if(!$.apiKey){e.flash("Config: Shift+A"),t.flashError(2e3);return}l=!0,p=T,r=new AbortController;let D=r.signal;f.resetHash(),t.setState("loading"),(!_||T>0)&&e.flash(T>0?`Tentativa ${T+1}`:"Analisando"),i.log("SYS",`Iniciando an\xE1lise (proativo: ${_}, retry: ${T})`);function b(){let S=m[Math.min(T,m.length-1)];i.log("WARN",`Agendando retry em ${S}ms`),u=window.setTimeout(()=>{o.isActive()||g(!1,T+1)},S)}try{if(_&&await new Promise(I=>setTimeout(I,700)),D.aborted)return;let S=wt(!1);if(S||(S=We()),!S||!S.questionText?.trim()){t.setState("idle"),T===0&&!_&&e.flash("Sem conte\xFAdo"),i.log("WARN","Nenhum conte\xFAdo ou quest\xE3o detectada na p\xE1gina"),b();return}i.log("DOM",`Contexto detectado: ${S.controls.length} controles, ${S.questionText.length} chars`,S.questionText);let k=await At(S.scope,$.useVision);if(D.aborted)return;i.setImages(k);let L=performance.now(),v=await _t(S,k,$,(I,U)=>i.log(U==="error"?"ERROR":U==="warning"?"WARN":"SYS",`[IA] ${I}`),D,{systemPromptOverride:_n}),C=Math.round(performance.now()-L);if(D.aborted)return;t.setState("idle");let q=v.plan;if(i.log("SYS",`An\xE1lise conclu\xEDda em ${C}ms via ${v.usedModel??$.model} \u2014 pageType: ${q.pageType} | mode: ${q.mode} | ${q.actions?.length??0} a\xE7\xE3o(\xF5es)`),i.setPlan(q,S.questionText,C,$.model,k),q.memoryToStore&&ct(q.memoryToStore),q.imageDescriptions&&q.imageDescriptions.length>0){i.log("AI",`\u{1F5BC}\uFE0F ${q.imageDescriptions.length} imagem(ns) analisadas:`);for(let I of q.imageDescriptions){let U=I.relevant?"\u2705":"\u26A0\uFE0F";i.log(I.relevant?"AI":"WARN",`  ${U} Imagem ${I.index+1} [${I.relevant?"RELEVANTE":"IGNORADA"}]: ${I.description}`)}}if(q.pageType==="conclusion"){e.flash("Sess\xE3o encerrada"),i.log("SYS","P\xE1gina de conclus\xE3o detectada");return}let N=Ht(q.interactionFlow,q.actions||[]);if(i.log("SYS",`Fluxo gerado: ${N.length} step(s) \u2014 ${N.map(I=>`${I.trigger}[${I.action?.t}]`).join(", ")}`),q.pageType==="info"||q.pageType==="start"){if(t.flashOk(1e3),e.flash("Avan\xE7ar \u2192"),i.log("SYS",`P\xE1gina informativa (${q.pageType}) \u2014 aguardando clique do usu\xE1rio para avan\xE7ar`),N.length>0)o.start(N);else{let I=[{step:1,trigger:"click",action:{t:"adv",label:"continuar"},hint:"Clique para avan\xE7ar",customMsg:null}];i.log("SYS","Fluxo adv gerado automaticamente para p\xE1gina informativa"),o.start(I)}return}if(!N.length){i.log("WARN","Plano da IA retornou sem a\xE7\xF5es ou fluxo de intera\xE7\xE3o"),b();return}p=0,t.flashOk(500);let z=N[0];e.flash(z.hint||"Pronto"),z.customMsg&&setTimeout(()=>e.flash(z.customMsg),1400);let F=N.filter(I=>I.action?.t==="drag");if(F.length>0){i.log("FLOW",`\u{1F504} ${F.length} step(s) de drag/categoriza\xE7\xE3o no fluxo. Estrat\xE9gias A-G ser\xE3o tentadas.`);for(let I of F){let U=I.action;i.log("FLOW",`  Drag: "${U.from}" \u2192 "${U.to}"`,JSON.stringify(U))}}o.start(N)}catch(S){if(D.aborted)return;t.setState("idle");let k=S instanceof Error?S.message:String(S);if(i.log("ERROR",`Erro na an\xE1lise: ${k}`),k.includes("403")||k.includes("API key")||k.includes("inv\xE1lida")){e.flash("Acesso negado"),t.flashError();return}if(k.includes("429")||k.includes("Quota")||k.includes("RESOURCE_EXHAUSTED")||k.includes("Todas as tentativas")){k.includes("Todas as tentativas")||T>=4?(e.flash("Limite \u2014 aguarde"),t.flashError(),b()):(e.flash("Chave rotacionando"),t.flashError(300),g(!1,T+1));return}t.flashError(800),b()}finally{r?.signal===D&&(r=null),l=!1}}function h(){if(l){e.flash("Analisando...");return}if(o.isActive()){let _=o.getCurrentStep()+1,T=o.getTotalSteps(),$=o.getState()==="waiting_key"?"Tecla":"Mouse";e.flash(`${_}/${T} ${$}`)}else{let T=te().model.replace("gemini-","").replace("-flash","F").replace("-lite","L").replace("-preview","P");e.flash(`OK \u2014 ${T}`)}}function y(){a.isOpen()&&a.close(),s.isOpen()&&s.close(),c.isOpen()&&c.close(),i.isOpen()&&i.close()}let x=[{keys:"Shift+Q",label:"Analisar p\xE1gina",action:()=>void g()},{keys:"Shift+V",label:"M\xEDdias IA (Vision)",action:()=>{i.openTab("media"),e.flash("M\xEDdias IA")}},{keys:"Shift+M",label:"Trocar modelo",action:()=>a.isOpen()?a.close():a.open()},{keys:"Shift+A",label:"Config API keys",action:()=>s.isOpen()?s.close():s.open()},{keys:"Shift+Z",label:"Abortar fluxo",action:()=>o.isActive()?o.abort():e.flash("Nada ativo")},{keys:"Shift+R",label:"Re-analisar",action:()=>void g()},{keys:"Shift+H",label:"Debug Output",action:()=>i.toggle()},{keys:"Shift+I",label:"\xDAltimo aviso",action:()=>e.reshow()},{keys:"Shift+C",label:"Comandos",action:()=>c.isOpen()?c.close():c.open()},{keys:"Escape",label:"Fechar menus",action:y}];c.setCommands(x);function w(_){let T=_.key;if(_.altKey&&(T==="q"||T==="Q")||_.shiftKey&&T==="Q"){_.preventDefault(),_.stopPropagation(),g();return}if(_.shiftKey&&T==="M"){_.preventDefault(),_.stopPropagation(),a.isOpen()?a.close():a.open();return}if(_.shiftKey&&T==="A"){_.preventDefault(),_.stopPropagation(),s.isOpen()?s.close():s.open();return}if(_.shiftKey&&T==="Z"){if(_.preventDefault(),_.stopPropagation(),r){try{r.abort()}catch{}r=null}u&&(clearTimeout(u),u=null),o.isActive()?o.abort():e.flash("Abortado"),l=!1,t.setState("idle");return}if(_.shiftKey&&T==="R"){_.preventDefault(),_.stopPropagation(),g();return}if(_.shiftKey&&T==="H"){_.preventDefault(),_.stopPropagation(),i.toggle();return}if(_.shiftKey&&(T==="V"||T==="v")){_.preventDefault(),_.stopPropagation(),i.openTab("media"),e.flash("M\xEDdias IA");return}if(_.shiftKey&&T==="I"){_.preventDefault(),_.stopPropagation(),e.reshow();return}if(_.shiftKey&&T==="C"){_.preventDefault(),_.stopPropagation(),c.isOpen()?c.close():c.open();return}T==="Escape"&&(a.isOpen()||s.isOpen()||c.isOpen()||i.isOpen())&&(_.stopPropagation(),_.preventDefault(),y())}window.addEventListener("keydown",w,{capture:!0}),window.__eqdiscrete={analyze:()=>g(),destroy:()=>{window.removeEventListener("keydown",w,{capture:!0}),u&&clearTimeout(u),o.destroy(),i.destroy(),a.destroy(),s.destroy(),c.destroy(),f.stop(),t.destroy(),e.destroy(),n.clearAll(),delete window.__eqdiscrete}}}})();
