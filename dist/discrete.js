 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8};function le(t){if(!t||typeof t!="string")return!1;let e=t.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let n=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of n)if(e.includes(o))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var st="easyquiz_settings_v2",at="easyquiz_activity_metrics";function te(){try{let t=localStorage.getItem(st);if(!t){let s=localStorage.getItem("easyquiz_settings_v1");if(s){let r=JSON.parse(s);return{...ie,apiKey:r.apiKey||""}}return{...ie}}let e=JSON.parse(t),n=typeof e.model=="string"&&le(e.model)?e.model:ie.model,o=Array.isArray(e.apiKeys)?e.apiKeys.map(s=>typeof s=="string"?s.trim().replace(/^["']|["']$/g,""):"").filter(s=>s.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return o.length===0&&i&&(o=[i]),{apiKey:o[0]||i||ie.apiKey,apiKeys:o,model:n,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:ie.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function Ne(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);if(!e)return{};let n=JSON.parse(e);if(n.advanceSelector&&/inject|injetar/i.test(n.advanceSelector)){n.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+t)}catch{}}return n}catch{return{}}}function ze(t,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...Ne(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function he(t){let e=te(),n=Array.isArray(t.apiKeys)?t.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,o;typeof t.apiKey=="string"?o=t.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(t.apiKeys)&&t.apiKeys.length>0?o=n[0]||"":o=e.apiKey,o&&!n.includes(o)&&(n=[o,...n]),n.length>0&&(!o||!n.includes(o))&&(o=n[0]);let i={...e,...t,apiKey:o,apiKeys:n};try{localStorage.setItem(st,JSON.stringify(i))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var ue=[],it=12,Rt=1200;function ct(t){let e=t.trim().replace(/\s+/g," ").slice(0,Rt);e&&!ue.includes(e)&&(ue.push(e),ue.length>it&&(ue=ue.slice(-it)))}function lt(){return ue}function dt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var rt=dt();function ut(){rt=dt();try{sessionStorage.removeItem(at),localStorage.removeItem(at)}catch{}return rt}var xe=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(t)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(t)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(t)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(t)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(t)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Fe(t,e,n){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(_=>_.type==="draggable"||_.type==="dropzone"),i=/katex|latex|\\frac|\\sqrt/i.test(t.htmlSnippet),a=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(t.sourceUrl)||t.htmlSnippet.includes("Qr7Oae")||t.htmlSnippet.includes("data-item-id")||t.htmlSnippet.includes("freebirdFormviewer"),s=(/wayground|quizizz/i.test(t.sourceUrl)||t.htmlSnippet.includes("data-functional-selector"))&&(t.htmlSnippet.includes("classification")||t.controls.filter(_=>_.role==="answer").length===0),r=t.controls.filter(_=>_.role!=="navigation").length===0,d=r||o||a||s||i&&t.questionText.length<60,c=r?4500:s?6e3:1800,u=d?`
[HTML]:
${t.htmlSnippet.slice(0,c).replace(/\s+/g," ")}`:"",f="";if(r&&typeof document<"u")try{let _=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(x=>{let v=x,S=v.getBoundingClientRect?.()||{width:0,height:0};return S.width>0&&S.height>0&&!v.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(x=>{let v=x,S=v.tagName.toLowerCase(),I=v.id?`#${v.id}`:"",D=v.className&&typeof v.className=="string"?`.${v.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",z=(v.textContent||v.value||v.getAttribute("aria-label")||"").trim().slice(0,60),y=v.getAttribute("type")||v.getAttribute("role")||"";return`${S}${I}${D}[${y}] txt="${z}"`});_.length>0&&(f=`
[DOM-INTERATIVO]:
${_.join(`
`)}`)}catch{}let l=lt(),p=l.length>0?`
[MEM\xD3RIA]:
${l.join(" | ")}
`:"",m=t.controls.filter(_=>_.role!=="navigation"),g=t.controls.filter(_=>_.role==="navigation"),h=Dt(t.sourceUrl,t.htmlSnippet),b=h?`
${h}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(m.length===0)return"Nenhuma";let _=m.filter(w=>w.type==="checkbox"||w.type==="chk"),x=new Set(m.filter(w=>w.type==="radio").map(w=>w.name).filter(Boolean)),v=_.filter(w=>!w.name||!x.has(w.name)),S=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(t.questionText),I=v.length>=2||S,D=x.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(t.questionText)&&x.size>=1,z=m.every(w=>w.type==="radio"||w.type==="chk")&&x.size===1&&!I&&!D,y=m.filter(w=>w.type==="text"||w.type==="number"||w.type==="val"||w.tag==="input"||w.tag==="textarea"),T=y.length>=2;return(D?`[GRADE VERDADEIRO/FALSO (${x.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${x.size} afirma\xE7\xF5es \u2014 emita ${x.size} a\xE7\xF5es chk separadas + adv]
`:I?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
...
`:"")+JSON.stringify(m.map(w=>({id:w.id,t:w.type,n:w.name||void 0,txt:w.label?w.label.length>160?w.label.slice(0,160)+"...":w.label:void 0,v:w.value||void 0,opt:w.options&&w.options.length?w.options.slice(0,20).map(k=>k.label||k.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${g.length>0?g.map(_=>`"${_.label||_.id}"[${_.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length===0?"Nenhum anexo visual.":e.map((_,x)=>{let v=_.associatedLabel||"Gr\xE1fico da Quest\xE3o",S=_.alt?` | alt: "${_.alt}"`:"";if(_.captureStatus==="text_only")return`  - Imagem ${x+1} [CONTEXTO_TEXTUAL]: ${v}${S} | ${_.textContext||"sem contexto adicional"}`;if(_.captureStatus==="captured"||_.base64){let I=_.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${_.textContext}"`:"";return`  - Imagem ${x+1} [VISUAL_INLINE]: ${v}${S}${I}`}return`  - Imagem ${x+1} [FALHOU]: ${v}${S}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Nt=new Set(["question","info","start","conclusion"]),zt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Ft=new Set(["val","chk","sel","clk","adv","js","drag"]),Bt=150,be=2e3;function Q(t,e=""){return t==null?e:typeof t=="string"?t.trim().slice(0,be):typeof t=="number"||typeof t=="boolean"?String(t).trim().slice(0,be):e}function Ut(t,e){if(!t||typeof t!="object")return null;let n=t,o=n.t;if(typeof o!="string"||!Ft.has(o))return null;if(o==="adv"){let r=n.id??n.target??n.name??n.selector;return{t:"adv",...Q(r)?{id:Q(r,"").slice(0,500)}:{}}}if(o==="drag"){let r=Q(n.from??n.source),d=Q(n.to??n.target??n.destination);return!r||!d?null:{t:"drag",from:r.slice(0,500),to:d.slice(0,500)}}if(o==="js"){let r=Q(n.v??n.code??n.script);return!r||r.length>8e3?null:{t:"js",v:r}}let i=n.id??n.target??n.name??n.selector??n.element;(i==null||i==="")&&o==="val"&&(i="1");let a=Q(i).slice(0,500);if(!a)return null;if(o==="val"){let r=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text!==void 0?n.text:n.answer;return{t:"val",id:a,v:Q(r).slice(0,be)}}if(o==="sel"){let r=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.values,c=(Array.isArray(r)?r:[r]).map(u=>Q(u).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:c}}if(o==="chk"){let r=n.c===!1||n.c==="false"||n.c===0||n.c==="0"||n.c==="off"||n.c==="unchecked"||n.c==="desmarcar",d={t:"chk",id:a,c:!r};return n.v!==void 0&&(d.v=Q(n.v).slice(0,be)),d}let s={t:"clk",id:a};if(n.c!==void 0){let r=n.c===!1||n.c==="false"||n.c===0||n.c==="0"||n.c==="off"||n.c==="unchecked"||n.c==="desmarcar";s.c=!r}return n.v!==void 0&&(s.v=Q(n.v).slice(0,be)),Array.isArray(n.co)&&n.co.length===2&&n.co.every(r=>typeof r=="number"&&Number.isFinite(r))&&(s.co=[n.co[0],n.co[1]]),s}function jt(t,e,n){if(n!=="question")return t;let o=t.filter(a=>a.t==="adv"),i=t.filter(a=>a.t!=="adv");if(e==="escolha_unica"){i=i.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let a=i.filter(s=>s.t==="chk"||s.t==="clk");if(a.length>1){let s=i.filter(d=>d.t!=="chk"&&d.t!=="clk"),r=a[a.length-1];i=[...s,r]}}else if(e==="escolha_multipla"){i=i.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let a=new Set;i=i.filter(s=>{let r="id"in s&&typeof s.id=="string"?s.id:"";return r?a.has(r)?!1:(a.add(r),!0):!0})}else if(e==="verdadeiro_falso"){let a=new Set,s=[...i].reverse(),r=[];for(let d of s){let c="id"in d&&typeof d.id=="string"?d.id:"";c?a.has(c)||(a.add(c),r.push(d)):r.push(d)}i=r.reverse()}return[...i,...o]}function pt(t){if(!t||typeof t!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=t,n=e.pageType,o=e.mode;(typeof n!="string"||!Nt.has(n))&&(n="question"),(typeof o!="string"||!zt.has(o))&&(o="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],a=[];for(let d=0;d<Math.min(i.length,Bt);d++){let c=Ut(i[d],d);c&&a.push(c)}a.some(d=>d.t==="val")&&(o==="escolha_unica"||!e.mode)&&(o="preenchimento"),a.some(d=>d.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(o)&&(o="arrastar_soltar"),a=jt(a,o,n);let s=a.some(d=>d.t==="adv");n==="conclusion"?a.length=0:n==="info"||n==="start"?s||a.push({t:"adv"}):n==="question"&&!s&&a.push({t:"adv"});let r=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:n,mode:o,confidence:r,rationale:Q(e.rationale,"Plano validado e auto-recuperado."),actions:a,...Q(e.memoryToStore)?{memoryToStore:Q(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var ne=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let n=new Map(this.keys);this.keys.clear();let o=e.flatMap(a=>a.split(/[\n\r]+/));Array.from(new Set(o.map(a=>a.trim().replace(/^["']|["']$/g,"")).filter(a=>a.length>5))).forEach((a,s)=>{let r=this.generateId(a),d=n.get(r)||n.get(a);this.keys.set(r,{id:r,key:a,label:d?.label||`Chave ${s+1}`,addedAt:d?.addedAt||Date.now(),lastUsedAt:d?.lastUsedAt,lastLatencyMs:d?.lastLatencyMs,cooldownUntil:d?.cooldownUntil,errorCount:d?.errorCount||0,lastError:d?.lastError,winCount:d?.winCount||0})})}generateId(e){let n=0;for(let i=0;i<e.length;i++)n=(n<<5)-n+e.charCodeAt(i),n|=0;let o=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(n).toString(36).slice(0,6)}${o}`}static maskKey(e){let n=e.trim().replace(/^["']|["']$/g,"");return n.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${n.slice(0,6)}...${n.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(n=>{let o=Math.max(0,(n.cooldownUntil||0)-e);return{...n,isCooldown:o>0,remainingCooldownMs:o}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(n=>(n.cooldownUntil||0)<=e&&(n.errorCount||0)<50)}getRoundRobinKeys(e=2){let n=Date.now(),o=Array.from(this.keys.values()).filter(a=>(a.errorCount||0)<50);if(o.length===0)return Array.from(this.keys.values()).slice(0,e);let i=o.filter(a=>(a.cooldownUntil||0)<=n);return i.length>0?(i.sort((a,s)=>{let r=a.lastLatencyMs!==void 0?a.lastLatencyMs:99999,d=s.lastLatencyMs!==void 0?s.lastLatencyMs:99999;if(r!==d)return r-d;let c=(a.lastUsedAt||0)-(s.lastUsedAt||0);return c!==0?c:a.addedAt-s.addedAt}),i.slice(0,e)):(o.sort((a,s)=>(a.cooldownUntil||0)-(s.cooldownUntil||0)),o.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(n=>n.key)}markQuotaHit(e,n=8e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+n,o.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(n/1e3)}s ativado.`)}markOverloaded(e,n=5e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+n,o.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(n/1e3)}s ativado.`)}markSuccess(e,n){let o=this.findKeyObj(e);o&&(o.lastLatencyMs=n,o.lastUsedAt=Date.now(),o.errorCount=0,o.lastError=void 0,o.cooldownUntil=void 0)}markWinner(e){let n=this.findKeyObj(e);n&&(n.winCount=(n.winCount||0)+1)}markInvalid(e,n){let o=this.findKeyObj(e);o&&(o.errorCount=99,o.lastError=n)}addKey(e,n){let o=e.trim().replace(/^["']|["']$/g,"");if(!o)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(o.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(o);if(this.keys.has(i)||Array.from(this.keys.values()).some(r=>r.key===o))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let s={id:i,key:o,label:n?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,s),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:s}}updateKey(e,n,o){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=n.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=a,o!==void 0&&(i.label=o.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let n=this.findKeyObj(e);return n?(this.keys.delete(n.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let n of this.keys.values())if(n.key===e)return n}},Y=new ne;var Ee=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],ft=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],Kt={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function Ke(t){return Kt[t]??t}function Vt(t,e){let o={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??Gt};return/lite/i.test(t)||(/gemini-3\.[0-9]+-?flash/i.test(t)?o.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(t)&&(o.thinkingConfig={thinkingBudget:0})),o}var Gt={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function gt(t){let e=t.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let n=Ke(e);return le(n)?n:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function Ue(t,e){let n="";try{let o=JSON.parse(t);n=o.error?.message||o.message||""}catch{n=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(n)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(n)||e===429?`Cota do Gemini excedida (HTTP 429): ${n||"Aguarde"}`:e===404?`HTTP 404: ${n||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(n)?`Servidores Google sobrecarregados (HTTP 503): ${n||"Aguardando"}`:n?`Erro Gemini (HTTP ${e}): ${n}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Wt(t){let e=t.trim(),n=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(n)try{return JSON.parse(n[1].trim())}catch{}try{return JSON.parse(e)}catch{}let o=e.match(/\{[\s\S]*\}/);if(o)try{return JSON.parse(o[0].trim())}catch{}try{let i=e.indexOf("{");if(i!==-1){let a=e.slice(i).trim();a=a.replace(/,\s*\{[^}]*$/,""),a=a.replace(/,\s*$/,"");let s=0,r=0,d=!1,c=!1;for(let f=0;f<a.length;f++){let l=a[f];if(c){c=!1;continue}if(l==="\\"){c=!0;continue}if(l==='"'){d=!d;continue}d||(l==="{"?s++:l==="}"?s=Math.max(0,s-1):l==="["?r++:l==="]"&&(r=Math.max(0,r-1)))}for(d&&(a+='"');r>0;)a+="]",r--;for(;s>0;)a+="}",s--;let u=JSON.parse(a);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var we=(()=>{try{let t=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!t)return null;let e=JSON.parse(t);if(Array.isArray(e)){let n=e.filter(o=>o&&typeof o.id=="string"&&le(o.id));return n.length>0?n:null}return null}catch{return null}})(),Be=new Set;async function Ve(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return Ee;let n=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of n)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let s=await i.text(),r=Ue(s,i.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let a=await i.json();if(Array.isArray(a.models)&&a.models.length>0){let s=a.models.filter(r=>{let d=r.supportedGenerationMethods||[],c=(r.name||"").replace(/^models\//,""),u=d.includes("generateContent");return le(c)&&u}).map(r=>{let d=r.supportedGenerationMethods||[],c=r.name.replace(/^models\//,""),u=r.displayName||c;return{id:c,name:u.includes(c)?u:`${u} (${c})`,description:r.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:d.includes("generateContent"),supportedGenerationMethods:d,discoveredAt:Date.now()}});if(s.length>0){s.sort((r,d)=>{let c=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return c(d.id)-c(r.id)}),we=s;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(s))}catch{}return s}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return Ee}async function ht(t,e){let n=e.map(c=>c.trim().replace(/^["']|["']$/g,"")).filter(c=>c.length>5);if(n.length===0)return{ok:!1,model:t,key:"",message:"Nenhuma chave dispon\xEDvel."};let o=Ke(gt(t)),i=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),a={"Content-Type":"application/json"};async function s(c,u,f){let l=new AbortController,p=setTimeout(()=>l.abort(),f);try{let m=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(c)}`,g=await fetch(m,{method:"POST",headers:{...a,"x-goog-api-key":c},body:i,signal:l.signal});if(clearTimeout(p),g.ok)return{ok:!0,model:u,key:c,message:`Modelo '${u}' validado com sucesso!`};let h=await g.text().catch(()=>"");throw new Error(`HTTP ${g.status}: ${h.slice(0,80)}`)}catch(m){throw clearTimeout(p),m}}if(n.length>=2){let c=n.slice(0,6);try{return await Promise.any(c.map(f=>s(f,o,8e3)))}catch{}}let r=n[0],d=[o,...ft.filter(c=>c!==o)];for(let c of d)try{let u=await s(r,c,4e3);return c!==o&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${c}'.`),u}catch{}return{ok:!1,model:o,key:r,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function Qt(t,e,n,o,i){let a=["v1beta","v1"],s=new Error(`Falha ao consultar modelo ${t}`),d={...Vt(t,i)};for(let c of a){if(o.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${c}/models/${t}:generateContent?key=${encodeURIComponent(e)}`,f=Date.now();try{let l=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...n,generationConfig:d}),signal:o});if(!l.ok){let g=await l.text();if(l.status===400){let b=/thinking/i.test(g),_=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(g);if((b||_)&&(d.thinkingConfig||d.responseSchema)){let x={...d};b&&delete x.thinkingConfig,_&&(delete x.responseSchema,delete x.responseMimeType),d=x;let v=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...n,generationConfig:d}),signal:o});if(v.ok){let D=await v.json(),z=D.candidates?.[0];if(z?.content?.parts?.[0]?.text)return Y.markSuccess(e,Date.now()-f),{rawText:z.content.parts[0].text,data:D,usedModel:t,usedKey:e}}let S=await v?.text?.().catch(()=>"")??g,I=Ue(S,l.status);throw new Error(`[${t}|${ne.maskKey(e)}] ${I}`)}}let h=Ue(g,l.status);if(l.status===404&&c==="v1beta")continue;throw l.status===429?(Y.markQuotaHit(e,8e3),bt(e,t,1e4),new Error(`[${t}|${ne.maskKey(e)}] ${h}`)):(l.status===503||/no capacity|overloaded|unavailable/i.test(g)?(Y.markOverloaded(e,5e3),Be.add(t)):l.status===403||/API_KEY_INVALID/i.test(g)?Y.markInvalid(e,h):l.status===404&&Be.add(t),new Error(`[${t}|${ne.maskKey(e)}] ${h}`))}let p=await l.json(),m=p.candidates?.[0];if(!m||!m.content?.parts?.[0]?.text)throw new Error(`[${t}|${ne.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return Y.markSuccess(e,Date.now()-f),{rawText:m.content.parts[0].text,data:p,usedModel:t,usedKey:e}}catch(l){if(o.aborted)throw l;s=l;let p=s.message||"";if(p.includes("404")||/no longer available/i.test(p)){Be.add(t);break}if(p.includes("429")||p.includes("Quota"))break}}throw s}var je=new Map;function mt(t,e){let n=`${t}::${e}`,o=je.get(n);return o===void 0?!1:Date.now()>o?(je.delete(n),!1):!0}function bt(t,e,n=1e4){je.set(`${t}::${e}`,Date.now()+n)}async function yt(t,e,n,o,i,a){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let s=Array.isArray(n.apiKeys)&&n.apiKeys.length>0?n.apiKeys:n.apiKey?[n.apiKey]:[];Y.init(s);let r=n.apiKey.trim().replace(/^["']|["']$/g,""),d=Y.getBestKey()||r;if(!d)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let c=gt(n.model);if(!we&&d&&Ve(d).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),f=Fe(t,e,n),l=[{text:f}];for(let A=0;A<e.length;A++){let w=e[A],k=w.associatedLabel||(w.alt?`Imagem: ${w.alt}`:`Imagem ${A+1}`);if(w.captureStatus==="text_only"||!w.base64){let M=w.textContext||w.alt||"";l.push({text:`[CONTEXTO_IMAGEM_${A+1} - V\xCDNCULO: ${k}]: ${M}`})}else l.push({text:`[ANEXO VISUAL ${A+1} - V\xCDNCULO: ${k}]:`}),l.push({inline_data:{mime_type:w.mediaType,data:w.base64}})}let p={system_instruction:{parts:[{text:a?.systemPromptOverride??xe}]},contents:[{role:"user",parts:l}]},m=Ke(c),g=ft.filter(A=>A!==m),b=Y.getAllKeys().length,_=A=>b<=1||A===0?1:2,x=new Set,v=(A,w)=>{let k=/pro/i.test(A),M=/lite/i.test(A);return k?w===0?18e3:w===1?24e3:3e4:M?w===0?1e4:w===1?14e3:18e3:w===0?16e3:w===1?2e4:25e3},S=async(A,w)=>{if(w.length===0||i?.aborted)return null;let k=w.map(()=>new AbortController),M=()=>k.forEach(P=>{try{P.abort()}catch{}});i?.addEventListener("abort",M,{once:!0});let N=w.map(P=>`${P.model.replace("gemini-","")}/${P.label}`).join(" | ");o?.(`\u26A1 ${A}: ${w.length} slot(s) [${N}]...`,"info");try{let P=w.map(async(q,F)=>{let V=k[F],ce=setTimeout(()=>{try{V.abort(new Error(`Timeout ${q.timeout/1e3}s (${q.model}|${q.label})`))}catch{V.abort()}},q.timeout);try{let B=await Qt(q.model,q.key,p,V.signal,a?.generationSchemaOverride);clearTimeout(ce);let Z=pt(Wt(B.rawText));return Z.usedModel=B.usedModel,Z.durationMs=Date.now()-u,Z.promptSent=f,Z.tokensUsed=B.data.usageMetadata?.totalTokenCount,Z.promptTokens=B.data.usageMetadata?.promptTokenCount,Z.candidatesTokens=B.data.usageMetadata?.candidatesTokenCount,Z.rawResponse=B.rawText,k.forEach((ot,Pt)=>{if(Pt!==F)try{ot.abort(new Error("Cancelado: vencedor respondeu."))}catch{ot.abort()}}),{plan:Z,rawUsage:B.data.usageMetadata,usedModel:B.usedModel,usedKey:B.usedKey,slotLabel:q.label}}catch(B){clearTimeout(ce);let Z=B instanceof Error?B.message:String(B);throw(Z.includes("429")||Z.includes("Quota")||Z.includes("RESOURCE_EXHAUSTED"))&&(bt(q.key,q.model,1e4),Y.markQuotaHit(q.key,8e3)),B}}),U=await Promise.any(P);return i?.removeEventListener("abort",M),Y.markWinner(U.usedKey),U}catch(P){return i?.removeEventListener("abort",M),P instanceof AggregateError&&P.errors.length>0?y=P.errors.map(U=>U instanceof Error?U.message:String(U)).join(" | "):P instanceof Error&&(y=P.message),console.warn(`[EasyQuiz ${A}] Falha na onda:`,y),null}},D=(b<=1?1:1+Math.ceil((b-1)/2))+4,z=0,y="",T=0;for(;z<D;){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let A=Y.getRoundRobinKeys(b),w=A.filter(V=>!x.has(`${V.key}::${m}`)&&!mt(V.key,m)),k,M;if(w.length>0)k=m,M=w;else{let V=g;k=V[T%V.length]||m,T++;let ce=A.filter(B=>!x.has(`${B.key}::${k}`)&&!mt(B.key,k));M=ce.length>0?ce:A.filter(B=>!x.has(`${B.key}::${k}`))}if(M.length===0){if(T<g.length)continue;break}let N=M.slice(0,_(z));if(N.length===0)break;let P=v(k,z),U=N.map(V=>(x.add(`${V.key}::${k}`),{model:k,key:V.key,label:V.label||"Chave",timeout:P})),q=z===0?"Onda 1":`Onda ${z+1}`,F=await S(q,U);if(F){let V=F.plan.durationMs||Date.now()-u,ce=ne.maskKey(F.usedKey);return o?.(`\u2705 ${V}ms via '${F.usedModel}' (${F.slotLabel}: ${ce})`,"info"),F}z++}throw new Error(y||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var me=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),pe=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,oe=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,Yt=0;function Ge(t){try{let e=t.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!fe(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(t):t.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof t.getBoundingClientRect=="function"){let e=t.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(t.textContent||"").trim().length>0}function $(t){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(t)}catch{}return String(t).replace(/["\\]/g,"\\$&")}function C(t){let e=t;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||fe(e))return!1;let n=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(n)){let o=e.type?.toLowerCase();if(o==="checkbox"||o==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${$(e.id)}"]`);if(a&&Ge(a))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Ge(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let s=e.getBoundingClientRect();if(s.width>0||s.height>0)return!0}return!0}}}catch{}}return Ge(e)}function Xt(t){if(t==null)return"";if(typeof t=="string")return t;if(typeof t=="number"||typeof t=="boolean")return String(t);if(t instanceof Node)return t.textContent||"";try{if(typeof t?.toString=="function"){let e=t.toString();if(typeof e=="string")return e}}catch{}return""}function H(t,e=500){return Xt(t).replace(/\s+/g," ").trim().slice(0,e)}function Jt(t){let e=t.dataset.easyquizId;if(e)return e;let n=`eq-${Date.now().toString(36)}-${(Yt+=1).toString(36)}`;return t.dataset.easyquizId=n,n}function fe(t){return t?!!(t.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||t.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var ye=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function R(t){if(!t||typeof t.getAttribute!="function"||typeof Element<"u"&&!(t instanceof Element))return!1;if(fe(t))return!0;let e=t.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((t.type||"").toLowerCase()))return!1;let o=t.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||t,i=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||""),a=String(o.getAttribute?.("aria-label")||""),s=String(o.getAttribute?.("title")||""),r=typeof o.className=="string"?o.className:typeof o.className?.baseVal=="string"?o.className.baseVal:"",d=H(o.textContent,60);return!!(ye.test(i)||ye.test(a)||ye.test(s)||ye.test(r)||d.length>0&&d.length<=25&&ye.test(d))}function X(t){if(!t||typeof t.getAttribute!="function"||typeof Element<"u"&&!(t instanceof Element)||fe(t)||R(t)||t.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||t.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&t instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&t instanceof HTMLButtonElement?t.value:"",n=H(t.getAttribute?.("aria-label")||t.textContent||t.getAttribute?.("value")||e),o=t.type,i=n.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),a=String(t.getAttribute?.("data-testid")||t.getAttribute?.("data-test-id")||t.getAttribute?.("id")||t.getAttribute?.("href")||"").toLowerCase();return oe.test(i)||oe.test(n)?!1:pe.test(i)||pe.test(n)||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")?!0:/^\d{1,3}$/.test(n.trim())?!!t.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function We(t){let e=t.closest("tr");if(e){let d=e.querySelector("th, td:first-child"),c=d&&d!==t.closest("td")?H(d.textContent,100):"",u=H(t.closest("label, td")?.textContent||"",50);if(c&&u)return`${c}: ${u}`}let n=t.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(n){let d=n.querySelector('.dropdown-label, [class*="label" i]'),c=d&&d!==t?H(d.textContent,150):"";if(c)return c}let o=t.getAttribute("aria-label");if(o)return H(o);let i=t.getAttribute("aria-labelledby");if(i){let d=i.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(d.trim())return H(d)}if("labels"in t&&t.labels){let d=Array.from(t.labels??[]).map(c=>c.textContent).join(" ");if(d.trim())return H(d)}let a=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==t){let d=H(a.textContent);if(d)return d}let s=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||s||"";return H(r)}function Qe(t,e){let o=typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName.toLowerCase()==="select"?t:null,i=t;t.dataset.easyquizRole=e;let a=t.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(a)?a:"other",r=t.getAttribute("role")||"",d=(t.getAttribute("data-testid")||t.getAttribute("data-test-id")||"").toLowerCase(),c=(t.className&&typeof t.className=="string"?t.className:"").toLowerCase(),u=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item")||t.classList.contains("sortable-item")||c.includes("cursor-grab")||!!t.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(d)||/drag|card-item|sortable/i.test(c),f=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category")||!!t.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(d)||/dropzone|category-box|bucket|target-zone/i.test(c),p=H((u?"draggable":f?"dropzone":"")||i.type||r||s,40),m="";if(i.type==="checkbox"||i.type==="radio"||r==="radio"||r==="checkbox"){let v=i.checked||t.getAttribute("aria-checked")==="true",S=i.value&&i.value!=="on"?i.value:t.getAttribute("data-value")||"";m=v?S?`checked:${S}`:"checked":S||"unchecked"}else if(s==="button"||a==="a"||e==="navigation"||X(t))m="";else{let v=typeof t.value=="string"||typeof t.value=="number"?t.value:"";m=H(v||t.getAttribute("data-category")||"",2e3)}let g=[];if(o&&o.options)for(let v of Array.from(o.options).slice(0,80))g.push({value:H(v.value),label:H(v.textContent)});else if(r==="combobox"||r==="listbox"||c.includes("select")||c.includes("dropdown")){let v=t.getAttribute("aria-controls")||t.getAttribute("aria-owns"),S=v?document.getElementById(v):t;if(S){let I=S.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let D of Array.from(I).slice(0,80)){let z=H(D.textContent);z&&g.push({value:D.getAttribute("data-value")||D.getAttribute("value")||z,label:z})}}}let h=!!(i.required||t.getAttribute("aria-required")==="true"),b=!!(i.disabled||t.getAttribute("aria-disabled")==="true"),_=Jt(t);return{id:t.id||_,tag:s,type:p,label:We(t),name:H(i.name||t.getAttribute("name")||"",180),value:m,options:g,required:h,disabled:b,role:e}}var _t=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function vt(t){if(!C(t))return-1/0;let e=t.getBoundingClientRect(),n=Array.from(t.querySelectorAll(me)).filter(C),o=H(t.innerText||t.textContent||"",4e3).length;if(o<10||!n.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),s=Math.min(1,a/i),r=e.top+e.height/2,d=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),c=o>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return n.length*15+Math.min(60,o/20)+c+u-s*20-d*10}function Se(t){let e=t;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let n=e.parentElement,o=n.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(n.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&o!=="main"&&o!=="body"){e=n;break}let i=H(e.innerText||e.textContent||"",1e4),a=H(n.innerText||n.textContent||"",1e4),s=e.querySelectorAll(me).length,r=n.querySelectorAll(me).length;if(i.length<150&&a.length>i.length&&r<=s+4&&o!=="main"&&o!=="body"){e=n;continue}break}return e}function xt(t){let e=t,n=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(n&&n!==document.body&&C(n))return n;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function J(){let t=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(t&&C(t))return t;let e=document.activeElement;if(e&&e!==document.body){let s=e.closest(_t);if(s&&vt(s)>0)return Se(s)}let o=Array.from(document.querySelectorAll(_t)).map(s=>({element:s,score:vt(s)})).filter(s=>Number.isFinite(s.score)).sort((s,r)=>r.score-s.score),i=o.find(s=>{let r=s.element.tagName.toLowerCase();return r!=="main"&&r!=="body"&&s.score>0});if(i)return Se(i.element);if(o.length>0&&o[0].score>0)return Se(o[0].element);let a=document.querySelector('form, main, [role="main"]');return a&&C(a)?a:document.body}function Et(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let n=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))n.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Te(t){let e=Array.from(t.querySelectorAll(me)),n=new Set,o=[];for(let c of e){if(!C(c)||X(c)||R(c))continue;let u=(c.value||c.textContent||"").trim();if(oe.test(u))continue;let f=c.tagName.toLowerCase();["input","textarea","select"].includes(f)&&(n.add(c),o.push(c))}for(let c of e){if(!C(c)||X(c)||R(c))continue;let u=(c.value||c.textContent||"").trim();if(oe.test(u))continue;let f=c.tagName.toLowerCase();if(["input","textarea","select"].includes(f))continue;let l=c.querySelector("input, textarea, select");if(!(l&&n.has(l))){if(c.hasAttribute("for")){let p=c.getAttribute("for"),m=p?c.ownerDocument.getElementById(p):null;if(m&&n.has(m))continue}if(f==="a"){let p=c.getAttribute("role"),m=c.getAttribute("class")||"",g=c.getAttribute("data-testid")||"",h=c.getAttribute("draggable")==="true"||c.classList.contains("perseus-drag-item")||c.classList.contains("sortable-item")||m.includes("cursor-grab")||!!c.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(g)||/drag|card-item|sortable/i.test(m);if(!(p==="button"||p==="radio"||p==="checkbox"||p==="option"||h||c.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}o.push(c)}}let i=o.length>0&&o.every(c=>R(c)||/read-?aloud|audio/i.test(c.getAttribute("data-testid")||c.getAttribute("aria-label")||"")),a=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||t,s=document.body.querySelector('[class*="classification" i]')!==null||t.querySelector('[class*="classification" i]')!==null||t.querySelector('[data-cy*="quiz" i]')!==null||t.querySelector('[class*="draggable-item" i]')!==null||t.querySelector('[class*="drag-item" i]')!==null||t.querySelector('[class*="sortable-card" i]')!==null||t.matches?.('[class*="classification" i]');if((o.length===0||i)&&s){i&&(o.length=0);let c=Array.from(a.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(c.length>0){for(let u of c)if(!(!C(u)||R(u))&&(o.push(u),o.length>=50))break}else{let u=Array.from(a.querySelectorAll("button, div[class], span[class], p, li"));for(let f of u){if(!C(f)||X(f)||R(f)||oe.test((f.textContent||"").trim()))continue;let l=(f.textContent||"").trim();if(l.length<2||l.length>300)continue;if(Array.from(f.children).some(m=>m.className&&m.textContent?.trim())||o.push(f),o.length>=50)break}}}let d=!o.some(c=>["input","select","textarea"].includes(c.tagName.toLowerCase()))&&o.length>0&&o.every(c=>{let u=c.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let f=(c.textContent||"").trim();return!c.id||f.length<10||/^\d+\s*\/\s*\d+$/.test(f)||/^question text/i.test(f)});if(o.length===0||d){d&&(o.length=0);let c=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(c.length>0)for(let u of c){if(!C(u)||fe(u)||X(u)||R(u)||oe.test((u.textContent||"").trim()))continue;let f=(u.textContent||"").trim();if(!(f.length<10||f.length>500)&&!/^\d+\s*\/\s*\d+$/.test(f)&&(o.push(u),o.length>=20))break}}return o.slice(0,100).map(c=>Qe(c,"answer"))}function Ye(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),n=new Set,o=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(me)))if(!(n.has(a)||!C(a)||!X(a)||R(a))&&(n.add(a),o.push(Qe(a,"navigation")),o.length>=10))return o;return o}function Ae(t=!1){let e=J();e=Se(e),t&&(e=xt(e));let n=Te(e),o=Ye(e);if(n.length===0){let r=Te(document.body);r.length>0&&(e=xt(e),n=Te(e),n.length===0&&(n=r,e=document.querySelector('main, article, form, [role="main"]')||document.body))}o.length===0&&(o=Ye(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=i.length>4e4?H(i.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+H(i.slice(-2e3),2e3):H(i,16e3),s=[...n,...o].slice(0,120);return!a||s.length===0&&a.length<30?H(document.body.innerText||document.body.textContent||"",16e3).length>=30?_e():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:Et(e),controls:s,scope:e}}function _e(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=H(t,16e3),n=Te(document.body),o=Ye(document.body),i=[...n,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Et(a).slice(0,15e3),controls:i,scope:a}}function wt(t){let e=t.controls.map(n=>`${n.role}:${n.id}:${n.type}`).join("|");return[window.location.href,t.pageTitle,t.questionText.slice(0,400),e].join("::")}var Xe=10,Zt=1400,ve=15e5;function re(t){return new Promise((e,n)=>{let o=new FileReader;o.onerror=()=>n(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function de(t){let e=0,n=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,n=t.naturalHeight||t.height):(e=t.width,n=t.height),e<=0||n<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Zt/Math.max(e,n)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(n*o)),s=document.createElement("canvas");s.width=i,s.height=a;let r=s.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,a),r.drawImage(t,0,0,i,a),new Promise((d,c)=>{s.toBlob(u=>u?d(u):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Tt(t){let e=typeof t.getBoundingClientRect=="function"?t.getBoundingClientRect():{width:0,height:0},n=e.width||parseFloat(t.getAttribute("width")||"0")||parseFloat(t.style.width||"0")||400,o=e.height||parseFloat(t.getAttribute("height")||"0")||parseFloat(t.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(n*i))),s=Math.min(1800,Math.max(100,Math.round(o*i))),r=t.cloneNode(!0);r.getAttribute("xmlns")||r.setAttribute("xmlns","http://www.w3.org/2000/svg"),r.getAttribute("xmlns:xlink")||r.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),r.setAttribute("width",String(a)),r.setAttribute("height",String(s)),!r.getAttribute("viewBox")&&n>0&&o>0&&r.setAttribute("viewBox",`0 0 ${n} ${o}`);try{let l=Array.from(t.querySelectorAll("*")),p=Array.from(r.querySelectorAll("*"));for(let m=0;m<Math.min(l.length,p.length);m++){let g=l[m],h=p[m];if(!g||!h||!h.style)continue;let b=window.getComputedStyle?window.getComputedStyle(g):null;b&&(b.fill&&b.fill!=="none"&&(h.style.fill=b.fill),b.stroke&&b.stroke!=="none"&&(h.style.stroke=b.stroke),b.strokeWidth&&(h.style.strokeWidth=b.strokeWidth),b.fontFamily&&(h.style.fontFamily=b.fontFamily),b.fontSize&&(h.style.fontSize=b.fontSize),b.fontWeight&&(h.style.fontWeight=b.fontWeight),b.color&&(h.style.color=b.color))}}catch{}let d="#ffffff";try{let l=t.parentElement||t;for(;l&&l!==document.documentElement;){let m=(window.getComputedStyle?window.getComputedStyle(l):null)?.backgroundColor;if(m&&m!=="transparent"&&m!=="rgba(0, 0, 0, 0)"){d=m;break}l=l.parentElement}}catch{}let u=new XMLSerializer().serializeToString(r),f="";try{f=btoa(unescape(encodeURIComponent(u)))}catch{}try{let l=h=>new Promise((b,_)=>{let x=new Image,v=setTimeout(()=>_(new Error("Timeout render SVG")),1200);x.onload=()=>{clearTimeout(v),b(x)},x.onerror=()=>{clearTimeout(v),_(new Error("Falha ao renderizar SVG em Image."))},x.src=h}),p=null;if(f)try{p=await l(`data:image/svg+xml;base64,${f}`)}catch{}if(!p){let h=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),b=URL.createObjectURL(h);try{p=await l(b)}finally{URL.revokeObjectURL(b)}}let m=document.createElement("canvas");m.width=a,m.height=s;let g=m.getContext("2d",{alpha:!1});if(g&&p){g.fillStyle=d,g.fillRect(0,0,a,s),g.drawImage(p,0,0,a,s);let h=await new Promise(b=>{m.toBlob(b,"image/jpeg",.92)});if(h){let b=await re(h);if(b)return{blob:h,base64:b,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function Je(t){try{let e=t.getBoundingClientRect(),n=Math.round(e.width)||t.offsetWidth||400,o=Math.round(e.height)||t.offsetHeight||300;if(n<30||o<30)return null;let i=t.tagName.toLowerCase()==="svg"?t:t.querySelector("svg");if(i&&t.querySelectorAll("input, select, textarea").length===0)try{let g=await Tt(i);if(g.base64&&g.base64.length<=ve)return{mediaType:g.mediaType,base64:g.base64,alt:t.getAttribute("aria-label")||i.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:se(i)}}catch{}if(t instanceof HTMLCanvasElement)try{let g=await de(t),h=await re(g);if(h)return{mediaType:"image/jpeg",base64:h,alt:t.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let g=t;for(;g&&g!==document.documentElement;){let b=(window.getComputedStyle?window.getComputedStyle(g):null)?.backgroundColor;if(b&&b!=="transparent"&&b!=="rgba(0, 0, 0, 0)"){a=b;break}g=g.parentElement}}catch{}let s=t.cloneNode(!0),r=Array.from(t.querySelectorAll("*")),d=Array.from(s.querySelectorAll("*"));for(let g=0;g<Math.min(r.length,d.length);g++){let h=r[g],b=d[g];if(!(!h||!b||!b.style))try{let _=window.getComputedStyle(h);b.style.color=_.color,b.style.backgroundColor=_.backgroundColor,b.style.borderColor=_.borderColor,b.style.borderWidth=_.borderWidth,b.style.borderStyle=_.borderStyle,b.style.fontSize=_.fontSize,b.style.fontFamily=_.fontFamily,b.style.fontWeight=_.fontWeight,b.style.lineHeight=_.lineHeight,b.style.letterSpacing=_.letterSpacing,b.style.textAlign=_.textAlign}catch{}}let c=Math.min(2,Math.max(1,1200/Math.max(n,o))),u=Math.round(n*c),f=Math.round(o*c),l=`
    ...
    `,p=new Blob([l],{type:"image/svg+xml;charset=utf-8"}),m=URL.createObjectURL(p);try{let g=new Image;await new Promise((_,x)=>{let v=setTimeout(()=>x(new Error("Timeout render ForeignObject")),2500);g.onload=()=>{clearTimeout(v),_()},g.onerror=()=>{clearTimeout(v),x(new Error("Falha ao carregar ForeignObject"))},g.src=m});let h=document.createElement("canvas");h.width=u,h.height=f;let b=h.getContext("2d",{alpha:!1});if(b){b.fillStyle=a,b.fillRect(0,0,u,f),b.drawImage(g,0,0,u,f);let _=await new Promise(x=>h.toBlob(x,"image/jpeg",.9));if(_){let x=await re(_);if(x&&x.length<=ve)return{mediaType:"image/jpeg",base64:x,alt:t.getAttribute("aria-label")||"Captura visual da \xE1rea (print-like)",source:"element_snapshot",captureStatus:"captured",textContext:se(t)}}}}finally{URL.revokeObjectURL(m)}}catch(e){console.warn("[EasyQuiz] Snapshot visual do n\xF3:",e)}return null}function St(t,e,n,o){if(n<=0||o<=0){let l=typeof t.getBoundingClientRect=="function"?t.getBoundingClientRect():{width:0,height:0};if(n=l.width||n,o=l.height||o,n<=0||o<=0){if(e&&/\b(icon|logo|avatar|badge|emoji|spinner|loading)\b/i.test(e))return!1;let m=t instanceof HTMLImageElement&&t.src||"";return m&&/\/icons?\/|\/logos?\/|\/avatars?\/|\/badges?\//i.test(m)?!1:!!(m||e)}}if(n<48||o<48||Math.max(n,o)/Math.max(1,Math.min(n,o))>15)return!1;let a=t.getAttribute("class")||"",s=t.getAttribute("aria-hidden"),r=t.getAttribute("role"),d=t instanceof HTMLImageElement&&t.src||"";if(s==="true"||r==="presentation"||r==="none")return!1;let c=/\b(icon|logo|avatar|badge|emoji|decoration|ornament|spinner|loading|thumbnail|profile|photo)\b/i;if(c.test(a)||e&&c.test(e)||d&&/\/icons?\/|\/logos?\/|\/avatars?\/|\/badges?\/|\/emojis?\//i.test(d)||e===""||e===" "||e==="-")return!1;let u=/\b(graph|chart|diagram|table|map|formula|equation|figure|plot|curve|histogram|scatter|matrix|image|foto|imagem|gráfico|tabela|mapa|fórmula|questão|enunciado|stimulus)\b/i;return u.test(e)||u.test(a)||t.closest('[data-question], [class*="question" i], [class*="prompt" i], [class*="stimulus" i], [class*="enunciado" i], [class*="statement" i], article, .problem, .exercise')?!0:n>=80&&o>=80}function se(t){let e=[],n=t.getAttribute("alt")||t.getAttribute("aria-label")||t.getAttribute("title")||"";n&&n.length>2&&e.push(`Alt: "${n}"`);let a=t.closest("figure")?.querySelector("figcaption")?.textContent?.trim();a&&a.length>2&&e.push(`Legenda: "${a}"`);let s=t.getAttribute("aria-describedby");if(s){let u=document.getElementById(s)?.textContent?.trim();u&&e.push(`Descri\xE7\xE3o: "${u.slice(0,200)}"`)}let r=t.parentElement;if(r){let c=H(r.textContent||"",300);c&&c.length>5&&c!==n&&e.push(`Contexto: "${c.slice(0,200)}"`)}if(t.tagName.toLowerCase()==="svg"){let c=Array.from(t.querySelectorAll("text, tspan")).map(u=>u.textContent?.trim()).filter(Boolean);c.length>0&&e.push(`R\xF3tulos/Textos do Gr\xE1fico: "${c.join(" | ")}"`)}let d=t.getAttribute("data-alt")||t.getAttribute("data-description")||"";return d&&e.push(`Data: "${d}"`),e.length===0?"":e.join(" | ")}async function en(t){let e=t.currentSrc||t.src;if(!e)return null;let n=(t.alt||t.getAttribute("aria-label")||"Imagem da quest\xE3o").slice(0,500);if(t.complete&&t.naturalWidth>0)try{let s=await de(t),r=await re(s);if(r&&r.length<=ve)return{mediaType:"image/jpeg",base64:r,alt:n,source:e.slice(0,2e3),captureStatus:"captured",textContext:se(t)}}catch{}try{let s=await fetch(e,{mode:"cors"});if(s.ok){let r=await s.blob();if(r.type.startsWith("image/")){let d=await createImageBitmap(r),c=await de(d);d.close();let u=await re(c);if(u&&u.length<=ve)return{mediaType:"image/jpeg",base64:u,alt:n,source:e.slice(0,2e3),captureStatus:"captured",textContext:se(t)}}}}catch{}if(e.startsWith("http")){let s=[`https://corsproxy.io/?${encodeURIComponent(e)}`,`https://api.allorigins.win/raw?url=${encodeURIComponent(e)}`],r=async d=>{let c=new AbortController,u=setTimeout(()=>c.abort(),1500);try{let f=await fetch(d,{signal:c.signal});if(clearTimeout(u),f.ok)return f;throw new Error("Proxy status "+f.status)}catch(f){throw clearTimeout(u),f}};try{let c=await(await Promise.any(s.map(r))).blob();if(c.type.startsWith("image/")||c.size>200){let u=await createImageBitmap(c),f=await de(u);u.close();let l=await re(f);if(l&&l.length<=ve)return{mediaType:"image/jpeg",base64:l,alt:n,source:e.slice(0,2e3),captureStatus:"captured",textContext:se(t)}}}catch{}}let o=t.parentElement||t,i=await Je(o);if(i)return i;let a=se(t);return a||n?{mediaType:"image/jpeg",base64:"",alt:n,source:e.slice(0,2e3),captureStatus:"text_only",textContext:a||`Imagem da quest\xE3o (src: ${e.slice(0,100)})`}:null}function tn(t){return t.querySelectorAll("path, line, polyline, polygon, circle, rect, text, image").length>0}function nn(t){try{let e=t.style.backgroundImage||(window.getComputedStyle?window.getComputedStyle(t).backgroundImage:"");if(e&&e.includes("url(")){let n=e.match(/url\(["']?([^"')]+)["']?\)/);if(n&&n[1]&&!n[1].startsWith("data:image/svg+xml"))return n[1]}}catch{}return null}function on(t,e){let n=t.closest('[data-easyquiz-id], button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], label, .option-card, .quiz-option, .choice, .answer, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr');if(n&&n!==e&&C(n)&&!X(n)&&!R(n)){let a=n.dataset.easyquizId||n.id||void 0,s=H(n.innerText||n.textContent||"",120),r=n.getAttribute("aria-label")||n.getAttribute("title")||"",d=s||r,c=a?` [id: ${a}]`:"";if(d)return{associatedLabel:`Alternativa/Op\xE7\xE3o: "${d}"${c}`,targetControlId:a};if(a)return{associatedLabel:`Alternativa/Op\xE7\xE3o ${c}`,targetControlId:a}}let o=t.closest("figure")?.querySelector("figcaption")?.textContent?.trim();if(o)return{associatedLabel:`Figura do Enunciado: "${H(o,100)}"`};let i=t.closest('[class*="prompt" i], [class*="stimulus" i], [class*="question-text" i], [class*="statement" i], header, h1, h2, h3, h4, p');if(i){let a=H(i.textContent||"",80);if(a)return{associatedLabel:`Gr\xE1fico do Enunciado: "${a}"`}}return{associatedLabel:"Gr\xE1fico/Imagem do Enunciado Principal"}}async function At(t,e=!0){if(!e)return[];let n=[],o=0,i=35e5,a=(u,f)=>{if(!u)return!1;let l=u.base64?u.base64.length:0;if(l>0&&o+l>i)return!1;let p=on(f,t);return u.associatedLabel=p.associatedLabel,u.targetControlId=p.targetControlId,u.element=f,n.push(u),o+=l,n.filter(g=>g.captureStatus==="captured").length>=Xe},s=[t],r=t.closest('article, .card, [class*="question" i], [class*="exercise" i], form, [data-test-id*="exercise" i], [data-testid*="exercise" i]');r&&r!==t&&r!==document.body&&C(r)&&s.push(r);let d=new Set;for(let u of s){let f=Array.from(u.querySelectorAll("img")).filter(l=>C(l)&&!R(l)&&!d.has(l));for(let l of f){d.add(l);try{let p=l.getBoundingClientRect(),m=l.naturalWidth||p.width||l.width||0,g=l.naturalHeight||p.height||l.height||0,h=l.alt||"";if(!St(l,h,m,g))continue;let b=await en(l);if(a(b,l))return n}catch{}}}let c=new Set;for(let u of s){let f=Array.from(u.querySelectorAll("svg")).filter(l=>{if(!C(l)||R(l)||c.has(l))return!1;let p=typeof l.getBoundingClientRect=="function"?l.getBoundingClientRect():{width:0,height:0},m=p.width||parseFloat(l.getAttribute("width")||"0"),g=p.height||parseFloat(l.getAttribute("height")||"0");return m<30||g<30?!1:tn(l)});for(let l of f){c.add(l);try{let p=await Tt(l);if(p.base64){let m=se(l),g={mediaType:p.mediaType,base64:p.base64,alt:l.getAttribute("aria-label")||"Gr\xE1fico/Diagrama vetorial da quest\xE3o",source:"svg",captureStatus:"captured",textContext:m};if(a(g,l))return n}}catch{let p=l.closest('.trig-diagram-container, [class*="diagram" i], [class*="graph" i], figure')||l.parentElement||l,m=await Je(p);if(m){if(a(m,l))return n}else{let g=se(l);if(g){let h={mediaType:"image/jpeg",base64:"",alt:l.getAttribute("aria-label")||"Gr\xE1fico vetorial",source:"svg",captureStatus:"text_only",textContext:g};a(h,l)}}}}}if(n.filter(u=>u.captureStatus==="captured").length<Xe){let u=Array.from(t.querySelectorAll("canvas")).filter(f=>C(f)&&!R(f));for(let f of u)try{let l=await de(f),p=await re(l);if(p){let m={mediaType:"image/jpeg",base64:p,alt:f.getAttribute("aria-label")||"Gr\xE1fico Canvas inline",source:"canvas",captureStatus:"captured"};if(a(m,f))return n}}catch{let l=await Je(f.parentElement||f);if(a(l,f))return n}}if(n.filter(u=>u.captureStatus==="captured").length<Xe){let u=Array.from(t.querySelectorAll('[style*="background-image"], .option-image, .question-media')).filter(f=>C(f)&&!R(f));for(let f of u){let l=nn(f);if(!l)continue;let p=f.getBoundingClientRect();if(St(f,f.getAttribute("aria-label")||"",p.width,p.height))try{let m=await fetch(l,{mode:"cors"});if(m.ok){let g=await m.blob();if(g.type.startsWith("image/")){let h=await createImageBitmap(g),b=await de(h);h.close();let _=await re(b);if(_){let x={mediaType:"image/jpeg",base64:_,alt:"Imagem de fundo da alternativa",source:l.slice(0,2e3),captureStatus:"captured"};if(a(x,f))return n}}}}catch{try{let g=await(await fetch(l,{mode:"no-cors"})).blob();if(g.size>100){let h=await createImageBitmap(g),b=await de(h);h.close();let _=await re(b);if(_&&_.length>100){let x={mediaType:"image/jpeg",base64:_,alt:"Imagem CSS background",source:l.slice(0,2e3),captureStatus:"captured"};if(a(x,f))return n}}}catch{}}}}return n}var an=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Ze(t){let e=t?.engine||"smart",n=new Set(["dom","framework","keyboard","drag"]);return t?.autoAdvance&&n.add("navigation"),e==="javascript"&&n.add("javascript"),{engine:e,capabilities:n,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!t?.autoAdvance}}function et(t,e){if(t.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(t.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ct(t){if(!t.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(t.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(an.find(n=>n.test(t)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(t)&&!t.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}function O(t){return t?!!(t.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||t.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function E(t){return t==null?"":(typeof t=="string"?t:String(t)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function j(t){if(!t||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t.getAttribute("draggable")==="true"||t.classList.contains("dnd-card")||t.hasAttribute("data-category")||t.hasAttribute("data-dropzone"))return t;if(t.hasAttribute("for")){let o=t.getAttribute("for");if(o){let i=t.ownerDocument.getElementById(o);if(i)return i}}let e=t.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let o=e.getAttribute("for"),a=(o?e.ownerDocument.getElementById(o):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let n=t.closest('button, a, [role="button"], [draggable="true"]');if(n)return n;if(["body","html","main","section","article","form"].includes(t.tagName.toLowerCase())){let o=t.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(o)return j(o)}return t}function kt(t){let e=t;if(!e||!document.contains(e))try{e=J()}catch{}e=e||document.body;let n=i=>{let a=Array.from(i.querySelectorAll("tr")).filter(u=>C(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let s=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>C(u)&&!O(u));if(s.length>0)return s;let d=Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>C(u)&&!O(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return d.length>0?d:Array.from(i.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let f=u;return C(f)&&!O(f)&&(f.textContent||"").trim().length>2&&!X(f)&&!R(f)&&!f.querySelector("[class]")})},o=n(e);return o.length>0?o:e!==document.body?n(document.body):[]}function L(t,e,n=!1){if(t==null)return null;let i=(typeof t=="string"?t:String(t)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=$(i),s=document.querySelector(`[data-easyquiz-id="${a}"]`);if(s&&!O(s))return j(s);try{let l=document.getElementById(i);if(l&&C(l)&&!O(l))return l.hasAttribute("data-category")||l.hasAttribute("data-dropzone")||l.classList.contains("dnd-zone")?l:j(l)}catch{}try{let l=document.querySelector(`[data-item-id="${a}"]`);if(l&&C(l)&&!O(l))return j(l)}catch{}let r=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(r){let l=parseInt(r[1],10);if(n){let m=document.body;try{m=J()||document.body}catch{}let g=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(h=>C(h)&&!O(h));if(l>=1&&l-1<g.length)return g[l-1];if(l===0&&g.length>0)return g[0]}let p=l-1;if(p>=0){let m=kt();if(p<m.length){let b=m[p];if(b.tagName.toLowerCase()==="tr"){if(e){let x=b.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(x)return x}let _=b.querySelector("input");if(_)return _}return j(b)}let g=document.body;try{g=J()||document.body}catch{}let h=Array.from(g.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>C(b)&&!O(b));if(p<h.length)return h[p]}}let d=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(d){let l=d[1].toUpperCase().charCodeAt(0)-65;if(l>=0){let p=kt();if(l<p.length){let m=p[l];if(m.tagName.toLowerCase()==="tr"){if(e){let h=m.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(h)return h}let g=m.querySelector("input");if(g)return g}return j(m)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let p=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(b=>C(b)&&!O(b));if(p)return p;let g=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(b=>C(b)&&!O(b));if(g)return j(g);let h=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(b=>{if(!C(b)||O(b))return!1;let _=E(b.textContent).toLowerCase();return _===i.toLowerCase()||_===i.toLowerCase()+")"});if(h)return j(h)}try{let l=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let m=l.find(g=>{if(!C(g)||O(g))return!1;if(g instanceof HTMLInputElement&&g.value.toLowerCase()===e.toLowerCase())return!0;let h=g.closest("label, .vf-label, td, div");return h&&E(h.textContent).toLowerCase().includes(E(e).toLowerCase())});if(m)return j(m)}let p=l.find(m=>C(m)&&!O(m));if(p)return p.hasAttribute("data-category")||p.hasAttribute("data-dropzone")||p.classList.contains("dnd-zone")?p:j(p)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let p=Array.from(document.querySelectorAll(i)).find(m=>C(m)&&!O(m));if(p)return j(p)}catch{}try{let l=i.replace(/"/g,""),p=`//button[normalize-space(.)="${l}"] | //a[normalize-space(.)="${l}"] | //*[not(*) and normalize-space(.)="${l}"] | //*[@aria-label="${l}"] | //*[@data-category="${l}"] | //*[@data-testid="${l}"]`,m=document.evaluate(p,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let g=0;g<m.snapshotLength;g++){let h=m.snapshotItem(g);if(h&&C(h)&&!O(h)){if(["body","html"].includes(h.tagName.toLowerCase())){let _=h.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(_&&C(_))return j(_)}return h.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||j(h)}}}catch{}let u=E(i).toLowerCase(),f=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let l of f){if(!C(l)||O(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||R(l)||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let m=E(l.textContent).toLowerCase(),g=E(l.getAttribute("aria-label")||"").toLowerCase(),h=E(l.getAttribute("placeholder")||"").toLowerCase(),b=E(l.getAttribute("title")||"").toLowerCase(),_=E(l.getAttribute("name")||"").toLowerCase(),x=E(l.getAttribute("data-category")||"").toLowerCase(),v=l instanceof HTMLInputElement||l instanceof HTMLButtonElement?l.value:"",S=E(v).toLowerCase(),I=m.startsWith(u+")")||m.startsWith(u+".")||m.startsWith(u+" -")||m.startsWith(u+":");if(m===u||g===u||h===u||b===u||_===u||x&&x===u||S&&S===u||I)return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||j(l)}if(u.length>=3)for(let l of f){if(!C(l)||O(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||R(l)||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let m=E(l.textContent).toLowerCase(),g=E(l.getAttribute("aria-label")||"").toLowerCase(),h=E(l.getAttribute("placeholder")||"").toLowerCase(),b=E(l.getAttribute("title")||"").toLowerCase(),_=E(l.getAttribute("name")||"").toLowerCase();if(m.includes(u)||g.includes(u)||h.includes(u)||b.includes(u)||_.includes(u)){if(Array.from(l.children).some(I=>{let D=E(I.textContent).toLowerCase();return D&&D.includes(u)}))continue;return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||j(l)}let x=u.split(/\s+/).filter(Boolean);if(x.length>=3){let v=x.slice(0,Math.min(5,x.length)).join(" ");if(m.includes(v)||g.includes(v)||h.includes(v))return j(l)}}return null}function Lt(t,e){for(let n of e)t.dispatchEvent(new Event(n,{bubbles:!0,composed:!0}))}function K(t,e){if(!t)return;try{t.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{t.focus?.()}catch{}let n=t.getBoundingClientRect(),o=e?e[0]:Math.round(n.left+Math.max(1,n.width/2)),i=e?e[1]:Math.round(n.top+Math.max(1,n.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:o,clientY:i};try{t.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{t.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{t.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{t.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{t.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}if(typeof t.click=="function")try{t.click()}catch{try{t.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{t.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let s=Object.keys(t).find(r=>r.startsWith("__reactFiber")||r.startsWith("__reactInternalInstance"));if(s){let r=t[s];for(;r;){let d=r.memoizedProps||r.pendingProps;if(d?.onClick){d.onClick({type:"click",target:t,currentTarget:t,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}r=r.return}}}catch{}try{let s=Object.keys(t).find(r=>r.startsWith("__reactProps"));if(s){let r=t[s];r?.onClick&&r.onClick({type:"click",target:t,currentTarget:t,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let s=t._vei;s?.onClick&&(Array.isArray(s.onClick.value)?s.onClick.value:[s.onClick.value]).forEach(d=>{try{d({type:"click",target:t})}catch{}})}catch{}try{t.$onclick&&t.$onclick({type:"click",target:t,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||t.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let r=t.querySelector('input[type="radio"], input[type="checkbox"]');r&&(r.focus?.(),r.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(r,!0),r.dispatchEvent(new Event("change",{bubbles:!0})));let d=t.closest("[jsaction]");if(d&&d!==t)try{d.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:o,clientY:i}))}catch{}}}catch{}if(t.getAttribute("role")==="button"||t.getAttribute("tabindex")!==null)try{t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function Me(t){try{let e=t.id,n=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,t.id=e);let o=document.createElement("script");return o.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(o),o.remove(),n||setTimeout(()=>{try{t.id===e&&t.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function Ce(t,e){let n=t;if(n.hasAttribute("for")){let c=n.getAttribute("for"),u=n.ownerDocument.getElementById(c);u&&(n=u)}if(typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox"||n.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){ke(n,[e]);return}let i=n.querySelector('select, [role="combobox"], [role="listbox"]');if(i){ke(i,[e]);return}if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLTextAreaElement)&&!(n instanceof HTMLSelectElement)&&!n.isContentEditable){let c=n.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)n=c;else{let f=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(f)n=f;else{let l=n.nextElementSibling;for(;l;){if(l instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(l.type)||l instanceof HTMLTextAreaElement||l instanceof HTMLElement&&l.isContentEditable){n=l;break}let p=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){n=p;break}l=l.nextElementSibling}}}}if(n instanceof HTMLButtonElement||n.tagName.toLowerCase()==="a"||n.getAttribute("role")==="button"||n instanceof HTMLInputElement&&["button","submit","reset","image"].includes(n.type)){let c=n.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)n=c;else{let u=document.body;try{u=J()||document.body}catch{}let f=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f)n=f;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLTextAreaElement)&&!(n instanceof HTMLSelectElement)&&!n.isContentEditable){let c=document.body;try{c=J()||document.body}catch{}let u=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)n=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===n.value;ae(n,c);return}let s=String(e??""),r=s;if(n instanceof HTMLInputElement&&n.type==="number"){let c=s.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(r=c)}try{n.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),n.focus?.()}catch{}try{if(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement){let c=n instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(c,"value")?.set;u?u.call(n,""):n.value="";try{n.select?.()}catch{}}else if(n.isContentEditable){n.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let d=!1;try{n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement?n.type!=="number"&&n.type!=="range"&&(d=document.execCommand?.("insertText",!1,r)||!1):n.isContentEditable&&(d=document.execCommand?.("insertText",!1,r)||!1)}catch{}if(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement){try{let f=n._valueTracker;f&&f.setValue(r===""?" ":"")}catch{}let c=n instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(c,"value")?.set;u?u.call(n,r):n.value=r;try{n.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:r.slice(-1)||"a"}))}catch{}try{n.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:r,inputType:"insertText"}))}catch{}try{n.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:r,inputType:"insertText"}))}catch{n.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{n.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:r.slice(-1)||"a"}))}catch{}try{n.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{n.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(n.value!==r&&!(n instanceof HTMLInputElement&&n.type==="number"&&Number(n.value)===Number(r))){n.value=r;try{u?.call(n,r)}catch{}}return}if(n.isContentEditable){if(n.textContent?.trim()!==r.trim()){n.textContent=r;try{n.innerText=r}catch{}}try{n.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:r,inputType:"insertText"}))}catch{n.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{n.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{n.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in n&&(n.value=r),n.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),n.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function ae(t,e){if(!t)return;let n=t.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||t,o=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:n.querySelector('input[type="checkbox"], input[type="radio"]');!o&&n.hasAttribute("for")&&(o=n.ownerDocument.getElementById(n.getAttribute("for")));let i=t instanceof HTMLInputElement?t.closest("label")||(t.id?n.ownerDocument.getElementById(n.getAttribute("for")):null)||t:n&&C(n)?n:t;if(o){let a=o.type==="radio",s=o.type==="checkbox",r=!!o._valueTracker;if(o.checked===e){if(a&&e){n.setAttribute("aria-checked","true"),n.setAttribute("aria-selected","true"),n.classList.add("selected","active","checked");return}if(s){n.setAttribute("aria-checked",e?"true":"false"),n.setAttribute("aria-selected",e?"true":"false"),n.classList.toggle("selected",e),n.classList.toggle("active",e),n.classList.toggle("checked",e);return}}i&&i!==o&&K(i);try{o.focus?.(),o.click()}catch{}if(o.checked!==e){try{let c=o._valueTracker;c&&c.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,Lt(o,["input","change"])}n.setAttribute("aria-checked",e?"true":"false"),n.setAttribute("aria-selected",e?"true":"false"),n.classList.toggle("selected",e),n.classList.toggle("active",e),n.classList.toggle("checked",e)}else{if((n.getAttribute("aria-checked")==="true"||n.getAttribute("aria-selected")==="true"||n.getAttribute("data-selected")==="true"||n.getAttribute("data-checked")==="true"||n.classList.contains("selected")||n.classList.contains("active")||n.classList.contains("checked"))===e&&e)return;K(i),n.setAttribute("aria-checked",e?"true":"false"),n.setAttribute("aria-selected",e?"true":"false"),n.classList.toggle("selected",e),n.classList.toggle("active",e),n.classList.toggle("checked",e)}}function ke(t,e){let n=typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"?t:t.querySelector("select");if(n){let s=e.map(c=>E(c).toLowerCase()),r=!1,d=(c,u)=>{c.selected=!0,n.selectedIndex=u;try{n.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(n,c.value)}catch{}try{let f=n._valueTracker;f&&f.setValue(c.value)}catch{}r=!0};for(let c=0;c<n.options.length;c++){let u=n.options[c],f=u.value.toLowerCase(),l=E(u.textContent).toLowerCase();if(s.some(m=>m===f||m===l)){if(d(u,c),!n.multiple)break}else n.multiple||(u.selected=!1)}if(!r)for(let c of s){let u=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let f=parseInt(u[1],10),p=n.options[0]?.value===""||n.options[0]?.disabled?f:f>=1?f-1:0;if(p>=0&&p<n.options.length&&(d(n.options[p],p),!n.multiple))break}}if(!r){for(let c of s)if(/^[a-z]$/i.test(c)){let u=c.toUpperCase().charCodeAt(0)-65,l=n.options[0]?.value===""||n.options[0]?.disabled?u+1:u;if(l>=0&&l<n.options.length&&(d(n.options[l],l),!n.multiple))break}}if(!r){let c=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<n.options.length;u++){let f=n.options[u],l=c(f.value.toLowerCase()),p=c(E(f.textContent).toLowerCase());if(s.some(g=>{let h=c(g);return l.includes(h)||p.includes(h)||h.length>2&&(h.includes(l)||h.includes(p))})&&(d(f,u),!n.multiple))break}}if(r){Lt(n,["focus","input","change","blur"]);return}}let o=t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?t:t.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');o&&K(o);let i=e.map(s=>E(s).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(s=>C(s)&&!O(s));for(let s of i){let r=a.find(c=>{let u=E(c.textContent).toLowerCase(),f=E(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return u===s||f===s||u.includes(s)||s.length>2&&s.includes(u)});if(r){K(r);let c=r.querySelector('input[type="radio"], input[type="checkbox"]');c&&ae(c,!0);return}let d=L(s);if(d){K(d);return}}}function rn(t,e){try{let n=new DataTransfer;try{n.setData("text/plain",t)}catch{}try{n.setData("text/html",e)}catch{}return n}catch{return null}}function tt(t){try{t.click()}catch{let e=t.ownerDocument.defaultView||window;t.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function sn(t,e,n){try{if(e.contains(t))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(t))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let o=e.children.length;if(n!==void 0&&o>n)return{success:!0,evidence:`dest child count increased: ${n} \u2192 ${o}`};if([t.getAttribute("data-placed")==="true",t.getAttribute("data-assigned")==="true",t.getAttribute("data-matched")==="true",t.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(t.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(t.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(d=>d!==e&&(d.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:t.getAttribute("aria-hidden")==="true"||t.style.display==="none"||t.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function G(t,e){let n=E(t).toLowerCase();if(!n)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(t.trim())){let r=document.getElementById(t.trim());if(r&&C(r)&&!O(r))return r}let s=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let r of s){let c=Array.from(document.querySelectorAll(r)).find(u=>{if(!C(u)||O(u))return!1;let f=E(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return f===n||f.includes(n)||u.id===t.trim()});if(c)return c}return null}let o=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),i=Array.from(document.querySelectorAll(o)),a=i.find(s=>[s.getAttribute("data-category"),s.getAttribute("data-dropzone")].some(r=>r?.trim().toLowerCase()===n));return a&&C(a)&&!O(a)?a:i.find(s=>{if(!C(s)||O(s)||/unclassified/i.test(s.className))return!1;let r=s.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),d=E(r?.textContent||s.textContent||"").toLowerCase();return d.includes("op")&&(d.includes("es")||d.includes("\xF5es"))?!1:d===n||d.startsWith(n)||d.includes(n)})||null}async function ge(t,e,n=1){try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=t.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(o.left+Math.max(1,o.width/2)),s=Math.round(o.top+Math.max(1,o.height/2)),r=Math.round(i.left+Math.max(1,i.width/2)),d=Math.round(i.top+Math.max(1,i.height/2)),c=E(e.textContent).toLowerCase();if(c){let g=Array.from(t.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(h=>{let b=E(h.textContent).toLowerCase(),_=h instanceof HTMLInputElement||h instanceof HTMLOptionElement?E(h.value).toLowerCase():"";return b&&(c.includes(b)||b.includes(c))||_&&(c.includes(_)||_.includes(c))});g&&(K(g),await new Promise(h=>setTimeout(h,120)))}tt(t),await new Promise(m=>setTimeout(m,140)),tt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&tt(u),await new Promise(m=>setTimeout(m,100)),!e.contains(t)&&t.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(t),e.contains(t)&&t.matches('.dnd-card, [draggable="true"]'))return;let f={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:s,screenX:a,screenY:s,button:0,buttons:1};try{t.dispatchEvent(new PointerEvent("pointerdown",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",f));let l=4;for(let m=1;m<=l;m++){let g=Math.round(a+(r-a)*(m/l)),h=Math.round(s+(d-s)*(m/l)),b={...f,clientX:g,clientY:h,screenX:g,screenY:h};try{t.dispatchEvent(new PointerEvent("pointermove",{...b,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",b))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:d,screenX:r,screenY:d,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let m=rn(H(t.textContent),t.outerHTML),g={...f},h={...p};m&&(g.dataTransfer=m,h.dataTransfer=m);let b=t.ownerDocument.defaultView?.DragEvent;if(!b)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");t.dispatchEvent(new b("dragstart",g)),e.dispatchEvent(new b("dragenter",h)),e.dispatchEvent(new b("dragover",h)),e.dispatchEvent(new b("drop",h)),t.dispatchEvent(new b("dragend",g))}catch(m){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",m)}try{let m=new Touch({identifier:1,target:t,clientX:a,clientY:s}),g=new Touch({identifier:1,target:e,clientX:r,clientY:d});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[m]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(n>=2&&!e.contains(t))try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(m=>setTimeout(m,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(t))try{let m=b=>{let _=Object.keys(b).find(v=>v.startsWith("__reactFiber")||v.startsWith("__reactInternalInstance"));if(!_)return null;let x=b[_];for(let v=0;v<10&&x;v++){if(x.memoizedProps)return x.memoizedProps;x=x.return}return null},g=m(t),h=m(e);if(g){let b=g.onMouseDown||g.onPointerDown||g.onDragStart;if(typeof b=="function")try{b({type:"mousedown",button:0,buttons:1,clientX:a,clientY:s,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:t,target:t}),await new Promise(_=>setTimeout(_,100))}catch{}}if(h){let b=h.onMouseUp||h.onPointerUp||h.onDrop;if(typeof b=="function")try{b({type:"mouseup",button:0,buttons:0,clientX:r,clientY:d,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(_=>setTimeout(_,200));let b=d>s?"ArrowDown":"ArrowUp";for(let _=0;_<3;_++)document.dispatchEvent(new KeyboardEvent("keydown",{key:b,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(_=>setTimeout(_,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(t.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:t.id||t.getAttribute("data-id")}})),await new Promise(_=>setTimeout(_,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(m){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",m)}}var qt={fill:(t,e)=>{let n=L(t);n?Ce(n,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=L(t);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?ae(e,!0):K(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let n=L(t);n?ae(n,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},find:(t,e)=>L(t,e),drag:(t,e)=>{let n=G(t,"source")||L(t),o=G(e,"destination")||L(e);n&&o?ge(n,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let n=G(t,"source")||L(t),o=G(e,"destination")||L(e);if(!n||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await ge(n,o)},execute:(t,e=!1,n=1)=>pn(t,e,n)};typeof window<"u"&&(window.$eq=qt);async function cn(t,e=1,n=Ze()){if(et(t,n),t.t==="js"){let d=String(t.v||"");Ct(d);try{new Function("$eq","document","window",d)(qt,document,window)}catch(c){throw console.warn("[EasyQuiz JS Execution]",c),c}return}if(t.t==="drag"){let d=G(t.from,"source")||L(t.from),c=G(t.to,"destination")||L(t.to);!d&&t.from&&(d=L(E(t.from))),!c&&t.to&&(c=L(E(t.to))),d&&c?await ge(d,c,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let o=t.id!==void 0&&t.id!==null?String(t.id):"";!o&&t.t==="val"&&(o=t.target??t.name??t.selector??"1");let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text,a=i!=null?String(i).trim():"",s=null,r=String(t.name??t.n??"").trim();if(!r&&o&&document.querySelector(`input[type="radio"][name="${$(o)}"]`)&&(r=o),(t.t==="chk"||t.t==="clk")&&r){let d=Array.from(document.querySelectorAll(`input[name="${$(r)}"]`));if(a&&(s=d.find(c=>c.value?.toLowerCase()===a.toLowerCase())??null),!s&&a){let c=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(c||u){let f=c?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=d.find(l=>{let p=l.value?.toLowerCase()??"";if(f.includes(p))return!0;let g=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return f.some(h=>g===h||g.startsWith(h+" ")||g.startsWith("("+h+")"))})??null}}!s&&d.length>0&&(s=d[0])}if(s||(s=L(o,a,t.t==="val"||t.t==="sel")),!s&&o&&(s=L(E(o),a,t.t==="val"||t.t==="sel")),s&&a){if(s instanceof HTMLInputElement&&s.type==="radio"&&s.name){if(E(s.value).toLowerCase()!==E(a).toLowerCase()){let d=document.querySelector(`input[type="radio"][name="${$(s.name)}"][value="${$(a)}" i]`);if(d)s=d;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(s.name)}"]`)).find(f=>{let l=f.closest("label, .vf-label, .option-card, tr, td, div");return l&&E(l.textContent).toLowerCase().includes(E(a).toLowerCase())});u&&(s=u)}}}else if(!(s instanceof HTMLInputElement)&&!(s instanceof HTMLSelectElement)&&!(s instanceof HTMLTextAreaElement)){let d=s.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(d)s=d;else{let u=Array.from(s.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(f=>{let l=f.closest("label, .vf-label, .option-card, td, div");return l&&E(l.textContent).toLowerCase().includes(E(a).toLowerCase())});u&&(s=u)}}}if(!s&&(t.t==="val"||t.t==="sel")){let d=document.body;try{d=J()||document.body}catch{}let c=Array.from(d.querySelectorAll(t.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>C(u)&&!O(u));if(c.length===1)s=c[0];else if(c.length>1){let u=E(o).toLowerCase(),f=u.match(/^#?_?([0-9]+)$/);if(f){let l=parseInt(f[1],10);l>=1&&l<=c.length?s=c[l-1]:l>=0&&l<c.length&&(s=c[l])}s||(s=c.find(p=>{let m=(p.getAttribute("placeholder")||"").toLowerCase(),g=(p.name||"").toLowerCase(),h=(p.getAttribute("aria-label")||"").toLowerCase(),b=(p.id||"").toLowerCase(),_=E(We(p)).toLowerCase(),x=E(p.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return m.includes(u)||g.includes(u)||h.includes(u)||b.includes(u)||_&&_.includes(u)||u.length>=2&&x.includes(u)})||(c.length===1?c[0]:null))}}if(!s&&t.t!=="adv")throw new Error(`Alvo '${o}' n\xE3o encontrado no DOM para a\xE7\xE3o '${t.t}'.`);switch(t.t){case"val":if(s){let u=s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement||s.isContentEditable?s:s.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let m=s.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');m&&(u=m)}if(!u){let p=s.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){u=p;break}let m=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){u=m;break}p=p.nextElementSibling}}if(!u){let p=document.body;try{p=J()||document.body}catch{}let m=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(g=>C(g)&&!O(g));m.length>0&&(u=m[0])}let f=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text,l=f!=null?String(f):"";Ce(u||s,l)}break;case"chk":let d=t.c!==void 0?!!t.c:!0;s&&ae(s,d);break;case"sel":if(s){let u=Array.isArray(t.v)?t.v:[String(t.v)];ke(s,u)}break;case"clk":if(s)if(!!(s.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||s.querySelector('input[type="radio"], input[type="checkbox"]')||s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type))){let f=t.c!==void 0?!!t.c:!0;ae(s,f)}else K(s,t.co);break;case"adv":let c=It(t.id);if(c){await nt(c,1200);let u=t.id||c.textContent?.trim()||"";u&&ze(window.location.hostname,{advanceSelector:u}),K(c)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function ln(){let t=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(t)).find(n=>{if(!C(n)||O(n)||n.closest("header, nav, aside"))return!1;let o=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",i=(n.textContent||o||n.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function It(t){let e=l=>{let p=(l.getAttribute("aria-label")||l.textContent||(l instanceof HTMLInputElement||l instanceof HTMLButtonElement?l.value:"")||"").trim();return oe.test(p)};if(t){let l=L(t);if(l&&C(l)&&!O(l)&&!R(l)&&!e(l))return l}try{let l=Ne(window.location.hostname);if(l.advanceSelector){let p=L(l.advanceSelector);if(p&&C(p)&&!O(p)&&!R(p)&&!e(p))return p}}catch{}let n=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(n)),i=l=>{let p=l instanceof HTMLInputElement||l instanceof HTMLButtonElement?l.value:"";return(l.getAttribute("aria-label")||l.textContent||p||"").trim()},a=l=>{let p=i(l).trim();return/^\d{1,3}$/.test(p)?!!l.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},s=o.filter(l=>C(l)&&!O(l)&&!l.closest("header, aside")&&!R(l)&&!e(l));for(let l of s){let p=i(l),m=p.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((pe.test(p)||pe.test(m))&&!a(l)&&!R(l))return l}for(let l of s)if(X(l)&&!R(l)&&!a(l))return l;let r=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(r&&C(r)&&!O(r)&&!R(r)&&!e(r))return r;let d=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let l of d)if(C(l)&&!O(l)&&!e(l)&&!R(l)&&!a(l))return l;let c=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,f=c.filter(l=>{if(!C(l)||O(l)||e(l)||R(l)||l.closest("header, nav, aside, .eq-sidebar")||a(l))return!1;let p=l.getBoundingClientRect();return p.top>u*.45&&p.height>=24&&p.width>=24});if(f.length>0)return f.sort((l,p)=>{let m=l.getBoundingClientRect(),g=p.getBoundingClientRect(),h=m.left+m.top;return g.left+g.top-h}),f[0];for(let l of s)if(X(l)&&!R(l))return l;return null}async function nt(t,e=2500){let n=Date.now();for(;Date.now()-n<e;){if(!(t.disabled===!0||t.getAttribute("aria-disabled")==="true"||t.classList.contains("disabled")||t.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function dn(){let t=window.location.href,e=document.title,n=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,o=(document.body?.innerText||document.body?.textContent||"").length;return`${t}|${e}|${n}|${o}`}async function un(t,e=3500){let[n,o,i,a]=t.split("|"),s=parseInt(a||"0",10),r=Date.now();for(;Date.now()-r<e;){let d=window.location.href,c=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),f=(document.body?.innerText||document.body?.textContent||"").length;if(d!==n)return{changed:!0,evidence:`URL mudou: ${n} \u2192 ${d}`};if(c!==o)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${o}" \u2192 "${c}"`};if(Math.abs(parseInt(u)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${u}`};if(Math.abs(f-s)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(f-s)} chars)`};await new Promise(l=>setTimeout(l,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Mt(t){if(t.t==="js"||t.t==="adv")return;if(t.t==="drag"){let a=L(t.from)||L(E(t.from)),s=L(t.to)||L(E(t.to));a&&s&&await ge(a,s,2);return}let e=t.id||"",n=t.v!==void 0?String(t.v).trim():"",o=L(e,n)||L(E(e),n),i=String(t.name??t.n??"").trim();if(!i&&e&&document.querySelector(`input[type="radio"][name="${$(e)}"]`)&&(i=e),!o&&i){let a=Array.from(document.querySelectorAll(`input[name="${$(i)}"]`));if(n&&(o=a.find(s=>s.value?.toLowerCase()===n.toLowerCase())??null),!o&&n){let s=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(n),r=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(n);if(s||r){let d=s?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];o=a.find(c=>{let u=c.value?.toLowerCase()??"";if(d.includes(u))return!0;let l=(c.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return d.some(p=>l===p||l.startsWith(p+" ")||l.startsWith("("+p+")"))})??null}}!o&&a.length>0&&(o=a[0])}if(t.t==="clk"||t.t==="chk"){if(!o&&e){let s=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),r=E(e).toLowerCase();o=s.find(d=>{let c=E(d.textContent).toLowerCase();return!!(E(d.value||"").toLowerCase()===r||c===r||c.startsWith(r+")")||c.startsWith("("+r+")")||c.startsWith(r+".")||c.startsWith(r+" - ")||c.startsWith(r+":")||r.length>=3&&c.includes(r))})||null}let a=t.v!==void 0?String(t.v).trim():"";if(o&&a){if(o instanceof HTMLInputElement&&o.type==="radio"&&o.name){if(E(o.value).toLowerCase()!==E(a).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${$(o.name)}"][value="${$(a)}" i]`);if(s)o=s;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(o.name)}"]`)).find(c=>{let u=c.closest("label, .vf-label, .option-card, tr, td, div");return u&&E(u.textContent).toLowerCase().includes(E(a).toLowerCase())});d&&(o=d)}}}else if(!(o instanceof HTMLInputElement)&&!(o instanceof HTMLSelectElement)&&!(o instanceof HTMLTextAreaElement)){let s=o.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(s)o=s;else{let d=Array.from(o.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(c=>{let u=c.closest("label, .vf-label, .option-card, td, div");return u&&E(u.textContent).toLowerCase().includes(E(a).toLowerCase())});d&&(o=d)}}}if(o){let s=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,r=o instanceof HTMLInputElement&&["radio","checkbox"].includes(o.type)?o:s.querySelector('input[type="radio"], input[type="checkbox"]')||(s.getAttribute("for")?s.ownerDocument.getElementById(s.getAttribute("for")):null),d=t.c!==void 0?!!t.c:!0;if(ae(r||s,d),r&&r.checked!==d){try{let c=r._valueTracker;c&&c.setValue(!d)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(r,d)}catch{}r.checked=d,r.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),r.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(t.t==="val"){let a=null;if(o&&(a=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o.isContentEditable?o:o.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let s=document.body;try{s=J()||document.body}catch{}let r=Array.from(s.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),d=E(e).toLowerCase();a=r.find(c=>{let u=(c.getAttribute("placeholder")||"").toLowerCase(),f=(c.name||"").toLowerCase(),l=(c.id||"").toLowerCase(),p=(c.getAttribute("aria-label")||"").toLowerCase();return u.includes(d)||f.includes(d)||l.includes(d)||p.includes(d)})||(r.length>0?r[0]:null)}if(a){let s=String(t.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,s)}}catch{}Ce(a,s)}return}if(t.t==="sel"){if(!o&&e){let a=Array.from(document.querySelectorAll("select")),s=E(e).toLowerCase();o=a.find(r=>{let d=(r.name||"").toLowerCase(),c=(r.id||"").toLowerCase(),u=(r.getAttribute("aria-label")||"").toLowerCase();return d.includes(s)||c.includes(s)||u.includes(s)})||null}if(o){let a=Array.isArray(t.v)?t.v:[String(t.v)];ke(o,a)}return}}function ee(t){try{if(t.t==="val"){let e=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text,n=String(e??"").trim(),o=n,i=t.id!==void 0&&t.id!==null?String(t.id):"";i||(i=t.target??t.name??t.selector??"1");let a=L(i,o,!0)||L(E(i),o,!0);if(!a){let p=document.body;try{p=J()||document.body}catch{}let m=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(g=>C(g)&&!O(g));m.length>0&&(a=m[0])}if(!a)return!1;let s=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(s&&s.name){let p=document.querySelector(`input[type="radio"][name="${$(s.name)}"]:checked`);if(!p)return!1;let m=E(p.value).toLowerCase(),g=E(n).toLowerCase(),h=E(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return m===g||h===g||h.includes(g)}let r=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!r){let m=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');m&&(r=m)}if(!r){let p=a.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){r=p;break}let m=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){r=m;break}p=p.nextElementSibling}}if(r instanceof HTMLSelectElement){let p=E(n).toLowerCase();return Array.from(r.options).some(m=>{if(!m.selected)return!1;let g=m.value.toLowerCase(),h=E(m.textContent).toLowerCase();return p===g||p===h||g.includes(p)||h.includes(p)})}let d=(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement?r.value:r?.textContent??a.textContent??"").trim();if(!d&&!n)return!0;if(!d&&n)return!1;let c=d.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=n.replace(",",".").replace(/\s+/g,"").toLowerCase(),f=parseFloat(c),l=parseFloat(u);return!isNaN(f)&&!isNaN(l)&&c.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(f-l)<1e-4:c===u||d.toLowerCase()===n.toLowerCase()||u.length>=3&&c===u}if(t.t==="sel"){let e=L(t.id,void 0,!0)||L(E(t.id),void 0,!0);if(!e){let a=document.body;try{a=J()||document.body}catch{}let s=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>C(c)&&!O(c)),r=E(t.id).toLowerCase();e=s.find(c=>{let u=(c.id||"").toLowerCase(),f=(c.getAttribute("name")||"").toLowerCase(),l=(c.getAttribute("aria-label")||"").toLowerCase(),p=E(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(r)||f.includes(r)||l.includes(r)||r.length>=2&&p.includes(r)})||(s.length===1?s[0]:null)}if(!e)return!1;let n=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!n){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let r=(Array.isArray(t.v)?t.v:[String(t.v)]).map(c=>E(c).toLowerCase()),d=E(a.textContent).toLowerCase();return r.some(c=>d.includes(c)||c.includes(d))}return!1}let i=(Array.isArray(t.v)?t.v:[String(t.v)]).map(a=>E(a).toLowerCase());return Array.from(n.options).some(a=>{if(!a.selected)return!1;let s=a.value.toLowerCase(),r=E(a.textContent).toLowerCase();return i.some(d=>d===s||d===r||s.includes(d)||r.includes(d))})}if(t.t==="chk"||t.t==="clk"){let e=t.v!==void 0?String(t.v).trim():"",n=String(t.name??t.n??"").trim();if(n&&!t.id){let l=Array.from(document.querySelectorAll(`input[name="${$(n)}"]`));if(l.length>0){let p=l.find(_=>_.checked);if(!p)return!1;if(!e)return!0;let m=p.value?.toLowerCase()??"",g=e.toLowerCase();if(m===g)return!0;let h=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),b=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return h?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(m):b?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(m):!1}}let o=L(t.id,e)||L(E(t.id),e);if(!o&&n){let l=document.querySelector(`input[name="${$(n)}"]`);l&&(o=l)}if(!o)return!1;let i=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:i.querySelector('input[type="checkbox"], input[type="radio"]')||(i.getAttribute("for")?i.ownerDocument.getElementById(i.getAttribute("for")):null),s=t.t==="chk"||t.c!==void 0?!!t.c:!0;if(a&&a.type==="radio"){if(a.checked===s)return!0;if(t.v&&a.name){let l=E(String(t.v)).toLowerCase(),p=document.querySelector(`input[type="radio"][name="${$(a.name)}"]:checked`);if(!p)return!1;if(p===a)return!0;let m=E(p.value).toLowerCase(),g=E(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return m===l||g.includes(l)||l.includes(m)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===s;let r=i.getAttribute("aria-checked")===String(s)||i.getAttribute("aria-selected")===String(s)||i.getAttribute("aria-pressed")===String(s),d=s?i.getAttribute("data-selected")==="true"||i.getAttribute("data-checked")==="true"||i.getAttribute("data-active")==="true"||i.getAttribute("data-state")==="checked"||i.getAttribute("data-state")==="on":i.getAttribute("data-selected")==="false"||i.getAttribute("data-checked")==="false"||i.getAttribute("data-state")==="unchecked",c=i.className||"",u=s?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(c):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(c);if(r||d||u)return!0;let f=!!i.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return t.t==="clk"&&!a&&!f||i.getAttribute("aria-expanded")!==null||i.getAttribute("aria-pressed")!==null}if(t.t==="drag"){let e=G(t.from,"source")||L(t.from)||L(E(t.from)),n=G(t.to,"destination")||L(t.to)||L(E(t.to));return!e||!n?!1:sn(e,n).success}}catch{}return!1}async function pn(t,e,n=1,o=Ze({engine:"smart",autoAdvance:e})){let i=y=>{if(y.t==="adv")return!0;if(y.t==="clk"&&"id"in y&&typeof y.id=="string"){let T=E(y.id);if(pe.test(T)&&!oe.test(T))return!0}return!1},a=t.actions.filter(y=>!i(y)),s=t.actions.filter(y=>i(y)),r=0,d=[],c=new Map,u=new Map,f=new Map,l=new Set,p=t.pageType==="question",m=a.filter(y=>y.t==="chk"||y.t==="clk"&&y.c!==void 0),g=new Map;for(let y of a){let T=[];u.set(y,T);try{if(y.t==="drag"){T.push("declarative-A-F");try{let A=G(y.from,"source")||L(y.from),w=G(y.to,"destination")||L(y.to);A&&f.set(y,A.parentElement?.outerHTML?.slice(0,500)||""),w&&g.set(y,w.children.length)}catch{}}else T.push("declarative-primary");await cn(y,n,o),r++,l.add(y)}catch(A){c.set(y,A instanceof Error?A.message:String(A)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",y,A)}await new Promise(A=>setTimeout(A,y.t==="drag"?180:35))}if(p&&t.mode==="escolha_multipla"&&m.length>0){let y=document.body;try{y=J()||document.body}catch{}let T=Array.from(y.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(A=>C(A)&&!O(A));if(T.length>1){let w=function(k,M){if(k===M||k.contains(M)||M.contains(k))return!0;let N=k.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),P=M.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(N&&P&&N===P)return!0;let U=k.getAttribute("for")||k.id,q=M.getAttribute("for")||M.id;return!!(U&&q&&U===q)};var z=w;let A=new Set;for(let k of m){let M=k.t==="chk"?!!k.c:!!(k.c??!0),N="id"in k&&typeof k.id=="string"?k.id:"";if(M&&N){let P=L(N,k.v);if(P){A.add(P);let U=P.querySelector('input[type="checkbox"]');U&&A.add(U);let q=P.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');q&&(A.add(q),q.querySelectorAll('input[type="checkbox"]').forEach(F=>A.add(F)))}}}if(A.size>=m.length&&A.size>0){let k=Array.from(A);for(let M of T)k.some(P=>w(P,M))||(M instanceof HTMLInputElement&&M.checked||M.getAttribute("aria-checked")==="true"||M.closest(".option-card, label")?.classList.contains("selected"))&&ae(M,!1)}}}await new Promise(y=>setTimeout(y,a.length>0?100:25));let h=0;for(let y of a){if(ee(y)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${y.t}' no alvo '${y.id||y.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{et(y,o),u.get(y)?.push("alternative-path"),await Mt(y)}catch(T){c.set(y,T instanceof Error?T.message:String(T)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",T)}await new Promise(T=>setTimeout(T,250)),ee(y)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++,l.has(y)?c.has(y)&&c.delete(y):(c.delete(y),r++,l.add(y)))}if(h<a.length&&a.length>0){console.warn(`[EasyQuiz Auto-Cura] ${a.length-h} de ${a.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(y=>setTimeout(y,200));for(let y of a)if(!ee(y))try{if(await Mt(y),await new Promise(T=>setTimeout(T,80)),!ee(y)&&(y.t==="clk"||y.t==="chk"))try{let T="id"in y?String(y.id||""):"",A=y.v!==void 0?String(y.v).trim():"",w=L(T,A)||L(E(T),A);w&&(Me(w),await new Promise(k=>setTimeout(k,120)))}catch{}}catch(T){c.set(y,T instanceof Error?T.message:String(T))}await new Promise(y=>setTimeout(y,200)),h=0;for(let y of a)ee(y)&&(h++,l.has(y)?c.has(y)&&c.delete(y):(c.delete(y),r++,l.add(y)))}let b=[];for(let[y,T]of a.entries())if(!ee(T)){let A=T.t==="drag"?`${T.from} -> ${T.to}`:"id"in T&&T.id?T.id:T.t;d.push(A),b.push({actionIndex:y,action:T,strategiesAttempted:u.get(T)||[],evidence:c.get(T)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:f.get(T)}),T.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${T.from}" -> "${T.to}"`,`
  Estrat\xE9gias: ${(u.get(T)||[]).join(", ")}`,`
  Snapshot DOM: ${f.get(T)?.slice(0,200)||"n/a"}`)}p&&a.length===0&&d.push("nenhuma a\xE7\xE3o de resposta prescrita");let _=a.map((y,T)=>{let A=y.t==="drag"?`${y.from} -> ${y.to}`:y.t==="js"?"$eq":y.id||y.t,w=y.t==="js"?!0:y.t==="drag"?!!(G(y.from,"source")&&G(y.to,"destination")):!!(L(y.id||"")||L(E(y.id||""))),k=ee(y);return{index:T,action:y,target:A,located:w,applied:!c.has(y),verified:k,strategy:y.t==="drag"?"drag-adaptive":y.t==="js"?"javascript":"declarative-dom",evidence:k?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(y)?{error:c.get(y)}:{}}}),x=p?a.length>0&&d.length===0&&(h===a.length||r===a.length&&h>0):!0,v=!1,S=!1,I="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",D=r>0&&r>=a.length/2;if(e&&(x||!p||D)){await new Promise(A=>setTimeout(A,a.length>0?120:40));let y=!1,T=null;if(t.pageType!=="info"){let A=ln();A&&C(A)&&(await nt(A,1200),K(A),y=!0,T=A,v=!0,S=!0,I="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.",await new Promise(w=>setTimeout(w,400)))}if(!y){let A=dn(),w=s.length>0&&"id"in s[0]?s[0].id:void 0,k=It(w);if(k){await nt(k,1500);let M=w||k.textContent?.trim()||"";M&&ze(window.location.hostname,{advanceSelector:M}),K(k);let N=await un(A,1800);S=N.changed,I=N.evidence,v=N.changed||!0,N.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:h,success:x,advanced:v,failed:d,reports:_,navigationVerified:S,navigationEvidence:I,failedActions:b}}var Le=class{el=null;state="idle";mouseX=-300;mouseY=-300;displayX=-300;displayY=-300;rafId=null;flashTimer=null;boundMove;constructor(){this.boundMove=e=>{this.mouseX=e.clientX,this.mouseY=e.clientY,this.displayX===-300&&(this.displayX=e.clientX,this.displayY=e.clientY)},window.addEventListener("mousemove",this.boundMove,{passive:!0}),this.injectStyle(),this.createEl(),this.startRaf()}injectStyle(){if(document.getElementById("__eqdc_style__"))return;let e=document.createElement("style");e.id="__eqdc_style__",e.textContent=`
    ...
    `,document.documentElement.appendChild(e)}open(){this.close();let n=te().model,o=[...Ee],i=(we||[]).filter(g=>!o.some(h=>h.id===g.id)),a=document.createElement("div");a.id="__eqdm_menu__",a.setAttribute("role","menu"),a.tabIndex=-1;let s=document.createElement("div");s.className="__eqdm_section__",s.textContent="Modelo Gemini",a.appendChild(s);let r=document.createElement("div");r.className="__eqdm_sep__",a.appendChild(r);let d=(g,h,b)=>{let _=g===n,x=document.createElement("div");x.className="__eqdm_item__",x.setAttribute("role","menuitemradio"),x.setAttribute("aria-checked",_?"true":"false"),x.tabIndex=0;let v=document.createElement("span");v.className="__eqdm_check__",_&&(v.innerHTML=`<svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
        ...
        </svg>`),x.appendChild(v);let S=document.createElement("span");if(S.className="__eqdm_name__",S.textContent=h,_&&(S.style.fontWeight="500"),x.appendChild(S),b){let I=document.createElement("span");I.className="__eqdm_badge__",I.textContent=b,x.appendChild(I)}x.addEventListener("click",()=>{he({model:g}),this.onModelChange?.(g),this.close()}),x.addEventListener("keydown",I=>{(I.key==="Enter"||I.key===" ")&&(I.preventDefault(),he({model:g}),this.onModelChange?.(g),this.close())}),a.appendChild(x)};for(let g of o){let h;g.id.includes("3.8")||g.id.includes("3.7")?h="Novo":g.id.includes("flash-lite")?h="Eco":g.id.includes("pro")&&(h="Pro");let b=g.name.replace(/\s*\(.*?\)\s*/g,"").trim();d(g.id,b,h)}if(i.length>0){let g=document.createElement("div");g.className="__eqdm_sep__",a.appendChild(g);let h=document.createElement("div");h.className="__eqdm_section__",h.textContent="Modelos da conta",a.appendChild(h);for(let b of i)d(b.id,b.name.replace(/\s*\(.*?\)\s*/g,"").trim())}document.documentElement.appendChild(a),this.el=a;let{offsetWidth:c,offsetHeight:u}=a,f=this.lastMouseX,l=this.lastMouseY,p=window.innerWidth,m=window.innerHeight;f+c+8>p&&(f=p-c-8),l+u+8>m&&(l=m-u-8),f<4&&(f=4),l<4&&(l=4),a.style.left=`${f}px`,a.style.top=`${l}px`,a.focus(),setTimeout(()=>{window.addEventListener("click",this.boundOutside,{capture:!0}),window.addEventListener("keydown",this.boundOutside,{capture:!0})},50),this.autoTimer=window.setTimeout(()=>this.close(),8e3)}close(){this.autoTimer&&(clearTimeout(this.autoTimer),this.autoTimer=null),window.removeEventListener("click",this.boundOutside,{capture:!0}),window.removeEventListener("keydown",this.boundOutside,{capture:!0}),this.el?.remove(),this.el=null}isOpen(){return this.el!==null}destroy(){this.close(),window.removeEventListener("mousemove",this.boundMouseMove),document.getElementById("__eqdm_style__")?.remove()}};var Oe=class{el=null;coin;toast;boundEsc;constructor(e,n){this.coin=e,this.toast=n,this.boundEsc=o=>{o.key==="Escape"&&this.isOpen()&&(o.stopPropagation(),o.preventDefault(),this.close())},this.injectStyle()}injectStyle(){if(document.getElementById("__eqkm_style__"))return;let e=document.createElement("style");e.id="__eqkm_style__",e.textContent=`
      #__eqkm_overlay__ {
...
`);navigator.clipboard.writeText(i).then(()=>{n.textContent="\u2713",setTimeout(()=>n.textContent="\u{1F4CB}",1e3)})}),this.el.querySelector("#__eq_dbg_btn_clear__")?.addEventListener("click",()=>{this.logs=[],this.renderConsoleLogs(),this.updateTabCounters()})}renderFlow(){let e=this.el?.querySelector(".__eq_dbg_body__");if(!e)return;if(!this.currentFlow||this.currentFlow.length===0){e.innerHTML=`
      ...
      `;return}let n=this.currentFlow.map((i,a)=>{let s=i.action,r=this.stepStatuses.get(a)||(a===this.currentStepIdx?"active":a<this.currentStepIdx?"done":"pending"),d=r==="done"?'<span class="__eq_status_done__">\u2713 Conclu\xEDdo</span>':r==="active"?'<span class="__eq_status_active__">\u25B6 Em Andamento</span>':r==="failed"?'<span class="__eq_status_failed__">\u2715 Falhou</span>':'<span class="__eq_status_pending__">Pendente</span>',c=i.trigger==="key"?"\u2328\uFE0F Tecla":"\u{1F5B1}\uFE0F Clique",u=String(s.t||"act").toUpperCase(),f=s.id?`#${s.id}`:s.name?`[name="${s.name}"]`:s.label||s.from||"alvo",l=s.v!==void 0?` = "${s.v}"`:s.c!==void 0?` (check: ${s.c})`:"";return`
        <div class="__eq_flow_card__ ${r==="active"?"__eq_flow_active__":""}">
          ...
          <div class="__eq_flow_content__">
            <div class="__eq_flow_target__">${W(String(f))}<span style="color:#8ab4f8;">${W(String(l))}</span></div>
    ...
    `,e.querySelector("#__eq_btn_copy_json__")?.addEventListener("click",a=>{navigator.clipboard.writeText(i).then(()=>{let s=a.currentTarget;s.textContent="\u2713 Copiado",setTimeout(()=>s.textContent="Copiar JSON",1200)})})}renderMedia(){let e=this.el?.querySelector(".__eq_dbg_body__");if(!e)return;if(!this.capturedImages||this.capturedImages.length===0){e.innerHTML=`
      ...
      `;return}let n=this.currentPlan?.imageDescriptions||[],o="";this.capturedImages.forEach((i,a)=>{let s=n.find(m=>m.index===a),r=s?.relevant??!0,d=s?.description??(i.textContext||"Aguardando an\xE1lise da IA..."),c=i.captureStatus==="captured"?"\u2705":i.captureStatus==="text_only"?"\u{1F4DD}":"\u26A0\uFE0F",u=i.captureStatus==="captured"?"Visual":i.captureStatus==="text_only"?"Texto":"Falhou",f=i.base64?`data:${i.mediaType||"image/jpeg"};base64,${i.base64}`:"",l="";f?l=`
...
`;function Ot(t){let e=[],n=1;for(let o of t){let i=o.t;i==="val"?e.push({step:n++,trigger:"key",action:o,hint:"Keyboard Interact",customMsg:null}):i==="chk"||i==="clk"?e.push({step:n++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:null}):i==="sel"?(e.push({step:n++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:"Opening..."}),e.push({step:n++,trigger:"click",action:o,hint:"Option Selected",customMsg:null})):i==="drag"?e.push({step:n++,trigger:"click",action:o,hint:"Mover Item",customMsg:null}):i==="adv"&&e.push({step:n++,trigger:"click",action:o,hint:"Next Page Loading",customMsg:null})}return e}function $t(t,e){if(!Array.isArray(t)||t.length===0)return Ot(e);let n=[];for(let o of t){if(!o||typeof o!="object")continue;let i=o,a=i.trigger==="key"?"key":"click",s=i.action||{},r=a==="key"?1:void 0;n.push({step:typeof i.step=="number"?i.step:n.length+1,trigger:a,action:s,chars:r,hint:typeof i.hint=="string"?i.hint.slice(0,30):a==="key"?"Keyboard Interact":"Mouse Interact",customMsg:typeof i.customMsg=="string"?i.customMsg.slice(0,22):null})}return n.length===0?Ot(e):bn(n,e)}function bn(t,e){let n=[];for(let o=0;o<t.length;o++){let i=t[o],a=i.action;if(!a.t&&e[o]&&(i.action=e[o]),a.t==="chk"&&!a.name&&a.id){let r=String(a.id);if(r.startsWith("eq-")||r.match(/^[a-z0-9]+-[a-z0-9]+-[a-z0-9]+$/))try{let d=document.querySelector(`[data-easyquiz-id="${r}"], #${r}`);d?.name&&(i.action.name=d.name,d.value&&d.value!=="on"&&(i.action.v=d.value))}catch{}}let s=n[n.length-1];if(s){let r=s.action;if(s.trigger===i.trigger&&r.t===a.t&&r.name===a.name&&r.v===a.v&&r.id===a.id||r.t==="adv"&&a.t==="adv")continue;(r.t==="clk"||r.t==="chk")&&a.t==="adv"&&typeof r.id=="string"&&/(avançar|proximo|próximo|next|continuar|verificar|submit|check)/i.test(r.id)&&n.pop()}i.step=n.length+1,n.push(i)}return n.length>0?n:t}if(window.__eqdiscrete)try{window.__eqdiscrete.destroy()}catch{}vn();function yn(){try{if(document.querySelector("link[data-eqdiscrete-preconnect]"))return;let t=document.createElement("link");t.rel="preconnect",t.href="https://generativelanguage.googleapis.com",t.crossOrigin="anonymous",t.setAttribute("data-eqdiscrete-preconnect","true"),document.head?.appendChild(t)}catch{}}var _n=xe+Ht;async function vn(){yn(),ut();let t=new Le,e=new qe,n=new He,o=new Pe(t,e,n),i=new De({onForceStep:v=>o.forceStep(v),onForceAllSteps:()=>o.forceAll()});o.setDebugOutput(i);let a=new Ie({onModelChange:()=>e.flash("Modelo OK")}),s=new Oe(t,e),r=new Re,d=null,c=!1,u=null,f=new $e({onPageAdvance:()=>{o.isActive()||c||g(!0)}});f.start();let l=te();l.apiKey&&Ve(l.apiKey).catch(()=>{}),e.flash("EQ Ativo");let p=0,m=[1500,3e3,5e3,8e3];async function g(v=!1,S=0){if(u&&(clearTimeout(u),u=null),c&&v){i.log("SYS","An\xE1lise j\xE1 em andamento \u2014 preservando requisi\xE7\xE3o ativa");return}if(v&&o.isActive())return;if(d){try{d.abort()}catch{}d=null}o.isActive()&&o.abort();let I=te();if(!I.apiKey){e.flash("Config: Shift+A"),t.flashError(2e3);return}c=!0,p=S,d=new AbortController;let D=d.signal;f.resetHash(),t.setState("loading"),(!v||S>0)&&e.flash(S>0?`Tentativa ${S+1}`:"Analisando"),i.log("SYS",`Iniciando an\xE1lise (proativo: ${v}, retry: ${S})`);function z(){let y=m[Math.min(S,m.length-1)];i.log("WARN",`Agendando retry em ${y}ms`),u=window.setTimeout(()=>{o.isActive()||g(!1,S+1)},y)}try{if(v&&await new Promise(q=>setTimeout(q,700)),D.aborted)return;let y=Ae(!1);if(y||(y=_e()),!y||!y.questionText?.trim()){t.setState("idle"),S===0&&!v&&e.flash("Sem conte\xFAdo"),i.log("WARN","Nenhum conte\xFAdo ou quest\xE3o detectada na p\xE1gina"),z();return}i.log("DOM",`Contexto detectado: ${y.controls.length} controles, ${y.questionText.length} chars`,y.questionText);let T=await At(y.scope,I.useVision);if(D.aborted)return;i.setImages(T);let A=performance.now(),w=await yt(y,T,I,(q,F)=>i.log(F==="error"?"ERROR":F==="warning"?"WARN":"SYS",`[IA] ${q}`),D,{systemPromptOverride:_n}),k=Math.round(performance.now()-A);if(D.aborted)return;t.setState("idle");let M=w.plan;if(i.log("SYS",`An\xE1lise conclu\xEDda em ${k}ms via ${w.usedModel??I.model} \u2014 pageType: ${M.pageType} | mode: ${M.mode} | ${M.actions?.length??0} a\xE7\xE3o(\xF5es)`),i.setPlan(M,y.questionText,k,I.model,T),M.memoryToStore&&ct(M.memoryToStore),M.imageDescriptions&&M.imageDescriptions.length>0){i.log("AI",`\u{1F5BC}\uFE0F ${M.imageDescriptions.length} imagem(ns) analisadas:`);for(let q of M.imageDescriptions){let F=q.relevant?"\u2705":"\u26A0\uFE0F";i.log(q.relevant?"AI":"WARN",`  ${F} Imagem ${q.index+1} [${q.relevant?"RELEVANTE":"IGNORADA"}]: ${q.description}`)}}if(M.pageType==="conclusion"){e.flash("Sess\xE3o encerrada"),i.log("SYS","P\xE1gina de conclus\xE3o detectada");return}let N=$t(M.interactionFlow,M.actions||[]);if(i.log("SYS",`Fluxo gerado: ${N.length} step(s) \u2014 ${N.map(q=>`${q.trigger}[${q.action?.t}]`).join(", ")}`),M.pageType==="info"||M.pageType==="start"){if(t.flashOk(1e3),e.flash("Avan\xE7ar \u2192"),i.log("SYS",`P\xE1gina informativa (${M.pageType}) \u2014 aguardando clique do usu\xE1rio para avan\xE7ar`),N.length>0)o.start(N);else{let q=[{step:1,trigger:"click",action:{t:"adv",label:"continuar"},hint:"Clique para avan\xE7ar",customMsg:null}];i.log("SYS","Fluxo adv gerado automaticamente para p\xE1gina informativa"),o.start(q)}return}if(!N.length){i.log("WARN","Plano da IA retornou sem a\xE7\xF5es ou fluxo de intera\xE7\xE3o"),z();return}p=0,t.flashOk(500);let P=N[0];e.flash(P.hint||"Pronto"),P.customMsg&&setTimeout(()=>e.flash(P.customMsg),1400);let U=N.filter(q=>q.action?.t==="drag");if(U.length>0){i.log("FLOW",`\u{1F504} ${U.length} step(s) de drag/categoriza\xE7\xE3o no fluxo. Estrat\xE9gias A-G ser\xE3o tentadas.`);for(let q of U){let F=q.action;i.log("FLOW",`  Drag: "${F.from}" \u2192 "${F.to}"`,JSON.stringify(F))}}o.start(N)}catch(y){if(D.aborted)return;t.setState("idle");let T=y instanceof Error?y.message:String(y);if(i.log("ERROR",`Erro na an\xE1lise: ${T}`),T.includes("403")||T.includes("API key")||T.includes("inv\xE1lida")){e.flash("Acesso negado"),t.flashError();return}if(T.includes("429")||T.includes("Quota")||T.includes("RESOURCE_EXHAUSTED")||T.includes("Todas as tentativas")){T.includes("Todas as tentativas")||S>=4?(e.flash("Limite \u2014 aguarde"),t.flashError(),z()):(e.flash("Chave rotacionando"),t.flashError(300),g(!1,S+1));return}t.flashError(800),z()}finally{d?.signal===D&&(d=null),c=!1}}function h(){if(c){e.flash("Analisando...");return}if(o.isActive()){let v=o.getCurrentStep()+1,S=o.getTotalSteps(),I=o.getState()==="waiting_key"?"Tecla":"Mouse";e.flash(`${v}/${S} ${I}`)}else{let S=te().model.replace("gemini-","").replace("-flash","F").replace("-lite","L").replace("-preview","P");e.flash(`OK \u2014 ${S}`)}}function b(){a.isOpen()&&a.close(),s.isOpen()&&s.close(),r.isOpen()&&r.close(),i.isOpen()&&i.close()}let _=[{keys:"Shift+Q",label:"Analisar p\xE1gina",action:()=>void g()},{keys:"Shift+V",label:"M\xEDdias IA (Vision)",action:()=>{i.openTab("media"),e.flash("M\xEDdias IA")}},{keys:"Shift+M",label:"Trocar modelo",action:()=>a.isOpen()?a.close():a.open()},{keys:"Shift+A",label:"Config API keys",action:()=>s.isOpen()?s.close():s.open()},{keys:"Shift+Z",label:"Abortar fluxo",action:()=>o.isActive()?o.abort():e.flash("Nada ativo")},{keys:"Shift+R",label:"Re-analisar",action:()=>void g()},{keys:"Shift+H",label:"Debug Output",action:()=>i.toggle()},{keys:"Shift+I",label:"\xDAltimo aviso",action:()=>e.reshow()},{keys:"Shift+C",label:"Comandos",action:()=>r.isOpen()?r.close():r.open()},{keys:"Escape",label:"Fechar menus",action:b}];r.setCommands(_);function x(v){let S=v.key;if(v.altKey&&(S==="q"||S==="Q")||v.shiftKey&&S==="Q"){v.preventDefault(),v.stopPropagation(),g();return}if(v.shiftKey&&S==="M"){v.preventDefault(),v.stopPropagation(),a.isOpen()?a.close():a.open();return}if(v.shiftKey&&S==="A"){v.preventDefault(),v.stopPropagation(),s.isOpen()?s.close():s.open();return}if(v.shiftKey&&S==="Z"){if(v.preventDefault(),v.stopPropagation(),d){try{d.abort()}catch{}d=null}u&&(clearTimeout(u),u=null),o.isActive()?o.abort():e.flash("Abortado"),c=!1,t.setState("idle");return}if(v.shiftKey&&S==="R"){v.preventDefault(),v.stopPropagation(),g();return}if(v.shiftKey&&S==="H"){v.preventDefault(),v.stopPropagation(),i.toggle();return}if(v.shiftKey&&(S==="V"||S==="v")){v.preventDefault(),v.stopPropagation(),i.openTab("media"),e.flash("M\xEDdias IA");return}if(v.shiftKey&&S==="I"){v.preventDefault(),v.stopPropagation(),e.reshow();return}if(v.shiftKey&&S==="C"){v.preventDefault(),v.stopPropagation(),r.isOpen()?r.close():r.open();return}S==="Escape"&&(a.isOpen()||s.isOpen()||r.isOpen()||i.isOpen())&&(v.stopPropagation(),v.preventDefault(),b())}window.addEventListener("keydown",x,{capture:!0}),window.__eqdiscrete={analyze:()=>g(),destroy:()=>{window.removeEventListener("keydown",x,{capture:!0}),u&&clearTimeout(u),o.destroy(),i.destroy(),a.destroy(),s.destroy(),r.destroy(),f.stop(),t.destroy(),e.destroy(),n.clearAll(),delete window.__eqdiscrete}}}})();
