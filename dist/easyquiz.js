 ...
 */
"use strict";(()=>{var ne={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function V(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ge="easyquiz_settings_v2",re="easyquiz_activity_metrics";function Fe(){try{let o=localStorage.getItem(Ge);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...ne,apiKey:s.apiKey||""}}return{...ne}}let e=JSON.parse(o),t=typeof e.model=="string"&&V(e.model)?e.model:ne.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&i&&(a=[i]),{apiKey:a[0]||i||ne.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ne.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ne.confidenceThreshold}}catch{return{...ne}}}function xt(){try{localStorage.removeItem(Ge),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(re),sessionStorage.removeItem(re);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Qe()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function ye(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ue(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...ye(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function qt(o){let e=Fe(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let i={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ge,JSON.stringify(i))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return i}var se=[],yt=12,Ut=1200;function wt(o){let e=o.trim().replace(/\s+/g," ").slice(0,Ut);e&&!se.includes(e)&&(se.push(e),se.length>yt&&(se=se.slice(-yt)))}function ke(){return se}function Qe(){se=[]}function Et(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var ve=Et();function xe(){try{localStorage.removeItem(re)}catch{}return ve}function Qt(o){ve=o;try{let e=JSON.stringify(o);sessionStorage.setItem(re,e),localStorage.removeItem(re)}catch{}}function Ct(o){let e=ve,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let i={...o,timestamp:t},n=[...e.records,i],l=n.filter(d=>d.status==="answered"||d.status==="verified").length,s=n.reduce((d,p)=>d+p.durationMs,0),r=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:r,records:n};return Qt(c),c}function qe(){ve=Et();try{sessionStorage.removeItem(re),localStorage.removeItem(re)}catch{}return ve}var Tt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown ou conversa.
...
[RESPOSTAS]:
${(()=>{if(c.length===0)return"Nenhuma";let h=c.filter(w=>w.type==="checkbox"||w.type==="chk"),f=new Set(c.filter(w=>w.type==="radio").map(w=>w.name).filter(Boolean)),v=h.filter(w=>!w.name||!f.has(w.name)),y=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),m=v.length>=2||y,b=c.every(w=>w.type==="radio"||w.type==="chk")&&f.size>=1&&!m,g=c.filter(w=>w.type==="text"||w.type==="number"||w.type==="val"||w.tag==="input"||w.tag==="textarea"),x=g.length>=2;return(m?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:b?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:x?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${g.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${g.length} campos abaixo com seu id exato]
`:"")+JSON.stringify(c.map(w=>({id:w.id,t:w.type,n:w.name||void 0,txt:w.label?w.label.length>160?w.label.slice(0,160)+"...":w.label:void 0,v:w.value||void 0,opt:w.options&&w.options.length?w.options.slice(0,20).map(E=>E.label||E.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${d.length>0?d.map(h=>`"${h.label||h.id}"[${h.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length>0?e.map((h,f)=>`  - Imagem ${f+1}: ${h.associatedLabel||"Gr\xE1fico da Quest\xE3o"}${h.alt?` (Texto alt: "${h.alt}")`:""}`).join(`
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Jt=new Set(["question","info","start","conclusion"]),Xt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Wt=new Set(["val","chk","sel","clk","adv","js","drag"]),Zt=150,Ee=2e3;function J(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Ee):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Ee):e}function eo(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!Wt.has(a))return null;if(a==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...J(s)?{id:J(s,"").slice(0,500)}:{}}}if(a==="drag"){let s=J(t.from??t.source),r=J(t.to??t.target??t.destination);return!s||!r?null:{t:"drag",from:s.slice(0,500),to:r.slice(0,500)}}if(a==="js"){let s=J(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&a==="val"&&(i="1");let n=J(i).slice(0,500);if(!n)return null;if(a==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:J(s).slice(0,Ee)}}if(a==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,c=(Array.isArray(s)?s:[s]).map(d=>J(d).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:c}}if(a==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",r={t:"chk",id:n,c:!s};return t.v!==void 0&&(r.v=J(t.v).slice(0,Ee)),r}let l={t:"clk",id:n};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";l.c=!s}return t.v!==void 0&&(l.v=J(t.v).slice(0,Ee)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(l.co=[t.co[0],t.co[1]]),l}function to(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),i=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){i=i.filter(l=>!(l.t==="chk"&&l.c===!1||l.t==="clk"&&l.c===!1));let n=i.filter(l=>l.t==="chk"||l.t==="clk");if(n.length>1){let l=i.filter(r=>r.t!=="chk"&&r.t!=="clk"),s=n[n.length-1];i=[...l,s]}}else if(e==="escolha_multipla"){i=i.filter(l=>!(l.t==="chk"&&l.c===!1||l.t==="clk"&&l.c===!1));let n=new Set;i=i.filter(l=>{let s="id"in l&&typeof l.id=="string"?l.id:"";return s?n.has(s)?!1:(n.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,l=[...i].reverse(),s=[];for(let r of l){let c="id"in r&&typeof r.id=="string"?r.id:"";c?n.has(c)||(n.add(c),s.push(r)):s.push(r)}i=s.reverse()}return[...i,...a]}function At(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!Jt.has(t))&&(t="question"),(typeof a!="string"||!Xt.has(a))&&(a="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],n=[];for(let r=0;r<Math.min(i.length,Zt);r++){let c=eo(i[r],r);c&&n.push(c)}n.some(r=>r.t==="val")&&(a==="escolha_unica"||!e.mode)&&(a="preenchimento"),n=to(n,a,t);let l=n.some(r=>r.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?l||n.push({t:"adv"}):t==="question"&&!l&&n.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:s,rationale:J(e.rationale,"Plano validado e auto-recuperado."),actions:n,...J(e.memoryToStore)?{memoryToStore:J(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var ee=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear(),Array.from(new Set(e.map(i=>i.trim().replace(/^["']|["']$/g,"")).filter(i=>i.length>5))).forEach((i,n)=>{let l=this.generateId(i),s=t.get(l)||t.get(i);this.keys.set(l,{id:l,key:i,label:s?.label||`Chave ${n+1}`,addedAt:s?.addedAt||Date.now(),lastUsedAt:s?.lastUsedAt,lastLatencyMs:s?.lastLatencyMs,cooldownUntil:s?.cooldownUntil,errorCount:s?.errorCount||0,lastError:s?.lastError,winCount:s?.winCount||0})})}generateId(e){let t=0;for(let a=0;a<e.length;a++)t=(t<<5)-t+e.charCodeAt(a),t|=0;return`key_${Math.abs(t).toString(36).slice(0,8)}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<5)}getBestKey(){let e=this.getHealthyKeys();if(e.length>0)return e.sort((a,i)=>{let n=a.lastLatencyMs??99999,l=i.lastLatencyMs??99999;return n-l}),e[0].key;let t=Array.from(this.keys.values());return t.length>0?(t.sort((a,i)=>(a.cooldownUntil||0)-(i.cooldownUntil||0)),t[0].key):""}getDiverseKeys(e){let t=this.getHealthyKeys();if(t.length===0){let i=this.getBestKey();return i?[i]:[]}t.sort((i,n)=>{let l=i.lastLatencyMs??99999,s=n.lastLatencyMs??99999;return l-s});let a=[];for(let i=0;i<e;i++){let n=t[i%t.length];a.push(n.key)}return a}markQuotaHit(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${t/1e3}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${t/1e3}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(a);if(this.keys.has(i))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let n={id:i,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,n),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:n}}updateKey(e,t,a){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=n,a!==void 0&&(i.label=a.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},k=new ee;var de=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico)",description:"Modelo econ\xF4mico de alta velocidade para volume elevado.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Legacy R\xE1pido)",description:"Modelo legacy com zero-thinking suportado. Ultra-baixa lat\xEAncia.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Legacy Avan\xE7ado)",description:"Modelo legacy avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Ye=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash"],oo={"gemini-2.5-flash":"gemini-3.6-flash","gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash"};function Je(o){return oo[o]??o}var Ce=null;function no(o){let e={temperature:0,maxOutputTokens:1500,responseMimeType:"application/json",responseSchema:Lt,response_mime_type:"application/json",response_schema:Lt};return/lite/i.test(o)||(/gemini-3\.[567]-flash/i.test(o)?e.thinkingConfig={thinkingLevel:"none"}:/gemini-3\.[89]|gemini-3\.[1-9][0-9]/i.test(o)?e.thinkingConfig={thinkingLevel:"low"}:/gemini-2\.5-flash/i.test(o)&&(e.thinkingConfig={thinkingBudget:0})),e}var Lt={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function St(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");return!e||!V(e)?"gemini-3.5-flash-lite":e}function kt(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function ao(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}try{let i=e.indexOf("{");if(i!==-1){let n=e.slice(i).trim();n=n.replace(/,\s*\{[^}]*$/,""),n=n.replace(/,\s*$/,"");let l=0,s=0,r=!1,c=!1;for(let p=0;p<n.length;p++){let u=n[p];if(c){c=!1;continue}if(u==="\\"){c=!0;continue}if(u==='"'){r=!r;continue}r||(u==="{"?l++:u==="}"?l=Math.max(0,l-1):u==="["?s++:u==="]"&&(s=Math.max(0,s-1)))}for(r&&(n+='"');s>0;)n+="]",s--;for(;l>0;)n+="}",l--;let d=JSON.parse(n);if(d&&typeof d=="object")return d}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Ht=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&V(a.id));return t.length>0?t:null}return null}catch{return null}})(),He=new Set;async function ze(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return de;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let i=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let l=await i.text(),s=kt(l,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let n=await i.json();if(Array.isArray(n.models)&&n.models.length>0){let l=n.models.filter(s=>{let r=s.supportedGenerationMethods||[],c=(s.name||"").replace(/^models\//,""),d=r.includes("generateContent");return V(c)&&d}).map(s=>{let r=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),d=s.displayName||c;return{id:c,name:d.includes(c)?d:`${d} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:r.includes("generateContent"),supportedGenerationMethods:r,discoveredAt:Date.now()}});if(l.length>0){l.sort((s,r)=>{let c=d=>d==="gemini-3.8-flash"?200:d==="gemini-3.7-flash"?190:d==="gemini-3.6-flash"?180:d==="gemini-3.5-flash"?170:d==="gemini-3.5-flash-lite"?160:d==="gemini-2.5-flash"?130:d.includes("flash")?80:d==="gemini-2.5-pro"?60:d.includes("pro")?50:10;return c(r.id)-c(s.id)}),Ht=l;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(l))}catch{}return l}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return de}async function $e(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await ze(e);if(a.length>0&&a!==de){let i=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let i of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${i}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${i})!`,models:de}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function Xe(o,e){let t=e.map(c=>c.trim().replace(/^["']|["']$/g,"")).filter(c=>c.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=Je(St(o)),i=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function l(c,d,p){let u=new AbortController,h=setTimeout(()=>u.abort(),p);try{let f=`https://generativelanguage.googleapis.com/v1beta/models/${d}:generateContent?key=${encodeURIComponent(c)}`,v=await fetch(f,{method:"POST",headers:{...n,"x-goog-api-key":c},body:i,signal:u.signal});if(clearTimeout(h),v.ok)return{ok:!0,model:d,key:c,message:`Modelo '${d}' validado com sucesso!`};let y=await v.text().catch(()=>"");throw new Error(`HTTP ${v.status}: ${y.slice(0,80)}`)}catch(f){throw clearTimeout(h),f}}if(t.length>=2){let c=t.slice(0,6);try{return await Promise.any(c.map(p=>l(p,a,8e3)))}catch{}}let s=t[0],r=[a,...Ye.filter(c=>c!==a)];for(let c of r)try{let d=await l(s,c,4e3);return c!==a&&(d.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${c}'.`),d}catch{}return{ok:!1,model:a,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function io(o,e,t,a,i){let n=["v1beta","v1"],l=new Error(`Falha ao consultar modelo ${o}`),r={...no(o)};for(let c of n){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let d=`https://generativelanguage.googleapis.com/${c}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,p=Date.now();try{let u=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:r}),signal:i,keepalive:a});if(!u.ok){let v=await u.text();if(u.status===400&&r.thinkingConfig&&/thinking/i.test(v)){delete r.thinkingConfig;let m=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:r}),signal:i,keepalive:a});if(m.ok){let b=await m.json(),g=b.candidates?.[0];if(g?.content?.parts?.[0]?.text)return k.markSuccess(e,Date.now()-p),{rawText:g.content.parts[0].text,data:b,usedModel:o,usedKey:e}}}let y=kt(v,u.status);if(u.status===404&&c==="v1beta")continue;throw u.status===429?k.markQuotaHit(e,5e3):u.status===503||/no capacity|overloaded|unavailable/i.test(v)?(k.markOverloaded(e,5e3),He.add(o)):u.status===403||/API_KEY_INVALID/i.test(v)?k.markInvalid(e,y):u.status===404&&He.add(o),new Error(`[${o}|${ee.maskKey(e)}] ${y}`)}let h=await u.json(),f=h.candidates?.[0];if(!f||!f.content?.parts?.[0]?.text)throw new Error(`[${o}|${ee.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return k.markSuccess(e,Date.now()-p),{rawText:f.content.parts[0].text,data:h,usedModel:o,usedKey:e}}catch(u){if(i.aborted)throw u;l=u;let h=l.message||"";if(h.includes("404")||/no longer available/i.test(h)){He.add(o);break}}}throw l}var Ie=new Map;function Mt(o){let e=Ie.get(o);return e===void 0?!1:Date.now()>e?(Ie.delete(o),!1):!0}function so(o,e=6e4){Ie.set(o,Date.now()+e)}function It(){Ie.clear()}async function We(o,e,t,a,i){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let n=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];k.init(n);let l=t.apiKey.trim().replace(/^[\"']|[\"']$/g,""),s=k.getBestKey()||l;if(!s)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let r=St(t.model);if(!Ht&&s&&ze(s).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let c=Date.now(),d=we(o,e,t),p=[{text:d}];for(let S=0;S<e.length;S++){let I=e[S],$=I.associatedLabel||(I.alt?`Imagem: ${I.alt}`:`Imagem ${S+1}`);p.push({text:`[ANEXO VISUAL ${S+1} - V\xCDNCULO: ${$}]:`}),p.push({inline_data:{mime_type:I.mediaType,data:I.base64}})}let u={system_instruction:{parts:[{text:Tt}]},contents:[{role:"user",parts:p}]},h=!0;He.clear();let f=Je(r),v=Ce?Je(Ce):null,y=[];v&&V(v)&&v!==f&&y.push(v);for(let S of Ye)S!==f&&!y.includes(S)&&y.push(S);let m=[];V(f)&&m.push(f);for(let S of y)V(S)&&!m.includes(S)&&m.push(S);m.length<2&&m.push(...Ye.filter(S=>!m.includes(S)));let b=k.getHealthyKeys().filter(S=>!Mt(S.key)).sort((S,I)=>(S.lastLatencyMs??99999)-(I.lastLatencyMs??99999)),g=k.getAllKeys().filter(S=>!Mt(S.key)),x=b.length>0?b:g.map(S=>({key:S.key,lastLatencyMs:S.lastLatencyMs,label:S.label})),A=new Set;function w(S,I,$,Q){let Y=[];for(let D of I){for(let j of S){let Z=`${j.key}::${D}`;!A.has(Z)&&Y.length<$&&(Y.push({model:D,key:j.key,label:j.label||"Chave",timeout:Q}),A.add(Z))}if(Y.length>=$)break}return Y}let E=async(S,I)=>{if(I.length===0||i?.aborted)return null;let $=I.map(()=>new AbortController),Q=()=>$.forEach(D=>{try{D.abort()}catch{}});i?.addEventListener("abort",Q,{once:!0});let Y=I.map(D=>`${D.model.replace("gemini-","")}/${D.label}`).join(" | ");a?.(`\u26A1 ${S}: ${I.length} slot(s) [${Y}]...`,"info");try{let D=I.map(async(Z,ft)=>{let je=$[ft],bt=setTimeout(()=>{try{je.abort(new Error(`Timeout ${Z.timeout/1e3}s (${Z.model}|${Z.label})`))}catch{je.abort()}},Z.timeout);try{let F=await io(Z.model,Z.key,u,h,je.signal);clearTimeout(bt);let W=At(ao(F.rawText));return W.usedModel=F.usedModel,W.durationMs=Date.now()-c,W.promptSent=d,W.tokensUsed=F.data.usageMetadata?.totalTokenCount,W.promptTokens=F.data.usageMetadata?.promptTokenCount,W.candidatesTokens=F.data.usageMetadata?.candidatesTokenCount,W.rawResponse=F.rawText,$.forEach((vt,Ft)=>{if(Ft!==ft)try{vt.abort(new Error("Cancelado: vencedor respondeu."))}catch{vt.abort()}}),{plan:W,rawUsage:F.data.usageMetadata,usedModel:F.usedModel,usedKey:F.usedKey,slotLabel:Z.label}}catch(F){clearTimeout(bt);let W=F instanceof Error?F.message:String(F);throw(W.includes("429")||W.includes("Quota")||W.includes("RESOURCE_EXHAUSTED"))&&so(Z.key,6e4),F}}),j=await Promise.any(D);return i?.removeEventListener("abort",Q),k.markWinner(j.usedKey),j.usedModel!==f&&(Ce=j.usedModel),j}catch(D){return i?.removeEventListener("abort",Q),D instanceof AggregateError&&D.errors.length>0?te=D.errors.map(j=>j instanceof Error?j.message:String(j)).join(" | "):D instanceof Error&&(te=D.message),console.warn(`[EasyQuiz ${S}] Falha na onda:`,te),null}},C=x.length,H=Math.min(Math.max(C,2)+(C>=2&&C<6?1:0),6),R=/pro/i.test(f),_=(S,I)=>{let $=I?/pro/i.test(I):R,Q=I?/lite/i.test(I):/lite/i.test(f);return S===0?$?15e3:Q?8e3:9e3:S===1?$?18e3:Q?1e4:12e3:$?2e4:14e3},B=6,K=0,te="";for(;K<B;){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let S=m.find(D=>!Array.from(A).some(j=>j.startsWith(`${x[0]?.key}::${D}`)))??m[0],I=_(K,S),$=w(x,m,H,I);if($.length===0)break;let Q=K===0?"Onda 1":`Onda ${K+1}`,Y=await E(Q,$);if(Y){let D=Y.plan.durationMs||Date.now()-c,j=ee.maskKey(Y.usedKey);return a?.(`\u2705 ${D}ms via '${Y.usedModel}' (${Y.slotLabel}: ${j})`,"info"),Y}K++}throw new Error(te||"Todas as ondas falharam. Verifique sua cota e conex\xE3o com a internet.")}var ro=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Te(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function Ze(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function zt(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(ro.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var ue=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),Pe=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,lo=0;function et(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!pe(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function N(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function M(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||pe(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${N(e.id)}"]`);if(n&&et(n))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&et(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let l=e.getBoundingClientRect();if(l.width>0||l.height>0)return!0}return!0}}}catch{}}return et(e)}function co(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function z(o,e=500){return co(o).replace(/\s+/g," ").trim().slice(0,e)}function uo(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(lo+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function pe(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Ae=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function O(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(pe(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),l=String(a.getAttribute?.("title")||""),s=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",r=z(a.textContent,60);return!!(Ae.test(i)||Ae.test(n)||Ae.test(l)||Ae.test(s)||r.length>0&&r.length<=25&&Ae.test(r))}function oe(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||pe(o)||O(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=z(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,i=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return Pe.test(i)||Pe.test(t)||a==="submit"||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")||!1}function tt(o){let e=o.closest("tr");if(e){let r=e.querySelector("th, td:first-child"),c=r&&r!==o.closest("td")?z(r.textContent,100):"",d=z(o.closest("label, td")?.textContent||"",50);if(c&&d)return`${c}: ${d}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let r=t.querySelector('.dropdown-label, [class*="label" i]'),c=r&&r!==o?z(r.textContent,150):"";if(c)return c}let a=o.getAttribute("aria-label");if(a)return z(a);let i=o.getAttribute("aria-labelledby");if(i){let r=i.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(r.trim())return z(r)}if("labels"in o&&o.labels){let r=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(r.trim())return z(r)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let r=z(n.textContent);if(r)return r}let l=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||l||"";return z(s)}function ot(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),l=["input","textarea","select","button"].includes(n)?n:"other",s=o.getAttribute("role")||"",r=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),d=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(r)||/drag|card-item|sortable/i.test(c),p=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(r)||/dropzone|category-box|bucket|target-zone/i.test(c),h=z((d?"draggable":p?"dropzone":"")||i.type||s||l,40),f="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox")f=i.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(l==="button"||n==="a"||e==="navigation"||oe(o))f="";else{let x=typeof o.value=="string"||typeof o.value=="number"?o.value:"";f=z(x||o.getAttribute("data-category")||"",2e3)}let v=[];if(a&&a.options)for(let x of Array.from(a.options).slice(0,80))v.push({value:z(x.value),label:z(x.textContent)});else if(s==="combobox"||s==="listbox"||c.includes("select")||c.includes("dropdown")){let x=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),A=x?document.getElementById(x):o;if(A){let w=A.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let E of Array.from(w).slice(0,80)){let C=z(E.textContent);C&&v.push({value:E.getAttribute("data-value")||E.getAttribute("value")||C,label:C})}}}let y=!!(i.required||o.getAttribute("aria-required")==="true"),m=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),b=uo(o);return{id:o.id||b,tag:l,type:h,label:tt(o),name:z(i.name||o.getAttribute("name")||"",180),value:f,options:v,required:y,disabled:m,role:e}}var $t=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Pt(o){if(!M(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(ue)).filter(M),a=z(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),l=Math.min(1,n/i),s=e.top+e.height/2,r=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=a>40?35:0,d=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+c+d-l*20-r*10}function Re(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let i=z(e.innerText||e.textContent||"",1e4),n=z(t.innerText||t.textContent||"",1e4),l=e.querySelectorAll(ue).length,s=t.querySelectorAll(ue).length;if(i.length<150&&n.length>i.length&&s<=l+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Rt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&M(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function G(){let o=document.activeElement;if(o&&o!==document.body){let n=o.closest($t);if(n&&Pt(n)>0)return Re(n)}let t=Array.from(document.querySelectorAll($t)).map(n=>({element:n,score:Pt(n)})).filter(n=>Number.isFinite(n.score)).sort((n,l)=>l.score-n.score),a=t.find(n=>{let l=n.element.tagName.toLowerCase();return l!=="main"&&l!=="body"&&n.score>0});if(a)return Re(a.element);if(t.length>0&&t[0].score>0)return Re(t[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&M(i)?i:document.body}function Bt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let i of Array.from(a.attributes))t.includes(i.name)||a.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Be(o){let e=Array.from(o.querySelectorAll(ue)),t=new Set,a=[];for(let i of e){if(!M(i)||oe(i)||O(i))continue;let n=i.tagName.toLowerCase();["input","textarea","select"].includes(n)&&(t.add(i),a.push(i))}for(let i of e){if(!M(i)||oe(i)||O(i))continue;let n=i.tagName.toLowerCase();if(["input","textarea","select"].includes(n))continue;let l=i.querySelector("input, textarea, select");if(!(l&&t.has(l))){if(i.hasAttribute("for")){let s=i.getAttribute("for"),r=s?i.ownerDocument.getElementById(s):null;if(r&&t.has(r))continue}if(n==="a"){let s=i.getAttribute("role");if(!(s==="button"||s==="radio"||s==="checkbox"||s==="option"||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(i)}}return a.slice(0,100).map(i=>ot(i,"answer"))}function nt(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let i of e)for(let n of Array.from(i.querySelectorAll(ue)))if(!(t.has(n)||!M(n)||!oe(n)||O(n))&&(t.add(n),a.push(ot(n,"navigation")),a.length>=10))return a;return a}function Le(o=!1){let e=G();e=Re(e),o&&(e=Rt(e));let t=Be(e),a=nt(e);if(t.length===0){let s=Be(document.body);s.length>0&&(e=Rt(e),t=Be(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=nt(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=z(i,16e3),l=[...t,...a].slice(0,120);return!n||l.length===0&&n.length<30?z(document.body.innerText||document.body.textContent||"",16e3).length>=30?he():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:Bt(e),controls:l,scope:e}}function he(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=z(o,16e3),t=Be(document.body),a=nt(document.body),i=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Bt(n).slice(0,15e3),controls:i,scope:n}}function Nt(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function P(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function q(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function U(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let i=o.ownerDocument.getElementById(a);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return U(a)}return o}function Ot(o){let e=o;if(!e||!document.contains(e))try{e=G()}catch{}e=e||document.body;let t=i=>{let n=Array.from(i.querySelectorAll("tr")).filter(r=>M(r)&&r.querySelector('input[type="radio"], input[type="checkbox"]'));if(n.length>1)return n;let l=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(r=>M(r)&&!P(r));return l.length>0?l:Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(r=>M(r)&&!P(r)).filter(r=>!r.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'))},a=t(e);return a.length>0?a:e!==document.body?t(document.body):[]}function L(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let n=N(i),l=document.querySelector(`[data-easyquiz-id="${n}"]`);if(l&&!P(l))return U(l);try{let u=document.getElementById(i);if(u&&M(u)&&!P(u))return u.hasAttribute("data-category")||u.hasAttribute("data-dropzone")||u.classList.contains("dnd-zone")?u:U(u)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let u=parseInt(s[1],10);if(t){let f=document.body;try{f=G()||document.body}catch{}let v=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(y=>M(y)&&!P(y));if(u>=1&&u-1<v.length)return v[u-1];if(u===0&&v.length>0)return v[0]}let h=u-1;if(h>=0){let f=Ot();if(h<f.length){let m=f[h];if(m.tagName.toLowerCase()==="tr"){if(e){let g=m.querySelector(`input[value="${N(e)}" i], [data-value="${N(e)}" i]`);if(g)return g}let b=m.querySelector("input");if(b)return b}return U(m)}let v=document.body;try{v=G()||document.body}catch{}let y=Array.from(v.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(m=>M(m)&&!P(m));if(h<y.length)return y[h]}}let r=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(r){let u=r[1].toUpperCase().charCodeAt(0)-65;if(u>=0){let h=Ot();if(u<h.length){let f=h[u];if(f.tagName.toLowerCase()==="tr"){if(e){let y=f.querySelector(`input[value="${N(e)}" i], [data-value="${N(e)}" i]`);if(y)return y}let v=f.querySelector("input");if(v)return v}return U(f)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let h=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(m=>M(m)&&!P(m));if(h)return h;let v=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(m=>M(m)&&!P(m));if(v)return U(v);let y=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(m=>{if(!M(m)||P(m))return!1;let b=q(m.textContent).toLowerCase();return b===i.toLowerCase()||b===i.toLowerCase()+")"});if(y)return U(y)}try{let h=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`)).find(f=>M(f)&&!P(f));if(h)return h.hasAttribute("data-category")||h.hasAttribute("data-dropzone")||h.classList.contains("dnd-zone")?h:U(h)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let h=Array.from(document.querySelectorAll(i)).find(f=>M(f)&&!P(f));if(h)return U(h)}catch{}try{let u=i.replace(/"/g,""),h=`//button[normalize-space(.)="${u}"] | //a[normalize-space(.)="${u}"] | //*[not(*) and normalize-space(.)="${u}"] | //*[@aria-label="${u}"] | //*[@data-category="${u}"] | //*[@data-testid="${u}"]`,f=document.evaluate(h,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let v=0;v<f.snapshotLength;v++){let y=f.snapshotItem(v);if(y&&M(y)&&!P(y)){if(["body","html"].includes(y.tagName.toLowerCase())){let b=y.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&M(b))return U(b)}return y.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||U(y)}}}catch{}let d=q(i).toLowerCase(),p=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let u of p){if(!M(u)||P(u)||u.closest("header, nav, .stepper, .step-item, .progress-bar-container")||O(u)||!!(u.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||u.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!u.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let f=q(u.textContent).toLowerCase(),v=q(u.getAttribute("aria-label")||"").toLowerCase(),y=q(u.getAttribute("placeholder")||"").toLowerCase(),m=q(u.getAttribute("title")||"").toLowerCase(),b=q(u.getAttribute("name")||"").toLowerCase(),g=q(u.getAttribute("data-category")||"").toLowerCase(),x=u instanceof HTMLInputElement||u instanceof HTMLButtonElement?u.value:"",A=q(x).toLowerCase(),w=f.startsWith(d+")")||f.startsWith(d+".")||f.startsWith(d+" -")||f.startsWith(d+":");if(f===d||v===d||y===d||m===d||b===d||g&&g===d||A&&A===d||w)return u.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||U(u)}if(d.length>=3)for(let u of p){if(!M(u)||P(u)||u.closest("header, nav, .stepper, .step-item, .progress-bar-container")||O(u)||!!(u.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||u.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!u.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let f=q(u.textContent).toLowerCase(),v=q(u.getAttribute("aria-label")||"").toLowerCase(),y=q(u.getAttribute("placeholder")||"").toLowerCase(),m=q(u.getAttribute("title")||"").toLowerCase(),b=q(u.getAttribute("name")||"").toLowerCase();if(f.includes(d)||v.includes(d)||y.includes(d)||m.includes(d)||b.includes(d)){if(Array.from(u.children).some(w=>{let E=q(w.textContent).toLowerCase();return E&&E.includes(d)}))continue;return u.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||U(u)}let g=d.split(/\s+/).filter(Boolean);if(g.length>=3){let x=g.slice(0,Math.min(5,g.length)).join(" ");if(f.includes(x)||v.includes(x)||y.includes(x))return U(u)}}return null}function Vt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function X(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement||typeof HTMLAnchorElement<"u"&&o instanceof HTMLAnchorElement||o.tagName?.toLowerCase()==="a"||o.tagName?.toLowerCase()==="button"||typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type),a=o.getBoundingClientRect(),i=e?e[0]:Math.round(a.left+Math.max(1,a.width/2)),n=e?e[1]:Math.round(a.top+Math.max(1,a.height/2)),l={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:n};try{o.dispatchEvent(new PointerEvent("pointerover",{...l}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...l}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...l,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...l,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...l,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...l,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...l,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function Ne(o,e){let t=o;if(t.hasAttribute("for")){let c=t.getAttribute("for"),d=t.ownerDocument.getElementById(c);d&&(t=d)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Oe(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){Oe(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)t=c;else{let p=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(p)t=p;else{let u=t.nextElementSibling;for(;u;){if(u instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(u.type)||u instanceof HTMLTextAreaElement||u instanceof HTMLElement&&u.isContentEditable){t=u;break}let h=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h){t=h;break}u=u.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let c=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{let d=document.body;try{d=G()||document.body}catch{}let p=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p)t=p;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=document.body;try{c=G()||document.body}catch{}let d=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d)t=d;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;ie(t,c);return}let l=String(e??""),s=l;if(t instanceof HTMLInputElement&&t.type==="number"){let c=l.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(s=c)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let r=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}r=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}r=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let p=t._valueTracker;p&&p.setValue(s===""?" ":"")}catch{}let c=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(c,"value")?.set;d?d.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{d?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Me(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=q(t),n=L(t)||L(i);if(!n)return a?e:i||e;let l=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(l){let p=q(l.textContent);if(p&&p.length>0&&p.length<150)return p}if(n.id){let p=document.querySelector(`label[for="${N(n.id)}"]`);if(p){let u=q(p.textContent);if(u&&u.length>0&&u.length<150)return u}}let s=n.getAttribute("aria-label");if(s)return q(s);let r=n.getAttribute("placeholder");if(r)return q(r);let c=q(n.textContent);if(c&&c.length>0&&c.length<120)return c;let d=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return d?q(d):a?e:i||e}function ie(o,e){if(!o)return;let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li, tr')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for")));let i=t&&M(t)?t:o;if(a){let n=a.type==="radio",l=a.type==="checkbox",s=!!a._valueTracker;if(a.checked===e){if(n&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(l){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}i&&i!==a&&X(i);try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let c=a._valueTracker;c&&c.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,Vt(a,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;X(i),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Oe(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let l=e.map(c=>q(c).toLowerCase()),s=!1,r=(c,d)=>{c.selected=!0,t.selectedIndex=d;try{t.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,c.value)}catch{}try{let p=t._valueTracker;p&&p.setValue(c.value)}catch{}s=!0};for(let c=0;c<t.options.length;c++){let d=t.options[c],p=d.value.toLowerCase(),u=q(d.textContent).toLowerCase();if(l.some(f=>f===p||f===u)){if(r(d,c),!t.multiple)break}else t.multiple||(d.selected=!1)}if(!s)for(let c of l){let d=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(d){let p=parseInt(d[1],10),h=t.options[0]?.value===""||t.options[0]?.disabled?p:p>=1?p-1:0;if(h>=0&&h<t.options.length&&(r(t.options[h],h),!t.multiple))break}}if(!s){for(let c of l)if(/^[a-z]$/i.test(c)){let d=c.toUpperCase().charCodeAt(0)-65,u=t.options[0]?.value===""||t.options[0]?.disabled?d+1:d;if(u>=0&&u<t.options.length&&(r(t.options[u],u),!t.multiple))break}}if(!s){let c=d=>d.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let d=0;d<t.options.length;d++){let p=t.options[d],u=c(p.value.toLowerCase()),h=c(q(p.textContent).toLowerCase());if(l.some(v=>{let y=c(v);return u.includes(y)||h.includes(y)||y.length>2&&(y.includes(u)||y.includes(h))})&&(r(p,d),!t.multiple))break}}if(s){Vt(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&X(a);let i=e.map(l=>q(l).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(l=>M(l)&&!P(l));for(let l of i){let s=n.find(c=>{let d=q(c.textContent).toLowerCase(),p=q(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return d===l||p===l||d.includes(l)||l.length>2&&l.includes(d)});if(s){X(s);let c=s.querySelector('input[type="radio"], input[type="checkbox"]');c&&ie(c,!0);return}let r=L(l);if(r){X(r);return}}}function po(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function at(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function ae(o,e){let t=q(o).toLowerCase();if(!t)return null;let a=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',i=Array.from(document.querySelectorAll(a)),n=e==="destination"?i.find(l=>[l.getAttribute("data-category"),l.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t)):null;return n&&M(n)&&!P(n)?n:i.find(l=>{if(!M(l)||P(l))return!1;let s=q(`${l.textContent||""} ${l.getAttribute("data-category")||""} ${l.getAttribute("data-dropzone")||""}`).toLowerCase();return s===t||s.includes(t)})||null}async function De(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),i=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),l=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),r=Math.round(i.top+Math.max(1,i.height/2)),c=q(e.textContent).toLowerCase();if(c){let v=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(y=>{let m=q(y.textContent).toLowerCase(),b=y instanceof HTMLInputElement||y instanceof HTMLOptionElement?q(y.value).toLowerCase():"";return m&&(c.includes(m)||m.includes(c))||b&&(c.includes(b)||b.includes(c))});v&&(X(v),await new Promise(y=>setTimeout(y,120)))}at(o),await new Promise(f=>setTimeout(f,140)),at(e);let d=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(d&&d!==e&&at(d),await new Promise(f=>setTimeout(f,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:l,screenX:n,screenY:l,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",p));let u=4;for(let f=1;f<=u;f++){let v=Math.round(n+(s-n)*(f/u)),y=Math.round(l+(r-l)*(f/u)),m={...p,clientX:v,clientY:y,screenX:v,screenY:y};try{o.dispatchEvent(new PointerEvent("pointermove",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",m))}let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:r,screenX:s,screenY:r,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",h)),e.dispatchEvent(new MouseEvent("click",h));try{let f=po(z(o.textContent),o.outerHTML),v={...p},y={...h};f&&(v.dataTransfer=f,y.dataTransfer=f);let m=o.ownerDocument.defaultView?.DragEvent;if(!m)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new m("dragstart",v)),e.dispatchEvent(new m("dragenter",y)),e.dispatchEvent(new m("dragover",y)),e.dispatchEvent(new m("drop",y)),o.dispatchEvent(new m("dragend",v))}catch(f){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",f)}try{let f=new Touch({identifier:1,target:o,clientX:n,clientY:l}),v=new Touch({identifier:1,target:e,clientX:s,clientY:r});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[v]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(f=>setTimeout(f,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var _t={fill:(o,e)=>{let t=L(o);t?Ne(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=L(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?ie(e,!0):X(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=L(o);t?ie(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>L(o,e),drag:(o,e)=>{let t=ae(o,"source")||L(o),a=ae(e,"destination")||L(e);t&&a?De(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=ae(o,"source")||L(o),a=ae(e,"destination")||L(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await De(t,a)},execute:(o,e=!1,t=1)=>rt(o,e,t)};typeof window<"u"&&(window.$eq=_t);async function ho(o,e=1,t=Te()){if(Ze(o,t),o.t==="js"){let s=String(o.v||"");zt(s);try{new Function("$eq","document","window",s)(_t,document,window)}catch(r){throw console.warn("[EasyQuiz JS Execution]",r),r}return}if(o.t==="drag"){let s=ae(o.from,"source")||L(o.from),r=ae(o.to,"destination")||L(o.to);!s&&o.from&&(s=L(q(o.from))),!r&&o.to&&(r=L(q(o.to))),s&&r?await De(s,r,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=i!=null?String(i).trim():"",l=L(a,n,o.t==="val"||o.t==="sel");if(!l&&a&&(l=L(q(a),n,o.t==="val"||o.t==="sel")),l&&n){if(l instanceof HTMLInputElement&&l.type==="radio"&&l.name){if(q(l.value).toLowerCase()!==q(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${N(l.name)}"][value="${N(n)}" i]`);if(s)l=s;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${N(l.name)}"]`)).find(d=>{let p=d.closest("label, .vf-label, .option-card, tr, td, div");return p&&q(p.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(l=c)}}}else if(!(l instanceof HTMLInputElement)&&!(l instanceof HTMLSelectElement)&&!(l instanceof HTMLTextAreaElement)){let s=l.querySelector(`input[value="${N(n)}" i], [data-value="${N(n)}" i]`);if(s)l=s;else{let c=Array.from(l.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(d=>{let p=d.closest("label, .vf-label, .option-card, td, div");return p&&q(p.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(l=c)}}}if(!l&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=G()||document.body}catch{}let r=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(c=>M(c)&&!P(c));if(r.length===1)l=r[0];else if(r.length>1){let c=q(a).toLowerCase(),d=c.match(/^#?_?([0-9]+)$/);if(d){let p=parseInt(d[1],10);p>=1&&p<=r.length?l=r[p-1]:p>=0&&p<r.length&&(l=r[p])}l||(l=r.find(u=>{let h=(u.getAttribute("placeholder")||"").toLowerCase(),f=(u.name||"").toLowerCase(),v=(u.getAttribute("aria-label")||"").toLowerCase(),y=(u.id||"").toLowerCase(),m=q(tt(u)).toLowerCase(),b=q(u.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return h.includes(c)||f.includes(c)||v.includes(c)||y.includes(c)||m&&m.includes(c)||c.length>=2&&b.includes(c)})||(r.length===1?r[0]:null))}}if(!l&&o.t!=="adv")throw new Error(`Alvo '${a}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);switch(o.t){case"val":if(l){let r=l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement||l instanceof HTMLSelectElement||l.isContentEditable?l:l.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!r){let u=l.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(r=u)}if(!r){let p=l.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){r=p;break}let u=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){r=u;break}p=p.nextElementSibling}}if(!r){let p=document.body;try{p=G()||document.body}catch{}let u=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>M(h)&&!P(h));u.length>0&&(r=u[0])}let c=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,d=c!=null?String(c):"";Ne(r||l,d)}break;case"chk":l&&ie(l,!!o.c);break;case"sel":if(l){let r=Array.isArray(o.v)?o.v:[String(o.v)];Oe(l,r)}break;case"clk":if(l)if(!!(l.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||l.querySelector('input[type="radio"], input[type="checkbox"]')||l instanceof HTMLInputElement&&["checkbox","radio"].includes(l.type))){let c=o.c!==void 0?!!o.c:!0;ie(l,c)}else X(l,o.co);break;case"adv":let s=it(o.id);if(s){await st(s,1200);let r=o.id||s.textContent?.trim()||"";r&&Ue(window.location.hostname,{advanceSelector:r}),X(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function mo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!M(t)||P(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function it(o){if(o){let n=L(o);if(n&&M(n)&&!P(n)&&!O(n))return n}try{let n=ye(window.location.hostname);if(n.advanceSelector){let l=L(n.advanceSelector);if(l&&M(l)&&!P(l)&&!O(l))return l}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(e)).filter(n=>M(n)&&!P(n)&&!n.closest("header, nav, aside")&&!O(n));for(let n of a)if(oe(n)&&!O(n))return n;for(let n of a){let l=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",s=(n.textContent||l||n.getAttribute("aria-label")||"").trim();if(Pe.test(s)&&!O(n))return n}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&M(i)&&!P(i)&&!O(i)?i:null}async function st(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function go(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function fo(o,e=3500){let[t,a,i,n]=o.split("|"),l=parseInt(n||"0",10),s=Date.now();for(;Date.now()-s<e;){let r=window.location.href,c=document.title,d=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),p=(document.body?.innerText||document.body?.textContent||"").length;if(r!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${r}`};if(c!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${c}"`};if(Math.abs(parseInt(d)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${d}`};if(Math.abs(p-l)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(p-l)} chars)`};await new Promise(u=>setTimeout(u,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Dt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let i=L(o.from)||L(q(o.from)),n=L(o.to)||L(q(o.to));i&&n&&await De(i,n,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=L(e,t)||L(q(e),t);if(o.t==="clk"||o.t==="chk"){if(!a&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),l=q(e).toLowerCase();a=n.find(s=>{let r=q(s.textContent).toLowerCase();return!!(q(s.value||"").toLowerCase()===l||r===l||r.startsWith(l+")")||r.startsWith("("+l+")")||r.startsWith(l+".")||r.startsWith(l+" - ")||r.startsWith(l+":")||l.length>=3&&r.includes(l))})||null}let i=o.v!==void 0?String(o.v).trim():"";if(a&&i){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(q(a.value).toLowerCase()!==q(i).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${N(a.name)}"][value="${N(i)}" i]`);if(n)a=n;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${N(a.name)}"]`)).find(r=>{let c=r.closest("label, .vf-label, .option-card, tr, td, div");return c&&q(c.textContent).toLowerCase().includes(q(i).toLowerCase())});s&&(a=s)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let n=a.querySelector(`input[value="${N(i)}" i], [data-value="${N(i)}" i]`);if(n)a=n;else{let s=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(r=>{let c=r.closest("label, .vf-label, .option-card, td, div");return c&&q(c.textContent).toLowerCase().includes(q(i).toLowerCase())});s&&(a=s)}}}if(a){let n=a.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,l=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(ie(l||n,s),l&&l.checked!==s){try{let r=l._valueTracker;r&&r.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(l,s)}catch{}l.checked=s,l.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),l.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let i=null;if(a&&(i=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let n=document.body;try{n=G()||document.body}catch{}let l=Array.from(n.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=q(e).toLowerCase();i=l.find(r=>{let c=(r.getAttribute("placeholder")||"").toLowerCase(),d=(r.name||"").toLowerCase(),p=(r.id||"").toLowerCase(),u=(r.getAttribute("aria-label")||"").toLowerCase();return c.includes(s)||d.includes(s)||p.includes(s)||u.includes(s)})||(l.length>0?l[0]:null)}if(i){let n=String(o.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,n)}}catch{}Ne(i,n)}return}if(o.t==="sel"){if(!a&&e){let i=Array.from(document.querySelectorAll("select")),n=q(e).toLowerCase();a=i.find(l=>{let s=(l.name||"").toLowerCase(),r=(l.id||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase();return s.includes(n)||r.includes(n)||c.includes(n)})||null}if(a){let i=Array.isArray(o.v)?o.v:[String(o.v)];Oe(a,i)}return}}function me(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let n=L(i,a,!0)||L(q(i),a,!0);if(!n){let p=document.body;try{p=G()||document.body}catch{}let u=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>M(h)&&!P(h));u.length>0&&(n=u[0])}if(!n)return!1;let l=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(l&&l.name){let p=document.querySelector(`input[type="radio"][name="${N(l.name)}"]:checked`);if(!p)return!1;let u=q(p.value).toLowerCase(),h=q(t).toLowerCase(),f=q(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===h||f===h||f.includes(h)}let s=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let u=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(s=u)}if(!s){let p=n.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){s=p;break}let u=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){s=u;break}p=p.nextElementSibling}}if(s instanceof HTMLSelectElement){let p=q(t).toLowerCase();return Array.from(s.options).some(u=>{if(!u.selected)return!1;let h=u.value.toLowerCase(),f=q(u.textContent).toLowerCase();return p===h||p===f||h.includes(p)||f.includes(p)})}let r=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??n.textContent??"").trim();if(!r&&!t)return!0;if(!r&&t)return!1;let c=r.replace(",",".").replace(/\s+/g,"").toLowerCase(),d=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return c===d||c.includes(d)||d.includes(c)||r.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=L(o.id,void 0,!0)||L(q(o.id),void 0,!0);if(!e){let n=document.body;try{n=G()||document.body}catch{}let l=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>M(c)&&!P(c)),s=q(o.id).toLowerCase();e=l.find(c=>{let d=(c.id||"").toLowerCase(),p=(c.getAttribute("name")||"").toLowerCase(),u=(c.getAttribute("aria-label")||"").toLowerCase(),h=q(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return d.includes(s)||p.includes(s)||u.includes(s)||s.length>=2&&h.includes(s)})||(l.length===1?l[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(c=>q(c).toLowerCase()),r=q(n.textContent).toLowerCase();return s.some(c=>r.includes(c)||c.includes(r))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>q(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let l=n.value.toLowerCase(),s=q(n.textContent).toLowerCase();return i.some(r=>r===l||r===s||l.includes(r)||s.includes(r))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=L(o.id,e)||L(q(o.id),e);if(!t)return!1;let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,i=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),n=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(i&&i.type==="radio"){if(i.checked===n)return!0;if(o.v&&i.name){let d=q(String(o.v)).toLowerCase(),p=document.querySelector(`input[type="radio"][name="${N(i.name)}"]:checked`);if(!p)return!1;if(p===i)return!0;let u=q(p.value).toLowerCase(),h=q(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===d||h.includes(d)||d.includes(u)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===n;let l=a.getAttribute("aria-checked")===String(n)||a.getAttribute("aria-selected")===String(n)||a.getAttribute("aria-pressed")===String(n),s=n?a.getAttribute("data-selected")==="true"||a.getAttribute("data-checked")==="true"||a.getAttribute("data-active")==="true"||a.getAttribute("data-state")==="checked"||a.getAttribute("data-state")==="on":a.getAttribute("data-selected")==="false"||a.getAttribute("data-checked")==="false"||a.getAttribute("data-state")==="unchecked",r=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||"");return!!(l||s||r||(a instanceof HTMLButtonElement||a.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!i)}if(o.t==="drag"){let e=L(o.from)||L(q(o.from)),t=L(o.to)||L(q(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function rt(o,e,t=1,a=Te({engine:"smart",autoAdvance:e})){let i=o.actions.filter(g=>g.t!=="adv"),n=o.actions.filter(g=>g.t==="adv"),l=0,s=[],r=new Map,c=o.pageType==="question",d=i.filter(g=>g.t==="chk"||g.t==="clk"&&g.c!==void 0);for(let g of i){try{await ho(g,t,a),l++}catch(x){r.set(g,x instanceof Error?x.message:String(x)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",g,x)}await new Promise(x=>setTimeout(x,g.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&d.length>0){let g=document.body;try{g=G()||document.body}catch{}let x=Array.from(g.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(A=>M(A)&&!P(A));if(x.length>1){let w=function(E,C){if(E===C||E.contains(C)||C.contains(E))return!0;let H=E.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),R=C.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(H&&R&&H===R)return!0;let _=E.getAttribute("for")||E.id,B=C.getAttribute("for")||C.id;return!!(_&&B&&_===B)};var b=w;let A=new Set;for(let E of d){let C=E.t==="chk"?!!E.c:!!(E.c??!0),H="id"in E&&typeof E.id=="string"?E.id:"";if(C&&H){let R=L(H,E.v);if(R){A.add(R);let _=R.querySelector('input[type="checkbox"]');_&&A.add(_);let B=R.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');B&&(A.add(B),B.querySelectorAll('input[type="checkbox"]').forEach(K=>A.add(K)))}}}if(A.size>=d.length&&A.size>0){let E=Array.from(A);for(let C of x)E.some(R=>w(R,C))||(C instanceof HTMLInputElement&&C.checked||C.getAttribute("aria-checked")==="true"||C.closest(".option-card, label")?.classList.contains("selected"))&&ie(C,!1)}}}await new Promise(g=>setTimeout(g,i.length>0?100:25));let p=0;for(let g of i){if(me(g)){p++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${g.t}' no alvo '${g.id||g.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ze(g,a),await Dt(g)}catch(x){r.set(g,x instanceof Error?x.message:String(x)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",x)}await new Promise(x=>setTimeout(x,250)),me(g)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),p++,r.has(g)&&(r.delete(g),l++))}if(p<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-p} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(g=>setTimeout(g,200));for(let g of i)if(!me(g))try{await Dt(g)}catch(x){r.set(g,x instanceof Error?x.message:String(x))}await new Promise(g=>setTimeout(g,200)),p=0;for(let g of i)me(g)&&(p++,r.has(g)&&(r.delete(g),l++))}for(let g of i)me(g)||s.push(g.t==="drag"?`${g.from} -> ${g.to}`:"id"in g?g.id:g.t);c&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let u=i.map((g,x)=>{let A=g.t==="drag"?`${g.from} -> ${g.to}`:g.t==="js"?"$eq":g.id||g.t,w=g.t==="js"?!0:g.t==="drag"?!!(ae(g.from,"source")&&ae(g.to,"destination")):!!(L(g.id||"")||L(q(g.id||""))),E=me(g);return{index:x,action:g,target:A,located:w,applied:!r.has(g),verified:E,strategy:g.t==="drag"?"drag-adaptive":g.t==="js"?"javascript":"declarative-dom",evidence:E?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...r.has(g)?{error:r.get(g)}:{}}}),h=c?i.length>0&&s.length===0&&(p===i.length||l===i.length&&p>0):!0,f=!1,v=!1,y="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",m=l>0&&l>=i.length/2;if(e&&(h||!c||m)){await new Promise(E=>setTimeout(E,i.length>0?120:40));let g=!1;if(o.pageType!=="info"){let E=mo();E&&M(E)&&(await st(E,1200),X(E),g=!0,await new Promise(C=>setTimeout(C,350)))}let x=go(),A=n.length>0?n[0].id:void 0,w=it(A);if(!w&&g&&(await new Promise(E=>setTimeout(E,250)),w=it(A)),w){await st(w,1500);let E=A||w.textContent?.trim()||"";E&&Ue(window.location.hostname,{advanceSelector:E}),X(w);let C=await fo(x,1800);v=C.changed,y=C.evidence,f=C.changed||g,!C.changed&&!g&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else g?(f=!0,v=!0,y="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:l,verified:p,success:h,advanced:f,failed:s,reports:u,navigationVerified:v,navigationEvidence:y}}var ge=null,le=[],lt=[],ct=[],fe=null,bo=`
...
`;function Kt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=bo,document.head.appendChild(o)}}catch{}}function ce(){ge&&(ge.style.removeProperty("outline"),ge.style.removeProperty("outline-offset"),ge.style.removeProperty("position"),ge=null);for(let o of le)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");le=[];for(let o of lt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");lt=[];for(let o of ct)try{o.remove()}catch{}if(ct=[],fe){try{fe.remove()}catch{}fe=null}}function dt(o){Kt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),lt.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),ct.push(n)}}catch{}}}function ut(o){ce(),Kt(),ge=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),fe=t,setTimeout(()=>{try{t.remove()}catch{}fe===t&&(fe=null)},900)}catch{}}function vo(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function jt(o,e){let t=vo(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let p=L(a.from),u=L(a.to);p&&(p.style.outline=`2px solid ${t.outline}`,le.push(p)),u&&(u.style.outline="2px dashed #00e5ff",le.push(u))}catch{}continue}if(!a.id)continue;let i=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=L(a.id,i,a.t==="val"||a.t==="sel")||L(q(a.id),i,a.t==="val"||a.t==="sel");if(!n&&a.t==="sel"){let p=document.body;try{p=G()||document.body}catch{}let u=Array.from(p.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>M(v)&&!pe(v)),h=q(a.id).toLowerCase();n=u.find(v=>{let y=(v.id||"").toLowerCase(),m=(v.getAttribute("name")||"").toLowerCase(),b=(v.getAttribute("aria-label")||"").toLowerCase(),g=q(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return y.includes(h)||m.includes(h)||b.includes(h)||h.length>=2&&g.includes(h)})||(u.length===1?u[0]:null)}if(!n)continue;let l=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox",r=n.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||n;r.style.outline=`2px solid ${t.outline}`,r.style.outlineOffset="2px",r.style.backgroundColor=t.bg,r.setAttribute("data-easyquiz-highlight","true"),le.push(r);let c=l?n:r.querySelector('select, [role="combobox"], [role="listbox"]');c&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),le.push(c));let d=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:r.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==r&&(d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${t.glow}`,d.setAttribute("data-easyquiz-highlight","true"),le.push(d))}}var pt=10,yo=1400,ht=15e5;function be(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let i=String(a.result||"");e(i.split(",")[1]||"")},a.readAsDataURL(o)})}async function Se(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,yo/Math.max(e,t)),i=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),l=document.createElement("canvas");l.width=i,l.height=n;let s=l.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,n),s.drawImage(o,0,0,i,n),new Promise((r,c)=>{l.toBlob(d=>d?r(d):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function xo(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,n=Math.min(1800,Math.max(120,Math.round(t*i))),l=Math.min(1800,Math.max(100,Math.round(a*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(n)),s.setAttribute("height",String(l)),!s.getAttribute("viewBox")&&t>0&&a>0&&s.setAttribute("viewBox",`0 0 ${t} ${a}`);let c=new XMLSerializer().serializeToString(s),d=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(d);try{let u=new Image;u.crossOrigin="anonymous",await new Promise((v,y)=>{u.onload=()=>v(),u.onerror=()=>y(new Error("Falha ao renderizar SVG em Image.")),u.src=p});let h=document.createElement("canvas");h.width=n,h.height=l;let f=h.getContext("2d",{alpha:!1});if(!f)throw new Error("Sem suporte a Canvas 2D.");return f.fillStyle="#ffffff",f.fillRect(0,0,n,l),f.drawImage(u,0,0,n,l),new Promise((v,y)=>{h.toBlob(m=>m?v(m):y(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(p)}}async function mt(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let n=s=>{if(!this.isDragging||!this.element)return;let r=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,d=Math.max(10,window.innerWidth-this.element.offsetWidth-10),p=Math.max(10,window.innerHeight-this.element.offsetHeight-10),u=Math.min(Math.max(10,this.initialLeft+r),d),h=Math.min(Math.max(10,this.initialTop+c),p);this.element.style.left=`${u}px`,this.element.style.top=`${h}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,n=i.actions.filter(h=>h.t==="drag"),l=i.actions.filter(h=>{if(h.t!=="val")return!1;let f=q(h.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(f)}),s=i.actions.filter(h=>h.t==="clk"||h.t==="chk"),r=i.actions.filter(h=>h.t==="sel"),c=n.length||l.length||s.length||r.length,d=document.createElement("div");d.className="eq-fah-meta";let p=document.createElement("span");p.textContent=`Modo: ${i.mode.replace("_"," ")}`;let u=document.createElement("span");if(u.className="eq-fah-meta-badge",u.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,d.append(p,u),e.appendChild(d),n.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let h={};for(let f of n){let v=q(f.to)||"Geral";h[v]||(h[v]=[]),h[v].push(q(f.from))}for(let[f,v]of Object.entries(h)){let y=document.createElement("div"),m=/fato|true|verdadeiro|sim/i.test(f),b=/opini[aã]o|false|falso|n[aã]o/i.test(f);y.className=`eq-fah-group ${m?"group-fato":b?"group-opiniao":""}`;let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent=`\u{1F4C1} ${f} (${v.length})`,y.appendChild(g);let x=document.createElement("div");x.className="eq-fah-group-items";for(let A of v){let w=document.createElement("div");w.className="eq-fah-item";let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=A,w.appendChild(E);let C=document.createElement("button");C.className="eq-fah-copy-inline",C.textContent="Copiar",C.addEventListener("click",()=>{navigator.clipboard.writeText(A),C.textContent="\u2713 Copiado",setTimeout(()=>C.textContent="Copiar",1200)}),w.appendChild(C),x.appendChild(w)}y.appendChild(x),e.appendChild(y)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,a.textContent=String(l.length);let h=document.createElement("div");h.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F4DD} Respostas para os Campos de Texto:",h.appendChild(f);let v=document.createElement("div");v.className="eq-fah-group-items";for(let y=0;y<l.length;y++){let m=l[y],b=document.createElement("div");b.className="eq-fah-item";let g=Me(m.id);(!g||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Campo ${y+1}`);let x=String(m.v??""),A=document.createElement("div");A.className="eq-fah-field-box";let w=document.createElement("div");w.className="eq-fah-field-label",w.textContent=g,A.appendChild(w);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=x,A.appendChild(E),b.appendChild(A);let C=document.createElement("button");C.className="eq-fah-copy-inline",C.textContent="Copiar",C.addEventListener("click",()=>{navigator.clipboard.writeText(x),C.textContent="\u2713 Copiado",setTimeout(()=>C.textContent="Copiar",1200)}),b.appendChild(C),v.appendChild(b)}h.appendChild(v),e.appendChild(h)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let h=document.createElement("div");h.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F3AF} Alternativa(s) Correta(s):",h.appendChild(f);let v=document.createElement("div");v.className="eq-fah-group-items";for(let y=0;y<s.length;y++){let m=s[y],b=document.createElement("div");b.className="eq-fah-item";let g=Me(m.id);(!g||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g))&&m.v&&(g=String(m.v)),g=q(g),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g)&&(g="");let x="",A=g.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);A?(x=A[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),g=A[2].trim()||g):s.length>1&&(x=String.fromCharCode(65+y));let w=document.createElement("div");if(w.style.display="flex",w.style.alignItems="center",w.style.gap="8px",w.style.flex="1",x){let H=document.createElement("span");H.className="eq-fah-letter-badge",H.textContent=x,w.appendChild(H)}let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=g||(x?`Alternativa ${x}`:"Alternativa Selecionada"),w.appendChild(E),b.appendChild(w);let C=document.createElement("button");C.className="eq-fah-copy-inline",C.textContent="Copiar",C.addEventListener("click",()=>{navigator.clipboard.writeText(g||x),C.textContent="\u2713 Copiado",setTimeout(()=>C.textContent="Copiar",1200)}),b.appendChild(C),v.appendChild(b)}h.appendChild(v),e.appendChild(h)}else if(r.length>0){t.textContent=`Sele\xE7\xE3o (${r.length} listas)`,a.textContent=String(r.length);let h=document.createElement("div");h.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",h.appendChild(f);let v=document.createElement("div");v.className="eq-fah-group-items";for(let y=0;y<r.length;y++){let m=r[y],b=document.createElement("div");b.className="eq-fah-item";let g=Me(m.id);(!g||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Lista ${y+1}`);let w=(Array.isArray(m.v)?m.v:[String(m.v??"")]).map(_=>{let B=L(m.id,void 0,!0)||L(q(m.id),void 0,!0),K=B instanceof HTMLSelectElement?B:B?.querySelector("select");if(K){let te=q(_).toLowerCase();for(let S=0;S<K.options.length;S++){let I=K.options[S];if(I.value.toLowerCase()===te||q(I.textContent).toLowerCase()===te){let $=q(I.textContent);if($&&!$.toLowerCase().includes("selecione"))return $}}}return _}).join(", "),E=document.createElement("div");E.className="eq-fah-field-box";let C=document.createElement("div");C.className="eq-fah-field-label",C.textContent=g,E.appendChild(C);let H=document.createElement("div");H.className="eq-fah-field-val",H.textContent=w,E.appendChild(H),b.appendChild(E);let R=document.createElement("button");R.className="eq-fah-copy-inline",R.textContent="Copiar",R.addEventListener("click",()=>{navigator.clipboard.writeText(w),R.textContent="\u2713 Copiado",setTimeout(()=>R.textContent="Copiar",1200)}),b.appendChild(R),v.appendChild(b)}h.appendChild(v),e.appendChild(h)}else{t.textContent="Gabarito",a.textContent="0";let h=document.createElement("div");h.style.padding="10px",h.style.color="#888",h.textContent="Nenhuma resposta direta para exibir.",e.appendChild(h)}if(i.rationale){let h=document.createElement("div");h.className="eq-fah-rationale",h.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(h)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let r of a){let c=q(r.to)||"Geral";s[c]||(s[c]=[]),s[c].push(q(r.from))}for(let[r,c]of Object.entries(s)){t.push(`### Categoria: ${r}`);for(let d of c)t.push(`- ${d}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let r=q(s.id);t.push(`- **${r||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let r=n[s],c=Me(r.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&r.v&&(c=String(r.v)),c=q(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let d=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${d}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let r=q(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${r}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
