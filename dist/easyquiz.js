...
`;function Yt(o,e){return/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o)||e.includes("Qr7Oae")||e.includes("freebirdFormviewer")||e.includes("data-item-id")?"[PLATAFORMA: Google Forms \u2014 use clk nos containers de alternativa; IDs via data-item-id ou texto da op\xE7\xE3o]":/wayground|quizizz/i.test(o)||e.includes("data-functional-selector")?e.includes("classification")||e.toLowerCase().includes("fato")||e.toLowerCase().includes("opini")?"[PLATAFORMA: Wayground/Quizizz CLASSIFICA\xC7\xC3O \u2014 items s\xE3o cards com bot\xF5es de categoria; use clk no id do item/categoria OU drag com from=texto_item, to=nome_categoria]":"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Ee(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(f=>f.type==="draggable"||f.type==="dropzone"),i=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),l=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(f=>f.role==="answer").length===0),s=o.controls.filter(f=>f.role!=="navigation").length===0,r=s||a||n||l||i&&o.questionText.length<60,c=s?4500:1800,d=r?`
[HTML]:
${o.htmlSnippet.slice(0,c).replace(/\s+/g," ")}`:"",p="";if(s&&typeof document<"u")try{let f=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(h=>{let v=h,C=v.getBoundingClientRect?.()||{width:0,height:0};return C.width>0&&C.height>0&&!v.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(h=>{let v=h,C=v.tagName.toLowerCase(),A=v.id?`#${v.id}`:"",w=v.className&&typeof v.className=="string"?`.${v.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",E=(v.textContent||v.value||v.getAttribute("aria-label")||"").trim().slice(0,60),I=v.getAttribute("type")||v.getAttribute("role")||"";return`${C}${A}${w}[${I}] txt="${E}"`});f.length>0&&(p=`
[DOM-INTERATIVO]:
${f.join(`
`)}`)}catch{}let u=He(),m=u.length>0?`
[MEM\xD3RIA]:
${u.join(" | ")}
`:"",b=o.controls.filter(f=>f.role!=="navigation"),y=o.controls.filter(f=>f.role==="navigation"),x=Yt(o.sourceUrl,o.htmlSnippet),g=x?`
${x}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(b.length===0)return"Nenhuma";let f=b.filter(M=>M.type==="checkbox"||M.type==="chk"),h=new Set(b.filter(M=>M.type==="radio").map(M=>M.name).filter(Boolean)),v=f.filter(M=>!M.name||!h.has(M.name)),C=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),A=v.length>=2||C,w=b.every(M=>M.type==="radio"||M.type==="chk")&&h.size>=1&&!A,E=b.filter(M=>M.type==="text"||M.type==="number"||M.type==="val"||M.tag==="input"||M.tag==="textarea"),I=E.length>=2;return(A?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
...
`;function jt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=vo,document.head.appendChild(o)}}catch{}}function de(){fe&&(fe.style.removeProperty("outline"),fe.style.removeProperty("outline-offset"),fe.style.removeProperty("position"),fe=null);for(let o of ce)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ce=[];for(let o of ct)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");ct=[];for(let o of dt)try{o.remove()}catch{}if(dt=[],be){try{be.remove()}catch{}be=null}}function ut(o){jt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),ct.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let n=s=>{if(!this.isDragging||!this.element)return;let r=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,d=Math.max(10,window.innerWidth-this.element.offsetWidth-10),p=Math.max(10,window.innerHeight-this.element.offsetHeight-10),u=Math.min(Math.max(10,this.initialLeft+r),d),m=Math.min(Math.max(10,this.initialTop+c),p);this.element.style.left=`${u}px`,this.element.style.top=`${m}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,n=i.actions.filter(m=>m.t==="drag"),l=i.actions.filter(m=>{if(m.t!=="val")return!1;let b=q(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(b)}),s=i.actions.filter(m=>m.t==="clk"||m.t==="chk"),r=i.actions.filter(m=>m.t==="sel"),c=n.length||l.length||s.length||r.length,d=document.createElement("div");d.className="eq-fah-meta";let p=document.createElement("span");p.textContent=`Modo: ${i.mode.replace("_"," ")}`;let u=document.createElement("span");if(u.className="eq-fah-meta-badge",u.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,d.append(p,u),e.appendChild(d),n.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let b of n){let y=q(b.to)||"Geral";m[y]||(m[y]=[]),m[y].push(q(b.from))}for(let[b,y]of Object.entries(m)){let x=document.createElement("div"),g=/fato|true|verdadeiro|sim/i.test(b),f=/opini[aã]o|false|falso|n[aã]o/i.test(b);x.className=`eq-fah-group ${g?"group-fato":f?"group-opiniao":""}`;let h=document.createElement("div");h.className="eq-fah-group-title",h.textContent=`\u{1F4C1} ${b} (${y.length})`,x.appendChild(h);let v=document.createElement("div");v.className="eq-fah-group-items";for(let C of y){let A=document.createElement("div");A.className="eq-fah-item";let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=C,A.appendChild(w);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(C),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),A.appendChild(E),v.appendChild(A)}x.appendChild(v),e.appendChild(x)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,a.textContent=String(l.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<l.length;x++){let g=l[x],f=document.createElement("div");f.className="eq-fah-item";let h=Me(g.id);(!h||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(h))&&(h=`Campo ${x+1}`);let v=String(g.v??""),C=document.createElement("div");C.className="eq-fah-field-box";let A=document.createElement("div");A.className="eq-fah-field-label",A.textContent=h,C.appendChild(A);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=v,C.appendChild(w),f.appendChild(C);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),f.appendChild(E),y.appendChild(f)}m.appendChild(y),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<s.length;x++){let g=s[x],f=document.createElement("div");f.className="eq-fah-item";let h=Me(g.id);(!h||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(h))&&g.v&&(h=String(g.v)),h=q(h),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(h)&&(h="");let v="",C=h.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);C?(v=C[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),h=C[2].trim()||h):s.length>1&&(v=String.fromCharCode(65+x));let A=document.createElement("div");if(A.style.display="flex",A.style.alignItems="center",A.style.gap="8px",A.style.flex="1",v){let I=document.createElement("span");I.className="eq-fah-letter-badge",I.textContent=v,A.appendChild(I)}let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=h||(v?`Alternativa ${v}`:"Alternativa Selecionada"),A.appendChild(w),f.appendChild(A);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(h||v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),f.appendChild(E),y.appendChild(f)}m.appendChild(y),e.appendChild(m)}else if(r.length>0){t.textContent=`Sele\xE7\xE3o (${r.length} listas)`,a.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<r.length;x++){let g=r[x],f=document.createElement("div");f.className="eq-fah-item";let h=Me(g.id);(!h||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(h))&&(h=`Lista ${x+1}`);let A=(Array.isArray(g.v)?g.v:[String(g.v??"")]).map(M=>{let D=L(g.id,void 0,!0)||L(q(g.id),void 0,!0),K=D instanceof HTMLSelectElement?D:D?.querySelector("select");if(K){let oe=q(M).toLowerCase();for(let H=0;H<K.options.length;H++){let $=K.options[H];if($.value.toLowerCase()===oe||q($.textContent).toLowerCase()===oe){let N=q($.textContent);if(N&&!N.toLowerCase().includes("selecione"))return N}}}return M}).join(", "),w=document.createElement("div");w.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=h,w.appendChild(E);let I=document.createElement("div");I.className="eq-fah-field-val",I.textContent=A,w.appendChild(I),f.appendChild(w);let z=document.createElement("button");z.className="eq-fah-copy-inline",z.textContent="Copiar",z.addEventListener("click",()=>{navigator.clipboard.writeText(A),z.textContent="\u2713 Copiado",setTimeout(()=>z.textContent="Copiar",1200)}),f.appendChild(z),y.appendChild(f)}m.appendChild(y),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(i.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let r of a){let c=q(r.to)||"Geral";s[c]||(s[c]=[]),s[c].push(q(r.from))}for(let[r,c]of Object.entries(s)){t.push(`### Categoria: ${r}`);for(let d of c)t.push(`- ${d}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let r=q(s.id);t.push(`- **${r||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let r=n[s],c=Me(r.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&r.v&&(c=String(r.v)),c=q(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let d=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${d}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let r=q(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${r}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
