...
[HTML]: Omitido.`,r=Me(),c=r.length>0?`
[MEM\xD3RIA]:
${r.join(" | ")}
...
`;function Nt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=uo,document.head.appendChild(o)}}catch{}}function ie(){he&&(he.style.removeProperty("outline"),he.style.removeProperty("outline-offset"),he.style.removeProperty("position"),he=null);for(let o of ne)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ne=[];for(let o of it)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");it=[];for(let o of st)try{o.remove()}catch{}if(st=[],me){try{me.remove()}catch{}me=null}}function rt(o){Nt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),it.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),st.push(n)}}catch{}}}function lt(o){ie(),Nt(),he=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),me=t,setTimeout(()=>{try{t.remove()}catch{}me===t&&(me=null)},900)}catch{}}function po(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Dt(o,e){let t=po(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let h=E(a.from),d=E(a.to);h&&(h.style.outline=`2px solid ${t.outline}`,ne.push(h)),d&&(d.style.outline="2px dashed #00e5ff",ne.push(d))}catch{}continue}if(!a.id)continue;let i=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=E(a.id,i,a.t==="val"||a.t==="sel")||E(y(a.id),i,a.t==="val"||a.t==="sel");if(!n&&a.t==="sel"){let h=document.body;try{h=D()||document.body}catch{}let d=Array.from(h.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>T(v)&&!de(v)),m=y(a.id).toLowerCase();n=d.find(v=>{let f=(v.id||"").toLowerCase(),u=(v.getAttribute("name")||"").toLowerCase(),b=(v.getAttribute("aria-label")||"").toLowerCase(),x=y(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return f.includes(m)||u.includes(m)||b.includes(m)||m.length>=2&&x.includes(m)})||(d.length===1?d[0]:null)}if(!n)continue;let l=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox",r=n.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||n;r.style.outline=`2px solid ${t.outline}`,r.style.outlineOffset="2px",r.style.backgroundColor=t.bg,r.setAttribute("data-easyquiz-highlight","true"),ne.push(r);let c=l?n:r.querySelector('select, [role="combobox"], [role="listbox"]');c&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ne.push(c));let p=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:r.querySelector('input[type="checkbox"], input[type="radio"]');p&&p!==r&&(p.style.outline=`2px solid ${t.outline}`,p.style.outlineOffset="2px",p.style.boxShadow=`0 0 10px ${t.glow}`,p.setAttribute("data-easyquiz-highlight","true"),ne.push(p))}}var ct=10,ho=1400,dt=15e5;function ge(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let i=String(a.result||"");e(i.split(",")[1]||"")},a.readAsDataURL(o)})}async function Te(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,ho/Math.max(e,t)),i=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),l=document.createElement("canvas");l.width=i,l.height=n;let s=l.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,n),s.drawImage(o,0,0,i,n),new Promise((r,c)=>{l.toBlob(p=>p?r(p):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function mo(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,n=Math.min(1800,Math.max(120,Math.round(t*i))),l=Math.min(1800,Math.max(100,Math.round(a*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(n)),s.setAttribute("height",String(l)),!s.getAttribute("viewBox")&&t>0&&a>0&&s.setAttribute("viewBox",`0 0 ${t} ${a}`);let c=new XMLSerializer().serializeToString(s),p=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(p);try{let d=new Image;d.crossOrigin="anonymous",await new Promise((v,f)=>{d.onload=()=>v(),d.onerror=()=>f(new Error("Falha ao renderizar SVG em Image.")),d.src=h});let m=document.createElement("canvas");m.width=n,m.height=l;let g=m.getContext("2d",{alpha:!1});if(!g)throw new Error("Sem suporte a Canvas 2D.");return g.fillStyle="#ffffff",g.fillRect(0,0,n,l),g.drawImage(d,0,0,n,l),new Promise((v,f)=>{m.toBlob(u=>u?v(u):f(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(h)}}async function ut(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,i=`
