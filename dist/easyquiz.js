...
`;function K(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(u=>u.type==="draggable"||u.type==="dropzone"),n=new Set(["navigation"]);o.controls.some(u=>["text","number","textarea","contenteditable"].some(h=>u.type.includes(h)))&&n.add("text"),o.controls.some(u=>["radio","checkbox"].includes(u.type)||u.tag==="button")&&n.add("choice"),o.controls.some(u=>u.tag==="select")&&n.add("select"),o.controls.some(u=>/combobox|dropdown/i.test(u.type))&&n.add("combobox"),(o.controls.some(u=>["draggable","dropzone"].includes(u.type))||a)&&n.add("drag"),t.engine==="javascript"&&n.add("javascript");let i=o.questionText.length<120||a||o.controls.length<3?`
[HTML]:
${o.htmlSnippet.slice(0,3e3).replace(/\s+/g," ")}`:`
[HTML]: Omitido.`,s=te(),l=s.length>0?`
[MEM\xD3RIA]:
${s.join(" | ")}
`:"",c=o.controls.filter(u=>u.role!=="navigation"),d=o.controls.filter(u=>u.role==="navigation");return`--- AN\xC1LISE ---
...
[IMAGENS]: ${e.length}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var ut=new Set(["question","info","start","conclusion"]),pt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),ht=new Set(["val","chk","sel","clk","adv","js","drag"]),_e=150,je=2e3,mt=new Set(["pageType","mode","confidence","rationale","actions","memoryToStore"]),gt={val:new Set(["t","id","v"]),chk:new Set(["t","id","c"]),sel:new Set(["t","id","v"]),clk:new Set(["t","id","co"]),adv:new Set(["t","id"]),js:new Set(["t","v"]),drag:new Set(["t","from","to"])};function V(o,e=""){return typeof o=="string"?o.trim().slice(0,je):e}function N(o,e){let t=V(o);if(!t)throw new Error(`Plano inv\xE1lido: ${e} \xE9 obrigat\xF3rio.`);return t}function ft(o,e){if(!o||typeof o!="object")throw new Error(`Plano inv\xE1lido: a\xE7\xE3o ${e+1} n\xE3o \xE9 um objeto.`);let t=o,a=t.t;if(typeof a!="string"||!ht.has(a))throw new Error(`Plano inv\xE1lido: tipo de a\xE7\xE3o desconhecido na posi\xE7\xE3o ${e+1}.`);for(let i of Object.keys(t))if(!gt[a].has(i))throw new Error(`Plano inv\xE1lido: campo '${i}' n\xE3o permitido na a\xE7\xE3o ${e+1}.`);if(a==="adv")return{t:"adv",...V(t.id)?{id:V(t.id,"").slice(0,500)}:{}};if(a==="drag")return{t:"drag",from:N(t.from,`a\xE7\xF5es[${e}].from`).slice(0,500),to:N(t.to,`a\xE7\xF5es[${e}].to`).slice(0,500)};if(a==="js"){let i=N(t.v,`a\xE7\xF5es[${e}].v`);if(i.length>8e3)throw new Error(`Plano inv\xE1lido: JavaScript da a\xE7\xE3o ${e+1} excede o limite.`);return{t:"js",v:i}}let n=N(t.id,`a\xE7\xF5es[${e}].id`).slice(0,500);if(a==="val")return{t:"val",id:n,v:N(t.v,`a\xE7\xF5es[${e}].v`).slice(0,je)};if(a==="sel"){let s=(Array.isArray(t.v)?t.v:[t.v]).map(l=>N(l,`a\xE7\xF5es[${e}].v`).slice(0,500));return{t:"sel",id:n,v:s}}if(a==="chk"){if(typeof t.c!="boolean")throw new Error(`Plano inv\xE1lido: a\xE7\xF5es[${e}].c deve ser booleano.`);return{t:"chk",id:n,c:t.c}}let r={t:"clk",id:n};if(t.co!==void 0&&(!Array.isArray(t.co)||t.co.length!==2||!t.co.every(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0&&i<=1e4)))throw new Error(`Plano inv\xE1lido: coordenadas fora do limite na a\xE7\xE3o ${e+1}.`);return Array.isArray(t.co)&&t.co.length===2&&t.co.every(i=>typeof i=="number"&&Number.isFinite(i))&&(r.co=[t.co[0],t.co[1]]),r}function Ge(o){if(!o||typeof o!="object")throw new Error("A IA n\xE3o retornou um plano de objeto v\xE1lido.");let e=o;for(let l of Object.keys(e))if(!mt.has(l))throw new Error(`Plano inv\xE1lido: campo '${l}' n\xE3o permitido.`);let t=e.pageType,a=e.mode;if(typeof t!="string"||!ut.has(t))throw new Error("Plano inv\xE1lido: pageType desconhecido.");if(typeof a!="string"||!pt.has(a))throw new Error("Plano inv\xE1lido: mode desconhecido.");if(!Array.isArray(e.actions)||e.actions.length>_e)throw new Error(`Plano inv\xE1lido: actions deve conter entre 0 e ${_e} a\xE7\xF5es.`);let n=e.actions.map(ft),r=n.filter(l=>l.t!=="adv"),i=n.some(l=>l.t==="adv");if(t==="question"&&r.length===0)throw new Error("Plano inv\xE1lido: uma quest\xE3o precisa conter ao menos uma a\xE7\xE3o de resposta.");if(t==="conclusion"&&n.length>0)throw new Error("Plano inv\xE1lido: tela de conclus\xE3o n\xE3o pode conter a\xE7\xF5es.");if((t==="info"||t==="start")&&r.length>0)throw new Error("Plano inv\xE1lido: p\xE1ginas informativas s\xF3 podem avan\xE7ar.");if((t==="info"||t==="start")&&!i)throw new Error("Plano inv\xE1lido: p\xE1gina informativa ou inicial precisa indicar avan\xE7o.");t==="question"&&!i&&n.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):0;if((a==="categorizacao"||a==="ordenacao"||a==="arrastar_soltar")&&r.some(l=>l.t!=="drag"))throw new Error("Plano inv\xE1lido: modo de arrastar/ordenar exige somente a\xE7\xF5es drag.");if(a==="escolha_multipla"&&r.some(l=>l.t!=="chk"&&l.t!=="clk"))throw new Error("Plano inv\xE1lido: escolha m\xFAltipla exige a\xE7\xF5es chk ou clk.");return{pageType:t,mode:a,confidence:s,rationale:V(e.rationale,"Plano validado sem justificativa fornecida."),actions:n,...V(e.memoryToStore)?{memoryToStore:V(e.memoryToStore)}:{}}}var D=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (R\xE1pido e atual)",description:"Modelo est\xE1vel multimodal para baixa lat\xEAncia e tarefas agentivas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico)",description:"Modelo est\xE1vel de menor custo e baixa lat\xEAncia.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Compatibilidade)",description:"Modelo est\xE1vel multimodal para contas que ainda n\xE3o exp\xF5em a s\xE9rie 3.",stable:!0},{id:"gemini-3.1-pro-preview",name:"Gemini 3.1 Pro (Racioc\xEDnio avan\xE7ado)",description:"Modelo preview para quest\xF5es complexas e multimodais.",stable:!1}],vt={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function bt(o){return o.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function Fe(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function yt(o){try{return JSON.parse(o)}catch(e){throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var oe=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;return o?JSON.parse(o):null}catch{return null}})(),ve=new Set;async function ae(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return D;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let n=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!n.ok){let i=await n.text(),s=Fe(i,n.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let r=await n.json();if(Array.isArray(r.models)&&r.models.length>0){let i=r.models.filter(s=>{let l=s.supportedGenerationMethods||[],c=(s.name||"").includes("gemini"),d=l.includes("generateContent"),u=(s.name||"").includes("embedding")||(s.name||"").includes("tts")||(s.name||"").includes("imagen")||(s.name||"").includes("aqa")||(s.name||"").includes("computer-use");return c&&d&&!u}).map(s=>{let l=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),d=s.displayName||c;return{id:c,name:d.includes(c)?d:`${d} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image/i.test(c),supportsStructuredOutput:l.includes("generateContent"),supportedGenerationMethods:l,discoveredAt:Date.now()}});if(i.length>0){i.sort((s,l)=>{let c=d=>d==="gemini-3.8-flash"?120:d==="gemini-3.5-flash-lite"?115:d==="gemini-2.5-flash"?100:d==="gemini-3.1-pro-preview"?90:d.includes("flash")?50:10;return c(l.id)-c(s.id)}),oe=i;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(i))}catch{}return i}}}catch(n){if(n.message?.includes("Chave de API"))throw n}return D}async function Qe(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await ae(e);if(a.length>0&&a!==D){let n=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${n.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.5-flash-lite","gemini-2.5-flash"];for(let a of t)for(let n of["v1beta","v1"]){let r=`https://generativelanguage.googleapis.com/${n}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(r,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${n})!`,models:D}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function be(o,e,t,a){let n=t.apiKey.trim().replace(/^["']|["']$/g,"");if(!n)throw new Error("Chave de API n\xE3o configurada.");let r=bt(t.model);if(!oe||oe.length===0)try{a?.("Verificando modelos autorizados na sua chave de API...","info"),await ae(n)}catch(g){let m=g instanceof Error?g.message:String(g);if(m.includes("inv\xE1lida")||m.includes("n\xE3o autorizada"))throw new Error(m)}let i=Date.now(),s=K(o,e,t),l=[{text:s}];for(let g of e)l.push({inline_data:{mime_type:g.mediaType,data:g.base64}});let c={temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:vt},d=[r,...oe?.map(g=>g.id)||[],"gemini-2.5-flash","gemini-3.5-flash-lite","gemini-2.5-flash","gemini-3.1-pro-preview"],u=Array.from(new Set(d)).filter(g=>!ve.has(g));u.length===0&&(ve.clear(),u.push(...D.map(g=>g.id)));let h=new Error("Nenhum modelo tentado.");for(let g=0;g<u.length;g++){let m=u[g],b=u[g+1];m.includes("2.5")||m.includes("thinking")?c.thinkingConfig={thinkingBudget:0}:delete c.thinkingConfig;let p={system_instruction:{parts:[{text:Ve}]},contents:[{role:"user",parts:l}],generationConfig:c};a?.(`Aguardando resposta da API (${m})...`,"info");let v=["v1beta","v1"];for(let S of v){let P=`https://generativelanguage.googleapis.com/${S}/models/${m}:generateContent?key=${encodeURIComponent(n)}`,L=new AbortController,ze=setTimeout(()=>L.abort(),35e3);try{let $=await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":n},body:JSON.stringify(p),signal:L.signal});if(clearTimeout(ze),!$.ok){let Pe=await $.text();if($.status===400&&c.thinkingConfig&&/thinking/i.test(Pe)){delete c.thinkingConfig,p.generationConfig=c;continue}let lt=Fe(Pe,$.status);if($.status===404&&S==="v1beta")continue;throw new Error(lt)}let ue=await $.json(),pe=ue.candidates?.[0];if(!pe||!pe.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let rt=pe.content.parts[0].text,Q=Ge(yt(rt));if(Q.usedModel=m,Q.durationMs=Date.now()-i,Q.promptSent=s,Q.tokensUsed=ue.usageMetadata?.totalTokenCount,m!==r){a?.(`Resolvido com sucesso pelo fallback '${m}' (${S})!`,"info");try{t.model=m}catch{}}return{plan:Q,rawUsage:ue.usageMetadata,usedModel:m}}catch($){if(clearTimeout(ze),h=$,h.message.includes("inv\xE1lida")||h.message.includes("n\xE3o autorizada"))throw h}}let E=h.message.includes("429")||h.message.includes("cota"),q=h.message.includes("503")||h.message.includes("sobrecarregado");if(h.message.includes("404")&&ve.add(m),b){let S=E?3500:q?2500:900,P=`Modelo '${m}' indispon\xEDvel (${h.message}). Aguardando ${S/1e3}s antes de alternar para '${b}'...`;console.warn(`[EasyQuiz Fallback] ${P}`),a?.(P,"warning"),await new Promise(L=>setTimeout(L,S))}else console.warn(`[EasyQuiz Fallback] Modelo '${m}' falhou: ${h.message}. Todos os modelos esgotados.`)}throw h}var xt=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Y(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function ye(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ue(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(xt.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var _=['input:not([type="hidden"])',"textarea","select","button","a",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),ne=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,wt=0;function w(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected)return!1;if(typeof e.checkVisibility=="function")try{if(!e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}))return!1}catch{}try{let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(a&&(a.display==="none"||a.visibility==="hidden"||Number(a.opacity||"1")<=0))return!1}catch{}try{let a=e.closest('[hidden], [style*="display: none"], [style*="display:none"]');if(a&&!Ke(a))return!1}catch{}try{if(typeof e.getBoundingClientRect=="function"){let a=e.getBoundingClientRect();if(a.width>0||a.height>0)return!0}}catch{}try{if(typeof e.getClientRects=="function"&&e.getClientRects().length>0)return!0}catch{}let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.closest('label, .option-card, .quiz-option, [class*="option" i], [class*="choice" i], tr, div');if(a&&a!==e)return w(a)}return e.ownerDocument&&e.ownerDocument.defaultView&&/jsdom/i.test(e.ownerDocument.defaultView.navigator?.userAgent||"")?!e.closest('[style*="display: none"], [style*="display:none"], [hidden]'):(e.textContent||"").trim().length>0}function qt(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function C(o,e=500){return qt(o).replace(/\s+/g," ").trim().slice(0,e)}function Et(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(wt+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function Ke(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function I(o){if(!o||!(o instanceof Element)||Ke(o)||o.closest("header, nav, aside"))return!1;let e=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",t=C(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,n=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),r=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return ne.test(n)||ne.test(t)||a==="submit"||r.includes("next")||r.includes("check")||r.includes("continue")||r.includes("proximo")||r.includes("forward")||!1}function Ct(o){let e=o.closest("tr");if(e){let s=e.querySelector("th, td:first-child"),l=s&&s!==o.closest("td")?C(s.textContent,100):"",c=C(o.closest("label, td")?.textContent||"",50);if(l&&c)return`${l}: ${c}`}let t=o.getAttribute("aria-label");if(t)return C(t);let a=o.getAttribute("aria-labelledby");if(a){let s=a.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(s.trim())return C(s)}if("labels"in o&&o.labels){let s=Array.from(o.labels??[]).map(l=>l.textContent).join(" ");if(s.trim())return C(s)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let s=C(n.textContent);if(s)return s}let r=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",i=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||r||"";return C(i)}function xe(o,e){let t=o instanceof HTMLSelectElement?o:null,a=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(n)?n:"other",i=o.getAttribute("role")||"",s=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),l=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),c=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(s)||/drag|card-item|sortable/i.test(l),d=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(s)||/dropzone|category-box|bucket|target-zone/i.test(l),h=C((c?"draggable":d?"dropzone":"")||a.type||i||r,40),g="";if(a.type==="checkbox"||a.type==="radio"||i==="radio"||i==="checkbox")g=a.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(r==="button"||n==="a"||e==="navigation"||I(o))g="";else{let q=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o instanceof HTMLSelectElement?o.value:"";g=C(q||o.getAttribute("data-category")||"",2e3)}let m=[];if(t)for(let q of Array.from(t.options).slice(0,80))m.push({value:C(q.value),label:C(q.textContent)});let b=!!(a.required||o.getAttribute("aria-required")==="true"),p=!!(a.disabled||o.getAttribute("aria-disabled")==="true"),v=Et(o);return{id:o.id||v,tag:r,type:h,label:Ct(o),name:C(a.name||o.getAttribute("name")||"",180),value:g,options:m,required:b,disabled:p,role:e}}var Ye=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Je(o){if(!w(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(_)).filter(w),a=C(o.innerText,4e3).length;if(a<10||!t.length&&a<60)return-1/0;let n=Math.max(1,window.innerWidth*window.innerHeight),r=Math.max(1,e.width*e.height),i=Math.min(1,r/n),s=e.top+e.height/2,l=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=a>40?35:0,d=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+c+d-i*20-l*10}function we(o){let e=o;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=t;break}let n=C(e.innerText,1e4),r=C(t.innerText,1e4),i=e.querySelectorAll(_).length,s=t.querySelectorAll(_).length;if(n.length<150&&r.length>n.length&&s<=i+4){e=t;continue}break}return e}function Tt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&w(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function St(){let o=document.activeElement;if(o&&o!==document.body){let n=o.closest(Ye);if(n&&Je(n)>0)return we(n)}let t=Array.from(document.querySelectorAll(Ye)).map(n=>({element:n,score:Je(n)})).filter(n=>Number.isFinite(n.score)).sort((n,r)=>r.score-n.score);if(t.length>0&&t[0].score>0)return we(t[0].element);let a=document.querySelector('form, main, [role="main"]');return a&&w(a)?a:document.body}function Xe(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let n of Array.from(a.attributes))t.includes(n.name)||a.removeAttribute(n.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function At(o){return Array.from(o.querySelectorAll(_)).filter(e=>{if(!w(e)||I(e))return!1;if(e.tagName.toLowerCase()==="a"){let t=e.getAttribute("role");return!!(t==="button"||t==="radio"||t==="checkbox"||t==="option"||e.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]'))}return!0}).slice(0,100).map(e=>xe(e,"answer"))}function qe(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let n of e)for(let r of Array.from(n.querySelectorAll(_)))if(!(t.has(r)||!w(r)||!I(r))&&(t.add(r),a.push(xe(r,"navigation")),a.length>=10))return a;return a}function J(o=!1){let e=St();e=we(e),o&&(e=Tt(e));let t=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=C(t,16e3),n=At(e),r=qe(e);r.length===0&&(r=qe(document.body));let i=[...n,...r].slice(0,120);return!a||i.length===0&&a.length<30?C(document.body.innerText||document.body.textContent||"",16e3).length>=30?j():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:Xe(e),controls:i,scope:e}}function j(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=C(o,14e3),t=qe(document.body),a=document.querySelector('main, article, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Leitura/Contexto",questionText:e,htmlSnippet:Xe(a).slice(0,15e3),controls:t,scope:a}}function We(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}:${t.value}:${t.disabled}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,500),e].join("::")}function T(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function f(o){return o?o.replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim():""}function M(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let n=o.ownerDocument.getElementById(a);if(n)return n}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),r=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return r||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return M(a)}return o}function y(o){if(!o)return null;let e=o.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let t=CSS.escape(e),a=document.querySelector(`[data-easyquiz-id="${t}"]`);if(a&&!T(a)&&w(a))return M(a);try{let c=document.getElementById(e);if(c&&!T(c)&&w(c))return c.hasAttribute("data-category")||c.hasAttribute("data-dropzone")||c.classList.contains("dnd-zone")?c:M(c)}catch{}let n=e.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([0-9]+)$/i);if(n){let c=parseInt(n[1],10)-1;if(c>=0){let d=Array.from(document.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>w(u)&&!T(u));if(c<d.length)return M(d[c])}}let r=e.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(r){let c=r[1].toUpperCase().charCodeAt(0)-65;if(c>=0){let d=Array.from(document.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>w(u)&&!T(u));if(c<d.length)return M(d[c])}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(e)){let d=Array.from(document.querySelectorAll(`[data-category="${t}" i], [data-dropzone="${t}" i], [data-role="dropzone"][data-category="${t}" i]`)).find(m=>w(m)&&!T(m));if(d)return d;let h=Array.from(document.querySelectorAll(`input[value="${t}" i], [data-value="${t}" i], input[id="${t}" i]`)).find(m=>w(m)&&!T(m));if(h)return M(h);let g=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(m=>{if(!w(m)||T(m))return!1;let b=f(m.textContent).toLowerCase();return b===e.toLowerCase()||b===e.toLowerCase()+")"});if(g)return M(g)}try{let d=Array.from(document.querySelectorAll(`[name="${t}"], [value="${t}"], [data-category="${t}" i], [data-dropzone="${t}" i], [data-testid="${t}" i], [data-test-id="${t}" i], [aria-label="${t}" i]`)).find(u=>w(u)&&!T(u));if(d)return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:M(d)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(e))try{let d=Array.from(document.querySelectorAll(e)).find(u=>w(u)&&!T(u));if(d)return M(d)}catch{}try{let c=e.replace(/"/g,""),d=`//button[normalize-space(.)="${c}"] | //a[normalize-space(.)="${c}"] | //*[not(*) and normalize-space(.)="${c}"] | //*[@aria-label="${c}"] | //*[@data-category="${c}"] | //*[@data-testid="${c}"]`,u=document.evaluate(d,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let h=0;h<u.snapshotLength;h++){let g=u.snapshotItem(h);if(g&&w(g)&&!T(g)){if(["body","html"].includes(g.tagName.toLowerCase())){let b=g.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&w(b))return M(b)}return g.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||M(g)}}}catch{}let s=f(e).toLowerCase(),l=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let c of l){if(!w(c)||T(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=f(c.textContent).toLowerCase(),h=f(c.getAttribute("aria-label")||"").toLowerCase(),g=f(c.getAttribute("data-category")||"").toLowerCase(),m=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"",b=f(m).toLowerCase(),p=u.startsWith(s+")")||u.startsWith(s+".")||u.startsWith(s+" -")||u.startsWith(s+":");if(u===s||h===s||g&&g===s||b&&b===s||p)return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||M(c)}if(s.length>=3)for(let c of l){if(!w(c)||T(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=f(c.textContent).toLowerCase(),h=f(c.getAttribute("aria-label")||"").toLowerCase();if(u.includes(s)||h.includes(s)){if(Array.from(c.children).some(p=>{let v=f(p.textContent).toLowerCase();return v&&v.includes(s)}))continue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||M(c)}let g=s.split(/\s+/).filter(Boolean);if(g.length>=3){let m=g.slice(0,Math.min(5,g.length)).join(" ");if(u.includes(m)||h.includes(m))return M(c)}}return null}function X(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function k(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){H(t,!t.checked);return}if(t.type==="radio"){H(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(o instanceof HTMLButtonElement||o instanceof HTMLAnchorElement||o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let n=o.getBoundingClientRect(),r=e?e[0]:Math.round(n.left+Math.max(1,n.width/2)),i=e?e[1]:Math.round(n.top+Math.max(1,n.height/2)),s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:i};try{o.dispatchEvent(new PointerEvent("pointerdown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function Te(o,e){let t=o;if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let n=o.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');n&&(t=n)}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t.getAttribute("role")==="link"||t instanceof HTMLInputElement&&["button","submit"].includes(t.type)||I(t)){console.log("[EasyQuiz] Auto-corre\xE7\xE3o em setNativeValue: elemento \xE9 bot\xE3o/navega\xE7\xE3o. Clicando..."),k(t);return}if(t instanceof HTMLSelectElement){Ae(t,[e]);return}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let n=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;H(t,n);return}try{t.focus?.()}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:e}))}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let i=t._valueTracker;i&&i.setValue("")}catch{}let n=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,r=Object.getOwnPropertyDescriptor(n,"value")?.set;r?r.call(t,e):t.value=e;try{let i=t._valueTracker;i&&i.setValue(e)}catch{}X(t,["input","change","blur"]);return}if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0),document.execCommand?.("insertText",!1,e)}catch{}if(t.textContent?.trim()!==e.trim()){t.textContent=e;try{t.innerText=e}catch{}}X(t,["input","change","blur"]);return}try{t.value=e,t.textContent=e,X(t,["input","change","blur"])}catch{}}function Se(o,e=""){if(!o)return e;let t=f(o),a=y(o)||y(t);if(!a)return t||e;let n=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr');if(n){let l=f(n.textContent);if(l&&l.length>0&&l.length<150)return l}if(a.id){let l=document.querySelector(`label[for="${CSS.escape(a.id)}"]`);if(l){let c=f(l.textContent);if(c&&c.length>0&&c.length<150)return c}}let r=a.getAttribute("aria-label");if(r)return f(r);let i=a.getAttribute("placeholder");if(i)return f(i);let s=f(a.textContent);return s&&s.length>0&&s.length<120?s:t||e}function H(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let n=e?"true":"false";t.setAttribute("aria-checked",n),t.setAttribute("aria-selected",n),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(a){if(a.type==="radio"&&a.checked===e)return;a.checked=e;try{let r=a._valueTracker;r&&r.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,X(a,["input","change"]);let n=t!==a?t:a;try{n.focus?.()}catch{}n.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:window}))}else{try{t.focus?.()}catch{}t.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:window}))}}function Ae(o,e){let t=o instanceof HTMLSelectElement?o:o.querySelector("select");if(t){let n=e.map(i=>f(i).toLowerCase()),r=!1;for(let i=0;i<t.options.length;i++){let s=t.options[i],l=s.value.toLowerCase(),c=f(s.textContent).toLowerCase();if(n.some(u=>u===l||u===c)){if(s.selected=!0,t.selectedIndex=i,r=!0,!t.multiple)break}else t.multiple||(s.selected=!1)}if(!r)for(let i=0;i<t.options.length;i++){let s=t.options[i],l=s.value.toLowerCase(),c=f(s.textContent).toLowerCase();if(n.some(u=>l.includes(u)||c.includes(u)||u.length>3&&(u.includes(l)||u.includes(c)))&&(s.selected=!0,t.selectedIndex=i,r=!0,!t.multiple))break}if(r){X(t,["input","change","blur"]);return}}let a=o.closest('[role="combobox"], [class*="select" i], [class*="dropdown" i]');if(a){k(a);for(let n of e){let r=y(n);if(r){k(r);return}}}}function Mt(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Ee(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function B(o,e){let t=f(o).toLowerCase();if(!t)return null;let a=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',n=Array.from(document.querySelectorAll(a)),r=e==="destination"?n.find(i=>[i.getAttribute("data-category"),i.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t)):null;return r&&w(r)&&!T(r)?r:n.find(i=>{if(!w(i)||T(i))return!1;let s=f(`${i.textContent||""} ${i.getAttribute("data-category")||""} ${i.getAttribute("data-dropzone")||""}`).toLowerCase();return s===t||s.includes(t)})||null}async function ie(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),n=e.getBoundingClientRect(),r=Math.round(a.left+Math.max(1,a.width/2)),i=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(n.left+Math.max(1,n.width/2)),l=Math.round(n.top+Math.max(1,n.height/2)),c=f(e.textContent).toLowerCase();if(c){let b=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(p=>{let v=f(p.textContent).toLowerCase(),E=p instanceof HTMLInputElement||p instanceof HTMLOptionElement?f(p.value).toLowerCase():"";return v&&(c.includes(v)||v.includes(c))||E&&(c.includes(E)||E.includes(c))});b&&(k(b),await new Promise(p=>setTimeout(p,120)))}Ee(o),await new Promise(m=>setTimeout(m,140)),Ee(e);let d=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(d&&d!==e&&Ee(d),await new Promise(m=>setTimeout(m,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let u={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:i,screenX:r,screenY:i,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...u,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",u));let h=4;for(let m=1;m<=h;m++){let b=Math.round(r+(s-r)*(m/h)),p=Math.round(i+(l-i)*(m/h)),v={...u,clientX:b,clientY:p,screenX:b,screenY:p};try{o.dispatchEvent(new PointerEvent("pointermove",{...v,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",v))}let g={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:l,screenX:s,screenY:l,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...g,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",g)),e.dispatchEvent(new MouseEvent("click",g));try{let m=Mt(C(o.textContent),o.outerHTML),b={...u},p={...g};m&&(b.dataTransfer=m,p.dataTransfer=m);let v=o.ownerDocument.defaultView?.DragEvent;if(!v)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new v("dragstart",b)),e.dispatchEvent(new v("dragenter",p)),e.dispatchEvent(new v("dragover",p)),e.dispatchEvent(new v("drop",p)),o.dispatchEvent(new v("dragend",b))}catch(m){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",m)}try{let m=new Touch({identifier:1,target:o,clientX:r,clientY:i}),b=new Touch({identifier:1,target:e,clientX:s,clientY:l});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[m]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[b]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(m=>setTimeout(m,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var tt={fill:(o,e)=>{let t=y(o);t?Te(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=y(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?H(e,!0):k(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=y(o);t?H(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:o=>y(o),drag:(o,e)=>{let t=B(o,"source")||y(o),a=B(e,"destination")||y(e);t&&a?ie(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=B(o,"source")||y(o),a=B(e,"destination")||y(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await ie(t,a)},execute:(o,e=!1,t=1)=>Me(o,e,t)};window.$eq=tt;async function kt(o,e=1,t=Y()){if(ye(o,t),o.t==="js"){let i=String(o.v||"");Ue(i);try{new Function("$eq","document","window",i)(tt,document,window)}catch(s){throw console.warn("[EasyQuiz JS Execution]",s),s}return}if(o.t==="drag"){let i=B(o.from,"source")||y(o.from),s=B(o.to,"destination")||y(o.to);!i&&o.from&&(i=y(f(o.from))),!s&&o.to&&(s=y(f(o.to))),i&&s?await ie(i,s,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id||"",n=y(a);!n&&a&&(n=y(f(a)));let r=o.v!==void 0?String(o.v).trim():"";if(n&&r){if(n instanceof HTMLInputElement&&n.type==="radio"&&n.name){if(f(n.value).toLowerCase()!==f(r).toLowerCase()){let i=document.querySelector(`input[type="radio"][name="${CSS.escape(n.name)}"][value="${CSS.escape(r)}" i]`);if(i)n=i;else{let l=Array.from(document.querySelectorAll(`input[type="radio"][name="${CSS.escape(n.name)}"]`)).find(c=>{let d=c.closest("label, .vf-label, .option-card, tr, td, div");return d&&f(d.textContent).toLowerCase().includes(f(r).toLowerCase())});l&&(n=l)}}}else if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLSelectElement)&&!(n instanceof HTMLTextAreaElement)){let i=n.querySelector(`input[value="${CSS.escape(r)}" i], [data-value="${CSS.escape(r)}" i]`);if(i)n=i;else{let l=Array.from(n.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(c=>{let d=c.closest("label, .vf-label, .option-card, td, div");return d&&f(d.textContent).toLowerCase().includes(f(r).toLowerCase())});l&&(n=l)}}}if(!n&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":n&&(n instanceof HTMLButtonElement||n.tagName.toLowerCase()==="a"||n.getAttribute("role")==="button"||n.getAttribute("role")==="link"||n instanceof HTMLInputElement&&["button","submit"].includes(n.type)||I(n)?(console.log(`[EasyQuiz] Auto-corre\xE7\xE3o: A\xE7\xE3o 'val' direcionada a bot\xE3o/link '${o.id}'. Clicando...`),k(n)):Te(n,String(o.v)));break;case"chk":n&&H(n,!!o.c);break;case"sel":if(n){let s=Array.isArray(o.v)?o.v:[String(o.v)];Ae(n,s)}break;case"clk":n&&(!!(n.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||n.querySelector('input[type="radio"], input[type="checkbox"]')||n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type))?H(n,!0):k(n,o.co));break;case"adv":let i=ot(o.id);if(i){await Ce(i,1200);let s=o.id||i.textContent?.trim()||"";s&&ge(window.location.hostname,{advanceSelector:s}),k(i)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Lt(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!w(t)||T(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",n=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(n)})||null}function ot(o){if(o){let r=y(o);if(r&&w(r)&&!T(r))return r}try{let r=U(window.location.hostname);if(r.advanceSelector){let i=y(r.advanceSelector);if(i&&w(i)&&!T(i))return i}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(e)).filter(r=>w(r)&&!T(r)&&!r.closest("header, nav, aside"));for(let r of a)if(I(r))return r;for(let r of a){let i=r instanceof HTMLInputElement||r instanceof HTMLButtonElement?r.value:"",s=(r.textContent||i||r.getAttribute("aria-label")||"").trim();if(ne.test(s))return r}let n=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return n&&w(n)&&!T(n)?n:null}async function Ce(o,e=1500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(n=>setTimeout(n,100))}}function at(){let o=(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim(),e=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"]').length;return`${window.location.href}|${document.title}|${o.slice(0,900)}|${e}`}async function Ht(o,e=1800){let t=Date.now();for(;Date.now()-t<e;){if(at()!==o)return{changed:!0,evidence:"URL, texto, t\xEDtulo ou conjunto de controles mudou ap\xF3s a a\xE7\xE3o."};await new Promise(n=>setTimeout(n,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a observ\xE1vel foi detectada dentro do tempo limite."}}async function Ze(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let a=y(o.from)||y(f(o.from)),n=y(o.to)||y(f(o.to));a&&n&&await ie(a,n,2);return}let e=o.id||"",t=y(e)||y(f(e));if(o.t==="clk"||o.t==="chk"){if(!t&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),r=f(e).toLowerCase();t=n.find(i=>{let s=f(i.textContent).toLowerCase(),l=f(i.value||"").toLowerCase();return s.includes(r)||l===r||s.startsWith(r+")")||s.startsWith("("+r+")")})||null}let a=o.v!==void 0?String(o.v).trim():"";if(t&&a){if(t instanceof HTMLInputElement&&t.type==="radio"&&t.name){if(f(t.value).toLowerCase()!==f(a).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${CSS.escape(t.name)}"][value="${CSS.escape(a)}" i]`);if(n)t=n;else{let i=Array.from(document.querySelectorAll(`input[type="radio"][name="${CSS.escape(t.name)}"]`)).find(s=>{let l=s.closest("label, .vf-label, .option-card, tr, td, div");return l&&f(l.textContent).toLowerCase().includes(f(a).toLowerCase())});i&&(t=i)}}}else if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLSelectElement)&&!(t instanceof HTMLTextAreaElement)){let n=t.querySelector(`input[value="${CSS.escape(a)}" i], [data-value="${CSS.escape(a)}" i]`);if(n)t=n;else{let i=Array.from(t.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(s=>{let l=s.closest("label, .vf-label, .option-card, td, div");return l&&f(l.textContent).toLowerCase().includes(f(a).toLowerCase())});i&&(t=i)}}}if(t){let n=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,r=t instanceof HTMLInputElement&&["radio","checkbox"].includes(t.type)?t:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),i=o.t==="chk"?!!o.c:!0;if(H(r||n,i),r)try{r.checked=i;try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(r,i)}catch{}(r.type!=="checkbox"||r.checked!==i)&&r.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:window})),r.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),r.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}catch{}try{n.focus?.(),n.setAttribute("aria-checked",i?"true":"false"),n.classList.toggle("selected",i),n.classList.toggle("active",i),n.classList.toggle("checked",i),r||n.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:window}))}catch{}if(!r||r.checked!==i)try{n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0}))}catch{}try{n.onclick?.()}catch{}try{r?.onclick?.()}catch{}try{r?.onchange?.()}catch{}}return}if(o.t==="val"){if(!t&&e){let a=Array.from(document.querySelectorAll('input:not([type="hidden"]), textarea, [contenteditable="true"]')),n=f(e).toLowerCase();t=a.find(r=>{let i=(r.getAttribute("placeholder")||"").toLowerCase(),s=(r.name||"").toLowerCase(),l=(r.id||"").toLowerCase(),c=(r.getAttribute("aria-label")||"").toLowerCase();return i.includes(n)||s.includes(n)||l.includes(n)||c.includes(n)})||null}if(t){let n=(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t:t.querySelector('input:not([type="hidden"]), textarea, [contenteditable="true"]'))||t,r=String(o.v??"");try{n.focus?.(),document.execCommand?.("selectAll",!1,void 0),document.execCommand?.("insertText",!1,r)}catch{}Te(n,r)}return}if(o.t==="sel"){if(!t&&e){let a=Array.from(document.querySelectorAll("select")),n=f(e).toLowerCase();t=a.find(r=>{let i=(r.name||"").toLowerCase(),s=(r.id||"").toLowerCase(),l=(r.getAttribute("aria-label")||"").toLowerCase();return i.includes(n)||s.includes(n)||l.includes(n)})||null}if(t){let a=Array.isArray(o.v)?o.v:[String(o.v)];Ae(t,a)}return}}function G(o){try{if(o.t==="val"){let e=y(o.id)||y(f(o.id));if(!e)return!1;if(e instanceof HTMLButtonElement||e.tagName.toLowerCase()==="a"||e.getAttribute("role")==="button"||e.getAttribute("role")==="link"||e instanceof HTMLInputElement&&["button","submit"].includes(e.type)||I(e))return!0;let a=String(o.v??"").trim(),n=e instanceof HTMLInputElement&&e.type==="radio"?e:e.querySelector('input[type="radio"]');if(n&&n.name){let c=document.querySelector(`input[type="radio"][name="${CSS.escape(n.name)}"]:checked`);if(!c)return!1;let d=f(c.value).toLowerCase(),u=f(a).toLowerCase(),h=f(c.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===u||h===u||h.includes(u)}let r=e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement?e:e.querySelector('input:not([type="hidden"]), textarea, [contenteditable="true"]'),i=(r?r.value??r.textContent??"":e.textContent??"").trim();if(!i&&!a)return!0;if(!i&&a)return!1;let s=i.replace(",",".").toLowerCase(),l=a.replace(",",".").toLowerCase();return s===l||s.includes(l)||i.toLowerCase()===a.toLowerCase()}if(o.t==="sel"){let e=y(o.id)||y(f(o.id));if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t)return!1;let n=(Array.isArray(o.v)?o.v:[String(o.v)]).map(r=>f(r).toLowerCase());return Array.from(t.options).some(r=>{if(!r.selected)return!1;let i=r.value.toLowerCase(),s=f(r.textContent).toLowerCase();return n.some(l=>l===i||l===s||i.includes(l)||s.includes(l))})}if(o.t==="chk"||o.t==="clk"){let e=y(o.id)||y(f(o.id));if(!e)return!1;let t=e.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||e,a=e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type)?e:t.querySelector('input[type="checkbox"], input[type="radio"]')||(t.getAttribute("for")?t.ownerDocument.getElementById(t.getAttribute("for")):null),n=o.t==="chk"?!!o.c:!0;if(a&&a.type==="radio"&&o.v){let c=f(String(o.v)).toLowerCase();if(a.name){let d=document.querySelector(`input[type="radio"][name="${CSS.escape(a.name)}"]:checked`);return d?f(d.value).toLowerCase()===c:!1}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===n;let r=t.getAttribute("aria-checked")===String(n)||t.getAttribute("aria-selected")===String(n)||t.getAttribute("aria-pressed")===String(n),i=n?t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.getAttribute("data-active")==="true"||t.getAttribute("data-state")==="checked"||t.getAttribute("data-state")==="on":t.getAttribute("data-selected")==="false"||t.getAttribute("data-checked")==="false"||t.getAttribute("data-state")==="unchecked",s=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(t.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(t.className||"");return!!(r||i||s||(t instanceof HTMLButtonElement||t.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!a)}if(o.t==="drag"){let e=y(o.from)||y(f(o.from)),t=y(o.to)||y(f(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function Me(o,e,t=1,a=Y({engine:"smart",autoAdvance:e})){let n=o.actions.filter(p=>p.t!=="adv"),r=o.actions.filter(p=>p.t==="adv"),i=0,s=[],l=new Map;for(let p of n){try{await kt(p,t,a),i++}catch(v){l.set(p,v instanceof Error?v.message:String(v)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",p,v)}p.t==="drag"&&await new Promise(v=>setTimeout(v,250))}await new Promise(p=>setTimeout(p,n.length>0?300:50));let c=0;for(let p of n){if(G(p)){c++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${p.t}' no alvo '${p.id||p.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{ye(p,a),await Ze(p)}catch(v){l.set(p,v instanceof Error?v.message:String(v)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",v)}await new Promise(v=>setTimeout(v,180)),G(p)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),c++)}if(c<n.length&&n.length>0){console.warn(`[EasyQuiz Auto-Cura] ${n.length-c} de ${n.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(p=>setTimeout(p,200));for(let p of n)if(!G(p))try{await Ze(p)}catch(v){l.set(p,v instanceof Error?v.message:String(v))}await new Promise(p=>setTimeout(p,200)),c=0;for(let p of n)G(p)&&c++}let d=o.pageType==="question";for(let p of n)G(p)||s.push(p.t==="drag"?`${p.from} -> ${p.to}`:"id"in p?p.id:p.t);let u=n.map((p,v)=>{let E=p.t==="drag"?`${p.from} -> ${p.to}`:p.t==="js"?"$eq":p.id||p.t,q=p.t==="js"?!0:p.t==="drag"?!!(B(p.from,"source")&&B(p.to,"destination")):!!(y(p.id||"")||y(f(p.id||""))),A=G(p);return{index:v,action:p,target:E,located:q,applied:!l.has(p),verified:A,strategy:p.t==="drag"?"drag-adaptive":p.t==="js"?"javascript":"declarative-dom",evidence:A?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...l.has(p)?{error:l.get(p)}:{}}}),h=!d||n.length===0?!0:i===n.length&&c===n.length&&s.length===0,g=!1,m=!1,b="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.";if(e&&(h||!d)){if(await new Promise(q=>setTimeout(q,n.length>0?500:200)),o.pageType!=="info"){let q=Lt();q&&w(q)&&(await Ce(q,1200),k(q),await new Promise(A=>setTimeout(A,800)))}let p=at(),v=r.length>0?r[0].id:void 0,E=ot(v);if(E){await Ce(E,1200);let q=v||E.textContent?.trim()||"";q&&ge(window.location.hostname,{advanceSelector:q}),k(E);let A=await Ht(p);m=A.changed,b=A.evidence,g=A.changed,A.changed||console.warn("[EasyQuiz] O bot\xE3o foi acionado, mas a navega\xE7\xE3o n\xE3o foi confirmada.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:i,verified:c,success:h,advanced:g,failed:s,reports:u,navigationVerified:m,navigationEvidence:b}}var et=!1,z=null;function ke(){let o=typeof window<"u"&&window.document?window.document:typeof document<"u"?document:null;!o||et||(et=!0,o.addEventListener("click",e=>{let t=e.target;if(!t||T(t))return;if(z&&(t===z||t.contains(z))){e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.();return}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type))return;let a=t.closest('label, .option-card, [role="radio"], [role="checkbox"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]');if(!a||T(a))return;let n=a.querySelector('input[type="checkbox"], input[type="radio"]');if(!n&&a.hasAttribute("for")){let r=a.getAttribute("for");r&&(n=a.ownerDocument.getElementById(r))}n&&(n.type==="checkbox"?(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),z=n,setTimeout(()=>{z===n&&(z=null)},70),H(n,!n.checked)):n.type==="radio"&&(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),z=n,setTimeout(()=>{z===n&&(z=null)},70),H(n,!0)))},!0))}var W=null,F=[];function Z(){W&&(W.style.removeProperty("outline"),W.style.removeProperty("outline-offset"),W=null);for(let o of F)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");F=[]}function Le(o){Z(),W=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px"}function nt(o){for(let e of o){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let r=y(e.from),i=y(e.to);r&&(r.style.outline="2px solid #00ff88",F.push(r)),i&&(i.style.outline="2px dashed #00e5ff",F.push(i))}catch{}continue}if(!e.id)continue;let t=y(e.id);if(!t)continue;let a=t.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i], tr, li')||t;a.style.outline="2px solid #00ff88",a.style.outlineOffset="2px",a.style.backgroundColor="rgba(0, 255, 136, 0.12)",a.setAttribute("data-easyquiz-highlight","true"),F.push(a);let n=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]');n&&n!==a&&(n.style.outline="2px solid #00ff88",n.style.outlineOffset="2px",n.style.boxShadow="0 0 10px rgba(0, 255, 136, 0.8)",n.setAttribute("data-easyquiz-highlight","true"),F.push(n))}}var ee=4,It=1200,He=12e5;function se(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let n=String(a.result||"");e(n.split(",")[1]||"")},a.readAsDataURL(o)})}async function re(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,It/Math.max(e,t)),n=Math.max(1,Math.round(e*a)),r=Math.max(1,Math.round(t*a)),i=document.createElement("canvas");i.width=n,i.height=r;let s=i.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,n,r),s.drawImage(o,0,0,n,r),new Promise((l,c)=>{i.toBlob(d=>d?l(d):c(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function it(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,n=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let n=this.element.querySelector("#eq-fah-copy-md-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let r=this.element.querySelector("#eq-fah-copy-all-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let i=this.element.querySelector("#eq-fah-header");this.setupDraggable(i)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let n=this.element.getBoundingClientRect();this.initialLeft=n.left,this.initialTop=n.top;let r=s=>{if(!this.isDragging||!this.element)return;let l=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,d=Math.max(10,window.innerWidth-this.element.offsetWidth-10),u=Math.max(10,window.innerHeight-this.element.offsetHeight-10),h=Math.min(Math.max(10,this.initialLeft+l),d),g=Math.min(Math.max(10,this.initialTop+c),u);this.element.style.left=`${h}px`,this.element.style.top=`${g}px`},i=()=>{this.isDragging=!1,window.removeEventListener("mousemove",r),window.removeEventListener("mouseup",i)};window.addEventListener("mousemove",r),window.addEventListener("mouseup",i)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let n=this.currentPlan,r=n.actions.filter(h=>h.t==="drag"),i=n.actions.filter(h=>{if(h.t!=="val")return!1;let g=f(h.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(g)}),s=n.actions.filter(h=>h.t==="clk"||h.t==="chk"),l=r.length||i.length||s.length,c=document.createElement("div");c.className="eq-fah-meta";let d=document.createElement("span");d.textContent=`Modo: ${n.mode.replace("_"," ")}`;let u=document.createElement("span");if(u.className="eq-fah-meta-badge",u.textContent=`${Math.round(n.confidence*100)}% Confian\xE7a`,c.append(d,u),e.appendChild(c),r.length>0||n.mode==="categorizacao"||n.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${r.length} itens)`,a.textContent=String(r.length);let h={};for(let g of r){let m=f(g.to)||"Geral";h[m]||(h[m]=[]),h[m].push(f(g.from))}for(let[g,m]of Object.entries(h)){let b=document.createElement("div"),p=/fato|true|verdadeiro|sim/i.test(g),v=/opini[aã]o|false|falso|n[aã]o/i.test(g);b.className=`eq-fah-group ${p?"group-fato":v?"group-opiniao":""}`;let E=document.createElement("div");E.className="eq-fah-group-title",E.textContent=`\u{1F4C1} ${g} (${m.length})`,b.appendChild(E);let q=document.createElement("div");q.className="eq-fah-group-items";for(let A of m){let S=document.createElement("div");S.className="eq-fah-item";let P=document.createElement("span");P.className="eq-fah-item-text",P.textContent=A,S.appendChild(P);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(A),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),S.appendChild(L),q.appendChild(S)}b.appendChild(q),e.appendChild(b)}}else if(i.length>0){t.textContent=`Preenchimento (${i.length} campos)`,a.textContent=String(i.length);let h=document.createElement("div");h.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="Respostas para Inserir:",h.appendChild(g);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b of i){let p=document.createElement("div");p.className="eq-fah-item";let v=document.createElement("span");v.className="eq-fah-item-text";let E=Se(b.id),A=/^[#\.\$]|input|mat-|cell|field|q[0-9]/i.test(E)?"":E;v.textContent=`${A?`${A}: `:""}${b.v}`,p.appendChild(v);let S=document.createElement("button");S.className="eq-fah-copy-inline",S.textContent="Copiar",S.addEventListener("click",()=>{navigator.clipboard.writeText(String(b.v)),S.textContent="\u2713 Copiado",setTimeout(()=>S.textContent="Copiar",1200)}),p.appendChild(S),m.appendChild(p)}h.appendChild(m),e.appendChild(h)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let h=document.createElement("div");h.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="Alternativa(s) Correta(s):",h.appendChild(g);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b of s){let p=document.createElement("div");p.className="eq-fah-item";let v=document.createElement("span");v.className="eq-fah-item-text";let E=Se(b.id);/^[#\.\$]|opt|choice|radio|chk|q[0-9]/i.test(E)&&b.v&&(E=String(b.v)),v.textContent=`\u2611 ${E}`,p.appendChild(v);let q=document.createElement("button");q.className="eq-fah-copy-inline",q.textContent="Copiar",q.addEventListener("click",()=>{navigator.clipboard.writeText(E),q.textContent="\u2713 Copiado",setTimeout(()=>q.textContent="Copiar",1200)}),p.appendChild(q),m.appendChild(p)}h.appendChild(m),e.appendChild(h)}else{t.textContent="Gabarito",a.textContent="0";let h=document.createElement("div");h.style.padding="10px",h.style.color="#888",h.textContent="Nenhuma resposta direta para exibir.",e.appendChild(h)}if(n.rationale){let h=document.createElement("div");h.className="eq-fah-rationale",h.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${n.rationale}`,e.appendChild(h)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(i=>i.t==="drag"),n=e.actions.filter(i=>i.t==="val"),r=e.actions.filter(i=>i.t==="clk"||i.t==="chk");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let s of a){let l=f(s.to)||"Geral";i[l]||(i[l]=[]),i[l].push(f(s.from))}for(let[s,l]of Object.entries(i)){t.push(`### Categoria: ${s}`);for(let c of l)t.push(`- ${c}`);t.push("")}}else if(n.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of n){let s=f(i.id);t.push(`- **${s||"Campo"}:** \`${i.v}\``)}t.push("")}else if(r.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i of r)t.push(`- [x] ${f(i.id)}`);t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let a=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=a},1500)})}};var st=`
...
`;var Pt=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],$t=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],de=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestPromptText="";progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new le({onStatusChange:(n,r,i)=>{this.logToConsole(r,i),n==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(n==="advancing"||n==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async n=>{try{return await this.callbacks.onAnalyze(n)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
    ...
    `,this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap"),this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new ce(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),D.forEach(n=>this.modelSelect.add(new Option(n.name,n.id,!1,n.id===e.model))),Pt.forEach(n=>this.modeSelect.add(new Option(n.label,n.value,!1,n.value===e.modeHint))),$t.forEach(n=>this.engineSelect.add(new Option(n.label,n.value,!1,n.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.setupEventListeners(),document.body.appendChild(this.host),this.applyHostDarkMode(e.hostDarkMode),e.apiKey&&ae(e.apiKey).then(n=>{n&&n.length>0&&this.updateModelSelect(n,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","settings"];for(let a of t){let n=this.shadow.querySelector(`#eq-tab-${a}`),r=this.shadow.querySelector(`#eq-view-${a}`);a===e?(n?.classList.add("active"),r&&(r.style.display="flex")):(n?.classList.remove("active"),r&&(r.style.display="none"))}e==="brain"&&(this.renderContextTree(),this.refreshInspectorView())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),this.shadow.querySelector("#eq-min-btn")?.addEventListener("click",()=>this.toggle(!1)),this.shadow.querySelector("#eq-close-btn")?.addEventListener("click",()=>this.toggle(!1)),window.addEventListener("keydown",i=>{i.altKey&&(i.key==="q"||i.key==="Q")&&(i.preventDefault(),this.toggle())},!0);let e=i=>{let s=i.composedPath();(s.includes(this.sidebarEl)||s.includes(this.host))&&i.stopImmediatePropagation()};window.addEventListener("keydown",e,!0),window.addEventListener("keyup",e,!0),window.addEventListener("keypress",e,!0),this.apiKeyInput.addEventListener("input",()=>{let i=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:i})}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let i=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=i,this.callbacks.onSettingsChange({apiKey:i}),this.setStatus("Chave Gemini salva com sucesso!","success"),this.keyContextMenu.hidden=!0}),this.keyMoreBtn.addEventListener("click",i=>{i.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",i=>{let s=i.target;!s.closest("#eq-key-context-menu")&&!s.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let i=this.apiKeyInput.value.trim(),s=window.prompt("Cole sua Chave API do Google Gemini (AI Studio):",i);if(s!==null){let l=s.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=l,this.callbacks.onSettingsChange({apiKey:l}),this.setStatus("Chave Gemini inserida e salva com sucesso!","success")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let i=await navigator.clipboard.readText();if(i){let s=i.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=s,this.callbacks.onSettingsChange({apiKey:s}),this.setStatus("Chave colada e salva com sucesso!","success")}}catch{let i=this.apiKeyInput.value.trim(),s=window.prompt("Cole sua Chave API do Google Gemini (AI Studio):",i);if(s!==null){let l=s.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=l,this.callbacks.onSettingsChange({apiKey:l}),this.setStatus("Chave Gemini inserida e salva com sucesso!","success")}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let i=this.apiKeyInput.type==="password";this.apiKeyInput.type=i?"text":"password";let s=this.shadow.querySelector("#eq-menu-vis-icon"),l=this.shadow.querySelector("#eq-menu-vis-text");s&&(s.innerHTML=i?x.eyeOff:x.eye),l&&(l.textContent=i?"Ocultar Chave":"Mostrar Chave")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.callbacks.onSettingsChange({apiKey:""}),this.setStatus("Campo limpo. Cole a nova chave e clique em Salvar.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-test")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;let i=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!i)return this.setStatus("Insira ou cole a chave de API.","error");this.setStatus("Testando chave e descobrindo modelos autorizados...","info");try{let s=await Qe(i);this.setStatus(s.message,s.ok?"success":"error"),s.ok&&s.models&&s.models.length>0&&this.updateModelSelect(s.models)}catch(s){this.setStatus("Erro ao validar chave: "+s.message,"error")}});let a=()=>{this.keyContextMenu.hidden=!0,window.confirm("Deseja realmente resetar todos os dados, chaves e mem\xF3ria de sess\xE3o do EasyQuiz?")&&(Re(),this.apiKeyInput.value="",this.callbacks.onSettingsChange({apiKey:""}),this.setStatus("Todos os dados do EasyQuiz foram limpos.","info"),this.logToConsole("> [SYS] Armazenamento local resetado.","text-yellow"))};this.shadow.querySelector("#eq-menu-reset")?.addEventListener("click",a),this.shadow.querySelector("#eq-reset-all-btn")?.addEventListener("click",a),this.apToggleBtn.addEventListener("click",()=>{if(this.autopilot.isActive())this.autopilot.stop(),this.apToggleBtn.innerHTML=`${x.play} INICIAR AUTOPILOT`,this.apToggleBtn.classList.remove("danger"),this.stopStopwatch(),this.setStatus("Autopilot pausado pelo usu\xE1rio.","info");else{if(!this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"")){this.setStatus("Configure sua chave de API Gemini na aba Configura\xE7\xF5es antes de ligar o Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,this.autopilot.start(),this.apToggleBtn.innerHTML=`${x.stop} PARAR AUTOPILOT`,this.apToggleBtn.classList.add("danger"),this.startStopwatch(),this.setStatus("Autopilot ativo. Monitorando exerc\xEDcios...","info")}}),this.shadow.querySelector("#eq-ap-clear-memory").addEventListener("click",()=>{fe(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")});let r=this.shadow.querySelector("#eq-copy-console-btn");r?.addEventListener("click",()=>{let i=this.apConsole?.innerText||"";navigator.clipboard.writeText(i).then(()=>{let s=r.innerHTML;r.innerHTML=x.check,setTimeout(()=>r.innerHTML=s,1800)})}),this.copyPromptBtn.addEventListener("click",()=>{let i=this.inspPrompt.textContent||"";navigator.clipboard.writeText(i).then(()=>{let s=this.copyPromptBtn.innerHTML;this.copyPromptBtn.innerHTML=`${x.check} Copiado!`,setTimeout(()=>this.copyPromptBtn.innerHTML=s,2e3)})}),this.modelSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({model:this.modelSelect.value})),this.modeSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({modeHint:this.modeSelect.value})),this.engineSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({engine:this.engineSelect.value})),this.dryRunCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({dryRun:this.dryRunCheckbox.checked})),this.autoApplyCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoApply:this.autoApplyCheckbox.checked})),this.autoAdvanceCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoAdvance:this.autoAdvanceCheckbox.checked})),this.useVisionCheckbox.addEventListener("change",()=>{let i=this.useVisionCheckbox.checked;this.callbacks.onSettingsChange({useVision:i}),this.setStatus(i?"Vis\xE3o Computacional ativada (capturas habilitadas).":"Modo DOM R\xE1pido ativado (capturas desabilitadas).","info")}),this.hostDarkModeCheckbox.addEventListener("change",()=>{let i=this.hostDarkModeCheckbox.checked;this.callbacks.onSettingsChange({hostDarkMode:i}),this.applyHostDarkMode(i)}),this.analyzeBtn.addEventListener("click",async()=>{await this.callbacks.onAnalyze()&&!this.dryRunCheckbox.checked&&!this.autoApplyCheckbox.checked&&this.callbacks.onApply()}),this.applyBtn.addEventListener("click",()=>this.callbacks.onApply())}startStopwatch(){this.stopStopwatch(),this.stopwatchStartTime=Date.now();let e=()=>{let t=((Date.now()-this.stopwatchStartTime)/1e3).toFixed(2)+"s";this.stopwatchAp.textContent=t,this.stopwatchAdv.textContent=t};e(),this.stopwatchInterval=setInterval(e,100)}stopStopwatch(e){if(this.stopwatchInterval&&(clearInterval(this.stopwatchInterval),this.stopwatchInterval=null),e!==void 0){let t=(e/1e3).toFixed(2)+"s";this.stopwatchAp.textContent=t,this.stopwatchAdv.textContent=t}}logToConsole(e,t){if(!this.apConsole)return;let a=document.createElement("div"),n=new Date,r=`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}:${String(n.getSeconds()).padStart(2,"0")}.${String(Math.floor(n.getMilliseconds()/100))}`,i=e;if(e.startsWith(">")?i=`> [${r}] ${e.slice(1).trim()}`:i=`[${r}] ${e}`,a.textContent=i,t&&(a.className=t),this.apConsole.appendChild(a),this.apConsole.scrollTop=this.apConsole.scrollHeight,this.executionConsole){let s=a.cloneNode(!0);for(this.executionConsole.appendChild(s),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}for(;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let a=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${a}%`,this.progressVal&&(this.progressVal.textContent=`${a}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),a>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t),this.activeTab==="brain"&&(this.renderContextTree(),t&&this.refreshInspectorView())}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=te(),a=this.latestPlan;this.contextTreeContainer.innerHTML="";let n=this.createTreeFolder("\u{1F4C4} P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(n);let r=e?e.controls:[],i=r.map((d,u)=>{let h=d.role==="navigation"||d.type==="button",g=!h&&d.value?` [val: "${d.value}"]`:"";return{label:`[#${u+1}] ${d.type.toUpperCase()}`,value:`${d.label||d.id||d.name||"(Sem r\xF3tulo)"}${g}`.trim(),badge:h?"Navega\xE7\xE3o":d.role||d.type}}),s=this.createTreeFolder(`\u{1F39B}\uFE0F CONTROLES DETECTADOS (${r.length})`,r.length>0,i);this.contextTreeContainer.appendChild(s);let l=t.map((d,u)=>({label:`Mem\xF3ria #${u+1}`,value:d,badge:"RAG"})),c=this.createTreeFolder(`\u{1F9E0} MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,l);if(this.contextTreeContainer.appendChild(c),a){let d=this.createTreeFolder(`\u{1F916} \xDALTIMO PLANO IA (${a.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:a.pageType,badge:`${(a.confidence*100).toFixed(0)}%`},{label:"Modo",value:a.mode},{label:"Racioc\xEDnio",value:a.rationale||"N/A"},...a.actions.map((u,h)=>({label:`A\xE7\xE3o #${h+1} (${u.t})`,value:JSON.stringify(u)}))]);this.contextTreeContainer.appendChild(d)}}createTreeFolder(e,t,a){let n=document.createElement("div");n.className="eq-tree-node";let r=document.createElement("div");r.className="eq-tree-header",r.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let i=document.createElement("div");if(i.className="eq-tree-content",i.style.display=t?"flex":"none",a.length===0)i.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let s of a){let l=document.createElement("div");l.className="eq-tree-leaf",l.innerHTML=`
        ...
        `,i.appendChild(l)}return r.addEventListener("click",()=>{let s=i.style.display==="none";i.style.display=s?"flex":"none";let l=r.querySelector(".eq-tree-arrow");l&&(l.textContent=s?"\u25BC":"\u25B6")}),n.appendChild(r),n.appendChild(i),n}toggle(e){e!==void 0?this.isCollapsed=!e:this.isCollapsed=!this.isCollapsed,this.isCollapsed?this.sidebarEl.classList.add("eq-collapsed"):(this.sidebarEl.classList.remove("eq-collapsed"),this.apiKeyInput.value||(this.switchTab("settings"),this.apiKeyInput.focus()))}setBusy(e,t){this.analyzeBtn.disabled=e,[this.modelSelect,this.modeSelect,this.engineSelect,this.dryRunCheckbox,this.autoApplyCheckbox,this.autoAdvanceCheckbox,this.useVisionCheckbox].forEach(a=>a.disabled=e),e?(this.startStopwatch(),this.dotPulseAp.className="eq-dot-pulse busy",this.dotPulseAdv.className="eq-dot-pulse busy",this.launcherDot.className="eq-launcher-dot busy",t&&this.setStatus(t,"info")):(this.stopStopwatch(),this.dotPulseAp.className="eq-dot-pulse",this.dotPulseAdv.className="eq-dot-pulse",this.launcherDot.className="eq-launcher-dot")}setStatus(e,t="info"){this.statusTextAp.textContent=e,this.statusTextAdv.textContent=e;let a=this.shadow.querySelector("#eq-operation-state");a&&(a.textContent=t==="error"?"Bloqueado":t==="success"?"Confirmado":this.autopilot.isActive()?"Monitorando":"Pronto",a.className=`eq-operation-state is-${t}`),t==="error"?(this.dotPulseAp.className="eq-dot-pulse error",this.dotPulseAdv.className="eq-dot-pulse error",this.launcherDot.className="eq-launcher-dot error"):t==="success"&&(this.dotPulseAp.className="eq-dot-pulse",this.dotPulseAdv.className="eq-dot-pulse",this.launcherDot.className="eq-launcher-dot");let n=e.includes("Alternando")||e.includes("indispon\xEDvel")||e.includes("fallback")||e.includes("alternativo"),r=t==="error"?"> [ERRO] ":t==="success"?"> [SUCESSO] ":n?"> [FALLBACK] ":"> [SYS] ",i=t==="error"?"text-red":t==="success"?"text-green":n?"text-yellow":"text-blue";this.logToConsole(`${r}${e}`,i)}setPlan(e,t){this.latestPlan=e,this.resultContainer.style.display="flex",e.durationMs&&this.stopStopwatch(e.durationMs);let a=this.shadow.querySelector("#eq-badges");a.replaceChildren();let n=[e.mode.replace("_"," "),`${Math.round(e.confidence*100)}% Confian\xE7a`,`${e.actions.length} a\xE7\xF5es`,...e.usedModel?[e.usedModel]:[]];for(let l of n){let c=document.createElement("span");c.className="eq-brand-badge",c.textContent=l,a.appendChild(c)}let r=this.shadow.querySelector("#eq-rationale-text");r.textContent=e.rationale;let i=this.shadow.querySelector("#eq-actions-list");i.innerHTML="";for(let l of e.actions){let c=document.createElement("div");c.className="eq-action-item";let d="";l.t==="chk"?d=`chk ${l.id} (${l.c})`:l.t==="val"?d=`val "${l.v}" -> ${l.id}`:l.t==="sel"?d=`sel "${Array.isArray(l.v)?l.v.join(","):l.v}" -> ${l.id}`:l.t==="clk"?d=`clk ${l.id}`:l.t==="adv"?d="adv":l.t==="js"?d=`js: ${String(l.v).slice(0,40)}...`:l.t==="drag"&&(d=`drag "${l.from}" -> "${l.to}"`);let u=document.createElement("span");u.className="eq-action-badge",u.textContent=l.t.toUpperCase();let h=document.createElement("span");h.textContent=d,c.append(u,h),i.appendChild(c)}this.applyBtn.disabled=!t||!e.actions.length;let s=this.shadow.querySelector("#eq-execution-card");s&&(s.hidden=!0),this.refreshInspectorView()}setExecutionReport(e){let t=this.shadow.querySelector("#eq-execution-card"),a=this.shadow.querySelector("#eq-execution-summary"),n=this.shadow.querySelector("#eq-execution-list");if(!t||!a||!n)return;t.hidden=!1,a.textContent=e.navigationVerified?`${e.verified}/${e.applied} a\xE7\xF5es verificadas. Navega\xE7\xE3o confirmada.`:`${e.verified}/${e.applied} a\xE7\xF5es verificadas. ${e.navigationEvidence}`,a.className=`eq-execution-summary ${e.success?"is-success":"is-warning"}`,n.replaceChildren();let r=this.shadow.querySelector("#eq-execution-placeholder");r&&(r.textContent=e.navigationVerified?"Fluxo conclu\xEDdo: aplica\xE7\xE3o e navega\xE7\xE3o confirmadas.":`Fluxo interrompido: ${e.navigationEvidence}`,r.className=`eq-execution-placeholder ${e.success?"is-success":"is-warning"}`);for(let i of e.reports){let s=document.createElement("div");s.className=`eq-execution-row ${i.verified?"is-success":"is-failed"}`;let l=document.createElement("span");l.className="eq-execution-state",l.textContent=i.verified?"OK":"FALHOU";let c=document.createElement("div");c.className="eq-execution-details";let d=document.createElement("strong");d.textContent=i.target;let u=document.createElement("span");if(u.textContent=`${i.strategy} | ${i.evidence}`,c.append(d,u),s.append(l,c),i.error){let h=document.createElement("small");h.textContent=i.error,s.appendChild(h)}n.appendChild(s)}}setInspectorPrompt(e,t){this.latestPromptText=e,this.inspPrompt&&(this.inspPrompt.textContent=e),t&&this.inspModel&&(this.inspModel.textContent=t),this.inspLatency&&(this.inspLatency.textContent="Aguardando IA...")}refreshInspectorView(){let e=this.latestPlan;if(e)if(this.inspModel.textContent=e.usedModel||this.initialSettings.model,this.inspLatency.textContent=e.durationMs?`${e.durationMs}ms`:"--",this.inspTokens.textContent=e.tokensUsed?`${e.tokensUsed}`:"--",this.inspPrompt.textContent=e.promptSent||this.latestPromptText||"Prompt n\xE3o registrado para esta requisi\xE7\xE3o.",this.inspRationale.textContent=e.rationale,this.inspActions.innerHTML="",e.actions.length>0)for(let t of e.actions){let a=document.createElement("div");a.className="eq-action-item",a.textContent=JSON.stringify(t),this.inspActions.appendChild(a)}else this.inspActions.innerHTML='<div class="text-muted" style="padding: 4px;">Nenhuma a\xE7\xE3o prescrita pela IA.</div>';else this.latestPromptText&&(this.inspPrompt.textContent=this.latestPromptText)}showFloatingAnswers(e){let t=e||this.latestPlan;t&&this.floatingAnswers.show(t)}hideFloatingAnswers(){this.floatingAnswers.hide()}isFloatingAnswersOpen(){return this.floatingAnswers.isOpen()}updateModelSelect(e,t){let a=t||this.initialSettings.model||this.modelSelect.value;this.modelSelect.innerHTML="";let n=!1;e.forEach(r=>{let i=r.id===a;i&&(n=!0),this.modelSelect.add(new Option(r.name,r.id,!1,i))}),!n&&a&&this.modelSelect.add(new Option(`Gemini (${a})`,a,!1,!0)),this.modelSelect.value=a}updateSelectedModel(e){Array.from(this.modelSelect.options).some(a=>a.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}applyHostDarkMode(e){document.getElementById("eq-host-dark-mode-style")?.remove(),this.host.classList.toggle("eq-dark-mode-active",e)}destroy(){this.stopStopwatch(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function Rt(){let o=window;if(ke(),o.__easyquiz){o.__easyquiz.toggle();return}let e=me(),t=null,a=new de(e,{onAnalyze:(i=1)=>n(i),onApply:(i=1)=>void r(i),onDestroy:()=>{Z(),delete o.__easyquiz},onSettingsChange:i=>{e=Be(i)}});o.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await n()}},window.addEventListener("keydown",i=>{if(i.altKey&&(i.key==="q"||i.key==="Q")){if(i.preventDefault(),!a)return;a.toggle(!0),n()}});async function n(i=1){if(!e.apiKey){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),Z(),a.hideFloatingAnswers();try{let s=J(!1);s||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),s=j()),Le(s.scope),a.updateContext(s),a.logToConsole(`> [DOM] Escopo: <${s.scope.tagName.toLowerCase()}> com ${s.controls.length} controle(s) e ${s.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${s.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let l=await Ie(s.scope,e.useVision);a.setStatus(l.length>0?`Consultando Gemini (${e.model}) com ${l.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${e.model}) via DOM nativo (modo r\xE1pido)...`,"info");let c=K(s,l,e);a.setInspectorPrompt(c,e.model);let{plan:d,usedModel:u}=await be(s,l,e,(h,g)=>{a.setStatus(h,g==="warning"?"info":g)});if(d.needsMoreContext){a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),s=J(!0),s||(s=j()),Le(s.scope),a.updateContext(s),l=await Ie(s.scope,e.useVision),a.setStatus(`Reconsultando IA com escopo ampliado (${s.controls.length} controles)...`,"info");let h=K(s,l,e);a.setInspectorPrompt(h,e.model),d=(await be(s,l,e,(m,b)=>{a.setStatus(m,b==="warning"?"info":b)})).plan}return a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${u||e.model} | Modo: ${d.mode} | Confian\xE7a: ${(d.confidence*100).toFixed(0)}%`,"text-green"),d.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${d.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${d.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),d.memoryToStore&&(Oe(d.memoryToStore),a.logToConsole(`> [RAG] \u{1F9E0} Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${d.memoryToStore}"`,"text-yellow")),t=d,a.updateContext(s,d),nt(d.actions),a.setPlan(d,!e.dryRun),d.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):d.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):d.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&d.pageType==="question"&&a.showFloatingAnswers(d),e.autoApply&&!e.dryRun&&await r(i),d}catch(s){Z(),a.setProgress(0);let l=s instanceof Error?s.message:"Falha desconhecida na an\xE1lise.";a.setStatus(l,"error");return}finally{a.setBusy(!1)}}async function r(i=1){if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let s=t.pageType==="info"||t.pageType==="start",l=(e.autoAdvance||s)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext;a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let c=await Me(t,l,i,Y(e));if(a.setExecutionReport(c),c.success||c.advanced)a.setProgress(100,"Sucesso! Respostas preenchidas e validadas!"),a.logToConsole(`> [VERIF] \u2713 Sucesso no DOM: ${c.verified}/${c.applied} a\xE7\xF5es validadas com sucesso!`,"text-green"),c.advanced?a.logToConsole("> [NAV] \u2713 Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):l&&a.logToConsole(`> [NAV] \u26A0\uFE0F ${c.navigationEvidence}`,"text-yellow"),a.setStatus(c.advanced?`Sucesso: ${c.applied} resposta(s) preenchida(s) e pr\xF3xima quest\xE3o confirmada.`:`Respostas preenchidas e validadas. Avan\xE7o n\xE3o confirmado: ${c.navigationEvidence}`,c.advanced||!l?"success":"info"),a.hideFloatingAnswers();else{a.setProgress(0,"Aplica\xE7\xE3o bloqueada: verifica\xE7\xE3o incompleta.");let d=c.failed.length>0?c.failed.join(", "):"alvos n\xE3o confirmados";a.logToConsole(`> [VERIF] Falha: ${c.verified}/${c.applied} a\xE7\xF5es confirmadas. Alvos pendentes: ${d}.`,"text-yellow"),a.setStatus(`Aplica\xE7\xE3o incompleta. ${c.verified}/${c.applied} a\xE7\xF5es confirmadas; avan\xE7o bloqueado.`,"error"),t.pageType==="question"&&a.showFloatingAnswers(t)}}catch(c){a.setProgress(0);let d=c instanceof Error?c.message:"Falha ao aplicar plano.";a.setStatus(d,"error"),t.pageType==="question"&&i>=3?a.showFloatingAnswers(t):a.hideFloatingAnswers()}finally{a.setBusy(!1)}}a.toggle(!0)}ke();Rt().catch(o=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",o),window.alert(`EasyQuiz: falha ao iniciar: ${o instanceof Error?o.message:String(o)}`)});})();
