 ...
 */
"use strict";(()=>{var oe={apiKey:"",apiKeys:[],model:"gemini-3.8-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function B(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let n of t)if(e.includes(n))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Fe="easyquiz_settings_v2",se="easyquiz_activity_metrics";function Ge(){try{let o=localStorage.getItem(Fe);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...oe,apiKey:s.apiKey||""}}return{...oe}}let e=JSON.parse(o),t=typeof e.model=="string"&&B(e.model)?e.model:oe.model,n=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return n.length===0&&i&&(n=[i]),{apiKey:n[0]||i||oe.apiKey,apiKeys:n,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:oe.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:oe.confidenceThreshold}}catch{return{...oe}}}function wt(){try{localStorage.removeItem(Fe),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(se),sessionStorage.removeItem(se);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Qe()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function ye(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ue(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let n={...ye(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(n))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function qt(o){let e=Ge(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,n;typeof o.apiKey=="string"?n=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?n=t[0]||"":n=e.apiKey,n&&!t.includes(n)&&(t=[n,...t]),t.length>0&&(!n||!t.includes(n))&&(n=t[0]);let i={...e,...o,apiKey:n,apiKeys:t};try{localStorage.setItem(Fe,JSON.stringify(i))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var ie=[],xt=12,Gt=1200;function Et(o){let e=o.trim().replace(/\s+/g," ").slice(0,Gt);e&&!ie.includes(e)&&(ie.push(e),ie.length>xt&&(ie=ie.slice(-xt)))}function ke(){return ie}function Qe(){ie=[]}function Ct(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var ve=Ct();function ce(){try{localStorage.removeItem(se)}catch{}return ve}function Ut(o){ve=o;try{let e=JSON.stringify(o);sessionStorage.setItem(se,e),localStorage.removeItem(se)}catch{}}function Ye(o){let e=ve,t=Date.now(),n=e.records[e.records.length-1];if(n&&n.id===o.id&&t-n.timestamp<3e3)return e;let i={...o,timestamp:t},a=[...e.records,i],l=a.filter(d=>d.status==="answered"||d.status==="verified").length,s=a.reduce((d,h)=>d+h.durationMs,0),r=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:r,records:a};return Ut(c),c}function xe(){ve=Ct();try{sessionStorage.removeItem(se),localStorage.removeItem(se)}catch{}return ve}var Tt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown ou conversa.
...
`;function _t(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=fo,document.head.appendChild(o)}}catch{}}function le(){ge&&(ge.style.removeProperty("outline"),ge.style.removeProperty("outline-offset"),ge.style.removeProperty("position"),ge=null);for(let o of re)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");re=[];for(let o of ct)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");ct=[];for(let o of dt)try{o.remove()}catch{}if(dt=[],fe){try{fe.remove()}catch{}fe=null}}function ut(o){_t();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),ct.push(t);try{let n=t.parentElement;if(n&&!n.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let a=document.createElement("div");a.setAttribute("data-easyquiz-capture-badge","true"),a.textContent="\u{1F4F7} Capturado pela IA",a.style.cssText=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=n=>{if(n.target.closest(".eq-fah-btn"))return;n.preventDefault(),this.isDragging=!0,this.dragStartX=n.clientX,this.dragStartY=n.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let a=s=>{if(!this.isDragging||!this.element)return;let r=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,d=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),p=Math.min(Math.max(10,this.initialLeft+r),d),u=Math.min(Math.max(10,this.initialTop+c),h);this.element.style.left=`${p}px`,this.element.style.top=`${u}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),n=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,a=i.actions.filter(u=>u.t==="drag"),l=i.actions.filter(u=>{if(u.t!=="val")return!1;let f=y(u.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(f)}),s=i.actions.filter(u=>u.t==="clk"||u.t==="chk"),r=i.actions.filter(u=>u.t==="sel"),c=a.length||l.length||s.length||r.length,d=document.createElement("div");d.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let p=document.createElement("span");if(p.className="eq-fah-meta-badge",p.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,d.append(h,p),e.appendChild(d),a.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,n.textContent=String(a.length);let u={};for(let f of a){let v=y(f.to)||"Geral";u[v]||(u[v]=[]),u[v].push(y(f.from))}for(let[f,v]of Object.entries(u)){let b=document.createElement("div"),g=/fato|true|verdadeiro|sim/i.test(f),m=/opini[aã]o|false|falso|n[aã]o/i.test(f);b.className=`eq-fah-group ${g?"group-fato":m?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${f} (${v.length})`,b.appendChild(x);let w=document.createElement("div");w.className="eq-fah-group-items";for(let E of v){let C=document.createElement("div");C.className="eq-fah-item";let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=E,C.appendChild(T);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(E),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),C.appendChild(M),w.appendChild(C)}b.appendChild(w),e.appendChild(b)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,n.textContent=String(l.length);let u=document.createElement("div");u.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F4DD} Respostas para os Campos de Texto:",u.appendChild(f);let v=document.createElement("div");v.className="eq-fah-group-items";for(let b=0;b<l.length;b++){let g=l[b],m=document.createElement("div");m.className="eq-fah-item";let x=Le(g.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${b+1}`);let w=String(g.v??""),E=document.createElement("div");E.className="eq-fah-field-box";let C=document.createElement("div");C.className="eq-fah-field-label",C.textContent=x,E.appendChild(C);let T=document.createElement("div");T.className="eq-fah-field-val",T.textContent=w,E.appendChild(T),m.appendChild(E);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(w),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),m.appendChild(M),v.appendChild(m)}u.appendChild(v),e.appendChild(u)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,n.textContent=String(s.length);let u=document.createElement("div");u.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F3AF} Alternativa(s) Correta(s):",u.appendChild(f);let v=document.createElement("div");v.className="eq-fah-group-items";for(let b=0;b<s.length;b++){let g=s[b],m=document.createElement("div");m.className="eq-fah-item";let x=Le(g.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&g.v&&(x=String(g.v)),x=y(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let w="",E=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);E?(w=E[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=E[2].trim()||x):s.length>1&&(w=String.fromCharCode(65+b));let C=document.createElement("div");if(C.style.display="flex",C.style.alignItems="center",C.style.gap="8px",C.style.flex="1",w){let N=document.createElement("span");N.className="eq-fah-letter-badge",N.textContent=w,C.appendChild(N)}let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=x||(w?`Alternativa ${w}`:"Alternativa Selecionada"),C.appendChild(T),m.appendChild(C);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(x||w),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),m.appendChild(M),v.appendChild(m)}u.appendChild(v),e.appendChild(u)}else if(r.length>0){t.textContent=`Sele\xE7\xE3o (${r.length} listas)`,n.textContent=String(r.length);let u=document.createElement("div");u.className="eq-fah-group";let f=document.createElement("div");f.className="eq-fah-group-title",f.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",u.appendChild(f);let v=document.createElement("div");v.className="eq-fah-group-items";for(let b=0;b<r.length;b++){let g=r[b],m=document.createElement("div");m.className="eq-fah-item";let x=Le(g.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${b+1}`);let C=(Array.isArray(g.v)?g.v:[String(g.v??"")]).map(ee=>{let O=A(g.id,void 0,!0)||A(y(g.id),void 0,!0),G=O instanceof HTMLSelectElement?O:O?.querySelector("select");if(G){let Se=y(ee).toLowerCase();for(let S=0;S<G.options.length;S++){let z=G.options[S];if(z.value.toLowerCase()===Se||y(z.textContent).toLowerCase()===Se){let R=y(z.textContent);if(R&&!R.toLowerCase().includes("selecione"))return R}}}return ee}).join(", "),T=document.createElement("div");T.className="eq-fah-field-box";let M=document.createElement("div");M.className="eq-fah-field-label",M.textContent=x,T.appendChild(M);let N=document.createElement("div");N.className="eq-fah-field-val",N.textContent=C,T.appendChild(N),m.appendChild(T);let X=document.createElement("button");X.className="eq-fah-copy-inline",X.textContent="Copiar",X.addEventListener("click",()=>{navigator.clipboard.writeText(C),X.textContent="\u2713 Copiado",setTimeout(()=>X.textContent="Copiar",1200)}),m.appendChild(X),v.appendChild(m)}u.appendChild(v),e.appendChild(u)}else{t.textContent="Gabarito",n.textContent="0";let u=document.createElement("div");u.style.padding="10px",u.style.color="#888",u.textContent="Nenhuma resposta direta para exibir.",e.appendChild(u)}if(i.rationale){let u=document.createElement("div");u.className="eq-fah-rationale",u.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(u)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let n=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),a=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(n.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let r of n){let c=y(r.to)||"Geral";s[c]||(s[c]=[]),s[c].push(y(r.from))}for(let[r,c]of Object.entries(s)){t.push(`### Categoria: ${r}`);for(let d of c)t.push(`- ${d}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let r=y(s.id);t.push(`- **${r||"Campo"}:** \`${s.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<a.length;s++){let r=a[s],c=Le(r.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&r.v&&(c=String(r.v)),c=y(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let d=a.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${d}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let r=y(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${r}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
                  ...
                  <div class="eq-key-input-container">
                    ...
                    <div class="eq-context-menu" id="eq-key-context-menu" hidden>
                      ...
                      <button class="eq-context-item" id="eq-menu-bulk" type="button">
                        <span class="eq-item-icon">${q.listPlus}</span>
