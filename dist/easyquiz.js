 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8};function W(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ye="easyquiz_settings_v2",Ae="easyquiz_activity_metrics";function Ze(){try{let o=localStorage.getItem(Ye);if(!o){let s=localStorage.getItem("easyquiz_settings_v1");if(s){let i=JSON.parse(s);return{...ie,apiKey:i.apiKey||""}}return{...ie}}let e=JSON.parse(o),t=typeof e.model=="string"&&W(e.model)?e.model:ie.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(s=>typeof s=="string"?s.trim().replace(/^["']|["']$/g,""):"").filter(s=>s.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(a.length===0&&r&&(a=[r]),a.length===0)try{let s=localStorage.getItem("easyquiz_api_keys");if(s){let i=JSON.parse(s);Array.isArray(i)&&(a=i.filter(d=>typeof d=="string"&&d.trim().length>5))}}catch{}return{apiKey:a[0]||r||ie.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:ie.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function wt(){try{localStorage.removeItem(Ye),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(Ae),sessionStorage.removeItem(Ae);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),et()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function $e(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function _e(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...$e(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function qt(o){let e=Ze(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ye,JSON.stringify(r)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var ge=[],Et=12,_t=1200;function Tt(o){let e=o.trim().replace(/\s+/g," ").slice(0,_t);e&&!ge.includes(e)&&(ge.push(e),ge.length>Et&&(ge=ge.slice(-Et)))}function De(){return ge}function et(){ge=[]}function St(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Ee=St();function we(){try{localStorage.removeItem(Ae)}catch{}return Ee}function eo(o){Ee=o;try{let e=JSON.stringify(o);sessionStorage.setItem(Ae,e),localStorage.removeItem(Ae)}catch{}}function Lt(o){let e=Ee,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],s=n.filter(u=>u.status==="answered"||u.status==="verified").length,i=n.reduce((u,A)=>u+A.durationMs,0),d=s>0?Math.round(i/s):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),i),completedQuestionsCount:s,averageDurationMs:d,records:n};return eo(l),l}function qe(){Ee=St();try{sessionStorage.removeItem(Ae),localStorage.removeItem(Ae)}catch{}return Ee}var kt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Te(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(f=>f.type==="draggable"||f.type==="dropzone"),r=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),s=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(f=>f.role==="answer").length===0),i=o.controls.filter(f=>f.role!=="navigation").length===0,d=i||a||n||s||r&&o.questionText.length<60,l=i?4500:s?6e3:1800,u=d?`
[HTML]:
${o.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",A="";if(i&&typeof document<"u")try{let f=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(g=>{let x=g,C=x.getBoundingClientRect?.()||{width:0,height:0};return C.width>0&&C.height>0&&!x.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(g=>{let x=g,C=x.tagName.toLowerCase(),q=x.id?`#${x.id}`:"",H=x.className&&typeof x.className=="string"?`.${x.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",L=(x.textContent||x.value||x.getAttribute("aria-label")||"").trim().slice(0,60),y=x.getAttribute("type")||x.getAttribute("role")||"";return`${C}${q}${H}[${y}] txt="${L}"`});f.length>0&&(A=`
[DOM-INTERATIVO]:
${f.join(`
`)}`)}catch{}let c=De(),m=c.length>0?`
[MEM\xD3RIA]:
${c.join(" | ")}
`:"",p=o.controls.filter(f=>f.role!=="navigation"),h=o.controls.filter(f=>f.role==="navigation"),b=to(o.sourceUrl,o.htmlSnippet),v=b?`
${b}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let f=p.filter(w=>w.type==="checkbox"||w.type==="chk"),g=new Set(p.filter(w=>w.type==="radio").map(w=>w.name).filter(Boolean)),x=f.filter(w=>!w.name||!g.has(w.name)),C=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),q=x.length>=2||C,H=g.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&g.size>=1,L=p.every(w=>w.type==="radio"||w.type==="chk")&&g.size===1&&!q&&!H,y=p.filter(w=>w.type==="text"||w.type==="number"||w.type==="val"||w.tag==="input"||w.tag==="textarea"),T=y.length>=2;return(H?`[GRADE VERDADEIRO/FALSO (${g.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${g.size} afirma\xE7\xF5es \u2014 emita ${g.size} a\xE7\xF5es chk separadas + adv]
`:q?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:L?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:T?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${y.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${y.length} campos abaixo com seu id exato]
`:"")+JSON.stringify(p.map(w=>({id:w.id,t:w.type,n:w.name||void 0,txt:w.label?w.label.length>160?w.label.slice(0,160)+"...":w.label:void 0,v:w.value||void 0,opt:w.options&&w.options.length?w.options.slice(0,20).map(M=>M.label||M.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${h.length>0?h.map(f=>`"${f.label||f.id}"[${f.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length===0?"Nenhum anexo visual.":e.map((f,g)=>{let x=f.associatedLabel||"Gr\xE1fico da Quest\xE3o",C=f.alt?` | alt: "${f.alt}"`:"";if(f.captureStatus==="text_only")return`  - Imagem ${g+1} [CONTEXTO_TEXTUAL]: ${x}${C} | ${f.textContext||"sem contexto adicional"}`;if(f.captureStatus==="captured"||f.base64){let q=f.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${f.textContext}"`:"";return`  - Imagem ${g+1} [VISUAL_INLINE]: ${x}${C}${q}`}return`  - Imagem ${g+1} [FALHOU]: ${x}${C}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var oo=new Set(["question","info","start","conclusion"]),ao=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),no=new Set(["val","chk","sel","clk","adv","js","drag"]),io=150,Se=2e3;function Y(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Se):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Se):e}function so(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!no.has(a))return null;if(a==="adv"){let i=t.id??t.target??t.name??t.selector;return{t:"adv",...Y(i)?{id:Y(i,"").slice(0,500)}:{}}}if(a==="drag"){let i=Y(t.from??t.source),d=Y(t.to??t.target??t.destination);return!i||!d?null:{t:"drag",from:i.slice(0,500),to:d.slice(0,500)}}if(a==="js"){let i=Y(t.v??t.code??t.script);return!i||i.length>8e3?null:{t:"js",v:i}}let r=t.id??t.target??t.name??t.selector??t.element;(r==null||r==="")&&a==="val"&&(r="1");let n=Y(r).slice(0,500);if(!n)return null;if(a==="val"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:Y(i).slice(0,Se)}}if(a==="sel"){let i=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(i)?i:[i]).map(u=>Y(u).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:l}}if(a==="chk"){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",d={t:"chk",id:n,c:!i};return t.v!==void 0&&(d.v=Y(t.v).slice(0,Se)),d}let s={t:"clk",id:n};if(t.c!==void 0){let i=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";s.c=!i}return t.v!==void 0&&(s.v=Y(t.v).slice(0,Se)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(i=>typeof i=="number"&&Number.isFinite(i))&&(s.co=[t.co[0],t.co[1]]),s}function ro(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),r=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){r=r.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let n=r.filter(s=>s.t==="chk"||s.t==="clk");if(n.length>1){let s=r.filter(d=>d.t!=="chk"&&d.t!=="clk"),i=n[n.length-1];r=[...s,i]}}else if(e==="escolha_multipla"){r=r.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let n=new Set;r=r.filter(s=>{let i="id"in s&&typeof s.id=="string"?s.id:"";return i?n.has(i)?!1:(n.add(i),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,s=[...r].reverse(),i=[];for(let d of s){let l="id"in d&&typeof d.id=="string"?d.id:"";l?n.has(l)||(n.add(l),i.push(d)):i.push(d)}r=i.reverse()}return[...r,...a]}function Mt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!oo.has(t))&&(t="question"),(typeof a!="string"||!ao.has(a))&&(a="escolha_unica");let r=Array.isArray(e.actions)?e.actions:[],n=[];for(let d=0;d<Math.min(r.length,io);d++){let l=so(r[d],d);l&&n.push(l)}n.some(d=>d.t==="val")&&(a==="escolha_unica"||!e.mode)&&(a="preenchimento"),n.some(d=>d.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(a)&&(a="arrastar_soltar"),n=ro(n,a,t);let s=n.some(d=>d.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?s||n.push({t:"adv"}):t==="question"&&!s&&n.push({t:"adv"});let i=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:i,rationale:Y(e.rationale,"Plano validado e auto-recuperado."),actions:n,...Y(e.memoryToStore)?{memoryToStore:Y(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var _=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let a=e.flatMap(n=>n.split(/[\n\r]+/));Array.from(new Set(a.map(n=>n.trim().replace(/^["']|["']$/g,"")).filter(n=>n.length>5))).forEach((n,s)=>{let i=this.generateId(n),d=t.get(i)||t.get(n);this.keys.set(i,{id:i,key:n,label:d?.label||`Chave ${s+1}`,addedAt:d?.addedAt||Date.now(),lastUsedAt:d?.lastUsedAt,lastLatencyMs:d?.lastLatencyMs,cooldownUntil:d?.cooldownUntil,errorCount:d?.errorCount||0,lastError:d?.lastError,winCount:d?.winCount||0})})}generateId(e){let t=0;for(let r=0;r<e.length;r++)t=(t<<5)-t+e.charCodeAt(r),t|=0;let a=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${a}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),a=Array.from(this.keys.values()).filter(n=>(n.errorCount||0)<50);if(a.length===0)return Array.from(this.keys.values()).slice(0,e);let r=a.filter(n=>(n.cooldownUntil||0)<=t);return r.length>0?(r.sort((n,s)=>{let i=n.lastLatencyMs!==void 0?n.lastLatencyMs:99999,d=s.lastLatencyMs!==void 0?s.lastLatencyMs:99999;if(i!==d)return i-d;let l=(n.lastUsedAt||0)-(s.lastUsedAt||0);return l!==0?l:n.addedAt-s.addedAt}),r.slice(0,e)):(a.sort((n,s)=>(n.cooldownUntil||0)-(s.cooldownUntil||0)),a.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let r=this.generateId(a);if(this.keys.has(r)||Array.from(this.keys.values()).some(i=>i.key===a))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let s={id:r,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(r,s),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:s}}updateKey(e,t,a){let r=this.keys.get(e);if(!r)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(r.key=n,a!==void 0&&(r.label=a.trim()),r.errorCount=0,r.cooldownUntil=void 0,r.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},z=new _;var xe=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Ht=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],lo={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function at(o){return lo[o]??o}function co(o,e){let a={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??uo};return/lite/i.test(o)||(/gemini-3\.[0-9]+-?flash/i.test(o)?a.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(o)&&(a.thinkingConfig={thinkingBudget:0})),a}var uo={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Pt(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=at(e);return W(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function ot(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function po(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}try{let r=e.indexOf("{");if(r!==-1){let n=e.slice(r).trim();n=n.replace(/,\s*\{[^}]*$/,""),n=n.replace(/,\s*$/,"");let s=0,i=0,d=!1,l=!1;for(let A=0;A<n.length;A++){let c=n[A];if(l){l=!1;continue}if(c==="\\"){l=!0;continue}if(c==='"'){d=!d;continue}d||(c==="{"?s++:c==="}"?s=Math.max(0,s-1):c==="["?i++:c==="]"&&(i=Math.max(0,i-1)))}for(d&&(n+='"');i>0;)n+="]",i--;for(;s>0;)n+="}",s--;let u=JSON.parse(n);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var zt=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&W(a.id));return t.length>0?t:null}return null}catch{return null}})(),tt=new Set;async function Ne(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return xe;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let r=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!r.ok){let s=await r.text(),i=ot(s,r.status);if(i.includes("inv\xE1lida")||i.includes("n\xE3o autorizada"))throw new Error(i);continue}let n=await r.json();if(Array.isArray(n.models)&&n.models.length>0){let s=n.models.filter(i=>{let d=i.supportedGenerationMethods||[],l=(i.name||"").replace(/^models\//,""),u=d.includes("generateContent");return W(l)&&u}).map(i=>{let d=i.supportedGenerationMethods||[],l=i.name.replace(/^models\//,""),u=i.displayName||l;return{id:l,name:u.includes(l)?u:`${u} (${l})`,description:i.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:d.includes("generateContent"),supportedGenerationMethods:d,discoveredAt:Date.now()}});if(s.length>0){s.sort((i,d)=>{let l=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return l(d.id)-l(i.id)}),zt=s;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(s))}catch{}return s}}}catch(r){if(r.message?.includes("Chave de API"))throw r}return xe}async function Re(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await Ne(e);if(a.length>0&&a!==xe){let r=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${r.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let r of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${r}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${r})!`,models:xe}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function nt(o,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=at(Pt(o)),r=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function s(l,u,A){let c=new AbortController,m=setTimeout(()=>c.abort(),A);try{let p=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(l)}`,h=await fetch(p,{method:"POST",headers:{...n,"x-goog-api-key":l},body:r,signal:c.signal});if(clearTimeout(m),h.ok)return{ok:!0,model:u,key:l,message:`Modelo '${u}' validado com sucesso!`};let b=await h.text().catch(()=>"");throw new Error(`HTTP ${h.status}: ${b.slice(0,80)}`)}catch(p){throw clearTimeout(m),p}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(A=>s(A,a,8e3)))}catch{}}let i=t[0],d=[a,...Ht.filter(l=>l!==a)];for(let l of d)try{let u=await s(i,l,4e3);return l!==a&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),u}catch{}return{ok:!1,model:a,key:i,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function mo(o,e,t,a,r){let n=["v1beta","v1"],s=new Error(`Falha ao consultar modelo ${o}`),d={...co(o,r)};for(let l of n){if(a.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${l}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,A=Date.now();try{let c=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:d}),signal:a});if(!c.ok){let h=await c.text();if(c.status===400){let v=/thinking/i.test(h),f=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(h);if((v||f)&&(d.thinkingConfig||d.responseSchema)){let g={...d};v&&delete g.thinkingConfig,f&&(delete g.responseSchema,delete g.responseMimeType),d=g;let x=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:d}),signal:a});if(x.ok){let H=await x.json(),L=H.candidates?.[0];if(L?.content?.parts?.[0]?.text)return z.markSuccess(e,Date.now()-A),{rawText:L.content.parts[0].text,data:H,usedModel:o,usedKey:e}}let C=await x?.text?.().catch(()=>"")??h,q=ot(C,c.status);throw new Error(`[${o}|${_.maskKey(e)}] ${q}`)}}let b=ot(h,c.status);if(c.status===404&&l==="v1beta")continue;throw c.status===429?(z.markQuotaHit(e,8e3),Dt(e,o,1e4),new Error(`[${o}|${_.maskKey(e)}] ${b}`)):(c.status===503||/no capacity|overloaded|unavailable/i.test(h)?(z.markOverloaded(e,5e3),tt.add(o)):c.status===403||/API_KEY_INVALID/i.test(h)?z.markInvalid(e,b):c.status===404&&tt.add(o),new Error(`[${o}|${_.maskKey(e)}] ${b}`))}let m=await c.json(),p=m.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error(`[${o}|${_.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return z.markSuccess(e,Date.now()-A),{rawText:p.content.parts[0].text,data:m,usedModel:o,usedKey:e}}catch(c){if(a.aborted)throw c;s=c;let m=s.message||"";if(m.includes("404")||/no longer available/i.test(m)){tt.add(o);break}if(m.includes("429")||m.includes("Quota"))break}}throw s}var Oe=new Map;function It(o,e){let t=`${o}::${e}`,a=Oe.get(t);return a===void 0?!1:Date.now()>a?(Oe.delete(t),!1):!0}function Dt(o,e,t=1e4){Oe.set(`${o}::${e}`,Date.now()+t)}function it(){Oe.clear()}async function Be(o,e,t,a,r,n){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let s=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];z.init(s);let i=t.apiKey.trim().replace(/^["']|["']$/g,""),d=z.getBestKey()||i;if(!d)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=Pt(t.model);if(!zt&&d&&Ne(d).catch(()=>{}),r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),A=Te(o,e,t),c=[{text:A}];for(let S=0;S<e.length;S++){let w=e[S],M=w.associatedLabel||(w.alt?`Imagem: ${w.alt}`:`Imagem ${S+1}`);if(w.captureStatus==="text_only"||!w.base64){let D=w.textContext||w.alt||"";c.push({text:`[CONTEXTO_IMAGEM_${S+1} - V\xCDNCULO: ${M}]: ${D}`})}else c.push({text:`[ANEXO VISUAL ${S+1} - V\xCDNCULO: ${M}]:`}),c.push({inline_data:{mime_type:w.mediaType,data:w.base64}})}let m={system_instruction:{parts:[{text:n?.systemPromptOverride??kt}]},contents:[{role:"user",parts:c}]},p=at(l),h=Ht.filter(S=>S!==p),v=z.getAllKeys().length,f=S=>v<=1||S===0?1:2,g=new Set,x=(S,w)=>{let M=/pro/i.test(S),D=/lite/i.test(S);return M?w===0?18e3:w===1?24e3:3e4:D?w===0?1e4:w===1?14e3:18e3:w===0?16e3:w===1?2e4:25e3},C=async(S,w)=>{if(w.length===0||r?.aborted)return null;let M=w.map(()=>new AbortController),D=()=>M.forEach(R=>{try{R.abort()}catch{}});r?.addEventListener("abort",D,{once:!0});let U=w.map(R=>`${R.model.replace("gemini-","")}/${R.label}`).join(" | ");a?.(`\u26A1 ${S}: ${w.length} slot(s) [${U}]...`,"info");try{let R=w.map(async(B,G)=>{let F=M[G],he=setTimeout(()=>{try{F.abort(new Error(`Timeout ${B.timeout/1e3}s (${B.model}|${B.label})`))}catch{F.abort()}},B.timeout);try{let X=await mo(B.model,B.key,m,F.signal,n?.generationSchemaOverride);clearTimeout(he);let $=Mt(po(X.rawText));return $.usedModel=X.usedModel,$.durationMs=Date.now()-u,$.promptSent=A,$.tokensUsed=X.data.usageMetadata?.totalTokenCount,$.promptTokens=X.data.usageMetadata?.promptTokenCount,$.candidatesTokens=X.data.usageMetadata?.candidatesTokenCount,$.rawResponse=X.rawText,M.forEach((Ct,$t)=>{if($t!==G)try{Ct.abort(new Error("Cancelado: vencedor respondeu."))}catch{Ct.abort()}}),{plan:$,rawUsage:X.data.usageMetadata,usedModel:X.usedModel,usedKey:X.usedKey,slotLabel:B.label}}catch(X){clearTimeout(he);let $=X instanceof Error?X.message:String(X);throw($.includes("429")||$.includes("Quota")||$.includes("RESOURCE_EXHAUSTED"))&&(Dt(B.key,B.model,1e4),z.markQuotaHit(B.key,8e3)),X}}),V=await Promise.any(R);return r?.removeEventListener("abort",D),z.markWinner(V.usedKey),V}catch(R){return r?.removeEventListener("abort",D),R instanceof AggregateError&&R.errors.length>0?y=R.errors.map(V=>V instanceof Error?V.message:String(V)).join(" | "):R instanceof Error&&(y=R.message),console.warn(`[EasyQuiz ${S}] Falha na onda:`,y),null}},H=(v<=1?1:1+Math.ceil((v-1)/2))+4,L=0,y="",T=0;for(;L<H;){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let S=z.getRoundRobinKeys(v),w=S.filter(F=>!g.has(`${F.key}::${p}`)&&!It(F.key,p)),M,D;if(w.length>0)M=p,D=w;else{let F=h;M=F[T%F.length]||p,T++;let he=S.filter(X=>!g.has(`${X.key}::${M}`)&&!It(X.key,M));D=he.length>0?he:S.filter(X=>!g.has(`${X.key}::${M}`))}if(D.length===0){if(T<h.length)continue;break}let U=D.slice(0,f(L));if(U.length===0)break;let R=x(M,L),V=U.map(F=>(g.add(`${F.key}::${M}`),{model:M,key:F.key,label:F.label||"Chave",timeout:R})),B=L===0?"Onda 1":`Onda ${L+1}`,G=await C(B,V);if(G){let F=G.plan.durationMs||Date.now()-u,he=_.maskKey(G.usedKey);return a?.(`\u2705 ${F}ms via '${G.usedModel}' (${G.slotLabel}: ${he})`,"info"),G}L++}throw new Error(y||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var fo=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function be(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function st(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ot(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(fo.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var Ce=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),ke=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,se=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,ho=0;function rt(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!ce(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function Q(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function I(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||ce(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${Q(e.id)}"]`);if(n&&rt(n))return!0}catch{}let r=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(r&&r!==e&&rt(r))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let s=e.getBoundingClientRect();if(s.width>0||s.height>0)return!0}return!0}}}catch{}}return rt(e)}function go(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function N(o,e=500){return go(o).replace(/\s+/g," ").trim().slice(0,e)}function Ao(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(ho+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function ce(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Le=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function j(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(ce(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,r=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),s=String(a.getAttribute?.("title")||""),i=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",d=N(a.textContent,60);return!!(Le.test(r)||Le.test(n)||Le.test(s)||Le.test(i)||d.length>0&&d.length<=25&&Le.test(d))}function Z(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||ce(o)||j(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=N(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,r=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return se.test(r)||se.test(t)?!1:ke.test(r)||ke.test(t)||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!o.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function lt(o){let e=o.closest("tr");if(e){let d=e.querySelector("th, td:first-child"),l=d&&d!==o.closest("td")?N(d.textContent,100):"",u=N(o.closest("label, td")?.textContent||"",50);if(l&&u)return`${l}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let d=t.querySelector('.dropdown-label, [class*="label" i]'),l=d&&d!==o?N(d.textContent,150):"";if(l)return l}let a=o.getAttribute("aria-label");if(a)return N(a);let r=o.getAttribute("aria-labelledby");if(r){let d=r.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(d.trim())return N(d)}if("labels"in o&&o.labels){let d=Array.from(o.labels??[]).map(l=>l.textContent).join(" ");if(d.trim())return N(d)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let d=N(n.textContent);if(d)return d}let s=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",i=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||s||"";return N(i)}function ct(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,r=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(n)?n:"other",i=o.getAttribute("role")||"",d=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),l=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||l.includes("cursor-grab")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(d)||/drag|card-item|sortable/i.test(l),A=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(d)||/dropzone|category-box|bucket|target-zone/i.test(l),m=N((u?"draggable":A?"dropzone":"")||r.type||i||s,40),p="";if(r.type==="checkbox"||r.type==="radio"||i==="radio"||i==="checkbox"){let x=r.checked||o.getAttribute("aria-checked")==="true",C=r.value&&r.value!=="on"?r.value:o.getAttribute("data-value")||"";p=x?C?`checked:${C}`:"checked":C||"unchecked"}else if(s==="button"||n==="a"||e==="navigation"||Z(o))p="";else{let x=typeof o.value=="string"||typeof o.value=="number"?o.value:"";p=N(x||o.getAttribute("data-category")||"",2e3)}let h=[];if(a&&a.options)for(let x of Array.from(a.options).slice(0,80))h.push({value:N(x.value),label:N(x.textContent)});else if(i==="combobox"||i==="listbox"||l.includes("select")||l.includes("dropdown")){let x=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),C=x?document.getElementById(x):o;if(C){let q=C.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let H of Array.from(q).slice(0,80)){let L=N(H.textContent);L&&h.push({value:H.getAttribute("data-value")||H.getAttribute("value")||L,label:L})}}}let b=!!(r.required||o.getAttribute("aria-required")==="true"),v=!!(r.disabled||o.getAttribute("aria-disabled")==="true"),f=Ao(o);return{id:o.id||f,tag:s,type:m,label:lt(o),name:N(r.name||o.getAttribute("name")||"",180),value:p,options:h,required:b,disabled:v,role:e}}var Nt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Rt(o){if(!I(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(Ce)).filter(I),a=N(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let r=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),s=Math.min(1,n/r),i=e.top+e.height/2,d=Math.abs(i-window.innerHeight/2)/Math.max(1,window.innerHeight),l=a>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+l+u-s*20-d*10}function Qe(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let r=N(e.innerText||e.textContent||"",1e4),n=N(t.innerText||t.textContent||"",1e4),s=e.querySelectorAll(Ce).length,i=t.querySelectorAll(Ce).length;if(r.length<150&&n.length>r.length&&i<=s+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Bt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&I(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function J(){let o=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(o&&I(o))return o;let e=document.activeElement;if(e&&e!==document.body){let s=e.closest(Nt);if(s&&Rt(s)>0)return Qe(s)}let a=Array.from(document.querySelectorAll(Nt)).map(s=>({element:s,score:Rt(s)})).filter(s=>Number.isFinite(s.score)).sort((s,i)=>i.score-s.score),r=a.find(s=>{let i=s.element.tagName.toLowerCase();return i!=="main"&&i!=="body"&&s.score>0});if(r)return Qe(r.element);if(a.length>0&&a[0].score>0)return Qe(a[0].element);let n=document.querySelector('form, main, [role="main"]');return n&&I(n)?n:document.body}function Qt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let r of Array.from(a.attributes))t.includes(r.name)||a.removeAttribute(r.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function je(o){let e=Array.from(o.querySelectorAll(Ce)),t=new Set,a=[];for(let l of e){if(!I(l)||Z(l)||j(l))continue;let u=(l.value||l.textContent||"").trim();if(se.test(u))continue;let A=l.tagName.toLowerCase();["input","textarea","select"].includes(A)&&(t.add(l),a.push(l))}for(let l of e){if(!I(l)||Z(l)||j(l))continue;let u=(l.value||l.textContent||"").trim();if(se.test(u))continue;let A=l.tagName.toLowerCase();if(["input","textarea","select"].includes(A))continue;let c=l.querySelector("input, textarea, select");if(!(c&&t.has(c))){if(l.hasAttribute("for")){let m=l.getAttribute("for"),p=m?l.ownerDocument.getElementById(m):null;if(p&&t.has(p))continue}if(A==="a"){let m=l.getAttribute("role"),p=l.getAttribute("class")||"",h=l.getAttribute("data-testid")||"",b=l.getAttribute("draggable")==="true"||l.classList.contains("perseus-drag-item")||l.classList.contains("sortable-item")||p.includes("cursor-grab")||!!l.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(h)||/drag|card-item|sortable/i.test(p);if(!(m==="button"||m==="radio"||m==="checkbox"||m==="option"||b||l.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(l)}}let r=a.length>0&&a.every(l=>j(l)||/read-?aloud|audio/i.test(l.getAttribute("data-testid")||l.getAttribute("aria-label")||"")),n=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,s=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((a.length===0||r)&&s){r&&(a.length=0);let l=Array.from(n.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(l.length>0){for(let u of l)if(!(!I(u)||j(u))&&(a.push(u),a.length>=50))break}else{let u=Array.from(n.querySelectorAll("button, div[class], span[class], p, li"));for(let A of u){if(!I(A)||Z(A)||j(A)||se.test((A.textContent||"").trim()))continue;let c=(A.textContent||"").trim();if(c.length<2||c.length>300)continue;if(Array.from(A.children).some(p=>p.className&&p.textContent?.trim())||a.push(A),a.length>=50)break}}}let d=!a.some(l=>["input","select","textarea"].includes(l.tagName.toLowerCase()))&&a.length>0&&a.every(l=>{let u=l.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let A=(l.textContent||"").trim();return!l.id||A.length<10||/^\d+\s*\/\s*\d+$/.test(A)||/^question text/i.test(A)});if(a.length===0||d){d&&(a.length=0);let l=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(l.length>0)for(let u of l){if(!I(u)||ce(u)||Z(u)||j(u)||se.test((u.textContent||"").trim()))continue;let A=(u.textContent||"").trim();if(!(A.length<10||A.length>500)&&!/^\d+\s*\/\s*\d+$/.test(A)&&(a.push(u),a.length>=20))break}}return a.slice(0,100).map(l=>ct(l,"answer"))}function dt(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let r of e)for(let n of Array.from(r.querySelectorAll(Ce)))if(!(t.has(n)||!I(n)||!Z(n)||j(n))&&(t.add(n),a.push(ct(n,"navigation")),a.length>=10))return a;return a}function de(o=!1){let e=J();e=Qe(e),o&&(e=Bt(e));let t=je(e),a=dt(e);if(t.length===0){let i=je(document.body);i.length>0&&(e=Bt(e),t=je(e),t.length===0&&(t=i,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=dt(document.body));let r=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=r.length>4e4?N(r.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+N(r.slice(-2e3),2e3):N(r,16e3),s=[...t,...a].slice(0,120);return!n||s.length===0&&n.length<30?N(document.body.innerText||document.body.textContent||"",16e3).length>=30?re():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:Qt(e),controls:s,scope:e}}function re(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=N(o,16e3),t=je(document.body),a=dt(document.body),r=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Qt(n).slice(0,15e3),controls:r,scope:n}}function ut(o){let e=o.controls.map(t=>{let a=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${a}`}).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function Ve(o){if(!o)return!1;let e=o.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(a=>e.includes(a))}function O(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function E(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function K(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let r=o.ownerDocument.getElementById(a);if(r)return r}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return K(a)}return o}function jt(o){let e=o;if(!e||!document.contains(e))try{e=J()}catch{}e=e||document.body;let t=r=>{let n=Array.from(r.querySelectorAll("tr")).filter(u=>I(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(n.length>1)return n;let s=Array.from(r.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>I(u)&&!O(u));if(s.length>0)return s;let d=Array.from(r.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>I(u)&&!O(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return d.length>0?d:Array.from(r.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let A=u;return I(A)&&!O(A)&&(A.textContent||"").trim().length>2&&!Z(A)&&!j(A)&&!A.querySelector("[class]")})},a=t(e);return a.length>0?a:e!==document.body?t(document.body):[]}function P(o,e,t=!1){if(o==null)return null;let r=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!r)return null;let n=Q(r),s=document.querySelector(`[data-easyquiz-id="${n}"]`);if(s&&!O(s))return K(s);try{let c=document.getElementById(r);if(c&&I(c)&&!O(c))return c.hasAttribute("data-category")||c.hasAttribute("data-dropzone")||c.classList.contains("dnd-zone")?c:K(c)}catch{}try{let c=document.querySelector(`[data-item-id="${n}"]`);if(c&&I(c)&&!O(c))return K(c)}catch{}let i=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(i){let c=parseInt(i[1],10);if(t){let p=document.body;try{p=J()||document.body}catch{}let h=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>I(b)&&!O(b));if(c>=1&&c-1<h.length)return h[c-1];if(c===0&&h.length>0)return h[0]}let m=c-1;if(m>=0){let p=jt();if(m<p.length){let v=p[m];if(v.tagName.toLowerCase()==="tr"){if(e){let g=v.querySelector(`input[value="${Q(e)}" i], [data-value="${Q(e)}" i]`);if(g)return g}let f=v.querySelector("input");if(f)return f}return K(v)}let h=document.body;try{h=J()||document.body}catch{}let b=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(v=>I(v)&&!O(v));if(m<b.length)return b[m]}}let d=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(d){let c=d[1].toUpperCase(),m=c.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${c}" i], input[type="checkbox"][value="${c}" i]`)).find(b=>I(b)&&!O(b));if(p)return K(p);let h=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(b=>{if(!I(b)||O(b))return!1;let f=(b.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(f===c||f===`${c})`||f===`(${c})`||f===`${c}.`||f===`${c}:`)return!0;let g=(b.textContent||"").trim().toUpperCase();return g.startsWith(`${c})`)||g.startsWith(`(${c})`)||g.startsWith(`${c}.`)||g.startsWith(`${c}:`)});if(h)return K(h);if(m>=0){let b=jt();if(m<b.length){let v=b[m];if(v.tagName.toLowerCase()==="tr"){if(e){let g=v.querySelector(`input[value="${Q(e)}" i], [data-value="${Q(e)}" i]`);if(g)return g}let f=v.querySelector("input");if(f)return f}return K(v)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(r)){let m=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(v=>I(v)&&!O(v));if(m)return m;let h=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(v=>I(v)&&!O(v));if(h)return K(h);let b=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(v=>{if(!I(v)||O(v))return!1;let f=E(v.textContent).toLowerCase();return f===r.toLowerCase()||f===r.toLowerCase()+")"});if(b)return K(b)}try{let c=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`));if(e){let p=c.find(h=>{if(!I(h)||O(h))return!1;if(h instanceof HTMLInputElement&&h.value.toLowerCase()===e.toLowerCase())return!0;let b=h.closest("label, .vf-label, td, div");return b&&E(b.textContent).toLowerCase().includes(E(e).toLowerCase())});if(p)return K(p)}let m=c.find(p=>I(p)&&!O(p));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:K(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(r))try{let m=Array.from(document.querySelectorAll(r)).find(p=>I(p)&&!O(p));if(m)return K(m)}catch{}try{let c=r.replace(/"/g,""),m=`//button[normalize-space(.)="${c}"] | //a[normalize-space(.)="${c}"] | //*[not(*) and normalize-space(.)="${c}"] | //*[@aria-label="${c}"] | //*[@data-category="${c}"] | //*[@data-testid="${c}"]`,p=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let h=0;h<p.snapshotLength;h++){let b=p.snapshotItem(h);if(b&&I(b)&&!O(b)){if(["body","html"].includes(b.tagName.toLowerCase())){let f=b.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(f&&I(f))return K(f)}return b.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(b)}}}catch{}let u=E(r).toLowerCase(),A=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let c of A){if(!I(c)||O(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||j(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=E(c.textContent).toLowerCase(),h=E(c.getAttribute("aria-label")||"").toLowerCase(),b=E(c.getAttribute("placeholder")||"").toLowerCase(),v=E(c.getAttribute("title")||"").toLowerCase(),f=E(c.getAttribute("name")||"").toLowerCase(),g=E(c.getAttribute("data-category")||"").toLowerCase(),x=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"",C=E(x).toLowerCase(),q=p.startsWith(u+")")||p.startsWith(u+".")||p.startsWith(u+" -")||p.startsWith(u+":");if(p===u||h===u||b===u||v===u||f===u||g&&g===u||C&&C===u||q)return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(c)}if(u.length>=3)for(let c of A){if(!I(c)||O(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||j(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=E(c.textContent).toLowerCase(),h=E(c.getAttribute("aria-label")||"").toLowerCase(),b=E(c.getAttribute("placeholder")||"").toLowerCase(),v=E(c.getAttribute("title")||"").toLowerCase(),f=E(c.getAttribute("name")||"").toLowerCase();if(p.includes(u)||h.includes(u)||b.includes(u)||v.includes(u)||f.includes(u)){if(Array.from(c.children).some(q=>{let H=E(q.textContent).toLowerCase();return H&&H.includes(u)}))continue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||K(c)}let g=u.split(/\s+/).filter(Boolean);if(g.length>=3){let x=g.slice(0,Math.min(5,g.length)).join(" ");if(p.includes(x)||h.includes(x)||b.includes(x))return K(c)}}return null}function Vt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function oe(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),a=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),r=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),n={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerover",{...n}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...n}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...n,button:0,buttons:0}))}catch{}if(typeof o.click=="function")try{o.click()}catch{try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}}else try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}try{let s=Object.keys(o).find(i=>i.startsWith("__reactFiber")||i.startsWith("__reactInternalInstance"));if(s){let i=o[s];for(;i;){let d=i.memoizedProps||i.pendingProps;if(d?.onClick){d.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}i=i.return}}}catch{}try{let s=Object.keys(o).find(i=>i.startsWith("__reactProps"));if(s){let i=o[s];i?.onClick&&i.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let s=o._vei;s?.onClick&&(Array.isArray(s.onClick.value)?s.onClick.value:[s.onClick.value]).forEach(d=>{try{d({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let i=o.querySelector('input[type="radio"], input[type="checkbox"]');i&&(i.focus?.(),i.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,!0),i.dispatchEvent(new Event("change",{bubbles:!0})));let d=o.closest("[jsaction]");if(d&&d!==o)try{d.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:a,clientY:r}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function ft(o){try{let e=o.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,o.id=e);let a=document.createElement("script");return a.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(a),a.remove(),t||setTimeout(()=>{try{o.id===e&&o.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function Ue(o,e){let t=o;if(t.hasAttribute("for")){let l=t.getAttribute("for"),u=t.ownerDocument.getElementById(l);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Xe(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){Xe(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)t=l;else{let A=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(A)t=A;else{let c=t.nextElementSibling;for(;c;){if(c instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(c.type)||c instanceof HTMLTextAreaElement||c instanceof HTMLElement&&c.isContentEditable){t=c;break}let m=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}c=c.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let l=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)t=l;else{let u=document.body;try{u=J()||document.body}catch{}let A=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(A)t=A;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=document.body;try{l=J()||document.body}catch{}let u=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;ue(t,l);return}let s=String(e??""),i=s;if(t instanceof HTMLInputElement&&t.type==="number"){let l=s.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(i=l)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let d=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(d=document.execCommand?.("insertText",!1,i)||!1):t.isContentEditable&&(d=document.execCommand?.("insertText",!1,i)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let A=t._valueTracker;A&&A.setValue(i===""?" ":"")}catch{}let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,i):t.value=i;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:i.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==i&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(i))){t.value=i;try{u?.call(t,i)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==i.trim()){t.textContent=i;try{t.innerText=i}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:i,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=i),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Me(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),r=E(t),n=P(t)||P(r);if(!n)return a?e:r||e;let s=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(s){let A=E(s.textContent);if(A&&A.length>0&&A.length<150)return A}if(n.id){let A=document.querySelector(`label[for="${Q(n.id)}"]`);if(A){let c=E(A.textContent);if(c&&c.length>0&&c.length<150)return c}}let i=n.getAttribute("aria-label");if(i)return E(i);let d=n.getAttribute("placeholder");if(d)return E(d);let l=E(n.textContent);if(l&&l.length>0&&l.length<120)return l;let u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return u?E(u):a?e:r||e}function ue(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for")));let r=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&I(t)?t:o;if(a){let n=a.type==="radio",s=a.type==="checkbox",i=!!a._valueTracker;if(a.checked===e){if(n&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(s){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(r&&r!==a&&oe(r),a.checked!==e)try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let l=a._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,Vt(a,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;oe(r),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Xe(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let s=e.map(l=>E(l).toLowerCase()),i=!1,d=(l,u)=>{l.selected=!0,t.selectedIndex=u;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let A=t._valueTracker;A&&A.setValue(l.value)}catch{}i=!0};for(let l=0;l<t.options.length;l++){let u=t.options[l],A=u.value.toLowerCase(),c=E(u.textContent).toLowerCase();if(s.some(p=>p===A||p===c)){if(d(u,l),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!i)for(let l of s){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let A=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?A:A>=1?A-1:0;if(m>=0&&m<t.options.length&&(d(t.options[m],m),!t.multiple))break}}if(!i){for(let l of s)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,c=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(c>=0&&c<t.options.length&&(d(t.options[c],c),!t.multiple))break}}if(!i){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let A=t.options[u],c=l(A.value.toLowerCase()),m=l(E(A.textContent).toLowerCase());if(s.some(h=>{let b=l(h);return c.includes(b)||m.includes(b)||b.length>2&&(b.includes(c)||b.includes(m))})&&(d(A,u),!t.multiple))break}}if(i){Vt(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&oe(a);let r=e.map(s=>E(s).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(s=>I(s)&&!O(s));for(let s of r){let i=n.find(l=>{let u=E(l.textContent).toLowerCase(),A=E(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===s||A===s||u.includes(s)||s.length>2&&s.includes(u)});if(i){oe(i);let l=i.querySelector('input[type="radio"], input[type="checkbox"]');l&&ue(l,!0);return}let d=P(s);if(d){oe(d);return}}}function bo(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function pt(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function vo(o,e,t){try{if(e.contains(o))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(o))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let a=e.children.length;if(t!==void 0&&a>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${a}`};if([o.getAttribute("data-placed")==="true",o.getAttribute("data-assigned")==="true",o.getAttribute("data-matched")==="true",o.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(o.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let n=(o.textContent||"").trim().toLowerCase();return n.length>2&&Array.from(e.querySelectorAll("*")).some(d=>d!==e&&(d.textContent||"").trim().toLowerCase()===n)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:o.getAttribute("aria-hidden")==="true"||o.style.display==="none"||o.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function te(o,e){let t=E(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let i=document.getElementById(o.trim());if(i&&I(i)&&!O(i))return i}let s=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let i of s){let l=Array.from(document.querySelectorAll(i)).find(u=>{if(!I(u)||O(u))return!1;let A=E(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return A===t||A.includes(t)||u.id===o.trim()});if(l)return l}return null}let a=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),r=Array.from(document.querySelectorAll(a)),n=r.find(s=>[s.getAttribute("data-category"),s.getAttribute("data-dropzone")].some(i=>i?.trim().toLowerCase()===t));return n&&I(n)&&!O(n)?n:r.find(s=>{if(!I(s)||O(s)||/unclassified/i.test(s.className))return!1;let i=s.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),d=E(i?.textContent||s.textContent||"").toLowerCase();return d.includes("op")&&(d.includes("es")||d.includes("\xF5es"))?!1:d===t||d.startsWith(t)||d.includes(t)})||null}async function Ke(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),r=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),s=Math.round(a.top+Math.max(1,a.height/2)),i=Math.round(r.left+Math.max(1,r.width/2)),d=Math.round(r.top+Math.max(1,r.height/2)),l=E(e.textContent).toLowerCase();if(l){let h=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let v=E(b.textContent).toLowerCase(),f=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?E(b.value).toLowerCase():"";return v&&(l.includes(v)||v.includes(l))||f&&(l.includes(f)||f.includes(l))});h&&(oe(h),await new Promise(b=>setTimeout(b,120)))}pt(o),await new Promise(p=>setTimeout(p,140)),pt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&pt(u),await new Promise(p=>setTimeout(p,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let A={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:s,screenX:n,screenY:s,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...A,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",A));let c=4;for(let p=1;p<=c;p++){let h=Math.round(n+(i-n)*(p/c)),b=Math.round(s+(d-s)*(p/c)),v={...A,clientX:h,clientY:b,screenX:h,screenY:b};try{o.dispatchEvent(new PointerEvent("pointermove",{...v,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",v))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:d,screenX:i,screenY:d,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let p=bo(N(o.textContent),o.outerHTML),h={...A},b={...m};p&&(h.dataTransfer=p,b.dataTransfer=p);let v=o.ownerDocument.defaultView?.DragEvent;if(!v)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new v("dragstart",h)),e.dispatchEvent(new v("dragenter",b)),e.dispatchEvent(new v("dragover",b)),e.dispatchEvent(new v("drop",b)),o.dispatchEvent(new v("dragend",h))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:o,clientX:n,clientY:s}),h=new Touch({identifier:1,target:e,clientX:i,clientY:d});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[h]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(o))try{let p=v=>{let f=Object.keys(v).find(x=>x.startsWith("__reactFiber")||x.startsWith("__reactInternalInstance"));if(!f)return null;let g=v[f];for(let x=0;x<10&&g;x++){if(g.memoizedProps)return g.memoizedProps;g=g.return}return null},h=p(o),b=p(e);if(h){let v=h.onMouseDown||h.onPointerDown||h.onDragStart;if(typeof v=="function")try{v({type:"mousedown",button:0,buttons:1,clientX:n,clientY:s,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:o,target:o}),await new Promise(f=>setTimeout(f,100))}catch{}}if(b){let v=b.onMouseUp||b.onPointerUp||b.onDrop;if(typeof v=="function")try{v({type:"mouseup",button:0,buttons:0,clientX:i,clientY:d,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(f=>setTimeout(f,200));let v=d>s?"ArrowDown":"ArrowUp";for(let f=0;f<3;f++)document.dispatchEvent(new KeyboardEvent("keydown",{key:v,bubbles:!0,cancelable:!0})),await new Promise(g=>setTimeout(g,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(f=>setTimeout(f,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(o.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:o.id||o.getAttribute("data-id")}})),await new Promise(f=>setTimeout(f,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}}function Ut(o,e,t,a){let r=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),n=r(o.toLowerCase()),s=r(e.toLowerCase()),i=r(t),d=r(a);return`var src=$eq.find('${i}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${n}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${s}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${n} -> ${s}');}`}var Xt={fill:(o,e)=>{let t=P(o);t?Ue(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=P(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?ue(e,!0):oe(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=P(o);t?ue(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>P(o,e),drag:(o,e)=>{let t=te(o,"source")||P(o),a=te(e,"destination")||P(e);t&&a?Ke(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=te(o,"source")||P(o),a=te(e,"destination")||P(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Ke(t,a)},execute:(o,e=!1,t=1)=>Ie(o,e,t)};typeof window<"u"&&(window.$eq=Xt);async function yo(o,e=1,t=be()){if(st(o,t),o.t==="js"){let d=String(o.v||"");Ot(d);try{new Function("$eq","document","window",d)(Xt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let d=te(o.from,"source")||P(o.from),l=te(o.to,"destination")||P(o.to);!d&&o.from&&(d=P(E(o.from))),!l&&o.to&&(l=P(E(o.to))),d&&l?await Ke(d,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let r=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=r!=null?String(r).trim():"",s=null,i=String(o.name??o.n??"").trim();if(!i&&a&&document.querySelector(`input[type="radio"][name="${Q(a)}"]`)&&(i=a),(o.t==="chk"||o.t==="clk")&&i){let d=Array.from(document.querySelectorAll(`input[name="${Q(i)}"]`));if(n&&(s=d.find(l=>l.value?.toLowerCase()===n.toLowerCase())??null),!s&&n){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(n),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(n);if(l||u){let A=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=d.find(c=>{let m=c.value?.toLowerCase()??"";if(A.includes(m))return!0;let h=(c.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return A.some(b=>h===b||h.startsWith(b+" ")||h.startsWith("("+b+")"))})??null}}!s&&d.length>0&&(s=d[0])}if(s||(s=P(a,n,o.t==="val"||o.t==="sel")),!s&&a&&(s=P(E(a),n,o.t==="val"||o.t==="sel")),s&&n){if(s instanceof HTMLInputElement&&s.type==="radio"&&s.name){if(E(s.value).toLowerCase()!==E(n).toLowerCase()){let d=document.querySelector(`input[type="radio"][name="${Q(s.name)}"][value="${Q(n)}" i]`);if(d)s=d;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${Q(s.name)}"]`)).find(A=>{let c=A.closest("label, .vf-label, .option-card, tr, td, div");return c&&E(c.textContent).toLowerCase().includes(E(n).toLowerCase())});u&&(s=u)}}}else if(!(s instanceof HTMLInputElement)&&!(s instanceof HTMLSelectElement)&&!(s instanceof HTMLTextAreaElement)){let d=s.querySelector(`input[value="${Q(n)}" i], [data-value="${Q(n)}" i]`);if(d)s=d;else{let u=Array.from(s.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(A=>{let c=A.closest("label, .vf-label, .option-card, td, div");return c&&E(c.textContent).toLowerCase().includes(E(n).toLowerCase())});u&&(s=u)}}}if(!s&&(o.t==="val"||o.t==="sel")){let d=document.body;try{d=J()||document.body}catch{}let l=Array.from(d.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>I(u)&&!O(u));if(l.length===1)s=l[0];else if(l.length>1){let u=E(a).toLowerCase(),A=u.match(/^#?_?([0-9]+)$/);if(A){let c=parseInt(A[1],10);c>=1&&c<=l.length?s=l[c-1]:c>=0&&c<l.length&&(s=l[c])}s||(s=l.find(m=>{let p=(m.getAttribute("placeholder")||"").toLowerCase(),h=(m.name||"").toLowerCase(),b=(m.getAttribute("aria-label")||"").toLowerCase(),v=(m.id||"").toLowerCase(),f=E(lt(m)).toLowerCase(),g=E(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(u)||h.includes(u)||b.includes(u)||v.includes(u)||f&&f.includes(u)||u.length>=2&&g.includes(u)})||(l.length===1?l[0]:null))}}if(!s&&o.t!=="adv")throw new Error(`Alvo '${a}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);switch(o.t){case"val":if(s){let u=s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement||s.isContentEditable?s:s.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let p=s.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(u=p)}if(!u){let m=s.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){u=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){u=p;break}m=m.nextElementSibling}}if(!u){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>I(h)&&!O(h));p.length>0&&(u=p[0])}let A=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,c=A!=null?String(A):"";Ue(u||s,c)}break;case"chk":let d=o.c!==void 0?!!o.c:!0;s&&ue(s,d);break;case"sel":if(s){let u=Array.isArray(o.v)?o.v:[String(o.v)];Xe(s,u)}break;case"clk":if(s)if(!!(s.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||s.querySelector('input[type="radio"], input[type="checkbox"]')||s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type))){let A=o.c!==void 0?!!o.c:!0;ue(s,A)}else oe(s,o.co);break;case"adv":let l=Kt(o.id);if(l){await mt(l,1200);let u=o.id||l.textContent?.trim()||"";u&&_e(window.location.hostname,{advanceSelector:u}),oe(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function xo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!I(t)||O(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(r)})||null}function Kt(o){let e=c=>{let m=(c.getAttribute("aria-label")||c.textContent||(c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"")||"").trim();return se.test(m)};if(o){let c=P(o);if(c&&I(c)&&!O(c)&&!j(c)&&!e(c))return c}try{let c=$e(window.location.hostname);if(c.advanceSelector){let m=P(c.advanceSelector);if(m&&I(m)&&!O(m)&&!j(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(t)),r=c=>{let m=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"";return(c.getAttribute("aria-label")||c.textContent||m||"").trim()},n=c=>{let m=r(c).trim();return/^\d{1,3}$/.test(m)?!!c.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},s=a.filter(c=>I(c)&&!O(c)&&!c.closest("header, aside")&&!j(c)&&!e(c));for(let c of s){let m=r(c),p=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((ke.test(m)||ke.test(p))&&!n(c)&&!j(c))return c}for(let c of s)if(Z(c)&&!j(c)&&!n(c))return c;let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(i&&I(i)&&!O(i)&&!j(i)&&!e(i))return i;let d=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let c of d)if(I(c)&&!O(c)&&!e(c)&&!j(c)&&!n(c))return c;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,A=l.filter(c=>{if(!I(c)||O(c)||e(c)||j(c)||c.closest("header, nav, aside, .eq-sidebar")||n(c))return!1;let m=c.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(A.length>0)return A.sort((c,m)=>{let p=c.getBoundingClientRect(),h=m.getBoundingClientRect(),b=p.left+p.top;return h.left+h.top-b}),A[0];for(let c of s)if(Z(c)&&!j(c))return c;return null}async function mt(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(r=>setTimeout(r,80))}}function Co(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function Eo(o,e=3500){let[t,a,r,n]=o.split("|"),s=parseInt(n||"0",10),i=Date.now();for(;Date.now()-i<e;){let d=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),A=(document.body?.innerText||document.body?.textContent||"").length;if(d!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${d}`};if(l!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(r||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${r} \u2192 ${u}`};if(Math.abs(A-s)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(A-s)} chars)`};await new Promise(c=>setTimeout(c,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Fe(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let n=P(o.from)||P(E(o.from)),s=P(o.to)||P(E(o.to));n&&s&&await Ke(n,s,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=P(e,t)||P(E(e),t),r=String(o.name??o.n??"").trim();if(!r&&e&&document.querySelector(`input[type="radio"][name="${Q(e)}"]`)&&(r=e),!a&&r){let n=Array.from(document.querySelectorAll(`input[name="${Q(r)}"]`));if(t&&(a=n.find(s=>s.value?.toLowerCase()===t.toLowerCase())??null),!a&&t){let s=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),i=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(s||i){let d=s?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];a=n.find(l=>{let u=l.value?.toLowerCase()??"";if(d.includes(u))return!0;let c=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return d.some(m=>c===m||c.startsWith(m+" ")||c.startsWith("("+m+")"))})??null}}!a&&n.length>0&&(a=n[0])}if(o.t==="clk"||o.t==="chk"){if(!a&&e){let s=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),i=E(e).toLowerCase();a=s.find(d=>{let l=E(d.textContent).toLowerCase();return!!(E(d.value||"").toLowerCase()===i||l===i||l.startsWith(i+")")||l.startsWith("("+i+")")||l.startsWith(i+".")||l.startsWith(i+" - ")||l.startsWith(i+":")||i.length>=3&&l.includes(i))})||null}let n=o.v!==void 0?String(o.v).trim():"";if(a&&n){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(E(a.value).toLowerCase()!==E(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${Q(a.name)}"][value="${Q(n)}" i]`);if(s)a=s;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${Q(a.name)}"]`)).find(l=>{let u=l.closest("label, .vf-label, .option-card, tr, td, div");return u&&E(u.textContent).toLowerCase().includes(E(n).toLowerCase())});d&&(a=d)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let s=a.querySelector(`input[value="${Q(n)}" i], [data-value="${Q(n)}" i]`);if(s)a=s;else{let d=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let u=l.closest("label, .vf-label, .option-card, td, div");return u&&E(u.textContent).toLowerCase().includes(E(n).toLowerCase())});d&&(a=d)}}}if(a){let s=a.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,i=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:s.querySelector('input[type="radio"], input[type="checkbox"]')||(s.getAttribute("for")?s.ownerDocument.getElementById(s.getAttribute("for")):null),d=o.c!==void 0?!!o.c:!0;if(ue(i||s,d),i&&i.checked!==d){try{let l=i._valueTracker;l&&l.setValue(!d)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(i,d)}catch{}i.checked=d,i.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),i.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let n=null;if(a&&(n=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!n){let s=document.body;try{s=J()||document.body}catch{}let i=Array.from(s.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),d=E(e).toLowerCase();n=i.find(l=>{let u=(l.getAttribute("placeholder")||"").toLowerCase(),A=(l.name||"").toLowerCase(),c=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return u.includes(d)||A.includes(d)||c.includes(d)||m.includes(d)})||(i.length>0?i[0]:null)}if(n){let s=String(o.v??"");try{if(n.focus?.(),n.type!=="number"){try{n.select?.()}catch{}document.execCommand?.("insertText",!1,s)}}catch{}Ue(n,s)}return}if(o.t==="sel"){if(!a&&e){let n=Array.from(document.querySelectorAll("select")),s=E(e).toLowerCase();a=n.find(i=>{let d=(i.name||"").toLowerCase(),l=(i.id||"").toLowerCase(),u=(i.getAttribute("aria-label")||"").toLowerCase();return d.includes(s)||l.includes(s)||u.includes(s)})||null}if(a){let n=Array.isArray(o.v)?o.v:[String(o.v)];Xe(a,n)}return}}function ee(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,r=o.id!==void 0&&o.id!==null?String(o.id):"";r||(r=o.target??o.name??o.selector??"1");let n=P(r,a,!0)||P(E(r),a,!0);if(!n){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>I(h)&&!O(h));p.length>0&&(n=p[0])}if(!n)return!1;let s=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(s&&s.name){let m=document.querySelector(`input[type="radio"][name="${Q(s.name)}"]:checked`);if(!m)return!1;let p=E(m.value).toLowerCase(),h=E(t).toLowerCase(),b=E(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===h||b===h||b.includes(h)}let i=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!i){let p=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(i=p)}if(!i){let m=n.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){i=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){i=p;break}m=m.nextElementSibling}}if(i instanceof HTMLSelectElement){let m=E(t).toLowerCase();return Array.from(i.options).some(p=>{if(!p.selected)return!1;let h=p.value.toLowerCase(),b=E(p.textContent).toLowerCase();return m===h||m===b||h.includes(m)||b.includes(m)})}let d=(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i?.textContent??n.textContent??"").trim();if(!d&&!t)return!0;if(!d&&t)return!1;let l=d.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),A=parseFloat(l),c=parseFloat(u);return!isNaN(A)&&!isNaN(c)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(A-c)<1e-4:l===u||d.toLowerCase()===t.toLowerCase()||u.length>=3&&l===u}if(o.t==="sel"){let e=P(o.id,void 0,!0)||P(E(o.id),void 0,!0);if(!e){let n=document.body;try{n=J()||document.body}catch{}let s=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>I(l)&&!O(l)),i=E(o.id).toLowerCase();e=s.find(l=>{let u=(l.id||"").toLowerCase(),A=(l.getAttribute("name")||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase(),m=E(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(i)||A.includes(i)||c.includes(i)||i.length>=2&&m.includes(i)})||(s.length===1?s[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(l=>E(l).toLowerCase()),d=E(n.textContent).toLowerCase();return i.some(l=>d.includes(l)||l.includes(d))}return!1}let r=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>E(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let s=n.value.toLowerCase(),i=E(n.textContent).toLowerCase();return r.some(d=>d===s||d===i||s.includes(d)||i.includes(d))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=String(o.name??o.n??"").trim();if(t&&!o.id){let c=Array.from(document.querySelectorAll(`input[name="${Q(t)}"]`));if(c.length>0){let m=c.find(f=>f.checked);if(!m)return!1;if(!e)return!0;let p=m.value?.toLowerCase()??"",h=e.toLowerCase();if(p===h)return!0;let b=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),v=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return b?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):v?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let a=P(o.id,e)||P(E(o.id),e);if(!a&&t){let c=document.querySelector(`input[name="${Q(t)}"]`);c&&(a=c)}if(!a)return!1;let r=a.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,n=a instanceof HTMLInputElement&&["checkbox","radio"].includes(a.type)?a:r.querySelector('input[type="checkbox"], input[type="radio"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(n&&n.type==="radio"){if(n.checked===s)return!0;if(o.v&&n.name){let c=E(String(o.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${Q(n.name)}"]:checked`);if(!m)return!1;if(m===n)return!0;let p=E(m.value).toLowerCase(),h=E(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===c||h.includes(c)||c.includes(p)}}if(n&&["checkbox","radio"].includes(n.type))return n.checked===s;let i=r.getAttribute("aria-checked")===String(s)||r.getAttribute("aria-selected")===String(s)||r.getAttribute("aria-pressed")===String(s),d=s?r.getAttribute("data-selected")==="true"||r.getAttribute("data-checked")==="true"||r.getAttribute("data-active")==="true"||r.getAttribute("data-state")==="checked"||r.getAttribute("data-state")==="on":r.getAttribute("data-selected")==="false"||r.getAttribute("data-checked")==="false"||r.getAttribute("data-state")==="unchecked",l=r.className||"",u=s?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(i||d||u)return!0;let A=!!r.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return o.t==="clk"&&!n&&!A||r.getAttribute("aria-expanded")!==null||r.getAttribute("aria-pressed")!==null}if(o.t==="drag"){let e=te(o.from,"source")||P(o.from)||P(E(o.from)),t=te(o.to,"destination")||P(o.to)||P(E(o.to));return!e||!t?!1:vo(e,t).success}}catch{}return!1}async function Ie(o,e,t=1,a=be({engine:"smart",autoAdvance:e})){let r=o.actions.filter(y=>y.t!=="adv"),n=o.actions.filter(y=>y.t==="adv"),s=0,i=[],d=new Map,l=new Map,u=new Map,A=new Set,c=o.pageType==="question"||r.length>0,m=r.filter(y=>y.t==="chk"||y.t==="clk"&&y.c!==void 0),p=new Map;for(let y of r){let T=[];l.set(y,T);try{if(y.t==="drag"){T.push("declarative-A-F");try{let S=te(y.from,"source")||P(y.from),w=te(y.to,"destination")||P(y.to);S&&u.set(y,S.parentElement?.outerHTML?.slice(0,500)||""),w&&p.set(y,w.children.length)}catch{}}else T.push("declarative-primary");await yo(y,t,a),s++,A.add(y)}catch(S){d.set(y,S instanceof Error?S.message:String(S)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",y,S)}await new Promise(S=>setTimeout(S,y.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&m.length>0){let y=document.body;try{y=J()||document.body}catch{}let T=Array.from(y.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(S=>I(S)&&!O(S));if(T.length>1){let w=function(M,D){if(M===D||M.contains(D)||D.contains(M))return!0;let U=M.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),R=D.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(U&&R&&U===R)return!0;let V=M.getAttribute("for")||M.id,B=D.getAttribute("for")||D.id;return!!(V&&B&&V===B)};var L=w;let S=new Set;for(let M of m){let D=M.t==="chk"?!!M.c:!!(M.c??!0),U="id"in M&&typeof M.id=="string"?M.id:"";if(D&&U){let R=P(U,M.v);if(R){S.add(R);let V=R.querySelector('input[type="checkbox"]');V&&S.add(V);let B=R.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');B&&(S.add(B),B.querySelectorAll('input[type="checkbox"]').forEach(G=>S.add(G)))}}}if(S.size>=m.length&&S.size>0){let M=Array.from(S);for(let D of T)M.some(R=>w(R,D))||(D instanceof HTMLInputElement&&D.checked||D.getAttribute("aria-checked")==="true"||D.closest(".option-card, label")?.classList.contains("selected"))&&ue(D,!1)}}}await new Promise(y=>setTimeout(y,r.length>0?100:25));let h=0;for(let y of r){if(ee(y)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${y.t}' no alvo '${y.id||y.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{st(y,a),l.get(y)?.push("alternative-path"),await Fe(y)}catch(T){d.set(y,T instanceof Error?T.message:String(T)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",T)}await new Promise(T=>setTimeout(T,250)),ee(y)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++,A.has(y)?d.has(y)&&d.delete(y):(d.delete(y),s++,A.add(y)))}if(h<r.length&&r.length>0){console.warn(`[EasyQuiz Auto-Cura] ${r.length-h} de ${r.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(y=>setTimeout(y,200));for(let y of r)if(!ee(y))try{if(await Fe(y),await new Promise(T=>setTimeout(T,80)),!ee(y)&&(y.t==="clk"||y.t==="chk"))try{let T="id"in y?String(y.id||""):"",S=y.v!==void 0?String(y.v).trim():"",w=P(T,S)||P(E(T),S);w&&(ft(w),await new Promise(M=>setTimeout(M,120)))}catch{}}catch(T){d.set(y,T instanceof Error?T.message:String(T))}await new Promise(y=>setTimeout(y,200)),h=0;for(let y of r)ee(y)&&(h++,A.has(y)?d.has(y)&&d.delete(y):(d.delete(y),s++,A.add(y)))}let b=[];for(let[y,T]of r.entries())if(!ee(T)){let S=T.t==="drag"?`${T.from} -> ${T.to}`:"id"in T&&T.id?T.id:T.t;i.push(S),b.push({actionIndex:y,action:T,strategiesAttempted:l.get(T)||[],evidence:d.get(T)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(T)}),T.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${T.from}" -> "${T.to}"`,`
  Estrat\xE9gias: ${(l.get(T)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(T)?.slice(0,200)||"n/a"}`)}c&&r.length===0&&i.push("nenhuma a\xE7\xE3o de resposta prescrita");let v=r.map((y,T)=>{let S=y.t==="drag"?`${y.from} -> ${y.to}`:y.t==="js"?"$eq":y.id||y.t,w=y.t==="js"?!0:y.t==="drag"?!!(te(y.from,"source")&&te(y.to,"destination")):!!(P(y.id||"")||P(E(y.id||""))),M=ee(y);return{index:T,action:y,target:S,located:w,applied:!d.has(y),verified:M,strategy:y.t==="drag"?"drag-adaptive":y.t==="js"?"javascript":"declarative-dom",evidence:M?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...d.has(y)?{error:d.get(y)}:{}}}),f=c?r.length>0&&i.length===0&&(h===r.length||s===r.length&&h>0):!0,g=!1,x=!1,C="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",q=c?h>0&&h>=Math.ceil(r.length/2):s>0&&s>=r.length/2,H=c?h>0&&(f||q):f||r.length===0||q;if(e&&H){await new Promise(S=>setTimeout(S,r.length>0?120:40));let y=!1,T=null;if(o.pageType!=="info"){let S=xo();if(S&&I(S)){await mt(S,1200),oe(S),y=!0,T=S,await new Promise(D=>setTimeout(D,350));let w=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');w&&I(w)&&(w.textContent||"").trim().length>0?(g=!1,x=!1,C=`Aviso do formul\xE1rio ap\xF3s checagem: ${w.textContent?.trim().slice(0,100)}`):(g=!0,x=!0,C="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!y){let S=Co(),w=n.length>0&&"id"in n[0]?n[0].id:void 0,M=Kt(w);if(M){await mt(M,1500);let D=w||M.textContent?.trim()||"";D&&_e(window.location.hostname,{advanceSelector:D}),oe(M);let U=await Eo(S,1800);x=U.changed,C=U.evidence,g=U.changed||!0,U.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:s,verified:h,success:f,advanced:g,failed:i,reports:v,navigationVerified:x,navigationEvidence:C,failedActions:b}}var ae=null,ve=[],ht=[],gt=[],At=[],ne=null,pe=null,wo=`
...
`;function Ft(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=wo,document.head.appendChild(o)}}catch{}}function me(){ae&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset"),ae.style.removeProperty("position"),ae=null);for(let o of ve)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ve=[];for(let o of ht)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");ht=[];for(let o of gt)try{o.remove()}catch{}gt=[],pe&&typeof window<"u"&&(window.removeEventListener("scroll",pe),window.removeEventListener("resize",pe),pe=null);for(let o of At)try{o.remove()}catch{}if(At=[],ne){try{ne.remove()}catch{}ne=null}}function bt(o){Ft();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),ht.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,s=r.height||t.offsetHeight||200;if(n>10&&s>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
    ...
    `,o.appendChild(t),ne=t}catch{}}function qo(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Jt(o,e){if(ne){try{ne.remove()}catch{}ne=null}let t=qo(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let m=P(a.from),p=P(a.to);m&&(m.style.outline=`2px solid ${t.outline}`,ve.push(m)),p&&(p.style.outline="2px dashed #00e5ff",ve.push(p))}catch{}continue}let r=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=String(a.name??a.n??"").trim(),s=null;if(n){let m=Array.from(document.querySelectorAll(`input[name="${Q(n)}"]`));if(r&&(s=m.find(p=>p.value?.toLowerCase()===r.toLowerCase())??null,!s)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(r),h=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(r);if(p||h){let b=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=m.find(v=>{let f=v.value?.toLowerCase()??"";if(b.includes(f))return!0;let x=(v.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(C=>x===C||x.startsWith(C+" ")||x.startsWith("("+C+")"))})??null}}!s&&m.length>0&&(s=m[0])}if(!s&&a.id&&(s=P(a.id,r,a.t==="val"||a.t==="sel")||P(E(a.id),r,a.t==="val"||a.t==="sel")),!s&&a.t==="sel"){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>I(v)&&!ce(v)),h=E(a.id).toLowerCase();s=p.find(v=>{let f=(v.id||"").toLowerCase(),g=(v.getAttribute("name")||"").toLowerCase(),x=(v.getAttribute("aria-label")||"").toLowerCase(),C=E(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return f.includes(h)||g.includes(h)||x.includes(h)||h.length>=2&&C.includes(h)})||(p.length===1?p[0]:null)}if(!s)continue;let i=typeof HTMLSelectElement<"u"&&s instanceof HTMLSelectElement||s.tagName?.toLowerCase()==="select"||s.getAttribute("role")==="combobox"||s.getAttribute("role")==="listbox",d=s.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?s.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=d||l||s;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),ve.push(u);let A=i?s:u.querySelector('select, [role="combobox"], [role="listbox"]');A&&(A.style.outline=`2px solid ${t.outline}`,A.style.outlineOffset="2px",A.style.boxShadow=`0 0 10px ${t.glow}`,A.setAttribute("data-easyquiz-highlight","true"),ve.push(A));let c=s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type)?s:u.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==u&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ve.push(c))}}var vt=10,To=1400,Pe=15e5;function le(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let r=String(a.result||"");e(r.split(",")[1]||"")},a.readAsDataURL(o)})}async function ye(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,To/Math.max(e,t)),r=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),s=document.createElement("canvas");s.width=r,s.height=n;let i=s.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,r,n),i.drawImage(o,0,0,r,n),new Promise((d,l)=>{s.toBlob(u=>u?d(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Wt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,r=2,n=Math.min(1800,Math.max(120,Math.round(t*r))),s=Math.min(1800,Math.max(100,Math.round(a*r))),i=o.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(n)),i.setAttribute("height",String(s)),!i.getAttribute("viewBox")&&t>0&&a>0&&i.setAttribute("viewBox",`0 0 ${t} ${a}`);try{let c=Array.from(o.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,m.length);p++){let h=c[p],b=m[p];if(!h||!b||!b.style)continue;let v=window.getComputedStyle?window.getComputedStyle(h):null;v&&(v.fill&&v.fill!=="none"&&(b.style.fill=v.fill),v.stroke&&v.stroke!=="none"&&(b.style.stroke=v.stroke),v.strokeWidth&&(b.style.strokeWidth=v.strokeWidth),v.fontFamily&&(b.style.fontFamily=v.fontFamily),v.fontSize&&(b.style.fontSize=v.fontSize),v.fontWeight&&(b.style.fontWeight=v.fontWeight),v.color&&(b.style.color=v.color))}}catch{}let d="#ffffff";try{let c=o.parentElement||o;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){d=p;break}c=c.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),A="";try{A=btoa(unescape(encodeURIComponent(u)))}catch{}try{let c=b=>new Promise((v,f)=>{let g=new Image,x=setTimeout(()=>f(new Error("Timeout render SVG")),1200);g.onload=()=>{clearTimeout(x),v(g)},g.onerror=()=>{clearTimeout(x),f(new Error("Falha ao renderizar SVG em Image."))},g.src=b}),m=null;if(A)try{m=await c(`data:image/svg+xml;base64,${A}`)}catch{}if(!m){let b=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),v=URL.createObjectURL(b);try{m=await c(v)}finally{URL.revokeObjectURL(v)}}let p=document.createElement("canvas");p.width=n,p.height=s;let h=p.getContext("2d",{alpha:!1});if(h&&m){h.fillStyle=d,h.fillRect(0,0,n,s),h.drawImage(m,0,0,n,s);let b=await new Promise(v=>{p.toBlob(v,"image/jpeg",.92)});if(b){let v=await le(b);if(v)return{blob:b,base64:v,mediaType:"image/jpeg"}}}}catch{}return{base64:A,mediaType:"image/svg+xml"}}async function yt(o){try{let e=o.getBoundingClientRect(),t=Math.round(e.width)||o.offsetWidth||400,a=Math.round(e.height)||o.offsetHeight||300;if(t<30||a<30)return null;let r=o.tagName.toLowerCase()==="svg"?o:o.querySelector("svg");if(r&&o.querySelectorAll("input, select, textarea").length===0)try{let h=await Wt(r);if(h.base64&&h.base64.length<=Pe)return{mediaType:h.mediaType,base64:h.base64,alt:o.getAttribute("aria-label")||r.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:fe(r)}}catch{}if(o instanceof HTMLCanvasElement)try{let h=await ye(o),b=await le(h);if(b)return{mediaType:"image/jpeg",base64:b,alt:o.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let n="#ffffff";try{let h=o;for(;h&&h!==document.documentElement;){let v=(window.getComputedStyle?window.getComputedStyle(h):null)?.backgroundColor;if(v&&v!=="transparent"&&v!=="rgba(0, 0, 0, 0)"){n=v;break}h=h.parentElement}}catch{}let s=o.cloneNode(!0),i=Array.from(o.querySelectorAll("*")),d=Array.from(s.querySelectorAll("*"));for(let h=0;h<Math.min(i.length,d.length);h++){let b=i[h],v=d[h];if(!(!b||!v||!v.style))try{let f=window.getComputedStyle(b);v.style.color=f.color,v.style.backgroundColor=f.backgroundColor,v.style.borderColor=f.borderColor,v.style.borderWidth=f.borderWidth,v.style.borderStyle=f.borderStyle,v.style.fontSize=f.fontSize,v.style.fontFamily=f.fontFamily,v.style.fontWeight=f.fontWeight,v.style.lineHeight=f.lineHeight,v.style.letterSpacing=f.letterSpacing,v.style.textAlign=f.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,a))),u=Math.round(t*l),A=Math.round(a*l),c=`
      <svg xmlns="http://www.w3.org/2000/svg" width="${u}" height="${A}" viewBox="0 0 ${t} ${a}">
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let s=this.element.querySelector("#eq-fah-header");this.setupDraggable(s)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=i=>{if(!this.isDragging||!this.element)return;let d=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),A=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),A);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},s=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",s)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",s)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),s=r.actions.filter(m=>{if(m.t!=="val")return!1;let p=E(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=r.actions.filter(m=>m.t==="sel"),l=n.length||s.length||i.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let A=document.createElement("span");A.textContent=`Modo: ${r.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(A,c),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let p of n){let h=E(p.to)||"Geral";m[h]||(m[h]=[]),m[h].push(E(p.from))}for(let[p,h]of Object.entries(m)){let b=document.createElement("div"),v=/fato|true|verdadeiro|sim/i.test(p),f=/opini[aã]o|false|falso|n[aã]o/i.test(p);b.className=`eq-fah-group ${v?"group-fato":f?"group-opiniao":""}`;let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent=`\u{1F4C1} ${p} (${h.length})`,b.appendChild(g);let x=document.createElement("div");x.className="eq-fah-group-items";for(let C of h){let q=document.createElement("div");q.className="eq-fah-item";let H=document.createElement("span");H.className="eq-fah-item-text",H.textContent=C,q.appendChild(H);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(C),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),q.appendChild(L),x.appendChild(q)}b.appendChild(x),e.appendChild(b)}}else if(s.length>0){t.textContent=`Preenchimento (${s.length} campos)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<s.length;b++){let v=s[b],f=document.createElement("div");f.className="eq-fah-item";let g=Me(v.id);(!g||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Campo ${b+1}`);let x=String(v.v??""),C=document.createElement("div");C.className="eq-fah-field-box";let q=document.createElement("div");q.className="eq-fah-field-label",q.textContent=g,C.appendChild(q);let H=document.createElement("div");H.className="eq-fah-field-val",H.textContent=x,C.appendChild(H),f.appendChild(C);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(x),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),f.appendChild(L),h.appendChild(f)}m.appendChild(h),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<i.length;b++){let v=i[b],f=document.createElement("div");f.className="eq-fah-item";let g=Me(v.id);(!g||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g))&&v.v&&(g=String(v.v)),g=E(g),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g)&&(g="");let x="",C=g.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);C?(x=C[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),g=C[2].trim()||g):i.length>1&&(x=String.fromCharCode(65+b));let q=document.createElement("div");if(q.style.display="flex",q.style.alignItems="center",q.style.gap="8px",q.style.flex="1",x){let y=document.createElement("span");y.className="eq-fah-letter-badge",y.textContent=x,q.appendChild(y)}let H=document.createElement("span");H.className="eq-fah-item-text",H.textContent=g||(x?`Alternativa ${x}`:"Alternativa Selecionada"),q.appendChild(H),f.appendChild(q);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(g||x),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),f.appendChild(L),h.appendChild(f)}m.appendChild(h),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,a.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let h=document.createElement("div");h.className="eq-fah-group-items";for(let b=0;b<d.length;b++){let v=d[b],f=document.createElement("div");f.className="eq-fah-item";let g=Me(v.id);(!g||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Lista ${b+1}`);let q=(Array.isArray(v.v)?v.v:[String(v.v??"")]).map(S=>{let w=P(v.id,void 0,!0)||P(E(v.id),void 0,!0),M=w instanceof HTMLSelectElement?w:w?.querySelector("select");if(M){let D=E(S).toLowerCase();for(let U=0;U<M.options.length;U++){let R=M.options[U];if(R.value.toLowerCase()===D||E(R.textContent).toLowerCase()===D){let V=E(R.textContent);if(V&&!V.toLowerCase().includes("selecione"))return V}}}return S}).join(", "),H=document.createElement("div");H.className="eq-fah-field-box";let L=document.createElement("div");L.className="eq-fah-field-label",L.textContent=g,H.appendChild(L);let y=document.createElement("div");y.className="eq-fah-field-val",y.textContent=q,H.appendChild(y),f.appendChild(H);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(q),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),f.appendChild(T),h.appendChild(f)}m.appendChild(h),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(i=>i.t==="drag"),r=e.actions.filter(i=>i.t==="val"),n=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),s=e.actions.filter(i=>i.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let d of a){let l=E(d.to)||"Geral";i[l]||(i[l]=[]),i[l].push(E(d.from))}for(let[d,l]of Object.entries(i)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of r){let d=E(i.id);t.push(`- **${d||"Campo"}:** \`${i.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<n.length;i++){let d=n[i],l=Me(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=E(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=n.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(s.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of s){let d=E(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`;var ze="v2.6.1";var Zt=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function Ho(o,e){try{if(Zt){o.innerHTML=Zt.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var Po=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],zo=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],We=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new Je({onStatusChange:(i,d,l)=>{this.logToConsole(d,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),d.includes("conclus\xE3o")||d.includes("finalizada")||d.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda com sucesso! Autopilot finalizado.","success"):this.setStatus("Autopilot desativado.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,d)=>{try{return await this.callbacks.onAnalyze(i,d,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Ho(this.shadow,`
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-resolver-cta-row">
                  <button class="eq-resolve-primary" id="eq-analyze-btn" type="button">${k.play} Iniciar Auto-Resposta</button>
                </div>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new Ge(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),xe.filter(i=>W(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===e.model))),Po.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===e.modeHint))),zo.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let r=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];z.init(r),this.apiKeyInput.value=z.getBestKey()||e.apiKey||"",this.renderKeysList();let n=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof n?.unref=="function"&&n.unref();let s=z.getBestKey()||e.apiKey;s&&Ne(s).then(i=>{i&&i.length>0&&this.updateModelSelect(i,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","media","metrics","debug","settings"];for(let a of t){let r=this.shadow.querySelector(`#eq-tab-${a}`),n=this.shadow.querySelector(`#eq-view-${a}`);a===e?(r?.classList.add("active"),n&&(n.style.display="flex")):(r?.classList.remove("active"),n&&(n.style.display="none"))}e==="brain"?(this.renderContextTree(),this.refreshInspectorView()):e==="media"?this.renderMediaTab():e==="metrics"?this.updateTimingMetrics():e==="debug"&&(this.refreshDebugView(),this.renderTerminalEntries())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-media")?.addEventListener("click",()=>this.switchTab("media")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let f=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!f))}),this.metricsResetBtn?.addEventListener("click",()=>{qe(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-scroll-toggle");t?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,t&&(t.style.color=this.autoScrollLogs?"#00ffcc":"#858585",t.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let a=this.shadow.querySelector("#eq-dbg-copy-logs");a?.addEventListener("click",()=>{let f=this.getFormattedLogs();navigator.clipboard.writeText(f).then(()=>{let g=a.innerHTML;a.innerHTML=k.check,setTimeout(()=>a.innerHTML=g,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let r=this.shadow.querySelector("#eq-dbg-copy-prompt");r?.addEventListener("click",()=>{let f=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(f).then(()=>{let g=r.innerHTML;r.innerHTML=`${k.check} Copiado!`,setTimeout(()=>r.innerHTML=g,1800)})});let n=this.shadow.querySelector("#eq-dbg-copy-context");n?.addEventListener("click",()=>{let f=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let g=n.innerHTML;n.innerHTML=`${k.check} Copiado!`,setTimeout(()=>n.innerHTML=g,1800)})});let s=this.shadow.querySelector("#eq-dbg-copy-raw-resp");s?.addEventListener("click",()=>{let f=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let g=s.innerHTML;s.innerHTML=`${k.check} Copiado!`,setTimeout(()=>s.innerHTML=g,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-error-btn");i?.addEventListener("click",()=>{let f=this.lastErrorMsg||"";navigator.clipboard.writeText(f).then(()=>{let g=i.innerHTML;i.innerHTML=k.check,setTimeout(()=>i.innerHTML=g,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",f=>{f.altKey&&(f.key==="q"||f.key==="Q"||f.key==="a"||f.key==="A")&&(f.preventDefault(),this.toggle())},!0);let d=f=>{let g=f.composedPath();g.includes(this.shadow)||(g.includes(this.sidebarEl)||g.includes(this.host))&&f.stopImmediatePropagation()};window.addEventListener("keydown",d,!0),window.addEventListener("keyup",d,!0),window.addEventListener("keypress",d,!0),this.apiKeyInput.addEventListener("input",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:f})});let l=this.shadow.querySelector("#eq-keys-collapsible"),u=this.shadow.querySelector("#eq-keys-chevron"),A=this.shadow.querySelector("#eq-keys-section-header"),c=f=>{l&&(f?(l.style.display="none",u&&(u.style.transform="rotate(0deg)")):(l.style.display="block",l.style.maxHeight="none",l.style.overflow="visible",u&&(u.style.transform="rotate(90deg)")))},m=!1;try{m=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}c(m),A?.addEventListener("click",f=>{if(f.target?.closest("a"))return;let g=l?.style.display==="none";c(!g);try{localStorage.setItem("easyquiz_keys_collapsed",g?"false":"true")}catch{}}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!f){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let g=z.addKey(f);if(g.ok){let x=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:x[0],apiKeys:x}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${x.length} chaves ativas no pool)`,"success"),c(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Re(f).then(C=>{C.ok?(z.markSuccess(f,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(z.markInvalid(f,C.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${C.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(g.message,"warning")}),this.keyMoreBtn.addEventListener("click",f=>{f.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",f=>{let g=f.target;!g.closest("#eq-key-context-menu")&&!g.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(f!==null&&f.trim()){let g=f.trim().replace(/^["']|["']$/g,""),x=z.addKey(g);if(x.ok){let C=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:C[0],apiKeys:C}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(x.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let f=await navigator.clipboard.readText();if(f){let g=f.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=g,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let f=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(f!==null&&f.trim()){let g=f.trim().replace(/^["']|["']$/g,"");if(z.addKey(g).ok){let C=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:C[0],apiKeys:C}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=this.apiKeyInput.type==="password";this.apiKeyInput.type=f?"text":"password";let g=this.shadow.querySelector("#eq-menu-vis-icon"),x=this.shadow.querySelector("#eq-menu-vis-text");g&&(g.innerHTML=f?k.eyeOff:k.eye),x&&(x.textContent=f?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let f=document.createElement("div");f.id="eq-bulk-overlay",f.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let g=document.createElement("div");g.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),g.innerHTML=`
      ...
      `,f.appendChild(g),this.shadow.appendChild(f);let x=g.querySelector("#eq-bulk-ta"),C=g.querySelector("#eq-bulk-status"),q=g.querySelector("#eq-bulk-import"),H=g.querySelector("#eq-bulk-paste-btn"),L=g.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>x?.focus());let y=()=>{f.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(T=>{f.addEventListener(T,S=>{S.stopPropagation(),S.stopImmediatePropagation()},!0)}),f.addEventListener("keydown",T=>{T.key==="Escape"&&y()}),f.addEventListener("click",T=>{T.target===f&&y()}),g.querySelector("#eq-bulk-x")?.addEventListener("click",y),g.querySelector("#eq-bulk-cancel")?.addEventListener("click",y),L.addEventListener("click",()=>{x.value="",C.textContent="",x.focus()}),H.addEventListener("click",async()=>{try{let T=await navigator.clipboard?.readText();T?(x.value=T,x.focus(),C.style.color="#38bdf8",C.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(C.style.color="#fbbf24",C.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{C.style.color="#fbbf24",C.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",x.focus()}}),g.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let T=x.value.trim();if(!T){C.style.color="#f87171",C.textContent="Insira pelo menos uma chave de API antes de importar.";return}let S=T.match(/AIza[0-9A-Za-z\-_]{35}/g),w=[];if(S&&S.length>0?w=Array.from(new Set(S)):w=Array.from(new Set(T.split(/[\n,;\s]+/).map(B=>B.trim().replace(/^["'`]|["'`]$/g,"")).filter(B=>B.length>=20))),w.length===0){C.style.color="#f87171",C.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}C.style.color="#00e5ff",C.textContent=`Processando ${w.length} chave(s)...`,q.disabled=!0,q.style.opacity="0.6";let M=0,D=0;for(let B of w){let G=z.addKey(B);G.ok?M++:G.message.includes("j\xE1 est\xE1 cadastrada")&&D++}if(M>0){let B=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:B[0],apiKeys:B}),c(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}C.textContent=`${M} adicionada(s), ${D} duplicada(s). Validando modelo em paralelo...`;let U=z.exportRawKeys(),R=this.modelSelect?.value||"gemini-3.5-flash-lite",V=await nt(R,U);V.ok?(z.markSuccess(V.key,200),C.style.color="#4ade80",C.textContent=` ${M} adicionada(s), ${D} duplicada(s). Modelo '${V.model}' pronto!`):(C.style.color="#fbbf24",C.textContent=`${M} adicionada(s), ${D} duplicada(s). Aviso: ${V.message}`),this.renderKeysList(),q.disabled=!1,q.style.opacity="1",M>0&&(this.setStatus(` Lote importado: ${M} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(y,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let f=z.exportRawKeys(),g=document.createElement("div");g.id="eq-text-editor-overlay",g.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let x=document.createElement("div");x.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),x.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
...
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let a=t?`[${t}] ${e}`:e;this.setLastError(a)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,a=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let r=e?.promptTokens!==void 0?String(e.promptTokens):"--",n=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${r} / ${n}`,this.dbgSplitTokens.title=`Prompt: ${r} tokens | Resposta: ${n} tokens`}if(this.dbgTotalTokens){let r=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=r!==void 0?`${r}`:"--"}if(this.dbgPromptLen){let r=a.length,n=Math.round(r/4);this.dbgPromptLen.textContent=`${r} chars (~${n} tokens est.)`}if(this.dbgPromptView&&(this.dbgPromptView.textContent=a||"Nenhum prompt enviado at\xE9 o momento."),this.dbgContextView)if(t){let r={scope:`${t.scope.tagName.toLowerCase()}${t.scope.id?"#"+t.scope.id:""}${t.scope.className?"."+t.scope.className.split(" ").join("."):""}`,questionLength:t.questionText.length,questionSnippet:t.questionText.slice(0,150)+(t.questionText.length>150?"...":""),controlsCount:t.controls.length,controls:t.controls.map((n,s)=>({index:s+1,tag:n.tag,type:n.type,name:n.name||void 0,id:n.id||void 0,value:n.value||void 0,label:n.label||void 0,role:n.role}))};this.dbgContextView.textContent=JSON.stringify(r,null,2)}else this.dbgContextView.textContent="Aguardando captura de contexto pelo EasyQuiz...";this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let a=new Date,r=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}:${String(a.getSeconds()).padStart(2,"0")}.${String(Math.floor(a.getMilliseconds()/100))}`,n=e;e.startsWith(">")?n=`> [${r}] ${e.slice(1).trim()}`:n=`[${r}] ${e}`;let s="all";t==="text-red"||n.includes("[ERRO]")||n.includes("Falha")||n.includes("Error")?s="error":n.includes("[IA]")||n.includes("[RAG]")||n.includes("Tokens")||n.includes("Gemini")||n.includes("Modelo:")?s="ai":(n.includes("[DOM]")||n.includes("[EXEC]")||n.includes("[VERIF]")||n.includes("[NAV]"))&&(s="dom");let i={id:Date.now()+Math.random(),timestamp:r,message:n,colorClass:t,category:s};for(this.logEntries.push(i);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),s==="error"&&this.setLastError(n),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===s)){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.liveDebugTerminal.appendChild(d);this.liveDebugTerminal.children.length>250;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.apConsole.appendChild(d),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.executionConsole.appendChild(d),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let a=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${a}%`,this.progressVal&&(this.progressVal.textContent=`${a}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),a>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions,this.renderMediaTab())),this.activeTab==="brain"?(this.renderContextTree(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&this.renderContextTree(),(this.activeTab==="media"||e.length>0)&&this.renderMediaTab()}renderMediaTab(){let e=this.shadow?.querySelector("#eq-media-grid"),t=this.shadow?.querySelector("#eq-media-count-badge");if(!e)return;let a=this.latestImages,r=this.latestImageDescriptions;if(t&&(t.textContent=`${a.length} m\xEDdias`),a.length===0){e.innerHTML=`
        ...
        <div style="padding: 10px 12px; display: flex; flex-direction: column; gap: 6px;">
          ...
          <div style="font-size:10px;color:#aaa;line-height:1.5;">${A}</div>
        ...
        </div>`;c.innerHTML=p+b,e.appendChild(c)})}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=De(),a=this.latestPlan;this.contextTreeContainer.innerHTML="";let r=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(r);let n=e?e.controls:[],s=n.map((p,h)=>{let b=p.role==="navigation"||p.type==="button",v=!b&&p.value?` [val: "${p.value}"]`:"";return{label:`[#${h+1}] ${p.type.toUpperCase()}`,value:`${p.label||p.id||p.name||"(Sem r\xF3tulo)"}${v}`.trim(),badge:b?"Navega\xE7\xE3o":p.role||p.type}}),i=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${n.length})`,n.length>0,s);this.contextTreeContainer.appendChild(i);let d=t.map((p,h)=>({label:`Mem\xF3ria #${h+1}`,value:p,badge:"RAG"})),l=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,d);if(this.contextTreeContainer.appendChild(l),a){let p=this.createTreeFolder(` \xDALTIMO PLANO IA (${a.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:a.pageType,badge:`${(a.confidence*100).toFixed(0)}%`},{label:"Modo",value:a.mode},{label:"Racioc\xEDnio",value:a.rationale||"N/A"},...a.actions.map((h,b)=>({label:`A\xE7\xE3o #${b+1} (${h.t})`,value:JSON.stringify(h)}))]);this.contextTreeContainer.appendChild(p)}let u=this.latestImages,A=this.latestImageDescriptions,c=u.map((p,h)=>{let b=A.find(C=>C.index===h),v=(p.captureStatus==="captured"||p.captureStatus==="text_only",""),f=p.captureStatus==="captured"?"Visual":p.captureStatus==="text_only"?"Texto":"Falhou",g=b?b.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",x=b?b.description:p.textContext?p.textContext:"Aguardando an\xE1lise IA...";return{label:`${v} Img ${h+1} [${f}]`,value:`${x}`,badge:g,imgSrc:p.base64?`data:${p.mediaType||"image/jpeg"};base64,${p.base64}`:void 0}}),m=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${u.length})`,!0,c);this.contextTreeContainer.appendChild(m)}createTreeFolder(e,t,a){let r=document.createElement("div");r.className="eq-tree-node";let n=document.createElement("div");n.className="eq-tree-header",n.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let s=document.createElement("div");if(s.className="eq-tree-content",s.style.display=t?"flex":"none",a.length===0)s.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let i of a){let d=document.createElement("div");d.className="eq-tree-leaf";let l="";i.imgSrc&&i.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${i.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),d.innerHTML=`
...
`)).then(()=>{if(this.metricsCopyBtn){let a=this.metricsCopyBtn.innerHTML;this.metricsCopyBtn.innerHTML=" Copiado!",setTimeout(()=>{this.metricsCopyBtn.innerHTML=a},1500)}})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Do(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Oo(){let o=window;if(qe(),Do(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=Ze(),t=null,a=null,r=0,n=new We(e,{onAnalyze:(l=1,u,A=!1)=>s(l,u,A),onApply:(l=1)=>void i(l),onDestroy:()=>{if(a){try{a.abort()}catch{}a=null}me(),delete o.__easyquiz},onCancel:()=>{if(a){try{a.abort()}catch{}a=null}me(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=qt(l)}});o.__easyquiz={toggle:()=>n.toggle(),destroy:()=>n.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!n)return;n.toggle(!0),s()}});async function s(l=1,u,A=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){n.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),n.toggle(!0);return}if(a)try{a.abort()}catch{}a=new AbortController;let c=a,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){n.setBusy(!1),n.setProgress(0);return}r=Date.now(),n.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),n.setProgress(20,"Varrendo escopo do DOM e controles..."),me(),n.hideFloatingAnswers();try{let p=de(!1);p||(n.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=re()),He(p.scope),n.updateContext(p),n.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),n.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),n.setProgress(40,`Consultando Gemini (${e.model})...`);let h=await xt(p.scope,e.useVision);if(h.length>0){let C=h.map(q=>q.element).filter(Boolean);bt(C),n.updateImages(h)}if(c.signal.aborted)return;let b=e.model;n.setStatus(h.length>0?`Consultando Gemini (${b}) com ${h.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let v=Te(p,h,e);n.setInspectorPrompt(v,e.model);let f=(C,q)=>{n.setStatus(C,q==="warning"?"info":q);let H=C.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(H){let L=H[1].split(",")[0].trim();n.setProgress(50,`Gemini ${L} respondendo...`)}},{plan:g,usedModel:x}=await Be(p,h,e,f,c.signal);if(c.signal.aborted)return;if(g.needsMoreContext){if(n.setProgress(55,"Ampliando escopo da quest\xE3o..."),n.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=de(!0),p||(p=re()),He(p.scope),n.updateContext(p),h=await xt(p.scope,e.useVision),h.length>0){let H=h.map(L=>L.element).filter(Boolean);bt(H),n.updateImages(h)}n.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let C=Te(p,h,e);n.setInspectorPrompt(C,e.model),g=(await Be(p,h,e,f,c.signal)).plan}if(c.signal.aborted)return;if(n.setProgress(70,"Resposta recebida da IA! Processando plano..."),n.logToConsole(`> [IA] Modelo: ${x||e.model} | Modo: ${g.mode} | Confian\xE7a: ${(g.confidence*100).toFixed(0)}%`,"text-green"),g.rationale&&n.logToConsole(`> [IA] Racioc\xEDnio: "${g.rationale}"`,"text-blue"),n.logToConsole(`> [IA] ${g.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),g.memoryToStore&&(Tt(g.memoryToStore),n.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${g.memoryToStore}"`,"text-yellow")),g.imageDescriptions&&g.imageDescriptions.length>0){n.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${g.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let C of g.imageDescriptions){let q=C.relevant?"":"\uFE0F";n.logToConsole(`>   ${q} Imagem ${C.index+1} [${C.relevant?"RELEVANTE":"IGNORADA"}]: ${C.description}`,C.relevant?"text-blue":"text-yellow")}}return t=g,n.updateContext(p,g),Jt(g.actions,g.confidence),n.setPlan(g,!e.dryRun),g.pageType==="conclusion"?(n.setProgress(100,"Atividade conclu\xEDda!"),n.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):g.pageType==="info"?(n.setProgress(100,"Contexto absorvido na mem\xF3ria!"),n.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):g.pageType==="start"?(n.setProgress(100,"In\xEDcio detectado!"),n.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(n.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),n.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&g.pageType==="question"&&n.showFloatingAnswers(g),c.signal.aborted?void 0:((A||e.autoApply)&&!e.dryRun&&await i(l,c.signal,A),g)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){me(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}me(),n.setProgress(0);let h=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";n.setStatus(h,"error"),n.setErrorDiagnostic(h,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),a===c&&(a=null),c.signal.aborted||n.setBusy(!1)}}async function i(l=1,u,A=!1){if(u?.aborted)return;if(!t){n.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){n.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(b=>b.t!=="adv"),p=t.pageType==="question"||Ve(t.rationale||"");if(p&&m.length===0){n.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let h=(A||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);n.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),n.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),n.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Ie(t,h,l,be(e));if(u?.aborted)return;if(n.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){n.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let C of b.failedActions){let q=C.action,H=q.t==="drag"?`drag: "${q.from}" \u2192 "${q.to}"`:q.t==="clk"||q.t==="chk"?`${q.t}: "${q.id}"`:q.t==="val"?`val: "${q.id}" = "${q.v}"`:JSON.stringify(q).slice(0,80);n.logToConsole(`>    [${q.t.toUpperCase()}] ${H} | ${C.evidence.slice(0,80)}`,"text-yellow")}await d(b.failedActions,u)}let v=r>0?Date.now()-r:1200,f=b.verified>0,g=b.applied>0;if(b.success||f&&g){n.setProgress(100,"Sucesso! Resposta preenchida."),n.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?n.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):h&&n.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),n.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),n.hideFloatingAnswers();let C=Lt({id:`q-${Date.now()}`,questionIndex:(we().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:v,status:"answered",mode:t.mode,actionsCount:b.applied});n.updateTimingMetrics(C)}else g?(n.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),n.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),n.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(n.setProgress(0,"Alvo de resposta n\xE3o localizado."),n.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),n.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&n.showFloatingAnswers(t))}catch(b){n.setProgress(0);let v=b instanceof Error?b.message:"Falha ao aplicar plano.";n.setStatus(`Erro ao aplicar: ${v}`,"error"),n.logToConsole(`> [ERRO] ${v}`,"text-red")}finally{n.setBusy(!1)}}async function d(l,u){if(!t)return;let A=l.filter(m=>m.action.t==="drag");for(let m of A){if(u?.aborted)return;let p=m.action,h=String(p.from||""),b=String(p.to||""),v=Ut(h,b,h,b);n.logToConsole(`> [REPLAN]  Drag JS fallback: "${h}" \u2192 "${b}"`,"text-blue");let f={...t,actions:[{t:"js",v}],pageType:"question"},g=await Ie(f,!1,1,be(e));n.logToConsole(g.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",g.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){n.logToConsole(`> [REPLAN]  ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,h=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);n.logToConsole(`> [REPLAN]  Recuperando: ${h}`,"text-blue");let b=String(p.id||p.name||p.selector||""),v=p.v!==void 0?String(p.v):"";n.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Fe(m.action),await new Promise(f=>setTimeout(f,250)),ee(m.action)){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${h}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let f=P(b,v)||P(b.replace(/[^\w\s]/g," ").trim(),v);if(f&&(ft(f),await new Promise(g=>setTimeout(g,300)),ee(m.action))){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let f=P(b,v)||P(b.replace(/[^\w\s]/g," ").trim(),v);if(f&&(f.focus?.(),await new Promise(g=>setTimeout(g,50)),f.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),f.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(g=>setTimeout(g,80)),f.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),f.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(g=>setTimeout(g,200)),ee(m.action))){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){n.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let f=P(b,v)||P(b.replace(/[^\w\s]/g," ").trim(),v);if(f){let g=f.id,x=!!g;g||(g=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,f.id=g);let C=String(p.v??""),q=p.t==="val",H=document.createElement("script");if(H.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(H),H.remove(),x||setTimeout(()=>{try{f.id===g&&f.removeAttribute("id")}catch{}},0),await new Promise(L=>setTimeout(L,300)),ee(m.action)){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${h}`,"text-green");continue}}}catch{}}if(u?.aborted)return;n.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let f="";try{let w=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(M=>(M.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));w&&(f=w.outerHTML.slice(0,400))}catch{}let g=de(!1)||re(),x=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${f?`
HTML do alvo: ${f}`:""}`,C=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],q=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
A seguinte a\xE7\xE3o falhou ap\xF3s ${C.length} estrat\xE9gias autom\xE1ticas: ${C.join(", ")}.

${x}

Contexto atual da quest\xE3o:
${g?.questionText.slice(0,400)||"N/A"}

Controles dispon\xEDveis:
${JSON.stringify((g?.controls||[]).slice(0,6).map(w=>({id:w.id,type:w.type,label:w.label,options:w.options?.slice(0,3)})),null,2)}
...
N\xC3O repita as estrat\xE9gias j\xE1 tentadas acima.`,H={...g,questionText:q},L=await Be(H,[],{...e},w=>n.logToConsole(`> [REPLAN-AI] ${w}`,"text-blue"),u);if(u?.aborted||!L?.plan){n.logToConsole("> [REPLAN]  Re-consulta n\xE3o retornou plano.","text-yellow");continue}let y=L.plan.actions.filter(w=>w.t==="js");if(y.length===0){n.logToConsole("> [REPLAN] \u2139\uFE0F IA n\xE3o gerou a\xE7\xF5es JS de fallback.","text-yellow");continue}n.logToConsole(`> [REPLAN]  IA gerou ${y.length} a\xE7\xE3o(\xF5es) JS custom. Executando...`,"text-blue");let T={...t,actions:y,pageType:"question"},S=await Ie(T,!1,1,be(e));S.applied>0?n.logToConsole(`> [REPLAN]  Estrat\xE9gia 5 OK: ${S.applied} a\xE7\xE3o(\xF5es) JS executada(s)!`,"text-green"):n.logToConsole("> [REPLAN]  Todas as estrat\xE9gias esgotadas para esta a\xE7\xE3o.","text-yellow")}catch(f){n.logToConsole(`> [REPLAN] Erro na re-consulta: ${f instanceof Error?f.message:String(f)}`,"text-yellow")}}}}n.toggle(!0)}Oo().catch(o=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",o),window.alert(`EasyQuiz: falha ao iniciar: ${o instanceof Error?o.message:String(o)}`)});})();
