/* EasyQuiz v3.6.0 (acd483c) — Resolução inteligente de quizzes sem servidor
 * GitHub: https://github.com/minifoxie/EasyQuiz
 * 100% Client-side. Direct Google Gemini REST API.
 */
"use strict";(()=>{var xe={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0};function ce(n){if(!n||typeof n!="string")return!1;let e=n.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of t)if(e.includes(o))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Tt="easyquiz_settings_v2",He="easyquiz_activity_metrics";function qt(){try{let n=localStorage.getItem(Tt);if(!n){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let s=JSON.parse(r);return{...xe,apiKey:s.apiKey||""}}return{...xe}}let e=JSON.parse(n),t=typeof e.model=="string"&&ce(e.model)?e.model:xe.model,o=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(o.length===0&&i&&(o=[i]),o.length===0)try{let r=localStorage.getItem("easyquiz_api_keys");if(r){let s=JSON.parse(r);Array.isArray(s)&&(o=s.filter(c=>typeof c=="string"&&c.trim().length>5))}}catch{}return{apiKey:o[0]||i||xe.apiKey,apiKeys:o,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:xe.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:xe.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:xe.confidenceThreshold}}catch{return{...xe}}}function Yt(){try{localStorage.removeItem(Tt),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(He),sessionStorage.removeItem(He);let n=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&n.push(t)}n.forEach(e=>localStorage.removeItem(e)),ot()}catch(n){console.warn("[EasyQuiz] Erro ao resetar dados:",n)}}function kt(n){try{let e=localStorage.getItem("eq_domain_cache_"+n);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+n)}catch{}}return t}catch{return{}}}function Lt(n,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...kt(n),...e};try{localStorage.setItem("eq_domain_cache_"+n,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function Zt(n){let e=qt(),t=Array.isArray(n.apiKeys)?n.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,o;typeof n.apiKey=="string"?o=n.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(n.apiKeys)&&n.apiKeys.length>0?o=t[0]||"":o=e.apiKey,o&&!t.includes(o)&&(t=[o,...t]),t.length>0&&(!o||!t.includes(o))&&(o=t[0]);let i={...e,...n,apiKey:o,apiKeys:t};try{localStorage.setItem(Tt,JSON.stringify(i)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var Ie=[],Jt=12,Hn=1200;function $t(n){let e=n.trim().replace(/\s+/g," ").slice(0,Hn);e&&!Ie.includes(e)&&(Ie.push(e),Ie.length>Jt&&(Ie=Ie.slice(-Jt)))}function nt(){return Ie}function ot(){Ie=[]}function _t(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Qe=_t();function Fe(){try{localStorage.removeItem(He)}catch{}return Qe}function Pn(n){Qe=n;try{let e=JSON.stringify(n);sessionStorage.setItem(He,e),localStorage.removeItem(He)}catch{}}function en(n){let e=Qe,t=Date.now(),o=e.records[e.records.length-1];if(o&&o.id===n.id&&t-o.timestamp<3e3)return e;let i={...n,timestamp:t},a=[...e.records,i],r=a.filter(p=>p.status==="answered"||p.status==="verified").length,s=a.reduce((p,f)=>p+f.durationMs,0),c=r>0?Math.round(s/r):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:r,averageDurationMs:c,records:a};return Pn(l),l}function Ue(){Qe=_t();try{sessionStorage.removeItem(He),localStorage.removeItem(He)}catch{}return Qe}var tn=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(n)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(n)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(n)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(n)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(n)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Xe(n,e,t){let o=n.htmlSnippet.includes("draggable")||n.htmlSnippet.includes("perseus")||n.htmlSnippet.includes("category")||n.htmlSnippet.includes("dropzone")||n.controls.some(x=>x.type==="draggable"||x.type==="dropzone"),i=/katex|latex|\\frac|\\sqrt/i.test(n.htmlSnippet),a=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(n.sourceUrl)||n.htmlSnippet.includes("Qr7Oae")||n.htmlSnippet.includes("data-item-id")||n.htmlSnippet.includes("freebirdFormviewer"),r=(/wayground|quizizz/i.test(n.sourceUrl)||n.htmlSnippet.includes("data-functional-selector"))&&(n.htmlSnippet.includes("classification")||n.controls.filter(x=>x.role==="answer").length===0),s=n.controls.filter(x=>x.role!=="navigation").length===0,c=s||o||a||r||i&&n.questionText.length<60,l=s?4500:r?6e3:1800,p=c?`
[HTML]:
${n.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",f="";if(s&&typeof document<"u")try{let x=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(A=>{let C=A,v=C.getBoundingClientRect?.()||{width:0,height:0};return v.width>0&&v.height>0&&!C.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(A=>{let C=A,v=C.tagName.toLowerCase(),w=C.id?`#${C.id}`:"",T=C.className&&typeof C.className=="string"?`.${C.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",q=(C.textContent||C.value||C.getAttribute("aria-label")||"").trim().slice(0,60),E=C.getAttribute("type")||C.getAttribute("role")||"";return`${v}${w}${T}[${E}] txt="${q}"`});x.length>0&&(f=`
[DOM-INTERATIVO]:
${x.join(`
`)}`)}catch{}let d=nt(),m=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",u=n.controls.filter(x=>x.role!=="navigation"),h=n.controls.filter(x=>x.role==="navigation"),b=zn(n.sourceUrl,n.htmlSnippet),y=b?`
${b}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(u.length===0)return"Nenhuma";let x=u.filter(k=>k.type==="checkbox"||k.type==="chk"),A=new Set(u.filter(k=>k.type==="radio").map(k=>k.name).filter(Boolean)),C=x.filter(k=>!k.name||!A.has(k.name)),v=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),w=C.length>=2||v,T=A.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&A.size>=1,q=u.every(k=>k.type==="radio"||k.type==="chk")&&A.size===1&&!w&&!T,E=u.filter(k=>k.type==="text"||k.type==="number"||k.type==="val"||k.tag==="input"||k.tag==="textarea"),H=E.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${A.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${A.size} afirma\xE7\xF5es \u2014 emita ${A.size} a\xE7\xF5es chk separadas + adv]
...
${(()=>{if(e.length===0)return/\b(observ[ea]|analis[ea]|figur[a]|gráfic[o]|diagram[a]|image[mn]|mapa|tabela|veja|conforme|de acordo com|pela|ilustra|representa|mostr[a]|exib[ea]|consider[ea]\s+(a|o)\s+(image|figur|gráfic|diagram|tabela|mapa))\b/i.test(n.questionText)?"[AVISO CR\xCDTICO]: O enunciado referencia conte\xFAdo visual (gr\xE1fico/imagem/figura/diagrama) mas NENHUMA imagem foi capturada. Sua confian\xE7a DEVE ser \u22640.15. N\xC3O adivinhe \u2014 use apenas o contexto textual dispon\xEDvel.":"Nenhum anexo visual.";let x=e.filter(T=>T.captureStatus==="failed_relevant"),C=/\b(observ[ea]|analis[ea]|figur[a]|gráfic[o]|diagram[a]|image[mn]|mapa|tabela|veja|conforme|de acordo com|pela|ilustra|representa|mostr[a])\b/i.test(n.questionText),v=e.every(T=>T.captureStatus!=="captured"),w="";return(x.length>0||C&&v)&&(w=`
...
`),w+e.map((T,q)=>{let E=T.associatedLabel||"Gr\xE1fico da Quest\xE3o",H=T.alt?` | alt: "${T.alt}"`:"";if(T.captureStatus==="failed_relevant")return`  - Imagem ${q+1} [IMAGEM_RELEVANTE_N\xC3O_CAPTURADA]: ${E}${H} | ${T.textContext||"sem contexto adicional"} | src: ${(T.source||"").slice(0,100)}`;if(T.captureStatus==="text_only")return`  - Imagem ${q+1} [CONTEXTO_TEXTUAL]: ${E}${H} | ${T.textContext||"sem contexto adicional"}`;if(T.captureStatus==="captured"||T.base64){let z=T.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${T.textContext}"`:"";return`  - Imagem ${q+1} [VISUAL_INLINE]: ${E}${H}${z}`}return`  - Imagem ${q+1} [FALHOU]: ${E}${H}`}).join(`
`)})()}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var On=new Set(["question","info","start","conclusion"]),Dn=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Nn=new Set(["val","chk","sel","clk","adv","js","drag"]),Bn=150,Ve=2e3;function de(n,e=""){return n==null?e:typeof n=="string"?n.trim().slice(0,Ve):typeof n=="number"||typeof n=="boolean"?String(n).trim().slice(0,Ve):e}function Rn(n,e){if(!n||typeof n!="object")return null;let t=n,o=t.t;if(typeof o!="string"||!Nn.has(o))return null;if(o==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...de(s)?{id:de(s,"").slice(0,500)}:{}}}if(o==="drag"){let s=de(t.from??t.source),c=de(t.to??t.target??t.destination);return!s||!c?null:{t:"drag",from:s.slice(0,500),to:c.slice(0,500)}}if(o==="js"){let s=de(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&o==="val"&&(i="1");let a=de(i).slice(0,500);if(!a)return null;if(o==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:de(s).slice(0,Ve)}}if(o==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(s)?s:[s]).map(p=>de(p).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:l}}if(o==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",c={t:"chk",id:a,c:!s};return t.v!==void 0&&(c.v=de(t.v).slice(0,Ve)),c}let r={t:"clk",id:a};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!s}return t.v!==void 0&&(r.v=de(t.v).slice(0,Ve)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(r.co=[t.co[0],t.co[1]]),r}function jn(n,e,t){if(t!=="question")return n;let o=n.filter(a=>a.t==="adv"),i=n.filter(a=>a.t!=="adv");if(e==="escolha_unica"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=i.filter(r=>r.t==="chk"||r.t==="clk");if(a.length>1){let r=i.filter(c=>c.t!=="chk"&&c.t!=="clk"),s=a[a.length-1];i=[...r,s]}}else if(e==="escolha_multipla"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=new Set;i=i.filter(r=>{let s="id"in r&&typeof r.id=="string"?r.id:"";return s?a.has(s)?!1:(a.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let a=new Set,r=[...i].reverse(),s=[];for(let c of r){let l="id"in c&&typeof c.id=="string"?c.id:"";l?a.has(l)||(a.add(l),s.push(c)):s.push(c)}i=s.reverse()}return[...i,...o]}function nn(n){if(!n||typeof n!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=n,t=e.pageType,o=e.mode;(typeof t!="string"||!On.has(t))&&(t="question"),(typeof o!="string"||!Dn.has(o))&&(o="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],a=[];for(let c=0;c<Math.min(i.length,Bn);c++){let l=Rn(i[c],c);l&&a.push(l)}a.some(c=>c.t==="val")&&(o==="escolha_unica"||!e.mode)&&(o="preenchimento"),a.some(c=>c.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(o)&&(o="arrastar_soltar"),a=jn(a,o,t);let r=a.some(c=>c.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?r||a.push({t:"adv"}):t==="question"&&!r&&a.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:o,confidence:s,rationale:de(e.rationale,"Plano validado e auto-recuperado."),actions:a,...de(e.memoryToStore)?{memoryToStore:de(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var pe=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let o=e.flatMap(a=>a.split(/[\n\r]+/));Array.from(new Set(o.map(a=>a.trim().replace(/^["']|["']$/g,"")).filter(a=>a.length>5))).forEach((a,r)=>{let s=this.generateId(a),c=t.get(s)||t.get(a);this.keys.set(s,{id:s,key:a,label:c?.label||`Chave ${r+1}`,addedAt:c?.addedAt||Date.now(),lastUsedAt:c?.lastUsedAt,lastLatencyMs:c?.lastLatencyMs,cooldownUntil:c?.cooldownUntil,errorCount:c?.errorCount||0,lastError:c?.lastError,winCount:c?.winCount||0})})}generateId(e){let t=0;for(let i=0;i<e.length;i++)t=(t<<5)-t+e.charCodeAt(i),t|=0;let o=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${o}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let o=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:o>0,remainingCooldownMs:o}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),o=Array.from(this.keys.values()).filter(a=>(a.errorCount||0)<50);if(o.length===0)return Array.from(this.keys.values()).slice(0,e);let i=o.filter(a=>(a.cooldownUntil||0)<=t);return i.length>0?(i.sort((a,r)=>{let s=a.lastLatencyMs!==void 0?a.lastLatencyMs:99999,c=r.lastLatencyMs!==void 0?r.lastLatencyMs:99999;if(s!==c)return s-c;let l=(a.lastUsedAt||0)-(r.lastUsedAt||0);return l!==0?l:a.addedAt-r.addedAt}),i.slice(0,e)):(o.sort((a,r)=>(a.cooldownUntil||0)-(r.cooldownUntil||0)),o.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let o=this.findKeyObj(e);o&&(o.lastLatencyMs=t,o.lastUsedAt=Date.now(),o.errorCount=0,o.lastError=void 0,o.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let o=this.findKeyObj(e);o&&(o.errorCount=99,o.lastError=t)}addKey(e,t){let o=e.trim().replace(/^["']|["']$/g,"");if(!o)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(o.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(o);if(this.keys.has(i)||Array.from(this.keys.values()).some(s=>s.key===o))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let r={id:i,key:o,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,r),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:r}}updateKey(e,t,o){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=t.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=a,o!==void 0&&(i.label=o.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},X=new pe;var Oe=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],an=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],Qn={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function It(n){return Qn[n]??n}function Fn(n,e){let o={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??Un};return/lite/i.test(n)||(/gemini-3\.[0-9]+-?flash/i.test(n)?o.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(n)&&(o.thinkingConfig={thinkingBudget:0})),o}var Un={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function sn(n){let e=n.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=It(e);return ce(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function Mt(n,e){let t="";try{let o=JSON.parse(n);t=o.error?.message||o.message||""}catch{t=n.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Xn(n){let e=n.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let o=e.match(/\{[\s\S]*\}/);if(o)try{return JSON.parse(o[0].trim())}catch{}try{let i=e.indexOf("{");if(i!==-1){let a=e.slice(i).trim();a=a.replace(/,\s*\{[^}]*$/,""),a=a.replace(/,\s*$/,"");let r=0,s=0,c=!1,l=!1;for(let f=0;f<a.length;f++){let d=a[f];if(l){l=!1;continue}if(d==="\\"){l=!0;continue}if(d==='"'){c=!c;continue}c||(d==="{"?r++:d==="}"?r=Math.max(0,r-1):d==="["?s++:d==="]"&&(s=Math.max(0,s-1)))}for(c&&(a+='"');s>0;)a+="]",s--;for(;r>0;)a+="}",r--;let p=JSON.parse(a);if(p&&typeof p=="object")return p}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var rn=(()=>{try{let n=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!n)return null;let e=JSON.parse(n);if(Array.isArray(e)){let t=e.filter(o=>o&&typeof o.id=="string"&&ce(o.id));return t.length>0?t:null}return null}catch{return null}})(),St=new Set;async function it(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return Oe;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of t)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let r=await i.text(),s=Mt(r,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let a=await i.json();if(Array.isArray(a.models)&&a.models.length>0){let r=a.models.filter(s=>{let c=s.supportedGenerationMethods||[],l=(s.name||"").replace(/^models\//,""),p=c.includes("generateContent");return ce(l)&&p}).map(s=>{let c=s.supportedGenerationMethods||[],l=s.name.replace(/^models\//,""),p=s.displayName||l;return{id:l,name:p.includes(l)?p:`${p} (${l})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(r.length>0){r.sort((s,c)=>{let l=p=>p==="gemini-3.8-flash"?200:p==="gemini-3.7-flash"?190:p==="gemini-3.6-flash"?180:p==="gemini-3.5-flash"?170:p==="gemini-3.5-flash-lite"?160:p==="gemini-2.5-flash"?130:p.includes("flash")?80:p==="gemini-2.5-pro"?60:p.includes("pro")?50:10;return l(c.id)-l(s.id)}),rn=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return Oe}async function st(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await it(e);if(o.length>0&&o!==Oe){let i=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let o of t)for(let i of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${i}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${i})!`,models:Oe}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function Ht(n,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:n,key:"",message:"Nenhuma chave dispon\xEDvel."};let o=It(sn(n)),i=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),a={"Content-Type":"application/json"};async function r(l,p,f){let d=new AbortController,m=setTimeout(()=>d.abort(),f);try{let u=`https://generativelanguage.googleapis.com/v1beta/models/${p}:generateContent?key=${encodeURIComponent(l)}`,h=await fetch(u,{method:"POST",headers:{...a,"x-goog-api-key":l},body:i,signal:d.signal});if(clearTimeout(m),h.ok)return{ok:!0,model:p,key:l,message:`Modelo '${p}' validado com sucesso!`};let b=await h.text().catch(()=>"");throw new Error(`HTTP ${h.status}: ${b.slice(0,80)}`)}catch(u){throw clearTimeout(m),u}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(f=>r(f,o,8e3)))}catch{}}let s=t[0],c=[o,...an.filter(l=>l!==o)];for(let l of c)try{let p=await r(s,l,4e3);return l!==o&&(p.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),p}catch{}return{ok:!1,model:o,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function Vn(n,e,t,o,i){let a=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${n}`),c={...Fn(n,i)};for(let l of a){if(o.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let p=`https://generativelanguage.googleapis.com/${l}/models/${n}:generateContent?key=${encodeURIComponent(e)}`,f=Date.now();try{let d=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(!d.ok){let h=await d.text();if(d.status===400){let y=/thinking/i.test(h),x=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(h);if((y||x)&&(c.thinkingConfig||c.responseSchema)){let A={...c};y&&delete A.thinkingConfig,x&&(delete A.responseSchema,delete A.responseMimeType),c=A;let C=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(C.ok){let T=await C.json(),q=T.candidates?.[0];if(q?.content?.parts?.[0]?.text)return X.markSuccess(e,Date.now()-f),{rawText:q.content.parts[0].text,data:T,usedModel:n,usedKey:e}}let v=await C?.text?.().catch(()=>"")??h,w=Mt(v,d.status);throw new Error(`[${n}|${pe.maskKey(e)}] ${w}`)}}let b=Mt(h,d.status);if(d.status===404&&l==="v1beta")continue;throw d.status===429?(X.markQuotaHit(e,8e3),ln(e,n,1e4),new Error(`[${n}|${pe.maskKey(e)}] ${b}`)):(d.status===503||/no capacity|overloaded|unavailable/i.test(h)?(X.markOverloaded(e,5e3),St.add(n)):d.status===403||/API_KEY_INVALID/i.test(h)?X.markInvalid(e,b):d.status===404&&St.add(n),new Error(`[${n}|${pe.maskKey(e)}] ${b}`))}let m=await d.json(),u=m.candidates?.[0];if(!u||!u.content?.parts?.[0]?.text)throw new Error(`[${n}|${pe.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return X.markSuccess(e,Date.now()-f),{rawText:u.content.parts[0].text,data:m,usedModel:n,usedKey:e}}catch(d){if(o.aborted)throw d;r=d;let m=r.message||"";if(m.includes("404")||/no longer available/i.test(m)){St.add(n);break}if(m.includes("429")||m.includes("Quota"))break}}throw r}var at=new Map;function on(n,e){let t=`${n}::${e}`,o=at.get(t);return o===void 0?!1:Date.now()>o?(at.delete(t),!1):!0}function ln(n,e,t=1e4){at.set(`${n}::${e}`,Date.now()+t)}function Pt(){at.clear()}async function rt(n,e,t,o,i,a){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let r=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];X.init(r);let s=t.apiKey.trim().replace(/^["']|["']$/g,""),c=X.getBestKey()||s;if(!c)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=sn(t.model);if(!rn&&c&&it(c).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let p=Date.now(),f=Xe(n,e,t),d=[{text:f}];for(let z=0;z<e.length;z++){let k=e[z],P=k.associatedLabel||(k.alt?`Imagem: ${k.alt}`:`Imagem ${z+1}`);if(k.captureStatus==="text_only"||!k.base64){let j=k.textContext||k.alt||"";d.push({text:`[CONTEXTO_IMAGEM_${z+1} - V\xCDNCULO: ${P}]: ${j}`})}else d.push({text:`[ANEXO VISUAL ${z+1} - V\xCDNCULO: ${P}]:`}),d.push({inline_data:{mime_type:k.mediaType,data:k.base64}})}let m={system_instruction:{parts:[{text:a?.systemPromptOverride??tn}]},contents:[{role:"user",parts:d}]},u=It(l),h=an.filter(z=>z!==u),y=X.getAllKeys().length,x=z=>y<=1||z===0?1:2,A=new Set,C=(z,k)=>{let P=/pro/i.test(z),j=/lite/i.test(z);return P?k===0?18e3:k===1?24e3:3e4:j?k===0?1e4:k===1?14e3:18e3:k===0?16e3:k===1?2e4:25e3},v=async(z,k)=>{if(k.length===0||i?.aborted)return null;let P=k.map(()=>new AbortController),j=()=>P.forEach(F=>{try{F.abort()}catch{}});i?.addEventListener("abort",j,{once:!0});let Q=k.map(F=>`${F.model.replace("gemini-","")}/${F.label}`).join(" | ");o?.(`\u26A1 ${z}: ${k.length} slot(s) [${Q}]...`,"info");try{let F=k.map(async(W,te)=>{let ee=P[te],ne=setTimeout(()=>{try{ee.abort(new Error(`Timeout ${W.timeout/1e3}s (${W.model}|${W.label})`))}catch{ee.abort()}},W.timeout);try{let _=await Vn(W.model,W.key,m,ee.signal,a?.generationSchemaOverride);clearTimeout(ne);let se=nn(Xn(_.rawText));return se.usedModel=_.usedModel,se.durationMs=Date.now()-p,se.promptSent=f,se.tokensUsed=_.data.usageMetadata?.totalTokenCount,se.promptTokens=_.data.usageMetadata?.promptTokenCount,se.candidatesTokens=_.data.usageMetadata?.candidatesTokenCount,se.rawResponse=_.rawText,P.forEach((Be,wt)=>{if(wt!==te)try{Be.abort(new Error("Cancelado: vencedor respondeu."))}catch{Be.abort()}}),{plan:se,rawUsage:_.data.usageMetadata,usedModel:_.usedModel,usedKey:_.usedKey,slotLabel:W.label}}catch(_){clearTimeout(ne);let se=_ instanceof Error?_.message:String(_);throw(se.includes("429")||se.includes("Quota")||se.includes("RESOURCE_EXHAUSTED"))&&(ln(W.key,W.model,1e4),X.markQuotaHit(W.key,8e3)),_}}),G=await Promise.any(F);return i?.removeEventListener("abort",j),X.markWinner(G.usedKey),G}catch(F){return i?.removeEventListener("abort",j),F instanceof AggregateError&&F.errors.length>0?E=F.errors.map(G=>G instanceof Error?G.message:String(G)).join(" | "):F instanceof Error&&(E=F.message),console.warn(`[EasyQuiz ${z}] Falha na onda:`,E),null}},T=(y<=1?1:1+Math.ceil((y-1)/2))+4,q=0,E="",H=0;for(;q<T;){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let z=X.getRoundRobinKeys(y),k=z.filter(ee=>!A.has(`${ee.key}::${u}`)&&!on(ee.key,u)),P,j;if(k.length>0)P=u,j=k;else{let ee=h;P=ee[H%ee.length]||u,H++;let ne=z.filter(_=>!A.has(`${_.key}::${P}`)&&!on(_.key,P));j=ne.length>0?ne:z.filter(_=>!A.has(`${_.key}::${P}`))}if(j.length===0){if(H<h.length)continue;break}let Q=j.slice(0,x(q));if(Q.length===0)break;let F=C(P,q),G=Q.map(ee=>(A.add(`${ee.key}::${P}`),{model:P,key:ee.key,label:ee.label||"Chave",timeout:F})),W=q===0?"Onda 1":`Onda ${q+1}`,te=await v(W,G);if(te){let ee=te.plan.durationMs||Date.now()-p,ne=pe.maskKey(te.usedKey);return o?.(`\u2705 ${ee}ms via '${te.usedModel}' (${te.slotLabel}: ${ne})`,"info"),te}q++}throw new Error(E||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var Kn=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Pe(n){let e=n?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return n?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!n?.autoAdvance}}function zt(n,e){if(n.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(n.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function cn(n){if(!n.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(n.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(Kn.find(t=>t.test(n)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(n)&&!n.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var De=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]',".mq-editable-field",".mq-root-block",'[class*="expression-editor" i]','[class*="math-input" i]','[class*="perseus-dropdown" i]','[class*="perseus-radio" i]','[class*="perseus"] [role="listbox"]','[class*="perseus"] [role="radio"]','[class*="perseus"] [role="combobox"]','.perseus-widget-container [role="button"]',".perseus-widget-container input",".perseus-widget-container select",'.number-line [role="slider"]','[class*="interactive-graph" i]'].join(","),Ge=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,Ae=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,Gn=0;function Ot(n){try{let e=n.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!ue(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(n):n.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof n.getBoundingClientRect=="function"){let e=n.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(n.textContent||"").trim().length>0}function $(n){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(n)}catch{}return String(n).replace(/["\\]/g,"\\$&")}function B(n){let e=n;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||ue(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let o=e.type?.toLowerCase();if(o==="checkbox"||o==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${$(e.id)}"]`);if(a&&Ot(a))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Ot(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return Ot(e)}function Wn(n){if(n==null)return"";if(typeof n=="string")return n;if(typeof n=="number"||typeof n=="boolean")return String(n);if(n instanceof Node)return n.textContent||"";try{if(typeof n?.toString=="function"){let e=n.toString();if(typeof e=="string")return e}}catch{}return""}function J(n,e=500){return Wn(n).replace(/\s+/g," ").trim().slice(0,e)}function Jn(n){let e=n.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(Gn+=1).toString(36)}`;return n.dataset.easyquizId=t,t}function ue(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function we(n){if(!n)return!1;let e=n.closest('aside, nav, [class*="task-list" i], [class*="lesson-list" i], [class*="mastery" i], [class*="sidebar" i], [class*="side-bar" i], [class*="side_bar" i], [class*="unit-nav" i], [class*="course-nav" i], [data-testid*="sidebar" i], [data-testid*="task-list" i], [class*="practice-tab" i], [class*="progress-nav" i], [role="navigation"], [role="complementary"]');return!!(e&&!e.querySelector('.perseus-renderer, .framework-perseus, [data-test-id*="exercise" i]'))}function We(){try{if(/khanacademy\.org/i.test(window.location.href)||document.querySelector(".perseus-renderer, .framework-perseus"))return!0}catch{}return!1}var Ke=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function Y(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element))return!1;if(ue(n))return!0;let e=n.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((n.type||"").toLowerCase()))return!1;let o=n.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||n,i=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||""),a=String(o.getAttribute?.("aria-label")||""),r=String(o.getAttribute?.("title")||""),s=typeof o.className=="string"?o.className:typeof o.className?.baseVal=="string"?o.className.baseVal:"",c=J(o.textContent,60);return!!(Ke.test(i)||Ke.test(a)||Ke.test(r)||Ke.test(s)||c.length>0&&c.length<=25&&Ke.test(c))}function re(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element)||ue(n)||Y(n)||n.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||n.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&n instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&n instanceof HTMLButtonElement?n.value:"",t=J(n.getAttribute?.("aria-label")||n.textContent||n.getAttribute?.("value")||e),o=n.type,i=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),a=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||n.getAttribute?.("href")||"").toLowerCase();return Ae.test(i)||Ae.test(t)?!1:Ge.test(i)||Ge.test(t)||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!n.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function Dt(n){let e=n.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),l=c&&c!==n.closest("td")?J(c.textContent,100):"",p=J(n.closest("label, td")?.textContent||"",50);if(l&&p)return`${l}: ${p}`}let t=n.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let c=t.querySelector('.dropdown-label, [class*="label" i]'),l=c&&c!==n?J(c.textContent,150):"";if(l)return l}let o=n.getAttribute("aria-label");if(o)return J(o);let i=n.getAttribute("aria-labelledby");if(i){let c=i.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(c.trim())return J(c)}if("labels"in n&&n.labels){let c=Array.from(n.labels??[]).map(l=>l.textContent).join(" ");if(c.trim())return J(c)}let a=n.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==n){let c=J(a.textContent);if(c)return c}let r=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",s=n.getAttribute("placeholder")||n.getAttribute("title")||n.textContent||r||"";return J(s)}function Nt(n,e){let o=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName.toLowerCase()==="select"?n:null,i=n;n.dataset.easyquizRole=e;let a=n.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(a)?a:"other",s=n.getAttribute("role")||"",c=(n.getAttribute("data-testid")||n.getAttribute("data-test-id")||"").toLowerCase(),l=(n.className&&typeof n.className=="string"?n.className:"").toLowerCase(),p=n.getAttribute("draggable")==="true"||n.classList.contains("perseus-drag-item")||n.classList.contains("sortable-item")||l.includes("cursor-grab")||!!n.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(l),f=n.getAttribute("data-role")==="dropzone"||n.classList.contains("category-container")||n.hasAttribute("data-category")||!!n.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(l),m=J((p?"draggable":f?"dropzone":"")||i.type||s||r,40),u="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox"){let C=i.checked||n.getAttribute("aria-checked")==="true",v=i.value&&i.value!=="on"?i.value:n.getAttribute("data-value")||"";u=C?v?`checked:${v}`:"checked":v||"unchecked"}else if(r==="button"||a==="a"||e==="navigation"||re(n))u="";else{let C=typeof n.value=="string"||typeof n.value=="number"?n.value:"";u=J(C||n.getAttribute("data-category")||"",2e3)}let h=[];if(o&&o.options)for(let C of Array.from(o.options).slice(0,80))h.push({value:J(C.value),label:J(C.textContent)});else if(s==="combobox"||s==="listbox"||l.includes("select")||l.includes("dropdown")){let C=n.getAttribute("aria-controls")||n.getAttribute("aria-owns"),v=C?document.getElementById(C):n;if(v){let w=v.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let T of Array.from(w).slice(0,80)){let q=J(T.textContent);q&&h.push({value:T.getAttribute("data-value")||T.getAttribute("value")||q,label:q})}}}let b=!!(i.required||n.getAttribute("aria-required")==="true"),y=!!(i.disabled||n.getAttribute("aria-disabled")==="true"),x=Jn(n);return{id:n.id||x,tag:r,type:m,label:Dt(n),name:J(i.name||n.getAttribute("name")||"",180),value:u,options:h,required:b,disabled:y,role:e}}var dn=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Bt(n){if(!B(n)||we(n))return-1/0;let e=n.getBoundingClientRect(),t=Array.from(n.querySelectorAll(De)).filter(d=>B(d)&&!we(d)),o=J(n.innerText||n.textContent||"",4e3).length;if(o<10||!t.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),r=Math.min(1,a/i),s=e.top+e.height/2,c=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),l=o>40?35:0,p=e.top>=0&&e.bottom<=window.innerHeight?25:0,f=n.matches?.('.perseus-renderer, .framework-perseus, [data-test-id*="exercise" i]')?50:0;return t.length*15+Math.min(60,o/20)+l+p+f-r*20-c*10}function Ne(n){let e=n;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,o=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&o!=="main"&&o!=="body"){e=t;break}let i=J(e.innerText||e.textContent||"",1e4),a=J(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(De).length,s=t.querySelectorAll(De).length;if(i.length<150&&a.length>i.length&&s<=r+4&&o!=="main"&&o!=="body"){e=t;continue}break}return e}function Yn(n,e=16e3){let t=n.cloneNode(!0),o=Array.from(t.querySelectorAll(".katex"));for(let l of o){let p=l.querySelector('annotation[encoding="application/x-tex"]');if(p&&p.textContent){let f=` $${p.textContent.trim()}$ `,d=document.createTextNode(f);l.replaceWith(d)}}let i=Array.from(t.querySelectorAll("math"));for(let l of i)try{let p=Zn(l);if(p){let f=document.createTextNode(` ${p} `);l.replaceWith(f)}}catch{}let a=Array.from(t.querySelectorAll(".mq-root-block, .mq-editable-field"));for(let l of a){let p=l.textContent?.trim();p&&(l.textContent=` [math: ${p}] `)}let r=Array.from(t.querySelectorAll("sup"));for(let l of r)l.textContent=`^{${l.textContent?.trim()||""}}`;let s=Array.from(t.querySelectorAll("sub"));for(let l of s)l.textContent=`_{${l.textContent?.trim()||""}}`;let c=t.innerText&&t.innerText.trim().length>0?t.innerText:t.textContent||"";return J(c,e)}function Zn(n){let e=[];function t(o){let i=o.tagName?.toLowerCase();if(i==="mfrac"){let a=Array.from(o.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`(${r}/${s})`);return}if(i==="msqrt"){e.push(`sqrt(${o.textContent?.trim()||"?"})`);return}if(i==="msup"){let a=Array.from(o.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`${r}^{${s}}`);return}if(i==="msub"){let a=Array.from(o.children),r=a[0]?.textContent?.trim()||"?",s=a[1]?.textContent?.trim()||"?";e.push(`${r}_{${s}}`);return}if(i==="mn"||i==="mi"||i==="mo"||i==="mtext"){e.push(o.textContent?.trim()||"");return}for(let a of Array.from(o.children))t(a)}return t(n),e.join(" ")}function un(n){let e=n,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&B(t))return t;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}var ct=new Map,$n=3e4;function _n(){let n=window.location.hostname,e=ct.get(n);return e?Date.now()-e.timestamp>$n?(ct.delete(n),null):e.selector:null}function Je(n){try{let e=n.tagName.toLowerCase(),t=n.id?`#${n.id}`:"",o=Array.from(n.classList).slice(0,3).map(a=>`.${a}`).join(""),i=`${e}${t}${o}`;i&&i!=="body"&&i!=="html"&&ct.set(window.location.hostname,{selector:i,timestamp:Date.now()})}catch{}}function le(){let n=_n();if(n){try{let s=document.querySelector(n);if(s&&B(s)&&!we(s)&&Bt(s)>0)return Ne(s)}catch{}ct.delete(window.location.hostname)}let e=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(e&&B(e))return Je(e),e;if(We()){let c=Array.from(document.querySelectorAll(".perseus-renderer, .framework-perseus")).filter(l=>{if(!B(l)||we(l))return!1;let p=l.getBoundingClientRect();return p.width>100&&p.height>50&&p.bottom>0&&p.top<window.innerHeight});if(c.length>0){c.sort((p,f)=>{let d=p.getBoundingClientRect(),m=f.getBoundingClientRect();return m.width*m.height-d.width*d.height});let l=Ne(c[0]);return Je(l),l}}let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(dn);if(s&&!we(s)&&Bt(s)>0){let c=Ne(s);return Je(c),c}}let i=Array.from(document.querySelectorAll(dn)).filter(s=>!we(s)).map(s=>({element:s,score:Bt(s)})).filter(s=>Number.isFinite(s.score)).sort((s,c)=>c.score-s.score),a=i.find(s=>{let c=s.element.tagName.toLowerCase();return c!=="main"&&c!=="body"&&s.score>0});if(a){let s=Ne(a.element);return Je(s),s}if(i.length>0&&i[0].score>0){let s=Ne(i[0].element);return Je(s),s}let r=document.querySelector('form, main, [role="main"]');return r&&B(r)?r:document.body}function pn(n){let e=n.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))t.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function lt(n){let e=Array.from(n.querySelectorAll(De)),t=new Set,o=[],i=We();for(let p of e){if(!B(p)||re(p)||Y(p)||i&&we(p))continue;let f=(p.value||p.textContent||"").trim();if(Ae.test(f))continue;let d=p.tagName.toLowerCase();["input","textarea","select"].includes(d)&&(t.add(p),o.push(p))}for(let p of e){if(!B(p)||re(p)||Y(p)||i&&we(p))continue;let f=(p.value||p.textContent||"").trim();if(Ae.test(f))continue;let d=p.tagName.toLowerCase();if(["input","textarea","select"].includes(d))continue;let m=p.querySelector("input, textarea, select");if(!(m&&t.has(m))){if(p.hasAttribute("for")){let u=p.getAttribute("for"),h=u?p.ownerDocument.getElementById(u):null;if(h&&t.has(h))continue}if(d==="a"){let u=p.getAttribute("role"),h=p.getAttribute("class")||"",b=p.getAttribute("data-testid")||"",y=p.getAttribute("draggable")==="true"||p.classList.contains("perseus-drag-item")||p.classList.contains("sortable-item")||h.includes("cursor-grab")||!!p.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(b)||/drag|card-item|sortable/i.test(h);if(!(u==="button"||u==="radio"||u==="checkbox"||u==="option"||y||p.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}o.push(p)}}let a=o.length>0&&o.every(p=>Y(p)||/read-?aloud|audio/i.test(p.getAttribute("data-testid")||p.getAttribute("aria-label")||"")),r=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||n,s=document.body.querySelector('[class*="classification" i]')!==null||n.querySelector('[class*="classification" i]')!==null||n.querySelector('[data-cy*="quiz" i]')!==null||n.querySelector('[class*="draggable-item" i]')!==null||n.querySelector('[class*="drag-item" i]')!==null||n.querySelector('[class*="sortable-card" i]')!==null||n.matches?.('[class*="classification" i]');if((o.length===0||a)&&s){a&&(o.length=0);let p=Array.from(r.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(p.length>0){for(let f of p)if(!(!B(f)||Y(f))&&(o.push(f),o.length>=50))break}else{let f=Array.from(r.querySelectorAll("button, div[class], span[class], p, li"));for(let d of f){if(!B(d)||re(d)||Y(d)||Ae.test((d.textContent||"").trim()))continue;let m=(d.textContent||"").trim();if(m.length<2||m.length>300)continue;if(Array.from(d.children).some(h=>h.className&&h.textContent?.trim())||o.push(d),o.length>=50)break}}}let c=o.some(p=>["input","select","textarea"].includes(p.tagName.toLowerCase())),l=!c&&o.length>0&&o.every(p=>{let f=p.tagName.toLowerCase();if(["input","select","textarea","button"].includes(f))return!1;let d=(p.textContent||"").trim();return!p.id||d.length<10||/^\d+\s*\/\s*\d+$/.test(d)||/^question text/i.test(d)});if(o.length===0||l){l&&(o.length=0);let p=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(p.length>0)for(let f of p){if(!B(f)||ue(f)||re(f)||Y(f)||Ae.test((f.textContent||"").trim()))continue;let d=(f.textContent||"").trim();if(!(d.length<10||d.length>500)&&!/^\d+\s*\/\s*\d+$/.test(d)&&(o.push(f),o.length>=20))break}}if(o.length===0||o.length>0&&!c&&!o.some(p=>p.getAttribute("role")==="radio"||p.getAttribute("role")==="checkbox"||p.classList.contains("mq-editable-field")||p.closest(".perseus-widget-container"))){let f=document.querySelector(".perseus-renderer, .framework-perseus")||n,d=Array.from(f.querySelectorAll('.mq-editable-field, .mq-root-block, [class*="expression-editor" i], [class*="math-input" i]'));for(let y of d)!B(y)||ue(y)||o.includes(y)||o.push(y);let m=Array.from(f.querySelectorAll('[class*="perseus-dropdown" i], .perseus-widget-container select, .perseus-widget-container [role="combobox"], .perseus-widget-container [role="listbox"]'));for(let y of m)!B(y)||ue(y)||o.includes(y)||o.push(y);let u=Array.from(f.querySelectorAll('[class*="perseus-radio" i] [role="radio"], .perseus-widget-container [role="radio"], .perseus-widget-container [role="checkbox"]'));for(let y of u)!B(y)||ue(y)||y.querySelector('input[type="radio"], input[type="checkbox"]')||o.includes(y)||o.push(y);let h=Array.from(f.querySelectorAll('.perseus-widget-container [role="button"], .number-line [role="slider"], [class*="interactive-graph" i] [role="button"]'));for(let y of h)!B(y)||ue(y)||re(y)||o.includes(y)||o.push(y);let b=Array.from(f.querySelectorAll('.perseus-widget-container input:not([type="hidden"]), .perseus-widget-container textarea, .perseus-widget-container select'));for(let y of b)!B(y)||ue(y)||t.has(y)||o.includes(y)||o.push(y)}return o.slice(0,100).map(p=>Nt(p,"answer"))}function Rt(n){let e=[n,n.parentElement,n.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,o=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(De)))if(!(t.has(a)||!B(a)||!re(a)||Y(a))&&(t.add(a),o.push(Nt(a,"navigation")),o.length>=10))return o;return o}function Ce(n=!1){let e=le();e=Ne(e),n&&(e=un(e));let t=lt(e),o=Rt(e);if(t.length===0){let s=lt(document.body);s.length>0&&(e=un(e),t=lt(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}o.length===0&&(o=Rt(document.body));let i=e.querySelector(".katex, math, .mq-root-block, .mq-editable-field"),a;if(i)a=Yn(e,16e3);else{let s=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"";a=s.length>4e4?J(s.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+J(s.slice(-2e3),2e3):J(s,16e3)}let r=[...t,...o].slice(0,120);return!a||r.length===0&&a.length<30?J(document.body.innerText||document.body.textContent||"",16e3).length>=30?Ee():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:pn(e),controls:r,scope:e}}function Ee(){let n=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=J(n,16e3),t=lt(document.body),o=Rt(document.body),i=[...t,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:pn(a).slice(0,15e3),controls:i,scope:a}}function jt(n){let e=n.controls.map(t=>{let o=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${o}`}).join("|");return[window.location.href,n.pageTitle,n.questionText.slice(0,400),e].join("::")}function dt(n){if(!n)return!1;let e=n.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(o=>e.includes(o))}function K(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function I(n){return n==null?"":(typeof n=="string"?n:String(n)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function ae(n){if(!n||n instanceof HTMLInputElement||n instanceof HTMLSelectElement||n instanceof HTMLTextAreaElement||n.getAttribute("draggable")==="true"||n.classList.contains("dnd-card")||n.hasAttribute("data-category")||n.hasAttribute("data-dropzone"))return n;if(n.hasAttribute("for")){let o=n.getAttribute("for");if(o){let i=n.ownerDocument.getElementById(o);if(i)return i}}let e=n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let o=e.getAttribute("for"),a=(o?e.ownerDocument.getElementById(o):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=n.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(n.tagName.toLowerCase())){let o=n.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(o)return ae(o)}return n}function mn(n){let e=n;if(!e||!document.contains(e))try{e=le()}catch{}e=e||document.body;let t=i=>{let a=Array.from(i.querySelectorAll("tr")).filter(p=>B(p)&&p.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let r=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(p=>B(p)&&!K(p));if(r.length>0)return r;let c=Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(p=>B(p)&&!K(p)).filter(p=>!p.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return c.length>0?c:Array.from(i.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(p=>{let f=p;return B(f)&&!K(f)&&(f.textContent||"").trim().length>2&&!re(f)&&!Y(f)&&!f.querySelector("[class]")})},o=t(e);return o.length>0?o:e!==document.body?t(document.body):[]}function R(n,e,t=!1){if(n==null)return null;let i=(typeof n=="string"?n:String(n)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=$(i),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!K(r))return ae(r);try{let d=document.getElementById(i);if(d&&B(d)&&!K(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:ae(d)}catch{}try{let d=document.querySelector(`[data-item-id="${a}"]`);if(d&&B(d)&&!K(d))return ae(d)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let d=parseInt(s[1],10);if(t){let u=document.body;try{u=le()||document.body}catch{}let h=Array.from(u.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>B(b)&&!K(b));if(d>=1&&d-1<h.length)return h[d-1];if(d===0&&h.length>0)return h[0]}let m=d-1;if(m>=0){let u=mn();if(m<u.length){let y=u[m];if(y.tagName.toLowerCase()==="tr"){if(e){let A=y.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(A)return A}let x=y.querySelector("input");if(x)return x}return ae(y)}let h=document.body;try{h=le()||document.body}catch{}let b=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(y=>B(y)&&!K(y));if(m<b.length)return b[m]}}let c=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(c){let d=c[1].toUpperCase(),m=d.charCodeAt(0)-65,u=Array.from(document.querySelectorAll(`input[type="radio"][value="${d}" i], input[type="checkbox"][value="${d}" i]`)).find(b=>B(b)&&!K(b));if(u)return ae(u);let h=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(b=>{if(!B(b)||K(b))return!1;let x=(b.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(x===d||x===`${d})`||x===`(${d})`||x===`${d}.`||x===`${d}:`)return!0;let A=(b.textContent||"").trim().toUpperCase();return A.startsWith(`${d})`)||A.startsWith(`(${d})`)||A.startsWith(`${d}.`)||A.startsWith(`${d}:`)});if(h)return ae(h);if(m>=0){let b=mn();if(m<b.length){let y=b[m];if(y.tagName.toLowerCase()==="tr"){if(e){let A=y.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(A)return A}let x=y.querySelector("input");if(x)return x}return ae(y)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let m=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(y=>B(y)&&!K(y));if(m)return m;let h=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(y=>B(y)&&!K(y));if(h)return ae(h);let b=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(y=>{if(!B(y)||K(y))return!1;let x=I(y.textContent).toLowerCase();return x===i.toLowerCase()||x===i.toLowerCase()+")"});if(b)return ae(b)}try{let d=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let u=d.find(h=>{if(!B(h)||K(h))return!1;if(h instanceof HTMLInputElement&&h.value.toLowerCase()===e.toLowerCase())return!0;let b=h.closest("label, .vf-label, td, div");return b&&I(b.textContent).toLowerCase().includes(I(e).toLowerCase())});if(u)return ae(u)}let m=d.find(u=>B(u)&&!K(u));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:ae(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let m=Array.from(document.querySelectorAll(i)).find(u=>B(u)&&!K(u));if(m)return ae(m)}catch{}try{let d=i.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,u=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let h=0;h<u.snapshotLength;h++){let b=u.snapshotItem(h);if(b&&B(b)&&!K(b)){if(["body","html"].includes(b.tagName.toLowerCase())){let x=b.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(x&&B(x))return ae(x)}return b.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ae(b)}}}catch{}let p=I(i).toLowerCase(),f=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of f){if(!B(d)||K(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=I(d.textContent).toLowerCase(),h=I(d.getAttribute("aria-label")||"").toLowerCase(),b=I(d.getAttribute("placeholder")||"").toLowerCase(),y=I(d.getAttribute("title")||"").toLowerCase(),x=I(d.getAttribute("name")||"").toLowerCase(),A=I(d.getAttribute("data-category")||"").toLowerCase(),C=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",v=I(C).toLowerCase(),w=u.startsWith(p+")")||u.startsWith(p+".")||u.startsWith(p+" -")||u.startsWith(p+":");if(u===p||h===p||b===p||y===p||x===p||A&&A===p||v&&v===p||w)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ae(d)}if(p.length>=3)for(let d of f){if(!B(d)||K(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||Y(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=I(d.textContent).toLowerCase(),h=I(d.getAttribute("aria-label")||"").toLowerCase(),b=I(d.getAttribute("placeholder")||"").toLowerCase(),y=I(d.getAttribute("title")||"").toLowerCase(),x=I(d.getAttribute("name")||"").toLowerCase();if(u.includes(p)||h.includes(p)||b.includes(p)||y.includes(p)||x.includes(p)){if(Array.from(d.children).some(w=>{let T=I(w.textContent).toLowerCase();return T&&T.includes(p)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||ae(d)}let A=p.split(/\s+/).filter(Boolean);if(A.length>=3){let C=A.slice(0,Math.min(5,A.length)).join(" ");if(u.includes(C)||h.includes(C)||b.includes(C))return ae(d)}}return null}function hn(n,e){for(let t of e)n.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function ie(n,e){if(!n)return;try{n.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{n.focus?.()}catch{}let t=n.getBoundingClientRect(),o=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),i=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:o,clientY:i};try{n.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}if(typeof n.click=="function")try{n.click()}catch{try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let r=Object.keys(n).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(r){let s=n[r];for(;s;){let c=s.memoizedProps||s.pendingProps;if(c?.onClick){c.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let r=Object.keys(n).find(s=>s.startsWith("__reactProps"));if(r){let s=n[r];s?.onClick&&s.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let r=n._vei;r?.onClick&&(Array.isArray(r.onClick.value)?r.onClick.value:[r.onClick.value]).forEach(c=>{try{c({type:"click",target:n})}catch{}})}catch{}try{n.$onclick&&n.$onclick({type:"click",target:n,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||n.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=n.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let c=n.closest("[jsaction]");if(c&&c!==n)try{c.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:o,clientY:i}))}catch{}}}catch{}if(n.getAttribute("role")==="button"||n.getAttribute("tabindex")!==null)try{n.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function Ut(n){try{let e=n.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,n.id=e);let o=document.createElement("script");return o.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(o),o.remove(),t||setTimeout(()=>{try{n.id===e&&n.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function ut(n,e){let t=n;if(t.hasAttribute("for")){let f=t.getAttribute("for"),d=t.ownerDocument.getElementById(f);d&&(t=d)}let o=t.classList?.contains("mq-editable-field")||t.classList?.contains("mq-root-block")?t:t.querySelector(".mq-editable-field, .mq-root-block");if(o)try{let f=o.__mathquill||o.mathquill;if(f&&typeof f.latex=="function"){f.latex(e),o.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),o.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));return}let d=window.MathQuill?.getInterface?.(2)||window.MathQuill?.getInterface?.(1);if(d){let m=d(o);if(m&&typeof m.latex=="function"){m.latex(e),o.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}));return}}o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:"a",code:"KeyA",ctrlKey:!0,bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keydown",{key:"Backspace",code:"Backspace",bubbles:!0}));for(let m of e)o.dispatchEvent(new KeyboardEvent("keydown",{key:m,code:`Key${m.toUpperCase()}`,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keypress",{key:m,code:`Key${m.toUpperCase()}`,bubbles:!0,cancelable:!0})),o.dispatchEvent(new InputEvent("input",{data:m,inputType:"insertText",bubbles:!0,cancelable:!0,composed:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:m,code:`Key${m.toUpperCase()}`,bubbles:!0,cancelable:!0}));o.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));return}catch(f){console.warn("[EasyQuiz] MathQuill fill falhou, continuando com fallback padr\xE3o:",f)}let i=t.matches?.('[class*="perseus-dropdown" i], [class*="perseus"] [role="combobox"]')?t:t.querySelector('[class*="perseus-dropdown" i], [class*="perseus"] [role="combobox"]');if(i)try{ie(i),setTimeout(()=>{let f=e.trim().toLowerCase(),d=Array.from(document.querySelectorAll('[role="option"], [role="listbox"] [role="option"], [class*="dropdown"] [role="option"], [class*="perseus"] [class*="option"], .dropdown-option, [class*="select-option"]')).filter(m=>{let u=m;if(!B(u)||K(u))return!1;let h=(u.textContent||"").trim().toLowerCase(),b=u.getAttribute("data-value")?.toLowerCase()||"";return h===f||b===f||h.includes(f)||f.length>2&&f.includes(h)});d.length>0&&ie(d[0])},250);return}catch(f){console.warn("[EasyQuiz] Perseus dropdown fill falhou:",f)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){pt(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){pt(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let f=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(f)t=f;else{let m=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(m)t=m;else{let u=t.nextElementSibling;for(;u;){if(u instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(u.type)||u instanceof HTMLTextAreaElement||u instanceof HTMLElement&&u.isContentEditable){t=u;break}let h=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h){t=h;break}u=u.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let f=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(f)t=f;else{let d=document.body;try{d=le()||document.body}catch{}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m)t=m;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let f=document.body;try{f=le()||document.body}catch{}let d=f.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d)t=d;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let f=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;Te(t,f);return}let c=String(e??""),l=c;if(t instanceof HTMLInputElement&&t.type==="number"){let f=c.replace(",",".").replace(/[^0-9.-]/g,"");f&&!isNaN(Number(f))&&(l=f)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let f=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(f,"value")?.set;d?d.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let p=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(p=document.execCommand?.("insertText",!1,l)||!1):t.isContentEditable&&(p=document.execCommand?.("insertText",!1,l)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let m=t._valueTracker;m&&m.setValue(l===""?" ":"")}catch{}let f=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(f,"value")?.set;d?d.call(t,l):t.value=l;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:l.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:l.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==l&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(l))){t.value=l;try{d?.call(t,l)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==l.trim()){t.textContent=l;try{t.innerText=l}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:l,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=l),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Ye(n,e=""){if(n==null)return e;let t=typeof n=="string"?n:String(n);if(!t)return e;let o=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=I(t),a=R(t)||R(i);if(!a)return o?e:i||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let f=I(r.textContent);if(f&&f.length>0&&f.length<150)return f}if(a.id){let f=document.querySelector(`label[for="${$(a.id)}"]`);if(f){let d=I(f.textContent);if(d&&d.length>0&&d.length<150)return d}}let s=a.getAttribute("aria-label");if(s)return I(s);let c=a.getAttribute("placeholder");if(c)return I(c);let l=I(a.textContent);if(l&&l.length>0&&l.length<120)return l;let p=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return p?I(p):o?e:i||e}function Te(n,e){if(!n)return;let t=n.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||n,o=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:t.querySelector('input[type="checkbox"], input[type="radio"]');!o&&t.hasAttribute("for")&&(o=t.ownerDocument.getElementById(t.getAttribute("for")));let i=n instanceof HTMLInputElement?n.closest("label")||(n.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||n:t&&B(t)?t:n;if(o){let a=o.type==="radio",r=o.type==="checkbox",s=!!o._valueTracker;if(o.checked===e){if(a&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(r){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(i&&i!==o&&ie(i),o.checked!==e)try{o.focus?.(),o.click()}catch{}if(o.checked!==e){try{let l=o._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,hn(o,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;ie(i),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function pt(n,e){let t=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"?n:n.querySelector("select");if(t){let r=e.map(l=>I(l).toLowerCase()),s=!1,c=(l,p)=>{l.selected=!0,t.selectedIndex=p;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let f=t._valueTracker;f&&f.setValue(l.value)}catch{}s=!0};for(let l=0;l<t.options.length;l++){let p=t.options[l],f=p.value.toLowerCase(),d=I(p.textContent).toLowerCase();if(r.some(u=>u===f||u===d)){if(c(p,l),!t.multiple)break}else t.multiple||(p.selected=!1)}if(!s)for(let l of r){let p=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(p){let f=parseInt(p[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?f:f>=1?f-1:0;if(m>=0&&m<t.options.length&&(c(t.options[m],m),!t.multiple))break}}if(!s){for(let l of r)if(/^[a-z]$/i.test(l)){let p=l.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?p+1:p;if(d>=0&&d<t.options.length&&(c(t.options[d],d),!t.multiple))break}}if(!s){let l=p=>p.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let p=0;p<t.options.length;p++){let f=t.options[p],d=l(f.value.toLowerCase()),m=l(I(f.textContent).toLowerCase());if(r.some(h=>{let b=l(h);return d.includes(b)||m.includes(b)||b.length>2&&(b.includes(d)||b.includes(m))})&&(c(f,p),!t.multiple))break}}if(s){hn(t,["focus","input","change","blur"]);return}}let o=n.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?n:n.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');o&&ie(o);let i=e.map(r=>I(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>B(r)&&!K(r));for(let r of i){let s=a.find(l=>{let p=I(l.textContent).toLowerCase(),f=I(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return p===r||f===r||p.includes(r)||r.length>2&&r.includes(p)});if(s){ie(s);let l=s.querySelector('input[type="radio"], input[type="checkbox"]');l&&Te(l,!0);return}let c=R(r);if(c){ie(c);return}}}function eo(n,e){try{let t=new DataTransfer;try{t.setData("text/plain",n)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Qt(n){try{n.click()}catch{let e=n.ownerDocument.defaultView||window;n.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function to(n,e,t){try{if(e.contains(n))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(n))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let o=e.children.length;if(t!==void 0&&o>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${o}`};if([n.getAttribute("data-placed")==="true",n.getAttribute("data-assigned")==="true",n.getAttribute("data-matched")==="true",n.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(n.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(n.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(c=>c!==e&&(c.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:n.getAttribute("aria-hidden")==="true"||n.style.display==="none"||n.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function he(n,e){let t=I(n).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(n.trim())){let s=document.getElementById(n.trim());if(s&&B(s)&&!K(s))return s}let r=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of r){let l=Array.from(document.querySelectorAll(s)).find(p=>{if(!B(p)||K(p))return!1;let f=I(`${p.id} ${p.textContent||""} ${p.getAttribute("data-id")||""}`).toLowerCase();return f===t||f.includes(t)||p.id===n.trim()});if(l)return l}return null}let o=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),i=Array.from(document.querySelectorAll(o)),a=i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return a&&B(a)&&!K(a)?a:i.find(r=>{if(!B(r)||K(r)||/unclassified/i.test(r.className))return!1;let s=r.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),c=I(s?.textContent||r.textContent||"").toLowerCase();return c.includes("op")&&(c.includes("es")||c.includes("\xF5es"))?!1:c===t||c.startsWith(t)||c.includes(t)})||null}async function mt(n,e,t=1){try{n.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=n.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(o.left+Math.max(1,o.width/2)),r=Math.round(o.top+Math.max(1,o.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),c=Math.round(i.top+Math.max(1,i.height/2)),l=I(e.textContent).toLowerCase();if(l){let h=Array.from(n.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(b=>{let y=I(b.textContent).toLowerCase(),x=b instanceof HTMLInputElement||b instanceof HTMLOptionElement?I(b.value).toLowerCase():"";return y&&(l.includes(y)||y.includes(l))||x&&(l.includes(x)||x.includes(l))});h&&(ie(h),await new Promise(b=>setTimeout(b,120)))}Qt(n),await new Promise(u=>setTimeout(u,140)),Qt(e);let p=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(p&&p!==e&&Qt(p),await new Promise(u=>setTimeout(u,100)),!e.contains(n)&&n.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(n),e.contains(n)&&n.matches('.dnd-card, [draggable="true"]'))return;let f={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{n.dispatchEvent(new PointerEvent("pointerdown",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}n.dispatchEvent(new MouseEvent("mousedown",f));let d=4;for(let u=1;u<=d;u++){let h=Math.round(a+(s-a)*(u/d)),b=Math.round(r+(c-r)*(u/d)),y={...f,clientX:h,clientY:b,screenX:h,screenY:b};try{n.dispatchEvent(new PointerEvent("pointermove",{...y,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",y))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:c,screenX:s,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let u=eo(J(n.textContent),n.outerHTML),h={...f},b={...m};u&&(h.dataTransfer=u,b.dataTransfer=u);let y=n.ownerDocument.defaultView?.DragEvent;if(!y)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");n.dispatchEvent(new y("dragstart",h)),e.dispatchEvent(new y("dragenter",b)),e.dispatchEvent(new y("dragover",b)),e.dispatchEvent(new y("drop",b)),n.dispatchEvent(new y("dragend",h))}catch(u){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",u)}try{let u=new Touch({identifier:1,target:n,clientX:a,clientY:r}),h=new Touch({identifier:1,target:e,clientX:s,clientY:c});n.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[u]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[h]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(n))try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(u=>setTimeout(u,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(n))try{let u=y=>{let x=Object.keys(y).find(C=>C.startsWith("__reactFiber")||C.startsWith("__reactInternalInstance"));if(!x)return null;let A=y[x];for(let C=0;C<10&&A;C++){if(A.memoizedProps)return A.memoizedProps;A=A.return}return null},h=u(n),b=u(e);if(h){let y=h.onMouseDown||h.onPointerDown||h.onDragStart;if(typeof y=="function")try{y({type:"mousedown",button:0,buttons:1,clientX:a,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:n,target:n}),await new Promise(x=>setTimeout(x,100))}catch{}}if(b){let y=b.onMouseUp||b.onPointerUp||b.onDrop;if(typeof y=="function")try{y({type:"mouseup",button:0,buttons:0,clientX:s,clientY:c,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200));let y=c>r?"ArrowDown":"ArrowUp";for(let x=0;x<3;x++)document.dispatchEvent(new KeyboardEvent("keydown",{key:y,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80))}catch{}try{document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(n.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:n.id||n.getAttribute("data-id")}})),await new Promise(x=>setTimeout(x,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(u){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",u)}}function gn(n,e,t,o){let i=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),a=i(n.toLowerCase()),r=i(e.toLowerCase()),s=i(t),c=i(o);return`var src=$eq.find('${s}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${a}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${r}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${a} -> ${r}');}`}var fn={fill:(n,e)=>{let t=R(n);t?ut(t,e):console.warn(`$eq.fill: Elemento '${n}' n\xE3o encontrado`)},click:n=>{let e=R(n);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?Te(e,!0):ie(e):console.warn(`$eq.click: Elemento '${n}' n\xE3o encontrado`)},check:(n,e)=>{let t=R(n);t?Te(t,e):console.warn(`$eq.check: Elemento '${n}' n\xE3o encontrado`)},find:(n,e)=>R(n,e),drag:(n,e)=>{let t=he(n,"source")||R(n),o=he(e,"destination")||R(e);t&&o?mt(t,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${n}' -> '${e}')`)},categorize:async(n,e)=>{let t=he(n,"source")||R(n),o=he(e,"destination")||R(e);if(!t||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${n}' -> '${e}')`);return}await mt(t,o)},execute:(n,e=!1,t=1)=>Ze(n,e,t)};typeof window<"u"&&(window.$eq=fn);async function no(n,e,t){if(!e)return!1;if(n.t==="val"&&(e.classList.contains("mq-editable-field")||e.closest(".mq-editable-field"))){let o=e.classList.contains("mq-editable-field")?e:e.closest(".mq-editable-field");if(o){try{let i=o.__controller||o.__mathquill_controller;if(i&&i.API)return i.API.latex(t),!0}catch{}try{o.focus();for(let i of t){let a={key:i,bubbles:!0,cancelable:!0};o.dispatchEvent(new KeyboardEvent("keydown",a)),o.dispatchEvent(new KeyboardEvent("keypress",a)),document.execCommand?.("insertText",!1,i),o.dispatchEvent(new KeyboardEvent("keyup",a))}return!0}catch{}}}if(n.t==="sel"&&e.closest(".perseus-widget-container")){let o=e.tagName==="BUTTON"?e:e.querySelector("button")||e.closest("button");if(o)try{ie(o),await new Promise(a=>setTimeout(a,150));let i=Array.from(document.querySelectorAll('[data-reach-popover], [role="listbox"], .perseus-dropdown'));for(let a of i){let s=Array.from(a.querySelectorAll('[role="option"], li, button')).find(c=>I(c.textContent).toLowerCase().includes(I(t).toLowerCase()));if(s)return ie(s),!0}ie(o)}catch{}}if((n.t==="clk"||n.t==="chk")&&e.closest(".perseus-widget-container"))try{let o=Object.keys(e).find(a=>a.startsWith("__reactFiber$")),i=Object.keys(e).find(a=>a.startsWith("__reactProps$"));if(i&&e[i]){let a=e[i];if(typeof a.onClick=="function")return a.onClick({preventDefault:()=>{},stopPropagation:()=>{}}),!0;if(typeof a.onChange=="function")return a.onChange({target:{checked:!0,value:t},preventDefault:()=>{}}),!0}}catch{}return!1}async function oo(n,e=1,t=Pe()){if(zt(n,t),n.t==="js"){let c=String(n.v||"");cn(c);try{new Function("$eq","document","window",c)(fn,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(n.t==="drag"){let c=he(n.from,"source")||R(n.from),l=he(n.to,"destination")||R(n.to);!c&&n.from&&(c=R(I(n.from))),!l&&n.to&&(l=R(I(n.to))),c&&l?await mt(c,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${n.from}' -> '${n.to}')`);return}let o=n.id!==void 0&&n.id!==null?String(n.id):"";!o&&n.t==="val"&&(o=n.target??n.name??n.selector??"1");let i=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,a=i!=null?String(i).trim():"",r=null,s=String(n.name??n.n??"").trim();if(!s&&o&&document.querySelector(`input[type="radio"][name="${$(o)}"]`)&&(s=o),(n.t==="chk"||n.t==="clk")&&s){let c=Array.from(document.querySelectorAll(`input[name="${$(s)}"]`));if(a&&(r=c.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!r&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),p=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||p){let f=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=c.find(d=>{let m=d.value?.toLowerCase()??"";if(f.includes(m))return!0;let h=(d.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return f.some(b=>h===b||h.startsWith(b+" ")||h.startsWith("("+b+")"))})??null}}!r&&c.length>0&&(r=c[0])}if(r||(r=R(o,a,n.t==="val"||n.t==="sel")),!r&&o&&(r=R(I(o),a,n.t==="val"||n.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(I(r.value).toLowerCase()!==I(a).toLowerCase()){let c=document.querySelector(`input[type="radio"][name="${$(r.name)}"][value="${$(a)}" i]`);if(c)r=c;else{let p=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(r.name)}"]`)).find(f=>{let d=f.closest("label, .vf-label, .option-card, tr, td, div");return d&&I(d.textContent).toLowerCase().includes(I(a).toLowerCase())});p&&(r=p)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let c=r.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(c)r=c;else{let p=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(f=>{let d=f.closest("label, .vf-label, .option-card, td, div");return d&&I(d.textContent).toLowerCase().includes(I(a).toLowerCase())});p&&(r=p)}}}if(!r&&(n.t==="val"||n.t==="sel")){let c=document.body;try{c=le()||document.body}catch{}let l=Array.from(c.querySelectorAll(n.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(p=>B(p)&&!K(p));if(l.length===1)r=l[0];else if(l.length>1){let p=I(o).toLowerCase(),f=p.match(/^#?_?([0-9]+)$/);if(f){let d=parseInt(f[1],10);d>=1&&d<=l.length?r=l[d-1]:d>=0&&d<l.length&&(r=l[d])}r||(r=l.find(m=>{let u=(m.getAttribute("placeholder")||"").toLowerCase(),h=(m.name||"").toLowerCase(),b=(m.getAttribute("aria-label")||"").toLowerCase(),y=(m.id||"").toLowerCase(),x=I(Dt(m)).toLowerCase(),A=I(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return u.includes(p)||h.includes(p)||b.includes(p)||y.includes(p)||x&&x.includes(p)||p.length>=2&&A.includes(p)})||(l.length===1?l[0]:null))}}if(!r&&n.t!=="adv"){let c=document.querySelector(".perseus-renderer, .framework-perseus, .perseus-widget-container");if(c){let l=I(o).toLowerCase(),p=Array.from(c.querySelectorAll('.mq-editable-field, [role="radio"], [role="checkbox"], [role="combobox"], input:not([type="hidden"]), textarea, select, [role="button"], [role="option"]')).filter(f=>B(f)&&!K(f));if(r=p.find(f=>{let d=(f.textContent||"").trim().toLowerCase(),m=(f.id||"").toLowerCase(),u=(f.getAttribute("aria-label")||"").toLowerCase(),h=(f.value||f.getAttribute("data-value")||"").toLowerCase();return m===l||d===l||u===l||h===l||l.length>=3&&(d.includes(l)||u.includes(l))})||null,!r&&n.t==="val"&&p.length>0){let f=p.filter(d=>d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement||d.classList.contains("mq-editable-field")||d.classList.contains("mq-root-block")||d.isContentEditable);if(f.length>0){let d=l.match(/^#?_?([0-9]+)$/);if(d){let m=parseInt(d[1],10);r=f[Math.min(m-1,f.length-1)]||f[0]}else r=f[0]}}}}if(!r&&n.t!=="adv")throw new Error(`Alvo '${o}' n\xE3o encontrado no DOM para a\xE7\xE3o '${n.t}'.`);if(!(We()&&r&&n.t!=="js"&&n.t!=="adv"&&await no(n,r,a)))switch(n.t){case"val":if(r){let p=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!p){let h=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');h&&(p=h)}if(!p){let u=r.nextElementSibling;for(;u;){if(u instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(u.type)||u instanceof HTMLTextAreaElement||u instanceof HTMLElement&&u.isContentEditable){p=u;break}let h=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h){p=h;break}u=u.nextElementSibling}}if(!p){let u=document.body;try{u=le()||document.body}catch{}let h=Array.from(u.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(b=>B(b)&&!K(b));h.length>0&&(p=h[0])}let f=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,d=f!=null?String(f):"",m=p||r;if(m instanceof HTMLInputElement){let u=m.type.toLowerCase(),h=m.maxLength,b=m.min,y=m.max,x=m.step,A=m.pattern;if(h>0&&d.length>h&&(d=d.slice(0,h)),u==="number"||u==="range"){let C=parseFloat(d);if(!isNaN(C)){let v=C;if(b!==""&&!isNaN(parseFloat(b))&&(v=Math.max(v,parseFloat(b))),y!==""&&!isNaN(parseFloat(y))&&(v=Math.min(v,parseFloat(y))),x!==""&&x!=="any"&&!isNaN(parseFloat(x))){let w=parseFloat(x),T=b!==""?parseFloat(b):0;v=T+Math.round((v-T)/w)*w,b!==""&&!isNaN(parseFloat(b))&&(v=Math.max(v,parseFloat(b))),y!==""&&!isNaN(parseFloat(y))&&(v=Math.min(v,parseFloat(y)))}d=Number.isInteger(v)?String(v):String(parseFloat(v.toFixed(6)))}}if(A)try{let C=new RegExp(`^(?:${A})$`);if(!C.test(d)){let v=d.match(/-?\d+\.?\d*/);v&&C.test(v[0])&&(d=v[0])}}catch{}}ut(p||r,d)}break;case"chk":let c=n.c!==void 0?!!n.c:!0;r&&Te(r,c);break;case"sel":if(r){let p=Array.isArray(n.v)?n.v:[String(n.v)];pt(r,p)}break;case"clk":if(r)if(!!(r.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let f=n.c!==void 0?!!n.c:!0;Te(r,f)}else ie(r,n.co);break;case"adv":let l=gt(n.id);if(l){await Ft(l,1200);let p=n.id||l.textContent?.trim()||"";p&&Lt(window.location.hostname,{advanceSelector:p}),ie(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function ao(){let n=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(n)).find(t=>{if(!B(t)||K(t)||t.closest("header, nav, aside"))return!1;let o=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||o||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function gt(n){let e=d=>{let m=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return Ae.test(m)};if(n){let d=R(n);if(d&&B(d)&&!K(d)&&!Y(d)&&!e(d))return d}try{let d=kt(window.location.hostname);if(d.advanceSelector){let m=R(d.advanceSelector);if(m&&B(m)&&!K(m)&&!Y(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(t)),i=d=>{let m=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||m||"").trim()},a=d=>{let m=i(d).trim();return/^\d{1,3}$/.test(m)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},r=o.filter(d=>B(d)&&!K(d)&&!d.closest("header, aside")&&!Y(d)&&!e(d));for(let d of r){let m=i(d),u=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Ge.test(m)||Ge.test(u))&&!a(d)&&!Y(d))return d}for(let d of r)if(re(d)&&!Y(d)&&!a(d))return d;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&B(s)&&!K(s)&&!Y(s)&&!e(s))return s;let c=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of c)if(B(d)&&!K(d)&&!e(d)&&!Y(d)&&!a(d))return d;let l=Array.from(document.querySelectorAll('button, [role="button"]')),p=window.innerHeight,f=l.filter(d=>{if(!B(d)||K(d)||e(d)||Y(d)||d.closest("header, nav, aside, .eq-sidebar")||a(d))return!1;let m=d.getBoundingClientRect();return m.top>p*.45&&m.height>=24&&m.width>=24});if(f.length>0)return f.sort((d,m)=>{let u=d.getBoundingClientRect(),h=m.getBoundingClientRect(),b=u.left+u.top;return h.left+h.top-b}),f[0];for(let d of r)if(re(d)&&!Y(d))return d;return null}async function Ft(n,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(n.disabled===!0||n.getAttribute("aria-disabled")==="true"||n.classList.contains("disabled")||n.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function io(){let n=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,o=(document.body?.innerText||document.body?.textContent||"").length;return`${n}|${e}|${t}|${o}`}async function so(n,e=3500){let[t,o,i,a]=n.split("|"),r=parseInt(a||"0",10),s=Date.now();for(;Date.now()-s<e;){let c=window.location.href,l=document.title,p=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),f=(document.body?.innerText||document.body?.textContent||"").length;if(c!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${c}`};if(l!==o)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${o}" \u2192 "${l}"`};if(Math.abs(parseInt(p)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${p}`};if(Math.abs(f-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(f-r)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function ht(n){if(n.t==="js"||n.t==="adv")return;if(n.t==="drag"){let a=R(n.from)||R(I(n.from)),r=R(n.to)||R(I(n.to));a&&r&&await mt(a,r,2);return}let e=n.id||"",t=n.v!==void 0?String(n.v).trim():"",o=R(e,t)||R(I(e),t),i=String(n.name??n.n??"").trim();if(!i&&e&&document.querySelector(`input[type="radio"][name="${$(e)}"]`)&&(i=e),!o&&i){let a=Array.from(document.querySelectorAll(`input[name="${$(i)}"]`));if(t&&(o=a.find(r=>r.value?.toLowerCase()===t.toLowerCase())??null),!o&&t){let r=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),s=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(r||s){let c=r?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];o=a.find(l=>{let p=l.value?.toLowerCase()??"";if(c.includes(p))return!0;let d=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return c.some(m=>d===m||d.startsWith(m+" ")||d.startsWith("("+m+")"))})??null}}!o&&a.length>0&&(o=a[0])}if(n.t==="clk"||n.t==="chk"){if(!o&&e){let r=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=I(e).toLowerCase();o=r.find(c=>{let l=I(c.textContent).toLowerCase();return!!(I(c.value||"").toLowerCase()===s||l===s||l.startsWith(s+")")||l.startsWith("("+s+")")||l.startsWith(s+".")||l.startsWith(s+" - ")||l.startsWith(s+":")||s.length>=3&&l.includes(s))})||null}let a=n.v!==void 0?String(n.v).trim():"";if(o&&a){if(o instanceof HTMLInputElement&&o.type==="radio"&&o.name){if(I(o.value).toLowerCase()!==I(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${$(o.name)}"][value="${$(a)}" i]`);if(r)o=r;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(o.name)}"]`)).find(l=>{let p=l.closest("label, .vf-label, .option-card, tr, td, div");return p&&I(p.textContent).toLowerCase().includes(I(a).toLowerCase())});c&&(o=c)}}}else if(!(o instanceof HTMLInputElement)&&!(o instanceof HTMLSelectElement)&&!(o instanceof HTMLTextAreaElement)){let r=o.querySelector(`input[value="${$(a)}" i], [data-value="${$(a)}" i]`);if(r)o=r;else{let c=Array.from(o.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let p=l.closest("label, .vf-label, .option-card, td, div");return p&&I(p.textContent).toLowerCase().includes(I(a).toLowerCase())});c&&(o=c)}}}if(o){let r=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,s=o instanceof HTMLInputElement&&["radio","checkbox"].includes(o.type)?o:r.querySelector('input[type="radio"], input[type="checkbox"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),c=n.c!==void 0?!!n.c:!0;if(Te(s||r,c),s&&s.checked!==c){try{let l=s._valueTracker;l&&l.setValue(!c)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,c)}catch{}s.checked=c,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(n.t==="val"){let a=null;if(o&&(a=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o.isContentEditable?o:o.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let r=document.body;try{r=le()||document.body}catch{}let s=Array.from(r.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),c=I(e).toLowerCase();a=s.find(l=>{let p=(l.getAttribute("placeholder")||"").toLowerCase(),f=(l.name||"").toLowerCase(),d=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return p.includes(c)||f.includes(c)||d.includes(c)||m.includes(c)})||(s.length>0?s[0]:null)}if(a){let r=String(n.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,r)}}catch{}ut(a,r)}return}if(n.t==="sel"){if(!o&&e){let a=Array.from(document.querySelectorAll("select")),r=I(e).toLowerCase();o=a.find(s=>{let c=(s.name||"").toLowerCase(),l=(s.id||"").toLowerCase(),p=(s.getAttribute("aria-label")||"").toLowerCase();return c.includes(r)||l.includes(r)||p.includes(r)})||null}if(o){let a=Array.isArray(n.v)?n.v:[String(n.v)];pt(o,a)}return}}function me(n){try{if(n.t==="val"){let e=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,t=String(e??"").trim(),o=t,i=n.id!==void 0&&n.id!==null?String(n.id):"";i||(i=n.target??n.name??n.selector??"1");let a=R(i,o,!0)||R(I(i),o,!0);if(!a){let m=document.body;try{m=le()||document.body}catch{}let u=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(h=>B(h)&&!K(h));u.length>0&&(a=u[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let m=document.querySelector(`input[type="radio"][name="${$(r.name)}"]:checked`);if(!m)return!1;let u=I(m.value).toLowerCase(),h=I(t).toLowerCase(),b=I(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===h||b===h||b.includes(h)}let s=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let u=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');u&&(s=u)}if(!s){let m=a.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){s=m;break}let u=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u){s=u;break}m=m.nextElementSibling}}if(s instanceof HTMLSelectElement){let m=I(t).toLowerCase();return Array.from(s.options).some(u=>{if(!u.selected)return!1;let h=u.value.toLowerCase(),b=I(u.textContent).toLowerCase();return m===h||m===b||h.includes(m)||b.includes(m)})}let c=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??a.textContent??"").trim();if(!c&&!t)return!0;if(!c&&t)return!1;let l=c.replace(",",".").replace(/\s+/g,"").toLowerCase(),p=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),f=parseFloat(l),d=parseFloat(p);return!isNaN(f)&&!isNaN(d)&&l.match(/^-?[\d.,]+$/)&&p.match(/^-?[\d.,]+$/)?Math.abs(f-d)<1e-4:l===p||c.toLowerCase()===t.toLowerCase()||p.length>=3&&l===p}if(n.t==="sel"){let e=R(n.id,void 0,!0)||R(I(n.id),void 0,!0);if(!e){let a=document.body;try{a=le()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>B(l)&&!K(l)),s=I(n.id).toLowerCase();e=r.find(l=>{let p=(l.id||"").toLowerCase(),f=(l.getAttribute("name")||"").toLowerCase(),d=(l.getAttribute("aria-label")||"").toLowerCase(),m=I(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return p.includes(s)||f.includes(s)||d.includes(s)||s.length>=2&&m.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let s=(Array.isArray(n.v)?n.v:[String(n.v)]).map(l=>I(l).toLowerCase()),c=I(a.textContent).toLowerCase();return s.some(l=>c.includes(l)||l.includes(c))}return!1}let i=(Array.isArray(n.v)?n.v:[String(n.v)]).map(a=>I(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),s=I(a.textContent).toLowerCase();return i.some(c=>c===r||c===s||r.includes(c)||s.includes(c))})}if(n.t==="chk"||n.t==="clk"){let e=n.v!==void 0?String(n.v).trim():"",t=String(n.name??n.n??"").trim();if(t&&!n.id){let d=Array.from(document.querySelectorAll(`input[name="${$(t)}"]`));if(d.length>0){let m=d.find(x=>x.checked);if(!m)return!1;if(!e)return!0;let u=m.value?.toLowerCase()??"",h=e.toLowerCase();if(u===h)return!0;let b=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),y=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return b?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(u):y?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(u):!1}}let o=R(n.id,e)||R(I(n.id),e);if(!o&&t){let d=document.querySelector(`input[name="${$(t)}"]`);d&&(o=d)}if(!o)return!1;let i=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:i.querySelector('input[type="checkbox"], input[type="radio"]')||(i.getAttribute("for")?i.ownerDocument.getElementById(i.getAttribute("for")):null),r=n.t==="chk"||n.c!==void 0?!!n.c:!0;if(a&&a.type==="radio"){if(a.checked===r)return!0;if(n.v&&a.name){let d=I(String(n.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${$(a.name)}"]:checked`);if(!m)return!1;if(m===a)return!0;let u=I(m.value).toLowerCase(),h=I(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return u===d||h.includes(d)||d.includes(u)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===r;let s=i.getAttribute("aria-checked")===String(r)||i.getAttribute("aria-selected")===String(r)||i.getAttribute("aria-pressed")===String(r),c=r?i.getAttribute("data-selected")==="true"||i.getAttribute("data-checked")==="true"||i.getAttribute("data-active")==="true"||i.getAttribute("data-state")==="checked"||i.getAttribute("data-state")==="on":i.getAttribute("data-selected")==="false"||i.getAttribute("data-checked")==="false"||i.getAttribute("data-state")==="unchecked",l=i.className||"",p=r?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(s||c||p)return!0;let f=!!i.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return n.t==="clk"&&!a&&!f||i.getAttribute("aria-expanded")!==null||i.getAttribute("aria-pressed")!==null}if(n.t==="drag"){let e=he(n.from,"source")||R(n.from)||R(I(n.from)),t=he(n.to,"destination")||R(n.to)||R(I(n.to));return!e||!t?!1:to(e,t).success}}catch{}return!1}async function Ze(n,e,t=1,o=Pe({engine:"smart",autoAdvance:e})){let i=n.actions.filter(E=>E.t!=="adv"),a=n.actions.filter(E=>E.t==="adv"),r=0,s=[],c=new Map,l=new Map,p=new Map,f=new Set,d=n.pageType==="question"||i.length>0,m=i.filter(E=>E.t==="chk"||E.t==="clk"&&E.c!==void 0),u=new Map;for(let E of i){let H=[];l.set(E,H);try{if(E.t==="drag"){H.push("declarative-A-F");try{let z=he(E.from,"source")||R(E.from),k=he(E.to,"destination")||R(E.to);z&&p.set(E,z.parentElement?.outerHTML?.slice(0,500)||""),k&&u.set(E,k.children.length)}catch{}}else H.push("declarative-primary");await oo(E,t,o),r++,f.add(E)}catch(z){c.set(E,z instanceof Error?z.message:String(z)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",E,z)}await new Promise(z=>setTimeout(z,E.t==="drag"?180:35))}if(d&&n.mode==="escolha_multipla"&&m.length>0){let E=document.body;try{E=le()||document.body}catch{}let H=Array.from(E.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(z=>B(z)&&!K(z));if(H.length>1){let k=function(P,j){if(P===j||P.contains(j)||j.contains(P))return!0;let Q=P.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),F=j.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(Q&&F&&Q===F)return!0;let G=P.getAttribute("for")||P.id,W=j.getAttribute("for")||j.id;return!!(G&&W&&G===W)};var q=k;let z=new Set;for(let P of m){let j=P.t==="chk"?!!P.c:!!(P.c??!0),Q="id"in P&&typeof P.id=="string"?P.id:"";if(j&&Q){let F=R(Q,P.v);if(F){z.add(F);let G=F.querySelector('input[type="checkbox"]');G&&z.add(G);let W=F.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');W&&(z.add(W),W.querySelectorAll('input[type="checkbox"]').forEach(te=>z.add(te)))}}}if(z.size>=m.length&&z.size>0){let P=Array.from(z);for(let j of H)P.some(F=>k(F,j))||(j instanceof HTMLInputElement&&j.checked||j.getAttribute("aria-checked")==="true"||j.closest(".option-card, label")?.classList.contains("selected"))&&Te(j,!1)}}}await new Promise(E=>setTimeout(E,i.length>0?100:25));let h=0;for(let E of i){if(me(E)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${E.t}' no alvo '${E.id||E.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{zt(E,o),l.get(E)?.push("alternative-path"),await ht(E)}catch(H){c.set(E,H instanceof Error?H.message:String(H)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",H)}await new Promise(H=>setTimeout(H,250)),me(E)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++,f.has(E)?c.has(E)&&c.delete(E):(c.delete(E),r++,f.add(E)))}if(h<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-h} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(E=>setTimeout(E,200));for(let E of i)if(!me(E))try{if(await ht(E),await new Promise(H=>setTimeout(H,80)),!me(E)&&(E.t==="clk"||E.t==="chk"))try{let H="id"in E?String(E.id||""):"",z=E.v!==void 0?String(E.v).trim():"",k=R(H,z)||R(I(H),z);k&&(Ut(k),await new Promise(P=>setTimeout(P,120)))}catch{}}catch(H){c.set(E,H instanceof Error?H.message:String(H))}await new Promise(E=>setTimeout(E,200)),h=0;for(let E of i)me(E)&&(h++,f.has(E)?c.has(E)&&c.delete(E):(c.delete(E),r++,f.add(E)))}let b=[];for(let[E,H]of i.entries())if(!me(H)){let z=H.t==="drag"?`${H.from} -> ${H.to}`:"id"in H&&H.id?H.id:H.t;s.push(z),b.push({actionIndex:E,action:H,strategiesAttempted:l.get(H)||[],evidence:c.get(H)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:p.get(H)}),H.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${H.from}" -> "${H.to}"`,`
  Estrat\xE9gias: ${(l.get(H)||[]).join(", ")}`,`
  Snapshot DOM: ${p.get(H)?.slice(0,200)||"n/a"}`)}d&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let y=i.map((E,H)=>{let z=E.t==="drag"?`${E.from} -> ${E.to}`:E.t==="js"?"$eq":E.id||E.t,k=E.t==="js"?!0:E.t==="drag"?!!(he(E.from,"source")&&he(E.to,"destination")):!!(R(E.id||"")||R(I(E.id||""))),P=me(E);return{index:H,action:E,target:z,located:k,applied:!c.has(E),verified:P,strategy:E.t==="drag"?"drag-adaptive":E.t==="js"?"javascript":"declarative-dom",evidence:P?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(E)?{error:c.get(E)}:{}}}),x=d?i.length>0&&s.length===0&&(h===i.length||r===i.length&&h>0):!0,A=!1,C=!1,v="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",w=d?h>0&&h>=Math.ceil(i.length/2):r>0&&r>=i.length/2,T=d?h>0&&(x||w):x||i.length===0||w;if(e&&T){await new Promise(z=>setTimeout(z,i.length>0?120:40));let E=!1,H=null;if(n.pageType!=="info"){let z=ao();if(z&&B(z)){await Ft(z,1200),ie(z),E=!0,H=z,await new Promise(j=>setTimeout(j,350));let k=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');k&&B(k)&&(k.textContent||"").trim().length>0?(A=!1,C=!1,v=`Aviso do formul\xE1rio ap\xF3s checagem: ${k.textContent?.trim().slice(0,100)}`):(A=!0,C=!0,v="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!E){let z=io(),k=a.length>0&&"id"in a[0]?a[0].id:void 0,P=gt(k);if(P){await Ft(P,1500);let j=k||P.textContent?.trim()||"";j&&Lt(window.location.hostname,{advanceSelector:j}),ie(P);let Q=await so(z,1800);C=Q.changed,v=Q.evidence,A=Q.changed||!0,Q.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:h,success:x,advanced:A,failed:s,reports:y,navigationVerified:C,navigationEvidence:v,failedActions:b}}var fe=null,ze=[],Xt=[],$e=[],Vt=[],be=null,ge=null,ro=`
...
`;function bn(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=ro,document.head.appendChild(n)}}catch{}}function qe(){fe&&(fe.style.removeProperty("outline"),fe.style.removeProperty("outline-offset"),fe.style.removeProperty("position"),fe=null);for(let n of ze)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");ze=[];for(let n of Xt)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");Xt=[];for(let n of $e)try{n.remove()}catch{}$e=[],ge&&typeof window<"u"&&(window.removeEventListener("scroll",ge),window.removeEventListener("resize",ge),ge=null);for(let n of Vt)try{n.remove()}catch{}if(Vt=[],be){try{be.remove()}catch{}be=null}try{document.querySelectorAll("[data-easyquiz-image-frame]").forEach(n=>{try{n.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-capture-badge]").forEach(n=>{try{n.remove()}catch{}}),document.querySelectorAll("[data-easyquiz-image-highlight]").forEach(n=>{try{let e=n;e.style.removeProperty("animation"),e.style.removeProperty("outline"),e.style.removeProperty("outline-offset"),e.style.removeProperty("box-shadow"),e.style.removeProperty("filter"),e.removeAttribute("data-easyquiz-image-highlight")}catch{}})}catch{}}function Kt(n){bn();let e=[];for(let t of n){if(!t||typeof t.setAttribute!="function")continue;let o=t;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),Xt.push(o)}catch{}try{let i=t.getBoundingClientRect(),a=i.width||t.offsetWidth||280,r=i.height||t.offsetHeight||200;if(a>10&&r>10){let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
          position: absolute;
        ...
        `,s.appendChild(c),document.body.appendChild(s),$e.push(s),Vt.push(c),e.push({element:t,frame:s})}}catch{}}e.length>0&&!ge&&typeof window<"u"&&(ge=()=>{for(let t=e.length-1;t>=0;t--){let o=e[t];try{if(!document.contains(o.element)){try{o.frame.remove()}catch{}let a=$e.indexOf(o.frame);a!==-1&&$e.splice(a,1),e.splice(t,1);continue}let i=o.element.getBoundingClientRect();i.width>0&&i.height>0?(o.frame.style.top=`${i.top+window.scrollY-3}px`,o.frame.style.left=`${i.left+window.scrollX-3}px`,o.frame.style.width=`${i.width+6}px`,o.frame.style.height=`${i.height+6}px`):o.frame.style.display="none"}catch{}}e.length===0&&ge&&(window.removeEventListener("scroll",ge),window.removeEventListener("resize",ge),ge=null)},window.addEventListener("scroll",ge,{passive:!0}),window.addEventListener("resize",ge,{passive:!0}))}function _e(n){fe&&fe!==n&&(fe.style.removeProperty("outline"),fe.style.removeProperty("outline-offset")),bn(),fe=n,n.style.outline="2px solid #00e5ff",n.style.outlineOffset="4px";try{if(be){try{be.remove()}catch{}be=null}window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,n.appendChild(t),be=t}catch{}}function lo(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function yn(n,e){if(be){try{be.remove()}catch{}be=null}let t=lo(e);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let m=R(o.from),u=R(o.to);m&&(m.style.outline=`2px solid ${t.outline}`,ze.push(m)),u&&(u.style.outline="2px dashed #00e5ff",ze.push(u))}catch{}continue}let i=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${$(a)}"]`));if(i&&(r=m.find(u=>u.value?.toLowerCase()===i.toLowerCase())??null,!r)){let u=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(i),h=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(i);if(u||h){let b=u?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=m.find(y=>{let x=y.value?.toLowerCase()??"";if(b.includes(x))return!0;let C=(y.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(v=>C===v||C.startsWith(v+" ")||C.startsWith("("+v+")"))})??null}}!r&&m.length>0&&(r=m[0])}if(!r&&o.id&&(r=R(o.id,i,o.t==="val"||o.t==="sel")||R(I(o.id),i,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let m=document.body;try{m=le()||document.body}catch{}let u=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(y=>B(y)&&!ue(y)),h=I(o.id).toLowerCase();r=u.find(y=>{let x=(y.id||"").toLowerCase(),A=(y.getAttribute("name")||"").toLowerCase(),C=(y.getAttribute("aria-label")||"").toLowerCase(),v=I(y.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return x.includes(h)||A.includes(h)||C.includes(h)||h.length>=2&&v.includes(h)})||(u.length===1?u[0]:null)}if(!r)continue;let s=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",c=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=s?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,p=c||l||r;p.style.outline=`2px solid ${t.outline}`,p.style.outlineOffset="2px",p.style.backgroundColor=t.bg,p.setAttribute("data-easyquiz-highlight","true"),ze.push(p);let f=s?r:p.querySelector('select, [role="combobox"], [role="listbox"]');f&&(f.style.outline=`2px solid ${t.outline}`,f.style.outlineOffset="2px",f.style.boxShadow=`0 0 10px ${t.glow}`,f.setAttribute("data-easyquiz-highlight","true"),ze.push(f));let d=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:p.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==p&&(d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${t.glow}`,d.setAttribute("data-easyquiz-highlight","true"),ze.push(d))}}var ft=10,co=1400,et=15e5;function ve(n){return new Promise((e,t)=>{let o=new FileReader;o.onerror=()=>t(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(n)})}function vn(n){try{let e=n.getContext("2d");if(!e)return!0;let t=n.width,o=n.height;if(t<=0||o<=0)return!0;let i=Math.min(40,Math.floor(t/3),Math.floor(o/3));if(i<=0)return!0;let a=[[0,0],[Math.floor(t/2)-Math.floor(i/2),Math.floor(o/2)-Math.floor(i/2)],[Math.floor(t/3),Math.floor(o*2/3)]],r=0,s=0,c=-1,l=-1,p=-1;for(let[f,d]of a){let m=Math.max(0,Math.min(f,t-i)),u=Math.max(0,Math.min(d,o-i)),h=e.getImageData(m,u,i,i).data;for(let b=0;b<h.length;b+=4){r++;let y=h[b],x=h[b+1],A=h[b+2];if(h[b+3]===0){s++;continue}c===-1&&(c=y,l=x,p=A),Math.abs(y-c)<8&&Math.abs(x-l)<8&&Math.abs(A-p)<8&&s++}}return r>0&&s/r>.97}catch{return!1}}function xn(n){try{let e=n.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/);if(e){let[t,o,i]=[parseInt(e[1]),parseInt(e[2]),parseInt(e[3])];if((.299*t+.587*o+.114*i)/255<.15)return"#ffffff"}if(n==="transparent"||n==="rgba(0, 0, 0, 0)")return"#ffffff"}catch{}return n}async function ke(n){let e=0,t=0;if(n instanceof HTMLImageElement?(e=n.naturalWidth||n.width,t=n.naturalHeight||n.height):(e=n.width,t=n.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,co/Math.max(e,t)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(t*o)),r=document.createElement("canvas");r.width=i,r.height=a;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,a),s.drawImage(n,0,0,i,a),new Promise((c,l)=>{r.toBlob(p=>p?c(p):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function An(n){let e=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=e.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(o*i))),s=n.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.getAttribute("xmlns:xlink")||s.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),s.setAttribute("width",String(a)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&o>0&&s.setAttribute("viewBox",`0 0 ${t} ${o}`);try{let d=Array.from(n.querySelectorAll("*")),m=Array.from(s.querySelectorAll("*"));for(let u=0;u<Math.min(d.length,m.length);u++){let h=d[u],b=m[u];if(!h||!b||!b.style)continue;let y=window.getComputedStyle?window.getComputedStyle(h):null;y&&(y.fill&&y.fill!=="none"&&(b.style.fill=y.fill),y.stroke&&y.stroke!=="none"&&(b.style.stroke=y.stroke),y.strokeWidth&&(b.style.strokeWidth=y.strokeWidth),y.fontFamily&&(b.style.fontFamily=y.fontFamily),y.fontSize&&(b.style.fontSize=y.fontSize),y.fontWeight&&(b.style.fontWeight=y.fontWeight),y.color&&(b.style.color=y.color))}}catch{}let c="#ffffff";try{let d=n.parentElement||n;for(;d&&d!==document.documentElement;){let u=(window.getComputedStyle?window.getComputedStyle(d):null)?.backgroundColor;if(u&&u!=="transparent"&&u!=="rgba(0, 0, 0, 0)"){c=u;break}d=d.parentElement}}catch{}c=xn(c);let p=new XMLSerializer().serializeToString(s),f="";try{f=btoa(unescape(encodeURIComponent(p)))}catch{}try{let d=b=>new Promise((y,x)=>{let A=new Image,C=setTimeout(()=>x(new Error("Timeout render SVG")),1200);A.onload=()=>{clearTimeout(C),y(A)},A.onerror=()=>{clearTimeout(C),x(new Error("Falha ao renderizar SVG em Image."))},A.src=b}),m=null;if(f)try{m=await d(`data:image/svg+xml;base64,${f}`)}catch{}if(!m){let b=new Blob([p],{type:"image/svg+xml;charset=utf-8"}),y=URL.createObjectURL(b);try{m=await d(y)}finally{URL.revokeObjectURL(y)}}let u=document.createElement("canvas");u.width=a,u.height=r;let h=u.getContext("2d",{alpha:!1});if(h&&m){if(h.fillStyle=c,h.fillRect(0,0,a,r),h.drawImage(m,0,0,a,r),vn(u))return{base64:f,mediaType:"image/svg+xml"};let b=await new Promise(y=>{u.toBlob(y,"image/jpeg",.92)});if(b){let y=await ve(b);if(y)return{blob:b,base64:y,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function bt(n){try{let e=n.getBoundingClientRect(),t=Math.round(e.width)||n.offsetWidth||400,o=Math.round(e.height)||n.offsetHeight||300;if(t<30||o<30)return null;let i=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(i&&n.querySelectorAll("input, select, textarea").length===0)try{let h=await An(i);if(h.base64&&h.base64.length<=et)return{mediaType:h.mediaType,base64:h.base64,alt:n.getAttribute("aria-label")||i.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:ye(i)}}catch{}if(n instanceof HTMLCanvasElement)try{let h=await ke(n),b=await ve(h);if(b)return{mediaType:"image/jpeg",base64:b,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let h=n;for(;h&&h!==document.documentElement;){let y=(window.getComputedStyle?window.getComputedStyle(h):null)?.backgroundColor;if(y&&y!=="transparent"&&y!=="rgba(0, 0, 0, 0)"){a=y;break}h=h.parentElement}}catch{}a=xn(a);let r=n.cloneNode(!0),s=Array.from(n.querySelectorAll("*")),c=Array.from(r.querySelectorAll("*"));for(let h=0;h<Math.min(s.length,c.length);h++){let b=s[h],y=c[h];if(!(!b||!y||!y.style))try{let x=window.getComputedStyle(b);y.style.color=x.color,y.style.backgroundColor=x.backgroundColor,y.style.borderColor=x.borderColor,y.style.borderWidth=x.borderWidth,y.style.borderStyle=x.borderStyle,y.style.fontSize=x.fontSize,y.style.fontFamily=x.fontFamily,y.style.fontWeight=x.fontWeight,y.style.lineHeight=x.lineHeight,y.style.letterSpacing=x.letterSpacing,y.style.textAlign=x.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,o))),p=Math.round(t*l),f=Math.round(o*l),d=`
...
`;var Le="v3.6.0";var En=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:n=>n})}catch{}return null})();function fo(n,e){try{if(En){n.innerHTML=En.createHTML(e);return}}catch{}try{if(typeof n.setHTMLUnsafe=="function"){n.setHTMLUnsafe(e);return}}catch{}n.innerHTML=e}var bo=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],yo=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],At=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_wallpaperRAF=0;_wlpWhiteLogo=null;_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;keyContextMenu;_ctxPopup=null;_ctxCloseH=null;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new vt({onStatusChange:(s,c,l)=>{this.logToConsole(c,l),s==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):s==="advancing"||s==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):s==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),c.includes("conclus\xE3o")||c.includes("finalizada")||c.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):s==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(s,c)=>{try{return await this.callbacks.onAnalyze(s,c,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),fo(this.shadow,`
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new xt(this.shadow,()=>{this.callbacks.onAnalyze(1)});let o=this.shadow.querySelector("#eq-open-hud-btn");o&&o.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),Oe.filter(s=>ce(s.id)).forEach(s=>this.modelSelect.add(new Option(s.name,s.id,!1,s.id===e.model))),bo.forEach(s=>this.modeSelect.add(new Option(s.label,s.value,!1,s.value===e.modeHint))),yo.forEach(s=>this.engineSelect.add(new Option(s.label,s.value,!1,s.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let i=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];X.init(i),this.apiKeyInput.value=X.getBestKey()||e.apiKey||"",this.renderKeysList();let a=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof a?.unref=="function"&&a.unref();let r=X.getBestKey()||e.apiKey;r&&it(r).then(s=>{s&&s.length>0&&this.updateModelSelect(s,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];this.shadow.querySelector(".eq-views-wrapper")?.classList.toggle("is-brain-active",e==="brain");for(let i of t){let a=this.shadow.querySelector(`#eq-tab-${i}`),r=this.shadow.querySelector(`#eq-view-${i}`),s=i===e;a?.classList.toggle("active",s),r&&(r.style.display=s?"flex":"none")}switch(this.updateContextBar(e),e){case"brain":this.initBrainControls(),this.renderContextTree(),this.refreshInspectorView();break;case"metrics":try{this.updateTimingMetrics()}catch{}break;case"debug":this.terminalMode="terminal";try{this.refreshDebugView(),this.renderTerminalEntries(),this.initTerminalREPL(),this.initTerminalWallpaper()}catch{}break;case"settings":break}}updateContextBar(e){let t=this.shadow.querySelector("#eq-ctxbar-icon"),o=this.shadow.querySelector("#eq-ctxbar-name"),i=this.shadow.querySelector("#eq-ctxbar-sub"),a=this.shadow.querySelector("#eq-ctxbar-actions");if(!t||!o||!i||!a)return;a.innerHTML="";let s={resolver:{icon:L.sparkles,label:"Resolver",sub:"Autopilot & opera\xE7\xF5es",color:"#a78bfa",actions:()=>{let c=document.createElement("span");return c.id="eq-ctxbar-status",c.style.cssText="font-size:9px;font-weight:700;padding:2px 7px;border-radius:10px;background:rgba(167,139,250,0.13);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;letter-spacing:0.04em;",c.textContent="PRONTO",[c]}},brain:{icon:L.inspector,label:"C\xE9rebro da IA",sub:"Contexto & inspe\xE7\xE3o",color:"#60a5fa",actions:()=>{let c=this.shadow.querySelector("#eq-brain-canvas-toggle"),l=document.createElement("button");l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",l.innerHTML=this.brainCanvasHidden?L.eyeOff:L.eye,l.title="Mostrar/Ocultar canvas",l.addEventListener("click",()=>{c?.click(),l.innerHTML=this.brainCanvasHidden?L.eyeOff:L.eye});let p=document.createElement("button");return p.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",p.innerHTML=L.copy,p.title="Copiar conte\xFAdo selecionado",p.addEventListener("click",()=>this.smartCopy()),[l,p]}},metrics:{icon:L.clock,label:"M\xE9tricas",sub:"Cron\xF4metro & hist\xF3rico",color:"#4ade80",actions:()=>{let c=document.createElement("button");c.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",c.innerHTML=L.copy,c.title="Copiar relat\xF3rio",c.addEventListener("click",()=>this.copyMetricsReport());let l=document.createElement("button");return l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.07);border:1px solid rgba(255,85,85,0.13);border-radius:4px;cursor:pointer;color:#ff5555;",l.innerHTML=L.trash,l.title="Zerar m\xE9tricas",l.addEventListener("click",()=>{this.shadow.querySelector("#eq-metrics-reset-btn")?.click()}),[c,l]}},debug:{icon:L.code,label:"Terminal",sub:"Comandos & logs",color:"#0098ff",actions:()=>{let c=document.createElement("div");c.style.cssText="display:inline-flex;align-items:center;gap:1px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:2px;";let l=(d,m,u)=>{let h=document.createElement("button");return h.id=d,h.type="button",h.textContent=m,h.style.cssText="font-size:9px;font-weight:600;padding:2px 8px;border-radius:3px;cursor:pointer;transition:all 0.1s;background:"+(u?"#1a1a1a":"transparent")+";border:1px solid "+(u?"#333":"transparent")+";color:"+(u?"#ddd":"#555")+";",h};c.appendChild(l("eq-term-mode-terminal","Terminal",!0)),c.appendChild(l("eq-term-mode-output","Output",!1));let p=document.createElement("button");p.id="eq-term-copy-btn",p.type="button",p.title="Copiar",p.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",p.innerHTML=L.copy;let f=document.createElement("button");return f.id="eq-term-clear-btn",f.type="button",f.title="Limpar",f.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.07);border:1px solid rgba(255,85,85,0.13);border-radius:4px;cursor:pointer;color:#ff5555;",f.innerHTML=L.trash,[c,p,f]}},settings:{icon:L.settings,label:"Configura\xE7\xF5es",sub:"Ajustes & prefer\xEAncias",color:"#fbbf24"}}[e];if(s&&(t.innerHTML=s.icon,t.style.color=s.color,o.textContent=s.label,o.style.color=s.color==="#a78bfa"?"#ccc":"#ddd",i.textContent=s.sub,s.actions))for(let c of s.actions())a.appendChild(c)}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let v=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!v))}),this.metricsResetBtn?.addEventListener("click",()=>{Ue(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let v=this.getFormattedLogs();navigator.clipboard.writeText(v).then(()=>{let w=t.innerHTML;t.innerHTML=L.check,setTimeout(()=>t.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let o=this.shadow.querySelector("#eq-dbg-copy-prompt");o?.addEventListener("click",()=>{let v=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(v).then(()=>{let w=o.innerHTML;o.innerHTML=`${L.check} Copiado!`,setTimeout(()=>o.innerHTML=w,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-context");i?.addEventListener("click",()=>{let v=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let w=i.innerHTML;i.innerHTML=`${L.check} Copiado!`,setTimeout(()=>i.innerHTML=w,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-raw-resp");a?.addEventListener("click",()=>{let v=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let w=a.innerHTML;a.innerHTML=`${L.check} Copiado!`,setTimeout(()=>a.innerHTML=w,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-error-btn");r?.addEventListener("click",()=>{let v=this.lastErrorMsg||"";navigator.clipboard.writeText(v).then(()=>{let w=r.innerHTML;r.innerHTML=L.check,setTimeout(()=>r.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",v=>{v.altKey&&(v.key==="q"||v.key==="Q"||v.key==="a"||v.key==="A")&&(v.preventDefault(),this.toggle())},!0);let s=v=>{let w=v.composedPath();w.includes(this.shadow)||(w.includes(this.sidebarEl)||w.includes(this.host))&&v.stopImmediatePropagation()};window.addEventListener("keydown",s,!0),window.addEventListener("keyup",s,!0),window.addEventListener("keypress",s,!0),this.apiKeyInput.addEventListener("input",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:v})});let c=this.shadow.querySelector("#eq-keys-collapsible"),l=this.shadow.querySelector("#eq-keys-chevron"),p=this.shadow.querySelector("#eq-keys-section-header"),f=v=>{c&&(v?(c.style.display="none",l&&(l.style.transform="rotate(0deg)")):(c.style.display="block",c.style.maxHeight="none",c.style.overflow="visible",l&&(l.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}f(d),p?.addEventListener("click",v=>{if(v.target?.closest("a"))return;let w=c?.style.display==="none";f(!w);try{localStorage.setItem("easyquiz_keys_collapsed",w?"false":"true")}catch{}});let m=this.shadow.querySelector("#eq-auto-menu-btn"),u=this.shadow.querySelector("#eq-auto-menu");u&&(u.hidden=!0),m?.classList.remove("is-open"),m?.addEventListener("click",v=>{if(v.stopPropagation(),!!u){if(this._ctxPopup){this.closeCtxPopup(),m.classList.remove("is-open");return}m.classList.add("is-open"),this.showCtxPopup(m,[{ic:"sparkles",label:"Resolver Autopilot",onClick:()=>{m.classList.remove("is-open"),u.querySelector('[data-auto-action="toggle"]')?.click()}},{ic:"eraser",label:"Limpar mem\xF3ria",onClick:()=>{m.classList.remove("is-open"),u.querySelector('[data-auto-action="memory"]')?.click()}},{ic:"info",label:"Mostrar status",onClick:()=>{m.classList.remove("is-open"),u.querySelector('[data-auto-action="status"]')?.click()}}])}}),u?.querySelectorAll("[data-auto-action]").forEach(v=>{v.addEventListener("click",w=>{w.stopPropagation();let T=v.dataset.autoAction;T==="toggle"?this.analyzeBtn?.click():T==="memory"?(ot(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):T==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),u&&(u.hidden=!0),m?.classList.remove("is-open")})}),this.shadow.addEventListener("click",v=>{v.target.closest(".eq-menu-shell")||(u&&(u.hidden=!0),m?.classList.remove("is-open"))});let h=this.shadow.querySelector("#eq-result-toggle"),b=this.shadow.querySelector("#eq-result-body");h&&b&&(b.classList.add("is-collapsed"),h.classList.remove("is-open"),h.addEventListener("click",()=>{let v=h.classList.toggle("is-open");b.classList.toggle("is-collapsed",!v)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!v){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let w=X.addKey(v);if(w.ok){let T=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${T.length} chaves ativas no pool)`,"success"),f(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,st(v).then(q=>{q.ok?(X.markSuccess(v,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(X.markInvalid(v,q.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${q.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(w.message,"warning")}),this.keyMoreBtn.addEventListener("click",v=>{if(v.stopPropagation(),this._ctxPopup){this.closeCtxPopup();return}let w=T=>this.shadow.querySelector(T);this.showCtxPopup(this.keyMoreBtn,[{ic:"edit",label:"Inserir via Janela Nativa",badge:"Bypass",onClick:()=>w("#eq-menu-prompt")?.click()},{ic:"paste",label:"Colar da \xC1rea de Transfer\xEAncia",onClick:()=>w("#eq-menu-paste")?.click()},{ic:"eye",label:"Mostrar/Ocultar Campo",onClick:()=>w("#eq-menu-toggle-vis")?.click()},{ic:"eraser",label:"Limpar Campo",onClick:()=>w("#eq-menu-clear")?.click()},{ic:"upload",label:"Importar Chaves em Lote",onClick:()=>w("#eq-menu-bulk")?.click()},{ic:"code",label:"Ver/Editar Chaves como Texto",onClick:()=>w("#eq-menu-edit-text")?.click()},{ic:"zap",label:"Testar Todas as Chaves",onClick:()=>w("#eq-menu-test")?.click()},{divider:!0,label:"",onClick:()=>{}},{ic:"trash",label:"Apagar Todas as Chaves",danger:!0,onClick:()=>w("#eq-menu-delete-all")?.click()},{ic:"refreshCw",label:"Resetar Todos os Dados",danger:!0,onClick:()=>w("#eq-menu-reset")?.click()}])}),this.shadow.addEventListener("click",v=>{let w=v.target;!w.closest("#eq-key-context-menu")&&!w.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(v!==null&&v.trim()){let w=v.trim().replace(/^["']|["']$/g,""),T=X.addKey(w);if(T.ok){let q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:q[0],apiKeys:q}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(T.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let v=await navigator.clipboard.readText();if(v){let w=v.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=w,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let v=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(v!==null&&v.trim()){let w=v.trim().replace(/^["']|["']$/g,"");if(X.addKey(w).ok){let q=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:q[0],apiKeys:q}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=this.apiKeyInput.type==="password";this.apiKeyInput.type=v?"text":"password";let w=this.shadow.querySelector("#eq-menu-vis-icon"),T=this.shadow.querySelector("#eq-menu-vis-text");w&&(w.innerHTML=v?L.eyeOff:L.eye),T&&(T.textContent=v?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let v=document.createElement("div");v.id="eq-bulk-overlay",v.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let w=document.createElement("div");w.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),w.innerHTML=`
      ...
      `,v.appendChild(w),this.shadow.appendChild(v);let T=w.querySelector("#eq-bulk-ta"),q=w.querySelector("#eq-bulk-status"),E=w.querySelector("#eq-bulk-import"),H=w.querySelector("#eq-bulk-paste-btn"),z=w.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>T?.focus());let k=()=>{v.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(P=>{v.addEventListener(P,j=>{j.stopPropagation(),j.stopImmediatePropagation()},!0)}),v.addEventListener("keydown",P=>{P.key==="Escape"&&k()}),v.addEventListener("click",P=>{P.target===v&&k()}),w.querySelector("#eq-bulk-x")?.addEventListener("click",k),w.querySelector("#eq-bulk-cancel")?.addEventListener("click",k),z.addEventListener("click",()=>{T.value="",q.textContent="",T.focus()}),H.addEventListener("click",async()=>{try{let P=await navigator.clipboard?.readText();P?(T.value=P,T.focus(),q.style.color="#38bdf8",q.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(q.style.color="#fbbf24",q.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{q.style.color="#fbbf24",q.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",T.focus()}}),w.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let P=T.value.trim();if(!P){q.style.color="#f87171",q.textContent="Insira pelo menos uma chave de API antes de importar.";return}let j=P.match(/AIza[0-9A-Za-z\-_]{35}/g),Q=[];if(j&&j.length>0?Q=Array.from(new Set(j)):Q=Array.from(new Set(P.split(/[\n,;\s]+/).map(ne=>ne.trim().replace(/^["'`]|["'`]$/g,"")).filter(ne=>ne.length>=20))),Q.length===0){q.style.color="#f87171",q.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}q.style.color="#00e5ff",q.textContent=`Processando ${Q.length} chave(s)...`,E.disabled=!0,E.style.opacity="0.6";let F=0,G=0;for(let ne of Q){let _=X.addKey(ne);_.ok?F++:_.message.includes("j\xE1 est\xE1 cadastrada")&&G++}if(F>0){let ne=X.exportRawKeys();this.callbacks.onSettingsChange({apiKey:ne[0],apiKeys:ne}),f(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}q.textContent=`${F} adicionada(s), ${G} duplicada(s). Validando modelo em paralelo...`;let W=X.exportRawKeys(),te=this.modelSelect?.value||"gemini-3.5-flash-lite",ee=await Ht(te,W);ee.ok?(X.markSuccess(ee.key,200),q.style.color="#4ade80",q.textContent=` ${F} adicionada(s), ${G} duplicada(s). Modelo '${ee.model}' pronto!`):(q.style.color="#fbbf24",q.textContent=`${F} adicionada(s), ${G} duplicada(s). Aviso: ${ee.message}`),this.renderKeysList(),E.disabled=!1,E.style.opacity="1",F>0&&(this.setStatus(` Lote importado: ${F} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(k,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let v=X.exportRawKeys(),w=document.createElement("div");w.id="eq-text-editor-overlay",w.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let T=document.createElement("div");T.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),T.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
