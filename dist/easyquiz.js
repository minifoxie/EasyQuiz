...
[MEM\xD3RIA]:
${c.join(" | ")}
`:"",p=o.controls.filter(g=>g.role!=="navigation"),f=o.controls.filter(g=>g.role==="navigation"),v=to(o.sourceUrl,o.htmlSnippet),h=v?`
${v}
`:"";return`--- AN\xC1LISE ---
...
`;function jt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=Co,document.head.appendChild(o)}}catch{}}function me(){ae&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset"),ae.style.removeProperty("position"),ae=null);for(let o of ye)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ye=[];for(let o of mt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");mt=[];for(let o of ht)try{o.remove()}catch{}ht=[],pe&&typeof window<"u"&&(window.removeEventListener("scroll",pe),window.removeEventListener("resize",pe),pe=null);for(let o of gt)try{o.remove()}catch{}if(gt=[],ne){try{ne.remove()}catch{}ne=null}}function ft(o){jt();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),mt.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,s=r.height||t.offsetHeight||200;if(n>10&&s>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(d),document.body.appendChild(i),ht.push(i),gt.push(d),e.push({element:t,frame:i})}}catch{}}e.length>0&&!pe&&typeof window<"u"&&(pe=()=>{for(let t of e)try{let a=t.element.getBoundingClientRect();a.width>0&&a.height>0&&(t.frame.style.top=`${a.top+window.scrollY-3}px`,t.frame.style.left=`${a.left+window.scrollX-3}px`,t.frame.style.width=`${a.width+6}px`,t.frame.style.height=`${a.height+6}px`)}catch{}},window.addEventListener("scroll",pe,{passive:!0}),window.addEventListener("resize",pe,{passive:!0}))}function He(o){ae&&ae!==o&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset")),jt(),ae=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(ne){try{ne.remove()}catch{}ne=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
          ...
          <main class="eq-sidebar-body">
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-footer-note" style="margin-top: auto;">${Jt} \u2022 H\xEDbrido 4.0 (RAG + AST + Vision)</div>
              </div>
