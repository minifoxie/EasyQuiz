...
[HTML]: Omitido.`,r=ee(),c=r.length>0?`
[MEM\xD3RIA]:
${r.join(" | ")}
`:"",l=o.controls.filter(u=>u.role!=="navigation"),h=o.controls.filter(u=>u.role==="navigation");return`--- AN\xC1LISE ---
...
[NAVEGA\xC7\xC3O]:
${h.length>0?h.map(u=>`"${u.label||u.id}"[${u.type}]`).join(","):"Nenhuma"}

[IMAGENS]: ${e.length}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var lt=new Set(["question","info","start","conclusion"]),ct=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),dt=new Set(["val","chk","sel","clk","adv","js","drag"]),ut=150,_e=2e3;function H(o,e=""){return typeof o=="string"?o.trim().slice(0,_e):e}function pt(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!dt.has(a))return null;if(a==="adv")return{t:"adv",...H(t.id)?{id:H(t.id,"").slice(0,500)}:{}};if(a==="drag"){let i=H(t.from),r=H(t.to);return!i||!r?null:{t:"drag",from:i.slice(0,500),to:r.slice(0,500)}}if(a==="js"){let i=H(t.v);return!i||i.length>8e3?null:{t:"js",v:i}}let n=H(t.id).slice(0,500);if(!n)return null;if(a==="val")return{t:"val",id:n,v:H(t.v).slice(0,_e)};if(a==="sel"){let r=(Array.isArray(t.v)?t.v:[t.v]).map(c=>H(c).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:r}}if(a==="chk")return{t:"chk",id:n,c:t.c!==!1};let s={t:"clk",id:n};return Array.isArray(t.co)&&t.co.length===2&&t.co.every(i=>typeof i=="number"&&Number.isFinite(i))&&(s.co=[t.co[0],t.co[1]]),s}function Ge(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!lt.has(t))&&(t="question"),(typeof a!="string"||!ct.has(a))&&(a="escolha_unica");let n=Array.isArray(e.actions)?e.actions:[],s=[];for(let l=0;l<Math.min(n.length,ut);l++){let h=pt(n[l],l);h&&s.push(h)}let i=s.filter(l=>l.t!=="adv"),r=s.some(l=>l.t==="adv");t==="conclusion"?s.length=0:t==="info"||t==="start"?r||s.push({t:"adv"}):t==="question"&&!r&&s.push({t:"adv"});let c=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:c,rationale:H(e.rationale,"Plano validado e auto-recuperado."),actions:s,...H(e.memoryToStore)?{memoryToStore:H(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var N=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (R\xE1pido e atual)",description:"Modelo est\xE1vel multimodal para baixa lat\xEAncia e tarefas agentivas.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Recomendado Google)",description:"Modelo recomendado oficial do Google AI Studio com alt\xEDssima disponibilidade.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico e r\xE1pido)",description:"Modelo est\xE1vel de menor custo e menor taxa de fila.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Equilibrado)",description:"Modelo balanceado para resolu\xE7\xE3o de exerc\xEDcios.",stable:!0},{id:"gemini-2.0-flash",name:"Gemini 2.0 Flash (Alta Disponibilidade)",description:"Modelo consolidado para conting\xEAncia.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Legado)",description:"Modelo da gera\xE7\xE3o anterior para contas existentes.",stable:!0}],ht={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function mt(o){return o.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function je(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function gt(o){try{return JSON.parse(o)}catch(e){throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var te=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;return o?JSON.parse(o):null}catch{return null}})(),fe=new Set;async function oe(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return N;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let n=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!n.ok){let i=await n.text(),r=je(i,n.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let s=await n.json();if(Array.isArray(s.models)&&s.models.length>0){let i=s.models.filter(r=>{let c=r.supportedGenerationMethods||[],l=(r.name||"").includes("gemini"),h=c.includes("generateContent"),u=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return l&&h&&!u}).map(r=>{let c=r.supportedGenerationMethods||[],l=r.name.replace(/^models\//,""),h=r.displayName||l;return{id:l,name:h.includes(l)?h:`${h} (${l})`,description:r.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image/i.test(l),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(i.length>0){i.sort((r,c)=>{let l=h=>h==="gemini-3.8-flash"?120:h==="gemini-3.5-flash-lite"?115:h==="gemini-2.5-flash"?100:h==="gemini-3.1-pro-preview"?90:h.includes("flash")?50:10;return l(c.id)-l(r.id)}),te=i;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(i))}catch{}return i}}}catch(n){if(n.message?.includes("Chave de API"))throw n}return N}async function Fe(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await oe(e);if(a.length>0&&a!==N){let n=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${n.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.5-flash-lite","gemini-2.5-flash"];for(let a of t)for(let n of["v1beta","v1"]){let s=`https://generativelanguage.googleapis.com/${n}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${n})!`,models:N}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function ve(o,e,t,a){let n=t.apiKey.trim().replace(/^["']|["']$/g,"");if(!n)throw new Error("Chave de API n\xE3o configurada.");let s=mt(t.model);if(!te||te.length===0)try{a?.("Verificando modelos autorizados na sua chave de API...","info"),await oe(n)}catch(p){let m=p instanceof Error?p.message:String(p);if(m.includes("inv\xE1lida")||m.includes("n\xE3o autorizada"))throw new Error(m)}let i=Date.now(),r=Q(o,e,t),c=[{text:r}];for(let p of e)c.push({inline_data:{mime_type:p.mediaType,data:p.base64}});let l={temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:ht},h=[s,...te?.map(p=>p.id)||[],"gemini-3.8-flash","gemini-3.5-flash-lite","gemini-3.6-flash","gemini-2.5-flash","gemini-3.5-flash","gemini-2.0-flash"],u=Array.from(new Set(h)).filter(p=>!fe.has(p));u.length===0&&(fe.clear(),u.push(...N.map(p=>p.id)));let d=new Error("Nenhum modelo tentado.");for(let p=0;p<u.length;p++){let m=u[p],b=u[p+1];l.thinkingConfig={thinkingBudget:0};let q={system_instruction:{parts:[{text:Ve}]},contents:[{role:"user",parts:c}],generationConfig:l};a?.(`Consultando Gemini (${m})...`,"info");let g=["v1beta","v1"];for(let C of g){let E=`https://generativelanguage.googleapis.com/${C}/models/${m}:generateContent?key=${encodeURIComponent(n)}`,z=new AbortController,P=setTimeout(()=>{try{z.abort(new Error(`Timeout de 9s excedido na API Gemini (${m}). Servidor demorou a responder.`))}catch{z.abort()}},9e3);try{let k=await fetch(E,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":n},body:JSON.stringify(q),signal:z.signal});if(clearTimeout(P),!k.ok){let Pe=await k.text();if(k.status===400&&l.thinkingConfig&&/thinking/i.test(Pe)){delete l.thinkingConfig,q.generationConfig=l;continue}let it=je(Pe,k.status);if(k.status===404&&C==="v1beta")continue;throw new Error(it)}let F=await k.json(),ue=F.candidates?.[0];if(!ue||!ue.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let ze=ue.content.parts[0].text,$=Ge(gt(ze));if($.usedModel=m,$.durationMs=Date.now()-i,$.promptSent=r,$.tokensUsed=F.usageMetadata?.totalTokenCount,$.promptTokens=F.usageMetadata?.promptTokenCount,$.candidatesTokens=F.usageMetadata?.candidatesTokenCount,$.rawResponse=ze,m!==s){a?.(`Resolvido com sucesso pelo fallback '${m}' (${C})!`,"info");try{t.model=m}catch{}}return{plan:$,rawUsage:F.usageMetadata,usedModel:m}}catch(k){if(clearTimeout(P),k instanceof Error&&(k.name==="AbortError"||k.message.includes("aborted")||k.message.includes("Timeout"))?d=new Error(`Timeout de 9s excedido na API Gemini (${m}). Sem resposta imediata.`):d=k,d.message.includes("inv\xE1lida")||d.message.includes("n\xE3o autorizada"))throw d;if(d.message.includes("Timeout")||d.message.includes("503")||d.message.includes("429"))break}}let x=d.message.includes("429")||d.message.includes("cota");if(d.message.includes("404")&&fe.add(m),b){let C=x?500:150,E=`Modelo '${m}' indispon\xEDvel (${d.message}). Alternando imediatamente para '${b}'...`;console.warn(`[EasyQuiz Fallback] ${E}`),a?.(E,"warning"),C>0&&await new Promise(z=>setTimeout(z,C))}else console.warn(`[EasyQuiz Fallback] Modelo '${m}' falhou: ${d.message}. Todos os modelos esgotados.`)}throw d}var ft=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function K(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function be(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ue(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(ft.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var V=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),ae=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,vt=0;function ye(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!xe(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function w(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||xe(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let s=e.ownerDocument?.querySelector(`label[for="${CSS.escape(e.id)}"]`);if(s&&ye(s))return!0}catch{}let n=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(n&&n!==e&&ye(n))return!0}}return ye(e)}function bt(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function S(o,e=500){return bt(o).replace(/\s+/g," ").trim().slice(0,e)}function yt(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(vt+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function xe(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function I(o){if(!o||!(o instanceof Element)||xe(o)||o.closest("header, nav, aside"))return!1;let e=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",t=S(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,n=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),s=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return ae.test(n)||ae.test(t)||a==="submit"||s.includes("next")||s.includes("check")||s.includes("continue")||s.includes("proximo")||s.includes("forward")||!1}function xt(o){let e=o.closest("tr");if(e){let r=e.querySelector("th, td:first-child"),c=r&&r!==o.closest("td")?S(r.textContent,100):"",l=S(o.closest("label, td")?.textContent||"",50);if(c&&l)return`${c}: ${l}`}let t=o.getAttribute("aria-label");if(t)return S(t);let a=o.getAttribute("aria-labelledby");if(a){let r=a.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(r.trim())return S(r)}if("labels"in o&&o.labels){let r=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(r.trim())return S(r)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let r=S(n.textContent);if(r)return r}let s=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",i=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||s||"";return S(i)}function qe(o,e){let t=o instanceof HTMLSelectElement?o:null,a=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(n)?n:"other",i=o.getAttribute("role")||"",r=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),l=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(r)||/drag|card-item|sortable/i.test(c),h=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(r)||/dropzone|category-box|bucket|target-zone/i.test(c),d=S((l?"draggable":h?"dropzone":"")||a.type||i||s,40),p="";if(a.type==="checkbox"||a.type==="radio"||i==="radio"||i==="checkbox")p=a.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(s==="button"||n==="a"||e==="navigation"||I(o))p="";else{let T=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o instanceof HTMLSelectElement?o.value:"";p=S(T||o.getAttribute("data-category")||"",2e3)}let m=[];if(t)for(let T of Array.from(t.options).slice(0,80))m.push({value:S(T.value),label:S(T.textContent)});let b=!!(a.required||o.getAttribute("aria-required")==="true"),q=!!(a.disabled||o.getAttribute("aria-disabled")==="true"),g=yt(o);return{id:o.id||g,tag:s,type:d,label:xt(o),name:S(a.name||o.getAttribute("name")||"",180),value:p,options:m,required:b,disabled:q,role:e}}var Qe=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Ke(o){if(!w(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(V)).filter(w),a=S(o.innerText,4e3).length;if(a<10||!t.length&&a<60)return-1/0;let n=Math.max(1,window.innerWidth*window.innerHeight),s=Math.max(1,e.width*e.height),i=Math.min(1,s/n),r=e.top+e.height/2,c=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),l=a>40?35:0,h=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+l+h-i*20-c*10}function we(o){let e=o;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=t;break}let n=S(e.innerText,1e4),s=S(t.innerText,1e4),i=e.querySelectorAll(V).length,r=t.querySelectorAll(V).length;if(n.length<150&&s.length>n.length&&r<=i+4){e=t;continue}break}return e}function Ye(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&w(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function qt(){let o=document.activeElement;if(o&&o!==document.body){let n=o.closest(Qe);if(n&&Ke(n)>0)return we(n)}let t=Array.from(document.querySelectorAll(Qe)).map(n=>({element:n,score:Ke(n)})).filter(n=>Number.isFinite(n.score)).sort((n,s)=>s.score-n.score);if(t.length>0&&t[0].score>0)return we(t[0].element);let a=document.querySelector('form, main, [role="main"]');return a&&w(a)?a:document.body}function Je(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let n of Array.from(a.attributes))t.includes(n.name)||a.removeAttribute(n.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function ne(o){let e=Array.from(o.querySelectorAll(V)),t=new Set,a=[];for(let n of e){if(!w(n)||I(n))continue;let s=n.tagName.toLowerCase();["input","textarea","select"].includes(s)&&(t.add(n),a.push(n))}for(let n of e){if(!w(n)||I(n))continue;let s=n.tagName.toLowerCase();if(["input","textarea","select"].includes(s))continue;let i=n.querySelector("input, textarea, select");if(!(i&&t.has(i))){if(n.hasAttribute("for")){let r=n.getAttribute("for"),c=r?n.ownerDocument.getElementById(r):null;if(c&&t.has(c))continue}if(s==="a"){let r=n.getAttribute("role");if(!(r==="button"||r==="radio"||r==="checkbox"||r==="option"||n.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(n)}}return a.slice(0,100).map(n=>qe(n,"answer"))}function Ee(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let n of e)for(let s of Array.from(n.querySelectorAll(V)))if(!(t.has(s)||!w(s)||!I(s))&&(t.add(s),a.push(qe(s,"navigation")),a.length>=10))return a;return a}function Y(o=!1){let e=qt();e=we(e),o&&(e=Ye(e));let t=ne(e),a=Ee(e);if(t.length===0){let r=ne(document.body);r.length>0&&(e=Ye(e),t=ne(e),t.length===0&&(t=r,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=Ee(document.body));let n=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",s=S(n,16e3),i=[...t,...a].slice(0,120);return!s||i.length===0&&s.length<30?S(document.body.innerText||document.body.textContent||"",16e3).length>=30?_():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:s,htmlSnippet:Je(e),controls:i,scope:e}}function _(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=S(o,16e3),t=ne(document.body),a=Ee(document.body),n=[...t,...a].slice(0,120),s=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Je(s).slice(0,15e3),controls:n,scope:s}}function Xe(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}:${t.value}:${t.disabled}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,500),e].join("::")}function A(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function f(o){return o?o.replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim():""}function M(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let n=o.ownerDocument.getElementById(a);if(n)return n}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),s=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return s||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return M(a)}return o}function y(o){if(!o)return null;let e=o.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let t=CSS.escape(e),a=document.querySelector(`[data-easyquiz-id="${t}"]`);if(a&&!A(a)&&w(a))return M(a);try{let l=document.getElementById(e);if(l&&!A(l)&&w(l))return l.hasAttribute("data-category")||l.hasAttribute("data-dropzone")||l.classList.contains("dnd-zone")?l:M(l)}catch{}let n=e.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([0-9]+)$/i);if(n){let l=parseInt(n[1],10)-1;if(l>=0){let h=Array.from(document.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>w(u)&&!A(u));if(l<h.length)return M(h[l])}}let s=e.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(s){let l=s[1].toUpperCase().charCodeAt(0)-65;if(l>=0){let h=Array.from(document.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>w(u)&&!A(u));if(l<h.length)return M(h[l])}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(e)){let h=Array.from(document.querySelectorAll(`[data-category="${t}" i], [data-dropzone="${t}" i], [data-role="dropzone"][data-category="${t}" i]`)).find(m=>w(m)&&!A(m));if(h)return h;let d=Array.from(document.querySelectorAll(`input[value="${t}" i], [data-value="${t}" i], input[id="${t}" i]`)).find(m=>w(m)&&!A(m));if(d)return M(d);let p=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(m=>{if(!w(m)||A(m))return!1;let b=f(m.textContent).toLowerCase();return b===e.toLowerCase()||b===e.toLowerCase()+")"});if(p)return M(p)}try{let h=Array.from(document.querySelectorAll(`[name="${t}"], [value="${t}"], [data-category="${t}" i], [data-dropzone="${t}" i], [data-testid="${t}" i], [data-test-id="${t}" i], [aria-label="${t}" i]`)).find(u=>w(u)&&!A(u));if(h)return h.hasAttribute("data-category")||h.hasAttribute("data-dropzone")||h.classList.contains("dnd-zone")?h:M(h)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(e))try{let h=Array.from(document.querySelectorAll(e)).find(u=>w(u)&&!A(u));if(h)return M(h)}catch{}try{let l=e.replace(/"/g,""),h=`//button[normalize-space(.)="${l}"] | //a[normalize-space(.)="${l}"] | //*[not(*) and normalize-space(.)="${l}"] | //*[@aria-label="${l}"] | //*[@data-category="${l}"] | //*[@data-testid="${l}"]`,u=document.evaluate(h,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let d=0;d<u.snapshotLength;d++){let p=u.snapshotItem(d);if(p&&w(p)&&!A(p)){if(["body","html"].includes(p.tagName.toLowerCase())){let b=p.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&w(b))return M(b)}return p.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||M(p)}}}catch{}let r=f(e).toLowerCase(),c=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let l of c){if(!w(l)||A(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=f(l.textContent).toLowerCase(),d=f(l.getAttribute("aria-label")||"").toLowerCase(),p=f(l.getAttribute("data-category")||"").toLowerCase(),m=l instanceof HTMLInputElement||l instanceof HTMLButtonElement?l.value:"",b=f(m).toLowerCase(),q=u.startsWith(r+")")||u.startsWith(r+".")||u.startsWith(r+" -")||u.startsWith(r+":");if(u===r||d===r||p&&p===r||b&&b===r||q)return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||M(l)}if(r.length>=3)for(let l of c){if(!w(l)||A(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let u=f(l.textContent).toLowerCase(),d=f(l.getAttribute("aria-label")||"").toLowerCase();if(u.includes(r)||d.includes(r)){if(Array.from(l.children).some(q=>{let g=f(q.textContent).toLowerCase();return g&&g.includes(r)}))continue;return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||M(l)}let p=r.split(/\s+/).filter(Boolean);if(p.length>=3){let m=p.slice(0,Math.min(5,p.length)).join(" ");if(u.includes(m)||d.includes(m))return M(l)}}return null}function J(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function L(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){B(t,!t.checked);return}if(t.type==="radio"){B(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(o instanceof HTMLButtonElement||o instanceof HTMLAnchorElement||o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let n=o.getBoundingClientRect(),s=e?e[0]:Math.round(n.left+Math.max(1,n.width/2)),i=e?e[1]:Math.round(n.top+Math.max(1,n.height/2)),r={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:i};try{o.dispatchEvent(new PointerEvent("pointerdown",{...r,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...r,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...r,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...r,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...r,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function Se(o,e){let t=o;if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let n=o.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');n&&(t=n)}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t.getAttribute("role")==="link"||t instanceof HTMLInputElement&&["button","submit"].includes(t.type)||I(t)){console.log("[EasyQuiz] Auto-corre\xE7\xE3o em setNativeValue: elemento \xE9 bot\xE3o/navega\xE7\xE3o. Clicando..."),L(t);return}if(t instanceof HTMLSelectElement){Me(t,[e]);return}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let n=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;B(t,n);return}try{t.focus?.()}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:e}))}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let i=t._valueTracker;i&&i.setValue("")}catch{}let n=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,s=Object.getOwnPropertyDescriptor(n,"value")?.set;s?s.call(t,e):t.value=e;try{let i=t._valueTracker;i&&i.setValue(e)}catch{}J(t,["input","change","blur"]);return}if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0),document.execCommand?.("insertText",!1,e)}catch{}if(t.textContent?.trim()!==e.trim()){t.textContent=e;try{t.innerText=e}catch{}}J(t,["input","change","blur"]);return}try{t.value=e,t.textContent=e,J(t,["input","change","blur"])}catch{}}function Ae(o,e=""){if(!o)return e;let t=f(o),a=y(o)||y(t);if(!a)return t||e;let n=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr');if(n){let c=f(n.textContent);if(c&&c.length>0&&c.length<150)return c}if(a.id){let c=document.querySelector(`label[for="${CSS.escape(a.id)}"]`);if(c){let l=f(c.textContent);if(l&&l.length>0&&l.length<150)return l}}let s=a.getAttribute("aria-label");if(s)return f(s);let i=a.getAttribute("placeholder");if(i)return f(i);let r=f(a.textContent);return r&&r.length>0&&r.length<120?r:t||e}function B(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let n=e?"true":"false";t.setAttribute("aria-checked",n),t.setAttribute("aria-selected",n),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(a){if(a.checked===e)return;try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let n=a._valueTracker;n&&n.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,J(a,["input","change"])}}else{try{t.focus?.()}catch{}try{t.click()}catch{L(t)}}}function Me(o,e){let t=o instanceof HTMLSelectElement?o:o.querySelector("select");if(t){let n=e.map(i=>f(i).toLowerCase()),s=!1;for(let i=0;i<t.options.length;i++){let r=t.options[i],c=r.value.toLowerCase(),l=f(r.textContent).toLowerCase();if(n.some(u=>u===c||u===l)){if(r.selected=!0,t.selectedIndex=i,s=!0,!t.multiple)break}else t.multiple||(r.selected=!1)}if(!s)for(let i=0;i<t.options.length;i++){let r=t.options[i],c=r.value.toLowerCase(),l=f(r.textContent).toLowerCase();if(n.some(u=>c.includes(u)||l.includes(u)||u.length>3&&(u.includes(c)||u.includes(l)))&&(r.selected=!0,t.selectedIndex=i,s=!0,!t.multiple))break}if(s){J(t,["input","change","blur"]);return}}let a=o.closest('[role="combobox"], [class*="select" i], [class*="dropdown" i]');if(a){L(a);for(let n of e){let s=y(n);if(s){L(s);return}}}}function wt(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Te(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function D(o,e){let t=f(o).toLowerCase();if(!t)return null;let a=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',n=Array.from(document.querySelectorAll(a)),s=e==="destination"?n.find(i=>[i.getAttribute("data-category"),i.getAttribute("data-dropzone")].some(r=>r?.trim().toLowerCase()===t)):null;return s&&w(s)&&!A(s)?s:n.find(i=>{if(!w(i)||A(i))return!1;let r=f(`${i.textContent||""} ${i.getAttribute("data-category")||""} ${i.getAttribute("data-dropzone")||""}`).toLowerCase();return r===t||r.includes(t)})||null}async function ie(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),n=e.getBoundingClientRect(),s=Math.round(a.left+Math.max(1,a.width/2)),i=Math.round(a.top+Math.max(1,a.height/2)),r=Math.round(n.left+Math.max(1,n.width/2)),c=Math.round(n.top+Math.max(1,n.height/2)),l=f(e.textContent).toLowerCase();if(l){let b=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(q=>{let g=f(q.textContent).toLowerCase(),x=q instanceof HTMLInputElement||q instanceof HTMLOptionElement?f(q.value).toLowerCase():"";return g&&(l.includes(g)||g.includes(l))||x&&(l.includes(x)||x.includes(l))});b&&(L(b),await new Promise(q=>setTimeout(q,120)))}Te(o),await new Promise(m=>setTimeout(m,140)),Te(e);let h=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(h&&h!==e&&Te(h),await new Promise(m=>setTimeout(m,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let u={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:i,screenX:s,screenY:i,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...u,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",u));let d=4;for(let m=1;m<=d;m++){let b=Math.round(s+(r-s)*(m/d)),q=Math.round(i+(c-i)*(m/d)),g={...u,clientX:b,clientY:q,screenX:b,screenY:q};try{o.dispatchEvent(new PointerEvent("pointermove",{...g,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",g))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:c,screenX:r,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let m=wt(S(o.textContent),o.outerHTML),b={...u},q={...p};m&&(b.dataTransfer=m,q.dataTransfer=m);let g=o.ownerDocument.defaultView?.DragEvent;if(!g)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new g("dragstart",b)),e.dispatchEvent(new g("dragenter",q)),e.dispatchEvent(new g("dragover",q)),e.dispatchEvent(new g("drop",q)),o.dispatchEvent(new g("dragend",b))}catch(m){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",m)}try{let m=new Touch({identifier:1,target:o,clientX:s,clientY:i}),b=new Touch({identifier:1,target:e,clientX:r,clientY:c});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[m]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[b]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(m=>setTimeout(m,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Ze={fill:(o,e)=>{let t=y(o);t?Se(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=y(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?B(e,!0):L(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=y(o);t?B(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:o=>y(o),drag:(o,e)=>{let t=D(o,"source")||y(o),a=D(e,"destination")||y(e);t&&a?ie(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=D(o,"source")||y(o),a=D(e,"destination")||y(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await ie(t,a)},execute:(o,e=!1,t=1)=>Le(o,e,t)};window.$eq=Ze;async function Et(o,e=1,t=K()){if(be(o,t),o.t==="js"){let i=String(o.v||"");Ue(i);try{new Function("$eq","document","window",i)(Ze,document,window)}catch(r){throw console.warn("[EasyQuiz JS Execution]",r),r}return}if(o.t==="drag"){let i=D(o.from,"source")||y(o.from),r=D(o.to,"destination")||y(o.to);!i&&o.from&&(i=y(f(o.from))),!r&&o.to&&(r=y(f(o.to))),i&&r?await ie(i,r,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id||"",n=y(a);!n&&a&&(n=y(f(a)));let s=o.v!==void 0?String(o.v).trim():"";if(n&&s){if(n instanceof HTMLInputElement&&n.type==="radio"&&n.name){if(f(n.value).toLowerCase()!==f(s).toLowerCase()){let i=document.querySelector(`input[type="radio"][name="${CSS.escape(n.name)}"][value="${CSS.escape(s)}" i]`);if(i)n=i;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${CSS.escape(n.name)}"]`)).find(l=>{let h=l.closest("label, .vf-label, .option-card, tr, td, div");return h&&f(h.textContent).toLowerCase().includes(f(s).toLowerCase())});c&&(n=c)}}}else if(!(n instanceof HTMLInputElement)&&!(n instanceof HTMLSelectElement)&&!(n instanceof HTMLTextAreaElement)){let i=n.querySelector(`input[value="${CSS.escape(s)}" i], [data-value="${CSS.escape(s)}" i]`);if(i)n=i;else{let c=Array.from(n.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let h=l.closest("label, .vf-label, .option-card, td, div");return h&&f(h.textContent).toLowerCase().includes(f(s).toLowerCase())});c&&(n=c)}}}if(!n&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":n&&(n instanceof HTMLButtonElement||n.tagName.toLowerCase()==="a"||n.getAttribute("role")==="button"||n.getAttribute("role")==="link"||n instanceof HTMLInputElement&&["button","submit"].includes(n.type)||I(n)?(console.log(`[EasyQuiz] Auto-corre\xE7\xE3o: A\xE7\xE3o 'val' direcionada a bot\xE3o/link '${o.id}'. Clicando...`),L(n)):Se(n,String(o.v)));break;case"chk":n&&B(n,!!o.c);break;case"sel":if(n){let r=Array.isArray(o.v)?o.v:[String(o.v)];Me(n,r)}break;case"clk":n&&(!!(n.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||n.querySelector('input[type="radio"], input[type="checkbox"]')||n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type))?B(n,!0):L(n,o.co));break;case"adv":let i=et(o.id);if(i){await Ce(i,1200);let r=o.id||i.textContent?.trim()||"";r&&me(window.location.hostname,{advanceSelector:r}),L(i)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Tt(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!w(t)||A(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",n=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(n)})||null}function et(o){if(o){let s=y(o);if(s&&w(s)&&!A(s))return s}try{let s=U(window.location.hostname);if(s.advanceSelector){let i=y(s.advanceSelector);if(i&&w(i)&&!A(i))return i}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(e)).filter(s=>w(s)&&!A(s)&&!s.closest("header, nav, aside"));for(let s of a)if(I(s))return s;for(let s of a){let i=s instanceof HTMLInputElement||s instanceof HTMLButtonElement?s.value:"",r=(s.textContent||i||s.getAttribute("aria-label")||"").trim();if(ae.test(r))return s}let n=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return n&&w(n)&&!A(n)?n:null}async function Ce(o,e=1500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(n=>setTimeout(n,100))}}function tt(){let o=(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim(),e=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"]').length;return`${window.location.href}|${document.title}|${o.slice(0,900)}|${e}`}async function Ct(o,e=1800){let t=Date.now();for(;Date.now()-t<e;){if(tt()!==o)return{changed:!0,evidence:"URL, texto, t\xEDtulo ou conjunto de controles mudou ap\xF3s a a\xE7\xE3o."};await new Promise(n=>setTimeout(n,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a observ\xE1vel foi detectada dentro do tempo limite."}}async function We(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let a=y(o.from)||y(f(o.from)),n=y(o.to)||y(f(o.to));a&&n&&await ie(a,n,2);return}let e=o.id||"",t=y(e)||y(f(e));if(o.t==="clk"||o.t==="chk"){if(!t&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=f(e).toLowerCase();t=n.find(i=>{let r=f(i.textContent).toLowerCase(),c=f(i.value||"").toLowerCase();return r.includes(s)||c===s||r.startsWith(s+")")||r.startsWith("("+s+")")})||null}let a=o.v!==void 0?String(o.v).trim():"";if(t&&a){if(t instanceof HTMLInputElement&&t.type==="radio"&&t.name){if(f(t.value).toLowerCase()!==f(a).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${CSS.escape(t.name)}"][value="${CSS.escape(a)}" i]`);if(n)t=n;else{let i=Array.from(document.querySelectorAll(`input[type="radio"][name="${CSS.escape(t.name)}"]`)).find(r=>{let c=r.closest("label, .vf-label, .option-card, tr, td, div");return c&&f(c.textContent).toLowerCase().includes(f(a).toLowerCase())});i&&(t=i)}}}else if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLSelectElement)&&!(t instanceof HTMLTextAreaElement)){let n=t.querySelector(`input[value="${CSS.escape(a)}" i], [data-value="${CSS.escape(a)}" i]`);if(n)t=n;else{let i=Array.from(t.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(r=>{let c=r.closest("label, .vf-label, .option-card, td, div");return c&&f(c.textContent).toLowerCase().includes(f(a).toLowerCase())});i&&(t=i)}}}if(t){let n=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,s=t instanceof HTMLInputElement&&["radio","checkbox"].includes(t.type)?t:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),i=o.t==="chk"?!!o.c:!0;if(B(s||n,i),s&&s.checked!==i){try{let r=s._valueTracker;r&&r.setValue(!i)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,i)}catch{}s.checked=i,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){if(!t&&e){let a=Array.from(document.querySelectorAll('input:not([type="hidden"]), textarea, [contenteditable="true"]')),n=f(e).toLowerCase();t=a.find(s=>{let i=(s.getAttribute("placeholder")||"").toLowerCase(),r=(s.name||"").toLowerCase(),c=(s.id||"").toLowerCase(),l=(s.getAttribute("aria-label")||"").toLowerCase();return i.includes(n)||r.includes(n)||c.includes(n)||l.includes(n)})||null}if(t){let n=(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t:t.querySelector('input:not([type="hidden"]), textarea, [contenteditable="true"]'))||t,s=String(o.v??"");try{n.focus?.(),document.execCommand?.("selectAll",!1,void 0),document.execCommand?.("insertText",!1,s)}catch{}Se(n,s)}return}if(o.t==="sel"){if(!t&&e){let a=Array.from(document.querySelectorAll("select")),n=f(e).toLowerCase();t=a.find(s=>{let i=(s.name||"").toLowerCase(),r=(s.id||"").toLowerCase(),c=(s.getAttribute("aria-label")||"").toLowerCase();return i.includes(n)||r.includes(n)||c.includes(n)})||null}if(t){let a=Array.isArray(o.v)?o.v:[String(o.v)];Me(t,a)}return}}function G(o){try{if(o.t==="val"){let e=y(o.id)||y(f(o.id));if(!e)return!1;if(e instanceof HTMLButtonElement||e.tagName.toLowerCase()==="a"||e.getAttribute("role")==="button"||e.getAttribute("role")==="link"||e instanceof HTMLInputElement&&["button","submit"].includes(e.type)||I(e))return!0;let a=String(o.v??"").trim(),n=e instanceof HTMLInputElement&&e.type==="radio"?e:e.querySelector('input[type="radio"]');if(n&&n.name){let l=document.querySelector(`input[type="radio"][name="${CSS.escape(n.name)}"]:checked`);if(!l)return!1;let h=f(l.value).toLowerCase(),u=f(a).toLowerCase(),d=f(l.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return h===u||d===u||d.includes(u)}let s=e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement?e:e.querySelector('input:not([type="hidden"]), textarea, [contenteditable="true"]'),i=(s?s.value??s.textContent??"":e.textContent??"").trim();if(!i&&!a)return!0;if(!i&&a)return!1;let r=i.replace(",",".").toLowerCase(),c=a.replace(",",".").toLowerCase();return r===c||r.includes(c)||i.toLowerCase()===a.toLowerCase()}if(o.t==="sel"){let e=y(o.id)||y(f(o.id));if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t)return!1;let n=(Array.isArray(o.v)?o.v:[String(o.v)]).map(s=>f(s).toLowerCase());return Array.from(t.options).some(s=>{if(!s.selected)return!1;let i=s.value.toLowerCase(),r=f(s.textContent).toLowerCase();return n.some(c=>c===i||c===r||i.includes(c)||r.includes(c))})}if(o.t==="chk"||o.t==="clk"){let e=y(o.id)||y(f(o.id));if(!e)return!1;let t=e.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||e,a=e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type)?e:t.querySelector('input[type="checkbox"], input[type="radio"]')||(t.getAttribute("for")?t.ownerDocument.getElementById(t.getAttribute("for")):null),n=o.t==="chk"?!!o.c:!0;if(a&&a.type==="radio"&&o.v){let l=f(String(o.v)).toLowerCase();if(a.name){let h=document.querySelector(`input[type="radio"][name="${CSS.escape(a.name)}"]:checked`);return h?f(h.value).toLowerCase()===l:!1}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===n;let s=t.getAttribute("aria-checked")===String(n)||t.getAttribute("aria-selected")===String(n)||t.getAttribute("aria-pressed")===String(n),i=n?t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.getAttribute("data-active")==="true"||t.getAttribute("data-state")==="checked"||t.getAttribute("data-state")==="on":t.getAttribute("data-selected")==="false"||t.getAttribute("data-checked")==="false"||t.getAttribute("data-state")==="unchecked",r=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(t.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(t.className||"");return!!(s||i||r||(t instanceof HTMLButtonElement||t.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!a)}if(o.t==="drag"){let e=y(o.from)||y(f(o.from)),t=y(o.to)||y(f(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function Le(o,e,t=1,a=K({engine:"smart",autoAdvance:e})){let n=o.actions.filter(g=>g.t!=="adv"),s=o.actions.filter(g=>g.t==="adv"),i=0,r=[],c=new Map;for(let g of n){try{await Et(g,t,a),i++}catch(x){c.set(g,x instanceof Error?x.message:String(x)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",g,x)}g.t==="drag"&&await new Promise(x=>setTimeout(x,250))}await new Promise(g=>setTimeout(g,n.length>0?300:50));let l=0;for(let g of n){if(G(g)){l++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${g.t}' no alvo '${g.id||g.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{be(g,a),await We(g)}catch(x){c.set(g,x instanceof Error?x.message:String(x)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",x)}await new Promise(x=>setTimeout(x,180)),G(g)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),l++)}if(l<n.length&&n.length>0){console.warn(`[EasyQuiz Auto-Cura] ${n.length-l} de ${n.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(g=>setTimeout(g,200));for(let g of n)if(!G(g))try{await We(g)}catch(x){c.set(g,x instanceof Error?x.message:String(x))}await new Promise(g=>setTimeout(g,200)),l=0;for(let g of n)G(g)&&l++}let h=o.pageType==="question";for(let g of n)G(g)||r.push(g.t==="drag"?`${g.from} -> ${g.to}`:"id"in g?g.id:g.t);let u=n.map((g,x)=>{let T=g.t==="drag"?`${g.from} -> ${g.to}`:g.t==="js"?"$eq":g.id||g.t,C=g.t==="js"?!0:g.t==="drag"?!!(D(g.from,"source")&&D(g.to,"destination")):!!(y(g.id||"")||y(f(g.id||""))),E=G(g);return{index:x,action:g,target:T,located:C,applied:!c.has(g),verified:E,strategy:g.t==="drag"?"drag-adaptive":g.t==="js"?"javascript":"declarative-dom",evidence:E?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(g)?{error:c.get(g)}:{}}}),d=!h||n.length===0?!0:i===n.length&&l===n.length&&r.length===0,p=!1,m=!1,b="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",q=!!document.querySelector('input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled]), [role="radio"], [role="checkbox"], .option-card, [class*="choice-card" i]');if(o.pageType==="info"&&q)return console.warn("[EasyQuiz Autopilot] Alternativas detectadas na p\xE1gina, mas o plano indicava info. Avan\xE7o autom\xE1tico bloqueado para evitar pular a quest\xE3o."),{applied:i,verified:l,success:!1,advanced:!1,failed:["Avan\xE7o suspenso: a p\xE1gina possui alternativas a serem respondidas."],reports:u,navigationVerified:!1,navigationEvidence:"Avan\xE7o bloqueado: alternativas detectadas no DOM."};if(e&&(d||!h)){if(await new Promise(C=>setTimeout(C,n.length>0?500:200)),o.pageType!=="info"){let C=Tt();C&&w(C)&&(await Ce(C,1200),L(C),await new Promise(E=>setTimeout(E,800)))}let g=tt(),x=s.length>0?s[0].id:void 0,T=et(x);if(T){await Ce(T,1200);let C=x||T.textContent?.trim()||"";C&&me(window.location.hostname,{advanceSelector:C}),L(T);let E=await Ct(g);m=E.changed,b=E.evidence,p=E.changed,E.changed||console.warn("[EasyQuiz] O bot\xE3o foi acionado, mas a navega\xE7\xE3o n\xE3o foi confirmada.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:i,verified:l,success:d,advanced:p,failed:r,reports:u,navigationVerified:m,navigationEvidence:b}}var X=null,j=[];function W(){X&&(X.style.removeProperty("outline"),X.style.removeProperty("outline-offset"),X=null);for(let o of j)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");j=[]}function ke(o){W(),X=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px"}function ot(o){for(let e of o){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let s=y(e.from),i=y(e.to);s&&(s.style.outline="2px solid #00ff88",j.push(s)),i&&(i.style.outline="2px dashed #00e5ff",j.push(i))}catch{}continue}if(!e.id)continue;let t=y(e.id);if(!t)continue;let a=t.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i], tr, li')||t;a.style.outline="2px solid #00ff88",a.style.outlineOffset="2px",a.style.backgroundColor="rgba(0, 255, 136, 0.12)",a.setAttribute("data-easyquiz-highlight","true"),j.push(a);let n=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]');n&&n!==a&&(n.style.outline="2px solid #00ff88",n.style.outlineOffset="2px",n.style.boxShadow="0 0 10px rgba(0, 255, 136, 0.8)",n.setAttribute("data-easyquiz-highlight","true"),j.push(n))}}var Z=4,St=1200,He=12e5;function se(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let n=String(a.result||"");e(n.split(",")[1]||"")},a.readAsDataURL(o)})}async function re(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,St/Math.max(e,t)),n=Math.max(1,Math.round(e*a)),s=Math.max(1,Math.round(t*a)),i=document.createElement("canvas");i.width=n,i.height=s;let r=i.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,n,s),r.drawImage(o,0,0,n,s),new Promise((c,l)=>{i.toBlob(h=>h?c(h):l(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function at(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,n=`
    ...
    `,s=new Blob([n],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(s),r=new Image;r.crossOrigin="anonymous",await new Promise((h,u)=>{r.onload=h,r.onerror=u,r.src=i});let c=await re(r),l=await se(c);if(URL.revokeObjectURL(i),l&&l.length<=He)return{mediaType:"image/jpeg",base64:l,alt:"Captura Suprema via rasteriza\xE7\xE3o DOM",source:"rasterized"}}catch(e){console.warn("Falha na rasteriza\xE7\xE3o suprema:",e)}return null}async function At(o){let e=o.currentSrc||o.src;if(!e)return null;let t=(o.alt||o.getAttribute("aria-label")||"Imagem da quest\xE3o").slice(0,500);if(o.complete&&o.naturalWidth>0)try{let a=await re(o),n=await se(a);if(n&&n.length<=He)return{mediaType:"image/jpeg",base64:n,alt:t,source:e.slice(0,2e3)}}catch{}try{let a=await fetch(e,{mode:"cors"});if(a.ok){let n=await a.blob();if(n.type.startsWith("image/")){let s=await createImageBitmap(n),i=await re(s);s.close();let r=await se(i);if(r&&r.length<=He)return{mediaType:"image/jpeg",base64:r,alt:t,source:e.slice(0,2e3)}}}}catch{return at(o.parentElement||o)}return null}async function Ie(o,e=!0){if(!e)return[];let t=[],a=0,n=Array.from(o.querySelectorAll("img")).filter(w).slice(0,Z);for(let s of n)try{let i=await At(s);if(i&&a+i.base64.length<=25e5&&(t.push(i),a+=i.base64.length,t.length>=Z))break}catch{}if(t.length<Z){let s=Array.from(o.querySelectorAll("canvas")).filter(w).slice(0,Z);for(let i of s)try{let r=await re(i),c=await se(r);if(c&&a+c.length<=25e5&&(t.push({mediaType:"image/jpeg",base64:c,alt:"Canvas inline",source:"canvas"}),a+=c.length,t.length>=Z))break}catch{let r=await at(i.parentElement||i);r&&(t.push(r),a+=r.base64.length)}}return t}var le=class{active=!1;timer=null;callbacks;lastRunTime=0;lastActionTime=0;isProcessing=!1;observer=null;mutationTimer=null;constructor(e){this.callbacks=e}isActive(){return this.active}start(){this.active||(this.active=!0,this.lastActionTime=Date.now(),this.callbacks.onStatusChange("waiting","> [SYS] Autopilot ENGAGED. Monitorando..."),typeof MutationObserver<"u"&&(this.observer=new MutationObserver(()=>{!this.active||this.isProcessing||(this.mutationTimer&&clearTimeout(this.mutationTimer),this.mutationTimer=window.setTimeout(()=>{this.mutationTimer=null,this.loop()},180))}),this.observer.observe(document.body,{subtree:!0,childList:!0,attributes:!0,characterData:!0})),this.loop())}stop(){this.active=!1,this.timer&&clearTimeout(this.timer),this.mutationTimer&&clearTimeout(this.mutationTimer),this.mutationTimer=null,this.observer?.disconnect(),this.observer=null,this.callbacks.onStatusChange("idle","> [SYS] Autopilot DESATIVADO.")}errorCount=0;lastPageSig="";samePageCount=0;async loop(){if(!this.active)return;let e=Date.now();if(e-this.lastRunTime<2500||this.isProcessing){this.timer=window.setTimeout(()=>this.loop(),500);return}this.lastRunTime=e;try{this.isProcessing=!0;let t=Y(!1);if(t||(t=_()),t){let a=Xe(t);if(a===this.lastPageSig)this.samePageCount++;else{let i=this.samePageCount>1;this.lastPageSig=a,this.samePageCount=1,i&&(this.callbacks.onStatusChange("waiting","> [SYS] Avan\xE7o de p\xE1gina detectado! Retomando monitoramento autom\xE1tico...","text-green"),this.callbacks.onPageAdvance?.())}if(this.callbacks.isManualModeActive?.()){this.callbacks.onStatusChange("waiting","> [SYS] Gabarito manual ativo na tela. Aguardando voc\xEA posicionar as respostas e avan\xE7ar a p\xE1gina...","text-yellow"),this.lastRunTime=Date.now();return}this.samePageCount>1&&(this.callbacks.onStatusChange("waiting",`> [AUTOPILOT] Resolu\xE7\xE3o pendente (${this.samePageCount}\xAA verifica\xE7\xE3o). Conclua e avance para prosseguir...`,"text-yellow"),await new Promise(i=>setTimeout(i,4e3)));let n=t.controls.filter(i=>i.role==="answer"),s=U(window.location.hostname);if(n.length>0){this.callbacks.onStatusChange("analyzing","> [IA] Quest\xE3o/Exerc\xEDcio detectado. Consultando IA...","text-blue"),await new Promise(r=>setTimeout(r,600));let i=await this.callbacks.onRequestAnalysis(this.samePageCount);if(i){if(this.callbacks.onStatusChange("analyzing",`> [IA] (${i.usedModel||"gemini"}) Confian\xE7a: ${(i.confidence*100).toFixed(1)}% | Modo: ${i.mode}`,"text-blue"),this.callbacks.onStatusChange("analyzing",`> [IA] Racioc\xEDnio: ${i.rationale}`,"text-blue"),this.callbacks.onStatusChange("analyzing",`> [IA] A\xE7\xF5es geradas: ${i.actions.length}`,"text-blue"),this.errorCount=0,i.memoryToStore&&this.callbacks.onStatusChange("analyzing",`> [IA] \u{1F9E0} Mem\xF3ria RAG salva: "${i.memoryToStore}"`,"text-yellow"),i.pageType==="conclusion"){this.callbacks.onStatusChange("idle","> [SYS] Atividade conclu\xEDda! Desligando Autopilot.","text-green"),this.stop();return}}else{this.errorCount++;let r=this.errorCount===1?5e3:8e3;this.callbacks.onStatusChange("waiting",`> [AVISO] Falha na an\xE1lise (${this.errorCount}/3). Aguardando ${r/1e3}s para estabiliza\xE7\xE3o antes de tentar novamente...`,"text-yellow"),await new Promise(c=>setTimeout(c,r))}this.lastActionTime=Date.now()}else if(s.advanceSelector&&y(s.advanceSelector)&&t.questionText.length<50){let i=y(s.advanceSelector);i&&(this.callbacks.onStatusChange("advancing",`> [BRUTE] Avan\xE7ando via cache "${s.advanceSelector}"...`),await new Promise(r=>setTimeout(r,1e3)),L(i),this.lastActionTime=Date.now(),this.errorCount=0)}else{this.callbacks.onStatusChange("analyzing","> [IA] P\xE1gina informativa/contexto detectada. Lendo e consultando IA...","text-blue"),await new Promise(r=>setTimeout(r,600));let i=await this.callbacks.onRequestAnalysis(this.samePageCount);if(i){if(this.callbacks.onStatusChange("analyzing",`> [IA] (${i.usedModel||"gemini"}) Tipo: ${i.pageType} | Modo: ${i.mode}`,"text-blue"),this.callbacks.onStatusChange("analyzing",`> [IA] Racioc\xEDnio: ${i.rationale}`,"text-blue"),i.memoryToStore&&this.callbacks.onStatusChange("analyzing",`> [IA] \u{1F9E0} Conte\xFAdo absorvido na mem\xF3ria: "${i.memoryToStore}"`,"text-yellow"),i.pageType==="info")this.callbacks.onStatusChange("advancing","> [IA] \u{1F4D6} Leitura conclu\xEDda. Avan\xE7ando automaticamente...","text-green"),await new Promise(r=>setTimeout(r,1800));else if(i.pageType==="start")this.callbacks.onStatusChange("advancing","> [SYS] In\xEDcio de m\xF3dulo detectado. Iniciando...","text-blue"),await new Promise(r=>setTimeout(r,1800));else if(i.pageType==="conclusion"){this.callbacks.onStatusChange("idle","> [SYS] Atividade conclu\xEDda! Desligando Autopilot.","text-green"),this.stop();return}this.errorCount=0}else{this.errorCount++;let r=this.errorCount===1?5e3:8e3;this.callbacks.onStatusChange("waiting",`> [AVISO] Falha ao processar p\xE1gina (${this.errorCount}/3). Aguardando ${r/1e3}s para estabiliza\xE7\xE3o antes de tentar novamente...`,"text-yellow"),await new Promise(c=>setTimeout(c,r))}this.lastActionTime=Date.now()}if(this.errorCount>=3){this.callbacks.onStatusChange("error","> [ERRO] 3 falhas consecutivas. Abortando Autopilot para poupar sua cota e tokens.","text-red"),this.callbacks.onStatusChange("waiting","> [DICA] Verifique a mensagem vermelha de [ERRO DETALHADO] no console acima para saber o motivo exato.","text-yellow"),this.stop();return}}else this.callbacks.onStatusChange("waiting","> [SYS] Monitorando p\xE1gina... Aguardando carregamento dos elementos.")}catch(t){let a=t instanceof Error?t.message:String(t);console.warn("[EasyQuiz Autopilot]",t),this.callbacks.onStatusChange("error",`> [ERRO NO AUTOPILOT] ${a}`,"text-red")}finally{this.isProcessing=!1}this.active&&(this.timer=window.setTimeout(()=>this.loop(),1e3))}};var v={logo:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.8L19.2 8 12 11.2 4.8 8 12 4.8zM4 9.6l7 3.1v7.5l-7-3.5V9.6zm9 10.6v-7.5l7-3.1v7.1l-7 3.5z"/></svg>',rocket:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M13.13 2.81a.5.5 0 0 0-.46-.07c-.42.15-2.08.79-3.9 2.61-2.04 2.04-2.6 4.09-2.73 4.96l-.97.98a1 1 0 0 0-.29.71v2.12a1 1 0 0 0 .29.71l2.83 2.83a1 1 0 0 0 .71.29h2.12a1 1 0 0 0 .71-.29l.98-.97c.87-.13 2.92-.69 4.96-2.73 1.82-1.82 2.46-3.48 2.61-3.9a.5.5 0 0 0-.07-.46l-6.79-6.79zM4.5 16.5l-2.09 2.09a.5.5 0 0 0 .35.85h3.04l.35.35v3.04a.5.5 0 0 0 .85.35L9.09 21.1l-4.59-4.6z"/></svg>',play:'<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M6 6h12v12H6z"/></svg>',code:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg>',terminal:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zm-12-3l3-3-3-3 1.4-1.4L13.8 12l-4.4 4.4L8 15zm6 0h4v2h-4v-2z"/></svg>',inspector:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>',settings:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58a.49.49 0 0 0 .12-.61l-1.92-3.32a.49.49 0 0 0-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54a.484.484 0 0 0-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58a.49.49 0 0 0-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z"/></svg>',key:'<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M7 14c-2.76 0-5-2.24-5-5s2.24-5 5-5c2.42 0 4.44 1.72 4.9 4H22v4h-2v3h-3v-3h-2v3h-3v-3h-2.1c-.46 2.28-2.48 4-4.9 4zm0-7c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg>',paste:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M19 2h-4.18C14.4 .84 13.3 0 12 0c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm7 18H5V4h2v3h10V4h2v16z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a.996.996 0 0 0 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>',trash:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg>',eraser:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M15.14 3c-.51 0-1.02.2-1.41.59L2.59 14.73c-.78.78-.78 2.05 0 2.83L6.44 21.4c.78.78 2.05.78 2.83 0l11.14-11.14c.78-.78.78-2.05 0-2.83l-3.86-3.84c-.39-.39-.9-.59-1.41-.59zm.71 2.71l3.15 3.15-3.15 3.15-3.15-3.15 3.15-3.15zm-4.57 4.57l3.15 3.15-4.57 4.57H6.71l-3-3 7.57-7.57z"/></svg>',save:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4zm-5 16c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm3-10H5V5h10v4z"/></svg>',analyze:'<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2L3 14h8l-2 8 12-12h-8l2-8z"/></svg>',apply:'<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/></svg>',close:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z"/></svg>',chevronRight:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>',chevronLeft:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg>',eye:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>',eyeOff:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.44-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.17c0-1.66-1.34-3-3-3l-.17.02z"/></svg>',check:'<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>',clock:'<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>',copy:'<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>',refresh:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',chip:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M6 4h12v16H6V4zm2 2v12h8V6H8zm-4 3h2v2H4V9zm0 4h2v2H4v-2zm16-4h2v2h-2V9zm0 4h2v2h-2v-2zM9 2h2v2H9V2zm4 0h2v2h-2V2zm-4 18h2v2H9v-2zm4 0h2v2h-2v-2z"/></svg>',moreVertical:'<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg>',minimize:'<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13H5v-2h14v2z"/></svg>',maximize:'<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z"/></svg>',dragHandle:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M10 9h4V6h-4v3zm0 5h4v-3h-4v3zm0 5h4v-3h-4v3zM4 9h4V6H4v3zm0 5h4v-3H4v3zm0 5h4v-3H4v3zm12-10V6h4v3h-4zm0 5h4v-3h-4v3zm0 5h4v-3h-4v3z"/></svg>',list:'<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/></svg>',folderTree:'<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-6 10H6v-2h8v2zm4-4H6v-2h12v2z"/></svg>',folder:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',file:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>'};var ce=class{element=null;shadow;isMinimized=!1;currentPlan=null;isDragging=!1;dragStartX=0;dragStartY=0;initialLeft=25;initialTop=25;onAdvanceCallback;constructor(e,t){this.shadow=e,this.onAdvanceCallback=t,this.initGlobalListeners()}initGlobalListeners(){window.addEventListener("popstate",()=>this.handlePageNavigated()),window.addEventListener("hashchange",()=>this.handlePageNavigated()),document.addEventListener("click",e=>{if(!this.isOpen())return;let t=e.target;if(!t||this.shadow.contains(t)||t.closest("#easyquiz-shadow-root"))return;let a=t.closest('button, [role="button"], a, input[type="submit"]');if(a){let n=(a.textContent||a.value||"").toLowerCase();/pr[oó]xim|avan[cç]|continu|verific|enviar|submit|confirm|checar|validar|next/i.test(n)&&setTimeout(()=>{this.isOpen()&&this.handlePageNavigated()},800)}},!0)}handlePageNavigated(){this.isOpen()&&(this.hide(),this.onAdvanceCallback?.())}isOpen(){return this.element!==null&&this.element.style.display!=="none"}show(e){this.currentPlan=e,this.element||this.createElement(),this.renderContent(),this.element&&(this.element.style.display="flex")}hide(){this.element&&(this.element.style.display="none")}minimize(){this.isMinimized=!0,this.element&&this.element.classList.add("minimized")}restore(){this.isMinimized=!1,this.element&&this.element.classList.remove("minimized")}createElement(){this.element=document.createElement("div"),this.element.className="eq-floating-hud",this.element.style.left=`${this.initialLeft}px`,this.element.style.top=`${this.initialTop}px`,this.element.innerHTML=`
      ...
      <div class="eq-fah-header" id="eq-fah-header">
        <div class="eq-fah-title">
          <span style="display:flex; align-items:center;">${v.dragHandle}</span>
          <span>Gabarito Manual Interativo</span>
        </div>
        <div class="eq-fah-actions">
          <button class="eq-fah-btn" id="eq-fah-copy-md-btn" title="Copiar tudo formatado em Markdown">${v.copy}</button>
          <button class="eq-fah-btn" id="eq-fah-min-btn" title="Minimizar para p\xEDlula flutuante">${v.minimize}</button>
          <button class="eq-fah-btn" id="eq-fah-close-btn" title="Fechar gabarito">${v.close}</button>
        </div>
      </div>
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let n=this.element.querySelector("#eq-fah-copy-md-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let s=this.element.querySelector("#eq-fah-copy-all-btn");s.addEventListener("click",()=>this.copyMarkdownToClipboard(s));let i=this.element.querySelector("#eq-fah-header");this.setupDraggable(i)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let n=this.element.getBoundingClientRect();this.initialLeft=n.left,this.initialTop=n.top;let s=r=>{if(!this.isDragging||!this.element)return;let c=r.clientX-this.dragStartX,l=r.clientY-this.dragStartY,h=Math.max(10,window.innerWidth-this.element.offsetWidth-10),u=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+c),h),p=Math.min(Math.max(10,this.initialTop+l),u);this.element.style.left=`${d}px`,this.element.style.top=`${p}px`},i=()=>{this.isDragging=!1,window.removeEventListener("mousemove",s),window.removeEventListener("mouseup",i)};window.addEventListener("mousemove",s),window.addEventListener("mouseup",i)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let n=this.currentPlan,s=n.actions.filter(d=>d.t==="drag"),i=n.actions.filter(d=>{if(d.t!=="val")return!1;let p=f(d.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),r=n.actions.filter(d=>d.t==="clk"||d.t==="chk"),c=s.length||i.length||r.length,l=document.createElement("div");l.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${n.mode.replace("_"," ")}`;let u=document.createElement("span");if(u.className="eq-fah-meta-badge",u.textContent=`${Math.round(n.confidence*100)}% Confian\xE7a`,l.append(h,u),e.appendChild(l),s.length>0||n.mode==="categorizacao"||n.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${s.length} itens)`,a.textContent=String(s.length);let d={};for(let p of s){let m=f(p.to)||"Geral";d[m]||(d[m]=[]),d[m].push(f(p.from))}for(let[p,m]of Object.entries(d)){let b=document.createElement("div"),q=/fato|true|verdadeiro|sim/i.test(p),g=/opini[aã]o|false|falso|n[aã]o/i.test(p);b.className=`eq-fah-group ${q?"group-fato":g?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${p} (${m.length})`,b.appendChild(x);let T=document.createElement("div");T.className="eq-fah-group-items";for(let C of m){let E=document.createElement("div");E.className="eq-fah-item";let z=document.createElement("span");z.className="eq-fah-item-text",z.textContent=C,E.appendChild(z);let P=document.createElement("button");P.className="eq-fah-copy-inline",P.textContent="Copiar",P.addEventListener("click",()=>{navigator.clipboard.writeText(C),P.textContent="\u2713 Copiado",setTimeout(()=>P.textContent="Copiar",1200)}),E.appendChild(P),T.appendChild(E)}b.appendChild(T),e.appendChild(b)}}else if(i.length>0){t.textContent=`Preenchimento (${i.length} campos)`,a.textContent=String(i.length);let d=document.createElement("div");d.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="Respostas para Inserir:",d.appendChild(p);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b of i){let q=document.createElement("div");q.className="eq-fah-item";let g=document.createElement("span");g.className="eq-fah-item-text";let x=Ae(b.id),C=/^[#\.\$]|input|mat-|cell|field|q[0-9]/i.test(x)?"":x;g.textContent=`${C?`${C}: `:""}${b.v}`,q.appendChild(g);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(String(b.v)),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),q.appendChild(E),m.appendChild(q)}d.appendChild(m),e.appendChild(d)}else if(r.length>0){t.textContent=`Op\xE7\xF5es (${r.length} marcadas)`,a.textContent=String(r.length);let d=document.createElement("div");d.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="Alternativa(s) Correta(s):",d.appendChild(p);let m=document.createElement("div");m.className="eq-fah-group-items";for(let b of r){let q=document.createElement("div");q.className="eq-fah-item";let g=document.createElement("span");g.className="eq-fah-item-text";let x=Ae(b.id);/^[#\.\$]|opt|choice|radio|chk|q[0-9]/i.test(x)&&b.v&&(x=String(b.v)),g.textContent=`\u2611 ${x}`,q.appendChild(g);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(x),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),q.appendChild(T),m.appendChild(q)}d.appendChild(m),e.appendChild(d)}else{t.textContent="Gabarito",a.textContent="0";let d=document.createElement("div");d.style.padding="10px",d.style.color="#888",d.textContent="Nenhuma resposta direta para exibir.",e.appendChild(d)}if(n.rationale){let d=document.createElement("div");d.className="eq-fah-rationale",d.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${n.rationale}`,e.appendChild(d)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(i=>i.t==="drag"),n=e.actions.filter(i=>i.t==="val"),s=e.actions.filter(i=>i.t==="clk"||i.t==="chk");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let r of a){let c=f(r.to)||"Geral";i[c]||(i[c]=[]),i[c].push(f(r.from))}for(let[r,c]of Object.entries(i)){t.push(`### Categoria: ${r}`);for(let l of c)t.push(`- ${l}`);t.push("")}}else if(n.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of n){let r=f(i.id);t.push(`- **${r||"Campo"}:** \`${i.v}\``)}t.push("")}else if(s.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i of s)t.push(`- [x] ${f(i.id)}`);t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let a=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=a},1500)})}};var nt=`
...
`;var Mt=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Lt=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],de=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestPromptText="";liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new le({onStatusChange:(n,s,i)=>{this.logToConsole(s,i),n==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(n==="advancing"||n==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async n=>{try{return await this.callbacks.onAnalyze(n)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
      ...
      <button class="eq-launcher" type="button" title="Abrir / Recolher EasyQuiz (Alt+Q)">
        <span class="eq-launcher-icon">${v.logo}</span>
        <span>EasyQuiz</span>
      ...
      <aside class="eq-sidebar" aria-label="EasyQuiz Sidebar">
        ...
        <button class="eq-dock-toggle" id="eq-dock-toggle" type="button" title="Recolher / Expandir Painel (Alt+Q)">
          <span class="eq-dock-toggle-icon">${v.chevronRight}</span>
          ...
          <nav class="eq-activity-bar" role="tablist" aria-label="Atalhos">
            ...
            <div class="eq-activity-bottom">
              <button class="eq-activity-btn" id="eq-tab-settings" role="tab" title="Configura\xE7\xF5es e Ajustes Avan\xE7ados">
                <span class="eq-activity-indicator"></span>
                <span class="eq-activity-icon">${v.settings}</span>
              </button>
            </div>
          </nav>
          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                <span class="eq-brand-icon">${v.logo}</span>
                <span class="eq-brand-name">EasyQuiz</span>
                <span class="eq-brand-badge">2.0 SUPREME</span>
              </div>
              <div class="eq-header-tools">
                <button class="eq-icon-btn" id="eq-min-btn" type="button" title="Minimizar (Alt+Q)">${v.chevronRight}</button>
                <button class="eq-icon-btn" id="eq-close-btn" type="button" title="Fechar">${v.close}</button>
              </div>
            </header>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-operation-actions">
                  <button class="eq-btn-primary" id="eq-analyze-btn" type="button">${v.analyze} Analisar quest\xE3o</button>
                  <button class="eq-btn-secondary" id="eq-apply-btn" type="button">${v.apply} Aplicar respostas</button>
                </div>

                <div style="display: flex; gap: 8px; width: 100%; align-items: center;">
                  <button class="eq-btn-primary" id="eq-ap-toggle-btn" type="button" style="flex: 1;">
                    ${v.play} INICIAR AUTOPILOT
                  </button>
                </div>
                ...
                <div id="eq-result" class="eq-operation-result" style="display: none; flex-direction: column; gap: 10px;">
                  ...
                  <button class="eq-btn-secondary" id="eq-open-hud-btn" type="button">${v.list} Abrir respostas dispon\xEDveis</button>
                </div>
              ...
              <div class="eq-view-pane" id="eq-view-settings" style="display: none;">
                ...
                <div class="eq-field-group">
                  ...
                  <div class="eq-key-input-container">
                    <div class="eq-input-wrap">
                      <span class="eq-input-prefix-icon">${v.key}</span>
                      ...
                      <button class="eq-icon-btn" id="eq-key-save" type="button" title="Salvar Chave">${v.save}</button>
                      <button class="eq-icon-btn" id="eq-key-more-btn" type="button" title="Mais Op\xE7\xF5es da Chave">${v.moreVertical}</button>
                    </div>
                    ...
                    <div class="eq-context-menu" id="eq-key-context-menu" hidden>
                      <button class="eq-context-item" id="eq-menu-prompt" type="button">
                        <span class="eq-item-icon">${v.edit}</span>
                      ...
                      <button class="eq-context-item" id="eq-menu-paste" type="button">
                        <span class="eq-item-icon">${v.paste}</span>
                ...
                <div class="eq-field-group" style="margin-top: 14px; padding-top: 12px; border-top: 1px solid #282828;">
                  ...
                  <button class="eq-btn-secondary" id="eq-reset-all-btn" type="button" style="border-color: #662222; color: #ff8888;">
                    ${v.trash} Resetar Todos os Dados e Mem\xF3ria
                  </button>
                </div>
