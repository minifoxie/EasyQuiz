 ...
 */
"use strict";(()=>{var W={apiKey:"",apiKeys:[],model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function B(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let n of t)if(e.includes(n))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var je="easyquiz_settings_v2",oe="easyquiz_activity_metrics";function Fe(){try{let o=localStorage.getItem(je);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...W,apiKey:s.apiKey||""}}return{...W}}let e=JSON.parse(o),t=typeof e.model=="string"&&B(e.model)?e.model:W.model,n=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return n.length===0&&i&&(n=[i]),{apiKey:n[0]||i||W.apiKey,apiKeys:n,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:W.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:W.confidenceThreshold}}catch{return{...W}}}function vt(){try{localStorage.removeItem(je),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(oe),sessionStorage.removeItem(oe);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ue()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function ve(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ge(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let n={...ve(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(n))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function yt(o){let e=Fe(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,n;typeof o.apiKey=="string"?n=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?n=t[0]||"":n=e.apiKey,n&&!t.includes(n)&&(t=[n,...t]),t.length>0&&(!n||!t.includes(n))&&(n=t[0]);let i={...e,...o,apiKey:n,apiKeys:t};try{localStorage.setItem(je,JSON.stringify(i))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var te=[],bt=12,jt=1200;function xt(o){let e=o.trim().replace(/\s+/g," ").slice(0,jt);e&&!te.includes(e)&&(te.push(e),te.length>bt&&(te=te.slice(-bt)))}function Se(){return te}function Ue(){te=[]}function wt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var be=wt();function le(){try{localStorage.removeItem(oe)}catch{}return be}function Ft(o){be=o;try{let e=JSON.stringify(o);sessionStorage.setItem(oe,e),localStorage.removeItem(oe)}catch{}}function Qe(o){let e=be,t=Date.now(),n=e.records[e.records.length-1];if(n&&n.id===o.id&&t-n.timestamp<3e3)return e;let i={...o,timestamp:t},a=[...e.records,i],l=a.filter(p=>p.status==="answered"||p.status==="verified").length,s=a.reduce((p,h)=>p+h.durationMs,0),r=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:r,records:a};return Ft(c),c}function ye(){be=wt();try{sessionStorage.removeItem(oe),localStorage.removeItem(oe)}catch{}return be}var qt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown ou conversa.
...
[MEM\xD3RIA]:
${s.join(" | ")}
`:"",c=o.controls.filter(m=>m.role!=="navigation"),p=o.controls.filter(m=>m.role==="navigation"),h=Gt(o.sourceUrl,o.htmlSnippet),u=h?`
${h}
`:"";return`--- AN\xC1LISE ---
