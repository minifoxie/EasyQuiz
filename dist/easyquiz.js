 ...
 */
"use strict";(()=>{var Ve=Object.defineProperty;var B=(t,e)=>()=>(t&&(e=t(t=0)),e);var fe=(t,e)=>{for(var a in e)Ve(t,a,{get:e[a],enumerable:!0})};var E,ve=B(()=>{"use strict";E={apiKey:"",model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8}});var be={};fe(be,{addSessionMemory:()=>Ge,clearSessionMemories:()=>V,getSessionMemories:()=>ie,loadDomainCache:()=>_,loadSettings:()=>N,resetAllData:()=>oe,saveDomainCache:()=>ae,saveSettings:()=>ne});function N(){try{let t=localStorage.getItem(te);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let i=JSON.parse(o);return{...E,apiKey:i.apiKey||""}}return{...E}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:E.model;return(a.includes("3.8")||a.includes("3.7")||a.includes("3.6")||a.includes("3.5")||a.includes("3.1"))&&(a=E.model),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():E.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:E.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:E.confidenceThreshold}}catch{return{...E}}}function oe(){try{localStorage.removeItem(te),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),V()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function _(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function ae(t,e){let o={..._(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function ne(t){let a={...N(),...t};try{localStorage.setItem(te,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}function Ge(t){let e=t.trim();e&&!D.includes(e)&&D.push(e)}function ie(){return D}function V(){D=[]}var te,D,T=B(()=>{"use strict";ve();te="easyquiz_settings_v2";D=[]});function v(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function m(t,e=500){return(t??"").replace(/\s+/g," ").trim().slice(0,e)}function Fe(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(Ke+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function le(t){let e=m(t.getAttribute("aria-label")||t.textContent||t.getAttribute("value")||t.value),a=t.type,o=e.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim();return L.test(o)||L.test(e)||a==="submit"||t.getAttribute("data-testid")?.toLowerCase().includes("next")||t.getAttribute("data-testid")?.toLowerCase().includes("check")||!1}function Ye(t){let e=t.getAttribute("aria-label");if(e)return m(e);let a=t.getAttribute("aria-labelledby");if(a){let s=a.split(/\s+/).map(n=>document.getElementById(n)?.textContent).filter(Boolean).join(" ");if(s.trim())return m(s)}if("labels"in t&&t.labels){let s=Array.from(t.labels??[]).map(n=>n.textContent).join(" ");if(s.trim())return m(s)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let s=m(o.textContent);if(s)return s}let i=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||t.value||"";return m(i)}function ce(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let i=t.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(i)?i:"other",n=t.getAttribute("role")||"",r=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item"),l=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category"),c=m((r?"draggable":l?"dropzone":"")||o.type||n||s,40),u="";o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox"?u=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked":u=m(o.value||t.getAttribute("data-category")||t.textContent||"",2e3);let h=[];if(a)for(let w of Array.from(a.options).slice(0,80))h.push({value:m(w.value),label:m(w.textContent)});let g=!!(o.required||t.getAttribute("aria-required")==="true"),f=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Fe(t),tag:s,type:c,label:Ye(t),name:m(o.name||t.getAttribute("name")||"",180),value:u,options:h,required:g,disabled:f,role:e}}var C,L,Ke,j=B(()=>{"use strict";C=['input:not([type="hidden"])',"textarea","select","button",'[role="button"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),L=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir)/i,Ke=0});var F={};fe(F,{captureCurrentContext:()=>k,captureFullPageText:()=>Je,expandToGeneralSelection:()=>Se,extractAnswerControls:()=>Ce,extractNavigationControls:()=>K,findActiveScope:()=>Ae,findTrueQuestionContainer:()=>U,sanitizeHtml:()=>de});function Te(t){if(!v(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(C)).filter(v),o=m(t.innerText,4e3).length;if(o<10||!a.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),s=Math.max(1,e.width*e.height),n=Math.min(1,s/i),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),d=o>40?35:0,c=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+d+c-n*20-l*10}function U(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let i=m(e.innerText,1e4),s=m(a.innerText,1e4),n=e.querySelectorAll(C).length,r=a.querySelectorAll(C).length;if(i.length<150&&s.length>i.length&&r<=n+4){e=a;continue}break}return e}function Se(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&v(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Ae(){let t=document.activeElement;if(t&&t!==document.body){let i=t.closest(qe);if(i&&Te(i)>0)return U(i)}let a=Array.from(document.querySelectorAll(qe)).map(i=>({element:i,score:Te(i)})).filter(i=>Number.isFinite(i.score)).sort((i,s)=>s.score-i.score);if(a.length>0&&a[0].score>0)return U(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&v(o)?o:document.body}function de(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))a.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ce(t){return Array.from(t.querySelectorAll(C)).filter(e=>v(e)&&!le(e)).slice(0,100).map(e=>ce(e,"answer"))}function K(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let i of e)for(let s of Array.from(i.querySelectorAll(C)))if(!(a.has(s)||!v(s)||!le(s))&&(a.add(s),o.push(ce(s,"navigation")),o.length>=10))return o;return o}function k(t=!1){let e=Ae();e=U(e),t&&(e=Se(e));let a=m(e.innerText,16e3),o=Ce(e),i=K(e);i.length===0&&(i=K(document.body));let s=[...o,...i].slice(0,120);return!a||s.length===0&&a.length<30?null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:de(e),controls:s,scope:e}}function Je(){let t=document.body.innerText||document.documentElement.innerText,e=m(t,8e3),a=K(document.body),o=document.querySelector('main, article, [role="main"]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina Inteira",questionText:e,htmlSnippet:de(o).slice(0,1e4),controls:a,scope:o}}var qe,M=B(()=>{"use strict";j();qe=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",")});T();var ye=`Voc\xEA \xE9 o EasyQuiz Engine v4.8 Supreme. Responda estritamente em JSON v\xE1lido.
...
- { "t": "adv" } (aciona bot\xE3o de avan\xE7o/pr\xF3xima)`;function xe(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),s=t.questionText.length<120||o||t.controls.length<3?`
...
Responda estritamente em JSON.`}var S=[{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Padr\xE3o Oficial 2026)",description:"Mais r\xE1pido, econ\xF4mico e amplamente dispon\xEDvel em contas Google AI Studio."},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Gera\xE7\xE3o 3 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Compatibilidade Ampla)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],Qe={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function je(t){return t.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function we(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Ue(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let i of o)try{let s=JSON.parse(i);if(s&&typeof s=="object")return s}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var G=null,se=new Set;async function Q(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return S;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let n=await i.text(),r=we(n,i.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let s=await i.json();if(Array.isArray(s.models)&&s.models.length>0){let n=s.models.filter(r=>{let l=r.supportedGenerationMethods||[],d=(r.name||"").includes("gemini"),c=l.includes("generateContent"),u=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return d&&c&&!u}).map(r=>{let l=r.name.replace(/^models\//,""),d=r.displayName||l;return{id:l,name:d.includes(l)?d:`${d} (${l})`,description:r.description||""}});if(n.length>0)return n.sort((r,l)=>{let d=c=>c==="gemini-2.5-flash"?100:c==="gemini-3.5-flash"?95:c==="gemini-3.1-flash-lite"?90:c==="gemini-2.5-pro"?85:c==="gemini-3.1-pro"?80:c==="gemini-1.5-flash"?60:c.includes("flash")?50:10;return d(l.id)-d(r.id)}),G=n,n}}catch(i){if(i.message?.includes("Chave de API"))throw i}return S}async function Ee(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await Q(e);if(o.length>0&&o!==S){let i=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let i of["v1beta","v1"]){let s=`https://generativelanguage.googleapis.com/${i}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${i})!`,models:S}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function re(t,e,a,o){let i=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!i)throw new Error("Chave de API n\xE3o configurada.");let s=je(a.model);if(!G||G.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await Q(i)}catch(g){let f=g instanceof Error?g.message:String(g);if(f.includes("inv\xE1lida")||f.includes("n\xE3o autorizada"))throw new Error(f)}let n=Date.now(),r=xe(t,e,a),l=[{text:r}];for(let g of e)l.push({inline_data:{mime_type:g.mediaType,data:g.base64}});let d={system_instruction:{parts:[{text:ye}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:Qe}},c=[s,...G?.map(g=>g.id)||[],"gemini-2.5-flash","gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],u=Array.from(new Set(c)).filter(g=>!se.has(g));u.length===0&&(se.clear(),u.push(...S.map(g=>g.id)));let h=new Error("Nenhum modelo tentado.");for(let g=0;g<u.length;g++){let f=u[g],w=u[g+1];o?.(`Aguardando resposta da API (${f})...`,"info");let Oe=["v1beta","v1"];for(let A of Oe){let O=`https://generativelanguage.googleapis.com/${A}/models/${f}:generateContent?key=${encodeURIComponent(i)}`,$=new AbortController,ge=setTimeout(()=>$.abort(),35e3);try{let q=await fetch(O,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":i},body:JSON.stringify(d),signal:$.signal});if(clearTimeout(ge),!q.ok){let Ne=await q.text(),_e=we(Ne,q.status);if(q.status===404&&A==="v1beta")continue;throw new Error(_e)}let Z=await q.json(),ee=Z.candidates?.[0];if(!ee||!ee.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let De=ee.content.parts[0].text,x=Ue(De);return Array.isArray(x.actions)||(x.actions=[]),Array.isArray(x.warnings)||(x.warnings=[]),typeof x.confidence!="number"&&(x.confidence=.8),x.usedModel=f,x.durationMs=Date.now()-n,x.promptSent=r,x.tokensUsed=Z.usageMetadata?.totalTokenCount,f!==s&&o?.(`Resolvido com sucesso pelo fallback '${f}' (${A})!`,"info"),{plan:x,rawUsage:Z.usageMetadata,usedModel:f}}catch(q){if(clearTimeout(ge),h=q,h.message.includes("inv\xE1lida")||h.message.includes("n\xE3o autorizada"))throw h}}let $e=h.message.includes("429")||h.message.includes("cota"),Be=h.message.includes("503")||h.message.includes("sobrecarregado");if(h.message.includes("404")&&se.add(f),w){let A=$e?3500:Be?2500:900,O=`Modelo '${f}' indispon\xEDvel (${h.message}). Aguardando ${A/1e3}s antes de alternar para '${w}'...`;console.warn(`[EasyQuiz Fallback] ${O}`),o?.(O,"warning"),await new Promise($=>setTimeout($,A))}else console.warn(`[EasyQuiz Fallback] Modelo '${f}' falhou: ${h.message}. Todos os modelos esgotados.`)}throw h}T();M();T();j();function b(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o)return o;try{if(o=document.querySelector(e),o)return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o)return o}catch{}try{let n=e.replace(/"/g,""),r=`//*[normalize-space(text())="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(r,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let d=l.singleNodeValue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||d}}catch{}let i=m(e).toLowerCase().replace(/['"“”«»]/g,""),s=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of s){if(!v(n))continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,""),d=m(n.getAttribute("data-category")).toLowerCase().replace(/['"“”«»]/g,""),c=m(n.value).toLowerCase();if(r===i||l===i||d===i||c===i)return n.closest('button, [role="button"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], li')||n}if(i.length>=3)for(let n of s){if(!v(n)||n.children.length>5)continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,"");if(r.includes(i)||l.includes(i))return n.closest('button, [role="button"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], li')||n}return null}function I(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function y(t,e){let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let n=t.getBoundingClientRect();a=n.left+n.width/2,o=n.top+n.height/2}try{t.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{t.focus?.()}catch{}let i={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};t.dispatchEvent(new PointerEvent("pointerdown",{...i,isPrimary:!0,button:0,buttons:1})),t.dispatchEvent(new MouseEvent("mousedown",{...i,button:0,buttons:1})),t.dispatchEvent(new PointerEvent("pointerup",{...i,isPrimary:!0,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("mouseup",{...i,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...i,button:0,buttons:0}));try{t.click()}catch{}let s=t.querySelector('input[type="radio"], input[type="checkbox"]');if(s&&s!==t)try{s.click()}catch{}}function Me(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let i=t._valueTracker;i&&i.setValue("")}catch{}let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,I(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,I(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function Le(t,e){let a=t instanceof HTMLInputElement?t:t.querySelector('input[type="checkbox"], input[type="radio"]');if(a&&["checkbox","radio"].includes(a.type)){if(a.checked!==e&&a.click(),a.checked!==e){try{let s=a._valueTracker;s&&s.setValue("")}catch{}Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e),I(a,["input","change"])}return}let o=t.getAttribute("role");if(o==="radio"||o==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(y(t),t.setAttribute("aria-checked",e?"true":"false"),I(t,["input","change"]));return}y(t)}function Xe(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);I(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function We(){let t={};return{dropEffect:"move",effectAllowed:"all",files:[],items:[],types:["text/plain"],clearData:e=>{e?delete t[e]:Object.keys(t).forEach(a=>delete t[a])},getData:e=>t[e]||"",setData:(e,a)=>{t[e]=a},setDragImage:()=>{}}}async function pe(t,e){let a=t.getBoundingClientRect(),o=e.getBoundingClientRect(),i=a.left+a.width/2,s=a.top+a.height/2,n=o.left+o.width/2,r=o.top+o.height/2;y(t,[i,s]),await new Promise(h=>setTimeout(h,120)),y(e,[n,r]);let l=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], ul');l&&l!==e&&y(l),await new Promise(h=>setTimeout(h,100));let d={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:s,button:0,buttons:1};t.dispatchEvent(new PointerEvent("pointerdown",{...d,isPrimary:!0})),t.dispatchEvent(new MouseEvent("mousedown",d));for(let h=1;h<=3;h++){let g=i+(n-i)*(h/3),f=s+(r-s)*(h/3),w={...d,clientX:g,clientY:f};t.dispatchEvent(new PointerEvent("pointermove",{...w,isPrimary:!0})),document.dispatchEvent(new MouseEvent("mousemove",w))}let c={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,button:0,buttons:0};e.dispatchEvent(new PointerEvent("pointerup",{...c,isPrimary:!0})),e.dispatchEvent(new MouseEvent("mouseup",c));let u=We();u.setData("text/plain",t.textContent||""),u.setData("text/html",t.outerHTML),t.dispatchEvent(new DragEvent("dragstart",{...d,dataTransfer:u})),e.dispatchEvent(new DragEvent("dragenter",{...c,dataTransfer:u})),e.dispatchEvent(new DragEvent("dragover",{...c,dataTransfer:u})),e.dispatchEvent(new DragEvent("drop",{...c,dataTransfer:u})),t.dispatchEvent(new DragEvent("dragend",{...d,dataTransfer:u}));try{let h=new Touch({identifier:1,target:t,clientX:i,clientY:s}),g=new Touch({identifier:1,target:e,clientX:n,clientY:r});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[h]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}}var Ie={fill:(t,e)=>{let a=b(t);a?Me(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=b(t);e?y(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=b(t);a?Le(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=b(t),o=b(e);a&&o?pe(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=b(t),o=b(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await pe(a,o)}};window.$eq=Ie;async function ke(t){if(t.t==="js"){let o=String(t.v||"");try{new Function("$eq","document","window",o)(Ie,document,window)}catch(i){console.warn("[EasyQuiz JS Execution]",i)}return}if(t.t==="drag"){let o=b(t.from),i=b(t.to);o&&i?await pe(o,i):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let e=t.id||"",a=b(e);if(!a&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${e}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":a&&Me(a,String(t.v));break;case"chk":a&&Le(a,!!t.c);break;case"sel":if(a){let i=Array.isArray(t.v)?t.v:[String(t.v)];Xe(a,i)}break;case"clk":a&&y(a,t.co);break;case"adv":let o=a;if(!o){let i=Array.from(document.querySelectorAll('button, a, input[type="submit"]')).filter(s=>L.test(s.textContent||s.value||""));i.length&&(o=i[0])}if(o){let i=t.id||o.textContent?.trim()||o.value?.trim()||"";i&&ae(window.location.hostname,{advanceSelector:i}),y(o)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}async function He(t,e){let a=t.actions.filter(s=>s.t!=="adv"),o=t.actions.filter(s=>s.t==="adv");for(let s of a)await ke(s),s.t==="drag"&&await new Promise(n=>setTimeout(n,380));let i=!1;if(e){let s=t.pageType==="info"?void 0:Array.from(document.querySelectorAll('button, [role="button"], input[type="submit"], a')).find(n=>/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(n.textContent||n.value||n.getAttribute("aria-label")||""));if(s&&v(s)&&(y(s),await new Promise(n=>setTimeout(n,800))),o.length>0)await new Promise(n=>setTimeout(n,400)),await ke(o[0]),i=!0;else if(s||t.pageType==="info"||t.pageType==="start"){await new Promise(r=>setTimeout(r,500));let n=Array.from(document.querySelectorAll('button, [role="button"], a, input[type="submit"]')).find(r=>L.test(r.textContent||r.value||r.getAttribute("aria-label")||""));n&&v(n)&&(y(n),i=!0)}}return{applied:a.length,advanced:i}}var H=null,z=[];function P(){H&&(H.style.removeProperty("outline"),H.style.removeProperty("outline-offset"),H=null);for(let t of z)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");z=[]}function ue(t){P(),H=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function ze(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let s=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);s&&(s.style.outline="2px solid #00ff88",z.push(s)),n&&(n.style.outline="2px dashed #00e5ff",z.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let i=o.closest('label, [role="listitem"], .answer, .form-check')||o;i.style.outline="2px solid #00ff88",i.style.outlineOffset="2px",i.style.backgroundColor="rgba(0, 255, 136, 0.08)",z.push(i)}}j();var R=4,Ze=1200,he=12e5;function Y(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function J(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Ze/Math.max(e,a)),i=Math.max(1,Math.round(e*o)),s=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=i,n.height=s;let r=n.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,s),r.drawImage(t,0,0,i,s),new Promise((l,d)=>{n.toBlob(c=>c?l(c):d(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function Pe(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,i=`
...
`;var tt=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],ot=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],W=class{host;shadow;callbacks;autopilot;initialSettings;isCollapsed=!1;activeTab="autopilot";stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,a){this.initialSettings=e,this.callbacks=a,this.autopilot=new X({onStatusChange:(o,i,s)=>{this.logToConsole(i,s),o==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(o==="advancing"||o==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async()=>{try{return await this.callbacks.onAnalyze()||null}catch{return null}}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
    ...
    `;let i=this.shadow.querySelector("#eq-rationale-text");i.textContent=e.rationale;let s=this.shadow.querySelector("#eq-actions-list");s.innerHTML="";for(let n of e.actions){let r=document.createElement("div");r.className="eq-action-item";let l="";n.t==="chk"?l=`chk ${n.id} (${n.c})`:n.t==="val"?l=`val "${n.v}" -> ${n.id}`:n.t==="sel"?l=`sel "${Array.isArray(n.v)?n.v.join(","):n.v}" -> ${n.id}`:n.t==="clk"?l=`clk ${n.id}`:n.t==="adv"?l="adv":n.t==="js"?l=`js: ${String(n.v).slice(0,40)}...`:n.t==="drag"&&(l=`drag "${n.from}" -> "${n.to}"`),r.innerHTML=`<span class="eq-action-badge">${n.t.toUpperCase()}</span> <span>${l}</span>`,s.appendChild(r)}if(this.applyBtn.disabled=!a||!e.actions.length,this.inspModel.textContent=e.usedModel||this.initialSettings.model,this.inspLatency.textContent=e.durationMs?`${e.durationMs}ms`:"--",this.inspTokens.textContent=e.tokensUsed?`${e.tokensUsed}`:"--",this.inspPrompt.textContent=e.promptSent||"Prompt n\xE3o registrado para esta requisi\xE7\xE3o.",this.inspRationale.textContent=e.rationale,this.inspActions.innerHTML="",e.actions.length>0)for(let n of e.actions){let r=document.createElement("div");r.className="eq-action-item",r.textContent=JSON.stringify(n),this.inspActions.appendChild(r)}else this.inspActions.innerHTML='<div class="text-muted" style="padding: 4px;">Nenhuma a\xE7\xE3o prescrita pela IA.</div>'}updateModelSelect(e,a){let o=a||this.initialSettings.model||this.modelSelect.value;this.modelSelect.innerHTML="";let i=!1;e.forEach(s=>{let n=s.id===o;n&&(i=!0),this.modelSelect.add(new Option(s.name,s.id,!1,n))}),!i&&o&&this.modelSelect.add(new Option(`Gemini (${o})`,o,!1,!0)),this.modelSelect.value=o}updateSelectedModel(e){Array.from(this.modelSelect.options).some(o=>o.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}applyHostDarkMode(e){let a="eq-host-dark-mode-style",o=document.getElementById(a);if(e){let i=window.getComputedStyle(document.body).backgroundColor;(i.includes("rgba(0, 0, 0, 0)")||i==="transparent")&&(i=window.getComputedStyle(document.documentElement).backgroundColor);let s=i.match(/\d+(\.\d+)?/g);if(s&&s.length>=3&&(s[3]!==void 0?parseFloat(s[3]):1)>.1){let r=parseInt(s[0]),l=parseInt(s[1]),d=parseInt(s[2]);if((r*299+l*587+d*114)/1e3<100)return}o||(o=document.createElement("style"),o.id=a,o.innerHTML=`
        ...
        `,document.head.appendChild(o)),this.host.classList.add("eq-dark-mode-active")}else this.host.classList.remove("eq-dark-mode-active"),o&&o.remove()}destroy(){this.stopStopwatch(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function at(){let t=window;if(t.__easyquiz){t.__easyquiz.toggle();return}let e=N(),a=null,o=new W(e,{onAnalyze:()=>i(),onApply:()=>void s(),onDestroy:()=>{P(),delete t.__easyquiz},onSettingsChange:n=>{e=ne(n)}});t.__easyquiz={toggle:()=>o.toggle(),destroy:()=>o.destroy(),analyze:()=>void i()},window.addEventListener("keydown",n=>{if(n.altKey&&(n.key==="q"||n.key==="Q")){if(n.preventDefault(),!o)return;o.toggle(!0),i()}});async function i(){if(!e.apiKey){o.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),o.toggle(!0);return}o.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),P();try{let n=k(!1);if(!n){o.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info");let{captureFullPageText:c}=await Promise.resolve().then(()=>(M(),F));n=c()}ue(n.scope),o.setStatus(`Quest\xE3o localizada (${n.controls.length} controles). Preparando an\xE1lise...`,"info");let r=await me(n.scope,e.useVision);o.setStatus(r.length>0?`Consultando Gemini (${e.model}) com ${r.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${e.model}) via DOM nativo (modo r\xE1pido)...`,"info");let{plan:l,usedModel:d}=await re(n,r,e,(c,u)=>{o.setStatus(c,u==="warning"?"info":u)});if(l.needsMoreContext){if(o.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n=k(!0),!n){let{captureFullPageText:u}=await Promise.resolve().then(()=>(M(),F));n=u()}ue(n.scope),r=await me(n.scope,e.useVision),o.setStatus(`Reconsultando IA com escopo ampliado (${n.controls.length} controles)...`,"info"),l=(await re(n,r,e,(u,h)=>{o.setStatus(u,h==="warning"?"info":h)})).plan}if(l.memoryToStore){let{addSessionMemory:c}=await Promise.resolve().then(()=>(T(),be));c(l.memoryToStore),console.log("[EasyQuiz] Mem\xF3ria de sess\xE3o armazenada:",l.memoryToStore)}return a=l,ze(l.actions),o.setPlan(l,!e.dryRun),l.pageType==="conclusion"?o.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success"):l.pageType==="info"?o.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success"):l.pageType==="start"?o.setStatus("In\xEDcio de atividade detectado. Iniciando...","info"):o.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success"),e.autoApply&&!e.dryRun&&await s(),l}catch(n){P();let r=n instanceof Error?n.message:"Falha desconhecida na an\xE1lise.";o.setStatus(r,"error");return}finally{o.setBusy(!1)}}async function s(){if(!a){o.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){o.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let n=a.pageType==="info"||a.pageType==="start",r=(e.autoAdvance||n)&&a.confidence>=e.confidenceThreshold&&!a.needsMoreContext;o.setBusy(!0,"Aplicando respostas no formul\xE1rio...");try{let l=await He(a,r);o.setStatus(`Sucesso: ${l.applied} resposta(s) preenchida(s)${l.advanced?" e pr\xF3xima quest\xE3o acionada":""}.`,"success")}catch(l){let d=l instanceof Error?l.message:"Falha ao aplicar plano.";o.setStatus(d,"error")}finally{o.setBusy(!1)}}o.toggle(!0)}at().catch(t=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",t),window.alert(`EasyQuiz: falha ao iniciar: ${t instanceof Error?t.message:String(t)}`)});})();
