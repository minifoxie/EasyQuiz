 ...
 */
"use strict";(()=>{var te={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function G(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ve="easyquiz_settings_v2",re="easyquiz_activity_metrics";function _e(){try{let o=localStorage.getItem(Ve);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...te,apiKey:s.apiKey||""}}return{...te}}let e=JSON.parse(o),t=typeof e.model=="string"&&G(e.model)?e.model:te.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&r&&(a=[r]),{apiKey:a[0]||r||te.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:te.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:te.confidenceThreshold}}catch{return{...te}}}function ht(){try{localStorage.removeItem(Ve),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(re),sessionStorage.removeItem(re);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ue()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function ve(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ke(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...ve(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function gt(o){let e=_e(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ve,JSON.stringify(r))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var se=[],mt=12,Kt=1200;function ft(o){let e=o.trim().replace(/\s+/g," ").slice(0,Kt);e&&!se.includes(e)&&(se.push(e),se.length>mt&&(se=se.slice(-mt)))}function Me(){return se}function Ue(){se=[]}function bt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var be=bt();function ye(){try{localStorage.removeItem(re)}catch{}return be}function Ut(o){be=o;try{let e=JSON.stringify(o);sessionStorage.setItem(re,e),localStorage.removeItem(re)}catch{}}function vt(o){let e=be,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],l=n.filter(u=>u.status==="answered"||u.status==="verified").length,s=n.reduce((u,p)=>u+p.durationMs,0),i=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:i,records:n};return Ut(c),c}function xe(){be=bt();try{sessionStorage.removeItem(re),localStorage.removeItem(re)}catch{}return be}var yt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function qe(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(g=>g.type==="draggable"||g.type==="dropzone"),r=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),l=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(g=>g.role==="answer").length===0),s=o.controls.filter(g=>g.role!=="navigation").length===0,i=s||a||n||l||r&&o.questionText.length<60,c=s?4500:l?6e3:1800,u=i?`
[HTML]:
${o.htmlSnippet.slice(0,c).replace(/\s+/g," ")}`:"",p="";if(s&&typeof document<"u")try{let g=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(h=>{let v=h,T=v.getBoundingClientRect?.()||{width:0,height:0};return T.width>0&&T.height>0&&!v.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(h=>{let v=h,T=v.tagName.toLowerCase(),S=v.id?`#${v.id}`:"",w=v.className&&typeof v.className=="string"?`.${v.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",E=(v.textContent||v.value||v.getAttribute("aria-label")||"").trim().slice(0,60),I=v.getAttribute("type")||v.getAttribute("role")||"";return`${T}${S}${w}[${I}] txt="${E}"`});g.length>0&&(p=`
[DOM-INTERATIVO]:
${g.join(`
`)}`)}catch{}let d=Me(),m=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
...
`:"")+JSON.stringify(b.map(C=>({id:C.id,t:C.type,n:C.name||void 0,txt:C.label?C.label.length>160?C.label.slice(0,160)+"...":C.label:void 0,v:C.value||void 0,opt:C.options&&C.options.length?C.options.slice(0,20).map(N=>N.label||N.value):void 0})))})()}
...
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Gt=new Set(["question","info","start","conclusion"]),Ft=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Qt=new Set(["val","chk","sel","clk","adv","js","drag"]),Yt=150,we=2e3;function F(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,we):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,we):e}function Jt(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!Qt.has(a))return null;if(a==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...F(s)?{id:F(s,"").slice(0,500)}:{}}}if(a==="drag"){let s=F(t.from??t.source),i=F(t.to??t.target??t.destination);return!s||!i?null:{t:"drag",from:s.slice(0,500),to:i.slice(0,500)}}if(a==="js"){let s=F(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let r=t.id??t.target??t.name??t.selector??t.element;(r==null||r==="")&&a==="val"&&(r="1");let n=F(r).slice(0,500);if(!n)return null;if(a==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:F(s).slice(0,we)}}if(a==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,c=(Array.isArray(s)?s:[s]).map(u=>F(u).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:c}}if(a==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",i={t:"chk",id:n,c:!s};return t.v!==void 0&&(i.v=F(t.v).slice(0,we)),i}let l={t:"clk",id:n};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";l.c=!s}return t.v!==void 0&&(l.v=F(t.v).slice(0,we)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(l.co=[t.co[0],t.co[1]]),l}function Wt(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),r=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){r=r.filter(l=>!(l.t==="chk"&&l.c===!1||l.t==="clk"&&l.c===!1));let n=r.filter(l=>l.t==="chk"||l.t==="clk");if(n.length>1){let l=r.filter(i=>i.t!=="chk"&&i.t!=="clk"),s=n[n.length-1];r=[...l,s]}}else if(e==="escolha_multipla"){r=r.filter(l=>!(l.t==="chk"&&l.c===!1||l.t==="clk"&&l.c===!1));let n=new Set;r=r.filter(l=>{let s="id"in l&&typeof l.id=="string"?l.id:"";return s?n.has(s)?!1:(n.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,l=[...r].reverse(),s=[];for(let i of l){let c="id"in i&&typeof i.id=="string"?i.id:"";c?n.has(c)||(n.add(c),s.push(i)):s.push(i)}r=s.reverse()}return[...r,...a]}function xt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!Gt.has(t))&&(t="question"),(typeof a!="string"||!Ft.has(a))&&(a="escolha_unica");let r=Array.isArray(e.actions)?e.actions:[],n=[];for(let i=0;i<Math.min(r.length,Yt);i++){let c=Jt(r[i],i);c&&n.push(c)}n.some(i=>i.t==="val")&&(a==="escolha_unica"||!e.mode)&&(a="preenchimento"),n.some(i=>i.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(a)&&(a="arrastar_soltar"),n=Wt(n,a,t);let l=n.some(i=>i.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?l||n.push({t:"adv"}):t==="question"&&!l&&n.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:s,rationale:F(e.rationale,"Plano validado e auto-recuperado."),actions:n,...F(e.memoryToStore)?{memoryToStore:F(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var W=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let a=e.flatMap(n=>n.split(/[\n\r]+/));Array.from(new Set(a.map(n=>n.trim().replace(/^["']|["']$/g,"")).filter(n=>n.length>5))).forEach((n,l)=>{let s=this.generateId(n),i=t.get(s)||t.get(n);this.keys.set(s,{id:s,key:n,label:i?.label||`Chave ${l+1}`,addedAt:i?.addedAt||Date.now(),lastUsedAt:i?.lastUsedAt,lastLatencyMs:i?.lastLatencyMs,cooldownUntil:i?.cooldownUntil,errorCount:i?.errorCount||0,lastError:i?.lastError,winCount:i?.winCount||0})})}generateId(e){let t=0;for(let r=0;r<e.length;r++)t=(t<<5)-t+e.charCodeAt(r),t|=0;let a=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${a}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),a=Array.from(this.keys.values()).filter(n=>(n.errorCount||0)<50);if(a.length===0)return Array.from(this.keys.values()).slice(0,e);let r=a.filter(n=>(n.cooldownUntil||0)<=t);return r.length>0?(r.sort((n,l)=>(n.lastUsedAt||0)-(l.lastUsedAt||0)),r.slice(0,e)):(a.sort((n,l)=>(n.cooldownUntil||0)-(l.cooldownUntil||0)),a.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let r=this.generateId(a);if(this.keys.has(r)||Array.from(this.keys.values()).some(s=>s.key===a))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let l={id:r,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(r,l),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:l}}updateKey(e,t,a){let r=this.keys.get(e);if(!r)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(r.key=n,a!==void 0&&(r.label=a.trim()),r.errorCount=0,r.cooldownUntil=void 0,r.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},H=new W;var de=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],wt=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],Xt={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function Et(o){return Xt[o]??o}function Zt(o,e){let a={temperature:0,maxOutputTokens:1800,responseMimeType:"application/json",responseSchema:e??eo};return/lite/i.test(o)||(/gemini-3\.[0-9]+-?flash/i.test(o)?a.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(o)&&(a.thinkingConfig={thinkingBudget:0})),a}var eo={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Tt(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");return!e||!G(e)?"gemini-3.5-flash-lite":e}function Ge(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function to(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}try{let r=e.indexOf("{");if(r!==-1){let n=e.slice(r).trim();n=n.replace(/,\s*\{[^}]*$/,""),n=n.replace(/,\s*$/,"");let l=0,s=0,i=!1,c=!1;for(let p=0;p<n.length;p++){let d=n[p];if(c){c=!1;continue}if(d==="\\"){c=!0;continue}if(d==='"'){i=!i;continue}i||(d==="{"?l++:d==="}"?l=Math.max(0,l-1):d==="["?s++:d==="]"&&(s=Math.max(0,s-1)))}for(i&&(n+='"');s>0;)n+="]",s--;for(;l>0;)n+="}",l--;let u=JSON.parse(n);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Ct=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&G(a.id));return t.length>0?t:null}return null}catch{return null}})(),je=new Set;async function He(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return de;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let r=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!r.ok){let l=await r.text(),s=Ge(l,r.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let n=await r.json();if(Array.isArray(n.models)&&n.models.length>0){let l=n.models.filter(s=>{let i=s.supportedGenerationMethods||[],c=(s.name||"").replace(/^models\//,""),u=i.includes("generateContent");return G(c)&&u}).map(s=>{let i=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),u=s.displayName||c;return{id:c,name:u.includes(c)?u:`${u} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:i.includes("generateContent"),supportedGenerationMethods:i,discoveredAt:Date.now()}});if(l.length>0){l.sort((s,i)=>{let c=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return c(i.id)-c(s.id)}),Ct=l;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(l))}catch{}return l}}}catch(r){if(r.message?.includes("Chave de API"))throw r}return de}async function Ie(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await He(e);if(a.length>0&&a!==de){let r=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${r.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let r of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${r}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${r})!`,models:de}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function Fe(o,e){let t=e.map(c=>c.trim().replace(/^["']|["']$/g,"")).filter(c=>c.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=Et(Tt(o)),r=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function l(c,u,p){let d=new AbortController,m=setTimeout(()=>d.abort(),p);try{let b=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(c)}`,y=await fetch(b,{method:"POST",headers:{...n,"x-goog-api-key":c},body:r,signal:d.signal});if(clearTimeout(m),y.ok)return{ok:!0,model:u,key:c,message:`Modelo '${u}' validado com sucesso!`};let x=await y.text().catch(()=>"");throw new Error(`HTTP ${y.status}: ${x.slice(0,80)}`)}catch(b){throw clearTimeout(m),b}}if(t.length>=2){let c=t.slice(0,6);try{return await Promise.any(c.map(p=>l(p,a,8e3)))}catch{}}let s=t[0],i=[a,...wt.filter(c=>c!==a)];for(let c of i)try{let u=await l(s,c,4e3);return c!==a&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${c}'.`),u}catch{}return{ok:!1,model:a,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function oo(o,e,t,a,r){let n=["v1beta","v1"],l=new Error(`Falha ao consultar modelo ${o}`),i={...Zt(o,r)};for(let c of n){if(a.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${c}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,p=Date.now();try{let d=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:i}),signal:a});if(!d.ok){let y=await d.text();if(d.status===400){let f=/thinking/i.test(y),g=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(y);if((f||g)&&(i.thinkingConfig||i.responseSchema)){let h={...i};f&&delete h.thinkingConfig,g&&(delete h.responseSchema,delete h.responseMimeType),i=h;let v=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:i}),signal:a});if(v.ok){let w=await v.json(),E=w.candidates?.[0];if(E?.content?.parts?.[0]?.text)return H.markSuccess(e,Date.now()-p),{rawText:E.content.parts[0].text,data:w,usedModel:o,usedKey:e}}let T=await v?.text?.().catch(()=>"")??y,S=Ge(T,d.status);throw new Error(`[${o}|${W.maskKey(e)}] ${S}`)}}let x=Ge(y,d.status);if(d.status===404&&c==="v1beta")continue;throw d.status===429?(H.markQuotaHit(e,8e3),At(e,o,1e4),new Error(`[${o}|${W.maskKey(e)}] ${x}`)):(d.status===503||/no capacity|overloaded|unavailable/i.test(y)?(H.markOverloaded(e,5e3),je.add(o)):d.status===403||/API_KEY_INVALID/i.test(y)?H.markInvalid(e,x):d.status===404&&je.add(o),new Error(`[${o}|${W.maskKey(e)}] ${x}`))}let m=await d.json(),b=m.candidates?.[0];if(!b||!b.content?.parts?.[0]?.text)throw new Error(`[${o}|${W.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return H.markSuccess(e,Date.now()-p),{rawText:b.content.parts[0].text,data:m,usedModel:o,usedKey:e}}catch(d){if(a.aborted)throw d;l=d;let m=l.message||"";if(m.includes("404")||/no longer available/i.test(m)){je.add(o);break}if(m.includes("429")||m.includes("Quota"))break}}throw l}var ke=new Map;function qt(o,e){let t=`${o}::${e}`,a=ke.get(t);return a===void 0?!1:Date.now()>a?(ke.delete(t),!1):!0}function At(o,e,t=1e4){ke.set(`${o}::${e}`,Date.now()+t)}function St(){ke.clear()}async function Qe(o,e,t,a,r,n){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let l=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];H.init(l);let s=t.apiKey.trim().replace(/^["']|["']$/g,""),i=H.getBestKey()||s;if(!i)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let c=Tt(t.model);if(!Ct&&i&&He(i).catch(()=>{}),r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),p=qe(o,e,t),d=[{text:p}];for(let M=0;M<e.length;M++){let z=e[M],C=z.associatedLabel||(z.alt?`Imagem: ${z.alt}`:`Imagem ${M+1}`);d.push({text:`[ANEXO VISUAL ${M+1} - V\xCDNCULO: ${C}]:`}),d.push({inline_data:{mime_type:z.mediaType,data:z.base64}})}let m={system_instruction:{parts:[{text:n?.systemPromptOverride??yt}]},contents:[{role:"user",parts:d}]},b=Et(c),y=wt.filter(M=>M!==b),f=H.getAllKeys().length,g=f<=1?1:2,h=new Set,v=(M,z)=>{let C=/pro/i.test(M),N=/lite/i.test(M);return C?z===0?9e3:z===1?12e3:16e3:N?z===0?3500:z===1?5e3:6500:z===0?4500:z===1?6500:8e3},T=async(M,z)=>{if(z.length===0||r?.aborted)return null;let C=z.map(()=>new AbortController),N=()=>C.forEach(D=>{try{D.abort()}catch{}});r?.addEventListener("abort",N,{once:!0});let Z=z.map(D=>`${D.model.replace("gemini-","")}/${D.label}`).join(" | ");a?.(`\u26A1 ${M}: ${z.length} slot(s) [${Z}]...`,"info");try{let D=z.map(async(R,Y)=>{let K=C[Y],ie=setTimeout(()=>{try{K.abort(new Error(`Timeout ${R.timeout/1e3}s (${R.model}|${R.label})`))}catch{K.abort()}},R.timeout);try{let V=await oo(R.model,R.key,m,K.signal,n?.generationSchemaOverride);clearTimeout(ie);let J=xt(to(V.rawText));return J.usedModel=V.usedModel,J.durationMs=Date.now()-u,J.promptSent=p,J.tokensUsed=V.data.usageMetadata?.totalTokenCount,J.promptTokens=V.data.usageMetadata?.promptTokenCount,J.candidatesTokens=V.data.usageMetadata?.candidatesTokenCount,J.rawResponse=V.rawText,C.forEach((pt,_t)=>{if(_t!==Y)try{pt.abort(new Error("Cancelado: vencedor respondeu."))}catch{pt.abort()}}),{plan:J,rawUsage:V.data.usageMetadata,usedModel:V.usedModel,usedKey:V.usedKey,slotLabel:R.label}}catch(V){clearTimeout(ie);let J=V instanceof Error?V.message:String(V);throw(J.includes("429")||J.includes("Quota")||J.includes("RESOURCE_EXHAUSTED"))&&(At(R.key,R.model,1e4),H.markQuotaHit(R.key,8e3)),V}}),_=await Promise.any(D);return r?.removeEventListener("abort",N),H.markWinner(_.usedKey),_}catch(D){return r?.removeEventListener("abort",N),D instanceof AggregateError&&D.errors.length>0?E=D.errors.map(_=>_ instanceof Error?_.message:String(_)).join(" | "):D instanceof Error&&(E=D.message),console.warn(`[EasyQuiz ${M}] Falha na onda:`,E),null}},S=6,w=0,E="",I=0;for(;w<S;){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let M=H.getRoundRobinKeys(f),z=M.filter(K=>!h.has(`${K.key}::${b}`)&&!qt(K.key,b)),C,N;if(z.length>0)C=b,N=z;else{let K=y;C=K[I%K.length]||b,I++;let ie=M.filter(V=>!h.has(`${V.key}::${C}`)&&!qt(V.key,C));N=ie.length>0?ie:M.filter(V=>!h.has(`${V.key}::${C}`))}if(N.length===0){if(I<y.length)continue;break}let Z=N.slice(0,g);if(Z.length===0)break;let D=v(C,w),_=Z.map(K=>(h.add(`${K.key}::${C}`),{model:C,key:K.key,label:K.label||"Chave",timeout:D})),R=w===0?"Onda 1":`Onda ${w+1}`,Y=await T(R,_);if(Y){let K=Y.plan.durationMs||Date.now()-u,ie=W.maskKey(Y.usedKey);return a?.(`\u2705 ${K}ms via '${Y.usedModel}' (${Y.slotLabel}: ${ie})`,"info"),Y}w++}throw new Error(E||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var ao=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Ee(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function Ye(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Lt(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(ao.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var ue=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),Ce=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,ee=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,no=0;function Je(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!oe(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function B(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function L(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||oe(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${B(e.id)}"]`);if(n&&Je(n))return!0}catch{}let r=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(r&&r!==e&&Je(r))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let l=e.getBoundingClientRect();if(l.width>0||l.height>0)return!0}return!0}}}catch{}}return Je(e)}function io(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function P(o,e=500){return io(o).replace(/\s+/g," ").trim().slice(0,e)}function so(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(no+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function oe(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Te=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function O(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(oe(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,r=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),l=String(a.getAttribute?.("title")||""),s=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",i=P(a.textContent,60);return!!(Te.test(r)||Te.test(n)||Te.test(l)||Te.test(s)||i.length>0&&i.length<=25&&Te.test(i))}function Q(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||oe(o)||O(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=P(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,r=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return ee.test(r)||ee.test(t)?!1:Ce.test(r)||Ce.test(t)||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!o.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function We(o){let e=o.closest("tr");if(e){let i=e.querySelector("th, td:first-child"),c=i&&i!==o.closest("td")?P(i.textContent,100):"",u=P(o.closest("label, td")?.textContent||"",50);if(c&&u)return`${c}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let i=t.querySelector('.dropdown-label, [class*="label" i]'),c=i&&i!==o?P(i.textContent,150):"";if(c)return c}let a=o.getAttribute("aria-label");if(a)return P(a);let r=o.getAttribute("aria-labelledby");if(r){let i=r.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(i.trim())return P(i)}if("labels"in o&&o.labels){let i=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(i.trim())return P(i)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let i=P(n.textContent);if(i)return i}let l=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||l||"";return P(s)}function Xe(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,r=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),l=["input","textarea","select","button"].includes(n)?n:"other",s=o.getAttribute("role")||"",i=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||c.includes("cursor-grab")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(i)||/drag|card-item|sortable/i.test(c),p=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(i)||/dropzone|category-box|bucket|target-zone/i.test(c),m=P((u?"draggable":p?"dropzone":"")||r.type||s||l,40),b="";if(r.type==="checkbox"||r.type==="radio"||s==="radio"||s==="checkbox"){let v=r.checked||o.getAttribute("aria-checked")==="true",T=r.value&&r.value!=="on"?r.value:o.getAttribute("data-value")||"";b=v?T?`checked:${T}`:"checked":T||"unchecked"}else if(l==="button"||n==="a"||e==="navigation"||Q(o))b="";else{let v=typeof o.value=="string"||typeof o.value=="number"?o.value:"";b=P(v||o.getAttribute("data-category")||"",2e3)}let y=[];if(a&&a.options)for(let v of Array.from(a.options).slice(0,80))y.push({value:P(v.value),label:P(v.textContent)});else if(s==="combobox"||s==="listbox"||c.includes("select")||c.includes("dropdown")){let v=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),T=v?document.getElementById(v):o;if(T){let S=T.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let w of Array.from(S).slice(0,80)){let E=P(w.textContent);E&&y.push({value:w.getAttribute("data-value")||w.getAttribute("value")||E,label:E})}}}let x=!!(r.required||o.getAttribute("aria-required")==="true"),f=!!(r.disabled||o.getAttribute("aria-disabled")==="true"),g=so(o);return{id:o.id||g,tag:l,type:m,label:We(o),name:P(r.name||o.getAttribute("name")||"",180),value:b,options:y,required:x,disabled:f,role:e}}var Mt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function kt(o){if(!L(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(ue)).filter(L),a=P(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let r=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),l=Math.min(1,n/r),s=e.top+e.height/2,i=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=a>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+c+u-l*20-i*10}function ze(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let r=P(e.innerText||e.textContent||"",1e4),n=P(t.innerText||t.textContent||"",1e4),l=e.querySelectorAll(ue).length,s=t.querySelectorAll(ue).length;if(r.length<150&&n.length>r.length&&s<=l+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Ht(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&L(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function U(){let o=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(o&&L(o))return o;let e=document.activeElement;if(e&&e!==document.body){let l=e.closest(Mt);if(l&&kt(l)>0)return ze(l)}let a=Array.from(document.querySelectorAll(Mt)).map(l=>({element:l,score:kt(l)})).filter(l=>Number.isFinite(l.score)).sort((l,s)=>s.score-l.score),r=a.find(l=>{let s=l.element.tagName.toLowerCase();return s!=="main"&&s!=="body"&&l.score>0});if(r)return ze(r.element);if(a.length>0&&a[0].score>0)return ze(a[0].element);let n=document.querySelector('form, main, [role="main"]');return n&&L(n)?n:document.body}function It(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let r of Array.from(a.attributes))t.includes(r.name)||a.removeAttribute(r.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function $e(o){let e=Array.from(o.querySelectorAll(ue)),t=new Set,a=[];for(let i of e){if(!L(i)||Q(i)||O(i))continue;let c=(i.value||i.textContent||"").trim();if(ee.test(c))continue;let u=i.tagName.toLowerCase();["input","textarea","select"].includes(u)&&(t.add(i),a.push(i))}for(let i of e){if(!L(i)||Q(i)||O(i))continue;let c=(i.value||i.textContent||"").trim();if(ee.test(c))continue;let u=i.tagName.toLowerCase();if(["input","textarea","select"].includes(u))continue;let p=i.querySelector("input, textarea, select");if(!(p&&t.has(p))){if(i.hasAttribute("for")){let d=i.getAttribute("for"),m=d?i.ownerDocument.getElementById(d):null;if(m&&t.has(m))continue}if(u==="a"){let d=i.getAttribute("role"),m=i.getAttribute("class")||"",b=i.getAttribute("data-testid")||"",y=i.getAttribute("draggable")==="true"||i.classList.contains("perseus-drag-item")||i.classList.contains("sortable-item")||m.includes("cursor-grab")||!!i.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(b)||/drag|card-item|sortable/i.test(m);if(!(d==="button"||d==="radio"||d==="checkbox"||d==="option"||y||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(i)}}let r=a.length>0&&a.every(i=>O(i)||/read-?aloud|audio/i.test(i.getAttribute("data-testid")||i.getAttribute("aria-label")||"")),n=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,l=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((a.length===0||r)&&l){r&&(a.length=0);let i=Array.from(n.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(i.length>0){for(let c of i)if(!(!L(c)||O(c))&&(a.push(c),a.length>=50))break}else{let c=Array.from(n.querySelectorAll("button, div[class], span[class], p, li"));for(let u of c){if(!L(u)||Q(u)||O(u)||ee.test((u.textContent||"").trim()))continue;let p=(u.textContent||"").trim();if(p.length<2||p.length>300)continue;if(Array.from(u.children).some(m=>m.className&&m.textContent?.trim())||a.push(u),a.length>=50)break}}}let s=a.length>0&&a.every(i=>{let c=(i.textContent||"").trim();return!i.id||c.length<10||/^\d+\s*\/\s*\d+$/.test(c)||/^question text/i.test(c)});if(a.length===0||s){s&&(a.length=0);let i=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(i.length>0)for(let c of i){if(!L(c)||oe(c)||Q(c)||O(c)||ee.test((c.textContent||"").trim()))continue;let u=(c.textContent||"").trim();if(!(u.length<10||u.length>500)&&!/^\d+\s*\/\s*\d+$/.test(u)&&(a.push(c),a.length>=20))break}}return a.slice(0,100).map(i=>Xe(i,"answer"))}function Ze(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let r of e)for(let n of Array.from(r.querySelectorAll(ue)))if(!(t.has(n)||!L(n)||!Q(n)||O(n))&&(t.add(n),a.push(Xe(n,"navigation")),a.length>=10))return a;return a}function Ae(o=!1){let e=U();e=ze(e),o&&(e=Ht(e));let t=$e(e),a=Ze(e);if(t.length===0){let s=$e(document.body);s.length>0&&(e=Ht(e),t=$e(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=Ze(document.body));let r=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=r.length>4e4?P(r.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+P(r.slice(-2e3),2e3):P(r,16e3),l=[...t,...a].slice(0,120);return!n||l.length===0&&n.length<30?P(document.body.innerText||document.body.textContent||"",16e3).length>=30?pe():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:It(e),controls:l,scope:e}}function pe(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=P(o,16e3),t=$e(document.body),a=Ze(document.body),r=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:It(n).slice(0,15e3),controls:r,scope:n}}function zt(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function $(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function q(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function j(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let r=o.ownerDocument.getElementById(a);if(r)return r}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return j(a)}return o}function $t(o){let e=o;if(!e||!document.contains(e))try{e=U()}catch{}e=e||document.body;let t=r=>{let n=Array.from(r.querySelectorAll("tr")).filter(u=>L(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(n.length>1)return n;let l=Array.from(r.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>L(u)&&!$(u));if(l.length>0)return l;let i=Array.from(r.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>L(u)&&!$(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return i.length>0?i:Array.from(r.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let p=u;return L(p)&&!$(p)&&(p.textContent||"").trim().length>2&&!Q(p)&&!O(p)&&!p.querySelector("[class]")})},a=t(e);return a.length>0?a:e!==document.body?t(document.body):[]}function k(o,e,t=!1){if(o==null)return null;let r=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!r)return null;let n=B(r),l=document.querySelector(`[data-easyquiz-id="${n}"]`);if(l&&!$(l))return j(l);try{let d=document.getElementById(r);if(d&&L(d)&&!$(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:j(d)}catch{}try{let d=document.querySelector(`[data-item-id="${n}"]`);if(d&&L(d)&&!$(d))return j(d)}catch{}let s=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let d=parseInt(s[1],10);if(t){let b=document.body;try{b=U()||document.body}catch{}let y=Array.from(b.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(x=>L(x)&&!$(x));if(d>=1&&d-1<y.length)return y[d-1];if(d===0&&y.length>0)return y[0]}let m=d-1;if(m>=0){let b=$t();if(m<b.length){let f=b[m];if(f.tagName.toLowerCase()==="tr"){if(e){let h=f.querySelector(`input[value="${B(e)}" i], [data-value="${B(e)}" i]`);if(h)return h}let g=f.querySelector("input");if(g)return g}return j(f)}let y=document.body;try{y=U()||document.body}catch{}let x=Array.from(y.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(f=>L(f)&&!$(f));if(m<x.length)return x[m]}}let i=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(i){let d=i[1].toUpperCase().charCodeAt(0)-65;if(d>=0){let m=$t();if(d<m.length){let b=m[d];if(b.tagName.toLowerCase()==="tr"){if(e){let x=b.querySelector(`input[value="${B(e)}" i], [data-value="${B(e)}" i]`);if(x)return x}let y=b.querySelector("input");if(y)return y}return j(b)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(r)){let m=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(f=>L(f)&&!$(f));if(m)return m;let y=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(f=>L(f)&&!$(f));if(y)return j(y);let x=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(f=>{if(!L(f)||$(f))return!1;let g=q(f.textContent).toLowerCase();return g===r.toLowerCase()||g===r.toLowerCase()+")"});if(x)return j(x)}try{let m=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`)).find(b=>L(b)&&!$(b));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:j(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(r))try{let m=Array.from(document.querySelectorAll(r)).find(b=>L(b)&&!$(b));if(m)return j(m)}catch{}try{let d=r.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,b=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let y=0;y<b.snapshotLength;y++){let x=b.snapshotItem(y);if(x&&L(x)&&!$(x)){if(["body","html"].includes(x.tagName.toLowerCase())){let g=x.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(g&&L(g))return j(g)}return x.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||j(x)}}}catch{}let u=q(r).toLowerCase(),p=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of p){if(!L(d)||$(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||O(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let b=q(d.textContent).toLowerCase(),y=q(d.getAttribute("aria-label")||"").toLowerCase(),x=q(d.getAttribute("placeholder")||"").toLowerCase(),f=q(d.getAttribute("title")||"").toLowerCase(),g=q(d.getAttribute("name")||"").toLowerCase(),h=q(d.getAttribute("data-category")||"").toLowerCase(),v=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",T=q(v).toLowerCase(),S=b.startsWith(u+")")||b.startsWith(u+".")||b.startsWith(u+" -")||b.startsWith(u+":");if(b===u||y===u||x===u||f===u||g===u||h&&h===u||T&&T===u||S)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||j(d)}if(u.length>=3)for(let d of p){if(!L(d)||$(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||O(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let b=q(d.textContent).toLowerCase(),y=q(d.getAttribute("aria-label")||"").toLowerCase(),x=q(d.getAttribute("placeholder")||"").toLowerCase(),f=q(d.getAttribute("title")||"").toLowerCase(),g=q(d.getAttribute("name")||"").toLowerCase();if(b.includes(u)||y.includes(u)||x.includes(u)||f.includes(u)||g.includes(u)){if(Array.from(d.children).some(S=>{let w=q(S.textContent).toLowerCase();return w&&w.includes(u)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||j(d)}let h=u.split(/\s+/).filter(Boolean);if(h.length>=3){let v=h.slice(0,Math.min(5,h.length)).join(" ");if(b.includes(v)||y.includes(v)||x.includes(v))return j(d)}}return null}function Ot(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function X(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),a=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),r=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),n={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerover",{...n}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...n}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}try{o.click()}catch{}try{let l=Object.keys(o).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(l){let s=o[l];for(;s;){let i=s.memoizedProps||s.pendingProps;if(i?.onClick){i.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let l=Object.keys(o).find(s=>s.startsWith("__reactProps"));if(l){let s=o[l];s?.onClick&&s.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let l=o._vei;l?.onClick&&(Array.isArray(l.onClick.value)?l.onClick.value:[l.onClick.value]).forEach(i=>{try{i({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=o.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let i=o.closest("[jsaction]");if(i&&i!==o)try{i.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:a,clientY:r}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function Pe(o,e){let t=o;if(t.hasAttribute("for")){let c=t.getAttribute("for"),u=t.ownerDocument.getElementById(c);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Oe(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){Oe(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)t=c;else{let p=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(p)t=p;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let c=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{let u=document.body;try{u=U()||document.body}catch{}let p=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p)t=p;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=document.body;try{c=U()||document.body}catch{}let u=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;ne(t,c);return}let l=String(e??""),s=l;if(t instanceof HTMLInputElement&&t.type==="number"){let c=l.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(s=c)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let i=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}i=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}i=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let p=t._valueTracker;p&&p.setValue(s===""?" ":"")}catch{}let c=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(c,"value")?.set;u?u.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{u?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Se(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),r=q(t),n=k(t)||k(r);if(!n)return a?e:r||e;let l=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(l){let p=q(l.textContent);if(p&&p.length>0&&p.length<150)return p}if(n.id){let p=document.querySelector(`label[for="${B(n.id)}"]`);if(p){let d=q(p.textContent);if(d&&d.length>0&&d.length<150)return d}}let s=n.getAttribute("aria-label");if(s)return q(s);let i=n.getAttribute("placeholder");if(i)return q(i);let c=q(n.textContent);if(c&&c.length>0&&c.length<120)return c;let u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return u?q(u):a?e:r||e}function ne(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for")));let r=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&L(t)?t:o;if(a){let n=a.type==="radio",l=a.type==="checkbox",s=!!a._valueTracker;if(a.checked===e){if(n&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(l){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}r&&r!==a&&X(r);try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let c=a._valueTracker;c&&c.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,Ot(a,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;X(r),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Oe(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let l=e.map(c=>q(c).toLowerCase()),s=!1,i=(c,u)=>{c.selected=!0,t.selectedIndex=u;try{t.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,c.value)}catch{}try{let p=t._valueTracker;p&&p.setValue(c.value)}catch{}s=!0};for(let c=0;c<t.options.length;c++){let u=t.options[c],p=u.value.toLowerCase(),d=q(u.textContent).toLowerCase();if(l.some(b=>b===p||b===d)){if(i(u,c),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!s)for(let c of l){let u=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let p=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?p:p>=1?p-1:0;if(m>=0&&m<t.options.length&&(i(t.options[m],m),!t.multiple))break}}if(!s){for(let c of l)if(/^[a-z]$/i.test(c)){let u=c.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(d>=0&&d<t.options.length&&(i(t.options[d],d),!t.multiple))break}}if(!s){let c=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let p=t.options[u],d=c(p.value.toLowerCase()),m=c(q(p.textContent).toLowerCase());if(l.some(y=>{let x=c(y);return d.includes(x)||m.includes(x)||x.length>2&&(x.includes(d)||x.includes(m))})&&(i(p,u),!t.multiple))break}}if(s){Ot(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&X(a);let r=e.map(l=>q(l).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(l=>L(l)&&!$(l));for(let l of r){let s=n.find(c=>{let u=q(c.textContent).toLowerCase(),p=q(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return u===l||p===l||u.includes(l)||l.length>2&&l.includes(u)});if(s){X(s);let c=s.querySelector('input[type="radio"], input[type="checkbox"]');c&&ne(c,!0);return}let i=k(l);if(i){X(i);return}}}function ro(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function et(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function ae(o,e){let t=q(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let s=document.getElementById(o.trim());if(s&&L(s)&&!$(s))return s}let l=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of l){let c=Array.from(document.querySelectorAll(s)).find(u=>{if(!L(u)||$(u))return!1;let p=q(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return p===t||p.includes(t)||u.id===o.trim()});if(c)return c}return null}let a=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),r=Array.from(document.querySelectorAll(a)),n=r.find(l=>[l.getAttribute("data-category"),l.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return n&&L(n)&&!$(n)?n:r.find(l=>{if(!L(l)||$(l)||/unclassified/i.test(l.className))return!1;let s=l.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),i=q(s?.textContent||l.textContent||"").toLowerCase();return i.includes("op")&&(i.includes("es")||i.includes("\xF5es"))?!1:i===t||i.startsWith(t)||i.includes(t)})||null}async function Re(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),r=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),l=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(r.left+Math.max(1,r.width/2)),i=Math.round(r.top+Math.max(1,r.height/2)),c=q(e.textContent).toLowerCase();if(c){let y=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(x=>{let f=q(x.textContent).toLowerCase(),g=x instanceof HTMLInputElement||x instanceof HTMLOptionElement?q(x.value).toLowerCase():"";return f&&(c.includes(f)||f.includes(c))||g&&(c.includes(g)||g.includes(c))});y&&(X(y),await new Promise(x=>setTimeout(x,120)))}et(o),await new Promise(b=>setTimeout(b,140)),et(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&et(u),await new Promise(b=>setTimeout(b,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:l,screenX:n,screenY:l,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",p));let d=4;for(let b=1;b<=d;b++){let y=Math.round(n+(s-n)*(b/d)),x=Math.round(l+(i-l)*(b/d)),f={...p,clientX:y,clientY:x,screenX:y,screenY:x};try{o.dispatchEvent(new PointerEvent("pointermove",{...f,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",f))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:i,screenX:s,screenY:i,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let b=ro(P(o.textContent),o.outerHTML),y={...p},x={...m};b&&(y.dataTransfer=b,x.dataTransfer=b);let f=o.ownerDocument.defaultView?.DragEvent;if(!f)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new f("dragstart",y)),e.dispatchEvent(new f("dragenter",x)),e.dispatchEvent(new f("dragover",x)),e.dispatchEvent(new f("drop",x)),o.dispatchEvent(new f("dragend",y))}catch(b){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",b)}try{let b=new Touch({identifier:1,target:o,clientX:n,clientY:l}),y=new Touch({identifier:1,target:e,clientX:s,clientY:i});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[b]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[y]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(b=>setTimeout(b,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Rt={fill:(o,e)=>{let t=k(o);t?Pe(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=k(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?ne(e,!0):X(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=k(o);t?ne(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>k(o,e),drag:(o,e)=>{let t=ae(o,"source")||k(o),a=ae(e,"destination")||k(e);t&&a?Re(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=ae(o,"source")||k(o),a=ae(e,"destination")||k(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Re(t,a)},execute:(o,e=!1,t=1)=>at(o,e,t)};typeof window<"u"&&(window.$eq=Rt);async function lo(o,e=1,t=Ee()){if(Ye(o,t),o.t==="js"){let s=String(o.v||"");Lt(s);try{new Function("$eq","document","window",s)(Rt,document,window)}catch(i){throw console.warn("[EasyQuiz JS Execution]",i),i}return}if(o.t==="drag"){let s=ae(o.from,"source")||k(o.from),i=ae(o.to,"destination")||k(o.to);!s&&o.from&&(s=k(q(o.from))),!i&&o.to&&(i=k(q(o.to))),s&&i?await Re(s,i,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let r=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=r!=null?String(r).trim():"",l=k(a,n,o.t==="val"||o.t==="sel");if(!l&&a&&(l=k(q(a),n,o.t==="val"||o.t==="sel")),l&&n){if(l instanceof HTMLInputElement&&l.type==="radio"&&l.name){if(q(l.value).toLowerCase()!==q(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${B(l.name)}"][value="${B(n)}" i]`);if(s)l=s;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${B(l.name)}"]`)).find(u=>{let p=u.closest("label, .vf-label, .option-card, tr, td, div");return p&&q(p.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(l=c)}}}else if(!(l instanceof HTMLInputElement)&&!(l instanceof HTMLSelectElement)&&!(l instanceof HTMLTextAreaElement)){let s=l.querySelector(`input[value="${B(n)}" i], [data-value="${B(n)}" i]`);if(s)l=s;else{let c=Array.from(l.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(u=>{let p=u.closest("label, .vf-label, .option-card, td, div");return p&&q(p.textContent).toLowerCase().includes(q(n).toLowerCase())});c&&(l=c)}}}if(!l&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=U()||document.body}catch{}let i=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(c=>L(c)&&!$(c));if(i.length===1)l=i[0];else if(i.length>1){let c=q(a).toLowerCase(),u=c.match(/^#?_?([0-9]+)$/);if(u){let p=parseInt(u[1],10);p>=1&&p<=i.length?l=i[p-1]:p>=0&&p<i.length&&(l=i[p])}l||(l=i.find(d=>{let m=(d.getAttribute("placeholder")||"").toLowerCase(),b=(d.name||"").toLowerCase(),y=(d.getAttribute("aria-label")||"").toLowerCase(),x=(d.id||"").toLowerCase(),f=q(We(d)).toLowerCase(),g=q(d.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return m.includes(c)||b.includes(c)||y.includes(c)||x.includes(c)||f&&f.includes(c)||c.length>=2&&g.includes(c)})||(i.length===1?i[0]:null))}}if(!l&&o.t!=="adv")throw new Error(`Alvo '${a}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);switch(o.t){case"val":if(l){let i=l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement||l instanceof HTMLSelectElement||l.isContentEditable?l:l.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!i){let d=l.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(i=d)}if(!i){let p=l.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){i=p;break}let d=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){i=d;break}p=p.nextElementSibling}}if(!i){let p=document.body;try{p=U()||document.body}catch{}let d=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>L(m)&&!$(m));d.length>0&&(i=d[0])}let c=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,u=c!=null?String(c):"";Pe(i||l,u)}break;case"chk":l&&ne(l,!!o.c);break;case"sel":if(l){let i=Array.isArray(o.v)?o.v:[String(o.v)];Oe(l,i)}break;case"clk":if(l)if(!!(l.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||l.querySelector('input[type="radio"], input[type="checkbox"]')||l instanceof HTMLInputElement&&["checkbox","radio"].includes(l.type))){let c=o.c!==void 0?!!o.c:!0;ne(l,c)}else X(l,o.co);break;case"adv":let s=tt(o.id);if(s){await ot(s,1200);let i=o.id||s.textContent?.trim()||"";i&&Ke(window.location.hostname,{advanceSelector:i}),X(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function co(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!L(t)||$(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(r)})||null}function tt(o){let e=d=>{let m=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return ee.test(m)};if(o){let d=k(o);if(d&&L(d)&&!$(d)&&!O(d)&&!e(d))return d}try{let d=ve(window.location.hostname);if(d.advanceSelector){let m=k(d.advanceSelector);if(m&&L(m)&&!$(m)&&!O(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(t)),r=d=>{let m=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||m||"").trim()},n=d=>{let m=r(d).trim();return/^\d{1,3}$/.test(m)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},l=a.filter(d=>L(d)&&!$(d)&&!d.closest("header, aside")&&!O(d)&&!e(d));for(let d of l){let m=r(d),b=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Ce.test(m)||Ce.test(b))&&!n(d)&&!O(d))return d}for(let d of l)if(Q(d)&&!O(d)&&!n(d))return d;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&L(s)&&!$(s)&&!O(s)&&!e(s))return s;let i=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of i)if(L(d)&&!$(d)&&!e(d)&&!O(d)&&!n(d))return d;let c=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,p=c.filter(d=>{if(!L(d)||$(d)||e(d)||O(d)||d.closest("header, nav, aside, .eq-sidebar")||n(d))return!1;let m=d.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(p.length>0)return p.sort((d,m)=>{let b=d.getBoundingClientRect(),y=m.getBoundingClientRect(),x=b.left+b.top;return y.left+y.top-x}),p[0];for(let d of l)if(Q(d)&&!O(d))return d;return null}async function ot(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(r=>setTimeout(r,80))}}function uo(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function po(o,e=3500){let[t,a,r,n]=o.split("|"),l=parseInt(n||"0",10),s=Date.now();for(;Date.now()-s<e;){let i=window.location.href,c=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),p=(document.body?.innerText||document.body?.textContent||"").length;if(i!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${i}`};if(c!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${c}"`};if(Math.abs(parseInt(u)-parseInt(r||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${r} \u2192 ${u}`};if(Math.abs(p-l)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(p-l)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Pt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let r=k(o.from)||k(q(o.from)),n=k(o.to)||k(q(o.to));r&&n&&await Re(r,n,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=k(e,t)||k(q(e),t);if(o.t==="clk"||o.t==="chk"){if(!a&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),l=q(e).toLowerCase();a=n.find(s=>{let i=q(s.textContent).toLowerCase();return!!(q(s.value||"").toLowerCase()===l||i===l||i.startsWith(l+")")||i.startsWith("("+l+")")||i.startsWith(l+".")||i.startsWith(l+" - ")||i.startsWith(l+":")||l.length>=3&&i.includes(l))})||null}let r=o.v!==void 0?String(o.v).trim():"";if(a&&r){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(q(a.value).toLowerCase()!==q(r).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${B(a.name)}"][value="${B(r)}" i]`);if(n)a=n;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${B(a.name)}"]`)).find(i=>{let c=i.closest("label, .vf-label, .option-card, tr, td, div");return c&&q(c.textContent).toLowerCase().includes(q(r).toLowerCase())});s&&(a=s)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let n=a.querySelector(`input[value="${B(r)}" i], [data-value="${B(r)}" i]`);if(n)a=n;else{let s=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(i=>{let c=i.closest("label, .vf-label, .option-card, td, div");return c&&q(c.textContent).toLowerCase().includes(q(r).toLowerCase())});s&&(a=s)}}}if(a){let n=a.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,l=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(ne(l||n,s),l&&l.checked!==s){try{let i=l._valueTracker;i&&i.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(l,s)}catch{}l.checked=s,l.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),l.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let r=null;if(a&&(r=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!r){let n=document.body;try{n=U()||document.body}catch{}let l=Array.from(n.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=q(e).toLowerCase();r=l.find(i=>{let c=(i.getAttribute("placeholder")||"").toLowerCase(),u=(i.name||"").toLowerCase(),p=(i.id||"").toLowerCase(),d=(i.getAttribute("aria-label")||"").toLowerCase();return c.includes(s)||u.includes(s)||p.includes(s)||d.includes(s)})||(l.length>0?l[0]:null)}if(r){let n=String(o.v??"");try{if(r.focus?.(),r.type!=="number"){try{r.select?.()}catch{}document.execCommand?.("insertText",!1,n)}}catch{}Pe(r,n)}return}if(o.t==="sel"){if(!a&&e){let r=Array.from(document.querySelectorAll("select")),n=q(e).toLowerCase();a=r.find(l=>{let s=(l.name||"").toLowerCase(),i=(l.id||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase();return s.includes(n)||i.includes(n)||c.includes(n)})||null}if(a){let r=Array.isArray(o.v)?o.v:[String(o.v)];Oe(a,r)}return}}function me(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,r=o.id!==void 0&&o.id!==null?String(o.id):"";r||(r=o.target??o.name??o.selector??"1");let n=k(r,a,!0)||k(q(r),a,!0);if(!n){let p=document.body;try{p=U()||document.body}catch{}let d=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>L(m)&&!$(m));d.length>0&&(n=d[0])}if(!n)return!1;let l=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(l&&l.name){let p=document.querySelector(`input[type="radio"][name="${B(l.name)}"]:checked`);if(!p)return!1;let d=q(p.value).toLowerCase(),m=q(t).toLowerCase(),b=q(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===m||b===m||b.includes(m)}let s=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let d=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(s=d)}if(!s){let p=n.nextElementSibling;for(;p;){if(p instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(p.type)||p instanceof HTMLTextAreaElement||p instanceof HTMLElement&&p.isContentEditable){s=p;break}let d=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){s=d;break}p=p.nextElementSibling}}if(s instanceof HTMLSelectElement){let p=q(t).toLowerCase();return Array.from(s.options).some(d=>{if(!d.selected)return!1;let m=d.value.toLowerCase(),b=q(d.textContent).toLowerCase();return p===m||p===b||m.includes(p)||b.includes(p)})}let i=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??n.textContent??"").trim();if(!i&&!t)return!0;if(!i&&t)return!1;let c=i.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return c===u||c.includes(u)||u.includes(c)||i.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=k(o.id,void 0,!0)||k(q(o.id),void 0,!0);if(!e){let n=document.body;try{n=U()||document.body}catch{}let l=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>L(c)&&!$(c)),s=q(o.id).toLowerCase();e=l.find(c=>{let u=(c.id||"").toLowerCase(),p=(c.getAttribute("name")||"").toLowerCase(),d=(c.getAttribute("aria-label")||"").toLowerCase(),m=q(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(s)||p.includes(s)||d.includes(s)||s.length>=2&&m.includes(s)})||(l.length===1?l[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(c=>q(c).toLowerCase()),i=q(n.textContent).toLowerCase();return s.some(c=>i.includes(c)||c.includes(i))}return!1}let r=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>q(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let l=n.value.toLowerCase(),s=q(n.textContent).toLowerCase();return r.some(i=>i===l||i===s||l.includes(i)||s.includes(i))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=k(o.id,e)||k(q(o.id),e);if(!t)return!1;let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,r=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),n=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(r&&r.type==="radio"){if(r.checked===n)return!0;if(o.v&&r.name){let u=q(String(o.v)).toLowerCase(),p=document.querySelector(`input[type="radio"][name="${B(r.name)}"]:checked`);if(!p)return!1;if(p===r)return!0;let d=q(p.value).toLowerCase(),m=q(p.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===u||m.includes(u)||u.includes(d)}}if(r&&["checkbox","radio"].includes(r.type))return r.checked===n;let l=a.getAttribute("aria-checked")===String(n)||a.getAttribute("aria-selected")===String(n)||a.getAttribute("aria-pressed")===String(n),s=n?a.getAttribute("data-selected")==="true"||a.getAttribute("data-checked")==="true"||a.getAttribute("data-active")==="true"||a.getAttribute("data-state")==="checked"||a.getAttribute("data-state")==="on":a.getAttribute("data-selected")==="false"||a.getAttribute("data-checked")==="false"||a.getAttribute("data-state")==="unchecked",i=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||"");return!!(l||s||i||(a instanceof HTMLButtonElement||a.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!r)}if(o.t==="drag"){let e=k(o.from)||k(q(o.from)),t=k(o.to)||k(q(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function at(o,e,t=1,a=Ee({engine:"smart",autoAdvance:e})){let r=o.actions.filter(h=>h.t!=="adv"),n=o.actions.filter(h=>h.t==="adv"),l=0,s=[],i=new Map,c=o.pageType==="question",u=r.filter(h=>h.t==="chk"||h.t==="clk"&&h.c!==void 0);for(let h of r){try{await lo(h,t,a),l++}catch(v){i.set(h,v instanceof Error?v.message:String(v)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",h,v)}await new Promise(v=>setTimeout(v,h.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&u.length>0){let h=document.body;try{h=U()||document.body}catch{}let v=Array.from(h.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(T=>L(T)&&!$(T));if(v.length>1){let S=function(w,E){if(w===E||w.contains(E)||E.contains(w))return!0;let I=w.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),M=E.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(I&&M&&I===M)return!0;let z=w.getAttribute("for")||w.id,C=E.getAttribute("for")||E.id;return!!(z&&C&&z===C)};var g=S;let T=new Set;for(let w of u){let E=w.t==="chk"?!!w.c:!!(w.c??!0),I="id"in w&&typeof w.id=="string"?w.id:"";if(E&&I){let M=k(I,w.v);if(M){T.add(M);let z=M.querySelector('input[type="checkbox"]');z&&T.add(z);let C=M.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');C&&(T.add(C),C.querySelectorAll('input[type="checkbox"]').forEach(N=>T.add(N)))}}}if(T.size>=u.length&&T.size>0){let w=Array.from(T);for(let E of v)w.some(M=>S(M,E))||(E instanceof HTMLInputElement&&E.checked||E.getAttribute("aria-checked")==="true"||E.closest(".option-card, label")?.classList.contains("selected"))&&ne(E,!1)}}}await new Promise(h=>setTimeout(h,r.length>0?100:25));let p=0;for(let h of r){if(me(h)){p++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${h.t}' no alvo '${h.id||h.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ye(h,a),await Pt(h)}catch(v){i.set(h,v instanceof Error?v.message:String(v)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",v)}await new Promise(v=>setTimeout(v,250)),me(h)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),p++,i.has(h)&&(i.delete(h),l++))}if(p<r.length&&r.length>0){console.warn(`[EasyQuiz Auto-Cura] ${r.length-p} de ${r.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(h=>setTimeout(h,200));for(let h of r)if(!me(h))try{await Pt(h)}catch(v){i.set(h,v instanceof Error?v.message:String(v))}await new Promise(h=>setTimeout(h,200)),p=0;for(let h of r)me(h)&&(p++,i.has(h)&&(i.delete(h),l++))}for(let h of r)me(h)||s.push(h.t==="drag"?`${h.from} -> ${h.to}`:"id"in h?h.id:h.t);c&&r.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let d=r.map((h,v)=>{let T=h.t==="drag"?`${h.from} -> ${h.to}`:h.t==="js"?"$eq":h.id||h.t,S=h.t==="js"?!0:h.t==="drag"?!!(ae(h.from,"source")&&ae(h.to,"destination")):!!(k(h.id||"")||k(q(h.id||""))),w=me(h);return{index:v,action:h,target:T,located:S,applied:!i.has(h),verified:w,strategy:h.t==="drag"?"drag-adaptive":h.t==="js"?"javascript":"declarative-dom",evidence:w?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...i.has(h)?{error:i.get(h)}:{}}}),m=c?r.length>0&&s.length===0&&(p===r.length||l===r.length&&p>0):!0,b=!1,y=!1,x="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",f=l>0&&l>=r.length/2;if(e&&(m||!c||f)){await new Promise(w=>setTimeout(w,r.length>0?120:40));let h=!1;if(o.pageType!=="info"){let w=co();w&&L(w)&&(await ot(w,1200),X(w),h=!0,await new Promise(E=>setTimeout(E,350)))}let v=uo(),T=n.length>0?n[0].id:void 0,S=tt(T);if(!S&&h&&(await new Promise(w=>setTimeout(w,250)),S=tt(T)),S){await ot(S,1500);let w=T||S.textContent?.trim()||"";w&&Ke(window.location.hostname,{advanceSelector:w}),X(S);let E=await po(v,1800);y=E.changed,x=E.evidence,b=E.changed||h,!E.changed&&!h&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else h?(b=!0,y=!0,x="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:l,verified:p,success:m,advanced:b,failed:s,reports:d,navigationVerified:y,navigationEvidence:x}}var he=null,le=[],nt=[],it=[],ge=null,mo=`
...
`;function Nt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=mo,document.head.appendChild(o)}}catch{}}function ce(){he&&(he.style.removeProperty("outline"),he.style.removeProperty("outline-offset"),he.style.removeProperty("position"),he=null);for(let o of le)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");le=[];for(let o of nt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");nt=[];for(let o of it)try{o.remove()}catch{}if(it=[],ge){try{ge.remove()}catch{}ge=null}}function st(o){Nt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),nt.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),it.push(n)}}catch{}}}function rt(o){ce(),Nt(),he=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),ge=t,setTimeout(()=>{try{t.remove()}catch{}ge===t&&(ge=null)},900)}catch{}}function ho(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Dt(o,e){let t=ho(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let p=k(a.from),d=k(a.to);p&&(p.style.outline=`2px solid ${t.outline}`,le.push(p)),d&&(d.style.outline="2px dashed #00e5ff",le.push(d))}catch{}continue}if(!a.id)continue;let r=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=k(a.id,r,a.t==="val"||a.t==="sel")||k(q(a.id),r,a.t==="val"||a.t==="sel");if(!n&&a.t==="sel"){let p=document.body;try{p=U()||document.body}catch{}let d=Array.from(p.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(y=>L(y)&&!oe(y)),m=q(a.id).toLowerCase();n=d.find(y=>{let x=(y.id||"").toLowerCase(),f=(y.getAttribute("name")||"").toLowerCase(),g=(y.getAttribute("aria-label")||"").toLowerCase(),h=q(y.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return x.includes(m)||f.includes(m)||g.includes(m)||m.length>=2&&h.includes(m)})||(d.length===1?d[0]:null)}if(!n)continue;let l=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox",i=n.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||n;i.style.outline=`2px solid ${t.outline}`,i.style.outlineOffset="2px",i.style.backgroundColor=t.bg,i.setAttribute("data-easyquiz-highlight","true"),le.push(i);let c=l?n:i.querySelector('select, [role="combobox"], [role="listbox"]');c&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),le.push(c));let u=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:i.querySelector('input[type="checkbox"], input[type="radio"]');u&&u!==i&&(u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.boxShadow=`0 0 10px ${t.glow}`,u.setAttribute("data-easyquiz-highlight","true"),le.push(u))}}var lt=10,go=1400,ct=15e5;function fe(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let r=String(a.result||"");e(r.split(",")[1]||"")},a.readAsDataURL(o)})}async function Le(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,go/Math.max(e,t)),r=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),l=document.createElement("canvas");l.width=r,l.height=n;let s=l.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,r,n),s.drawImage(o,0,0,r,n),new Promise((i,c)=>{l.toBlob(u=>u?i(u):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function fo(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,r=2,n=Math.min(1800,Math.max(120,Math.round(t*r))),l=Math.min(1800,Math.max(100,Math.round(a*r))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(n)),s.setAttribute("height",String(l)),!s.getAttribute("viewBox")&&t>0&&a>0&&s.setAttribute("viewBox",`0 0 ${t} ${a}`);let c=new XMLSerializer().serializeToString(s),u=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(u);try{let d=new Image;d.crossOrigin="anonymous",await new Promise((y,x)=>{d.onload=()=>y(),d.onerror=()=>x(new Error("Falha ao renderizar SVG em Image.")),d.src=p});let m=document.createElement("canvas");m.width=n,m.height=l;let b=m.getContext("2d",{alpha:!1});if(!b)throw new Error("Sem suporte a Canvas 2D.");return b.fillStyle="#ffffff",b.fillRect(0,0,n,l),b.drawImage(d,0,0,n,l),new Promise((y,x)=>{m.toBlob(f=>f?y(f):x(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(p)}}async function dt(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,r=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=s=>{if(!this.isDragging||!this.element)return;let i=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),p=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+i),u),m=Math.min(Math.max(10,this.initialTop+c),p);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),l=r.actions.filter(m=>{if(m.t!=="val")return!1;let b=q(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(b)}),s=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),i=r.actions.filter(m=>m.t==="sel"),c=n.length||l.length||s.length||i.length,u=document.createElement("div");u.className="eq-fah-meta";let p=document.createElement("span");p.textContent=`Modo: ${r.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(p,d),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let b of n){let y=q(b.to)||"Geral";m[y]||(m[y]=[]),m[y].push(q(b.from))}for(let[b,y]of Object.entries(m)){let x=document.createElement("div"),f=/fato|true|verdadeiro|sim/i.test(b),g=/opini[aã]o|false|falso|n[aã]o/i.test(b);x.className=`eq-fah-group ${f?"group-fato":g?"group-opiniao":""}`;let h=document.createElement("div");h.className="eq-fah-group-title",h.textContent=`\u{1F4C1} ${b} (${y.length})`,x.appendChild(h);let v=document.createElement("div");v.className="eq-fah-group-items";for(let T of y){let S=document.createElement("div");S.className="eq-fah-item";let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=T,S.appendChild(w);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(T),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),S.appendChild(E),v.appendChild(S)}x.appendChild(v),e.appendChild(x)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,a.textContent=String(l.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<l.length;x++){let f=l[x],g=document.createElement("div");g.className="eq-fah-item";let h=Se(f.id);(!h||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(h))&&(h=`Campo ${x+1}`);let v=String(f.v??""),T=document.createElement("div");T.className="eq-fah-field-box";let S=document.createElement("div");S.className="eq-fah-field-label",S.textContent=h,T.appendChild(S);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=v,T.appendChild(w),g.appendChild(T);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),g.appendChild(E),y.appendChild(g)}m.appendChild(y),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<s.length;x++){let f=s[x],g=document.createElement("div");g.className="eq-fah-item";let h=Se(f.id);(!h||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(h))&&f.v&&(h=String(f.v)),h=q(h),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(h)&&(h="");let v="",T=h.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);T?(v=T[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),h=T[2].trim()||h):s.length>1&&(v=String.fromCharCode(65+x));let S=document.createElement("div");if(S.style.display="flex",S.style.alignItems="center",S.style.gap="8px",S.style.flex="1",v){let I=document.createElement("span");I.className="eq-fah-letter-badge",I.textContent=v,S.appendChild(I)}let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=h||(v?`Alternativa ${v}`:"Alternativa Selecionada"),S.appendChild(w),g.appendChild(S);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(h||v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),g.appendChild(E),y.appendChild(g)}m.appendChild(y),e.appendChild(m)}else if(i.length>0){t.textContent=`Sele\xE7\xE3o (${i.length} listas)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<i.length;x++){let f=i[x],g=document.createElement("div");g.className="eq-fah-item";let h=Se(f.id);(!h||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(h))&&(h=`Lista ${x+1}`);let S=(Array.isArray(f.v)?f.v:[String(f.v??"")]).map(z=>{let C=k(f.id,void 0,!0)||k(q(f.id),void 0,!0),N=C instanceof HTMLSelectElement?C:C?.querySelector("select");if(N){let Z=q(z).toLowerCase();for(let D=0;D<N.options.length;D++){let _=N.options[D];if(_.value.toLowerCase()===Z||q(_.textContent).toLowerCase()===Z){let R=q(_.textContent);if(R&&!R.toLowerCase().includes("selecione"))return R}}}return z}).join(", "),w=document.createElement("div");w.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=h,w.appendChild(E);let I=document.createElement("div");I.className="eq-fah-field-val",I.textContent=S,w.appendChild(I),g.appendChild(w);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(S),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),g.appendChild(M),y.appendChild(g)}m.appendChild(y),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),r=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let i of a){let c=q(i.to)||"Geral";s[c]||(s[c]=[]),s[c].push(q(i.from))}for(let[i,c]of Object.entries(s)){t.push(`### Categoria: ${i}`);for(let u of c)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of r){let i=q(s.id);t.push(`- **${i||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let i=n[s],c=Se(i.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&i.v&&(c=String(i.v)),c=q(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let u=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let i=q(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${i}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let a=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=a},1500)})}};var Bt=`
...
`;var Vt=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function wo(o,e){try{if(Vt){o.innerHTML=Vt.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var Eo=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],To=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Be=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new Ne({onStatusChange:(s,i,c)=>{this.logToConsole(i,c),s==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):s==="advancing"||s==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):s==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),i.includes("conclus\xE3o")||i.includes("finalizada")||i.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda com sucesso! Autopilot finalizado.","success"):this.setStatus("Autopilot desativado.","info")):s==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(s,i)=>{try{return await this.callbacks.onAnalyze(s,i,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),wo(this.shadow,`
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap"),this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn.disabled=!0,this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new De(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),de.filter(s=>G(s.id)).forEach(s=>this.modelSelect.add(new Option(s.name,s.id,!1,s.id===e.model))),Eo.forEach(s=>this.modeSelect.add(new Option(s.label,s.value,!1,s.value===e.modeHint))),To.forEach(s=>this.engineSelect.add(new Option(s.label,s.value,!1,s.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let r=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];H.init(r),this.renderKeysList();let n=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof n?.unref=="function"&&n.unref();let l=H.getBestKey()||e.apiKey;l&&He(l).then(s=>{s&&s.length>0&&this.updateModelSelect(s,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];for(let a of t){let r=this.shadow.querySelector(`#eq-tab-${a}`),n=this.shadow.querySelector(`#eq-view-${a}`);a===e?(r?.classList.add("active"),n&&(n.style.display="flex")):(r?.classList.remove("active"),n&&(n.style.display="none"))}e==="brain"?(this.renderContextTree(),this.refreshInspectorView()):e==="metrics"?this.updateTimingMetrics():e==="debug"&&(this.refreshDebugView(),this.renderTerminalEntries())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.metricsResetBtn?.addEventListener("click",()=>{xe(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let e=this.shadow.querySelector("#eq-dbg-scroll-toggle");e?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,e&&(e.style.color=this.autoScrollLogs?"#00ffcc":"#858585",e.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let f=this.getFormattedLogs();navigator.clipboard.writeText(f).then(()=>{let g=t.innerHTML;t.innerHTML=A.check,setTimeout(()=>t.innerHTML=g,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let a=this.shadow.querySelector("#eq-dbg-copy-prompt");a?.addEventListener("click",()=>{let f=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(f).then(()=>{let g=a.innerHTML;a.innerHTML=`${A.check} Copiado!`,setTimeout(()=>a.innerHTML=g,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-context");r?.addEventListener("click",()=>{let f=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let g=r.innerHTML;r.innerHTML=`${A.check} Copiado!`,setTimeout(()=>r.innerHTML=g,1800)})});let n=this.shadow.querySelector("#eq-dbg-copy-raw-resp");n?.addEventListener("click",()=>{let f=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let g=n.innerHTML;n.innerHTML=`${A.check} Copiado!`,setTimeout(()=>n.innerHTML=g,1800)})});let l=this.shadow.querySelector("#eq-dbg-copy-error-btn");l?.addEventListener("click",()=>{let f=this.lastErrorMsg||"";navigator.clipboard.writeText(f).then(()=>{let g=l.innerHTML;l.innerHTML=A.check,setTimeout(()=>l.innerHTML=g,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),this.shadow.querySelector("#eq-min-btn")?.addEventListener("click",()=>this.toggle(!1)),this.shadow.querySelector("#eq-close-btn")?.addEventListener("click",()=>this.toggle(!1)),window.addEventListener("keydown",f=>{f.altKey&&(f.key==="q"||f.key==="Q")&&(f.preventDefault(),this.toggle())},!0);let s=f=>{let g=f.composedPath();g.includes(this.shadow)||(g.includes(this.sidebarEl)||g.includes(this.host))&&f.stopImmediatePropagation()};window.addEventListener("keydown",s,!0),window.addEventListener("keyup",s,!0),window.addEventListener("keypress",s,!0),this.apiKeyInput.addEventListener("input",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:f})});let i=this.shadow.querySelector("#eq-keys-collapsible"),c=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),p=f=>{i&&(f?(i.style.display="none",c&&(c.style.transform="rotate(0deg)")):(i.style.display="block",i.style.maxHeight="none",i.style.overflow="visible",c&&(c.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}p(d),u?.addEventListener("click",f=>{if(f.target?.closest("a"))return;let g=i?.style.display==="none";p(!g);try{localStorage.setItem("easyquiz_keys_collapsed",g?"false":"true")}catch{}}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!f){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let g=H.addKey(f);if(g.ok){let h=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:h[0],apiKeys:h}),this.apiKeyInput.value="",this.setStatus(`\u2713 Nova chave adicionada com sucesso! (${h.length} chaves ativas no pool)`,"success"),p(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Ie(f).then(v=>{v.ok?(H.markSuccess(f,100),this.setStatus("\u2713 Nova chave validada com sucesso no Google AI Studio!","success")):(H.markInvalid(f,v.message),this.setStatus(`\u26A0\uFE0F Chave cadastrada, mas aviso retornado: ${v.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(g.message,"warning")}),this.keyMoreBtn.addEventListener("click",f=>{f.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",f=>{let g=f.target;!g.closest("#eq-key-context-menu")&&!g.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(f!==null&&f.trim()){let g=f.trim().replace(/^["']|["']$/g,""),h=H.addKey(g);if(h.ok){let v=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(h.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let f=await navigator.clipboard.readText();if(f){let g=f.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=g,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let f=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(f!==null&&f.trim()){let g=f.trim().replace(/^["']|["']$/g,"");if(H.addKey(g).ok){let v=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=this.apiKeyInput.type==="password";this.apiKeyInput.type=f?"text":"password";let g=this.shadow.querySelector("#eq-menu-vis-icon"),h=this.shadow.querySelector("#eq-menu-vis-text");g&&(g.innerHTML=f?A.eyeOff:A.eye),h&&(h.textContent=f?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let f=document.createElement("div");f.id="eq-bulk-overlay",f.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let g=document.createElement("div");g.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),g.innerHTML=`
      ...
      `,f.appendChild(g),this.shadow.appendChild(f);let h=g.querySelector("#eq-bulk-ta"),v=g.querySelector("#eq-bulk-status"),T=g.querySelector("#eq-bulk-import"),S=g.querySelector("#eq-bulk-paste-btn"),w=g.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>h?.focus());let E=()=>{f.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(I=>{f.addEventListener(I,M=>{M.stopPropagation(),M.stopImmediatePropagation()},!0)}),f.addEventListener("keydown",I=>{I.key==="Escape"&&E()}),f.addEventListener("click",I=>{I.target===f&&E()}),g.querySelector("#eq-bulk-x")?.addEventListener("click",E),g.querySelector("#eq-bulk-cancel")?.addEventListener("click",E),w.addEventListener("click",()=>{h.value="",v.textContent="",h.focus()}),S.addEventListener("click",async()=>{try{let I=await navigator.clipboard?.readText();I?(h.value=I,h.focus(),v.style.color="#38bdf8",v.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(v.style.color="#fbbf24",v.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{v.style.color="#fbbf24",v.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",h.focus()}}),g.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let I=h.value.trim();if(!I){v.style.color="#f87171",v.textContent="Insira pelo menos uma chave de API antes de importar.";return}let M=I.match(/AIza[0-9A-Za-z\-_]{35}/g),z=[];if(M&&M.length>0?z=Array.from(new Set(M)):z=Array.from(new Set(I.split(/[\n,;\s]+/).map(R=>R.trim().replace(/^["'`]|["'`]$/g,"")).filter(R=>R.length>=20))),z.length===0){v.style.color="#f87171",v.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}v.style.color="#00e5ff",v.textContent=`Processando ${z.length} chave(s)...`,T.disabled=!0,T.style.opacity="0.6";let C=0,N=0;for(let R of z){let Y=H.addKey(R);Y.ok?C++:Y.message.includes("j\xE1 est\xE1 cadastrada")&&N++}if(C>0){let R=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:R[0],apiKeys:R}),p(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}v.textContent=`${C} adicionada(s), ${N} duplicada(s). Validando modelo em paralelo...`;let Z=H.exportRawKeys(),D=this.modelSelect?.value||"gemini-3.5-flash-lite",_=await Fe(D,Z);_.ok?(H.markSuccess(_.key,200),v.style.color="#4ade80",v.textContent=`\u2713 ${C} adicionada(s), ${N} duplicada(s). Modelo '${_.model}' pronto!`):(v.style.color="#fbbf24",v.textContent=`${C} adicionada(s), ${N} duplicada(s). Aviso: ${_.message}`),this.renderKeysList(),T.disabled=!1,T.style.opacity="1",C>0&&(this.setStatus(`\u2713 Lote importado: ${C} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(E,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let f=H.exportRawKeys(),g=document.createElement("div");g.id="eq-text-editor-overlay",g.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let h=document.createElement("div");h.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),h.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
