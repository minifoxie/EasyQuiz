 ...
 */
"use strict";(()=>{var j={apiKey:"",model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};var ke="easyquiz_settings_v2",Q="easyquiz_activity_metrics";function He(){try{let o=localStorage.getItem(ke);if(!o){let a=localStorage.getItem("easyquiz_settings_v1");if(a){let i=JSON.parse(a);return{...j,apiKey:i.apiKey||""}}return{...j}}let e=JSON.parse(o),t=typeof e.model=="string"&&e.model?e.model:j.model;return{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():j.apiKey,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:j.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:j.confidenceThreshold}}catch{return{...j}}}function tt(){try{localStorage.removeItem(ke),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(Q),sessionStorage.removeItem(Q);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),ze()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function ie(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Ie(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...ie(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function ot(o){let t={...He(),...o};try{localStorage.setItem(ke,JSON.stringify(t))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return t}var F=[],et=12,Tt=1200;function nt(o){let e=o.trim().replace(/\s+/g," ").slice(0,Tt);e&&!F.includes(e)&&(F.push(e),F.length>et&&(F=F.slice(-et)))}function fe(){return F}function ze(){F=[]}function at(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var ae=at();function J(){try{localStorage.removeItem(Q)}catch{}return ae}function Ct(o){ae=o;try{let e=JSON.stringify(o);sessionStorage.setItem(Q,e),localStorage.removeItem(Q)}catch{}}function $e(o){let e=ae,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let i={...o,timestamp:t},n=[...e.records,i],s=n.filter(u=>u.status==="answered"||u.status==="verified").length,r=n.reduce((u,h)=>u+h.durationMs,0),c=s>0?Math.round(r/s):0,d={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),r),completedQuestionsCount:s,averageDurationMs:c,records:n};return Ct(d),d}function se(){ae=at();try{sessionStorage.removeItem(Q),localStorage.removeItem(Q)}catch{}return ae}var it=[{id:"native-value-events",widget:"text",label:"Setter nativo com input/change/blur",precondition:"Campo edit\xE1vel vis\xEDvel e n\xE3o desabilitado.",evidence:"value ou textContent coincide exatamente com o valor esperado.",risk:"low",cost:"fast"},{id:"native-choice-state",widget:"choice",label:"Estado nativo de radio/checkbox",precondition:"Input ou widget ARIA \xFAnico localizado.",evidence:"checked/aria-checked/data-state do alvo e grupo correspondem ao esperado.",risk:"low",cost:"fast"},{id:"native-select-events",widget:"select",label:"Sele\xE7\xE3o nativa por value/texto exato",precondition:"Select vis\xEDvel com op\xE7\xE3o correspondente.",evidence:"option.selected e selected value correspondem ao esperado.",risk:"low",cost:"fast"},{id:"aria-combobox-keyboard",widget:"combobox",label:"Combobox ARIA por foco e teclado",precondition:"Combobox vis\xEDvel com popup/op\xE7\xF5es acess\xEDveis.",evidence:"aria-expanded, aria-activedescendant ou op\xE7\xE3o selecionada mudam.",risk:"medium",cost:"normal"},{id:"click-to-place",widget:"drag",label:"Selecionar item e clicar no destino",precondition:"Cart\xE3o e dropzone vis\xEDveis com protocolo click-to-place.",evidence:"Item passa a ser filho do destino ou recebe estado de colocado.",risk:"medium",cost:"normal"},{id:"html5-drag-drop",widget:"drag",label:"HTML5 dragstart/dragover/drop",precondition:"Origem draggable e destino aceita drag/drop.",evidence:"Relocation, callback ou estado placed confirmado.",risk:"medium",cost:"normal"},{id:"keyboard-order",widget:"order",label:"Ordena\xE7\xE3o por foco e teclado",precondition:"Itens orden\xE1veis com foco/roles ou bot\xF5es de mover.",evidence:"Ordem dos itens no DOM corresponde \xE0 sequ\xEAncia esperada.",risk:"medium",cost:"normal"},{id:"navigation-feedback",widget:"navigation",label:"Verificar e confirmar feedback/transi\xE7\xE3o",precondition:"Bot\xE3o de verifica\xE7\xE3o/avan\xE7o \xFAnico e habilitado.",evidence:"Feedback esperado e assinatura espec\xEDfica da quest\xE3o mudam.",risk:"high",cost:"normal"},{id:"javascript-explicit",widget:"javascript",label:"JavaScript limitado via capability expl\xEDcita",precondition:"Engine javascript autorizada e a\xE7\xE3o declarativa insuficiente.",evidence:"Efeito DOM esperado confirmado por verificador.",risk:"high",cost:"last-resort"}];function Lt(o){if(!o||o.length===0)return it.filter(t=>t.widget!=="javascript");let e=new Set(o);return it.filter(t=>e.has(t.widget))}function st(o){return Lt(o).map(e=>`${e.id}: ${e.label} | pr\xE9: ${e.precondition} | prova: ${e.evidence} | risco: ${e.risk}`).join(`
...
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var St=new Set(["question","info","start","conclusion"]),Mt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),At=new Set(["val","chk","sel","clk","adv","js","drag"]),kt=150,le=2e3;function R(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,le):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,le):e}function Ht(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!At.has(a))return null;if(a==="adv"){let r=t.id??t.target??t.name??t.selector;return{t:"adv",...R(r)?{id:R(r,"").slice(0,500)}:{}}}if(a==="drag"){let r=R(t.from??t.source),c=R(t.to??t.target??t.destination);return!r||!c?null:{t:"drag",from:r.slice(0,500),to:c.slice(0,500)}}if(a==="js"){let r=R(t.v??t.code??t.script);return!r||r.length>8e3?null:{t:"js",v:r}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&a==="val"&&(i="1");let n=R(i).slice(0,500);if(!n)return null;if(a==="val"){let r=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:R(r).slice(0,le)}}if(a==="sel"){let r=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,d=(Array.isArray(r)?r:[r]).map(u=>R(u).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:d}}if(a==="chk"){let r=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",c={t:"chk",id:n,c:!r};return t.v!==void 0&&(c.v=R(t.v).slice(0,le)),c}let s={t:"clk",id:n};if(t.c!==void 0){let r=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";s.c=!r}return t.v!==void 0&&(s.v=R(t.v).slice(0,le)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(r=>typeof r=="number"&&Number.isFinite(r))&&(s.co=[t.co[0],t.co[1]]),s}function lt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!St.has(t))&&(t="question"),(typeof a!="string"||!Mt.has(a))&&(a="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],n=[];for(let d=0;d<Math.min(i.length,kt);d++){let u=Ht(i[d],d);u&&n.push(u)}let s=n.filter(d=>d.t!=="adv"),r=n.some(d=>d.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?r||n.push({t:"adv"}):t==="question"&&!r&&n.push({t:"adv"});let c=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:c,rationale:R(e.rationale,"Plano validado e auto-recuperado."),actions:n,...R(e.memoryToStore)?{memoryToStore:R(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var W=[{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido - 0 Thinking)",description:"Modelo de ultrabaixa lat\xEAncia com zero thinking overhead para respostas imediatas.",stable:!0},{id:"gemini-2.0-flash",name:"Gemini 2.0 Flash (M\xE1xima Disponibilidade)",description:"Ultra-baixa lat\xEAncia comprovada com suporte multimodal nativo.",stable:!0},{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Nova Gera\xE7\xE3o)",description:"Modelo de ponta Flash otimizado para alta velocidade e racioc\xEDnio.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Equilibrado)",description:"Excelente velocidade e consist\xEAncia.",stable:!0},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Reserva Global)",description:"Modelo de alt\xEDssima estabilidade e ampla cota gratuita.",stable:!0},{id:"gemini-2.0-flash-lite-preview-02-05",name:"Gemini 2.0 Flash-Lite (Econ\xF4mico)",description:"Modelo leve para respostas ultrarr\xE1pidas.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0},{id:"gemini-1.5-pro",name:"Gemini 1.5 Pro (Alta Precis\xE3o)",description:"Modelo confi\xE1vel para problemas dif\xEDceis.",stable:!0}],Pe=null;function It(o){let e={temperature:0,maxOutputTokens:2e3,response_mime_type:"application/json",response_schema:zt};return/gemini-2\.5/i.test(o)?e.thinkingConfig={thinkingBudget:0}:/gemini-3/i.test(o)&&(e.thinkingConfig={thinkingLevel:"LOW"}),e}var zt={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function $t(o){return o.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function ct(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Pt(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Re=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;return o?JSON.parse(o):null}catch{return null}})(),ce=new Set;async function ve(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return W;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let i=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let s=await i.text(),r=ct(s,i.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let n=await i.json();if(Array.isArray(n.models)&&n.models.length>0){let s=n.models.filter(r=>{let c=r.supportedGenerationMethods||[],d=(r.name||"").includes("gemini"),u=c.includes("generateContent"),h=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return d&&u&&!h}).map(r=>{let c=r.supportedGenerationMethods||[],d=r.name.replace(/^models\//,""),u=r.displayName||d;return{id:d,name:u.includes(d)?u:`${u} (${d})`,description:r.description||"",stable:!/-preview|-experimental|-latest/i.test(d),supportsVision:!/embedding|tts|transcribe|live|image/i.test(d),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(s.length>0){s.sort((r,c)=>{let d=u=>u==="gemini-2.5-flash"?130:u==="gemini-2.0-flash"?125:u==="gemini-3.8-flash"?120:u==="gemini-3.5-flash"?115:u==="gemini-3.5-flash-lite"?110:u==="gemini-2.0-flash-lite-preview-02-05"?105:u==="gemini-1.5-flash"?90:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u==="gemini-3.1-pro-preview"?55:u==="gemini-1.5-pro"?50:10;return d(c.id)-d(r.id)}),Re=s;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(s))}catch{}return s}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return W}async function dt(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await ve(e);if(a.length>0&&a!==W){let i=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-2.5-flash","gemini-2.0-flash","gemini-3.8-flash","gemini-1.5-flash"];for(let a of t)for(let i of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${i}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${i})!`,models:W}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function Rt(o,e,t,a,i){let n=["v1beta","v1"],s=new Error(`Falha ao consultar modelo ${o}`),c={...It(o)};for(let d of n){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${d}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{let h=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:i,keepalive:a});if(!h.ok){let g=await h.text();if(h.status===400&&c.thinkingConfig&&/thinking/i.test(g)){delete c.thinkingConfig;let f=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:i,keepalive:a});if(f.ok){let m=await f.json(),b=m.candidates?.[0];if(b?.content?.parts?.[0]?.text)return{rawText:b.content.parts[0].text,data:m,usedModel:o}}}let y=ct(g,h.status);if(h.status===404&&d==="v1beta")continue;throw(h.status===404||h.status===403)&&ce.add(o),new Error(y)}let l=await h.json(),p=l.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");return{rawText:p.content.parts[0].text,data:l,usedModel:o}}catch(h){if(i.aborted)throw h;if(s=h,s.message.includes("404")&&ce.add(o),!s.message.includes("404"))break}}throw s}async function Be(o,e,t,a,i){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let n=t.apiKey.trim().replace(/^["']|["']$/g,"");if(!n)throw new Error("Chave de API n\xE3o configurada.");let s=$t(t.model);if(!Re&&n&&ve(n).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let r=Date.now(),c=re(o,e,t),d=[{text:c}];for(let m=0;m<e.length;m++){let b=e[m],x=b.associatedLabel||(b.alt?`Imagem: ${b.alt}`:`Imagem ${m+1}`);d.push({text:`[ANEXO VISUAL ${m+1} - V\xCDNCULO: ${x}]:`}),d.push({inline_data:{mime_type:b.mediaType,data:b.base64}})}let u={system_instruction:{parts:[{text:rt}]},contents:[{role:"user",parts:d}]},h=!0,l=[...Pe?[Pe]:[],s,"gemini-2.5-flash","gemini-2.0-flash","gemini-3.8-flash","gemini-3.5-flash",...Re?.map(m=>m.id)||[],"gemini-1.5-flash","gemini-2.0-flash-lite-preview-02-05","gemini-3.5-flash-lite","gemini-2.5-pro","gemini-1.5-pro"],p=Array.from(new Set(l)).filter(m=>!ce.has(m));p.length===0&&(ce.clear(),p=Array.from(new Set(l)));let g=3,y=[];for(let m=0;m<p.length;m+=g)y.push(p.slice(m,m+g));let f=new Error("Nenhum modelo dispon\xEDvel para an\xE1lise.");for(let m=0;m<y.length;m++){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let b=y[m].filter(E=>!ce.has(E));if(b.length===0)continue;m===0?a?.(`\u26A1 Velocidade M\xE1xima: consultando APIs em paralelo (${b.join(", ")})...`,"info"):a?.(`\u26A1 Alternando onda de fallback em paralelo (${b.join(", ")})...`,"warning");let x=b.map(()=>new AbortController),q=E=>{x.forEach((S,M)=>{if(M!==E)try{S.abort(new Error("Cancelado: outro modelo respondeu mais r\xE1pido."))}catch{S.abort()}})},L=()=>{x.forEach(E=>{try{E.abort(new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio."))}catch{E.abort()}})};if(i){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");i.addEventListener("abort",L,{once:!0})}try{let E=b.map(async(M,O)=>{let D=x[O],ne=b.length>1?8e3:12e3,Y=setTimeout(()=>{try{D.abort(new Error(`Timeout de ${ne/1e3}s excedido na API Gemini (${M}).`))}catch{D.abort()}},ne);try{let $=await Rt(M,n,u,h,D.signal);clearTimeout(Y);let N=lt(Pt($.rawText));return N.usedModel=$.usedModel,N.durationMs=Date.now()-r,N.promptSent=c,N.tokensUsed=$.data.usageMetadata?.totalTokenCount,N.promptTokens=$.data.usageMetadata?.promptTokenCount,N.candidatesTokens=$.data.usageMetadata?.candidatesTokenCount,N.rawResponse=$.rawText,q(O),{plan:N,rawUsage:$.data.usageMetadata,usedModel:$.usedModel}}catch($){throw clearTimeout(Y),$}}),S=await Promise.any(E);i?.removeEventListener("abort",L),Pe=S.usedModel;try{t.model=S.usedModel}catch{}return a?.(`\u26A1 Resposta mais r\xE1pida recebida em ${S.plan.durationMs}ms via '${S.usedModel}'!`,"info"),S}catch(E){if(i?.removeEventListener("abort",L),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");f=E instanceof Error?E:new Error(String(E)),console.warn(`[EasyQuiz Wave Race] Onda ${m+1} (${b.join(", ")}) falhou. Tentando pr\xF3xima onda...`,E)}}throw f}var Bt=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function de(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function Ne(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function ut(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(Bt.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var X=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),be=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,Nt=0;function Oe(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!Z(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function H(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function C(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||Z(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${H(e.id)}"]`);if(n&&Oe(n))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Oe(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let s=e.getBoundingClientRect();if(s.width>0||s.height>0)return!0}return!0}}}catch{}}return Oe(e)}function Ot(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function A(o,e=500){return Ot(o).replace(/\s+/g," ").trim().slice(0,e)}function Dt(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(Nt+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function Z(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var ue=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function I(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(Z(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),s=String(a.getAttribute?.("title")||""),r=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",c=A(a.textContent,60);return!!(ue.test(i)||ue.test(n)||ue.test(s)||ue.test(r)||c.length>0&&c.length<=25&&ue.test(c))}function _(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||Z(o)||I(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=A(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,i=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return be.test(i)||be.test(t)||a==="submit"||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")||!1}function De(o){let e=o.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),d=c&&c!==o.closest("td")?A(c.textContent,100):"",u=A(o.closest("label, td")?.textContent||"",50);if(d&&u)return`${d}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let c=t.querySelector('.dropdown-label, [class*="label" i]'),d=c&&c!==o?A(c.textContent,150):"";if(d)return d}let a=o.getAttribute("aria-label");if(a)return A(a);let i=o.getAttribute("aria-labelledby");if(i){let c=i.split(/\s+/).map(d=>document.getElementById(d)?.textContent).filter(Boolean).join(" ");if(c.trim())return A(c)}if("labels"in o&&o.labels){let c=Array.from(o.labels??[]).map(d=>d.textContent).join(" ");if(c.trim())return A(c)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let c=A(n.textContent);if(c)return c}let s=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",r=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||s||"";return A(r)}function Ve(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(n)?n:"other",r=o.getAttribute("role")||"",c=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),d=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(d),h=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(d),p=A((u?"draggable":h?"dropzone":"")||i.type||r||s,40),g="";if(i.type==="checkbox"||i.type==="radio"||r==="radio"||r==="checkbox")g=i.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(s==="button"||n==="a"||e==="navigation"||_(o))g="";else{let q=typeof o.value=="string"||typeof o.value=="number"?o.value:"";g=A(q||o.getAttribute("data-category")||"",2e3)}let y=[];if(a&&a.options)for(let q of Array.from(a.options).slice(0,80))y.push({value:A(q.value),label:A(q.textContent)});else if(r==="combobox"||r==="listbox"||d.includes("select")||d.includes("dropdown")){let q=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),L=q?document.getElementById(q):o;if(L){let E=L.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let S of Array.from(E).slice(0,80)){let M=A(S.textContent);M&&y.push({value:S.getAttribute("data-value")||S.getAttribute("value")||M,label:M})}}}let f=!!(i.required||o.getAttribute("aria-required")==="true"),m=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),b=Dt(o);return{id:o.id||b,tag:s,type:p,label:De(o),name:A(i.name||o.getAttribute("name")||"",180),value:g,options:y,required:f,disabled:m,role:e}}var pt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function ht(o){if(!C(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(X)).filter(C),a=A(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),s=Math.min(1,n/i),r=e.top+e.height/2,c=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),d=a>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+d+u-s*20-c*10}function ye(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let i=A(e.innerText||e.textContent||"",1e4),n=A(t.innerText||t.textContent||"",1e4),s=e.querySelectorAll(X).length,r=t.querySelectorAll(X).length;if(i.length<150&&n.length>i.length&&r<=s+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function mt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&C(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function z(){let o=document.activeElement;if(o&&o!==document.body){let n=o.closest(pt);if(n&&ht(n)>0)return ye(n)}let t=Array.from(document.querySelectorAll(pt)).map(n=>({element:n,score:ht(n)})).filter(n=>Number.isFinite(n.score)).sort((n,s)=>s.score-n.score),a=t.find(n=>{let s=n.element.tagName.toLowerCase();return s!=="main"&&s!=="body"&&n.score>0});if(a)return ye(a.element);if(t.length>0&&t[0].score>0)return ye(t[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&C(i)?i:document.body}function gt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let i of Array.from(a.attributes))t.includes(i.name)||a.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function xe(o){let e=Array.from(o.querySelectorAll(X)),t=new Set,a=[];for(let i of e){if(!C(i)||_(i)||I(i))continue;let n=i.tagName.toLowerCase();["input","textarea","select"].includes(n)&&(t.add(i),a.push(i))}for(let i of e){if(!C(i)||_(i)||I(i))continue;let n=i.tagName.toLowerCase();if(["input","textarea","select"].includes(n))continue;let s=i.querySelector("input, textarea, select");if(!(s&&t.has(s))){if(i.hasAttribute("for")){let r=i.getAttribute("for"),c=r?i.ownerDocument.getElementById(r):null;if(c&&t.has(c))continue}if(n==="a"){let r=i.getAttribute("role");if(!(r==="button"||r==="radio"||r==="checkbox"||r==="option"||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(i)}}return a.slice(0,100).map(i=>Ve(i,"answer"))}function _e(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let i of e)for(let n of Array.from(i.querySelectorAll(X)))if(!(t.has(n)||!C(n)||!_(n)||I(n))&&(t.add(n),a.push(Ve(n,"navigation")),a.length>=10))return a;return a}function pe(o=!1){let e=z();e=ye(e),o&&(e=mt(e));let t=xe(e),a=_e(e);if(t.length===0){let r=xe(document.body);r.length>0&&(e=mt(e),t=xe(e),t.length===0&&(t=r,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=_e(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=A(i,16e3),s=[...t,...a].slice(0,120);return!n||s.length===0&&n.length<30?A(document.body.innerText||document.body.textContent||"",16e3).length>=30?ee():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:gt(e),controls:s,scope:e}}function ee(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=A(o,16e3),t=xe(document.body),a=_e(document.body),i=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:gt(n).slice(0,15e3),controls:i,scope:n}}function ft(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}:${t.value}:${t.disabled}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,500),e].join("::")}function k(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function v(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function P(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let i=o.ownerDocument.getElementById(a);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return P(a)}return o}function vt(o){let e=o;if(!e||!document.contains(e))try{e=z()}catch{}e=e||document.body;let t=Array.from(e.querySelectorAll("tr")).filter(n=>C(n)&&n.querySelector('input[type="radio"], input[type="checkbox"]'));if(t.length>1)return t;let a=Array.from(e.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(n=>C(n)&&!k(n));return a.length>0?a:Array.from(e.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(n=>C(n)&&!k(n)).filter(n=>!n.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'))}function T(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let n=H(i),s=document.querySelector(`[data-easyquiz-id="${n}"]`);if(s&&!k(s)&&C(s))return P(s);try{let l=document.getElementById(i);if(l&&!k(l)&&C(l))return l.hasAttribute("data-category")||l.hasAttribute("data-dropzone")||l.classList.contains("dnd-zone")?l:P(l)}catch{}let r=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(r){let l=parseInt(r[1],10);if(t){let g=document.body;try{g=z()||document.body}catch{}let y=Array.from(g.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(f=>C(f)&&!k(f));if(l>=1&&l-1<y.length)return y[l-1];if(l===0&&y.length>0)return y[0]}let p=l-1;if(p>=0){let g=vt();if(p<g.length){let m=g[p];if(m.tagName.toLowerCase()==="tr"){if(e){let x=m.querySelector(`input[value="${H(e)}" i], [data-value="${H(e)}" i]`);if(x)return x}let b=m.querySelector("input");if(b)return b}return P(m)}let y=document.body;try{y=z()||document.body}catch{}let f=Array.from(y.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(m=>C(m)&&!k(m));if(p<f.length)return f[p]}}let c=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(c){let l=c[1].toUpperCase().charCodeAt(0)-65;if(l>=0){let p=vt();if(l<p.length){let g=p[l];if(g.tagName.toLowerCase()==="tr"){if(e){let f=g.querySelector(`input[value="${H(e)}" i], [data-value="${H(e)}" i]`);if(f)return f}let y=g.querySelector("input");if(y)return y}return P(g)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let p=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(m=>C(m)&&!k(m));if(p)return p;let y=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(m=>C(m)&&!k(m));if(y)return P(y);let f=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(m=>{if(!C(m)||k(m))return!1;let b=v(m.textContent).toLowerCase();return b===i.toLowerCase()||b===i.toLowerCase()+")"});if(f)return P(f)}try{let p=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`)).find(g=>C(g)&&!k(g));if(p)return p.hasAttribute("data-category")||p.hasAttribute("data-dropzone")||p.classList.contains("dnd-zone")?p:P(p)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let p=Array.from(document.querySelectorAll(i)).find(g=>C(g)&&!k(g));if(p)return P(p)}catch{}try{let l=i.replace(/"/g,""),p=`//button[normalize-space(.)="${l}"] | //a[normalize-space(.)="${l}"] | //*[not(*) and normalize-space(.)="${l}"] | //*[@aria-label="${l}"] | //*[@data-category="${l}"] | //*[@data-testid="${l}"]`,g=document.evaluate(p,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let y=0;y<g.snapshotLength;y++){let f=g.snapshotItem(y);if(f&&C(f)&&!k(f)){if(["body","html"].includes(f.tagName.toLowerCase())){let b=f.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&C(b))return P(b)}return f.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||P(f)}}}catch{}let u=v(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let l of h){if(!C(l)||k(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||I(l)||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=v(l.textContent).toLowerCase(),y=v(l.getAttribute("aria-label")||"").toLowerCase(),f=v(l.getAttribute("placeholder")||"").toLowerCase(),m=v(l.getAttribute("title")||"").toLowerCase(),b=v(l.getAttribute("name")||"").toLowerCase(),x=v(l.getAttribute("data-category")||"").toLowerCase(),q=l instanceof HTMLInputElement||l instanceof HTMLButtonElement?l.value:"",L=v(q).toLowerCase(),E=g.startsWith(u+")")||g.startsWith(u+".")||g.startsWith(u+" -")||g.startsWith(u+":");if(g===u||y===u||f===u||m===u||b===u||x&&x===u||L&&L===u||E)return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||P(l)}if(u.length>=3)for(let l of h){if(!C(l)||k(l)||l.closest("header, nav, .stepper, .step-item, .progress-bar-container")||I(l)||!!(l.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||l.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!l.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=v(l.textContent).toLowerCase(),y=v(l.getAttribute("aria-label")||"").toLowerCase(),f=v(l.getAttribute("placeholder")||"").toLowerCase(),m=v(l.getAttribute("title")||"").toLowerCase(),b=v(l.getAttribute("name")||"").toLowerCase();if(g.includes(u)||y.includes(u)||f.includes(u)||m.includes(u)||b.includes(u)){if(Array.from(l.children).some(E=>{let S=v(E.textContent).toLowerCase();return S&&S.includes(u)}))continue;return l.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||P(l)}let x=u.split(/\s+/).filter(Boolean);if(x.length>=3){let q=x.slice(0,Math.min(5,x.length)).join(" ");if(g.includes(q)||y.includes(q)||f.includes(q))return P(l)}}return null}function yt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function B(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){V(t,!0);return}if(t.type==="radio"){V(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement||typeof HTMLAnchorElement<"u"&&o instanceof HTMLAnchorElement||o.tagName?.toLowerCase()==="a"||o.tagName?.toLowerCase()==="button"||typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let i=o.getBoundingClientRect(),n=e?e[0]:Math.round(i.left+Math.max(1,i.width/2)),s=e?e[1]:Math.round(i.top+Math.max(1,i.height/2)),r={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:s};try{o.dispatchEvent(new PointerEvent("pointerdown",{...r,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...r,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...r,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...r,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...r,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function qe(o,e){let t=o;if(t.hasAttribute("for")){let d=t.getAttribute("for"),u=t.ownerDocument.getElementById(d);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){we(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){we(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let d=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(d)t=d;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let l=t.nextElementSibling;for(;l;){if(l instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(l.type)||l instanceof HTMLTextAreaElement||l instanceof HTMLElement&&l.isContentEditable){t=l;break}let p=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){t=p;break}l=l.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let d=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d)t=d;else{let u=document.body;try{u=z()||document.body}catch{}let h=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let d=document.body;try{d=z()||document.body}catch{}let u=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let d=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;V(t,d);return}let s=String(e??""),r=s;if(t instanceof HTMLInputElement&&t.type==="number"){let d=s.replace(",",".").replace(/[^0-9.-]/g,"");d&&!isNaN(Number(d))&&(r=d)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let c=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}c=document.execCommand?.("insertText",!1,r)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}c=document.execCommand?.("insertText",!1,r)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(r===""?" ":"")}catch{}let d=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(d,"value")?.set;u?u.call(t,r):t.value=r;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:r.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:r,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:r,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:r.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==r&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(r))){t.value=r;try{u?.call(t,r)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==r.trim()){t.textContent=r;try{t.innerText=r}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:r,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=r),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function he(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=v(t),n=T(t)||T(i);if(!n)return a?e:i||e;let s=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(s){let h=v(s.textContent);if(h&&h.length>0&&h.length<150)return h}if(n.id){let h=document.querySelector(`label[for="${H(n.id)}"]`);if(h){let l=v(h.textContent);if(l&&l.length>0&&l.length<150)return l}}let r=n.getAttribute("aria-label");if(r)return v(r);let c=n.getAttribute("placeholder");if(c)return v(c);let d=v(n.textContent);if(d&&d.length>0&&d.length<120)return d;let u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return u?v(u):a?e:i||e}function V(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let i=e?"true":"false";t.setAttribute("aria-checked",i),t.setAttribute("aria-selected",i),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(a){if(a.checked===e)return;try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let i=a._valueTracker;i&&i.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,yt(a,["input","change"])}}else{try{t.focus?.()}catch{}try{t.click()}catch{B(t)}}}function we(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let s=e.map(d=>v(d).toLowerCase()),r=!1,c=(d,u)=>{d.selected=!0,t.selectedIndex=u;try{t.value=d.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,d.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(d.value)}catch{}r=!0};for(let d=0;d<t.options.length;d++){let u=t.options[d],h=u.value.toLowerCase(),l=v(u.textContent).toLowerCase();if(s.some(g=>g===h||g===l)){if(c(u,d),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!r)for(let d of s){let u=d.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let h=parseInt(u[1],10),p=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(p>=0&&p<t.options.length&&(c(t.options[p],p),!t.multiple))break}}if(!r){for(let d of s)if(/^[a-z]$/i.test(d)){let u=d.toUpperCase().charCodeAt(0)-65,l=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(l>=0&&l<t.options.length&&(c(t.options[l],l),!t.multiple))break}}if(!r){let d=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let h=t.options[u],l=d(h.value.toLowerCase()),p=d(v(h.textContent).toLowerCase());if(s.some(y=>{let f=d(y);return l.includes(f)||p.includes(f)||f.length>2&&(f.includes(l)||f.includes(p))})&&(c(h,u),!t.multiple))break}}if(r){yt(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&B(a);let i=e.map(s=>v(s).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(s=>C(s)&&!k(s));for(let s of i){let r=n.find(d=>{let u=v(d.textContent).toLowerCase(),h=v(d.getAttribute("data-value")||d.getAttribute("value")||"").toLowerCase();return u===s||h===s||u.includes(s)||s.length>2&&s.includes(u)});if(r){B(r);let d=r.querySelector('input[type="radio"], input[type="checkbox"]');d&&V(d,!0);return}let c=T(s);if(c){B(c);return}}}function Vt(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function je(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function G(o,e){let t=v(o).toLowerCase();if(!t)return null;let a=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',i=Array.from(document.querySelectorAll(a)),n=e==="destination"?i.find(s=>[s.getAttribute("data-category"),s.getAttribute("data-dropzone")].some(r=>r?.trim().toLowerCase()===t)):null;return n&&C(n)&&!k(n)?n:i.find(s=>{if(!C(s)||k(s))return!1;let r=v(`${s.textContent||""} ${s.getAttribute("data-category")||""} ${s.getAttribute("data-dropzone")||""}`).toLowerCase();return r===t||r.includes(t)})||null}async function Ee(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),i=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),s=Math.round(a.top+Math.max(1,a.height/2)),r=Math.round(i.left+Math.max(1,i.width/2)),c=Math.round(i.top+Math.max(1,i.height/2)),d=v(e.textContent).toLowerCase();if(d){let y=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(f=>{let m=v(f.textContent).toLowerCase(),b=f instanceof HTMLInputElement||f instanceof HTMLOptionElement?v(f.value).toLowerCase():"";return m&&(d.includes(m)||m.includes(d))||b&&(d.includes(b)||b.includes(d))});y&&(B(y),await new Promise(f=>setTimeout(f,120)))}je(o),await new Promise(g=>setTimeout(g,140)),je(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&je(u),await new Promise(g=>setTimeout(g,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:s,screenX:n,screenY:s,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",h));let l=4;for(let g=1;g<=l;g++){let y=Math.round(n+(r-n)*(g/l)),f=Math.round(s+(c-s)*(g/l)),m={...h,clientX:y,clientY:f,screenX:y,screenY:f};try{o.dispatchEvent(new PointerEvent("pointermove",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",m))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:c,screenX:r,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",p)),e.dispatchEvent(new MouseEvent("click",p));try{let g=Vt(A(o.textContent),o.outerHTML),y={...h},f={...p};g&&(y.dataTransfer=g,f.dataTransfer=g);let m=o.ownerDocument.defaultView?.DragEvent;if(!m)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new m("dragstart",y)),e.dispatchEvent(new m("dragenter",f)),e.dispatchEvent(new m("dragover",f)),e.dispatchEvent(new m("drop",f)),o.dispatchEvent(new m("dragend",y))}catch(g){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",g)}try{let g=new Touch({identifier:1,target:o,clientX:n,clientY:s}),y=new Touch({identifier:1,target:e,clientX:r,clientY:c});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[y]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(g=>setTimeout(g,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var xt={fill:(o,e)=>{let t=T(o);t?qe(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=T(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?V(e,!0):B(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=T(o);t?V(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>T(o,e),drag:(o,e)=>{let t=G(o,"source")||T(o),a=G(e,"destination")||T(e);t&&a?Ee(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=G(o,"source")||T(o),a=G(e,"destination")||T(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Ee(t,a)},execute:(o,e=!1,t=1)=>Qe(o,e,t)};typeof window<"u"&&(window.$eq=xt);async function _t(o,e=1,t=de()){if(Ne(o,t),o.t==="js"){let r=String(o.v||"");ut(r);try{new Function("$eq","document","window",r)(xt,document,window)}catch(c){throw console.warn("[EasyQuiz JS Execution]",c),c}return}if(o.t==="drag"){let r=G(o.from,"source")||T(o.from),c=G(o.to,"destination")||T(o.to);!r&&o.from&&(r=T(v(o.from))),!c&&o.to&&(c=T(v(o.to))),r&&c?await Ee(r,c,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=i!=null?String(i).trim():"",s=T(a,n,o.t==="val"||o.t==="sel");if(!s&&a&&(s=T(v(a),n,o.t==="val"||o.t==="sel")),s&&n){if(s instanceof HTMLInputElement&&s.type==="radio"&&s.name){if(v(s.value).toLowerCase()!==v(n).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${H(s.name)}"][value="${H(n)}" i]`);if(r)s=r;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${H(s.name)}"]`)).find(u=>{let h=u.closest("label, .vf-label, .option-card, tr, td, div");return h&&v(h.textContent).toLowerCase().includes(v(n).toLowerCase())});d&&(s=d)}}}else if(!(s instanceof HTMLInputElement)&&!(s instanceof HTMLSelectElement)&&!(s instanceof HTMLTextAreaElement)){let r=s.querySelector(`input[value="${H(n)}" i], [data-value="${H(n)}" i]`);if(r)s=r;else{let d=Array.from(s.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(u=>{let h=u.closest("label, .vf-label, .option-card, td, div");return h&&v(h.textContent).toLowerCase().includes(v(n).toLowerCase())});d&&(s=d)}}}if(!s&&(o.t==="val"||o.t==="sel")){let r=document.body;try{r=z()||document.body}catch{}let c=Array.from(r.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(d=>C(d)&&!k(d));if(c.length===1)s=c[0];else if(c.length>1){let d=v(a).toLowerCase(),u=d.match(/^#?_?([0-9]+)$/);if(u){let h=parseInt(u[1],10);h>=1&&h<=c.length?s=c[h-1]:h>=0&&h<c.length&&(s=c[h])}s||(s=c.find(l=>{let p=(l.getAttribute("placeholder")||"").toLowerCase(),g=(l.name||"").toLowerCase(),y=(l.getAttribute("aria-label")||"").toLowerCase(),f=(l.id||"").toLowerCase(),m=v(De(l)).toLowerCase(),b=v(l.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(d)||g.includes(d)||y.includes(d)||f.includes(d)||m&&m.includes(d)||d.length>=2&&b.includes(d)})||(c.length===1?c[0]:null))}}if(!s&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":if(s){let c=s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement||s.isContentEditable?s:s.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!c){let l=s.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');l&&(c=l)}if(!c){let h=s.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){c=h;break}let l=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l){c=l;break}h=h.nextElementSibling}}if(!c){let h=document.body;try{h=z()||document.body}catch{}let l=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>C(p)&&!k(p));l.length>0&&(c=l[0])}let d=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,u=d!=null?String(d):"";qe(c||s,u)}break;case"chk":s&&V(s,!!o.c);break;case"sel":if(s){let c=Array.isArray(o.v)?o.v:[String(o.v)];we(s,c)}break;case"clk":if(s)if(!!(s.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||s.querySelector('input[type="radio"], input[type="checkbox"]')||s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type))){let d=o.c!==void 0?!!o.c:!0;V(s,d)}else B(s,o.co);break;case"adv":let r=Ge(o.id);if(r){await Fe(r,1200);let c=o.id||r.textContent?.trim()||"";c&&Ie(window.location.hostname,{advanceSelector:c}),B(r)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function jt(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!C(t)||k(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function Ge(o){if(o){let n=T(o);if(n&&C(n)&&!k(n)&&!I(n))return n}try{let n=ie(window.location.hostname);if(n.advanceSelector){let s=T(n.advanceSelector);if(s&&C(s)&&!k(s)&&!I(s))return s}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(e)).filter(n=>C(n)&&!k(n)&&!n.closest("header, nav, aside")&&!I(n));for(let n of a)if(_(n)&&!I(n))return n;for(let n of a){let s=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",r=(n.textContent||s||n.getAttribute("aria-label")||"").trim();if(be.test(r)&&!I(n))return n}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&C(i)&&!k(i)&&!I(i)?i:null}async function Fe(o,e=1500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,100))}}function qt(){let o=(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim(),e=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"]').length;return`${window.location.href}|${document.title}|${o.slice(0,900)}|${e}`}async function Gt(o,e=1800){let t=Date.now();for(;Date.now()-t<e;){if(qt()!==o)return{changed:!0,evidence:"URL, texto, t\xEDtulo ou conjunto de controles mudou ap\xF3s a a\xE7\xE3o."};await new Promise(i=>setTimeout(i,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a observ\xE1vel foi detectada dentro do tempo limite."}}async function bt(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let i=T(o.from)||T(v(o.from)),n=T(o.to)||T(v(o.to));i&&n&&await Ee(i,n,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=T(e,t)||T(v(e),t);if(o.t==="clk"||o.t==="chk"){if(!a&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=v(e).toLowerCase();a=n.find(r=>{let c=v(r.textContent).toLowerCase(),d=v(r.value||"").toLowerCase();return c.includes(s)||d===s||c.startsWith(s+")")||c.startsWith("("+s+")")})||null}let i=o.v!==void 0?String(o.v).trim():"";if(a&&i){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(v(a.value).toLowerCase()!==v(i).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${H(a.name)}"][value="${H(i)}" i]`);if(n)a=n;else{let r=Array.from(document.querySelectorAll(`input[type="radio"][name="${H(a.name)}"]`)).find(c=>{let d=c.closest("label, .vf-label, .option-card, tr, td, div");return d&&v(d.textContent).toLowerCase().includes(v(i).toLowerCase())});r&&(a=r)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let n=a.querySelector(`input[value="${H(i)}" i], [data-value="${H(i)}" i]`);if(n)a=n;else{let r=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(c=>{let d=c.closest("label, .vf-label, .option-card, td, div");return d&&v(d.textContent).toLowerCase().includes(v(i).toLowerCase())});r&&(a=r)}}}if(a){let n=a.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,s=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),r=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(V(s||n,r),s&&s.checked!==r){try{let c=s._valueTracker;c&&c.setValue(!r)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,r)}catch{}s.checked=r,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let i=null;if(a&&(i=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let n=document.body;try{n=z()||document.body}catch{}let s=Array.from(n.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),r=v(e).toLowerCase();i=s.find(c=>{let d=(c.getAttribute("placeholder")||"").toLowerCase(),u=(c.name||"").toLowerCase(),h=(c.id||"").toLowerCase(),l=(c.getAttribute("aria-label")||"").toLowerCase();return d.includes(r)||u.includes(r)||h.includes(r)||l.includes(r)})||(s.length>0?s[0]:null)}if(i){let n=String(o.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,n)}}catch{}qe(i,n)}return}if(o.t==="sel"){if(!a&&e){let i=Array.from(document.querySelectorAll("select")),n=v(e).toLowerCase();a=i.find(s=>{let r=(s.name||"").toLowerCase(),c=(s.id||"").toLowerCase(),d=(s.getAttribute("aria-label")||"").toLowerCase();return r.includes(n)||c.includes(n)||d.includes(n)})||null}if(a){let i=Array.isArray(o.v)?o.v:[String(o.v)];we(a,i)}return}}function te(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let n=T(i,a,!0)||T(v(i),a,!0);if(!n){let h=document.body;try{h=z()||document.body}catch{}let l=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(p=>C(p)&&!k(p));l.length>0&&(n=l[0])}if(!n)return!1;let s=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(s&&s.name){let h=document.querySelector(`input[type="radio"][name="${H(s.name)}"]:checked`);if(!h)return!1;let l=v(h.value).toLowerCase(),p=v(t).toLowerCase(),g=v(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return l===p||g===p||g.includes(p)}let r=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!r){let l=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');l&&(r=l)}if(!r){let h=n.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){r=h;break}let l=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l){r=l;break}h=h.nextElementSibling}}if(r instanceof HTMLSelectElement){let h=v(t).toLowerCase();return Array.from(r.options).some(l=>{if(!l.selected)return!1;let p=l.value.toLowerCase(),g=v(l.textContent).toLowerCase();return h===p||h===g||p.includes(h)||g.includes(h)})}let c=(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement?r.value:r?.textContent??n.textContent??"").trim();if(!c&&!t)return!0;if(!c&&t)return!1;let d=c.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return d===u||d.includes(u)||u.includes(d)||c.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=T(o.id,void 0,!0)||T(v(o.id),void 0,!0);if(!e){let n=document.body;try{n=z()||document.body}catch{}let s=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(d=>C(d)&&!k(d)),r=v(o.id).toLowerCase();e=s.find(d=>{let u=(d.id||"").toLowerCase(),h=(d.getAttribute("name")||"").toLowerCase(),l=(d.getAttribute("aria-label")||"").toLowerCase(),p=v(d.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(r)||h.includes(r)||l.includes(r)||r.length>=2&&p.includes(r)})||(s.length===1?s[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let r=(Array.isArray(o.v)?o.v:[String(o.v)]).map(d=>v(d).toLowerCase()),c=v(n.textContent).toLowerCase();return r.some(d=>c.includes(d)||d.includes(c))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>v(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let s=n.value.toLowerCase(),r=v(n.textContent).toLowerCase();return i.some(c=>c===s||c===r||s.includes(c)||r.includes(c))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=T(o.id,e)||T(v(o.id),e);if(!t)return!1;let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,i=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),n=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(i&&i.type==="radio"){if(i.checked===n)return!0;if(o.v&&i.name){let u=v(String(o.v)).toLowerCase(),h=document.querySelector(`input[type="radio"][name="${H(i.name)}"]:checked`);if(!h)return!1;if(h===i)return!0;let l=v(h.value).toLowerCase(),p=v(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return l===u||p.includes(u)||u.includes(l)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===n;let s=a.getAttribute("aria-checked")===String(n)||a.getAttribute("aria-selected")===String(n)||a.getAttribute("aria-pressed")===String(n),r=n?a.getAttribute("data-selected")==="true"||a.getAttribute("data-checked")==="true"||a.getAttribute("data-active")==="true"||a.getAttribute("data-state")==="checked"||a.getAttribute("data-state")==="on":a.getAttribute("data-selected")==="false"||a.getAttribute("data-checked")==="false"||a.getAttribute("data-state")==="unchecked",c=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||"");return!!(s||r||c||(a instanceof HTMLButtonElement||a.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!i)}if(o.t==="drag"){let e=T(o.from)||T(v(o.from)),t=T(o.to)||T(v(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function Qe(o,e,t=1,a=de({engine:"smart",autoAdvance:e})){let i=o.actions.filter(m=>m.t!=="adv"),n=o.actions.filter(m=>m.t==="adv"),s=0,r=[],c=new Map,d=o.pageType==="question",u=i.filter(m=>m.t==="chk"||m.t==="clk"&&m.c!==void 0);if(d&&u.length>0){let m=document.body;try{m=z()||document.body}catch{}let b=Array.from(m.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(x=>C(x)&&!k(x));if(b.length>1){let x=new Set;for(let q of u){let L=q.t==="chk"?!!q.c:!!(q.c??!0),E="id"in q&&typeof q.id=="string"?q.id:"";if(L&&E){let S=T(E,q.v);if(S){let M=S instanceof HTMLInputElement&&S.type==="checkbox"?S:S.querySelector('input[type="checkbox"]');x.add(M||S)}}}if(x.size>0)for(let q of b)x.has(q)||(q instanceof HTMLInputElement&&q.checked||q.getAttribute("aria-checked")==="true"||q.closest(".option-card, label")?.classList.contains("selected"))&&V(q,!1)}}for(let m of i){try{await _t(m,t,a),s++}catch(b){c.set(m,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",m,b)}await new Promise(b=>setTimeout(b,m.t==="drag"?250:70))}await new Promise(m=>setTimeout(m,i.length>0?300:50));let h=0;for(let m of i){if(te(m)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${m.t}' no alvo '${m.id||m.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ne(m,a),await bt(m)}catch(b){c.set(m,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",b)}await new Promise(b=>setTimeout(b,180)),te(m)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++)}if(h<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-h} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(m=>setTimeout(m,200));for(let m of i)if(!te(m))try{await bt(m)}catch(b){c.set(m,b instanceof Error?b.message:String(b))}await new Promise(m=>setTimeout(m,200)),h=0;for(let m of i)te(m)&&h++}for(let m of i)te(m)||r.push(m.t==="drag"?`${m.from} -> ${m.to}`:"id"in m?m.id:m.t);d&&i.length===0&&r.push("nenhuma a\xE7\xE3o de resposta prescrita");let l=i.map((m,b)=>{let x=m.t==="drag"?`${m.from} -> ${m.to}`:m.t==="js"?"$eq":m.id||m.t,q=m.t==="js"?!0:m.t==="drag"?!!(G(m.from,"source")&&G(m.to,"destination")):!!(T(m.id||"")||T(v(m.id||""))),L=te(m);return{index:b,action:m,target:x,located:q,applied:!c.has(m),verified:L,strategy:m.t==="drag"?"drag-adaptive":m.t==="js"?"javascript":"declarative-dom",evidence:L?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(m)?{error:c.get(m)}:{}}}),p=d?i.length>0&&r.length===0&&(h===i.length||s===i.length&&h>0):!0,g=!1,y=!1,f="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.";if(e&&(p||!d)){await new Promise(L=>setTimeout(L,i.length>0?400:150));let m=!1;if(o.pageType!=="info"){let L=jt();L&&C(L)&&(await Fe(L,1200),B(L),m=!0,await new Promise(E=>setTimeout(E,800)))}let b=qt(),x=n.length>0?n[0].id:void 0,q=Ge(x);if(!q&&m&&(await new Promise(L=>setTimeout(L,600)),q=Ge(x)),q){await Fe(q,1500);let L=x||q.textContent?.trim()||"";L&&Ie(window.location.hostname,{advanceSelector:L}),B(q);let E=await Gt(b,2500);y=E.changed,f=E.evidence,g=E.changed||m,!E.changed&&!m&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else m?(g=!0,y=!0,f="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:s,verified:h,success:p,advanced:g,failed:r,reports:l,navigationVerified:y,navigationEvidence:f}}var me=null,U=[],Ue=[],Ft=`
...
`;function Qt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=Ft,document.head.appendChild(o)}}catch{}}function K(){me&&(me.style.removeProperty("outline"),me.style.removeProperty("outline-offset"),me=null);for(let o of U)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");U=[];for(let o of Ue)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");Ue=[]}function Ke(o){Qt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),Ue.push(t)}}function Ye(o){K(),me=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px"}function wt(o){for(let e of o){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let d=T(e.from),u=T(e.to);d&&(d.style.outline="2px solid #00ff88",U.push(d)),u&&(u.style.outline="2px dashed #00e5ff",U.push(u))}catch{}continue}if(!e.id)continue;let t=e.v!==void 0?Array.isArray(e.v)?e.v[0]:String(e.v):"",a=T(e.id,t,e.t==="val"||e.t==="sel")||T(v(e.id),t,e.t==="val"||e.t==="sel");if(!a&&e.t==="sel"){let d=document.body;try{d=z()||document.body}catch{}let u=Array.from(d.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(p=>C(p)&&!Z(p)),h=v(e.id).toLowerCase();a=u.find(p=>{let g=(p.id||"").toLowerCase(),y=(p.getAttribute("name")||"").toLowerCase(),f=(p.getAttribute("aria-label")||"").toLowerCase(),m=v(p.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return g.includes(h)||y.includes(h)||f.includes(h)||h.length>=2&&m.includes(h)})||(u.length===1?u[0]:null)}if(!a)continue;let i=typeof HTMLSelectElement<"u"&&a instanceof HTMLSelectElement||a.tagName?.toLowerCase()==="select"||a.getAttribute("role")==="combobox"||a.getAttribute("role")==="listbox",s=a.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||a.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||a;s.style.outline="2px solid #00ff88",s.style.outlineOffset="2px",s.style.backgroundColor="rgba(0, 255, 136, 0.12)",s.setAttribute("data-easyquiz-highlight","true"),U.push(s);let r=i?a:s.querySelector('select, [role="combobox"], [role="listbox"]');r&&(r.style.outline="2px solid #00ff88",r.style.outlineOffset="2px",r.style.boxShadow="0 0 10px rgba(0, 255, 136, 0.8)",r.setAttribute("data-easyquiz-highlight","true"),U.push(r));let c=a instanceof HTMLInputElement&&["checkbox","radio"].includes(a.type)?a:s.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==s&&(c.style.outline="2px solid #00ff88",c.style.outlineOffset="2px",c.style.boxShadow="0 0 10px rgba(0, 255, 136, 0.8)",c.setAttribute("data-easyquiz-highlight","true"),U.push(c))}}var Je=10,Ut=1400,We=15e5;function oe(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let i=String(a.result||"");e(i.split(",")[1]||"")},a.readAsDataURL(o)})}async function ge(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,Ut/Math.max(e,t)),i=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),s=document.createElement("canvas");s.width=i,s.height=n;let r=s.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,n),r.drawImage(o,0,0,i,n),new Promise((c,d)=>{s.toBlob(u=>u?c(u):d(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Kt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,n=Math.min(1800,Math.max(120,Math.round(t*i))),s=Math.min(1800,Math.max(100,Math.round(a*i))),r=o.cloneNode(!0);r.getAttribute("xmlns")||r.setAttribute("xmlns","http://www.w3.org/2000/svg"),r.setAttribute("width",String(n)),r.setAttribute("height",String(s)),!r.getAttribute("viewBox")&&t>0&&a>0&&r.setAttribute("viewBox",`0 0 ${t} ${a}`);let d=new XMLSerializer().serializeToString(r),u=new Blob([d],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(u);try{let l=new Image;l.crossOrigin="anonymous",await new Promise((y,f)=>{l.onload=()=>y(),l.onerror=()=>f(new Error("Falha ao renderizar SVG em Image.")),l.src=h});let p=document.createElement("canvas");p.width=n,p.height=s;let g=p.getContext("2d",{alpha:!1});if(!g)throw new Error("Sem suporte a Canvas 2D.");return g.fillStyle="#ffffff",g.fillRect(0,0,n,s),g.drawImage(l,0,0,n,s),new Promise((y,f)=>{p.toBlob(m=>m?y(m):f(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(h)}}async function Xe(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let s=this.element.querySelector("#eq-fah-header");this.setupDraggable(s)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let n=r=>{if(!this.isDragging||!this.element)return;let c=r.clientX-this.dragStartX,d=r.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),l=Math.min(Math.max(10,this.initialLeft+c),u),p=Math.min(Math.max(10,this.initialTop+d),h);this.element.style.left=`${l}px`,this.element.style.top=`${p}px`},s=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",s)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",s)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,n=i.actions.filter(p=>p.t==="drag"),s=i.actions.filter(p=>{if(p.t!=="val")return!1;let g=v(p.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(g)}),r=i.actions.filter(p=>p.t==="clk"||p.t==="chk"),c=i.actions.filter(p=>p.t==="sel"),d=n.length||s.length||r.length||c.length,u=document.createElement("div");u.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let l=document.createElement("span");if(l.className="eq-fah-meta-badge",l.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,u.append(h,l),e.appendChild(u),n.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let p={};for(let g of n){let y=v(g.to)||"Geral";p[y]||(p[y]=[]),p[y].push(v(g.from))}for(let[g,y]of Object.entries(p)){let f=document.createElement("div"),m=/fato|true|verdadeiro|sim/i.test(g),b=/opini[aã]o|false|falso|n[aã]o/i.test(g);f.className=`eq-fah-group ${m?"group-fato":b?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${g} (${y.length})`,f.appendChild(x);let q=document.createElement("div");q.className="eq-fah-group-items";for(let L of y){let E=document.createElement("div");E.className="eq-fah-item";let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=L,E.appendChild(S);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(L),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),E.appendChild(M),q.appendChild(E)}f.appendChild(q),e.appendChild(f)}}else if(s.length>0){t.textContent=`Preenchimento (${s.length} campos)`,a.textContent=String(s.length);let p=document.createElement("div");p.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4DD} Respostas para os Campos de Texto:",p.appendChild(g);let y=document.createElement("div");y.className="eq-fah-group-items";for(let f=0;f<s.length;f++){let m=s[f],b=document.createElement("div");b.className="eq-fah-item";let x=he(m.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${f+1}`);let q=String(m.v??""),L=document.createElement("div");L.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=x,L.appendChild(E);let S=document.createElement("div");S.className="eq-fah-field-val",S.textContent=q,L.appendChild(S),b.appendChild(L);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(q),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),b.appendChild(M),y.appendChild(b)}p.appendChild(y),e.appendChild(p)}else if(r.length>0){t.textContent=`Op\xE7\xF5es (${r.length} marcadas)`,a.textContent=String(r.length);let p=document.createElement("div");p.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F3AF} Alternativa(s) Correta(s):",p.appendChild(g);let y=document.createElement("div");y.className="eq-fah-group-items";for(let f=0;f<r.length;f++){let m=r[f],b=document.createElement("div");b.className="eq-fah-item";let x=he(m.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&m.v&&(x=String(m.v)),x=v(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let q="",L=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);L?(q=L[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=L[2].trim()||x):r.length>1&&(q=String.fromCharCode(65+f));let E=document.createElement("div");if(E.style.display="flex",E.style.alignItems="center",E.style.gap="8px",E.style.flex="1",q){let O=document.createElement("span");O.className="eq-fah-letter-badge",O.textContent=q,E.appendChild(O)}let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=x||(q?`Alternativa ${q}`:"Alternativa Selecionada"),E.appendChild(S),b.appendChild(E);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(x||q),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),b.appendChild(M),y.appendChild(b)}p.appendChild(y),e.appendChild(p)}else if(c.length>0){t.textContent=`Sele\xE7\xE3o (${c.length} listas)`,a.textContent=String(c.length);let p=document.createElement("div");p.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",p.appendChild(g);let y=document.createElement("div");y.className="eq-fah-group-items";for(let f=0;f<c.length;f++){let m=c[f],b=document.createElement("div");b.className="eq-fah-item";let x=he(m.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${f+1}`);let E=(Array.isArray(m.v)?m.v:[String(m.v??"")]).map(ne=>{let Y=T(m.id,void 0,!0)||T(v(m.id),void 0,!0),$=Y instanceof HTMLSelectElement?Y:Y?.querySelector("select");if($){let N=v(ne).toLowerCase();for(let Se=0;Se<$.options.length;Se++){let Me=$.options[Se];if(Me.value.toLowerCase()===N||v(Me.textContent).toLowerCase()===N){let Ae=v(Me.textContent);if(Ae&&!Ae.toLowerCase().includes("selecione"))return Ae}}}return ne}).join(", "),S=document.createElement("div");S.className="eq-fah-field-box";let M=document.createElement("div");M.className="eq-fah-field-label",M.textContent=x,S.appendChild(M);let O=document.createElement("div");O.className="eq-fah-field-val",O.textContent=E,S.appendChild(O),b.appendChild(S);let D=document.createElement("button");D.className="eq-fah-copy-inline",D.textContent="Copiar",D.addEventListener("click",()=>{navigator.clipboard.writeText(E),D.textContent="\u2713 Copiado",setTimeout(()=>D.textContent="Copiar",1200)}),b.appendChild(D),y.appendChild(b)}p.appendChild(y),e.appendChild(p)}else{t.textContent="Gabarito",a.textContent="0";let p=document.createElement("div");p.style.padding="10px",p.style.color="#888",p.textContent="Nenhuma resposta direta para exibir.",e.appendChild(p)}if(i.rationale){let p=document.createElement("div");p.className="eq-fah-rationale",p.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(p)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(r=>r.t==="drag"),i=e.actions.filter(r=>r.t==="val"),n=e.actions.filter(r=>r.t==="clk"||r.t==="chk"),s=e.actions.filter(r=>r.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let r={};for(let c of a){let d=v(c.to)||"Geral";r[d]||(r[d]=[]),r[d].push(v(c.from))}for(let[c,d]of Object.entries(r)){t.push(`### Categoria: ${c}`);for(let u of d)t.push(`- ${u}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let r of i){let c=v(r.id);t.push(`- **${c||"Campo"}:** \`${r.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let r=0;r<n.length;r++){let c=n[r],d=he(c.id);(!d||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(d))&&c.v&&(d=String(c.v)),d=v(d),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(d)&&(d="");let u=n.length>1?`${String.fromCharCode(65+r)}) `:"";t.push(`- [x] ${u}${d||"Alternativa "+String.fromCharCode(65+r)}`)}t.push("")}else if(s.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let r of s){let c=v(r.id)||"Lista",d=Array.isArray(r.v)?r.v.join(", "):String(r.v??"");t.push(`- **${c}:** \`${d}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
