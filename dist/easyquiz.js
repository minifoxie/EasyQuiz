 ...
 */
"use strict";(()=>{var ee={apiKey:"",apiKeys:[],model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function R(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Oe="easyquiz_settings_v2",ae="easyquiz_activity_metrics";function Ve(){try{let o=localStorage.getItem(Oe);if(!o){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let s=JSON.parse(r);return{...ee,apiKey:s.apiKey||""}}return{...ee}}let e=JSON.parse(o),t=typeof e.model=="string"&&R(e.model)?e.model:ee.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&i&&(a=[i]),{apiKey:a[0]||i||ee.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ee.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ee.confidenceThreshold}}catch{return{...ee}}}function pt(){try{localStorage.removeItem(Oe),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(ae),sessionStorage.removeItem(ae);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ke()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function be(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function _e(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...be(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function ht(o){let e=Ve(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let i={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Oe,JSON.stringify(i))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return i}var oe=[],ut=12,Dt=1200;function mt(o){let e=o.trim().replace(/\s+/g," ").slice(0,Dt);e&&!oe.includes(e)&&(oe.push(e),oe.length>ut&&(oe=oe.slice(-ut)))}function Me(){return oe}function Ke(){oe=[]}function gt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var fe=gt();function se(){try{localStorage.removeItem(ae)}catch{}return fe}function Ot(o){fe=o;try{let e=JSON.stringify(o);sessionStorage.setItem(ae,e),localStorage.removeItem(ae)}catch{}}function je(o){let e=fe,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let i={...o,timestamp:t},n=[...e.records,i],r=n.filter(p=>p.status==="answered"||p.status==="verified").length,s=n.reduce((p,h)=>p+h.durationMs,0),l=r>0?Math.round(s/r):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:r,averageDurationMs:l,records:n};return Ot(c),c}function ve(){fe=gt();try{sessionStorage.removeItem(ae),localStorage.removeItem(ae)}catch{}return fe}var ft=[{id:"native-value-events",widget:"text",label:"Setter nativo com input/change/blur",precondition:"Campo edit\xE1vel vis\xEDvel e n\xE3o desabilitado.",evidence:"value ou textContent coincide exatamente com o valor esperado.",risk:"low",cost:"fast"},{id:"native-choice-state",widget:"choice",label:"Estado nativo de radio/checkbox",precondition:"Input ou widget ARIA \xFAnico localizado.",evidence:"checked/aria-checked/data-state do alvo e grupo correspondem ao esperado.",risk:"low",cost:"fast"},{id:"native-select-events",widget:"select",label:"Sele\xE7\xE3o nativa por value/texto exato",precondition:"Select vis\xEDvel com op\xE7\xE3o correspondente.",evidence:"option.selected e selected value correspondem ao esperado.",risk:"low",cost:"fast"},{id:"aria-combobox-keyboard",widget:"combobox",label:"Combobox ARIA por foco e teclado",precondition:"Combobox vis\xEDvel com popup/op\xE7\xF5es acess\xEDveis.",evidence:"aria-expanded, aria-activedescendant ou op\xE7\xE3o selecionada mudam.",risk:"medium",cost:"normal"},{id:"click-to-place",widget:"drag",label:"Selecionar item e clicar no destino",precondition:"Cart\xE3o e dropzone vis\xEDveis com protocolo click-to-place.",evidence:"Item passa a ser filho do destino ou recebe estado de colocado.",risk:"medium",cost:"normal"},{id:"html5-drag-drop",widget:"drag",label:"HTML5 dragstart/dragover/drop",precondition:"Origem draggable e destino aceita drag/drop.",evidence:"Relocation, callback ou estado placed confirmado.",risk:"medium",cost:"normal"},{id:"keyboard-order",widget:"order",label:"Ordena\xE7\xE3o por foco e teclado",precondition:"Itens orden\xE1veis com foco/roles ou bot\xF5es de mover.",evidence:"Ordem dos itens no DOM corresponde \xE0 sequ\xEAncia esperada.",risk:"medium",cost:"normal"},{id:"navigation-feedback",widget:"navigation",label:"Verificar e confirmar feedback/transi\xE7\xE3o",precondition:"Bot\xE3o de verifica\xE7\xE3o/avan\xE7o \xFAnico e habilitado.",evidence:"Feedback esperado e assinatura espec\xEDfica da quest\xE3o mudam.",risk:"high",cost:"normal"},{id:"javascript-explicit",widget:"javascript",label:"JavaScript limitado via capability expl\xEDcita",precondition:"Engine javascript autorizada e a\xE7\xE3o declarativa insuficiente.",evidence:"Efeito DOM esperado confirmado por verificador.",risk:"high",cost:"last-resort"}];function Vt(o){if(!o||o.length===0)return ft.filter(t=>t.widget!=="javascript");let e=new Set(o);return ft.filter(t=>e.has(t.widget))}function bt(o){return Vt(o).map(e=>`${e.id}: ${e.label} | pr\xE9: ${e.precondition} | prova: ${e.evidence} | risco: ${e.risk}`).join(`
`)}var vt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown ou conversa.
...
`;function _t(o,e){return/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/forms\.google|docs\.google.*forms/i.test(o)||e.includes("Qr7Oae")?"[PLATAFORMA: Google Forms \u2014 IDs via data-item-id, data-params]":/wayground|quizizz/i.test(o)||e.includes("data-functional-selector")?"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function ye(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(g=>g.type==="draggable"||g.type==="dropzone"),i=new Set(["navigation"]);o.controls.some(g=>["text","number","textarea","contenteditable"].some(v=>g.type.includes(v)))&&i.add("text"),o.controls.some(g=>["radio","checkbox"].includes(g.type)||g.tag==="button")&&i.add("choice"),o.controls.some(g=>g.tag==="select")&&i.add("select"),o.controls.some(g=>/combobox|dropdown/i.test(g.type))&&i.add("combobox"),(o.controls.some(g=>["draggable","dropzone"].includes(g.type))||a)&&i.add("drag"),t.engine==="javascript"&&i.add("javascript");let n=/katex|latex|math|matrix|formula|frac|\$|\^|\_/i.test(o.htmlSnippet)||/calcular|calcule|resolva|matriz|equação|função|probabilidade|geometria|fórmula|coordenada|sistema/i.test(o.questionText),s=o.questionText.length<250||a||o.controls.length<4||n?`
[HTML]:
${o.htmlSnippet.slice(0,3500).replace(/\s+/g," ")}`:`
[HTML]: Omitido.`,l=Me(),c=l.length>0?`
[MEM\xD3RIA]:
${l.join(" | ")}
`:"",p=o.controls.filter(g=>g.role!=="navigation"),h=o.controls.filter(g=>g.role==="navigation"),d=_t(o.sourceUrl,o.htmlSnippet),m=d?`
${d}
`:"";return`--- AN\xC1LISE ---
...
`):"Nenhum anexo visual."}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Kt=new Set(["question","info","start","conclusion"]),jt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Gt=new Set(["val","chk","sel","clk","adv","js","drag"]),Ft=150,xe=2e3;function V(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,xe):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,xe):e}function Ut(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!Gt.has(a))return null;if(a==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...V(s)?{id:V(s,"").slice(0,500)}:{}}}if(a==="drag"){let s=V(t.from??t.source),l=V(t.to??t.target??t.destination);return!s||!l?null:{t:"drag",from:s.slice(0,500),to:l.slice(0,500)}}if(a==="js"){let s=V(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&a==="val"&&(i="1");let n=V(i).slice(0,500);if(!n)return null;if(a==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:V(s).slice(0,xe)}}if(a==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,c=(Array.isArray(s)?s:[s]).map(p=>V(p).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:c}}if(a==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",l={t:"chk",id:n,c:!s};return t.v!==void 0&&(l.v=V(t.v).slice(0,xe)),l}let r={t:"clk",id:n};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!s}return t.v!==void 0&&(r.v=V(t.v).slice(0,xe)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(r.co=[t.co[0],t.co[1]]),r}function Ge(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!Kt.has(t))&&(t="question"),(typeof a!="string"||!jt.has(a))&&(a="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],n=[];for(let c=0;c<Math.min(i.length,Ft);c++){let p=Ut(i[c],c);p&&n.push(p)}let r=n.filter(c=>c.t!=="adv"),s=n.some(c=>c.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?s||n.push({t:"adv"}):t==="question"&&!s&&n.push({t:"adv"});let l=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:l,rationale:V(e.rationale,"Plano validado e auto-recuperado."),actions:n,...V(e.memoryToStore)?{memoryToStore:V(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var F=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear(),Array.from(new Set(e.map(i=>i.trim().replace(/^["']|["']$/g,"")).filter(i=>i.length>5))).forEach((i,n)=>{let r=this.generateId(i),s=t.get(r)||t.get(i);this.keys.set(r,{id:r,key:i,label:s?.label||`Chave ${n+1}`,addedAt:s?.addedAt||Date.now(),lastUsedAt:s?.lastUsedAt,lastLatencyMs:s?.lastLatencyMs,cooldownUntil:s?.cooldownUntil,errorCount:s?.errorCount||0,lastError:s?.lastError,winCount:s?.winCount||0})})}generateId(e){let t=0;for(let a=0;a<e.length;a++)t=(t<<5)-t+e.charCodeAt(a),t|=0;return`key_${Math.abs(t).toString(36).slice(0,8)}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<5)}getBestKey(){let e=this.getHealthyKeys();if(e.length>0)return e.sort((a,i)=>{let n=a.lastLatencyMs??99999,r=i.lastLatencyMs??99999;return n-r}),e[0].key;let t=Array.from(this.keys.values());return t.length>0?(t.sort((a,i)=>(a.cooldownUntil||0)-(i.cooldownUntil||0)),t[0].key):""}getDiverseKeys(e){let t=this.getHealthyKeys();if(t.length===0){let i=this.getBestKey();return i?[i]:[]}t.sort((i,n)=>{let r=i.lastLatencyMs??99999,s=n.lastLatencyMs??99999;return r-s});let a=[];for(let i=0;i<e;i++){let n=t[i%t.length];a.push(n.key)}return a}markQuotaHit(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${t/1e3}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.errorCount=(a.errorCount||0)+1,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${t/1e3}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(a);if(this.keys.has(i))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let n={id:i,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,n),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:n}}updateKey(e,t,a){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=n,a!==void 0&&(i.label=a.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},A=new F;var le=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Econ\xF4mico)",description:"Modelo econ\xF4mico de alta velocidade para volume elevado.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Legacy R\xE1pido)",description:"Modelo legacy com zero-thinking suportado. Ultra-baixa lat\xEAncia.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Legacy Avan\xE7ado)",description:"Modelo legacy avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],yt=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"],re=null;function Qt(o){let e={temperature:0,maxOutputTokens:1200,response_mime_type:"application/json",response_schema:Yt};return/gemini-3\.[56]-flash/i.test(o)?e.thinkingConfig={thinkingLevel:"none"}:/gemini-3\.[789]|gemini-3\.[1-9][0-9]/i.test(o)?e.thinkingConfig={thinkingLevel:"low"}:/gemini-2\.5-flash/i.test(o)&&(e.thinkingConfig={thinkingBudget:0}),e}var Yt={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Jt(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");return!e||!R(e)?"gemini-3.8-flash":e}function qt(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(t)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function xt(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Et=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&R(a.id));return t.length>0?t:null}return null}catch{return null}})(),Ae=new Set;async function Se(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return le;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let i=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let r=await i.text(),s=qt(r,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let n=await i.json();if(Array.isArray(n.models)&&n.models.length>0){let r=n.models.filter(s=>{let l=s.supportedGenerationMethods||[],c=(s.name||"").replace(/^models\//,""),p=l.includes("generateContent");return R(c)&&p}).map(s=>{let l=s.supportedGenerationMethods||[],c=s.name.replace(/^models\//,""),p=s.displayName||c;return{id:c,name:p.includes(c)?p:`${p} (${c})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(c),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(c),supportsStructuredOutput:l.includes("generateContent"),supportedGenerationMethods:l,discoveredAt:Date.now()}});if(r.length>0){r.sort((s,l)=>{let c=p=>p==="gemini-3.8-flash"?200:p==="gemini-3.7-flash"?190:p==="gemini-3.6-flash"?180:p==="gemini-3.5-flash"?170:p==="gemini-3.5-flash-lite"?160:p==="gemini-2.5-flash"?130:p.includes("flash")?80:p==="gemini-2.5-pro"?60:p.includes("pro")?50:10;return c(l.id)-c(s.id)}),Et=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return le}async function ke(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await Se(e);if(a.length>0&&a!==le){let i=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let i of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${i}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${i})!`,models:le}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function wt(o,e,t,a,i){let n=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${o}`),l={...Qt(o)};for(let c of n){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let p=`https://generativelanguage.googleapis.com/${c}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,h=Date.now();try{let d=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:l}),signal:i,keepalive:a});if(!d.ok){let v=await d.text();if(d.status===400&&l.thinkingConfig&&/thinking/i.test(v)){delete l.thinkingConfig;let u=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:l}),signal:i,keepalive:a});if(u.ok){let b=await u.json(),x=b.candidates?.[0];if(x?.content?.parts?.[0]?.text)return A.markSuccess(e,Date.now()-h),{rawText:x.content.parts[0].text,data:b,usedModel:o,usedKey:e}}}let f=qt(v,d.status);if(d.status===404&&c==="v1beta")continue;throw d.status===429?A.markQuotaHit(e,5e3):d.status===503||/no capacity|overloaded|unavailable/i.test(v)?(A.markOverloaded(e,5e3),Ae.add(o)):d.status===403||/API_KEY_INVALID/i.test(v)?A.markInvalid(e,f):d.status===404&&Ae.add(o),new Error(`[${o}|${F.maskKey(e)}] ${f}`)}let m=await d.json(),g=m.candidates?.[0];if(!g||!g.content?.parts?.[0]?.text)throw new Error(`[${o}|${F.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return A.markSuccess(e,Date.now()-h),{rawText:g.content.parts[0].text,data:m,usedModel:o,usedKey:e}}catch(d){if(i.aborted)throw d;r=d;let m=r.message||"";if(m.includes("404")||/no longer available/i.test(m)){Ae.add(o);break}}}throw r}var Wt=8;async function Fe(o,e,t,a,i){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let n=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];A.init(n);let r=t.apiKey.trim().replace(/^["']|["']$/g,""),s=A.getBestKey()||r;if(!s)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=Jt(t.model);if(!Et&&s&&Se(s).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let c=Date.now(),p=ye(o,e,t),h=[{text:p}];for(let L=0;L<e.length;L++){let I=e[L],O=I.associatedLabel||(I.alt?`Imagem: ${I.alt}`:`Imagem ${L+1}`);h.push({text:`[ANEXO VISUAL ${L+1} - V\xCDNCULO: ${O}]:`}),h.push({inline_data:{mime_type:I.mediaType,data:I.base64}})}let d={system_instruction:{parts:[{text:vt}]},contents:[{role:"user",parts:h}]},m=!0;Ae.clear();let g=[];re&&R(re)&&g.push(re),R(l)&&l!==re&&g.push(l);for(let L of yt)g.includes(L)||g.push(L);let v=g.filter(L=>R(L)).slice(0,3);v.length<2&&v.push(...yt.filter(L=>!v.includes(L)));let f=A.getHealthyKeys(),u=A.getAllKeys(),b=f.sort((L,I)=>(L.lastLatencyMs??99999)-(I.lastLatencyMs??99999)),x=b.length>0?b:u.map(L=>({key:L.key,lastLatencyMs:L.lastLatencyMs,label:L.label})),w=Math.min(x.length,Wt),C=[];for(let L=0;L<w;L++){let I=x[L];C.push({model:v[L%v.length],key:I.key,label:I.label||`Chave ${L+1}`})}C.length===0&&C.push({model:v[0]||"gemini-3.6-flash",key:s,label:"Chave 1"});let M=C.length,S=new Set(C.map(L=>L.key)).size,k=new Set(C.map(L=>L.model)).size;M>1&&a?.(`\u26A1 BLITZ: ${M} slots (${S} chave${S>1?"s":""} \xD7 ${k} modelo${k>1?"s":""})...`,"info");let K=C.map(()=>new AbortController),U=()=>{K.forEach(L=>{try{L.abort(new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio."))}catch{L.abort()}})};if(i){if(i.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");i.addEventListener("abort",U,{once:!0})}try{let L=C.map(async(B,X)=>{let j=K[X],Q=M>1?8e3:12e3,Le=setTimeout(()=>{try{j.abort(new Error(`Timeout ${Q/1e3}s (${B.model}|${B.label})`))}catch{j.abort()}},Q);try{let G=await wt(B.model,B.key,d,m,j.signal);clearTimeout(Le);let Z=Ge(xt(G.rawText));return Z.usedModel=G.usedModel,Z.durationMs=Date.now()-c,Z.promptSent=p,Z.tokensUsed=G.data.usageMetadata?.totalTokenCount,Z.promptTokens=G.data.usageMetadata?.promptTokenCount,Z.candidatesTokens=G.data.usageMetadata?.candidatesTokenCount,Z.rawResponse=G.rawText,K.forEach((dt,Nt)=>{if(Nt!==X)try{dt.abort(new Error("Cancelado: slot vencedor respondeu."))}catch{dt.abort()}}),{plan:Z,rawUsage:G.data.usageMetadata,usedModel:G.usedModel,usedKey:G.usedKey,slotLabel:B.label}}catch(G){throw clearTimeout(Le),G}}),I=await Promise.any(L);i?.removeEventListener("abort",U),A.markWinner(I.usedKey),re=I.usedModel;let O=F.maskKey(I.usedKey),J=I.plan.durationMs||Date.now()-c;return a?.(`\u26A1 ${J}ms via '${I.usedModel}' (${I.slotLabel}: ${O})`,"info"),I}catch(L){if(i?.removeEventListener("abort",U),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let I=A.getBestKey(),O="gemini-3.6-flash";if(I&&!i?.aborted)try{a?.(`Fallback: tentando ${O} com melhor chave dispon\xEDvel...`,"info");let B=new AbortController,X=setTimeout(()=>{try{B.abort()}catch{}},1e4),j=await wt(O,I,d,m,B.signal);clearTimeout(X);let Q=Ge(xt(j.rawText));Q.usedModel=j.usedModel,Q.durationMs=Date.now()-c,Q.promptSent=p,Q.rawResponse=j.rawText,A.markSuccess(I,Q.durationMs),re=O;let Le=F.maskKey(I);return a?.(`\u26A1 Fallback OK: ${Q.durationMs}ms via '${O}' (${Le})`,"info"),{plan:Q,rawUsage:void 0,usedModel:O,usedKey:I}}catch{}let J="";throw Array.isArray(L?.errors)&&L.errors.length>0?J=L.errors.map(B=>B?.message||String(B)).filter(Boolean).slice(0,3).join(" | "):L instanceof Error?J=L.message:J=String(L),new Error(J||"Nenhum modelo respondeu com sucesso.")}}var Xt=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function we(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function Ue(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ct(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(Xt.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var ce=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]"].join(","),He=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,Zt=0;function Qe(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!de(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function $(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function T(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||de(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${$(e.id)}"]`);if(n&&Qe(n))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&Qe(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return Qe(e)}function eo(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function H(o,e=500){return eo(o).replace(/\s+/g," ").trim().slice(0,e)}function to(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(Zt+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function de(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var qe=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function P(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(de(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,i=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),r=String(a.getAttribute?.("title")||""),s=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",l=H(a.textContent,60);return!!(qe.test(i)||qe.test(n)||qe.test(r)||qe.test(s)||l.length>0&&l.length<=25&&qe.test(l))}function W(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||de(o)||P(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=H(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,i=t.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return He.test(i)||He.test(t)||a==="submit"||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")||!1}function Ye(o){let e=o.closest("tr");if(e){let l=e.querySelector("th, td:first-child"),c=l&&l!==o.closest("td")?H(l.textContent,100):"",p=H(o.closest("label, td")?.textContent||"",50);if(c&&p)return`${c}: ${p}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let l=t.querySelector('.dropdown-label, [class*="label" i]'),c=l&&l!==o?H(l.textContent,150):"";if(c)return c}let a=o.getAttribute("aria-label");if(a)return H(a);let i=o.getAttribute("aria-labelledby");if(i){let l=i.split(/\s+/).map(c=>document.getElementById(c)?.textContent).filter(Boolean).join(" ");if(l.trim())return H(l)}if("labels"in o&&o.labels){let l=Array.from(o.labels??[]).map(c=>c.textContent).join(" ");if(l.trim())return H(l)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let l=H(n.textContent);if(l)return l}let r=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||r||"";return H(s)}function Je(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,i=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(n)?n:"other",s=o.getAttribute("role")||"",l=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),c=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),p=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(l)||/drag|card-item|sortable/i.test(c),h=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(l)||/dropzone|category-box|bucket|target-zone/i.test(c),m=H((p?"draggable":h?"dropzone":"")||i.type||s||r,40),g="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox")g=i.checked||o.getAttribute("aria-checked")==="true"?"checked":"unchecked";else if(r==="button"||n==="a"||e==="navigation"||W(o))g="";else{let w=typeof o.value=="string"||typeof o.value=="number"?o.value:"";g=H(w||o.getAttribute("data-category")||"",2e3)}let v=[];if(a&&a.options)for(let w of Array.from(a.options).slice(0,80))v.push({value:H(w.value),label:H(w.textContent)});else if(s==="combobox"||s==="listbox"||c.includes("select")||c.includes("dropdown")){let w=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),C=w?document.getElementById(w):o;if(C){let M=C.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let S of Array.from(M).slice(0,80)){let k=H(S.textContent);k&&v.push({value:S.getAttribute("data-value")||S.getAttribute("value")||k,label:k})}}}let f=!!(i.required||o.getAttribute("aria-required")==="true"),u=!!(i.disabled||o.getAttribute("aria-disabled")==="true"),b=to(o);return{id:o.id||b,tag:r,type:m,label:Ye(o),name:H(i.name||o.getAttribute("name")||"",180),value:g,options:v,required:f,disabled:u,role:e}}var Tt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Lt(o){if(!T(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(ce)).filter(T),a=H(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),r=Math.min(1,n/i),s=e.top+e.height/2,l=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),c=a>40?35:0,p=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+c+p-r*20-l*10}function Ie(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let i=H(e.innerText||e.textContent||"",1e4),n=H(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(ce).length,s=t.querySelectorAll(ce).length;if(i.length<150&&n.length>i.length&&s<=r+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Mt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&T(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function N(){let o=document.activeElement;if(o&&o!==document.body){let n=o.closest(Tt);if(n&&Lt(n)>0)return Ie(n)}let t=Array.from(document.querySelectorAll(Tt)).map(n=>({element:n,score:Lt(n)})).filter(n=>Number.isFinite(n.score)).sort((n,r)=>r.score-n.score),a=t.find(n=>{let r=n.element.tagName.toLowerCase();return r!=="main"&&r!=="body"&&n.score>0});if(a)return Ie(a.element);if(t.length>0&&t[0].score>0)return Ie(t[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&T(i)?i:document.body}function At(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let i of Array.from(a.attributes))t.includes(i.name)||a.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function ze(o){let e=Array.from(o.querySelectorAll(ce)),t=new Set,a=[];for(let i of e){if(!T(i)||W(i)||P(i))continue;let n=i.tagName.toLowerCase();["input","textarea","select"].includes(n)&&(t.add(i),a.push(i))}for(let i of e){if(!T(i)||W(i)||P(i))continue;let n=i.tagName.toLowerCase();if(["input","textarea","select"].includes(n))continue;let r=i.querySelector("input, textarea, select");if(!(r&&t.has(r))){if(i.hasAttribute("for")){let s=i.getAttribute("for"),l=s?i.ownerDocument.getElementById(s):null;if(l&&t.has(l))continue}if(n==="a"){let s=i.getAttribute("role");if(!(s==="button"||s==="radio"||s==="checkbox"||s==="option"||i.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(i)}}return a.slice(0,100).map(i=>Je(i,"answer"))}function We(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let i of e)for(let n of Array.from(i.querySelectorAll(ce)))if(!(t.has(n)||!T(n)||!W(n)||P(n))&&(t.add(n),a.push(Je(n,"navigation")),a.length>=10))return a;return a}function Ee(o=!1){let e=N();e=Ie(e),o&&(e=Mt(e));let t=ze(e),a=We(e);if(t.length===0){let s=ze(document.body);s.length>0&&(e=Mt(e),t=ze(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=We(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=H(i,16e3),r=[...t,...a].slice(0,120);return!n||r.length===0&&n.length<30?H(document.body.innerText||document.body.textContent||"",16e3).length>=30?ue():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:At(e),controls:r,scope:e}}function ue(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=H(o,16e3),t=ze(document.body),a=We(document.body),i=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:At(n).slice(0,15e3),controls:i,scope:n}}function St(o){let e=o.controls.map(t=>`${t.role}:${t.id}:${t.type}:${t.value}:${t.disabled}`).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,500),e].join("::")}function z(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function y(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function D(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let i=o.ownerDocument.getElementById(a);if(i)return i}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, tr, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return D(a)}return o}function kt(o){let e=o;if(!e||!document.contains(e))try{e=N()}catch{}e=e||document.body;let t=Array.from(e.querySelectorAll("tr")).filter(n=>T(n)&&n.querySelector('input[type="radio"], input[type="checkbox"]'));if(t.length>1)return t;let a=Array.from(e.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(n=>T(n)&&!z(n));return a.length>0?a:Array.from(e.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(n=>T(n)&&!z(n)).filter(n=>!n.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'))}function E(o,e,t=!1){if(o==null)return null;let i=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let n=$(i),r=document.querySelector(`[data-easyquiz-id="${n}"]`);if(r&&!z(r)&&T(r))return D(r);try{let d=document.getElementById(i);if(d&&!z(d)&&T(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:D(d)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let d=parseInt(s[1],10);if(t){let g=document.body;try{g=N()||document.body}catch{}let v=Array.from(g.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(f=>T(f)&&!z(f));if(d>=1&&d-1<v.length)return v[d-1];if(d===0&&v.length>0)return v[0]}let m=d-1;if(m>=0){let g=kt();if(m<g.length){let u=g[m];if(u.tagName.toLowerCase()==="tr"){if(e){let x=u.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(x)return x}let b=u.querySelector("input");if(b)return b}return D(u)}let v=document.body;try{v=N()||document.body}catch{}let f=Array.from(v.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>T(u)&&!z(u));if(m<f.length)return f[m]}}let l=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(l){let d=l[1].toUpperCase().charCodeAt(0)-65;if(d>=0){let m=kt();if(d<m.length){let g=m[d];if(g.tagName.toLowerCase()==="tr"){if(e){let f=g.querySelector(`input[value="${$(e)}" i], [data-value="${$(e)}" i]`);if(f)return f}let v=g.querySelector("input");if(v)return v}return D(g)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let m=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(u=>T(u)&&!z(u));if(m)return m;let v=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(u=>T(u)&&!z(u));if(v)return D(v);let f=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(u=>{if(!T(u)||z(u))return!1;let b=y(u.textContent).toLowerCase();return b===i.toLowerCase()||b===i.toLowerCase()+")"});if(f)return D(f)}try{let m=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`)).find(g=>T(g)&&!z(g));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:D(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let m=Array.from(document.querySelectorAll(i)).find(g=>T(g)&&!z(g));if(m)return D(m)}catch{}try{let d=i.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,g=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let v=0;v<g.snapshotLength;v++){let f=g.snapshotItem(v);if(f&&T(f)&&!z(f)){if(["body","html"].includes(f.tagName.toLowerCase())){let b=f.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(b&&T(b))return D(b)}return f.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||D(f)}}}catch{}let p=y(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of h){if(!T(d)||z(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||P(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=y(d.textContent).toLowerCase(),v=y(d.getAttribute("aria-label")||"").toLowerCase(),f=y(d.getAttribute("placeholder")||"").toLowerCase(),u=y(d.getAttribute("title")||"").toLowerCase(),b=y(d.getAttribute("name")||"").toLowerCase(),x=y(d.getAttribute("data-category")||"").toLowerCase(),w=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",C=y(w).toLowerCase(),M=g.startsWith(p+")")||g.startsWith(p+".")||g.startsWith(p+" -")||g.startsWith(p+":");if(g===p||v===p||f===p||u===p||b===p||x&&x===p||C&&C===p||M)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||D(d)}if(p.length>=3)for(let d of h){if(!T(d)||z(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||P(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let g=y(d.textContent).toLowerCase(),v=y(d.getAttribute("aria-label")||"").toLowerCase(),f=y(d.getAttribute("placeholder")||"").toLowerCase(),u=y(d.getAttribute("title")||"").toLowerCase(),b=y(d.getAttribute("name")||"").toLowerCase();if(g.includes(p)||v.includes(p)||f.includes(p)||u.includes(p)||b.includes(p)){if(Array.from(d.children).some(M=>{let S=y(M.textContent).toLowerCase();return S&&S.includes(p)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||D(d)}let x=p.split(/\s+/).filter(Boolean);if(x.length>=3){let w=x.slice(0,Math.min(5,x.length)).join(" ");if(g.includes(w)||v.includes(w)||f.includes(w))return D(d)}}return null}function It(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function _(o,e){if(!o)return;let t=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:o.querySelector('input[type="checkbox"], input[type="radio"]')||(o.hasAttribute("for")?o.ownerDocument.getElementById(o.getAttribute("for")):null);if(t&&o!==t){if(t.type==="checkbox"){Y(t,!0);return}if(t.type==="radio"){Y(t,!0);return}}try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}try{o.focus?.()}catch{}if(typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement||typeof HTMLAnchorElement<"u"&&o instanceof HTMLAnchorElement||o.tagName?.toLowerCase()==="a"||o.tagName?.toLowerCase()==="button"||typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement&&!["checkbox","radio"].includes(o.type)){try{o.click()}catch{}return}let i=o.getBoundingClientRect(),n=e?e[0]:Math.round(i.left+Math.max(1,i.width/2)),r=e?e[1]:Math.round(i.top+Math.max(1,i.height/2)),s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerdown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}))}catch{}try{o.click()}catch{}}function $e(o,e){let t=o;if(t.hasAttribute("for")){let c=t.getAttribute("for"),p=t.ownerDocument.getElementById(c);p&&(t=p)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Pe(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){Pe(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(c)t=c;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let c=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(c)t=c;else{let p=document.body;try{p=N()||document.body}catch{}let h=p.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let c=document.body;try{c=N()||document.body}catch{}let p=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p)t=p;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let c=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;Y(t,c);return}let r=String(e??""),s=r;if(t instanceof HTMLInputElement&&t.type==="number"){let c=r.replace(",",".").replace(/[^0-9.-]/g,"");c&&!isNaN(Number(c))&&(s=c)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}let l=!1;try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){if(t.type!=="number"){try{t.select?.()}catch{}l=document.execCommand?.("insertText",!1,s)||!1}}else if(t.isContentEditable){try{document.execCommand?.("selectAll",!1,void 0)}catch{}l=document.execCommand?.("insertText",!1,s)||!1}}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(s===""?" ":"")}catch{}let c=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,p=Object.getOwnPropertyDescriptor(c,"value")?.set;p?p.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{p?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Ce(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=y(t),n=E(t)||E(i);if(!n)return a?e:i||e;let r=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let h=y(r.textContent);if(h&&h.length>0&&h.length<150)return h}if(n.id){let h=document.querySelector(`label[for="${$(n.id)}"]`);if(h){let d=y(h.textContent);if(d&&d.length>0&&d.length<150)return d}}let s=n.getAttribute("aria-label");if(s)return y(s);let l=n.getAttribute("placeholder");if(l)return y(l);let c=y(n.textContent);if(c&&c.length>0&&c.length<120)return c;let p=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return p?y(p):a?e:i||e}function Y(o,e){let t=o.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');if(!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for"))),t){let i=e?"true":"false";t.setAttribute("aria-checked",i),t.setAttribute("aria-selected",i),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}if(a){if(a.checked===e)return;try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let i=a._valueTracker;i&&i.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,It(a,["input","change"])}}else{try{t.focus?.()}catch{}try{t.click()}catch{_(t)}}}function Pe(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let r=e.map(c=>y(c).toLowerCase()),s=!1,l=(c,p)=>{c.selected=!0,t.selectedIndex=p;try{t.value=c.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,c.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(c.value)}catch{}s=!0};for(let c=0;c<t.options.length;c++){let p=t.options[c],h=p.value.toLowerCase(),d=y(p.textContent).toLowerCase();if(r.some(g=>g===h||g===d)){if(l(p,c),!t.multiple)break}else t.multiple||(p.selected=!1)}if(!s)for(let c of r){let p=c.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(p){let h=parseInt(p[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(m>=0&&m<t.options.length&&(l(t.options[m],m),!t.multiple))break}}if(!s){for(let c of r)if(/^[a-z]$/i.test(c)){let p=c.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?p+1:p;if(d>=0&&d<t.options.length&&(l(t.options[d],d),!t.multiple))break}}if(!s){let c=p=>p.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let p=0;p<t.options.length;p++){let h=t.options[p],d=c(h.value.toLowerCase()),m=c(y(h.textContent).toLowerCase());if(r.some(v=>{let f=c(v);return d.includes(f)||m.includes(f)||f.length>2&&(f.includes(d)||f.includes(m))})&&(l(h,p),!t.multiple))break}}if(s){It(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&_(a);let i=e.map(r=>y(r).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>T(r)&&!z(r));for(let r of i){let s=n.find(c=>{let p=y(c.textContent).toLowerCase(),h=y(c.getAttribute("data-value")||c.getAttribute("value")||"").toLowerCase();return p===r||h===r||p.includes(r)||r.length>2&&r.includes(p)});if(s){_(s);let c=s.querySelector('input[type="radio"], input[type="checkbox"]');c&&Y(c,!0);return}let l=E(r);if(l){_(l);return}}}function oo(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function Xe(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function te(o,e){let t=y(o).toLowerCase();if(!t)return null;let a=e==="source"?'.dnd-card, [draggable="true"]':'[data-dropzone], [data-category], [data-role="dropzone"]',i=Array.from(document.querySelectorAll(a)),n=e==="destination"?i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t)):null;return n&&T(n)&&!z(n)?n:i.find(r=>{if(!T(r)||z(r))return!1;let s=y(`${r.textContent||""} ${r.getAttribute("data-category")||""} ${r.getAttribute("data-dropzone")||""}`).toLowerCase();return s===t||s.includes(t)})||null}async function Re(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),i=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),r=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),l=Math.round(i.top+Math.max(1,i.height/2)),c=y(e.textContent).toLowerCase();if(c){let v=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(f=>{let u=y(f.textContent).toLowerCase(),b=f instanceof HTMLInputElement||f instanceof HTMLOptionElement?y(f.value).toLowerCase():"";return u&&(c.includes(u)||u.includes(c))||b&&(c.includes(b)||b.includes(c))});v&&(_(v),await new Promise(f=>setTimeout(f,120)))}Xe(o),await new Promise(g=>setTimeout(g,140)),Xe(e);let p=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(p&&p!==e&&Xe(p),await new Promise(g=>setTimeout(g,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,screenX:n,screenY:r,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",h));let d=4;for(let g=1;g<=d;g++){let v=Math.round(n+(s-n)*(g/d)),f=Math.round(r+(l-r)*(g/d)),u={...h,clientX:v,clientY:f,screenX:v,screenY:f};try{o.dispatchEvent(new PointerEvent("pointermove",{...u,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",u))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:l,screenX:s,screenY:l,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let g=oo(H(o.textContent),o.outerHTML),v={...h},f={...m};g&&(v.dataTransfer=g,f.dataTransfer=g);let u=o.ownerDocument.defaultView?.DragEvent;if(!u)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new u("dragstart",v)),e.dispatchEvent(new u("dragenter",f)),e.dispatchEvent(new u("dragover",f)),e.dispatchEvent(new u("drop",f)),o.dispatchEvent(new u("dragend",v))}catch(g){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",g)}try{let g=new Touch({identifier:1,target:o,clientX:n,clientY:r}),v=new Touch({identifier:1,target:e,clientX:s,clientY:l});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[v]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(g=>setTimeout(g,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var zt={fill:(o,e)=>{let t=E(o);t?$e(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=E(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?Y(e,!0):_(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=E(o);t?Y(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>E(o,e),drag:(o,e)=>{let t=te(o,"source")||E(o),a=te(e,"destination")||E(e);t&&a?Re(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=te(o,"source")||E(o),a=te(e,"destination")||E(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Re(t,a)},execute:(o,e=!1,t=1)=>tt(o,e,t)};typeof window<"u"&&(window.$eq=zt);async function ao(o,e=1,t=we()){if(Ue(o,t),o.t==="js"){let s=String(o.v||"");Ct(s);try{new Function("$eq","document","window",s)(zt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let s=te(o.from,"source")||E(o.from),l=te(o.to,"destination")||E(o.to);!s&&o.from&&(s=E(y(o.from))),!l&&o.to&&(l=E(y(o.to))),s&&l?await Re(s,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let i=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=i!=null?String(i).trim():"",r=E(a,n,o.t==="val"||o.t==="sel");if(!r&&a&&(r=E(y(a),n,o.t==="val"||o.t==="sel")),r&&n){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(y(r.value).toLowerCase()!==y(n).toLowerCase()){let s=document.querySelector(`input[type="radio"][name="${$(r.name)}"][value="${$(n)}" i]`);if(s)r=s;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(r.name)}"]`)).find(p=>{let h=p.closest("label, .vf-label, .option-card, tr, td, div");return h&&y(h.textContent).toLowerCase().includes(y(n).toLowerCase())});c&&(r=c)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let s=r.querySelector(`input[value="${$(n)}" i], [data-value="${$(n)}" i]`);if(s)r=s;else{let c=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(p=>{let h=p.closest("label, .vf-label, .option-card, td, div");return h&&y(h.textContent).toLowerCase().includes(y(n).toLowerCase())});c&&(r=c)}}}if(!r&&(o.t==="val"||o.t==="sel")){let s=document.body;try{s=N()||document.body}catch{}let l=Array.from(s.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(c=>T(c)&&!z(c));if(l.length===1)r=l[0];else if(l.length>1){let c=y(a).toLowerCase(),p=c.match(/^#?_?([0-9]+)$/);if(p){let h=parseInt(p[1],10);h>=1&&h<=l.length?r=l[h-1]:h>=0&&h<l.length&&(r=l[h])}r||(r=l.find(d=>{let m=(d.getAttribute("placeholder")||"").toLowerCase(),g=(d.name||"").toLowerCase(),v=(d.getAttribute("aria-label")||"").toLowerCase(),f=(d.id||"").toLowerCase(),u=y(Ye(d)).toLowerCase(),b=y(d.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return m.includes(c)||g.includes(c)||v.includes(c)||f.includes(c)||u&&u.includes(c)||c.length>=2&&b.includes(c)})||(l.length===1?l[0]:null))}}if(!r&&o.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${o.t}'. Prosseguindo...`);return}switch(o.t){case"val":if(r){let l=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!l){let d=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(l=d)}if(!l){let h=r.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){l=h;break}let d=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){l=d;break}h=h.nextElementSibling}}if(!l){let h=document.body;try{h=N()||document.body}catch{}let d=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>T(m)&&!z(m));d.length>0&&(l=d[0])}let c=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,p=c!=null?String(c):"";$e(l||r,p)}break;case"chk":r&&Y(r,!!o.c);break;case"sel":if(r){let l=Array.isArray(o.v)?o.v:[String(o.v)];Pe(r,l)}break;case"clk":if(r)if(!!(r.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let c=o.c!==void 0?!!o.c:!0;Y(r,c)}else _(r,o.co);break;case"adv":let s=Ze(o.id);if(s){await et(s,1200);let l=o.id||s.textContent?.trim()||"";l&&_e(window.location.hostname,{advanceSelector:l}),_(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function no(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!T(t)||z(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function Ze(o){if(o){let n=E(o);if(n&&T(n)&&!z(n)&&!P(n))return n}try{let n=be(window.location.hostname);if(n.advanceSelector){let r=E(n.advanceSelector);if(r&&T(r)&&!z(r)&&!P(r))return r}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(e)).filter(n=>T(n)&&!z(n)&&!n.closest("header, nav, aside")&&!P(n));for(let n of a)if(W(n)&&!P(n))return n;for(let n of a){let r=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",s=(n.textContent||r||n.getAttribute("aria-label")||"").trim();if(He.test(s)&&!P(n))return n}let i=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return i&&T(i)&&!z(i)&&!P(i)?i:null}async function et(o,e=1500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,100))}}function $t(){let o=(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim(),e=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"]').length;return`${window.location.href}|${document.title}|${o.slice(0,900)}|${e}`}async function io(o,e=1800){let t=Date.now();for(;Date.now()-t<e;){if($t()!==o)return{changed:!0,evidence:"URL, texto, t\xEDtulo ou conjunto de controles mudou ap\xF3s a a\xE7\xE3o."};await new Promise(i=>setTimeout(i,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a observ\xE1vel foi detectada dentro do tempo limite."}}async function Ht(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let i=E(o.from)||E(y(o.from)),n=E(o.to)||E(y(o.to));i&&n&&await Re(i,n,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=E(e,t)||E(y(e),t);if(o.t==="clk"||o.t==="chk"){if(!a&&e){let n=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),r=y(e).toLowerCase();a=n.find(s=>{let l=y(s.textContent).toLowerCase(),c=y(s.value||"").toLowerCase();return l.includes(r)||c===r||l.startsWith(r+")")||l.startsWith("("+r+")")})||null}let i=o.v!==void 0?String(o.v).trim():"";if(a&&i){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(y(a.value).toLowerCase()!==y(i).toLowerCase()){let n=document.querySelector(`input[type="radio"][name="${$(a.name)}"][value="${$(i)}" i]`);if(n)a=n;else{let s=Array.from(document.querySelectorAll(`input[type="radio"][name="${$(a.name)}"]`)).find(l=>{let c=l.closest("label, .vf-label, .option-card, tr, td, div");return c&&y(c.textContent).toLowerCase().includes(y(i).toLowerCase())});s&&(a=s)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let n=a.querySelector(`input[value="${$(i)}" i], [data-value="${$(i)}" i]`);if(n)a=n;else{let s=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let c=l.closest("label, .vf-label, .option-card, td, div");return c&&y(c.textContent).toLowerCase().includes(y(i).toLowerCase())});s&&(a=s)}}}if(a){let n=a.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,r=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:n.querySelector('input[type="radio"], input[type="checkbox"]')||(n.getAttribute("for")?n.ownerDocument.getElementById(n.getAttribute("for")):null),s=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(Y(r||n,s),r&&r.checked!==s){try{let l=r._valueTracker;l&&l.setValue(!s)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(r,s)}catch{}r.checked=s,r.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),r.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let i=null;if(a&&(i=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!i){let n=document.body;try{n=N()||document.body}catch{}let r=Array.from(n.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),s=y(e).toLowerCase();i=r.find(l=>{let c=(l.getAttribute("placeholder")||"").toLowerCase(),p=(l.name||"").toLowerCase(),h=(l.id||"").toLowerCase(),d=(l.getAttribute("aria-label")||"").toLowerCase();return c.includes(s)||p.includes(s)||h.includes(s)||d.includes(s)})||(r.length>0?r[0]:null)}if(i){let n=String(o.v??"");try{if(i.focus?.(),i.type!=="number"){try{i.select?.()}catch{}document.execCommand?.("insertText",!1,n)}}catch{}$e(i,n)}return}if(o.t==="sel"){if(!a&&e){let i=Array.from(document.querySelectorAll("select")),n=y(e).toLowerCase();a=i.find(r=>{let s=(r.name||"").toLowerCase(),l=(r.id||"").toLowerCase(),c=(r.getAttribute("aria-label")||"").toLowerCase();return s.includes(n)||l.includes(n)||c.includes(n)})||null}if(a){let i=Array.isArray(o.v)?o.v:[String(o.v)];Pe(a,i)}return}}function pe(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,i=o.id!==void 0&&o.id!==null?String(o.id):"";i||(i=o.target??o.name??o.selector??"1");let n=E(i,a,!0)||E(y(i),a,!0);if(!n){let h=document.body;try{h=N()||document.body}catch{}let d=Array.from(h.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(m=>T(m)&&!z(m));d.length>0&&(n=d[0])}if(!n)return!1;let r=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(r&&r.name){let h=document.querySelector(`input[type="radio"][name="${$(r.name)}"]:checked`);if(!h)return!1;let d=y(h.value).toLowerCase(),m=y(t).toLowerCase(),g=y(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===m||g===m||g.includes(m)}let s=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let d=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');d&&(s=d)}if(!s){let h=n.nextElementSibling;for(;h;){if(h instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(h.type)||h instanceof HTMLTextAreaElement||h instanceof HTMLElement&&h.isContentEditable){s=h;break}let d=h.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(d){s=d;break}h=h.nextElementSibling}}if(s instanceof HTMLSelectElement){let h=y(t).toLowerCase();return Array.from(s.options).some(d=>{if(!d.selected)return!1;let m=d.value.toLowerCase(),g=y(d.textContent).toLowerCase();return h===m||h===g||m.includes(h)||g.includes(h)})}let l=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??n.textContent??"").trim();if(!l&&!t)return!0;if(!l&&t)return!1;let c=l.replace(",",".").replace(/\s+/g,"").toLowerCase(),p=t.replace(",",".").replace(/\s+/g,"").toLowerCase();return c===p||c.includes(p)||p.includes(c)||l.toLowerCase()===t.toLowerCase()}if(o.t==="sel"){let e=E(o.id,void 0,!0)||E(y(o.id),void 0,!0);if(!e){let n=document.body;try{n=N()||document.body}catch{}let r=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(c=>T(c)&&!z(c)),s=y(o.id).toLowerCase();e=r.find(c=>{let p=(c.id||"").toLowerCase(),h=(c.getAttribute("name")||"").toLowerCase(),d=(c.getAttribute("aria-label")||"").toLowerCase(),m=y(c.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return p.includes(s)||h.includes(s)||d.includes(s)||s.length>=2&&m.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(c=>y(c).toLowerCase()),l=y(n.textContent).toLowerCase();return s.some(c=>l.includes(c)||c.includes(l))}return!1}let i=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>y(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let r=n.value.toLowerCase(),s=y(n.textContent).toLowerCase();return i.some(l=>l===r||l===s||r.includes(l)||s.includes(l))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=E(o.id,e)||E(y(o.id),e);if(!t)return!1;let a=t.closest('.option-card, label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||t,i=t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)?t:a.querySelector('input[type="checkbox"], input[type="radio"]')||(a.getAttribute("for")?a.ownerDocument.getElementById(a.getAttribute("for")):null),n=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(i&&i.type==="radio"){if(i.checked===n)return!0;if(o.v&&i.name){let p=y(String(o.v)).toLowerCase(),h=document.querySelector(`input[type="radio"][name="${$(i.name)}"]:checked`);if(!h)return!1;if(h===i)return!0;let d=y(h.value).toLowerCase(),m=y(h.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return d===p||m.includes(p)||p.includes(d)}}if(i&&["checkbox","radio"].includes(i.type))return i.checked===n;let r=a.getAttribute("aria-checked")===String(n)||a.getAttribute("aria-selected")===String(n)||a.getAttribute("aria-pressed")===String(n),s=n?a.getAttribute("data-selected")==="true"||a.getAttribute("data-checked")==="true"||a.getAttribute("data-active")==="true"||a.getAttribute("data-state")==="checked"||a.getAttribute("data-state")==="on":a.getAttribute("data-selected")==="false"||a.getAttribute("data-checked")==="false"||a.getAttribute("data-state")==="unchecked",l=n?/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||""):!/active|selected|checked|picked|correct|is-selected|choice-selected|selected-option|is-checked|chosen|current|highlight|ring|border-primary/i.test(a.className||"");return!!(r||s||l||(a instanceof HTMLButtonElement||a.getAttribute("role")==="button")&&o.t==="clk"||o.t==="clk"&&!i)}if(o.t==="drag"){let e=E(o.from)||E(y(o.from)),t=E(o.to)||E(y(o.to));return!e||!t?!1:t.contains(e)?!0:/placed|dropped|assigned|matched|done|selected/i.test(e.className||"")||e.getAttribute("data-placed")==="true"}}catch{}return!1}async function tt(o,e,t=1,a=we({engine:"smart",autoAdvance:e})){let i=o.actions.filter(u=>u.t!=="adv"),n=o.actions.filter(u=>u.t==="adv"),r=0,s=[],l=new Map,c=o.pageType==="question",p=i.filter(u=>u.t==="chk"||u.t==="clk"&&u.c!==void 0);if(c&&p.length>0){let u=document.body;try{u=N()||document.body}catch{}let b=Array.from(u.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(x=>T(x)&&!z(x));if(b.length>1){let x=new Set;for(let w of p){let C=w.t==="chk"?!!w.c:!!(w.c??!0),M="id"in w&&typeof w.id=="string"?w.id:"";if(C&&M){let S=E(M,w.v);if(S){let k=S instanceof HTMLInputElement&&S.type==="checkbox"?S:S.querySelector('input[type="checkbox"]');x.add(k||S)}}}if(x.size>0)for(let w of b)x.has(w)||(w instanceof HTMLInputElement&&w.checked||w.getAttribute("aria-checked")==="true"||w.closest(".option-card, label")?.classList.contains("selected"))&&Y(w,!1)}}for(let u of i){try{await ao(u,t,a),r++}catch(b){l.set(u,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",u,b)}await new Promise(b=>setTimeout(b,u.t==="drag"?250:70))}await new Promise(u=>setTimeout(u,i.length>0?300:50));let h=0;for(let u of i){if(pe(u)){h++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${u.t}' no alvo '${u.id||u.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{Ue(u,a),await Ht(u)}catch(b){l.set(u,b instanceof Error?b.message:String(b)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",b)}await new Promise(b=>setTimeout(b,180)),pe(u)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),h++)}if(h<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-h} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(u=>setTimeout(u,200));for(let u of i)if(!pe(u))try{await Ht(u)}catch(b){l.set(u,b instanceof Error?b.message:String(b))}await new Promise(u=>setTimeout(u,200)),h=0;for(let u of i)pe(u)&&h++}for(let u of i)pe(u)||s.push(u.t==="drag"?`${u.from} -> ${u.to}`:"id"in u?u.id:u.t);c&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let d=i.map((u,b)=>{let x=u.t==="drag"?`${u.from} -> ${u.to}`:u.t==="js"?"$eq":u.id||u.t,w=u.t==="js"?!0:u.t==="drag"?!!(te(u.from,"source")&&te(u.to,"destination")):!!(E(u.id||"")||E(y(u.id||""))),C=pe(u);return{index:b,action:u,target:x,located:w,applied:!l.has(u),verified:C,strategy:u.t==="drag"?"drag-adaptive":u.t==="js"?"javascript":"declarative-dom",evidence:C?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...l.has(u)?{error:l.get(u)}:{}}}),m=c?i.length>0&&s.length===0&&(h===i.length||r===i.length&&h>0):!0,g=!1,v=!1,f="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.";if(e&&(m||!c)){await new Promise(C=>setTimeout(C,i.length>0?400:150));let u=!1;if(o.pageType!=="info"){let C=no();C&&T(C)&&(await et(C,1200),_(C),u=!0,await new Promise(M=>setTimeout(M,800)))}let b=$t(),x=n.length>0?n[0].id:void 0,w=Ze(x);if(!w&&u&&(await new Promise(C=>setTimeout(C,600)),w=Ze(x)),w){await et(w,1500);let C=x||w.textContent?.trim()||"";C&&_e(window.location.hostname,{advanceSelector:C}),_(w);let M=await io(b,2500);v=M.changed,f=M.evidence,g=M.changed||u,!M.changed&&!u&&console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else u?(g=!0,v=!0,f="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio."):console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:r,verified:h,success:m,advanced:g,failed:s,reports:d,navigationVerified:v,navigationEvidence:f}}var he=null,ne=[],ot=[],at=[],me=null,so=`
...
`;function Pt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=so,document.head.appendChild(o)}}catch{}}function ie(){he&&(he.style.removeProperty("outline"),he.style.removeProperty("outline-offset"),he.style.removeProperty("position"),he=null);for(let o of ne)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ne=[];for(let o of ot)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");ot=[];for(let o of at)try{o.remove()}catch{}if(at=[],me){try{me.remove()}catch{}me=null}}function nt(o){Pt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),ot.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),at.push(n)}}catch{}}}function it(o){ie(),Pt(),he=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),me=t,setTimeout(()=>{try{t.remove()}catch{}me===t&&(me=null)},900)}catch{}}function ro(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Rt(o,e){let t=ro(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let h=E(a.from),d=E(a.to);h&&(h.style.outline=`2px solid ${t.outline}`,ne.push(h)),d&&(d.style.outline="2px dashed #00e5ff",ne.push(d))}catch{}continue}if(!a.id)continue;let i=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=E(a.id,i,a.t==="val"||a.t==="sel")||E(y(a.id),i,a.t==="val"||a.t==="sel");if(!n&&a.t==="sel"){let h=document.body;try{h=N()||document.body}catch{}let d=Array.from(h.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(v=>T(v)&&!de(v)),m=y(a.id).toLowerCase();n=d.find(v=>{let f=(v.id||"").toLowerCase(),u=(v.getAttribute("name")||"").toLowerCase(),b=(v.getAttribute("aria-label")||"").toLowerCase(),x=y(v.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return f.includes(m)||u.includes(m)||b.includes(m)||m.length>=2&&x.includes(m)})||(d.length===1?d[0]:null)}if(!n)continue;let r=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"||n.getAttribute("role")==="combobox"||n.getAttribute("role")==="listbox",l=n.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li')||n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]')||n;l.style.outline=`2px solid ${t.outline}`,l.style.outlineOffset="2px",l.style.backgroundColor=t.bg,l.setAttribute("data-easyquiz-highlight","true"),ne.push(l);let c=r?n:l.querySelector('select, [role="combobox"], [role="listbox"]');c&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ne.push(c));let p=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:l.querySelector('input[type="checkbox"], input[type="radio"]');p&&p!==l&&(p.style.outline=`2px solid ${t.outline}`,p.style.outlineOffset="2px",p.style.boxShadow=`0 0 10px ${t.glow}`,p.setAttribute("data-easyquiz-highlight","true"),ne.push(p))}}var st=10,lo=1400,rt=15e5;function ge(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let i=String(a.result||"");e(i.split(",")[1]||"")},a.readAsDataURL(o)})}async function Te(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,lo/Math.max(e,t)),i=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),r=document.createElement("canvas");r.width=i,r.height=n;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,n),s.drawImage(o,0,0,i,n),new Promise((l,c)=>{r.toBlob(p=>p?l(p):c(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function co(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,i=2,n=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(a*i))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.setAttribute("width",String(n)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&a>0&&s.setAttribute("viewBox",`0 0 ${t} ${a}`);let c=new XMLSerializer().serializeToString(s),p=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),h=URL.createObjectURL(p);try{let d=new Image;d.crossOrigin="anonymous",await new Promise((v,f)=>{d.onload=()=>v(),d.onerror=()=>f(new Error("Falha ao renderizar SVG em Image.")),d.src=h});let m=document.createElement("canvas");m.width=n,m.height=r;let g=m.getContext("2d",{alpha:!1});if(!g)throw new Error("Sem suporte a Canvas 2D.");return g.fillStyle="#ffffff",g.fillRect(0,0,n,r),g.drawImage(d,0,0,n,r),new Promise((v,f)=>{m.toBlob(u=>u?v(u):f(new Error("Falha na compress\xE3o do SVG.")),"image/jpeg",.92)})}finally{URL.revokeObjectURL(h)}}async function lt(o){try{let e=o.cloneNode(!0),t=o.offsetWidth||500,a=o.offsetHeight||500,i=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let n=s=>{if(!this.isDragging||!this.element)return;let l=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,p=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+l),p),m=Math.min(Math.max(10,this.initialTop+c),h);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,n=i.actions.filter(m=>m.t==="drag"),r=i.actions.filter(m=>{if(m.t!=="val")return!1;let g=y(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(g)}),s=i.actions.filter(m=>m.t==="clk"||m.t==="chk"),l=i.actions.filter(m=>m.t==="sel"),c=n.length||r.length||s.length||l.length,p=document.createElement("div");p.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,p.append(h,d),e.appendChild(p),n.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let g of n){let v=y(g.to)||"Geral";m[v]||(m[v]=[]),m[v].push(y(g.from))}for(let[g,v]of Object.entries(m)){let f=document.createElement("div"),u=/fato|true|verdadeiro|sim/i.test(g),b=/opini[aã]o|false|falso|n[aã]o/i.test(g);f.className=`eq-fah-group ${u?"group-fato":b?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${g} (${v.length})`,f.appendChild(x);let w=document.createElement("div");w.className="eq-fah-group-items";for(let C of v){let M=document.createElement("div");M.className="eq-fah-item";let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=C,M.appendChild(S);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),M.appendChild(k),w.appendChild(M)}f.appendChild(w),e.appendChild(f)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,a.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let f=0;f<r.length;f++){let u=r[f],b=document.createElement("div");b.className="eq-fah-item";let x=Ce(u.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${f+1}`);let w=String(u.v??""),C=document.createElement("div");C.className="eq-fah-field-box";let M=document.createElement("div");M.className="eq-fah-field-label",M.textContent=x,C.appendChild(M);let S=document.createElement("div");S.className="eq-fah-field-val",S.textContent=w,C.appendChild(S),b.appendChild(C);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(w),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),b.appendChild(k),v.appendChild(b)}m.appendChild(v),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let f=0;f<s.length;f++){let u=s[f],b=document.createElement("div");b.className="eq-fah-item";let x=Ce(u.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&u.v&&(x=String(u.v)),x=y(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let w="",C=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);C?(w=C[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=C[2].trim()||x):s.length>1&&(w=String.fromCharCode(65+f));let M=document.createElement("div");if(M.style.display="flex",M.style.alignItems="center",M.style.gap="8px",M.style.flex="1",w){let K=document.createElement("span");K.className="eq-fah-letter-badge",K.textContent=w,M.appendChild(K)}let S=document.createElement("span");S.className="eq-fah-item-text",S.textContent=x||(w?`Alternativa ${w}`:"Alternativa Selecionada"),M.appendChild(S),b.appendChild(M);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(x||w),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),b.appendChild(k),v.appendChild(b)}m.appendChild(v),e.appendChild(m)}else if(l.length>0){t.textContent=`Sele\xE7\xE3o (${l.length} listas)`,a.textContent=String(l.length);let m=document.createElement("div");m.className="eq-fah-group";let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let f=0;f<l.length;f++){let u=l[f],b=document.createElement("div");b.className="eq-fah-item";let x=Ce(u.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${f+1}`);let M=(Array.isArray(u.v)?u.v:[String(u.v??"")]).map(L=>{let I=E(u.id,void 0,!0)||E(y(u.id),void 0,!0),O=I instanceof HTMLSelectElement?I:I?.querySelector("select");if(O){let J=y(L).toLowerCase();for(let B=0;B<O.options.length;B++){let X=O.options[B];if(X.value.toLowerCase()===J||y(X.textContent).toLowerCase()===J){let j=y(X.textContent);if(j&&!j.toLowerCase().includes("selecione"))return j}}}return L}).join(", "),S=document.createElement("div");S.className="eq-fah-field-box";let k=document.createElement("div");k.className="eq-fah-field-label",k.textContent=x,S.appendChild(k);let K=document.createElement("div");K.className="eq-fah-field-val",K.textContent=M,S.appendChild(K),b.appendChild(S);let U=document.createElement("button");U.className="eq-fah-copy-inline",U.textContent="Copiar",U.addEventListener("click",()=>{navigator.clipboard.writeText(M),U.textContent="\u2713 Copiado",setTimeout(()=>U.textContent="Copiar",1200)}),b.appendChild(U),v.appendChild(b)}m.appendChild(v),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(i.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),r=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let l of a){let c=y(l.to)||"Geral";s[c]||(s[c]=[]),s[c].push(y(l.from))}for(let[l,c]of Object.entries(s)){t.push(`### Categoria: ${l}`);for(let p of c)t.push(`- ${p}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let l=y(s.id);t.push(`- **${l||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let l=n[s],c=Ce(l.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&l.v&&(c=String(l.v)),c=y(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let p=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${p}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of r){let l=y(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${l}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
