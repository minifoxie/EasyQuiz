 ...
 */
"use strict";(()=>{var Ve=Object.defineProperty;var $=(t,e)=>()=>(t&&(e=t(t=0)),e);var fe=(t,e)=>{for(var a in e)Ve(t,a,{get:e[a],enumerable:!0})};var q,ve=$(()=>{"use strict";q={apiKey:"",model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8}});var be={};fe(be,{addSessionMemory:()=>Ge,clearSessionMemories:()=>_,getSessionMemories:()=>ie,loadDomainCache:()=>N,loadSettings:()=>B,resetAllData:()=>oe,saveDomainCache:()=>ae,saveSettings:()=>ne});function B(){try{let t=localStorage.getItem(te);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let s=JSON.parse(o);return{...q,apiKey:s.apiKey||""}}return{...q}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:q.model;return(a.includes("3.8")||a.includes("3.7")||a.includes("3.6")||a.includes("3.5")||a.includes("3.1"))&&(a=q.model),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():q.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:q.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:q.confidenceThreshold}}catch{return{...q}}}function oe(){try{localStorage.removeItem(te),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),_()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function N(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function ae(t,e){let o={...N(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function ne(t){let a={...B(),...t};try{localStorage.setItem(te,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}function Ge(t){let e=t.trim();e&&!D.includes(e)&&D.push(e)}function ie(){return D}function _(){D=[]}var te,D,T=$(()=>{"use strict";ve();te="easyquiz_settings_v2";D=[]});function v(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function m(t,e=500){return(t??"").replace(/\s+/g," ").trim().slice(0,e)}function Fe(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(Ke+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function le(t){let e=m(t.getAttribute("aria-label")||t.textContent||t.getAttribute("value")||t.value),a=t.type,o=e.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim();return Q.test(o)||Q.test(e)||a==="submit"||t.getAttribute("data-testid")?.toLowerCase().includes("next")||t.getAttribute("data-testid")?.toLowerCase().includes("check")||!1}function Ye(t){let e=t.getAttribute("aria-label");if(e)return m(e);let a=t.getAttribute("aria-labelledby");if(a){let i=a.split(/\s+/).map(n=>document.getElementById(n)?.textContent).filter(Boolean).join(" ");if(i.trim())return m(i)}if("labels"in t&&t.labels){let i=Array.from(t.labels??[]).map(n=>n.textContent).join(" ");if(i.trim())return m(i)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let i=m(o.textContent);if(i)return i}let s=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||t.value||"";return m(s)}function ce(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let s=t.tagName.toLowerCase(),i=["input","textarea","select","button"].includes(s)?s:"other",n=t.getAttribute("role")||"",r=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item"),l=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category"),c=m((r?"draggable":l?"dropzone":"")||o.type||n||i,40),u="";o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox"?u=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked":u=m(o.value||t.getAttribute("data-category")||t.textContent||"",2e3);let h=[];if(a)for(let w of Array.from(a.options).slice(0,80))h.push({value:m(w.value),label:m(w.textContent)});let g=!!(o.required||t.getAttribute("aria-required")==="true"),f=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Fe(t),tag:i,type:c,label:Ye(t),name:m(o.name||t.getAttribute("name")||"",180),value:u,options:h,required:g,disabled:f,role:e}}var C,Q,Ke,j=$(()=>{"use strict";C=['input:not([type="hidden"])',"textarea","select","button",'[role="button"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),Q=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi)/i,Ke=0});var F={};fe(F,{captureCurrentContext:()=>k,captureFullPageText:()=>Je,expandToGeneralSelection:()=>Se,extractAnswerControls:()=>Ce,extractNavigationControls:()=>K,findActiveScope:()=>Ae,findTrueQuestionContainer:()=>U,sanitizeHtml:()=>de});function Te(t){if(!v(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(C)).filter(v),o=m(t.innerText,4e3).length;if(!a.length||o<10)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),i=Math.max(1,e.width*e.height),n=Math.min(1,i/s),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),d=o>40?35:0,c=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+d+c-n*20-l*10}function U(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let s=m(e.innerText,1e4),i=m(a.innerText,1e4),n=e.querySelectorAll(C).length,r=a.querySelectorAll(C).length;if(s.length<150&&i.length>s.length&&r<=n+4){e=a;continue}break}return e}function Se(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&v(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Ae(){let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(Ee);if(s&&Te(s)>0)return U(s)}let a=Array.from(document.querySelectorAll(Ee)).map(s=>({element:s,score:Te(s)})).filter(s=>Number.isFinite(s.score)).sort((s,i)=>i.score-s.score);if(a.length>0&&a[0].score>0)return U(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&v(o)?o:document.body}function de(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))a.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ce(t){return Array.from(t.querySelectorAll(C)).filter(e=>v(e)&&!le(e)).slice(0,100).map(e=>ce(e,"answer"))}function K(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let s of e)for(let i of Array.from(s.querySelectorAll(C)))if(!(a.has(i)||!v(i)||!le(i))&&(a.add(i),o.push(ce(i,"navigation")),o.length>=10))return o;return o}function k(t=!1){let e=Ae();e=U(e),t&&(e=Se(e));let a=m(e.innerText,16e3),o=Ce(e),s=K(e);s.length===0&&(s=K(document.body));let i=[...o,...s].slice(0,120);return!a||i.length===0&&a.length<30?null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:de(e),controls:i,scope:e}}function Je(){let t=document.body.innerText||document.documentElement.innerText,e=m(t,8e3),a=K(document.body),o=document.querySelector('main, article, [role="main"]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina Inteira",questionText:e,htmlSnippet:de(o).slice(0,1e4),controls:a,scope:o}}var Ee,M=$(()=>{"use strict";j();Ee=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",")});T();var ye=`Voc\xEA \xE9 o EasyQuiz Engine v4.5. Retorne JSON estrito.
Regras Absolutas:
1. "pageType": 
...
6. "needsMoreContext": true se a sele\xE7\xE3o atual parecer restrita ou isolada (cortando o enunciado da pergunta, faltando contexto do texto-base ou op\xE7\xF5es). O EasyQuiz acionar\xE1 a SELE\xC7\xC3O GERAL EXPANDIDA, ampliando o escopo para o container completo da p\xE1gina para lhe dar vis\xE3o total.`;function xe(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),i=t.questionText.length<120||o||t.controls.length<3?`
...
Responda estritamente em JSON.`}var S=[{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Padr\xE3o Oficial 2026)",description:"Mais r\xE1pido, econ\xF4mico e amplamente dispon\xEDvel em contas Google AI Studio."},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Gera\xE7\xE3o 3 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Compatibilidade Ampla)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],Qe={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function je(t){return t.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function we(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Ue(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let s of o)try{let i=JSON.parse(s);if(i&&typeof i=="object")return i}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var V=null,se=new Set;async function G(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return S;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let s=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!s.ok){let n=await s.text(),r=we(n,s.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let i=await s.json();if(Array.isArray(i.models)&&i.models.length>0){let n=i.models.filter(r=>{let l=r.supportedGenerationMethods||[],d=(r.name||"").includes("gemini"),c=l.includes("generateContent"),u=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return d&&c&&!u}).map(r=>{let l=r.name.replace(/^models\//,""),d=r.displayName||l;return{id:l,name:d.includes(l)?d:`${d} (${l})`,description:r.description||""}});if(n.length>0)return n.sort((r,l)=>{let d=c=>c==="gemini-2.5-flash"?100:c==="gemini-3.5-flash"?95:c==="gemini-3.1-flash-lite"?90:c==="gemini-2.5-pro"?85:c==="gemini-3.1-pro"?80:c==="gemini-1.5-flash"?60:c.includes("flash")?50:10;return d(l.id)-d(r.id)}),V=n,n}}catch(s){if(s.message?.includes("Chave de API"))throw s}return S}async function qe(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await G(e);if(o.length>0&&o!==S){let s=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${s.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let s of["v1beta","v1"]){let i=`https://generativelanguage.googleapis.com/${s}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(i,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${s})!`,models:S}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function re(t,e,a,o){let s=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!s)throw new Error("Chave de API n\xE3o configurada.");let i=je(a.model);if(!V||V.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await G(s)}catch(g){let f=g instanceof Error?g.message:String(g);if(f.includes("inv\xE1lida")||f.includes("n\xE3o autorizada"))throw new Error(f)}let n=Date.now(),r=xe(t,e,a),l=[{text:r}];for(let g of e)l.push({inline_data:{mime_type:g.mediaType,data:g.base64}});let d={system_instruction:{parts:[{text:ye}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:Qe}},c=[i,...V?.map(g=>g.id)||[],"gemini-2.5-flash","gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],u=Array.from(new Set(c)).filter(g=>!se.has(g));u.length===0&&(se.clear(),u.push(...S.map(g=>g.id)));let h=new Error("Nenhum modelo tentado.");for(let g=0;g<u.length;g++){let f=u[g],w=u[g+1];o?.(`Aguardando resposta da API (${f})...`,"info");let Oe=["v1beta","v1"];for(let A of Oe){let R=`https://generativelanguage.googleapis.com/${A}/models/${f}:generateContent?key=${encodeURIComponent(s)}`,O=new AbortController,ge=setTimeout(()=>O.abort(),35e3);try{let E=await fetch(R,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":s},body:JSON.stringify(d),signal:O.signal});if(clearTimeout(ge),!E.ok){let Ne=await E.text(),_e=we(Ne,E.status);if(E.status===404&&A==="v1beta")continue;throw new Error(_e)}let Z=await E.json(),ee=Z.candidates?.[0];if(!ee||!ee.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let Be=ee.content.parts[0].text,x=Ue(Be);return Array.isArray(x.actions)||(x.actions=[]),Array.isArray(x.warnings)||(x.warnings=[]),typeof x.confidence!="number"&&(x.confidence=.8),x.usedModel=f,x.durationMs=Date.now()-n,x.promptSent=r,x.tokensUsed=Z.usageMetadata?.totalTokenCount,f!==i&&o?.(`Resolvido com sucesso pelo fallback '${f}' (${A})!`,"info"),{plan:x,rawUsage:Z.usageMetadata,usedModel:f}}catch(E){if(clearTimeout(ge),h=E,h.message.includes("inv\xE1lida")||h.message.includes("n\xE3o autorizada"))throw h}}let $e=h.message.includes("429")||h.message.includes("cota"),De=h.message.includes("503")||h.message.includes("sobrecarregado");if(h.message.includes("404")&&se.add(f),w){let A=$e?3500:De?2500:900,R=`Modelo '${f}' indispon\xEDvel (${h.message}). Aguardando ${A/1e3}s antes de alternar para '${w}'...`;console.warn(`[EasyQuiz Fallback] ${R}`),o?.(R,"warning"),await new Promise(O=>setTimeout(O,A))}else console.warn(`[EasyQuiz Fallback] Modelo '${f}' falhou: ${h.message}. Todos os modelos esgotados.`)}throw h}T();M();T();j();function b(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o)return o;try{if(o=document.querySelector(e),o)return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o)return o}catch{}try{let n=e.replace(/"/g,""),r=`//*[normalize-space(text())="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(r,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let d=l.singleNodeValue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||d}}catch{}let s=m(e).toLowerCase().replace(/['"“”«»]/g,""),i=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of i){if(!v(n))continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,""),d=m(n.getAttribute("data-category")).toLowerCase().replace(/['"“”«»]/g,""),c=m(n.value).toLowerCase();if(r===s||l===s||d===s||c===s)return n.closest('button, [role="button"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], li')||n}if(s.length>=3)for(let n of i){if(!v(n)||n.children.length>5)continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,"");if(r.includes(s)||l.includes(s))return n.closest('button, [role="button"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], li')||n}return null}function L(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function y(t,e){let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let i=t.getBoundingClientRect();a=i.left+i.width/2,o=i.top+i.height/2}try{t.focus?.()}catch{}let s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};t.dispatchEvent(new PointerEvent("pointerdown",{...s,isPrimary:!0,button:0,buttons:1})),t.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1})),t.dispatchEvent(new PointerEvent("pointerup",{...s,isPrimary:!0,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}));try{t.click()}catch{}}function Me(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,L(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,L(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function Le(t,e){if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){t.checked!==e&&t.click(),t.checked!==e&&(Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(t,e),L(t,["input","change"]));return}let a=t.getAttribute("role");if(a==="radio"||a==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(y(t),t.setAttribute("aria-checked",e?"true":"false"),L(t,["input","change"]));return}y(t)}function Xe(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);L(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function We(){let t={};return{dropEffect:"move",effectAllowed:"all",files:[],items:[],types:["text/plain"],clearData:e=>{e?delete t[e]:Object.keys(t).forEach(a=>delete t[a])},getData:e=>t[e]||"",setData:(e,a)=>{t[e]=a},setDragImage:()=>{}}}async function pe(t,e){let a=t.getBoundingClientRect(),o=e.getBoundingClientRect(),s=a.left+a.width/2,i=a.top+a.height/2,n=o.left+o.width/2,r=o.top+o.height/2;y(t,[s,i]),await new Promise(h=>setTimeout(h,120)),y(e,[n,r]);let l=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], ul');l&&l!==e&&y(l),await new Promise(h=>setTimeout(h,100));let d={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:i,button:0,buttons:1};t.dispatchEvent(new PointerEvent("pointerdown",{...d,isPrimary:!0})),t.dispatchEvent(new MouseEvent("mousedown",d));for(let h=1;h<=3;h++){let g=s+(n-s)*(h/3),f=i+(r-i)*(h/3),w={...d,clientX:g,clientY:f};t.dispatchEvent(new PointerEvent("pointermove",{...w,isPrimary:!0})),document.dispatchEvent(new MouseEvent("mousemove",w))}let c={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,button:0,buttons:0};e.dispatchEvent(new PointerEvent("pointerup",{...c,isPrimary:!0})),e.dispatchEvent(new MouseEvent("mouseup",c));let u=We();u.setData("text/plain",t.textContent||""),u.setData("text/html",t.outerHTML),t.dispatchEvent(new DragEvent("dragstart",{...d,dataTransfer:u})),e.dispatchEvent(new DragEvent("dragenter",{...c,dataTransfer:u})),e.dispatchEvent(new DragEvent("dragover",{...c,dataTransfer:u})),e.dispatchEvent(new DragEvent("drop",{...c,dataTransfer:u})),t.dispatchEvent(new DragEvent("dragend",{...d,dataTransfer:u}));try{let h=new Touch({identifier:1,target:t,clientX:s,clientY:i}),g=new Touch({identifier:1,target:e,clientX:n,clientY:r});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[h]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}}var Ie={fill:(t,e)=>{let a=b(t);a?Me(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=b(t);e?y(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=b(t);a?Le(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=b(t),o=b(e);a&&o?pe(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=b(t),o=b(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await pe(a,o)}};window.$eq=Ie;async function ke(t){if(t.t==="js"){let o=String(t.v||"");try{new Function("$eq","document","window",o)(Ie,document,window)}catch(s){console.warn("[EasyQuiz JS Execution]",s)}return}if(t.t==="drag"){let o=b(t.from),s=b(t.to);o&&s?await pe(o,s):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let e=t.id||"",a=b(e);if(!a&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${e}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":a&&Me(a,String(t.v));break;case"chk":a&&Le(a,!!t.c);break;case"sel":if(a){let s=Array.isArray(t.v)?t.v:[String(t.v)];Xe(a,s)}break;case"clk":a&&y(a,t.co);break;case"adv":let o=a;if(!o){let s=Array.from(document.querySelectorAll('button, a, input[type="submit"]')).filter(i=>Q.test(i.textContent||i.value||""));s.length&&(o=s[0])}if(o){let s=t.id||o.textContent?.trim()||o.value?.trim()||"";s&&ae(window.location.hostname,{advanceSelector:s}),y(o)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}async function ze(t,e){let a=t.actions.filter(i=>i.t!=="adv"),o=t.actions.filter(i=>i.t==="adv");for(let i of a)await ke(i),i.t==="drag"&&await new Promise(n=>setTimeout(n,380));let s=!1;if(e){let i=Array.from(document.querySelectorAll('button, [role="button"], input[type="submit"]')).find(n=>/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(n.textContent||n.value||""));if(i&&v(i)&&(y(i),await new Promise(n=>setTimeout(n,800))),o.length>0)await new Promise(n=>setTimeout(n,600)),await ke(o[0]),s=!0;else if(i){await new Promise(r=>setTimeout(r,600));let n=Array.from(document.querySelectorAll('button, [role="button"], a, input[type="submit"]')).find(r=>/(próxim[oa]|next|continuar|avançar|mostrar resumo)/i.test(r.textContent||r.value||""));n&&v(n)&&(y(n),s=!0)}}return{applied:a.length,advanced:s}}var I=null,z=[];function H(){I&&(I.style.removeProperty("outline"),I.style.removeProperty("outline-offset"),I=null);for(let t of z)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");z=[]}function ue(t){H(),I=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function He(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let i=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);i&&(i.style.outline="2px solid #00ff88",z.push(i)),n&&(n.style.outline="2px dashed #00e5ff",z.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let s=o.closest('label, [role="listitem"], .answer, .form-check')||o;s.style.outline="2px solid #00ff88",s.style.outlineOffset="2px",s.style.backgroundColor="rgba(0, 255, 136, 0.08)",z.push(s)}}j();var P=4,Ze=1200,he=12e5;function Y(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");e(s.split(",")[1]||"")},o.readAsDataURL(t)})}async function J(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Ze/Math.max(e,a)),s=Math.max(1,Math.round(e*o)),i=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=s,n.height=i;let r=n.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,s,i),r.drawImage(t,0,0,s,i),new Promise((l,d)=>{n.toBlob(c=>c?l(c):d(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function Pe(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,s=`
