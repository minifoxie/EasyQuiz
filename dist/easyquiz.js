 ...
 */
"use strict";(()=>{var q={apiKey:"",model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};var Y="easyquiz_settings_v2";function X(){try{let t=localStorage.getItem(Y);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let s=JSON.parse(o);return{...q,apiKey:s.apiKey||""}}return{...q}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:q.model;return(a.includes("3.8")||a.includes("3.7")||a.includes("3.6")||a.includes("3.5")||a.includes("3.1"))&&(a=q.model),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():q.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:q.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:q.confidenceThreshold}}catch{return{...q}}}function ue(){try{localStorage.removeItem(Y),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),W()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function M(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function J(t,e){let o={...M(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function pe(t){let a={...X(),...t};try{localStorage.setItem(Y,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}var D=[];function he(t){let e=t.trim();e&&!D.includes(e)&&D.push(e)}function me(){return D}function W(){D=[]}var ge=`Voc\xEA \xE9 o EasyQuiz Engine v4.8 Supreme. Responda estritamente em JSON v\xE1lido.
...
- { "t": "adv" } (aciona bot\xE3o de avan\xE7o/pr\xF3xima)`;function fe(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),i=t.questionText.length<120||o||t.controls.length<3?`
[HTML FRAGMENT (Estrutura DOM/Widgets)]:
${t.htmlSnippet.slice(0,5e3)}`:`
[HTML FRAGMENT]: Omitido (Texto e controles s\xE3o suficientes).`,n=me(),r="";return n.length>0&&(r=`
...
Responda estritamente em JSON.`}var S=[{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Padr\xE3o Oficial 2026)",description:"Mais r\xE1pido, econ\xF4mico e amplamente dispon\xEDvel em contas Google AI Studio."},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Gera\xE7\xE3o 3 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Compatibilidade Ampla)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],Re={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function Oe(t){return t.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function ve(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Be(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let s of o)try{let i=JSON.parse(s);if(i&&typeof i=="object")return i}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var N=null,Z=new Set;async function _(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return S;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let s=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!s.ok){let n=await s.text(),r=ve(n,s.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let i=await s.json();if(Array.isArray(i.models)&&i.models.length>0){let n=i.models.filter(r=>{let l=r.supportedGenerationMethods||[],c=(r.name||"").includes("gemini"),u=l.includes("generateContent"),h=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return c&&u&&!h}).map(r=>{let l=r.name.replace(/^models\//,""),c=r.displayName||l;return{id:l,name:c.includes(l)?c:`${c} (${l})`,description:r.description||""}});if(n.length>0)return n.sort((r,l)=>{let c=u=>u==="gemini-2.5-flash"?100:u==="gemini-3.5-flash"?95:u==="gemini-3.1-flash-lite"?90:u==="gemini-2.5-pro"?85:u==="gemini-3.1-pro"?80:u==="gemini-1.5-flash"?60:u.includes("flash")?50:10;return c(l.id)-c(r.id)}),N=n,n}}catch(s){if(s.message?.includes("Chave de API"))throw s}return S}async function be(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await _(e);if(o.length>0&&o!==S){let s=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${s.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let s of["v1beta","v1"]){let i=`https://generativelanguage.googleapis.com/${s}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(i,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${s})!`,models:S}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function ee(t,e,a,o){let s=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!s)throw new Error("Chave de API n\xE3o configurada.");let i=Oe(a.model);if(!N||N.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await _(s)}catch(g){let v=g instanceof Error?g.message:String(g);if(v.includes("inv\xE1lida")||v.includes("n\xE3o autorizada"))throw new Error(v)}let n=Date.now(),r=fe(t,e,a),l=[{text:r}];for(let g of e)l.push({inline_data:{mime_type:g.mediaType,data:g.base64}});let c={system_instruction:{parts:[{text:ge}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:Re}},u=[i,...N?.map(g=>g.id)||[],"gemini-2.5-flash","gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],h=Array.from(new Set(u)).filter(g=>!Z.has(g));h.length===0&&(Z.clear(),h.push(...S.map(g=>g.id)));let p=new Error("Nenhum modelo tentado.");for(let g=0;g<h.length;g++){let v=h[g],x=h[g+1];o?.(`Aguardando resposta da API (${v})...`,"info");let Me=["v1beta","v1"];for(let A of Me){let B=`https://generativelanguage.googleapis.com/${A}/models/${v}:generateContent?key=${encodeURIComponent(s)}`,$=new AbortController,de=setTimeout(()=>$.abort(),35e3);try{let T=await fetch(B,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":s},body:JSON.stringify(c),signal:$.signal});if(clearTimeout(de),!T.ok){let ze=await T.text(),Pe=ve(ze,T.status);if(T.status===404&&A==="v1beta")continue;throw new Error(Pe)}let K=await T.json(),F=K.candidates?.[0];if(!F||!F.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let He=F.content.parts[0].text,w=Be(He);return Array.isArray(w.actions)||(w.actions=[]),Array.isArray(w.warnings)||(w.warnings=[]),typeof w.confidence!="number"&&(w.confidence=.8),w.usedModel=v,w.durationMs=Date.now()-n,w.promptSent=r,w.tokensUsed=K.usageMetadata?.totalTokenCount,v!==i&&o?.(`Resolvido com sucesso pelo fallback '${v}' (${A})!`,"info"),{plan:w,rawUsage:K.usageMetadata,usedModel:v}}catch(T){if(clearTimeout(de),p=T,p.message.includes("inv\xE1lida")||p.message.includes("n\xE3o autorizada"))throw p}}let Le=p.message.includes("429")||p.message.includes("cota"),Ie=p.message.includes("503")||p.message.includes("sobrecarregado");if(p.message.includes("404")&&Z.add(v),x){let A=Le?3500:Ie?2500:900,B=`Modelo '${v}' indispon\xEDvel (${p.message}). Aguardando ${A/1e3}s antes de alternar para '${x}'...`;console.warn(`[EasyQuiz Fallback] ${B}`),o?.(B,"warning"),await new Promise($=>setTimeout($,A))}else console.warn(`[EasyQuiz Fallback] Modelo '${v}' falhou: ${p.message}. Todos os modelos esgotados.`)}throw p}var k=['input:not([type="hidden"])',"textarea","select","button","a",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),V=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,$e=0;function f(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function De(t){if(t==null)return"";if(typeof t=="string")return t;if(typeof t=="number"||typeof t=="boolean")return String(t);if(t instanceof Node)return t.textContent||"";try{if(typeof t?.toString=="function"){let e=t.toString();if(typeof e=="string")return e}}catch{}return""}function m(t,e=500){return De(t).replace(/\s+/g," ").trim().slice(0,e)}function Ne(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${($e+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function L(t){if(!t||!(t instanceof Element))return!1;let e=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",a=m(t.getAttribute?.("aria-label")||t.textContent||t.getAttribute?.("value")||e),o=t.type,s=a.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),i=String(t.getAttribute?.("data-testid")||t.getAttribute?.("data-test-id")||t.getAttribute?.("id")||t.getAttribute?.("href")||"").toLowerCase();return V.test(s)||V.test(a)||o==="submit"||i.includes("next")||i.includes("check")||i.includes("continue")||i.includes("proximo")||i.includes("forward")||!1}function _e(t){let e=t.getAttribute("aria-label");if(e)return m(e);let a=t.getAttribute("aria-labelledby");if(a){let n=a.split(/\s+/).map(r=>document.getElementById(r)?.textContent).filter(Boolean).join(" ");if(n.trim())return m(n)}if("labels"in t&&t.labels){let n=Array.from(t.labels??[]).map(r=>r.textContent).join(" ");if(n.trim())return m(n)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let n=m(o.textContent);if(n)return n}let s=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||s||"";return m(i)}function te(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let s=t.tagName.toLowerCase(),i=["input","textarea","select","button"].includes(s)?s:"other",n=t.getAttribute("role")||"",r=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item"),l=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category"),u=m((r?"draggable":l?"dropzone":"")||o.type||n||i,40),h="";if(o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox")h=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked";else{let x=t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement?t.value:"";h=m(x||t.getAttribute("data-category")||t.textContent||"",2e3)}let p=[];if(a)for(let x of Array.from(a.options).slice(0,80))p.push({value:m(x.value),label:m(x.textContent)});let g=!!(o.required||t.getAttribute("aria-required")==="true"),v=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Ne(t),tag:i,type:u,label:_e(t),name:m(o.name||t.getAttribute("name")||"",180),value:h,options:p,required:g,disabled:v,role:e}}var ye=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function xe(t){if(!f(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(k)).filter(f),o=m(t.innerText,4e3).length;if(o<10||!a.length&&o<60)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),i=Math.max(1,e.width*e.height),n=Math.min(1,i/s),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),c=o>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+c+u-n*20-l*10}function oe(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let s=m(e.innerText,1e4),i=m(a.innerText,1e4),n=e.querySelectorAll(k).length,r=a.querySelectorAll(k).length;if(s.length<150&&i.length>s.length&&r<=n+4){e=a;continue}break}return e}function Ve(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&f(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Ge(){let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(ye);if(s&&xe(s)>0)return oe(s)}let a=Array.from(document.querySelectorAll(ye)).map(s=>({element:s,score:xe(s)})).filter(s=>Number.isFinite(s.score)).sort((s,i)=>i.score-s.score);if(a.length>0&&a[0].score>0)return oe(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&f(o)?o:document.body}function we(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))a.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Qe(t){return Array.from(t.querySelectorAll(k)).filter(e=>{if(!f(e)||L(e))return!1;if(e.tagName.toLowerCase()==="a"){let a=e.getAttribute("role");return!!(a==="button"||a==="radio"||a==="checkbox"||a==="option"||e.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]'))}return!0}).slice(0,100).map(e=>te(e,"answer"))}function ae(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let s of e)for(let i of Array.from(s.querySelectorAll(k)))if(!(a.has(i)||!f(i)||!L(i))&&(a.add(i),o.push(te(i,"navigation")),o.length>=10))return o;return o}function I(t=!1){let e=Ge();e=oe(e),t&&(e=Ve(e));let a=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",o=m(a,16e3),s=Qe(e),i=ae(e);i.length===0&&(i=ae(document.body));let n=[...s,...i].slice(0,120);return!o||n.length===0&&o.length<30?m(document.body.innerText||document.body.textContent||"",16e3).length>=30?C():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:o,htmlSnippet:we(e),controls:n,scope:e}}function C(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=m(t,14e3),a=ae(document.body),o=document.querySelector('main, article, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Leitura/Contexto",questionText:e,htmlSnippet:we(o).slice(0,15e3),controls:a,scope:o}}function E(t){return!!t.closest("#easyquiz-shadow-root, .eq-sidebar, .eq-launcher")}function b(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o&&!E(o))return o;try{if(o=document.querySelector(e),o&&!E(o))return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o&&!E(o))return o}catch{}try{let n=e.replace(/"/g,""),r=`//*[normalize-space(.)="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(r,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let c=l.singleNodeValue;if(!E(c))return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||c}}catch{}let s=m(e).toLowerCase().replace(/['"“”«»]/g,""),i=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of i){if(!f(n)||E(n))continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,""),c=m(n.getAttribute("data-category")).toLowerCase().replace(/['"“”«»]/g,""),u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",h=m(u).toLowerCase(),p=r.startsWith(s+")")||r.startsWith(s+".")||r.startsWith(s+" -")||r.startsWith(s+":");if(r===s||l===s||c&&c===s||h&&h===s||p)return n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li')||n}if(s.length>=3)for(let n of i){if(!f(n)||E(n)||n.children.length>5)continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,"");if(r.includes(s)||l.includes(s))return n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li')||n}return null}function H(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function y(t,e){if(!t)return;try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let r=t.getBoundingClientRect();a=Math.round(r.left+Math.max(1,r.width/2)),o=Math.round(r.top+Math.max(1,r.height/2))}try{t.focus?.()}catch{}let s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};try{t.dispatchEvent(new PointerEvent("pointerdown",{...s,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:1}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}));try{t.dispatchEvent(new PointerEvent("pointerup",{...s,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:0}))}catch{}t.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}));try{let r=new Touch({identifier:Date.now(),target:t,clientX:a,clientY:o,screenX:a,screenY:o,pageX:a+(window.scrollX||0),pageY:o+(window.scrollY||0)});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,composed:!0,touches:[r],targetTouches:[r]})),t.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,composed:!0,touches:[],targetTouches:[]}))}catch{}try{t.click()}catch{}let i=t.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], label');if(i&&i!==t)try{i.click()}catch{}let n=t.querySelector('input[type="radio"], input[type="checkbox"]');if(n&&n!==t)try{n.click()}catch{}}function Ee(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let s=t._valueTracker;s&&s.setValue("")}catch{}let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,H(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,H(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function ne(t,e){let a=t instanceof HTMLInputElement?t:t.querySelector('input[type="checkbox"], input[type="radio"]');if(a&&["checkbox","radio"].includes(a.type)){if(a.checked!==e&&a.click(),a.checked!==e){try{let i=a._valueTracker;i&&i.setValue("")}catch{}Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e),H(a,["input","change"])}return}let o=t.getAttribute("role");if(o==="radio"||o==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(y(t),t.setAttribute("aria-checked",e?"true":"false"),H(t,["input","change"]));return}y(t)}function je(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);H(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function Ue(){let t={};return{dropEffect:"move",effectAllowed:"all",files:[],items:[],types:["text/plain"],clearData:e=>{e?delete t[e]:Object.keys(t).forEach(a=>delete t[a])},getData:e=>t[e]||"",setData:(e,a)=>{t[e]=a},setDragImage:()=>{}}}async function ie(t,e){let a=t.getBoundingClientRect(),o=e.getBoundingClientRect(),s=a.left+a.width/2,i=a.top+a.height/2,n=o.left+o.width/2,r=o.top+o.height/2;y(t,[s,i]),await new Promise(p=>setTimeout(p,120)),y(e,[n,r]);let l=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], ul');l&&l!==e&&y(l),await new Promise(p=>setTimeout(p,100));let c={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:i,button:0,buttons:1};t.dispatchEvent(new PointerEvent("pointerdown",{...c,isPrimary:!0})),t.dispatchEvent(new MouseEvent("mousedown",c));for(let p=1;p<=3;p++){let g=s+(n-s)*(p/3),v=i+(r-i)*(p/3),x={...c,clientX:g,clientY:v};t.dispatchEvent(new PointerEvent("pointermove",{...x,isPrimary:!0})),document.dispatchEvent(new MouseEvent("mousemove",x))}let u={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,button:0,buttons:0};e.dispatchEvent(new PointerEvent("pointerup",{...u,isPrimary:!0})),e.dispatchEvent(new MouseEvent("mouseup",u));let h=Ue();h.setData("text/plain",t.textContent||""),h.setData("text/html",t.outerHTML),t.dispatchEvent(new DragEvent("dragstart",{...c,dataTransfer:h})),e.dispatchEvent(new DragEvent("dragenter",{...u,dataTransfer:h})),e.dispatchEvent(new DragEvent("dragover",{...u,dataTransfer:h})),e.dispatchEvent(new DragEvent("drop",{...u,dataTransfer:h})),t.dispatchEvent(new DragEvent("dragend",{...c,dataTransfer:h}));try{let p=new Touch({identifier:1,target:t,clientX:s,clientY:i}),g=new Touch({identifier:1,target:e,clientX:n,clientY:r});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}}var qe={fill:(t,e)=>{let a=b(t);a?Ee(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=b(t);e?y(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=b(t);a?ne(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=b(t),o=b(e);a&&o?ie(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=b(t),o=b(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await ie(a,o)}};window.$eq=qe;async function Ke(t){if(t.t==="js"){let o=String(t.v||"");try{new Function("$eq","document","window",o)(qe,document,window)}catch(s){console.warn("[EasyQuiz JS Execution]",s)}return}if(t.t==="drag"){let o=b(t.from),s=b(t.to);o&&s?await ie(o,s):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let e=t.id||"",a=b(e);if(!a&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${e}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":a&&Ee(a,String(t.v));break;case"chk":a&&ne(a,!!t.c);break;case"sel":if(a){let s=Array.isArray(t.v)?t.v:[String(t.v)];je(a,s)}break;case"clk":if(a){y(a,t.co);let s=a.querySelector('input[type="radio"], input[type="checkbox"]');s&&!s.checked&&ne(s,!0)}break;case"adv":let o=Te(t.id);if(o){await se(o,1200);let s=t.id||o.textContent?.trim()||"";s&&J(window.location.hostname,{advanceSelector:s}),y(o)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Fe(){let t=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(t)).find(a=>{if(!f(a)||E(a))return!1;let o=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"",s=(a.textContent||o||a.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(s)})||null}function Te(t){if(t){let i=b(t);if(i&&f(i)&&!E(i))return i}try{let i=M(window.location.hostname);if(i.advanceSelector){let n=b(i.advanceSelector);if(n&&f(n)&&!E(n))return n}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(e)).filter(i=>f(i)&&!E(i));for(let i of o)if(L(i))return i;for(let i of o){let n=i instanceof HTMLInputElement||i instanceof HTMLButtonElement?i.value:"",r=(i.textContent||n||i.getAttribute("aria-label")||"").trim();if(V.test(r))return i}let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return s&&f(s)&&!E(s)?s:null}async function se(t,e=1500){let a=Date.now();for(;Date.now()-a<e;){if(!(t.disabled===!0||t.getAttribute("aria-disabled")==="true"||t.classList.contains("disabled")||t.getAttribute("disabled")!==null))return;await new Promise(s=>setTimeout(s,100))}try{t.removeAttribute("disabled"),t.removeAttribute("aria-disabled"),t.classList.remove("disabled"),t.disabled=!1}catch{}}async function Se(t,e){let a=t.actions.filter(i=>i.t!=="adv"),o=t.actions.filter(i=>i.t==="adv");for(let i of a)await Ke(i),i.t==="drag"&&await new Promise(n=>setTimeout(n,380));let s=!1;if(e){if(await new Promise(r=>setTimeout(r,a.length>0?500:200)),t.pageType!=="info"){let r=Fe();r&&f(r)&&(await se(r,1200),y(r),await new Promise(l=>setTimeout(l,800)))}let i=o.length>0?o[0].id:void 0,n=Te(i);if(n){await se(n,1200);let r=i||n.textContent?.trim()||"";r&&J(window.location.hostname,{advanceSelector:r}),y(n),s=!0}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:a.length,advanced:s}}var z=null,P=[];function R(){z&&(z.style.removeProperty("outline"),z.style.removeProperty("outline-offset"),z=null);for(let t of P)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");P=[]}function re(t){R(),z=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function Ae(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let i=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);i&&(i.style.outline="2px solid #00ff88",P.push(i)),n&&(n.style.outline="2px dashed #00e5ff",P.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let s=o.closest('label, [role="listitem"], .answer, .form-check')||o;s.style.outline="2px solid #00ff88",s.style.outlineOffset="2px",s.style.backgroundColor="rgba(0, 255, 136, 0.08)",P.push(s)}}var O=4,Ye=1200,le=12e5;function G(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");e(s.split(",")[1]||"")},o.readAsDataURL(t)})}async function Q(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Ye/Math.max(e,a)),s=Math.max(1,Math.round(e*o)),i=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=s,n.height=i;let r=n.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,s,i),r.drawImage(t,0,0,s,i),new Promise((l,c)=>{n.toBlob(u=>u?l(u):c(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function ke(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,s=`
...
`;var Je=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],We=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],U=class{host;shadow;callbacks;autopilot;initialSettings;isCollapsed=!1;activeTab="autopilot";stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,a){this.initialSettings=e,this.callbacks=a,this.autopilot=new j({onStatusChange:(o,s,i)=>{this.logToConsole(s,i),o==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(o==="advancing"||o==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async()=>{try{return await this.callbacks.onAnalyze()||null}catch{return null}}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
      <style>${Ce}</style>
    ...
    `;let s=this.shadow.querySelector("#eq-rationale-text");s.textContent=e.rationale;let i=this.shadow.querySelector("#eq-actions-list");i.innerHTML="";for(let n of e.actions){let r=document.createElement("div");r.className="eq-action-item";let l="";n.t==="chk"?l=`chk ${n.id} (${n.c})`:n.t==="val"?l=`val "${n.v}" -> ${n.id}`:n.t==="sel"?l=`sel "${Array.isArray(n.v)?n.v.join(","):n.v}" -> ${n.id}`:n.t==="clk"?l=`clk ${n.id}`:n.t==="adv"?l="adv":n.t==="js"?l=`js: ${String(n.v).slice(0,40)}...`:n.t==="drag"&&(l=`drag "${n.from}" -> "${n.to}"`),r.innerHTML=`<span class="eq-action-badge">${n.t.toUpperCase()}</span> <span>${l}</span>`,i.appendChild(r)}if(this.applyBtn.disabled=!a||!e.actions.length,this.inspModel.textContent=e.usedModel||this.initialSettings.model,this.inspLatency.textContent=e.durationMs?`${e.durationMs}ms`:"--",this.inspTokens.textContent=e.tokensUsed?`${e.tokensUsed}`:"--",this.inspPrompt.textContent=e.promptSent||"Prompt n\xE3o registrado para esta requisi\xE7\xE3o.",this.inspRationale.textContent=e.rationale,this.inspActions.innerHTML="",e.actions.length>0)for(let n of e.actions){let r=document.createElement("div");r.className="eq-action-item",r.textContent=JSON.stringify(n),this.inspActions.appendChild(r)}else this.inspActions.innerHTML='<div class="text-muted" style="padding: 4px;">Nenhuma a\xE7\xE3o prescrita pela IA.</div>'}updateModelSelect(e,a){let o=a||this.initialSettings.model||this.modelSelect.value;this.modelSelect.innerHTML="";let s=!1;e.forEach(i=>{let n=i.id===o;n&&(s=!0),this.modelSelect.add(new Option(i.name,i.id,!1,n))}),!s&&o&&this.modelSelect.add(new Option(`Gemini (${o})`,o,!1,!0)),this.modelSelect.value=o}updateSelectedModel(e){Array.from(this.modelSelect.options).some(o=>o.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}applyHostDarkMode(e){let a="eq-host-dark-mode-style",o=document.getElementById(a);if(e){let s=window.getComputedStyle(document.body).backgroundColor;(s.includes("rgba(0, 0, 0, 0)")||s==="transparent")&&(s=window.getComputedStyle(document.documentElement).backgroundColor);let i=s.match(/\d+(\.\d+)?/g);if(i&&i.length>=3&&(i[3]!==void 0?parseFloat(i[3]):1)>.1){let r=parseInt(i[0]),l=parseInt(i[1]),c=parseInt(i[2]);if((r*299+l*587+c*114)/1e3<100)return}o||(o=document.createElement("style"),o.id=a,o.innerHTML=`
        ...
        `,document.head.appendChild(o)),this.host.classList.add("eq-dark-mode-active")}else this.host.classList.remove("eq-dark-mode-active"),o&&o.remove()}destroy(){this.stopStopwatch(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function Ze(){let t=window;if(t.__easyquiz){t.__easyquiz.toggle();return}let e=X(),a=null,o=new U(e,{onAnalyze:()=>s(),onApply:()=>void i(),onDestroy:()=>{R(),delete t.__easyquiz},onSettingsChange:n=>{e=pe(n)}});t.__easyquiz={toggle:()=>o.toggle(),destroy:()=>o.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",n=>{if(n.altKey&&(n.key==="q"||n.key==="Q")){if(n.preventDefault(),!o)return;o.toggle(!0),s()}});async function s(){if(!e.apiKey){o.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),o.toggle(!0);return}o.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),R();try{let n=I(!1);n||(o.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),n=C()),re(n.scope),o.setStatus(`Quest\xE3o localizada (${n.controls.length} controles). Preparando an\xE1lise...`,"info");let r=await ce(n.scope,e.useVision);o.setStatus(r.length>0?`Consultando Gemini (${e.model}) com ${r.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${e.model}) via DOM nativo (modo r\xE1pido)...`,"info");let{plan:l,usedModel:c}=await ee(n,r,e,(u,h)=>{o.setStatus(u,h==="warning"?"info":h)});return l.needsMoreContext&&(o.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n=I(!0),n||(n=C()),re(n.scope),r=await ce(n.scope,e.useVision),o.setStatus(`Reconsultando IA com escopo ampliado (${n.controls.length} controles)...`,"info"),l=(await ee(n,r,e,(h,p)=>{o.setStatus(h,p==="warning"?"info":p)})).plan),l.memoryToStore&&(he(l.memoryToStore),console.log("[EasyQuiz] Mem\xF3ria de sess\xE3o armazenada:",l.memoryToStore)),a=l,Ae(l.actions),o.setPlan(l,!e.dryRun),l.pageType==="conclusion"?o.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success"):l.pageType==="info"?o.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success"):l.pageType==="start"?o.setStatus("In\xEDcio de atividade detectado. Iniciando...","info"):o.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success"),e.autoApply&&!e.dryRun&&await i(),l}catch(n){R();let r=n instanceof Error?n.message:"Falha desconhecida na an\xE1lise.";o.setStatus(r,"error");return}finally{o.setBusy(!1)}}async function i(){if(!a){o.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){o.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let n=a.pageType==="info"||a.pageType==="start",r=(e.autoAdvance||n)&&a.confidence>=e.confidenceThreshold&&!a.needsMoreContext;o.setBusy(!0,"Aplicando respostas no formul\xE1rio...");try{let l=await Se(a,r);o.setStatus(`Sucesso: ${l.applied} resposta(s) preenchida(s)${l.advanced?" e pr\xF3xima quest\xE3o acionada":""}.`,"success")}catch(l){let c=l instanceof Error?l.message:"Falha ao aplicar plano.";o.setStatus(c,"error")}finally{o.setBusy(!1)}}o.toggle(!0)}Ze().catch(t=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",t),window.alert(`EasyQuiz: falha ao iniciar: ${t instanceof Error?t.message:String(t)}`)});})();
