 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8};function G(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ye="easyquiz_settings_v2",Ae="easyquiz_activity_metrics";function Ze(){try{let o=localStorage.getItem(Ye);if(!o){let s=localStorage.getItem("easyquiz_settings_v1");if(s){let i=JSON.parse(s);return{...ie,apiKey:i.apiKey||""}}return{...ie}}let e=JSON.parse(o),t=typeof e.model=="string"&&G(e.model)?e.model:ie.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(s=>typeof s=="string"?s.trim().replace(/^["']|["']$/g,""):"").filter(s=>s.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(a.length===0&&r&&(a=[r]),a.length===0)try{let s=localStorage.getItem("easyquiz_api_keys");if(s){let i=JSON.parse(s);Array.isArray(i)&&(a=i.filter(d=>typeof d=="string"&&d.trim().length>5))}}catch{}return{apiKey:a[0]||r||ie.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:ie.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function Et(){try{localStorage.removeItem(Ye),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(Ae),sessionStorage.removeItem(Ae);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),et()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function $e(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function _e(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...$e(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function wt(o){let e=Ze(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ye,JSON.stringify(r)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var ge=[],Ct=12,_t=1200;function qt(o){let e=o.trim().replace(/\s+/g," ").slice(0,_t);e&&!ge.includes(e)&&(ge.push(e),ge.length>Ct&&(ge=ge.slice(-Ct)))}function ze(){return ge}function et(){ge=[]}function Tt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Ee=Tt();function we(){try{localStorage.removeItem(Ae)}catch{}return Ee}function eo(o){Ee=o;try{let e=JSON.stringify(o);sessionStorage.setItem(Ae,e),localStorage.removeItem(Ae)}catch{}}function St(o){let e=Ee,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],s=n.filter(u=>u.status==="answered"||u.status==="verified").length,i=n.reduce((u,A)=>u+A.durationMs,0),d=s>0?Math.round(i/s):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),i),completedQuestionsCount:s,averageDurationMs:d,records:n};return eo(l),l}function qe(){Ee=Tt();try{sessionStorage.removeItem(Ae),localStorage.removeItem(Ae)}catch{}return Ee}var Lt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Te(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(h=>h.type==="draggable"||h.type==="dropzone"),r=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),s=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(h=>h.role==="answer").length===0),i=o.controls.filter(h=>h.role!=="navigation").length===0,d=i||a||n||s||r&&o.questionText.length<60,l=i?4500:s?6e3:1800,u=d?`
[HTML]:
${o.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",A="";if(i&&typeof document<"u")try{let h=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(v=>{let y=v,w=y.getBoundingClientRect?.()||{width:0,height:0};return w.width>0&&w.height>0&&!y.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(v=>{let y=v,w=y.tagName.toLowerCase(),q=y.id?`#${y.id}`:"",k=y.className&&typeof y.className=="string"?`.${y.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",T=(y.textContent||y.value||y.getAttribute("aria-label")||"").trim().slice(0,60),x=y.getAttribute("type")||y.getAttribute("role")||"";return`${w}${q}${k}[${x}] txt="${T}"`});h.length>0&&(A=`
[DOM-INTERATIVO]:
${h.join(`
`)}`)}catch{}let c=ze(),m=c.length>0?`
[MEM\xD3RIA]:
${c.join(" | ")}
`:"",p=o.controls.filter(h=>h.role!=="navigation"),g=o.controls.filter(h=>h.role==="navigation"),b=to(o.sourceUrl,o.htmlSnippet),f=b?`
${b}
`:"";return`--- AN\xC1LISE ---
[MODO]: ${t.engine} | Dica: ${t.modeHint||"Auto"}
[URL]: ${o.sourceUrl}
[P\xC1GINA]: ${o.pageTitle}${m}${f}
[DADOS]
[TEXTO]:
${o.questionText}${u}${A}

[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let h=p.filter(E=>E.type==="checkbox"||E.type==="chk"),v=new Set(p.filter(E=>E.type==="radio").map(E=>E.name).filter(Boolean)),y=h.filter(E=>!E.name||!v.has(E.name)),w=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),q=y.length>=2||w,k=v.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&v.size>=1,T=p.every(E=>E.type==="radio"||E.type==="chk")&&v.size===1&&!q&&!k,x=p.filter(E=>E.type==="text"||E.type==="number"||E.type==="val"||E.tag==="input"||E.tag==="textarea"),L=x.length>=2;return(k?`[GRADE VERDADEIRO/FALSO (${v.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${v.size} afirma\xE7\xF5es \u2014 emita ${v.size} a\xE7\xF5es chk separadas + adv]
`:q?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:T?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:L?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${x.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${x.length} campos abaixo com seu id exato]
...
`;function Kt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=wo,document.head.appendChild(o)}}catch{}}function me(){ae&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset"),ae.style.removeProperty("position"),ae=null);for(let o of ve)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ve=[];for(let o of ft)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");ft=[];for(let o of ht)try{o.remove()}catch{}ht=[],pe&&typeof window<"u"&&(window.removeEventListener("scroll",pe),window.removeEventListener("resize",pe),pe=null);for(let o of gt)try{o.remove()}catch{}if(gt=[],ne){try{ne.remove()}catch{}ne=null}}function At(o){Kt();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),ft.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,s=r.height||t.offsetHeight||200;if(n>10&&s>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(d),document.body.appendChild(i),ht.push(i),gt.push(d),e.push({element:t,frame:i})}}catch{}}e.length>0&&!pe&&typeof window<"u"&&(pe=()=>{for(let t of e)try{let a=t.element.getBoundingClientRect();a.width>0&&a.height>0&&(t.frame.style.top=`${a.top+window.scrollY-3}px`,t.frame.style.left=`${a.left+window.scrollX-3}px`,t.frame.style.width=`${a.width+6}px`,t.frame.style.height=`${a.height+6}px`)}catch{}},window.addEventListener("scroll",pe,{passive:!0}),window.addEventListener("resize",pe,{passive:!0}))}function He(o){ae&&ae!==o&&(ae.style.removeProperty("outline"),ae.style.removeProperty("outline-offset")),Kt(),ae=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(ne){try{ne.remove()}catch{}ne=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),ne=t}catch{}}function qo(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Jt(o,e){if(ne){try{ne.remove()}catch{}ne=null}let t=qo(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let m=P(a.from),p=P(a.to);m&&(m.style.outline=`2px solid ${t.outline}`,ve.push(m)),p&&(p.style.outline="2px dashed #00e5ff",ve.push(p))}catch{}continue}let r=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=String(a.name??a.n??"").trim(),s=null;if(n){let m=Array.from(document.querySelectorAll(`input[name="${B(n)}"]`));if(r&&(s=m.find(p=>p.value?.toLowerCase()===r.toLowerCase())??null,!s)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(r),g=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(r);if(p||g){let b=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];s=m.find(f=>{let h=f.value?.toLowerCase()??"";if(b.includes(h))return!0;let y=(f.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return b.some(w=>y===w||y.startsWith(w+" ")||y.startsWith("("+w+")"))})??null}}!s&&m.length>0&&(s=m[0])}if(!s&&a.id&&(s=P(a.id,r,a.t==="val"||a.t==="sel")||P(C(a.id),r,a.t==="val"||a.t==="sel")),!s&&a.t==="sel"){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(f=>I(f)&&!ce(f)),g=C(a.id).toLowerCase();s=p.find(f=>{let h=(f.id||"").toLowerCase(),v=(f.getAttribute("name")||"").toLowerCase(),y=(f.getAttribute("aria-label")||"").toLowerCase(),w=C(f.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return h.includes(g)||v.includes(g)||y.includes(g)||g.length>=2&&w.includes(g)})||(p.length===1?p[0]:null)}if(!s)continue;let i=typeof HTMLSelectElement<"u"&&s instanceof HTMLSelectElement||s.tagName?.toLowerCase()==="select"||s.getAttribute("role")==="combobox"||s.getAttribute("role")==="listbox",d=s.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?s.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=d||l||s;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),ve.push(u);let A=i?s:u.querySelector('select, [role="combobox"], [role="listbox"]');A&&(A.style.outline=`2px solid ${t.outline}`,A.style.outlineOffset="2px",A.style.boxShadow=`0 0 10px ${t.glow}`,A.setAttribute("data-easyquiz-highlight","true"),ve.push(A));let c=s instanceof HTMLInputElement&&["checkbox","radio"].includes(s.type)?s:u.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==u&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ve.push(c))}}var bt=10,To=1400,Pe=15e5;function le(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let r=String(a.result||"");e(r.split(",")[1]||"")},a.readAsDataURL(o)})}async function ye(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,To/Math.max(e,t)),r=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),s=document.createElement("canvas");s.width=r,s.height=n;let i=s.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,r,n),i.drawImage(o,0,0,r,n),new Promise((d,l)=>{s.toBlob(u=>u?d(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Wt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,r=2,n=Math.min(1800,Math.max(120,Math.round(t*r))),s=Math.min(1800,Math.max(100,Math.round(a*r))),i=o.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(n)),i.setAttribute("height",String(s)),!i.getAttribute("viewBox")&&t>0&&a>0&&i.setAttribute("viewBox",`0 0 ${t} ${a}`);try{let c=Array.from(o.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,m.length);p++){let g=c[p],b=m[p];if(!g||!b||!b.style)continue;let f=window.getComputedStyle?window.getComputedStyle(g):null;f&&(f.fill&&f.fill!=="none"&&(b.style.fill=f.fill),f.stroke&&f.stroke!=="none"&&(b.style.stroke=f.stroke),f.strokeWidth&&(b.style.strokeWidth=f.strokeWidth),f.fontFamily&&(b.style.fontFamily=f.fontFamily),f.fontSize&&(b.style.fontSize=f.fontSize),f.fontWeight&&(b.style.fontWeight=f.fontWeight),f.color&&(b.style.color=f.color))}}catch{}let d="#ffffff";try{let c=o.parentElement||o;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){d=p;break}c=c.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),A="";try{A=btoa(unescape(encodeURIComponent(u)))}catch{}try{let c=b=>new Promise((f,h)=>{let v=new Image,y=setTimeout(()=>h(new Error("Timeout render SVG")),1200);v.onload=()=>{clearTimeout(y),f(v)},v.onerror=()=>{clearTimeout(y),h(new Error("Falha ao renderizar SVG em Image."))},v.src=b}),m=null;if(A)try{m=await c(`data:image/svg+xml;base64,${A}`)}catch{}if(!m){let b=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),f=URL.createObjectURL(b);try{m=await c(f)}finally{URL.revokeObjectURL(f)}}let p=document.createElement("canvas");p.width=n,p.height=s;let g=p.getContext("2d",{alpha:!1});if(g&&m){g.fillStyle=d,g.fillRect(0,0,n,s),g.drawImage(m,0,0,n,s);let b=await new Promise(f=>{p.toBlob(f,"image/jpeg",.92)});if(b){let f=await le(b);if(f)return{blob:b,base64:f,mediaType:"image/jpeg"}}}}catch{}return{base64:A,mediaType:"image/svg+xml"}}async function vt(o){try{let e=o.getBoundingClientRect(),t=Math.round(e.width)||o.offsetWidth||400,a=Math.round(e.height)||o.offsetHeight||300;if(t<30||a<30)return null;let r=o.tagName.toLowerCase()==="svg"?o:o.querySelector("svg");if(r&&o.querySelectorAll("input, select, textarea").length===0)try{let g=await Wt(r);if(g.base64&&g.base64.length<=Pe)return{mediaType:g.mediaType,base64:g.base64,alt:o.getAttribute("aria-label")||r.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:fe(r)}}catch{}if(o instanceof HTMLCanvasElement)try{let g=await ye(o),b=await le(g);if(b)return{mediaType:"image/jpeg",base64:b,alt:o.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let n="#ffffff";try{let g=o;for(;g&&g!==document.documentElement;){let f=(window.getComputedStyle?window.getComputedStyle(g):null)?.backgroundColor;if(f&&f!=="transparent"&&f!=="rgba(0, 0, 0, 0)"){n=f;break}g=g.parentElement}}catch{}let s=o.cloneNode(!0),i=Array.from(o.querySelectorAll("*")),d=Array.from(s.querySelectorAll("*"));for(let g=0;g<Math.min(i.length,d.length);g++){let b=i[g],f=d[g];if(!(!b||!f||!f.style))try{let h=window.getComputedStyle(b);f.style.color=h.color,f.style.backgroundColor=h.backgroundColor,f.style.borderColor=h.borderColor,f.style.borderWidth=h.borderWidth,f.style.borderStyle=h.borderStyle,f.style.fontSize=h.fontSize,f.style.fontFamily=h.fontFamily,f.style.fontWeight=h.fontWeight,f.style.lineHeight=h.lineHeight,f.style.letterSpacing=h.letterSpacing,f.style.textAlign=h.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,a))),u=Math.round(t*l),A=Math.round(a*l),c=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let s=this.element.querySelector("#eq-fah-header");this.setupDraggable(s)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=i=>{if(!this.isDragging||!this.element)return;let d=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),A=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),A);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},s=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",s)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",s)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),s=r.actions.filter(m=>{if(m.t!=="val")return!1;let p=C(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=r.actions.filter(m=>m.t==="sel"),l=n.length||s.length||i.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let A=document.createElement("span");A.textContent=`Modo: ${r.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(A,c),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let p of n){let g=C(p.to)||"Geral";m[g]||(m[g]=[]),m[g].push(C(p.from))}for(let[p,g]of Object.entries(m)){let b=document.createElement("div"),f=/fato|true|verdadeiro|sim/i.test(p),h=/opini[aã]o|false|falso|n[aã]o/i.test(p);b.className=`eq-fah-group ${f?"group-fato":h?"group-opiniao":""}`;let v=document.createElement("div");v.className="eq-fah-group-title",v.textContent=`\u{1F4C1} ${p} (${g.length})`,b.appendChild(v);let y=document.createElement("div");y.className="eq-fah-group-items";for(let w of g){let q=document.createElement("div");q.className="eq-fah-item";let k=document.createElement("span");k.className="eq-fah-item-text",k.textContent=w,q.appendChild(k);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(w),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),q.appendChild(T),y.appendChild(q)}b.appendChild(y),e.appendChild(b)}}else if(s.length>0){t.textContent=`Preenchimento (${s.length} campos)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let g=document.createElement("div");g.className="eq-fah-group-items";for(let b=0;b<s.length;b++){let f=s[b],h=document.createElement("div");h.className="eq-fah-item";let v=Me(f.id);(!v||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(v))&&(v=`Campo ${b+1}`);let y=String(f.v??""),w=document.createElement("div");w.className="eq-fah-field-box";let q=document.createElement("div");q.className="eq-fah-field-label",q.textContent=v,w.appendChild(q);let k=document.createElement("div");k.className="eq-fah-field-val",k.textContent=y,w.appendChild(k),h.appendChild(w);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(y),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),h.appendChild(T),g.appendChild(h)}m.appendChild(g),e.appendChild(m)}else if(i.length>0){t.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let g=document.createElement("div");g.className="eq-fah-group-items";for(let b=0;b<i.length;b++){let f=i[b],h=document.createElement("div");h.className="eq-fah-item";let v=Me(f.id);(!v||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(v))&&f.v&&(v=String(f.v)),v=C(v),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(v)&&(v="");let y="",w=v.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);w?(y=w[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),v=w[2].trim()||v):i.length>1&&(y=String.fromCharCode(65+b));let q=document.createElement("div");if(q.style.display="flex",q.style.alignItems="center",q.style.gap="8px",q.style.flex="1",y){let x=document.createElement("span");x.className="eq-fah-letter-badge",x.textContent=y,q.appendChild(x)}let k=document.createElement("span");k.className="eq-fah-item-text",k.textContent=v||(y?`Alternativa ${y}`:"Alternativa Selecionada"),q.appendChild(k),h.appendChild(q);let T=document.createElement("button");T.className="eq-fah-copy-inline",T.textContent="Copiar",T.addEventListener("click",()=>{navigator.clipboard.writeText(v||y),T.textContent="\u2713 Copiado",setTimeout(()=>T.textContent="Copiar",1200)}),h.appendChild(T),g.appendChild(h)}m.appendChild(g),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,a.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let g=document.createElement("div");g.className="eq-fah-group-items";for(let b=0;b<d.length;b++){let f=d[b],h=document.createElement("div");h.className="eq-fah-item";let v=Me(f.id);(!v||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(v))&&(v=`Lista ${b+1}`);let q=(Array.isArray(f.v)?f.v:[String(f.v??"")]).map(S=>{let E=P(f.id,void 0,!0)||P(C(f.id),void 0,!0),H=E instanceof HTMLSelectElement?E:E?.querySelector("select");if(H){let O=C(S).toLowerCase();for(let V=0;V<H.options.length;V++){let N=H.options[V];if(N.value.toLowerCase()===O||C(N.textContent).toLowerCase()===O){let j=C(N.textContent);if(j&&!j.toLowerCase().includes("selecione"))return j}}}return S}).join(", "),k=document.createElement("div");k.className="eq-fah-field-box";let T=document.createElement("div");T.className="eq-fah-field-label",T.textContent=v,k.appendChild(T);let x=document.createElement("div");x.className="eq-fah-field-val",x.textContent=q,k.appendChild(x),h.appendChild(k);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(q),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),h.appendChild(L),g.appendChild(h)}m.appendChild(g),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(i=>i.t==="drag"),r=e.actions.filter(i=>i.t==="val"),n=e.actions.filter(i=>i.t==="clk"||i.t==="chk"),s=e.actions.filter(i=>i.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let d of a){let l=C(d.to)||"Geral";i[l]||(i[l]=[]),i[l].push(C(d.from))}for(let[d,l]of Object.entries(i)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of r){let d=C(i.id);t.push(`- **${d||"Campo"}:** \`${i.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let i=0;i<n.length;i++){let d=n[i],l=Me(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=C(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=n.length>1?`${String.fromCharCode(65+i)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}t.push("")}else if(s.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of s){let d=C(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`;var Ge="v2.4.9";var Zt=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function Ho(o,e){try{if(Zt){o.innerHTML=Zt.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var Po=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],zo=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],We=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new Ke({onStatusChange:(i,d,l)=>{this.logToConsole(d,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),d.includes("conclus\xE3o")||d.includes("finalizada")||d.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda com sucesso! Autopilot finalizado.","success"):this.setStatus("Autopilot desativado.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,d)=>{try{return await this.callbacks.onAnalyze(i,d,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Ho(this.shadow,`
          ...
          <nav class="eq-activity-bar" role="tablist" aria-label="Atalhos">
            <div class="eq-activity-top">
              ...
              <button class="eq-activity-btn" id="eq-tab-media" role="tab" title="M\xEDdias & Imagens (Capturas enviadas \xE0 IA e Interpreta\xE7\xF5es)">
                <span class="eq-activity-indicator"></span>
                <span class="eq-activity-icon">${M.image}</span>
              </button>
          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                ...
                <span class="eq-brand-version">${Ge}</span>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-operation-actions">
                  <button class="eq-btn-primary" id="eq-analyze-btn" type="button">${M.analyze} Analisar quest\xE3o</button>
                  <button class="eq-btn-secondary" id="eq-apply-btn" type="button">${M.apply} Aplicar respostas</button>
                </div>

                <div style="display: flex; gap: 8px; width: 100%; align-items: center;">
                  <button class="eq-btn-primary" id="eq-ap-toggle-btn" type="button" style="flex: 1;">
                    ${M.play} INICIAR AUTOPILOT
                  </button>
                </div>
                ...
                <div class="eq-footer-note" style="margin-top: auto;">${Ge} \u2022 H\xEDbrido 4.0 (RAG + AST + Vision)</div>
              </div>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap"),this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn.disabled=!0,this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new Je(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),xe.filter(i=>G(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===e.model))),Po.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===e.modeHint))),zo.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let r=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];z.init(r),this.apiKeyInput.value=z.getBestKey()||e.apiKey||"",this.renderKeysList();let n=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof n?.unref=="function"&&n.unref();let s=z.getBestKey()||e.apiKey;s&&De(s).then(i=>{i&&i.length>0&&this.updateModelSelect(i,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","media","metrics","debug","settings"];for(let a of t){let r=this.shadow.querySelector(`#eq-tab-${a}`),n=this.shadow.querySelector(`#eq-view-${a}`);a===e?(r?.classList.add("active"),n&&(n.style.display="flex")):(r?.classList.remove("active"),n&&(n.style.display="none"))}e==="brain"?(this.renderContextTree(),this.refreshInspectorView()):e==="media"?this.renderMediaTab():e==="metrics"?this.updateTimingMetrics():e==="debug"&&(this.refreshDebugView(),this.renderTerminalEntries())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-media")?.addEventListener("click",()=>this.switchTab("media")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.metricsResetBtn?.addEventListener("click",()=>{qe(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let e=this.shadow.querySelector("#eq-dbg-scroll-toggle");e?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,e&&(e.style.color=this.autoScrollLogs?"#00ffcc":"#858585",e.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let f=this.getFormattedLogs();navigator.clipboard.writeText(f).then(()=>{let h=t.innerHTML;t.innerHTML=M.check,setTimeout(()=>t.innerHTML=h,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let a=this.shadow.querySelector("#eq-dbg-copy-prompt");a?.addEventListener("click",()=>{let f=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(f).then(()=>{let h=a.innerHTML;a.innerHTML=`${M.check} Copiado!`,setTimeout(()=>a.innerHTML=h,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-context");r?.addEventListener("click",()=>{let f=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let h=r.innerHTML;r.innerHTML=`${M.check} Copiado!`,setTimeout(()=>r.innerHTML=h,1800)})});let n=this.shadow.querySelector("#eq-dbg-copy-raw-resp");n?.addEventListener("click",()=>{let f=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let h=n.innerHTML;n.innerHTML=`${M.check} Copiado!`,setTimeout(()=>n.innerHTML=h,1800)})});let s=this.shadow.querySelector("#eq-dbg-copy-error-btn");s?.addEventListener("click",()=>{let f=this.lastErrorMsg||"";navigator.clipboard.writeText(f).then(()=>{let h=s.innerHTML;s.innerHTML=M.check,setTimeout(()=>s.innerHTML=h,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),this.shadow.querySelector("#eq-min-btn")?.addEventListener("click",()=>this.toggle(!1)),this.shadow.querySelector("#eq-close-btn")?.addEventListener("click",()=>this.toggle(!1)),window.addEventListener("keydown",f=>{f.altKey&&(f.key==="q"||f.key==="Q"||f.key==="a"||f.key==="A")&&(f.preventDefault(),this.toggle())},!0);let i=f=>{let h=f.composedPath();h.includes(this.shadow)||(h.includes(this.sidebarEl)||h.includes(this.host))&&f.stopImmediatePropagation()};window.addEventListener("keydown",i,!0),window.addEventListener("keyup",i,!0),window.addEventListener("keypress",i,!0),this.apiKeyInput.addEventListener("input",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:f})});let d=this.shadow.querySelector("#eq-keys-collapsible"),l=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),A=f=>{d&&(f?(d.style.display="none",l&&(l.style.transform="rotate(0deg)")):(d.style.display="block",d.style.maxHeight="none",d.style.overflow="visible",l&&(l.style.transform="rotate(90deg)")))},c=!1;try{c=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}A(c),u?.addEventListener("click",f=>{if(f.target?.closest("a"))return;let h=d?.style.display==="none";A(!h);try{localStorage.setItem("easyquiz_keys_collapsed",h?"false":"true")}catch{}}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!f){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let h=z.addKey(f);if(h.ok){let v=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${v.length} chaves ativas no pool)`,"success"),A(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Ne(f).then(y=>{y.ok?(z.markSuccess(f,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(z.markInvalid(f,y.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${y.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(h.message,"warning")}),this.keyMoreBtn.addEventListener("click",f=>{f.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",f=>{let h=f.target;!h.closest("#eq-key-context-menu")&&!h.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(f!==null&&f.trim()){let h=f.trim().replace(/^["']|["']$/g,""),v=z.addKey(h);if(v.ok){let y=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:y[0],apiKeys:y}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(v.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let f=await navigator.clipboard.readText();if(f){let h=f.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=h,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let f=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(f!==null&&f.trim()){let h=f.trim().replace(/^["']|["']$/g,"");if(z.addKey(h).ok){let y=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:y[0],apiKeys:y}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=this.apiKeyInput.type==="password";this.apiKeyInput.type=f?"text":"password";let h=this.shadow.querySelector("#eq-menu-vis-icon"),v=this.shadow.querySelector("#eq-menu-vis-text");h&&(h.innerHTML=f?M.eyeOff:M.eye),v&&(v.textContent=f?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let f=document.createElement("div");f.id="eq-bulk-overlay",f.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let h=document.createElement("div");h.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),h.innerHTML=`
      ...
      `,f.appendChild(h),this.shadow.appendChild(f);let v=h.querySelector("#eq-bulk-ta"),y=h.querySelector("#eq-bulk-status"),w=h.querySelector("#eq-bulk-import"),q=h.querySelector("#eq-bulk-paste-btn"),k=h.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>v?.focus());let T=()=>{f.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(x=>{f.addEventListener(x,L=>{L.stopPropagation(),L.stopImmediatePropagation()},!0)}),f.addEventListener("keydown",x=>{x.key==="Escape"&&T()}),f.addEventListener("click",x=>{x.target===f&&T()}),h.querySelector("#eq-bulk-x")?.addEventListener("click",T),h.querySelector("#eq-bulk-cancel")?.addEventListener("click",T),k.addEventListener("click",()=>{v.value="",y.textContent="",v.focus()}),q.addEventListener("click",async()=>{try{let x=await navigator.clipboard?.readText();x?(v.value=x,v.focus(),y.style.color="#38bdf8",y.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(y.style.color="#fbbf24",y.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{y.style.color="#fbbf24",y.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",v.focus()}}),h.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let x=v.value.trim();if(!x){y.style.color="#f87171",y.textContent="Insira pelo menos uma chave de API antes de importar.";return}let L=x.match(/AIza[0-9A-Za-z\-_]{35}/g),S=[];if(L&&L.length>0?S=Array.from(new Set(L)):S=Array.from(new Set(x.split(/[\n,;\s]+/).map(j=>j.trim().replace(/^["'`]|["'`]$/g,"")).filter(j=>j.length>=20))),S.length===0){y.style.color="#f87171",y.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}y.style.color="#00e5ff",y.textContent=`Processando ${S.length} chave(s)...`,w.disabled=!0,w.style.opacity="0.6";let E=0,H=0;for(let j of S){let U=z.addKey(j);U.ok?E++:U.message.includes("j\xE1 est\xE1 cadastrada")&&H++}if(E>0){let j=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:j[0],apiKeys:j}),A(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}y.textContent=`${E} adicionada(s), ${H} duplicada(s). Validando modelo em paralelo...`;let O=z.exportRawKeys(),V=this.modelSelect?.value||"gemini-3.5-flash-lite",N=await nt(V,O);N.ok?(z.markSuccess(N.key,200),y.style.color="#4ade80",y.textContent=` ${E} adicionada(s), ${H} duplicada(s). Modelo '${N.model}' pronto!`):(y.style.color="#fbbf24",y.textContent=`${E} adicionada(s), ${H} duplicada(s). Aviso: ${N.message}`),this.renderKeysList(),w.disabled=!1,w.style.opacity="1",E>0&&(this.setStatus(` Lote importado: ${E} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(T,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let f=z.exportRawKeys(),h=document.createElement("div");h.id="eq-text-editor-overlay",h.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let v=document.createElement("div");v.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),v.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
...
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let a=t?`[${t}] ${e}`:e;this.setLastError(a)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,a=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let r=e?.promptTokens!==void 0?String(e.promptTokens):"--",n=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${r} / ${n}`,this.dbgSplitTokens.title=`Prompt: ${r} tokens | Resposta: ${n} tokens`}if(this.dbgTotalTokens){let r=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=r!==void 0?`${r}`:"--"}if(this.dbgPromptLen){let r=a.length,n=Math.round(r/4);this.dbgPromptLen.textContent=`${r} chars (~${n} tokens est.)`}if(this.dbgPromptView&&(this.dbgPromptView.textContent=a||"Nenhum prompt enviado at\xE9 o momento."),this.dbgContextView)if(t){let r={scope:`${t.scope.tagName.toLowerCase()}${t.scope.id?"#"+t.scope.id:""}${t.scope.className?"."+t.scope.className.split(" ").join("."):""}`,questionLength:t.questionText.length,questionSnippet:t.questionText.slice(0,150)+(t.questionText.length>150?"...":""),controlsCount:t.controls.length,controls:t.controls.map((n,s)=>({index:s+1,tag:n.tag,type:n.type,name:n.name||void 0,id:n.id||void 0,value:n.value||void 0,label:n.label||void 0,role:n.role}))};this.dbgContextView.textContent=JSON.stringify(r,null,2)}else this.dbgContextView.textContent="Aguardando captura de contexto pelo EasyQuiz...";this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let a=new Date,r=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}:${String(a.getSeconds()).padStart(2,"0")}.${String(Math.floor(a.getMilliseconds()/100))}`,n=e;e.startsWith(">")?n=`> [${r}] ${e.slice(1).trim()}`:n=`[${r}] ${e}`;let s="all";t==="text-red"||n.includes("[ERRO]")||n.includes("Falha")||n.includes("Error")?s="error":n.includes("[IA]")||n.includes("[RAG]")||n.includes("Tokens")||n.includes("Gemini")||n.includes("Modelo:")?s="ai":(n.includes("[DOM]")||n.includes("[EXEC]")||n.includes("[VERIF]")||n.includes("[NAV]"))&&(s="dom");let i={id:Date.now()+Math.random(),timestamp:r,message:n,colorClass:t,category:s};for(this.logEntries.push(i);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),s==="error"&&this.setLastError(n),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===s)){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.liveDebugTerminal.appendChild(d);this.liveDebugTerminal.children.length>250;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.apConsole.appendChild(d),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.executionConsole.appendChild(d),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let a=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${a}%`,this.progressVal&&(this.progressVal.textContent=`${a}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),a>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions,this.renderMediaTab())),this.activeTab==="brain"?(this.renderContextTree(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&this.renderContextTree(),(this.activeTab==="media"||e.length>0)&&this.renderMediaTab()}renderMediaTab(){let e=this.shadow?.querySelector("#eq-media-grid"),t=this.shadow?.querySelector("#eq-media-count-badge");if(!e)return;let a=this.latestImages,r=this.latestImageDescriptions;if(t&&(t.textContent=`${a.length} m\xEDdias`),a.length===0){e.innerHTML=`
        ...
        </div>`;c.innerHTML=p+b,e.appendChild(c)})}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=ze(),a=this.latestPlan;this.contextTreeContainer.innerHTML="";let r=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(r);let n=e?e.controls:[],s=n.map((p,g)=>{let b=p.role==="navigation"||p.type==="button",f=!b&&p.value?` [val: "${p.value}"]`:"";return{label:`[#${g+1}] ${p.type.toUpperCase()}`,value:`${p.label||p.id||p.name||"(Sem r\xF3tulo)"}${f}`.trim(),badge:b?"Navega\xE7\xE3o":p.role||p.type}}),i=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${n.length})`,n.length>0,s);this.contextTreeContainer.appendChild(i);let d=t.map((p,g)=>({label:`Mem\xF3ria #${g+1}`,value:p,badge:"RAG"})),l=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,d);if(this.contextTreeContainer.appendChild(l),a){let p=this.createTreeFolder(` \xDALTIMO PLANO IA (${a.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:a.pageType,badge:`${(a.confidence*100).toFixed(0)}%`},{label:"Modo",value:a.mode},{label:"Racioc\xEDnio",value:a.rationale||"N/A"},...a.actions.map((g,b)=>({label:`A\xE7\xE3o #${b+1} (${g.t})`,value:JSON.stringify(g)}))]);this.contextTreeContainer.appendChild(p)}let u=this.latestImages,A=this.latestImageDescriptions,c=u.map((p,g)=>{let b=A.find(w=>w.index===g),f=(p.captureStatus==="captured"||p.captureStatus==="text_only",""),h=p.captureStatus==="captured"?"Visual":p.captureStatus==="text_only"?"Texto":"Falhou",v=b?b.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",y=b?b.description:p.textContext?p.textContext:"Aguardando an\xE1lise IA...";return{label:`${f} Img ${g+1} [${h}]`,value:`${y}`,badge:v,imgSrc:p.base64?`data:${p.mediaType||"image/jpeg"};base64,${p.base64}`:void 0}}),m=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${u.length})`,!0,c);this.contextTreeContainer.appendChild(m)}createTreeFolder(e,t,a){let r=document.createElement("div");r.className="eq-tree-node";let n=document.createElement("div");n.className="eq-tree-header",n.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let s=document.createElement("div");if(s.className="eq-tree-content",s.style.display=t?"flex":"none",a.length===0)s.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let i of a){let d=document.createElement("div");d.className="eq-tree-leaf";let l="";i.imgSrc&&i.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${i.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),d.innerHTML=`
...
`)).then(()=>{if(this.metricsCopyBtn){let a=this.metricsCopyBtn.innerHTML;this.metricsCopyBtn.innerHTML=" Copiado!",setTimeout(()=>{this.metricsCopyBtn.innerHTML=a},1500)}})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Oo(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Do(){let o=window;if(qe(),Oo(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=Ze(),t=null,a=null,r=0,n=new We(e,{onAnalyze:(l=1,u,A=!1)=>s(l,u,A),onApply:(l=1)=>void i(l),onDestroy:()=>{if(a){try{a.abort()}catch{}a=null}me(),delete o.__easyquiz},onCancel:()=>{if(a){try{a.abort()}catch{}a=null}me(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=wt(l)}});o.__easyquiz={toggle:()=>n.toggle(),destroy:()=>n.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!n)return;n.toggle(!0),s()}});async function s(l=1,u,A=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){n.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),n.toggle(!0);return}if(a)try{a.abort()}catch{}a=new AbortController;let c=a,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){n.setBusy(!1),n.setProgress(0);return}r=Date.now(),n.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),n.setProgress(20,"Varrendo escopo do DOM e controles..."),me(),n.hideFloatingAnswers();try{let p=de(!1);p||(n.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=re()),He(p.scope),n.updateContext(p),n.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),n.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),n.setProgress(40,`Consultando Gemini (${e.model})...`);let g=await yt(p.scope,e.useVision);if(g.length>0){let w=g.map(q=>q.element).filter(Boolean);At(w),n.updateImages(g)}if(c.signal.aborted)return;let b=e.model;n.setStatus(g.length>0?`Consultando Gemini (${b}) com ${g.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let f=Te(p,g,e);n.setInspectorPrompt(f,e.model);let h=(w,q)=>{n.setStatus(w,q==="warning"?"info":q);let k=w.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(k){let T=k[1].split(",")[0].trim();n.setProgress(50,`Gemini ${T} respondendo...`)}},{plan:v,usedModel:y}=await Re(p,g,e,h,c.signal);if(c.signal.aborted)return;if(v.needsMoreContext){if(n.setProgress(55,"Ampliando escopo da quest\xE3o..."),n.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=de(!0),p||(p=re()),He(p.scope),n.updateContext(p),g=await yt(p.scope,e.useVision),g.length>0){let k=g.map(T=>T.element).filter(Boolean);At(k),n.updateImages(g)}n.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let w=Te(p,g,e);n.setInspectorPrompt(w,e.model),v=(await Re(p,g,e,h,c.signal)).plan}if(c.signal.aborted)return;if(n.setProgress(70,"Resposta recebida da IA! Processando plano..."),n.logToConsole(`> [IA] Modelo: ${y||e.model} | Modo: ${v.mode} | Confian\xE7a: ${(v.confidence*100).toFixed(0)}%`,"text-green"),v.rationale&&n.logToConsole(`> [IA] Racioc\xEDnio: "${v.rationale}"`,"text-blue"),n.logToConsole(`> [IA] ${v.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),v.memoryToStore&&(qt(v.memoryToStore),n.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${v.memoryToStore}"`,"text-yellow")),v.imageDescriptions&&v.imageDescriptions.length>0){n.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${v.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let w of v.imageDescriptions){let q=w.relevant?"":"\uFE0F";n.logToConsole(`>   ${q} Imagem ${w.index+1} [${w.relevant?"RELEVANTE":"IGNORADA"}]: ${w.description}`,w.relevant?"text-blue":"text-yellow")}}return t=v,n.updateContext(p,v),Jt(v.actions,v.confidence),n.setPlan(v,!e.dryRun),v.pageType==="conclusion"?(n.setProgress(100,"Atividade conclu\xEDda!"),n.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):v.pageType==="info"?(n.setProgress(100,"Contexto absorvido na mem\xF3ria!"),n.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):v.pageType==="start"?(n.setProgress(100,"In\xEDcio detectado!"),n.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(n.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),n.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&v.pageType==="question"&&n.showFloatingAnswers(v),c.signal.aborted?void 0:((A||e.autoApply)&&!e.dryRun&&await i(l,c.signal,A),v)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){me(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}me(),n.setProgress(0);let g=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";n.setStatus(g,"error"),n.setErrorDiagnostic(g,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),a===c&&(a=null),c.signal.aborted||n.setBusy(!1)}}async function i(l=1,u,A=!1){if(u?.aborted)return;if(!t){n.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){n.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(b=>b.t!=="adv"),p=t.pageType==="question"||je(t.rationale||"");if(p&&m.length===0){n.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let g=(A||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);n.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),n.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),n.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await Ie(t,g,l,be(e));if(u?.aborted)return;if(n.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){n.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let w of b.failedActions){let q=w.action,k=q.t==="drag"?`drag: "${q.from}" \u2192 "${q.to}"`:q.t==="clk"||q.t==="chk"?`${q.t}: "${q.id}"`:q.t==="val"?`val: "${q.id}" = "${q.v}"`:JSON.stringify(q).slice(0,80);n.logToConsole(`>    [${q.t.toUpperCase()}] ${k} | ${w.evidence.slice(0,80)}`,"text-yellow")}await d(b.failedActions,u)}let f=r>0?Date.now()-r:1200,h=b.verified>0,v=b.applied>0;if(b.success||h&&v){n.setProgress(100,"Sucesso! Resposta preenchida."),n.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?n.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):g&&n.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),n.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),n.hideFloatingAnswers();let w=St({id:`q-${Date.now()}`,questionIndex:(we().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:f,status:"answered",mode:t.mode,actionsCount:b.applied});n.updateTimingMetrics(w)}else v?(n.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),n.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),n.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(n.setProgress(0,"Alvo de resposta n\xE3o localizado."),n.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),n.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&n.showFloatingAnswers(t))}catch(b){n.setProgress(0);let f=b instanceof Error?b.message:"Falha ao aplicar plano.";n.setStatus(`Erro ao aplicar: ${f}`,"error"),n.logToConsole(`> [ERRO] ${f}`,"text-red")}finally{n.setBusy(!1)}}async function d(l,u){if(!t)return;let A=l.filter(m=>m.action.t==="drag");for(let m of A){if(u?.aborted)return;let p=m.action,g=String(p.from||""),b=String(p.to||""),f=Ut(g,b,g,b);n.logToConsole(`> [REPLAN]  Drag JS fallback: "${g}" \u2192 "${b}"`,"text-blue");let h={...t,actions:[{t:"js",v:f}],pageType:"question"},v=await Ie(h,!1,1,be(e));n.logToConsole(v.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",v.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){n.logToConsole(`> [REPLAN]  ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,g=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);n.logToConsole(`> [REPLAN]  Recuperando: ${g}`,"text-blue");let b=String(p.id||p.name||p.selector||""),f=p.v!==void 0?String(p.v):"";n.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Fe(m.action),await new Promise(h=>setTimeout(h,250)),_(m.action)){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${g}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let h=P(b,f)||P(b.replace(/[^\w\s]/g," ").trim(),f);if(h&&(mt(h),await new Promise(v=>setTimeout(v,300)),_(m.action))){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${g}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let h=P(b,f)||P(b.replace(/[^\w\s]/g," ").trim(),f);if(h&&(h.focus?.(),await new Promise(v=>setTimeout(v,50)),h.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),h.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(v=>setTimeout(v,80)),h.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),h.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(v=>setTimeout(v,200)),_(m.action))){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${g}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){n.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let h=P(b,f)||P(b.replace(/[^\w\s]/g," ").trim(),f);if(h){let v=h.id,y=!!v;v||(v=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,h.id=v);let w=String(p.v??""),q=p.t==="val",k=document.createElement("script");if(k.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(k),k.remove(),y||setTimeout(()=>{try{h.id===v&&h.removeAttribute("id")}catch{}},0),await new Promise(T=>setTimeout(T,300)),_(m.action)){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${g}`,"text-green");continue}}}catch{}}if(u?.aborted)return;n.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let h="";try{let E=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(H=>(H.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));E&&(h=E.outerHTML.slice(0,400))}catch{}let v=de(!1)||re(),y=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${h?`
HTML do alvo: ${h}`:""}`,w=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],q=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
