 ...
 */
"use strict";(()=>{var E={apiKey:"",model:"gemini-2.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};var U="easyquiz_settings_v2";function K(){try{let t=localStorage.getItem(U);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let i=JSON.parse(o);return{...E,apiKey:i.apiKey||""}}return{...E}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:E.model;return(a.includes("3.8")||a.includes("3.7")||a.includes("3.6")||a.includes("3.5")||a.includes("3.1"))&&(a=E.model),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():E.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:E.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:E.confidenceThreshold}}catch{return{...E}}}function re(){try{localStorage.removeItem(U),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),Y()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function F(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function le(t,e){let o={...F(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function ce(t){let a={...K(),...t};try{localStorage.setItem(U,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}var $=[];function de(t){let e=t.trim();e&&!$.includes(e)&&$.push(e)}function pe(){return $}function Y(){$=[]}var ue=`Voc\xEA \xE9 o EasyQuiz Engine v4.8 Supreme. Responda estritamente em JSON v\xE1lido.
...
- { "t": "adv" } (aciona bot\xE3o de avan\xE7o/pr\xF3xima)`;function he(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),s=t.questionText.length<120||o||t.controls.length<3?`
[HTML FRAGMENT (Estrutura DOM/Widgets)]:
${t.htmlSnippet.slice(0,5e3)}`:`
[HTML FRAGMENT]: Omitido (Texto e controles s\xE3o suficientes).`,n=pe(),r="";return n.length>0&&(r=`
...
Responda estritamente em JSON.`}var T=[{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Padr\xE3o Oficial 2026)",description:"Mais r\xE1pido, econ\xF4mico e amplamente dispon\xEDvel em contas Google AI Studio."},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Gera\xE7\xE3o 3 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Compatibilidade Ampla)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],He={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function Pe(t){return t.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-2.5-flash"}function me(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function Re(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let i of o)try{let s=JSON.parse(i);if(s&&typeof s=="object")return s}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var B=null,J=new Set;async function D(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return T;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let n=await i.text(),r=me(n,i.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let s=await i.json();if(Array.isArray(s.models)&&s.models.length>0){let n=s.models.filter(r=>{let l=r.supportedGenerationMethods||[],c=(r.name||"").includes("gemini"),p=l.includes("generateContent"),h=(r.name||"").includes("embedding")||(r.name||"").includes("tts")||(r.name||"").includes("imagen")||(r.name||"").includes("aqa")||(r.name||"").includes("computer-use");return c&&p&&!h}).map(r=>{let l=r.name.replace(/^models\//,""),c=r.displayName||l;return{id:l,name:c.includes(l)?c:`${c} (${l})`,description:r.description||""}});if(n.length>0)return n.sort((r,l)=>{let c=p=>p==="gemini-2.5-flash"?100:p==="gemini-3.5-flash"?95:p==="gemini-3.1-flash-lite"?90:p==="gemini-2.5-pro"?85:p==="gemini-3.1-pro"?80:p==="gemini-1.5-flash"?60:p.includes("flash")?50:10;return c(l.id)-c(r.id)}),B=n,n}}catch(i){if(i.message?.includes("Chave de API"))throw i}return T}async function ge(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await D(e);if(o.length>0&&o!==T){let i=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let i of["v1beta","v1"]){let s=`https://generativelanguage.googleapis.com/${i}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${i})!`,models:T}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function X(t,e,a,o){let i=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!i)throw new Error("Chave de API n\xE3o configurada.");let s=Pe(a.model);if(!B||B.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await D(i)}catch(g){let f=g instanceof Error?g.message:String(g);if(f.includes("inv\xE1lida")||f.includes("n\xE3o autorizada"))throw new Error(f)}let n=Date.now(),r=he(t,e,a),l=[{text:r}];for(let g of e)l.push({inline_data:{mime_type:g.mediaType,data:g.base64}});let c={system_instruction:{parts:[{text:ue}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:He}},p=[s,...B?.map(g=>g.id)||[],"gemini-2.5-flash","gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],h=Array.from(new Set(p)).filter(g=>!J.has(g));h.length===0&&(J.clear(),h.push(...T.map(g=>g.id)));let u=new Error("Nenhum modelo tentado.");for(let g=0;g<h.length;g++){let f=h[g],w=h[g+1];o?.(`Aguardando resposta da API (${f})...`,"info");let Ce=["v1beta","v1"];for(let S of Ce){let R=`https://generativelanguage.googleapis.com/${S}/models/${f}:generateContent?key=${encodeURIComponent(i)}`,O=new AbortController,se=setTimeout(()=>O.abort(),35e3);try{let q=await fetch(R,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":i},body:JSON.stringify(c),signal:O.signal});if(clearTimeout(se),!q.ok){let Ie=await q.text(),ze=me(Ie,q.status);if(q.status===404&&S==="v1beta")continue;throw new Error(ze)}let Q=await q.json(),j=Q.candidates?.[0];if(!j||!j.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let Le=j.content.parts[0].text,x=Re(Le);return Array.isArray(x.actions)||(x.actions=[]),Array.isArray(x.warnings)||(x.warnings=[]),typeof x.confidence!="number"&&(x.confidence=.8),x.usedModel=f,x.durationMs=Date.now()-n,x.promptSent=r,x.tokensUsed=Q.usageMetadata?.totalTokenCount,f!==s&&o?.(`Resolvido com sucesso pelo fallback '${f}' (${S})!`,"info"),{plan:x,rawUsage:Q.usageMetadata,usedModel:f}}catch(q){if(clearTimeout(se),u=q,u.message.includes("inv\xE1lida")||u.message.includes("n\xE3o autorizada"))throw u}}let ke=u.message.includes("429")||u.message.includes("cota"),Me=u.message.includes("503")||u.message.includes("sobrecarregado");if(u.message.includes("404")&&J.add(f),w){let S=ke?3500:Me?2500:900,R=`Modelo '${f}' indispon\xEDvel (${u.message}). Aguardando ${S/1e3}s antes de alternar para '${w}'...`;console.warn(`[EasyQuiz Fallback] ${R}`),o?.(R,"warning"),await new Promise(O=>setTimeout(O,S))}else console.warn(`[EasyQuiz Fallback] Modelo '${f}' falhou: ${u.message}. Todos os modelos esgotados.`)}throw u}var A=['input:not([type="hidden"])',"textarea","select","button","a",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),k=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,Oe=0;function v(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function m(t,e=500){return(t??"").replace(/\s+/g," ").trim().slice(0,e)}function $e(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(Oe+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function W(t){let e=m(t.getAttribute("aria-label")||t.textContent||t.getAttribute("value")||t.value),a=t.type,o=e.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),i=(t.getAttribute("data-testid")||t.getAttribute("data-test-id")||t.getAttribute("id")||t.getAttribute("href")||"").toLowerCase();return k.test(o)||k.test(e)||a==="submit"||i.includes("next")||i.includes("check")||i.includes("continue")||i.includes("proximo")||i.includes("forward")||!1}function Be(t){let e=t.getAttribute("aria-label");if(e)return m(e);let a=t.getAttribute("aria-labelledby");if(a){let s=a.split(/\s+/).map(n=>document.getElementById(n)?.textContent).filter(Boolean).join(" ");if(s.trim())return m(s)}if("labels"in t&&t.labels){let s=Array.from(t.labels??[]).map(n=>n.textContent).join(" ");if(s.trim())return m(s)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let s=m(o.textContent);if(s)return s}let i=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||t.value||"";return m(i)}function Z(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let i=t.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(i)?i:"other",n=t.getAttribute("role")||"",r=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item"),l=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category"),p=m((r?"draggable":l?"dropzone":"")||o.type||n||s,40),h="";o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox"?h=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked":h=m(o.value||t.getAttribute("data-category")||t.textContent||"",2e3);let u=[];if(a)for(let w of Array.from(a.options).slice(0,80))u.push({value:m(w.value),label:m(w.textContent)});let g=!!(o.required||t.getAttribute("aria-required")==="true"),f=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:$e(t),tag:s,type:p,label:Be(t),name:m(o.name||t.getAttribute("name")||"",180),value:h,options:u,required:g,disabled:f,role:e}}var fe=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function ve(t){if(!v(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(A)).filter(v),o=m(t.innerText,4e3).length;if(o<10||!a.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),s=Math.max(1,e.width*e.height),n=Math.min(1,s/i),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),c=o>40?35:0,p=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+c+p-n*20-l*10}function ee(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let i=m(e.innerText,1e4),s=m(a.innerText,1e4),n=e.querySelectorAll(A).length,r=a.querySelectorAll(A).length;if(i.length<150&&s.length>i.length&&r<=n+4){e=a;continue}break}return e}function De(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&v(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Ne(){let t=document.activeElement;if(t&&t!==document.body){let i=t.closest(fe);if(i&&ve(i)>0)return ee(i)}let a=Array.from(document.querySelectorAll(fe)).map(i=>({element:i,score:ve(i)})).filter(i=>Number.isFinite(i.score)).sort((i,s)=>s.score-i.score);if(a.length>0&&a[0].score>0)return ee(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&v(o)?o:document.body}function be(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))a.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function _e(t){return Array.from(t.querySelectorAll(A)).filter(e=>{if(!v(e)||W(e))return!1;if(e.tagName.toLowerCase()==="a"){let a=e.getAttribute("role");return!!(a==="button"||a==="radio"||a==="checkbox"||a==="option"||e.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]'))}return!0}).slice(0,100).map(e=>Z(e,"answer"))}function te(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let i of e)for(let s of Array.from(i.querySelectorAll(A)))if(!(a.has(s)||!v(s)||!W(s))&&(a.add(s),o.push(Z(s,"navigation")),o.length>=10))return o;return o}function M(t=!1){let e=Ne();e=ee(e),t&&(e=De(e));let a=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",o=m(a,16e3),i=_e(e),s=te(e);s.length===0&&(s=te(document.body));let n=[...i,...s].slice(0,120);return!o||n.length===0&&o.length<30?m(document.body.innerText||document.body.textContent||"",16e3).length>=30?C():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:o,htmlSnippet:be(e),controls:n,scope:e}}function C(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=m(t,14e3),a=te(document.body),o=document.querySelector('main, article, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Leitura/Contexto",questionText:e,htmlSnippet:be(o).slice(0,15e3),controls:a,scope:o}}function b(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o)return o;try{if(o=document.querySelector(e),o)return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o)return o}catch{}try{let n=e.replace(/"/g,""),r=`//*[normalize-space(text())="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(r,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let c=l.singleNodeValue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||c}}catch{}let i=m(e).toLowerCase().replace(/['"“”«»]/g,""),s=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of s){if(!v(n))continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,""),c=m(n.getAttribute("data-category")).toLowerCase().replace(/['"“”«»]/g,""),p=m(n.value).toLowerCase();if(r===i||l===i||c===i||p===i)return n.closest('button, [role="button"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], li')||n}if(i.length>=3)for(let n of s){if(!v(n)||n.children.length>5)continue;let r=m(n.textContent).toLowerCase().replace(/['"“”«»]/g,""),l=m(n.getAttribute("aria-label")).toLowerCase().replace(/['"“”«»]/g,"");if(r.includes(i)||l.includes(i))return n.closest('button, [role="button"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], li')||n}return null}function L(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function y(t,e){let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let n=t.getBoundingClientRect();a=n.left+n.width/2,o=n.top+n.height/2}try{t.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{t.focus?.()}catch{}let i={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};t.dispatchEvent(new PointerEvent("pointerdown",{...i,isPrimary:!0,button:0,buttons:1})),t.dispatchEvent(new MouseEvent("mousedown",{...i,button:0,buttons:1})),t.dispatchEvent(new PointerEvent("pointerup",{...i,isPrimary:!0,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("mouseup",{...i,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...i,button:0,buttons:0}));try{t.click()}catch{}let s=t.querySelector('input[type="radio"], input[type="checkbox"]');if(s&&s!==t)try{s.click()}catch{}}function xe(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let i=t._valueTracker;i&&i.setValue("")}catch{}let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,L(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,L(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function we(t,e){let a=t instanceof HTMLInputElement?t:t.querySelector('input[type="checkbox"], input[type="radio"]');if(a&&["checkbox","radio"].includes(a.type)){if(a.checked!==e&&a.click(),a.checked!==e){try{let s=a._valueTracker;s&&s.setValue("")}catch{}Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e),L(a,["input","change"])}return}let o=t.getAttribute("role");if(o==="radio"||o==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(y(t),t.setAttribute("aria-checked",e?"true":"false"),L(t,["input","change"]));return}y(t)}function Ve(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);L(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function Ge(){let t={};return{dropEffect:"move",effectAllowed:"all",files:[],items:[],types:["text/plain"],clearData:e=>{e?delete t[e]:Object.keys(t).forEach(a=>delete t[a])},getData:e=>t[e]||"",setData:(e,a)=>{t[e]=a},setDragImage:()=>{}}}async function oe(t,e){let a=t.getBoundingClientRect(),o=e.getBoundingClientRect(),i=a.left+a.width/2,s=a.top+a.height/2,n=o.left+o.width/2,r=o.top+o.height/2;y(t,[i,s]),await new Promise(u=>setTimeout(u,120)),y(e,[n,r]);let l=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], ul');l&&l!==e&&y(l),await new Promise(u=>setTimeout(u,100));let c={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:s,button:0,buttons:1};t.dispatchEvent(new PointerEvent("pointerdown",{...c,isPrimary:!0})),t.dispatchEvent(new MouseEvent("mousedown",c));for(let u=1;u<=3;u++){let g=i+(n-i)*(u/3),f=s+(r-s)*(u/3),w={...c,clientX:g,clientY:f};t.dispatchEvent(new PointerEvent("pointermove",{...w,isPrimary:!0})),document.dispatchEvent(new MouseEvent("mousemove",w))}let p={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,button:0,buttons:0};e.dispatchEvent(new PointerEvent("pointerup",{...p,isPrimary:!0})),e.dispatchEvent(new MouseEvent("mouseup",p));let h=Ge();h.setData("text/plain",t.textContent||""),h.setData("text/html",t.outerHTML),t.dispatchEvent(new DragEvent("dragstart",{...c,dataTransfer:h})),e.dispatchEvent(new DragEvent("dragenter",{...p,dataTransfer:h})),e.dispatchEvent(new DragEvent("dragover",{...p,dataTransfer:h})),e.dispatchEvent(new DragEvent("drop",{...p,dataTransfer:h})),t.dispatchEvent(new DragEvent("dragend",{...c,dataTransfer:h}));try{let u=new Touch({identifier:1,target:t,clientX:i,clientY:s}),g=new Touch({identifier:1,target:e,clientX:n,clientY:r});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[u]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[g]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}}var Ee={fill:(t,e)=>{let a=b(t);a?xe(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=b(t);e?y(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=b(t);a?we(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=b(t),o=b(e);a&&o?oe(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=b(t),o=b(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await oe(a,o)}};window.$eq=Ee;async function ye(t){if(t.t==="js"){let o=String(t.v||"");try{new Function("$eq","document","window",o)(Ee,document,window)}catch(i){console.warn("[EasyQuiz JS Execution]",i)}return}if(t.t==="drag"){let o=b(t.from),i=b(t.to);o&&i?await oe(o,i):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let e=t.id||"",a=b(e);if(!a&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${e}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":a&&xe(a,String(t.v));break;case"chk":a&&we(a,!!t.c);break;case"sel":if(a){let i=Array.isArray(t.v)?t.v:[String(t.v)];Ve(a,i)}break;case"clk":a&&y(a,t.co);break;case"adv":let o=a;if(!o){let i=Array.from(document.querySelectorAll('button, a, input[type="submit"]')).filter(s=>k.test(s.textContent||s.value||""));i.length&&(o=i[0])}if(o){let i=t.id||o.textContent?.trim()||o.value?.trim()||"";i&&le(window.location.hostname,{advanceSelector:i}),y(o)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}async function qe(t,e){let a=t.actions.filter(s=>s.t!=="adv"),o=t.actions.filter(s=>s.t==="adv");for(let s of a)await ye(s),s.t==="drag"&&await new Promise(n=>setTimeout(n,380));let i=!1;if(e){let s=t.pageType==="info"?void 0:Array.from(document.querySelectorAll('button, [role="button"], input[type="submit"], a')).find(n=>/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(n.textContent||n.value||n.getAttribute("aria-label")||""));if(s&&v(s)&&(y(s),await new Promise(n=>setTimeout(n,800))),o.length>0)await new Promise(n=>setTimeout(n,400)),await ye(o[0]),i=!0;else if(s||t.pageType==="info"||t.pageType==="start"){await new Promise(r=>setTimeout(r,500));let n=Array.from(document.querySelectorAll('button, [role="button"], a, input[type="submit"]')).find(r=>k.test(r.textContent||r.value||r.getAttribute("aria-label")||""));n&&v(n)&&(y(n),i=!0)}}return{applied:a.length,advanced:i}}var I=null,z=[];function H(){I&&(I.style.removeProperty("outline"),I.style.removeProperty("outline-offset"),I=null);for(let t of z)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");z=[]}function ae(t){H(),I=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function Te(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let s=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);s&&(s.style.outline="2px solid #00ff88",z.push(s)),n&&(n.style.outline="2px dashed #00e5ff",z.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let i=o.closest('label, [role="listitem"], .answer, .form-check')||o;i.style.outline="2px solid #00ff88",i.style.outlineOffset="2px",i.style.backgroundColor="rgba(0, 255, 136, 0.08)",z.push(i)}}var P=4,Qe=1200,ne=12e5;function N(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function _(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Qe/Math.max(e,a)),i=Math.max(1,Math.round(e*o)),s=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=i,n.height=s;let r=n.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,s),r.drawImage(t,0,0,i,s),new Promise((l,c)=>{n.toBlob(p=>p?l(p):c(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function Se(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,i=`
