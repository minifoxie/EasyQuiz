 ...
 */
"use strict";(()=>{var C={apiKey:"",model:"gemini-3.5-flash",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};var ee="easyquiz_settings_v2";function te(){try{let t=localStorage.getItem(ee);if(!t){let o=localStorage.getItem("easyquiz_settings_v1");if(o){let s=JSON.parse(o);return{...C,apiKey:s.apiKey||""}}return{...C}}let e=JSON.parse(t),a=typeof e.model=="string"&&e.model?e.model:C.model;return a==="gemini-2.5-flash"&&(a="gemini-3.5-flash"),{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():C.apiKey,model:a,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:C.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:C.confidenceThreshold}}catch{return{...C}}}function fe(){try{localStorage.removeItem(ee),localStorage.removeItem("easyquiz_settings_v1");let t=[];for(let e=0;e<localStorage.length;e++){let a=localStorage.key(e);a&&(a.startsWith("eq_")||a.startsWith("easyquiz_"))&&t.push(a)}t.forEach(e=>localStorage.removeItem(e)),ae()}catch(t){console.warn("[EasyQuiz] Erro ao resetar dados:",t)}}function z(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function oe(t,e){let o={...z(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function be(t){let a={...te(),...t};try{localStorage.setItem(ee,JSON.stringify(a))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return a}var G=[];function ve(t){let e=t.trim();e&&!G.includes(e)&&G.push(e)}function ye(){return G}function ae(){G=[]}var xe=`Voc\xEA \xE9 o EasyQuiz Engine v4.8 Supreme. Responda estritamente em JSON v\xE1lido.
...
- { "t": "adv" } (aciona bot\xE3o de avan\xE7o/pr\xF3xima)`;function we(t,e,a){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(l=>l.type==="draggable"||l.type==="dropzone"),r=t.questionText.length<120||o||t.controls.length<3?`
[HTML FRAGMENT (Estrutura DOM/Widgets)]:
${t.htmlSnippet.slice(0,5e3)}`:`
[HTML FRAGMENT]: Omitido (Texto e controles s\xE3o suficientes).`,n=ye(),i="";return n.length>0&&(i=`
...
Responda estritamente em JSON.`}var A=[{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (Padr\xE3o 2026 - Alta Velocidade)",description:"Frontier model com alta intelig\xEAncia multimodal otimizado para velocidade."},{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash Lite (Ultra Eficiente e Est\xE1vel)",description:"Equil\xEDbrio ideal entre intelig\xEAncia e economia extrema de cota."},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Compatibilidade)",description:"Modelo r\xE1pido para contas com acesso ativo."},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Racioc\xEDnio Avan\xE7ado)",description:"Alta capacidade de racioc\xEDnio l\xF3gico, problemas complexos e STEM."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo avan\xE7ado para racioc\xEDnio em m\xFAltiplos passos e c\xF3digo."},{id:"gemini-1.5-flash",name:"Gemini 1.5 Flash (Legado Universal)",description:"Suporte universal de alta compatibilidade em contas com endpoints legados."}],Oe={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},memoryToStore:{type:"STRING"},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function Be(t){let e=t.trim().replace(/^google\//,"").replace(/^models\//,"");return e==="gemini-2.5-flash"?"gemini-3.5-flash":e||"gemini-3.5-flash"}function Ee(t,e){let a="";try{let o=JSON.parse(t);a=o.error?.message||o.message||""}catch{a=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(a)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded/i.test(a)||e===429?"Limite tempor\xE1rio de cota do Gemini (HTTP 429) atingido. Aguardando recupera\xE7\xE3o...":e===404?`HTTP 404: ${a||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(a)?`Servidores Google sobrecarregados (HTTP 503): ${a||"Aguardando"}`:a?`Erro Gemini (HTTP ${e}): ${a}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function $e(t){try{return JSON.parse(t)}catch(e){let a=t.trim(),o=[a+"}",a+"]}",a+'"}]}',a+'"]}',a+"}]}",a+"}]}}"];for(let s of o)try{let r=JSON.parse(s);if(r&&typeof r=="object")return r}catch{}throw new Error(`Falha ao decodificar JSON da IA (${e instanceof Error?e.message:"incompleto"})`)}}var Q=null,ne=new Set;async function j(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return A;let a=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of a)try{let s=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!s.ok){let n=await s.text(),i=Ee(n,s.status);if(i.includes("inv\xE1lida")||i.includes("n\xE3o autorizada"))throw new Error(i);continue}let r=await s.json();if(Array.isArray(r.models)&&r.models.length>0){let n=r.models.filter(i=>{let l=i.supportedGenerationMethods||[],c=(i.name||"").includes("gemini"),d=l.includes("generateContent"),g=(i.name||"").includes("embedding")||(i.name||"").includes("tts")||(i.name||"").includes("imagen")||(i.name||"").includes("aqa")||(i.name||"").includes("computer-use");return c&&d&&!g}).map(i=>{let l=i.name.replace(/^models\//,""),c=i.displayName||l;return{id:l,name:c.includes(l)?c:`${c} (${l})`,description:i.description||""}});if(n.length>0)return n.sort((i,l)=>{let c=d=>d==="gemini-2.5-flash"?100:d==="gemini-3.5-flash"?95:d==="gemini-3.1-flash-lite"?90:d==="gemini-2.5-pro"?85:d==="gemini-3.1-pro"?80:d==="gemini-1.5-flash"?60:d.includes("flash")?50:10;return c(l.id)-c(i.id)}),Q=n,n}}catch(s){if(s.message?.includes("Chave de API"))throw s}return A}async function qe(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await j(e);if(o.length>0&&o!==A){let s=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${s.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let a=["gemini-2.5-flash","gemini-3.5-flash","gemini-1.5-flash"];for(let o of a)for(let s of["v1beta","v1"]){let r=`https://generativelanguage.googleapis.com/${s}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(r,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${s})!`,models:A}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function ie(t,e,a,o){let s=a.apiKey.trim().replace(/^["']|["']$/g,"");if(!s)throw new Error("Chave de API n\xE3o configurada.");let r=Be(a.model);if(!Q||Q.length===0)try{o?.("Verificando modelos autorizados na sua chave de API...","info"),await j(s)}catch(h){let u=h instanceof Error?h.message:String(h);if(u.includes("inv\xE1lida")||u.includes("n\xE3o autorizada"))throw new Error(u)}let n=Date.now(),i=we(t,e,a),l=[{text:i}];for(let h of e)l.push({inline_data:{mime_type:h.mediaType,data:h.base64}});let c={system_instruction:{parts:[{text:xe}]},contents:[{role:"user",parts:l}],generationConfig:{temperature:.05,maxOutputTokens:2500,response_mime_type:"application/json",response_schema:Oe}},d=[r,...Q?.map(h=>h.id)||[],"gemini-3.5-flash","gemini-3.1-flash-lite","gemini-2.5-flash","gemini-2.5-pro","gemini-3.1-pro","gemini-1.5-flash"],g=Array.from(new Set(d)).filter(h=>!ne.has(h));g.length===0&&(ne.clear(),g.push(...A.map(h=>h.id)));let m=new Error("Nenhum modelo tentado.");for(let h=0;h<g.length;h++){let u=g[h],x=g[h+1];o?.(`Aguardando resposta da API (${u})...`,"info");let v=["v1beta","v1"];for(let M of v){let _=`https://generativelanguage.googleapis.com/${M}/models/${u}:generateContent?key=${encodeURIComponent(s)}`,V=new AbortController,ge=setTimeout(()=>V.abort(),35e3);try{let k=await fetch(_,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":s},body:JSON.stringify(c),signal:V.signal});if(clearTimeout(ge),!k.ok){let Pe=await k.text(),Re=Ee(Pe,k.status);if(k.status===404&&M==="v1beta")continue;throw new Error(Re)}let W=await k.json(),Z=W.candidates?.[0];if(!Z||!Z.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let ze=Z.content.parts[0].text,T=$e(ze);if(Array.isArray(T.actions)||(T.actions=[]),Array.isArray(T.warnings)||(T.warnings=[]),typeof T.confidence!="number"&&(T.confidence=.8),T.usedModel=u,T.durationMs=Date.now()-n,T.promptSent=i,T.tokensUsed=W.usageMetadata?.totalTokenCount,u!==r){o?.(`Resolvido com sucesso pelo fallback '${u}' (${M})!`,"info");try{a.model=u}catch{}}return{plan:T,rawUsage:W.usageMetadata,usedModel:u}}catch(k){if(clearTimeout(ge),m=k,m.message.includes("inv\xE1lida")||m.message.includes("n\xE3o autorizada"))throw m}}let w=m.message.includes("429")||m.message.includes("cota"),H=m.message.includes("503")||m.message.includes("sobrecarregado");if(m.message.includes("404")&&ne.add(u),x){let M=w?3500:H?2500:900,_=`Modelo '${u}' indispon\xEDvel (${m.message}). Aguardando ${M/1e3}s antes de alternar para '${x}'...`;console.warn(`[EasyQuiz Fallback] ${_}`),o?.(_,"warning"),await new Promise(V=>setTimeout(V,M))}else console.warn(`[EasyQuiz Fallback] Modelo '${u}' falhou: ${m.message}. Todos os modelos esgotados.`)}throw m}var L=['input:not([type="hidden"])',"textarea","select","button","a",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="category" i]','[data-role="dropzone"]',"[data-category]"].join(","),U=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,De=0;function b(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let a=e.getBoundingClientRect(),o=window.getComputedStyle(e);return a.width>0&&a.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function Ne(t){if(t==null)return"";if(typeof t=="string")return t;if(typeof t=="number"||typeof t=="boolean")return String(t);if(t instanceof Node)return t.textContent||"";try{if(typeof t?.toString=="function"){let e=t.toString();if(typeof e=="string")return e}}catch{}return""}function f(t,e=500){return Ne(t).replace(/\s+/g," ").trim().slice(0,e)}function _e(t){let e=t.dataset.easyquizId;if(e)return e;let a=`eq-${Date.now().toString(36)}-${(De+=1).toString(36)}`;return t.dataset.easyquizId=a,a}function P(t){if(!t||!(t instanceof Element))return!1;let e=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",a=f(t.getAttribute?.("aria-label")||t.textContent||t.getAttribute?.("value")||e),o=t.type,s=a.replace(/[\d\(\)\[\]→\>\•\-\/\\]+/g," ").trim(),r=String(t.getAttribute?.("data-testid")||t.getAttribute?.("data-test-id")||t.getAttribute?.("id")||t.getAttribute?.("href")||"").toLowerCase();return U.test(s)||U.test(a)||o==="submit"||r.includes("next")||r.includes("check")||r.includes("continue")||r.includes("proximo")||r.includes("forward")||!1}function Ve(t){let e=t.getAttribute("aria-label");if(e)return f(e);let a=t.getAttribute("aria-labelledby");if(a){let n=a.split(/\s+/).map(i=>document.getElementById(i)?.textContent).filter(Boolean).join(" ");if(n.trim())return f(n)}if("labels"in t&&t.labels){let n=Array.from(t.labels??[]).map(i=>i.textContent).join(" ");if(n.trim())return f(n)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let n=f(o.textContent);if(n)return n}let s=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||s||"";return f(r)}function se(t,e){let a=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let s=t.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(s)?s:"other",n=t.getAttribute("role")||"",i=(t.getAttribute("data-testid")||t.getAttribute("data-test-id")||"").toLowerCase(),l=(t.className&&typeof t.className=="string"?t.className:"").toLowerCase(),c=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item")||t.classList.contains("sortable-item")||!!t.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(i)||/drag|card-item|sortable/i.test(l),d=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category")||!!t.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(i)||/dropzone|category-box|bucket|target-zone/i.test(l),m=f((c?"draggable":d?"dropzone":"")||o.type||n||r,40),h="";if(o.type==="checkbox"||o.type==="radio"||n==="radio"||n==="checkbox")h=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked";else{let w=t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement?t.value:"";h=f(w||t.getAttribute("data-category")||t.textContent||"",2e3)}let u=[];if(a)for(let w of Array.from(a.options).slice(0,80))u.push({value:f(w.value),label:f(w.textContent)});let x=!!(o.required||t.getAttribute("aria-required")==="true"),v=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:_e(t),tag:r,type:m,label:Ve(t),name:f(o.name||t.getAttribute("name")||"",180),value:h,options:u,required:x,disabled:v,role:e}}var Te=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]',"article","form","section","main"].join(",");function Se(t){if(!b(t))return-1/0;let e=t.getBoundingClientRect(),a=Array.from(t.querySelectorAll(L)).filter(b),o=f(t.innerText,4e3).length;if(o<10||!a.length&&o<60)return-1/0;let s=Math.max(1,window.innerWidth*window.innerHeight),r=Math.max(1,e.width*e.height),n=Math.min(1,r/s),i=e.top+e.height/2,l=Math.abs(i-window.innerHeight/2)/Math.max(1,window.innerHeight),c=o>40?35:0,d=e.top>=0&&e.bottom<=window.innerHeight?25:0;return a.length*15+Math.min(60,o/20)+c+d-n*20-l*10}function re(t){let e=t;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let a=e.parentElement,o=a.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(a.matches?.('article, section, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que, main')){e=a;break}let s=f(e.innerText,1e4),r=f(a.innerText,1e4),n=e.querySelectorAll(L).length,i=a.querySelectorAll(L).length;if(s.length<150&&r.length>s.length&&i<=n+4){e=a;continue}break}return e}function Ge(t){let e=t,a=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(a&&a!==document.body&&b(a))return a;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function Qe(){let t=document.activeElement;if(t&&t!==document.body){let s=t.closest(Te);if(s&&Se(s)>0)return re(s)}let a=Array.from(document.querySelectorAll(Te)).map(s=>({element:s,score:Se(s)})).filter(s=>Number.isFinite(s.score)).sort((s,r)=>r.score-s.score);if(a.length>0&&a[0].score>0)return re(a[0].element);let o=document.querySelector('form, main, [role="main"]');return o&&b(o)?o:document.body}function Ce(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let a=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let s of Array.from(o.attributes))a.includes(s.name)||o.removeAttribute(s.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function je(t){return Array.from(t.querySelectorAll(L)).filter(e=>{if(!b(e)||P(e))return!1;if(e.tagName.toLowerCase()==="a"){let a=e.getAttribute("role");return!!(a==="button"||a==="radio"||a==="checkbox"||a==="option"||e.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]'))}return!0}).slice(0,100).map(e=>se(e,"answer"))}function le(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),a=new Set,o=[];for(let s of e)for(let r of Array.from(s.querySelectorAll(L)))if(!(a.has(r)||!b(r)||!P(r))&&(a.add(r),o.push(se(r,"navigation")),o.length>=10))return o;return o}function R(t=!1){let e=Qe();e=re(e),t&&(e=Ge(e));let a=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",o=f(a,16e3),s=je(e),r=le(e);r.length===0&&(r=le(document.body));let n=[...s,...r].slice(0,120);return!o||n.length===0&&o.length<30?f(document.body.innerText||document.body.textContent||"",16e3).length>=30?I():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:o,htmlSnippet:Ce(e),controls:n,scope:e}}function I(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=f(t,14e3),a=le(document.body),o=document.querySelector('main, article, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Leitura/Contexto",questionText:e,htmlSnippet:Ce(o).slice(0,15e3),controls:a,scope:o}}function S(t){return!!t.closest("#easyquiz-shadow-root, .eq-sidebar, .eq-launcher")}function q(t){return t?t.replace(/^[\d\.\-\)\s]+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim():""}function y(t){if(!t)return null;let e=t.trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!e)return null;let a=CSS.escape(e),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(o&&!S(o))return o;try{if(o=document.querySelector(e),o&&!S(o))return o}catch{}try{if(o=document.querySelector(`#${a}, [name="${a}"], [value="${a}"]`),o&&!S(o))return o}catch{}try{let n=e.replace(/"/g,""),i=`//*[normalize-space(.)="${n}"] | //*[@aria-label="${n}"] | //*[@data-category="${n}"] | //*[@data-testid="${n}"]`,l=document.evaluate(i,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);if(l.singleNodeValue){let c=l.singleNodeValue;if(!S(c))return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||c}}catch{}let s=q(e).toLowerCase(),r=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let n of r){if(!b(n)||S(n))continue;let i=q(n.textContent).toLowerCase(),l=q(n.getAttribute("aria-label")||"").toLowerCase(),c=q(n.getAttribute("data-category")||"").toLowerCase(),d=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",g=q(d).toLowerCase(),m=i.startsWith(s+")")||i.startsWith(s+".")||i.startsWith(s+" -")||i.startsWith(s+":");if(i===s||l===s||c&&c===s||g&&g===s||m){let h=n.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]'),u=n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li');return h||u||n}}if(s.length>=3)for(let n of r){if(!b(n)||S(n))continue;let i=q(n.textContent).toLowerCase(),l=q(n.getAttribute("aria-label")||"").toLowerCase();if(i.includes(s)||l.includes(s)||s.length>8&&i&&s.includes(i)){let d=n.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]'),g=n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li');return d||g||n}let c=s.split(" ").filter(d=>d.length>2);if(c.length>=3){let d=c.slice(0,Math.min(4,c.length)).join(" ");if(i.includes(d)||l.includes(d))return n.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], [draggable="true"], [class*="card" i], [class*="option" i], [class*="item" i], label, li')||n}}return null}function O(t,e){for(let a of e)t.dispatchEvent(new Event(a,{bubbles:!0,composed:!0}))}function E(t,e){if(!t)return;try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=0,o=0;if(e&&e.length===2)a=e[0],o=e[1];else{let i=t.getBoundingClientRect();a=Math.round(i.left+Math.max(1,i.width/2)),o=Math.round(i.top+Math.max(1,i.height/2))}try{t.focus?.()}catch{}let s={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:o,screenX:a,screenY:o};try{t.dispatchEvent(new PointerEvent("pointerdown",{...s,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:1}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",{...s,button:0,buttons:1}));try{t.dispatchEvent(new PointerEvent("pointerup",{...s,isPrimary:!0,pointerId:1,pointerType:"mouse",width:1,height:1,pressure:.5,button:0,buttons:0}))}catch{}t.dispatchEvent(new MouseEvent("mouseup",{...s,button:0,buttons:0})),t.dispatchEvent(new MouseEvent("click",{...s,button:0,buttons:0}));try{let i=new Touch({identifier:Date.now(),target:t,clientX:a,clientY:o,screenX:a,screenY:o,pageX:a+(window.scrollX||0),pageY:o+(window.scrollY||0)});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,composed:!0,touches:[i],targetTouches:[i]})),t.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,composed:!0,touches:[],targetTouches:[]}))}catch{}try{t.click()}catch{}let r=t.closest('button, a, [role="button"], [role="radio"], [role="checkbox"], label');if(r&&r!==t)try{r.click()}catch{}let n=t.querySelector('input[type="radio"], input[type="checkbox"]');if(n&&n!==t)try{n.click()}catch{}}function ke(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let s=t._valueTracker;s&&s.setValue("")}catch{}let a=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(a,"value")?.set;o?o.call(t,e):t.value=e,O(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,O(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function ce(t,e){let a=t instanceof HTMLInputElement?t:t.querySelector('input[type="checkbox"], input[type="radio"]');if(a&&["checkbox","radio"].includes(a.type)){if(a.checked!==e&&a.click(),a.checked!==e){try{let r=a._valueTracker;r&&r.setValue("")}catch{}Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e),O(a,["input","change"])}return}let o=t.getAttribute("role");if(o==="radio"||o==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(E(t),t.setAttribute("aria-checked",e?"true":"false"),O(t,["input","change"]));return}E(t)}function Ue(t,e){if(t instanceof HTMLSelectElement){for(let a of Array.from(t.options))a.selected=e.includes(a.value);O(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}function Ke(t,e){try{let a=new DataTransfer;try{a.setData("text/plain",t)}catch{}try{a.setData("text/html",e)}catch{}return a}catch{return null}}async function de(t,e,a=1){try{t.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=t.getBoundingClientRect(),s=e.getBoundingClientRect(),r=Math.round(o.left+Math.max(1,o.width/2)),n=Math.round(o.top+Math.max(1,o.height/2)),i=Math.round(s.left+Math.max(1,s.width/2)),l=Math.round(s.top+Math.max(1,s.height/2)),c=q(e.textContent).toLowerCase();if(c){let x=Array.from(t.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(v=>{let w=q(v.textContent).toLowerCase(),H=v instanceof HTMLInputElement||v instanceof HTMLOptionElement?q(v.value).toLowerCase():"";return w&&(c.includes(w)||w.includes(c))||H&&(c.includes(H)||H.includes(c))});x&&(E(x),await new Promise(v=>setTimeout(v,120)))}E(t,[r,n]),await new Promise(u=>setTimeout(u,140)),E(e,[i,l]);let d=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');d&&d!==e&&E(d),await new Promise(u=>setTimeout(u,100));let g={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:n,screenX:r,screenY:n,button:0,buttons:1};try{t.dispatchEvent(new PointerEvent("pointerdown",{...g,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}t.dispatchEvent(new MouseEvent("mousedown",g));let m=4;for(let u=1;u<=m;u++){let x=Math.round(r+(i-r)*(u/m)),v=Math.round(n+(l-n)*(u/m)),w={...g,clientX:x,clientY:v,screenX:x,screenY:v};try{t.dispatchEvent(new PointerEvent("pointermove",{...w,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",w))}let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:i,clientY:l,screenX:i,screenY:l,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",h)),e.dispatchEvent(new MouseEvent("click",h));try{let u=Ke(f(t.textContent),t.outerHTML),x={...g},v={...h};u&&(x.dataTransfer=u,v.dataTransfer=u),t.dispatchEvent(new DragEvent("dragstart",x)),e.dispatchEvent(new DragEvent("dragenter",v)),e.dispatchEvent(new DragEvent("dragover",v)),e.dispatchEvent(new DragEvent("drop",v)),t.dispatchEvent(new DragEvent("dragend",x))}catch(u){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",u)}try{let u=new Touch({identifier:1,target:t,clientX:r,clientY:n}),x=new Touch({identifier:1,target:e,clientX:i,clientY:l});t.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[u]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[x]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(a>=2&&!e.contains(t))try{t.focus?.(),t.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(u=>setTimeout(u,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}}var Ae={fill:(t,e)=>{let a=y(t);a?ke(a,e):console.warn(`$eq.fill: Elemento '${t}' n\xE3o encontrado`)},click:t=>{let e=y(t);e?E(e):console.warn(`$eq.click: Elemento '${t}' n\xE3o encontrado`)},check:(t,e)=>{let a=y(t);a?ce(a,e):console.warn(`$eq.check: Elemento '${t}' n\xE3o encontrado`)},drag:(t,e)=>{let a=y(t),o=y(e);a&&o?de(a,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${t}' -> '${e}')`)},categorize:async(t,e)=>{let a=y(t),o=y(e);if(!a||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${t}' -> '${e}')`);return}await de(a,o)}};window.$eq=Ae;async function Fe(t,e=1){if(t.t==="js"){let s=String(t.v||"");try{new Function("$eq","document","window",s)(Ae,document,window)}catch(r){console.warn("[EasyQuiz JS Execution]",r)}return}if(t.t==="drag"){let s=y(t.from),r=y(t.to);!s&&t.from&&(s=y(q(t.from))),!r&&t.to&&(r=y(q(t.to))),s&&r?await de(s,r,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${t.from}' -> '${t.to}')`);return}let a=t.id||"",o=y(a);if(!o&&a&&(o=y(q(a))),!o&&t.t!=="adv"){console.warn(`[EasyQuiz] Alvo '${a}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'. Prosseguindo...`);return}switch(t.t){case"val":o&&ke(o,String(t.v));break;case"chk":o&&ce(o,!!t.c);break;case"sel":if(o){let r=Array.isArray(t.v)?t.v:[String(t.v)];Ue(o,r)}break;case"clk":if(o){E(o,t.co);let r=o.querySelector('input[type="radio"], input[type="checkbox"]');r&&!r.checked&&ce(r,!0)}break;case"adv":let s=K(t.id);if(s){await ue(s,1200);let r=t.id||s.textContent?.trim()||"";r&&oe(window.location.hostname,{advanceSelector:r}),E(s)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function Ye(){let t=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(t)).find(a=>{if(!b(a)||S(a))return!1;let o=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"",s=(a.textContent||o||a.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(s)})||null}function K(t){if(t){let r=y(t);if(r&&b(r)&&!S(r))return r}try{let r=z(window.location.hostname);if(r.advanceSelector){let n=y(r.advanceSelector);if(n&&b(n)&&!S(n))return n}}catch{}let e=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(e)).filter(r=>b(r)&&!S(r));for(let r of o)if(P(r))return r;for(let r of o){let n=r instanceof HTMLInputElement||r instanceof HTMLButtonElement?r.value:"",i=(r.textContent||n||r.getAttribute("aria-label")||"").trim();if(U.test(i))return r}let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');return s&&b(s)&&!S(s)?s:null}async function ue(t,e=1500){let a=Date.now();for(;Date.now()-a<e;){if(!(t.disabled===!0||t.getAttribute("aria-disabled")==="true"||t.classList.contains("disabled")||t.getAttribute("disabled")!==null))return;await new Promise(s=>setTimeout(s,100))}try{t.removeAttribute("disabled"),t.removeAttribute("aria-disabled"),t.classList.remove("disabled"),t.disabled=!1}catch{}}async function Me(t,e,a=1){let o=t.actions.filter(i=>i.t!=="adv"),s=t.actions.filter(i=>i.t==="adv"),r=0;for(let i of o){try{await Fe(i,a),r++}catch(l){console.warn("[EasyQuiz] A\xE7\xE3o declarativa falhou com seguran\xE7a:",i,l)}i.t==="drag"&&await new Promise(l=>setTimeout(l,250))}let n=!1;if(e||a>=2){if(await new Promise(c=>setTimeout(c,o.length>0?500:200)),t.pageType!=="info"){let c=Ye();c&&b(c)&&(await ue(c,1200),E(c),await new Promise(d=>setTimeout(d,800)))}let i=s.length>0?s[0].id:void 0,l=K(i);if(l){await ue(l,1200);let c=i||l.textContent?.trim()||"";c&&oe(window.location.hostname,{advanceSelector:c}),E(l),n=!0}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}return{applied:r,advanced:n}}var B=null,$=[];function D(){B&&(B.style.removeProperty("outline"),B.style.removeProperty("outline-offset"),B=null);for(let t of $)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");$=[]}function pe(t){D(),B=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function Le(t){for(let e of t){if(e.t==="adv"||e.t==="js")continue;if(e.t==="drag"){try{let r=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.from)}"]`)||document.querySelector(e.from),n=document.querySelector(`[data-easyquiz-id="${CSS.escape(e.to)}"]`)||document.querySelector(e.to);r&&(r.style.outline="2px solid #00ff88",$.push(r)),n&&(n.style.outline="2px dashed #00e5ff",$.push(n))}catch{}continue}if(!e.id)continue;let a=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${a}"]`);if(!o)continue;let s=o.closest('label, [role="listitem"], .answer, .form-check')||o;s.style.outline="2px solid #00ff88",s.style.outlineOffset="2px",s.style.backgroundColor="rgba(0, 255, 136, 0.08)",$.push(s)}}var N=4,Xe=1200,he=12e5;function F(t){return new Promise((e,a)=>{let o=new FileReader;o.onerror=()=>a(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");e(s.split(",")[1]||"")},o.readAsDataURL(t)})}async function Y(t){let e=0,a=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,a=t.naturalHeight||t.height):(e=t.width,a=t.height),e<=0||a<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Xe/Math.max(e,a)),s=Math.max(1,Math.round(e*o)),r=Math.max(1,Math.round(a*o)),n=document.createElement("canvas");n.width=s,n.height=r;let i=n.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,s,r),i.drawImage(t,0,0,s,r),new Promise((l,c)=>{n.toBlob(d=>d?l(d):c(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function Ie(t){try{let e=t.cloneNode(!0),a=t.offsetWidth||500,o=t.offsetHeight||500,s=`
...
`;var We=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Ze=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],J=class{host;shadow;callbacks;autopilot;initialSettings;isCollapsed=!1;activeTab="autopilot";stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,a){this.initialSettings=e,this.callbacks=a,this.autopilot=new X({onStatusChange:(o,s,r)=>{this.logToConsole(s,r),o==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(o==="advancing"||o==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async o=>{try{return await this.callbacks.onAnalyze(o)||null}catch{return null}}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
      <style>${He}</style>
      ...
      <button class="eq-launcher" type="button" title="Abrir / Recolher EasyQuiz (Alt+Q)">
        <span class="eq-launcher-icon">${p.logo}</span>
        <span>EasyQuiz</span>
      ...
      <aside class="eq-sidebar" aria-label="EasyQuiz Sidebar">
        ...
        <button class="eq-dock-toggle" id="eq-dock-toggle" type="button" title="Recolher / Expandir Painel (Alt+Q)">
          <span class="eq-dock-toggle-icon">${p.chevronRight}</span>
        ...
        <nav class="eq-activity-bar" role="tablist" aria-label="Atalhos">
          ...
          <div class="eq-activity-bottom">
            <button class="eq-activity-btn" id="eq-tab-settings" role="tab" title="Configura\xE7\xF5es & Chaves">
              <span class="eq-activity-indicator"></span>
              <span class="eq-activity-icon">${p.settings}</span>
            </button>
          </div>
        </nav>
        ...
        <main class="eq-sidebar-body">
          ...
          <header class="eq-header">
            <div class="eq-brand">
              <span class="eq-brand-icon">${p.logo}</span>
              <span class="eq-brand-name">EasyQuiz</span>
              <span class="eq-brand-badge">2.0 SUPREME</span>
            </div>
            <div class="eq-header-tools">
              <button class="eq-icon-btn" id="eq-min-btn" type="button" title="Minimizar (Alt+Q)">${p.chevronRight}</button>
          ...
          <div class="eq-views-wrapper">
            ...
            <div class="eq-view-pane" id="eq-view-advanced" style="display: none;">
              <button class="eq-btn-primary" id="eq-analyze-btn" type="button">
                ${p.analyze} Analisar & Resolver Quest\xE3o
              </button>
              ...
              <div id="eq-result" style="display: none; flex-direction: column; gap: 10px;">
                ...
                <button class="eq-btn-secondary" id="eq-apply-btn" type="button">
                  ${p.apply} Injetar Resposta na P\xE1gina
                </button>
              </div>
            ...
            <div class="eq-view-pane" id="eq-view-settings" style="display: none;">
              ...
              <div class="eq-field-group">
                ...
                <div class="eq-key-input-container">
                  <div class="eq-input-wrap">
                    <span class="eq-input-prefix-icon">${p.key}</span>
                    ...
                    <button class="eq-icon-btn" id="eq-key-save" type="button" title="Salvar Chave">${p.save}</button>
                    <button class="eq-icon-btn" id="eq-key-more-btn" type="button" title="Mais Op\xE7\xF5es da Chave">${p.moreVertical}</button>
                  </div>
                  ...
                  <div class="eq-context-menu" id="eq-key-context-menu" hidden>
                    <button class="eq-context-item" id="eq-menu-prompt" type="button">
                      <span class="eq-item-icon">${p.edit}</span>
                    ...
                    <button class="eq-context-item" id="eq-menu-paste" type="button">
                      <span class="eq-item-icon">${p.paste}</span>
              ...
              <div class="eq-field-group" style="margin-top: 14px; padding-top: 12px; border-top: 1px solid #282828;">
                ...
                <button class="eq-btn-secondary" id="eq-reset-all-btn" type="button" style="border-color: #662222; color: #ff8888;">
                  ${p.trash} Resetar Todos os Dados e Mem\xF3ria
                </button>
              </div>
    ...
    `;let s=this.shadow.querySelector("#eq-rationale-text");s.textContent=e.rationale;let r=this.shadow.querySelector("#eq-actions-list");r.innerHTML="";for(let n of e.actions){let i=document.createElement("div");i.className="eq-action-item";let l="";n.t==="chk"?l=`chk ${n.id} (${n.c})`:n.t==="val"?l=`val "${n.v}" -> ${n.id}`:n.t==="sel"?l=`sel "${Array.isArray(n.v)?n.v.join(","):n.v}" -> ${n.id}`:n.t==="clk"?l=`clk ${n.id}`:n.t==="adv"?l="adv":n.t==="js"?l=`js: ${String(n.v).slice(0,40)}...`:n.t==="drag"&&(l=`drag "${n.from}" -> "${n.to}"`),i.innerHTML=`<span class="eq-action-badge">${n.t.toUpperCase()}</span> <span>${l}</span>`,r.appendChild(i)}if(this.applyBtn.disabled=!a||!e.actions.length,this.inspModel.textContent=e.usedModel||this.initialSettings.model,this.inspLatency.textContent=e.durationMs?`${e.durationMs}ms`:"--",this.inspTokens.textContent=e.tokensUsed?`${e.tokensUsed}`:"--",this.inspPrompt.textContent=e.promptSent||"Prompt n\xE3o registrado para esta requisi\xE7\xE3o.",this.inspRationale.textContent=e.rationale,this.inspActions.innerHTML="",e.actions.length>0)for(let n of e.actions){let i=document.createElement("div");i.className="eq-action-item",i.textContent=JSON.stringify(n),this.inspActions.appendChild(i)}else this.inspActions.innerHTML='<div class="text-muted" style="padding: 4px;">Nenhuma a\xE7\xE3o prescrita pela IA.</div>'}updateModelSelect(e,a){let o=a||this.initialSettings.model||this.modelSelect.value;this.modelSelect.innerHTML="";let s=!1;e.forEach(r=>{let n=r.id===o;n&&(s=!0),this.modelSelect.add(new Option(r.name,r.id,!1,n))}),!s&&o&&this.modelSelect.add(new Option(`Gemini (${o})`,o,!1,!0)),this.modelSelect.value=o}updateSelectedModel(e){Array.from(this.modelSelect.options).some(o=>o.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}applyHostDarkMode(e){let a="eq-host-dark-mode-style",o=document.getElementById(a);if(e){let s=window.getComputedStyle(document.body).backgroundColor;(s.includes("rgba(0, 0, 0, 0)")||s==="transparent")&&(s=window.getComputedStyle(document.documentElement).backgroundColor);let r=s.match(/\d+(\.\d+)?/g);if(r&&r.length>=3&&(r[3]!==void 0?parseFloat(r[3]):1)>.1){let i=parseInt(r[0]),l=parseInt(r[1]),c=parseInt(r[2]);if((i*299+l*587+c*114)/1e3<100)return}o||(o=document.createElement("style"),o.id=a,o.innerHTML=`
          html { filter: invert(1) hue-rotate(180deg) !important; background: #fff !important; }
          img, video, canvas, [style*="background-image"] { filter: invert(1) hue-rotate(180deg) !important; }
        `,document.head.appendChild(o)),this.host.classList.add("eq-dark-mode-active")}else this.host.classList.remove("eq-dark-mode-active"),o&&o.remove()}destroy(){this.stopStopwatch(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function et(){let t=window;if(t.__easyquiz){t.__easyquiz.toggle();return}let e=te(),a=null,o=new J(e,{onAnalyze:(n=1)=>s(n),onApply:(n=1)=>void r(n),onDestroy:()=>{D(),delete t.__easyquiz},onSettingsChange:n=>{e=be(n)}});t.__easyquiz={toggle:()=>o.toggle(),destroy:()=>o.destroy(),analyze:async()=>{await s()}},window.addEventListener("keydown",n=>{if(n.altKey&&(n.key==="q"||n.key==="Q")){if(n.preventDefault(),!o)return;o.toggle(!0),s()}});async function s(n=1){if(!e.apiKey){o.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),o.toggle(!0);return}o.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),D();try{let i=R(!1);i||(o.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),i=I()),pe(i.scope),o.setStatus(`Quest\xE3o localizada (${i.controls.length} controles). Preparando an\xE1lise...`,"info");let l=await me(i.scope,e.useVision);o.setStatus(l.length>0?`Consultando Gemini (${e.model}) com ${l.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${e.model}) via DOM nativo (modo r\xE1pido)...`,"info");let{plan:c,usedModel:d}=await ie(i,l,e,(g,m)=>{o.setStatus(g,m==="warning"?"info":m)});return c.needsMoreContext&&(o.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),i=R(!0),i||(i=I()),pe(i.scope),l=await me(i.scope,e.useVision),o.setStatus(`Reconsultando IA com escopo ampliado (${i.controls.length} controles)...`,"info"),c=(await ie(i,l,e,(m,h)=>{o.setStatus(m,h==="warning"?"info":h)})).plan),c.memoryToStore&&(ve(c.memoryToStore),console.log("[EasyQuiz] Mem\xF3ria de sess\xE3o armazenada:",c.memoryToStore)),a=c,Le(c.actions),o.setPlan(c,!e.dryRun),c.pageType==="conclusion"?o.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success"):c.pageType==="info"?o.setStatus("\u{1F4D8} Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success"):c.pageType==="start"?o.setStatus("In\xEDcio de atividade detectado. Iniciando...","info"):o.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success"),e.autoApply&&!e.dryRun&&await r(n),c}catch(i){D();let l=i instanceof Error?i.message:"Falha desconhecida na an\xE1lise.";o.setStatus(l,"error");return}finally{o.setBusy(!1)}}async function r(n=1){if(!a){o.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){o.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let i=a.pageType==="info"||a.pageType==="start",l=(e.autoAdvance||i||n>=2)&&a.confidence>=e.confidenceThreshold&&!a.needsMoreContext;o.setBusy(!0,"Aplicando respostas no formul\xE1rio...");try{let c=await Me(a,l,n);o.setStatus(`Sucesso: ${c.applied} resposta(s) preenchida(s)${c.advanced?" e pr\xF3xima quest\xE3o acionada":""}.`,"success")}catch(c){let d=c instanceof Error?c.message:"Falha ao aplicar plano.";o.setStatus(d,"error")}finally{o.setBusy(!1)}}o.toggle(!0)}et().catch(t=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",t),window.alert(`EasyQuiz: falha ao iniciar: ${t instanceof Error?t.message:String(t)}`)});})();
