 ...
 */
"use strict";(()=>{var me=Object.defineProperty;var K=(t,e)=>()=>(t&&(e=t(t=0)),e);var ye=(t,e)=>{for(var n in e)me(t,n,{get:e[n],enumerable:!0})};function g(t){let e=t;if(!e||typeof e.getBoundingClientRect!="function")return!1;let n=e.getBoundingClientRect(),o=window.getComputedStyle(e);return n.width>0&&n.height>0&&o.display!=="none"&&o.visibility!=="hidden"&&Number(o.opacity||"1")>0}function u(t,e=500){return(t??"").replace(/\s+/g," ").trim().slice(0,e)}function Ee(t){let e=t.dataset.easyquizId;if(e)return e;let n=`eq-${Date.now().toString(36)}-${(xe+=1).toString(36)}`;return t.dataset.easyquizId=n,n}function N(t){let e=u(t.textContent||t.getAttribute("aria-label")||t.getAttribute("value")||t.value),n=t.type;return D.test(e)||n==="submit"}function we(t){let e=t.getAttribute("aria-label");if(e)return u(e);let n=t.getAttribute("aria-labelledby");if(n){let a=n.split(/\s+/).map(s=>document.getElementById(s)?.textContent).filter(Boolean).join(" ");if(a.trim())return u(a)}if("labels"in t&&t.labels){let a=Array.from(t.labels??[]).map(s=>s.textContent).join(" ");if(a.trim())return u(a)}let o=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check');if(o&&o!==t){let a=u(o.textContent);if(a)return a}let i=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||t.value||"";return u(i)}function _(t,e){let n=t instanceof HTMLSelectElement?t:null,o=t;t.dataset.easyquizRole=e;let i=t.tagName.toLowerCase(),a=["input","textarea","select","button"].includes(i)?i:"other",s=t.getAttribute("role")||"",r=u(o.type||s||a,40),l="";o.type==="checkbox"||o.type==="radio"||s==="radio"||s==="checkbox"?l=o.checked||t.getAttribute("aria-checked")==="true"?"checked":"unchecked":l=u(o.value||t.textContent||"",2e3);let c=[];if(n)for(let p of Array.from(n.options).slice(0,80))c.push({value:u(p.value),label:u(p.textContent)});let d=!!(o.required||t.getAttribute("aria-required")==="true"),E=!!(o.disabled||t.getAttribute("aria-disabled")==="true");return{id:Ee(t),tag:a,type:r,label:we(t),name:u(o.name||t.getAttribute("name")||"",180),value:l,options:c,required:d,disabled:E,role:e}}var S,D,xe,k=K(()=>{"use strict";S=['input:not([type="hidden"])',"textarea","select","button",'[role="button"]','[role="radio"]','[role="checkbox"]','[role="option"]','[contenteditable="true"]'].join(","),D=/^(próxim[oa]|next|continuar|avançar|prosseguir|enviar|submit|concluir|finalizar|próxima questão|next question|avançar questão)$/i,xe=0});var M={};ye(M,{captureCurrentContext:()=>v,captureFullPageText:()=>qe,extractAnswerControls:()=>ae,extractNavigationControls:()=>ie,findActiveScope:()=>oe,sanitizeHtml:()=>ne});function te(t){if(!g(t))return-1/0;let e=t.getBoundingClientRect(),n=Array.from(t.querySelectorAll(S)).filter(g),o=u(t.innerText,4e3).length;if(!n.length||o<10)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),s=Math.min(1,a/i),r=e.top+e.height/2,l=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),c=Math.min(60,n.length*15e3/a),d=e.top>=0&&e.bottom<=window.innerHeight?30:0;return n.length*20+Math.min(50,o/25)+c+d-s*60-l*15}function oe(){let t=document.activeElement;if(t&&t!==document.body){let i=t.closest(ee);if(i&&te(i)>0)return i}let n=Array.from(document.querySelectorAll(ee)).map(i=>({element:i,score:te(i)})).filter(i=>Number.isFinite(i.score)).sort((i,a)=>a.score-i.score);if(n.length>0&&n[0].score>0)return n[0].element;let o=document.querySelector('form, main, [role="main"]');return o&&g(o)?o:document.body}function ne(t){let e=t.cloneNode(!0);return e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(n=>n.remove()),e.querySelectorAll("*").forEach(n=>{let o=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id"];for(let i of Array.from(n.attributes))o.includes(i.name)||n.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function ae(t){return Array.from(t.querySelectorAll(S)).filter(e=>g(e)&&!N(e)).slice(0,100).map(e=>_(e,"answer"))}function ie(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),n=new Set,o=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(S)))if(!(n.has(a)||!g(a)||!N(a))&&(n.add(a),o.push(_(a,"navigation")),o.length>=10))return o;return o}function v(t=!1){let e=oe();t&&e.parentElement&&e.parentElement!==document.body&&(e=e.parentElement);let n=u(e.innerText,16e3),o=ae(e),i=ie(e),a=[...o,...i].slice(0,120);return!n||!a.length?null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:ne(e),controls:a,scope:e}}function qe(){let t=document.body.innerText||document.documentElement.innerText,e=u(t,8e3);return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina Inteira",questionText:e,htmlSnippet:"<!-- HTML omitido no fallback -->",controls:[],scope:document.body}}var ee,x=K(()=>{"use strict";k();ee=[".Qr7Oae",".geSAlb",'[role="listitem"]',".que",".form-group",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container","[data-question-id]",'[data-testid*="question" i]','[class*="question" i]','[class*="pergunta" i]','[id*="question" i]','[id*="pergunta" i]',"fieldset","form","article","section",'[role="group"]','[role="region"]','[role="dialog"]',"main"].join(",")});var V=`Voc\xEA \xE9 o EasyQuiz Engine v3.0. Retorne JSON estrito.
Regras Absolutas:
1. "pageType": "question" (se h\xE1 pergunta), "info" (avisos), "start" (in\xEDcio), "conclusion" (FIM/NOTA: retorne actions vazias).
...
3. "needsMoreContext": true se n\xE3o houver dados suficientes.
4. "actions": Array de comandos minificados:
   ...
   - { "t": "js", "v": "$eq.click('botao')" }`;function U(t,e,n){let i=t.questionText.length<80?`
[HTML FRAGMENT]:
${t.htmlSnippet}`:`
[HTML FRAGMENT]: Omitido (Texto puro suficiente. Foque no texto e nos controles).`;return`--- NOVA QUEST\xC3O ---
...
[CONTROLES]:
${JSON.stringify(t.controls.map(a=>({id:a.id,type:a.type,lbl:a.label,val:a.value,opt:a.options.length?a.options:void 0})),null,0)}

[IMAGENS ANEXADAS]: ${e.length}
Responda em JSON.`}var B=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Recomendado)",description:"Ultrapoderoso, hiper-r\xE1pido modelo 2026 para agents."},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash",description:"Alta velocidade para tarefas simples e fallback."},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",description:"Velocidade e estabilidade."},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro",description:"Racioc\xEDnio longo de elite."}],be={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},needsMoreContext:{type:"BOOLEAN"},warnings:{type:"ARRAY",items:{type:"STRING"}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js"]},id:{type:"STRING"},v:{},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}}},required:["t"]}}},required:["pageType","mode","confidence","rationale","needsMoreContext","actions"]};function ve(t){return t.trim().replace(/^google\//,"").replace(/^models\//,"")||"gemini-3.8-flash"}function J(t,e){try{let n=JSON.parse(t),o=n.error?.message||n.message||"";if(/API_KEY_INVALID|API key not valid/i.test(o))return"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada. Verifique no Google AI Studio.";if(/RESOURCE_EXHAUSTED|Quota exceeded/i.test(o))return"Limite de cota do Gemini atingido temporariamente. Aguarde alguns segundos.";if(o)return`Erro Gemini (${e}): ${o}`}catch{}return`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}). Verifique sua conex\xE3o e chave.`}async function Y(t){let e=t.trim();if(!e)return{ok:!1,message:"Insira sua chave de API."};let n=`https://generativelanguage.googleapis.com/v1beta/models/gemini-3.8-flash:generateContent?key=${encodeURIComponent(e)}`;try{let o=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})});if(!o.ok){let i=await o.text();return{ok:!1,message:J(i,o.status)}}return{ok:!0,message:"Chave de API validada com sucesso no Gemini 3.8 Flash!"}}catch(o){return{ok:!1,message:o instanceof Error?`Erro de conex\xE3o: ${o.message}`:"Erro desconhecido ao testar chave."}}}async function R(t,e,n){let o=n.apiKey.trim();if(!o)throw new Error("Chave de API n\xE3o configurada.");let i=ve(n.model),s=[{text:U(t,e,n)}];for(let d of e)s.push({inline_data:{mime_type:d.mediaType,data:d.base64}});let r={system_instruction:{parts:[{text:V}]},contents:[{role:"user",parts:s}],generationConfig:{temperature:.05,maxOutputTokens:400,response_mime_type:"application/json",response_schema:be}},l=n.uiMode==="easy"?B.map(d=>d.id):[i];n.uiMode==="easy"&&!l.includes(i)&&l.unshift(i);let c=new Error("Nenhum modelo tentado.");for(let d of new Set(l)){let E=`https://generativelanguage.googleapis.com/v1beta/models/${d}:generateContent?key=${encodeURIComponent(o)}`;try{let p=await fetch(E,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!p.ok){let ge=await p.text(),fe=J(ge,p.status);throw new Error(fe)}let G=await p.json(),z=G.candidates?.[0];if(!z||!z.content?.parts?.[0]?.text)throw new Error("A IA n\xE3o retornou uma resposta estruturada v\xE1lida.");let h;try{h=JSON.parse(z.content.parts[0].text)}catch{throw new Error("Falha ao decodificar o plano JSON da IA.")}return Array.isArray(h.actions)||(h.actions=[]),Array.isArray(h.warnings)||(h.warnings=[]),typeof h.confidence!="number"&&(h.confidence=.8),h.usedModel=d,{plan:h,rawUsage:G.usageMetadata,usedModel:d}}catch(p){if(c=p,n.uiMode!=="easy"||c.message.includes("inv\xE1lida"))throw c;console.warn(`[EasyQuiz] Fallback: Falha no modelo ${d}. Tentando pr\xF3ximo...`,p)}}throw c}var m={apiKey:"",model:"gemini-3.8-flash",uiMode:"advanced",modeHint:"",engine:"smart",dryRun:!1,autoApply:!1,autoAdvance:!1,hostDarkMode:!0,confidenceThreshold:.8};var W="easyquiz_settings_v2";function P(){try{let t=localStorage.getItem(W);if(!t){let n=localStorage.getItem("easyquiz_settings_v1");if(n){let o=JSON.parse(n);return{...m,apiKey:o.apiKey||""}}return{...m}}let e=JSON.parse(t);return{apiKey:typeof e.apiKey=="string"?e.apiKey.trim():m.apiKey,model:typeof e.model=="string"&&e.model?e.model:m.model,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:m.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:!!e.autoApply,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:m.confidenceThreshold}}catch{return{...m}}}function O(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);return e?JSON.parse(e):{}}catch{return{}}}function X(t,e){let o={...O(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function Z(t){let n={...P(),...t};try{localStorage.setItem(W,JSON.stringify(n))}catch(o){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",o)}return n}x();k();function f(t){let e=CSS.escape(t),n=document.querySelector(`[data-easyquiz-id="${e}"]`);if(n||(n=document.querySelector(`#${e}, [name="${e}"]`),n))return n;let o=`//*[text()="${t}"] | //*[contains(text(),"${t}")]`,i=document.evaluate(o,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null);return i.singleNodeValue?i.singleNodeValue:null}function w(t,e){for(let n of e)t.dispatchEvent(new Event(n,{bubbles:!0,composed:!0}))}function b(t,e){let n=0,o=0;if(e&&e.length===2)n=e[0],o=e[1];else{let a=t.getBoundingClientRect();n=a.left+a.width/2,o=a.top+a.height/2}let i={bubbles:!0,cancelable:!0,composed:!0,clientX:n,clientY:o};t.dispatchEvent(new PointerEvent("pointerdown",i)),t.dispatchEvent(new MouseEvent("mousedown",i)),t.dispatchEvent(new PointerEvent("pointerup",i)),t.dispatchEvent(new MouseEvent("mouseup",i)),t.click()}function re(t,e){if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let n=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,o=Object.getOwnPropertyDescriptor(n,"value")?.set;o?o.call(t,e):t.value=e,w(t,["input","change","blur"]);return}if(t.isContentEditable){t.textContent=e,w(t,["input","change","blur"]);return}throw new Error(`N\xE3o \xE9 poss\xEDvel injetar texto em <${t.tagName.toLowerCase()}>`)}function le(t,e){if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){t.checked!==e&&t.click(),t.checked!==e&&(Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(t,e),w(t,["input","change"]));return}let n=t.getAttribute("role");if(n==="radio"||n==="checkbox"){t.getAttribute("aria-checked")==="true"!==e&&(b(t),t.setAttribute("aria-checked",e?"true":"false"),w(t,["input","change"]));return}b(t)}function Ae(t,e){if(t instanceof HTMLSelectElement){for(let n of Array.from(t.options))n.selected=e.includes(n.value);w(t,["input","change"]);return}throw new Error("Elemento n\xE3o \xE9 select.")}var ce={fill:(t,e)=>{let n=f(t);n?re(n,e):console.warn(`$eq.fill: Elemento ${t} n\xE3o encontrado`)},click:t=>{let e=f(t);e?b(e):console.warn(`$eq.click: Elemento ${t} n\xE3o encontrado`)},check:(t,e)=>{let n=f(t);n?le(n,e):console.warn(`$eq.check: Elemento ${t} n\xE3o encontrado`)},drag:(t,e)=>{let n=f(t),o=f(e);n&&o&&(n.dispatchEvent(new DragEvent("dragstart",{bubbles:!0})),o.dispatchEvent(new DragEvent("drop",{bubbles:!0})),n.dispatchEvent(new DragEvent("dragend",{bubbles:!0})))}};window.$eq=ce;function se(t){if(t.t==="js"){let o=String(t.v||"");try{new Function("$eq",o)(ce)}catch(i){throw console.error("[EasyQuiz JS Error]",i),new Error("Falha na execu\xE7\xE3o JS gerada pela IA.")}return}let e=t.id||"",n=f(e);if(!n&&t.t!=="adv")throw new Error(`Alvo '${e}' n\xE3o encontrado para a\xE7\xE3o '${t.t}'`);switch(t.t){case"val":n&&re(n,String(t.v));break;case"chk":n&&le(n,!!t.c);break;case"sel":if(n){let i=Array.isArray(t.v)?t.v:[String(t.v)];Ae(n,i)}break;case"clk":n&&b(n,t.co);break;case"adv":let o=n;if(!o){let i=Array.from(document.querySelectorAll('button, a, input[type="submit"]')).filter(a=>D.test(a.textContent||a.value||""));i.length&&(o=i[0])}if(o){let i=t.id||o.textContent?.trim()||o.value?.trim()||"";i&&X(window.location.hostname,{advanceSelector:i}),b(o)}else throw new Error("Bot\xE3o de avan\xE7o n\xE3o encontrado.");break}}async function de(t,e){let n=t.actions.filter(a=>a.t!=="adv"),o=t.actions.filter(a=>a.t==="adv");for(let a of n)se(a);let i=!1;return e&&o.length>0&&(await new Promise(a=>setTimeout(a,600)),se(o[0]),i=!0),{applied:n.length,advanced:i}}var q=null,$=[];function A(){q&&(q.style.removeProperty("outline"),q.style.removeProperty("outline-offset"),q=null);for(let t of $)t.style.removeProperty("outline"),t.style.removeProperty("outline-offset"),t.style.removeProperty("background-color");$=[]}function Q(t){A(),q=t,t.style.outline="2px solid #00e5ff",t.style.outlineOffset="4px"}function ue(t){for(let e of t){if(e.t==="adv"||e.t==="js"||!e.id)continue;let n=CSS.escape(e.id),o=document.querySelector(`[data-easyquiz-id="${n}"]`);if(!o)continue;let i=o.closest('label, [role="listitem"], .answer, .form-check')||o;i.style.outline="2px solid #00ff88",i.style.outlineOffset="2px",i.style.backgroundColor="rgba(0, 255, 136, 0.08)",$.push(i)}}k();var T=4,Te=1200,F=12e5;function C(t){return new Promise((e,n)=>{let o=new FileReader;o.onerror=()=>n(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(t)})}async function L(t){let e=0,n=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,n=t.naturalHeight||t.height):(e=t.width,n=t.height),e<=0||n<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,Te/Math.max(e,n)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(n*o)),s=document.createElement("canvas");s.width=i,s.height=a;let r=s.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,i,a),r.drawImage(t,0,0,i,a),new Promise((l,c)=>{s.toBlob(d=>d?l(d):c(new Error("Falha compress\xE3o.")),"image/jpeg",.8)})}async function pe(t){try{let e=t.cloneNode(!0),n=t.offsetWidth||500,o=t.offsetHeight||500,i=`
...
`;var ke=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Me=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],I=class{host;shadow;callbacks;autopilot;initialSettings;launcherBtn;panelEl;statusBox;resultContainer;apiKeyInput;testKeyBtn;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;analyzeBtn;applyBtn;tabEasyBtn;tabAdvBtn;contentEasy;contentAdv;apToggleBtn;apConsole;constructor(e,n){this.initialSettings=e,this.callbacks=n,this.autopilot=new H({onStatusChange:(o,i,a)=>{if(this.apConsole){let s=document.createElement("div");s.textContent=i,a&&s.classList.add(a),this.apConsole.appendChild(s),this.apConsole.scrollTop=this.apConsole.scrollHeight}o==="analyzing"?this.setBusy(!0,"Autopilot: IA analisando..."):(o==="advancing"||o==="waiting")&&this.setBusy(!1)},onRequestAnalysis:async()=>{try{return await this.callbacks.onAnalyze()||null}catch{return null}}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),this.shadow.innerHTML=`
      <style>${he}</style>
    ...
    `;let i=this.shadow.querySelector("#eq-rationale-text");i.textContent=e.rationale;let a=this.shadow.querySelector("#eq-actions-list");a.innerHTML="";for(let s of e.actions){let r=document.createElement("div");r.className="eq-action-item";let l="";s.t==="chk"?l=`[CHK] ${s.id}`:s.t==="val"?l=`[INJ] "${s.v}" em ${s.id}`:s.t==="sel"?l=`[SEL] ${Array.isArray(s.v)?s.v.join(","):s.v} em ${s.id}`:s.t==="clk"?l=`[CLK] ${s.id}`:s.t==="adv"?l="[AVAN\xC7AR]":s.t==="js"&&(l=`[JS] ${String(s.v)}`),r.innerHTML=`<span class="eq-action-bullet">\u25A0</span> <span>${l}</span>`,a.appendChild(r)}this.applyBtn.disabled=!n||!e.actions.length}destroy(){this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};async function Ce(){let t=window;if(t.__easyquiz){t.__easyquiz.toggle();return}let e=P(),n=null,o=new I(e,{onAnalyze:()=>i(),onApply:()=>void a(),onDestroy:()=>{A(),delete t.__easyquiz},onSettingsChange:s=>{e=Z(s)}});t.__easyquiz={toggle:()=>o.toggle(),destroy:()=>o.destroy(),analyze:()=>void i()},window.addEventListener("keydown",s=>{if(s.altKey&&(s.key==="q"||s.key==="Q")){if(s.preventDefault(),!o)return;o.toggle(!0),i()}});async function i(){if(!e.apiKey){o.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),o.toggle(!0);return}o.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),A();try{let s=v(!1);if(!s){o.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info");let{captureFullPageText:c}=await Promise.resolve().then(()=>(x(),M));s=c()}Q(s.scope),o.setStatus(`Quest\xE3o localizada (${s.controls.length} controles). Otimizando imagens...`,"info");let r=await j(s.scope);o.setStatus(`Consultando Gemini (${e.model}) com ${r.length} imagem(ns) anexada(s)...`,"info");let{plan:l}=await R(s,r,e);if(l.needsMoreContext){if(o.setStatus("Expandindo contexto ao redor da quest\xE3o para maior assertividade...","info"),s=v(!0),!s){let{captureFullPageText:d}=await Promise.resolve().then(()=>(x(),M));s=d()}Q(s.scope),r=await j(s.scope),l=(await R(s,r,e)).plan}return n=l,ue(l.actions),o.setPlan(l,!e.dryRun),l.pageType==="conclusion"?o.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success"):o.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success"),e.autoApply&&!e.dryRun&&await a(),l}catch(s){A();let r=s instanceof Error?s.message:"Falha desconhecida na an\xE1lise.";o.setStatus(r,"error");return}finally{o.setBusy(!1)}}async function a(){if(!n){o.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){o.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let s=e.autoAdvance&&n.confidence>=e.confidenceThreshold&&!n.needsMoreContext;o.setBusy(!0,"Aplicando respostas no formul\xE1rio...");try{let r=await de(n,s);o.setStatus(`Sucesso: ${r.applied} resposta(s) preenchida(s)${r.advanced?" e pr\xF3xima quest\xE3o acionada":""}.`,"success")}catch(r){let l=r instanceof Error?r.message:"Falha ao aplicar plano.";o.setStatus(l,"error")}finally{o.setBusy(!1)}}o.toggle(!0)}Ce().catch(t=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",t),window.alert(`EasyQuiz: falha ao iniciar: ${t instanceof Error?t.message:String(t)}`)});})();
