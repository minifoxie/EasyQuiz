...
[HTML]:
${n.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",f="";if(i&&typeof document<"u")try{let A=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(x=>{let q=x,L=q.getBoundingClientRect?.()||{width:0,height:0};return L.width>0&&L.height>0&&!q.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(x=>{let q=x,L=q.tagName.toLowerCase(),E=q.id?`#${q.id}`:"",w=q.className&&typeof q.className=="string"?`.${q.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",T=(q.textContent||q.value||q.getAttribute("aria-label")||"").trim().slice(0,60),y=q.getAttribute("type")||q.getAttribute("role")||"";return`${L}${E}${w}[${y}] txt="${T}"`});A.length>0&&(f=`
[DOM-INTERATIVO]:
${A.join(`
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let A=p.filter(C=>C.type==="checkbox"||C.type==="chk"),x=new Set(p.filter(C=>C.type==="radio").map(C=>C.name).filter(Boolean)),q=A.filter(C=>!C.name||!x.has(C.name)),L=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),E=q.length>=2||L,w=x.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&x.size>=1,T=p.every(C=>C.type==="radio"||C.type==="chk")&&x.size===1&&!E&&!w,y=p.filter(C=>C.type==="text"||C.type==="number"||C.type==="val"||C.tag==="input"||C.tag==="textarea"),S=y.length>=2;return(w?`[GRADE VERDADEIRO/FALSO (${x.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${x.size} afirma\xE7\xF5es \u2014 emita ${x.size} a\xE7\xF5es chk separadas + adv]
...
`;var be="v3.1.4";var $t=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:n=>n})}catch{}return null})();function zn(n,e){try{if($t){n.innerHTML=$t.createHTML(e);return}}catch{}try{if(typeof n.setHTMLUnsafe=="function"){n.setHTMLUnsafe(e);return}}catch{}n.innerHTML=e}var Pn=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],On=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Ze=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;terminalCmdHistory=[];terminalCmdHistoryIdx=-1;terminalMode="terminal";_terminalInited=!1;liveTerminalOutput=null;terminalInputEl=null;outputSearchQuery="";outputSortNewest=!0;_reconnectContextbarBtns=()=>{};_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn=null;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;toastStackingCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new We({onStatusChange:(i,c,l)=>{this.logToConsole(c,l),i==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):i==="advancing"||i==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):i==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),c.includes("conclus\xE3o")||c.includes("finalizada")||c.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):i==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(i,c)=>{try{return await this.callbacks.onAnalyze(i,c,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),zn(this.shadow,`
              ...
              <div class="eq-view-pane" id="eq-view-debug" style="display:none;flex-direction:column;">
                ...
                <div id="eq-output-toolbar" style="display:none;align-items:center;gap:5px;padding:5px 10px;background:#080808;border-bottom:1px solid #161616;flex-shrink:0;">
                  <div style="position:relative;display:inline-flex;">
                    ...
                    <div id="eq-output-filter-menu" hidden style="position:absolute;top:calc(100% + 5px);left:0;z-index:9999;background:rgba(8,8,14,0.72);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:5px;min-width:172px;box-shadow:0 12px 32px rgba(0,0,0,0.75);">
                      ...
                      <label class="eq-filter-lbl" id="eq-filter-opt-all"   style="display:flex;align-items:center;gap:7px;padding:5px 10px;cursor:pointer;border-radius:5px;transition:background 0.08s;" onmouseover="this.style.background='rgba(255,255,255,0.05)'" onmouseout="this.style.background='transparent'"><input type="checkbox" id="eq-fchk-all"   checked style="accent-color:#aaa;cursor:pointer;"> <span style="display:inline-flex;width:12px;height:12px;color:#777;">${I.list}</span>     <span style="font-size:10px;color:#aaa;font-family:monospace;">Todos</span>    <span id="eq-dbg-count-all"   style="margin-left:auto;color:#333;font-size:8px;font-family:monospace;">0</span></label>
                      <label class="eq-filter-lbl" id="eq-filter-opt-error" style="display:flex;align-items:center;gap:7px;padding:5px 10px;cursor:pointer;border-radius:5px;transition:background 0.08s;" onmouseover="this.style.background='rgba(255,85,85,0.08)'"   onmouseout="this.style.background='transparent'"><input type="checkbox" id="eq-fchk-error"         style="accent-color:#ff5555;cursor:pointer;"> <span style="display:inline-flex;width:12px;height:12px;color:#ff5555;">${I.info}</span>    <span style="font-size:10px;color:#aaa;font-family:monospace;">Erros</span>    <span id="eq-dbg-count-error" style="margin-left:auto;color:#333;font-size:8px;font-family:monospace;">0</span></label>
                      <label class="eq-filter-lbl" id="eq-filter-opt-ai"    style="display:flex;align-items:center;gap:7px;padding:5px 10px;cursor:pointer;border-radius:5px;transition:background 0.08s;" onmouseover="this.style.background='rgba(96,165,250,0.08)'"  onmouseout="this.style.background='transparent'"><input type="checkbox" id="eq-fchk-ai"           style="accent-color:#60a5fa;cursor:pointer;"> <span style="display:inline-flex;width:12px;height:12px;color:#60a5fa;">${I.sparkles}</span> <span style="font-size:10px;color:#aaa;font-family:monospace;">IA</span>       <span id="eq-dbg-count-ai"    style="margin-left:auto;color:#333;font-size:8px;font-family:monospace;">0</span></label>
                      <label class="eq-filter-lbl" id="eq-filter-opt-dom"   style="display:flex;align-items:center;gap:7px;padding:5px 10px;cursor:pointer;border-radius:5px;transition:background 0.08s;" onmouseover="this.style.background='rgba(74,222,128,0.06)'"  onmouseout="this.style.background='transparent'"><input type="checkbox" id="eq-fchk-dom"          style="accent-color:#4ade80;cursor:pointer;"> <span style="display:inline-flex;width:12px;height:12px;color:#4ade80;">${I.code}</span>    <span style="font-size:10px;color:#aaa;font-family:monospace;">DOM/Exec</span> <span id="eq-dbg-count-dom"   style="margin-left:auto;color:#333;font-size:8px;font-family:monospace;">0</span></label>
                    </div>
                  </div>
                  <button id="eq-output-sort-btn" type="button" title="Ordenar (mais recente/mais antigo)" style="display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.07);border-radius:5px;color:#aaa;cursor:pointer;flex-shrink:0;transition:color 0.12s;"><span style="display:inline-flex;width:13px;height:13px;transform:rotate(270deg);transition:transform 0.2s;">${I.chevronRight}</span></button>
                  <div style="flex:1;display:flex;align-items:center;gap:5px;background:#0d0d0d;border:1px solid #1a1a1a;border-radius:5px;padding:0 8px;height:24px;"><span style="color:#2a2a2a;display:inline-flex;flex-shrink:0;width:10px;height:10px;">${I.analyze}</span><input id="eq-output-search" type="text" placeholder="buscar logs..." autocomplete="off" style="flex:1;background:transparent;border:none;outline:none;color:#777;font-size:9.5px;font-family:'Cascadia Code','Fira Code',monospace;caret-color:#555;" /><button id="eq-output-search-clear" type="button" style="display:none;background:transparent;border:none;color:#333;cursor:pointer;font-size:9px;padding:0;line-height:1;">\u2715</button></div>
                ...
                <div class="eq-debug-error-card" id="eq-dbg-error-card" style="display:none;flex-shrink:0;">
                  <div class="eq-debug-error-header">
                    ...
                    <button class="eq-icon-btn" id="eq-dbg-copy-error-btn" type="button" title="Copiar" style="width:20px;height:20px;">${I.copy}</button>
                  </div>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new Ye(this.shadow,()=>{this.callbacks.onAnalyze(1)});let o=this.shadow.querySelector("#eq-open-hud-btn");o&&o.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),Ee.filter(i=>Y(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===e.model))),Pn.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===e.modeHint))),On.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.toastStackingCheckbox.checked=e.toastStacking??!0,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let s=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];D.init(s),this.apiKeyInput.value=D.getBestKey()||e.apiKey||"",this.renderKeysList();let a=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof a?.unref=="function"&&a.unref();let r=D.getBestKey()||e.apiKey;r&&Re(r).then(i=>{i&&i.length>0&&this.updateModelSelect(i,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];this.shadow.querySelector(".eq-views-wrapper")?.classList.toggle("is-brain-active",e==="brain");for(let s of t){let a=this.shadow.querySelector(`#eq-tab-${s}`),r=this.shadow.querySelector(`#eq-view-${s}`),i=s===e;a?.classList.toggle("active",i),r&&(r.style.display=i?"flex":"none")}switch(this.updateContextBar(e),e){case"brain":this.initBrainControls(),this.renderContextTree(),this.refreshInspectorView();break;case"metrics":try{this.updateTimingMetrics()}catch{}break;case"debug":try{this.refreshDebugView(),this.renderTerminalEntries(),this.initTerminalREPL()}catch{}break;case"settings":break}}updateContextBar(e){let t=this.shadow.querySelector("#eq-ctxbar-icon"),o=this.shadow.querySelector("#eq-ctxbar-name"),s=this.shadow.querySelector("#eq-ctxbar-sub"),a=this.shadow.querySelector("#eq-ctxbar-actions");if(!t||!o||!s||!a)return;a.innerHTML="";let i={resolver:{icon:I.sparkles,label:"Resolver",sub:"Autopilot & opera\xE7\xF5es",color:"#a78bfa",actions:()=>{let c=document.createElement("span");return c.id="eq-ctxbar-status",c.style.cssText="font-size:9px;font-weight:700;padding:2px 7px;border-radius:10px;background:rgba(167,139,250,0.13);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;letter-spacing:0.04em;",c.textContent="PRONTO",[c]}},brain:{icon:I.inspector,label:"C\xE9rebro da IA",sub:"Contexto & inspe\xE7\xE3o",color:"#60a5fa",actions:()=>{let c=this.shadow.querySelector("#eq-brain-canvas-toggle"),l=document.createElement("button");l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",l.innerHTML=this.brainCanvasHidden?I.eyeOff:I.eye,l.title="Mostrar/Ocultar canvas",l.addEventListener("click",()=>{c?.click(),l.innerHTML=this.brainCanvasHidden?I.eyeOff:I.eye});let u=document.createElement("button");return u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=I.copy,u.title="Copiar conte\xFAdo selecionado",u.addEventListener("click",()=>this.smartCopy()),[l,u]}},metrics:{icon:I.clock,label:"M\xE9tricas",sub:"Cron\xF4metro & hist\xF3rico",color:"#4ade80",actions:()=>{let c=document.createElement("button");c.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",c.innerHTML=I.copy,c.title="Copiar relat\xF3rio",c.addEventListener("click",()=>this.copyMetricsReport());let l=document.createElement("button");return l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.08);border:1px solid rgba(255,85,85,0.15);border-radius:4px;cursor:pointer;color:#ff8888;",l.innerHTML=I.trash,l.title="Zerar m\xE9tricas",l.addEventListener("click",()=>{this.shadow.querySelector("#eq-metrics-reset-btn")?.click()}),[c,l]}},debug:{icon:I.code,label:"Terminal",sub:"Comandos & logs",color:"#0098ff",actions:()=>{let c=document.createElement("div");c.style.cssText="display:inline-flex;align-items:center;gap:1px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:2px;";let l=(d,m,p)=>{let h=document.createElement("button");return h.id=d,h.type="button",h.textContent=m,h.style.cssText="font-size:9px;font-weight:600;padding:2px 8px;border-radius:3px;cursor:pointer;transition:all 0.1s;background:"+(p?"#1a1a1a":"transparent")+";border:1px solid "+(p?"#333":"transparent")+";color:"+(p?"#ddd":"#555")+";",h};c.appendChild(l("eq-term-mode-terminal","Terminal",!0)),c.appendChild(l("eq-term-mode-output","Output",!1));let u=document.createElement("button");u.id="eq-term-copy-btn",u.type="button",u.title="Copiar",u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=I.copy;let f=document.createElement("button");return f.id="eq-term-clear-btn",f.type="button",f.title="Limpar",f.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.06);border:1px solid rgba(255,85,85,0.12);border-radius:4px;cursor:pointer;color:#ff5555;",f.innerHTML=I.eraser,[c,u,f]}},settings:{icon:I.settings,label:"Configura\xE7\xF5es",sub:"Ajustes & prefer\xEAncias",color:"#fbbf24"}}[e];if(i&&(t.innerHTML=i.icon,t.style.color=i.color,o.textContent=i.label,o.style.color=i.color==="#a78bfa"?"#ccc":"#ddd",s.textContent=i.sub,i.actions))for(let c of i.actions())a.appendChild(c)}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let E=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!E))}),this.metricsResetBtn?.addEventListener("click",()=>{ke(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-scroll-toggle");t?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,t&&(t.style.color=this.autoScrollLogs?"#00ffcc":"#858585",t.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let o=this.shadow.querySelector("#eq-dbg-copy-logs");o?.addEventListener("click",()=>{let E=this.getFormattedLogs();navigator.clipboard.writeText(E).then(()=>{let w=o.innerHTML;o.innerHTML=I.check,setTimeout(()=>o.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let s=this.shadow.querySelector("#eq-dbg-copy-prompt");s?.addEventListener("click",()=>{let E=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(E).then(()=>{let w=s.innerHTML;s.innerHTML=`${I.check} Copiado!`,setTimeout(()=>s.innerHTML=w,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-context");a?.addEventListener("click",()=>{let E=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(E).then(()=>{let w=a.innerHTML;a.innerHTML=`${I.check} Copiado!`,setTimeout(()=>a.innerHTML=w,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-raw-resp");r?.addEventListener("click",()=>{let E=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(E).then(()=>{let w=r.innerHTML;r.innerHTML=`${I.check} Copiado!`,setTimeout(()=>r.innerHTML=w,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-error-btn");i?.addEventListener("click",()=>{let E=this.lastErrorMsg||"";navigator.clipboard.writeText(E).then(()=>{let w=i.innerHTML;i.innerHTML=I.check,setTimeout(()=>i.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",E=>{E.altKey&&(E.key==="q"||E.key==="Q"||E.key==="a"||E.key==="A")&&(E.preventDefault(),this.toggle())},!0);let c=E=>{let w=E.composedPath();w.includes(this.shadow)||(w.includes(this.sidebarEl)||w.includes(this.host))&&E.stopImmediatePropagation()};window.addEventListener("keydown",c,!0),window.addEventListener("keyup",c,!0),window.addEventListener("keypress",c,!0),this.apiKeyInput.addEventListener("input",()=>{let E=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:E})});let l=this.shadow.querySelector("#eq-keys-collapsible"),u=this.shadow.querySelector("#eq-keys-chevron"),f=this.shadow.querySelector("#eq-keys-section-header"),d=E=>{l&&(E?(l.style.display="none",u&&(u.style.transform="rotate(0deg)")):(l.style.display="block",l.style.maxHeight="none",l.style.overflow="visible",u&&(u.style.transform="rotate(90deg)")))},m=!1;try{m=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}d(m),f?.addEventListener("click",E=>{if(E.target?.closest("a"))return;let w=l?.style.display==="none";d(!w);try{localStorage.setItem("easyquiz_keys_collapsed",w?"false":"true")}catch{}});let p=this.shadow.querySelector("#eq-auto-menu-btn"),h=this.shadow.querySelector("#eq-auto-menu");h&&(h.hidden=!0),p?.classList.remove("is-open"),p?.addEventListener("click",E=>{if(E.stopPropagation(),!h)return;let w=h.hidden;h.hidden=!w,p.classList.toggle("is-open",!h.hidden)}),h?.querySelectorAll("[data-auto-action]").forEach(E=>{E.addEventListener("click",w=>{w.stopPropagation();let T=E.dataset.autoAction;T==="toggle"?this.analyzeBtn?.click():T==="memory"?(Be(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):T==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),h&&(h.hidden=!0),p?.classList.remove("is-open")})}),this.shadow.addEventListener("click",E=>{E.target.closest(".eq-menu-shell")||(h&&(h.hidden=!0),p?.classList.remove("is-open"))});let b=this.shadow.querySelector("#eq-result-toggle"),v=this.shadow.querySelector("#eq-result-body");b&&v&&(v.classList.add("is-collapsed"),b.classList.remove("is-open"),b.addEventListener("click",()=>{let E=b.classList.toggle("is-open");v.classList.toggle("is-collapsed",!E)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let E=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!E){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let w=D.addKey(E);if(w.ok){let T=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${T.length} chaves ativas no pool)`,"success"),d(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Qe(E).then(y=>{y.ok?(D.markSuccess(E,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(D.markInvalid(E,y.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${y.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(w.message,"warning")}),this.keyMoreBtn.addEventListener("click",E=>{E.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",E=>{let w=E.target;!w.closest("#eq-key-context-menu")&&!w.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let E=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(E!==null&&E.trim()){let w=E.trim().replace(/^["']|["']$/g,""),T=D.addKey(w);if(T.ok){let y=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:y[0],apiKeys:y}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(T.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let E=await navigator.clipboard.readText();if(E){let w=E.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=w,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let E=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(E!==null&&E.trim()){let w=E.trim().replace(/^["']|["']$/g,"");if(D.addKey(w).ok){let y=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:y[0],apiKeys:y}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let E=this.apiKeyInput.type==="password";this.apiKeyInput.type=E?"text":"password";let w=this.shadow.querySelector("#eq-menu-vis-icon"),T=this.shadow.querySelector("#eq-menu-vis-text");w&&(w.innerHTML=E?I.eyeOff:I.eye),T&&(T.textContent=E?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let E=document.createElement("div");E.id="eq-bulk-overlay",E.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let w=document.createElement("div");w.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),w.innerHTML=`
      ...
      `,E.appendChild(w),this.shadow.appendChild(E);let T=w.querySelector("#eq-bulk-ta"),y=w.querySelector("#eq-bulk-status"),S=w.querySelector("#eq-bulk-import"),k=w.querySelector("#eq-bulk-paste-btn"),C=w.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>T?.focus());let M=()=>{E.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(z=>{E.addEventListener(z,B=>{B.stopPropagation(),B.stopImmediatePropagation()},!0)}),E.addEventListener("keydown",z=>{z.key==="Escape"&&M()}),E.addEventListener("click",z=>{z.target===E&&M()}),w.querySelector("#eq-bulk-x")?.addEventListener("click",M),w.querySelector("#eq-bulk-cancel")?.addEventListener("click",M),C.addEventListener("click",()=>{T.value="",y.textContent="",T.focus()}),k.addEventListener("click",async()=>{try{let z=await navigator.clipboard?.readText();z?(T.value=z,T.focus(),y.style.color="#38bdf8",y.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(y.style.color="#fbbf24",y.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{y.style.color="#fbbf24",y.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",T.focus()}}),w.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let z=T.value.trim();if(!z){y.style.color="#f87171",y.textContent="Insira pelo menos uma chave de API antes de importar.";return}let B=z.match(/AIza[0-9A-Za-z\-_]{35}/g),N=[];if(B&&B.length>0?N=Array.from(new Set(B)):N=Array.from(new Set(z.split(/[\n,;\s]+/).map(F=>F.trim().replace(/^["'`]|["'`]$/g,"")).filter(F=>F.length>=20))),N.length===0){y.style.color="#f87171",y.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}y.style.color="#00e5ff",y.textContent=`Processando ${N.length} chave(s)...`,S.disabled=!0,S.style.opacity="0.6";let j=0,X=0;for(let F of N){let J=D.addKey(F);J.ok?j++:J.message.includes("j\xE1 est\xE1 cadastrada")&&X++}if(j>0){let F=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:F[0],apiKeys:F}),d(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}y.textContent=`${j} adicionada(s), ${X} duplicada(s). Validando modelo em paralelo...`;let Z=D.exportRawKeys(),K=this.modelSelect?.value||"gemini-3.5-flash-lite",ee=await it(K,Z);ee.ok?(D.markSuccess(ee.key,200),y.style.color="#4ade80",y.textContent=` ${j} adicionada(s), ${X} duplicada(s). Modelo '${ee.model}' pronto!`):(y.style.color="#fbbf24",y.textContent=`${j} adicionada(s), ${X} duplicada(s). Aviso: ${ee.message}`),this.renderKeysList(),S.disabled=!1,S.style.opacity="1",j>0&&(this.setStatus(` Lote importado: ${j} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(M,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let E=D.exportRawKeys(),w=document.createElement("div");w.id="eq-text-editor-overlay",w.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let T=document.createElement("div");T.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),T.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
      ...
      `,w.appendChild(T),this.shadow.appendChild(w);let y=T.querySelector("#eq-edittext-ta"),S=T.querySelector("#eq-edittext-status");y.value=E.join(`
`),requestAnimationFrame(()=>{y.focus(),y.select()});let k=()=>w.remove();["keydown","keyup","keypress","paste","copy","cut"].forEach(C=>{w.addEventListener(C,M=>{M.stopPropagation(),M.stopImmediatePropagation()},!0)}),w.addEventListener("keydown",C=>{C.key==="Escape"&&k()}),w.addEventListener("click",C=>{C.target===w&&k()}),T.querySelector("#eq-edittext-x")?.addEventListener("click",k),T.querySelector("#eq-edittext-cancel")?.addEventListener("click",k),T.querySelector("#eq-edittext-clear")?.addEventListener("click",()=>{confirm("Apagar todas as chaves? Esta a\xE7\xE3o \xE9 irrevers\xEDvel.")&&(y.value="",S.style.color="#fbbf24",S.textContent="Campo limpo. Clique em Salvar para confirmar a remo\xE7\xE3o de todas as chaves.")}),T.querySelector("#eq-edittext-save")?.addEventListener("click",()=>{let C=y.value.split(/[\n\r]+/).map(B=>B.trim().replace(/^["']|["']$/g,"")).filter(B=>B.length>5),M=Array.from(new Set(C));D.init(M);let z=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:z[0]||"",apiKeys:z}),this.renderKeysList(),S.style.color="#4ade80",M.length===0?S.textContent=" Todas as chaves removidas.":S.textContent=` ${M.length} chave(s) salva(s) com sucesso!`,this.setStatus(M.length>0?` ${M.length} chave(s) salva(s)!`:"Todas as chaves foram removidas.",M.length>0?"success":"info"),setTimeout(k,1400)})}),this.shadow.querySelector("#eq-menu-delete-all")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let E=D.getAllKeys();if(E.length===0)return this.setStatus("Nenhuma chave para apagar.","info");confirm(`Apagar todas as ${E.length} chave(s) permanentemente?`)&&(D.init([]),this.callbacks.onSettingsChange({apiKey:"",apiKeys:[]}),this.renderKeysList(),this.setStatus("Todas as chaves foram removidas.","info"))}),this.shadow.querySelector("#eq-menu-test")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;let E=D.getAllKeys();if(E.length===0)return this.setStatus("Nenhuma chave cadastrada para testar.","error");this.setStatus(` Testando ${E.length} chave(s) em paralelo...`,"info");let w=this.modelSelect?.value||"gemini-3.5-flash-lite",T=E.map(S=>S.key),y=await it(w,T);if(y.ok)D.markSuccess(y.key,150),this.setStatus(` Validado! Modelo '${y.model}' respondeu com sucesso!`,"success");else{let S=await Promise.allSettled(T.map(C=>Qe(C))),k=0;S.forEach((C,M)=>{if(C.status==="fulfilled"&&C.value.ok)k++,D.markSuccess(T[M],200);else{let z=C.status==="fulfilled"?C.value.message:String(C.reason);D.markInvalid(T[M],z)}}),this.setStatus(`Teste: ${k}/${E.length} chave(s) v\xE1lidas. ${y.message}`,k>0?"info":"error")}this.renderKeysList()});let x=()=>{this.keyContextMenu.hidden=!0,window.confirm("Deseja realmente resetar todos os dados, chaves e mem\xF3ria de sess\xE3o do EasyQuiz?")&&(this.autopilot.isActive()&&this.autopilot.stop(),this.updateAutopilotUi(!1),this.setBusy(!1),Tt(),ke(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.className="eq-live-stopwatch-status"),this.updateTimingMetrics(),this.apiKeyInput.value="",this.callbacks.onSettingsChange({apiKey:""}),this.setStatus("Todos os dados do EasyQuiz foram limpos.","info"),this.logToConsole("> [SYS] Armazenamento local resetado.","text-yellow"))};this.shadow.querySelector("#eq-menu-reset")?.addEventListener("click",x),this.shadow.querySelector("#eq-reset-all-btn")?.addEventListener("click",x),this.apToggleBtn?.addEventListener("click",()=>{if(this.autopilot.isActive())this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setInterrupted("Autopilot interrompido imediatamente pelo usu\xE1rio.");else{if(!this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"")){this.setStatus("Configure sua chave de API Gemini na aba Configura\xE7\xF5es antes de ligar o Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,st(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Autopilot ativo. Monitorando exerc\xEDcios...","info")}}),this.shadow.querySelector("#eq-ap-clear-memory")?.addEventListener("click",()=>{Be(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")});let L=this.shadow.querySelector("#eq-copy-console-btn");L?.addEventListener("click",()=>{let E=this.apConsole?.innerText||"";navigator.clipboard.writeText(E).then(()=>{let w=L.innerHTML;L.innerHTML=I.check,setTimeout(()=>L.innerHTML=w,1800)})}),this.copyPromptBtn?.addEventListener("click",()=>{let E=this.inspPrompt.textContent||"";navigator.clipboard.writeText(E).then(()=>{if(!this.copyPromptBtn)return;let w=this.copyPromptBtn.innerHTML;this.copyPromptBtn.innerHTML=`${I.check} Copiado!`,setTimeout(()=>this.copyPromptBtn.innerHTML=w,2e3)})}),this.modelSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({model:this.modelSelect.value})),this.modeSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({modeHint:this.modeSelect.value})),this.engineSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({engine:this.engineSelect.value})),this.dryRunCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({dryRun:this.dryRunCheckbox.checked})),this.autoApplyCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoApply:this.autoApplyCheckbox.checked})),this.autoAdvanceCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoAdvance:this.autoAdvanceCheckbox.checked})),this.useVisionCheckbox.addEventListener("change",()=>{let E=this.useVisionCheckbox.checked;this.callbacks.onSettingsChange({useVision:E}),this.setStatus(E?"Vis\xE3o Computacional ativada (capturas habilitadas).":"Modo DOM R\xE1pido ativado (capturas desabilitadas).","info")}),this.hostDarkModeCheckbox.addEventListener("change",()=>{let E=this.hostDarkModeCheckbox.checked;this.callbacks.onSettingsChange({hostDarkMode:E}),this.applyHostDarkMode(E)}),this.analyzeBtn?.addEventListener("click",async()=>{if(this.analyzeBtn.classList.contains("danger")){this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setBusy(!1),this.setInterrupted("Resolver Autopilot interrompido pelo usu\xE1rio.");return}if(!this.apiKeyInput.value.trim().replace(/^['"]|['"]$/g,"")){this.setStatus("Configure sua chave de API Gemini antes de ativar o Resolver Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,st(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Resolver Autopilot ativo. Monitorando e respondendo...","info")}),this.applyBtn&&this.applyBtn.addEventListener("click",()=>this.callbacks.onApply())}startStopwatch(){this.stopStopwatch(),this.stopwatchStartTime=Date.now();let e=()=>{let t=((Date.now()-this.stopwatchStartTime)/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)};e(),this.stopwatchInterval=setInterval(e,100)}stopStopwatch(e){if(this.stopwatchInterval&&(clearInterval(this.stopwatchInterval),this.stopwatchInterval=null),e!==void 0){let t=(e/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)}}setLogFilter(e){this.activeLogFilter=e;let t=["all","error","ai","dom"];for(let o of t){let s=this.shadow.querySelector(`#eq-dbg-filter-${o}`);o===e?s?.classList.add("active"):s?.classList.remove("active")}this.renderTerminalEntries()}updateLogCounters(){let e=0,t=0,o=0;for(let s of this.logEntries)s.category==="error"?e++:s.category==="ai"?t++:s.category==="dom"&&o++;this.dbgCountAll&&(this.dbgCountAll.textContent=String(this.logEntries.length)),this.dbgCountError&&(this.dbgCountError.textContent=String(e)),this.dbgCountAi&&(this.dbgCountAi.textContent=String(t)),this.dbgCountDom&&(this.dbgCountDom.textContent=String(o))}renderTerminalEntries(){if(!this.liveDebugTerminal)return;this.liveDebugTerminal.replaceChildren();let e=this.activeLogFilter==="all"?[...this.logEntries]:this.logEntries.filter(t=>t.category===this.activeLogFilter);if(this.outputSearchQuery){let t=this.outputSearchQuery.toLowerCase();e=e.filter(o=>o.message.toLowerCase().includes(t))}if(this.outputSortNewest||(e=e.reverse()),e.length===0){let t=document.createElement("div");t.style.cssText="color:#333;font-style:italic;white-space:pre-wrap;",t.textContent=this.outputSearchQuery?'Nenhum resultado para "'+this.outputSearchQuery+'".':'Nenhum log para o filtro "'+this.activeLogFilter.toUpperCase()+'".',this.liveDebugTerminal.appendChild(t);return}for(let t of e){let o=document.createElement("div");o.style.cssText="padding:1px 0;white-space:pre-wrap;overflow-wrap:break-word;word-break:break-word;max-width:100%;",o.textContent=t.message,t.colorClass&&(o.className=t.colorClass),this.liveDebugTerminal.appendChild(o)}this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}appendTerminalLine(e,t){if(!this.liveTerminalOutput)return;let o=this.shadow.querySelector("#eq-term-current-line"),s=document.createElement("div");s.style.cssText="padding:0;white-space:pre-wrap;overflow-wrap:break-word;",s.textContent=e;let a=t==="text-red"?"#ff4444":t==="text-blue"?"#888":t==="text-green"?"#aaa":t==="text-yellow"?"#888":"#ccc";for(s.style.color=a,o?this.liveTerminalOutput.insertBefore(s,o):this.liveTerminalOutput.appendChild(s);this.liveTerminalOutput.children.length>600;){let r=this.liveTerminalOutput.firstChild;if(r&&r!==o)this.liveTerminalOutput.removeChild(r);else break}this.liveTerminalOutput.scrollTop=this.liveTerminalOutput.scrollHeight}initTerminalREPL(){if(this.liveTerminalOutput=this.shadow.querySelector("#eq-term-output"),this._terminalInited){this._reconnectContextbarBtns();return}this._terminalInited=!0;let e=this.shadow.querySelector("#eq-term-capture"),t=this.shadow.querySelector("#eq-term-output"),o=this.shadow.querySelector("#eq-term-typed"),s=this.shadow.querySelector("#eq-term-current-line"),a=this.shadow.querySelector("#eq-term-panel-terminal"),r=this.shadow.querySelector("#eq-term-panel-output"),i=this.shadow.querySelector("#eq-output-toolbar"),c=this.shadow.querySelector("#eq-output-search"),l=this.shadow.querySelector("#eq-output-search-clear"),u=this.shadow.querySelector("#eq-output-filter-btn"),f=this.shadow.querySelector("#eq-output-filter-menu"),d=this.shadow.querySelector("#eq-fchk-apply"),m=(w,T="#888",y=13)=>`<span style="display:inline-flex;vertical-align:middle;width:${y}px;height:${y}px;color:${T};flex-shrink:0;">${I[w]||""}</span>`,p=(w,T="")=>{if(!t||!s)return;let y=document.createElement("div");y.style.cssText="padding:0;white-space:pre-wrap;overflow-wrap:break-word;word-break:break-word;max-width:100%;line-height:1.65;"+T,y.innerHTML=w,t.insertBefore(y,s)},h=(w,T="#cccccc")=>p(`<span style="color:${T};">${w}</span>`),b=()=>h("","#000"),v=(w=52)=>h("  "+"\u2500".repeat(w),"#222"),A=(w,T,y)=>{let S=w.map((C,M)=>C.padEnd(T[M]||0)),k=y?S.map((C,M)=>`<span style="color:${y[M]||"#aaa"}">${C}</span>`):S.map(C=>`<span style="color:#aaa">${C}</span>`);p("  "+k.join("  ")+"  ")},x=w=>{let T=w.trim().split(/s+/),y=T[0].toLowerCase();switch(y){case"help":b(),p("  "+m("terminal","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> COMANDOS DISPON\xCDVEIS</span>'),b(),[["help","lista todos os comandos","list","#666"],["status","estado atual do sistema","sparkles","#666"],["version","vers\xE3o e info do build","info","#666"],["info-api","dados da \xFAltima requisi\xE7\xE3o \xE0 API","chip","#666"],["tokens","tokens consumidos (detalhado)","code","#666"],["context","contexto da quest\xE3o atual","eye","#666"],["controls","controles detectados (tabela)","list","#666"],["errors","erros recentes registrados","info","#666"],["logs [n]","\xFAltimas N entradas do output","file","#666"],["history","hist\xF3rico de quest\xF5es respondidas","clock","#666"],["reset","limpa logs e m\xE9tricas","eraser","#666"],["clear","limpa o terminal","trash","#666"],["copy","copia terminal para clipboard","copy","#666"]].forEach(([k,C,M,z])=>{p(`    ${m(M,z,11)} <span style="color:#ccc;font-weight:600;min-width:72px;display:inline-block;">${k.padEnd(10)}</span> <span style="color:#555;">${C}</span>`)}),b();break;case"clear":t&&s&&[...t.children].forEach(C=>{C!==s&&C.remove()});return;case"info-api":{let k=this.latestPlan;b(),p("  "+m("chip","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> INFORMA\xC7\xD5ES DA API</span>'),v(44);let C=(M,z,B,N,j="#aaa")=>p(`  ${m(M,z,11)}  <span style="color:#444;">${B.padEnd(16)}</span><span style="color:${j};font-weight:600;">${N||"--"}</span>`);C("sparkles","#888","Modelo",k?.usedModel||this.initialSettings?.model||"--","#ccc"),C("clock","#888","Lat\xEAncia",k?.durationMs?k.durationMs+"ms":"--","#ccc"),C("code","#888","Prompt tokens",String(k?.promptTokens??"--")),C("code","#888","Resp. tokens",String(k?.candidatesTokens??"--")),C("chip","#aaa","Total tokens",String(k?.tokensUsed??"--"),"#fff"),C("file","#888","Prompt chars",this.latestPromptText?.length?this.latestPromptText.length+" chars":"--"),v(44),b();break}case"version":b(),p("  "+m("sparkles","#888",14)+` <span style="color:#ddd;font-weight:700;"> EasyQuiz ${typeof be<"u"?be:"?"}</span>`),h("  Motor: H\xEDbrido 4.0  \xB7  RAG + AST + Vision + Multimodal","#555"),h("  Build: "+new Date().toLocaleDateString("pt-BR"),"#333"),b();break;case"status":{let k=this.latestPlan,C=this.latestContext;b(),p("  "+m("inspector","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> STATUS DO SISTEMA</span>'),v(44);let M=(z,B,N,j,X="#aaa")=>p(`  ${m(z,B,11)}  <span style="color:#444;">${N.padEnd(14)}</span><span style="color:${X};">${j||"--"}</span>`);if(M("sparkles","#888","Modelo",k?.usedModel||this.initialSettings?.model||"--","#ccc"),M("play","#888","Modo",k?.mode||"aguardando"),M("clock","#888","Lat\xEAncia",k?.durationMs?k.durationMs+"ms":"--","#aaa"),M("chip","#888","Tokens",String(k?.tokensUsed??"--")),M("analyze","#888","Confian\xE7a",k?Math.round(k.confidence*100)+"%":"--"),M("eye","#888","Controles",C?String(C.controls.length):"--"),C){let z='"'+C.questionText.slice(0,50)+(C.questionText.length>50?"...":"")+'"';M("file","#888","Contexto",z,"#666")}v(44),b();break}case"tokens":{let k=this.latestPlan;if(b(),!k){h("  Nenhuma requisi\xE7\xE3o ainda.","#444"),b();break}p("  "+m("code","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> TOKENS CONSUMIDOS</span>'),v(38),h(`  Prompt tokens    ${String(k.promptTokens??"--").padStart(8)}`,"#888"),h(`  Response tokens  ${String(k.candidatesTokens??"--").padStart(8)}`,"#888"),h("  "+"\u2508".repeat(28),"#222"),h(`  Total            ${String(k.tokensUsed??"--").padStart(8)}`,"#ddd"),h(`  Lat\xEAncia         ${(k.durationMs?k.durationMs+"ms":"--").padStart(8)}`,"#aaa"),v(38),b();break}case"context":{let k=this.latestContext;if(b(),!k){h("  Contexto n\xE3o dispon\xEDvel.","#444"),b();break}p("  "+m("eye","#555",14)+' <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> CONTEXTO ATUAL</span>'),v(44),h("  Escopo    "+k.scope.tagName.toLowerCase()+(k.scope.id?"#"+k.scope.id:""),"#aaa"),h("  Controles "+k.controls.length,"#aaa"),h("  Texto     "+k.questionText.slice(0,55)+(k.questionText.length>55?"...":""),"#888"),v(44),b();break}case"controls":{let k=this.latestContext;if(b(),!k?.controls.length){h("  Nenhum controle detectado.","#444"),b();break}p("  "+m("list","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> CONTROLES (${k.controls.length})</span>`),v(55),A(["#","Tipo","Label / ID","Valor"],[3,10,27,10],["#555","#777","#aaa","#888"]),h("  "+"\u2508".repeat(53),"#222"),k.controls.forEach((C,M)=>A([String(M+1),(C.type||C.tag||"?").toUpperCase().slice(0,9),(C.label||C.id||C.name||"\u2014").slice(0,26),(C.value||"\u2014").slice(0,9)],[3,10,27,10],["#555","#777","#ccc","#888"])),v(55),b();break}case"errors":{let k=this.logEntries.filter(C=>C.category==="error");if(b(),!k.length){p("  "+m("check","#4ade80",11)+' <span style="color:#555;"> Nenhum erro nesta sess\xE3o.</span>'),b();break}p("  "+m("info","#ff5555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> ERROS (${k.length})</span>`),v(44),k.slice(-15).forEach(C=>h("  "+C.message,"#888")),v(44),b();break}case"logs":{let k=Math.min(parseInt(T[1]||"10",10)||10,50),C=this.logEntries.slice(-k);if(b(),!C.length){h("  Nenhum log.","#444"),b();break}p("  "+m("file","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> \xDALTIMAS ${k} ENTRADAS</span>`),v(44),C.forEach(M=>h("  "+M.message,"#777")),v(44),b();break}case"history":{let k=this.metricsHistory;if(b(),!k?.length){h("  Nenhuma quest\xE3o respondida.","#444"),b();break}p("  "+m("clock","#555",14)+` <span style="color:#888;font-weight:700;letter-spacing:0.06em;"> HIST\xD3RICO (${k.length})</span>`),v(58),A(["#","Quest\xE3o","Tempo","Modelo"],[3,38,7,10],["#555","#aaa","#888","#777"]),h("  "+"\u2508".repeat(58),"#222"),k.slice(-15).forEach((C,M)=>A([String(M+1),(C.questionTitle||"Quest\xE3o").slice(0,37),C.durationMs?(C.durationMs/1e3).toFixed(1)+"s":"--",(C.model||"--").slice(0,9)],[3,38,7,10],["#555","#ccc","#888","#777"])),v(58),b();break}case"reset":this.clearLogs(),b(),p("  "+m("check","#888",11)+' <span style="color:#666;"> Logs e m\xE9tricas resetados.</span>'),b();break;case"copy":{if(!t)break;let k=Array.from(t.children).filter(C=>C!==s).map(C=>C.textContent||"");navigator.clipboard.writeText(k.join(`
`)).then(()=>{p("  "+m("copy","#888",11)+' <span style="color:#666;"> Conte\xFAdo copiado para a \xE1rea de transfer\xEAncia.</span>'),this.showToast("Terminal copiado","success",2e3)});break}case"":break;default:b(),p(`  <span style="color:#555;">Comando n\xE3o reconhecido: </span><span style="color:#888;">&quot;${y}&quot;</span>`),p('  <span style="color:#333;">Digite </span><span style="color:#666;font-weight:600;">help</span><span style="color:#333;"> para ver os comandos.</span>'),b()}t&&(t.scrollTop=t.scrollHeight)},q=w=>{this.terminalMode=w;let T=w==="terminal";a&&(a.style.display=T?"flex":"none"),r&&(r.style.display=T?"none":"flex"),i&&(i.style.display=T?"none":"flex");let y=this.shadow.querySelector("#eq-term-mode-terminal"),S=this.shadow.querySelector("#eq-term-mode-output");y&&(y.style.background=T?"#181818":"transparent",y.style.borderColor=T?"#2a2a2a":"transparent",y.style.color=T?"#ddd":"#555"),S&&(S.style.background=T?"transparent":"#181818",S.style.borderColor=T?"transparent":"#2a2a2a",S.style.color=T?"#555":"#ddd"),T||this.renderTerminalEntries()};this._reconnectContextbarBtns=()=>{let w=this.shadow.querySelector("#eq-term-mode-terminal"),T=this.shadow.querySelector("#eq-term-mode-output"),y=this.shadow.querySelector("#eq-term-copy-btn"),S=this.shadow.querySelector("#eq-term-clear-btn");w?.addEventListener("click",()=>q("terminal")),T?.addEventListener("click",()=>q("output")),y?.addEventListener("click",()=>{let k=M=>{let z=M.style.color;M.style.color="#4ade80",setTimeout(()=>M.style.color=z,400)},C=window.getSelection()?.toString()||"";if(this.terminalMode==="terminal"){if(C)navigator.clipboard.writeText(C).then(()=>{this.showToast("Sele\xE7\xE3o copiada","success",2e3),y&&k(y)});else if(t){let M=Array.from(t.children).filter(z=>z!==s).map(z=>z.textContent||"");navigator.clipboard.writeText(M.join(`
`)).then(()=>{this.showToast("Terminal copiado","success",2e3),y&&k(y)})}}else C?navigator.clipboard.writeText(C).then(()=>{this.showToast("Sele\xE7\xE3o copiada","success",2e3),y&&k(y)}):navigator.clipboard.writeText(this.getFormattedLogs()).then(()=>{this.showToast("Output copiado","success",2e3),y&&k(y)})}),S?.addEventListener("click",()=>{this.terminalMode==="terminal"?(t&&s&&[...t.children].forEach(k=>{k!==s&&k.remove()}),o&&(o.textContent="")):this.clearLogs()})},this._reconnectContextbarBtns();let L=()=>{e?.focus(),t?.classList.remove("eq-term-unfocused")};t?.addEventListener("mousedown",w=>{let T=window.getSelection();T&&T.toString().length>0||(w.preventDefault(),L())}),t?.addEventListener("focus",()=>t.classList.remove("eq-term-unfocused")),e?.addEventListener("blur",()=>t?.classList.add("eq-term-unfocused")),e?.addEventListener("focus",()=>t?.classList.remove("eq-term-unfocused")),e?.addEventListener("keydown",w=>{if(!o)return;let T=o.textContent||"";if(w.key==="Enter"){w.preventDefault();let y=T.trim();if(o.textContent="",this.terminalCmdHistoryIdx=-1,y&&(this.terminalCmdHistory.unshift(y),this.terminalCmdHistory.length>50&&this.terminalCmdHistory.pop()),s){let S=document.createElement("div");S.style.cssText="white-space:pre-wrap;overflow-wrap:break-word;",S.innerHTML=`<span style="color:#fff;font-weight:700;">EasyQuiz_Legacy:&nbsp;</span><span style="color:#888;">${y}</span>`,t?.insertBefore(S,s)}y&&x(y),t&&(t.scrollTop=t.scrollHeight)}else if(w.key==="Backspace")w.preventDefault(),o.textContent=T.slice(0,-1);else if(w.key==="ArrowUp")w.preventDefault(),this.terminalCmdHistoryIdx=Math.min(this.terminalCmdHistoryIdx+1,this.terminalCmdHistory.length-1),this.terminalCmdHistoryIdx>=0&&(o.textContent=this.terminalCmdHistory[this.terminalCmdHistoryIdx]);else if(w.key==="ArrowDown")w.preventDefault(),this.terminalCmdHistoryIdx=Math.max(this.terminalCmdHistoryIdx-1,-1),o.textContent=this.terminalCmdHistoryIdx>=0?this.terminalCmdHistory[this.terminalCmdHistoryIdx]:"";else if(w.key==="c"&&w.ctrlKey){let y=window.getSelection()?.toString()||"";y?navigator.clipboard.writeText(y):o?.textContent&&navigator.clipboard.writeText(o.textContent);let S=this.shadow.querySelector("#eq-term-copy-btn");if(S){let k=S.style.color;S.style.color="#4ade80",setTimeout(()=>S.style.color=k,400)}}else w.key==="v"&&w.ctrlKey?(w.preventDefault(),navigator.clipboard.readText().then(y=>{o&&(o.textContent=(o.textContent||"")+y.replace(/\n/g," ")),t&&(t.scrollTop=t.scrollHeight)})):w.key==="l"&&w.ctrlKey?(w.preventDefault(),t&&s&&[...t.children].forEach(y=>{y!==s&&y.remove()}),o.textContent=""):w.key.length===1&&!w.ctrlKey&&!w.metaKey&&(w.preventDefault(),o.textContent=T+w.key,t&&(t.scrollTop=t.scrollHeight))}),e?.addEventListener("paste",w=>{w.preventDefault();let T=w.clipboardData?.getData("text")||"",y=/\n/g;o&&(o.textContent=(o.textContent||"")+T.replace(y," "))});let E=()=>{let w=this.shadow.querySelector("#eq-fchk-all")?.checked,T=this.shadow.querySelector("#eq-fchk-error")?.checked,y=this.shadow.querySelector("#eq-fchk-ai")?.checked,S=this.shadow.querySelector("#eq-fchk-dom")?.checked;if(w||T||y||S)w?this.activeLogFilter="all":T&&!y&&!S?this.activeLogFilter="error":y&&!T&&!S?this.activeLogFilter="ai":S&&!T&&!y?this.activeLogFilter="dom":this.activeLogFilter="all";else{let z=this.shadow.querySelector("#eq-fchk-all");z&&(z.checked=!0),this.activeLogFilter="all"}let C=this.shadow.querySelector("#eq-output-filter-label"),M={all:"Todos",error:"Erros",ai:"IA",dom:"DOM"};C&&(C.textContent="Filtro: "+(M[this.activeLogFilter]||this.activeLogFilter)),this.renderTerminalEntries()};u?.addEventListener("click",w=>{w.stopPropagation(),f&&(f.hidden=!f.hidden)}),d?.addEventListener("click",()=>{let w=this.shadow.querySelector("#eq-fchk-all")?.checked,T=this.shadow.querySelector("#eq-fchk-error")?.checked,y=this.shadow.querySelector("#eq-fchk-ai")?.checked,S=this.shadow.querySelector("#eq-fchk-dom")?.checked,k=w||T||y||S;k||(this.shadow.querySelector("#eq-fchk-all").checked=!0),w||!k?this.activeLogFilter="all":T&&!y&&!S?this.activeLogFilter="error":y&&!T&&!S?this.activeLogFilter="ai":S&&!T&&!y?this.activeLogFilter="dom":this.activeLogFilter="all";let C=this.shadow.querySelector("#eq-output-filter-label");C&&(C.textContent="Filtro: "+this.activeLogFilter.toUpperCase()),f&&(f.hidden=!0),this.renderTerminalEntries()}),document.addEventListener("mousedown",w=>{f&&!f.contains(w.target)&&w.target!==u&&(f.hidden=!0)}),c?.addEventListener("input",()=>{this.outputSearchQuery=c.value,l&&(l.style.display=c.value?"inline":"none"),this.renderTerminalEntries()}),l?.addEventListener("click",()=>{c&&(c.value=""),this.outputSearchQuery="",l&&(l.style.display="none"),this.renderTerminalEntries()}),this.shadow.querySelector("#eq-dbg-scroll-toggle")?.addEventListener("click",w=>{this.autoScrollLogs=!this.autoScrollLogs,w.currentTarget.style.color=this.autoScrollLogs?"#aaaaaa":"#333"}),q("terminal"),setTimeout(()=>L(),80)}clearLogs(){if(this.logEntries=[],this.updateLogCounters(),this.liveDebugTerminal){this.liveDebugTerminal.replaceChildren();let e=document.createElement("div");e.className="text-blue",e.textContent="> [SYS] Output limpo.",this.liveDebugTerminal.appendChild(e)}this.apConsole&&this.apConsole.replaceChildren(),this.executionConsole&&this.executionConsole.replaceChildren()}getFormattedLogs(){return(this.activeLogFilter==="all"?this.logEntries:this.logEntries.filter(t=>t.category===this.activeLogFilter)).map(t=>t.message).join(`
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let o=t?`[${t}] ${e}`:e;this.setLastError(o)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,o=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let s=e?.promptTokens!==void 0?String(e.promptTokens):"--",a=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${s} / ${a}`,this.dbgSplitTokens.title=`Prompt: ${s} tokens | Resposta: ${a} tokens`}if(this.dbgTotalTokens){let s=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=s!==void 0?`${s}`:"--"}if(this.dbgPromptLen){let s=o.length,a=Math.round(s/4);this.dbgPromptLen.textContent=`${s}c (~${a}tok)`}this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let o=new Date,s=`${String(o.getHours()).padStart(2,"0")}:${String(o.getMinutes()).padStart(2,"0")}:${String(o.getSeconds()).padStart(2,"0")}.${String(Math.floor(o.getMilliseconds()/100))}`,a=e;e.startsWith(">")?a=`> [${s}] ${e.slice(1).trim()}`:a=`[${s}] ${e}`;let r="all";t==="text-red"||a.includes("[ERRO]")||a.includes("Falha")||a.includes("Error")?r="error":a.includes("[IA]")||a.includes("[RAG]")||a.includes("Tokens")||a.includes("Gemini")||a.includes("Modelo:")?r="ai":(a.includes("[DOM]")||a.includes("[EXEC]")||a.includes("[VERIF]")||a.includes("[NAV]"))&&(r="dom");let i={id:Date.now()+Math.random(),timestamp:s,message:a,colorClass:t,category:r};for(this.logEntries.push(i);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),r==="error"&&this.setLastError(a),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===r)){let c=document.createElement("div");c.style.cssText="padding:1px 0;",c.textContent=a,t&&(c.className=t),this.liveDebugTerminal.appendChild(c)}if(this.liveTerminalOutput&&(r==="dom"||r==="all"||r==="error")){for(this.appendTerminalLine(a,t);this.liveDebugTerminal.children.length>300;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.apConsole.appendChild(c),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.executionConsole.appendChild(c),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let o=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${o}%`,this.progressVal&&(this.progressVal.textContent=`${o}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),o>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions)),this.activeTab==="brain"?(this.renderContextTree(),this.refreshBrainCanvas(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&(this.renderContextTree(),this.refreshBrainCanvas()),this.activeTab==="brain"&&(this.brainSelectedFolder==="media-images"||(this.brainActiveTab||"").startsWith("img-"))&&this.refreshBrainCanvas()}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=De(),o=this.latestPlan,s=!!(this.latestPromptText||o?.promptSent),a=!!e,r=!!o;this.contextTreeContainer.innerHTML="";let i=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(i);let c=e?e.controls:[],l=c.map((v,A)=>{let x=v.role==="navigation"||v.type==="button",q=!x&&v.value?` [val: "${v.value}"]`:"";return{label:`[#${A+1}] ${v.type.toUpperCase()}`,value:`${v.label||v.id||v.name||"(Sem r\xF3tulo)"}${q}`.trim(),badge:x?"Navega\xE7\xE3o":v.role||v.type}}),u=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${c.length})`,c.length>0,l);this.contextTreeContainer.appendChild(u);let f=t.map((v,A)=>({label:`Mem\xF3ria #${A+1}`,value:v,badge:"RAG"})),d=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,f);if(this.contextTreeContainer.appendChild(d),o){let v=this.createTreeFolder(` \xDALTIMO PLANO IA (${o.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:o.pageType,badge:`${(o.confidence*100).toFixed(0)}%`},{label:"Modo",value:o.mode},{label:"Racioc\xEDnio",value:o.rationale||"N/A"},...o.actions.map((A,x)=>({label:`A\xE7\xE3o #${x+1} (${A.t})`,value:JSON.stringify(A)}))]);this.contextTreeContainer.appendChild(v)}{let v=document.createElement("div");v.style.cssText="border-bottom:1px solid rgba(255,255,255,0.04);";let A=document.createElement("div");A.style.cssText="display:flex;align-items:center;gap:6px;padding:5px 10px;cursor:pointer;font-size:10px;font-weight:600;color:#fbbf24;letter-spacing:0.04em;user-select:none;",A.innerHTML='<span style="display:inline-flex;width:12px;height:12px;color:#fbbf24;">'+I.inspector+"</span> IA ARTIFACTS";let x=document.createElement("div");x.style.cssText="padding-left:16px;overflow:hidden;";let q=(E,w,T,y)=>{let S=document.createElement("div");return S.style.cssText="display:flex;align-items:center;gap:6px;padding:4px 10px 4px 4px;cursor:pointer;border-radius:4px;transition:background 0.1s;"+(this.brainActiveTab===E?"background:rgba(251,191,36,0.1);":""),S.innerHTML='<span style="font-size:9px;color:'+(y?"#fbbf24":"#444")+';">'+I.code+'</span><span style="font-size:10px;color:'+(y?"#ddd":"#444")+';flex:1;">'+w+'</span><span style="font-size:8px;color:#333;">'+T+"</span>",S.addEventListener("click",()=>{this.brainSelectedFolder=null,this.brainActiveTab=E;let k=this.getBrainFileText(E),C=this.shadow.querySelector("#eq-brain-content");if(C){C.innerHTML="";let M=document.createElement("pre");M.className="eq-brain-code",M.style.cssText='padding:12px;font-size:10.5px;line-height:1.55;white-space:pre-wrap;word-break:break-word;color:#d0d8e8;font-family:"Cascadia Code","Fira Code","Courier New",monospace;',M.textContent=k,C.appendChild(M)}this.renderBrainExplorer(),this.renderBrainTabs()}),S};x.appendChild(q("ai-prompt","prompt.txt",s?"pronto":"aguardando",s)),x.appendChild(q("ai-context","context.json",a?"pronto":"aguardando",a)),x.appendChild(q("ai-response","response.txt",r?"pronto":"aguardando",!!o));let L=!1;A.addEventListener("click",()=>{L=!L,x.style.display=L?"block":"none"}),x.style.display="none",v.appendChild(A),v.appendChild(x),this.contextTreeContainer.appendChild(v)}let m=this.latestImages,p=this.latestImageDescriptions,h=m.map((v,A)=>{let x=p.find(T=>T.index===A),q=(v.captureStatus==="captured"||v.captureStatus==="text_only",""),L=v.captureStatus==="captured"?"Visual":v.captureStatus==="text_only"?"Texto":"Falhou",E=x?x.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",w=x?x.description:v.textContext?v.textContext:"Aguardando an\xE1lise IA...";return{label:`${q} Img ${A+1} [${L}]`,value:`${w}`,badge:E,imgSrc:v.base64?`data:${v.mediaType||"image/jpeg"};base64,${v.base64}`:void 0}}),b=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${m.length})`,!0,h);this.contextTreeContainer.appendChild(b)}createTreeFolder(e,t,o){let s=document.createElement("div");s.className="eq-tree-node";let a=document.createElement("div");a.className="eq-tree-header",a.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let r=document.createElement("div");if(r.className="eq-tree-content",r.style.display=t?"flex":"none",o.length===0)r.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let i of o){let c=document.createElement("div");c.className="eq-tree-leaf";let l="";i.imgSrc&&i.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${i.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),c.innerHTML=`
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Dn(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Bn(){let n=window;if(ke(),Dn(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=_e(),t=null,o=null,s=0,a=new Ze(e,{onAnalyze:(l=1,u,f=!1)=>r(l,u,f),onApply:(l=1)=>void i(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}ge(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}ge(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=qt(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,f=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,m=()=>{try{d.abort()}catch{}};if(u&&(u.aborted?d.abort():u.addEventListener("abort",m,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}s=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),ge(),a.hideFloatingAnswers();try{let p=pe(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ce()),Pe(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let h=await wt(p.scope,e.useVision);if(h.length>0){let L=h.map(E=>E.element).filter(Boolean);At(L),a.updateImages(h)}if(d.signal.aborted)return;let b=e.model;a.setStatus(h.length>0?`Consultando Gemini (${b}) com ${h.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${b}) via DOM nativo (modo r\xE1pido)...`,"info");let v=Le(p,h,e);a.setInspectorPrompt(v,e.model);let A=(L,E)=>{a.setStatus(L,E==="warning"?"info":E);let w=L.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(w){let T=w[1].split(",")[0].trim();a.setProgress(50,`Gemini ${T} respondendo...`)}},{plan:x,usedModel:q}=await je(p,h,e,A,d.signal);if(d.signal.aborted)return;if(x.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=pe(!0),p||(p=ce()),Pe(p.scope),a.updateContext(p),h=await wt(p.scope,e.useVision),h.length>0){let w=h.map(T=>T.element).filter(Boolean);At(w),a.updateImages(h)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let L=Le(p,h,e);a.setInspectorPrompt(L,e.model),x=(await je(p,h,e,A,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${q||e.model} | Modo: ${x.mode} | Confian\xE7a: ${(x.confidence*100).toFixed(0)}%`,"text-green"),x.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${x.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${x.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),x.memoryToStore&&(kt(x.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${x.memoryToStore}"`,"text-yellow")),x.imageDescriptions&&x.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${x.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let L of x.imageDescriptions){let E=L.relevant?"":"\uFE0F";a.logToConsole(`>   ${E} Imagem ${L.index+1} [${L.relevant?"RELEVANTE":"IGNORADA"}]: ${L.description}`,L.relevant?"text-blue":"text-yellow")}}return t=x,a.updateContext(p,x),Jt(x.actions,x.confidence),a.setPlan(x,!e.dryRun),x.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):x.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):x.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&x.pageType==="question"&&a.showFloatingAnswers(x),d.signal.aborted?void 0:((f||e.autoApply)&&!e.dryRun&&await i(l,d.signal,f),x)}catch(p){if(d.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){ge(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}ge(),a.setProgress(0);let h=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(h,"error"),a.setErrorDiagnostic(h,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function i(l=1,u,f=!1){if(u?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(b=>b.t!=="adv"),p=t.pageType==="question"||Ue(t.rationale||"");if(p&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let h=(f||e.autoAdvance||d)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let b=await ze(t,h,l,ye(e));if(u?.aborted)return;if(a.setExecutionReport(b),b.failedActions&&b.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${b.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let L of b.failedActions){let E=L.action,w=E.t==="drag"?`drag: "${E.from}" \u2192 "${E.to}"`:E.t==="clk"||E.t==="chk"?`${E.t}: "${E.id}"`:E.t==="val"?`val: "${E.id}" = "${E.v}"`:JSON.stringify(E).slice(0,80);a.logToConsole(`>    [${E.t.toUpperCase()}] ${w} | ${L.evidence.slice(0,80)}`,"text-yellow")}await c(b.failedActions,u)}let v=s>0?Date.now()-s:1200,A=b.verified>0,x=b.applied>0;if(b.success||A&&x){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${b.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${b.verified} verificada(s) no DOM.`,"text-green"),b.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):h&&a.logToConsole(`> [NAV] ${b.navigationEvidence}`,"text-blue"),a.setStatus(b.advanced?`Sucesso: ${b.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${b.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let L=St({id:`q-${Date.now()}`,questionIndex:(qe().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:v,status:"answered",mode:t.mode,actionsCount:b.applied});a.updateTimingMetrics(L)}else x?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${b.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${b.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${b.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${b.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(b){a.setProgress(0);let v=b instanceof Error?b.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${v}`,"error"),a.logToConsole(`> [ERRO] ${v}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,u){if(!t)return;let f=l.filter(m=>m.action.t==="drag");for(let m of f){if(u?.aborted)return;let p=m.action,h=String(p.from||""),b=String(p.to||""),v=Ut(h,b,h,b);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${h}" \u2192 "${b}"`,"text-blue");let A={...t,actions:[{t:"js",v}],pageType:"question"},x=await ze(A,!1,1,ye(e));a.logToConsole(x.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",x.applied>0?"text-green":"text-yellow")}let d=l.filter(m=>m.action.t!=="drag");if(d.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of d){if(u?.aborted)return;let p=m.action,h=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${h}`,"text-blue");let b=String(p.id||p.name||p.selector||""),v=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Je(m.action),await new Promise(A=>setTimeout(A,250)),ne(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${h}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let A=O(b,v)||O(b.replace(/[^\w\s]/g," ").trim(),v);if(A&&(gt(A),await new Promise(x=>setTimeout(x,300)),ne(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let A=O(b,v)||O(b.replace(/[^\w\s]/g," ").trim(),v);if(A&&(A.focus?.(),await new Promise(x=>setTimeout(x,50)),A.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80)),A.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200)),ne(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${h}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let A=O(b,v)||O(b.replace(/[^\w\s]/g," ").trim(),v);if(A){let x=A.id,q=!!x;x||(x=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,A.id=x);let L=String(p.v??""),E=p.t==="val",w=document.createElement("script");if(w.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(w),w.remove(),q||setTimeout(()=>{try{A.id===x&&A.removeAttribute("id")}catch{}},0),await new Promise(T=>setTimeout(T,300)),ne(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${h}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let A="";try{let C=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(M=>(M.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));C&&(A=C.outerHTML.slice(0,400))}catch{}let x=pe(!1)||ce(),q=`A\xE7\xE3o (${p.t}) alvo="${b}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${A?`
HTML do alvo: ${A}`:""}`,L=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],E=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
...
${JSON.stringify((x?.controls||[]).slice(0,6).map(C=>({id:C.id,type:C.type,label:C.label,options:C.options?.slice(0,3)})),null,2)}
