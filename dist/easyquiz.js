 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!1,confidenceThreshold:.8};function _(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Fe="easyquiz_settings_v2",de="easyquiz_activity_metrics";function Ge(){try{let o=localStorage.getItem(Fe);if(!o){let l=localStorage.getItem("easyquiz_settings_v1");if(l){let s=JSON.parse(l);return{...ie,apiKey:s.apiKey||""}}return{...ie}}let e=JSON.parse(o),t=typeof e.model=="string"&&_(e.model)?e.model:ie.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(l=>typeof l=="string"?l.trim().replace(/^["']|["']$/g,""):"").filter(l=>l.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";return a.length===0&&r&&(a=[r]),{apiKey:a[0]||r||ie.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:!!e.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function wt(){try{localStorage.removeItem(Fe),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(de),sessionStorage.removeItem(de);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Ye()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function qe(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function Qe(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={...qe(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function Et(o){let e=Ge(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Fe,JSON.stringify(r))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var ce=[],qt=12,Jt=1200;function Tt(o){let e=o.trim().replace(/\s+/g," ").slice(0,Jt);e&&!ce.includes(e)&&(ce.push(e),ce.length>qt&&(ce=ce.slice(-qt)))}function ze(){return ce}function Ye(){ce=[]}function Ct(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var xe=Ct();function we(){try{localStorage.removeItem(de)}catch{}return xe}function Wt(o){xe=o;try{let e=JSON.stringify(o);sessionStorage.setItem(de,e),localStorage.removeItem(de)}catch{}}function At(o){let e=xe,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],l=n.filter(u=>u.status==="answered"||u.status==="verified").length,s=n.reduce((u,p)=>u+p.durationMs,0),i=l>0?Math.round(s/l):0,c={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:l,averageDurationMs:i,records:n};return Wt(c),c}function Ee(){xe=Ct();try{sessionStorage.removeItem(de),localStorage.removeItem(de)}catch{}return xe}var St=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
[HTML]:
${o.htmlSnippet.slice(0,c).replace(/\s+/g," ")}`:"",p="";if(s&&typeof document<"u")try{let h=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(g=>{let v=g,T=v.getBoundingClientRect?.()||{width:0,height:0};return T.width>0&&T.height>0&&!v.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(g=>{let v=g,T=v.tagName.toLowerCase(),A=v.id?`#${v.id}`:"",w=v.className&&typeof v.className=="string"?`.${v.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",E=(v.textContent||v.value||v.getAttribute("aria-label")||"").trim().slice(0,60),I=v.getAttribute("type")||v.getAttribute("role")||"";return`${T}${A}${w}[${I}] txt="${E}"`});h.length>0&&(p=`
[DOM-INTERATIVO]:
${h.join(`
`)}`)}catch{}let d=ze(),m=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",b=o.controls.filter(h=>h.role!=="navigation"),y=o.controls.filter(h=>h.role==="navigation"),x=Xt(o.sourceUrl,o.htmlSnippet),f=x?`
${x}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(b.length===0)return"Nenhuma";let h=b.filter(L=>L.type==="checkbox"||L.type==="chk"),g=new Set(b.filter(L=>L.type==="radio").map(L=>L.name).filter(Boolean)),v=h.filter(L=>!L.name||!g.has(L.name)),T=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),A=v.length>=2||T,w=b.every(L=>L.type==="radio"||L.type==="chk")&&g.size>=1&&!A,E=b.filter(L=>L.type==="text"||L.type==="number"||L.type==="val"||L.tag==="input"||L.tag==="textarea"),I=E.length>=2;return(A?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
...
`:"")+JSON.stringify(b.map(L=>({id:L.id,t:L.type,n:L.name||void 0,txt:L.label?L.label.length>160?L.label.slice(0,160)+"...":L.label:void 0,v:L.value||void 0,opt:L.options&&L.options.length?L.options.slice(0,20).map(N=>N.label||N.value):void 0})))})()}
...
`;function jt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=xo,document.head.appendChild(o)}}catch{}}function pe(){be&&(be.style.removeProperty("outline"),be.style.removeProperty("outline-offset"),be.style.removeProperty("position"),be=null);for(let o of ue)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ue=[];for(let o of dt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-image-highlight");dt=[];for(let o of ut)try{o.remove()}catch{}if(ut=[],ve){try{ve.remove()}catch{}ve=null}}function pt(o){jt();for(let e of o){if(!e||!(e instanceof(typeof HTMLElement<"u"?HTMLElement:e.constructor)))continue;let t=e;t.style.outline="3px solid #ffd600",t.style.outlineOffset="3px",t.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",t.setAttribute("data-easyquiz-image-highlight","true"),dt.push(t);try{let a=t.parentElement;if(a&&!a.querySelector("[data-easyquiz-capture-badge]")){window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let n=document.createElement("div");n.setAttribute("data-easyquiz-capture-badge","true"),n.textContent="\u{1F4F7} Capturado pela IA",n.style.cssText=`
        ...
        `,a.appendChild(n),ut.push(n)}}catch{}}}function mt(o){pe(),jt(),be=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let l=this.element.querySelector("#eq-fah-header");this.setupDraggable(l)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=s=>{if(!this.isDragging||!this.element)return;let i=s.clientX-this.dragStartX,c=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),p=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+i),u),m=Math.min(Math.max(10,this.initialTop+c),p);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},l=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",l)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",l)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),l=r.actions.filter(m=>{if(m.t!=="val")return!1;let b=q(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(b)}),s=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),i=r.actions.filter(m=>m.t==="sel"),c=n.length||l.length||s.length||i.length,u=document.createElement("div");u.className="eq-fah-meta";let p=document.createElement("span");p.textContent=`Modo: ${r.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(p,d),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let b of n){let y=q(b.to)||"Geral";m[y]||(m[y]=[]),m[y].push(q(b.from))}for(let[b,y]of Object.entries(m)){let x=document.createElement("div"),f=/fato|true|verdadeiro|sim/i.test(b),h=/opini[aã]o|false|falso|n[aã]o/i.test(b);x.className=`eq-fah-group ${f?"group-fato":h?"group-opiniao":""}`;let g=document.createElement("div");g.className="eq-fah-group-title",g.textContent=`\u{1F4C1} ${b} (${y.length})`,x.appendChild(g);let v=document.createElement("div");v.className="eq-fah-group-items";for(let T of y){let A=document.createElement("div");A.className="eq-fah-item";let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=T,A.appendChild(w);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(T),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),A.appendChild(E),v.appendChild(A)}x.appendChild(v),e.appendChild(x)}}else if(l.length>0){t.textContent=`Preenchimento (${l.length} campos)`,a.textContent=String(l.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<l.length;x++){let f=l[x],h=document.createElement("div");h.className="eq-fah-item";let g=He(f.id);(!g||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Campo ${x+1}`);let v=String(f.v??""),T=document.createElement("div");T.className="eq-fah-field-box";let A=document.createElement("div");A.className="eq-fah-field-label",A.textContent=g,T.appendChild(A);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=v,T.appendChild(w),h.appendChild(T);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),h.appendChild(E),y.appendChild(h)}m.appendChild(y),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<s.length;x++){let f=s[x],h=document.createElement("div");h.className="eq-fah-item";let g=He(f.id);(!g||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g))&&f.v&&(g=String(f.v)),g=q(g),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(g)&&(g="");let v="",T=g.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);T?(v=T[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),g=T[2].trim()||g):s.length>1&&(v=String.fromCharCode(65+x));let A=document.createElement("div");if(A.style.display="flex",A.style.alignItems="center",A.style.gap="8px",A.style.flex="1",v){let I=document.createElement("span");I.className="eq-fah-letter-badge",I.textContent=v,A.appendChild(I)}let w=document.createElement("span");w.className="eq-fah-item-text",w.textContent=g||(v?`Alternativa ${v}`:"Alternativa Selecionada"),A.appendChild(w),h.appendChild(A);let E=document.createElement("button");E.className="eq-fah-copy-inline",E.textContent="Copiar",E.addEventListener("click",()=>{navigator.clipboard.writeText(g||v),E.textContent="\u2713 Copiado",setTimeout(()=>E.textContent="Copiar",1200)}),h.appendChild(E),y.appendChild(h)}m.appendChild(y),e.appendChild(m)}else if(i.length>0){t.textContent=`Sele\xE7\xE3o (${i.length} listas)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let b=document.createElement("div");b.className="eq-fah-group-title",b.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(b);let y=document.createElement("div");y.className="eq-fah-group-items";for(let x=0;x<i.length;x++){let f=i[x],h=document.createElement("div");h.className="eq-fah-item";let g=He(f.id);(!g||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(g))&&(g=`Lista ${x+1}`);let A=(Array.isArray(f.v)?f.v:[String(f.v??"")]).map(L=>{let N=M(f.id,void 0,!0)||M(q(f.id),void 0,!0),J=N instanceof HTMLSelectElement?N:N?.querySelector("select");if(J){let ee=q(L).toLowerCase();for(let te=0;te<J.options.length;te++){let k=J.options[te];if(k.value.toLowerCase()===ee||q(k.textContent).toLowerCase()===ee){let z=q(k.textContent);if(z&&!z.toLowerCase().includes("selecione"))return z}}}return L}).join(", "),w=document.createElement("div");w.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=g,w.appendChild(E);let I=document.createElement("div");I.className="eq-fah-field-val",I.textContent=A,w.appendChild(I),h.appendChild(w);let P=document.createElement("button");P.className="eq-fah-copy-inline",P.textContent="Copiar",P.addEventListener("click",()=>{navigator.clipboard.writeText(A),P.textContent="\u2713 Copiado",setTimeout(()=>P.textContent="Copiar",1200)}),h.appendChild(P),y.appendChild(h)}m.appendChild(y),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),r=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),l=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let i of a){let c=q(i.to)||"Geral";s[c]||(s[c]=[]),s[c].push(q(i.from))}for(let[i,c]of Object.entries(s)){t.push(`### Categoria: ${i}`);for(let u of c)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of r){let i=q(s.id);t.push(`- **${i||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let i=n[s],c=He(i.id);(!c||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c))&&i.v&&(c=String(i.v)),c=q(c),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(c)&&(c="");let u=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${c||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(l.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of l){let i=q(s.id)||"Lista",c=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${i}:** \`${c}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
...
`;var Qt=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function Mo(o,e){try{if(Qt){o.innerHTML=Qt.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var ko=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],Ho=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Ue=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new _e({onStatusChange:(s,i,c)=>{this.logToConsole(i,c),s==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):s==="advancing"||s==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):s==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),i.includes("conclus\xE3o")||i.includes("finalizada")||i.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda com sucesso! Autopilot finalizado.","success"):this.setStatus("Autopilot desativado.","info")):s==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(s,i)=>{try{return await this.callbacks.onAnalyze(s,i,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Mo(this.shadow,`
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap"),this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn.disabled=!0,this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new Ke(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),me.filter(s=>_(s.id)).forEach(s=>this.modelSelect.add(new Option(s.name,s.id,!1,s.id===e.model))),ko.forEach(s=>this.modeSelect.add(new Option(s.label,s.value,!1,s.value===e.modeHint))),Ho.forEach(s=>this.engineSelect.add(new Option(s.label,s.value,!1,s.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let r=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];H.init(r),this.renderKeysList();let n=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof n?.unref=="function"&&n.unref();let l=H.getBestKey()||e.apiKey;l&&Pe(l).then(s=>{s&&s.length>0&&this.updateModelSelect(s,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","metrics","debug","settings"];for(let a of t){let r=this.shadow.querySelector(`#eq-tab-${a}`),n=this.shadow.querySelector(`#eq-view-${a}`);a===e?(r?.classList.add("active"),n&&(n.style.display="flex")):(r?.classList.remove("active"),n&&(n.style.display="none"))}e==="brain"?(this.renderContextTree(),this.refreshInspectorView()):e==="metrics"?this.updateTimingMetrics():e==="debug"&&(this.refreshDebugView(),this.renderTerminalEntries())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings")),this.metricsResetBtn?.addEventListener("click",()=>{Ee(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let e=this.shadow.querySelector("#eq-dbg-scroll-toggle");e?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,e&&(e.style.color=this.autoScrollLogs?"#00ffcc":"#858585",e.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let t=this.shadow.querySelector("#eq-dbg-copy-logs");t?.addEventListener("click",()=>{let f=this.getFormattedLogs();navigator.clipboard.writeText(f).then(()=>{let h=t.innerHTML;t.innerHTML=C.check,setTimeout(()=>t.innerHTML=h,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let a=this.shadow.querySelector("#eq-dbg-copy-prompt");a?.addEventListener("click",()=>{let f=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(f).then(()=>{let h=a.innerHTML;a.innerHTML=`${C.check} Copiado!`,setTimeout(()=>a.innerHTML=h,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-context");r?.addEventListener("click",()=>{let f=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let h=r.innerHTML;r.innerHTML=`${C.check} Copiado!`,setTimeout(()=>r.innerHTML=h,1800)})});let n=this.shadow.querySelector("#eq-dbg-copy-raw-resp");n?.addEventListener("click",()=>{let f=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(f).then(()=>{let h=n.innerHTML;n.innerHTML=`${C.check} Copiado!`,setTimeout(()=>n.innerHTML=h,1800)})});let l=this.shadow.querySelector("#eq-dbg-copy-error-btn");l?.addEventListener("click",()=>{let f=this.lastErrorMsg||"";navigator.clipboard.writeText(f).then(()=>{let h=l.innerHTML;l.innerHTML=C.check,setTimeout(()=>l.innerHTML=h,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),this.shadow.querySelector("#eq-min-btn")?.addEventListener("click",()=>this.toggle(!1)),this.shadow.querySelector("#eq-close-btn")?.addEventListener("click",()=>this.toggle(!1)),window.addEventListener("keydown",f=>{f.altKey&&(f.key==="q"||f.key==="Q")&&(f.preventDefault(),this.toggle())},!0);let s=f=>{let h=f.composedPath();h.includes(this.shadow)||(h.includes(this.sidebarEl)||h.includes(this.host))&&f.stopImmediatePropagation()};window.addEventListener("keydown",s,!0),window.addEventListener("keyup",s,!0),window.addEventListener("keypress",s,!0),this.apiKeyInput.addEventListener("input",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:f})});let i=this.shadow.querySelector("#eq-keys-collapsible"),c=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),p=f=>{i&&(f?(i.style.display="none",c&&(c.style.transform="rotate(0deg)")):(i.style.display="block",i.style.maxHeight="none",i.style.overflow="visible",c&&(c.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}p(d),u?.addEventListener("click",f=>{if(f.target?.closest("a"))return;let h=i?.style.display==="none";p(!h);try{localStorage.setItem("easyquiz_keys_collapsed",h?"false":"true")}catch{}}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let f=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!f){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let h=H.addKey(f);if(h.ok){let g=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:g[0],apiKeys:g}),this.apiKeyInput.value="",this.setStatus(`\u2713 Nova chave adicionada com sucesso! (${g.length} chaves ativas no pool)`,"success"),p(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Oe(f).then(v=>{v.ok?(H.markSuccess(f,100),this.setStatus("\u2713 Nova chave validada com sucesso no Google AI Studio!","success")):(H.markInvalid(f,v.message),this.setStatus(`\u26A0\uFE0F Chave cadastrada, mas aviso retornado: ${v.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(h.message,"warning")}),this.keyMoreBtn.addEventListener("click",f=>{f.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",f=>{let h=f.target;!h.closest("#eq-key-context-menu")&&!h.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(f!==null&&f.trim()){let h=f.trim().replace(/^["']|["']$/g,""),g=H.addKey(h);if(g.ok){let v=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(g.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let f=await navigator.clipboard.readText();if(f){let h=f.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=h,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let f=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(f!==null&&f.trim()){let h=f.trim().replace(/^["']|["']$/g,"");if(H.addKey(h).ok){let v=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let f=this.apiKeyInput.type==="password";this.apiKeyInput.type=f?"text":"password";let h=this.shadow.querySelector("#eq-menu-vis-icon"),g=this.shadow.querySelector("#eq-menu-vis-text");h&&(h.innerHTML=f?C.eyeOff:C.eye),g&&(g.textContent=f?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let f=document.createElement("div");f.id="eq-bulk-overlay",f.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let h=document.createElement("div");h.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),h.innerHTML=`
      ...
      `,f.appendChild(h),this.shadow.appendChild(f);let g=h.querySelector("#eq-bulk-ta"),v=h.querySelector("#eq-bulk-status"),T=h.querySelector("#eq-bulk-import"),A=h.querySelector("#eq-bulk-paste-btn"),w=h.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>g?.focus());let E=()=>{f.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(I=>{f.addEventListener(I,P=>{P.stopPropagation(),P.stopImmediatePropagation()},!0)}),f.addEventListener("keydown",I=>{I.key==="Escape"&&E()}),f.addEventListener("click",I=>{I.target===f&&E()}),h.querySelector("#eq-bulk-x")?.addEventListener("click",E),h.querySelector("#eq-bulk-cancel")?.addEventListener("click",E),w.addEventListener("click",()=>{g.value="",v.textContent="",g.focus()}),A.addEventListener("click",async()=>{try{let I=await navigator.clipboard?.readText();I?(g.value=I,g.focus(),v.style.color="#38bdf8",v.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(v.style.color="#fbbf24",v.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{v.style.color="#fbbf24",v.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",g.focus()}}),h.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let I=g.value.trim();if(!I){v.style.color="#f87171",v.textContent="Insira pelo menos uma chave de API antes de importar.";return}let P=I.match(/AIza[0-9A-Za-z\-_]{35}/g),L=[];if(P&&P.length>0?L=Array.from(new Set(P)):L=Array.from(new Set(I.split(/[\n,;\s]+/).map(z=>z.trim().replace(/^["'`]|["'`]$/g,"")).filter(z=>z.length>=20))),L.length===0){v.style.color="#f87171",v.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}v.style.color="#00e5ff",v.textContent=`Processando ${L.length} chave(s)...`,T.disabled=!0,T.style.opacity="0.6";let N=0,J=0;for(let z of L){let V=H.addKey(z);V.ok?N++:V.message.includes("j\xE1 est\xE1 cadastrada")&&J++}if(N>0){let z=H.exportRawKeys();this.callbacks.onSettingsChange({apiKey:z[0],apiKeys:z}),p(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}v.textContent=`${N} adicionada(s), ${J} duplicada(s). Validando modelo em paralelo...`;let ee=H.exportRawKeys(),te=this.modelSelect?.value||"gemini-3.5-flash-lite",k=await Ze(te,ee);k.ok?(H.markSuccess(k.key,200),v.style.color="#4ade80",v.textContent=`\u2713 ${N} adicionada(s), ${J} duplicada(s). Modelo '${k.model}' pronto!`):(v.style.color="#fbbf24",v.textContent=`${N} adicionada(s), ${J} duplicada(s). Aviso: ${k.message}`),this.renderKeysList(),T.disabled=!1,T.style.opacity="1",N>0&&(this.setStatus(`\u2713 Lote importado: ${N} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(E,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let f=H.exportRawKeys(),h=document.createElement("div");h.id="eq-text-editor-overlay",h.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let g=document.createElement("div");g.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),g.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
