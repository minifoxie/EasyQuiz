 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0};function ce(t){if(!t||typeof t!="string")return!1;let e=t.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let n=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of n)if(e.includes(o))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var ut="easyquiz_settings_v2",lt="easyquiz_activity_metrics";function te(){try{let t=localStorage.getItem(ut);if(!t){let s=localStorage.getItem("easyquiz_settings_v1");if(s){let r=JSON.parse(s);return{...ie,apiKey:r.apiKey||""}}return{...ie}}let e=JSON.parse(t),n=typeof e.model=="string"&&ce(e.model)?e.model:ie.model,o=Array.isArray(e.apiKeys)?e.apiKeys.map(s=>typeof s=="string"?s.trim().replace(/^["']|["']$/g,""):"").filter(s=>s.length>5):[],a=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(o.length===0&&a&&(o=[a]),o.length===0)try{let s=localStorage.getItem("easyquiz_api_keys");if(s){let r=JSON.parse(s);Array.isArray(r)&&(o=r.filter(c=>typeof c=="string"&&c.trim().length>5))}}catch{}return{apiKey:o[0]||a||ie.apiKey,apiKeys:o,model:n,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:ie.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function je(t){try{let e=localStorage.getItem("eq_domain_cache_"+t);if(!e)return{};let n=JSON.parse(e);if(n.advanceSelector&&/inject|injetar/i.test(n.advanceSelector)){n.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+t)}catch{}}return n}catch{return{}}}function Qe(t,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...je(t),...e};try{localStorage.setItem("eq_domain_cache_"+t,JSON.stringify(o))}catch(a){console.warn("[EasyQuiz] Erro cache de dominio:",a)}}function he(t){let e=te(),n=Array.isArray(t.apiKeys)?t.apiKeys.map(i=>typeof i=="string"?i.trim().replace(/^["']|["']$/g,""):"").filter(i=>i.length>5):e.apiKeys,o;typeof t.apiKey=="string"?o=t.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(t.apiKeys)&&t.apiKeys.length>0?o=n[0]||"":o=e.apiKey,o&&!n.includes(o)&&(n=[o,...n]),n.length>0&&(!o||!n.includes(o))&&(o=n[0]);let a={...e,...t,apiKey:o,apiKeys:n};try{localStorage.setItem(ut,JSON.stringify(a)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(n))}catch(i){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",i)}return a}var ue=[],ct=12,Ft=1200;function pt(t){let e=t.trim().replace(/\s+/g," ").slice(0,Ft);e&&!ue.includes(e)&&(ue.push(e),ue.length>ct&&(ue=ue.slice(-ct)))}function mt(){return ue}function ft(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var dt=ft();function gt(){dt=ft();try{sessionStorage.removeItem(lt),localStorage.removeItem(lt)}catch{}return dt}var Ee=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(t)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(t)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(t)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(t)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(t)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Fe(t,e,n){let o=t.htmlSnippet.includes("draggable")||t.htmlSnippet.includes("perseus")||t.htmlSnippet.includes("category")||t.htmlSnippet.includes("dropzone")||t.controls.some(b=>b.type==="draggable"||b.type==="dropzone"),a=/katex|latex|\\frac|\\sqrt/i.test(t.htmlSnippet),i=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(t.sourceUrl)||t.htmlSnippet.includes("Qr7Oae")||t.htmlSnippet.includes("data-item-id")||t.htmlSnippet.includes("freebirdFormviewer"),s=(/wayground|quizizz/i.test(t.sourceUrl)||t.htmlSnippet.includes("data-functional-selector"))&&(t.htmlSnippet.includes("classification")||t.controls.filter(b=>b.role==="answer").length===0),r=t.controls.filter(b=>b.role!=="navigation").length===0,c=r||o||i||s||a&&t.questionText.length<60,d=r?4500:s?6e3:1800,u=c?`
[HTML]:
${t.htmlSnippet.slice(0,d).replace(/\s+/g," ")}`:"",f="";if(r&&typeof document<"u")try{let b=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(v=>{let x=v,w=x.getBoundingClientRect?.()||{width:0,height:0};return w.width>0&&w.height>0&&!x.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(v=>{let x=v,w=x.tagName.toLowerCase(),k=x.id?`#${x.id}`:"",P=x.className&&typeof x.className=="string"?`.${x.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",B=(x.textContent||x.value||x.getAttribute("aria-label")||"").trim().slice(0,60),y=x.getAttribute("type")||x.getAttribute("role")||"";return`${w}${k}${P}[${y}] txt="${B}"`});b.length>0&&(f=`
[DOM-INTERATIVO]:
${b.join(`
`)}`)}catch{}let l=mt(),p=l.length>0?`
[MEM\xD3RIA]:
${l.join(" | ")}
`:"",m=t.controls.filter(b=>b.role!=="navigation"),g=t.controls.filter(b=>b.role==="navigation"),h=Xt(t.sourceUrl,t.htmlSnippet),A=h?`
${h}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(m.length===0)return"Nenhuma";let b=m.filter(C=>C.type==="checkbox"||C.type==="chk"),v=new Set(m.filter(C=>C.type==="radio").map(C=>C.name).filter(Boolean)),x=b.filter(C=>!C.name||!v.has(C.name)),w=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(t.questionText),k=x.length>=2||w,P=v.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(t.questionText)&&v.size>=1,B=m.every(C=>C.type==="radio"||C.type==="chk")&&v.size===1&&!k&&!P,y=m.filter(C=>C.type==="text"||C.type==="number"||C.type==="val"||C.tag==="input"||C.tag==="textarea"),S=y.length>=2;return(P?`[GRADE VERDADEIRO/FALSO (${v.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${v.size} afirma\xE7\xF5es \u2014 emita ${v.size} a\xE7\xF5es chk separadas + adv]
...
`:"")+JSON.stringify(m.map(C=>({id:C.id,t:C.type,n:C.name||void 0,txt:C.label?C.label.length>160?C.label.slice(0,160)+"...":C.label:void 0,v:C.value||void 0,opt:C.options&&C.options.length?C.options.slice(0,20).map(M=>M.label||M.value):void 0})))})()}

[NAVEGA\xC7\xC3O]:
${g.length>0?g.map(b=>`"${b.label||b.id}"[${b.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length===0?"Nenhum anexo visual.":e.map((b,v)=>{let x=b.associatedLabel||"Gr\xE1fico da Quest\xE3o",w=b.alt?` | alt: "${b.alt}"`:"";if(b.captureStatus==="text_only")return`  - Imagem ${v+1} [CONTEXTO_TEXTUAL]: ${x}${w} | ${b.textContext||"sem contexto adicional"}`;if(b.captureStatus==="captured"||b.base64){let k=b.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${b.textContext}"`:"";return`  - Imagem ${v+1} [VISUAL_INLINE]: ${x}${w}${k}`}return`  - Imagem ${v+1} [FALHOU]: ${x}${w}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var Ut=new Set(["question","info","start","conclusion"]),Vt=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),Wt=new Set(["val","chk","sel","clk","adv","js","drag"]),Yt=150,Ae=2e3;function J(t,e=""){return t==null?e:typeof t=="string"?t.trim().slice(0,Ae):typeof t=="number"||typeof t=="boolean"?String(t).trim().slice(0,Ae):e}function Jt(t,e){if(!t||typeof t!="object")return null;let n=t,o=n.t;if(typeof o!="string"||!Wt.has(o))return null;if(o==="adv"){let r=n.id??n.target??n.name??n.selector;return{t:"adv",...J(r)?{id:J(r,"").slice(0,500)}:{}}}if(o==="drag"){let r=J(n.from??n.source),c=J(n.to??n.target??n.destination);return!r||!c?null:{t:"drag",from:r.slice(0,500),to:c.slice(0,500)}}if(o==="js"){let r=J(n.v??n.code??n.script);return!r||r.length>8e3?null:{t:"js",v:r}}let a=n.id??n.target??n.name??n.selector??n.element;(a==null||a==="")&&o==="val"&&(a="1");let i=J(a).slice(0,500);if(!i)return null;if(o==="val"){let r=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text!==void 0?n.text:n.answer;return{t:"val",id:i,v:J(r).slice(0,Ae)}}if(o==="sel"){let r=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.values,d=(Array.isArray(r)?r:[r]).map(u=>J(u).slice(0,500)).filter(Boolean);return{t:"sel",id:i,v:d}}if(o==="chk"){let r=n.c===!1||n.c==="false"||n.c===0||n.c==="0"||n.c==="off"||n.c==="unchecked"||n.c==="desmarcar",c={t:"chk",id:i,c:!r};return n.v!==void 0&&(c.v=J(n.v).slice(0,Ae)),c}let s={t:"clk",id:i};if(n.c!==void 0){let r=n.c===!1||n.c==="false"||n.c===0||n.c==="0"||n.c==="off"||n.c==="unchecked"||n.c==="desmarcar";s.c=!r}return n.v!==void 0&&(s.v=J(n.v).slice(0,Ae)),Array.isArray(n.co)&&n.co.length===2&&n.co.every(r=>typeof r=="number"&&Number.isFinite(r))&&(s.co=[n.co[0],n.co[1]]),s}function Kt(t,e,n){if(n!=="question")return t;let o=t.filter(i=>i.t==="adv"),a=t.filter(i=>i.t!=="adv");if(e==="escolha_unica"){a=a.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let i=a.filter(s=>s.t==="chk"||s.t==="clk");if(i.length>1){let s=a.filter(c=>c.t!=="chk"&&c.t!=="clk"),r=i[i.length-1];a=[...s,r]}}else if(e==="escolha_multipla"){a=a.filter(s=>!(s.t==="chk"&&s.c===!1||s.t==="clk"&&s.c===!1));let i=new Set;a=a.filter(s=>{let r="id"in s&&typeof s.id=="string"?s.id:"";return r?i.has(r)?!1:(i.add(r),!0):!0})}else if(e==="verdadeiro_falso"){let i=new Set,s=[...a].reverse(),r=[];for(let c of s){let d="id"in c&&typeof c.id=="string"?c.id:"";d?i.has(d)||(i.add(d),r.push(c)):r.push(c)}a=r.reverse()}return[...a,...o]}function ht(t){if(!t||typeof t!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=t,n=e.pageType,o=e.mode;(typeof n!="string"||!Ut.has(n))&&(n="question"),(typeof o!="string"||!Vt.has(o))&&(o="escolha_unica");let a=Array.isArray(e.actions)?e.actions:[],i=[];for(let c=0;c<Math.min(a.length,Yt);c++){let d=Jt(a[c],c);d&&i.push(d)}i.some(c=>c.t==="val")&&(o==="escolha_unica"||!e.mode)&&(o="preenchimento"),i.some(c=>c.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(o)&&(o="arrastar_soltar"),i=Kt(i,o,n);let s=i.some(c=>c.t==="adv");n==="conclusion"?i.length=0:n==="info"||n==="start"?s||i.push({t:"adv"}):n==="question"&&!s&&i.push({t:"adv"});let r=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:n,mode:o,confidence:r,rationale:J(e.rationale,"Plano validado e auto-recuperado."),actions:i,...J(e.memoryToStore)?{memoryToStore:J(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var ne=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let n=new Map(this.keys);this.keys.clear();let o=e.flatMap(i=>i.split(/[\n\r]+/));Array.from(new Set(o.map(i=>i.trim().replace(/^["']|["']$/g,"")).filter(i=>i.length>5))).forEach((i,s)=>{let r=this.generateId(i),c=n.get(r)||n.get(i);this.keys.set(r,{id:r,key:i,label:c?.label||`Chave ${s+1}`,addedAt:c?.addedAt||Date.now(),lastUsedAt:c?.lastUsedAt,lastLatencyMs:c?.lastLatencyMs,cooldownUntil:c?.cooldownUntil,errorCount:c?.errorCount||0,lastError:c?.lastError,winCount:c?.winCount||0})})}generateId(e){let n=0;for(let a=0;a<e.length;a++)n=(n<<5)-n+e.charCodeAt(a),n|=0;let o=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(n).toString(36).slice(0,6)}${o}`}static maskKey(e){let n=e.trim().replace(/^["']|["']$/g,"");return n.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${n.slice(0,6)}...${n.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(n=>{let o=Math.max(0,(n.cooldownUntil||0)-e);return{...n,isCooldown:o>0,remainingCooldownMs:o}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(n=>(n.cooldownUntil||0)<=e&&(n.errorCount||0)<50)}getRoundRobinKeys(e=2){let n=Date.now(),o=Array.from(this.keys.values()).filter(i=>(i.errorCount||0)<50);if(o.length===0)return Array.from(this.keys.values()).slice(0,e);let a=o.filter(i=>(i.cooldownUntil||0)<=n);return a.length>0?(a.sort((i,s)=>{let r=i.lastLatencyMs!==void 0?i.lastLatencyMs:99999,c=s.lastLatencyMs!==void 0?s.lastLatencyMs:99999;if(r!==c)return r-c;let d=(i.lastUsedAt||0)-(s.lastUsedAt||0);return d!==0?d:i.addedAt-s.addedAt}),a.slice(0,e)):(o.sort((i,s)=>(i.cooldownUntil||0)-(s.cooldownUntil||0)),o.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(n=>n.key)}markQuotaHit(e,n=8e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+n,o.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(n/1e3)}s ativado.`)}markOverloaded(e,n=5e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+n,o.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(n/1e3)}s ativado.`)}markSuccess(e,n){let o=this.findKeyObj(e);o&&(o.lastLatencyMs=n,o.lastUsedAt=Date.now(),o.errorCount=0,o.lastError=void 0,o.cooldownUntil=void 0)}markWinner(e){let n=this.findKeyObj(e);n&&(n.winCount=(n.winCount||0)+1)}markInvalid(e,n){let o=this.findKeyObj(e);o&&(o.errorCount=99,o.lastError=n)}addKey(e,n){let o=e.trim().replace(/^["']|["']$/g,"");if(!o)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(o.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let a=this.generateId(o);if(this.keys.has(a)||Array.from(this.keys.values()).some(r=>r.key===o))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let s={id:a,key:o,label:n?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(a,s),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:s}}updateKey(e,n,o){let a=this.keys.get(e);if(!a)return{ok:!1,message:"Chave n\xE3o encontrada."};let i=n.trim().replace(/^["']|["']$/g,"");return!i||i.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(a.key=i,o!==void 0&&(a.label=o.trim()),a.errorCount=0,a.cooldownUntil=void 0,a.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let n=this.findKeyObj(e);return n?(this.keys.delete(n.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let n of this.keys.values())if(n.key===e)return n}},K=new ne;var Ce=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],bt=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],Zt={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function We(t){return Zt[t]??t}function Gt(t,e){let o={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??$t};return/lite/i.test(t)||(/gemini-3\.[0-9]+-?flash/i.test(t)?o.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(t)&&(o.thinkingConfig={thinkingBudget:0})),o}var $t={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function vt(t){let e=t.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let n=We(e);return ce(n)?n:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function Ue(t,e){let n="";try{let o=JSON.parse(t);n=o.error?.message||o.message||""}catch{n=t.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(n)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(n)||e===429?`Cota do Gemini excedida (HTTP 429): ${n||"Aguarde"}`:e===404?`HTTP 404: ${n||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(n)?`Servidores Google sobrecarregados (HTTP 503): ${n||"Aguardando"}`:n?`Erro Gemini (HTTP ${e}): ${n}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function en(t){let e=t.trim(),n=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(n)try{return JSON.parse(n[1].trim())}catch{}try{return JSON.parse(e)}catch{}let o=e.match(/\{[\s\S]*\}/);if(o)try{return JSON.parse(o[0].trim())}catch{}try{let a=e.indexOf("{");if(a!==-1){let i=e.slice(a).trim();i=i.replace(/,\s*\{[^}]*$/,""),i=i.replace(/,\s*$/,"");let s=0,r=0,c=!1,d=!1;for(let f=0;f<i.length;f++){let l=i[f];if(d){d=!1;continue}if(l==="\\"){d=!0;continue}if(l==='"'){c=!c;continue}c||(l==="{"?s++:l==="}"?s=Math.max(0,s-1):l==="["?r++:l==="]"&&(r=Math.max(0,r-1)))}for(c&&(i+='"');r>0;)i+="]",r--;for(;s>0;)i+="}",s--;let u=JSON.parse(i);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var _e=(()=>{try{let t=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!t)return null;let e=JSON.parse(t);if(Array.isArray(e)){let n=e.filter(o=>o&&typeof o.id=="string"&&ce(o.id));return n.length>0?n:null}return null}catch{return null}})(),Xe=new Set;async function Ye(t){let e=t.trim().replace(/^["']|["']$/g,"");if(!e)return Ce;let n=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of n)try{let a=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!a.ok){let s=await a.text(),r=Ue(s,a.status);if(r.includes("inv\xE1lida")||r.includes("n\xE3o autorizada"))throw new Error(r);continue}let i=await a.json();if(Array.isArray(i.models)&&i.models.length>0){let s=i.models.filter(r=>{let c=r.supportedGenerationMethods||[],d=(r.name||"").replace(/^models\//,""),u=c.includes("generateContent");return ce(d)&&u}).map(r=>{let c=r.supportedGenerationMethods||[],d=r.name.replace(/^models\//,""),u=r.displayName||d;return{id:d,name:u.includes(d)?u:`${u} (${d})`,description:r.description||"",stable:!/-preview|-experimental|-latest/i.test(d),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(d),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(s.length>0){s.sort((r,c)=>{let d=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return d(c.id)-d(r.id)}),_e=s;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(s))}catch{}return s}}}catch(a){if(a.message?.includes("Chave de API"))throw a}return Ce}async function yt(t,e){let n=e.map(d=>d.trim().replace(/^["']|["']$/g,"")).filter(d=>d.length>5);if(n.length===0)return{ok:!1,model:t,key:"",message:"Nenhuma chave dispon\xEDvel."};let o=We(vt(t)),a=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),i={"Content-Type":"application/json"};async function s(d,u,f){let l=new AbortController,p=setTimeout(()=>l.abort(),f);try{let m=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(d)}`,g=await fetch(m,{method:"POST",headers:{...i,"x-goog-api-key":d},body:a,signal:l.signal});if(clearTimeout(p),g.ok)return{ok:!0,model:u,key:d,message:`Modelo '${u}' validado com sucesso!`};let h=await g.text().catch(()=>"");throw new Error(`HTTP ${g.status}: ${h.slice(0,80)}`)}catch(m){throw clearTimeout(p),m}}if(n.length>=2){let d=n.slice(0,6);try{return await Promise.any(d.map(f=>s(f,o,8e3)))}catch{}}let r=n[0],c=[o,...bt.filter(d=>d!==o)];for(let d of c)try{let u=await s(r,d,4e3);return d!==o&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${d}'.`),u}catch{}return{ok:!1,model:o,key:r,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function tn(t,e,n,o,a){let i=["v1beta","v1"],s=new Error(`Falha ao consultar modelo ${t}`),c={...Gt(t,a)};for(let d of i){if(o.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${d}/models/${t}:generateContent?key=${encodeURIComponent(e)}`,f=Date.now();try{let l=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...n,generationConfig:c}),signal:o});if(!l.ok){let g=await l.text();if(l.status===400){let A=/thinking/i.test(g),b=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(g);if((A||b)&&(c.thinkingConfig||c.responseSchema)){let v={...c};A&&delete v.thinkingConfig,b&&(delete v.responseSchema,delete v.responseMimeType),c=v;let x=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...n,generationConfig:c}),signal:o});if(x.ok){let P=await x.json(),B=P.candidates?.[0];if(B?.content?.parts?.[0]?.text)return K.markSuccess(e,Date.now()-f),{rawText:B.content.parts[0].text,data:P,usedModel:t,usedKey:e}}let w=await x?.text?.().catch(()=>"")??g,k=Ue(w,l.status);throw new Error(`[${t}|${ne.maskKey(e)}] ${k}`)}}let h=Ue(g,l.status);if(l.status===404&&d==="v1beta")continue;throw l.status===429?(K.markQuotaHit(e,8e3),wt(e,t,1e4),new Error(`[${t}|${ne.maskKey(e)}] ${h}`)):(l.status===503||/no capacity|overloaded|unavailable/i.test(g)?(K.markOverloaded(e,5e3),Xe.add(t)):l.status===403||/API_KEY_INVALID/i.test(g)?K.markInvalid(e,h):l.status===404&&Xe.add(t),new Error(`[${t}|${ne.maskKey(e)}] ${h}`))}let p=await l.json(),m=p.candidates?.[0];if(!m||!m.content?.parts?.[0]?.text)throw new Error(`[${t}|${ne.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return K.markSuccess(e,Date.now()-f),{rawText:m.content.parts[0].text,data:p,usedModel:t,usedKey:e}}catch(l){if(o.aborted)throw l;s=l;let p=s.message||"";if(p.includes("404")||/no longer available/i.test(p)){Xe.add(t);break}if(p.includes("429")||p.includes("Quota"))break}}throw s}var Ve=new Map;function At(t,e){let n=`${t}::${e}`,o=Ve.get(n);return o===void 0?!1:Date.now()>o?(Ve.delete(n),!1):!0}function wt(t,e,n=1e4){Ve.set(`${t}::${e}`,Date.now()+n)}async function xt(t,e,n,o,a,i){if(a?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let s=Array.isArray(n.apiKeys)&&n.apiKeys.length>0?n.apiKeys:n.apiKey?[n.apiKey]:[];K.init(s);let r=n.apiKey.trim().replace(/^["']|["']$/g,""),c=K.getBestKey()||r;if(!c)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let d=vt(n.model);if(!_e&&c&&Ye(c).catch(()=>{}),a?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),f=Fe(t,e,n),l=[{text:f}];for(let _=0;_<e.length;_++){let C=e[_],M=C.associatedLabel||(C.alt?`Imagem: ${C.alt}`:`Imagem ${_+1}`);if(C.captureStatus==="text_only"||!C.base64){let L=C.textContext||C.alt||"";l.push({text:`[CONTEXTO_IMAGEM_${_+1} - V\xCDNCULO: ${M}]: ${L}`})}else l.push({text:`[ANEXO VISUAL ${_+1} - V\xCDNCULO: ${M}]:`}),l.push({inline_data:{mime_type:C.mediaType,data:C.base64}})}let p={system_instruction:{parts:[{text:i?.systemPromptOverride??Ee}]},contents:[{role:"user",parts:l}]},m=We(d),g=bt.filter(_=>_!==m),A=K.getAllKeys().length,b=_=>A<=1||_===0?1:2,v=new Set,x=(_,C)=>{let M=/pro/i.test(_),L=/lite/i.test(_);return M?C===0?18e3:C===1?24e3:3e4:L?C===0?1e4:C===1?14e3:18e3:C===0?16e3:C===1?2e4:25e3},w=async(_,C)=>{if(C.length===0||a?.aborted)return null;let M=C.map(()=>new AbortController),L=()=>M.forEach(q=>{try{q.abort()}catch{}});a?.addEventListener("abort",L,{once:!0});let H=C.map(q=>`${q.model.replace("gemini-","")}/${q.label}`).join(" | ");o?.(`\u26A1 ${_}: ${C.length} slot(s) [${H}]...`,"info");try{let q=C.map(async(Q,N)=>{let j=M[N],le=setTimeout(()=>{try{j.abort(new Error(`Timeout ${Q.timeout/1e3}s (${Q.model}|${Q.label})`))}catch{j.abort()}},Q.timeout);try{let F=await tn(Q.model,Q.key,p,j.signal,i?.generationSchemaOverride);clearTimeout(le);let $=ht(en(F.rawText));return $.usedModel=F.usedModel,$.durationMs=Date.now()-u,$.promptSent=f,$.tokensUsed=F.data.usageMetadata?.totalTokenCount,$.promptTokens=F.data.usageMetadata?.promptTokenCount,$.candidatesTokens=F.data.usageMetadata?.candidatesTokenCount,$.rawResponse=F.rawText,M.forEach((st,Qt)=>{if(Qt!==N)try{st.abort(new Error("Cancelado: vencedor respondeu."))}catch{st.abort()}}),{plan:$,rawUsage:F.data.usageMetadata,usedModel:F.usedModel,usedKey:F.usedKey,slotLabel:Q.label}}catch(F){clearTimeout(le);let $=F instanceof Error?F.message:String(F);throw($.includes("429")||$.includes("Quota")||$.includes("RESOURCE_EXHAUSTED"))&&(wt(Q.key,Q.model,1e4),K.markQuotaHit(Q.key,8e3)),F}}),X=await Promise.any(q);return a?.removeEventListener("abort",L),K.markWinner(X.usedKey),X}catch(q){return a?.removeEventListener("abort",L),q instanceof AggregateError&&q.errors.length>0?y=q.errors.map(X=>X instanceof Error?X.message:String(X)).join(" | "):q instanceof Error&&(y=q.message),console.warn(`[EasyQuiz ${_}] Falha na onda:`,y),null}},P=(A<=1?1:1+Math.ceil((A-1)/2))+4,B=0,y="",S=0;for(;B<P;){if(a?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let _=K.getRoundRobinKeys(A),C=_.filter(j=>!v.has(`${j.key}::${m}`)&&!At(j.key,m)),M,L;if(C.length>0)M=m,L=C;else{let j=g;M=j[S%j.length]||m,S++;let le=_.filter(F=>!v.has(`${F.key}::${M}`)&&!At(F.key,M));L=le.length>0?le:_.filter(F=>!v.has(`${F.key}::${M}`))}if(L.length===0){if(S<g.length)continue;break}let H=L.slice(0,b(B));if(H.length===0)break;let q=x(M,B),X=H.map(j=>(v.add(`${j.key}::${M}`),{model:M,key:j.key,label:j.label||"Chave",timeout:q})),Q=B===0?"Onda 1":`Onda ${B+1}`,N=await w(Q,X);if(N){let j=N.plan.durationMs||Date.now()-u,le=ne.maskKey(N.usedKey);return o?.(`\u2705 ${j}ms via '${N.usedModel}' (${N.slotLabel}: ${le})`,"info"),N}B++}throw new Error(y||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var pe=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),ve=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,ae=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,nn=0;function Je(t){try{let e=t.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!me(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(t):t.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof t.getBoundingClientRect=="function"){let e=t.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(t.textContent||"").trim().length>0}function z(t){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(t)}catch{}return String(t).replace(/["\\]/g,"\\$&")}function T(t){let e=t;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||me(e))return!1;let n=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(n)){let o=e.type?.toLowerCase();if(o==="checkbox"||o==="radio"){if(e.id)try{let i=e.ownerDocument?.querySelector(`label[for="${z(e.id)}"]`);if(i&&Je(i))return!0}catch{}let a=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(a&&a!==e&&Je(a))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let i=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!i||i.display!=="none"&&i.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let s=e.getBoundingClientRect();if(s.width>0||s.height>0)return!0}return!0}}}catch{}}return Je(e)}function on(t){if(t==null)return"";if(typeof t=="string")return t;if(typeof t=="number"||typeof t=="boolean")return String(t);if(t instanceof Node)return t.textContent||"";try{if(typeof t?.toString=="function"){let e=t.toString();if(typeof e=="string")return e}}catch{}return""}function D(t,e=500){return on(t).replace(/\s+/g," ").trim().slice(0,e)}function an(t){let e=t.dataset.easyquizId;if(e)return e;let n=`eq-${Date.now().toString(36)}-${(nn+=1).toString(36)}`;return t.dataset.easyquizId=n,n}function me(t){return t?!!(t.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||t.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var be=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function R(t){if(!t||typeof t.getAttribute!="function"||typeof Element<"u"&&!(t instanceof Element))return!1;if(me(t))return!0;let e=t.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((t.type||"").toLowerCase()))return!1;let o=t.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||t,a=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||""),i=String(o.getAttribute?.("aria-label")||""),s=String(o.getAttribute?.("title")||""),r=typeof o.className=="string"?o.className:typeof o.className?.baseVal=="string"?o.className.baseVal:"",c=D(o.textContent,60);return!!(be.test(a)||be.test(i)||be.test(s)||be.test(r)||c.length>0&&c.length<=25&&be.test(c))}function Z(t){if(!t||typeof t.getAttribute!="function"||typeof Element<"u"&&!(t instanceof Element)||me(t)||R(t)||t.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||t.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&t instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&t instanceof HTMLButtonElement?t.value:"",n=D(t.getAttribute?.("aria-label")||t.textContent||t.getAttribute?.("value")||e),o=t.type,a=n.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),i=String(t.getAttribute?.("data-testid")||t.getAttribute?.("data-test-id")||t.getAttribute?.("id")||t.getAttribute?.("href")||"").toLowerCase();return ae.test(a)||ae.test(n)?!1:ve.test(a)||ve.test(n)||i.includes("next")||i.includes("check")||i.includes("continue")||i.includes("proximo")||i.includes("forward")?!0:/^\d{1,3}$/.test(n.trim())?!!t.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function Ke(t){let e=t.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),d=c&&c!==t.closest("td")?D(c.textContent,100):"",u=D(t.closest("label, td")?.textContent||"",50);if(d&&u)return`${d}: ${u}`}let n=t.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(n){let c=n.querySelector('.dropdown-label, [class*="label" i]'),d=c&&c!==t?D(c.textContent,150):"";if(d)return d}let o=t.getAttribute("aria-label");if(o)return D(o);let a=t.getAttribute("aria-labelledby");if(a){let c=a.split(/\s+/).map(d=>document.getElementById(d)?.textContent).filter(Boolean).join(" ");if(c.trim())return D(c)}if("labels"in t&&t.labels){let c=Array.from(t.labels??[]).map(d=>d.textContent).join(" ");if(c.trim())return D(c)}let i=t.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(i&&i!==t){let c=D(i.textContent);if(c)return c}let s=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=t.getAttribute("placeholder")||t.getAttribute("title")||t.textContent||s||"";return D(r)}function Ze(t,e){let o=typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName.toLowerCase()==="select"?t:null,a=t;t.dataset.easyquizRole=e;let i=t.tagName.toLowerCase(),s=["input","textarea","select","button"].includes(i)?i:"other",r=t.getAttribute("role")||"",c=(t.getAttribute("data-testid")||t.getAttribute("data-test-id")||"").toLowerCase(),d=(t.className&&typeof t.className=="string"?t.className:"").toLowerCase(),u=t.getAttribute("draggable")==="true"||t.classList.contains("perseus-drag-item")||t.classList.contains("sortable-item")||d.includes("cursor-grab")||!!t.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(d),f=t.getAttribute("data-role")==="dropzone"||t.classList.contains("category-container")||t.hasAttribute("data-category")||!!t.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(d),p=D((u?"draggable":f?"dropzone":"")||a.type||r||s,40),m="";if(a.type==="checkbox"||a.type==="radio"||r==="radio"||r==="checkbox"){let x=a.checked||t.getAttribute("aria-checked")==="true",w=a.value&&a.value!=="on"?a.value:t.getAttribute("data-value")||"";m=x?w?`checked:${w}`:"checked":w||"unchecked"}else if(s==="button"||i==="a"||e==="navigation"||Z(t))m="";else{let x=typeof t.value=="string"||typeof t.value=="number"?t.value:"";m=D(x||t.getAttribute("data-category")||"",2e3)}let g=[];if(o&&o.options)for(let x of Array.from(o.options).slice(0,80))g.push({value:D(x.value),label:D(x.textContent)});else if(r==="combobox"||r==="listbox"||d.includes("select")||d.includes("dropdown")){let x=t.getAttribute("aria-controls")||t.getAttribute("aria-owns"),w=x?document.getElementById(x):t;if(w){let k=w.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let P of Array.from(k).slice(0,80)){let B=D(P.textContent);B&&g.push({value:P.getAttribute("data-value")||P.getAttribute("value")||B,label:B})}}}let h=!!(a.required||t.getAttribute("aria-required")==="true"),A=!!(a.disabled||t.getAttribute("aria-disabled")==="true"),b=an(t);return{id:t.id||b,tag:s,type:p,label:Ke(t),name:D(a.name||t.getAttribute("name")||"",180),value:m,options:g,required:h,disabled:A,role:e}}var Et=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Ct(t){if(!T(t))return-1/0;let e=t.getBoundingClientRect(),n=Array.from(t.querySelectorAll(pe)).filter(T),o=D(t.innerText||t.textContent||"",4e3).length;if(o<10||!n.length&&o<60)return-1/0;let a=Math.max(1,window.innerWidth*window.innerHeight),i=Math.max(1,e.width*e.height),s=Math.min(1,i/a),r=e.top+e.height/2,c=Math.abs(r-window.innerHeight/2)/Math.max(1,window.innerHeight),d=o>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return n.length*15+Math.min(60,o/20)+d+u-s*20-c*10}function ke(t){let e=t;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let n=e.parentElement,o=n.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(n.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&o!=="main"&&o!=="body"){e=n;break}let a=D(e.innerText||e.textContent||"",1e4),i=D(n.innerText||n.textContent||"",1e4),s=e.querySelectorAll(pe).length,r=n.querySelectorAll(pe).length;if(a.length<150&&i.length>a.length&&r<=s+4&&o!=="main"&&o!=="body"){e=n;continue}break}return e}function _t(t){let e=t,n=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(n&&n!==document.body&&T(n))return n;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function G(){let t=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(t&&T(t))return t;let e=document.activeElement;if(e&&e!==document.body){let s=e.closest(Et);if(s&&Ct(s)>0)return ke(s)}let o=Array.from(document.querySelectorAll(Et)).map(s=>({element:s,score:Ct(s)})).filter(s=>Number.isFinite(s.score)).sort((s,r)=>r.score-s.score),a=o.find(s=>{let r=s.element.tagName.toLowerCase();return r!=="main"&&r!=="body"&&s.score>0});if(a)return ke(a.element);if(o.length>0&&o[0].score>0)return ke(o[0].element);let i=document.querySelector('form, main, [role="main"]');return i&&T(i)?i:document.body}function kt(t){let e=t.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let n=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let a of Array.from(o.attributes))n.includes(a.name)||o.removeAttribute(a.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Se(t){let e=Array.from(t.querySelectorAll(pe)),n=new Set,o=[];for(let d of e){if(!T(d)||Z(d)||R(d))continue;let u=(d.value||d.textContent||"").trim();if(ae.test(u))continue;let f=d.tagName.toLowerCase();["input","textarea","select"].includes(f)&&(n.add(d),o.push(d))}for(let d of e){if(!T(d)||Z(d)||R(d))continue;let u=(d.value||d.textContent||"").trim();if(ae.test(u))continue;let f=d.tagName.toLowerCase();if(["input","textarea","select"].includes(f))continue;let l=d.querySelector("input, textarea, select");if(!(l&&n.has(l))){if(d.hasAttribute("for")){let p=d.getAttribute("for"),m=p?d.ownerDocument.getElementById(p):null;if(m&&n.has(m))continue}if(f==="a"){let p=d.getAttribute("role"),m=d.getAttribute("class")||"",g=d.getAttribute("data-testid")||"",h=d.getAttribute("draggable")==="true"||d.classList.contains("perseus-drag-item")||d.classList.contains("sortable-item")||m.includes("cursor-grab")||!!d.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(g)||/drag|card-item|sortable/i.test(m);if(!(p==="button"||p==="radio"||p==="checkbox"||p==="option"||h||d.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}o.push(d)}}let a=o.length>0&&o.every(d=>R(d)||/read-?aloud|audio/i.test(d.getAttribute("data-testid")||d.getAttribute("aria-label")||"")),i=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||t,s=document.body.querySelector('[class*="classification" i]')!==null||t.querySelector('[class*="classification" i]')!==null||t.querySelector('[data-cy*="quiz" i]')!==null||t.querySelector('[class*="draggable-item" i]')!==null||t.querySelector('[class*="drag-item" i]')!==null||t.querySelector('[class*="sortable-card" i]')!==null||t.matches?.('[class*="classification" i]');if((o.length===0||a)&&s){a&&(o.length=0);let d=Array.from(i.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(d.length>0){for(let u of d)if(!(!T(u)||R(u))&&(o.push(u),o.length>=50))break}else{let u=Array.from(i.querySelectorAll("button, div[class], span[class], p, li"));for(let f of u){if(!T(f)||Z(f)||R(f)||ae.test((f.textContent||"").trim()))continue;let l=(f.textContent||"").trim();if(l.length<2||l.length>300)continue;if(Array.from(f.children).some(m=>m.className&&m.textContent?.trim())||o.push(f),o.length>=50)break}}}let c=!o.some(d=>["input","select","textarea"].includes(d.tagName.toLowerCase()))&&o.length>0&&o.every(d=>{let u=d.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let f=(d.textContent||"").trim();return!d.id||f.length<10||/^\d+\s*\/\s*\d+$/.test(f)||/^question text/i.test(f)});if(o.length===0||c){c&&(o.length=0);let d=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(d.length>0)for(let u of d){if(!T(u)||me(u)||Z(u)||R(u)||ae.test((u.textContent||"").trim()))continue;let f=(u.textContent||"").trim();if(!(f.length<10||f.length>500)&&!/^\d+\s*\/\s*\d+$/.test(f)&&(o.push(u),o.length>=20))break}}return o.slice(0,100).map(d=>Ze(d,"answer"))}function Ge(t){let e=[t,t.parentElement,t.parentElement?.parentElement,document.body].filter(Boolean),n=new Set,o=[];for(let a of e)for(let i of Array.from(a.querySelectorAll(pe)))if(!(n.has(i)||!T(i)||!Z(i)||R(i))&&(n.add(i),o.push(Ze(i,"navigation")),o.length>=10))return o;return o}function Te(t=!1){let e=G();e=ke(e),t&&(e=_t(e));let n=Se(e),o=Ge(e);if(n.length===0){let r=Se(document.body);r.length>0&&(e=_t(e),n=Se(e),n.length===0&&(n=r,e=document.querySelector('main, article, form, [role="main"]')||document.body))}o.length===0&&(o=Ge(document.body));let a=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",i=a.length>4e4?D(a.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+D(a.slice(-2e3),2e3):D(a,16e3),s=[...n,...o].slice(0,120);return!i||s.length===0&&i.length<30?D(document.body.innerText||document.body.textContent||"",16e3).length>=30?ye():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:i,htmlSnippet:kt(e),controls:s,scope:e}}function ye(){let t=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=D(t,16e3),n=Se(document.body),o=Ge(document.body),a=[...n,...o].slice(0,120),i=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:kt(i).slice(0,15e3),controls:a,scope:i}}function St(t){let e=t.controls.map(n=>{let o=n.options?n.options.length:0;return`${n.role}:${n.id}:${n.type}:${o}`}).join("|");return[window.location.href,t.pageTitle,t.questionText.slice(0,400),e].join("::")}var $e=10,rn=1400,we=15e5;function re(t){return new Promise((e,n)=>{let o=new FileReader;o.onerror=()=>n(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let a=String(o.result||"");e(a.split(",")[1]||"")},o.readAsDataURL(t)})}async function de(t){let e=0,n=0;if(t instanceof HTMLImageElement?(e=t.naturalWidth||t.width,n=t.naturalHeight||t.height):(e=t.width,n=t.height),e<=0||n<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,rn/Math.max(e,n)),a=Math.max(1,Math.round(e*o)),i=Math.max(1,Math.round(n*o)),s=document.createElement("canvas");s.width=a,s.height=i;let r=s.getContext("2d",{alpha:!1});if(!r)throw new Error("Sem suporte a Canvas 2D.");return r.fillStyle="#ffffff",r.fillRect(0,0,a,i),r.drawImage(t,0,0,a,i),new Promise((c,d)=>{s.toBlob(u=>u?c(u):d(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Mt(t){let e=typeof t.getBoundingClientRect=="function"?t.getBoundingClientRect():{width:0,height:0},n=e.width||parseFloat(t.getAttribute("width")||"0")||parseFloat(t.style.width||"0")||400,o=e.height||parseFloat(t.getAttribute("height")||"0")||parseFloat(t.style.height||"0")||300,a=2,i=Math.min(1800,Math.max(120,Math.round(n*a))),s=Math.min(1800,Math.max(100,Math.round(o*a))),r=t.cloneNode(!0);r.getAttribute("xmlns")||r.setAttribute("xmlns","http://www.w3.org/2000/svg"),r.getAttribute("xmlns:xlink")||r.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),r.setAttribute("width",String(i)),r.setAttribute("height",String(s)),!r.getAttribute("viewBox")&&n>0&&o>0&&r.setAttribute("viewBox",`0 0 ${n} ${o}`);try{let l=Array.from(t.querySelectorAll("*")),p=Array.from(r.querySelectorAll("*"));for(let m=0;m<Math.min(l.length,p.length);m++){let g=l[m],h=p[m];if(!g||!h||!h.style)continue;let A=window.getComputedStyle?window.getComputedStyle(g):null;A&&(A.fill&&A.fill!=="none"&&(h.style.fill=A.fill),A.stroke&&A.stroke!=="none"&&(h.style.stroke=A.stroke),A.strokeWidth&&(h.style.strokeWidth=A.strokeWidth),A.fontFamily&&(h.style.fontFamily=A.fontFamily),A.fontSize&&(h.style.fontSize=A.fontSize),A.fontWeight&&(h.style.fontWeight=A.fontWeight),A.color&&(h.style.color=A.color))}}catch{}let c="#ffffff";try{let l=t.parentElement||t;for(;l&&l!==document.documentElement;){let m=(window.getComputedStyle?window.getComputedStyle(l):null)?.backgroundColor;if(m&&m!=="transparent"&&m!=="rgba(0, 0, 0, 0)"){c=m;break}l=l.parentElement}}catch{}let u=new XMLSerializer().serializeToString(r),f="";try{f=btoa(unescape(encodeURIComponent(u)))}catch{}try{let l=h=>new Promise((A,b)=>{let v=new Image,x=setTimeout(()=>b(new Error("Timeout render SVG")),1200);v.onload=()=>{clearTimeout(x),A(v)},v.onerror=()=>{clearTimeout(x),b(new Error("Falha ao renderizar SVG em Image."))},v.src=h}),p=null;if(f)try{p=await l(`data:image/svg+xml;base64,${f}`)}catch{}if(!p){let h=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),A=URL.createObjectURL(h);try{p=await l(A)}finally{URL.revokeObjectURL(A)}}let m=document.createElement("canvas");m.width=i,m.height=s;let g=m.getContext("2d",{alpha:!1});if(g&&p){g.fillStyle=c,g.fillRect(0,0,i,s),g.drawImage(p,0,0,i,s);let h=await new Promise(A=>{m.toBlob(A,"image/jpeg",.92)});if(h){let A=await re(h);if(A)return{blob:h,base64:A,mediaType:"image/jpeg"}}}}catch{}return{base64:f,mediaType:"image/svg+xml"}}async function et(t){try{let e=t.getBoundingClientRect(),n=Math.round(e.width)||t.offsetWidth||400,o=Math.round(e.height)||t.offsetHeight||300;if(n<30||o<30)return null;let a=t.tagName.toLowerCase()==="svg"?t:t.querySelector("svg");if(a&&t.querySelectorAll("input, select, textarea").length===0)try{let g=await Mt(a);if(g.base64&&g.base64.length<=we)return{mediaType:g.mediaType,base64:g.base64,alt:t.getAttribute("aria-label")||a.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:se(a)}}catch{}if(t instanceof HTMLCanvasElement)try{let g=await de(t),h=await re(g);if(h)return{mediaType:"image/jpeg",base64:h,alt:t.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let i="#ffffff";try{let g=t;for(;g&&g!==document.documentElement;){let A=(window.getComputedStyle?window.getComputedStyle(g):null)?.backgroundColor;if(A&&A!=="transparent"&&A!=="rgba(0, 0, 0, 0)"){i=A;break}g=g.parentElement}}catch{}let s=t.cloneNode(!0),r=Array.from(t.querySelectorAll("*")),c=Array.from(s.querySelectorAll("*"));for(let g=0;g<Math.min(r.length,c.length);g++){let h=r[g],A=c[g];if(!(!h||!A||!A.style))try{let b=window.getComputedStyle(h);A.style.color=b.color,A.style.backgroundColor=b.backgroundColor,A.style.borderColor=b.borderColor,A.style.borderWidth=b.borderWidth,A.style.borderStyle=b.borderStyle,A.style.fontSize=b.fontSize,A.style.fontFamily=b.fontFamily,A.style.fontWeight=b.fontWeight,A.style.lineHeight=b.lineHeight,A.style.letterSpacing=b.letterSpacing,A.style.textAlign=b.textAlign}catch{}}let d=Math.min(2,Math.max(1,1200/Math.max(n,o))),u=Math.round(n*d),f=Math.round(o*d),l=`
...
`};var qe=class{el=null;state="idle";mouseX=-300;mouseY=-300;displayX=-300;displayY=-300;rafId=null;flashTimer=null;boundMove;constructor(){this.boundMove=e=>{this.mouseX=e.clientX,this.mouseY=e.clientY,this.displayX===-300&&(this.displayX=e.clientX,this.displayY=e.clientY)},window.addEventListener("mousemove",this.boundMove,{passive:!0}),this.injectStyle(),this.createEl(),this.startRaf()}injectStyle(){if(document.getElementById("__eqdc_style__"))return;let e=document.createElement("style");e.id="__eqdc_style__",e.textContent=`
    ...
    `,document.documentElement.appendChild(e)}open(){this.close();let n=te().model,o=[...Ce],a=(_e||[]).filter(g=>!o.some(h=>h.id===g.id)),i=document.createElement("div");i.id="__eqdm_menu__",i.setAttribute("role","menu"),i.tabIndex=-1;let s=document.createElement("div");s.className="__eqdm_section__",s.textContent="Modelo Gemini",i.appendChild(s);let r=document.createElement("div");r.className="__eqdm_sep__",i.appendChild(r);let c=(g,h,A)=>{let b=g===n,v=document.createElement("div");v.className="__eqdm_item__",v.setAttribute("role","menuitemradio"),v.setAttribute("aria-checked",b?"true":"false"),v.tabIndex=0;let x=document.createElement("span");x.className="__eqdm_check__",b&&(x.innerHTML=`<svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
        ...
        </svg>`),v.appendChild(x);let w=document.createElement("span");if(w.className="__eqdm_name__",w.textContent=h,b&&(w.style.fontWeight="500"),v.appendChild(w),A){let k=document.createElement("span");k.className="__eqdm_badge__",k.textContent=A,v.appendChild(k)}v.addEventListener("click",()=>{he({model:g}),this.onModelChange?.(g),this.close()}),v.addEventListener("keydown",k=>{(k.key==="Enter"||k.key===" ")&&(k.preventDefault(),he({model:g}),this.onModelChange?.(g),this.close())}),i.appendChild(v)};for(let g of o){let h;g.id.includes("3.8")||g.id.includes("3.7")?h="Novo":g.id.includes("flash-lite")?h="Eco":g.id.includes("pro")&&(h="Pro");let A=g.name.replace(/\s*\(.*?\)\s*/g,"").trim();c(g.id,A,h)}if(a.length>0){let g=document.createElement("div");g.className="__eqdm_sep__",i.appendChild(g);let h=document.createElement("div");h.className="__eqdm_section__",h.textContent="Modelos da conta",i.appendChild(h);for(let A of a)c(A.id,A.name.replace(/\s*\(.*?\)\s*/g,"").trim())}document.documentElement.appendChild(i),this.el=i;let{offsetWidth:d,offsetHeight:u}=i,f=this.lastMouseX,l=this.lastMouseY,p=window.innerWidth,m=window.innerHeight;f+d+8>p&&(f=p-d-8),l+u+8>m&&(l=m-u-8),f<4&&(f=4),l<4&&(l=4),i.style.left=`${f}px`,i.style.top=`${l}px`,i.focus(),setTimeout(()=>{window.addEventListener("click",this.boundOutside,{capture:!0}),window.addEventListener("keydown",this.boundOutside,{capture:!0})},50),this.autoTimer=window.setTimeout(()=>this.close(),8e3)}close(){this.autoTimer&&(clearTimeout(this.autoTimer),this.autoTimer=null),window.removeEventListener("click",this.boundOutside,{capture:!0}),window.removeEventListener("keydown",this.boundOutside,{capture:!0}),this.el?.remove(),this.el=null}isOpen(){return this.el!==null}destroy(){this.close(),window.removeEventListener("mousemove",this.boundMouseMove),document.getElementById("__eqdm_style__")?.remove()}};var He=class{el=null;coin;toast;boundEsc;constructor(e,n){this.coin=e,this.toast=n,this.boundEsc=o=>{o.key==="Escape"&&this.isOpen()&&(o.stopPropagation(),o.preventDefault(),this.close())},this.injectStyle()}injectStyle(){if(document.getElementById("__eqkm_style__"))return;let e=document.createElement("style");e.id="__eqkm_style__",e.textContent=`
      #__eqkm_overlay__ {
...
`),o=document.createElement("div");o.id="__eqkm_overlay__";let a=document.createElement("div");a.id="__eqkm_dialog__",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    `,o.appendChild(a),document.documentElement.appendChild(o),this.el=o;let i=a.querySelector("#__eqkm_ta__"),s=a.querySelector("#__eqkm_count__"),r=a.querySelector("#__eqkm_status__");i.value=n,this.updateCount(i.value,s),i.addEventListener("input",()=>this.updateCount(i.value,s)),a.querySelector("#__eqkm_close__").addEventListener("click",()=>this.close()),a.querySelector("#__eqkm_cancel__").addEventListener("click",()=>this.close()),a.querySelector("#__eqkm_save__").addEventListener("click",()=>{let c=this.parseKeys(i.value);he({apiKey:c[0]||"",apiKeys:c}),this.toast.flash("Config Saved"),this.coin.flashOk(1200),this.close()}),a.querySelector("#__eqkm_verify__").addEventListener("click",async()=>{let c=this.parseKeys(i.value);if(!c.length){r.style.color="#c5221f",r.textContent="Insira ao menos uma chave.";return}r.style.color="#70757a",r.textContent="Verificando\u2026",this.coin.setState("loading");try{let d=te().model,u=await yt(d,c);u.ok?(r.style.color="#137333",r.textContent=`\u2713 Acesso v\xE1lido \u2014 ${u.model}`,this.coin.flashOk(),this.toast.flash("Access OK")):(r.style.color="#c5221f",r.textContent=`\u2717 ${u.message.slice(0,55)}`,this.coin.flashError(),this.toast.flash("Access Denied"))}catch{r.style.color="#c5221f",r.textContent="\u2717 Erro ao verificar.",this.coin.flashError()}}),o.addEventListener("click",c=>{c.target===o&&this.close()}),window.addEventListener("keydown",this.boundEsc,{capture:!0}),requestAnimationFrame(()=>i.focus())}parseKeys(e){return e.split(/[\n\r,]+/).map(n=>n.trim().replace(/^["']|["']$/g,"")).filter(n=>n.length>5)}updateCount(e,n){let o=this.parseKeys(e).length;n.textContent=o===0?"":`${o} chave${o!==1?"s":""} cadastrada${o!==1?"s":""}`}close(){window.removeEventListener("keydown",this.boundEsc,{capture:!0}),this.el?.remove(),this.el=null}isOpen(){return this.el!==null}destroy(){this.close()}};var De=class{active=[];constructor(){this.injectStyle()}injectStyle(){if(document.getElementById("__eqsh_style__"))return;let e=document.createElement("style");e.id="__eqsh_style__",e.textContent=`
...
`);navigator.clipboard.writeText(a).then(()=>{n.textContent="\u2713",setTimeout(()=>n.textContent="\u{1F4CB}",1e3)})}),this.el.querySelector("#__eq_dbg_btn_clear__")?.addEventListener("click",()=>{this.logs=[],this.renderConsoleLogs(),this.updateTabCounters()})}renderFlow(){let e=this.el?.querySelector(".__eq_dbg_body__");if(!e)return;if(!this.currentFlow||this.currentFlow.length===0){e.innerHTML=`
      ...
      `;return}let n=this.currentFlow.map((a,i)=>{let s=a.action,r=this.stepStatuses.get(i)||(i===this.currentStepIdx?"active":i<this.currentStepIdx?"done":"pending"),c=r==="done"?'<span class="__eq_status_done__">\u2713 Conclu\xEDdo</span>':r==="active"?'<span class="__eq_status_active__">\u25B6 Em Andamento</span>':r==="failed"?'<span class="__eq_status_failed__">\u2715 Falhou</span>':'<span class="__eq_status_pending__">Pendente</span>',d=a.trigger==="key"?"\u2328\uFE0F Tecla":"\u{1F5B1}\uFE0F Clique",u=String(s.t||"act").toUpperCase(),f=s.id?`#${s.id}`:s.name?`[name="${s.name}"]`:s.label||s.from||"alvo",l=s.v!==void 0?` = "${s.v}"`:s.c!==void 0?` (check: ${s.c})`:"";return`
        <div class="__eq_flow_card__ ${r==="active"?"__eq_flow_active__":""}">
          ...
          <div class="__eq_flow_content__">
            <div class="__eq_flow_target__">${Y(String(f))}<span style="color:#8ab4f8;">${Y(String(l))}</span></div>
    ...
    `,e.querySelector("#__eq_btn_copy_json__")?.addEventListener("click",i=>{navigator.clipboard.writeText(a).then(()=>{let s=i.currentTarget;s.textContent="\u2713 Copiado",setTimeout(()=>s.textContent="Copiar JSON",1200)})})}renderMedia(){let e=this.el?.querySelector(".__eq_dbg_body__");if(!e)return;if(!this.capturedImages||this.capturedImages.length===0){e.innerHTML=`
      ...
      `;return}let n=this.currentPlan?.imageDescriptions||[],o="";this.capturedImages.forEach((a,i)=>{let s=n.find(m=>m.index===i),r=s?.relevant??!0,c=s?.description??(a.textContext||"Aguardando an\xE1lise da IA..."),d=a.captureStatus==="captured"?"\u2705":a.captureStatus==="text_only"?"\u{1F4DD}":"\u26A0\uFE0F",u=a.captureStatus==="captured"?"Visual":a.captureStatus==="text_only"?"Texto":"Falhou",f=a.base64?`data:${a.mediaType||"image/jpeg"};base64,${a.base64}`:"",l="";f?l=`
    ...
    `)}updateTabCounters(){if(!this.el)return;let e=this.el.querySelector("#__eq_cnt_all"),n=this.el.querySelector("#__eq_cnt_err"),o=this.el.querySelector("#__eq_cnt_flow"),a=this.el.querySelector("#__eq_cnt_dom"),i=this.el.querySelector("#__eq_cnt_ai");e&&(e.textContent=String(this.logs.length)),n&&(n.textContent=String(this.logs.filter(c=>c.category==="ERROR"||c.category==="WARN"||c.category==="REPLAN").length)),o&&(o.textContent=String(this.logs.filter(c=>c.category==="FLOW"||c.category==="KEY"||c.category==="CLICK").length)),a&&(a.textContent=String(this.logs.filter(c=>c.category==="DOM"||c.category==="ACTION").length)),i&&(i.textContent=String(this.logs.filter(c=>c.category==="AI").length));let s=this.el.querySelector("#__eq_tab_badge_flow__");s&&(s.textContent=this.currentFlow.length>0?`${this.currentStepIdx+1}/${this.currentFlow.length}`:"0");let r=this.el.querySelector("#__eq_tab_badge_media__");r&&(r.textContent=String(this.capturedImages.length))}updatePill(){if(!this.pillEl)return;let e=this.logs.filter(i=>i.category==="ERROR").length,n=this.currentFlow.length,o=n>0?`${this.currentStepIdx+1}/${n}`:"Idle",a=this.pillEl.querySelector(".__eq_pill_text__");a&&(a.innerHTML=`<img src="${xe.canvasLogo}" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;object-fit:contain;"/>EQ ${ge}: ${o} ${e>0?`(${e} err)`:"\u2022 OK"}`)}createDom(){this.el=document.createElement("div"),this.el.id="__eq_dbg_window__",this.el.style.display="none",this.el.innerHTML=`
...
`;function Rt(t){let e=[],n=1;for(let o of t){let a=o.t;a==="val"?e.push({step:n++,trigger:"key",action:o,hint:"Keyboard Interact",customMsg:null}):a==="chk"||a==="clk"?e.push({step:n++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:null}):a==="sel"?(e.push({step:n++,trigger:"click",action:o,hint:"Mouse Interact",customMsg:"Opening..."}),e.push({step:n++,trigger:"click",action:o,hint:"Option Selected",customMsg:null})):a==="drag"?e.push({step:n++,trigger:"click",action:o,hint:"Mover Item",customMsg:null}):a==="adv"&&e.push({step:n++,trigger:"click",action:o,hint:"Next Page Loading",customMsg:null})}return e}function jt(t,e){if(!Array.isArray(t)||t.length===0)return Rt(e);let n=[];for(let s of t){if(!s||typeof s!="object")continue;let r=s,c=r.trigger==="key"?"key":"click",d=r.action||{},u=c==="key"?1:void 0;n.push({step:typeof r.step=="number"?r.step:n.length+1,trigger:c,action:d,chars:u,hint:typeof r.hint=="string"?r.hint.slice(0,30):c==="key"?"Keyboard Interact":"Mouse Interact",customMsg:typeof r.customMsg=="string"?r.customMsg.slice(0,22):null})}if(n.length===0)return Rt(e);let o=vn(n,e),a=[],i=1;for(let s of o)if(s.action.t==="val"){let r=String(s.action.v??"");if(r.length>0)for(let c=1;c<=r.length;c++)a.push({...s,step:i++,chars:1,action:{...s.action,v:r.slice(0,c)},customMsg:c===r.length?"Preenchido":null});else s.step=i++,a.push(s)}else s.step=i++,a.push(s);return a}function vn(t,e){let n=[];for(let o=0;o<t.length;o++){let a=t[o],i=a.action;if(!i.t&&e[o]&&(a.action=e[o]),i.t==="chk"&&!i.name&&i.id){let r=String(i.id);if(r.startsWith("eq-")||r.match(/^[a-z0-9]+-[a-z0-9]+-[a-z0-9]+$/))try{let c=document.querySelector(`[data-easyquiz-id="${r}"], #${r}`);c?.name&&(a.action.name=c.name,c.value&&c.value!=="on"&&(a.action.v=c.value))}catch{}}if(i.t==="val"){let r=e.find(c=>c.t==="val"&&(i.id&&c.id===i.id||i.name&&c.name===i.name));r&&r.v!==void 0&&String(r.v).length>String(i.v??"").length&&(a.action.v=r.v)}let s=n[n.length-1];if(s){let r=s.action;if(r.t==="val"&&i.t==="val"&&(!!i.id&&!!r.id&&i.id===r.id||!!i.name&&!!r.name&&i.name===r.name||!i.id&&!i.name&&!r.id&&!r.name)){let f=e.find(l=>l.t==="val"&&(i.id&&l.id===i.id||i.name&&l.name===i.name))?.v??(String(r.v||"").length>=String(i.v||"").length?r.v:i.v);r.v=f;continue}if(s.trigger===a.trigger&&r.t===i.t&&r.name===i.name&&r.v===i.v&&r.id===i.id||r.t==="adv"&&i.t==="adv")continue}a.step=n.length+1,n.push(a)}return n.length>0?n:t}if(window.__eqdiscrete)try{window.__eqdiscrete.destroy()}catch{}xn();function yn(){try{if(document.querySelector("link[data-eqdiscrete-preconnect]"))return;let t=document.createElement("link");t.rel="preconnect",t.href="https://generativelanguage.googleapis.com",t.crossOrigin="anonymous",t.setAttribute("data-eqdiscrete-preconnect","true"),document.head?.appendChild(t)}catch{}}var wn=Ee+Bt;async function xn(){yn(),gt();let t=new qe,e=new Oe,n=new De,o=new Ne(t,e,n),a=new Be({onForceStep:w=>o.forceStep(w),onForceAllSteps:()=>o.forceAll()});o.setDebugOutput(a);let i=new Pe({onModelChange:()=>e.flash("Modelo OK")}),s=new He(t,e),r=new Re,c=null,d=!1,u=null,f=0;window.addEventListener("click",w=>{if(d&&w.isTrusted){let k=w.target;k&&!k.closest("#__eqdm_menu__,#__eqkm_overlay__,#__eqcm_menu__,#__eqdiscrete_coin__,#__eqdiscrete_toasts__,#__eq_dbg_window__,#__eq_dbg_pill__")&&(f=Date.now(),a.log("CLICK","Clique antecipado registrado durante an\xE1lise"))}},{capture:!0});let l=new ze({onPageAdvance:()=>o.isActive()||d?!1:(h(!0),!0)});l.start();let p=te();p.apiKey&&Ye(p.apiKey).catch(()=>{}),e.flash(`<img src="${xe.canvasLogo}" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;object-fit:contain;"/>EQ ${ge} Ativo`);let m=0,g=[1500,3e3,5e3,8e3];async function h(w=!1,k=0){if(u&&(clearTimeout(u),u=null),d&&w){a.log("SYS","An\xE1lise j\xE1 em andamento \u2014 preservando requisi\xE7\xE3o ativa");return}if(w&&o.isActive())return;if(c){try{c.abort()}catch{}c=null}o.isActive()&&o.abort();let P=te();if(!P.apiKey&&(!Array.isArray(P.apiKeys)||P.apiKeys.length===0)){e.flash("Config: Shift+A"),t.flashError(2e3);return}d=!0,m=k,c=new AbortController;let B=c.signal;l.resetHash(),t.setState("loading"),(!w||k>0)&&e.flash(k>0?`Tentativa ${k+1}`:"Analisando"),a.log("SYS",`Iniciando an\xE1lise (proativo: ${w}, retry: ${k})`);function y(){let S=g[Math.min(k,g.length-1)];a.log("WARN",`Agendando retry em ${S}ms`),u=window.setTimeout(()=>{o.isActive()||h(!1,k+1)},S)}try{if(w&&await new Promise(N=>setTimeout(N,60)),B.aborted)return;let S=Te(!1);if(S||(S=ye()),!S||!S.questionText?.trim()){t.setState("idle"),k===0&&!w&&e.flash("Sem conte\xFAdo"),a.log("WARN","Nenhum conte\xFAdo ou quest\xE3o detectada na p\xE1gina"),y();return}a.log("DOM",`Contexto detectado: ${S.controls.length} controles, ${S.questionText.length} chars`,S.questionText);let _=await It(S.scope,P.useVision);if(B.aborted)return;a.setImages(_);let C=performance.now(),M=await xt(S,_,P,(N,j)=>a.log(j==="error"?"ERROR":j==="warning"?"WARN":"SYS",`[IA] ${N}`),B,{systemPromptOverride:wn}),L=Math.round(performance.now()-C);if(B.aborted)return;t.setState("idle");let H=M.plan;if(a.log("SYS",`An\xE1lise conclu\xEDda em ${L}ms via ${M.usedModel??P.model} \u2014 pageType: ${H.pageType} | mode: ${H.mode} | ${H.actions?.length??0} a\xE7\xE3o(\xF5es)`),a.setPlan(H,S.questionText,L,P.model,_),H.memoryToStore&&pt(H.memoryToStore),H.imageDescriptions&&H.imageDescriptions.length>0){a.log("AI",`\u{1F5BC}\uFE0F ${H.imageDescriptions.length} imagem(ns) analisadas:`);for(let N of H.imageDescriptions){let j=N.relevant?"\u2705":"\u26A0\uFE0F";a.log(N.relevant?"AI":"WARN",`  ${j} Imagem ${N.index+1} [${N.relevant?"RELEVANTE":"IGNORADA"}]: ${N.description}`)}}if(H.pageType==="conclusion"){e.flash("Sess\xE3o encerrada"),a.log("SYS","P\xE1gina de conclus\xE3o detectada");return}let q=jt(H.interactionFlow,H.actions||[]);if(a.log("SYS",`Fluxo gerado: ${q.length} step(s) \u2014 ${q.map(N=>`${N.trigger}[${N.action?.t}]`).join(", ")}`),H.pageType==="info"||H.pageType==="start"){if(t.flashOk(1e3),e.flash("Avan\xE7ar \u2192"),a.log("SYS",`P\xE1gina informativa (${H.pageType}) \u2014 aguardando clique do usu\xE1rio para avan\xE7ar`),q.length>0)o.start(q);else{let N=[{step:1,trigger:"click",action:{t:"adv",label:"continuar"},hint:"Clique para avan\xE7ar",customMsg:null}];a.log("SYS","Fluxo adv gerado automaticamente para p\xE1gina informativa"),o.start(N)}return}if(!q.length){a.log("WARN","Plano da IA retornou sem a\xE7\xF5es ou fluxo de intera\xE7\xE3o"),y();return}m=0,t.flashOk(500);let X=q[0];e.flash(X.hint||"Pronto"),X.customMsg&&setTimeout(()=>e.flash(X.customMsg),1400);let Q=q.filter(N=>N.action?.t==="drag");if(Q.length>0){a.log("FLOW",`\u{1F504} ${Q.length} step(s) de drag/categoriza\xE7\xE3o no fluxo. Estrat\xE9gias A-G ser\xE3o tentadas.`);for(let N of Q){let j=N.action;a.log("FLOW",`  Drag: "${j.from}" \u2192 "${j.to}"`,JSON.stringify(j))}}o.start(q),q.length>0&&q[0].trigger==="click"&&Date.now()-f<4e3&&(f=0,a.log("FLOW","Aplicando clique antecipado no primeiro step"),setTimeout(()=>void o.forceStep(0),40))}catch(S){if(B.aborted)return;t.setState("idle");let _=S instanceof Error?S.message:String(S);if(a.log("ERROR",`Erro na an\xE1lise: ${_}`),_.includes("403")||_.includes("API key")||_.includes("inv\xE1lida")){e.flash("Acesso negado"),t.flashError();return}if(_.includes("429")||_.includes("Quota")||_.includes("RESOURCE_EXHAUSTED")||_.includes("Todas as tentativas")){_.includes("Todas as tentativas")||k>=4?(e.flash("Limite \u2014 aguarde"),t.flashError(),y()):(e.flash("Chave rotacionando"),t.flashError(300),h(!1,k+1));return}t.flashError(800),y()}finally{c?.signal===B&&(c=null),d=!1}}function A(){if(d){e.flash("Analisando...");return}if(o.isActive()){let w=o.getCurrentStep()+1,k=o.getTotalSteps(),P=o.getState()==="waiting_key"?"Tecla":"Mouse";e.flash(`${w}/${k} ${P}`)}else{let k=te().model.replace("gemini-","").replace("-flash","F").replace("-lite","L").replace("-preview","P");e.flash(`OK \u2014 ${k}`)}}function b(){i.isOpen()&&i.close(),s.isOpen()&&s.close(),r.isOpen()&&r.close(),a.isOpen()&&a.close()}let v=[{keys:"Shift+Q",label:"Analisar p\xE1gina",action:()=>void h()},{keys:"Shift+V",label:"M\xEDdias IA (Vision)",action:()=>{a.openTab("media"),e.flash("M\xEDdias IA")}},{keys:"Shift+M",label:"Trocar modelo",action:()=>i.isOpen()?i.close():i.open()},{keys:"Shift+A",label:"Config API keys",action:()=>s.isOpen()?s.close():s.open()},{keys:"Shift+Z",label:"Abortar fluxo",action:()=>o.isActive()?o.abort():e.flash("Nada ativo")},{keys:"Shift+R",label:"Re-analisar",action:()=>void h()},{keys:"Shift+H",label:"Debug Output",action:()=>a.toggle()},{keys:"Shift+I",label:"\xDAltimo aviso",action:()=>e.reshow()},{keys:"Shift+C",label:"Comandos",action:()=>r.isOpen()?r.close():r.open()},{keys:"Escape",label:"Fechar menus",action:b}];r.setCommands(v);function x(w){let k=w.key;if(w.altKey&&(k==="q"||k==="Q")||w.shiftKey&&k==="Q"){w.preventDefault(),w.stopPropagation(),h();return}if(w.shiftKey&&k==="M"){w.preventDefault(),w.stopPropagation(),i.isOpen()?i.close():i.open();return}if(w.shiftKey&&k==="A"){w.preventDefault(),w.stopPropagation(),s.isOpen()?s.close():s.open();return}if(w.shiftKey&&k==="Z"){if(w.preventDefault(),w.stopPropagation(),c){try{c.abort()}catch{}c=null}u&&(clearTimeout(u),u=null),o.isActive()?o.abort():e.flash("Abortado"),d=!1,t.setState("idle");return}if(w.shiftKey&&k==="R"){w.preventDefault(),w.stopPropagation(),h();return}if(w.shiftKey&&k==="H"){w.preventDefault(),w.stopPropagation(),a.toggle();return}if(w.shiftKey&&(k==="V"||k==="v")){w.preventDefault(),w.stopPropagation(),a.openTab("media"),e.flash("M\xEDdias IA");return}if(w.shiftKey&&k==="I"){w.preventDefault(),w.stopPropagation(),e.reshow();return}if(w.shiftKey&&k==="C"){w.preventDefault(),w.stopPropagation(),r.isOpen()?r.close():r.open();return}k==="Escape"&&(i.isOpen()||s.isOpen()||r.isOpen()||a.isOpen())&&(w.stopPropagation(),w.preventDefault(),b())}window.addEventListener("keydown",x,{capture:!0}),window.__eqdiscrete={analyze:()=>h(),destroy:()=>{window.removeEventListener("keydown",x,{capture:!0}),u&&clearTimeout(u),o.destroy(),a.destroy(),i.destroy(),s.destroy(),r.destroy(),l.stop(),t.destroy(),e.destroy(),n.clearAll(),delete window.__eqdiscrete}},h(!0)}})();
