          ...
          <main class="eq-sidebar-body">
            ...
            <header class="eq-header">
              <div class="eq-brand">
                ...
                <span class="eq-brand-version">${Ye}</span>
            ...
            <div class="eq-views-wrapper">
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-footer-note" style="margin-top: auto;">${Ye} \u2022 H\xEDbrido 4.0 (RAG + AST + Vision)</div>
              </div>
