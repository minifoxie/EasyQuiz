 ...
 */
"use strict";(()=>{var re={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0};function Y(n){if(!n||typeof n!="string")return!1;let e=n.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of t)if(e.includes(o))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var $e="easyquiz_settings_v2",Ae="easyquiz_activity_metrics";function _e(){try{let n=localStorage.getItem($e);if(!n){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let s=JSON.parse(r);return{...re,apiKey:s.apiKey||""}}return{...re}}let e=JSON.parse(n),t=typeof e.model=="string"&&Y(e.model)?e.model:re.model,o=Array.isArray(e.apiKeys)?e.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],i=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(o.length===0&&i&&(o=[i]),o.length===0)try{let r=localStorage.getItem("easyquiz_api_keys");if(r){let s=JSON.parse(r);Array.isArray(s)&&(o=s.filter(c=>typeof c=="string"&&c.trim().length>5))}}catch{}return{apiKey:o[0]||i||re.apiKey,apiKeys:o,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:re.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:re.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:re.confidenceThreshold}}catch{return{...re}}}function Tt(){try{localStorage.removeItem($e),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(Ae),sessionStorage.removeItem(Ae);let n=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&n.push(t)}n.forEach(e=>localStorage.removeItem(e)),Be()}catch(n){console.warn("[EasyQuiz] Erro ao resetar dados:",n)}}function et(n){try{let e=localStorage.getItem("eq_domain_cache_"+n);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+n)}catch{}}return t}catch{return{}}}function tt(n,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let o={...et(n),...e};try{localStorage.setItem("eq_domain_cache_"+n,JSON.stringify(o))}catch(i){console.warn("[EasyQuiz] Erro cache de dominio:",i)}}function qt(n){let e=_e(),t=Array.isArray(n.apiKeys)?n.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):e.apiKeys,o;typeof n.apiKey=="string"?o=n.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(n.apiKeys)&&n.apiKeys.length>0?o=t[0]||"":o=e.apiKey,o&&!t.includes(o)&&(t=[o,...t]),t.length>0&&(!o||!t.includes(o))&&(o=t[0]);let i={...e,...n,apiKey:o,apiKeys:t};try{localStorage.setItem($e,JSON.stringify(i)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return i}var ve=[],Ct=12,en=1200;function kt(n){let e=n.trim().replace(/\s+/g," ").slice(0,en);e&&!ve.includes(e)&&(ve.push(e),ve.length>Ct&&(ve=ve.slice(-Ct)))}function De(){return ve}function Be(){ve=[]}function Lt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Te=Lt();function qe(){try{localStorage.removeItem(Ae)}catch{}return Te}function tn(n){Te=n;try{let e=JSON.stringify(n);sessionStorage.setItem(Ae,e),localStorage.removeItem(Ae)}catch{}}function St(n){let e=Te,t=Date.now(),o=e.records[e.records.length-1];if(o&&o.id===n.id&&t-o.timestamp<3e3)return e;let i={...n,timestamp:t},a=[...e.records,i],r=a.filter(u=>u.status==="answered"||u.status==="verified").length,s=a.reduce((u,h)=>u+h.durationMs,0),c=r>0?Math.round(s/r):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:r,averageDurationMs:c,records:a};return tn(l),l}function ke(){Te=Lt();try{sessionStorage.removeItem(Ae),localStorage.removeItem(Ae)}catch{}return Te}var Mt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(n)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(n)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(n)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(n)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(n)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Le(n,e,t){let o=n.htmlSnippet.includes("draggable")||n.htmlSnippet.includes("perseus")||n.htmlSnippet.includes("category")||n.htmlSnippet.includes("dropzone")||n.controls.some(v=>v.type==="draggable"||v.type==="dropzone"),i=/katex|latex|\\frac|\\sqrt/i.test(n.htmlSnippet),a=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(n.sourceUrl)||n.htmlSnippet.includes("Qr7Oae")||n.htmlSnippet.includes("data-item-id")||n.htmlSnippet.includes("freebirdFormviewer"),r=(/wayground|quizizz/i.test(n.sourceUrl)||n.htmlSnippet.includes("data-functional-selector"))&&(n.htmlSnippet.includes("classification")||n.controls.filter(v=>v.role==="answer").length===0),s=n.controls.filter(v=>v.role!=="navigation").length===0,c=s||o||a||r||i&&n.questionText.length<60,l=s?4500:r?6e3:1800,u=c?`
[HTML]:
${n.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",h="";if(s&&typeof document<"u")try{let v=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(y=>{let C=y,T=C.getBoundingClientRect?.()||{width:0,height:0};return T.width>0&&T.height>0&&!C.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(y=>{let C=y,T=C.tagName.toLowerCase(),x=C.id?`#${C.id}`:"",E=C.className&&typeof C.className=="string"?`.${C.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",k=(C.textContent||C.value||C.getAttribute("aria-label")||"").trim().slice(0,60),w=C.getAttribute("type")||C.getAttribute("role")||"";return`${T}${x}${E}[${w}] txt="${k}"`});v.length>0&&(h=`
[DOM-INTERATIVO]:
${v.join(`
`)}`)}catch{}let d=De(),m=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",p=n.controls.filter(v=>v.role!=="navigation"),f=n.controls.filter(v=>v.role==="navigation"),A=nn(n.sourceUrl,n.htmlSnippet),b=A?`
${A}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let v=p.filter(q=>q.type==="checkbox"||q.type==="chk"),y=new Set(p.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),C=v.filter(q=>!q.name||!y.has(q.name)),T=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),x=C.length>=2||T,E=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&y.size>=1,k=p.every(q=>q.type==="radio"||q.type==="chk")&&y.size===1&&!x&&!E,w=p.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),M=w.length>=2;return(E?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
...
${e.length===0?"Nenhum anexo visual.":e.map((v,y)=>{let C=v.associatedLabel||"Gr\xE1fico da Quest\xE3o",T=v.alt?` | alt: "${v.alt}"`:"";if(v.captureStatus==="text_only")return`  - Imagem ${y+1} [CONTEXTO_TEXTUAL]: ${C}${T} | ${v.textContext||"sem contexto adicional"}`;if(v.captureStatus==="captured"||v.base64){let x=v.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${v.textContext}"`:"";return`  - Imagem ${y+1} [VISUAL_INLINE]: ${C}${T}${x}`}return`  - Imagem ${y+1} [FALHOU]: ${C}${T}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var on=new Set(["question","info","start","conclusion"]),an=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),sn=new Set(["val","chk","sel","clk","adv","js","drag"]),rn=150,Se=2e3;function $(n,e=""){return n==null?e:typeof n=="string"?n.trim().slice(0,Se):typeof n=="number"||typeof n=="boolean"?String(n).trim().slice(0,Se):e}function ln(n,e){if(!n||typeof n!="object")return null;let t=n,o=t.t;if(typeof o!="string"||!sn.has(o))return null;if(o==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...$(s)?{id:$(s,"").slice(0,500)}:{}}}if(o==="drag"){let s=$(t.from??t.source),c=$(t.to??t.target??t.destination);return!s||!c?null:{t:"drag",from:s.slice(0,500),to:c.slice(0,500)}}if(o==="js"){let s=$(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let i=t.id??t.target??t.name??t.selector??t.element;(i==null||i==="")&&o==="val"&&(i="1");let a=$(i).slice(0,500);if(!a)return null;if(o==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:a,v:$(s).slice(0,Se)}}if(o==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(s)?s:[s]).map(u=>$(u).slice(0,500)).filter(Boolean);return{t:"sel",id:a,v:l}}if(o==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",c={t:"chk",id:a,c:!s};return t.v!==void 0&&(c.v=$(t.v).slice(0,Se)),c}let r={t:"clk",id:a};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";r.c=!s}return t.v!==void 0&&(r.v=$(t.v).slice(0,Se)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(r.co=[t.co[0],t.co[1]]),r}function cn(n,e,t){if(t!=="question")return n;let o=n.filter(a=>a.t==="adv"),i=n.filter(a=>a.t!=="adv");if(e==="escolha_unica"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=i.filter(r=>r.t==="chk"||r.t==="clk");if(a.length>1){let r=i.filter(c=>c.t!=="chk"&&c.t!=="clk"),s=a[a.length-1];i=[...r,s]}}else if(e==="escolha_multipla"){i=i.filter(r=>!(r.t==="chk"&&r.c===!1||r.t==="clk"&&r.c===!1));let a=new Set;i=i.filter(r=>{let s="id"in r&&typeof r.id=="string"?r.id:"";return s?a.has(s)?!1:(a.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let a=new Set,r=[...i].reverse(),s=[];for(let c of r){let l="id"in c&&typeof c.id=="string"?c.id:"";l?a.has(l)||(a.add(l),s.push(c)):s.push(c)}i=s.reverse()}return[...i,...o]}function It(n){if(!n||typeof n!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=n,t=e.pageType,o=e.mode;(typeof t!="string"||!on.has(t))&&(t="question"),(typeof o!="string"||!an.has(o))&&(o="escolha_unica");let i=Array.isArray(e.actions)?e.actions:[],a=[];for(let c=0;c<Math.min(i.length,rn);c++){let l=ln(i[c],c);l&&a.push(l)}a.some(c=>c.t==="val")&&(o==="escolha_unica"||!e.mode)&&(o="preenchimento"),a.some(c=>c.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(o)&&(o="arrastar_soltar"),a=cn(a,o,t);let r=a.some(c=>c.t==="adv");t==="conclusion"?a.length=0:t==="info"||t==="start"?r||a.push({t:"adv"}):t==="question"&&!r&&a.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:o,confidence:s,rationale:$(e.rationale,"Plano validado e auto-recuperado."),actions:a,...$(e.memoryToStore)?{memoryToStore:$(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var te=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let o=e.flatMap(a=>a.split(/[\n\r]+/));Array.from(new Set(o.map(a=>a.trim().replace(/^["']|["']$/g,"")).filter(a=>a.length>5))).forEach((a,r)=>{let s=this.generateId(a),c=t.get(s)||t.get(a);this.keys.set(s,{id:s,key:a,label:c?.label||`Chave ${r+1}`,addedAt:c?.addedAt||Date.now(),lastUsedAt:c?.lastUsedAt,lastLatencyMs:c?.lastLatencyMs,cooldownUntil:c?.cooldownUntil,errorCount:c?.errorCount||0,lastError:c?.lastError,winCount:c?.winCount||0})})}generateId(e){let t=0;for(let i=0;i<e.length;i++)t=(t<<5)-t+e.charCodeAt(i),t|=0;let o=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${o}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let o=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:o>0,remainingCooldownMs:o}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),o=Array.from(this.keys.values()).filter(a=>(a.errorCount||0)<50);if(o.length===0)return Array.from(this.keys.values()).slice(0,e);let i=o.filter(a=>(a.cooldownUntil||0)<=t);return i.length>0?(i.sort((a,r)=>{let s=a.lastLatencyMs!==void 0?a.lastLatencyMs:99999,c=r.lastLatencyMs!==void 0?r.lastLatencyMs:99999;if(s!==c)return s-c;let l=(a.lastUsedAt||0)-(r.lastUsedAt||0);return l!==0?l:a.addedAt-r.addedAt}),i.slice(0,e)):(o.sort((a,r)=>(a.cooldownUntil||0)-(r.cooldownUntil||0)),o.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let o=this.findKeyObj(e);o&&(o.cooldownUntil=Date.now()+t,o.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let o=this.findKeyObj(e);o&&(o.lastLatencyMs=t,o.lastUsedAt=Date.now(),o.errorCount=0,o.lastError=void 0,o.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let o=this.findKeyObj(e);o&&(o.errorCount=99,o.lastError=t)}addKey(e,t){let o=e.trim().replace(/^["']|["']$/g,"");if(!o)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(o.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let i=this.generateId(o);if(this.keys.has(i)||Array.from(this.keys.values()).some(s=>s.key===o))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let r={id:i,key:o,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(i,r),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:r}}updateKey(e,t,o){let i=this.keys.get(e);if(!i)return{ok:!1,message:"Chave n\xE3o encontrada."};let a=t.trim().replace(/^["']|["']$/g,"");return!a||a.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(i.key=a,o!==void 0&&(i.label=o.trim()),i.errorCount=0,i.cooldownUntil=void 0,i.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},D=new te;var Ee=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],zt=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],dn={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function at(n){return dn[n]??n}function un(n,e){let o={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??pn};return/lite/i.test(n)||(/gemini-3\.[0-9]+-?flash/i.test(n)?o.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(n)&&(o.thinkingConfig={thinkingBudget:0})),o}var pn={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Pt(n){let e=n.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=at(e);return Y(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function ot(n,e){let t="";try{let o=JSON.parse(n);t=o.error?.message||o.message||""}catch{t=n.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function mn(n){let e=n.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let o=e.match(/\{[\s\S]*\}/);if(o)try{return JSON.parse(o[0].trim())}catch{}try{let i=e.indexOf("{");if(i!==-1){let a=e.slice(i).trim();a=a.replace(/,\s*\{[^}]*$/,""),a=a.replace(/,\s*$/,"");let r=0,s=0,c=!1,l=!1;for(let h=0;h<a.length;h++){let d=a[h];if(l){l=!1;continue}if(d==="\\"){l=!0;continue}if(d==='"'){c=!c;continue}c||(d==="{"?r++:d==="}"?r=Math.max(0,r-1):d==="["?s++:d==="]"&&(s=Math.max(0,s-1)))}for(c&&(a+='"');s>0;)a+="]",s--;for(;r>0;)a+="}",r--;let u=JSON.parse(a);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var Ot=(()=>{try{let n=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!n)return null;let e=JSON.parse(n);if(Array.isArray(e)){let t=e.filter(o=>o&&typeof o.id=="string"&&Y(o.id));return t.length>0?t:null}return null}catch{return null}})(),nt=new Set;async function Re(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return Ee;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let o of t)try{let i=await fetch(o,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!i.ok){let r=await i.text(),s=ot(r,i.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let a=await i.json();if(Array.isArray(a.models)&&a.models.length>0){let r=a.models.filter(s=>{let c=s.supportedGenerationMethods||[],l=(s.name||"").replace(/^models\//,""),u=c.includes("generateContent");return Y(l)&&u}).map(s=>{let c=s.supportedGenerationMethods||[],l=s.name.replace(/^models\//,""),u=s.displayName||l;return{id:l,name:u.includes(l)?u:`${u} (${l})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:c.includes("generateContent"),supportedGenerationMethods:c,discoveredAt:Date.now()}});if(r.length>0){r.sort((s,c)=>{let l=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return l(c.id)-l(s.id)}),Ot=r;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(r))}catch{}return r}}}catch(i){if(i.message?.includes("Chave de API"))throw i}return Ee}async function Qe(n){let e=n.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let o=await Re(e);if(o.length>0&&o!==Ee){let i=o[0];return{ok:!0,message:`Chave v\xE1lida! ${o.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${i.name}`,models:o}}}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let o of t)for(let i of["v1beta","v1"]){let a=`https://generativelanguage.googleapis.com/${i}/models/${o}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(a,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${o} (${i})!`,models:Ee}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function it(n,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:n,key:"",message:"Nenhuma chave dispon\xEDvel."};let o=at(Pt(n)),i=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),a={"Content-Type":"application/json"};async function r(l,u,h){let d=new AbortController,m=setTimeout(()=>d.abort(),h);try{let p=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(l)}`,f=await fetch(p,{method:"POST",headers:{...a,"x-goog-api-key":l},body:i,signal:d.signal});if(clearTimeout(m),f.ok)return{ok:!0,model:u,key:l,message:`Modelo '${u}' validado com sucesso!`};let A=await f.text().catch(()=>"");throw new Error(`HTTP ${f.status}: ${A.slice(0,80)}`)}catch(p){throw clearTimeout(m),p}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(h=>r(h,o,8e3)))}catch{}}let s=t[0],c=[o,...zt.filter(l=>l!==o)];for(let l of c)try{let u=await r(s,l,4e3);return l!==o&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),u}catch{}return{ok:!1,model:o,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function hn(n,e,t,o,i){let a=["v1beta","v1"],r=new Error(`Falha ao consultar modelo ${n}`),c={...un(n,i)};for(let l of a){if(o.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${l}/models/${n}:generateContent?key=${encodeURIComponent(e)}`,h=Date.now();try{let d=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(!d.ok){let f=await d.text();if(d.status===400){let b=/thinking/i.test(f),v=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(f);if((b||v)&&(c.thinkingConfig||c.responseSchema)){let y={...c};b&&delete y.thinkingConfig,v&&(delete y.responseSchema,delete y.responseMimeType),c=y;let C=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:c}),signal:o});if(C.ok){let E=await C.json(),k=E.candidates?.[0];if(k?.content?.parts?.[0]?.text)return D.markSuccess(e,Date.now()-h),{rawText:k.content.parts[0].text,data:E,usedModel:n,usedKey:e}}let T=await C?.text?.().catch(()=>"")??f,x=ot(T,d.status);throw new Error(`[${n}|${te.maskKey(e)}] ${x}`)}}let A=ot(f,d.status);if(d.status===404&&l==="v1beta")continue;throw d.status===429?(D.markQuotaHit(e,8e3),Dt(e,n,1e4),new Error(`[${n}|${te.maskKey(e)}] ${A}`)):(d.status===503||/no capacity|overloaded|unavailable/i.test(f)?(D.markOverloaded(e,5e3),nt.add(n)):d.status===403||/API_KEY_INVALID/i.test(f)?D.markInvalid(e,A):d.status===404&&nt.add(n),new Error(`[${n}|${te.maskKey(e)}] ${A}`))}let m=await d.json(),p=m.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error(`[${n}|${te.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return D.markSuccess(e,Date.now()-h),{rawText:p.content.parts[0].text,data:m,usedModel:n,usedKey:e}}catch(d){if(o.aborted)throw d;r=d;let m=r.message||"";if(m.includes("404")||/no longer available/i.test(m)){nt.add(n);break}if(m.includes("429")||m.includes("Quota"))break}}throw r}var Ne=new Map;function Ht(n,e){let t=`${n}::${e}`,o=Ne.get(t);return o===void 0?!1:Date.now()>o?(Ne.delete(t),!1):!0}function Dt(n,e,t=1e4){Ne.set(`${n}::${e}`,Date.now()+t)}function st(){Ne.clear()}async function je(n,e,t,o,i,a){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let r=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];D.init(r);let s=t.apiKey.trim().replace(/^["']|["']$/g,""),c=D.getBestKey()||s;if(!c)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=Pt(t.model);if(!Ot&&c&&Re(c).catch(()=>{}),i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),h=Le(n,e,t),d=[{text:h}];for(let H=0;H<e.length;H++){let q=e[H],I=q.associatedLabel||(q.alt?`Imagem: ${q.alt}`:`Imagem ${H+1}`);if(q.captureStatus==="text_only"||!q.base64){let O=q.textContext||q.alt||"";d.push({text:`[CONTEXTO_IMAGEM_${H+1} - V\xCDNCULO: ${I}]: ${O}`})}else d.push({text:`[ANEXO VISUAL ${H+1} - V\xCDNCULO: ${I}]:`}),d.push({inline_data:{mime_type:q.mediaType,data:q.base64}})}let m={system_instruction:{parts:[{text:a?.systemPromptOverride??Mt}]},contents:[{role:"user",parts:d}]},p=at(l),f=zt.filter(H=>H!==p),b=D.getAllKeys().length,v=H=>b<=1||H===0?1:2,y=new Set,C=(H,q)=>{let I=/pro/i.test(H),O=/lite/i.test(H);return I?q===0?18e3:q===1?24e3:3e4:O?q===0?1e4:q===1?14e3:18e3:q===0?16e3:q===1?2e4:25e3},T=async(H,q)=>{if(q.length===0||i?.aborted)return null;let I=q.map(()=>new AbortController),O=()=>I.forEach(R=>{try{R.abort()}catch{}});i?.addEventListener("abort",O,{once:!0});let N=q.map(R=>`${R.model.replace("gemini-","")}/${R.label}`).join(" | ");o?.(`\u26A1 ${H}: ${q.length} slot(s) [${N}]...`,"info");try{let R=q.map(async(X,Z)=>{let K=I[Z],ee=setTimeout(()=>{try{K.abort(new Error(`Timeout ${X.timeout/1e3}s (${X.model}|${X.label})`))}catch{K.abort()}},X.timeout);try{let j=await hn(X.model,X.key,m,K.signal,a?.generationSchemaOverride);clearTimeout(ee);let J=It(mn(j.rawText));return J.usedModel=j.usedModel,J.durationMs=Date.now()-u,J.promptSent=h,J.tokensUsed=j.data.usageMetadata?.totalTokenCount,J.promptTokens=j.data.usageMetadata?.promptTokenCount,J.candidatesTokens=j.data.usageMetadata?.candidatesTokenCount,J.rawResponse=j.rawText,I.forEach((Et,_t)=>{if(_t!==Z)try{Et.abort(new Error("Cancelado: vencedor respondeu."))}catch{Et.abort()}}),{plan:J,rawUsage:j.data.usageMetadata,usedModel:j.usedModel,usedKey:j.usedKey,slotLabel:X.label}}catch(j){clearTimeout(ee);let J=j instanceof Error?j.message:String(j);throw(J.includes("429")||J.includes("Quota")||J.includes("RESOURCE_EXHAUSTED"))&&(Dt(X.key,X.model,1e4),D.markQuotaHit(X.key,8e3)),j}}),U=await Promise.any(R);return i?.removeEventListener("abort",O),D.markWinner(U.usedKey),U}catch(R){return i?.removeEventListener("abort",O),R instanceof AggregateError&&R.errors.length>0?w=R.errors.map(U=>U instanceof Error?U.message:String(U)).join(" | "):R instanceof Error&&(w=R.message),console.warn(`[EasyQuiz ${H}] Falha na onda:`,w),null}},E=(b<=1?1:1+Math.ceil((b-1)/2))+4,k=0,w="",M=0;for(;k<E;){if(i?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let H=D.getRoundRobinKeys(b),q=H.filter(K=>!y.has(`${K.key}::${p}`)&&!Ht(K.key,p)),I,O;if(q.length>0)I=p,O=q;else{let K=f;I=K[M%K.length]||p,M++;let ee=H.filter(j=>!y.has(`${j.key}::${I}`)&&!Ht(j.key,I));O=ee.length>0?ee:H.filter(j=>!y.has(`${j.key}::${I}`))}if(O.length===0){if(M<f.length)continue;break}let N=O.slice(0,v(k));if(N.length===0)break;let R=C(I,k),U=N.map(K=>(y.add(`${K.key}::${I}`),{model:I,key:K.key,label:K.label||"Chave",timeout:R})),X=k===0?"Onda 1":`Onda ${k+1}`,Z=await T(X,U);if(Z){let K=Z.plan.durationMs||Date.now()-u,ee=te.maskKey(Z.usedKey);return o?.(`\u2705 ${K}ms via '${Z.usedModel}' (${Z.slotLabel}: ${ee})`,"info"),Z}k++}throw new Error(w||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var fn=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function ye(n){let e=n?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return n?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!n?.autoAdvance}}function rt(n,e){if(n.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(n.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Bt(n){if(!n.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(n.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(fn.find(t=>t.test(n)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(n)&&!n.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var Ce=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),Ie=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,le=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,gn=0;function lt(n){try{let e=n.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!ue(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(n):n.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof n.getBoundingClientRect=="function"){let e=n.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(n.textContent||"").trim().length>0}function F(n){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(n)}catch{}return String(n).replace(/["\\]/g,"\\$&")}function z(n){let e=n;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||ue(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let o=e.type?.toLowerCase();if(o==="checkbox"||o==="radio"){if(e.id)try{let a=e.ownerDocument?.querySelector(`label[for="${F(e.id)}"]`);if(a&&lt(a))return!0}catch{}let i=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(i&&i!==e&&lt(i))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let a=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!a||a.display!=="none"&&a.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let r=e.getBoundingClientRect();if(r.width>0||r.height>0)return!0}return!0}}}catch{}}return lt(e)}function bn(n){if(n==null)return"";if(typeof n=="string")return n;if(typeof n=="number"||typeof n=="boolean")return String(n);if(n instanceof Node)return n.textContent||"";try{if(typeof n?.toString=="function"){let e=n.toString();if(typeof e=="string")return e}}catch{}return""}function Q(n,e=500){return bn(n).replace(/\s+/g," ").trim().slice(0,e)}function vn(n){let e=n.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(gn+=1).toString(36)}`;return n.dataset.easyquizId=t,t}function ue(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Me=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function V(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element))return!1;if(ue(n))return!0;let e=n.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((n.type||"").toLowerCase()))return!1;let o=n.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||n,i=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||""),a=String(o.getAttribute?.("aria-label")||""),r=String(o.getAttribute?.("title")||""),s=typeof o.className=="string"?o.className:typeof o.className?.baseVal=="string"?o.className.baseVal:"",c=Q(o.textContent,60);return!!(Me.test(i)||Me.test(a)||Me.test(r)||Me.test(s)||c.length>0&&c.length<=25&&Me.test(c))}function _(n){if(!n||typeof n.getAttribute!="function"||typeof Element<"u"&&!(n instanceof Element)||ue(n)||V(n)||n.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||n.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&n instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&n instanceof HTMLButtonElement?n.value:"",t=Q(n.getAttribute?.("aria-label")||n.textContent||n.getAttribute?.("value")||e),o=n.type,i=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),a=String(n.getAttribute?.("data-testid")||n.getAttribute?.("data-test-id")||n.getAttribute?.("id")||n.getAttribute?.("href")||"").toLowerCase();return le.test(i)||le.test(t)?!1:Ie.test(i)||Ie.test(t)||a.includes("next")||a.includes("check")||a.includes("continue")||a.includes("proximo")||a.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!n.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function ct(n){let e=n.closest("tr");if(e){let c=e.querySelector("th, td:first-child"),l=c&&c!==n.closest("td")?Q(c.textContent,100):"",u=Q(n.closest("label, td")?.textContent||"",50);if(l&&u)return`${l}: ${u}`}let t=n.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let c=t.querySelector('.dropdown-label, [class*="label" i]'),l=c&&c!==n?Q(c.textContent,150):"";if(l)return l}let o=n.getAttribute("aria-label");if(o)return Q(o);let i=n.getAttribute("aria-labelledby");if(i){let c=i.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(c.trim())return Q(c)}if("labels"in n&&n.labels){let c=Array.from(n.labels??[]).map(l=>l.textContent).join(" ");if(c.trim())return Q(c)}let a=n.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(a&&a!==n){let c=Q(a.textContent);if(c)return c}let r=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"",s=n.getAttribute("placeholder")||n.getAttribute("title")||n.textContent||r||"";return Q(s)}function dt(n,e){let o=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName.toLowerCase()==="select"?n:null,i=n;n.dataset.easyquizRole=e;let a=n.tagName.toLowerCase(),r=["input","textarea","select","button"].includes(a)?a:"other",s=n.getAttribute("role")||"",c=(n.getAttribute("data-testid")||n.getAttribute("data-test-id")||"").toLowerCase(),l=(n.className&&typeof n.className=="string"?n.className:"").toLowerCase(),u=n.getAttribute("draggable")==="true"||n.classList.contains("perseus-drag-item")||n.classList.contains("sortable-item")||l.includes("cursor-grab")||!!n.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(c)||/drag|card-item|sortable/i.test(l),h=n.getAttribute("data-role")==="dropzone"||n.classList.contains("category-container")||n.hasAttribute("data-category")||!!n.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(c)||/dropzone|category-box|bucket|target-zone/i.test(l),m=Q((u?"draggable":h?"dropzone":"")||i.type||s||r,40),p="";if(i.type==="checkbox"||i.type==="radio"||s==="radio"||s==="checkbox"){let C=i.checked||n.getAttribute("aria-checked")==="true",T=i.value&&i.value!=="on"?i.value:n.getAttribute("data-value")||"";p=C?T?`checked:${T}`:"checked":T||"unchecked"}else if(r==="button"||a==="a"||e==="navigation"||_(n))p="";else{let C=typeof n.value=="string"||typeof n.value=="number"?n.value:"";p=Q(C||n.getAttribute("data-category")||"",2e3)}let f=[];if(o&&o.options)for(let C of Array.from(o.options).slice(0,80))f.push({value:Q(C.value),label:Q(C.textContent)});else if(s==="combobox"||s==="listbox"||l.includes("select")||l.includes("dropdown")){let C=n.getAttribute("aria-controls")||n.getAttribute("aria-owns"),T=C?document.getElementById(C):n;if(T){let x=T.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let E of Array.from(x).slice(0,80)){let k=Q(E.textContent);k&&f.push({value:E.getAttribute("data-value")||E.getAttribute("value")||k,label:k})}}}let A=!!(i.required||n.getAttribute("aria-required")==="true"),b=!!(i.disabled||n.getAttribute("aria-disabled")==="true"),v=vn(n);return{id:n.id||v,tag:r,type:m,label:ct(n),name:Q(i.name||n.getAttribute("name")||"",180),value:p,options:f,required:A,disabled:b,role:e}}var Nt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Rt(n){if(!z(n))return-1/0;let e=n.getBoundingClientRect(),t=Array.from(n.querySelectorAll(Ce)).filter(z),o=Q(n.innerText||n.textContent||"",4e3).length;if(o<10||!t.length&&o<60)return-1/0;let i=Math.max(1,window.innerWidth*window.innerHeight),a=Math.max(1,e.width*e.height),r=Math.min(1,a/i),s=e.top+e.height/2,c=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),l=o>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,o/20)+l+u-r*20-c*10}function Fe(n){let e=n;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,o=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(o))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&o!=="main"&&o!=="body"){e=t;break}let i=Q(e.innerText||e.textContent||"",1e4),a=Q(t.innerText||t.textContent||"",1e4),r=e.querySelectorAll(Ce).length,s=t.querySelectorAll(Ce).length;if(i.length<150&&a.length>i.length&&s<=r+4&&o!=="main"&&o!=="body"){e=t;continue}break}return e}function Qt(n){let e=n,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&z(t))return t;let o=0;for(;e.parentElement&&e.parentElement!==document.body&&o<3;)e=e.parentElement,o++;return e||document.body}function W(){let n=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(n&&z(n))return n;let e=document.activeElement;if(e&&e!==document.body){let r=e.closest(Nt);if(r&&Rt(r)>0)return Fe(r)}let o=Array.from(document.querySelectorAll(Nt)).map(r=>({element:r,score:Rt(r)})).filter(r=>Number.isFinite(r.score)).sort((r,s)=>s.score-r.score),i=o.find(r=>{let s=r.element.tagName.toLowerCase();return s!=="main"&&s!=="body"&&r.score>0});if(i)return Fe(i.element);if(o.length>0&&o[0].score>0)return Fe(o[0].element);let a=document.querySelector('form, main, [role="main"]');return a&&z(a)?a:document.body}function jt(n){let e=n.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(o=>o.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(o=>{for(let i of Array.from(o.attributes))t.includes(i.name)||o.removeAttribute(i.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ve(n){let e=Array.from(n.querySelectorAll(Ce)),t=new Set,o=[];for(let l of e){if(!z(l)||_(l)||V(l))continue;let u=(l.value||l.textContent||"").trim();if(le.test(u))continue;let h=l.tagName.toLowerCase();["input","textarea","select"].includes(h)&&(t.add(l),o.push(l))}for(let l of e){if(!z(l)||_(l)||V(l))continue;let u=(l.value||l.textContent||"").trim();if(le.test(u))continue;let h=l.tagName.toLowerCase();if(["input","textarea","select"].includes(h))continue;let d=l.querySelector("input, textarea, select");if(!(d&&t.has(d))){if(l.hasAttribute("for")){let m=l.getAttribute("for"),p=m?l.ownerDocument.getElementById(m):null;if(p&&t.has(p))continue}if(h==="a"){let m=l.getAttribute("role"),p=l.getAttribute("class")||"",f=l.getAttribute("data-testid")||"",A=l.getAttribute("draggable")==="true"||l.classList.contains("perseus-drag-item")||l.classList.contains("sortable-item")||p.includes("cursor-grab")||!!l.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(f)||/drag|card-item|sortable/i.test(p);if(!(m==="button"||m==="radio"||m==="checkbox"||m==="option"||A||l.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}o.push(l)}}let i=o.length>0&&o.every(l=>V(l)||/read-?aloud|audio/i.test(l.getAttribute("data-testid")||l.getAttribute("aria-label")||"")),a=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||n,r=document.body.querySelector('[class*="classification" i]')!==null||n.querySelector('[class*="classification" i]')!==null||n.querySelector('[data-cy*="quiz" i]')!==null||n.querySelector('[class*="draggable-item" i]')!==null||n.querySelector('[class*="drag-item" i]')!==null||n.querySelector('[class*="sortable-card" i]')!==null||n.matches?.('[class*="classification" i]');if((o.length===0||i)&&r){i&&(o.length=0);let l=Array.from(a.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(l.length>0){for(let u of l)if(!(!z(u)||V(u))&&(o.push(u),o.length>=50))break}else{let u=Array.from(a.querySelectorAll("button, div[class], span[class], p, li"));for(let h of u){if(!z(h)||_(h)||V(h)||le.test((h.textContent||"").trim()))continue;let d=(h.textContent||"").trim();if(d.length<2||d.length>300)continue;if(Array.from(h.children).some(p=>p.className&&p.textContent?.trim())||o.push(h),o.length>=50)break}}}let c=!o.some(l=>["input","select","textarea"].includes(l.tagName.toLowerCase()))&&o.length>0&&o.every(l=>{let u=l.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let h=(l.textContent||"").trim();return!l.id||h.length<10||/^\d+\s*\/\s*\d+$/.test(h)||/^question text/i.test(h)});if(o.length===0||c){c&&(o.length=0);let l=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(l.length>0)for(let u of l){if(!z(u)||ue(u)||_(u)||V(u)||le.test((u.textContent||"").trim()))continue;let h=(u.textContent||"").trim();if(!(h.length<10||h.length>500)&&!/^\d+\s*\/\s*\d+$/.test(h)&&(o.push(u),o.length>=20))break}}return o.slice(0,100).map(l=>dt(l,"answer"))}function ut(n){let e=[n,n.parentElement,n.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,o=[];for(let i of e)for(let a of Array.from(i.querySelectorAll(Ce)))if(!(t.has(a)||!z(a)||!_(a)||V(a))&&(t.add(a),o.push(dt(a,"navigation")),o.length>=10))return o;return o}function pe(n=!1){let e=W();e=Fe(e),n&&(e=Qt(e));let t=Ve(e),o=ut(e);if(t.length===0){let s=Ve(document.body);s.length>0&&(e=Qt(e),t=Ve(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}o.length===0&&(o=ut(document.body));let i=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",a=i.length>4e4?Q(i.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+Q(i.slice(-2e3),2e3):Q(i,16e3),r=[...t,...o].slice(0,120);return!a||r.length===0&&a.length<30?Q(document.body.innerText||document.body.textContent||"",16e3).length>=30?ce():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:a,htmlSnippet:jt(e),controls:r,scope:e}}function ce(){let n=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=Q(n,16e3),t=Ve(document.body),o=ut(document.body),i=[...t,...o].slice(0,120),a=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:jt(a).slice(0,15e3),controls:i,scope:a}}function pt(n){let e=n.controls.map(t=>{let o=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${o}`}).join("|");return[window.location.href,n.pageTitle,n.questionText.slice(0,400),e].join("::")}function Ue(n){if(!n)return!1;let e=n.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(o=>e.includes(o))}function B(n){return n?!!(n.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||n.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function S(n){return n==null?"":(typeof n=="string"?n:String(n)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function G(n){if(!n||n instanceof HTMLInputElement||n instanceof HTMLSelectElement||n instanceof HTMLTextAreaElement||n.getAttribute("draggable")==="true"||n.classList.contains("dnd-card")||n.hasAttribute("data-category")||n.hasAttribute("data-dropzone"))return n;if(n.hasAttribute("for")){let o=n.getAttribute("for");if(o){let i=n.ownerDocument.getElementById(o);if(i)return i}}let e=n.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let o=e.getAttribute("for"),a=(o?e.ownerDocument.getElementById(o):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return a||e}let t=n.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(n.tagName.toLowerCase())){let o=n.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(o)return G(o)}return n}function Ft(n){let e=n;if(!e||!document.contains(e))try{e=W()}catch{}e=e||document.body;let t=i=>{let a=Array.from(i.querySelectorAll("tr")).filter(u=>z(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(a.length>1)return a;let r=Array.from(i.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>z(u)&&!B(u));if(r.length>0)return r;let c=Array.from(i.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>z(u)&&!B(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return c.length>0?c:Array.from(i.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let h=u;return z(h)&&!B(h)&&(h.textContent||"").trim().length>2&&!_(h)&&!V(h)&&!h.querySelector("[class]")})},o=t(e);return o.length>0?o:e!==document.body?t(document.body):[]}function P(n,e,t=!1){if(n==null)return null;let i=(typeof n=="string"?n:String(n)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!i)return null;let a=F(i),r=document.querySelector(`[data-easyquiz-id="${a}"]`);if(r&&!B(r))return G(r);try{let d=document.getElementById(i);if(d&&z(d)&&!B(d))return d.hasAttribute("data-category")||d.hasAttribute("data-dropzone")||d.classList.contains("dnd-zone")?d:G(d)}catch{}try{let d=document.querySelector(`[data-item-id="${a}"]`);if(d&&z(d)&&!B(d))return G(d)}catch{}let s=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let d=parseInt(s[1],10);if(t){let p=document.body;try{p=W()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(A=>z(A)&&!B(A));if(d>=1&&d-1<f.length)return f[d-1];if(d===0&&f.length>0)return f[0]}let m=d-1;if(m>=0){let p=Ft();if(m<p.length){let b=p[m];if(b.tagName.toLowerCase()==="tr"){if(e){let y=b.querySelector(`input[value="${F(e)}" i], [data-value="${F(e)}" i]`);if(y)return y}let v=b.querySelector("input");if(v)return v}return G(b)}let f=document.body;try{f=W()||document.body}catch{}let A=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>z(b)&&!B(b));if(m<A.length)return A[m]}}let c=i.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(c){let d=c[1].toUpperCase(),m=d.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${d}" i], input[type="checkbox"][value="${d}" i]`)).find(A=>z(A)&&!B(A));if(p)return G(p);let f=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(A=>{if(!z(A)||B(A))return!1;let v=(A.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(v===d||v===`${d})`||v===`(${d})`||v===`${d}.`||v===`${d}:`)return!0;let y=(A.textContent||"").trim().toUpperCase();return y.startsWith(`${d})`)||y.startsWith(`(${d})`)||y.startsWith(`${d}.`)||y.startsWith(`${d}:`)});if(f)return G(f);if(m>=0){let A=Ft();if(m<A.length){let b=A[m];if(b.tagName.toLowerCase()==="tr"){if(e){let y=b.querySelector(`input[value="${F(e)}" i], [data-value="${F(e)}" i]`);if(y)return y}let v=b.querySelector("input");if(v)return v}return G(b)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(i)){let m=Array.from(document.querySelectorAll(`[data-category="${a}" i], [data-dropzone="${a}" i], [data-role="dropzone"][data-category="${a}" i]`)).find(b=>z(b)&&!B(b));if(m)return m;let f=Array.from(document.querySelectorAll(`input[value="${a}" i], [data-value="${a}" i], input[id="${a}" i], input[placeholder="${a}" i], textarea[placeholder="${a}" i], [title="${a}" i]`)).find(b=>z(b)&&!B(b));if(f)return G(f);let A=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(b=>{if(!z(b)||B(b))return!1;let v=S(b.textContent).toLowerCase();return v===i.toLowerCase()||v===i.toLowerCase()+")"});if(A)return G(A)}try{let d=Array.from(document.querySelectorAll(`[name="${a}"], [value="${a}"], [placeholder="${a}" i], [title="${a}" i], [data-category="${a}" i], [data-dropzone="${a}" i], [data-testid="${a}" i], [data-test-id="${a}" i], [aria-label="${a}" i]`));if(e){let p=d.find(f=>{if(!z(f)||B(f))return!1;if(f instanceof HTMLInputElement&&f.value.toLowerCase()===e.toLowerCase())return!0;let A=f.closest("label, .vf-label, td, div");return A&&S(A.textContent).toLowerCase().includes(S(e).toLowerCase())});if(p)return G(p)}let m=d.find(p=>z(p)&&!B(p));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:G(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(i))try{let m=Array.from(document.querySelectorAll(i)).find(p=>z(p)&&!B(p));if(m)return G(m)}catch{}try{let d=i.replace(/"/g,""),m=`//button[normalize-space(.)="${d}"] | //a[normalize-space(.)="${d}"] | //*[not(*) and normalize-space(.)="${d}"] | //*[@aria-label="${d}"] | //*[@data-category="${d}"] | //*[@data-testid="${d}"]`,p=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let f=0;f<p.snapshotLength;f++){let A=p.snapshotItem(f);if(A&&z(A)&&!B(A)){if(["body","html"].includes(A.tagName.toLowerCase())){let v=A.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(v&&z(v))return G(v)}return A.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(A)}}}catch{}let u=S(i).toLowerCase(),h=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let d of h){if(!z(d)||B(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||V(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=S(d.textContent).toLowerCase(),f=S(d.getAttribute("aria-label")||"").toLowerCase(),A=S(d.getAttribute("placeholder")||"").toLowerCase(),b=S(d.getAttribute("title")||"").toLowerCase(),v=S(d.getAttribute("name")||"").toLowerCase(),y=S(d.getAttribute("data-category")||"").toLowerCase(),C=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"",T=S(C).toLowerCase(),x=p.startsWith(u+")")||p.startsWith(u+".")||p.startsWith(u+" -")||p.startsWith(u+":");if(p===u||f===u||A===u||b===u||v===u||y&&y===u||T&&T===u||x)return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(d)}if(u.length>=3)for(let d of h){if(!z(d)||B(d)||d.closest("header, nav, .stepper, .step-item, .progress-bar-container")||V(d)||!!(d.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||d.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!d.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=S(d.textContent).toLowerCase(),f=S(d.getAttribute("aria-label")||"").toLowerCase(),A=S(d.getAttribute("placeholder")||"").toLowerCase(),b=S(d.getAttribute("title")||"").toLowerCase(),v=S(d.getAttribute("name")||"").toLowerCase();if(p.includes(u)||f.includes(u)||A.includes(u)||b.includes(u)||v.includes(u)){if(Array.from(d.children).some(x=>{let E=S(x.textContent).toLowerCase();return E&&E.includes(u)}))continue;return d.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||G(d)}let y=u.split(/\s+/).filter(Boolean);if(y.length>=3){let C=y.slice(0,Math.min(5,y.length)).join(" ");if(p.includes(C)||f.includes(C)||A.includes(C))return G(d)}}return null}function Vt(n,e){for(let t of e)n.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function ae(n,e){if(!n)return;try{n.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{n.focus?.()}catch{}let t=n.getBoundingClientRect(),o=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),i=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:o,clientY:i};try{n.dispatchEvent(new PointerEvent("pointerover",{...a}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseover",{...a}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerdown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new MouseEvent("mousedown",{...a,button:0,buttons:1}))}catch{}try{n.dispatchEvent(new PointerEvent("pointerup",{...a,button:0,buttons:0}))}catch{}try{n.dispatchEvent(new MouseEvent("mouseup",{...a,button:0,buttons:0}))}catch{}if(typeof n.click=="function")try{n.click()}catch{try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}}else try{n.dispatchEvent(new MouseEvent("click",{...a,button:0,buttons:0}))}catch{}try{let r=Object.keys(n).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(r){let s=n[r];for(;s;){let c=s.memoizedProps||s.pendingProps;if(c?.onClick){c.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let r=Object.keys(n).find(s=>s.startsWith("__reactProps"));if(r){let s=n[r];s?.onClick&&s.onClick({type:"click",target:n,currentTarget:n,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let r=n._vei;r?.onClick&&(Array.isArray(r.onClick.value)?r.onClick.value:[r.onClick.value]).forEach(c=>{try{c({type:"click",target:n})}catch{}})}catch{}try{n.$onclick&&n.$onclick({type:"click",target:n,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||n.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=n.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let c=n.closest("[jsaction]");if(c&&c!==n)try{c.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:o,clientY:i}))}catch{}}}catch{}if(n.getAttribute("role")==="button"||n.getAttribute("tabindex")!==null)try{n.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function ft(n){try{let e=n.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,n.id=e);let o=document.createElement("script");return o.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(o),o.remove(),t||setTimeout(()=>{try{n.id===e&&n.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function Xe(n,e){let t=n;if(t.hasAttribute("for")){let l=t.getAttribute("for"),u=t.ownerDocument.getElementById(l);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Ge(t,[e]);return}let i=t.querySelector('select, [role="combobox"], [role="listbox"]');if(i){Ge(i,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)t=l;else{let h=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(h)t=h;else{let d=t.nextElementSibling;for(;d;){if(d instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(d.type)||d instanceof HTMLTextAreaElement||d instanceof HTMLElement&&d.isContentEditable){t=d;break}let m=d.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}d=d.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let l=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)t=l;else{let u=document.body;try{u=W()||document.body}catch{}let h=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(h)t=h;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=document.body;try{l=W()||document.body}catch{}let u=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;me(t,l);return}let r=String(e??""),s=r;if(t instanceof HTMLInputElement&&t.type==="number"){let l=r.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(s=l)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let c=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(c=document.execCommand?.("insertText",!1,s)||!1):t.isContentEditable&&(c=document.execCommand?.("insertText",!1,s)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let h=t._valueTracker;h&&h.setValue(s===""?" ":"")}catch{}let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{u?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function He(n,e=""){if(n==null)return e;let t=typeof n=="string"?n:String(n);if(!t)return e;let o=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),i=S(t),a=P(t)||P(i);if(!a)return o?e:i||e;let r=a.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(r){let h=S(r.textContent);if(h&&h.length>0&&h.length<150)return h}if(a.id){let h=document.querySelector(`label[for="${F(a.id)}"]`);if(h){let d=S(h.textContent);if(d&&d.length>0&&d.length<150)return d}}let s=a.getAttribute("aria-label");if(s)return S(s);let c=a.getAttribute("placeholder");if(c)return S(c);let l=S(a.textContent);if(l&&l.length>0&&l.length<120)return l;let u=a instanceof HTMLInputElement||a instanceof HTMLButtonElement?a.value:"";return u?S(u):o?e:i||e}function me(n,e){if(!n)return;let t=n.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||n,o=n instanceof HTMLInputElement&&["checkbox","radio"].includes(n.type)?n:t.querySelector('input[type="checkbox"], input[type="radio"]');!o&&t.hasAttribute("for")&&(o=t.ownerDocument.getElementById(t.getAttribute("for")));let i=n instanceof HTMLInputElement?n.closest("label")||(n.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||n:t&&z(t)?t:n;if(o){let a=o.type==="radio",r=o.type==="checkbox",s=!!o._valueTracker;if(o.checked===e){if(a&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(r){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(i&&i!==o&&ae(i),o.checked!==e)try{o.focus?.(),o.click()}catch{}if(o.checked!==e){try{let l=o._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(o,e)}catch{}o.checked=e,Vt(o,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;ae(i),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Ge(n,e){let t=typeof HTMLSelectElement<"u"&&n instanceof HTMLSelectElement||n.tagName?.toLowerCase()==="select"?n:n.querySelector("select");if(t){let r=e.map(l=>S(l).toLowerCase()),s=!1,c=(l,u)=>{l.selected=!0,t.selectedIndex=u;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let h=t._valueTracker;h&&h.setValue(l.value)}catch{}s=!0};for(let l=0;l<t.options.length;l++){let u=t.options[l],h=u.value.toLowerCase(),d=S(u.textContent).toLowerCase();if(r.some(p=>p===h||p===d)){if(c(u,l),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!s)for(let l of r){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let h=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?h:h>=1?h-1:0;if(m>=0&&m<t.options.length&&(c(t.options[m],m),!t.multiple))break}}if(!s){for(let l of r)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,d=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(d>=0&&d<t.options.length&&(c(t.options[d],d),!t.multiple))break}}if(!s){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let h=t.options[u],d=l(h.value.toLowerCase()),m=l(S(h.textContent).toLowerCase());if(r.some(f=>{let A=l(f);return d.includes(A)||m.includes(A)||A.length>2&&(A.includes(d)||A.includes(m))})&&(c(h,u),!t.multiple))break}}if(s){Vt(t,["focus","input","change","blur"]);return}}let o=n.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?n:n.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');o&&ae(o);let i=e.map(r=>S(r).toLowerCase()),a=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(r=>z(r)&&!B(r));for(let r of i){let s=a.find(l=>{let u=S(l.textContent).toLowerCase(),h=S(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===r||h===r||u.includes(r)||r.length>2&&r.includes(u)});if(s){ae(s);let l=s.querySelector('input[type="radio"], input[type="checkbox"]');l&&me(l,!0);return}let c=P(r);if(c){ae(c);return}}}function An(n,e){try{let t=new DataTransfer;try{t.setData("text/plain",n)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function mt(n){try{n.click()}catch{let e=n.ownerDocument.defaultView||window;n.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function yn(n,e,t){try{if(e.contains(n))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(n))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let o=e.children.length;if(t!==void 0&&o>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${o}`};if([n.getAttribute("data-placed")==="true",n.getAttribute("data-assigned")==="true",n.getAttribute("data-matched")==="true",n.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(n.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let a=(n.textContent||"").trim().toLowerCase();return a.length>2&&Array.from(e.querySelectorAll("*")).some(c=>c!==e&&(c.textContent||"").trim().toLowerCase()===a)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:n.getAttribute("aria-hidden")==="true"||n.style.display==="none"||n.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function oe(n,e){let t=S(n).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(n.trim())){let s=document.getElementById(n.trim());if(s&&z(s)&&!B(s))return s}let r=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of r){let l=Array.from(document.querySelectorAll(s)).find(u=>{if(!z(u)||B(u))return!1;let h=S(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return h===t||h.includes(t)||u.id===n.trim()});if(l)return l}return null}let o=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),i=Array.from(document.querySelectorAll(o)),a=i.find(r=>[r.getAttribute("data-category"),r.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return a&&z(a)&&!B(a)?a:i.find(r=>{if(!z(r)||B(r)||/unclassified/i.test(r.className))return!1;let s=r.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),c=S(s?.textContent||r.textContent||"").toLowerCase();return c.includes("op")&&(c.includes("es")||c.includes("\xF5es"))?!1:c===t||c.startsWith(t)||c.includes(t)})||null}async function Ke(n,e,t=1){try{n.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let o=n.getBoundingClientRect(),i=e.getBoundingClientRect(),a=Math.round(o.left+Math.max(1,o.width/2)),r=Math.round(o.top+Math.max(1,o.height/2)),s=Math.round(i.left+Math.max(1,i.width/2)),c=Math.round(i.top+Math.max(1,i.height/2)),l=S(e.textContent).toLowerCase();if(l){let f=Array.from(n.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(A=>{let b=S(A.textContent).toLowerCase(),v=A instanceof HTMLInputElement||A instanceof HTMLOptionElement?S(A.value).toLowerCase():"";return b&&(l.includes(b)||b.includes(l))||v&&(l.includes(v)||v.includes(l))});f&&(ae(f),await new Promise(A=>setTimeout(A,120)))}mt(n),await new Promise(p=>setTimeout(p,140)),mt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&mt(u),await new Promise(p=>setTimeout(p,100)),!e.contains(n)&&n.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(n),e.contains(n)&&n.matches('.dnd-card, [draggable="true"]'))return;let h={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r,screenX:a,screenY:r,button:0,buttons:1};try{n.dispatchEvent(new PointerEvent("pointerdown",{...h,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}n.dispatchEvent(new MouseEvent("mousedown",h));let d=4;for(let p=1;p<=d;p++){let f=Math.round(a+(s-a)*(p/d)),A=Math.round(r+(c-r)*(p/d)),b={...h,clientX:f,clientY:A,screenX:f,screenY:A};try{n.dispatchEvent(new PointerEvent("pointermove",{...b,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",b))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:c,screenX:s,screenY:c,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let p=An(Q(n.textContent),n.outerHTML),f={...h},A={...m};p&&(f.dataTransfer=p,A.dataTransfer=p);let b=n.ownerDocument.defaultView?.DragEvent;if(!b)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");n.dispatchEvent(new b("dragstart",f)),e.dispatchEvent(new b("dragenter",A)),e.dispatchEvent(new b("dragover",A)),e.dispatchEvent(new b("drop",A)),n.dispatchEvent(new b("dragend",f))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:n,clientX:a,clientY:r}),f=new Touch({identifier:1,target:e,clientX:s,clientY:c});n.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(n))try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),n.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(n))try{let p=b=>{let v=Object.keys(b).find(C=>C.startsWith("__reactFiber")||C.startsWith("__reactInternalInstance"));if(!v)return null;let y=b[v];for(let C=0;C<10&&y;C++){if(y.memoizedProps)return y.memoizedProps;y=y.return}return null},f=p(n),A=p(e);if(f){let b=f.onMouseDown||f.onPointerDown||f.onDragStart;if(typeof b=="function")try{b({type:"mousedown",button:0,buttons:1,clientX:a,clientY:r,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:n,target:n}),await new Promise(v=>setTimeout(v,100))}catch{}}if(A){let b=A.onMouseUp||A.onPointerUp||A.onDrop;if(typeof b=="function")try{b({type:"mouseup",button:0,buttons:0,clientX:s,clientY:c,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{n.focus?.(),n.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(v=>setTimeout(v,200));let b=c>r?"ArrowDown":"ArrowUp";for(let v=0;v<3;v++)document.dispatchEvent(new KeyboardEvent("keydown",{key:b,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(v=>setTimeout(v,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(n.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:n.id||n.getAttribute("data-id")}})),await new Promise(v=>setTimeout(v,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}}function Ut(n,e,t,o){let i=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),a=i(n.toLowerCase()),r=i(e.toLowerCase()),s=i(t),c=i(o);return`var src=$eq.find('${s}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${a}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${r}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${a} -> ${r}');}`}var Xt={fill:(n,e)=>{let t=P(n);t?Xe(t,e):console.warn(`$eq.fill: Elemento '${n}' n\xE3o encontrado`)},click:n=>{let e=P(n);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?me(e,!0):ae(e):console.warn(`$eq.click: Elemento '${n}' n\xE3o encontrado`)},check:(n,e)=>{let t=P(n);t?me(t,e):console.warn(`$eq.check: Elemento '${n}' n\xE3o encontrado`)},find:(n,e)=>P(n,e),drag:(n,e)=>{let t=oe(n,"source")||P(n),o=oe(e,"destination")||P(e);t&&o?Ke(t,o):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${n}' -> '${e}')`)},categorize:async(n,e)=>{let t=oe(n,"source")||P(n),o=oe(e,"destination")||P(e);if(!t||!o){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${n}' -> '${e}')`);return}await Ke(t,o)},execute:(n,e=!1,t=1)=>ze(n,e,t)};typeof window<"u"&&(window.$eq=Xt);async function xn(n,e=1,t=ye()){if(rt(n,t),n.t==="js"){let c=String(n.v||"");Bt(c);try{new Function("$eq","document","window",c)(Xt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(n.t==="drag"){let c=oe(n.from,"source")||P(n.from),l=oe(n.to,"destination")||P(n.to);!c&&n.from&&(c=P(S(n.from))),!l&&n.to&&(l=P(S(n.to))),c&&l?await Ke(c,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${n.from}' -> '${n.to}')`);return}let o=n.id!==void 0&&n.id!==null?String(n.id):"";!o&&n.t==="val"&&(o=n.target??n.name??n.selector??"1");let i=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,a=i!=null?String(i).trim():"",r=null,s=String(n.name??n.n??"").trim();if(!s&&o&&document.querySelector(`input[type="radio"][name="${F(o)}"]`)&&(s=o),(n.t==="chk"||n.t==="clk")&&s){let c=Array.from(document.querySelectorAll(`input[name="${F(s)}"]`));if(a&&(r=c.find(l=>l.value?.toLowerCase()===a.toLowerCase())??null),!r&&a){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(a),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(a);if(l||u){let h=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=c.find(d=>{let m=d.value?.toLowerCase()??"";if(h.includes(m))return!0;let f=(d.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return h.some(A=>f===A||f.startsWith(A+" ")||f.startsWith("("+A+")"))})??null}}!r&&c.length>0&&(r=c[0])}if(r||(r=P(o,a,n.t==="val"||n.t==="sel")),!r&&o&&(r=P(S(o),a,n.t==="val"||n.t==="sel")),r&&a){if(r instanceof HTMLInputElement&&r.type==="radio"&&r.name){if(S(r.value).toLowerCase()!==S(a).toLowerCase()){let c=document.querySelector(`input[type="radio"][name="${F(r.name)}"][value="${F(a)}" i]`);if(c)r=c;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${F(r.name)}"]`)).find(h=>{let d=h.closest("label, .vf-label, .option-card, tr, td, div");return d&&S(d.textContent).toLowerCase().includes(S(a).toLowerCase())});u&&(r=u)}}}else if(!(r instanceof HTMLInputElement)&&!(r instanceof HTMLSelectElement)&&!(r instanceof HTMLTextAreaElement)){let c=r.querySelector(`input[value="${F(a)}" i], [data-value="${F(a)}" i]`);if(c)r=c;else{let u=Array.from(r.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(h=>{let d=h.closest("label, .vf-label, .option-card, td, div");return d&&S(d.textContent).toLowerCase().includes(S(a).toLowerCase())});u&&(r=u)}}}if(!r&&(n.t==="val"||n.t==="sel")){let c=document.body;try{c=W()||document.body}catch{}let l=Array.from(c.querySelectorAll(n.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>z(u)&&!B(u));if(l.length===1)r=l[0];else if(l.length>1){let u=S(o).toLowerCase(),h=u.match(/^#?_?([0-9]+)$/);if(h){let d=parseInt(h[1],10);d>=1&&d<=l.length?r=l[d-1]:d>=0&&d<l.length&&(r=l[d])}r||(r=l.find(m=>{let p=(m.getAttribute("placeholder")||"").toLowerCase(),f=(m.name||"").toLowerCase(),A=(m.getAttribute("aria-label")||"").toLowerCase(),b=(m.id||"").toLowerCase(),v=S(ct(m)).toLowerCase(),y=S(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(u)||f.includes(u)||A.includes(u)||b.includes(u)||v&&v.includes(u)||u.length>=2&&y.includes(u)})||(l.length===1?l[0]:null))}}if(!r&&n.t!=="adv")throw new Error(`Alvo '${o}' n\xE3o encontrado no DOM para a\xE7\xE3o '${n.t}'.`);switch(n.t){case"val":if(r){let u=r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement||r.isContentEditable?r:r.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let p=r.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(u=p)}if(!u){let m=r.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){u=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){u=p;break}m=m.nextElementSibling}}if(!u){let m=document.body;try{m=W()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>z(f)&&!B(f));p.length>0&&(u=p[0])}let h=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,d=h!=null?String(h):"";Xe(u||r,d)}break;case"chk":let c=n.c!==void 0?!!n.c:!0;r&&me(r,c);break;case"sel":if(r){let u=Array.isArray(n.v)?n.v:[String(n.v)];Ge(r,u)}break;case"clk":if(r)if(!!(r.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||r.querySelector('input[type="radio"], input[type="checkbox"]')||r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type))){let h=n.c!==void 0?!!n.c:!0;me(r,h)}else ae(r,n.co);break;case"adv":let l=Gt(n.id);if(l){await ht(l,1200);let u=n.id||l.textContent?.trim()||"";u&&tt(window.location.hostname,{advanceSelector:u}),ae(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function wn(){let n=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(n)).find(t=>{if(!z(t)||B(t)||t.closest("header, nav, aside"))return!1;let o=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",i=(t.textContent||o||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(i)})||null}function Gt(n){let e=d=>{let m=(d.getAttribute("aria-label")||d.textContent||(d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"")||"").trim();return le.test(m)};if(n){let d=P(n);if(d&&z(d)&&!B(d)&&!V(d)&&!e(d))return d}try{let d=et(window.location.hostname);if(d.advanceSelector){let m=P(d.advanceSelector);if(m&&z(m)&&!B(m)&&!V(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),o=Array.from(document.querySelectorAll(t)),i=d=>{let m=d instanceof HTMLInputElement||d instanceof HTMLButtonElement?d.value:"";return(d.getAttribute("aria-label")||d.textContent||m||"").trim()},a=d=>{let m=i(d).trim();return/^\d{1,3}$/.test(m)?!!d.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},r=o.filter(d=>z(d)&&!B(d)&&!d.closest("header, aside")&&!V(d)&&!e(d));for(let d of r){let m=i(d),p=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((Ie.test(m)||Ie.test(p))&&!a(d)&&!V(d))return d}for(let d of r)if(_(d)&&!V(d)&&!a(d))return d;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&z(s)&&!B(s)&&!V(s)&&!e(s))return s;let c=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let d of c)if(z(d)&&!B(d)&&!e(d)&&!V(d)&&!a(d))return d;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,h=l.filter(d=>{if(!z(d)||B(d)||e(d)||V(d)||d.closest("header, nav, aside, .eq-sidebar")||a(d))return!1;let m=d.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(h.length>0)return h.sort((d,m)=>{let p=d.getBoundingClientRect(),f=m.getBoundingClientRect(),A=p.left+p.top;return f.left+f.top-A}),h[0];for(let d of r)if(_(d)&&!V(d))return d;return null}async function ht(n,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(n.disabled===!0||n.getAttribute("aria-disabled")==="true"||n.classList.contains("disabled")||n.getAttribute("disabled")!==null))return;await new Promise(i=>setTimeout(i,80))}}function En(){let n=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,o=(document.body?.innerText||document.body?.textContent||"").length;return`${n}|${e}|${t}|${o}`}async function Cn(n,e=3500){let[t,o,i,a]=n.split("|"),r=parseInt(a||"0",10),s=Date.now();for(;Date.now()-s<e;){let c=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),h=(document.body?.innerText||document.body?.textContent||"").length;if(c!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${c}`};if(l!==o)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${o}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(i||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${i} \u2192 ${u}`};if(Math.abs(h-r)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(h-r)} chars)`};await new Promise(d=>setTimeout(d,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Je(n){if(n.t==="js"||n.t==="adv")return;if(n.t==="drag"){let a=P(n.from)||P(S(n.from)),r=P(n.to)||P(S(n.to));a&&r&&await Ke(a,r,2);return}let e=n.id||"",t=n.v!==void 0?String(n.v).trim():"",o=P(e,t)||P(S(e),t),i=String(n.name??n.n??"").trim();if(!i&&e&&document.querySelector(`input[type="radio"][name="${F(e)}"]`)&&(i=e),!o&&i){let a=Array.from(document.querySelectorAll(`input[name="${F(i)}"]`));if(t&&(o=a.find(r=>r.value?.toLowerCase()===t.toLowerCase())??null),!o&&t){let r=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),s=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(r||s){let c=r?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];o=a.find(l=>{let u=l.value?.toLowerCase()??"";if(c.includes(u))return!0;let d=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return c.some(m=>d===m||d.startsWith(m+" ")||d.startsWith("("+m+")"))})??null}}!o&&a.length>0&&(o=a[0])}if(n.t==="clk"||n.t==="chk"){if(!o&&e){let r=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=S(e).toLowerCase();o=r.find(c=>{let l=S(c.textContent).toLowerCase();return!!(S(c.value||"").toLowerCase()===s||l===s||l.startsWith(s+")")||l.startsWith("("+s+")")||l.startsWith(s+".")||l.startsWith(s+" - ")||l.startsWith(s+":")||s.length>=3&&l.includes(s))})||null}let a=n.v!==void 0?String(n.v).trim():"";if(o&&a){if(o instanceof HTMLInputElement&&o.type==="radio"&&o.name){if(S(o.value).toLowerCase()!==S(a).toLowerCase()){let r=document.querySelector(`input[type="radio"][name="${F(o.name)}"][value="${F(a)}" i]`);if(r)o=r;else{let c=Array.from(document.querySelectorAll(`input[type="radio"][name="${F(o.name)}"]`)).find(l=>{let u=l.closest("label, .vf-label, .option-card, tr, td, div");return u&&S(u.textContent).toLowerCase().includes(S(a).toLowerCase())});c&&(o=c)}}}else if(!(o instanceof HTMLInputElement)&&!(o instanceof HTMLSelectElement)&&!(o instanceof HTMLTextAreaElement)){let r=o.querySelector(`input[value="${F(a)}" i], [data-value="${F(a)}" i]`);if(r)o=r;else{let c=Array.from(o.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let u=l.closest("label, .vf-label, .option-card, td, div");return u&&S(u.textContent).toLowerCase().includes(S(a).toLowerCase())});c&&(o=c)}}}if(o){let r=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,s=o instanceof HTMLInputElement&&["radio","checkbox"].includes(o.type)?o:r.querySelector('input[type="radio"], input[type="checkbox"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),c=n.c!==void 0?!!n.c:!0;if(me(s||r,c),s&&s.checked!==c){try{let l=s._valueTracker;l&&l.setValue(!c)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,c)}catch{}s.checked=c,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(n.t==="val"){let a=null;if(o&&(a=o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o.isContentEditable?o:o.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!a){let r=document.body;try{r=W()||document.body}catch{}let s=Array.from(r.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),c=S(e).toLowerCase();a=s.find(l=>{let u=(l.getAttribute("placeholder")||"").toLowerCase(),h=(l.name||"").toLowerCase(),d=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return u.includes(c)||h.includes(c)||d.includes(c)||m.includes(c)})||(s.length>0?s[0]:null)}if(a){let r=String(n.v??"");try{if(a.focus?.(),a.type!=="number"){try{a.select?.()}catch{}document.execCommand?.("insertText",!1,r)}}catch{}Xe(a,r)}return}if(n.t==="sel"){if(!o&&e){let a=Array.from(document.querySelectorAll("select")),r=S(e).toLowerCase();o=a.find(s=>{let c=(s.name||"").toLowerCase(),l=(s.id||"").toLowerCase(),u=(s.getAttribute("aria-label")||"").toLowerCase();return c.includes(r)||l.includes(r)||u.includes(r)})||null}if(o){let a=Array.isArray(n.v)?n.v:[String(n.v)];Ge(o,a)}return}}function ne(n){try{if(n.t==="val"){let e=n.v!==void 0?n.v:n.value!==void 0?n.value:n.val!==void 0?n.val:n.text,t=String(e??"").trim(),o=t,i=n.id!==void 0&&n.id!==null?String(n.id):"";i||(i=n.target??n.name??n.selector??"1");let a=P(i,o,!0)||P(S(i),o,!0);if(!a){let m=document.body;try{m=W()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>z(f)&&!B(f));p.length>0&&(a=p[0])}if(!a)return!1;let r=a instanceof HTMLInputElement&&a.type==="radio"?a:a.querySelector('input[type="radio"]');if(r&&r.name){let m=document.querySelector(`input[type="radio"][name="${F(r.name)}"]:checked`);if(!m)return!1;let p=S(m.value).toLowerCase(),f=S(t).toLowerCase(),A=S(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===f||A===f||A.includes(f)}let s=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let p=a.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(s=p)}if(!s){let m=a.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){s=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){s=p;break}m=m.nextElementSibling}}if(s instanceof HTMLSelectElement){let m=S(t).toLowerCase();return Array.from(s.options).some(p=>{if(!p.selected)return!1;let f=p.value.toLowerCase(),A=S(p.textContent).toLowerCase();return m===f||m===A||f.includes(m)||A.includes(m)})}let c=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??a.textContent??"").trim();if(!c&&!t)return!0;if(!c&&t)return!1;let l=c.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),h=parseFloat(l),d=parseFloat(u);return!isNaN(h)&&!isNaN(d)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(h-d)<1e-4:l===u||c.toLowerCase()===t.toLowerCase()||u.length>=3&&l===u}if(n.t==="sel"){let e=P(n.id,void 0,!0)||P(S(n.id),void 0,!0);if(!e){let a=document.body;try{a=W()||document.body}catch{}let r=Array.from(a.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>z(l)&&!B(l)),s=S(n.id).toLowerCase();e=r.find(l=>{let u=(l.id||"").toLowerCase(),h=(l.getAttribute("name")||"").toLowerCase(),d=(l.getAttribute("aria-label")||"").toLowerCase(),m=S(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(s)||h.includes(s)||d.includes(s)||s.length>=2&&m.includes(s)})||(r.length===1?r[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let a=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(a){let s=(Array.isArray(n.v)?n.v:[String(n.v)]).map(l=>S(l).toLowerCase()),c=S(a.textContent).toLowerCase();return s.some(l=>c.includes(l)||l.includes(c))}return!1}let i=(Array.isArray(n.v)?n.v:[String(n.v)]).map(a=>S(a).toLowerCase());return Array.from(t.options).some(a=>{if(!a.selected)return!1;let r=a.value.toLowerCase(),s=S(a.textContent).toLowerCase();return i.some(c=>c===r||c===s||r.includes(c)||s.includes(c))})}if(n.t==="chk"||n.t==="clk"){let e=n.v!==void 0?String(n.v).trim():"",t=String(n.name??n.n??"").trim();if(t&&!n.id){let d=Array.from(document.querySelectorAll(`input[name="${F(t)}"]`));if(d.length>0){let m=d.find(v=>v.checked);if(!m)return!1;if(!e)return!0;let p=m.value?.toLowerCase()??"",f=e.toLowerCase();if(p===f)return!0;let A=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),b=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return A?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):b?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let o=P(n.id,e)||P(S(n.id),e);if(!o&&t){let d=document.querySelector(`input[name="${F(t)}"]`);d&&(o=d)}if(!o)return!1;let i=o.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:i.querySelector('input[type="checkbox"], input[type="radio"]')||(i.getAttribute("for")?i.ownerDocument.getElementById(i.getAttribute("for")):null),r=n.t==="chk"||n.c!==void 0?!!n.c:!0;if(a&&a.type==="radio"){if(a.checked===r)return!0;if(n.v&&a.name){let d=S(String(n.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${F(a.name)}"]:checked`);if(!m)return!1;if(m===a)return!0;let p=S(m.value).toLowerCase(),f=S(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===d||f.includes(d)||d.includes(p)}}if(a&&["checkbox","radio"].includes(a.type))return a.checked===r;let s=i.getAttribute("aria-checked")===String(r)||i.getAttribute("aria-selected")===String(r)||i.getAttribute("aria-pressed")===String(r),c=r?i.getAttribute("data-selected")==="true"||i.getAttribute("data-checked")==="true"||i.getAttribute("data-active")==="true"||i.getAttribute("data-state")==="checked"||i.getAttribute("data-state")==="on":i.getAttribute("data-selected")==="false"||i.getAttribute("data-checked")==="false"||i.getAttribute("data-state")==="unchecked",l=i.className||"",u=r?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(s||c||u)return!0;let h=!!i.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return n.t==="clk"&&!a&&!h||i.getAttribute("aria-expanded")!==null||i.getAttribute("aria-pressed")!==null}if(n.t==="drag"){let e=oe(n.from,"source")||P(n.from)||P(S(n.from)),t=oe(n.to,"destination")||P(n.to)||P(S(n.to));return!e||!t?!1:yn(e,t).success}}catch{}return!1}async function ze(n,e,t=1,o=ye({engine:"smart",autoAdvance:e})){let i=n.actions.filter(w=>w.t!=="adv"),a=n.actions.filter(w=>w.t==="adv"),r=0,s=[],c=new Map,l=new Map,u=new Map,h=new Set,d=n.pageType==="question"||i.length>0,m=i.filter(w=>w.t==="chk"||w.t==="clk"&&w.c!==void 0),p=new Map;for(let w of i){let M=[];l.set(w,M);try{if(w.t==="drag"){M.push("declarative-A-F");try{let H=oe(w.from,"source")||P(w.from),q=oe(w.to,"destination")||P(w.to);H&&u.set(w,H.parentElement?.outerHTML?.slice(0,500)||""),q&&p.set(w,q.children.length)}catch{}}else M.push("declarative-primary");await xn(w,t,o),r++,h.add(w)}catch(H){c.set(w,H instanceof Error?H.message:String(H)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",w,H)}await new Promise(H=>setTimeout(H,w.t==="drag"?180:35))}if(d&&n.mode==="escolha_multipla"&&m.length>0){let w=document.body;try{w=W()||document.body}catch{}let M=Array.from(w.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(H=>z(H)&&!B(H));if(M.length>1){let q=function(I,O){if(I===O||I.contains(O)||O.contains(I))return!0;let N=I.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),R=O.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(N&&R&&N===R)return!0;let U=I.getAttribute("for")||I.id,X=O.getAttribute("for")||O.id;return!!(U&&X&&U===X)};var k=q;let H=new Set;for(let I of m){let O=I.t==="chk"?!!I.c:!!(I.c??!0),N="id"in I&&typeof I.id=="string"?I.id:"";if(O&&N){let R=P(N,I.v);if(R){H.add(R);let U=R.querySelector('input[type="checkbox"]');U&&H.add(U);let X=R.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');X&&(H.add(X),X.querySelectorAll('input[type="checkbox"]').forEach(Z=>H.add(Z)))}}}if(H.size>=m.length&&H.size>0){let I=Array.from(H);for(let O of M)I.some(R=>q(R,O))||(O instanceof HTMLInputElement&&O.checked||O.getAttribute("aria-checked")==="true"||O.closest(".option-card, label")?.classList.contains("selected"))&&me(O,!1)}}}await new Promise(w=>setTimeout(w,i.length>0?100:25));let f=0;for(let w of i){if(ne(w)){f++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${w.t}' no alvo '${w.id||w.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{rt(w,o),l.get(w)?.push("alternative-path"),await Je(w)}catch(M){c.set(w,M instanceof Error?M.message:String(M)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",M)}await new Promise(M=>setTimeout(M,250)),ne(w)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),f++,h.has(w)?c.has(w)&&c.delete(w):(c.delete(w),r++,h.add(w)))}if(f<i.length&&i.length>0){console.warn(`[EasyQuiz Auto-Cura] ${i.length-f} de ${i.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(w=>setTimeout(w,200));for(let w of i)if(!ne(w))try{if(await Je(w),await new Promise(M=>setTimeout(M,80)),!ne(w)&&(w.t==="clk"||w.t==="chk"))try{let M="id"in w?String(w.id||""):"",H=w.v!==void 0?String(w.v).trim():"",q=P(M,H)||P(S(M),H);q&&(ft(q),await new Promise(I=>setTimeout(I,120)))}catch{}}catch(M){c.set(w,M instanceof Error?M.message:String(M))}await new Promise(w=>setTimeout(w,200)),f=0;for(let w of i)ne(w)&&(f++,h.has(w)?c.has(w)&&c.delete(w):(c.delete(w),r++,h.add(w)))}let A=[];for(let[w,M]of i.entries())if(!ne(M)){let H=M.t==="drag"?`${M.from} -> ${M.to}`:"id"in M&&M.id?M.id:M.t;s.push(H),A.push({actionIndex:w,action:M,strategiesAttempted:l.get(M)||[],evidence:c.get(M)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(M)}),M.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${M.from}" -> "${M.to}"`,`
  Estrat\xE9gias: ${(l.get(M)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(M)?.slice(0,200)||"n/a"}`)}d&&i.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let b=i.map((w,M)=>{let H=w.t==="drag"?`${w.from} -> ${w.to}`:w.t==="js"?"$eq":w.id||w.t,q=w.t==="js"?!0:w.t==="drag"?!!(oe(w.from,"source")&&oe(w.to,"destination")):!!(P(w.id||"")||P(S(w.id||""))),I=ne(w);return{index:M,action:w,target:H,located:q,applied:!c.has(w),verified:I,strategy:w.t==="drag"?"drag-adaptive":w.t==="js"?"javascript":"declarative-dom",evidence:I?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...c.has(w)?{error:c.get(w)}:{}}}),v=d?i.length>0&&s.length===0&&(f===i.length||r===i.length&&f>0):!0,y=!1,C=!1,T="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",x=d?f>0&&f>=Math.ceil(i.length/2):r>0&&r>=i.length/2,E=d?f>0&&(v||x):v||i.length===0||x;if(e&&E){await new Promise(H=>setTimeout(H,i.length>0?120:40));let w=!1,M=null;if(n.pageType!=="info"){let H=wn();if(H&&z(H)){await ht(H,1200),ae(H),w=!0,M=H,await new Promise(O=>setTimeout(O,350));let q=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');q&&z(q)&&(q.textContent||"").trim().length>0?(y=!1,C=!1,T=`Aviso do formul\xE1rio ap\xF3s checagem: ${q.textContent?.trim().slice(0,100)}`):(y=!0,C=!0,T="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!w){let H=En(),q=a.length>0&&"id"in a[0]?a[0].id:void 0,I=Gt(q);if(I){await ht(I,1500);let O=q||I.textContent?.trim()||"";O&&tt(window.location.hostname,{advanceSelector:O}),ae(I);let N=await Cn(H,1800);C=N.changed,T=N.evidence,y=N.changed||!0,N.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:r,verified:f,success:v,advanced:y,failed:s,reports:b,navigationVerified:C,navigationEvidence:T,failedActions:A}}var ie=null,xe=[],gt=[],bt=[],vt=[],se=null,he=null,Tn=`
...
`;function Kt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=Tn,document.head.appendChild(n)}}catch{}}function fe(){ie&&(ie.style.removeProperty("outline"),ie.style.removeProperty("outline-offset"),ie.style.removeProperty("position"),ie=null);for(let n of xe)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");xe=[];for(let n of gt)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");gt=[];for(let n of bt)try{n.remove()}catch{}bt=[],he&&typeof window<"u"&&(window.removeEventListener("scroll",he),window.removeEventListener("resize",he),he=null);for(let n of vt)try{n.remove()}catch{}if(vt=[],se){try{se.remove()}catch{}se=null}}function At(n){Kt();let e=[];for(let t of n){if(!t||typeof t.setAttribute!="function")continue;let o=t;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),gt.push(o)}catch{}try{let i=t.getBoundingClientRect(),a=i.width||t.offsetWidth||280,r=i.height||t.offsetHeight||200;if(a>10&&r>10){let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
          position: absolute;
    ...
    `,n.appendChild(t),se=t}catch{}}function qn(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Jt(n,e){if(se){try{se.remove()}catch{}se=null}let t=qn(e);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let m=P(o.from),p=P(o.to);m&&(m.style.outline=`2px solid ${t.outline}`,xe.push(m)),p&&(p.style.outline="2px dashed #00e5ff",xe.push(p))}catch{}continue}let i=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${F(a)}"]`));if(i&&(r=m.find(p=>p.value?.toLowerCase()===i.toLowerCase())??null,!r)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(i),f=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(i);if(p||f){let A=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=m.find(b=>{let v=b.value?.toLowerCase()??"";if(A.includes(v))return!0;let C=(b.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return A.some(T=>C===T||C.startsWith(T+" ")||C.startsWith("("+T+")"))})??null}}!r&&m.length>0&&(r=m[0])}if(!r&&o.id&&(r=P(o.id,i,o.t==="val"||o.t==="sel")||P(S(o.id),i,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let m=document.body;try{m=W()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(b=>z(b)&&!ue(b)),f=S(o.id).toLowerCase();r=p.find(b=>{let v=(b.id||"").toLowerCase(),y=(b.getAttribute("name")||"").toLowerCase(),C=(b.getAttribute("aria-label")||"").toLowerCase(),T=S(b.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return v.includes(f)||y.includes(f)||C.includes(f)||f.length>=2&&T.includes(f)})||(p.length===1?p[0]:null)}if(!r)continue;let s=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",c=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=s?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=c||l||r;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),xe.push(u);let h=s?r:u.querySelector('select, [role="combobox"], [role="listbox"]');h&&(h.style.outline=`2px solid ${t.outline}`,h.style.outlineOffset="2px",h.style.boxShadow=`0 0 10px ${t.glow}`,h.setAttribute("data-easyquiz-highlight","true"),xe.push(h));let d=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:u.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==u&&(d.style.outline=`2px solid ${t.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${t.glow}`,d.setAttribute("data-easyquiz-highlight","true"),xe.push(d))}}var yt=10,kn=1400,Oe=15e5;function de(n){return new Promise((e,t)=>{let o=new FileReader;o.onerror=()=>t(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(n)})}async function we(n){let e=0,t=0;if(n instanceof HTMLImageElement?(e=n.naturalWidth||n.width,t=n.naturalHeight||n.height):(e=n.width,t=n.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,kn/Math.max(e,t)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(t*o)),r=document.createElement("canvas");r.width=i,r.height=a;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,a),s.drawImage(n,0,0,i,a),new Promise((c,l)=>{r.toBlob(u=>u?c(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Yt(n){let e=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=e.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(o*i))),s=n.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.getAttribute("xmlns:xlink")||s.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),s.setAttribute("width",String(a)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&o>0&&s.setAttribute("viewBox",`0 0 ${t} ${o}`);try{let d=Array.from(n.querySelectorAll("*")),m=Array.from(s.querySelectorAll("*"));for(let p=0;p<Math.min(d.length,m.length);p++){let f=d[p],A=m[p];if(!f||!A||!A.style)continue;let b=window.getComputedStyle?window.getComputedStyle(f):null;b&&(b.fill&&b.fill!=="none"&&(A.style.fill=b.fill),b.stroke&&b.stroke!=="none"&&(A.style.stroke=b.stroke),b.strokeWidth&&(A.style.strokeWidth=b.strokeWidth),b.fontFamily&&(A.style.fontFamily=b.fontFamily),b.fontSize&&(A.style.fontSize=b.fontSize),b.fontWeight&&(A.style.fontWeight=b.fontWeight),b.color&&(A.style.color=b.color))}}catch{}let c="#ffffff";try{let d=n.parentElement||n;for(;d&&d!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(d):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){c=p;break}d=d.parentElement}}catch{}let u=new XMLSerializer().serializeToString(s),h="";try{h=btoa(unescape(encodeURIComponent(u)))}catch{}try{let d=A=>new Promise((b,v)=>{let y=new Image,C=setTimeout(()=>v(new Error("Timeout render SVG")),1200);y.onload=()=>{clearTimeout(C),b(y)},y.onerror=()=>{clearTimeout(C),v(new Error("Falha ao renderizar SVG em Image."))},y.src=A}),m=null;if(h)try{m=await d(`data:image/svg+xml;base64,${h}`)}catch{}if(!m){let A=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),b=URL.createObjectURL(A);try{m=await d(b)}finally{URL.revokeObjectURL(b)}}let p=document.createElement("canvas");p.width=a,p.height=r;let f=p.getContext("2d",{alpha:!1});if(f&&m){f.fillStyle=c,f.fillRect(0,0,a,r),f.drawImage(m,0,0,a,r);let A=await new Promise(b=>{p.toBlob(b,"image/jpeg",.92)});if(A){let b=await de(A);if(b)return{blob:A,base64:b,mediaType:"image/jpeg"}}}}catch{}return{base64:h,mediaType:"image/svg+xml"}}async function xt(n){try{let e=n.getBoundingClientRect(),t=Math.round(e.width)||n.offsetWidth||400,o=Math.round(e.height)||n.offsetHeight||300;if(t<30||o<30)return null;let i=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(i&&n.querySelectorAll("input, select, textarea").length===0)try{let f=await Yt(i);if(f.base64&&f.base64.length<=Oe)return{mediaType:f.mediaType,base64:f.base64,alt:n.getAttribute("aria-label")||i.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:ge(i)}}catch{}if(n instanceof HTMLCanvasElement)try{let f=await we(n),A=await de(f);if(A)return{mediaType:"image/jpeg",base64:A,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let f=n;for(;f&&f!==document.documentElement;){let b=(window.getComputedStyle?window.getComputedStyle(f):null)?.backgroundColor;if(b&&b!=="transparent"&&b!=="rgba(0, 0, 0, 0)"){a=b;break}f=f.parentElement}}catch{}let r=n.cloneNode(!0),s=Array.from(n.querySelectorAll("*")),c=Array.from(r.querySelectorAll("*"));for(let f=0;f<Math.min(s.length,c.length);f++){let A=s[f],b=c[f];if(!(!A||!b||!b.style))try{let v=window.getComputedStyle(A);b.style.color=v.color,b.style.backgroundColor=v.backgroundColor,b.style.borderColor=v.borderColor,b.style.borderWidth=v.borderWidth,b.style.borderStyle=v.borderStyle,b.style.fontSize=v.fontSize,b.style.fontFamily=v.fontFamily,b.style.fontWeight=v.fontWeight,b.style.lineHeight=v.lineHeight,b.style.letterSpacing=v.letterSpacing,b.style.textAlign=v.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,o))),u=Math.round(t*l),h=Math.round(o*l),d=`
      <svg xmlns="http://www.w3.org/2000/svg" width="${u}" height="${h}" viewBox="0 0 ${t} ${o}">
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let i=this.element.querySelector("#eq-fah-copy-md-btn");i.addEventListener("click",()=>this.copyMarkdownToClipboard(i));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(e){let t=o=>{if(o.target.closest(".eq-fah-btn"))return;o.preventDefault(),this.isDragging=!0,this.dragStartX=o.clientX,this.dragStartY=o.clientY;let i=this.element.getBoundingClientRect();this.initialLeft=i.left,this.initialTop=i.top;let a=s=>{if(!this.isDragging||!this.element)return;let c=s.clientX-this.dragStartX,l=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),h=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+c),u),m=Math.min(Math.max(10,this.initialTop+l),h);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),o=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let i=this.currentPlan,a=i.actions.filter(m=>m.t==="drag"),r=i.actions.filter(m=>{if(m.t!=="val")return!1;let p=S(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),s=i.actions.filter(m=>m.t==="clk"||m.t==="chk"),c=i.actions.filter(m=>m.t==="sel"),l=a.length||r.length||s.length||c.length,u=document.createElement("div");u.className="eq-fah-meta";let h=document.createElement("span");h.textContent=`Modo: ${i.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(i.confidence*100)}% Confian\xE7a`,u.append(h,d),e.appendChild(u),a.length>0||i.mode==="categorizacao"||i.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,o.textContent=String(a.length);let m={};for(let p of a){let f=S(p.to)||"Geral";m[f]||(m[f]=[]),m[f].push(S(p.from))}for(let[p,f]of Object.entries(m)){let A=document.createElement("div"),b=/fato|true|verdadeiro|sim/i.test(p),v=/opini[aã]o|false|falso|n[aã]o/i.test(p);A.className=`eq-fah-group ${b?"group-fato":v?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${p} (${f.length})`,A.appendChild(y);let C=document.createElement("div");C.className="eq-fah-group-items";for(let T of f){let x=document.createElement("div");x.className="eq-fah-item";let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=T,x.appendChild(E);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(T),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),x.appendChild(k),C.appendChild(x)}A.appendChild(C),e.appendChild(A)}}else if(r.length>0){t.textContent=`Preenchimento (${r.length} campos)`,o.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let A=0;A<r.length;A++){let b=r[A],v=document.createElement("div");v.className="eq-fah-item";let y=He(b.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${A+1}`);let C=String(b.v??""),T=document.createElement("div");T.className="eq-fah-field-box";let x=document.createElement("div");x.className="eq-fah-field-label",x.textContent=y,T.appendChild(x);let E=document.createElement("div");E.className="eq-fah-field-val",E.textContent=C,T.appendChild(E),v.appendChild(T);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),v.appendChild(k),f.appendChild(v)}m.appendChild(f),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,o.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let A=0;A<s.length;A++){let b=s[A],v=document.createElement("div");v.className="eq-fah-item";let y=He(b.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&b.v&&(y=String(b.v)),y=S(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let C="",T=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);T?(C=T[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=T[2].trim()||y):s.length>1&&(C=String.fromCharCode(65+A));let x=document.createElement("div");if(x.style.display="flex",x.style.alignItems="center",x.style.gap="8px",x.style.flex="1",C){let w=document.createElement("span");w.className="eq-fah-letter-badge",w.textContent=C,x.appendChild(w)}let E=document.createElement("span");E.className="eq-fah-item-text",E.textContent=y||(C?`Alternativa ${C}`:"Alternativa Selecionada"),x.appendChild(E),v.appendChild(x);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(y||C),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),v.appendChild(k),f.appendChild(v)}m.appendChild(f),e.appendChild(m)}else if(c.length>0){t.textContent=`Sele\xE7\xE3o (${c.length} listas)`,o.textContent=String(c.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let A=0;A<c.length;A++){let b=c[A],v=document.createElement("div");v.className="eq-fah-item";let y=He(b.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${A+1}`);let x=(Array.isArray(b.v)?b.v:[String(b.v??"")]).map(H=>{let q=P(b.id,void 0,!0)||P(S(b.id),void 0,!0),I=q instanceof HTMLSelectElement?q:q?.querySelector("select");if(I){let O=S(H).toLowerCase();for(let N=0;N<I.options.length;N++){let R=I.options[N];if(R.value.toLowerCase()===O||S(R.textContent).toLowerCase()===O){let U=S(R.textContent);if(U&&!U.toLowerCase().includes("selecione"))return U}}}return H}).join(", "),E=document.createElement("div");E.className="eq-fah-field-box";let k=document.createElement("div");k.className="eq-fah-field-label",k.textContent=y,E.appendChild(k);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=x,E.appendChild(w),v.appendChild(E);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(x),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),v.appendChild(M),f.appendChild(v)}m.appendChild(f),e.appendChild(m)}else{t.textContent="Gabarito",o.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(i.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${i.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let o=e.actions.filter(s=>s.t==="drag"),i=e.actions.filter(s=>s.t==="val"),a=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),r=e.actions.filter(s=>s.t==="sel");if(o.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let c of o){let l=S(c.to)||"Geral";s[l]||(s[l]=[]),s[l].push(S(c.from))}for(let[c,l]of Object.entries(s)){t.push(`### Categoria: ${c}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(i.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of i){let c=S(s.id);t.push(`- **${c||"Campo"}:** \`${s.v}\``)}t.push("")}else if(a.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<a.length;s++){let c=a[s],l=He(c.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&c.v&&(l=String(c.v)),l=S(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=a.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(r.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of r){let c=S(s.id)||"Lista",l=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${c}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
              ...
              <div class="eq-view-pane" id="eq-view-debug" style="display:none;flex-direction:column;">
                ...
                <div id="eq-output-toolbar" style="display:none;align-items:center;gap:6px;padding:5px 10px;background:#0a0a0a;border-bottom:1px solid #1a1a1a;flex-shrink:0;">
                  ...
                  <div style="flex:1;display:flex;align-items:center;gap:5px;background:#0d0d0d;border:1px solid #1e1e1e;border-radius:4px;padding:3px 8px;">
                    <span style="color:#333;display:inline-flex;flex-shrink:0;">${L.search||"\u2315"}</span>
                ...
                <div id="eq-term-panel-terminal" style="flex:1;display:flex;flex-direction:column;overflow:hidden;min-height:0;">
                  <div id="eq-term-output" style="flex:1;overflow-y:auto;padding:10px 14px 4px;font-family:'Cascadia Code','Fira Code','Courier New',monospace;font-size:11.5px;line-height:1.6;background:#0d0d0d;color:#e0e0e0;word-break:break-all;user-select:text;-webkit-user-select:text;cursor:text;">
                    ...
                    <div style="color:#333;">\u2502  <span style="color:#888;">EasyQuiz Terminal</span>  <span style="color:#444;">v${be}</span>               \u2502</div>
                    <div style="color:#333;">\u2502  Digite <span style="color:#ccc;font-weight:600;">help</span> para ver os comandos dispon\xEDveis  \u2502</div>
                    <div style="color:#333;">\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518</div>
                  </div>
...
`),requestAnimationFrame(()=>{w.focus(),w.select()});let H=()=>E.remove();["keydown","keyup","keypress","paste","copy","cut"].forEach(q=>{E.addEventListener(q,I=>{I.stopPropagation(),I.stopImmediatePropagation()},!0)}),E.addEventListener("keydown",q=>{q.key==="Escape"&&H()}),E.addEventListener("click",q=>{q.target===E&&H()}),k.querySelector("#eq-edittext-x")?.addEventListener("click",H),k.querySelector("#eq-edittext-cancel")?.addEventListener("click",H),k.querySelector("#eq-edittext-clear")?.addEventListener("click",()=>{confirm("Apagar todas as chaves? Esta a\xE7\xE3o \xE9 irrevers\xEDvel.")&&(w.value="",M.style.color="#fbbf24",M.textContent="Campo limpo. Clique em Salvar para confirmar a remo\xE7\xE3o de todas as chaves.")}),k.querySelector("#eq-edittext-save")?.addEventListener("click",()=>{let q=w.value.split(/[\n\r]+/).map(N=>N.trim().replace(/^["']|["']$/g,"")).filter(N=>N.length>5),I=Array.from(new Set(q));D.init(I);let O=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:O[0]||"",apiKeys:O}),this.renderKeysList(),M.style.color="#4ade80",I.length===0?M.textContent=" Todas as chaves removidas.":M.textContent=` ${I.length} chave(s) salva(s) com sucesso!`,this.setStatus(I.length>0?` ${I.length} chave(s) salva(s)!`:"Todas as chaves foram removidas.",I.length>0?"success":"info"),setTimeout(H,1400)})}),this.shadow.querySelector("#eq-menu-delete-all")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let x=D.getAllKeys();if(x.length===0)return this.setStatus("Nenhuma chave para apagar.","info");confirm(`Apagar todas as ${x.length} chave(s) permanentemente?`)&&(D.init([]),this.callbacks.onSettingsChange({apiKey:"",apiKeys:[]}),this.renderKeysList(),this.setStatus("Todas as chaves foram removidas.","info"))}),this.shadow.querySelector("#eq-menu-test")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;let x=D.getAllKeys();if(x.length===0)return this.setStatus("Nenhuma chave cadastrada para testar.","error");this.setStatus(` Testando ${x.length} chave(s) em paralelo...`,"info");let E=this.modelSelect?.value||"gemini-3.5-flash-lite",k=x.map(M=>M.key),w=await it(E,k);if(w.ok)D.markSuccess(w.key,150),this.setStatus(` Validado! Modelo '${w.model}' respondeu com sucesso!`,"success");else{let M=await Promise.allSettled(k.map(q=>Qe(q))),H=0;M.forEach((q,I)=>{if(q.status==="fulfilled"&&q.value.ok)H++,D.markSuccess(k[I],200);else{let O=q.status==="fulfilled"?q.value.message:String(q.reason);D.markInvalid(k[I],O)}}),this.setStatus(`Teste: ${H}/${x.length} chave(s) v\xE1lidas. ${w.message}`,H>0?"info":"error")}this.renderKeysList()});let y=()=>{this.keyContextMenu.hidden=!0,window.confirm("Deseja realmente resetar todos os dados, chaves e mem\xF3ria de sess\xE3o do EasyQuiz?")&&(this.autopilot.isActive()&&this.autopilot.stop(),this.updateAutopilotUi(!1),this.setBusy(!1),Tt(),ke(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.className="eq-live-stopwatch-status"),this.updateTimingMetrics(),this.apiKeyInput.value="",this.callbacks.onSettingsChange({apiKey:""}),this.setStatus("Todos os dados do EasyQuiz foram limpos.","info"),this.logToConsole("> [SYS] Armazenamento local resetado.","text-yellow"))};this.shadow.querySelector("#eq-menu-reset")?.addEventListener("click",y),this.shadow.querySelector("#eq-reset-all-btn")?.addEventListener("click",y),this.apToggleBtn?.addEventListener("click",()=>{if(this.autopilot.isActive())this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setInterrupted("Autopilot interrompido imediatamente pelo usu\xE1rio.");else{if(!this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"")){this.setStatus("Configure sua chave de API Gemini na aba Configura\xE7\xF5es antes de ligar o Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,st(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Autopilot ativo. Monitorando exerc\xEDcios...","info")}}),this.shadow.querySelector("#eq-ap-clear-memory")?.addEventListener("click",()=>{Be(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")});let T=this.shadow.querySelector("#eq-copy-console-btn");T?.addEventListener("click",()=>{let x=this.apConsole?.innerText||"";navigator.clipboard.writeText(x).then(()=>{let E=T.innerHTML;T.innerHTML=L.check,setTimeout(()=>T.innerHTML=E,1800)})}),this.copyPromptBtn?.addEventListener("click",()=>{let x=this.inspPrompt.textContent||"";navigator.clipboard.writeText(x).then(()=>{if(!this.copyPromptBtn)return;let E=this.copyPromptBtn.innerHTML;this.copyPromptBtn.innerHTML=`${L.check} Copiado!`,setTimeout(()=>this.copyPromptBtn.innerHTML=E,2e3)})}),this.modelSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({model:this.modelSelect.value})),this.modeSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({modeHint:this.modeSelect.value})),this.engineSelect.addEventListener("change",()=>this.callbacks.onSettingsChange({engine:this.engineSelect.value})),this.dryRunCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({dryRun:this.dryRunCheckbox.checked})),this.autoApplyCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoApply:this.autoApplyCheckbox.checked})),this.autoAdvanceCheckbox.addEventListener("change",()=>this.callbacks.onSettingsChange({autoAdvance:this.autoAdvanceCheckbox.checked})),this.useVisionCheckbox.addEventListener("change",()=>{let x=this.useVisionCheckbox.checked;this.callbacks.onSettingsChange({useVision:x}),this.setStatus(x?"Vis\xE3o Computacional ativada (capturas habilitadas).":"Modo DOM R\xE1pido ativado (capturas desabilitadas).","info")}),this.hostDarkModeCheckbox.addEventListener("change",()=>{let x=this.hostDarkModeCheckbox.checked;this.callbacks.onSettingsChange({hostDarkMode:x}),this.applyHostDarkMode(x)}),this.analyzeBtn?.addEventListener("click",async()=>{if(this.analyzeBtn.classList.contains("danger")){this.autopilot.stop(),this.callbacks.onCancel?.(),this.setProgress(0),this.updateAutopilotUi(!1),this.setBusy(!1),this.setInterrupted("Resolver Autopilot interrompido pelo usu\xE1rio.");return}if(!this.apiKeyInput.value.trim().replace(/^['"]|['"]$/g,"")){this.setStatus("Configure sua chave de API Gemini antes de ativar o Resolver Autopilot.","error"),this.switchTab("settings"),this.apiKeyInput.focus();return}this.callbacks.onSettingsChange({autoApply:!0,autoAdvance:!0}),this.autoApplyCheckbox.checked=!0,this.autoAdvanceCheckbox.checked=!0,st(),this.autopilot.start(),this.updateAutopilotUi(!0),this.startStopwatch(),this.setStatus("Resolver Autopilot ativo. Monitorando e respondendo...","info")}),this.applyBtn&&this.applyBtn.addEventListener("click",()=>this.callbacks.onApply())}startStopwatch(){this.stopStopwatch(),this.stopwatchStartTime=Date.now();let e=()=>{let t=((Date.now()-this.stopwatchStartTime)/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)};e(),this.stopwatchInterval=setInterval(e,100)}stopStopwatch(e){if(this.stopwatchInterval&&(clearInterval(this.stopwatchInterval),this.stopwatchInterval=null),e!==void 0){let t=(e/1e3).toFixed(2)+"s";this.stopwatchAp&&(this.stopwatchAp.textContent=t),this.stopwatchAdv&&(this.stopwatchAdv.textContent=t)}}setLogFilter(e){this.activeLogFilter=e;let t=["all","error","ai","dom"];for(let o of t){let i=this.shadow.querySelector(`#eq-dbg-filter-${o}`);o===e?i?.classList.add("active"):i?.classList.remove("active")}this.renderTerminalEntries()}updateLogCounters(){let e=0,t=0,o=0;for(let i of this.logEntries)i.category==="error"?e++:i.category==="ai"?t++:i.category==="dom"&&o++;this.dbgCountAll&&(this.dbgCountAll.textContent=String(this.logEntries.length)),this.dbgCountError&&(this.dbgCountError.textContent=String(e)),this.dbgCountAi&&(this.dbgCountAi.textContent=String(t)),this.dbgCountDom&&(this.dbgCountDom.textContent=String(o))}renderTerminalEntries(){if(!this.liveDebugTerminal)return;this.liveDebugTerminal.replaceChildren();let e=this.activeLogFilter==="all"?this.logEntries:this.logEntries.filter(t=>t.category===this.activeLogFilter);if(this.outputSearchQuery){let t=this.outputSearchQuery.toLowerCase();e=e.filter(o=>o.message.toLowerCase().includes(t))}if(e.length===0){let t=document.createElement("div");t.style.cssText="color:#333;font-style:italic;",t.textContent=this.outputSearchQuery?`Nenhum resultado para "${this.outputSearchQuery}".`:`Nenhum log para o filtro "${this.activeLogFilter.toUpperCase()}".`,this.liveDebugTerminal.appendChild(t);return}for(let t of e){let o=document.createElement("div");o.style.cssText="padding:1px 0;",o.textContent=t.message,t.colorClass&&(o.className=t.colorClass),this.liveDebugTerminal.appendChild(o)}this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}appendTerminalLine(e,t){if(!this.liveTerminalOutput)return;let o=document.createElement("div");o.style.cssText="padding:1px 0;",o.textContent=e;let i=t==="text-red"?"#ff4444":t==="text-blue"?"#aaaaaa":t==="text-green"?"#cccccc":t==="text-yellow"?"#999999":"#e0e0e0";for(o.style.color=i,this.liveTerminalOutput.appendChild(o);this.liveTerminalOutput.children.length>500;)this.liveTerminalOutput.removeChild(this.liveTerminalOutput.firstChild);this.liveTerminalOutput.scrollTop=this.liveTerminalOutput.scrollHeight}executeTerminalCommand(e){let t=e.trim().split(/\s+/),o=t[0].toLowerCase(),i=(c,l="#cccccc")=>{let u=document.createElement("div");u.style.cssText="padding:0;white-space:pre;color:"+l+";",u.textContent=c,this.liveTerminalOutput?.appendChild(u)},a=(c,l)=>i("  "+c.map((u,h)=>u.padEnd(l[h]||0)).join("  "),"#aaaaaa"),r=()=>i("","#000"),s=(c=50)=>i("  "+"\u2500".repeat(c),"#2a2a2a");switch(o){case"help":r(),i("  \u250C\u2500 COMANDOS \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510","#444"),i("  \u2502                                                   \u2502","#444"),i("  \u2502  help        lista todos os comandos             \u2502","#666"),i("  \u2502  status      estado atual do sistema             \u2502","#666"),i("  \u2502  version     vers\xE3o e build info                 \u2502","#666"),i("  \u2502  info-api    info da \xFAltima req. \xE0 API           \u2502","#666"),i("  \u2502  tokens      tokens consumidos (detalhado)       \u2502","#666"),i("  \u2502  context     contexto da quest\xE3o atual           \u2502","#666"),i("  \u2502  controls    controles detectados (tabela)       \u2502","#666"),i("  \u2502  errors      erros registrados                   \u2502","#666"),i("  \u2502  logs [n]    \xFAltimas N entradas do output        \u2502","#666"),i("  \u2502  history     hist\xF3rico de quest\xF5es               \u2502","#666"),i("  \u2502  reset       limpa logs e m\xE9tricas               \u2502","#666"),i("  \u2502  clear       limpa o terminal                    \u2502","#666"),i("  \u2502  copy        copia terminal para clipboard       \u2502","#666"),i("  \u2502                                                   \u2502","#444"),i("  \u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518","#444"),r();break;case"clear":this.liveTerminalOutput&&this.liveTerminalOutput.replaceChildren();return;case"info-api":{let c=this.latestPlan;r(),i("  \u250C\u2500 API INFO \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510","#444");let l=(u,h)=>i("  \u2502  "+u.padEnd(14)+(h||"--").toString().slice(0,36).padEnd(36)+"\u2502","#888");l("Modelo",c?.usedModel||this.initialSettings?.model||"--"),l("Lat\xEAncia",c?.durationMs?c.durationMs+"ms":"--"),l("P.Tokens",String(c?.promptTokens??"--")),l("R.Tokens",String(c?.candidatesTokens??"--")),l("Total",String(c?.tokensUsed??"--")),l("Prompt",this.latestPromptText?.length?this.latestPromptText.length+" chars":"--"),i("  \u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518","#444"),r();break}case"version":r(),i("  EasyQuiz "+(typeof be<"u"?be:"?"),"#ffffff"),i("  Motor: H\xEDbrido 4.0  (RAG + AST + Vision + Multimodal)","#888888"),i("  Build: "+new Date().toLocaleDateString("pt-BR"),"#555555"),r();break;case"status":{let c=this.latestPlan,l=this.latestContext;r(),s(),i("  STATUS DO SISTEMA","#ffffff"),s(),i("  Modelo     "+(c?.usedModel||this.initialSettings?.model||"--"),"#aaaaaa"),i("  Modo       "+(c?.mode||"aguardando"),"#aaaaaa"),i("  Lat\xEAncia   "+(c?.durationMs?c.durationMs+"ms":"--"),"#aaaaaa"),i("  Tokens     "+(c?.tokensUsed??"--"),"#aaaaaa"),i("  Confian\xE7a  "+(c?Math.round(c.confidence*100)+"%":"--"),"#aaaaaa"),i("  Contexto   "+(l?'"'+l.questionText.slice(0,45)+(l.questionText.length>45?"...":"")+'"':"n\xE3o capturado"),"#888888"),i("  Controles  "+(l?l.controls.length:"--"),"#aaaaaa"),s(),r();break}case"tokens":{let c=this.latestPlan;if(r(),!c){i("  Nenhuma requisi\xE7\xE3o ainda.","#555555"),r();break}s(),i("  TOKENS DA \xDALTIMA REQUISI\xC7\xC3O","#ffffff"),s(),i("  Prompt tokens    "+String(c.promptTokens??"--").padStart(8),"#888888"),i("  Response tokens  "+String(c.candidatesTokens??"--").padStart(8),"#888888"),i("  "+"\u2500".repeat(28),"#2a2a2a"),i("  Total            "+String(c.tokensUsed??"--").padStart(8),"#cccccc"),i("  Lat\xEAncia         "+(c.durationMs?c.durationMs+"ms":"--").padStart(8),"#cccccc"),s(),r();break}case"context":{let c=this.latestContext;if(r(),!c){i("  Contexto n\xE3o dispon\xEDvel.","#555555"),r();break}s(),i("  CONTEXTO ATUAL","#ffffff"),s(),i("  Escopo    "+c.scope.tagName.toLowerCase()+(c.scope.id?"#"+c.scope.id:""),"#aaaaaa"),i("  Controles "+c.controls.length,"#aaaaaa"),i("  Texto     "+c.questionText.slice(0,55)+(c.questionText.length>55?"...":""),"#888888"),s(),r();break}case"controls":{let c=this.latestContext;if(r(),!c?.controls.length){i("  Nenhum controle detectado.","#555555"),r();break}s(),i("  CONTROLES  ("+c.controls.length+")","#ffffff"),i("  "+"\u2500".repeat(55),"#2a2a2a"),a(["#","Tipo","Label / ID","Valor"],[3,10,26,10]),i("  "+"\u2500".repeat(55),"#2a2a2a"),c.controls.forEach((l,u)=>a([String(u+1),(l.type||l.tag||"?").toUpperCase().slice(0,9),(l.label||l.id||l.name||"\u2014").slice(0,25),(l.value||"\u2014").slice(0,9)],[3,10,26,10])),s(),r();break}case"errors":{let c=this.logEntries.filter(l=>l.category==="error");if(r(),!c.length){i("  \u2713 Nenhum erro nesta sess\xE3o.","#888888"),r();break}s(),i("  ERROS  ("+c.length+")","#ffffff"),s(),c.slice(-15).forEach(l=>i("  "+l.message,"#999999")),s(),r();break}case"logs":{let c=Math.min(parseInt(t[1]||"10",10)||10,50),l=this.logEntries.slice(-c);if(r(),!l.length){i("  Nenhum log.","#555555"),r();break}s(),i("  \xDALTIMAS "+c+" ENTRADAS","#ffffff"),s(),l.forEach(u=>i("  "+u.message,"#888888")),s(),r();break}case"history":{let c=this.metricsHistory;if(r(),!c?.length){i("  Nenhuma quest\xE3o respondida.","#555555"),r();break}s(),i("  HIST\xD3RICO  ("+c.length+" quest\xF5es)","#ffffff"),i("  "+"\u2500".repeat(58),"#2a2a2a"),a(["#","Quest\xE3o","Tempo","Modelo"],[3,37,7,10]),i("  "+"\u2500".repeat(58),"#2a2a2a"),c.slice(-15).forEach((l,u)=>a([String(u+1),(l.questionTitle||"Quest\xE3o").slice(0,36),l.durationMs?(l.durationMs/1e3).toFixed(1)+"s":"--",(l.model||"--").slice(0,9)],[3,37,7,10])),s(),r();break}case"reset":this.clearLogs(),r(),i("  \u2713 Logs e m\xE9tricas resetados.","#888888"),r();break;case"copy":{let c=Array.from(this.liveTerminalOutput?.children||[]).map(l=>l.textContent||"");navigator.clipboard.writeText(c.join(`
`)).then(()=>{i("  \u2713 Copiado.","#888888"),this.showToast("Terminal copiado","success",2e3)});break}case"":break;default:r(),i('  Comando n\xE3o reconhecido: "'+o+'"',"#666666"),i("  Digite help para ver os comandos.","#444444"),r()}this.liveTerminalOutput&&(this.liveTerminalOutput.scrollTop=this.liveTerminalOutput.scrollHeight)}initTerminalREPL(){if(this.liveTerminalOutput=this.shadow.querySelector("#eq-term-output"),this.terminalInputEl=this.shadow.querySelector("#eq-term-input"),this._terminalInited){this._reconnectContextbarBtns();return}this._terminalInited=!0;let e=this.shadow.querySelector("#eq-term-panel-terminal"),t=this.shadow.querySelector("#eq-term-panel-output"),o=this.shadow.querySelector("#eq-output-toolbar"),i=this.shadow.querySelector("#eq-term-input-line"),a=this.shadow.querySelector("#eq-output-search"),r=this.shadow.querySelector("#eq-output-search-clear"),s=this.shadow.querySelector("#eq-output-filter-btn"),c=this.shadow.querySelector("#eq-output-filter-menu"),l=this.shadow.querySelector("#eq-fchk-apply"),u=h=>{this.terminalMode=h;let d=h==="terminal";e&&(e.style.display=d?"flex":"none"),t&&(t.style.display=d?"none":"flex"),o&&(o.style.display=d?"none":"flex");let m=this.shadow.querySelector("#eq-term-mode-terminal"),p=this.shadow.querySelector("#eq-term-mode-output");m&&(m.style.background=d?"#1a1a1a":"transparent",m.style.borderColor=d?"#333":"transparent",m.style.color=d?"#ddd":"#555"),p&&(p.style.background=d?"transparent":"#1a1a1a",p.style.borderColor=d?"transparent":"#333",p.style.color=d?"#555":"#ddd"),d||this.renderTerminalEntries()};this._reconnectContextbarBtns=()=>{let h=this.shadow.querySelector("#eq-term-mode-terminal"),d=this.shadow.querySelector("#eq-term-mode-output"),m=this.shadow.querySelector("#eq-term-copy-btn"),p=this.shadow.querySelector("#eq-term-clear-btn");h?.addEventListener("click",()=>u("terminal")),d?.addEventListener("click",()=>u("output")),m?.addEventListener("click",()=>{if(this.terminalMode==="terminal"){let f=Array.from(this.liveTerminalOutput?.children||[]).map(A=>A.textContent||"");navigator.clipboard.writeText(f.join(`
`)).then(()=>this.showToast("Terminal copiado","success",2e3))}else navigator.clipboard.writeText(this.getFormattedLogs()).then(()=>this.showToast("Output copiado","success",2e3))}),p?.addEventListener("click",()=>{this.terminalMode==="terminal"?(this.liveTerminalOutput&&this.liveTerminalOutput.replaceChildren(),this.appendTerminalLine("> [SYS] Terminal limpo.","text-blue")):this.clearLogs()})},this._reconnectContextbarBtns(),s?.addEventListener("click",h=>{h.stopPropagation(),c&&(c.hidden=!c.hidden)}),l?.addEventListener("click",()=>{let h=this.shadow.querySelector("#eq-fchk-all")?.checked,d=this.shadow.querySelector("#eq-fchk-error")?.checked,m=this.shadow.querySelector("#eq-fchk-ai")?.checked,p=this.shadow.querySelector("#eq-fchk-dom")?.checked;h||!d&&!m&&!p?this.activeLogFilter="all":d&&!m&&!p?this.activeLogFilter="error":m&&!d&&!p?this.activeLogFilter="ai":p&&!d&&!m?this.activeLogFilter="dom":this.activeLogFilter="all";let f=this.shadow.querySelector("#eq-output-filter-label");f&&(f.textContent="Filtro: "+this.activeLogFilter.toUpperCase()),c&&(c.hidden=!0),this.renderTerminalEntries()}),document.addEventListener("click",()=>{c&&(c.hidden=!0)}),a?.addEventListener("input",()=>{this.outputSearchQuery=a.value,r&&(r.style.display=a.value?"inline":"none"),this.renderTerminalEntries()}),r?.addEventListener("click",()=>{a&&(a.value=""),this.outputSearchQuery="",r&&(r.style.display="none"),this.renderTerminalEntries()}),this.shadow.querySelector("#eq-dbg-scroll-toggle")?.addEventListener("click",h=>{this.autoScrollLogs=!this.autoScrollLogs,h.currentTarget.style.color=this.autoScrollLogs?"#cccccc":"#333"}),i?.addEventListener("click",()=>this.terminalInputEl?.focus()),this.terminalInputEl?.addEventListener("keydown",h=>{if(h.key==="Enter"){let d=this.terminalInputEl.value.trim();if(this.terminalInputEl.value="",this.terminalCmdHistoryIdx=-1,d){this.terminalCmdHistory.unshift(d),this.terminalCmdHistory.length>50&&this.terminalCmdHistory.pop();let m=document.createElement("div");m.style.cssText="padding:1px 0;color:#fff;font-weight:600;",m.textContent="EasyQuiz_Legacy: "+d,this.liveTerminalOutput?.appendChild(m),this.executeTerminalCommand(d)}}else h.key==="ArrowUp"?(h.preventDefault(),this.terminalCmdHistoryIdx=Math.min(this.terminalCmdHistoryIdx+1,this.terminalCmdHistory.length-1),this.terminalCmdHistoryIdx>=0&&(this.terminalInputEl.value=this.terminalCmdHistory[this.terminalCmdHistoryIdx])):h.key==="ArrowDown"&&(h.preventDefault(),this.terminalCmdHistoryIdx=Math.max(this.terminalCmdHistoryIdx-1,-1),this.terminalInputEl.value=this.terminalCmdHistoryIdx>=0?this.terminalCmdHistory[this.terminalCmdHistoryIdx]:"")}),u("terminal"),setTimeout(()=>this.terminalInputEl?.focus(),80)}clearLogs(){if(this.logEntries=[],this.updateLogCounters(),this.liveDebugTerminal){this.liveDebugTerminal.replaceChildren();let e=document.createElement("div");e.className="text-blue",e.textContent="> [SYS] Output limpo.",this.liveDebugTerminal.appendChild(e)}this.apConsole&&this.apConsole.replaceChildren(),this.executionConsole&&this.executionConsole.replaceChildren()}getFormattedLogs(){return(this.activeLogFilter==="all"?this.logEntries:this.logEntries.filter(t=>t.category===this.activeLogFilter)).map(t=>t.message).join(`
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let o=t?`[${t}] ${e}`:e;this.setLastError(o)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,o=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let i=e?.promptTokens!==void 0?String(e.promptTokens):"--",a=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${i} / ${a}`,this.dbgSplitTokens.title=`Prompt: ${i} tokens | Resposta: ${a} tokens`}if(this.dbgTotalTokens){let i=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=i!==void 0?`${i}`:"--"}if(this.dbgPromptLen){let i=o.length,a=Math.round(i/4);this.dbgPromptLen.textContent=`${i}c (~${a}tok)`}this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let o=new Date,i=`${String(o.getHours()).padStart(2,"0")}:${String(o.getMinutes()).padStart(2,"0")}:${String(o.getSeconds()).padStart(2,"0")}.${String(Math.floor(o.getMilliseconds()/100))}`,a=e;e.startsWith(">")?a=`> [${i}] ${e.slice(1).trim()}`:a=`[${i}] ${e}`;let r="all";t==="text-red"||a.includes("[ERRO]")||a.includes("Falha")||a.includes("Error")?r="error":a.includes("[IA]")||a.includes("[RAG]")||a.includes("Tokens")||a.includes("Gemini")||a.includes("Modelo:")?r="ai":(a.includes("[DOM]")||a.includes("[EXEC]")||a.includes("[VERIF]")||a.includes("[NAV]"))&&(r="dom");let s={id:Date.now()+Math.random(),timestamp:i,message:a,colorClass:t,category:r};for(this.logEntries.push(s);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),r==="error"&&this.setLastError(a),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===r)){let c=document.createElement("div");c.style.cssText="padding:1px 0;",c.textContent=a,t&&(c.className=t),this.liveDebugTerminal.appendChild(c)}if(this.liveTerminalOutput&&(r==="dom"||r==="all"||r==="error")){for(this.appendTerminalLine(a,t);this.liveDebugTerminal.children.length>300;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.apConsole.appendChild(c),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let c=document.createElement("div");for(c.textContent=a,t&&(c.className=t),this.executionConsole.appendChild(c),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let o=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${o}%`,this.progressVal&&(this.progressVal.textContent=`${o}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),o>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions)),this.activeTab==="brain"?(this.renderContextTree(),this.refreshBrainCanvas(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&(this.renderContextTree(),this.refreshBrainCanvas()),this.activeTab==="brain"&&(this.brainSelectedFolder==="media-images"||(this.brainActiveTab||"").startsWith("img-"))&&this.refreshBrainCanvas()}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=De(),o=this.latestPlan,i=!!(this.latestPromptText||o?.promptSent),a=!!e,r=!!o;this.contextTreeContainer.innerHTML="";let s=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(s);let c=e?e.controls:[],l=c.map((b,v)=>{let y=b.role==="navigation"||b.type==="button",C=!y&&b.value?` [val: "${b.value}"]`:"";return{label:`[#${v+1}] ${b.type.toUpperCase()}`,value:`${b.label||b.id||b.name||"(Sem r\xF3tulo)"}${C}`.trim(),badge:y?"Navega\xE7\xE3o":b.role||b.type}}),u=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${c.length})`,c.length>0,l);this.contextTreeContainer.appendChild(u);let h=t.map((b,v)=>({label:`Mem\xF3ria #${v+1}`,value:b,badge:"RAG"})),d=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,h);if(this.contextTreeContainer.appendChild(d),o){let b=this.createTreeFolder(` \xDALTIMO PLANO IA (${o.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:o.pageType,badge:`${(o.confidence*100).toFixed(0)}%`},{label:"Modo",value:o.mode},{label:"Racioc\xEDnio",value:o.rationale||"N/A"},...o.actions.map((v,y)=>({label:`A\xE7\xE3o #${y+1} (${v.t})`,value:JSON.stringify(v)}))]);this.contextTreeContainer.appendChild(b)}{let b=document.createElement("div");b.style.cssText="border-bottom:1px solid rgba(255,255,255,0.04);";let v=document.createElement("div");v.style.cssText="display:flex;align-items:center;gap:6px;padding:5px 10px;cursor:pointer;font-size:10px;font-weight:600;color:#fbbf24;letter-spacing:0.04em;user-select:none;",v.innerHTML='<span style="display:inline-flex;width:12px;height:12px;color:#fbbf24;">'+L.inspector+"</span> IA ARTIFACTS";let y=document.createElement("div");y.style.cssText="padding-left:16px;overflow:hidden;";let C=(x,E,k,w)=>{let M=document.createElement("div");return M.style.cssText="display:flex;align-items:center;gap:6px;padding:4px 10px 4px 4px;cursor:pointer;border-radius:4px;transition:background 0.1s;"+(this.brainActiveTab===x?"background:rgba(251,191,36,0.1);":""),M.innerHTML='<span style="font-size:9px;color:'+(w?"#fbbf24":"#444")+';">'+L.code+'</span><span style="font-size:10px;color:'+(w?"#ddd":"#444")+';flex:1;">'+E+'</span><span style="font-size:8px;color:#333;">'+k+"</span>",M.addEventListener("click",()=>{this.brainSelectedFolder=null,this.brainActiveTab=x;let H=this.getBrainFileText(x),q=this.shadow.querySelector("#eq-brain-content");if(q){q.innerHTML="";let I=document.createElement("pre");I.className="eq-brain-code",I.style.cssText='padding:12px;font-size:10.5px;line-height:1.55;white-space:pre-wrap;word-break:break-word;color:#d0d8e8;font-family:"Cascadia Code","Fira Code","Courier New",monospace;',I.textContent=H,q.appendChild(I)}this.renderBrainExplorer(),this.renderBrainTabs()}),M};y.appendChild(C("ai-prompt","prompt.txt",i?"pronto":"aguardando",i)),y.appendChild(C("ai-context","context.json",a?"pronto":"aguardando",a)),y.appendChild(C("ai-response","response.txt",r?"pronto":"aguardando",!!o));let T=!1;v.addEventListener("click",()=>{T=!T,y.style.display=T?"block":"none"}),y.style.display="none",b.appendChild(v),b.appendChild(y),this.contextTreeContainer.appendChild(b)}let m=this.latestImages,p=this.latestImageDescriptions,f=m.map((b,v)=>{let y=p.find(k=>k.index===v),C=(b.captureStatus==="captured"||b.captureStatus==="text_only",""),T=b.captureStatus==="captured"?"Visual":b.captureStatus==="text_only"?"Texto":"Falhou",x=y?y.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",E=y?y.description:b.textContext?b.textContext:"Aguardando an\xE1lise IA...";return{label:`${C} Img ${v+1} [${T}]`,value:`${E}`,badge:x,imgSrc:b.base64?`data:${b.mediaType||"image/jpeg"};base64,${b.base64}`:void 0}}),A=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${m.length})`,!0,f);this.contextTreeContainer.appendChild(A)}createTreeFolder(e,t,o){let i=document.createElement("div");i.className="eq-tree-node";let a=document.createElement("div");a.className="eq-tree-header",a.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let r=document.createElement("div");if(r.className="eq-tree-content",r.style.display=t?"flex":"none",o.length===0)r.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let s of o){let c=document.createElement("div");c.className="eq-tree-leaf";let l="";s.imgSrc&&s.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${s.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),c.innerHTML=`
...
`)}renderBrainExplorer(){let e=this.shadow.querySelector("#eq-brain-explorer");if(!e)return;e.innerHTML="";let t=this.getActiveFolder(),o=document.createElement("div");o.className="eq-tree-file eq-tree-global"+(this.brainActiveTab===this.GLOBAL_ID?" is-selected":""),o.innerHTML=`<span class="eq-tree-ficon" style="color:#60a5fa">${L.folderTree}</span><span class="eq-tree-label">${this.GLOBAL_LABEL}</span>`,o.addEventListener("click",()=>{this.brainSelectedFolder=null,this.openBrainFile(this.GLOBAL_ID,this.GLOBAL_LABEL)}),e.appendChild(o);let i=document.createElement("div");i.className="eq-tree-sep",e.appendChild(i);for(let a of this.getBrainFolders()){let r=this.brainOpenFolders.has(a.id),s=this.brainSelectedFolder===a.id||t===a.id,c=document.createElement("div");c.className="eq-tree-folder"+(s?" is-folder-sel":"");let l=document.createElement("span");l.className="eq-tree-arrow",l.innerHTML=r?L.chevronDown:L.chevronRight,l.addEventListener("click",p=>{p.stopPropagation(),this.brainOpenFolders.has(a.id)?this.brainOpenFolders.delete(a.id):this.brainOpenFolders.add(a.id),this.renderBrainExplorer()}),c.appendChild(l);let u=document.createElement("span");u.className="eq-tree-ficon",u.style.color="#fbbf24",u.innerHTML=L.folder;let h=document.createElement("span");h.className="eq-tree-label",h.textContent=a.label,c.appendChild(u),c.appendChild(h),c.addEventListener("click",()=>{this.brainSelectedFolder=a.id,this.brainActiveTab=null,this.showFolderContent(a),this.renderBrainExplorer(),this.renderBrainTabs()}),e.appendChild(c);let d=document.createElement("div"),m=a.files.length+(a.subfolders?.reduce((p,f)=>p+f.files.length+1,0)??0);d.className="eq-tree-children"+(r?" is-open":""),d.style.setProperty("--child-count",String(m));for(let p of a.files){let f=this.getBrainFileColor(p.icon),A=document.createElement("div");A.className="eq-tree-file"+(this.brainActiveTab===p.id?" is-selected":""),A.innerHTML=`<span class="eq-tree-ficon" style="color:${f}">${L[p.icon]||L.file}</span><span class="eq-tree-label">${p.label}</span>`,A.addEventListener("click",b=>{b.stopPropagation(),this.brainSelectedFolder=null,this.openBrainFile(p.id,p.label)}),d.appendChild(A)}for(let p of a.subfolders||[]){let f=this.brainOpenFolders.has(p.id),A=this.brainSelectedFolder===p.id,b=document.createElement("div");b.className="eq-tree-folder eq-tree-subfolder"+(A?" is-folder-sel":""),b.style.paddingLeft="18px";let v=document.createElement("span");v.className="eq-tree-arrow",v.innerHTML=f?L.chevronDown:L.chevronRight,v.addEventListener("click",E=>{E.stopPropagation(),this.brainOpenFolders.has(p.id)?this.brainOpenFolders.delete(p.id):this.brainOpenFolders.add(p.id),this.renderBrainExplorer()}),b.appendChild(v);let y=document.createElement("span");y.className="eq-tree-ficon",y.style.color="#60a5fa",y.innerHTML=L[p.icon]||L.folder;let C=document.createElement("span");C.className="eq-tree-label",C.textContent=p.label;let T=document.createElement("span");T.style.cssText="font-size:9px;color:#666;margin-left:4px;flex-shrink:0;",T.textContent=String(p.files.length),b.appendChild(y),b.appendChild(C),b.appendChild(T),b.addEventListener("click",()=>{this.brainSelectedFolder=p.id,this.brainActiveTab=null,this.brainOpenFolders.add(p.id),this.showSubfolderContent(p),this.renderBrainExplorer(),this.renderBrainTabs()}),d.appendChild(b);let x=document.createElement("div");x.className="eq-tree-children"+(f?" is-open":""),x.style.setProperty("--child-count",String(p.files.length));for(let E of p.files){let k=this.getBrainFileColor(E.icon),w=document.createElement("div");w.className="eq-tree-file"+(this.brainActiveTab===E.id?" is-selected":""),w.style.paddingLeft="32px",w.innerHTML=`<span class="eq-tree-ficon" style="color:${k}">${L[E.icon]||L.file}</span><span class="eq-tree-label">${E.label}</span>`,w.addEventListener("click",M=>{M.stopPropagation(),this.brainSelectedFolder=null,this.openBrainFile(E.id,E.label)}),x.appendChild(w)}d.appendChild(x)}e.appendChild(d)}}showFolderContent(e){let t=this.shadow.querySelector("#eq-brain-content");if(!t)return;t.innerHTML="";let o=s=>String(s??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),i=document.createElement("div");i.className="eq-folder-view";let a=document.createElement("div");a.className="eq-folder-view-header",a.innerHTML=`<span class="eq-tree-ficon" style="color:#fbbf24">${L.folder}</span><span>${o(e.label)}</span>`,i.appendChild(a);let r=document.createElement("div");r.className="eq-folder-view-files";for(let s of e.files){let c=this.getBrainFileColor(s.icon),l=document.createElement("div");l.className="eq-folder-view-row",l.innerHTML=`<span class="eq-tree-ficon" style="color:${c}">${L[s.icon]||L.file}</span><span>${o(s.label)}</span>`,l.addEventListener("click",()=>this.openBrainFile(s.id,s.label)),r.appendChild(l)}for(let s of e.subfolders||[]){let c=document.createElement("div");c.className="eq-folder-view-row",c.style.cssText="display:flex;align-items:center;gap:6px;padding:7px 10px;cursor:pointer;border-radius:5px;";let l=s.id==="media-images"?this.latestImages.length:s.files.length;c.innerHTML=`<span class="eq-tree-ficon" style="color:#60a5fa">${L[s.icon]||L.folder}</span><span style="flex:1">${o(s.label)}</span><span style="font-size:9px;color:#555;">${l} item${l!==1?"s":""}</span>`,c.addEventListener("mouseenter",()=>{c.style.background="rgba(255,255,255,0.04)"}),c.addEventListener("mouseleave",()=>{c.style.background=""}),c.addEventListener("click",()=>{this.brainSelectedFolder=s.id,this.brainActiveTab=null,this.brainOpenFolders.add(s.id),this.showSubfolderContent(s),this.renderBrainExplorer(),this.renderBrainTabs()}),r.appendChild(c)}i.appendChild(r),t.appendChild(i)}openBrainFile(e,t){if(this.brainOpenTabs.find(o=>o.id===e)||this.brainOpenTabs.push({id:e,label:t}),this.brainActiveTab=e,this.brainCanvasHidden){let o=this.shadow.querySelector(".eq-brain-canvas"),i=this.shadow.querySelector("#eq-brain-canvas-toggle");o?.classList.remove("is-hidden"),i&&(i.innerHTML=L.eye,i.title="Ocultar visualizador"),this.brainCanvasHidden=!1}this.renderBrainExplorer(),this.renderBrainTabs(),this.renderBrainFileContent(e)}showSubfolderContent(e){e.id==="media-images"?this.showMediaGrid():this.showFolderContent(e)}showMediaGrid(){let e=this.shadow.querySelector("#eq-brain-content");if(!e)return;e.innerHTML="";let t=this.latestImages,o=this.latestImageDescriptions,i=document.createElement("div");i.style.cssText="display:flex;flex-direction:column;height:100%;overflow:hidden;";let a=document.createElement("div");a.style.cssText="padding:8px 12px;font-size:10px;color:#666;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;flex-shrink:0;",a.innerHTML=`<span style="color:#60a5fa;font-weight:600;">Imagens</span><span>${t.length} captura${t.length!==1?"s":""}</span>`,i.appendChild(a);let r=document.createElement("div");if(r.style.cssText="flex:1;overflow-y:auto;padding:10px;",t.length===0)r.innerHTML='<div style="text-align:center;padding:32px 0;color:#555;font-size:11px;">Nenhuma imagem capturada.<br><span style="opacity:0.6;font-size:10px;">Ative "Vis\xE3o Computacional" nas configura\xE7\xF5es e execute uma an\xE1lise.</span></div>';else{let s=document.createElement("div");s.style.cssText="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;",t.forEach((c,l)=>{let h=o.find(f=>f.index===l)?.relevant??!0,d=c.base64?`data:${c.mediaType||"image/jpeg"};base64,${c.base64}`:"",m=document.createElement("div");if(m.style.cssText=`position:relative;aspect-ratio:1;border-radius:5px;overflow:hidden;cursor:pointer;background:#111;border:2px solid ${h?"rgba(96,165,250,0.3)":"rgba(255,255,255,0.06)"};transition:border-color 0.15s,transform 0.12s;`,d){let f=document.createElement("img");f.src=d,f.style.cssText="width:100%;height:100%;object-fit:cover;display:block;",m.appendChild(f)}else{let f=document.createElement("div");f.style.cssText="width:100%;height:100%;display:flex;align-items:center;justify-content:center;color:#555;font-size:10px;",f.textContent="Texto",m.appendChild(f)}let p=document.createElement("div");p.style.cssText="position:absolute;bottom:3px;right:3px;background:rgba(0,0,0,0.75);border-radius:3px;padding:1px 4px;font-size:9px;color:#aaa;",p.textContent=String(l+1),m.appendChild(p),m.addEventListener("mouseenter",()=>{m.style.transform="scale(1.03)",m.style.borderColor="#60a5fa"}),m.addEventListener("mouseleave",()=>{m.style.transform="",m.style.borderColor=h?"rgba(96,165,250,0.3)":"rgba(255,255,255,0.06)"}),m.addEventListener("click",()=>{this.brainSelectedFolder=null,this.openBrainFile("img-"+l,"img-"+(l+1)+"."+(c.mediaType?.split("/")?.[1]||"jpg"))}),s.appendChild(m)}),r.appendChild(s)}i.appendChild(r),e.appendChild(i)}showImageFile(e){let t=this.shadow.querySelector("#eq-brain-content");if(!t)return;t.innerHTML="";let o=this.latestImages[e];if(!o){t.innerHTML='<div style="padding:16px;color:#666;font-size:11px;">Imagem n\xE3o encontrada.</div>';return}let i=this.latestImageDescriptions.find(m=>m.index===e),a=o.base64?`data:${o.mediaType||"image/jpeg"};base64,${o.base64}`:"",r=i?.relevant??!0,s=o.captureStatus==="captured"?"Visual":o.captureStatus==="text_only"?"Texto":"Falhou",c=o.captureStatus==="captured"?"#4ade80":o.captureStatus==="text_only"?"#fbbf24":"#ef4444",l=document.createElement("div");l.style.cssText="display:flex;flex-direction:column;height:100%;overflow:hidden;";let u=document.createElement("div");if(u.style.cssText="flex:0 0 auto;background:#0a0a0f;display:flex;align-items:center;justify-content:center;padding:10px;min-height:140px;max-height:55%;cursor:zoom-in;border-bottom:1px solid rgba(255,255,255,0.06);position:relative;overflow:hidden;",a){let m=document.createElement("img");m.src=a,m.alt=o.alt||`Imagem ${e+1}`,m.style.cssText="max-width:100%;max-height:100%;object-fit:contain;border-radius:4px;transform-origin:center center;transition:transform 0.12s ease;user-select:none;",u.appendChild(m);let p=1,f=.5,A=4;u.addEventListener("wheel",y=>{y.preventDefault(),y.stopPropagation();let C=y.deltaY>0?-.15:.15;p=Math.min(A,Math.max(f,p+C)),m.style.transform=p===1?"":`scale(${p.toFixed(2)})`,u.style.cursor=p>1?"grab":"zoom-in";let T=u.querySelector(".eq-zoom-hint");T&&(T.textContent=p!==1?`${Math.round(p*100)}% \xB7 scroll para zoom \xB7 clique para ampliar`:"scroll para zoom \xB7 clique para ampliar")},{passive:!1}),u.addEventListener("click",()=>this.openImageLightbox(e));let b=document.createElement("div");b.className="eq-zoom-hint",b.style.cssText="position:absolute;bottom:6px;right:8px;font-size:9px;color:rgba(255,255,255,0.3);pointer-events:none;",b.textContent="scroll para zoom \xB7 clique para ampliar",u.appendChild(b);let v=this.latestImages.length;if(v>1){let y=C=>{let T=document.createElement("button");return T.style.cssText=`position:absolute;${C==="prev"?"left:6px":"right:6px"};top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.55);border:1px solid rgba(255,255,255,0.12);color:#ccc;width:24px;height:24px;border-radius:50%;cursor:pointer;font-size:13px;z-index:5;display:flex;align-items:center;justify-content:center;transition:background 0.12s;`,T.innerHTML=C==="prev"?"\u2039":"\u203A",T.title=C==="prev"?"Imagem anterior":"Pr\xF3xima imagem",T.style.display=C==="prev"&&e===0||C==="next"&&e===v-1?"none":"flex",T.addEventListener("mouseenter",()=>{T.style.background="rgba(96,165,250,0.3)"}),T.addEventListener("mouseleave",()=>{T.style.background="rgba(0,0,0,0.55)"}),T.addEventListener("click",x=>{x.stopPropagation();let E=C==="prev"?e-1:e+1;if(E>=0&&E<v){this.brainActiveTab="img-"+E;let k=this.latestImages[E],w="img-"+(E+1)+"."+(k?.mediaType?.split("/")?.[1]||"jpg");this.brainOpenTabs.find(M=>M.id==="img-"+E)||this.brainOpenTabs.push({id:"img-"+E,label:w}),this.renderBrainExplorer(),this.renderBrainTabs(),this.showImageFile(E)}}),T};u.appendChild(y("prev")),u.appendChild(y("next"))}}else u.style.cssText+="color:#555;font-size:11px;",u.textContent="Sem dados visuais \u2014 captura em modo texto";l.appendChild(u);let h=document.createElement("div");h.style.cssText="flex:1;overflow-y:auto;padding:10px 12px;display:flex;flex-direction:column;gap:7px;";let d=(m,p,f="#aaa")=>{let A=document.createElement("div");return A.style.cssText="display:flex;gap:8px;font-size:10.5px;",A.innerHTML=`<span style="color:#555;min-width:72px;flex-shrink:0;">${m}</span><span style="color:${f};word-break:break-word;">${p}</span>`,A};if(h.appendChild(d("\xCDndice",`Imagem ${e+1} de ${this.latestImages.length}`)),h.appendChild(d("Status",s,c)),h.appendChild(d("Relev\xE2ncia",r?"Relevante":"Ignorada",r?"#60a5fa":"#666")),h.appendChild(d("Tipo",o.mediaType||"--")),o.alt&&h.appendChild(d("Alt text",o.alt)),o.source&&h.appendChild(d("Fonte",o.source)),o.associatedLabel&&h.appendChild(d("R\xF3tulo",o.associatedLabel)),i?.description){let m=document.createElement("div");m.style.cssText="background:rgba(96,165,250,0.06);border:1px solid rgba(96,165,250,0.15);border-radius:5px;padding:8px;",m.innerHTML=`<div style="font-size:9px;color:#60a5fa;font-weight:600;margin-bottom:4px;">AN\xC1LISE DA IA</div><div style="font-size:10.5px;color:#ccc;line-height:1.55;">${i.description}</div>`,h.appendChild(m)}if(o.textContext){let m=document.createElement("div");m.style.cssText="background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.12);border-radius:5px;padding:8px;",m.innerHTML=`<div style="font-size:9px;color:#fbbf24;font-weight:600;margin-bottom:4px;">CONTEXTO TEXTUAL</div><div style="font-size:10.5px;color:#ccc;line-height:1.55;">${o.textContext}</div>`,h.appendChild(m)}l.appendChild(h),t.appendChild(l)}openImageLightbox(e){let t=this.latestImages[e];if(!t)return;let o=this.latestImageDescriptions.find(v=>v.index===e),i=t.base64?`data:${t.mediaType||"image/jpeg"};base64,${t.base64}`:"";this.shadow.querySelector("#eq-img-lightbox")?.remove();let a=document.createElement("div");a.id="eq-img-lightbox",a.style.cssText="position:fixed;inset:0;z-index:2147483647;background:rgba(0,0,0,0.92);display:flex;align-items:center;justify-content:center;padding:20px;box-sizing:border-box;";let r=document.createElement("div");r.style.cssText="display:flex;width:min(90vw,1100px);max-height:90vh;border-radius:10px;background:#0f0f17;border:1px solid rgba(255,255,255,0.1);box-shadow:0 24px 64px rgba(0,0,0,0.8);position:relative;overflow:hidden;";let s=document.createElement("button");s.style.cssText="position:absolute;top:10px;right:10px;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.15);color:#ddd;width:30px;height:30px;border-radius:50%;cursor:pointer;font-size:18px;z-index:10;display:flex;align-items:center;justify-content:center;line-height:1;",s.textContent="\xD7",s.title="Fechar (ESC)";let c=document.createElement("div");if(c.style.cssText="flex:0 0 65%;display:flex;align-items:center;justify-content:center;background:#050508;padding:16px;min-width:0;overflow:hidden;position:relative;",i){let v=document.createElement("img");v.src=i,v.style.cssText="max-width:100%;max-height:82vh;object-fit:contain;border-radius:4px;transform-origin:center center;transition:transform 0.1s ease;user-select:none;display:block;";let y=1,C=.3,T=6;c.addEventListener("wheel",E=>{E.preventDefault(),E.stopPropagation();let k=E.deltaY<0?.18:-.18;y=Math.min(T,Math.max(C,y+k)),v.style.transform=`scale(${y.toFixed(3)})`,v.style.cursor=y>1?"grab":"default",x.textContent=`${Math.round(y*100)}%`,x.style.opacity="1",clearTimeout(c._zt),c._zt=setTimeout(()=>{x.style.opacity="0"},1200)},{passive:!1}),v.addEventListener("dblclick",()=>{y=1,v.style.transform="",v.style.cursor="default",x.textContent="100%",x.style.opacity="1",setTimeout(()=>{x.style.opacity="0"},800)});let x=document.createElement("div");x.style.cssText="position:absolute;bottom:10px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.7);color:#aaa;font-size:10px;padding:2px 8px;border-radius:10px;pointer-events:none;opacity:0;transition:opacity 0.3s;",x.textContent="100%",c.appendChild(v),c.appendChild(x)}else c.innerHTML='<div style="color:#555;font-size:12px;text-align:center;width:100%;">Sem dados visuais</div>';r.appendChild(c);let l=document.createElement("div");l.style.cssText="flex:0 0 35%;overflow-y:auto;padding:20px 16px 20px;border-left:1px solid rgba(255,255,255,0.06);display:flex;flex-direction:column;gap:8px;min-width:0;";let u=document.createElement("div");u.style.cssText="font-size:13px;font-weight:700;color:#e0e0e0;margin-bottom:6px;",u.textContent=`Imagem ${e+1} de ${this.latestImages.length}`,l.appendChild(u);let h=t.captureStatus==="captured"?"#4ade80":t.captureStatus==="text_only"?"#fbbf24":"#ef4444",d=t.captureStatus==="captured"?"Visual":t.captureStatus==="text_only"?"Texto":"Falhou",m=(v,y,C="#aaa")=>{let T=document.createElement("div");return T.style.cssText="display:flex;gap:6px;font-size:10px;",T.innerHTML=`<span style="color:#555;min-width:64px;flex-shrink:0;">${v}</span><span style="color:${C};word-break:break-word;">${y}</span>`,T};l.appendChild(m("Status",d,h)),l.appendChild(m("Relev\xE2ncia",o?.relevant??!0?"Relevante":"Ignorada",o?.relevant??!0?"#60a5fa":"#666")),l.appendChild(m("Tipo",t.mediaType||"--")),t.alt&&l.appendChild(m("Alt",t.alt)),t.source&&l.appendChild(m("Fonte",t.source)),t.associatedLabel&&l.appendChild(m("R\xF3tulo",t.associatedLabel));let p=document.createElement("div");if(p.style.cssText="font-size:9px;color:#444;margin-top:4px;",p.textContent="Scroll na imagem para zoom \xB7 Duplo-clique para resetar",l.appendChild(p),o?.description){let v=document.createElement("div");v.style.cssText="background:rgba(96,165,250,0.07);border:1px solid rgba(96,165,250,0.18);border-radius:5px;padding:8px;margin-top:4px;",v.innerHTML=`<div style="font-size:9px;color:#60a5fa;font-weight:700;margin-bottom:5px;">AN\xC1LISE DA IA</div><div style="font-size:10px;color:#ccc;line-height:1.6;">${o.description}</div>`,l.appendChild(v)}if(t.textContext){let v=document.createElement("div");v.style.cssText="background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.12);border-radius:5px;padding:8px;",v.innerHTML=`<div style="font-size:9px;color:#fbbf24;font-weight:700;margin-bottom:5px;">CONTEXTO TEXTUAL</div><div style="font-size:10px;color:#ccc;line-height:1.6;">${t.textContext}</div>`,l.appendChild(v)}r.appendChild(l),a.appendChild(s),a.appendChild(r),this.shadow.appendChild(a);let f=()=>a.remove();s.addEventListener("click",v=>{v.stopPropagation(),f()}),r.addEventListener("click",v=>v.stopPropagation()),a.addEventListener("click",()=>f());let A=this.latestImages.length;if(A>1){let v=y=>{let C=document.createElement("button");return C.style.cssText=`position:absolute;${y==="prev"?"left:12px":"right:12px"};top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.6);border:1px solid rgba(255,255,255,0.15);color:#ddd;width:36px;height:36px;border-radius:50%;cursor:pointer;font-size:22px;z-index:10;display:${y==="prev"&&e===0||y==="next"&&e===A-1?"none":"flex"};align-items:center;justify-content:center;`,C.innerHTML=y==="prev"?"\u2039":"\u203A",C.title=y==="prev"?"Anterior":"Pr\xF3xima",C.addEventListener("mouseenter",()=>{C.style.background="rgba(96,165,250,0.35)"}),C.addEventListener("mouseleave",()=>{C.style.background="rgba(0,0,0,0.6)"}),C.addEventListener("click",T=>{T.stopPropagation();let x=y==="prev"?e-1:e+1;x>=0&&x<A&&(a.remove(),this.openImageLightbox(x))}),C};a.appendChild(v("prev")),a.appendChild(v("next"))}let b=v=>{v.key==="Escape"&&(f(),window.removeEventListener("keydown",b))};window.addEventListener("keydown",b)}closeBrainTab(e){let t=this.brainOpenTabs.findIndex(o=>o.id===e);t!==-1&&(this.brainOpenTabs.splice(t,1),this.brainActiveTab===e&&(this.brainActiveTab=this.brainOpenTabs[t-1]?.id||this.brainOpenTabs[0]?.id||null),this.renderBrainExplorer(),this.renderBrainTabs(),this.refreshBrainCanvas())}refreshBrainCanvas(){if(this.brainActiveTab)this.renderBrainFileContent(this.brainActiveTab);else if(this.brainSelectedFolder){if(this.brainSelectedFolder==="media-images"){this.showMediaGrid();return}for(let t of this.getBrainFolders()){let o=(t.subfolders||[]).find(i=>i.id===this.brainSelectedFolder);if(o){this.showSubfolderContent(o);return}}let e=this.getBrainFolders().find(t=>t.id===this.brainSelectedFolder);if(e)this.showFolderContent(e);else{let t=this.shadow.querySelector("#eq-brain-content");t&&(t.innerHTML='<div class="eq-brain-empty-canvas"><div style="margin-bottom:4px;opacity:0.5">Nada selecionado</div><div class="eq-brain-empty-sub">Selecione um arquivo no explorador abaixo para visualiz\xE1-lo</div></div>')}}else{let e=this.shadow.querySelector("#eq-brain-content");e&&(e.innerHTML='<div class="eq-brain-empty-canvas"><div style="margin-bottom:4px;opacity:0.5">Nada selecionado</div><div class="eq-brain-empty-sub">Selecione um arquivo no explorador abaixo para visualiz\xE1-lo</div></div>')}}renderBrainTabs(){let e=this.shadow.querySelector("#eq-brain-tabbar");if(e){e.innerHTML="";for(let t of this.brainOpenTabs){let o=document.createElement("div");o.className="eq-brain-tab"+(this.brainActiveTab===t.id?" is-active":""),o.innerHTML=`<span class="eq-brain-tab-icon">${t.id===this.GLOBAL_ID?L.folderTree:L.file}</span><span class="eq-brain-tab-label">${t.label}</span><button class="eq-brain-tab-close" data-tab-id="${t.id}" type="button">${L.close}</button>`,o.addEventListener("click",i=>{let a=i.target.closest(".eq-brain-tab-close");a?this.closeBrainTab(a.dataset.tabId):(this.brainActiveTab=t.id,this.brainSelectedFolder=null,this.renderBrainExplorer(),this.renderBrainTabs(),this.renderBrainFileContent(t.id))}),e.appendChild(o)}}}renderBrainFileContent(e){let t=this.shadow.querySelector("#eq-brain-content");if(!t)return;if(e.startsWith("img-")){this.showImageFile(parseInt(e.slice(4),10));return}let o=this.getBrainFileText(e),i=h=>String(h??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),a=e===this.GLOBAL_ID,r=e==="rationale"||a,c=a||r?"markdown":e==="actions"||e==="exec-result"?"json":"text";t.innerHTML="";let l=document.createElement("div");l.className="eq-brain-file-view";let u=document.createElement("div");if(u.className="eq-brain-file-header",u.innerHTML=`<span class="eq-brain-file-lang">${i(c)}</span>`,l.appendChild(u),r){let h=document.createElement("div");h.className="eq-brain-markdown";try{h.innerHTML=this.renderMarkdown(o||"(sem conte\xFAdo)")}catch{h.textContent=o||"(sem conte\xFAdo)"}l.appendChild(h)}else{let h=document.createElement("pre");h.className="eq-brain-code";let d=document.createElement("code");d.textContent=o||"(sem conte\xFAdo)",h.appendChild(d),l.appendChild(h)}t.appendChild(l)}showFloatingAnswers(e){let t=e||this.latestPlan;t&&this.floatingAnswers.show(t)}hideFloatingAnswers(){this.floatingAnswers.hide()}renderKeysList(){if(!this.keysListEl)return;let e=D.getAllKeys();if(this.keysBadgeEl){let i=e.filter(s=>!s.isCooldown).length,a=e.reduce((s,c)=>s+(c.winCount||0),0),r=i>=3?"  TURBO":"";this.keysBadgeEl.textContent=`${e.length} chave${e.length>1?"s":""} (${i} pronta${i!==1?"s":""})${r}`,this.keysBadgeEl.className=`eq-key-badge ${i>=3?"racing":i>0?"ready":"cooldown"}`}this.keysListEl.replaceChildren();let t=this.shadow?.querySelector("#eq-keys-collapsible");t&&t.style.display!=="none"&&(t.style.maxHeight="none",t.style.overflow="visible"),[...e].sort((i,a)=>{let r=i.winCount||0,s=a.winCount||0;if(r!==s)return s-r;let c=i.lastLatencyMs||99999,l=a.lastLatencyMs||99999;if(c!==l)return c-l;let u=i.isCooldown?1:0,h=a.isCooldown?1:0;return u-h}).forEach((i,a)=>{let r=e.findIndex(v=>v.id===i.id),s=r>=0?r:a,c=document.createElement("div");c.className="eq-key-item";let l=document.createElement("div");l.className="eq-key-info";let u=document.createElement("span");u.className="eq-key-label",u.textContent=i.label||`Chave ${s+1}`;let h=document.createElement("span");h.className="eq-key-masked",h.textContent=te.maskKey(i.key),h.title="Clique para copiar a chave",h.style.cursor="pointer",h.addEventListener("click",()=>{navigator.clipboard?.writeText(i.key),this.setStatus(`Chave ${s+1} copiada para a \xE1rea de transfer\xEAncia!`,"info")});let d=document.createElement("span");if(i.isCooldown){d.className="eq-key-badge cooldown";let v=Math.ceil(i.remainingCooldownMs/1e3);d.textContent=`\u23F1 Cooldown (${v}s)`}else i.lastError&&i.errorCount&&i.errorCount>3?(d.className="eq-key-badge invalid",d.textContent="Erro",d.title=i.lastError):i.lastLatencyMs?(d.className="eq-key-badge ready",d.textContent=`Pronta (${i.lastLatencyMs}ms)`):(d.className="eq-key-badge ready",d.textContent="Pronta");l.appendChild(u),l.appendChild(h),l.appendChild(d);let m=i.winCount||0;if(m>0){let v=document.createElement("span");v.className="eq-key-badge winner",v.textContent=` ${m} vit\xF3ria${m>1?"s":""}`,v.title=`Esta chave foi a mais r\xE1pida ${m} vez${m>1?"es":""} nas corridas paralelas`,l.appendChild(v)}let p=document.createElement("div");p.className="eq-key-actions";let f=document.createElement("button");f.className="eq-icon-btn",f.type="button",f.title="Testar esta chave",f.innerHTML=L.sparkles,f.addEventListener("click",async()=>{this.setStatus(`Testando chave ${i.label||s+1}...`,"info");let v=await Qe(i.key);v.ok?(D.markSuccess(i.key,120),this.setStatus(` ${i.label||`Chave ${s+1}`}: Conex\xE3o com Google Gemini aprovada!`,"success")):(D.markInvalid(i.key,v.message),this.setStatus(`\uFE0F ${i.label||`Chave ${s+1}`}: ${v.message}`,"error")),this.renderKeysList()});let A=document.createElement("button");A.className="eq-icon-btn",A.type="button",A.title="Editar chave",A.innerHTML=L.edit,A.addEventListener("click",()=>{let v=window.prompt(`Editar ${i.label||`Chave ${s+1}`}:`,i.key);if(v!==null&&v.trim()){let y=D.updateKey(i.id,v.trim());if(y.ok){let C=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:C[0],apiKeys:C}),this.setStatus(`Chave ${s+1} atualizada com sucesso!`,"success"),this.renderKeysList()}else this.setStatus(y.message,"warning")}});let b=document.createElement("button");b.className="eq-icon-btn",b.type="button",b.title="Remover chave",b.innerHTML=L.trash,b.addEventListener("click",()=>{if(confirm(`Remover permanentemente a ${i.label||`Chave ${s+1}`}?`)){let v=D.removeKey(i.id);if(v.ok){let y=D.exportRawKeys();this.callbacks.onSettingsChange({apiKey:y[0]||"",apiKeys:y}),this.setStatus("Chave removida com sucesso.","info"),this.renderKeysList()}else this.setStatus(v.message,"warning")}}),p.appendChild(f),p.appendChild(A),p.appendChild(b),c.appendChild(l),c.appendChild(p),this.keysListEl.appendChild(c)})}updateModelSelect(e,t){let o=e.filter(r=>Y(r.id)),i=t&&Y(t)?t:Y(this.initialSettings.model)?this.initialSettings.model:"gemini-2.5-flash";this.modelSelect.innerHTML="";let a=!1;o.forEach(r=>{let s=r.id===i;s&&(a=!0),this.modelSelect.add(new Option(r.name,r.id,!1,s))}),!a&&i&&Y(i)&&this.modelSelect.add(new Option(`Gemini (${i})`,i,!1,!0)),this.modelSelect.value=i}updateSelectedModel(e){if(!Y(e))return;Array.from(this.modelSelect.options).some(o=>o.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}mountHost(){let e=document.body||document.documentElement;if(!e){let t=()=>{let o=document.body||document.documentElement;o&&!this.host.isConnected&&o.appendChild(this.host)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t,{once:!0}):setTimeout(t,0);return}this.host.isConnected||e.appendChild(this.host)}applyHostDarkMode(e){document.getElementById("eq-host-dark-mode-style")?.remove(),this.host.classList.toggle("eq-dark-mode-active",e)}startQuestionTimer(){this.currentQuestionStartTime=Date.now(),this.questionLiveTimerInterval&&clearInterval(this.questionLiveTimerInterval),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Calculando...",this.metricsLiveStatus.classList.add("active"));let e=()=>{if(!this.metricsLiveTime)return;let t=Date.now()-this.currentQuestionStartTime,o=Math.floor(t/6e4),i=Math.floor(t%6e4/1e3),a=Math.floor(t%1e3/10);this.metricsLiveTime.textContent=`${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}.${String(a).padStart(2,"0")}`};e(),this.questionLiveTimerInterval=setInterval(e,50)}stopQuestionTimer(e){if(this.questionLiveTimerInterval&&(clearInterval(this.questionLiveTimerInterval),this.questionLiveTimerInterval=null),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Parado",this.metricsLiveStatus.classList.remove("active")),this.metricsLiveTime&&this.currentQuestionStartTime>0){let t=e!==void 0?e:Math.max(0,Date.now()-this.currentQuestionStartTime),o=Math.floor(t/6e4),i=Math.floor(t%6e4/1e3),a=Math.floor(t%1e3/10);this.metricsLiveTime.textContent=`${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}.${String(a).padStart(2,"0")}`}}updateTimingMetrics(e){let t=e||qe();if(!this.metricTotalTime)return;let o=Math.floor(t.totalElapsedMs/1e3),i=Math.floor(o/60),a=o%60;this.metricTotalTime.textContent=`${String(i).padStart(2,"0")}:${String(a).padStart(2,"0")}`;let r=(t.averageDurationMs/1e3).toFixed(1);this.metricAvgTime.textContent=`${r}s`,this.metricTotalCount.textContent=String(t.completedQuestionsCount),this.metricsTotalBadge&&(this.metricsTotalBadge.textContent=`${t.completedQuestionsCount} Quest\xE3o(\xF5es)`),this.metricsHistoryCount&&(this.metricsHistoryCount.textContent=`${t.records.length} registros`),this.renderMetricsHistory(t.records)}renderMetricsHistory(e){if(!this.metricsHistoryList)return;if(e.length===0){this.metricsHistoryList.innerHTML='<div style="text-align:center;padding:24px 0;color:#444;font-size:11px;">Nenhuma quest\xE3o respondida ainda.</div>';return}this.metricsHistoryList.innerHTML="";let t=[...e].reverse(),o=Math.max(...e.map(i=>i.durationMs),1);for(let i of t){let a=i.durationMs/1e3,r=Math.round(i.durationMs/o*100),s=i.status==="verified"||i.status==="answered",c=i.status==="manual",l=s?"#4ade80":c?"#fbbf24":"#666",u=s?"Injetado":c?"Gabarito":"Pendente",h=new Date(i.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}),d=i.mode?i.mode.replace(/_/g," "):"auto",m=a<5?"#4ade80":a<15?"#fbbf24":"#ef4444",p=document.createElement("div");p.style.cssText="background:rgba(255,255,255,0.025);border:1px solid rgba(255,255,255,0.055);border-radius:7px;padding:9px 10px;margin-bottom:5px;cursor:default;transition:background 0.1s;",p.addEventListener("mouseenter",()=>{p.style.background="rgba(255,255,255,0.045)"}),p.addEventListener("mouseleave",()=>{p.style.background="rgba(255,255,255,0.025)"});let f=document.createElement("div");f.style.cssText="display:flex;align-items:flex-start;gap:8px;margin-bottom:6px;";let A=document.createElement("div");A.style.cssText="flex-shrink:0;width:22px;height:22px;border-radius:5px;background:rgba(0,152,255,0.15);border:1px solid rgba(0,152,255,0.25);display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:800;color:#0098ff;",A.textContent=String(i.questionIndex);let b=document.createElement("div");b.style.cssText="flex:1;font-size:10.5px;color:#ccc;font-weight:600;line-height:1.4;word-break:break-word;",b.textContent=i.questionTitle||"Quest\xE3o "+i.questionIndex;let v=document.createElement("div");v.style.cssText="flex-shrink:0;font-size:13px;font-weight:800;color:"+m+";font-family:monospace;font-variant-numeric:tabular-nums;",v.textContent=a<60?a.toFixed(1)+"s":Math.floor(a/60)+"m"+String(Math.round(a%60)).padStart(2,"0")+"s",f.appendChild(A),f.appendChild(b),f.appendChild(v);let y=document.createElement("div");y.style.cssText="height:2px;background:rgba(255,255,255,0.05);border-radius:1px;margin-bottom:6px;overflow:hidden;";let C=document.createElement("div");C.style.cssText="height:100%;width:"+r+"%;background:"+m+";border-radius:1px;transition:width 0.4s ease;",y.appendChild(C);let T=document.createElement("div");T.style.cssText="display:flex;align-items:center;gap:6px;flex-wrap:wrap;";let x=(q,I,O)=>{let N=document.createElement("span");return N.style.cssText="font-size:8.5px;font-weight:700;letter-spacing:0.04em;padding:1px 6px;border-radius:8px;background:rgba("+O+",0.12);color:"+I+";",N.textContent=q,N};T.appendChild(x(u,l,s?"74,222,128":c?"251,191,36":"102,102,102")),T.appendChild(x(d,"#888","255,255,255")),i.actionsCount&&T.appendChild(x(i.actionsCount+" a\xE7\xE3o"+(i.actionsCount>1?"\xF5es":""),"#888","255,255,255"));let E=document.createElement("span");E.style.cssText="font-size:8.5px;color:#444;margin-left:auto;",E.textContent=h,T.appendChild(E);let k=document.createElement("span");k.style.cssText="flex-shrink:0;display:inline-flex;color:#444;transition:transform 0.2s ease;margin-left:4px;",k.innerHTML='<svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M7 10l5 5 5-5z"/></svg>',f.appendChild(k);let w=document.createElement("div");w.style.cssText="overflow:hidden;max-height:0;transition:max-height 0.22s ease;",w.appendChild(y),w.appendChild(T);let M=!1,H=()=>{M=!M,M?(this.metricsHistoryList?.querySelectorAll(".eq-mhist-body").forEach(q=>{if(q!==w){q.style.maxHeight="0";let I=q.parentElement?.querySelector(".eq-mhist-chevron");I&&(I.style.transform="")}}),w.style.maxHeight=w.scrollHeight+40+"px",k.style.transform="rotate(180deg)"):(w.style.maxHeight="0",k.style.transform="")};w.className="eq-mhist-body",k.className="eq-mhist-chevron",f.style.cursor="pointer",f.addEventListener("click",H),p.appendChild(f),p.appendChild(w),this.metricsHistoryList.appendChild(p)}}copyMetricsReport(){let e=qe(),t=[];t.push("# Relat\xF3rio de Desempenho e Tempo \u2014 EasyQuiz"),t.push(`- **Quest\xF5es Respondidas:** ${e.completedQuestionsCount}`),t.push(`- **Tempo Total:** ${(e.totalElapsedMs/1e3).toFixed(1)}s`),t.push(`- **Tempo M\xE9dio por Quest\xE3o:** ${(e.averageDurationMs/1e3).toFixed(2)}s`),t.push(""),t.push("### Hist\xF3rico:"),e.records.length===0?t.push("_Nenhum registro ainda._"):e.records.forEach((o,i)=>{t.push(`${i+1}. **${o.questionTitle||`Q${o.questionIndex}`}**: ${(o.durationMs/1e3).toFixed(2)}s (${o.status})`)}),navigator.clipboard.writeText(t.join(`
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Dn(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Bn(){let n=window;if(ke(),Dn(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=_e(),t=null,o=null,i=0,a=new Ze(e,{onAnalyze:(l=1,u,h=!1)=>r(l,u,h),onApply:(l=1)=>void s(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}fe(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}fe(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=qt(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,h=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,m=()=>{try{d.abort()}catch{}};if(u&&(u.aborted?d.abort():u.addEventListener("abort",m,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}i=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),fe(),a.hideFloatingAnswers();try{let p=pe(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=ce()),Pe(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${e.model})...`);let f=await wt(p.scope,e.useVision);if(f.length>0){let T=f.map(x=>x.element).filter(Boolean);At(T),a.updateImages(f)}if(d.signal.aborted)return;let A=e.model;a.setStatus(f.length>0?`Consultando Gemini (${A}) com ${f.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${A}) via DOM nativo (modo r\xE1pido)...`,"info");let b=Le(p,f,e);a.setInspectorPrompt(b,e.model);let v=(T,x)=>{a.setStatus(T,x==="warning"?"info":x);let E=T.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(E){let k=E[1].split(",")[0].trim();a.setProgress(50,`Gemini ${k} respondendo...`)}},{plan:y,usedModel:C}=await je(p,f,e,v,d.signal);if(d.signal.aborted)return;if(y.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=pe(!0),p||(p=ce()),Pe(p.scope),a.updateContext(p),f=await wt(p.scope,e.useVision),f.length>0){let E=f.map(k=>k.element).filter(Boolean);At(E),a.updateImages(f)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let T=Le(p,f,e);a.setInspectorPrompt(T,e.model),y=(await je(p,f,e,v,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${C||e.model} | Modo: ${y.mode} | Confian\xE7a: ${(y.confidence*100).toFixed(0)}%`,"text-green"),y.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${y.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${y.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),y.memoryToStore&&(kt(y.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${y.memoryToStore}"`,"text-yellow")),y.imageDescriptions&&y.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${y.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let T of y.imageDescriptions){let x=T.relevant?"":"\uFE0F";a.logToConsole(`>   ${x} Imagem ${T.index+1} [${T.relevant?"RELEVANTE":"IGNORADA"}]: ${T.description}`,T.relevant?"text-blue":"text-yellow")}}return t=y,a.updateContext(p,y),Jt(y.actions,y.confidence),a.setPlan(y,!e.dryRun),y.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):y.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):y.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&y.pageType==="question"&&a.showFloatingAnswers(y),d.signal.aborted?void 0:((h||e.autoApply)&&!e.dryRun&&await s(l,d.signal,h),y)}catch(p){if(d.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){fe(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}fe(),a.setProgress(0);let f=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(f,"error"),a.setErrorDiagnostic(f,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function s(l=1,u,h=!1){if(u?.aborted)return;if(!t){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(A=>A.t!=="adv"),p=t.pageType==="question"||Ue(t.rationale||"");if(p&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let f=(h||e.autoAdvance||d)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let A=await ze(t,f,l,ye(e));if(u?.aborted)return;if(a.setExecutionReport(A),A.failedActions&&A.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${A.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let T of A.failedActions){let x=T.action,E=x.t==="drag"?`drag: "${x.from}" \u2192 "${x.to}"`:x.t==="clk"||x.t==="chk"?`${x.t}: "${x.id}"`:x.t==="val"?`val: "${x.id}" = "${x.v}"`:JSON.stringify(x).slice(0,80);a.logToConsole(`>    [${x.t.toUpperCase()}] ${E} | ${T.evidence.slice(0,80)}`,"text-yellow")}await c(A.failedActions,u)}let b=i>0?Date.now()-i:1200,v=A.verified>0,y=A.applied>0;if(A.success||v&&y){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${A.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${A.verified} verificada(s) no DOM.`,"text-green"),A.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):f&&a.logToConsole(`> [NAV] ${A.navigationEvidence}`,"text-blue"),a.setStatus(A.advanced?`Sucesso: ${A.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${A.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let T=St({id:`q-${Date.now()}`,questionIndex:(qe().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:b,status:"answered",mode:t.mode,actionsCount:A.applied});a.updateTimingMetrics(T)}else y?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${A.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${A.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${A.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${A.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&a.showFloatingAnswers(t))}catch(A){a.setProgress(0);let b=A instanceof Error?A.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${b}`,"error"),a.logToConsole(`> [ERRO] ${b}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,u){if(!t)return;let h=l.filter(m=>m.action.t==="drag");for(let m of h){if(u?.aborted)return;let p=m.action,f=String(p.from||""),A=String(p.to||""),b=Ut(f,A,f,A);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${f}" \u2192 "${A}"`,"text-blue");let v={...t,actions:[{t:"js",v:b}],pageType:"question"},y=await ze(v,!1,1,ye(e));a.logToConsole(y.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",y.applied>0?"text-green":"text-yellow")}let d=l.filter(m=>m.action.t!=="drag");if(d.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of d){if(u?.aborted)return;let p=m.action,f=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${f}`,"text-blue");let A=String(p.id||p.name||p.selector||""),b=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Je(m.action),await new Promise(v=>setTimeout(v,250)),ne(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${f}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let v=P(A,b)||P(A.replace(/[^\w\s]/g," ").trim(),b);if(v&&(ft(v),await new Promise(y=>setTimeout(y,300)),ne(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let v=P(A,b)||P(A.replace(/[^\w\s]/g," ").trim(),b);if(v&&(v.focus?.(),await new Promise(y=>setTimeout(y,50)),v.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),v.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80)),v.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),v.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200)),ne(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let v=P(A,b)||P(A.replace(/[^\w\s]/g," ").trim(),b);if(v){let y=v.id,C=!!y;y||(y=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,v.id=y);let T=String(p.v??""),x=p.t==="val",E=document.createElement("script");if(E.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(E),E.remove(),C||setTimeout(()=>{try{v.id===y&&v.removeAttribute("id")}catch{}},0),await new Promise(k=>setTimeout(k,300)),ne(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${f}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let v="";try{let q=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(I=>(I.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));q&&(v=q.outerHTML.slice(0,400))}catch{}let y=pe(!1)||ce(),C=`A\xE7\xE3o (${p.t}) alvo="${A}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${v?`
HTML do alvo: ${v}`:""}`,T=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],x=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
...
N\xC3O repita as estrat\xE9gias j\xE1 tentadas acima.`,E={...y,questionText:x},k=await je(E,[],{...e},q=>a.logToConsole(`> [REPLAN-AI] ${q}`,"text-blue"),u);if(u?.aborted||!k?.plan){a.logToConsole("> [REPLAN]  Re-consulta n\xE3o retornou plano.","text-yellow");continue}let w=k.plan.actions.filter(q=>q.t==="js");if(w.length===0){a.logToConsole("> [REPLAN] \u2139\uFE0F IA n\xE3o gerou a\xE7\xF5es JS de fallback.","text-yellow");continue}a.logToConsole(`> [REPLAN]  IA gerou ${w.length} a\xE7\xE3o(\xF5es) JS custom. Executando...`,"text-blue");let M={...t,actions:w,pageType:"question"},H=await ze(M,!1,1,ye(e));H.applied>0?a.logToConsole(`> [REPLAN]  Estrat\xE9gia 5 OK: ${H.applied} a\xE7\xE3o(\xF5es) JS executada(s)!`,"text-green"):a.logToConsole("> [REPLAN]  Todas as estrat\xE9gias esgotadas para esta a\xE7\xE3o.","text-yellow")}catch(v){a.logToConsole(`> [REPLAN] Erro na re-consulta: ${v instanceof Error?v.message:String(v)}`,"text-yellow")}}}}a.toggle(!0)}Bn().catch(n=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",n),window.alert(`EasyQuiz: falha ao iniciar: ${n instanceof Error?n.message:String(n)}`)});})();
