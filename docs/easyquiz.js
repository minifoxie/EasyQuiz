 ...
 */
"use strict";(()=>{var ie={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8};function W(o){if(!o||typeof o!="string")return!1;let e=o.toLowerCase().trim().replace(/^models\//,"");if(!e.includes("gemini"))return!1;let t=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let a of t)if(e.includes(a))return!1;return!(!e.includes("flash")&&!e.includes("pro"))}var Ze="easyquiz_settings_v2",be="easyquiz_activity_metrics";function $e(){try{let o=localStorage.getItem(Ze);if(!o){let i=localStorage.getItem("easyquiz_settings_v1");if(i){let s=JSON.parse(i);return{...ie,apiKey:s.apiKey||""}}return{...ie}}let e=JSON.parse(o),t=typeof e.model=="string"&&W(e.model)?e.model:ie.model,a=Array.isArray(e.apiKeys)?e.apiKeys.map(i=>typeof i=="string"?i.trim().replace(/^["']|["']$/g,""):"").filter(i=>i.length>5):[],r=typeof e.apiKey=="string"?e.apiKey.trim().replace(/^["']|["']$/g,""):"";if(a.length===0&&r&&(a=[r]),a.length===0)try{let i=localStorage.getItem("easyquiz_api_keys");if(i){let s=JSON.parse(i);Array.isArray(s)&&(a=s.filter(d=>typeof d=="string"&&d.trim().length>5))}}catch{}return{apiKey:a[0]||r||ie.apiKey,apiKeys:a,model:t,uiMode:e.uiMode==="easy"||e.uiMode==="advanced"?e.uiMode:ie.uiMode,modeHint:e.modeHint??"",engine:e.engine??"smart",dryRun:!!e.dryRun,autoApply:e.autoApply!==void 0?!!e.autoApply:!0,autoAdvance:!!e.autoAdvance,hostDarkMode:e.hostDarkMode!==void 0?!!e.hostDarkMode:!0,useVision:e.useVision!==void 0?!!e.useVision:ie.useVision,confidenceThreshold:typeof e.confidenceThreshold=="number"?e.confidenceThreshold:ie.confidenceThreshold}}catch{return{...ie}}}function Et(){try{localStorage.removeItem(Ze),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(be),sessionStorage.removeItem(be);let o=[];for(let e=0;e<localStorage.length;e++){let t=localStorage.key(e);t&&(t.startsWith("eq_")||t.startsWith("easyquiz_"))&&o.push(t)}o.forEach(e=>localStorage.removeItem(e)),Oe()}catch(o){console.warn("[EasyQuiz] Erro ao resetar dados:",o)}}function _e(o){try{let e=localStorage.getItem("eq_domain_cache_"+o);if(!e)return{};let t=JSON.parse(e);if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector)){t.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+o)}catch{}}return t}catch{return{}}}function et(o,e){if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector))return;let a={..._e(o),...e};try{localStorage.setItem("eq_domain_cache_"+o,JSON.stringify(a))}catch(r){console.warn("[EasyQuiz] Erro cache de dominio:",r)}}function qt(o){let e=$e(),t=Array.isArray(o.apiKeys)?o.apiKeys.map(n=>typeof n=="string"?n.trim().replace(/^["']|["']$/g,""):"").filter(n=>n.length>5):e.apiKeys,a;typeof o.apiKey=="string"?a=o.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(o.apiKeys)&&o.apiKeys.length>0?a=t[0]||"":a=e.apiKey,a&&!t.includes(a)&&(t=[a,...t]),t.length>0&&(!a||!t.includes(a))&&(a=t[0]);let r={...e,...o,apiKey:a,apiKeys:t};try{localStorage.setItem(Ze,JSON.stringify(r)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(t))}catch(n){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",n)}return r}var he=[],Ct=12,_t=1200;function Tt(o){let e=o.trim().replace(/\s+/g," ").slice(0,_t);e&&!he.includes(e)&&(he.push(e),he.length>Ct&&(he=he.slice(-Ct)))}function De(){return he}function Oe(){he=[]}function St(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Ce=St();function Ee(){try{localStorage.removeItem(be)}catch{}return Ce}function eo(o){Ce=o;try{let e=JSON.stringify(o);sessionStorage.setItem(be,e),localStorage.removeItem(be)}catch{}}function Lt(o){let e=Ce,t=Date.now(),a=e.records[e.records.length-1];if(a&&a.id===o.id&&t-a.timestamp<3e3)return e;let r={...o,timestamp:t},n=[...e.records,r],i=n.filter(u=>u.status==="answered"||u.status==="verified").length,s=n.reduce((u,g)=>u+g.durationMs,0),d=i>0?Math.round(s/i):0,l={startTime:e.startTime||t,totalElapsedMs:Math.max(t-(e.startTime||t),s),completedQuestionsCount:i,averageDurationMs:d,records:n};return eo(l),l}function qe(){Ce=St();try{sessionStorage.removeItem(be),localStorage.removeItem(be)}catch{}return Ce}var kt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
mode: "arrastar_soltar"`:"[PLATAFORMA: Wayground/Quizizz \u2014 alternativas s\xE3o cards clic\xE1veis, use clk]":/khanacademy\.org/i.test(o)||e.includes("perseus")?"[PLATAFORMA: Khan Academy \u2014 widgets Perseus; use js via $eq para widgets interativos se necess\xE1rio]":/moodle|ava\.|classroom\.google/i.test(o)?"[PLATAFORMA: Moodle/AVA/Classroom \u2014 formul\xE1rios padr\xE3o]":/duolingo/i.test(o)?"[PLATAFORMA: Duolingo \u2014 tiles clic\xE1veis, use clk por texto]":/blackboard|canvas\.instructure/i.test(o)?"[PLATAFORMA: Canvas/Blackboard \u2014 quiz-question padr\xE3o]":/socrative|kahoot/i.test(o)?"[PLATAFORMA: Socrative/Kahoot \u2014 alternativas s\xE3o bot\xF5es, use clk]":""}function Te(o,e,t){let a=o.htmlSnippet.includes("draggable")||o.htmlSnippet.includes("perseus")||o.htmlSnippet.includes("category")||o.htmlSnippet.includes("dropzone")||o.controls.some(A=>A.type==="draggable"||A.type==="dropzone"),r=/katex|latex|\\frac|\\sqrt/i.test(o.htmlSnippet),n=/forms\.(google|gle)\.com|docs\.google\.com\/forms/i.test(o.sourceUrl)||o.htmlSnippet.includes("Qr7Oae")||o.htmlSnippet.includes("data-item-id")||o.htmlSnippet.includes("freebirdFormviewer"),i=(/wayground|quizizz/i.test(o.sourceUrl)||o.htmlSnippet.includes("data-functional-selector"))&&(o.htmlSnippet.includes("classification")||o.controls.filter(A=>A.role==="answer").length===0),s=o.controls.filter(A=>A.role!=="navigation").length===0,d=s||a||n||i||r&&o.questionText.length<60,l=s?4500:i?6e3:1800,u=d?`
[HTML]:
${o.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",g="";if(s&&typeof document<"u")try{let A=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(y=>{let v=y,x=v.getBoundingClientRect?.()||{width:0,height:0};return x.width>0&&x.height>0&&!v.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(y=>{let v=y,x=v.tagName.toLowerCase(),E=v.id?`#${v.id}`:"",T=v.className&&typeof v.className=="string"?`.${v.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",M=(v.textContent||v.value||v.getAttribute("aria-label")||"").trim().slice(0,60),w=v.getAttribute("type")||v.getAttribute("role")||"";return`${x}${E}${T}[${w}] txt="${M}"`});A.length>0&&(g=`
[DOM-INTERATIVO]:
${A.join(`
`)}`)}catch{}let c=De(),m=c.length>0?`
[MEM\xD3RIA]:
${c.join(" | ")}
`:"",p=o.controls.filter(A=>A.role!=="navigation"),f=o.controls.filter(A=>A.role==="navigation"),h=to(o.sourceUrl,o.htmlSnippet),b=h?`
${h}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let A=p.filter(C=>C.type==="checkbox"||C.type==="chk"),y=new Set(p.filter(C=>C.type==="radio").map(C=>C.name).filter(Boolean)),v=A.filter(C=>!C.name||!y.has(C.name)),x=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(o.questionText),E=v.length>=2||x,T=y.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(o.questionText)&&y.size>=1,M=p.every(C=>C.type==="radio"||C.type==="chk")&&y.size===1&&!E&&!T,w=p.filter(C=>C.type==="text"||C.type==="number"||C.type==="val"||C.tag==="input"||C.tag==="textarea"),L=w.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${y.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${y.size} afirma\xE7\xF5es \u2014 emita ${y.size} a\xE7\xF5es chk separadas + adv]
`:E?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:M?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:L?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${w.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${w.length} campos abaixo com seu id exato]
...
[NAVEGA\xC7\xC3O]:
${f.length>0?f.map(A=>`"${A.label||A.id}"[${A.type}]`).join(","):"Nenhuma"}

[IMAGENS E GR\xC1FICOS ANEXADOS (${e.length})]:
${e.length===0?"Nenhum anexo visual.":e.map((A,y)=>{let v=A.associatedLabel||"Gr\xE1fico da Quest\xE3o",x=A.alt?` | alt: "${A.alt}"`:"";if(A.captureStatus==="text_only")return`  - Imagem ${y+1} [CONTEXTO_TEXTUAL]: ${v}${x} | ${A.textContext||"sem contexto adicional"}`;if(A.captureStatus==="captured"||A.base64){let E=A.textContext?` | Textos e r\xF3tulos do gr\xE1fico: "${A.textContext}"`:"";return`  - Imagem ${y+1} [VISUAL_INLINE]: ${v}${x}${E}`}return`  - Imagem ${y+1} [FALHOU]: ${v}${x}`}).join(`
`)}
[/DADOS]
Sa\xEDda em JSON v\xE1lido.`}var oo=new Set(["question","info","start","conclusion"]),ao=new Set(["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]),no=new Set(["val","chk","sel","clk","adv","js","drag"]),so=150,Se=2e3;function Y(o,e=""){return o==null?e:typeof o=="string"?o.trim().slice(0,Se):typeof o=="number"||typeof o=="boolean"?String(o).trim().slice(0,Se):e}function io(o,e){if(!o||typeof o!="object")return null;let t=o,a=t.t;if(typeof a!="string"||!no.has(a))return null;if(a==="adv"){let s=t.id??t.target??t.name??t.selector;return{t:"adv",...Y(s)?{id:Y(s,"").slice(0,500)}:{}}}if(a==="drag"){let s=Y(t.from??t.source),d=Y(t.to??t.target??t.destination);return!s||!d?null:{t:"drag",from:s.slice(0,500),to:d.slice(0,500)}}if(a==="js"){let s=Y(t.v??t.code??t.script);return!s||s.length>8e3?null:{t:"js",v:s}}let r=t.id??t.target??t.name??t.selector??t.element;(r==null||r==="")&&a==="val"&&(r="1");let n=Y(r).slice(0,500);if(!n)return null;if(a==="val"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.text!==void 0?t.text:t.answer;return{t:"val",id:n,v:Y(s).slice(0,Se)}}if(a==="sel"){let s=t.v!==void 0?t.v:t.value!==void 0?t.value:t.val!==void 0?t.val:t.values,l=(Array.isArray(s)?s:[s]).map(u=>Y(u).slice(0,500)).filter(Boolean);return{t:"sel",id:n,v:l}}if(a==="chk"){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar",d={t:"chk",id:n,c:!s};return t.v!==void 0&&(d.v=Y(t.v).slice(0,Se)),d}let i={t:"clk",id:n};if(t.c!==void 0){let s=t.c===!1||t.c==="false"||t.c===0||t.c==="0"||t.c==="off"||t.c==="unchecked"||t.c==="desmarcar";i.c=!s}return t.v!==void 0&&(i.v=Y(t.v).slice(0,Se)),Array.isArray(t.co)&&t.co.length===2&&t.co.every(s=>typeof s=="number"&&Number.isFinite(s))&&(i.co=[t.co[0],t.co[1]]),i}function ro(o,e,t){if(t!=="question")return o;let a=o.filter(n=>n.t==="adv"),r=o.filter(n=>n.t!=="adv");if(e==="escolha_unica"){r=r.filter(i=>!(i.t==="chk"&&i.c===!1||i.t==="clk"&&i.c===!1));let n=r.filter(i=>i.t==="chk"||i.t==="clk");if(n.length>1){let i=r.filter(d=>d.t!=="chk"&&d.t!=="clk"),s=n[n.length-1];r=[...i,s]}}else if(e==="escolha_multipla"){r=r.filter(i=>!(i.t==="chk"&&i.c===!1||i.t==="clk"&&i.c===!1));let n=new Set;r=r.filter(i=>{let s="id"in i&&typeof i.id=="string"?i.id:"";return s?n.has(s)?!1:(n.add(s),!0):!0})}else if(e==="verdadeiro_falso"){let n=new Set,i=[...r].reverse(),s=[];for(let d of i){let l="id"in d&&typeof d.id=="string"?d.id:"";l?n.has(l)||(n.add(l),s.push(d)):s.push(d)}r=s.reverse()}return[...r,...a]}function Mt(o){if(!o||typeof o!="object")return{pageType:"info",mode:"acao_sem_resposta",confidence:.5,rationale:"Resposta estruturada n\xE3o identificada; avan\xE7ando como informativo.",actions:[{t:"adv"}]};let e=o,t=e.pageType,a=e.mode;(typeof t!="string"||!oo.has(t))&&(t="question"),(typeof a!="string"||!ao.has(a))&&(a="escolha_unica");let r=Array.isArray(e.actions)?e.actions:[],n=[];for(let d=0;d<Math.min(r.length,so);d++){let l=io(r[d],d);l&&n.push(l)}n.some(d=>d.t==="val")&&(a==="escolha_unica"||!e.mode)&&(a="preenchimento"),n.some(d=>d.t==="drag")&&!["categorizacao","arrastar_soltar","ordenacao"].includes(a)&&(a="arrastar_soltar"),n=ro(n,a,t);let i=n.some(d=>d.t==="adv");t==="conclusion"?n.length=0:t==="info"||t==="start"?i||n.push({t:"adv"}):t==="question"&&!i&&n.push({t:"adv"});let s=typeof e.confidence=="number"&&Number.isFinite(e.confidence)?Math.min(1,Math.max(0,e.confidence)):.85;return{pageType:t,mode:a,confidence:s,rationale:Y(e.rationale,"Plano validado e auto-recuperado."),actions:n,...Y(e.memoryToStore)?{memoryToStore:Y(e.memoryToStore)}:{},...e.needsMoreContext?{needsMoreContext:!!e.needsMoreContext}:{}}}var _=class{keys=new Map;constructor(e=[]){this.init(e)}init(e){let t=new Map(this.keys);this.keys.clear();let a=e.flatMap(n=>n.split(/[\n\r]+/));Array.from(new Set(a.map(n=>n.trim().replace(/^["']|["']$/g,"")).filter(n=>n.length>5))).forEach((n,i)=>{let s=this.generateId(n),d=t.get(s)||t.get(n);this.keys.set(s,{id:s,key:n,label:d?.label||`Chave ${i+1}`,addedAt:d?.addedAt||Date.now(),lastUsedAt:d?.lastUsedAt,lastLatencyMs:d?.lastLatencyMs,cooldownUntil:d?.cooldownUntil,errorCount:d?.errorCount||0,lastError:d?.lastError,winCount:d?.winCount||0})})}generateId(e){let t=0;for(let r=0;r<e.length;r++)t=(t<<5)-t+e.charCodeAt(r),t|=0;let a=e.slice(-12).replace(/[^a-zA-Z0-9]/g,"").slice(0,6);return`key_${Math.abs(t).toString(36).slice(0,6)}${a}`}static maskKey(e){let t=e.trim().replace(/^["']|["']$/g,"");return t.length<=10?"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022":`${t.slice(0,6)}...${t.slice(-4)}`}getAllKeys(){let e=Date.now();return Array.from(this.keys.values()).map(t=>{let a=Math.max(0,(t.cooldownUntil||0)-e);return{...t,isCooldown:a>0,remainingCooldownMs:a}})}getHealthyKeys(){let e=Date.now();return Array.from(this.keys.values()).filter(t=>(t.cooldownUntil||0)<=e&&(t.errorCount||0)<50)}getRoundRobinKeys(e=2){let t=Date.now(),a=Array.from(this.keys.values()).filter(n=>(n.errorCount||0)<50);if(a.length===0)return Array.from(this.keys.values()).slice(0,e);let r=a.filter(n=>(n.cooldownUntil||0)<=t);return r.length>0?(r.sort((n,i)=>{let s=n.lastLatencyMs!==void 0?n.lastLatencyMs:99999,d=i.lastLatencyMs!==void 0?i.lastLatencyMs:99999;if(s!==d)return s-d;let l=(n.lastUsedAt||0)-(i.lastUsedAt||0);return l!==0?l:n.addedAt-i.addedAt}),r.slice(0,e)):(a.sort((n,i)=>(n.cooldownUntil||0)-(i.cooldownUntil||0)),a.slice(0,e))}getBestKey(){return this.getRoundRobinKeys(1)[0]?.key||""}getDiverseKeys(e){return this.getRoundRobinKeys(e).map(t=>t.key)}markQuotaHit(e,t=8e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Cota tempor\xE1ria atingida (HTTP 429). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markOverloaded(e,t=5e3){let a=this.findKeyObj(e);a&&(a.cooldownUntil=Date.now()+t,a.lastError=`Servidores sobrecarregados (HTTP 503). Cooldown de ${Math.round(t/1e3)}s ativado.`)}markSuccess(e,t){let a=this.findKeyObj(e);a&&(a.lastLatencyMs=t,a.lastUsedAt=Date.now(),a.errorCount=0,a.lastError=void 0,a.cooldownUntil=void 0)}markWinner(e){let t=this.findKeyObj(e);t&&(t.winCount=(t.winCount||0)+1)}markInvalid(e,t){let a=this.findKeyObj(e);a&&(a.errorCount=99,a.lastError=t)}addKey(e,t){let a=e.trim().replace(/^["']|["']$/g,"");if(!a)return{ok:!1,message:"Chave n\xE3o pode ser vazia."};if(a.length<15)return{ok:!1,message:"Chave de API inv\xE1lida ou muito curta."};let r=this.generateId(a);if(this.keys.has(r)||Array.from(this.keys.values()).some(s=>s.key===a))return{ok:!1,message:"Esta chave de API j\xE1 est\xE1 cadastrada."};let i={id:r,key:a,label:t?.trim()||`Chave ${this.keys.size+1}`,addedAt:Date.now(),errorCount:0};return this.keys.set(r,i),{ok:!0,message:"Chave adicionada com sucesso!",keyItem:i}}updateKey(e,t,a){let r=this.keys.get(e);if(!r)return{ok:!1,message:"Chave n\xE3o encontrada."};let n=t.trim().replace(/^["']|["']$/g,"");return!n||n.length<15?{ok:!1,message:"Chave de API inv\xE1lida."}:(r.key=n,a!==void 0&&(r.label=a.trim()),r.errorCount=0,r.cooldownUntil=void 0,r.lastError=void 0,{ok:!0,message:"Chave atualizada com sucesso!"})}removeKey(e){if(this.keys.size<=1)return{ok:!1,message:"Voc\xEA precisa manter pelo menos 1 chave de API cadastrada."};let t=this.findKeyObj(e);return t?(this.keys.delete(t.id),{ok:!0,message:"Chave removida com sucesso."}):{ok:!1,message:"Chave n\xE3o encontrada."}}exportRawKeys(){return Array.from(this.keys.values()).map(e=>e.key)}size(){return this.keys.size}findKeyObj(e){if(this.keys.has(e))return this.keys.get(e);for(let t of this.keys.values())if(t.key===e)return t}},z=new _;var xe=[{id:"gemini-3.8-flash",name:"Gemini 3.8 Flash (Mais Inteligente 2026)",description:"Modelo flagship Flash lan\xE7ado em Set/2026. Ultra-r\xE1pido e altamente capaz.",stable:!0},{id:"gemini-3.7-flash",name:"Gemini 3.7 Flash (Agentic)",description:"Alta capacidade para racioc\xEDnio multimodal e workflows ag\xEAnticos.",stable:!0},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash (Est\xE1vel)",description:"Modelo est\xE1vel e confi\xE1vel com excelente velocidade.",stable:!0},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash (R\xE1pido)",description:"Modelo de alta performance para tarefas r\xE1pidas.",stable:!0},{id:"gemini-3.5-flash-lite",name:"Gemini 3.5 Flash-Lite (Cota Alta 30 RPM)",description:"Modelo econ\xF4mico de ultra-alta velocidade e maior limite de RPM.",stable:!0},{id:"gemini-3.1-pro",name:"Gemini 3.1 Pro (Racioc\xEDnio Profundo)",description:"Modelo topo de linha para racioc\xEDnio complexo, exatas e matem\xE1tica.",stable:!0},{id:"gemini-2.5-flash",name:"Gemini 2.5 Flash (Ultra R\xE1pido)",description:"Modelo comprovado de baix\xEDssima lat\xEAncia e alta disponibilidade.",stable:!0},{id:"gemini-2.5-pro",name:"Gemini 2.5 Pro (Avan\xE7ado)",description:"Modelo avan\xE7ado para quest\xF5es de alta complexidade.",stable:!0}],Ht=["gemini-3.5-flash-lite","gemini-3.5-flash","gemini-3.6-flash","gemini-3.8-flash","gemini-2.5-flash"],lo={"gemini-2.0-flash":"gemini-3.5-flash","gemini-2.0-flash-lite":"gemini-3.5-flash-lite","gemini-1.5-flash":"gemini-3.5-flash","gemini-1.5-pro":"gemini-3.6-flash","gemini-1.0-pro":"gemini-2.5-flash"};function at(o){return lo[o]??o}function co(o,e){let a={temperature:0,maxOutputTokens:1350,responseMimeType:"application/json",responseSchema:e??uo};return/lite/i.test(o)||(/gemini-3\.[0-9]+-?flash/i.test(o)?a.thinkingConfig={thinkingBudget:0}:/gemini-2\.5-flash/i.test(o)&&(a.thinkingConfig={thinkingBudget:0})),a}var uo={type:"OBJECT",properties:{pageType:{type:"STRING",enum:["question","info","start","conclusion"]},mode:{type:"STRING",enum:["texto_livre","escolha_unica","escolha_multipla","verdadeiro_falso","preenchimento","acao_sem_resposta","categorizacao","ordenacao","arrastar_soltar"]},confidence:{type:"NUMBER"},rationale:{type:"STRING"},thinking:{type:"STRING"},memoryToStore:{type:"STRING"},imageDescriptions:{type:"ARRAY",items:{type:"OBJECT",properties:{index:{type:"NUMBER"},description:{type:"STRING"},relevant:{type:"BOOLEAN"},associatedLabel:{type:"STRING"}}}},actions:{type:"ARRAY",items:{type:"OBJECT",properties:{t:{type:"STRING",enum:["val","chk","sel","clk","adv","js","drag"]},id:{type:"STRING"},name:{type:"STRING"},label:{type:"STRING"},v:{type:"STRING"},c:{type:"BOOLEAN"},co:{type:"ARRAY",items:{type:"NUMBER"}},from:{type:"STRING"},to:{type:"STRING"}},required:["t"]}}},required:["pageType","mode","confidence","rationale","actions"]};function Pt(o){let e=o.trim().replace(/^google\//,"").replace(/^models\//,"");if(!e)return"gemini-3.5-flash-lite";let t=at(e);return W(t)?t:(console.warn(`[EasyQuiz] Modelo desconhecido ou inv\xE1lido: "${e}". Verifique se o modelo est\xE1 dispon\xEDvel no Google AI Studio.`),"gemini-3.5-flash-lite")}function ot(o,e){let t="";try{let a=JSON.parse(o);t=a.error?.message||a.message||""}catch{t=o.slice(0,160)}return/API_KEY_INVALID|API key not valid|key.*invalid|unregistered/i.test(t)?"Chave de API do Gemini inv\xE1lida ou n\xE3o autorizada no Google AI Studio.":/RESOURCE_EXHAUSTED|Quota exceeded|rate limit|quota/i.test(t)||e===429?`Cota do Gemini excedida (HTTP 429): ${t||"Aguarde"}`:e===404?`HTTP 404: ${t||"Modelo ou endpoint n\xE3o encontrado no Google AI Studio"}`:e===503||/overloaded/i.test(t)?`Servidores Google sobrecarregados (HTTP 503): ${t||"Aguardando"}`:t?`Erro Gemini (HTTP ${e}): ${t}`:`Falha na requisi\xE7\xE3o ao Gemini (HTTP ${e}).`}function po(o){let e=o.trim(),t=e.match(/```(?:json)?\s*([\s\S]*?)\s*```/i);if(t)try{return JSON.parse(t[1].trim())}catch{}try{return JSON.parse(e)}catch{}let a=e.match(/\{[\s\S]*\}/);if(a)try{return JSON.parse(a[0].trim())}catch{}try{let r=e.indexOf("{");if(r!==-1){let n=e.slice(r).trim();n=n.replace(/,\s*\{[^}]*$/,""),n=n.replace(/,\s*$/,"");let i=0,s=0,d=!1,l=!1;for(let g=0;g<n.length;g++){let c=n[g];if(l){l=!1;continue}if(c==="\\"){l=!0;continue}if(c==='"'){d=!d;continue}d||(c==="{"?i++:c==="}"?i=Math.max(0,i-1):c==="["?s++:c==="]"&&(s=Math.max(0,s-1)))}for(d&&(n+='"');s>0;)n+="]",s--;for(;i>0;)n+="}",i--;let u=JSON.parse(n);if(u&&typeof u=="object")return u}}catch{}throw new Error("Falha ao decodificar JSON da IA.")}var zt=(()=>{try{let o=typeof localStorage<"u"?localStorage.getItem("easyquiz_cached_models"):null;if(!o)return null;let e=JSON.parse(o);if(Array.isArray(e)){let t=e.filter(a=>a&&typeof a.id=="string"&&W(a.id));return t.length>0?t:null}return null}catch{return null}})(),tt=new Set;async function Re(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return xe;let t=[`https://generativelanguage.googleapis.com/v1beta/models?key=${encodeURIComponent(e)}`,`https://generativelanguage.googleapis.com/v1/models?key=${encodeURIComponent(e)}`];for(let a of t)try{let r=await fetch(a,{headers:{"Content-Type":"application/json","x-goog-api-key":e}});if(!r.ok){let i=await r.text(),s=ot(i,r.status);if(s.includes("inv\xE1lida")||s.includes("n\xE3o autorizada"))throw new Error(s);continue}let n=await r.json();if(Array.isArray(n.models)&&n.models.length>0){let i=n.models.filter(s=>{let d=s.supportedGenerationMethods||[],l=(s.name||"").replace(/^models\//,""),u=d.includes("generateContent");return W(l)&&u}).map(s=>{let d=s.supportedGenerationMethods||[],l=s.name.replace(/^models\//,""),u=s.displayName||l;return{id:l,name:u.includes(l)?u:`${u} (${l})`,description:s.description||"",stable:!/-preview|-experimental|-latest/i.test(l),supportsVision:!/embedding|tts|transcribe|live|image|sound|voice/i.test(l),supportsStructuredOutput:d.includes("generateContent"),supportedGenerationMethods:d,discoveredAt:Date.now()}});if(i.length>0){i.sort((s,d)=>{let l=u=>u==="gemini-3.8-flash"?200:u==="gemini-3.7-flash"?190:u==="gemini-3.6-flash"?180:u==="gemini-3.5-flash"?170:u==="gemini-3.5-flash-lite"?160:u==="gemini-2.5-flash"?130:u.includes("flash")?80:u==="gemini-2.5-pro"?60:u.includes("pro")?50:10;return l(d.id)-l(s.id)}),zt=i;try{typeof localStorage<"u"&&localStorage.setItem("easyquiz_cached_models",JSON.stringify(i))}catch{}return i}}}catch(r){if(r.message?.includes("Chave de API"))throw r}return xe}async function Be(o){let e=o.trim().replace(/^["']|["']$/g,"");if(!e)return{ok:!1,message:"Insira sua chave de API."};try{let a=await Re(e);if(a.length>0&&a!==xe){let r=a[0];return{ok:!0,message:`Chave v\xE1lida! ${a.length} modelos Gemini dispon\xEDveis em sua conta. Recomendado: ${r.name}`,models:a}}}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}let t=["gemini-3.8-flash","gemini-3.6-flash","gemini-3.5-flash"];for(let a of t)for(let r of["v1beta","v1"]){let n=`https://generativelanguage.googleapis.com/${r}/models/${a}:generateContent?key=${encodeURIComponent(e)}`;try{if((await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}})})).ok)return{ok:!0,message:`Chave validada com sucesso no ${a} (${r})!`,models:xe}}catch{}}return{ok:!1,message:"Chave de API inv\xE1lida, sem cota ou sem permiss\xE3o para modelos Gemini."}}async function nt(o,e){let t=e.map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>5);if(t.length===0)return{ok:!1,model:o,key:"",message:"Nenhuma chave dispon\xEDvel."};let a=at(Pt(o)),r=JSON.stringify({contents:[{role:"user",parts:[{text:"PING"}]}],generationConfig:{maxOutputTokens:5}}),n={"Content-Type":"application/json"};async function i(l,u,g){let c=new AbortController,m=setTimeout(()=>c.abort(),g);try{let p=`https://generativelanguage.googleapis.com/v1beta/models/${u}:generateContent?key=${encodeURIComponent(l)}`,f=await fetch(p,{method:"POST",headers:{...n,"x-goog-api-key":l},body:r,signal:c.signal});if(clearTimeout(m),f.ok)return{ok:!0,model:u,key:l,message:`Modelo '${u}' validado com sucesso!`};let h=await f.text().catch(()=>"");throw new Error(`HTTP ${f.status}: ${h.slice(0,80)}`)}catch(p){throw clearTimeout(m),p}}if(t.length>=2){let l=t.slice(0,6);try{return await Promise.any(l.map(g=>i(g,a,8e3)))}catch{}}let s=t[0],d=[a,...Ht.filter(l=>l!==a)];for(let l of d)try{let u=await i(s,l,4e3);return l!==a&&(u.message=`Modelo preferido indispon\xEDvel. Validado via fallback '${l}'.`),u}catch{}return{ok:!1,model:a,key:s,message:"Nenhum modelo Gemini respondeu. Verifique sua chave e cota."}}async function mo(o,e,t,a,r){let n=["v1beta","v1"],i=new Error(`Falha ao consultar modelo ${o}`),d={...co(o,r)};for(let l of n){if(a.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=`https://generativelanguage.googleapis.com/${l}/models/${o}:generateContent?key=${encodeURIComponent(e)}`,g=Date.now();try{let c=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:d}),signal:a});if(!c.ok){let f=await c.text();if(c.status===400){let b=/thinking/i.test(f),A=/response_schema|responseSchema|Repeated map key|PROTO payload/i.test(f);if((b||A)&&(d.thinkingConfig||d.responseSchema)){let y={...d};b&&delete y.thinkingConfig,A&&(delete y.responseSchema,delete y.responseMimeType),d=y;let v=await fetch(u,{method:"POST",headers:{"Content-Type":"application/json","x-goog-api-key":e},body:JSON.stringify({...t,generationConfig:d}),signal:a});if(v.ok){let T=await v.json(),M=T.candidates?.[0];if(M?.content?.parts?.[0]?.text)return z.markSuccess(e,Date.now()-g),{rawText:M.content.parts[0].text,data:T,usedModel:o,usedKey:e}}let x=await v?.text?.().catch(()=>"")??f,E=ot(x,c.status);throw new Error(`[${o}|${_.maskKey(e)}] ${E}`)}}let h=ot(f,c.status);if(c.status===404&&l==="v1beta")continue;throw c.status===429?(z.markQuotaHit(e,8e3),Dt(e,o,1e4),new Error(`[${o}|${_.maskKey(e)}] ${h}`)):(c.status===503||/no capacity|overloaded|unavailable/i.test(f)?(z.markOverloaded(e,5e3),tt.add(o)):c.status===403||/API_KEY_INVALID/i.test(f)?z.markInvalid(e,h):c.status===404&&tt.add(o),new Error(`[${o}|${_.maskKey(e)}] ${h}`))}let m=await c.json(),p=m.candidates?.[0];if(!p||!p.content?.parts?.[0]?.text)throw new Error(`[${o}|${_.maskKey(e)}] A IA n\xE3o retornou uma resposta estruturada v\xE1lida.`);return z.markSuccess(e,Date.now()-g),{rawText:p.content.parts[0].text,data:m,usedModel:o,usedKey:e}}catch(c){if(a.aborted)throw c;i=c;let m=i.message||"";if(m.includes("404")||/no longer available/i.test(m)){tt.add(o);break}if(m.includes("429")||m.includes("Quota"))break}}throw i}var Ne=new Map;function It(o,e){let t=`${o}::${e}`,a=Ne.get(t);return a===void 0?!1:Date.now()>a?(Ne.delete(t),!1):!0}function Dt(o,e,t=1e4){Ne.set(`${o}::${e}`,Date.now()+t)}function st(){Ne.clear()}async function Qe(o,e,t,a,r,n){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let i=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];z.init(i);let s=t.apiKey.trim().replace(/^["']|["']$/g,""),d=z.getBestKey()||s;if(!d)throw new Error("Nenhuma chave de API do Gemini configurada ou dispon\xEDvel.");let l=Pt(t.model);if(!zt&&d&&Re(d).catch(()=>{}),r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let u=Date.now(),g=Te(o,e,t),c=[{text:g}];for(let S=0;S<e.length;S++){let C=e[S],I=C.associatedLabel||(C.alt?`Imagem: ${C.alt}`:`Imagem ${S+1}`);if(C.captureStatus==="text_only"||!C.base64){let D=C.textContext||C.alt||"";c.push({text:`[CONTEXTO_IMAGEM_${S+1} - V\xCDNCULO: ${I}]: ${D}`})}else c.push({text:`[ANEXO VISUAL ${S+1} - V\xCDNCULO: ${I}]:`}),c.push({inline_data:{mime_type:C.mediaType,data:C.base64}})}let m={system_instruction:{parts:[{text:n?.systemPromptOverride??kt}]},contents:[{role:"user",parts:c}]},p=at(l),f=Ht.filter(S=>S!==p),b=z.getAllKeys().length,A=S=>b<=1||S===0?1:2,y=new Set,v=(S,C)=>{let I=/pro/i.test(S),D=/lite/i.test(S);return I?C===0?18e3:C===1?24e3:3e4:D?C===0?1e4:C===1?14e3:18e3:C===0?16e3:C===1?2e4:25e3},x=async(S,C)=>{if(C.length===0||r?.aborted)return null;let I=C.map(()=>new AbortController),D=()=>I.forEach(N=>{try{N.abort()}catch{}});r?.addEventListener("abort",D,{once:!0});let B=C.map(N=>`${N.model.replace("gemini-","")}/${N.label}`).join(" | ");a?.(`\u26A1 ${S}: ${C.length} slot(s) [${B}]...`,"info");try{let N=C.map(async(U,G)=>{let V=I[G],ae=setTimeout(()=>{try{V.abort(new Error(`Timeout ${U.timeout/1e3}s (${U.model}|${U.label})`))}catch{V.abort()}},U.timeout);try{let K=await mo(U.model,U.key,m,V.signal,n?.generationSchemaOverride);clearTimeout(ae);let $=Mt(po(K.rawText));return $.usedModel=K.usedModel,$.durationMs=Date.now()-u,$.promptSent=g,$.tokensUsed=K.data.usageMetadata?.totalTokenCount,$.promptTokens=K.data.usageMetadata?.promptTokenCount,$.candidatesTokens=K.data.usageMetadata?.candidatesTokenCount,$.rawResponse=K.rawText,I.forEach((wt,$t)=>{if($t!==G)try{wt.abort(new Error("Cancelado: vencedor respondeu."))}catch{wt.abort()}}),{plan:$,rawUsage:K.data.usageMetadata,usedModel:K.usedModel,usedKey:K.usedKey,slotLabel:U.label}}catch(K){clearTimeout(ae);let $=K instanceof Error?K.message:String(K);throw($.includes("429")||$.includes("Quota")||$.includes("RESOURCE_EXHAUSTED"))&&(Dt(U.key,U.model,1e4),z.markQuotaHit(U.key,8e3)),K}}),X=await Promise.any(N);return r?.removeEventListener("abort",D),z.markWinner(X.usedKey),X}catch(N){return r?.removeEventListener("abort",D),N instanceof AggregateError&&N.errors.length>0?w=N.errors.map(X=>X instanceof Error?X.message:String(X)).join(" | "):N instanceof Error&&(w=N.message),console.warn(`[EasyQuiz ${S}] Falha na onda:`,w),null}},T=(b<=1?1:1+Math.ceil((b-1)/2))+4,M=0,w="",L=0;for(;M<T;){if(r?.aborted)throw new Error("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");let S=z.getRoundRobinKeys(b),C=S.filter(V=>!y.has(`${V.key}::${p}`)&&!It(V.key,p)),I,D;if(C.length>0)I=p,D=C;else{let V=f;I=V[L%V.length]||p,L++;let ae=S.filter(K=>!y.has(`${K.key}::${I}`)&&!It(K.key,I));D=ae.length>0?ae:S.filter(K=>!y.has(`${K.key}::${I}`))}if(D.length===0){if(L<f.length)continue;break}let B=D.slice(0,A(M));if(B.length===0)break;let N=v(I,M),X=B.map(V=>(y.add(`${V.key}::${I}`),{model:I,key:V.key,label:V.label||"Chave",timeout:N})),U=M===0?"Onda 1":`Onda ${M+1}`,G=await x(U,X);if(G){let V=G.plan.durationMs||Date.now()-u,ae=_.maskKey(G.usedKey);return a?.(`\u2705 ${V}ms via '${G.usedModel}' (${G.slotLabel}: ${ae})`,"info"),G}M++}throw new Error(w||"Todas as tentativas falharam. Verifique suas chaves de API e cotas.")}var fo=[/\bfetch\b/i,/\bXMLHttpRequest\b/i,/\bWebSocket\b/i,/\b(?:localStorage|sessionStorage|indexedDB)\b/i,/\b(?:eval|Function|AsyncFunction|GeneratorFunction)\b/i,/\bimport(?:Scripts)?\b/i,/\bnavigator\s*\.\s*credentials\b/i,/\b(?:cookie|location\s*=|history\s*\.)/i,/\bwindow\s*\[\s*['"](?:fetch|eval|Function|localStorage|sessionStorage)/i];function Ae(o){let e=o?.engine||"smart",t=new Set(["dom","framework","keyboard","drag"]);return o?.autoAdvance&&t.add("navigation"),e==="javascript"&&t.add("javascript"),{engine:e,capabilities:t,maxAttemptsPerAction:e==="command"?1:2,maxActionMs:e==="command"?1500:3e3,allowJavaScript:e==="javascript",allowNavigation:!!o?.autoAdvance}}function it(o,e){if(o.t==="js"&&!e.allowJavaScript)throw new Error("A\xE7\xE3o JavaScript bloqueada pela engine atual. Use o motor JavaScript explicitamente.");if(o.t==="adv"&&!e.allowNavigation)throw new Error("Avan\xE7o autom\xE1tico bloqueado pela pol\xEDtica atual.")}function Ot(o){if(!o.trim())throw new Error("JavaScript recusado: c\xF3digo vazio.");if(o.length>8e3)throw new Error("JavaScript recusado: c\xF3digo acima do limite operacional.");if(fo.find(t=>t.test(o)))throw new Error("JavaScript recusado: acesso externo, persist\xEAncia ou avalia\xE7\xE3o din\xE2mica n\xE3o permitidos.");if(!/^\s*(?:\/\/[^\n]*\n|\/\*[\s\S]*?\*\/|[\s\S])*\$eq\./.test(o)&&!o.includes("$eq."))throw new Error("JavaScript recusado: use somente a API declarativa $eq.")}var we=['input:not([type="hidden"])',"textarea","select","button","a","label",'[role="button"]','[role="link"]','[role="radio"]','[role="checkbox"]','[role="option"]','[role="treeitem"]','[role="menuitemcheckbox"]','[role="menuitemradio"]','[contenteditable="true"]','[draggable="true"]',"[aria-grabbed]","[aria-dropeffect]","[data-widget-type]",".perseus-drag-item",".sortable-item",'[data-testid*="drag" i]','[data-testid*="card" i]','[data-testid*="option" i]','[data-testid*="choice" i]','[data-testid*="category" i]',"[data-choice]","[data-option]","[data-answer]","[data-value]",".quiz-option",".option-card",".choice-card",'[class*="option-card" i]','[class*="choice-card" i]','[class*="option-item" i]','[class*="choice-item" i]','[class*="answer-item" i]','[class*="alternative" i]','li[class*="choice" i]','li[class*="option" i]','li[class*="answer" i]','[data-role="dropzone"]',"[data-category]","[data-item-id]","[data-params][jsmodel]",'[class*="draggable-item" i]','[class*="drag-item" i]','[class*="sortable-card" i]','[class*="card-option" i]','[class*="tile" i][class*="option" i]'].join(","),ke=/(verificar|checar|check|conferir|validar|próxim[oa]|next|continuar|continue|avançar|prosseguir|enviar|submit|concluir|finalizar|terminar|começar|iniciar|start|vamos lá|próxima tarefa|next task|próxima pergunta|next question|marcar como concluíd[oa]|mostrar resumo|entendi|compreendi|ok|leitura concluída|seguir|ir para o exercício|fazer o teste|próximo artigo|ir para a aula)/i,re=/(\banterior\b|\bvoltar\b|\bback\b|\bprev\b|\bprevious\b|recomeçar|\brestart\b|\breplay\b|\bretornar\b)/i,go=0;function rt(o){try{let e=o.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]');if(e&&!de(e))return!1}catch{}try{let e=window.getComputedStyle?window.getComputedStyle(o):o.style;if(e&&(e.display==="none"||e.visibility==="hidden"))return!1}catch{}try{if(typeof o.getBoundingClientRect=="function"){let e=o.getBoundingClientRect();if(e.width>0||e.height>0)return!0}}catch{}return(o.textContent||"").trim().length>0}function Q(o){try{if(typeof CSS<"u"&&typeof CSS.escape=="function")return CSS.escape(o)}catch{}return String(o).replace(/["\\]/g,"\\$&")}function H(o){let e=o;if(!e||typeof e.isConnected=="boolean"&&!e.isConnected||de(e))return!1;let t=e.tagName?.toLowerCase();if(["input","select","textarea","button"].includes(t)){let a=e.type?.toLowerCase();if(a==="checkbox"||a==="radio"){if(e.id)try{let n=e.ownerDocument?.querySelector(`label[for="${Q(e.id)}"]`);if(n&&rt(n))return!0}catch{}let r=e.closest('label, .option-card, .quiz-option, .choice, .answer, [role="radio"], [role="checkbox"], [class*="option" i], [class*="choice" i], [class*="item" i], li, tr');if(r&&r!==e&&rt(r))return!0}try{if(!e.closest('[hidden], [style*="display: none"], [style*="display:none"], [aria-hidden="true"]')){let n=window.getComputedStyle?window.getComputedStyle(e):e.style;if(!n||n.display!=="none"&&n.visibility!=="hidden"){if(typeof e.getBoundingClientRect=="function"){let i=e.getBoundingClientRect();if(i.width>0||i.height>0)return!0}return!0}}}catch{}}return rt(e)}function ho(o){if(o==null)return"";if(typeof o=="string")return o;if(typeof o=="number"||typeof o=="boolean")return String(o);if(o instanceof Node)return o.textContent||"";try{if(typeof o?.toString=="function"){let e=o.toString();if(typeof e=="string")return e}}catch{}return""}function R(o,e=500){return ho(o).replace(/\s+/g," ").trim().slice(0,e)}function bo(o){let e=o.dataset.easyquizId;if(e)return e;let t=`eq-${Date.now().toString(36)}-${(go+=1).toString(36)}`;return o.dataset.easyquizId=t,t}function de(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}var Le=/(leaderboard|scoreboard|placar|ranking|trophy|pause|pausar|mute|mutar|audio|sound|som|música|music|configuraç|settings|theme|ajuda|help|report|denunciar|feedback|power-?up|streak|coins|fullscreen|full-screen|read-?aloud|audio-?player|(?:audio|sound|som|media)[-_ ]*volume|volume[-_ ]*(?:slider|control|level|btn|button|icon|mute)|vol-slider)/i;function j(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element))return!1;if(de(o))return!0;let e=o.tagName?.toLowerCase();if(["select","textarea"].includes(e)||e==="input"&&!["button","submit","reset"].includes((o.type||"").toLowerCase()))return!1;let a=o.closest?.('button, a, [role="button"], [class*="leaderboard" i], [data-testid*="leaderboard" i], [class*="scoreboard" i], [class*="trophy" i]')||o,r=String(a.getAttribute?.("data-testid")||a.getAttribute?.("data-test-id")||a.getAttribute?.("id")||""),n=String(a.getAttribute?.("aria-label")||""),i=String(a.getAttribute?.("title")||""),s=typeof a.className=="string"?a.className:typeof a.className?.baseVal=="string"?a.className.baseVal:"",d=R(a.textContent,60);return!!(Le.test(r)||Le.test(n)||Le.test(i)||Le.test(s)||d.length>0&&d.length<=25&&Le.test(d))}function Z(o){if(!o||typeof o.getAttribute!="function"||typeof Element<"u"&&!(o instanceof Element)||de(o)||j(o)||o.closest?.('.option-card, .choice-card, .quiz-option, [class*="option-card" i], [class*="choice-card" i], [class*="option-item" i], [class*="choice-item" i], [class*="answer-item" i], [data-testid*="option" i], [data-testid*="choice" i], [data-choice], [data-option], [data-answer], [role="radio"], [role="checkbox"], [role="option"]')||o.closest?.("header, nav, aside"))return!1;let e=typeof HTMLInputElement<"u"&&o instanceof HTMLInputElement||typeof HTMLButtonElement<"u"&&o instanceof HTMLButtonElement?o.value:"",t=R(o.getAttribute?.("aria-label")||o.textContent||o.getAttribute?.("value")||e),a=o.type,r=t.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim(),n=String(o.getAttribute?.("data-testid")||o.getAttribute?.("data-test-id")||o.getAttribute?.("id")||o.getAttribute?.("href")||"").toLowerCase();return re.test(r)||re.test(t)?!1:ke.test(r)||ke.test(t)||n.includes("next")||n.includes("check")||n.includes("continue")||n.includes("proximo")||n.includes("forward")?!0:/^\d{1,3}$/.test(t.trim())?!!o.closest?.('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav, [class*="steps" i]'):!1}function lt(o){let e=o.closest("tr");if(e){let d=e.querySelector("th, td:first-child"),l=d&&d!==o.closest("td")?R(d.textContent,100):"",u=R(o.closest("label, td")?.textContent||"",50);if(l&&u)return`${l}: ${u}`}let t=o.closest('.dropdown-row, [class*="dropdown-row" i], [class*="select-row" i]');if(t){let d=t.querySelector('.dropdown-label, [class*="label" i]'),l=d&&d!==o?R(d.textContent,150):"";if(l)return l}let a=o.getAttribute("aria-label");if(a)return R(a);let r=o.getAttribute("aria-labelledby");if(r){let d=r.split(/\s+/).map(l=>document.getElementById(l)?.textContent).filter(Boolean).join(" ");if(d.trim())return R(d)}if("labels"in o&&o.labels){let d=Array.from(o.labels??[]).map(l=>l.textContent).join(" ");if(d.trim())return R(d)}let n=o.closest('.docssharedWizToggleLabeledContainer, [role="listitem"], .answer, label, .quiz-option, .form-check, .option-card');if(n&&n!==o){let d=R(n.textContent);if(d)return d}let i=o instanceof HTMLInputElement||o instanceof HTMLButtonElement?o.value:"",s=o.getAttribute("placeholder")||o.getAttribute("title")||o.textContent||i||"";return R(s)}function ct(o,e){let a=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName.toLowerCase()==="select"?o:null,r=o;o.dataset.easyquizRole=e;let n=o.tagName.toLowerCase(),i=["input","textarea","select","button"].includes(n)?n:"other",s=o.getAttribute("role")||"",d=(o.getAttribute("data-testid")||o.getAttribute("data-test-id")||"").toLowerCase(),l=(o.className&&typeof o.className=="string"?o.className:"").toLowerCase(),u=o.getAttribute("draggable")==="true"||o.classList.contains("perseus-drag-item")||o.classList.contains("sortable-item")||l.includes("cursor-grab")||!!o.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(d)||/drag|card-item|sortable/i.test(l),g=o.getAttribute("data-role")==="dropzone"||o.classList.contains("category-container")||o.hasAttribute("data-category")||!!o.getAttribute("aria-dropeffect")||/drop|category|bucket/i.test(d)||/dropzone|category-box|bucket|target-zone/i.test(l),m=R((u?"draggable":g?"dropzone":"")||r.type||s||i,40),p="";if(r.type==="checkbox"||r.type==="radio"||s==="radio"||s==="checkbox"){let v=r.checked||o.getAttribute("aria-checked")==="true",x=r.value&&r.value!=="on"?r.value:o.getAttribute("data-value")||"";p=v?x?`checked:${x}`:"checked":x||"unchecked"}else if(i==="button"||n==="a"||e==="navigation"||Z(o))p="";else{let v=typeof o.value=="string"||typeof o.value=="number"?o.value:"";p=R(v||o.getAttribute("data-category")||"",2e3)}let f=[];if(a&&a.options)for(let v of Array.from(a.options).slice(0,80))f.push({value:R(v.value),label:R(v.textContent)});else if(s==="combobox"||s==="listbox"||l.includes("select")||l.includes("dropdown")){let v=o.getAttribute("aria-controls")||o.getAttribute("aria-owns"),x=v?document.getElementById(v):o;if(x){let E=x.querySelectorAll('[role="option"], li, .dropdown-item, .option');for(let T of Array.from(E).slice(0,80)){let M=R(T.textContent);M&&f.push({value:T.getAttribute("data-value")||T.getAttribute("value")||M,label:M})}}}let h=!!(r.required||o.getAttribute("aria-required")==="true"),b=!!(r.disabled||o.getAttribute("aria-disabled")==="true"),A=bo(o);return{id:o.id||A,tag:i,type:m,label:lt(o),name:R(r.name||o.getAttribute("name")||"",180),value:p,options:f,required:h,disabled:b,role:e}}var Nt=['[data-test-id*="exercise" i]','[data-testid*="exercise" i]',".perseus-renderer",".framework-perseus",".Qr7Oae","[data-item-id]",".freebirdFormviewerViewItemsItemItem",".que",".question-holder",".quiz-question",".question_holder",".display_question",'[data-functional-selector*="question"]',".question-container",'[class*="classification-layout" i]','[class*="quiz-container" i]','[data-cy="quiz-container"]',"[data-question-id]",'[data-testid*="question" i]','[class*="question-container" i]','[class*="question" i]','[class*="pergunta" i]','[class*="categoriz" i]',"article","form","section","main"].join(",");function Rt(o){if(!H(o))return-1/0;let e=o.getBoundingClientRect(),t=Array.from(o.querySelectorAll(we)).filter(H),a=R(o.innerText||o.textContent||"",4e3).length;if(a<10||!t.length&&a<60)return-1/0;let r=Math.max(1,window.innerWidth*window.innerHeight),n=Math.max(1,e.width*e.height),i=Math.min(1,n/r),s=e.top+e.height/2,d=Math.abs(s-window.innerHeight/2)/Math.max(1,window.innerHeight),l=a>40?35:0,u=e.top>=0&&e.bottom<=window.innerHeight?25:0;return t.length*15+Math.min(60,a/20)+l+u-i*20-d*10}function je(o){let e=o;if(e.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&e.tagName.toLowerCase()!=="main"&&e.tagName.toLowerCase()!=="body")return e;for(;e.parentElement&&e.parentElement!==document.body&&e.parentElement!==document.documentElement;){let t=e.parentElement,a=t.tagName.toLowerCase();if(["header","footer","nav","aside"].includes(a))break;if(t.matches?.('article, [data-test-id*="exercise" i], [data-testid*="exercise" i], .perseus-renderer, .framework-perseus, [class*="question-container" i], .que')&&a!=="main"&&a!=="body"){e=t;break}let r=R(e.innerText||e.textContent||"",1e4),n=R(t.innerText||t.textContent||"",1e4),i=e.querySelectorAll(we).length,s=t.querySelectorAll(we).length;if(r.length<150&&n.length>r.length&&s<=i+4&&a!=="main"&&a!=="body"){e=t;continue}break}return e}function Bt(o){let e=o,t=e.closest('main, [role="main"], article, form, [data-test-id*="exercise" i], [data-testid*="exercise" i], .framework-perseus, section');if(t&&t!==document.body&&H(t))return t;let a=0;for(;e.parentElement&&e.parentElement!==document.body&&a<3;)e=e.parentElement,a++;return e||document.body}function J(){let o=document.querySelector('[class*="classification-layout" i], [class*="quiz-container" i][class*="classification" i]');if(o&&H(o))return o;let e=document.activeElement;if(e&&e!==document.body){let i=e.closest(Nt);if(i&&Rt(i)>0)return je(i)}let a=Array.from(document.querySelectorAll(Nt)).map(i=>({element:i,score:Rt(i)})).filter(i=>Number.isFinite(i.score)).sort((i,s)=>s.score-i.score),r=a.find(i=>{let s=i.element.tagName.toLowerCase();return s!=="main"&&s!=="body"&&i.score>0});if(r)return je(r.element);if(a.length>0&&a[0].score>0)return je(a[0].element);let n=document.querySelector('form, main, [role="main"]');return n&&H(n)?n:document.body}function Qt(o){let e=o.cloneNode(!0);e.querySelectorAll("script, style, iframe, object, embed, svg, canvas, noscript, audio, video").forEach(a=>a.remove());let t=["type","name","value","role","aria-label","aria-labelledby","aria-checked","aria-required","required","disabled","data-easyquiz-id","draggable","class","id","data-widget-type","data-role","data-category","data-testid"];return e.querySelectorAll("*").forEach(a=>{for(let r of Array.from(a.attributes))t.includes(r.name)||a.removeAttribute(r.name)}),e.outerHTML.replace(/\s+/g," ").slice(0,2e4)}function Ve(o){let e=Array.from(o.querySelectorAll(we)),t=new Set,a=[];for(let l of e){if(!H(l)||Z(l)||j(l))continue;let u=(l.value||l.textContent||"").trim();if(re.test(u))continue;let g=l.tagName.toLowerCase();["input","textarea","select"].includes(g)&&(t.add(l),a.push(l))}for(let l of e){if(!H(l)||Z(l)||j(l))continue;let u=(l.value||l.textContent||"").trim();if(re.test(u))continue;let g=l.tagName.toLowerCase();if(["input","textarea","select"].includes(g))continue;let c=l.querySelector("input, textarea, select");if(!(c&&t.has(c))){if(l.hasAttribute("for")){let m=l.getAttribute("for"),p=m?l.ownerDocument.getElementById(m):null;if(p&&t.has(p))continue}if(g==="a"){let m=l.getAttribute("role"),p=l.getAttribute("class")||"",f=l.getAttribute("data-testid")||"",h=l.getAttribute("draggable")==="true"||l.classList.contains("perseus-drag-item")||l.classList.contains("sortable-item")||p.includes("cursor-grab")||!!l.getAttribute("aria-grabbed")||/drag|card|option|item/i.test(f)||/drag|card-item|sortable/i.test(p);if(!(m==="button"||m==="radio"||m==="checkbox"||m==="option"||h||l.closest('[class*="choice" i], [class*="option" i], [class*="answer" i], [data-testid*="option" i]')))continue}a.push(l)}}let r=a.length>0&&a.every(l=>j(l)||/read-?aloud|audio/i.test(l.getAttribute("data-testid")||l.getAttribute("aria-label")||"")),n=document.body.querySelector('[class*="classification-layout" i]')||document.body.querySelector('[class*="classification" i]')||o,i=document.body.querySelector('[class*="classification" i]')!==null||o.querySelector('[class*="classification" i]')!==null||o.querySelector('[data-cy*="quiz" i]')!==null||o.querySelector('[class*="draggable-item" i]')!==null||o.querySelector('[class*="drag-item" i]')!==null||o.querySelector('[class*="sortable-card" i]')!==null||o.matches?.('[class*="classification" i]');if((a.length===0||r)&&i){r&&(a.length=0);let l=Array.from(n.querySelectorAll('[class*="cursor-grab"][id], [draggable="true"][id], .dnd-card[id]'));if(l.length>0){for(let u of l)if(!(!H(u)||j(u))&&(a.push(u),a.length>=50))break}else{let u=Array.from(n.querySelectorAll("button, div[class], span[class], p, li"));for(let g of u){if(!H(g)||Z(g)||j(g)||re.test((g.textContent||"").trim()))continue;let c=(g.textContent||"").trim();if(c.length<2||c.length>300)continue;if(Array.from(g.children).some(p=>p.className&&p.textContent?.trim())||a.push(g),a.length>=50)break}}}let d=!a.some(l=>["input","select","textarea"].includes(l.tagName.toLowerCase()))&&a.length>0&&a.every(l=>{let u=l.tagName.toLowerCase();if(["input","select","textarea","button"].includes(u))return!1;let g=(l.textContent||"").trim();return!l.id||g.length<10||/^\d+\s*\/\s*\d+$/.test(g)||/^question text/i.test(g)});if(a.length===0||d){d&&(a.length=0);let l=Array.from(document.body.querySelectorAll('[class*="cursor-pointer"][id]'));if(l.length>0)for(let u of l){if(!H(u)||de(u)||Z(u)||j(u)||re.test((u.textContent||"").trim()))continue;let g=(u.textContent||"").trim();if(!(g.length<10||g.length>500)&&!/^\d+\s*\/\s*\d+$/.test(g)&&(a.push(u),a.length>=20))break}}return a.slice(0,100).map(l=>ct(l,"answer"))}function dt(o){let e=[o,o.parentElement,o.parentElement?.parentElement,document.body].filter(Boolean),t=new Set,a=[];for(let r of e)for(let n of Array.from(r.querySelectorAll(we)))if(!(t.has(n)||!H(n)||!Z(n)||j(n))&&(t.add(n),a.push(ct(n,"navigation")),a.length>=10))return a;return a}function ue(o=!1){let e=J();e=je(e),o&&(e=Bt(e));let t=Ve(e),a=dt(e);if(t.length===0){let s=Ve(document.body);s.length>0&&(e=Bt(e),t=Ve(e),t.length===0&&(t=s,e=document.querySelector('main, article, form, [role="main"]')||document.body))}a.length===0&&(a=dt(document.body));let r=e.innerText&&e.innerText.trim().length>0?e.innerText:e.textContent||"",n=r.length>4e4?R(r.slice(0,8e3),8e3)+`
[...conte\xFAdo extenso truncado...]
`+R(r.slice(-2e3),2e3):R(r,16e3),i=[...t,...a].slice(0,120);return!n||i.length===0&&n.length<30?R(document.body.innerText||document.body.textContent||"",16e3).length>=30?le():null:{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:n,htmlSnippet:Qt(e),controls:i,scope:e}}function le(){let o=document.body.innerText||document.body.textContent||document.documentElement.textContent||"",e=R(o,16e3),t=Ve(document.body),a=dt(document.body),r=[...t,...a].slice(0,120),n=document.querySelector('main, article, form, [role="main"], [data-test-id*="content" i], [class*="content" i]')||document.body;return{sourceUrl:window.location.href.slice(0,2e3),pageTitle:document.title.slice(0,500)||"P\xE1gina de Quest\xE3o",questionText:e,htmlSnippet:Qt(n).slice(0,15e3),controls:r,scope:n}}function ut(o){let e=o.controls.map(t=>{let a=t.options?t.options.length:0;return`${t.role}:${t.id}:${t.type}:${a}`}).join("|");return[window.location.href,o.pageTitle,o.questionText.slice(0,400),e].join("::")}function Ue(o){if(!o)return!1;let e=o.toLowerCase();return["?","quest\xE3o","questao","pergunta","exerc\xEDcio","exercicio","assinale","calcule","determine","qual \xE9","qual o","quais","indique","selecione","escolha","responda","julgue","verdadeiro ou falso","complete","resolva","encontre","alternativa","correta","incorreta","m\xB3","cm\xB2","volume","probabilidade","matriz","valor de","resultado de","considere","dada a","sabendo que","quanto vale","obtenha"].some(a=>e.includes(a))}function O(o){return o?!!(o.closest('#easyquiz-shadow-root, .eq-sidebar, .eq-launcher, [data-easyquiz-ignore="true"], .btn-inject-eq, #btn-inject-script')||o.getAttribute?.("data-easyquiz-ignore")==="true"):!1}function q(o){return o==null?"":(typeof o=="string"?o:String(o)).replace(/^(\([0-9a-zA-Z]{1,2}\)|[0-9]{1,3}|[a-zA-Z])[\.\)\-\:]\s+/,"").replace(/[\.\u2026]{2,}/g," ").replace(/['"“”«»]/g,"").replace(/\s+/g," ").trim()}function F(o){if(!o||o instanceof HTMLInputElement||o instanceof HTMLSelectElement||o instanceof HTMLTextAreaElement||o.getAttribute("draggable")==="true"||o.classList.contains("dnd-card")||o.hasAttribute("data-category")||o.hasAttribute("data-dropzone"))return o;if(o.hasAttribute("for")){let a=o.getAttribute("for");if(a){let r=o.ownerDocument.getElementById(a);if(r)return r}}let e=o.closest('label, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, td, li, .dnd-card, [class*="option-card" i], [class*="choice-card" i], .dropdown-row, [class*="dropdown" i], [class*="select-row" i]');if(e&&!["article","section","main","form","body"].includes(e.tagName.toLowerCase())){let a=e.getAttribute("for"),n=(a?e.ownerDocument.getElementById(a):null)||e.querySelector('input:not([type="hidden"]), select, textarea');return n||e}let t=o.closest('button, a, [role="button"], [draggable="true"]');if(t)return t;if(["body","html","main","section","article","form"].includes(o.tagName.toLowerCase())){let a=o.querySelector('button, [role="button"], a, input:not([type="hidden"]), select, textarea, [role="radio"], [role="checkbox"], .option-card, label');if(a)return F(a)}return o}function jt(o){let e=o;if(!e||!document.contains(e))try{e=J()}catch{}e=e||document.body;let t=r=>{let n=Array.from(r.querySelectorAll("tr")).filter(u=>H(u)&&u.querySelector('input[type="radio"], input[type="checkbox"]'));if(n.length>1)return n;let i=Array.from(r.querySelectorAll('input[type="checkbox"], input[type="radio"], [role="checkbox"], [role="radio"]')).filter(u=>H(u)&&!O(u));if(i.length>0)return i;let d=Array.from(r.querySelectorAll('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i], li[class*="choice" i], li[class*="option" i]')).filter(u=>H(u)&&!O(u)).filter(u=>!u.parentElement?.closest('.option-card, [role="option"], [class*="choice-card" i], [class*="option-card" i]'));return d.length>0?d:Array.from(r.querySelectorAll('[class*="classification" i] [class], [class*="draggable-item" i], [class*="drag-item" i], [class*="sortable-card" i]')).filter(u=>{let g=u;return H(g)&&!O(g)&&(g.textContent||"").trim().length>2&&!Z(g)&&!j(g)&&!g.querySelector("[class]")})},a=t(e);return a.length>0?a:e!==document.body?t(document.body):[]}function P(o,e,t=!1){if(o==null)return null;let r=(typeof o=="string"?o:String(o)).trim().replace(/^["'“”«»]+|["'“”«»]+$/g,"");if(!r)return null;let n=Q(r),i=document.querySelector(`[data-easyquiz-id="${n}"]`);if(i&&!O(i))return F(i);try{let c=document.getElementById(r);if(c&&H(c)&&!O(c))return c.hasAttribute("data-category")||c.hasAttribute("data-dropzone")||c.classList.contains("dnd-zone")?c:F(c)}catch{}try{let c=document.querySelector(`[data-item-id="${n}"]`);if(c&&H(c)&&!O(c))return F(c)}catch{}let s=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao|campo|blank|lacuna|input|resposta)?\s*#?_?([0-9]+)$/i);if(s){let c=parseInt(s[1],10);if(t){let p=document.body;try{p=J()||document.body}catch{}let f=Array.from(p.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(h=>H(h)&&!O(h));if(c>=1&&c-1<f.length)return f[c-1];if(c===0&&f.length>0)return f[0]}let m=c-1;if(m>=0){let p=jt();if(m<p.length){let b=p[m];if(b.tagName.toLowerCase()==="tr"){if(e){let y=b.querySelector(`input[value="${Q(e)}" i], [data-value="${Q(e)}" i]`);if(y)return y}let A=b.querySelector("input");if(A)return A}return F(b)}let f=document.body;try{f=J()||document.body}catch{}let h=Array.from(f.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(b=>H(b)&&!O(b));if(m<h.length)return h[m]}}let d=r.match(/^(?:item|opção|opcao|afirmação|afirmacao|alternativa|linha|afirmativa|questão|questao)?\s*#?([a-eA-E])$/i);if(d){let c=d[1].toUpperCase(),m=c.charCodeAt(0)-65,p=Array.from(document.querySelectorAll(`input[type="radio"][value="${c}" i], input[type="checkbox"][value="${c}" i]`)).find(h=>H(h)&&!O(h));if(p)return F(p);let f=Array.from(document.querySelectorAll('.option-card, .choice, .answer, label, [role="radio"], [role="checkbox"]')).find(h=>{if(!H(h)||O(h))return!1;let A=(h.querySelector('.option-badge, .badge, [class*="badge" i], [class*="letter" i]')?.textContent||"").trim().toUpperCase();if(A===c||A===`${c})`||A===`(${c})`||A===`${c}.`||A===`${c}:`)return!0;let y=(h.textContent||"").trim().toUpperCase();return y.startsWith(`${c})`)||y.startsWith(`(${c})`)||y.startsWith(`${c}.`)||y.startsWith(`${c}:`)});if(f)return F(f);if(m>=0){let h=jt();if(m<h.length){let b=h[m];if(b.tagName.toLowerCase()==="tr"){if(e){let y=b.querySelector(`input[value="${Q(e)}" i], [data-value="${Q(e)}" i]`);if(y)return y}let A=b.querySelector("input");if(A)return A}return F(b)}}}if(/^[a-zA-Z0-9_-]{1,10}$/.test(r)){let m=Array.from(document.querySelectorAll(`[data-category="${n}" i], [data-dropzone="${n}" i], [data-role="dropzone"][data-category="${n}" i]`)).find(b=>H(b)&&!O(b));if(m)return m;let f=Array.from(document.querySelectorAll(`input[value="${n}" i], [data-value="${n}" i], input[id="${n}" i], input[placeholder="${n}" i], textarea[placeholder="${n}" i], [title="${n}" i]`)).find(b=>H(b)&&!O(b));if(f)return F(f);let h=Array.from(document.querySelectorAll('.option-badge, [class*="badge" i], [class*="letter" i], .option-card span, label span')).find(b=>{if(!H(b)||O(b))return!1;let A=q(b.textContent).toLowerCase();return A===r.toLowerCase()||A===r.toLowerCase()+")"});if(h)return F(h)}try{let c=Array.from(document.querySelectorAll(`[name="${n}"], [value="${n}"], [placeholder="${n}" i], [title="${n}" i], [data-category="${n}" i], [data-dropzone="${n}" i], [data-testid="${n}" i], [data-test-id="${n}" i], [aria-label="${n}" i]`));if(e){let p=c.find(f=>{if(!H(f)||O(f))return!1;if(f instanceof HTMLInputElement&&f.value.toLowerCase()===e.toLowerCase())return!0;let h=f.closest("label, .vf-label, td, div");return h&&q(h.textContent).toLowerCase().includes(q(e).toLowerCase())});if(p)return F(p)}let m=c.find(p=>H(p)&&!O(p));if(m)return m.hasAttribute("data-category")||m.hasAttribute("data-dropzone")||m.classList.contains("dnd-zone")?m:F(m)}catch{}if(/^[.#\[]|\s|[>+~:]/.test(r))try{let m=Array.from(document.querySelectorAll(r)).find(p=>H(p)&&!O(p));if(m)return F(m)}catch{}try{let c=r.replace(/"/g,""),m=`//button[normalize-space(.)="${c}"] | //a[normalize-space(.)="${c}"] | //*[not(*) and normalize-space(.)="${c}"] | //*[@aria-label="${c}"] | //*[@data-category="${c}"] | //*[@data-testid="${c}"]`,p=document.evaluate(m,document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(let f=0;f<p.snapshotLength;f++){let h=p.snapshotItem(f);if(h&&H(h)&&!O(h)){if(["body","html"].includes(h.tagName.toLowerCase())){let A=h.querySelector('button, [role="button"], a, input, [role="radio"], [role="checkbox"], label');if(A&&H(A))return F(A)}return h.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||F(h)}}}catch{}let u=q(r).toLowerCase(),g=Array.from(document.querySelectorAll('button, a, div, span, li, p, label, input, textarea, select, [draggable="true"], [data-testid], [class*="option" i], [class*="card" i], [class*="item" i], [class*="choice" i], [class*="category" i], [class*="bucket" i]'));for(let c of g){if(!H(c)||O(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||j(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=q(c.textContent).toLowerCase(),f=q(c.getAttribute("aria-label")||"").toLowerCase(),h=q(c.getAttribute("placeholder")||"").toLowerCase(),b=q(c.getAttribute("title")||"").toLowerCase(),A=q(c.getAttribute("name")||"").toLowerCase(),y=q(c.getAttribute("data-category")||"").toLowerCase(),v=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"",x=q(v).toLowerCase(),E=p.startsWith(u+")")||p.startsWith(u+".")||p.startsWith(u+" -")||p.startsWith(u+":");if(p===u||f===u||h===u||b===u||A===u||y&&y===u||x&&x===u||E)return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||F(c)}if(u.length>=3)for(let c of g){if(!H(c)||O(c)||c.closest("header, nav, .stepper, .step-item, .progress-bar-container")||j(c)||!!(c.matches('article, section, form, main, [class*="container" i], [class*="grid" i], .dnd-pool, .dnd-zones')||c.querySelector('label, [role="radio"], [role="checkbox"], .dnd-card, [draggable="true"], .option-card, tr'))&&!c.matches(".dnd-zone, [data-category], [data-dropzone]"))continue;let p=q(c.textContent).toLowerCase(),f=q(c.getAttribute("aria-label")||"").toLowerCase(),h=q(c.getAttribute("placeholder")||"").toLowerCase(),b=q(c.getAttribute("title")||"").toLowerCase(),A=q(c.getAttribute("name")||"").toLowerCase();if(p.includes(u)||f.includes(u)||h.includes(u)||b.includes(u)||A.includes(u)){if(Array.from(c.children).some(E=>{let T=q(E.textContent).toLowerCase();return T&&T.includes(u)}))continue;return c.closest('[data-role="dropzone"], [class*="category" i], [class*="bucket" i], [class*="column" i], [class*="drop" i]')||F(c)}let y=u.split(/\s+/).filter(Boolean);if(y.length>=3){let v=y.slice(0,Math.min(5,y.length)).join(" ");if(p.includes(v)||f.includes(v)||h.includes(v))return F(c)}}return null}function Vt(o,e){for(let t of e)o.dispatchEvent(new Event(t,{bubbles:!0,composed:!0}))}function oe(o,e){if(!o)return;try{o.scrollIntoView({block:"nearest",inline:"nearest",behavior:"instant"})}catch{}try{o.focus?.()}catch{}let t=o.getBoundingClientRect(),a=e?e[0]:Math.round(t.left+Math.max(1,t.width/2)),r=e?e[1]:Math.round(t.top+Math.max(1,t.height/2)),n={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:a,clientY:r};try{o.dispatchEvent(new PointerEvent("pointerover",{...n}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseover",{...n}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerdown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new MouseEvent("mousedown",{...n,button:0,buttons:1}))}catch{}try{o.dispatchEvent(new PointerEvent("pointerup",{...n,button:0,buttons:0}))}catch{}try{o.dispatchEvent(new MouseEvent("mouseup",{...n,button:0,buttons:0}))}catch{}if(typeof o.click=="function")try{o.click()}catch{try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}}else try{o.dispatchEvent(new MouseEvent("click",{...n,button:0,buttons:0}))}catch{}try{let i=Object.keys(o).find(s=>s.startsWith("__reactFiber")||s.startsWith("__reactInternalInstance"));if(i){let s=o[i];for(;s;){let d=s.memoizedProps||s.pendingProps;if(d?.onClick){d.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}});break}s=s.return}}}catch{}try{let i=Object.keys(o).find(s=>s.startsWith("__reactProps"));if(i){let s=o[i];s?.onClick&&s.onClick({type:"click",target:o,currentTarget:o,bubbles:!0,cancelable:!0,preventDefault:()=>{},stopPropagation:()=>{}})}}catch{}try{let i=o._vei;i?.onClick&&(Array.isArray(i.onClick.value)?i.onClick.value:[i.onClick.value]).forEach(d=>{try{d({type:"click",target:o})}catch{}})}catch{}try{o.$onclick&&o.$onclick({type:"click",target:o,preventDefault:()=>{},stopPropagation:()=>{}})}catch{}try{if(!!(document.querySelector('meta[content*="google.com/forms"], form[action*="formResponse"]')||o.closest("[data-item-id], [jsmodel], [jsaction], .freebirdFormviewerComponentsQuestionBaseRoot"))){let s=o.querySelector('input[type="radio"], input[type="checkbox"]');s&&(s.focus?.(),s.click(),Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,!0),s.dispatchEvent(new Event("change",{bubbles:!0})));let d=o.closest("[jsaction]");if(d&&d!==o)try{d.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,clientX:a,clientY:r}))}catch{}}}catch{}if(o.getAttribute("role")==="button"||o.getAttribute("tabindex")!==null)try{o.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0}))}catch{}}function ft(o){try{let e=o.id,t=!!e;e||(e=`__eq_tmp_${Math.random().toString(36).slice(2,8)}`,o.id=e);let a=document.createElement("script");return a.textContent=`(function(){var el=document.getElementById(${JSON.stringify(e)});if(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,composed:true,view:window}));if(typeof el.click==='function')el.click();var fk=Object.keys(el).find(function(k){return k.startsWith('__reactFiber')||k.startsWith('__reactInternalInstance');});if(fk){var fb=el[fk];while(fb){var mp=fb.memoizedProps||fb.pendingProps;if(mp&&typeof mp.onClick==='function'){try{mp.onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}break;}fb=fb.return;}}var pk=Object.keys(el).find(function(k){return k.startsWith('__reactProps');});if(pk&&el[pk]&&typeof el[pk].onClick==='function'){try{el[pk].onClick({type:'click',target:el,currentTarget:el,bubbles:true,cancelable:true,preventDefault:function(){},stopPropagation:function(){}});}catch(e){}}if(el._vei&&el._vei.onClick){var h=el._vei.onClick.value;var hs=Array.isArray(h)?h:[h];hs.forEach(function(fn){try{fn({type:'click',target:el});}catch(e){}});}}})()`,document.head.appendChild(a),a.remove(),t||setTimeout(()=>{try{o.id===e&&o.removeAttribute("id")}catch{}},0),!0}catch{return!1}}function Xe(o,e){let t=o;if(t.hasAttribute("for")){let l=t.getAttribute("for"),u=t.ownerDocument.getElementById(l);u&&(t=u)}if(typeof HTMLSelectElement<"u"&&t instanceof HTMLSelectElement||t.tagName?.toLowerCase()==="select"||t.getAttribute("role")==="combobox"||t.getAttribute("role")==="listbox"||t.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')){Ke(t,[e]);return}let r=t.querySelector('select, [role="combobox"], [role="listbox"]');if(r){Ke(r,[e]);return}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=t.querySelector('input:not([type="hidden"]), textarea, select, [contenteditable="true"]');if(l)t=l;else{let g=t.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, select, [contenteditable="true"]');if(g)t=g;else{let c=t.nextElementSibling;for(;c;){if(c instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(c.type)||c instanceof HTMLTextAreaElement||c instanceof HTMLElement&&c.isContentEditable){t=c;break}let m=c.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(m){t=m;break}c=c.nextElementSibling}}}}if(t instanceof HTMLButtonElement||t.tagName.toLowerCase()==="a"||t.getAttribute("role")==="button"||t instanceof HTMLInputElement&&["button","submit","reset","image"].includes(t.type)){let l=t.parentElement?.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(l)t=l;else{let u=document.body;try{u=J()||document.body}catch{}let g=u.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(g)t=g;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}}if(!(t instanceof HTMLInputElement)&&!(t instanceof HTMLTextAreaElement)&&!(t instanceof HTMLSelectElement)&&!t.isContentEditable){let l=document.body;try{l=J()||document.body}catch{}let u=l.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(u)t=u;else{console.warn("[EasyQuiz] setNativeValue: Nenhum campo de texto encontrado para receber o valor.");return}}if(t instanceof HTMLInputElement&&["checkbox","radio"].includes(t.type)){let l=["true","1","checked","yes","sim"].includes(e.toLowerCase())||e===t.value;pe(t,l);return}let i=String(e??""),s=i;if(t instanceof HTMLInputElement&&t.type==="number"){let l=i.replace(",",".").replace(/[^0-9.-]/g,"");l&&!isNaN(Number(l))&&(s=l)}try{t.scrollIntoView?.({block:"center",inline:"center",behavior:"instant"}),t.focus?.()}catch{}try{if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,""):t.value="";try{t.select?.()}catch{}}else if(t.isContentEditable){t.textContent="";try{document.execCommand?.("selectAll",!1,void 0)}catch{}}}catch{}let d=!1;try{t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.type!=="number"&&t.type!=="range"&&(d=document.execCommand?.("insertText",!1,s)||!1):t.isContentEditable&&(d=document.execCommand?.("insertText",!1,s)||!1)}catch{}if(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement){try{let g=t._valueTracker;g&&g.setValue(s===""?" ":"")}catch{}let l=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(l,"value")?.set;u?u.call(t,s):t.value=s;try{t.dispatchEvent(new KeyboardEvent("keydown",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new KeyboardEvent("keyup",{bubbles:!0,cancelable:!0,key:s.slice(-1)||"a"}))}catch{}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}if(t.value!==s&&!(t instanceof HTMLInputElement&&t.type==="number"&&Number(t.value)===Number(s))){t.value=s;try{u?.call(t,s)}catch{}}return}if(t.isContentEditable){if(t.textContent?.trim()!==s.trim()){t.textContent=s;try{t.innerText=s}catch{}}try{t.dispatchEvent(new InputEvent("input",{bubbles:!0,cancelable:!0,composed:!0,data:s,inputType:"insertText"}))}catch{t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0}))}try{t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}try{t.dispatchEvent(new FocusEvent("blur",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}return}try{"value"in t&&(t.value=s),t.dispatchEvent(new Event("input",{bubbles:!0,cancelable:!0,composed:!0})),t.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))}catch{}}function Me(o,e=""){if(o==null)return e;let t=typeof o=="string"?o:String(o);if(!t)return e;let a=/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(t),r=q(t),n=P(t)||P(r);if(!n)return a?e:r||e;let i=n.closest('label, .option-card, [class*="choice" i], [class*="option" i], .quiz-option, tr, td, li');if(i){let g=q(i.textContent);if(g&&g.length>0&&g.length<150)return g}if(n.id){let g=document.querySelector(`label[for="${Q(n.id)}"]`);if(g){let c=q(g.textContent);if(c&&c.length>0&&c.length<150)return c}}let s=n.getAttribute("aria-label");if(s)return q(s);let d=n.getAttribute("placeholder");if(d)return q(d);let l=q(n.textContent);if(l&&l.length>0&&l.length<120)return l;let u=n instanceof HTMLInputElement||n instanceof HTMLButtonElement?n.value:"";return u?q(u):a?e:r||e}function pe(o,e){if(!o)return;let t=o.closest('label, td, .option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], li')||o,a=o instanceof HTMLInputElement&&["checkbox","radio"].includes(o.type)?o:t.querySelector('input[type="checkbox"], input[type="radio"]');!a&&t.hasAttribute("for")&&(a=t.ownerDocument.getElementById(t.getAttribute("for")));let r=o instanceof HTMLInputElement?o.closest("label")||(o.id?t.ownerDocument.getElementById(t.getAttribute("for")):null)||o:t&&H(t)?t:o;if(a){let n=a.type==="radio",i=a.type==="checkbox",s=!!a._valueTracker;if(a.checked===e){if(n&&e){t.setAttribute("aria-checked","true"),t.setAttribute("aria-selected","true"),t.classList.add("selected","active","checked");return}if(i){t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e);return}}if(r&&r!==a&&oe(r),a.checked!==e)try{a.focus?.(),a.click()}catch{}if(a.checked!==e){try{let l=a._valueTracker;l&&l.setValue(!e)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(a,e)}catch{}a.checked=e,Vt(a,["input","change"])}t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}else{if((t.getAttribute("aria-checked")==="true"||t.getAttribute("aria-selected")==="true"||t.getAttribute("data-selected")==="true"||t.getAttribute("data-checked")==="true"||t.classList.contains("selected")||t.classList.contains("active")||t.classList.contains("checked"))===e&&e)return;oe(r),t.setAttribute("aria-checked",e?"true":"false"),t.setAttribute("aria-selected",e?"true":"false"),t.classList.toggle("selected",e),t.classList.toggle("active",e),t.classList.toggle("checked",e)}}function Ke(o,e){let t=typeof HTMLSelectElement<"u"&&o instanceof HTMLSelectElement||o.tagName?.toLowerCase()==="select"?o:o.querySelector("select");if(t){let i=e.map(l=>q(l).toLowerCase()),s=!1,d=(l,u)=>{l.selected=!0,t.selectedIndex=u;try{t.value=l.value}catch{}try{Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value")?.set?.call(t,l.value)}catch{}try{let g=t._valueTracker;g&&g.setValue(l.value)}catch{}s=!0};for(let l=0;l<t.options.length;l++){let u=t.options[l],g=u.value.toLowerCase(),c=q(u.textContent).toLowerCase();if(i.some(p=>p===g||p===c)){if(d(u,l),!t.multiple)break}else t.multiple||(u.selected=!1)}if(!s)for(let l of i){let u=l.match(/^(?:item|opção|opcao|alternativa|linha|escolha|campo)?\s*#?_?([0-9]+)$/i);if(u){let g=parseInt(u[1],10),m=t.options[0]?.value===""||t.options[0]?.disabled?g:g>=1?g-1:0;if(m>=0&&m<t.options.length&&(d(t.options[m],m),!t.multiple))break}}if(!s){for(let l of i)if(/^[a-z]$/i.test(l)){let u=l.toUpperCase().charCodeAt(0)-65,c=t.options[0]?.value===""||t.options[0]?.disabled?u+1:u;if(c>=0&&c<t.options.length&&(d(t.options[c],c),!t.multiple))break}}if(!s){let l=u=>u.normalize("NFD").replace(/[\u0300-\u036f]/g,"");for(let u=0;u<t.options.length;u++){let g=t.options[u],c=l(g.value.toLowerCase()),m=l(q(g.textContent).toLowerCase());if(i.some(f=>{let h=l(f);return c.includes(h)||m.includes(h)||h.length>2&&(h.includes(c)||h.includes(m))})&&(d(g,u),!t.multiple))break}}if(s){Vt(t,["focus","input","change","blur"]);return}}let a=o.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?o:o.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');a&&oe(a);let r=e.map(i=>q(i).toLowerCase()),n=Array.from(document.querySelectorAll('[role="listbox"] [role="option"], [role="menu"] [role="menuitem"], .select-dropdown li, .dropdown-menu .dropdown-item, .ant-select-item-option, .MuiMenuItem-root, [class*="option-item"], li[data-value]')).filter(i=>H(i)&&!O(i));for(let i of r){let s=n.find(l=>{let u=q(l.textContent).toLowerCase(),g=q(l.getAttribute("data-value")||l.getAttribute("value")||"").toLowerCase();return u===i||g===i||u.includes(i)||i.length>2&&i.includes(u)});if(s){oe(s);let l=s.querySelector('input[type="radio"], input[type="checkbox"]');l&&pe(l,!0);return}let d=P(i);if(d){oe(d);return}}}function Ao(o,e){try{let t=new DataTransfer;try{t.setData("text/plain",o)}catch{}try{t.setData("text/html",e)}catch{}return t}catch{return null}}function pt(o){try{o.click()}catch{let e=o.ownerDocument.defaultView||window;o.dispatchEvent(new e.MouseEvent("click",{bubbles:!0,cancelable:!0,composed:!0,view:e}))}}function vo(o,e,t){try{if(e.contains(o))return{success:!0,evidence:"origin is child of dest (DOM move confirmed)"};if(!document.body.contains(o))return{success:!0,evidence:"origin removed from DOM (consumed by framework)"};let a=e.children.length;if(t!==void 0&&a>t)return{success:!0,evidence:`dest child count increased: ${t} \u2192 ${a}`};if([o.getAttribute("data-placed")==="true",o.getAttribute("data-assigned")==="true",o.getAttribute("data-matched")==="true",o.getAttribute("aria-grabbed")==="false",/placed|dropped|assigned|matched|done|sorted|categorized/i.test(o.className||"")].some(Boolean))return{success:!0,evidence:"origin has placement indicator: class/attr"};let n=(o.textContent||"").trim().toLowerCase();return n.length>2&&Array.from(e.querySelectorAll("*")).some(d=>d!==e&&(d.textContent||"").trim().toLowerCase()===n)?{success:!0,evidence:"origin text found inside dest children (clone or DOM move)"}:e.getAttribute("data-count")&&parseInt(e.getAttribute("data-count")||"0")>0?{success:!0,evidence:"dest data-count > 0, categorization likely succeeded"}:o.getAttribute("aria-hidden")==="true"||o.style.display==="none"||o.style.visibility==="hidden"?{success:!0,evidence:"origin hidden after drop (framework confirmed placement)"}:{success:!1,evidence:"no DOM evidence of successful drag/categorization"}}catch{return{success:!1,evidence:"verification threw exception"}}}function te(o,e){let t=q(o).toLowerCase();if(!t)return null;if(e==="source"){if(/^[0-9a-f]{10,}$/.test(o.trim())){let s=document.getElementById(o.trim());if(s&&H(s)&&!O(s))return s}let i=['[class*="cursor-grab"][id]',".dnd-card",'[draggable="true"]'];for(let s of i){let l=Array.from(document.querySelectorAll(s)).find(u=>{if(!H(u)||O(u))return!1;let g=q(`${u.id} ${u.textContent||""} ${u.getAttribute("data-id")||""}`).toLowerCase();return g===t||g.includes(t)||u.id===o.trim()});if(l)return l}return null}let a=["[data-dropzone]","[data-category]",'[data-role="dropzone"]','[class*="dropzone" i]','[class*="list-group" i]','[class*="classification-group" i]'].join(","),r=Array.from(document.querySelectorAll(a)),n=r.find(i=>[i.getAttribute("data-category"),i.getAttribute("data-dropzone")].some(s=>s?.trim().toLowerCase()===t));return n&&H(n)&&!O(n)?n:r.find(i=>{if(!H(i)||O(i)||/unclassified/i.test(i.className))return!1;let s=i.querySelector('.font-bold, h1, h2, h3, h4, [class*="header" i], [class*="title" i], [class*="label" i]'),d=q(s?.textContent||i.textContent||"").toLowerCase();return d.includes("op")&&(d.includes("es")||d.includes("\xF5es"))?!1:d===t||d.startsWith(t)||d.includes(t)})||null}async function Fe(o,e,t=1){try{o.scrollIntoView({block:"center",inline:"center",behavior:"instant"})}catch{}let a=o.getBoundingClientRect(),r=e.getBoundingClientRect(),n=Math.round(a.left+Math.max(1,a.width/2)),i=Math.round(a.top+Math.max(1,a.height/2)),s=Math.round(r.left+Math.max(1,r.width/2)),d=Math.round(r.top+Math.max(1,r.height/2)),l=q(e.textContent).toLowerCase();if(l){let f=Array.from(o.querySelectorAll('button, [role="button"], input[type="radio"], input[type="checkbox"], option, .btn, [class*="tag" i]')).find(h=>{let b=q(h.textContent).toLowerCase(),A=h instanceof HTMLInputElement||h instanceof HTMLOptionElement?q(h.value).toLowerCase():"";return b&&(l.includes(b)||b.includes(l))||A&&(l.includes(A)||A.includes(l))});f&&(oe(f),await new Promise(h=>setTimeout(h,120)))}pt(o),await new Promise(p=>setTimeout(p,140)),pt(e);let u=e.querySelector('[data-role="dropzone"], [class*="bucket" i], [class*="slot" i], [class*="drop" i], [class*="target" i], [class*="items" i], ul, ol');if(u&&u!==e&&pt(u),await new Promise(p=>setTimeout(p,100)),!e.contains(o)&&o.matches('.dnd-card, [draggable="true"]')&&e.matches('.dnd-zone, [data-dropzone], [data-role="dropzone"]')&&e.appendChild(o),e.contains(o)&&o.matches('.dnd-card, [draggable="true"]'))return;let g={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:i,screenX:n,screenY:i,button:0,buttons:1};try{o.dispatchEvent(new PointerEvent("pointerdown",{...g,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}o.dispatchEvent(new MouseEvent("mousedown",g));let c=4;for(let p=1;p<=c;p++){let f=Math.round(n+(s-n)*(p/c)),h=Math.round(i+(d-i)*(p/c)),b={...g,clientX:f,clientY:h,screenX:f,screenY:h};try{o.dispatchEvent(new PointerEvent("pointermove",{...b,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:.5}))}catch{}document.dispatchEvent(new MouseEvent("mousemove",b))}let m={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:s,clientY:d,screenX:s,screenY:d,button:0,buttons:0};try{e.dispatchEvent(new PointerEvent("pointerup",{...m,isPrimary:!0,pointerId:1,pointerType:"mouse",pressure:0}))}catch{}e.dispatchEvent(new MouseEvent("mouseup",m)),e.dispatchEvent(new MouseEvent("click",m));try{let p=Ao(R(o.textContent),o.outerHTML),f={...g},h={...m};p&&(f.dataTransfer=p,h.dataTransfer=p);let b=o.ownerDocument.defaultView?.DragEvent;if(!b)throw new Error("DragEvent n\xE3o dispon\xEDvel neste documento");o.dispatchEvent(new b("dragstart",f)),e.dispatchEvent(new b("dragenter",h)),e.dispatchEvent(new b("dragover",h)),e.dispatchEvent(new b("drop",h)),o.dispatchEvent(new b("dragend",f))}catch(p){console.warn("[EasyQuiz] DragEvent ignorado com seguran\xE7a:",p)}try{let p=new Touch({identifier:1,target:o,clientX:n,clientY:i}),f=new Touch({identifier:1,target:e,clientX:s,clientY:d});o.dispatchEvent(new TouchEvent("touchstart",{bubbles:!0,cancelable:!0,touches:[p]})),e.dispatchEvent(new TouchEvent("touchmove",{bubbles:!0,cancelable:!0,touches:[f]})),e.dispatchEvent(new TouchEvent("touchend",{bubbles:!0,cancelable:!0,touches:[]}))}catch{}if(t>=2&&!e.contains(o))try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),o.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await new Promise(p=>setTimeout(p,80)),e.focus?.(),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}catch{}if(!e.contains(o))try{let p=b=>{let A=Object.keys(b).find(v=>v.startsWith("__reactFiber")||v.startsWith("__reactInternalInstance"));if(!A)return null;let y=b[A];for(let v=0;v<10&&y;v++){if(y.memoizedProps)return y.memoizedProps;y=y.return}return null},f=p(o),h=p(e);if(f){let b=f.onMouseDown||f.onPointerDown||f.onDragStart;if(typeof b=="function")try{b({type:"mousedown",button:0,buttons:1,clientX:n,clientY:i,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:o,target:o}),await new Promise(A=>setTimeout(A,100))}catch{}}if(h){let b=h.onMouseUp||h.onPointerUp||h.onDrop;if(typeof b=="function")try{b({type:"mouseup",button:0,buttons:0,clientX:s,clientY:d,bubbles:!0,preventDefault:()=>{},stopPropagation:()=>{},currentTarget:e,target:e})}catch{}}try{o.focus?.(),o.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,200));let b=d>i?"ArrowDown":"ArrowUp";for(let A=0;A<3;A++)document.dispatchEvent(new KeyboardEvent("keydown",{key:b,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,60));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(A=>setTimeout(A,80))}catch{}try{!!document.querySelector("[data-rbd-draggable-id], [data-rbd-droppable-id], [data-dnd-kit-sortable]")&&(o.dispatchEvent(new CustomEvent("dndkitdragstart",{bubbles:!0,cancelable:!0,detail:{id:o.id||o.getAttribute("data-id")}})),await new Promise(A=>setTimeout(A,100)),e.dispatchEvent(new CustomEvent("dndkitdrop",{bubbles:!0,cancelable:!0,detail:{overId:e.id||e.getAttribute("data-id")}})))}catch{}}catch(p){console.warn("[EasyQuiz] Estrat\xE9gia G (React DnD internals) falhou:",p)}}function Ut(o,e,t,a){let r=l=>l.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').slice(0,100),n=r(o.toLowerCase()),i=r(e.toLowerCase()),s=r(t),d=r(a);return`var src=$eq.find('${s}')||Array.from(document.querySelectorAll('[draggable],[class*="cursor-grab"],[class*="dnd-card"]')).find(function(e){return (e.textContent||'').toLowerCase().includes('${n}');});var dst=Array.from(document.querySelectorAll('[class*="list-group"],[class*="dropzone"],[data-category],[data-rbd-droppable-id]')).find(function(e){var h=e.querySelector('.font-bold,h1,h2,h3,h4,[class*="header"]');var t=(h||e);return (t.textContent||'').toLowerCase().includes('${i}');});if(src&&dst){dst.appendChild(src);[src,dst].forEach(function(el){try{el.dispatchEvent(new Event('change',{bubbles:true}));}catch(e){}try{el.dispatchEvent(new CustomEvent('dndkitdrop',{bubbles:true,detail:{}}));}catch(e){}});}else{console.warn('[EQ-drag-fallback] nao localizado: ${n} -> ${i}');}`}var Xt={fill:(o,e)=>{let t=P(o);t?Xe(t,e):console.warn(`$eq.fill: Elemento '${o}' n\xE3o encontrado`)},click:o=>{let e=P(o);e?!!(e.closest('.option-card, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i]')||e.querySelector('input[type="radio"], input[type="checkbox"]')||e instanceof HTMLInputElement&&["checkbox","radio"].includes(e.type))?pe(e,!0):oe(e):console.warn(`$eq.click: Elemento '${o}' n\xE3o encontrado`)},check:(o,e)=>{let t=P(o);t?pe(t,e):console.warn(`$eq.check: Elemento '${o}' n\xE3o encontrado`)},find:(o,e)=>P(o,e),drag:(o,e)=>{let t=te(o,"source")||P(o),a=te(e,"destination")||P(e);t&&a?Fe(t,a):console.warn(`$eq.drag: Origem ou destino n\xE3o encontrado ('${o}' -> '${e}')`)},categorize:async(o,e)=>{let t=te(o,"source")||P(o),a=te(e,"destination")||P(e);if(!t||!a){console.warn(`$eq.categorize: Item ou categoria n\xE3o encontrados ('${o}' -> '${e}')`);return}await Fe(t,a)},execute:(o,e=!1,t=1)=>Ie(o,e,t)};typeof window<"u"&&(window.$eq=Xt);async function yo(o,e=1,t=Ae()){if(it(o,t),o.t==="js"){let d=String(o.v||"");Ot(d);try{new Function("$eq","document","window",d)(Xt,document,window)}catch(l){throw console.warn("[EasyQuiz JS Execution]",l),l}return}if(o.t==="drag"){let d=te(o.from,"source")||P(o.from),l=te(o.to,"destination")||P(o.to);!d&&o.from&&(d=P(q(o.from))),!l&&o.to&&(l=P(q(o.to))),d&&l?await Fe(d,l,e):console.warn(`[EasyQuiz] Drag: alvo n\xE3o encontrado ('${o.from}' -> '${o.to}')`);return}let a=o.id!==void 0&&o.id!==null?String(o.id):"";!a&&o.t==="val"&&(a=o.target??o.name??o.selector??"1");let r=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,n=r!=null?String(r).trim():"",i=null,s=String(o.name??o.n??"").trim();if(!s&&a&&document.querySelector(`input[type="radio"][name="${Q(a)}"]`)&&(s=a),(o.t==="chk"||o.t==="clk")&&s){let d=Array.from(document.querySelectorAll(`input[name="${Q(s)}"]`));if(n&&(i=d.find(l=>l.value?.toLowerCase()===n.toLowerCase())??null),!i&&n){let l=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(n),u=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(n);if(l||u){let g=l?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];i=d.find(c=>{let m=c.value?.toLowerCase()??"";if(g.includes(m))return!0;let f=(c.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return g.some(h=>f===h||f.startsWith(h+" ")||f.startsWith("("+h+")"))})??null}}!i&&d.length>0&&(i=d[0])}if(i||(i=P(a,n,o.t==="val"||o.t==="sel")),!i&&a&&(i=P(q(a),n,o.t==="val"||o.t==="sel")),i&&n){if(i instanceof HTMLInputElement&&i.type==="radio"&&i.name){if(q(i.value).toLowerCase()!==q(n).toLowerCase()){let d=document.querySelector(`input[type="radio"][name="${Q(i.name)}"][value="${Q(n)}" i]`);if(d)i=d;else{let u=Array.from(document.querySelectorAll(`input[type="radio"][name="${Q(i.name)}"]`)).find(g=>{let c=g.closest("label, .vf-label, .option-card, tr, td, div");return c&&q(c.textContent).toLowerCase().includes(q(n).toLowerCase())});u&&(i=u)}}}else if(!(i instanceof HTMLInputElement)&&!(i instanceof HTMLSelectElement)&&!(i instanceof HTMLTextAreaElement)){let d=i.querySelector(`input[value="${Q(n)}" i], [data-value="${Q(n)}" i]`);if(d)i=d;else{let u=Array.from(i.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(g=>{let c=g.closest("label, .vf-label, .option-card, td, div");return c&&q(c.textContent).toLowerCase().includes(q(n).toLowerCase())});u&&(i=u)}}}if(!i&&(o.t==="val"||o.t==="sel")){let d=document.body;try{d=J()||document.body}catch{}let l=Array.from(d.querySelectorAll(o.t==="sel"?'select, [role="combobox"], [role="listbox"]':'input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, select, [contenteditable="true"]')).filter(u=>H(u)&&!O(u));if(l.length===1)i=l[0];else if(l.length>1){let u=q(a).toLowerCase(),g=u.match(/^#?_?([0-9]+)$/);if(g){let c=parseInt(g[1],10);c>=1&&c<=l.length?i=l[c-1]:c>=0&&c<l.length&&(i=l[c])}i||(i=l.find(m=>{let p=(m.getAttribute("placeholder")||"").toLowerCase(),f=(m.name||"").toLowerCase(),h=(m.getAttribute("aria-label")||"").toLowerCase(),b=(m.id||"").toLowerCase(),A=q(lt(m)).toLowerCase(),y=q(m.closest('label, tr, td, .form-group, .field, [class*="row" i], div')?.textContent||"").toLowerCase();return p.includes(u)||f.includes(u)||h.includes(u)||b.includes(u)||A&&A.includes(u)||u.length>=2&&y.includes(u)})||(l.length===1?l[0]:null))}}if(!i&&o.t!=="adv")throw new Error(`Alvo '${a}' n\xE3o encontrado no DOM para a\xE7\xE3o '${o.t}'.`);switch(o.t){case"val":if(i){let u=i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement||i instanceof HTMLSelectElement||i.isContentEditable?i:i.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');if(!u){let p=i.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(u=p)}if(!u){let m=i.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){u=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){u=p;break}m=m.nextElementSibling}}if(!u){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>H(f)&&!O(f));p.length>0&&(u=p[0])}let g=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,c=g!=null?String(g):"";Xe(u||i,c)}break;case"chk":let d=o.c!==void 0?!!o.c:!0;i&&pe(i,d);break;case"sel":if(i){let u=Array.isArray(o.v)?o.v:[String(o.v)];Ke(i,u)}break;case"clk":if(i)if(!!(i.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, [class*="option" i], [class*="choice" i], [class*="answer" i], li, tr')||i.querySelector('input[type="radio"], input[type="checkbox"]')||i instanceof HTMLInputElement&&["checkbox","radio"].includes(i.type))){let g=o.c!==void 0?!!o.c:!0;pe(i,g)}else oe(i,o.co);break;case"adv":let l=Kt(o.id);if(l){await mt(l,1200);let u=o.id||l.textContent?.trim()||"";u&&et(window.location.hostname,{advanceSelector:u}),oe(l)}else console.warn("[EasyQuiz] Bot\xE3o de avan\xE7o n\xE3o localizado.");break}}function xo(){let o=["button","a",'[role="button"]','input[type="submit"]','input[type="button"]','[data-testid*="check" i]','[data-test-id*="check" i]'].join(",");return Array.from(document.querySelectorAll(o)).find(t=>{if(!H(t)||O(t)||t.closest("header, nav, aside"))return!1;let a=t instanceof HTMLInputElement||t instanceof HTMLButtonElement?t.value:"",r=(t.textContent||a||t.getAttribute("aria-label")||"").trim();return/(verificar|checar|check|conferir|validar|enviar|responder)/i.test(r)})||null}function Kt(o){let e=c=>{let m=(c.getAttribute("aria-label")||c.textContent||(c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"")||"").trim();return re.test(m)};if(o){let c=P(o);if(c&&H(c)&&!O(c)&&!j(c)&&!e(c))return c}try{let c=_e(window.location.hostname);if(c.advanceSelector){let m=P(c.advanceSelector);if(m&&H(m)&&!O(m)&&!j(m)&&!e(m))return m}}catch{}let t=["button","a",'[role="button"]','[role="link"]','input[type="button"]','input[type="submit"]','[data-testid*="next" i]','[data-testid*="continue" i]','[data-testid*="check" i]','[data-test-id*="next" i]','[data-test-id*="continue" i]','[data-test-id*="check" i]','[class*="next" i]','[class*="continue" i]','[class*="proximo" i]','[class*="avancar" i]'].join(","),a=Array.from(document.querySelectorAll(t)),r=c=>{let m=c instanceof HTMLInputElement||c instanceof HTMLButtonElement?c.value:"";return(c.getAttribute("aria-label")||c.textContent||m||"").trim()},n=c=>{let m=r(c).trim();return/^\d{1,3}$/.test(m)?!!c.closest('[class*="pagination" i], [class*="pager" i], [class*="page-nav" i], [class*="step-indicator" i], [class*="breadcrumb" i], [class*="steps" i], [aria-label*="p\xE1gina" i], [aria-label*="page" i], [role="navigation"], nav'):!1},i=a.filter(c=>H(c)&&!O(c)&&!c.closest("header, aside")&&!j(c)&&!e(c));for(let c of i){let m=r(c),p=m.replace(/[\d\(\)\[\]\u2192>\u2022\-\/\\]+/g," ").trim();if((ke.test(m)||ke.test(p))&&!n(c)&&!j(c))return c}for(let c of i)if(Z(c)&&!j(c)&&!n(c))return c;let s=document.querySelector('[data-test-id*="next" i], [data-testid*="next" i], [aria-label*="next" i], [aria-label*="pr\xF3xim" i], [aria-label*="avan\xE7ar" i], [aria-label*="continuar" i]');if(s&&H(s)&&!O(s)&&!j(s)&&!e(s))return s;let d=Array.from(document.querySelectorAll('input[type="submit"], button[type="submit"]'));for(let c of d)if(H(c)&&!O(c)&&!e(c)&&!j(c)&&!n(c))return c;let l=Array.from(document.querySelectorAll('button, [role="button"]')),u=window.innerHeight,g=l.filter(c=>{if(!H(c)||O(c)||e(c)||j(c)||c.closest("header, nav, aside, .eq-sidebar")||n(c))return!1;let m=c.getBoundingClientRect();return m.top>u*.45&&m.height>=24&&m.width>=24});if(g.length>0)return g.sort((c,m)=>{let p=c.getBoundingClientRect(),f=m.getBoundingClientRect(),h=p.left+p.top;return f.left+f.top-h}),g[0];for(let c of i)if(Z(c)&&!j(c))return c;return null}async function mt(o,e=2500){let t=Date.now();for(;Date.now()-t<e;){if(!(o.disabled===!0||o.getAttribute("aria-disabled")==="true"||o.classList.contains("disabled")||o.getAttribute("disabled")!==null))return;await new Promise(r=>setTimeout(r,80))}}function wo(){let o=window.location.href,e=document.title,t=document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length,a=(document.body?.innerText||document.body?.textContent||"").length;return`${o}|${e}|${t}|${a}`}async function Co(o,e=3500){let[t,a,r,n]=o.split("|"),i=parseInt(n||"0",10),s=Date.now();for(;Date.now()-s<e;){let d=window.location.href,l=document.title,u=String(document.querySelectorAll('input, textarea, select, button, [role="button"], [role="option"], [role="radio"], [role="checkbox"]').length),g=(document.body?.innerText||document.body?.textContent||"").length;if(d!==t)return{changed:!0,evidence:`URL mudou: ${t} \u2192 ${d}`};if(l!==a)return{changed:!0,evidence:`T\xEDtulo da p\xE1gina mudou: "${a}" \u2192 "${l}"`};if(Math.abs(parseInt(u)-parseInt(r||"0"))>=2)return{changed:!0,evidence:`Controles interativos: ${r} \u2192 ${u}`};if(Math.abs(g-i)>50)return{changed:!0,evidence:`Conte\xFAdo da p\xE1gina mudou substancialmente (${Math.abs(g-i)} chars)`};await new Promise(c=>setTimeout(c,100))}return{changed:!1,evidence:"Nenhuma mudan\xE7a estrutural detectada dentro do tempo limite."}}async function Ge(o){if(o.t==="js"||o.t==="adv")return;if(o.t==="drag"){let n=P(o.from)||P(q(o.from)),i=P(o.to)||P(q(o.to));n&&i&&await Fe(n,i,2);return}let e=o.id||"",t=o.v!==void 0?String(o.v).trim():"",a=P(e,t)||P(q(e),t),r=String(o.name??o.n??"").trim();if(!r&&e&&document.querySelector(`input[type="radio"][name="${Q(e)}"]`)&&(r=e),!a&&r){let n=Array.from(document.querySelectorAll(`input[name="${Q(r)}"]`));if(t&&(a=n.find(i=>i.value?.toLowerCase()===t.toLowerCase())??null),!a&&t){let i=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(t),s=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(t);if(i||s){let d=i?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];a=n.find(l=>{let u=l.value?.toLowerCase()??"";if(d.includes(u))return!0;let c=(l.closest('label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return d.some(m=>c===m||c.startsWith(m+" ")||c.startsWith("("+m+")"))})??null}}!a&&n.length>0&&(a=n[0])}if(o.t==="clk"||o.t==="chk"){if(!a&&e){let i=Array.from(document.querySelectorAll('input, label, button, [role="radio"], [role="checkbox"], .option-card, [class*="option" i], [class*="choice" i]')),s=q(e).toLowerCase();a=i.find(d=>{let l=q(d.textContent).toLowerCase();return!!(q(d.value||"").toLowerCase()===s||l===s||l.startsWith(s+")")||l.startsWith("("+s+")")||l.startsWith(s+".")||l.startsWith(s+" - ")||l.startsWith(s+":")||s.length>=3&&l.includes(s))})||null}let n=o.v!==void 0?String(o.v).trim():"";if(a&&n){if(a instanceof HTMLInputElement&&a.type==="radio"&&a.name){if(q(a.value).toLowerCase()!==q(n).toLowerCase()){let i=document.querySelector(`input[type="radio"][name="${Q(a.name)}"][value="${Q(n)}" i]`);if(i)a=i;else{let d=Array.from(document.querySelectorAll(`input[type="radio"][name="${Q(a.name)}"]`)).find(l=>{let u=l.closest("label, .vf-label, .option-card, tr, td, div");return u&&q(u.textContent).toLowerCase().includes(q(n).toLowerCase())});d&&(a=d)}}}else if(!(a instanceof HTMLInputElement)&&!(a instanceof HTMLSelectElement)&&!(a instanceof HTMLTextAreaElement)){let i=a.querySelector(`input[value="${Q(n)}" i], [data-value="${Q(n)}" i]`);if(i)a=i;else{let d=Array.from(a.querySelectorAll('input[type="radio"], input[type="checkbox"]')).find(l=>{let u=l.closest("label, .vf-label, .option-card, td, div");return u&&q(u.textContent).toLowerCase().includes(q(n).toLowerCase())});d&&(a=d)}}}if(a){let i=a.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,s=a instanceof HTMLInputElement&&["radio","checkbox"].includes(a.type)?a:i.querySelector('input[type="radio"], input[type="checkbox"]')||(i.getAttribute("for")?i.ownerDocument.getElementById(i.getAttribute("for")):null),d=o.c!==void 0?!!o.c:!0;if(pe(s||i,d),s&&s.checked!==d){try{let l=s._valueTracker;l&&l.setValue(!d)}catch{}try{Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"checked")?.set?.call(s,d)}catch{}s.checked=d,s.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),s.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}return}if(o.t==="val"){let n=null;if(a&&(n=a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement||a.isContentEditable?a:a.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),!n){let i=document.body;try{i=J()||document.body}catch{}let s=Array.from(i.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]')),d=q(e).toLowerCase();n=s.find(l=>{let u=(l.getAttribute("placeholder")||"").toLowerCase(),g=(l.name||"").toLowerCase(),c=(l.id||"").toLowerCase(),m=(l.getAttribute("aria-label")||"").toLowerCase();return u.includes(d)||g.includes(d)||c.includes(d)||m.includes(d)})||(s.length>0?s[0]:null)}if(n){let i=String(o.v??"");try{if(n.focus?.(),n.type!=="number"){try{n.select?.()}catch{}document.execCommand?.("insertText",!1,i)}}catch{}Xe(n,i)}return}if(o.t==="sel"){if(!a&&e){let n=Array.from(document.querySelectorAll("select")),i=q(e).toLowerCase();a=n.find(s=>{let d=(s.name||"").toLowerCase(),l=(s.id||"").toLowerCase(),u=(s.getAttribute("aria-label")||"").toLowerCase();return d.includes(i)||l.includes(i)||u.includes(i)})||null}if(a){let n=Array.isArray(o.v)?o.v:[String(o.v)];Ke(a,n)}return}}function ee(o){try{if(o.t==="val"){let e=o.v!==void 0?o.v:o.value!==void 0?o.value:o.val!==void 0?o.val:o.text,t=String(e??"").trim(),a=t,r=o.id!==void 0&&o.id!==null?String(o.id):"";r||(r=o.target??o.name??o.selector??"1");let n=P(r,a,!0)||P(q(r),a,!0);if(!n){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]')).filter(f=>H(f)&&!O(f));p.length>0&&(n=p[0])}if(!n)return!1;let i=n instanceof HTMLInputElement&&n.type==="radio"?n:n.querySelector('input[type="radio"]');if(i&&i.name){let m=document.querySelector(`input[type="radio"][name="${Q(i.name)}"]:checked`);if(!m)return!1;let p=q(m.value).toLowerCase(),f=q(t).toLowerCase(),h=q(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===f||h===f||h.includes(f)}let s=n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n.isContentEditable?n:n.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(!s){let p=n.closest('.form-group, .field, [class*="input" i], [class*="control" i], label, tr, td, li, p, div')?.querySelector('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="submit"]):not([type="button"]), textarea, [contenteditable="true"]');p&&(s=p)}if(!s){let m=n.nextElementSibling;for(;m;){if(m instanceof HTMLInputElement&&!["hidden","button","submit","checkbox","radio"].includes(m.type)||m instanceof HTMLTextAreaElement||m instanceof HTMLElement&&m.isContentEditable){s=m;break}let p=m.querySelector('input:not([type="hidden"]):not([type="button"]):not([type="submit"]):not([type="checkbox"]):not([type="radio"]), textarea, [contenteditable="true"]');if(p){s=p;break}m=m.nextElementSibling}}if(s instanceof HTMLSelectElement){let m=q(t).toLowerCase();return Array.from(s.options).some(p=>{if(!p.selected)return!1;let f=p.value.toLowerCase(),h=q(p.textContent).toLowerCase();return m===f||m===h||f.includes(m)||h.includes(m)})}let d=(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement?s.value:s?.textContent??n.textContent??"").trim();if(!d&&!t)return!0;if(!d&&t)return!1;let l=d.replace(",",".").replace(/\s+/g,"").toLowerCase(),u=t.replace(",",".").replace(/\s+/g,"").toLowerCase(),g=parseFloat(l),c=parseFloat(u);return!isNaN(g)&&!isNaN(c)&&l.match(/^-?[\d.,]+$/)&&u.match(/^-?[\d.,]+$/)?Math.abs(g-c)<1e-4:l===u||d.toLowerCase()===t.toLowerCase()||u.length>=3&&l===u}if(o.t==="sel"){let e=P(o.id,void 0,!0)||P(q(o.id),void 0,!0);if(!e){let n=document.body;try{n=J()||document.body}catch{}let i=Array.from(n.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(l=>H(l)&&!O(l)),s=q(o.id).toLowerCase();e=i.find(l=>{let u=(l.id||"").toLowerCase(),g=(l.getAttribute("name")||"").toLowerCase(),c=(l.getAttribute("aria-label")||"").toLowerCase(),m=q(l.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return u.includes(s)||g.includes(s)||c.includes(s)||s.length>=2&&m.includes(s)})||(i.length===1?i[0]:null)}if(!e)return!1;let t=e instanceof HTMLSelectElement?e:e.querySelector("select");if(!t){let n=e.matches?.('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]')?e:e.closest('[role="combobox"], [role="listbox"], [class*="select" i], [class*="dropdown" i]');if(n){let s=(Array.isArray(o.v)?o.v:[String(o.v)]).map(l=>q(l).toLowerCase()),d=q(n.textContent).toLowerCase();return s.some(l=>d.includes(l)||l.includes(d))}return!1}let r=(Array.isArray(o.v)?o.v:[String(o.v)]).map(n=>q(n).toLowerCase());return Array.from(t.options).some(n=>{if(!n.selected)return!1;let i=n.value.toLowerCase(),s=q(n.textContent).toLowerCase();return r.some(d=>d===i||d===s||i.includes(d)||s.includes(d))})}if(o.t==="chk"||o.t==="clk"){let e=o.v!==void 0?String(o.v).trim():"",t=String(o.name??o.n??"").trim();if(t&&!o.id){let c=Array.from(document.querySelectorAll(`input[name="${Q(t)}"]`));if(c.length>0){let m=c.find(A=>A.checked);if(!m)return!1;if(!e)return!0;let p=m.value?.toLowerCase()??"",f=e.toLowerCase();if(p===f)return!0;let h=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(e),b=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(e);return h?/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(p):b?/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(p):!1}}let a=P(o.id,e)||P(q(o.id),e);if(!a&&t){let c=document.querySelector(`input[name="${Q(t)}"]`);c&&(a=c)}if(!a)return!1;let r=a.closest('.option-card, label, .vf-label, [role="radio"], [role="checkbox"], [role="option"], .quiz-option, .answer, .choice, li')||a,n=a instanceof HTMLInputElement&&["checkbox","radio"].includes(a.type)?a:r.querySelector('input[type="checkbox"], input[type="radio"]')||(r.getAttribute("for")?r.ownerDocument.getElementById(r.getAttribute("for")):null),i=o.t==="chk"||o.c!==void 0?!!o.c:!0;if(n&&n.type==="radio"){if(n.checked===i)return!0;if(o.v&&n.name){let c=q(String(o.v)).toLowerCase(),m=document.querySelector(`input[type="radio"][name="${Q(n.name)}"]:checked`);if(!m)return!1;if(m===n)return!0;let p=q(m.value).toLowerCase(),f=q(m.closest("label, .vf-label, .option-card, tr, td, div")?.textContent||"").toLowerCase();return p===c||f.includes(c)||c.includes(p)}}if(n&&["checkbox","radio"].includes(n.type))return n.checked===i;let s=r.getAttribute("aria-checked")===String(i)||r.getAttribute("aria-selected")===String(i)||r.getAttribute("aria-pressed")===String(i),d=i?r.getAttribute("data-selected")==="true"||r.getAttribute("data-checked")==="true"||r.getAttribute("data-active")==="true"||r.getAttribute("data-state")==="checked"||r.getAttribute("data-state")==="on":r.getAttribute("data-selected")==="false"||r.getAttribute("data-checked")==="false"||r.getAttribute("data-state")==="unchecked",l=r.className||"",u=i?/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l):!/\b(active|selected|checked|picked|is-selected|choice-selected|selected-option|is-checked|chosen|current)\b/i.test(l);if(s||d||u)return!0;let g=!!r.closest('[role="radiogroup"], [role="listbox"], .options, .choices, [class*="option" i], [class*="choice" i], [class*="answer" i], [class*="quiz" i]');return o.t==="clk"&&!n&&!g||r.getAttribute("aria-expanded")!==null||r.getAttribute("aria-pressed")!==null}if(o.t==="drag"){let e=te(o.from,"source")||P(o.from)||P(q(o.from)),t=te(o.to,"destination")||P(o.to)||P(q(o.to));return!e||!t?!1:vo(e,t).success}}catch{}return!1}async function Ie(o,e,t=1,a=Ae({engine:"smart",autoAdvance:e})){let r=o.actions.filter(w=>w.t!=="adv"),n=o.actions.filter(w=>w.t==="adv"),i=0,s=[],d=new Map,l=new Map,u=new Map,g=new Set,c=o.pageType==="question"||r.length>0,m=r.filter(w=>w.t==="chk"||w.t==="clk"&&w.c!==void 0),p=new Map;for(let w of r){let L=[];l.set(w,L);try{if(w.t==="drag"){L.push("declarative-A-F");try{let S=te(w.from,"source")||P(w.from),C=te(w.to,"destination")||P(w.to);S&&u.set(w,S.parentElement?.outerHTML?.slice(0,500)||""),C&&p.set(w,C.children.length)}catch{}}else L.push("declarative-primary");await yo(w,t,a),i++,g.add(w)}catch(S){d.set(w,S instanceof Error?S.message:String(S)),console.warn("[EasyQuiz] A\xE7\xE3o declarativa prim\xE1ria falhou com seguran\xE7a:",w,S)}await new Promise(S=>setTimeout(S,w.t==="drag"?180:35))}if(c&&o.mode==="escolha_multipla"&&m.length>0){let w=document.body;try{w=J()||document.body}catch{}let L=Array.from(w.querySelectorAll('input[type="checkbox"], [role="checkbox"]')).filter(S=>H(S)&&!O(S));if(L.length>1){let C=function(I,D){if(I===D||I.contains(D)||D.contains(I))return!0;let B=I.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]'),N=D.closest('.option-card, label, [role="checkbox"], [role="option"], tr, li, [class*="option" i]');if(B&&N&&B===N)return!0;let X=I.getAttribute("for")||I.id,U=D.getAttribute("for")||D.id;return!!(X&&U&&X===U)};var M=C;let S=new Set;for(let I of m){let D=I.t==="chk"?!!I.c:!!(I.c??!0),B="id"in I&&typeof I.id=="string"?I.id:"";if(D&&B){let N=P(B,I.v);if(N){S.add(N);let X=N.querySelector('input[type="checkbox"]');X&&S.add(X);let U=N.closest('.option-card, label, [role="checkbox"], tr, li, [class*="option" i]');U&&(S.add(U),U.querySelectorAll('input[type="checkbox"]').forEach(G=>S.add(G)))}}}if(S.size>=m.length&&S.size>0){let I=Array.from(S);for(let D of L)I.some(N=>C(N,D))||(D instanceof HTMLInputElement&&D.checked||D.getAttribute("aria-checked")==="true"||D.closest(".option-card, label")?.classList.contains("selected"))&&pe(D,!1)}}}await new Promise(w=>setTimeout(w,r.length>0?100:25));let f=0;for(let w of r){if(ee(w)){f++;continue}console.warn(`[EasyQuiz Auto-Cura] A\xE7\xE3o '${w.t}' no alvo '${w.id||w.from||""}' n\xE3o verificada no DOM. Disparando Passagem 2 de conting\xEAncia...`);try{it(w,a),l.get(w)?.push("alternative-path"),await Ge(w)}catch(L){d.set(w,L instanceof Error?L.message:String(L)),console.warn("[EasyQuiz Auto-Cura] Rota alternativa falhou:",L)}await new Promise(L=>setTimeout(L,250)),ee(w)&&(console.log("[EasyQuiz Auto-Cura] \u2713 A\xE7\xE3o recuperada com sucesso pela rota de conting\xEAncia!"),f++,g.has(w)?d.has(w)&&d.delete(w):(d.delete(w),i++,g.add(w)))}if(f<r.length&&r.length>0){console.warn(`[EasyQuiz Auto-Cura] ${r.length-f} de ${r.length} a\xE7\xE3o(\xF5es) ainda n\xE3o verificadas. Disparando Passagem 3 final...`),await new Promise(w=>setTimeout(w,200));for(let w of r)if(!ee(w))try{if(await Ge(w),await new Promise(L=>setTimeout(L,80)),!ee(w)&&(w.t==="clk"||w.t==="chk"))try{let L="id"in w?String(w.id||""):"",S=w.v!==void 0?String(w.v).trim():"",C=P(L,S)||P(q(L),S);C&&(ft(C),await new Promise(I=>setTimeout(I,120)))}catch{}}catch(L){d.set(w,L instanceof Error?L.message:String(L))}await new Promise(w=>setTimeout(w,200)),f=0;for(let w of r)ee(w)&&(f++,g.has(w)?d.has(w)&&d.delete(w):(d.delete(w),i++,g.add(w)))}let h=[];for(let[w,L]of r.entries())if(!ee(L)){let S=L.t==="drag"?`${L.from} -> ${L.to}`:"id"in L&&L.id?L.id:L.t;s.push(S),h.push({actionIndex:w,action:L,strategiesAttempted:l.get(L)||[],evidence:d.get(L)||"sem evid\xEAncia de aplica\xE7\xE3o no DOM",domSnapshot:u.get(L)}),L.t==="drag"&&console.warn(`[EasyQuiz Drag] FALHA CONFIRMADA: "${L.from}" -> "${L.to}"`,`
  Estrat\xE9gias: ${(l.get(L)||[]).join(", ")}`,`
  Snapshot DOM: ${u.get(L)?.slice(0,200)||"n/a"}`)}c&&r.length===0&&s.push("nenhuma a\xE7\xE3o de resposta prescrita");let b=r.map((w,L)=>{let S=w.t==="drag"?`${w.from} -> ${w.to}`:w.t==="js"?"$eq":w.id||w.t,C=w.t==="js"?!0:w.t==="drag"?!!(te(w.from,"source")&&te(w.to,"destination")):!!(P(w.id||"")||P(q(w.id||""))),I=ee(w);return{index:L,action:w,target:S,located:C,applied:!d.has(w),verified:I,strategy:w.t==="drag"?"drag-adaptive":w.t==="js"?"javascript":"declarative-dom",evidence:I?"estado do controle confirmado no DOM":"nenhuma evid\xEAncia suficiente ap\xF3s as tentativas",...d.has(w)?{error:d.get(w)}:{}}}),A=c?r.length>0&&s.length===0&&(f===r.length||i===r.length&&f>0):!0,y=!1,v=!1,x="Nenhuma a\xE7\xE3o de navega\xE7\xE3o solicitada.",E=c?f>0&&f>=Math.ceil(r.length/2):i>0&&i>=r.length/2,T=c?f>0&&(A||E):A||r.length===0||E;if(e&&T){await new Promise(S=>setTimeout(S,r.length>0?120:40));let w=!1,L=null;if(o.pageType!=="info"){let S=xo();if(S&&H(S)){await mt(S,1200),oe(S),w=!0,L=S,await new Promise(D=>setTimeout(D,350));let C=document.querySelector('.feedback-message.error, [class*="feedback"][class*="error" i], [role="alert"][class*="error" i]');C&&H(C)&&(C.textContent||"").trim().length>0?(y=!1,v=!1,x=`Aviso do formul\xE1rio ap\xF3s checagem: ${C.textContent?.trim().slice(0,100)}`):(y=!0,v=!0,x="Resposta confirmada via bot\xE3o de verifica\xE7\xE3o/envio.")}}if(!w){let S=wo(),C=n.length>0&&"id"in n[0]?n[0].id:void 0,I=Kt(C);if(I){await mt(I,1500);let D=C||I.textContent?.trim()||"";D&&et(window.location.hostname,{advanceSelector:D}),oe(I);let B=await Co(S,1800);v=B.changed,x=B.evidence,y=B.changed||!0,B.changed||console.warn("[EasyQuiz] O bot\xE3o de avan\xE7o foi acionado, mas a navega\xE7\xE3o ainda n\xE3o concluiu.")}else console.warn("[EasyQuiz] Nenhum bot\xE3o de avan\xE7o encontrado na p\xE1gina.")}}return{applied:i,verified:f,success:A,advanced:y,failed:s,reports:b,navigationVerified:v,navigationEvidence:x,failedActions:h}}var ne=null,ve=[],gt=[],ht=[],bt=[],se=null,me=null,Eo=`
...
`;function Ft(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let o=document.createElement("style");o.id="eq-image-pulse-style",o.textContent=Eo,document.head.appendChild(o)}}catch{}}function fe(){ne&&(ne.style.removeProperty("outline"),ne.style.removeProperty("outline-offset"),ne.style.removeProperty("position"),ne=null);for(let o of ve)o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("background-color"),o.style.removeProperty("box-shadow"),o.removeAttribute("data-easyquiz-highlight");ve=[];for(let o of gt)o.style.removeProperty("animation"),o.style.removeProperty("outline"),o.style.removeProperty("outline-offset"),o.style.removeProperty("box-shadow"),o.style.removeProperty("filter"),o.removeAttribute("data-easyquiz-image-highlight");gt=[];for(let o of ht)try{o.remove()}catch{}ht=[],me&&typeof window<"u"&&(window.removeEventListener("scroll",me),window.removeEventListener("resize",me),me=null);for(let o of bt)try{o.remove()}catch{}if(bt=[],se){try{se.remove()}catch{}se=null}}function At(o){Ft();let e=[];for(let t of o){if(!t||typeof t.setAttribute!="function")continue;let a=t;try{a.style&&(a.style.outline="3px solid #ffd600",a.style.outlineOffset="4px",a.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",a.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",a.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),a.setAttribute("data-easyquiz-image-highlight","true"),gt.push(a)}catch{}try{let r=t.getBoundingClientRect(),n=r.width||t.offsetWidth||280,i=r.height||t.offsetHeight||200;if(n>10&&i>10){let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
          position: absolute;
        ...
        `,s.appendChild(d),document.body.appendChild(s),ht.push(s),bt.push(d),e.push({element:t,frame:s})}}catch{}}e.length>0&&!me&&typeof window<"u"&&(me=()=>{for(let t of e)try{let a=t.element.getBoundingClientRect();a.width>0&&a.height>0&&(t.frame.style.top=`${a.top+window.scrollY-3}px`,t.frame.style.left=`${a.left+window.scrollX-3}px`,t.frame.style.width=`${a.width+6}px`,t.frame.style.height=`${a.height+6}px`)}catch{}},window.addEventListener("scroll",me,{passive:!0}),window.addEventListener("resize",me,{passive:!0}))}function He(o){ne&&ne!==o&&(ne.style.removeProperty("outline"),ne.style.removeProperty("outline-offset")),Ft(),ne=o,o.style.outline="2px solid #00e5ff",o.style.outlineOffset="4px";try{if(se){try{se.remove()}catch{}se=null}window.getComputedStyle(o).position==="static"&&(o.style.position="relative");let t=document.createElement("div");t.style.cssText=`
    ...
    `,o.appendChild(t),se=t}catch{}}function qo(o){return!o||o>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:o>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Gt(o,e){if(se){try{se.remove()}catch{}se=null}let t=qo(e);for(let a of o){if(a.t==="adv"||a.t==="js")continue;if(a.t==="drag"){try{let m=P(a.from),p=P(a.to);m&&(m.style.outline=`2px solid ${t.outline}`,ve.push(m)),p&&(p.style.outline="2px dashed #00e5ff",ve.push(p))}catch{}continue}let r=a.v!==void 0?Array.isArray(a.v)?a.v[0]:String(a.v):"",n=String(a.name??a.n??"").trim(),i=null;if(n){let m=Array.from(document.querySelectorAll(`input[name="${Q(n)}"]`));if(r&&(i=m.find(p=>p.value?.toLowerCase()===r.toLowerCase())??null,!i)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(r),f=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(r);if(p||f){let h=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];i=m.find(b=>{let A=b.value?.toLowerCase()??"";if(h.includes(A))return!0;let v=(b.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return h.some(x=>v===x||v.startsWith(x+" ")||v.startsWith("("+x+")"))})??null}}!i&&m.length>0&&(i=m[0])}if(!i&&a.id&&(i=P(a.id,r,a.t==="val"||a.t==="sel")||P(q(a.id),r,a.t==="val"||a.t==="sel")),!i&&a.t==="sel"){let m=document.body;try{m=J()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(b=>H(b)&&!de(b)),f=q(a.id).toLowerCase();i=p.find(b=>{let A=(b.id||"").toLowerCase(),y=(b.getAttribute("name")||"").toLowerCase(),v=(b.getAttribute("aria-label")||"").toLowerCase(),x=q(b.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return A.includes(f)||y.includes(f)||v.includes(f)||f.length>=2&&x.includes(f)})||(p.length===1?p[0]:null)}if(!i)continue;let s=typeof HTMLSelectElement<"u"&&i instanceof HTMLSelectElement||i.tagName?.toLowerCase()==="select"||i.getAttribute("role")==="combobox"||i.getAttribute("role")==="listbox",d=i.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=s?i.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=d||l||i;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),ve.push(u);let g=s?i:u.querySelector('select, [role="combobox"], [role="listbox"]');g&&(g.style.outline=`2px solid ${t.outline}`,g.style.outlineOffset="2px",g.style.boxShadow=`0 0 10px ${t.glow}`,g.setAttribute("data-easyquiz-highlight","true"),ve.push(g));let c=i instanceof HTMLInputElement&&["checkbox","radio"].includes(i.type)?i:u.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==u&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),ve.push(c))}}var vt=10,To=1400,Pe=15e5;function ce(o){return new Promise((e,t)=>{let a=new FileReader;a.onerror=()=>t(new Error("Falha ao converter blob para base64.")),a.onload=()=>{let r=String(a.result||"");e(r.split(",")[1]||"")},a.readAsDataURL(o)})}async function ye(o){let e=0,t=0;if(o instanceof HTMLImageElement?(e=o.naturalWidth||o.width,t=o.naturalHeight||o.height):(e=o.width,t=o.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let a=Math.min(1,To/Math.max(e,t)),r=Math.max(1,Math.round(e*a)),n=Math.max(1,Math.round(t*a)),i=document.createElement("canvas");i.width=r,i.height=n;let s=i.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,r,n),s.drawImage(o,0,0,r,n),new Promise((d,l)=>{i.toBlob(u=>u?d(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Wt(o){let e=typeof o.getBoundingClientRect=="function"?o.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(o.getAttribute("width")||"0")||parseFloat(o.style.width||"0")||400,a=e.height||parseFloat(o.getAttribute("height")||"0")||parseFloat(o.style.height||"0")||300,r=2,n=Math.min(1800,Math.max(120,Math.round(t*r))),i=Math.min(1800,Math.max(100,Math.round(a*r))),s=o.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.getAttribute("xmlns:xlink")||s.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),s.setAttribute("width",String(n)),s.setAttribute("height",String(i)),!s.getAttribute("viewBox")&&t>0&&a>0&&s.setAttribute("viewBox",`0 0 ${t} ${a}`);try{let c=Array.from(o.querySelectorAll("*")),m=Array.from(s.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,m.length);p++){let f=c[p],h=m[p];if(!f||!h||!h.style)continue;let b=window.getComputedStyle?window.getComputedStyle(f):null;b&&(b.fill&&b.fill!=="none"&&(h.style.fill=b.fill),b.stroke&&b.stroke!=="none"&&(h.style.stroke=b.stroke),b.strokeWidth&&(h.style.strokeWidth=b.strokeWidth),b.fontFamily&&(h.style.fontFamily=b.fontFamily),b.fontSize&&(h.style.fontSize=b.fontSize),b.fontWeight&&(h.style.fontWeight=b.fontWeight),b.color&&(h.style.color=b.color))}}catch{}let d="#ffffff";try{let c=o.parentElement||o;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){d=p;break}c=c.parentElement}}catch{}let u=new XMLSerializer().serializeToString(s),g="";try{g=btoa(unescape(encodeURIComponent(u)))}catch{}try{let c=h=>new Promise((b,A)=>{let y=new Image,v=setTimeout(()=>A(new Error("Timeout render SVG")),1200);y.onload=()=>{clearTimeout(v),b(y)},y.onerror=()=>{clearTimeout(v),A(new Error("Falha ao renderizar SVG em Image."))},y.src=h}),m=null;if(g)try{m=await c(`data:image/svg+xml;base64,${g}`)}catch{}if(!m){let h=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),b=URL.createObjectURL(h);try{m=await c(b)}finally{URL.revokeObjectURL(b)}}let p=document.createElement("canvas");p.width=n,p.height=i;let f=p.getContext("2d",{alpha:!1});if(f&&m){f.fillStyle=d,f.fillRect(0,0,n,i),f.drawImage(m,0,0,n,i);let h=await new Promise(b=>{p.toBlob(b,"image/jpeg",.92)});if(h){let b=await ce(h);if(b)return{blob:h,base64:b,mediaType:"image/jpeg"}}}}catch{}return{base64:g,mediaType:"image/svg+xml"}}async function yt(o){try{let e=o.getBoundingClientRect(),t=Math.round(e.width)||o.offsetWidth||400,a=Math.round(e.height)||o.offsetHeight||300;if(t<30||a<30)return null;let r=o.tagName.toLowerCase()==="svg"?o:o.querySelector("svg");if(r&&o.querySelectorAll("input, select, textarea").length===0)try{let f=await Wt(r);if(f.base64&&f.base64.length<=Pe)return{mediaType:f.mediaType,base64:f.base64,alt:o.getAttribute("aria-label")||r.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:ge(r)}}catch{}if(o instanceof HTMLCanvasElement)try{let f=await ye(o),h=await ce(f);if(h)return{mediaType:"image/jpeg",base64:h,alt:o.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let n="#ffffff";try{let f=o;for(;f&&f!==document.documentElement;){let b=(window.getComputedStyle?window.getComputedStyle(f):null)?.backgroundColor;if(b&&b!=="transparent"&&b!=="rgba(0, 0, 0, 0)"){n=b;break}f=f.parentElement}}catch{}let i=o.cloneNode(!0),s=Array.from(o.querySelectorAll("*")),d=Array.from(i.querySelectorAll("*"));for(let f=0;f<Math.min(s.length,d.length);f++){let h=s[f],b=d[f];if(!(!h||!b||!b.style))try{let A=window.getComputedStyle(h);b.style.color=A.color,b.style.backgroundColor=A.backgroundColor,b.style.borderColor=A.borderColor,b.style.borderWidth=A.borderWidth,b.style.borderStyle=A.borderStyle,b.style.fontSize=A.fontSize,b.style.fontFamily=A.fontFamily,b.style.fontWeight=A.fontWeight,b.style.lineHeight=A.lineHeight,b.style.letterSpacing=A.letterSpacing,b.style.textAlign=A.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,a))),u=Math.round(t*l),g=Math.round(a*l),c=`
      <svg xmlns="http://www.w3.org/2000/svg" width="${u}" height="${g}" viewBox="0 0 ${t} ${a}">
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let r=this.element.querySelector("#eq-fah-copy-md-btn");r.addEventListener("click",()=>this.copyMarkdownToClipboard(r));let n=this.element.querySelector("#eq-fah-copy-all-btn");n.addEventListener("click",()=>this.copyMarkdownToClipboard(n));let i=this.element.querySelector("#eq-fah-header");this.setupDraggable(i)}setupDraggable(e){let t=a=>{if(a.target.closest(".eq-fah-btn"))return;a.preventDefault(),this.isDragging=!0,this.dragStartX=a.clientX,this.dragStartY=a.clientY;let r=this.element.getBoundingClientRect();this.initialLeft=r.left,this.initialTop=r.top;let n=s=>{if(!this.isDragging||!this.element)return;let d=s.clientX-this.dragStartX,l=s.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),g=Math.max(10,window.innerHeight-this.element.offsetHeight-10),c=Math.min(Math.max(10,this.initialLeft+d),u),m=Math.min(Math.max(10,this.initialTop+l),g);this.element.style.left=`${c}px`,this.element.style.top=`${m}px`},i=()=>{this.isDragging=!1,window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",i)};window.addEventListener("mousemove",n),window.addEventListener("mouseup",i)};e.addEventListener("mousedown",t)}renderContent(){if(!this.element||!this.currentPlan)return;let e=this.element.querySelector("#eq-fah-body"),t=this.element.querySelector("#eq-fah-pill-text"),a=this.element.querySelector("#eq-fah-pill-badge");e.innerHTML="";let r=this.currentPlan,n=r.actions.filter(m=>m.t==="drag"),i=r.actions.filter(m=>{if(m.t!=="val")return!1;let p=q(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),s=r.actions.filter(m=>m.t==="clk"||m.t==="chk"),d=r.actions.filter(m=>m.t==="sel"),l=n.length||i.length||s.length||d.length,u=document.createElement("div");u.className="eq-fah-meta";let g=document.createElement("span");g.textContent=`Modo: ${r.mode.replace("_"," ")}`;let c=document.createElement("span");if(c.className="eq-fah-meta-badge",c.textContent=`${Math.round(r.confidence*100)}% Confian\xE7a`,u.append(g,c),e.appendChild(u),n.length>0||r.mode==="categorizacao"||r.mode==="arrastar_soltar"){t.textContent=`Categoriza\xE7\xE3o (${n.length} itens)`,a.textContent=String(n.length);let m={};for(let p of n){let f=q(p.to)||"Geral";m[f]||(m[f]=[]),m[f].push(q(p.from))}for(let[p,f]of Object.entries(m)){let h=document.createElement("div"),b=/fato|true|verdadeiro|sim/i.test(p),A=/opini[aã]o|false|falso|n[aã]o/i.test(p);h.className=`eq-fah-group ${b?"group-fato":A?"group-opiniao":""}`;let y=document.createElement("div");y.className="eq-fah-group-title",y.textContent=`\u{1F4C1} ${p} (${f.length})`,h.appendChild(y);let v=document.createElement("div");v.className="eq-fah-group-items";for(let x of f){let E=document.createElement("div");E.className="eq-fah-item";let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=x,E.appendChild(T);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(x),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),E.appendChild(M),v.appendChild(E)}h.appendChild(v),e.appendChild(h)}}else if(i.length>0){t.textContent=`Preenchimento (${i.length} campos)`,a.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let h=0;h<i.length;h++){let b=i[h],A=document.createElement("div");A.className="eq-fah-item";let y=Me(b.id);(!y||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Campo ${h+1}`);let v=String(b.v??""),x=document.createElement("div");x.className="eq-fah-field-box";let E=document.createElement("div");E.className="eq-fah-field-label",E.textContent=y,x.appendChild(E);let T=document.createElement("div");T.className="eq-fah-field-val",T.textContent=v,x.appendChild(T),A.appendChild(x);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(v),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),A.appendChild(M),f.appendChild(A)}m.appendChild(f),e.appendChild(m)}else if(s.length>0){t.textContent=`Op\xE7\xF5es (${s.length} marcadas)`,a.textContent=String(s.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let h=0;h<s.length;h++){let b=s[h],A=document.createElement("div");A.className="eq-fah-item";let y=Me(b.id);(!y||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y))&&b.v&&(y=String(b.v)),y=q(y),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(y)&&(y="");let v="",x=y.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);x?(v=x[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),y=x[2].trim()||y):s.length>1&&(v=String.fromCharCode(65+h));let E=document.createElement("div");if(E.style.display="flex",E.style.alignItems="center",E.style.gap="8px",E.style.flex="1",v){let w=document.createElement("span");w.className="eq-fah-letter-badge",w.textContent=v,E.appendChild(w)}let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=y||(v?`Alternativa ${v}`:"Alternativa Selecionada"),E.appendChild(T),A.appendChild(E);let M=document.createElement("button");M.className="eq-fah-copy-inline",M.textContent="Copiar",M.addEventListener("click",()=>{navigator.clipboard.writeText(y||v),M.textContent="\u2713 Copiado",setTimeout(()=>M.textContent="Copiar",1200)}),A.appendChild(M),f.appendChild(A)}m.appendChild(f),e.appendChild(m)}else if(d.length>0){t.textContent=`Sele\xE7\xE3o (${d.length} listas)`,a.textContent=String(d.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let h=0;h<d.length;h++){let b=d[h],A=document.createElement("div");A.className="eq-fah-item";let y=Me(b.id);(!y||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(y))&&(y=`Lista ${h+1}`);let E=(Array.isArray(b.v)?b.v:[String(b.v??"")]).map(S=>{let C=P(b.id,void 0,!0)||P(q(b.id),void 0,!0),I=C instanceof HTMLSelectElement?C:C?.querySelector("select");if(I){let D=q(S).toLowerCase();for(let B=0;B<I.options.length;B++){let N=I.options[B];if(N.value.toLowerCase()===D||q(N.textContent).toLowerCase()===D){let X=q(N.textContent);if(X&&!X.toLowerCase().includes("selecione"))return X}}}return S}).join(", "),T=document.createElement("div");T.className="eq-fah-field-box";let M=document.createElement("div");M.className="eq-fah-field-label",M.textContent=y,T.appendChild(M);let w=document.createElement("div");w.className="eq-fah-field-val",w.textContent=E,T.appendChild(w),A.appendChild(T);let L=document.createElement("button");L.className="eq-fah-copy-inline",L.textContent="Copiar",L.addEventListener("click",()=>{navigator.clipboard.writeText(E),L.textContent="\u2713 Copiado",setTimeout(()=>L.textContent="Copiar",1200)}),A.appendChild(L),f.appendChild(A)}m.appendChild(f),e.appendChild(m)}else{t.textContent="Gabarito",a.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",e.appendChild(m)}if(r.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${r.rationale}`,e.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let e=this.currentPlan,t=[];t.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),t.push(`- **Modo:** ${e.mode}`),t.push(`- **Confian\xE7a:** ${(e.confidence*100).toFixed(0)}%`),t.push("");let a=e.actions.filter(s=>s.t==="drag"),r=e.actions.filter(s=>s.t==="val"),n=e.actions.filter(s=>s.t==="clk"||s.t==="chk"),i=e.actions.filter(s=>s.t==="sel");if(a.length>0){t.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let s={};for(let d of a){let l=q(d.to)||"Geral";s[l]||(s[l]=[]),s[l].push(q(d.from))}for(let[d,l]of Object.entries(s)){t.push(`### Categoria: ${d}`);for(let u of l)t.push(`- ${u}`);t.push("")}}else if(r.length>0){t.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let s of r){let d=q(s.id);t.push(`- **${d||"Campo"}:** \`${s.v}\``)}t.push("")}else if(n.length>0){t.push("## \u2705 Alternativas Corretas:");for(let s=0;s<n.length;s++){let d=n[s],l=Me(d.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&d.v&&(l=String(d.v)),l=q(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=n.length>1?`${String.fromCharCode(65+s)}) `:"";t.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+s)}`)}t.push("")}else if(i.length>0){t.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let s of i){let d=q(s.id)||"Lista",l=Array.isArray(s.v)?s.v.join(", "):String(s.v??"");t.push(`- **${d}:** \`${l}\``)}t.push("")}return e.rationale&&(t.push("---"),t.push(`**\u{1F4A1} Racioc\xEDnio:** ${e.rationale}`)),t.join(`
`)}copyMarkdownToClipboard(e){let t=this.generateMarkdown();t&&navigator.clipboard.writeText(t).then(()=>{let a=e.innerHTML;e.id==="eq-fah-copy-md-btn"?e.innerHTML='<span style="font-size:10px; color:#00ffcc; font-weight:bold;">\u2713</span>':e.innerHTML="\u2713 Copiado!",setTimeout(()=>{e.innerHTML=a},1500)})}};var Yt=`
  ...
  * {
  ...
  .eq-status-card-resolver::after {
    ...
    bottom: 0;
    height: 1px;
    background: linear-gradient(90deg, rgba(137, 175, 255, 0.75), rgba(255,255,255,0.08), rgba(137,175,255,0.32));
    opacity: 0;
    transform: scaleX(0.7);
    transition: opacity 0.22s ease, transform 0.22s ease;
  }

  .eq-status-card-resolver.is-expanded::after,
  .eq-status-card-resolver:not(.is-collapsed)::after {
    opacity: 1;
    transform: scaleX(1);
  }
  ...
  .eq-status-card-resolver .eq-status-summary,
  .eq-status-card-resolver .eq-status-metrics {
  ...
  .eq-status-card-resolver:not(.is-collapsed) .eq-status-card-header {
  ...
  .eq-status-dot {
    ...
    animation: eq-status-dot-pulse 1.7s ease-in-out infinite;
  }
  ...
  .eq-status-card-resolver.is-busy .eq-status-dot,
  .eq-status-card-resolver.is-info .eq-status-dot {
    background: #7bb5ff;
    box-shadow: 0 0 0 4px rgba(123, 181, 255, 0.14);
  }

  .eq-status-card-resolver.is-success .eq-status-dot {
    background: #5ad88b;
    box-shadow: 0 0 0 4px rgba(90,216,139,0.12);
  }

  .eq-status-card-resolver.is-warning .eq-status-dot {
    background: #ffd166;
    box-shadow: 0 0 0 4px rgba(255, 209, 102, 0.14);
  }

  .eq-status-card-resolver.is-error .eq-status-dot {
    background: #ff7d7d;
    box-shadow: 0 0 0 4px rgba(255, 125, 125, 0.14);
  }

  .eq-status-card-resolver.is-busy {
    border-color: rgba(123, 181, 255, 0.26);
    box-shadow: 0 0 0 1px rgba(123, 181, 255, 0.15), inset 0 1px 0 rgba(255,255,255,0.05);
  }

  .eq-status-card-resolver.is-success {
    border-color: rgba(90, 216, 139, 0.28);
    box-shadow: 0 0 0 1px rgba(90,216,139,0.12), inset 0 1px 0 rgba(255,255,255,0.05);
  }

  .eq-status-card-resolver.is-warning {
    border-color: rgba(255, 209, 102, 0.28);
    box-shadow: 0 0 0 1px rgba(255,209,102,0.12), inset 0 1px 0 rgba(255,255,255,0.05);
  }

  .eq-status-card-resolver.is-error {
    border-color: rgba(255, 125, 125, 0.28);
    box-shadow: 0 0 0 1px rgba(255,125,125,0.12), inset 0 1px 0 rgba(255,255,255,0.05);
  }

  .eq-status-card-resolver.is-info {
  ...
  #eq-view-resolver .eq-operation-state svg {
    width: 12px;
    height: 12px;
  }
  ...
  #eq-view-resolver .eq-operation-state.is-success { color: #baf7cf; background: rgba(90,216,139,0.1); border-color: rgba(90,216,139,0.2); }
  #eq-view-resolver .eq-operation-state.is-error { color: #ffb1b1; background: rgba(255,125,125,0.1); border-color: rgba(255,125,125,0.2); }
  #eq-view-resolver .eq-operation-state.is-warning { color: #ffd977; background: rgba(255,209,102,0.1); border-color: rgba(255,209,102,0.2); }
  #eq-view-resolver .eq-operation-state.is-info { color: #9dd1ff; background: rgba(147,197,253,0.1); border-color: rgba(147,197,253,0.2); }
...
`;var ze="v2.7.0";var Zt=(()=>{try{if(typeof window.trustedTypes?.createPolicy=="function")return window.trustedTypes.createPolicy("easyquiz-ui#html",{createHTML:o=>o})}catch{}return null})();function Ho(o,e){try{if(Zt){o.innerHTML=Zt.createHTML(e);return}}catch{}try{if(typeof o.setHTMLUnsafe=="function"){o.setHTMLUnsafe(e);return}}catch{}o.innerHTML=e}var Po=[{value:"",label:"Detec\xE7\xE3o Autom\xE1tica"},{value:"escolha_unica",label:"M\xFAltipla Escolha (\xDAnica)"},{value:"escolha_multipla",label:"M\xFAltipla Escolha (V\xE1rias)"},{value:"categorizacao",label:"Categoriza\xE7\xE3o / Grupos"},{value:"arrastar_soltar",label:"Arrastar e Soltar (Drag & Drop)"},{value:"ordenacao",label:"Ordena\xE7\xE3o / Sequ\xEAncia"},{value:"verdadeiro_falso",label:"Verdadeiro / Falso"},{value:"texto_livre",label:"Texto Livre / Dissertativa"},{value:"preenchimento",label:"Preenchimento de Lacunas"}],zo=[{value:"smart",label:"Inteligente (Auto-H\xEDbrido)"},{value:"command",label:"Apenas Comando (Seguro)"},{value:"javascript",label:"Apenas JS Nativo (Avan\xE7ado)"}],Ye=class{host;shadow;callbacks;autopilot;floatingAnswers;initialSettings;isCollapsed=!1;activeTab="resolver";isBusy=!1;stopwatchInterval=null;stopwatchStartTime=0;latestPlan=null;latestContext=null;latestImages=[];latestImageDescriptions=[];latestPromptText="";metricsLiveTime;metricsLiveStatus;metricsTotalBadge;metricTotalTime;metricAvgTime;metricTotalCount;metricsHistoryList;metricsHistoryCount;metricsCopyBtn;metricsResetBtn;currentQuestionStartTime=0;questionLiveTimerInterval=null;liveDebugTerminal;dbgModel;dbgLatency;dbgSplitTokens;dbgTotalTokens;dbgErrorCard;dbgErrorText;dbgPromptLen;dbgPromptView;dbgContextView;dbgRawRespView;dbgCountAll;dbgCountError;dbgCountAi;dbgCountDom;logEntries=[];activeLogFilter="all";autoScrollLogs=!0;lastErrorMsg=null;_autopilotAnalyzingShown=!1;progressContainer;progressBar;progressLabel;progressVal;contextTreeContainer;launcherBtn;launcherDot;dockToggleBtn;sidebarEl;apToggleBtn;apConsole;executionConsole;dotPulseAp;statusTextAp;stopwatchAp;dotPulseAdv;statusTextAdv;stopwatchAdv;inspModel;inspLatency;inspTokens;inspPrompt;inspRationale;inspActions;copyPromptBtn;apiKeyInput;keyContextMenu;keyMoreBtn;keysListEl;keysBadgeEl;modelSelect;modeSelect;engineSelect;dryRunCheckbox;autoApplyCheckbox;autoAdvanceCheckbox;hostDarkModeCheckbox;useVisionCheckbox;analyzeBtn;applyBtn;resultContainer;constructor(e,t){this.initialSettings=e,this.callbacks=t,this.autopilot=new Je({onStatusChange:(s,d,l)=>{this.logToConsole(d,l),s==="analyzing"?this._autopilotAnalyzingShown||(this._autopilotAnalyzingShown=!0,this.setBusy(!0,"Autopilot: IA analisando...")):s==="advancing"||s==="waiting"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!0)):s==="idle"?(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),d.includes("conclus\xE3o")||d.includes("finalizada")||d.includes("Parab\xE9ns")?this.setStatus("Atividade conclu\xEDda. Resolver Autopilot finalizado com sucesso.","success"):this.setStatus("Resolver Autopilot pausado e aguardando nova a\xE7\xE3o.","info")):s==="error"&&(this._autopilotAnalyzingShown=!1,this.setBusy(!1),this.updateAutopilotUi(!1),this.setStatus("Resolver Autopilot interrompido por erro.","error"))},onRequestAnalysis:async(s,d)=>{try{return await this.callbacks.onAnalyze(s,d,!0)||null}catch{return null}},isManualModeActive:()=>this.floatingAnswers?.isOpen()??!1,onPageAdvance:()=>{this.floatingAnswers?.hide()}}),this.host=document.createElement("div"),this.host.id="easyquiz-shadow-root",this.host.style.position="fixed",this.host.style.top="0",this.host.style.left="0",this.host.style.width="100vw",this.host.style.height="100vh",this.host.style.zIndex="2147483647",this.host.style.pointerEvents="none",this.shadow=this.host.attachShadow({mode:"open"}),Ho(this.shadow,`
              ...
              <div class="eq-view-pane" id="eq-view-resolver">
                ...
                <div class="eq-resolver-cta-row">
                  ...
                  <div class="eq-resolve-menu-shell">
                    <button class="eq-resolve-menu" id="eq-auto-menu-btn" type="button" aria-label="Mais op\xE7\xF5es da IA" title="Mais op\xE7\xF5es da IA">
                ...
                <div class="eq-status-card eq-status-card-resolver is-collapsed" id="eq-status-card" aria-expanded="false">
                  <div class="eq-status-card-header">
                    <div class="eq-status-title-wrap">
                      <span class="eq-status-icon">${k.info}</span>
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new We(this.shadow,()=>{this.callbacks.onAnalyze(1)});let a=this.shadow.querySelector("#eq-open-hud-btn");a&&a.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),xe.filter(s=>W(s.id)).forEach(s=>this.modelSelect.add(new Option(s.name,s.id,!1,s.id===e.model))),Po.forEach(s=>this.modeSelect.add(new Option(s.label,s.value,!1,s.value===e.modeHint))),zo.forEach(s=>this.engineSelect.add(new Option(s.label,s.value,!1,s.value===e.engine))),this.apiKeyInput.value=e.apiKey,this.dryRunCheckbox.checked=e.dryRun,this.autoApplyCheckbox.checked=e.autoApply,this.autoAdvanceCheckbox.checked=e.autoAdvance,this.hostDarkModeCheckbox.checked=e.hostDarkMode,this.useVisionCheckbox.checked=e.useVision,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(e.hostDarkMode);let r=Array.isArray(e.apiKeys)&&e.apiKeys.length>0?e.apiKeys:e.apiKey?[e.apiKey]:[];z.init(r),this.apiKeyInput.value=z.getBestKey()||e.apiKey||"",this.renderKeysList();let n=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof n?.unref=="function"&&n.unref();let i=z.getBestKey()||e.apiKey;i&&Re(i).then(s=>{s&&s.length>0&&this.updateModelSelect(s,e.model)}).catch(()=>{})}switchTab(e){this.activeTab=e;let t=["resolver","brain","media","metrics","debug","settings"];for(let a of t){let r=this.shadow.querySelector(`#eq-tab-${a}`),n=this.shadow.querySelector(`#eq-view-${a}`);a===e?(r?.classList.add("active"),n&&(n.style.display="flex")):(r?.classList.remove("active"),n&&(n.style.display="none"))}e==="brain"?(this.renderContextTree(),this.refreshInspectorView()):e==="media"?this.renderMediaTab():e==="metrics"?this.updateTimingMetrics():e==="debug"&&(this.refreshDebugView(),this.renderTerminalEntries())}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-media")?.addEventListener("click",()=>this.switchTab("media")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let e=this.shadow.querySelector("#eq-status-card");e?.addEventListener("click",()=>{let v=e.classList.toggle("is-collapsed");e.setAttribute("aria-expanded",String(!v))}),this.metricsResetBtn?.addEventListener("click",()=>{qe(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let t=this.shadow.querySelector("#eq-dbg-scroll-toggle");t?.addEventListener("click",()=>{this.autoScrollLogs=!this.autoScrollLogs,t&&(t.style.color=this.autoScrollLogs?"#00ffcc":"#858585",t.title=this.autoScrollLogs?"Auto-Scroll Ligado (Clique para desligar)":"Auto-Scroll Desligado (Clique para ligar)"),this.autoScrollLogs&&this.liveDebugTerminal&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)});let a=this.shadow.querySelector("#eq-dbg-copy-logs");a?.addEventListener("click",()=>{let v=this.getFormattedLogs();navigator.clipboard.writeText(v).then(()=>{let x=a.innerHTML;a.innerHTML=k.check,setTimeout(()=>a.innerHTML=x,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let r=this.shadow.querySelector("#eq-dbg-copy-prompt");r?.addEventListener("click",()=>{let v=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(v).then(()=>{let x=r.innerHTML;r.innerHTML=`${k.check} Copiado!`,setTimeout(()=>r.innerHTML=x,1800)})});let n=this.shadow.querySelector("#eq-dbg-copy-context");n?.addEventListener("click",()=>{let v=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let x=n.innerHTML;n.innerHTML=`${k.check} Copiado!`,setTimeout(()=>n.innerHTML=x,1800)})});let i=this.shadow.querySelector("#eq-dbg-copy-raw-resp");i?.addEventListener("click",()=>{let v=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let x=i.innerHTML;i.innerHTML=`${k.check} Copiado!`,setTimeout(()=>i.innerHTML=x,1800)})});let s=this.shadow.querySelector("#eq-dbg-copy-error-btn");s?.addEventListener("click",()=>{let v=this.lastErrorMsg||"";navigator.clipboard.writeText(v).then(()=>{let x=s.innerHTML;s.innerHTML=k.check,setTimeout(()=>s.innerHTML=x,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",v=>{v.altKey&&(v.key==="q"||v.key==="Q"||v.key==="a"||v.key==="A")&&(v.preventDefault(),this.toggle())},!0);let d=v=>{let x=v.composedPath();x.includes(this.shadow)||(x.includes(this.sidebarEl)||x.includes(this.host))&&v.stopImmediatePropagation()};window.addEventListener("keydown",d,!0),window.addEventListener("keyup",d,!0),window.addEventListener("keypress",d,!0),this.apiKeyInput.addEventListener("input",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:v})});let l=this.shadow.querySelector("#eq-keys-collapsible"),u=this.shadow.querySelector("#eq-keys-chevron"),g=this.shadow.querySelector("#eq-keys-section-header"),c=v=>{l&&(v?(l.style.display="none",u&&(u.style.transform="rotate(0deg)")):(l.style.display="block",l.style.maxHeight="none",l.style.overflow="visible",u&&(u.style.transform="rotate(90deg)")))},m=!1;try{m=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}c(m),g?.addEventListener("click",v=>{if(v.target?.closest("a"))return;let x=l?.style.display==="none";c(!x);try{localStorage.setItem("easyquiz_keys_collapsed",x?"false":"true")}catch{}});let p=this.shadow.querySelector("#eq-auto-menu-btn"),f=this.shadow.querySelector("#eq-auto-menu");f&&(f.hidden=!0),p?.classList.remove("is-open"),p?.addEventListener("click",v=>{if(v.stopPropagation(),!f)return;let x=f.hidden;f.hidden=!x,p.classList.toggle("is-open",!f.hidden)}),f?.querySelectorAll("[data-auto-action]").forEach(v=>{v.addEventListener("click",()=>{let x=v.dataset.autoAction;if(x==="toggle")this.analyzeBtn?.click();else if(x==="memory")Oe(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success");else if(x==="status"){let E=this.shadow.querySelector("#eq-status-card");E?.classList.remove("is-collapsed"),E?.setAttribute("aria-expanded","true"),E?.scrollIntoView({behavior:"smooth",block:"nearest"})}f.hidden=!0,p?.classList.remove("is-open")})}),this.shadow.addEventListener("click",v=>{let x=v.target;!x.closest("#eq-auto-menu")&&!x.closest("#eq-auto-menu-btn")&&(f?.setAttribute("hidden","true"),p?.classList.remove("is-open"))}),this.shadow.querySelector("#eq-key-save").addEventListener("click",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!v){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let x=z.addKey(v);if(x.ok){let E=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:E[0],apiKeys:E}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${E.length} chaves ativas no pool)`,"success"),c(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,Be(v).then(T=>{T.ok?(z.markSuccess(v,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(z.markInvalid(v,T.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${T.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(x.message,"warning")}),this.keyMoreBtn.addEventListener("click",v=>{v.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",v=>{let x=v.target;!x.closest("#eq-key-context-menu")&&!x.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(v!==null&&v.trim()){let x=v.trim().replace(/^["']|["']$/g,""),E=z.addKey(x);if(E.ok){let T=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(E.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let v=await navigator.clipboard.readText();if(v){let x=v.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=x,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let v=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(v!==null&&v.trim()){let x=v.trim().replace(/^["']|["']$/g,"");if(z.addKey(x).ok){let T=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=this.apiKeyInput.type==="password";this.apiKeyInput.type=v?"text":"password";let x=this.shadow.querySelector("#eq-menu-vis-icon"),E=this.shadow.querySelector("#eq-menu-vis-text");x&&(x.innerHTML=v?k.eyeOff:k.eye),E&&(E.textContent=v?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let v=document.createElement("div");v.id="eq-bulk-overlay",v.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let x=document.createElement("div");x.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),x.innerHTML=`
      ...
      `,v.appendChild(x),this.shadow.appendChild(v);let E=x.querySelector("#eq-bulk-ta"),T=x.querySelector("#eq-bulk-status"),M=x.querySelector("#eq-bulk-import"),w=x.querySelector("#eq-bulk-paste-btn"),L=x.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>E?.focus());let S=()=>{v.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(C=>{v.addEventListener(C,I=>{I.stopPropagation(),I.stopImmediatePropagation()},!0)}),v.addEventListener("keydown",C=>{C.key==="Escape"&&S()}),v.addEventListener("click",C=>{C.target===v&&S()}),x.querySelector("#eq-bulk-x")?.addEventListener("click",S),x.querySelector("#eq-bulk-cancel")?.addEventListener("click",S),L.addEventListener("click",()=>{E.value="",T.textContent="",E.focus()}),w.addEventListener("click",async()=>{try{let C=await navigator.clipboard?.readText();C?(E.value=C,E.focus(),T.style.color="#38bdf8",T.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(T.style.color="#fbbf24",T.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{T.style.color="#fbbf24",T.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",E.focus()}}),x.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let C=E.value.trim();if(!C){T.style.color="#f87171",T.textContent="Insira pelo menos uma chave de API antes de importar.";return}let I=C.match(/AIza[0-9A-Za-z\-_]{35}/g),D=[];if(I&&I.length>0?D=Array.from(new Set(I)):D=Array.from(new Set(C.split(/[\n,;\s]+/).map(V=>V.trim().replace(/^["'`]|["'`]$/g,"")).filter(V=>V.length>=20))),D.length===0){T.style.color="#f87171",T.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}T.style.color="#00e5ff",T.textContent=`Processando ${D.length} chave(s)...`,M.disabled=!0,M.style.opacity="0.6";let B=0,N=0;for(let V of D){let ae=z.addKey(V);ae.ok?B++:ae.message.includes("j\xE1 est\xE1 cadastrada")&&N++}if(B>0){let V=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:V[0],apiKeys:V}),c(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}T.textContent=`${B} adicionada(s), ${N} duplicada(s). Validando modelo em paralelo...`;let X=z.exportRawKeys(),U=this.modelSelect?.value||"gemini-3.5-flash-lite",G=await nt(U,X);G.ok?(z.markSuccess(G.key,200),T.style.color="#4ade80",T.textContent=` ${B} adicionada(s), ${N} duplicada(s). Modelo '${G.model}' pronto!`):(T.style.color="#fbbf24",T.textContent=`${B} adicionada(s), ${N} duplicada(s). Aviso: ${G.message}`),this.renderKeysList(),M.disabled=!1,M.style.opacity="1",B>0&&(this.setStatus(` Lote importado: ${B} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(S,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let v=z.exportRawKeys(),x=document.createElement("div");x.id="eq-text-editor-overlay",x.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let E=document.createElement("div");E.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),E.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
...
`)}setLastError(e){this.lastErrorMsg=e,this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=e,this.dbgErrorCard.style.display="flex")}setErrorDiagnostic(e,t){let a=t?`[${t}] ${e}`:e;this.setLastError(a)}refreshDebugView(){let e=this.latestPlan,t=this.latestContext,a=this.latestPromptText||e?.promptSent||"";if(this.dbgModel&&(this.dbgModel.textContent=e?.usedModel||this.initialSettings.model||"--"),this.dbgLatency&&(this.dbgLatency.textContent=e?.durationMs?`${e.durationMs}ms`:"--"),this.dbgSplitTokens){let r=e?.promptTokens!==void 0?String(e.promptTokens):"--",n=e?.candidatesTokens!==void 0?String(e.candidatesTokens):"--";this.dbgSplitTokens.textContent=`${r} / ${n}`,this.dbgSplitTokens.title=`Prompt: ${r} tokens | Resposta: ${n} tokens`}if(this.dbgTotalTokens){let r=e?.tokensUsed??(e?.promptTokens&&e?.candidatesTokens?e.promptTokens+e.candidatesTokens:void 0);this.dbgTotalTokens.textContent=r!==void 0?`${r}`:"--"}if(this.dbgPromptLen){let r=a.length,n=Math.round(r/4);this.dbgPromptLen.textContent=`${r} chars (~${n} tokens est.)`}if(this.dbgPromptView&&(this.dbgPromptView.textContent=a||"Nenhum prompt enviado at\xE9 o momento."),this.dbgContextView)if(t){let r={scope:`${t.scope.tagName.toLowerCase()}${t.scope.id?"#"+t.scope.id:""}${t.scope.className?"."+t.scope.className.split(" ").join("."):""}`,questionLength:t.questionText.length,questionSnippet:t.questionText.slice(0,150)+(t.questionText.length>150?"...":""),controlsCount:t.controls.length,controls:t.controls.map((n,i)=>({index:i+1,tag:n.tag,type:n.type,name:n.name||void 0,id:n.id||void 0,value:n.value||void 0,label:n.label||void 0,role:n.role}))};this.dbgContextView.textContent=JSON.stringify(r,null,2)}else this.dbgContextView.textContent="Aguardando captura de contexto pelo EasyQuiz...";this.dbgRawRespView&&(e?e.rawResponse?this.dbgRawRespView.textContent=e.rawResponse:this.dbgRawRespView.textContent=JSON.stringify({pageType:e.pageType,mode:e.mode,confidence:e.confidence,rationale:e.rationale,actions:e.actions},null,2):this.dbgRawRespView.textContent="Aguardando retorno da API Gemini..."),this.lastErrorMsg&&this.dbgErrorCard&&this.dbgErrorText&&(this.dbgErrorText.textContent=this.lastErrorMsg,this.dbgErrorCard.style.display="flex")}logToConsole(e,t){let a=new Date,r=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}:${String(a.getSeconds()).padStart(2,"0")}.${String(Math.floor(a.getMilliseconds()/100))}`,n=e;e.startsWith(">")?n=`> [${r}] ${e.slice(1).trim()}`:n=`[${r}] ${e}`;let i="all";t==="text-red"||n.includes("[ERRO]")||n.includes("Falha")||n.includes("Error")?i="error":n.includes("[IA]")||n.includes("[RAG]")||n.includes("Tokens")||n.includes("Gemini")||n.includes("Modelo:")?i="ai":(n.includes("[DOM]")||n.includes("[EXEC]")||n.includes("[VERIF]")||n.includes("[NAV]"))&&(i="dom");let s={id:Date.now()+Math.random(),timestamp:r,message:n,colorClass:t,category:i};for(this.logEntries.push(s);this.logEntries.length>250;)this.logEntries.shift();if(this.updateLogCounters(),i==="error"&&this.setLastError(n),this.liveDebugTerminal&&(this.activeLogFilter==="all"||this.activeLogFilter===i)){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.liveDebugTerminal.appendChild(d);this.liveDebugTerminal.children.length>250;)this.liveDebugTerminal.removeChild(this.liveDebugTerminal.firstChild);this.autoScrollLogs&&(this.liveDebugTerminal.scrollTop=this.liveDebugTerminal.scrollHeight)}if(this.apConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.apConsole.appendChild(d),this.apConsole.scrollTop=this.apConsole.scrollHeight;this.apConsole.children.length>150;)this.apConsole.removeChild(this.apConsole.firstChild)}if(this.executionConsole){let d=document.createElement("div");for(d.textContent=n,t&&(d.className=t),this.executionConsole.appendChild(d),this.executionConsole.scrollTop=this.executionConsole.scrollHeight;this.executionConsole.children.length>150;)this.executionConsole.removeChild(this.executionConsole.firstChild)}}setProgress(e,t){if(!this.progressContainer||!this.progressBar)return;if(e<=0){this.progressContainer.style.display="none",this.progressBar.style.width="0%";return}this.progressContainer.style.display="flex";let a=Math.min(100,Math.max(0,Math.round(e)));this.progressBar.style.width=`${a}%`,this.progressVal&&(this.progressVal.textContent=`${a}%`),t&&this.progressLabel&&(this.progressLabel.textContent=t),a>=100&&setTimeout(()=>{this.progressContainer&&this.progressBar&&this.progressBar.style.width==="100%"&&(this.progressContainer.style.display="none")},1500)}updateContext(e,t){this.latestContext=e,t&&(this.latestPlan=t,t.imageDescriptions&&(this.latestImageDescriptions=t.imageDescriptions,this.renderMediaTab())),this.activeTab==="brain"?(this.renderContextTree(),t&&this.refreshInspectorView()):this.activeTab==="debug"&&this.refreshDebugView()}updateImages(e){this.latestImages=e,this.activeTab==="brain"&&this.renderContextTree(),(this.activeTab==="media"||e.length>0)&&this.renderMediaTab()}renderMediaTab(){let e=this.shadow?.querySelector("#eq-media-grid"),t=this.shadow?.querySelector("#eq-media-count-badge");if(!e)return;let a=this.latestImages,r=this.latestImageDescriptions;if(t&&(t.textContent=`${a.length} m\xEDdias`),a.length===0){e.innerHTML=`
        <div class="text-muted" style="padding: 16px 0; text-align: center;">
          ...
          </div>`;let f=u?'<span style="font-size:9px;font-weight:700;padding:1px 5px;border-radius:3px;background:rgba(251,191,36,0.14);border:1px solid rgba(251,191,36,0.4);color:#fbbf24;">RELEVANTE</span>':'<span style="font-size:9px;font-weight:700;padding:1px 5px;border-radius:3px;background:rgba(255,85,85,0.2);border:1px solid rgba(255,85,85,0.4);color:#ff5555;">IGNORADA</span>',h=`
        <div style="padding: 10px 12px; display: flex; flex-direction: column; gap: 6px;">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-size:11px;font-weight:700;color:#e0e0e0;">Imagem ${i+1}</span>
            ${f}
          </div>
          <div style="font-size:10px;color:#aaa;line-height:1.5;">${g}</div>
        ...
        </div>`;c.innerHTML=p+h,e.appendChild(c)})}renderContextTree(){if(!this.contextTreeContainer)return;let e=this.latestContext,t=De(),a=this.latestPlan;this.contextTreeContainer.innerHTML="";let r=this.createTreeFolder(" P\xC1GINA & ESCOPO ATUAL",!0,[{label:"T\xEDtulo",value:document.title||"Sem t\xEDtulo"},{label:"URL",value:window.location.pathname||"/"},{label:"Escopo DOM",value:e?`${e.scope.tagName.toLowerCase()}${e.scope.className?"."+e.scope.className.split(" ").join("."):""}`:"Document"},{label:"Tamanho Texto",value:e?`${e.questionText.length} caracteres`:"N\xE3o analisado"},{label:"Trecho Enunciado",value:e?`"${e.questionText.slice(0,120)}..."`:"Nenhum"}]);this.contextTreeContainer.appendChild(r);let n=e?e.controls:[],i=n.map((p,f)=>{let h=p.role==="navigation"||p.type==="button",b=!h&&p.value?` [val: "${p.value}"]`:"";return{label:`[#${f+1}] ${p.type.toUpperCase()}`,value:`${p.label||p.id||p.name||"(Sem r\xF3tulo)"}${b}`.trim(),badge:h?"Navega\xE7\xE3o":p.role||p.type}}),s=this.createTreeFolder(`\uFE0F CONTROLES DETECTADOS (${n.length})`,n.length>0,i);this.contextTreeContainer.appendChild(s);let d=t.map((p,f)=>({label:`Mem\xF3ria #${f+1}`,value:p,badge:"RAG"})),l=this.createTreeFolder(` MEM\xD3RIA RAG ACUMULADA (${t.length})`,t.length>0,d);if(this.contextTreeContainer.appendChild(l),a){let p=this.createTreeFolder(` \xDALTIMO PLANO IA (${a.actions.length} a\xE7\xF5es)`,!0,[{label:"Tipo P\xE1gina",value:a.pageType,badge:`${(a.confidence*100).toFixed(0)}%`},{label:"Modo",value:a.mode},{label:"Racioc\xEDnio",value:a.rationale||"N/A"},...a.actions.map((f,h)=>({label:`A\xE7\xE3o #${h+1} (${f.t})`,value:JSON.stringify(f)}))]);this.contextTreeContainer.appendChild(p)}let u=this.latestImages,g=this.latestImageDescriptions,c=u.map((p,f)=>{let h=g.find(x=>x.index===f),b=(p.captureStatus==="captured"||p.captureStatus==="text_only",""),A=p.captureStatus==="captured"?"Visual":p.captureStatus==="text_only"?"Texto":"Falhou",y=h?h.relevant?" Relevante":"\uFE0F Ignorada":"\u2014",v=h?h.description:p.textContext?p.textContext:"Aguardando an\xE1lise IA...";return{label:`${b} Img ${f+1} [${A}]`,value:`${v}`,badge:y,imgSrc:p.base64?`data:${p.mediaType||"image/jpeg"};base64,${p.base64}`:void 0}}),m=this.createTreeFolder(`\uFE0F IMAGENS DETECTADAS (${u.length})`,!0,c);this.contextTreeContainer.appendChild(m)}createTreeFolder(e,t,a){let r=document.createElement("div");r.className="eq-tree-node";let n=document.createElement("div");n.className="eq-tree-header",n.innerHTML=`<span class="eq-tree-arrow">${t?"\u25BC":"\u25B6"}</span> <span>${e}</span>`;let i=document.createElement("div");if(i.className="eq-tree-content",i.style.display=t?"flex":"none",a.length===0)i.innerHTML='<div class="text-muted" style="padding: 2px 0;">Nenhum item registrado.</div>';else for(let s of a){let d=document.createElement("div");d.className="eq-tree-leaf";let l="";s.imgSrc&&s.imgSrc.startsWith("data:image")&&(l=`<div style="margin-top: 8px; margin-bottom: 4px;"><img src="${s.imgSrc}" style="max-width: 100%; max-height: 120px; border-radius: 4px; border: 1px solid #3c4043; background: #1e1f22;" alt="Captura"></div>`),d.innerHTML=`
        ...
        `,i.appendChild(d)}return n.addEventListener("click",()=>{let s=i.style.display==="none";i.style.display=s?"flex":"none";let d=n.querySelector(".eq-tree-arrow");d&&(d.textContent=s?"\u25BC":"\u25B6")}),r.appendChild(n),r.appendChild(i),r}toggle(e){e!==void 0?this.isCollapsed=!e:this.isCollapsed=!this.isCollapsed,this.isCollapsed?this.sidebarEl.classList.add("eq-collapsed"):(this.sidebarEl.classList.remove("eq-collapsed"),z.getAllKeys().length===0&&(this.switchTab("settings"),this.apiKeyInput.focus()))}updateAutopilotUi(e){let t=this.analyzeBtn;if(t){let a=t.closest(".eq-resolver-cta-row"),r=e?"Parar Autopilot":"Resolver Autopilot",n=e?k.stop:k.sparkles;a&&(a.classList.toggle("is-running",e),a.classList.toggle("is-idle",!e)),t.classList.toggle("is-running",e),t.classList.toggle("is-idle",!e),t.classList.toggle("danger",e),t.innerHTML=`<span class="eq-btn-icon">${n}</span><span class="eq-btn-label">${r}</span>`,t.title=e?"Interromper o Resolver Autopilot":"Ligar o Resolver Autopilot"}this.apToggleBtn&&(this.apToggleBtn.innerHTML=`${e?k.stop:k.sparkles} ${e?"Parar Autopilot":"Resolver Autopilot"}`,this.apToggleBtn.classList.toggle("danger",e),this.apToggleBtn.title=e?"Interromper o Resolver Autopilot":"Ligar o Resolver Autopilot")}setOperationState(e,t){let a=this.shadow.querySelector("#eq-operation-state"),r=this.shadow.querySelector("#eq-status-card");a&&(a.innerHTML=`${k.info} <span>${e}</span>`,a.className=`eq-operation-state is-${t}`),r&&(r.classList.remove("is-busy","is-success","is-error","is-warning","is-info"),r.classList.add(`is-${t}`));let n=this.analyzeBtn;if(n){let i=n.closest(".eq-resolver-cta-row");i&&(i.classList.remove("status-busy","status-success","status-error","status-warning","status-info"),i.classList.add(`status-${t}`)),n.classList.remove("status-busy","status-success","status-error","status-warning","status-info"),n.classList.add(`status-${t}`)}}setInterrupted(e="An\xE1lise interrompida pelo usu\xE1rio."){this.isBusy=!1,[this.modelSelect,this.modeSelect,this.engineSelect,this.dryRunCheckbox,this.autoApplyCheckbox,this.autoAdvanceCheckbox,this.useVisionCheckbox].forEach(a=>a.disabled=!1);let t=this.analyzeBtn.closest(".eq-resolver-cta-row");t&&t.classList.remove("is-running"),this.analyzeBtn.disabled=!1,this.analyzeBtn.classList.remove("danger"),this.analyzeBtn.innerHTML=`<span class="eq-btn-icon">${k.sparkles}</span><span class="eq-btn-label">Resolver Autopilot</span>`,this.analyzeBtn.title="Ligar o Resolver Autopilot",this.applyBtn&&(this.applyBtn.disabled=!this.latestPlan||!this.latestPlan.actions.length),this.stopStopwatch(),this.stopQuestionTimer(),this.dotPulseAp.className="eq-dot-pulse stopped",this.dotPulseAdv.className="eq-dot-pulse stopped",this.launcherDot.className="eq-launcher-dot stopped",this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Interrompido",this.metricsLiveStatus.className="eq-live-stopwatch-status is-warning"),this.autopilot.isActive()||this.updateAutopilotUi(!1),this.setStatus(e,"warning")}setBusy(e,t){this.isBusy=e,[this.modelSelect,this.modeSelect,this.engineSelect,this.dryRunCheckbox,this.autoApplyCheckbox,this.autoAdvanceCheckbox,this.useVisionCheckbox].forEach(r=>r.disabled=e);let a=this.analyzeBtn.closest(".eq-resolver-cta-row");e?(a&&a.classList.add("is-running"),this.analyzeBtn.disabled=!1,this.analyzeBtn.classList.add("danger"),this.analyzeBtn.innerHTML=`<span class="eq-btn-icon">${k.stop}</span><span class="eq-btn-label">Parar Autopilot</span>`,this.analyzeBtn.title="Interromper o Resolver Autopilot",this.applyBtn&&(this.applyBtn.disabled=!0),this.startStopwatch(),this.startQuestionTimer(),this.dotPulseAp.className="eq-dot-pulse busy",this.dotPulseAdv.className="eq-dot-pulse busy",this.launcherDot.className="eq-launcher-dot busy",this.setOperationState("Analisando...","busy"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Calculando...",this.metricsLiveStatus.className="eq-live-stopwatch-status is-busy"),t&&this.setStatus(t,"info")):(this.analyzeBtn.disabled=!1,this.analyzeBtn.classList.remove("danger"),this.analyzeBtn.innerHTML=`<span class="eq-btn-icon">${k.sparkles}</span><span class="eq-btn-label">Resolver Autopilot</span>`,this.analyzeBtn.title="Ligar o Resolver Autopilot",this.applyBtn&&(this.applyBtn.disabled=!this.latestPlan||!this.latestPlan.actions.length),this.stopStopwatch(),this.stopQuestionTimer(),this.dotPulseAp.className="eq-dot-pulse",this.dotPulseAdv.className="eq-dot-pulse",this.launcherDot.className="eq-launcher-dot",this.setOperationState(this.autopilot.isActive()?"Monitorando":"Pronto","idle"),this.metricsLiveStatus&&this.metricsLiveStatus.textContent==="Calculando..."&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.className="eq-live-stopwatch-status"))}setStatus(e,t="info"){let a=this.shadow.querySelector("#eq-status-summary");a&&(a.textContent=e),this.statusTextAp&&(this.statusTextAp.textContent=e),this.statusTextAdv&&(this.statusTextAdv.textContent=e),t==="error"?(this.setOperationState("Bloqueado","error"),this.dotPulseAp.className="eq-dot-pulse error",this.dotPulseAdv.className="eq-dot-pulse error",this.launcherDot.className="eq-launcher-dot error"):t==="warning"?(this.setOperationState("Interrompido","warning"),this.dotPulseAp.className="eq-dot-pulse stopped",this.dotPulseAdv.className="eq-dot-pulse stopped",this.launcherDot.className="eq-launcher-dot stopped"):t==="success"?(this.setOperationState("Confirmado","success"),this.dotPulseAp.className="eq-dot-pulse",this.dotPulseAdv.className="eq-dot-pulse",this.launcherDot.className="eq-launcher-dot"):this.isBusy?(this.setOperationState("Analisando...","busy"),this.dotPulseAp.className="eq-dot-pulse busy",this.dotPulseAdv.className="eq-dot-pulse busy",this.launcherDot.className="eq-launcher-dot busy"):(this.setOperationState(this.autopilot.isActive()?"Monitorando":"Pronto","info"),this.dotPulseAp.className="eq-dot-pulse",this.dotPulseAdv.className="eq-dot-pulse",this.launcherDot.className="eq-launcher-dot");let r=e.includes("Alternando")||e.includes("indispon\xEDvel")||e.includes("fallback")||e.includes("alternativo"),n=t==="error"?"> [ERRO] ":t==="success"?"> [SUCESSO] ":t==="warning"?"> [PARADO] ":r?"> [FALLBACK] ":"> [SYS] ",i=t==="error"?"text-red":t==="success"?"text-green":t==="warning"||r?"text-yellow":"text-blue";this.logToConsole(`${n}${e}`,i)}setPlan(e,t){if(this.latestPlan=e,this.resultContainer.style.display="flex",e.durationMs&&this.stopStopwatch(e.durationMs),e.usedModel){let d=this.shadow.querySelector("#eq-active-model-badge");if(d){let l=e.usedModel.replace("gemini-","").replace("-latest","");d.textContent=`\u25CF ${l}`,d.style.display="inline-block"}}let a=this.shadow.querySelector("#eq-badges");a.replaceChildren();let r=[e.mode.replace("_"," "),`${Math.round(e.confidence*100)}% Confian\xE7a`,`${e.actions.length} a\xE7\xF5es`,...e.usedModel?[e.usedModel]:[]];for(let d of r){let l=document.createElement("span");l.className="eq-brand-badge",l.textContent=d,a.appendChild(l)}let n=this.shadow.querySelector("#eq-rationale-text");n.textContent=e.rationale;let i=this.shadow.querySelector("#eq-actions-list");i.innerHTML="";for(let d of e.actions){let l=document.createElement("div");l.className="eq-action-item";let u="";d.t==="chk"?u=`chk ${d.id} (${d.c})`:d.t==="val"?u=`val "${d.v}" -> ${d.id}`:d.t==="sel"?u=`sel "${Array.isArray(d.v)?d.v.join(","):d.v}" -> ${d.id}`:d.t==="clk"?u=`clk ${d.id}`:d.t==="adv"?u="adv":d.t==="js"?u=`js: ${String(d.v).slice(0,40)}...`:d.t==="drag"&&(u=`drag "${d.from}" -> "${d.to}"`);let g=document.createElement("span");g.className="eq-action-badge",g.textContent=d.t.toUpperCase();let c=document.createElement("span");c.textContent=u,l.append(g,c),i.appendChild(l)}this.applyBtn&&(this.applyBtn.disabled=!t||!e.actions.length);let s=this.shadow.querySelector("#eq-execution-card");s&&(s.hidden=!0),e.imageDescriptions&&e.imageDescriptions.length>0&&(this.latestImageDescriptions=e.imageDescriptions,this.renderMediaTab()),this.refreshInspectorView(),this.refreshDebugView()}setExecutionReport(e){let t=this.shadow.querySelector("#eq-execution-card"),a=this.shadow.querySelector("#eq-execution-summary"),r=this.shadow.querySelector("#eq-execution-list");if(!t||!a||!r)return;t.hidden=!1,a.textContent=e.navigationVerified?`${e.verified}/${e.applied} a\xE7\xF5es verificadas. Navega\xE7\xE3o confirmada.`:`${e.verified}/${e.applied} a\xE7\xF5es verificadas. ${e.navigationEvidence}`,a.className=`eq-execution-summary ${e.success?"is-success":"is-warning"}`,r.replaceChildren();let n=this.shadow.querySelector("#eq-execution-placeholder");n&&(n.textContent=e.navigationVerified?"Fluxo conclu\xEDdo: aplica\xE7\xE3o e navega\xE7\xE3o confirmadas.":`Fluxo interrompido: ${e.navigationEvidence}`,n.className=`eq-execution-placeholder ${e.success?"is-success":"is-warning"}`);for(let i of e.reports){let s=document.createElement("div");s.className=`eq-execution-row ${i.verified?"is-success":"is-failed"}`;let d=document.createElement("span");d.className="eq-execution-state",d.textContent=i.verified?"OK":"FALHOU";let l=document.createElement("div");l.className="eq-execution-details";let u=document.createElement("strong");u.textContent=i.target;let g=document.createElement("span");if(g.textContent=`${i.strategy} | ${i.evidence}`,l.append(u,g),s.append(d,l),i.error){let c=document.createElement("small");c.textContent=i.error,s.appendChild(c)}r.appendChild(s)}}setInspectorPrompt(e,t){this.latestPromptText=e,this.inspPrompt&&(this.inspPrompt.textContent=e),t&&this.inspModel&&(this.inspModel.textContent=t),this.inspLatency&&(this.inspLatency.textContent="Aguardando IA..."),this.activeTab==="debug"&&this.refreshDebugView()}refreshInspectorView(){let e=this.latestPlan;if(e)if(this.inspModel.textContent=e.usedModel||this.initialSettings.model,this.inspLatency.textContent=e.durationMs?`${e.durationMs}ms`:"--",this.inspTokens.textContent=e.tokensUsed?`${e.tokensUsed}`:"--",this.inspPrompt.textContent=e.promptSent||this.latestPromptText||"Prompt n\xE3o registrado para esta requisi\xE7\xE3o.",this.inspRationale.textContent=e.rationale,this.inspActions.innerHTML="",e.actions.length>0)for(let t of e.actions){let a=document.createElement("div");a.className="eq-action-item",a.textContent=JSON.stringify(t),this.inspActions.appendChild(a)}else this.inspActions.innerHTML='<div class="text-muted" style="padding: 4px;">Nenhuma a\xE7\xE3o prescrita pela IA.</div>';else this.latestPromptText&&(this.inspPrompt.textContent=this.latestPromptText)}showFloatingAnswers(e){let t=e||this.latestPlan;t&&this.floatingAnswers.show(t)}hideFloatingAnswers(){this.floatingAnswers.hide()}renderKeysList(){if(!this.keysListEl)return;let e=z.getAllKeys();if(this.keysBadgeEl){let r=e.filter(s=>!s.isCooldown).length,n=e.reduce((s,d)=>s+(d.winCount||0),0),i=r>=3?"  TURBO":"";this.keysBadgeEl.textContent=`${e.length} chave${e.length>1?"s":""} (${r} pronta${r!==1?"s":""})${i}`,this.keysBadgeEl.className=`eq-key-badge ${r>=3?"racing":r>0?"ready":"cooldown"}`}this.keysListEl.replaceChildren();let t=this.shadow?.querySelector("#eq-keys-collapsible");t&&t.style.display!=="none"&&(t.style.maxHeight="none",t.style.overflow="visible"),[...e].sort((r,n)=>{let i=r.winCount||0,s=n.winCount||0;if(i!==s)return s-i;let d=r.lastLatencyMs||99999,l=n.lastLatencyMs||99999;if(d!==l)return d-l;let u=r.isCooldown?1:0,g=n.isCooldown?1:0;return u-g}).forEach((r,n)=>{let i=e.findIndex(A=>A.id===r.id),s=i>=0?i:n,d=document.createElement("div");d.className="eq-key-item";let l=document.createElement("div");l.className="eq-key-info";let u=document.createElement("span");u.className="eq-key-label",u.textContent=r.label||`Chave ${s+1}`;let g=document.createElement("span");g.className="eq-key-masked",g.textContent=_.maskKey(r.key),g.title="Clique para copiar a chave",g.style.cursor="pointer",g.addEventListener("click",()=>{navigator.clipboard?.writeText(r.key),this.setStatus(`Chave ${s+1} copiada para a \xE1rea de transfer\xEAncia!`,"info")});let c=document.createElement("span");if(r.isCooldown){c.className="eq-key-badge cooldown";let A=Math.ceil(r.remainingCooldownMs/1e3);c.textContent=`\u23F1 Cooldown (${A}s)`}else r.lastError&&r.errorCount&&r.errorCount>3?(c.className="eq-key-badge invalid",c.textContent="Erro",c.title=r.lastError):r.lastLatencyMs?(c.className="eq-key-badge ready",c.textContent=`Pronta (${r.lastLatencyMs}ms)`):(c.className="eq-key-badge ready",c.textContent="Pronta");l.appendChild(u),l.appendChild(g),l.appendChild(c);let m=r.winCount||0;if(m>0){let A=document.createElement("span");A.className="eq-key-badge winner",A.textContent=` ${m} vit\xF3ria${m>1?"s":""}`,A.title=`Esta chave foi a mais r\xE1pida ${m} vez${m>1?"es":""} nas corridas paralelas`,l.appendChild(A)}let p=document.createElement("div");p.className="eq-key-actions";let f=document.createElement("button");f.className="eq-icon-btn",f.type="button",f.title="Testar esta chave",f.innerHTML=k.sparkles,f.addEventListener("click",async()=>{this.setStatus(`Testando chave ${r.label||s+1}...`,"info");let A=await Be(r.key);A.ok?(z.markSuccess(r.key,120),this.setStatus(` ${r.label||`Chave ${s+1}`}: Conex\xE3o com Google Gemini aprovada!`,"success")):(z.markInvalid(r.key,A.message),this.setStatus(`\uFE0F ${r.label||`Chave ${s+1}`}: ${A.message}`,"error")),this.renderKeysList()});let h=document.createElement("button");h.className="eq-icon-btn",h.type="button",h.title="Editar chave",h.innerHTML=k.edit,h.addEventListener("click",()=>{let A=window.prompt(`Editar ${r.label||`Chave ${s+1}`}:`,r.key);if(A!==null&&A.trim()){let y=z.updateKey(r.id,A.trim());if(y.ok){let v=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:v[0],apiKeys:v}),this.setStatus(`Chave ${s+1} atualizada com sucesso!`,"success"),this.renderKeysList()}else this.setStatus(y.message,"warning")}});let b=document.createElement("button");b.className="eq-icon-btn",b.type="button",b.title="Remover chave",b.innerHTML=k.trash,b.addEventListener("click",()=>{if(confirm(`Remover permanentemente a ${r.label||`Chave ${s+1}`}?`)){let A=z.removeKey(r.id);if(A.ok){let y=z.exportRawKeys();this.callbacks.onSettingsChange({apiKey:y[0]||"",apiKeys:y}),this.setStatus("Chave removida com sucesso.","info"),this.renderKeysList()}else this.setStatus(A.message,"warning")}}),p.appendChild(f),p.appendChild(h),p.appendChild(b),d.appendChild(l),d.appendChild(p),this.keysListEl.appendChild(d)})}updateModelSelect(e,t){let a=e.filter(i=>W(i.id)),r=t&&W(t)?t:W(this.initialSettings.model)?this.initialSettings.model:"gemini-2.5-flash";this.modelSelect.innerHTML="";let n=!1;a.forEach(i=>{let s=i.id===r;s&&(n=!0),this.modelSelect.add(new Option(i.name,i.id,!1,s))}),!n&&r&&W(r)&&this.modelSelect.add(new Option(`Gemini (${r})`,r,!1,!0)),this.modelSelect.value=r}updateSelectedModel(e){if(!W(e))return;Array.from(this.modelSelect.options).some(a=>a.value===e)||this.modelSelect.add(new Option(`Gemini (${e})`,e,!1,!0)),this.modelSelect.value=e}mountHost(){let e=document.body||document.documentElement;if(!e){let t=()=>{let a=document.body||document.documentElement;a&&!this.host.isConnected&&a.appendChild(this.host)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t,{once:!0}):setTimeout(t,0);return}this.host.isConnected||e.appendChild(this.host)}applyHostDarkMode(e){document.getElementById("eq-host-dark-mode-style")?.remove(),this.host.classList.toggle("eq-dark-mode-active",e)}startQuestionTimer(){this.currentQuestionStartTime=Date.now(),this.questionLiveTimerInterval&&clearInterval(this.questionLiveTimerInterval),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Calculando...",this.metricsLiveStatus.classList.add("active"));let e=()=>{if(!this.metricsLiveTime)return;let t=Date.now()-this.currentQuestionStartTime,a=Math.floor(t/6e4),r=Math.floor(t%6e4/1e3),n=Math.floor(t%1e3/10);this.metricsLiveTime.textContent=`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}.${String(n).padStart(2,"0")}`};e(),this.questionLiveTimerInterval=setInterval(e,50)}stopQuestionTimer(e){if(this.questionLiveTimerInterval&&(clearInterval(this.questionLiveTimerInterval),this.questionLiveTimerInterval=null),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Parado",this.metricsLiveStatus.classList.remove("active")),this.metricsLiveTime&&this.currentQuestionStartTime>0){let t=e!==void 0?e:Math.max(0,Date.now()-this.currentQuestionStartTime),a=Math.floor(t/6e4),r=Math.floor(t%6e4/1e3),n=Math.floor(t%1e3/10);this.metricsLiveTime.textContent=`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}.${String(n).padStart(2,"0")}`}}updateTimingMetrics(e){let t=e||Ee();if(!this.metricTotalTime)return;let a=Math.floor(t.totalElapsedMs/1e3),r=Math.floor(a/60),n=a%60;this.metricTotalTime.textContent=`${String(r).padStart(2,"0")}:${String(n).padStart(2,"0")}`;let i=(t.averageDurationMs/1e3).toFixed(1);this.metricAvgTime.textContent=`${i}s`,this.metricTotalCount.textContent=String(t.completedQuestionsCount),this.metricsTotalBadge&&(this.metricsTotalBadge.textContent=`${t.completedQuestionsCount} Quest\xE3o(\xF5es)`),this.metricsHistoryCount&&(this.metricsHistoryCount.textContent=`${t.records.length} registros`),this.renderMetricsHistory(t.records)}renderMetricsHistory(e){if(!this.metricsHistoryList)return;if(e.length===0){this.metricsHistoryList.innerHTML='<div class="eq-metrics-empty">Nenhuma quest\xE3o respondida nesta sess\xE3o ainda.</div>';return}this.metricsHistoryList.innerHTML="";let t=[...e].reverse();for(let a of t){let r=document.createElement("div");r.className="eq-metrics-item";let n=document.createElement("div");n.className="eq-metrics-item-left";let i=document.createElement("span");i.className="eq-metrics-badge",i.textContent=`Q${a.questionIndex}`;let s=document.createElement("div");s.className="eq-metrics-item-info";let d=document.createElement("div");d.className="eq-metrics-item-title",d.textContent=a.questionTitle||`Quest\xE3o ${a.questionIndex}`;let l=document.createElement("div");l.className="eq-metrics-item-meta";let u=new Date(a.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=a.mode?a.mode.replace("_"," "):"auto";l.textContent=`${u} \u2022 Modo: ${g}${a.actionsCount?` \u2022 ${a.actionsCount} a\xE7\xE3o(\xF5es)`:""}`,s.appendChild(d),s.appendChild(l),n.appendChild(i),n.appendChild(s);let c=document.createElement("div");c.className="eq-metrics-item-right";let m=document.createElement("span");m.className="eq-metrics-item-dur",m.textContent=`${(a.durationMs/1e3).toFixed(2)}s`;let p=document.createElement("span");p.className=`eq-metrics-item-status is-${a.status}`,p.textContent=a.status==="verified"||a.status==="answered"?" Injetado":a.status==="manual"?"Gabarito":"Pendente",c.appendChild(m),c.appendChild(p),r.appendChild(n),r.appendChild(c),this.metricsHistoryList.appendChild(r)}}copyMetricsReport(){let e=Ee(),t=[];t.push("# Relat\xF3rio de Desempenho e Tempo \u2014 EasyQuiz"),t.push(`- **Quest\xF5es Respondidas:** ${e.completedQuestionsCount}`),t.push(`- **Tempo Total:** ${(e.totalElapsedMs/1e3).toFixed(1)}s`),t.push(`- **Tempo M\xE9dio por Quest\xE3o:** ${(e.averageDurationMs/1e3).toFixed(2)}s`),t.push(""),t.push("### Hist\xF3rico:"),e.records.length===0?t.push("_Nenhum registro ainda._"):e.records.forEach((a,r)=>{t.push(`${r+1}. **${a.questionTitle||`Q${a.questionIndex}`}**: ${(a.durationMs/1e3).toFixed(2)}s (${a.status})`)}),navigator.clipboard.writeText(t.join(`
`)).then(()=>{if(this.metricsCopyBtn){let a=this.metricsCopyBtn.innerHTML;this.metricsCopyBtn.innerHTML=" Copiado!",setTimeout(()=>{this.metricsCopyBtn.innerHTML=a},1500)}})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function Do(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://generativelanguage.googleapis.com",o.crossOrigin="anonymous",o.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(o);let e=document.createElement("link");e.rel="dns-prefetch",e.href="https://generativelanguage.googleapis.com",e.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(e)}catch{}}async function Oo(){let o=window;if(qe(),Do(),o.__easyquiz){try{o.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let e=$e(),t=null,a=null,r=0,n=new Ye(e,{onAnalyze:(l=1,u,g=!1)=>i(l,u,g),onApply:(l=1)=>void s(l),onDestroy:()=>{if(a){try{a.abort()}catch{}a=null}fe(),delete o.__easyquiz},onCancel:()=>{if(a){try{a.abort()}catch{}a=null}fe(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{e=qt(l)}});o.__easyquiz={toggle:()=>n.toggle(),destroy:()=>n.destroy(),analyze:async()=>{await i()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!n)return;n.toggle(!0),i()}});async function i(l=1,u,g=!1){if(!e.apiKey&&(!Array.isArray(e.apiKeys)||e.apiKeys.length===0)){n.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),n.toggle(!0);return}if(a)try{a.abort()}catch{}a=new AbortController;let c=a,m=()=>{try{c.abort()}catch{}};if(u&&(u.aborted?c.abort():u.addEventListener("abort",m,{once:!0})),c.signal.aborted){n.setBusy(!1),n.setProgress(0);return}r=Date.now(),n.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),n.setProgress(20,"Varrendo escopo do DOM e controles..."),fe(),n.hideFloatingAnswers();try{let p=ue(!1);p||(n.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=le()),He(p.scope),n.updateContext(p),n.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),n.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),n.setProgress(40,`Consultando Gemini (${e.model})...`);let f=await xt(p.scope,e.useVision);if(f.length>0){let x=f.map(E=>E.element).filter(Boolean);At(x),n.updateImages(f)}if(c.signal.aborted)return;let h=e.model;n.setStatus(f.length>0?`Consultando Gemini (${h}) com ${f.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${h}) via DOM nativo (modo r\xE1pido)...`,"info");let b=Te(p,f,e);n.setInspectorPrompt(b,e.model);let A=(x,E)=>{n.setStatus(x,E==="warning"?"info":E);let T=x.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(T){let M=T[1].split(",")[0].trim();n.setProgress(50,`Gemini ${M} respondendo...`)}},{plan:y,usedModel:v}=await Qe(p,f,e,A,c.signal);if(c.signal.aborted)return;if(y.needsMoreContext){if(n.setProgress(55,"Ampliando escopo da quest\xE3o..."),n.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),n.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=ue(!0),p||(p=le()),He(p.scope),n.updateContext(p),f=await xt(p.scope,e.useVision),f.length>0){let T=f.map(M=>M.element).filter(Boolean);At(T),n.updateImages(f)}n.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let x=Te(p,f,e);n.setInspectorPrompt(x,e.model),y=(await Qe(p,f,e,A,c.signal)).plan}if(c.signal.aborted)return;if(n.setProgress(70,"Resposta recebida da IA! Processando plano..."),n.logToConsole(`> [IA] Modelo: ${v||e.model} | Modo: ${y.mode} | Confian\xE7a: ${(y.confidence*100).toFixed(0)}%`,"text-green"),y.rationale&&n.logToConsole(`> [IA] Racioc\xEDnio: "${y.rationale}"`,"text-blue"),n.logToConsole(`> [IA] ${y.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),y.memoryToStore&&(Tt(y.memoryToStore),n.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${y.memoryToStore}"`,"text-yellow")),y.imageDescriptions&&y.imageDescriptions.length>0){n.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${y.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let x of y.imageDescriptions){let E=x.relevant?"":"\uFE0F";n.logToConsole(`>   ${E} Imagem ${x.index+1} [${x.relevant?"RELEVANTE":"IGNORADA"}]: ${x.description}`,x.relevant?"text-blue":"text-yellow")}}return t=y,n.updateContext(p,y),Gt(y.actions,y.confidence),n.setPlan(y,!e.dryRun),y.pageType==="conclusion"?(n.setProgress(100,"Atividade conclu\xEDda!"),n.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):y.pageType==="info"?(n.setProgress(100,"Contexto absorvido na mem\xF3ria!"),n.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):y.pageType==="start"?(n.setProgress(100,"In\xEDcio detectado!"),n.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(n.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),n.setStatus(e.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),e.dryRun&&y.pageType==="question"&&n.showFloatingAnswers(y),c.signal.aborted?void 0:((g||e.autoApply)&&!e.dryRun&&await s(l,c.signal,g),y)}catch(p){if(c.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){fe(),n.setProgress(0),n.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}fe(),n.setProgress(0);let f=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";n.setStatus(f,"error"),n.setErrorDiagnostic(f,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),a===c&&(a=null),c.signal.aborted||n.setBusy(!1)}}async function s(l=1,u,g=!1){if(u?.aborted)return;if(!t){n.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(e.dryRun){n.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let c=t.pageType==="info"||t.pageType==="start",m=t.actions.filter(h=>h.t!=="adv"),p=t.pageType==="question"||Ue(t.rationale||"");if(p&&m.length===0){n.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let f=(g||e.autoAdvance||c)&&t.confidence>=e.confidenceThreshold&&!t.needsMoreContext&&(!p||m.length>0);n.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),n.setProgress(85,`Aplicando ${t.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),n.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${t.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let h=await Ie(t,f,l,Ae(e));if(u?.aborted)return;if(n.setExecutionReport(h),h.failedActions&&h.failedActions.length>0){n.logToConsole(`> [REPLAN] \uFE0F ${h.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let x of h.failedActions){let E=x.action,T=E.t==="drag"?`drag: "${E.from}" \u2192 "${E.to}"`:E.t==="clk"||E.t==="chk"?`${E.t}: "${E.id}"`:E.t==="val"?`val: "${E.id}" = "${E.v}"`:JSON.stringify(E).slice(0,80);n.logToConsole(`>    [${E.t.toUpperCase()}] ${T} | ${x.evidence.slice(0,80)}`,"text-yellow")}await d(h.failedActions,u)}let b=r>0?Date.now()-r:1200,A=h.verified>0,y=h.applied>0;if(h.success||A&&y){n.setProgress(100,"Sucesso! Resposta preenchida."),n.logToConsole(`> [DOM]  ${h.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${h.verified} verificada(s) no DOM.`,"text-green"),h.advanced?n.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):f&&n.logToConsole(`> [NAV] ${h.navigationEvidence}`,"text-blue"),n.setStatus(h.advanced?`Sucesso: ${h.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${h.applied} a\xE7\xE3o(\xF5es)).`,"success"),n.hideFloatingAnswers();let x=Lt({id:`q-${Date.now()}`,questionIndex:(Ee().records.length||0)+1,questionTitle:t.rationale?t.rationale.slice(0,45)+"...":`Quest\xE3o ${t.mode||"Auto"}`,durationMs:b,status:"answered",mode:t.mode,actionsCount:h.applied});n.updateTimingMetrics(x)}else y?(n.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),n.logToConsole(`> [DOM] \uFE0F ${h.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${h.failed.join(", ")||"nenhuma"}`,"text-yellow"),n.setStatus(`Resposta preenchida (${h.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(n.setProgress(0,"Alvo de resposta n\xE3o localizado."),n.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${h.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),n.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),e.dryRun&&n.showFloatingAnswers(t))}catch(h){n.setProgress(0);let b=h instanceof Error?h.message:"Falha ao aplicar plano.";n.setStatus(`Erro ao aplicar: ${b}`,"error"),n.logToConsole(`> [ERRO] ${b}`,"text-red")}finally{n.setBusy(!1)}}async function d(l,u){if(!t)return;let g=l.filter(m=>m.action.t==="drag");for(let m of g){if(u?.aborted)return;let p=m.action,f=String(p.from||""),h=String(p.to||""),b=Ut(f,h,f,h);n.logToConsole(`> [REPLAN]  Drag JS fallback: "${f}" \u2192 "${h}"`,"text-blue");let A={...t,actions:[{t:"js",v:b}],pageType:"question"},y=await Ie(A,!1,1,Ae(e));n.logToConsole(y.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",y.applied>0?"text-green":"text-yellow")}let c=l.filter(m=>m.action.t!=="drag");if(c.length!==0&&!u?.aborted){n.logToConsole(`> [REPLAN]  ${c.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of c){if(u?.aborted)return;let p=m.action,f=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);n.logToConsole(`> [REPLAN]  Recuperando: ${f}`,"text-blue");let h=String(p.id||p.name||p.selector||""),b=p.v!==void 0?String(p.v):"";n.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await Ge(m.action),await new Promise(A=>setTimeout(A,250)),ee(m.action)){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${f}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let A=P(h,b)||P(h.replace(/[^\w\s]/g," ").trim(),b);if(A&&(ft(A),await new Promise(y=>setTimeout(y,300)),ee(m.action))){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){n.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let A=P(h,b)||P(h.replace(/[^\w\s]/g," ").trim(),b);if(A&&(A.focus?.(),await new Promise(y=>setTimeout(y,50)),A.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,80)),A.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),A.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(y=>setTimeout(y,200)),ee(m.action))){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){n.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let A=P(h,b)||P(h.replace(/[^\w\s]/g," ").trim(),b);if(A){let y=A.id,v=!!y;y||(y=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,A.id=y);let x=String(p.v??""),E=p.t==="val",T=document.createElement("script");if(T.textContent=`(function(){
              var el=document.getElementById(${JSON.stringify(y)});
              if(!el)return;
              // Tenta Vue 3 update trigger
              try{if(el.__vueParentComponent){var ins=el.__vueParentComponent;var pr=ins.props||{};if(pr.modelValue!==undefined&&typeof ins.emit==='function'){ins.emit('update:modelValue',${E?JSON.stringify(x):"true"});}}}catch(e){}
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(T),T.remove(),v||setTimeout(()=>{try{A.id===y&&A.removeAttribute("id")}catch{}},0),await new Promise(M=>setTimeout(M,300)),ee(m.action)){n.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${f}`,"text-green");continue}}}catch{}}if(u?.aborted)return;n.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let A="";try{let C=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(I=>(I.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));C&&(A=C.outerHTML.slice(0,400))}catch{}let y=ue(!1)||le(),v=`A\xE7\xE3o (${p.t}) alvo="${h}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${A?`
HTML do alvo: ${A}`:""}`,x=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],E=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
...
N\xC3O repita as estrat\xE9gias j\xE1 tentadas acima.`,T={...y,questionText:E},M=await Qe(T,[],{...e},C=>n.logToConsole(`> [REPLAN-AI] ${C}`,"text-blue"),u);if(u?.aborted||!M?.plan){n.logToConsole("> [REPLAN]  Re-consulta n\xE3o retornou plano.","text-yellow");continue}let w=M.plan.actions.filter(C=>C.t==="js");if(w.length===0){n.logToConsole("> [REPLAN] \u2139\uFE0F IA n\xE3o gerou a\xE7\xF5es JS de fallback.","text-yellow");continue}n.logToConsole(`> [REPLAN]  IA gerou ${w.length} a\xE7\xE3o(\xF5es) JS custom. Executando...`,"text-blue");let L={...t,actions:w,pageType:"question"},S=await Ie(L,!1,1,Ae(e));S.applied>0?n.logToConsole(`> [REPLAN]  Estrat\xE9gia 5 OK: ${S.applied} a\xE7\xE3o(\xF5es) JS executada(s)!`,"text-green"):n.logToConsole("> [REPLAN]  Todas as estrat\xE9gias esgotadas para esta a\xE7\xE3o.","text-yellow")}catch(A){n.logToConsole(`> [REPLAN] Erro na re-consulta: ${A instanceof Error?A.message:String(A)}`,"text-yellow")}}}}n.toggle(!0)}Oo().catch(o=>{console.error("[EasyQuiz] Erro fatal na inicializa\xE7\xE3o:",o),window.alert(`EasyQuiz: falha ao iniciar: ${o instanceof Error?o.message:String(o)}`)});})();
