 ...
 */
"use strict";(()=>{var ge={apiKey:"",apiKeys:[],model:"gemini-3.5-flash-lite",uiMode:"easy",modeHint:"",engine:"smart",dryRun:!1,autoApply:!0,autoAdvance:!1,hostDarkMode:!0,useVision:!0,confidenceThreshold:.8,toastStacking:!0};function re(n){if(!n||typeof n!="string")return!1;let t=n.toLowerCase().trim().replace(/^models\//,"");if(!t.includes("gemini"))return!1;let e=["imagen","image","veo","omni","video","embedding","embed","tts","audio","speech","voice","sound","live","transcribe","bidi","aqa","learnlm","deep-research","computer-use","robotics","rt-1","rt-2","mediapipe","cyber","latest","-ultra","experimental"];for(let o of e)if(t.includes(o))return!1;return!(!t.includes("flash")&&!t.includes("pro"))}var gt="easyquiz_settings_v2",Me="easyquiz_activity_metrics";function ht(){try{let n=localStorage.getItem(gt);if(!n){let r=localStorage.getItem("easyquiz_settings_v1");if(r){let i=JSON.parse(r);return{...ge,apiKey:i.apiKey||""}}return{...ge}}let t=JSON.parse(n),e=typeof t.model=="string"&&re(t.model)?t.model:ge.model,o=Array.isArray(t.apiKeys)?t.apiKeys.map(r=>typeof r=="string"?r.trim().replace(/^["']|["']$/g,""):"").filter(r=>r.length>5):[],s=typeof t.apiKey=="string"?t.apiKey.trim().replace(/^["']|["']$/g,""):"";if(o.length===0&&s&&(o=[s]),o.length===0)try{let r=localStorage.getItem("easyquiz_api_keys");if(r){let i=JSON.parse(r);Array.isArray(i)&&(o=i.filter(c=>typeof c=="string"&&c.trim().length>5))}}catch{}return{apiKey:o[0]||s||ge.apiKey,apiKeys:o,model:e,uiMode:t.uiMode==="easy"||t.uiMode==="advanced"?t.uiMode:ge.uiMode,modeHint:t.modeHint??"",engine:t.engine??"smart",dryRun:!!t.dryRun,autoApply:t.autoApply!==void 0?!!t.autoApply:!0,autoAdvance:!!t.autoAdvance,hostDarkMode:t.hostDarkMode!==void 0?!!t.hostDarkMode:!0,useVision:t.useVision!==void 0?!!t.useVision:ge.useVision,confidenceThreshold:typeof t.confidenceThreshold=="number"?t.confidenceThreshold:ge.confidenceThreshold}}catch{return{...ge}}}function Ut(){try{localStorage.removeItem(gt),localStorage.removeItem("easyquiz_settings_v1"),localStorage.removeItem(Me),sessionStorage.removeItem(Me);let n=[];for(let t=0;t<localStorage.length;t++){let e=localStorage.key(t);e&&(e.startsWith("eq_")||e.startsWith("easyquiz_"))&&n.push(e)}n.forEach(t=>localStorage.removeItem(t)),$e()}catch(n){console.warn("[EasyQuiz] Erro ao resetar dados:",n)}}function bt(n){try{let t=localStorage.getItem("eq_domain_cache_"+n);if(!t)return{};let e=JSON.parse(t);if(e.advanceSelector&&/inject|injetar/i.test(e.advanceSelector)){e.advanceSelector=void 0;try{localStorage.removeItem("eq_domain_cache_"+n)}catch{}}return e}catch{return{}}}function vt(n,t){if(t.advanceSelector&&/inject|injetar/i.test(t.advanceSelector))return;let o={...bt(n),...t};try{localStorage.setItem("eq_domain_cache_"+n,JSON.stringify(o))}catch(s){console.warn("[EasyQuiz] Erro cache de dominio:",s)}}function Jt(n){let t=ht(),e=Array.isArray(n.apiKeys)?n.apiKeys.map(a=>typeof a=="string"?a.trim().replace(/^["']|["']$/g,""):"").filter(a=>a.length>5):t.apiKeys,o;typeof n.apiKey=="string"?o=n.apiKey.trim().replace(/^["']|["']$/g,""):Array.isArray(n.apiKeys)&&n.apiKeys.length>0?o=e[0]||"":o=t.apiKey,o&&!e.includes(o)&&(e=[o,...e]),e.length>0&&(!o||!e.includes(o))&&(o=e[0]);let s={...t,...n,apiKey:o,apiKeys:e};try{localStorage.setItem(gt,JSON.stringify(s)),localStorage.setItem("easyquiz_api_keys",JSON.stringify(e))}catch(a){console.warn("[EasyQuiz] Falha ao persistir configura\xE7\xF5es no localStorage:",a)}return s}var Se=[],Xt=12,qn=1200;function Ft(n){let t=n.trim().replace(/\s+/g," ").slice(0,qn);t&&!Se.includes(t)&&(Se.push(t),Se.length>Xt&&(Se=Se.slice(-Xt)))}function Ke(){return Se}function $e(){Se=[]}function Vt(){return{startTime:Date.now(),totalElapsedMs:0,completedQuestionsCount:0,averageDurationMs:0,records:[]}}var Qe=Vt();function Re(){try{localStorage.removeItem(Me)}catch{}return Qe}function kn(n){Qe=n;try{let t=JSON.stringify(n);sessionStorage.setItem(Me,t),localStorage.removeItem(Me)}catch{}}function Wt(n){let t=Qe,e=Date.now(),o=t.records[t.records.length-1];if(o&&o.id===n.id&&e-o.timestamp<3e3)return t;let s={...n,timestamp:e},a=[...t.records,s],r=a.filter(u=>u.status==="answered"||u.status==="verified").length,i=a.reduce((u,A)=>u+A.durationMs,0),c=r>0?Math.round(i/r):0,l={startTime:t.startTime||e,totalElapsedMs:Math.max(e-(t.startTime||e),i),completedQuestionsCount:r,averageDurationMs:c,records:a};return kn(l),l}function je(){Qe=Vt();try{sessionStorage.removeItem(Me),localStorage.removeItem(Me)}catch{}return Qe}var Yt=`Voc\xEA \xE9 o motor operacional inteligente do EasyQuiz. Sa\xEDda EXCLUSIVA em JSON minificado, sem markdown, sem coment\xE1rios, sem texto fora do JSON.
...
[HTML]:
${n.htmlSnippet.slice(0,l).replace(/\s+/g," ")}`:"",A="";if(i&&typeof document<"u")try{let y=Array.from(document.querySelectorAll('input:not([type=hidden]), textarea, select, button, [role="button"], [role="radio"], [role="checkbox"], [role="option"], [onclick], [data-action], a[href]:not([href="#"]), [tabindex]:not([tabindex="-1"])')).filter(x=>{let E=x,v=E.getBoundingClientRect?.()||{width:0,height:0};return v.width>0&&v.height>0&&!E.closest("#easyquiz-shadow-root, .eq-sidebar")}).slice(0,40).map(x=>{let E=x,v=E.tagName.toLowerCase(),w=E.id?`#${E.id}`:"",T=E.className&&typeof E.className=="string"?`.${E.className.trim().split(/\s+/).slice(0,2).join(".")}`:"",k=(E.textContent||E.value||E.getAttribute("aria-label")||"").trim().slice(0,60),C=E.getAttribute("type")||E.getAttribute("role")||"";return`${v}${w}${T}[${C}] txt="${k}"`});y.length>0&&(A=`
[DOM-INTERATIVO]:
${y.join(`
`)}`)}catch{}let d=Ke(),m=d.length>0?`
[MEM\xD3RIA]:
${d.join(" | ")}
`:"",p=n.controls.filter(y=>y.role!=="navigation"),f=n.controls.filter(y=>y.role==="navigation"),h=Ln(n.sourceUrl,n.htmlSnippet),b=h?`
${h}
`:"";return`--- AN\xC1LISE ---
...
[RESPOSTAS]:
${(()=>{if(p.length===0)return"Nenhuma";let y=p.filter(q=>q.type==="checkbox"||q.type==="chk"),x=new Set(p.filter(q=>q.type==="radio").map(q=>q.name).filter(Boolean)),E=y.filter(q=>!q.name||!x.has(q.name)),v=/selecione as|assinale as|quais das|todas as|marque as|escolha as|quais dessas|quais dos/i.test(n.questionText),w=E.length>=2||v,T=x.size>1||/verdadeir|fals[oa]|\bv\s*\/\s*f\b|julgue|itens/i.test(n.questionText)&&x.size>=1,k=p.every(q=>q.type==="radio"||q.type==="chk")&&x.size===1&&!w&&!T,C=p.filter(q=>q.type==="text"||q.type==="number"||q.type==="val"||q.tag==="input"||q.tag==="textarea"),P=C.length>=2;return(T?`[GRADE VERDADEIRO/FALSO (${x.size||"m\xFAltiplas"} afirma\xE7\xF5es): voc\xEA DEVE julgar e marcar exatamente 1 op\xE7\xE3o (V ou F) para CADA uma das ${x.size} afirma\xE7\xF5es \u2014 emita ${x.size} a\xE7\xF5es chk separadas + adv]
`:w?`[MULTI-SELE\xC7\xC3O: marque TODOS os corretos, pode ser 2 ou mais]
`:k?`[ESCOLHA-\xDAnica: marque APENAS 1 op\xE7\xE3o]
`:P?`[M\xDALTIPLOS CAMPOS DE PREENCHIMENTO (${C.length} campos): emita uma a\xE7\xE3o val para CADA um dos ${C.length} campos abaixo com seu id exato]
...
`;function pn(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=Gn,document.head.appendChild(n)}}catch{}}function Ee(){fe&&(fe.style.removeProperty("outline"),fe.style.removeProperty("outline-offset"),fe.style.removeProperty("position"),fe=null);for(let n of He)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");He=[];for(let n of Pt)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");Pt=[];for(let n of Dt)try{n.remove()}catch{}Dt=[],we&&typeof window<"u"&&(window.removeEventListener("scroll",we),window.removeEventListener("resize",we),we=null);for(let n of Ot)try{n.remove()}catch{}if(Ot=[],Ae){try{Ae.remove()}catch{}Ae=null}}function Bt(n){pn();let t=[];for(let e of n){if(!e||typeof e.setAttribute!="function")continue;let o=e;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),Pt.push(o)}catch{}try{let s=e.getBoundingClientRect(),a=s.width||e.offsetWidth||280,r=s.height||e.offsetHeight||200;if(a>10&&r>10){let i=document.createElement("div");i.setAttribute("data-easyquiz-image-frame","true"),i.style.cssText=`
          position: absolute;
        ...
        `,i.appendChild(c),document.body.appendChild(i),Dt.push(i),Ot.push(c),t.push({element:e,frame:i})}}catch{}}t.length>0&&!we&&typeof window<"u"&&(we=()=>{for(let e of t)try{let o=e.element.getBoundingClientRect();o.width>0&&o.height>0&&(e.frame.style.top=`${o.top+window.scrollY-3}px`,e.frame.style.left=`${o.left+window.scrollX-3}px`,e.frame.style.width=`${o.width+6}px`,e.frame.style.height=`${o.height+6}px`)}catch{}},window.addEventListener("scroll",we,{passive:!0}),window.addEventListener("resize",we,{passive:!0}))}function Ye(n){fe&&fe!==n&&(fe.style.removeProperty("outline"),fe.style.removeProperty("outline-offset")),pn(),fe=n,n.style.outline="2px solid #00e5ff",n.style.outlineOffset="4px";try{if(Ae){try{Ae.remove()}catch{}Ae=null}window.getComputedStyle(n).position==="static"&&(n.style.position="relative");let e=document.createElement("div");e.style.cssText=`
    ...
    `,n.appendChild(e),Ae=e}catch{}}function Kn(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function mn(n,t){if(Ae){try{Ae.remove()}catch{}Ae=null}let e=Kn(t);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let m=Q(o.from),p=Q(o.to);m&&(m.style.outline=`2px solid ${e.outline}`,He.push(m)),p&&(p.style.outline="2px dashed #00e5ff",He.push(p))}catch{}continue}let s=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${K(a)}"]`));if(s&&(r=m.find(p=>p.value?.toLowerCase()===s.toLowerCase())??null,!r)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(s),f=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(s);if(p||f){let h=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=m.find(b=>{let y=b.value?.toLowerCase()??"";if(h.includes(y))return!0;let E=(b.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return h.some(v=>E===v||E.startsWith(v+" ")||E.startsWith("("+v+")"))})??null}}!r&&m.length>0&&(r=m[0])}if(!r&&o.id&&(r=Q(o.id,s,o.t==="val"||o.t==="sel")||Q(H(o.id),s,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let m=document.body;try{m=se()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(b=>N(b)&&!ye(b)),f=H(o.id).toLowerCase();r=p.find(b=>{let y=(b.id||"").toLowerCase(),x=(b.getAttribute("name")||"").toLowerCase(),E=(b.getAttribute("aria-label")||"").toLowerCase(),v=H(b.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return y.includes(f)||x.includes(f)||E.includes(f)||f.length>=2&&v.includes(f)})||(p.length===1?p[0]:null)}if(!r)continue;let i=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",c=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=i?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=c||l||r;u.style.outline=`2px solid ${e.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=e.bg,u.setAttribute("data-easyquiz-highlight","true"),He.push(u);let A=i?r:u.querySelector('select, [role="combobox"], [role="listbox"]');A&&(A.style.outline=`2px solid ${e.outline}`,A.style.outlineOffset="2px",A.style.boxShadow=`0 0 10px ${e.glow}`,A.setAttribute("data-easyquiz-highlight","true"),He.push(A));let d=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:u.querySelector('input[type="checkbox"], input[type="radio"]');d&&d!==u&&(d.style.outline=`2px solid ${e.outline}`,d.style.outlineOffset="2px",d.style.boxShadow=`0 0 10px ${e.glow}`,d.setAttribute("data-easyquiz-highlight","true"),He.push(d))}}var Nt=10,$n=1400,Ze=15e5;function ve(n){return new Promise((t,e)=>{let o=new FileReader;o.onerror=()=>e(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let s=String(o.result||"");t(s.split(",")[1]||"")},o.readAsDataURL(n)})}async function ze(n){let t=0,e=0;if(n instanceof HTMLImageElement?(t=n.naturalWidth||n.width,e=n.naturalHeight||n.height):(t=n.width,e=n.height),t<=0||e<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,$n/Math.max(t,e)),s=Math.max(1,Math.round(t*o)),a=Math.max(1,Math.round(e*o)),r=document.createElement("canvas");r.width=s,r.height=a;let i=r.getContext("2d",{alpha:!1});if(!i)throw new Error("Sem suporte a Canvas 2D.");return i.fillStyle="#ffffff",i.fillRect(0,0,s,a),i.drawImage(n,0,0,s,a),new Promise((c,l)=>{r.toBlob(u=>u?c(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function An(n){let t=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},e=t.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=t.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,s=2,a=Math.min(1800,Math.max(120,Math.round(e*s))),r=Math.min(1800,Math.max(100,Math.round(o*s))),i=n.cloneNode(!0);i.getAttribute("xmlns")||i.setAttribute("xmlns","http://www.w3.org/2000/svg"),i.getAttribute("xmlns:xlink")||i.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),i.setAttribute("width",String(a)),i.setAttribute("height",String(r)),!i.getAttribute("viewBox")&&e>0&&o>0&&i.setAttribute("viewBox",`0 0 ${e} ${o}`);try{let d=Array.from(n.querySelectorAll("*")),m=Array.from(i.querySelectorAll("*"));for(let p=0;p<Math.min(d.length,m.length);p++){let f=d[p],h=m[p];if(!f||!h||!h.style)continue;let b=window.getComputedStyle?window.getComputedStyle(f):null;b&&(b.fill&&b.fill!=="none"&&(h.style.fill=b.fill),b.stroke&&b.stroke!=="none"&&(h.style.stroke=b.stroke),b.strokeWidth&&(h.style.strokeWidth=b.strokeWidth),b.fontFamily&&(h.style.fontFamily=b.fontFamily),b.fontSize&&(h.style.fontSize=b.fontSize),b.fontWeight&&(h.style.fontWeight=b.fontWeight),b.color&&(h.style.color=b.color))}}catch{}let c="#ffffff";try{let d=n.parentElement||n;for(;d&&d!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(d):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){c=p;break}d=d.parentElement}}catch{}let u=new XMLSerializer().serializeToString(i),A="";try{A=btoa(unescape(encodeURIComponent(u)))}catch{}try{let d=h=>new Promise((b,y)=>{let x=new Image,E=setTimeout(()=>y(new Error("Timeout render SVG")),1200);x.onload=()=>{clearTimeout(E),b(x)},x.onerror=()=>{clearTimeout(E),y(new Error("Falha ao renderizar SVG em Image."))},x.src=h}),m=null;if(A)try{m=await d(`data:image/svg+xml;base64,${A}`)}catch{}if(!m){let h=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),b=URL.createObjectURL(h);try{m=await d(b)}finally{URL.revokeObjectURL(b)}}let p=document.createElement("canvas");p.width=a,p.height=r;let f=p.getContext("2d",{alpha:!1});if(f&&m){f.fillStyle=c,f.fillRect(0,0,a,r),f.drawImage(m,0,0,a,r);let h=await new Promise(b=>{p.toBlob(b,"image/jpeg",.92)});if(h){let b=await ve(h);if(b)return{blob:h,base64:b,mediaType:"image/jpeg"}}}}catch{}return{base64:A,mediaType:"image/svg+xml"}}async function Qt(n){try{let t=n.getBoundingClientRect(),e=Math.round(t.width)||n.offsetWidth||400,o=Math.round(t.height)||n.offsetHeight||300;if(e<30||o<30)return null;let s=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(s&&n.querySelectorAll("input, select, textarea").length===0)try{let f=await An(s);if(f.base64&&f.base64.length<=Ze)return{mediaType:f.mediaType,base64:f.base64,alt:n.getAttribute("aria-label")||s.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:Te(s)}}catch{}if(n instanceof HTMLCanvasElement)try{let f=await ze(n),h=await ve(f);if(h)return{mediaType:"image/jpeg",base64:h,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let f=n;for(;f&&f!==document.documentElement;){let b=(window.getComputedStyle?window.getComputedStyle(f):null)?.backgroundColor;if(b&&b!=="transparent"&&b!=="rgba(0, 0, 0, 0)"){a=b;break}f=f.parentElement}}catch{}let r=n.cloneNode(!0),i=Array.from(n.querySelectorAll("*")),c=Array.from(r.querySelectorAll("*"));for(let f=0;f<Math.min(i.length,c.length);f++){let h=i[f],b=c[f];if(!(!h||!b||!b.style))try{let y=window.getComputedStyle(h);b.style.color=y.color,b.style.backgroundColor=y.backgroundColor,b.style.borderColor=y.borderColor,b.style.borderWidth=y.borderWidth,b.style.borderStyle=y.borderStyle,b.style.fontSize=y.fontSize,b.style.fontFamily=y.fontFamily,b.style.fontWeight=y.fontWeight,b.style.lineHeight=y.lineHeight,b.style.letterSpacing=y.letterSpacing,b.style.textAlign=y.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(e,o))),u=Math.round(e*l),A=Math.round(o*l),d=`
      <svg xmlns="http://www.w3.org/2000/svg" width="${u}" height="${A}" viewBox="0 0 ${e} ${o}">
    ...
    `,this.shadow.appendChild(this.element),this.element.querySelector("#eq-fah-pill").addEventListener("click",()=>this.restore()),this.element.querySelector("#eq-fah-min-btn").addEventListener("click",()=>this.minimize()),this.element.querySelector("#eq-fah-close-btn").addEventListener("click",()=>this.hide());let s=this.element.querySelector("#eq-fah-copy-md-btn");s.addEventListener("click",()=>this.copyMarkdownToClipboard(s));let a=this.element.querySelector("#eq-fah-copy-all-btn");a.addEventListener("click",()=>this.copyMarkdownToClipboard(a));let r=this.element.querySelector("#eq-fah-header");this.setupDraggable(r)}setupDraggable(t){let e=o=>{if(o.target.closest(".eq-fah-btn"))return;o.preventDefault(),this.isDragging=!0,this.dragStartX=o.clientX,this.dragStartY=o.clientY;let s=this.element.getBoundingClientRect();this.initialLeft=s.left,this.initialTop=s.top;let a=i=>{if(!this.isDragging||!this.element)return;let c=i.clientX-this.dragStartX,l=i.clientY-this.dragStartY,u=Math.max(10,window.innerWidth-this.element.offsetWidth-10),A=Math.max(10,window.innerHeight-this.element.offsetHeight-10),d=Math.min(Math.max(10,this.initialLeft+c),u),m=Math.min(Math.max(10,this.initialTop+l),A);this.element.style.left=`${d}px`,this.element.style.top=`${m}px`},r=()=>{this.isDragging=!1,window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",r)};t.addEventListener("mousedown",e)}renderContent(){if(!this.element||!this.currentPlan)return;let t=this.element.querySelector("#eq-fah-body"),e=this.element.querySelector("#eq-fah-pill-text"),o=this.element.querySelector("#eq-fah-pill-badge");t.innerHTML="";let s=this.currentPlan,a=s.actions.filter(m=>m.t==="drag"),r=s.actions.filter(m=>{if(m.t!=="val")return!1;let p=H(m.id||"").toLowerCase();return!/continu|avan[cç]|pr[oó]xim|submet|enviar|check|verific/i.test(p)}),i=s.actions.filter(m=>m.t==="clk"||m.t==="chk"),c=s.actions.filter(m=>m.t==="sel"),l=a.length||r.length||i.length||c.length,u=document.createElement("div");u.className="eq-fah-meta";let A=document.createElement("span");A.textContent=`Modo: ${s.mode.replace("_"," ")}`;let d=document.createElement("span");if(d.className="eq-fah-meta-badge",d.textContent=`${Math.round(s.confidence*100)}% Confian\xE7a`,u.append(A,d),t.appendChild(u),a.length>0||s.mode==="categorizacao"||s.mode==="arrastar_soltar"){e.textContent=`Categoriza\xE7\xE3o (${a.length} itens)`,o.textContent=String(a.length);let m={};for(let p of a){let f=H(p.to)||"Geral";m[f]||(m[f]=[]),m[f].push(H(p.from))}for(let[p,f]of Object.entries(m)){let h=document.createElement("div"),b=/fato|true|verdadeiro|sim/i.test(p),y=/opini[aã]o|false|falso|n[aã]o/i.test(p);h.className=`eq-fah-group ${b?"group-fato":y?"group-opiniao":""}`;let x=document.createElement("div");x.className="eq-fah-group-title",x.textContent=`\u{1F4C1} ${p} (${f.length})`,h.appendChild(x);let E=document.createElement("div");E.className="eq-fah-group-items";for(let v of f){let w=document.createElement("div");w.className="eq-fah-item";let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=v,w.appendChild(T);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(v),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),w.appendChild(k),E.appendChild(w)}h.appendChild(E),t.appendChild(h)}}else if(r.length>0){e.textContent=`Preenchimento (${r.length} campos)`,o.textContent=String(r.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4DD} Respostas para os Campos de Texto:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let h=0;h<r.length;h++){let b=r[h],y=document.createElement("div");y.className="eq-fah-item";let x=Ve(b.id);(!x||/^[#\.\$]|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Campo ${h+1}`);let E=String(b.v??""),v=document.createElement("div");v.className="eq-fah-field-box";let w=document.createElement("div");w.className="eq-fah-field-label",w.textContent=x,v.appendChild(w);let T=document.createElement("div");T.className="eq-fah-field-val",T.textContent=E,v.appendChild(T),y.appendChild(v);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(E),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),y.appendChild(k),f.appendChild(y)}m.appendChild(f),t.appendChild(m)}else if(i.length>0){e.textContent=`Op\xE7\xF5es (${i.length} marcadas)`,o.textContent=String(i.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F3AF} Alternativa(s) Correta(s):",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let h=0;h<i.length;h++){let b=i[h],y=document.createElement("div");y.className="eq-fah-item";let x=Ve(b.id);(!x||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x))&&b.v&&(x=String(b.v)),x=H(x),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(x)&&(x="");let E="",v=x.match(/^(\([A-Za-z0-9]\)|[A-Za-z0-9][\)\.\:\-])\s*(.*)$/);v?(E=v[1].replace(/[\(\)\.\:\-\s]/g,"").toUpperCase(),x=v[2].trim()||x):i.length>1&&(E=String.fromCharCode(65+h));let w=document.createElement("div");if(w.style.display="flex",w.style.alignItems="center",w.style.gap="8px",w.style.flex="1",E){let C=document.createElement("span");C.className="eq-fah-letter-badge",C.textContent=E,w.appendChild(C)}let T=document.createElement("span");T.className="eq-fah-item-text",T.textContent=x||(E?`Alternativa ${E}`:"Alternativa Selecionada"),w.appendChild(T),y.appendChild(w);let k=document.createElement("button");k.className="eq-fah-copy-inline",k.textContent="Copiar",k.addEventListener("click",()=>{navigator.clipboard.writeText(x||E),k.textContent="\u2713 Copiado",setTimeout(()=>k.textContent="Copiar",1200)}),y.appendChild(k),f.appendChild(y)}m.appendChild(f),t.appendChild(m)}else if(c.length>0){e.textContent=`Sele\xE7\xE3o (${c.length} listas)`,o.textContent=String(c.length);let m=document.createElement("div");m.className="eq-fah-group";let p=document.createElement("div");p.className="eq-fah-group-title",p.textContent="\u{1F4CB} Op\xE7\xF5es para Selecionar na Lista:",m.appendChild(p);let f=document.createElement("div");f.className="eq-fah-group-items";for(let h=0;h<c.length;h++){let b=c[h],y=document.createElement("div");y.className="eq-fah-item";let x=Ve(b.id);(!x||/^[#\.\$]|select|input|mat-|cell|field|q[0-9]|eq-/i.test(x))&&(x=`Lista ${h+1}`);let w=(Array.isArray(b.v)?b.v:[String(b.v??"")]).map(z=>{let q=Q(b.id,void 0,!0)||Q(H(b.id),void 0,!0),I=q instanceof HTMLSelectElement?q:q?.querySelector("select");if(I){let R=H(z).toLowerCase();for(let j=0;j<I.options.length;j++){let X=I.options[j];if(X.value.toLowerCase()===R||H(X.textContent).toLowerCase()===R){let W=H(X.textContent);if(W&&!W.toLowerCase().includes("selecione"))return W}}}return z}).join(", "),T=document.createElement("div");T.className="eq-fah-field-box";let k=document.createElement("div");k.className="eq-fah-field-label",k.textContent=x,T.appendChild(k);let C=document.createElement("div");C.className="eq-fah-field-val",C.textContent=w,T.appendChild(C),y.appendChild(T);let P=document.createElement("button");P.className="eq-fah-copy-inline",P.textContent="Copiar",P.addEventListener("click",()=>{navigator.clipboard.writeText(w),P.textContent="\u2713 Copiado",setTimeout(()=>P.textContent="Copiar",1200)}),y.appendChild(P),f.appendChild(y)}m.appendChild(f),t.appendChild(m)}else{e.textContent="Gabarito",o.textContent="0";let m=document.createElement("div");m.style.padding="10px",m.style.color="#888",m.textContent="Nenhuma resposta direta para exibir.",t.appendChild(m)}if(s.rationale){let m=document.createElement("div");m.className="eq-fah-rationale",m.textContent=`\u{1F4A1} Racioc\xEDnio da IA: ${s.rationale}`,t.appendChild(m)}}generateMarkdown(){if(!this.currentPlan)return"";let t=this.currentPlan,e=[];e.push("# Gabarito da Quest\xE3o \u2014 EasyQuiz Pro"),e.push(`- **Modo:** ${t.mode}`),e.push(`- **Confian\xE7a:** ${(t.confidence*100).toFixed(0)}%`),e.push("");let o=t.actions.filter(i=>i.t==="drag"),s=t.actions.filter(i=>i.t==="val"),a=t.actions.filter(i=>i.t==="clk"||i.t==="chk"),r=t.actions.filter(i=>i.t==="sel");if(o.length>0){e.push("## \u{1F4C2} Categoriza\xE7\xE3o:");let i={};for(let c of o){let l=H(c.to)||"Geral";i[l]||(i[l]=[]),i[l].push(H(c.from))}for(let[c,l]of Object.entries(i)){e.push(`### Categoria: ${c}`);for(let u of l)e.push(`- ${u}`);e.push("")}}else if(s.length>0){e.push("## \u270F\uFE0F Respostas para Preenchimento:");for(let i of s){let c=H(i.id);e.push(`- **${c||"Campo"}:** \`${i.v}\``)}e.push("")}else if(a.length>0){e.push("## \u2705 Alternativas Corretas:");for(let i=0;i<a.length;i++){let c=a[i],l=Ve(c.id);(!l||/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l))&&c.v&&(l=String(c.v)),l=H(l),/^(eq-|#|\$|\.|input_|mat-|choice_|radio_|chk_)/i.test(l)&&(l="");let u=a.length>1?`${String.fromCharCode(65+i)}) `:"";e.push(`- [x] ${u}${l||"Alternativa "+String.fromCharCode(65+i)}`)}e.push("")}else if(r.length>0){e.push("## \u{1F4CB} Op\xE7\xF5es Selecionadas em Lista:");for(let i of r){let c=H(i.id)||"Lista",l=Array.isArray(i.v)?i.v.join(", "):String(i.v??"");e.push(`- **${c}:** \`${l}\``)}e.push("")}return t.rationale&&(e.push("---"),e.push(`**\u{1F4A1} Racioc\xEDnio:** ${t.rationale}`)),e.join(`
...
######   #####
    ...
    `),this.launcherBtn=this.shadow.querySelector(".eq-launcher"),this.launcherDot=this.shadow.querySelector("#eq-launcher-dot"),this.dockToggleBtn=this.shadow.querySelector("#eq-dock-toggle"),this.sidebarEl=this.shadow.querySelector(".eq-sidebar"),this.apToggleBtn=this.shadow.querySelector("#eq-ap-toggle-btn"),this.apConsole=this.shadow.querySelector("#eq-ap-console"),this.executionConsole=this.shadow.querySelector("#eq-execution-console"),this.progressContainer=this.shadow.querySelector("#eq-progress-container"),this.progressBar=this.shadow.querySelector("#eq-progress-bar"),this.progressLabel=this.shadow.querySelector("#eq-progress-label"),this.progressVal=this.shadow.querySelector("#eq-progress-val"),this.contextTreeContainer=this.shadow.querySelector("#eq-tree-container"),this.dotPulseAp=this.shadow.querySelector("#eq-dot-ap"),this.statusTextAp=this.shadow.querySelector("#eq-status-text-ap")||this.shadow.querySelector("#eq-status-summary")||this.dotPulseAp,this.stopwatchAp=this.shadow.querySelector("#eq-stopwatch-ap span"),this.dotPulseAdv=this.dotPulseAp,this.statusTextAdv=this.statusTextAp,this.stopwatchAdv=this.stopwatchAp,this.inspModel=this.shadow.querySelector("#eq-insp-model"),this.inspLatency=this.shadow.querySelector("#eq-insp-latency"),this.inspTokens=this.shadow.querySelector("#eq-insp-tokens"),this.inspPrompt=this.shadow.querySelector("#eq-insp-prompt"),this.inspRationale=this.shadow.querySelector("#eq-insp-rationale"),this.inspActions=this.shadow.querySelector("#eq-insp-actions"),this.copyPromptBtn=this.shadow.querySelector("#eq-copy-prompt-btn"),this.liveDebugTerminal=this.shadow.querySelector("#eq-live-debug-terminal"),this.dbgModel=this.shadow.querySelector("#eq-dbg-model"),this.dbgLatency=this.shadow.querySelector("#eq-dbg-latency"),this.dbgSplitTokens=this.shadow.querySelector("#eq-dbg-split-tokens"),this.dbgTotalTokens=this.shadow.querySelector("#eq-dbg-total-tokens"),this.dbgErrorCard=this.shadow.querySelector("#eq-dbg-error-card"),this.dbgErrorText=this.shadow.querySelector("#eq-dbg-error-text"),this.dbgPromptLen=this.shadow.querySelector("#eq-dbg-prompt-len"),this.dbgPromptView=this.shadow.querySelector("#eq-dbg-prompt-view"),this.dbgContextView=this.shadow.querySelector("#eq-dbg-context-view"),this.dbgRawRespView=this.shadow.querySelector("#eq-dbg-raw-resp-view"),this.dbgCountAll=this.shadow.querySelector("#eq-dbg-count-all"),this.dbgCountError=this.shadow.querySelector("#eq-dbg-count-error"),this.dbgCountAi=this.shadow.querySelector("#eq-dbg-count-ai"),this.dbgCountDom=this.shadow.querySelector("#eq-dbg-count-dom"),this.apiKeyInput=this.shadow.querySelector("#eq-api-key"),this.keyContextMenu=this.shadow.querySelector("#eq-key-context-menu"),this.keyMoreBtn=this.shadow.querySelector("#eq-key-more-btn"),this.keysListEl=this.shadow.querySelector("#eq-keys-list"),this.keysBadgeEl=this.shadow.querySelector("#eq-keys-badge"),this.modelSelect=this.shadow.querySelector("#eq-model-select"),this.modeSelect=this.shadow.querySelector("#eq-mode-select"),this.engineSelect=this.shadow.querySelector("#eq-engine-select"),this.dryRunCheckbox=this.shadow.querySelector("#eq-dry-run"),this.autoApplyCheckbox=this.shadow.querySelector("#eq-auto-apply"),this.autoAdvanceCheckbox=this.shadow.querySelector("#eq-auto-advance"),this.hostDarkModeCheckbox=this.shadow.querySelector("#eq-host-dark"),this.useVisionCheckbox=this.shadow.querySelector("#eq-use-vision"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.toastStackingCheckbox=this.shadow.querySelector("#eq-toast-stacking"),this.analyzeBtn=this.shadow.querySelector("#eq-analyze-btn"),this.applyBtn=this.shadow.querySelector("#eq-apply-btn"),this.applyBtn&&(this.applyBtn.disabled=!0),this.resultContainer=this.shadow.querySelector("#eq-result"),this.floatingAnswers=new ut(this.shadow,()=>{this.callbacks.onAnalyze(1)});let o=this.shadow.querySelector("#eq-open-hud-btn");o&&o.addEventListener("click",()=>{this.latestPlan&&this.floatingAnswers.show(this.latestPlan)}),Pe.filter(i=>re(i.id)).forEach(i=>this.modelSelect.add(new Option(i.name,i.id,!1,i.id===t.model))),io.forEach(i=>this.modeSelect.add(new Option(i.label,i.value,!1,i.value===t.modeHint))),so.forEach(i=>this.engineSelect.add(new Option(i.label,i.value,!1,i.value===t.engine))),this.apiKeyInput.value=t.apiKey,this.dryRunCheckbox.checked=t.dryRun,this.autoApplyCheckbox.checked=t.autoApply,this.autoAdvanceCheckbox.checked=t.autoAdvance,this.hostDarkModeCheckbox.checked=t.hostDarkMode,this.useVisionCheckbox.checked=t.useVision,this.toastStackingCheckbox.checked=t.toastStacking??!0,this.toastStackingCheckbox.checked=t.toastStacking??!0,this.metricsLiveTime=this.shadow.querySelector("#eq-metrics-live-time"),this.metricsLiveStatus=this.shadow.querySelector("#eq-metrics-live-status"),this.metricsTotalBadge=this.shadow.querySelector("#eq-metrics-total-badge"),this.metricTotalTime=this.shadow.querySelector("#eq-metric-total-time"),this.metricAvgTime=this.shadow.querySelector("#eq-metric-avg-time"),this.metricTotalCount=this.shadow.querySelector("#eq-metric-total-count"),this.metricsHistoryList=this.shadow.querySelector("#eq-metrics-history-list"),this.metricsHistoryCount=this.shadow.querySelector("#eq-metrics-history-count"),this.metricsCopyBtn=this.shadow.querySelector("#eq-metrics-copy-btn"),this.metricsResetBtn=this.shadow.querySelector("#eq-metrics-reset-btn"),this.setupEventListeners(),this.updateTimingMetrics(),this.mountHost(),this.applyHostDarkMode(t.hostDarkMode);let s=Array.isArray(t.apiKeys)&&t.apiKeys.length>0?t.apiKeys:t.apiKey?[t.apiKey]:[];J.init(s),this.apiKeyInput.value=J.getBestKey()||t.apiKey||"",this.renderKeysList();let a=window.setInterval(()=>{this.activeTab==="settings"&&this.renderKeysList()},1e3);typeof a?.unref=="function"&&a.unref();let r=J.getBestKey()||t.apiKey;r&&et(r).then(i=>{i&&i.length>0&&this.updateModelSelect(i,t.model)}).catch(()=>{})}switchTab(t){this.activeTab=t;let e=["resolver","brain","metrics","debug","settings"];this.shadow.querySelector(".eq-views-wrapper")?.classList.toggle("is-brain-active",t==="brain");for(let s of e){let a=this.shadow.querySelector(`#eq-tab-${s}`),r=this.shadow.querySelector(`#eq-view-${s}`),i=s===t;a?.classList.toggle("active",i),r&&(r.style.display=i?"flex":"none")}switch(this.updateContextBar(t),t){case"brain":this.initBrainControls(),this.renderContextTree(),this.refreshInspectorView();break;case"metrics":try{this.updateTimingMetrics()}catch{}break;case"debug":try{this.refreshDebugView(),this.renderTerminalEntries(),this.initTerminalREPL()}catch{}break;case"settings":break}}updateContextBar(t){let e=this.shadow.querySelector("#eq-ctxbar-icon"),o=this.shadow.querySelector("#eq-ctxbar-name"),s=this.shadow.querySelector("#eq-ctxbar-sub"),a=this.shadow.querySelector("#eq-ctxbar-actions");if(!e||!o||!s||!a)return;a.innerHTML="";let i={resolver:{icon:S.sparkles,label:"Resolver",sub:"Autopilot & opera\xE7\xF5es",color:"#a78bfa",actions:()=>{let c=document.createElement("span");return c.id="eq-ctxbar-status",c.style.cssText="font-size:9px;font-weight:700;padding:2px 7px;border-radius:10px;background:rgba(167,139,250,0.13);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;letter-spacing:0.04em;",c.textContent="PRONTO",[c]}},brain:{icon:S.inspector,label:"C\xE9rebro da IA",sub:"Contexto & inspe\xE7\xE3o",color:"#60a5fa",actions:()=>{let c=this.shadow.querySelector("#eq-brain-canvas-toggle"),l=document.createElement("button");l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",l.innerHTML=this.brainCanvasHidden?S.eyeOff:S.eye,l.title="Mostrar/Ocultar canvas",l.addEventListener("click",()=>{c?.click(),l.innerHTML=this.brainCanvasHidden?S.eyeOff:S.eye});let u=document.createElement("button");return u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=S.copy,u.title="Copiar conte\xFAdo selecionado",u.addEventListener("click",()=>this.smartCopy()),[l,u]}},metrics:{icon:S.clock,label:"M\xE9tricas",sub:"Cron\xF4metro & hist\xF3rico",color:"#4ade80",actions:()=>{let c=document.createElement("button");c.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",c.innerHTML=S.copy,c.title="Copiar relat\xF3rio",c.addEventListener("click",()=>this.copyMetricsReport());let l=document.createElement("button");return l.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.08);border:1px solid rgba(255,85,85,0.15);border-radius:4px;cursor:pointer;color:#ff8888;",l.innerHTML=S.trash,l.title="Zerar m\xE9tricas",l.addEventListener("click",()=>{this.shadow.querySelector("#eq-metrics-reset-btn")?.click()}),[c,l]}},debug:{icon:S.code,label:"Terminal",sub:"Comandos & logs",color:"#0098ff",actions:()=>{let c=document.createElement("div");c.style.cssText="display:inline-flex;align-items:center;gap:1px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:2px;";let l=(d,m,p)=>{let f=document.createElement("button");return f.id=d,f.type="button",f.textContent=m,f.style.cssText="font-size:9px;font-weight:600;padding:2px 8px;border-radius:3px;cursor:pointer;transition:all 0.1s;background:"+(p?"#1a1a1a":"transparent")+";border:1px solid "+(p?"#333":"transparent")+";color:"+(p?"#ddd":"#555")+";",f};c.appendChild(l("eq-term-mode-terminal","Terminal",!0)),c.appendChild(l("eq-term-mode-output","Output",!1));let u=document.createElement("button");u.id="eq-term-copy-btn",u.type="button",u.title="Copiar",u.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:4px;cursor:pointer;color:#888;",u.innerHTML=S.copy;let A=document.createElement("button");return A.id="eq-term-clear-btn",A.type="button",A.title="Limpar",A.style.cssText="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:rgba(255,85,85,0.06);border:1px solid rgba(255,85,85,0.12);border-radius:4px;cursor:pointer;color:#ff5555;",A.innerHTML=S.trash,[c,u,A]}},settings:{icon:S.settings,label:"Configura\xE7\xF5es",sub:"Ajustes & prefer\xEAncias",color:"#fbbf24"}}[t];if(i&&(e.innerHTML=i.icon,e.style.color=i.color,o.textContent=i.label,o.style.color=i.color==="#a78bfa"?"#ccc":"#ddd",s.textContent=i.sub,i.actions))for(let c of i.actions())a.appendChild(c)}setupEventListeners(){this.shadow.querySelector("#eq-tab-resolver")?.addEventListener("click",()=>this.switchTab("resolver")),setTimeout(()=>this.updateContextBar(this.activeTab||"resolver"),0),this.shadow.querySelector("#eq-tab-brain")?.addEventListener("click",()=>this.switchTab("brain")),this.shadow.querySelector("#eq-tab-metrics")?.addEventListener("click",()=>this.switchTab("metrics")),this.shadow.querySelector("#eq-tab-debug")?.addEventListener("click",()=>this.switchTab("debug")),this.shadow.querySelector("#eq-tab-settings")?.addEventListener("click",()=>this.switchTab("settings"));let t=this.shadow.querySelector("#eq-status-card");t?.addEventListener("click",()=>{let v=t.classList.toggle("is-collapsed");t.setAttribute("aria-expanded",String(!v))}),this.metricsResetBtn?.addEventListener("click",()=>{je(),this.stopQuestionTimer(0),this.currentQuestionStartTime=0,this.metricsLiveTime&&(this.metricsLiveTime.textContent="00:00.00"),this.metricsLiveStatus&&(this.metricsLiveStatus.textContent="Em espera",this.metricsLiveStatus.classList.remove("active")),this.updateTimingMetrics(),this.logToConsole("> [SYS] M\xE9tricas e hist\xF3rico de tempo zerados com sucesso.","text-yellow")}),this.metricsCopyBtn?.addEventListener("click",()=>{this.copyMetricsReport()}),this.shadow.querySelector("#eq-dbg-filter-all")?.addEventListener("click",()=>this.setLogFilter("all")),this.shadow.querySelector("#eq-dbg-filter-error")?.addEventListener("click",()=>this.setLogFilter("error")),this.shadow.querySelector("#eq-dbg-filter-ai")?.addEventListener("click",()=>this.setLogFilter("ai")),this.shadow.querySelector("#eq-dbg-filter-dom")?.addEventListener("click",()=>this.setLogFilter("dom"));let e=this.shadow.querySelector("#eq-dbg-copy-logs");e?.addEventListener("click",()=>{let v=this.getFormattedLogs();navigator.clipboard.writeText(v).then(()=>{let w=e.innerHTML;e.innerHTML=S.check,setTimeout(()=>e.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-dbg-clear-logs")?.addEventListener("click",()=>{this.clearLogs()});let o=this.shadow.querySelector("#eq-dbg-copy-prompt");o?.addEventListener("click",()=>{let v=this.latestPromptText||this.latestPlan?.promptSent||"";navigator.clipboard.writeText(v).then(()=>{let w=o.innerHTML;o.innerHTML=`${S.check} Copiado!`,setTimeout(()=>o.innerHTML=w,1800)})});let s=this.shadow.querySelector("#eq-dbg-copy-context");s?.addEventListener("click",()=>{let v=this.dbgContextView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let w=s.innerHTML;s.innerHTML=`${S.check} Copiado!`,setTimeout(()=>s.innerHTML=w,1800)})});let a=this.shadow.querySelector("#eq-dbg-copy-raw-resp");a?.addEventListener("click",()=>{let v=this.latestPlan?.rawResponse||this.dbgRawRespView?.textContent||"";navigator.clipboard.writeText(v).then(()=>{let w=a.innerHTML;a.innerHTML=`${S.check} Copiado!`,setTimeout(()=>a.innerHTML=w,1800)})});let r=this.shadow.querySelector("#eq-dbg-copy-error-btn");r?.addEventListener("click",()=>{let v=this.lastErrorMsg||"";navigator.clipboard.writeText(v).then(()=>{let w=r.innerHTML;r.innerHTML=S.check,setTimeout(()=>r.innerHTML=w,1800)})}),this.shadow.querySelector("#eq-refresh-context-btn")?.addEventListener("click",()=>{this.renderContextTree()}),this.launcherBtn.addEventListener("click",()=>this.toggle()),this.dockToggleBtn.addEventListener("click",()=>this.toggle()),window.addEventListener("keydown",v=>{v.altKey&&(v.key==="q"||v.key==="Q"||v.key==="a"||v.key==="A")&&(v.preventDefault(),this.toggle())},!0);let i=v=>{let w=v.composedPath();w.includes(this.shadow)||(w.includes(this.sidebarEl)||w.includes(this.host))&&v.stopImmediatePropagation()};window.addEventListener("keydown",i,!0),window.addEventListener("keyup",i,!0),window.addEventListener("keypress",i,!0),this.apiKeyInput.addEventListener("input",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");this.callbacks.onSettingsChange({apiKey:v})});let c=this.shadow.querySelector("#eq-keys-collapsible"),l=this.shadow.querySelector("#eq-keys-chevron"),u=this.shadow.querySelector("#eq-keys-section-header"),A=v=>{c&&(v?(c.style.display="none",l&&(l.style.transform="rotate(0deg)")):(c.style.display="block",c.style.maxHeight="none",c.style.overflow="visible",l&&(l.style.transform="rotate(90deg)")))},d=!1;try{d=localStorage.getItem("easyquiz_keys_collapsed")==="true"}catch{}A(d),u?.addEventListener("click",v=>{if(v.target?.closest("a"))return;let w=c?.style.display==="none";A(!w);try{localStorage.setItem("easyquiz_keys_collapsed",w?"false":"true")}catch{}});let m=this.shadow.querySelector("#eq-auto-menu-btn"),p=this.shadow.querySelector("#eq-auto-menu");p&&(p.hidden=!0),m?.classList.remove("is-open"),m?.addEventListener("click",v=>{if(v.stopPropagation(),!p)return;let w=p.hidden;p.hidden=!w,m.classList.toggle("is-open",!p.hidden)}),p?.querySelectorAll("[data-auto-action]").forEach(v=>{v.addEventListener("click",w=>{w.stopPropagation();let T=v.dataset.autoAction;T==="toggle"?this.analyzeBtn?.click():T==="memory"?($e(),this.logToConsole("> [SYS] Mem\xF3ria contextual limpa com sucesso.","text-green"),this.setStatus("Mem\xF3ria contextual da sess\xE3o limpa.","success")):T==="status"&&this.shadow.querySelector("#eq-status-card")?.scrollIntoView({behavior:"smooth",block:"nearest"}),p&&(p.hidden=!0),m?.classList.remove("is-open")})}),this.shadow.addEventListener("click",v=>{v.target.closest(".eq-menu-shell")||(p&&(p.hidden=!0),m?.classList.remove("is-open"))});let f=this.shadow.querySelector("#eq-result-toggle"),h=this.shadow.querySelector("#eq-result-body");f&&h&&(h.classList.add("is-collapsed"),f.classList.remove("is-open"),f.addEventListener("click",()=>{let v=f.classList.toggle("is-open");h.classList.toggle("is-collapsed",!v)})),this.shadow.querySelector("#eq-key-save")?.addEventListener("click",()=>{let v=this.apiKeyInput.value.trim().replace(/^["']|["']$/g,"");if(!v){this.setStatus("Insira o valor da chave antes de adicionar.","warning");return}let w=J.addKey(v);if(w.ok){let T=J.exportRawKeys();this.callbacks.onSettingsChange({apiKey:T[0],apiKeys:T}),this.apiKeyInput.value="",this.setStatus(` Nova chave adicionada com sucesso! (${T.length} chaves ativas no pool)`,"success"),A(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}this.renderKeysList(),this.keyContextMenu.hidden=!0,tt(v).then(k=>{k.ok?(J.markSuccess(v,100),this.setStatus(" Nova chave validada com sucesso no Google AI Studio!","success")):(J.markInvalid(v,k.message),this.setStatus(`\uFE0F Chave cadastrada, mas aviso retornado: ${k.message}`,"warning")),this.renderKeysList()}).catch(()=>{})}else this.setStatus(w.message,"warning")}),this.keyMoreBtn.addEventListener("click",v=>{v.stopPropagation(),this.keyContextMenu.hidden=!this.keyContextMenu.hidden}),this.shadow.addEventListener("click",v=>{let w=v.target;!w.closest("#eq-key-context-menu")&&!w.closest("#eq-key-more-btn")&&(this.keyContextMenu.hidden=!0)}),this.shadow.querySelector("#eq-menu-prompt")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=window.prompt("Adicionar Nova Chave API do Google Gemini (AI Studio):");if(v!==null&&v.trim()){let w=v.trim().replace(/^["']|["']$/g,""),T=J.addKey(w);if(T.ok){let k=J.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}else this.setStatus(T.message,"warning")}}),this.shadow.querySelector("#eq-menu-paste")?.addEventListener("click",async()=>{this.keyContextMenu.hidden=!0;try{let v=await navigator.clipboard.readText();if(v){let w=v.trim().replace(/^["']|["']$/g,"");this.apiKeyInput.value=w,this.setStatus('Chave colada no campo. Clique no bot\xE3o "+" para adicionar ao pool.',"info")}}catch{let v=window.prompt("Adicionar Nova Chave API do Google Gemini:");if(v!==null&&v.trim()){let w=v.trim().replace(/^["']|["']$/g,"");if(J.addKey(w).ok){let k=J.exportRawKeys();this.callbacks.onSettingsChange({apiKey:k[0],apiKeys:k}),this.setStatus("Chave Gemini adicionada com sucesso!","success"),this.renderKeysList()}}}}),this.shadow.querySelector("#eq-menu-toggle-vis")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0;let v=this.apiKeyInput.type==="password";this.apiKeyInput.type=v?"text":"password";let w=this.shadow.querySelector("#eq-menu-vis-icon"),T=this.shadow.querySelector("#eq-menu-vis-text");w&&(w.innerHTML=v?S.eyeOff:S.eye),T&&(T.textContent=v?"Ocultar Campo":"Mostrar Campo")}),this.shadow.querySelector("#eq-menu-clear")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.apiKeyInput.value="",this.setStatus("Campo de inser\xE7\xE3o limpo.","info"),this.apiKeyInput.focus()}),this.shadow.querySelector("#eq-menu-bulk")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-bulk-overlay")?.remove();let v=document.createElement("div");v.id="eq-bulk-overlay",v.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.78)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif',"user-select:text","-webkit-user-select:text"].join(";");let w=document.createElement("div");w.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:440px","max-width:92vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85), 0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),w.innerHTML=`
      ...
      `,v.appendChild(w),this.shadow.appendChild(v);let T=w.querySelector("#eq-bulk-ta"),k=w.querySelector("#eq-bulk-status"),C=w.querySelector("#eq-bulk-import"),P=w.querySelector("#eq-bulk-paste-btn"),z=w.querySelector("#eq-bulk-clear-btn");requestAnimationFrame(()=>T?.focus());let q=()=>{v.remove()};["keydown","keyup","keypress","paste","copy","cut"].forEach(I=>{v.addEventListener(I,R=>{R.stopPropagation(),R.stopImmediatePropagation()},!0)}),v.addEventListener("keydown",I=>{I.key==="Escape"&&q()}),v.addEventListener("click",I=>{I.target===v&&q()}),w.querySelector("#eq-bulk-x")?.addEventListener("click",q),w.querySelector("#eq-bulk-cancel")?.addEventListener("click",q),z.addEventListener("click",()=>{T.value="",k.textContent="",T.focus()}),P.addEventListener("click",async()=>{try{let I=await navigator.clipboard?.readText();I?(T.value=I,T.focus(),k.style.color="#38bdf8",k.textContent="Conte\xFAdo colado da \xE1rea de transfer\xEAncia com sucesso!"):(k.style.color="#fbbf24",k.textContent="\xC1rea de transfer\xEAncia vazia ou sem permiss\xE3o de leitura.")}catch{k.style.color="#fbbf24",k.textContent="Permiss\xE3o de clipboard negada pelo navegador. Use Ctrl+V diretamente na caixa.",T.focus()}}),w.querySelector("#eq-bulk-import")?.addEventListener("click",async()=>{let I=T.value.trim();if(!I){k.style.color="#f87171",k.textContent="Insira pelo menos uma chave de API antes de importar.";return}let R=I.match(/AIza[0-9A-Za-z\-_]{35}/g),j=[];if(R&&R.length>0?j=Array.from(new Set(R)):j=Array.from(new Set(I.split(/[\n,;\s]+/).map(ne=>ne.trim().replace(/^["'`]|["'`]$/g,"")).filter(ne=>ne.length>=20))),j.length===0){k.style.color="#f87171",k.textContent="Nenhuma chave v\xE1lida encontrada (m\xEDnimo 20 caracteres).";return}k.style.color="#00e5ff",k.textContent=`Processando ${j.length} chave(s)...`,C.disabled=!0,C.style.opacity="0.6";let X=0,W=0;for(let ne of j){let _=J.addKey(ne);_.ok?X++:_.message.includes("j\xE1 est\xE1 cadastrada")&&W++}if(X>0){let ne=J.exportRawKeys();this.callbacks.onSettingsChange({apiKey:ne[0],apiKeys:ne}),A(!1);try{localStorage.setItem("easyquiz_keys_collapsed","false")}catch{}}k.textContent=`${X} adicionada(s), ${W} duplicada(s). Validando modelo em paralelo...`;let Y=J.exportRawKeys(),te=this.modelSelect?.value||"gemini-3.5-flash-lite",ee=await wt(te,Y);ee.ok?(J.markSuccess(ee.key,200),k.style.color="#4ade80",k.textContent=` ${X} adicionada(s), ${W} duplicada(s). Modelo '${ee.model}' pronto!`):(k.style.color="#fbbf24",k.textContent=`${X} adicionada(s), ${W} duplicada(s). Aviso: ${ee.message}`),this.renderKeysList(),C.disabled=!1,C.style.opacity="1",X>0&&(this.setStatus(` Lote importado: ${X} chave(s) adicionada(s) ao pool!`,"success"),setTimeout(q,2200))})}),this.shadow.querySelector("#eq-menu-edit-text")?.addEventListener("click",()=>{this.keyContextMenu.hidden=!0,this.shadow.querySelector("#eq-text-editor-overlay")?.remove();let v=J.exportRawKeys(),w=document.createElement("div");w.id="eq-text-editor-overlay",w.style.cssText=["position:fixed","inset:0","z-index:2147483647","pointer-events:auto","background:rgba(0,0,0,0.82)","backdrop-filter:blur(4px)","-webkit-backdrop-filter:blur(4px)","display:flex","align-items:center","justify-content:center",'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif'].join(";");let T=document.createElement("div");T.style.cssText=["background:#11151c","color:#e2e8f0","border:1px solid #283548","border-radius:12px","padding:20px","width:460px","max-width:94vw","font-size:13px","box-shadow:0 12px 40px rgba(0,0,0,0.85),0 0 0 1px rgba(0,229,255,0.15)","display:flex","flex-direction:column","gap:10px","pointer-events:auto"].join(";"),T.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #1f2937;padding-bottom:10px;">
          <div style="display:flex;align-items:center;gap:8px;">
...
`)).then(()=>{this.showToast("Relat\xF3rio copiado!","success",2500)})}destroy(){this.stopStopwatch(),this.stopQuestionTimer(),this.autopilot.stop(),this.applyHostDarkMode(!1),this.callbacks.onDestroy(),this.host.remove()}};function ro(){try{if(typeof document>"u"||!document.head||document.querySelector("link[data-easyquiz-preconnect]"))return;let n=document.createElement("link");n.rel="preconnect",n.href="https://generativelanguage.googleapis.com",n.crossOrigin="anonymous",n.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(n);let t=document.createElement("link");t.rel="dns-prefetch",t.href="https://generativelanguage.googleapis.com",t.setAttribute("data-easyquiz-preconnect","true"),document.head.appendChild(t)}catch{}}async function lo(){let n=window;if(je(),ro(),n.__easyquiz){try{n.__easyquiz.destroy()}catch{}try{document.getElementById("easyquiz-shadow-root")?.remove()}catch{}}let t=ht(),e=null,o=null,s=0,a=new pt(t,{onAnalyze:(l=1,u,A=!1)=>r(l,u,A),onApply:(l=1)=>void i(l),onDestroy:()=>{if(o){try{o.abort()}catch{}o=null}Ee(),delete n.__easyquiz},onCancel:()=>{if(o){try{o.abort()}catch{}o=null}Ee(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada imediatamente pelo usu\xE1rio.")},onSettingsChange:l=>{t=Jt(l)}});n.__easyquiz={toggle:()=>a.toggle(),destroy:()=>a.destroy(),analyze:async()=>{await r()}},window.addEventListener("keydown",l=>{if(l.altKey&&(l.key==="q"||l.key==="Q"||l.key==="a"||l.key==="A")){if(l.preventDefault(),!a)return;a.toggle(!0),r()}});async function r(l=1,u,A=!1){if(!t.apiKey&&(!Array.isArray(t.apiKeys)||t.apiKeys.length===0)){a.setStatus("Configure sua chave de API Gemini acima para come\xE7ar.","error"),a.toggle(!0);return}if(o)try{o.abort()}catch{}o=new AbortController;let d=o,m=()=>{try{d.abort()}catch{}};if(u&&(u.aborted?d.abort():u.addEventListener("abort",m,{once:!0})),d.signal.aborted){a.setBusy(!1),a.setProgress(0);return}s=Date.now(),a.setBusy(!0,"Identificando o bloco da quest\xE3o ativa na p\xE1gina..."),a.setProgress(20,"Varrendo escopo do DOM e controles..."),Ee(),a.hideFloatingAnswers();try{let p=xe(!1);p||(a.setStatus("Nenhum controle detectado. Tentando captura de tela inteira...","info"),p=be()),Ye(p.scope),a.updateContext(p),a.logToConsole(`> [DOM] Escopo: <${p.scope.tagName.toLowerCase()}> com ${p.controls.length} controle(s) e ${p.questionText.length} caracteres.`,"text-blue"),a.setStatus(`Quest\xE3o localizada (${p.controls.length} controles). Preparando an\xE1lise...`,"info"),a.setProgress(40,`Consultando Gemini (${t.model})...`);let f=await Rt(p.scope,t.useVision);if(f.length>0){let v=f.map(w=>w.element).filter(Boolean);Bt(v),a.updateImages(f)}if(d.signal.aborted)return;let h=t.model;a.setStatus(f.length>0?`Consultando Gemini (${h}) com ${f.length} imagem(ns) anexada(s)...`:`Consultando Gemini (${h}) via DOM nativo (modo r\xE1pido)...`,"info");let b=Xe(p,f,t);a.setInspectorPrompt(b,t.model);let y=(v,w)=>{a.setStatus(v,w==="warning"?"info":w);let T=v.match(/Onda\s+\d+.*?\[([^\]]+)\]/);if(T){let k=T[1].split(",")[0].trim();a.setProgress(50,`Gemini ${k} respondendo...`)}},{plan:x,usedModel:E}=await nt(p,f,t,y,d.signal);if(d.signal.aborted)return;if(x.needsMoreContext){if(a.setProgress(55,"Ampliando escopo da quest\xE3o..."),a.setStatus("Enunciado ou contexto isolado detectado pela IA. Acionando Sele\xE7\xE3o Geral Expandida...","info"),a.logToConsole("> [DOM] Enunciado isolado. Ampliando escopo para sele\xE7\xE3o expandida...","text-blue"),p=xe(!0),p||(p=be()),Ye(p.scope),a.updateContext(p),f=await Rt(p.scope,t.useVision),f.length>0){let T=f.map(k=>k.element).filter(Boolean);Bt(T),a.updateImages(f)}a.setStatus(`Reconsultando IA com escopo ampliado (${p.controls.length} controles)...`,"info");let v=Xe(p,f,t);a.setInspectorPrompt(v,t.model),x=(await nt(p,f,t,y,d.signal)).plan}if(d.signal.aborted)return;if(a.setProgress(70,"Resposta recebida da IA! Processando plano..."),a.logToConsole(`> [IA] Modelo: ${E||t.model} | Modo: ${x.mode} | Confian\xE7a: ${(x.confidence*100).toFixed(0)}%`,"text-green"),x.rationale&&a.logToConsole(`> [IA] Racioc\xEDnio: "${x.rationale}"`,"text-blue"),a.logToConsole(`> [IA] ${x.actions.length} a\xE7\xE3o(\xF5es) prescritas no plano.`,"text-blue"),x.memoryToStore&&(Ft(x.memoryToStore),a.logToConsole(`> [RAG]  Nova mem\xF3ria te\xF3rica salva na sess\xE3o: "${x.memoryToStore}"`,"text-yellow")),x.imageDescriptions&&x.imageDescriptions.length>0){a.logToConsole(`> [VISION] \uFE0F An\xE1lise de ${x.imageDescriptions.length} imagem(ns) pela IA:`,"text-blue");for(let v of x.imageDescriptions){let w=v.relevant?"":"\uFE0F";a.logToConsole(`>   ${w} Imagem ${v.index+1} [${v.relevant?"RELEVANTE":"IGNORADA"}]: ${v.description}`,v.relevant?"text-blue":"text-yellow")}}return e=x,a.updateContext(p,x),mn(x.actions,x.confidence),a.setPlan(x,!t.dryRun),x.pageType==="conclusion"?(a.setProgress(100,"Atividade conclu\xEDda!"),a.setStatus("Atividade conclu\xEDda ou tela final detectada pela IA.","success")):x.pageType==="info"?(a.setProgress(100,"Contexto absorvido na mem\xF3ria!"),a.setStatus(" Conte\xFAdo de contexto absorvido na mem\xF3ria RAG. Avan\xE7ando...","success")):x.pageType==="start"?(a.setProgress(100,"In\xEDcio detectado!"),a.setStatus("In\xEDcio de atividade detectado. Iniciando...","info")):(a.setProgress(80,"Plano de resolu\xE7\xE3o pronto!"),a.setStatus(t.dryRun?"Simula\xE7\xE3o conclu\xEDda. As respostas foram real\xE7adas na p\xE1gina sem altera\xE7\xE3o.":"Resolu\xE7\xE3o pronta! Verifique o realce na tela e aplique quando desejar.","success")),t.dryRun&&x.pageType==="question"&&a.showFloatingAnswers(x),d.signal.aborted?void 0:((A||t.autoApply)&&!t.dryRun&&await i(l,d.signal,A),x)}catch(p){if(d.signal.aborted||p instanceof Error&&(p.name==="AbortError"||p.message.includes("cancelada"))){Ee(),a.setProgress(0),a.setInterrupted("Opera\xE7\xE3o cancelada pelo usu\xE1rio.");return}Ee(),a.setProgress(0);let f=p instanceof Error?p.message:"Falha desconhecida na an\xE1lise.";a.setStatus(f,"error"),a.setErrorDiagnostic(f,"An\xE1lise da IA");return}finally{u?.removeEventListener("abort",m),o===d&&(o=null),d.signal.aborted||a.setBusy(!1)}}async function i(l=1,u,A=!1){if(u?.aborted)return;if(!e){a.setStatus("Nenhum plano dispon\xEDvel para aplicar. Execute a an\xE1lise primeiro.","error");return}if(t.dryRun){a.setStatus("O modo de simula\xE7\xE3o est\xE1 ativo. Desmarque para poder aplicar.","error");return}let d=e.pageType==="info"||e.pageType==="start",m=e.actions.filter(h=>h.t!=="adv"),p=e.pageType==="question"||it(e.rationale||"");if(p&&m.length===0){a.logToConsole("> [NAV]  Avan\xE7o bloqueado: quest\xE3o sem respostas prescritas.","text-yellow");return}let f=(A||t.autoAdvance||d)&&e.confidence>=t.confidenceThreshold&&!e.needsMoreContext&&(!p||m.length>0);a.setBusy(!0,"Aplicando respostas no formul\xE1rio..."),a.setProgress(85,`Aplicando ${e.actions.length} a\xE7\xE3o(\xF5es) no formul\xE1rio...`),a.logToConsole(`> [EXEC] Iniciando aplica\xE7\xE3o com 6 vias de persist\xEAncia para ${e.actions.length} a\xE7\xE3o(\xF5es)...`,"text-blue");try{let h=await We(e,f,l,Ie(t));if(u?.aborted)return;if(a.setExecutionReport(h),h.failedActions&&h.failedActions.length>0){a.logToConsole(`> [REPLAN] \uFE0F ${h.failedActions.length} a\xE7\xE3o(\xF5es) n\xE3o verificadas no DOM. Iniciando replanejamento...`,"text-yellow");for(let v of h.failedActions){let w=v.action,T=w.t==="drag"?`drag: "${w.from}" \u2192 "${w.to}"`:w.t==="clk"||w.t==="chk"?`${w.t}: "${w.id}"`:w.t==="val"?`val: "${w.id}" = "${w.v}"`:JSON.stringify(w).slice(0,80);a.logToConsole(`>    [${w.t.toUpperCase()}] ${T} | ${v.evidence.slice(0,80)}`,"text-yellow")}await c(h.failedActions,u)}let b=s>0?Date.now()-s:1200,y=h.verified>0,x=h.applied>0;if(h.success||y&&x){a.setProgress(100,"Sucesso! Resposta preenchida."),a.logToConsole(`> [DOM]  ${h.applied} a\xE7\xE3o(\xF5es) aplicada(s) \u2014 ${h.verified} verificada(s) no DOM.`,"text-green"),h.advanced?a.logToConsole("> [NAV]  Bot\xE3o de confirma\xE7\xE3o/avan\xE7o acionado com sucesso!","text-green"):f&&a.logToConsole(`> [NAV] ${h.navigationEvidence}`,"text-blue"),a.setStatus(h.advanced?`Sucesso: ${h.applied} resposta(s) preenchida(s) e avan\xE7ando.`:`Resposta aplicada na p\xE1gina (${h.applied} a\xE7\xE3o(\xF5es)).`,"success"),a.hideFloatingAnswers();let v=Wt({id:`q-${Date.now()}`,questionIndex:(Re().records.length||0)+1,questionTitle:e.rationale?e.rationale.slice(0,45)+"...":`Quest\xE3o ${e.mode||"Auto"}`,durationMs:b,status:"answered",mode:e.mode,actionsCount:h.applied});a.updateTimingMetrics(v)}else x?(a.setProgress(75,"Resposta aplicada (verifica\xE7\xE3o incerta)."),a.logToConsole(`> [DOM] \uFE0F ${h.applied} a\xE7\xE3o(\xF5es) disparadas mas sem confirma\xE7\xE3o DOM clara. Pendentes: ${h.failed.join(", ")||"nenhuma"}`,"text-yellow"),a.setStatus(`Resposta preenchida (${h.applied} a\xE7\xE3o(\xF5es) aplicadas, verifica\xE7\xE3o incerta).`,"warning")):(a.setProgress(0,"Alvo de resposta n\xE3o localizado."),a.logToConsole(`> [DOM] Alerta: nenhum controle de resposta foi modificado no DOM. Pend\xEAncias: ${h.failed.join(", ")||"nenhuma a\xE7\xE3o"}.`,"text-yellow"),a.setStatus("Controle de resposta n\xE3o encontrado na p\xE1gina. Use o bot\xE3o Gabarito no painel se desejar.","warning"),t.dryRun&&a.showFloatingAnswers(e))}catch(h){a.setProgress(0);let b=h instanceof Error?h.message:"Falha ao aplicar plano.";a.setStatus(`Erro ao aplicar: ${b}`,"error"),a.logToConsole(`> [ERRO] ${b}`,"text-red")}finally{a.setBusy(!1)}}async function c(l,u){if(!e)return;let A=l.filter(m=>m.action.t==="drag");for(let m of A){if(u?.aborted)return;let p=m.action,f=String(p.from||""),h=String(p.to||""),b=cn(f,h,f,h);a.logToConsole(`> [REPLAN]  Drag JS fallback: "${f}" \u2192 "${h}"`,"text-blue");let y={...e,actions:[{t:"js",v:b}],pageType:"question"},x=await We(y,!1,1,Ie(t));a.logToConsole(x.applied>0?"> [REPLAN]  Drag fallback aplicado!":"> [REPLAN]  Drag fallback sem efeito.",x.applied>0?"text-green":"text-yellow")}let d=l.filter(m=>m.action.t!=="drag");if(d.length!==0&&!u?.aborted){a.logToConsole(`> [REPLAN]  ${d.length} a\xE7\xE3o(\xF5es) pendente(s) \u2014 iniciando pipeline de recupera\xE7\xE3o multi-estrat\xE9gia...`,"text-blue");for(let m of d){if(u?.aborted)return;let p=m.action,f=p.t==="clk"||p.t==="chk"?`${p.t}: "${p.id}"`:p.t==="val"?`val: "${p.id}" = "${p.v}"`:p.t==="sel"?`sel: "${p.id}" = "${Array.isArray(p.v)?p.v[0]:p.v}"`:JSON.stringify(p).slice(0,60);a.logToConsole(`> [REPLAN]  Recuperando: ${f}`,"text-blue");let h=String(p.id||p.name||p.selector||""),b=p.v!==void 0?String(p.v):"";a.logToConsole("> [REPLAN] Estrat\xE9gia 1: rota alternativa padr\xE3o...","text-blue");try{if(await ct(m.action),await new Promise(y=>setTimeout(y,250)),ue(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 1 OK: ${f}`,"text-green");continue}}catch{}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 2: script injection (bypass isTrusted)...","text-blue");try{let y=Q(h,b)||Q(h.replace(/[^\w\s]/g," ").trim(),b);if(y&&(zt(y),await new Promise(x=>setTimeout(x,300)),ue(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 2 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"){a.logToConsole("> [REPLAN] Estrat\xE9gia 3: simula\xE7\xE3o de teclado (Tab+Space)...","text-blue");try{let y=Q(h,b)||Q(h.replace(/[^\w\s]/g," ").trim(),b);if(y&&(y.focus?.(),await new Promise(x=>setTimeout(x,50)),y.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),y.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,80)),y.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),y.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",keyCode:13,bubbles:!0,cancelable:!0})),await new Promise(x=>setTimeout(x,200)),ue(m.action))){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 3 OK: ${f}`,"text-green");continue}}catch{}}if(p.t==="clk"||p.t==="chk"||p.t==="val"){a.logToConsole("> [REPLAN] Estrat\xE9gia 4: internals Vue/React via script injection...","text-blue");try{let y=Q(h,b)||Q(h.replace(/[^\w\s]/g," ").trim(),b);if(y){let x=y.id,E=!!x;x||(x=`__eq_s4_${Math.random().toString(36).slice(2,8)}`,y.id=x);let v=String(p.v??""),w=p.t==="val",T=document.createElement("script");if(T.textContent=`(function(){
            ...
            })()`.replace(/\n\s+/g,""),document.head.appendChild(T),T.remove(),E||setTimeout(()=>{try{y.id===x&&y.removeAttribute("id")}catch{}},0),await new Promise(k=>setTimeout(k,300)),ue(m.action)){a.logToConsole(`> [REPLAN]  Estrat\xE9gia 4 OK: ${f}`,"text-green");continue}}}catch{}}if(u?.aborted)return;a.logToConsole("> [REPLAN] Estrat\xE9gia 5: re-consulta IA com diagn\xF3stico focado...","text-blue");try{let y="";try{let q=document.querySelector(`[data-easyquiz-id="${p.id}"]`)||document.getElementById(p.id||"")||Array.from(document.querySelectorAll('input, button, [role="radio"], [role="checkbox"], [role="option"]')).find(I=>(I.textContent||"").toLowerCase().includes(String(p.id||"").toLowerCase().slice(0,20)));q&&(y=q.outerHTML.slice(0,400))}catch{}let x=xe(!1)||be(),E=`A\xE7\xE3o (${p.t}) alvo="${h}" valor="${p.v||p.c||""}" \u2014 Falha: "${m.evidence.slice(0,80)}"${y?`
HTML do alvo: ${y}`:""}`,v=m.strategiesAttempted?[m.strategiesAttempted].flat().concat(["alternative-path","injectScript","keyboard","vue-react-internals"]):["alternative-path","injectScript","keyboard","vue-react-internals"],w=`[REPLANEJAMENTO URGENTE \u2014 TENTATIVA FINAL]
