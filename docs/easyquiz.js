...
`;function Kt(){try{if(typeof document>"u"||!document.head)return;if(!document.getElementById("eq-image-pulse-style")){let n=document.createElement("style");n.id="eq-image-pulse-style",n.textContent=Tn,document.head.appendChild(n)}}catch{}}function ge(){ie&&(ie.style.removeProperty("outline"),ie.style.removeProperty("outline-offset"),ie.style.removeProperty("position"),ie=null);for(let n of xe)n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("background-color"),n.style.removeProperty("box-shadow"),n.removeAttribute("data-easyquiz-highlight");xe=[];for(let n of ft)n.style.removeProperty("animation"),n.style.removeProperty("outline"),n.style.removeProperty("outline-offset"),n.style.removeProperty("box-shadow"),n.style.removeProperty("filter"),n.removeAttribute("data-easyquiz-image-highlight");ft=[];for(let n of bt)try{n.remove()}catch{}bt=[],he&&typeof window<"u"&&(window.removeEventListener("scroll",he),window.removeEventListener("resize",he),he=null);for(let n of vt)try{n.remove()}catch{}if(vt=[],se){try{se.remove()}catch{}se=null}}function At(n){Kt();let e=[];for(let t of n){if(!t||typeof t.setAttribute!="function")continue;let o=t;try{o.style&&(o.style.outline="3px solid #ffd600",o.style.outlineOffset="4px",o.style.animation="eq-image-pulse-yellow-white 1.2s ease-in-out infinite",o.style.boxShadow="0 0 16px rgba(255, 214, 0, 0.7)",o.style.filter="drop-shadow(0 0 8px rgba(255, 214, 0, 0.8))"),o.setAttribute("data-easyquiz-image-highlight","true"),ft.push(o)}catch{}try{let i=t.getBoundingClientRect(),a=i.width||t.offsetWidth||280,r=i.height||t.offsetHeight||200;if(a>10&&r>10){let s=document.createElement("div");s.setAttribute("data-easyquiz-image-frame","true"),s.style.cssText=`
    ...
    `,n.appendChild(t),se=t}catch{}}function qn(n){return!n||n>=.9?{outline:"#00ff88",bg:"rgba(0, 255, 136, 0.12)",glow:"rgba(0, 255, 136, 0.8)"}:n>=.7?{outline:"#00bfff",bg:"rgba(0, 191, 255, 0.10)",glow:"rgba(0, 191, 255, 0.7)"}:{outline:"#ffaa00",bg:"rgba(255, 170, 0, 0.10)",glow:"rgba(255, 170, 0, 0.7)"}}function Jt(n,e){if(se){try{se.remove()}catch{}se=null}let t=qn(e);for(let o of n){if(o.t==="adv"||o.t==="js")continue;if(o.t==="drag"){try{let m=P(o.from),p=P(o.to);m&&(m.style.outline=`2px solid ${t.outline}`,xe.push(m)),p&&(p.style.outline="2px dashed #00e5ff",xe.push(p))}catch{}continue}let i=o.v!==void 0?Array.isArray(o.v)?o.v[0]:String(o.v):"",a=String(o.name??o.n??"").trim(),r=null;if(a){let m=Array.from(document.querySelectorAll(`input[name="${F(a)}"]`));if(i&&(r=m.find(p=>p.value?.toLowerCase()===i.toLowerCase())??null,!r)){let p=/^(v|verdadeiro|true|1|t|sim|correto)$/i.test(i),f=/^(f|falso|false|0|nao|não|incorreto|errado)$/i.test(i);if(p||f){let A=p?["v","verdadeiro","true","1","t","sim","correto"]:["f","falso","false","0","nao","n\xE3o","incorreto","errado"];r=m.find(b=>{let v=b.value?.toLowerCase()??"";if(A.includes(v))return!0;let C=(b.closest('label, .vf-label, td, [class*="option" i]')?.textContent??"").trim().toLowerCase();return A.some(T=>C===T||C.startsWith(T+" ")||C.startsWith("("+T+")"))})??null}}!r&&m.length>0&&(r=m[0])}if(!r&&o.id&&(r=P(o.id,i,o.t==="val"||o.t==="sel")||P(L(o.id),i,o.t==="val"||o.t==="sel")),!r&&o.t==="sel"){let m=document.body;try{m=W()||document.body}catch{}let p=Array.from(m.querySelectorAll('select, [role="combobox"], [role="listbox"]')).filter(b=>z(b)&&!ue(b)),f=L(o.id).toLowerCase();r=p.find(b=>{let v=(b.id||"").toLowerCase(),y=(b.getAttribute("name")||"").toLowerCase(),C=(b.getAttribute("aria-label")||"").toLowerCase(),T=L(b.closest('.dropdown-row, [class*="dropdown" i], [class*="select" i], tr, label, div')?.textContent||"").toLowerCase();return v.includes(f)||y.includes(f)||C.includes(f)||f.length>=2&&T.includes(f)})||(p.length===1?p[0]:null)}if(!r)continue;let s=typeof HTMLSelectElement<"u"&&r instanceof HTMLSelectElement||r.tagName?.toLowerCase()==="select"||r.getAttribute("role")==="combobox"||r.getAttribute("role")==="listbox",d=r.closest('label, .vf-label, .option-card, [role="radio"], [role="checkbox"], [role="option"], [role="listitem"], .answer, .quiz-option, .form-check, [class*="option" i], [class*="choice" i]'),l=s?r.parentElement?.closest('.dropdown-row, [class*="dropdown" i], [class*="select-row" i], .form-group, tr, li'):null,u=d||l||r;u.style.outline=`2px solid ${t.outline}`,u.style.outlineOffset="2px",u.style.backgroundColor=t.bg,u.setAttribute("data-easyquiz-highlight","true"),xe.push(u);let h=s?r:u.querySelector('select, [role="combobox"], [role="listbox"]');h&&(h.style.outline=`2px solid ${t.outline}`,h.style.outlineOffset="2px",h.style.boxShadow=`0 0 10px ${t.glow}`,h.setAttribute("data-easyquiz-highlight","true"),xe.push(h));let c=r instanceof HTMLInputElement&&["checkbox","radio"].includes(r.type)?r:u.querySelector('input[type="checkbox"], input[type="radio"]');c&&c!==u&&(c.style.outline=`2px solid ${t.outline}`,c.style.outlineOffset="2px",c.style.boxShadow=`0 0 10px ${t.glow}`,c.setAttribute("data-easyquiz-highlight","true"),xe.push(c))}}var yt=10,kn=1400,Oe=15e5;function de(n){return new Promise((e,t)=>{let o=new FileReader;o.onerror=()=>t(new Error("Falha ao converter blob para base64.")),o.onload=()=>{let i=String(o.result||"");e(i.split(",")[1]||"")},o.readAsDataURL(n)})}async function we(n){let e=0,t=0;if(n instanceof HTMLImageElement?(e=n.naturalWidth||n.width,t=n.naturalHeight||n.height):(e=n.width,t=n.height),e<=0||t<=0)throw new Error("Dimens\xF5es inv\xE1lidas.");let o=Math.min(1,kn/Math.max(e,t)),i=Math.max(1,Math.round(e*o)),a=Math.max(1,Math.round(t*o)),r=document.createElement("canvas");r.width=i,r.height=a;let s=r.getContext("2d",{alpha:!1});if(!s)throw new Error("Sem suporte a Canvas 2D.");return s.fillStyle="#ffffff",s.fillRect(0,0,i,a),s.drawImage(n,0,0,i,a),new Promise((d,l)=>{r.toBlob(u=>u?d(u):l(new Error("Falha na compress\xE3o.")),"image/jpeg",.88)})}async function Yt(n){let e=typeof n.getBoundingClientRect=="function"?n.getBoundingClientRect():{width:0,height:0},t=e.width||parseFloat(n.getAttribute("width")||"0")||parseFloat(n.style.width||"0")||400,o=e.height||parseFloat(n.getAttribute("height")||"0")||parseFloat(n.style.height||"0")||300,i=2,a=Math.min(1800,Math.max(120,Math.round(t*i))),r=Math.min(1800,Math.max(100,Math.round(o*i))),s=n.cloneNode(!0);s.getAttribute("xmlns")||s.setAttribute("xmlns","http://www.w3.org/2000/svg"),s.getAttribute("xmlns:xlink")||s.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink"),s.setAttribute("width",String(a)),s.setAttribute("height",String(r)),!s.getAttribute("viewBox")&&t>0&&o>0&&s.setAttribute("viewBox",`0 0 ${t} ${o}`);try{let c=Array.from(n.querySelectorAll("*")),m=Array.from(s.querySelectorAll("*"));for(let p=0;p<Math.min(c.length,m.length);p++){let f=c[p],A=m[p];if(!f||!A||!A.style)continue;let b=window.getComputedStyle?window.getComputedStyle(f):null;b&&(b.fill&&b.fill!=="none"&&(A.style.fill=b.fill),b.stroke&&b.stroke!=="none"&&(A.style.stroke=b.stroke),b.strokeWidth&&(A.style.strokeWidth=b.strokeWidth),b.fontFamily&&(A.style.fontFamily=b.fontFamily),b.fontSize&&(A.style.fontSize=b.fontSize),b.fontWeight&&(A.style.fontWeight=b.fontWeight),b.color&&(A.style.color=b.color))}}catch{}let d="#ffffff";try{let c=n.parentElement||n;for(;c&&c!==document.documentElement;){let p=(window.getComputedStyle?window.getComputedStyle(c):null)?.backgroundColor;if(p&&p!=="transparent"&&p!=="rgba(0, 0, 0, 0)"){d=p;break}c=c.parentElement}}catch{}let u=new XMLSerializer().serializeToString(s),h="";try{h=btoa(unescape(encodeURIComponent(u)))}catch{}try{let c=A=>new Promise((b,v)=>{let y=new Image,C=setTimeout(()=>v(new Error("Timeout render SVG")),1200);y.onload=()=>{clearTimeout(C),b(y)},y.onerror=()=>{clearTimeout(C),v(new Error("Falha ao renderizar SVG em Image."))},y.src=A}),m=null;if(h)try{m=await c(`data:image/svg+xml;base64,${h}`)}catch{}if(!m){let A=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),b=URL.createObjectURL(A);try{m=await c(b)}finally{URL.revokeObjectURL(b)}}let p=document.createElement("canvas");p.width=a,p.height=r;let f=p.getContext("2d",{alpha:!1});if(f&&m){f.fillStyle=d,f.fillRect(0,0,a,r),f.drawImage(m,0,0,a,r);let A=await new Promise(b=>{p.toBlob(b,"image/jpeg",.92)});if(A){let b=await de(A);if(b)return{blob:A,base64:b,mediaType:"image/jpeg"}}}}catch{}return{base64:h,mediaType:"image/svg+xml"}}async function xt(n){try{let e=n.getBoundingClientRect(),t=Math.round(e.width)||n.offsetWidth||400,o=Math.round(e.height)||n.offsetHeight||300;if(t<30||o<30)return null;let i=n.tagName.toLowerCase()==="svg"?n:n.querySelector("svg");if(i&&n.querySelectorAll("input, select, textarea").length===0)try{let f=await Yt(i);if(f.base64&&f.base64.length<=Oe)return{mediaType:f.mediaType,base64:f.base64,alt:n.getAttribute("aria-label")||i.getAttribute("aria-label")||"Captura de diagrama/gr\xE1fico",source:"visual_snapshot",captureStatus:"captured",textContext:fe(i)}}catch{}if(n instanceof HTMLCanvasElement)try{let f=await we(n),A=await de(f);if(A)return{mediaType:"image/jpeg",base64:A,alt:n.getAttribute("aria-label")||"Captura de canvas visual",source:"canvas_snapshot",captureStatus:"captured"}}catch{}let a="#ffffff";try{let f=n;for(;f&&f!==document.documentElement;){let b=(window.getComputedStyle?window.getComputedStyle(f):null)?.backgroundColor;if(b&&b!=="transparent"&&b!=="rgba(0, 0, 0, 0)"){a=b;break}f=f.parentElement}}catch{}let r=n.cloneNode(!0),s=Array.from(n.querySelectorAll("*")),d=Array.from(r.querySelectorAll("*"));for(let f=0;f<Math.min(s.length,d.length);f++){let A=s[f],b=d[f];if(!(!A||!b||!b.style))try{let v=window.getComputedStyle(A);b.style.color=v.color,b.style.backgroundColor=v.backgroundColor,b.style.borderColor=v.borderColor,b.style.borderWidth=v.borderWidth,b.style.borderStyle=v.borderStyle,b.style.fontSize=v.fontSize,b.style.fontFamily=v.fontFamily,b.style.fontWeight=v.fontWeight,b.style.lineHeight=v.lineHeight,b.style.letterSpacing=v.letterSpacing,b.style.textAlign=v.textAlign}catch{}}let l=Math.min(2,Math.max(1,1200/Math.max(t,o))),u=Math.round(t*l),h=Math.round(o*l),c=`
              ...
              <div class="eq-view-pane" id="eq-view-debug" style="display: none; flex-direction:column;">
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;padding:5px 10px;background:rgba(255,255,255,0.02);border-bottom:1px solid rgba(255,255,255,0.06);flex-shrink:0;">
                  ...
                  <div style="display:flex;align-items:center;gap:3px;">
                    <button class="eq-icon-btn" id="eq-term-copy-btn" type="button" title="Copiar conte\xFAdo atual" style="width:22px;height:22px;">${S.copy}</button>
                    <button class="eq-icon-btn" id="eq-term-clear-btn" type="button" title="Limpar" style="width:22px;height:22px;color:#ff5555;">${S.eraser}</button>
                  </div>
                </div>
                ...
                <div id="eq-term-panel-terminal" style="flex:1;display:flex;flex-direction:column;overflow:hidden;min-height:0;">
                  <div id="eq-term-output" style="flex:1;overflow-y:auto;padding:10px 12px 4px;font-family:'Cascadia Code','Fira Code','Courier New',monospace;font-size:11px;line-height:1.55;background:#08080f;color:#c0c8d0;word-break:break-all;">
                    ...
                    <div style="color:#4a4a6a;">  EasyQuiz Terminal \u2014 v${be}</div>
                    <div style="color:#4a4a6a;">  Digite <span style="color:#a78bfa;">help</span> para ver os comandos dispon\xEDveis.</div>
                    <div style="color:#2a2a3a;">\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501</div>
                  </div>
