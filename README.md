...
<a id="portal" href="#portal">
  <img src="https://img.shields.io/badge/Bem--Vindo_ao_EasyQuiz-111111?style=for-the-badge&logo=google-gemini&logoColor=white" />
</a>
...
> ⚠️ **Atenção:** Devido à complexidade colossal do projeto, toda a documentação, tutorial de instalação, atalhos de teclado e mecânicas foram transferidas para o nosso Site Estático e Dossiês Técnicos (Manuais).

---

<a id="manuais" href="#manuais">
  <img src="https://img.shields.io/badge/Manuais_Avançados_de_Operação-0052CC?style=for-the-badge&logo=gitbook&logoColor=white" />
</a>

Acesse os dossiês detalhados no GitHub para entender como as técnicas de *Shadow DOM* e interceptação de Teclado (*Hooking*) funcionam:

* 🥷 **[Dossiê do MODO DISCRETO (Furtivo)](manuais/MODO_DISCRETO.md)** - Explica todos os atalhos invisíveis.
* 🖥️ **[Dossiê do MODO LEGACY (Painel)](manuais/MODO_LEGACY.md)** - Explica o sistema de auditoria visual de IA.
...
* **100% Chromium:** Suporta apenas Google Chrome, Edge, Brave e Opera. (Safari e Firefox bloqueiam as requisições de captura de tela).
